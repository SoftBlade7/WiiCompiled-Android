...
extern "C" void func_8082E608(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8082E62C:
{
    ...
    r0 = MemoryInline::FlatRead32((r4 + 17628));
    r0_addic_src_1 = r0;
    r0 = (r0_addic_src_1 + -1);
    {
...
loc_8082E644:
{
    MemoryInline::FlatWriteRam32((r4 + 17628), r0);
...
{
    r3 = 0x809C0000u;
    r3 = MemoryInline::FlatRead32((r3 + 17624));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(0));
}
...
loc_8082E670:
{
    r3 = 0x809C0000u;
    r0 = 0;
    MemoryInline::FlatWriteRam32((r3 + 17624), r0);
}
...
// RECOMP_REGISTRATION base 0x8082E608 func_8082E608 preserves=true fpr_mask=0x00000000
