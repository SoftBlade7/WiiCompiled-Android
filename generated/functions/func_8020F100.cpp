...
extern "C" void func_8020F100(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8020F134:
{
    ...
    r26 = MemoryInline::FlatRead32((r13 + -24200));
    r27 = (r4 + 19923);
    r25 = 0;
    r28 = 0x80000000u;
    r29 = 0;
...
// RECOMP_REGISTRATION base 0x8020F100 func_8020F100 preserves=true fpr_mask=0x00000000
