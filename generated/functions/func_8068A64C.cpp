...
extern "C" void func_8068A64C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8068A64C:
{
    ...
    guest_range_0 = MemoryInline::ResolveRangeHost((r3 + 48), 0, 48u, true, false);
...
// RECOMP_REGISTRATION base 0x8068A64C func_8068A64C preserves=false fpr_mask=0xF8000000
