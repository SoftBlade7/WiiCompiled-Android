...
extern "C" void func_806F1194(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806F1194:
{
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 0u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f1.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f3.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 0u, (r3 + 8), f1.d);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 4u, (r3 + 12), f3.d);
    }
...
// RECOMP_REGISTRATION base 0x806F1194 func_806F1194 preserves=true fpr_mask=0x00000000
