...
extern "C" void func_8014C25C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8014C334:
{
    MemoryInline::FlatWriteRam16((r3 + 40), static_cast<uint16_t>(r29));
...
loc_8014C360:
{
    r7 = MemoryInline::FlatRead8((r31 + 48));
    r4 = (r5 + 34);
    r6 = r29;
    r3 = (r1 + 8);
    r5 = (r5 + 53);
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80137CFCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8014C3D4:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8014F314u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8014C420:
{
    ...
    ctx->gpr[6] = r6;
    ctx->cr = cr;
    InvokeDirectCpu<0x801500A0u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
...
loc_8014C42C:
{
    ...
    r0 = (r3 + -1);
    MemoryInline::FlatWriteRam16((r31 + 40), static_cast<uint16_t>(r0));
    goto loc_8014C470;
}
...
// RECOMP_REGISTRATION base 0x8014C25C func_8014C25C preserves=true fpr_mask=0x00000000
