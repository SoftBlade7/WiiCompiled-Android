...
extern "C" void func_80194158(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8019420C:
{
    MemoryInline::FlatWrite32((r5 + 12), r24);
...
loc_80194228:
{
    MemoryInline::FlatWrite32((r5 + 28), r28);
...
loc_8019423C:
{
    ...
    r3 = r25;
    r4 = r26;
    MemoryInline::FlatWrite32((r5 + 20), r26);
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->xer = xer;
...
// RECOMP_REGISTRATION base 0x80194158 func_80194158 preserves=true fpr_mask=0x00000000
