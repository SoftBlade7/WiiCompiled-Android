...
extern "C" void func_8065AC94(CpuContext* MKW_RESTRICT ctx)
{
...
extern "C" MKW_PPC_NO_INLINE uint64_t func_8065AC94_statefree(uint32_t native_r3)
{
...
{
    cached_r4 = 0;
    guest_range_0 = MemoryInline::ResolveRangeHost(cached_r3, 0, 128u, false, true);
    ...
    MemoryInline::WriteResolved8(guest_range_0, 104u, (cached_r3 + 104), static_cast<uint8_t>(cached_r0));
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 112u, ((static_cast<uint64_t>(static_cast<uint32_t>(cached_r4)) << 32) | static_cast<uint32_t>(cached_r4)))) {
        MemoryInline::WriteResolved32(guest_range_0, 116u, (cached_r3 + 116), cached_r4);
        MemoryInline::WriteResolved32(guest_range_0, 112u, (cached_r3 + 112), cached_r4);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 120u, ((static_cast<uint64_t>(static_cast<uint32_t>(cached_r4)) << 32) | static_cast<uint32_t>(cached_r4)))) {
        MemoryInline::WriteResolved32(guest_range_0, 124u, (cached_r3 + 124), cached_r4);
        MemoryInline::WriteResolved32(guest_range_0, 120u, (cached_r3 + 120), cached_r4);
    }
...
// RECOMP_STATE_FREE_ABI address=0x8065AC94 symbol=func_8065AC94_statefree gpr_in=0x00000008 gpr_out=0x00000010 fpr_in=0x00000000 fpr_out=0x00000000 cr_in=0x00 cr_out=0x00 gqr_in=0x00 hid_in=0x00 hid_out=0x00 xer_in=0 ctr_in=0 lr_in=0
...
// RECOMP_REGISTRATION base 0x8065AC94 func_8065AC94 preserves=true fpr_mask=0x00000000
