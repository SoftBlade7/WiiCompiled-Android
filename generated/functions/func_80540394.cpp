...
extern "C" void func_80540394(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80540394:
{
    ...
    r29 = r7;
    r30 = r8;
    MemoryInline::FlatWrite32((r3 + 824), r5);
    r3 = (r3 + 836);
    r5 = 64;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    r3 = (r26 + r31);
    r4 = 0x80540000u;
    MemoryInline::FlatWrite32((r3 + 900), r29);
    r5 = r27;
    r4 = (r4 + 56);
    r6 = 0;
    MemoryInline::FlatWrite32((r3 + 904), r30);
...
// RECOMP_REGISTRATION base 0x80540394 func_80540394 preserves=true fpr_mask=0x00000000
