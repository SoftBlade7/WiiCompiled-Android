...
extern "C" void func_80605D64(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80605D64:
{
    MemoryInline::FlatWrite32((r3 + 504), r4);
    return;
}
...
// RECOMP_REGISTRATION base 0x80605D64 func_80605D64 preserves=true fpr_mask=0x00000000
