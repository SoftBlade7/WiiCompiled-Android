...
extern "C" void func_80584928(CpuContext* MKW_RESTRICT ctx)
{
    goto loc_80584928;

loc_80584928:
{
    InvokeDirectCpu<0x8058473Cu>(ctx);
    return;
}
...
// RECOMP_REGISTRATION base 0x80584928 func_80584928 preserves=true fpr_mask=0x00000000
