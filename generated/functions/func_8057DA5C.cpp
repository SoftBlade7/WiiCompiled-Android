...
extern "C" void func_8057DA5C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8057DA5C:
{
    ...
    r30 = 0x80890000u;
    r0 = 0;
    f0.d = MemoryInline::FlatReadFloat32((r30 + 6656));
    r3 = r31;
    MemoryInline::FlatWrite16((r31 + 252), static_cast<uint16_t>(r0));
    MemoryInline::FlatWrite16((r31 + 256), static_cast<uint16_t>(r0));
    MemoryInline::FlatWrite16((r31 + 254), static_cast<uint16_t>(r0));
    ...
    r4 = MemoryInline::FlatRead32((r31 + 644));
    f0.d = MemoryInline::FlatReadFloat32((r30 + 6656));
    f1.d = MemoryInline::FlatReadFloat32(r4);
    MemoryInline::FlatWriteFloat32((r31 + 552), f1.d);
    ...
    r3 = r31;
    f0.d = MemoryInline::FlatReadFloat32((r30 + 6656));
    f1.d = MemoryInline::FlatReadFloat32((r31 + 552));
    ...
    r4 = 407;
    f1.d = MemoryInline::FlatReadFloat32((r30 + 6656));
...
// RECOMP_REGISTRATION base 0x8057DA5C func_8057DA5C preserves=true fpr_mask=0x00000000
