...
extern "C" void func_807CAD68(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807CAE20:
{
    r3 = MemoryInline::FlatRead32((r27 + 260));
    r0 = 1;
...
loc_807CAE48:
{
    ...
    r6 = (r1 + 12);
    r4 = 0;
    r3 = MemoryInline::FlatRead32((r27 + 264));
    r5 = 0;
    ctx->lr = 0x807CAE64u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x807CAD68 func_807CAD68 preserves=false fpr_mask=0x80000000
