...
extern "C" void func_805FEDA4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805FEDA4:
{
    ...
    r3 = (r29 + 96);
    r4 = 0x808C0000u;
    guest_range_1 = MemoryInline::ResolveRangeHost((r29 + 96), 0, 36u, true, false);
    r30 = MemoryInline::ReadResolved32(guest_range_1, 0u, (r29 + 96));
    r7 = (r7 + -23956);
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r10 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r29 + 108));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r7 = MemoryInline::ReadResolved32(guest_range_1, 24u, (r29 + 120));
    ...
    r3 = 0x80890000u;
    r5 = 0x808D0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 25608));
    r5 = (r5 + 14156);
    r4 = 2001;
    r0 = 0;
...
// RECOMP_REGISTRATION base 0x805FEDA4 func_805FEDA4 preserves=true fpr_mask=0x00000000
