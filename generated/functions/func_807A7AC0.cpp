...
extern "C" void func_807A7AC0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_ca_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_807A7AC0:
{
    ...
    r4 = 0x808B0000u;
    r31 = 0x808A0000u;
    r6 = MemoryInline::FlatRead32((r4 + 19440));
    r0 = 2;
    r5 = 0;
    r30 = r3;
    r4 = (static_cast<int32_t>(r6) >> 31);
    r31 = (r31 + 22208);
    r0_subfc_sub_0 = r0;
    r0 = (r6 - r0_subfc_sub_0);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(r6) >= static_cast<uint32_t>(r0_subfc_sub_0) ? 1u : 0u) << 29);
    r0_ca_0 = (xer >> 29) & 1u;
    r0 = (r4 + r5);
    r0 = (r0 + r0_ca_0);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r4)) + static_cast<uint64_t>(static_cast<uint32_t>(r5)) + (static_cast<uint64_t>(static_cast<uint32_t>(r0_ca_0)) & 1u);
        xer = (xer & 0xDFFFFFFFu) | (static_cast<uint32_t>((ppcCarryWide >> 32) & 1u) << 29);
    }
    MemoryInline::FlatWrite8((r3 + 424), static_cast<uint8_t>(r0));
    r0 = (r0 & 255);
...
loc_807A7C08:
{
    ...
    r29 = MemoryInline::FlatRead32((r29 + 12));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_inl1_cont_80050660:
{
    ...
    MemoryInline::FlatWriteRam32((r5 + 13888), r3);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_807A7CD4:
{
    r3 = 0x809C0000u;
    r0 = 0;
    MemoryInline::FlatWriteRam32((r3 + 13888), r0);
    r28 = r30;
    r27 = 0;
    r31 = 0;
}
...
loc_807A7D28:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80072EB0u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
    cr = ctx->cr;
    r27 = (r27 + 1);
    MemoryInline::FlatWrite32((r28 + 428), r3);
...
// RECOMP_REGISTRATION base 0x807A7AC0 func_807A7AC0 preserves=true fpr_mask=0x00000000
