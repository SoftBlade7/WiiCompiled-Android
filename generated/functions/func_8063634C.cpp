...
extern "C" void func_8063634C(CpuContext* MKW_RESTRICT ctx)
{
    goto loc_8063634C;

loc_8063634C:
{
    InvokeDirectCpu<0x8063D044u>(ctx);
    return;
}
...
// RECOMP_REGISTRATION base 0x8063634C func_8063634C preserves=true fpr_mask=0x00000000
