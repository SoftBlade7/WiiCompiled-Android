...
extern "C" void func_80733290(CpuContext* MKW_RESTRICT ctx)
{
    goto loc_80733290;

loc_80733290:
{
    InvokeDirectCpu<0x80732508u>(ctx);
    return;
}
...
// RECOMP_REGISTRATION base 0x80733290 func_80733290 preserves=true fpr_mask=0x00000000
