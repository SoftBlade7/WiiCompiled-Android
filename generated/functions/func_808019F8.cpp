...
extern "C" void func_808019F8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80801A6C:
{
    f0.d = MemoryInline::FlatReadFloat64((r31 + 160));
...
// RECOMP_REGISTRATION base 0x808019F8 func_808019F8 preserves=false fpr_mask=0xC0000000
