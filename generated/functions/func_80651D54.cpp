...
extern "C" void func_80651D54(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80651D54:
{
    ...
    r5 = 0x808A0000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r5 + -24840));
    ctx->lr = 0x80651D7Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80651D54 func_80651D54 preserves=true fpr_mask=0x00000000
