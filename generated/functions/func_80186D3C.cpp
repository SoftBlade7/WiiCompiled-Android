...
extern "C" void func_80186D3C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_80186D3C:
{
    ...
    MemoryInline::FlatWrite8((r4 + 212), static_cast<uint8_t>(r6));
    r3 = MemoryInline::FlatRead8((r5 + 2));
    MemoryInline::FlatWrite8((r4 + 213), static_cast<uint8_t>(r0));
    r0 = MemoryInline::FlatRead8((r5 + 3));
    MemoryInline::FlatWrite8((r4 + 214), static_cast<uint8_t>(r3));
    MemoryInline::FlatWrite8((r4 + 215), static_cast<uint8_t>(r0));
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->gpr[6] = r6;
...
// RECOMP_REGISTRATION base 0x80186D3C func_80186D3C preserves=true fpr_mask=0x00000000
