...
extern "C" void func_8055E388(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8055E528:
{
    r0 = MemoryInline::FlatRead32((r27 + 40));
    r31 = r30;
    r26 = MemoryInline::FlatRead32(r28);
    r30 = (r30 + 1);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_8055E91C:
{
    MemoryInline::FlatWriteRam32((r1 + 36), r26);
    r3 = 0;
    r0 = 9;
    r9 = r29;
    r5 = MemoryInline::FlatRead32((r27 + 12));
...
// RECOMP_REGISTRATION base 0x8055E388 func_8055E388 preserves=true fpr_mask=0x00000000
