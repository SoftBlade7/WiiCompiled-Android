...
extern "C" void func_805CDAC0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r0 = 0;
    MemoryInline::FlatWriteRam8((r3 + 21036), static_cast<uint8_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x805CDAC0 func_805CDAC0 preserves=true fpr_mask=0x00000000
