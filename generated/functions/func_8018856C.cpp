...
extern "C" void func_8018856C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8018856C:
{
    ...
    r3 = 0x80340000u;
    r4 = (r4 + 18856);
    MemoryInline::FlatWriteRam32((r3 + 18872), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x8018856C func_8018856C preserves=true fpr_mask=0x00000000
