...
extern "C" void func_805FB80C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805FB80C:
{
    ...
    r3 = 0x809C0000u;
    r4 = (r4 + 7440);
    MemoryInline::FlatWriteRam32((r3 + 7392), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x805FB80C func_805FB80C preserves=true fpr_mask=0x00000000
