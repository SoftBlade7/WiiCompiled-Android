...
extern "C" void func_807B7A48(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807B7A70:
{
    r0 = MemoryInline::FlatRead32((r31 + 120));
    r3 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 25040));
    r0 = (r0 | 2048);
...
// RECOMP_REGISTRATION base 0x807B7A48 func_807B7A48 preserves=true fpr_mask=0x00000000
