...
extern "C" void func_806B0098(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806B00E0:
{
    r0 = MemoryInline::FlatRead32((r3 + 820));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_806B0188:
{
    f0.d = MemoryInline::FlatReadFloat32((r3 + 2708));
    f2.d = MemoryInline::FlatReadFloat32((r3 + 2712));
...
loc_806B027C:
{
    r3 = MemoryInline::FlatRead32((r3 + 820));
    r12 = MemoryInline::FlatRead32(r3);
    r12 = MemoryInline::FlatRead32((r12 + 12));
    ctr = r12;
    ctx->lr = 0x806B0290u;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r31 + 820));
    r4 = (r31 + 1780);
    r12 = MemoryInline::FlatRead32(r3);
    r12 = MemoryInline::FlatRead32((r12 + 120));
    ctr = r12;
...
// RECOMP_REGISTRATION base 0x806B0098 func_806B0098 preserves=false fpr_mask=0x80000000
