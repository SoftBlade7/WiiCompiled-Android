...
extern "C" void func_80777334(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80777334:
{
    ...
    r8 = 0;
    r7 = (r1 + 8);
    r0 = MemoryInline::FlatRead8((r4 + 16896));
    r4 = (r1 + 16);
...
// RECOMP_REGISTRATION base 0x80777334 func_80777334 preserves=true fpr_mask=0x00000000
