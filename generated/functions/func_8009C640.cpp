...
extern "C" void func_8009C640(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r3 = (r3 + -84);
    // inline leaf 0x8009C600 (15 guest instruction(s))
    ...
    // end of inlined leaf 0x8009C600
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->fpr[0] = f0;
    return;
...
// RECOMP_GUEST_ABI gpr_read=0x00000018 gpr_write=0x00000009 gpr_return=0x00000008 fpr_read=0x00000000 fpr_write=0x00000001 fpr_return=0x00000000 cr_read=0x00 cr_write=0x00 xer_read=0 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8009C640 func_8009C640 preserves=true fpr_mask=0x00000000
