...
extern "C" void func_8051B988(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8051B988:
{
    ...
    r31 = ctx->gpr[31];
    ctr = ctx->ctr;
    r3 = MemoryInline::FlatRead32((r31 + 9532));
    r0 = (r3 + -1);
    MemoryInline::FlatWrite32((r31 + 9532), r0);
...
// RECOMP_REGISTRATION base 0x8051B988 func_8051B988 preserves=true fpr_mask=0x00000000
