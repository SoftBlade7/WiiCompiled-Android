...
extern "C" void func_80874950(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_ca_0 = 0;
    uint32_t r0_ca_1 = 0;
...
loc_80874950:
{
    ...
    r0 = (r0 * 24);
    r6 = (r3 + r0);
    MemoryInline::FlatWrite8((r6 + 388), static_cast<uint8_t>(r4));
    r0 = MemoryInline::FlatRead32((r3 + 772));
    r0 = (r0 * 24);
    r4 = (r3 + r0);
    MemoryInline::FlatWrite32((r4 + 392), r5);
...
// RECOMP_REGISTRATION base 0x80874950 func_80874950 preserves=true fpr_mask=0x00000000
