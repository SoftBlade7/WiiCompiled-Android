...
extern "C" void func_800C8680(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800C8680:
{
    r4 = 0;
    ctx->gpr[4] = r4;
    InvokeDirectCpu<0x800C85A0u>(ctx);
    r4 = ctx->gpr[4];
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x800C8680 func_800C8680 preserves=true fpr_mask=0x00000000
