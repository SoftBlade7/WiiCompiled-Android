...
extern "C" void func_807DE858(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807DE858:
{
    ...
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r5_psq_tmp_0 = (r5 + 8);
    PPC_PsqStGqrInline<1u, 0u>(ctx, mkw_gqr0, r5_psq_tmp_0, f2.d);
    r1 = (r1 + 32);
    ctx->gpr[1] = r1;
    ctx->gpr[6] = r6;
    ctx->fpr[0] = f0;
...
// RECOMP_GUEST_ABI gpr_read=0x0000003A gpr_write=0x00000042 gpr_return=0x00000000 fpr_read=0x00000000 fpr_write=0x0000001F fpr_return=0x00000002 cr_read=0x00 cr_write=0x00 xer_read=0 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x807DE858 func_807DE858 preserves=true fpr_mask=0x00000000
