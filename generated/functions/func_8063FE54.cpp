...
extern "C" void func_8063FE54(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8063FE54:
{
    ...
    r28 = r3;
    r4 = r28;
    MemoryInline::FlatWrite32((r3 + 388), r7);
    ...
    r30 = ctx->gpr[30];
    r31 = ctx->gpr[31];
    MemoryInline::FlatWrite32((r28 + 376), r3);
    r4 = (r31 + 169);
    r3 = (r28 + 168);
    ctx->lr = 0x8063FED8u;
    ctx->gpr[0] = r0;
    ...
    r30 = ctx->gpr[30];
    r31 = ctx->gpr[31];
    MemoryInline::FlatWrite32((r28 + 380), r3);
    r4 = (r31 + 180);
    r3 = (r28 + 168);
    ctx->lr = 0x8063FEE8u;
    ctx->gpr[0] = r0;
    ...
    r30 = ctx->gpr[30];
    r31 = ctx->gpr[31];
    MemoryInline::FlatWrite32((r28 + 384), r3);
    r3 = (r1 + 8);
    r4 = -1;
    ctx->lr = 0x8063FEF8u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x8063FE54 func_8063FE54 preserves=true fpr_mask=0x00000000
