...
extern "C" void func_8071AC48(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8071AC50:
{
    r0 = (static_cast<int32_t>(static_cast<int8_t>(r22)));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
    if (((cr & 0x20000000u) == 0)) {
        goto loc_8071B7EC;
    }
...
// RECOMP_REGISTRATION base 0x8071AC48 func_8071AC48 preserves=true fpr_mask=0x00000000
