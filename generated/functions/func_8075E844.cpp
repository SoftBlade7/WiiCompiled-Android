...
extern "C" void func_8075E844(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8075E934:
{
    r6 = MemoryInline::FlatRead32((r29 + 180));
    r4 = (r1 + 32);
    r5 = 1;
    ctx->lr = 0x8075E944u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x8075E844 func_8075E844 preserves=true fpr_mask=0x00000000
