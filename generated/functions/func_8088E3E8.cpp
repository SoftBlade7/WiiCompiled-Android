...
extern "C" void func_8088E3E8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8088E438:
{
    ...
    r9 = 0;
    r3_addr_2 = (r3 + r6);
    r4 = MemoryInline::FlatRead16(r3_addr_2);
    goto loc_8088E4B4;
}
...
loc_8088E46C:
{
    ...
    r4_rot_3 = PpcRotl32Inline(static_cast<uint32_t>(r9), static_cast<uint32_t>(1));
    r4 = (r4_rot_3 & 131070);
    r9 = (r9 + 1);
    r5_addr_3 = (r5 + r0);
    r7 = MemoryInline::FlatRead32(r5_addr_3);
    r3 = (r7 + r4);
    r0 = MemoryInline::FlatRead16((r3 + 2));
    r7_addr_3 = (r7 + r4);
    MemoryInline::FlatWrite16(r7_addr_3, static_cast<uint16_t>(r0));
}

loc_8088E488:
{
    r7 = MemoryInline::FlatRead32((r29 + 52));
    r4 = (r9 & 65535);
    r6_addr_3 = (r6 + r7);
    r3 = MemoryInline::FlatRead16(r6_addr_3);
    r0 = (r3 + -1);
}
...
{
    r7_addr_4 = (r7 + r6);
    r3 = MemoryInline::FlatRead16(r7_addr_4);
    r0 = (r3 + -1);
    r7_addr_5 = (r7 + r6);
    MemoryInline::FlatWrite16(r7_addr_5, static_cast<uint16_t>(r0));
    goto loc_8088E4C0;
}
...
// RECOMP_REGISTRATION base 0x8088E3E8 func_8088E3E8 preserves=true fpr_mask=0x00000000
