...
extern "C" void func_800A0CE0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
    uint32_t r3_rot_1 = 0;
...
loc_800A0CE0:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800A1050u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800A0D58:
{
    MemoryInline::FlatWrite32((r27 + 20), r5);
    r3 = r28;
...
loc_800A0DD4:
{
    ...
    r23 = MemoryInline::FlatRead32((r1 + 8));
    r25 = (r0 * 1208);
    r3 = (r25 + r23);
    r0 = (r3 + 3);
    r24 = (r0 & -4);
...
loc_800A0F34:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80097500u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800A0F50:
{
    MemoryInline::FlatWrite32((r27 + 16), r28);
    r3 = 1;
    MemoryInline::FlatWrite32((r27 + 216), r29);
...
// RECOMP_REGISTRATION base 0x800A0CE0 func_800A0CE0 preserves=true fpr_mask=0x00000000
