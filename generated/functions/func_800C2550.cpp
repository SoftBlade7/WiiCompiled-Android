...
extern "C" void func_800C2550(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_800C2550:
{
    ...
    r6 = ctx->gpr[6];
    r7 = ctx->gpr[7];
    r0_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r28), static_cast<uint32_t>(1));
    r0 = (r0_rot_0 & 131070);
    r3 = r30;
    r4 = (r29 * r0);
    ctx->gpr[1] = r1;
...
// RECOMP_GUEST_ABI gpr_read=0xF80000FE gpr_write=0xF8000FFB gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x0000001E fpr_return=0x00000002 cr_read=0x00 cr_write=0x00 xer_read=0 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x800C2550 func_800C2550 preserves=true fpr_mask=0x00000000
