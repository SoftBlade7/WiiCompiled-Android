...
extern "C" void func_80174630(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801746A4:
{
    ...
    ctx->gpr[4] = r4;
    ctx->cr = cr;
    InvokeDirectCpu<0x8018CAE0u>(ctx);
    r0 = ctx->gpr[0];
    cr = ctx->cr;
    goto loc_801746D8;
}
...
// RECOMP_REGISTRATION base 0x80174630 func_80174630 preserves=true fpr_mask=0x00000000
