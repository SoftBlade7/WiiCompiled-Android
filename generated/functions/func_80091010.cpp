...
extern "C" void func_80091010(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80091034:
{
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWrite8((r30 + 392), static_cast<uint8_t>(r0));
    r3 = r30;
...
// RECOMP_REGISTRATION base 0x80091010 func_80091010 preserves=true fpr_mask=0x00000000
