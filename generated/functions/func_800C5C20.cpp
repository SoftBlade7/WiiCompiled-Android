...
extern "C" void func_800C5C20(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_inl0_cont_800BC400:
{
    ...
    r30 = (r3 + 60);
    r31 = r3;
    r3 = MemoryInline::FlatRead8((r3 + 6461));
...
loc_800C5C5C:
{
    ...
    r0 = MemoryInline::FlatRead8((r30 + 6401));
...
// RECOMP_REGISTRATION base 0x800C5C20 func_800C5C20 preserves=true fpr_mask=0x00000000
