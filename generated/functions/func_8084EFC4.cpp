...
extern "C" void func_8084EFC4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8084F040:
{
    r4 = MemoryInline::FlatRead32((r27 + 1620));
    r3 = r27;
    r6 = 0;
    r0 = (r4 + 1);
    MemoryInline::FlatWrite32((r27 + 1620), r0);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ...
    r0 = (r28 + 1);
    r0 = (r0 ^ -2147483648);
    f5.d = MemoryInline::FlatReadFloat64((r30 + 96));
...
// RECOMP_REGISTRATION base 0x8084EFC4 func_8084EFC4 preserves=true fpr_mask=0x00000000
