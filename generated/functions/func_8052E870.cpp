...
extern "C" void func_8052E870(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8052E870:
{
    ...
    r3 = 0x80890000u;
    r28 = (r4 * 240);
    f30.d = MemoryInline::FlatReadFloat32((r5 + -88));
    r30 = MemoryInline::FlatRead8((r6 + 36));
    r26 = r4;
...
// RECOMP_GUEST_ABI gpr_read=0xFC00009B gpr_write=0xFC0008FB gpr_return=0x00000018 fpr_read=0xC0000FF9 fpr_write=0xC0000FFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x8052E870 func_8052E870 preserves=false fpr_mask=0xC0000000
