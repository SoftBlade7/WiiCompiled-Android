...
extern "C" void func_80723B9C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFEFEE gpr_write=0x800018FB gpr_return=0x00000018 fpr_read=0xFFFFFFF7 fpr_write=0xC000000F fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x80723B9C func_80723B9C preserves=false fpr_mask=0xC0000000
