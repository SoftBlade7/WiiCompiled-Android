...
extern "C" void func_8085891C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8085891C:
{
    ...
    r3 = r31;
    MemoryInline::FlatWrite8((r31 + 372), static_cast<uint8_t>(r4));
    MemoryInline::FlatWrite32((r31 + 376), r0);
    MemoryInline::FlatWrite32((r31 + 392), r4);
...
// RECOMP_REGISTRATION base 0x8085891C func_8085891C preserves=true fpr_mask=0x00000000
