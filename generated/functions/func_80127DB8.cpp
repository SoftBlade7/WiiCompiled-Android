...
extern "C" void func_80127DB8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80127DF4:
{
    MemoryInline::FlatWrite16((r30 + 56), static_cast<uint16_t>(r31));
    r0 = (r0 | 4);
...
// RECOMP_REGISTRATION base 0x80127DB8 func_80127DB8 preserves=true fpr_mask=0x00000000
