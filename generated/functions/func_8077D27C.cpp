...
extern "C" void func_8077D27C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8077D2C8:
{
    r6 = MemoryInline::FlatRead16((r6 + 46));
    r6 = (r6 << 16);
    r6 = (static_cast<int32_t>(r6) >> 16);
    f2.d = MemoryInline::FlatReadFloat64((r5 + 17600));
    r0 = (r6 ^ -2147483648);
    MemoryInline::FlatWriteRam32((r1 + 28), r0);
    f0.d = MemoryInline::FlatReadFloat32((r3 + 17596));
...
// RECOMP_REGISTRATION base 0x8077D27C func_8077D27C preserves=true fpr_mask=0x00000000
