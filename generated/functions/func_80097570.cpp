...
extern "C" void func_80097570(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80097570:
{
    ...
    r5 = (r5 + 18880);
    r0 = 47;
    guest_range_0 = MemoryInline::ResolveRangeHost(r3, 0, 473u, false, true);
    ...
    r0 = 0;
    MemoryInline::WriteResolved8(guest_range_0, 472u, (r31 + 472), static_cast<uint8_t>(r0));
    r3 = r31;
...
extern "C" MKW_PPC_NO_INLINE MkwStateFreeResult2 func_80097570_statefree(uint32_t native_r1, uint32_t native_r3, uint32_t native_r31, uint32_t native_lr)
{
...
loc_80097570:
{
    ...
    cached_r0 = 47;
    guest_range_0 = MemoryInline::ResolveRangeHost(cached_r3, 0, 473u, false, true);
    ...
    // end of inlined leaf 0x8009E690
    cached_r0 = 0;
    MemoryInline::WriteResolved8(guest_range_0, 472u, (cached_r31 + 472), static_cast<uint8_t>(cached_r0));
...
// RECOMP_STATE_FREE_ABI address=0x80097570 symbol=func_80097570_statefree gpr_in=0x8000000A gpr_out=0x80000002 fpr_in=0x00000000 fpr_out=0x00000000 cr_in=0x00 cr_out=0x00 gqr_in=0x00 hid_in=0x00 hid_out=0x00 xer_in=0 ctr_in=0 lr_in=1
...
// RECOMP_REGISTRATION base 0x80097570 func_80097570 preserves=true fpr_mask=0x00000000
