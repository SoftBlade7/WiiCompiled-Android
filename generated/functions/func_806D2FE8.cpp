...
extern "C" void func_806D2FE8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806D3010:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r29 + 188), r31);
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r29 + 196), r31);
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r29 + 200), r31);
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r29 + 204), r31);
...
loc_806D308C:
{
    MemoryInline::FlatWrite32((r29 + 216), r31);
    if (((cr & 0x40000000u) == 0)) {
        goto loc_806D309C;
    }
}
...
// RECOMP_REGISTRATION base 0x806D2FE8 func_806D2FE8 preserves=true fpr_mask=0x00000000
