...
extern "C" void func_8073D6EC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8073D7D4:
{
    ...
    f2.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 24u, (r1 + 32));
    f1.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 36u, (r1 + 44));
    f5.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 0u, (r1 + 8));
    f3.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 28u, (r1 + 36));
    ...
    f6.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 32u, (r1 + 40));
    f3.d = PpcFmulsInline(f4.d, f3.d);
    f2.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 44u, (r1 + 52));
    f4.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 8u, (r1 + 16));
...
// RECOMP_REGISTRATION base 0x8073D6EC func_8073D6EC preserves=false fpr_mask=0xC0000000
