...
extern "C" void func_800276C0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80027708:
{
    r0 = MemoryInline::FlatRead32((r31 + -16360));
    r4 = r29;
    r3 = (r0 + r30);
...
// RECOMP_REGISTRATION base 0x800276C0 func_800276C0 preserves=true fpr_mask=0x00000000
