...
extern "C" void func_80540450(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805404B4:
{
    ...
    xer = ctx->xer;
    r4 = 0x80540000u;
    MemoryInline::FlatWrite32((r31 + 900), r28);
...
// RECOMP_REGISTRATION base 0x80540450 func_80540450 preserves=true fpr_mask=0x00000000
