...
extern "C" void func_80105694(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801057AC:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800FEE90u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801057C8:
{
    ...
    MemoryInline::FlatWrite32((r28 + 28), r4);
    r3 = 0;
...
// RECOMP_REGISTRATION base 0x80105694 func_80105694 preserves=true fpr_mask=0x00000000
