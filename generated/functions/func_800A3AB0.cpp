...
extern "C" void func_8008F460_statefree(uint32_t);

extern "C" void func_800A3AB0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800A3AB0:
{
    ...
    r4 = r30;
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x8008F460u) && KnownTranslatedCpuCall<0x8008F460u>::kAvailable && !KnownTranslatedCpuCall<0x8008F460u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x8008F460u>()) {
        func_8008F460_statefree(r3);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
        ...
        ctx->gpr[30] = r30;
        ctx->gpr[31] = r31;
        InvokeDirectCpu<0x8008F460u>(ctx);
        r0 = ctx->gpr[0];
        r1 = ctx->gpr[1];
        r3 = ctx->gpr[3];
        r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x800A3AB0 func_800A3AB0 preserves=true fpr_mask=0x00000000
