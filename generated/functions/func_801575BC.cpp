...
extern "C" void func_801575BC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_801575F8:
{
    r30 = MemoryInline::FlatRead8(r26);
    r3 = (r26 + 1);
    r5 = (r1 + 8);
    r4 = r30;
    ctx->gpr[0] = r0;
...
// RECOMP_GUEST_ABI gpr_read=0xFC0007FB gpr_write=0xFC0009FB gpr_return=0x00000018 fpr_read=0x00003FFE fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x801575BC func_801575BC preserves=true fpr_mask=0x00000000
