...
extern "C" void func_8023C98C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8023C98C:
{
    ...
    ctx->gpr[4] = r4;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x8006A4D0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r31 = ctx->gpr[31];
    r12 = MemoryInline::FlatRead32((r28 + 180));
    r3 = r28;
    r5 = r31;
    r4 = (r29 & 255);
...
// RECOMP_REGISTRATION base 0x8023C98C func_8023C98C preserves=true fpr_mask=0x00000000
