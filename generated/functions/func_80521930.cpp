...
extern "C" void func_80521930(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80521960:
{
    r4 = MemoryInline::FlatRead8((r31 + 81));
    goto loc_8052196C;
}
...
// RECOMP_REGISTRATION base 0x80521930 func_80521930 preserves=true fpr_mask=0x00000000
