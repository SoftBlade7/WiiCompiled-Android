...
extern "C" void func_801501D8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8015024C:
{
    r0 = MemoryInline::FlatRead32((r21 + 108));
}
...
loc_80150264:
{
    r4 = MemoryInline::FlatRead8((r21 + 13));
    r3 = r29;
    r5 = MemoryInline::FlatRead16((r21 + 18));
    ctx->lr = 0x80150274u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x801543C8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80150278:
{
    r0 = MemoryInline::FlatRead8((r22 + 1044));
...
loc_8015029C:
{
    MemoryInline::FlatWrite8((r21 + 14), static_cast<uint8_t>(r25));
    goto loc_801502A8;
}

loc_801502A4:
{
    MemoryInline::FlatWrite8((r21 + 14), static_cast<uint8_t>(r26));
}
...
loc_801502A8:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r21 + 108), r27);
    r12 = MemoryInline::FlatRead32((r21 + 140));
}
...
loc_801502C0:
{
    r0 = MemoryInline::FlatRead32((r21 + 136));
    r0 = (r0 & 32768);
...
loc_801502DC:
{
    r12 = MemoryInline::FlatRead32((r21 + 144));
...
loc_8015030C:
{
    if ((static_cast<int32_t>(r20) < static_cast<int32_t>(5))) {
        goto loc_8015024C;
    }
}
...
// RECOMP_REGISTRATION base 0x801501D8 func_801501D8 preserves=true fpr_mask=0x00000000
