...
extern "C" void func_8088D438(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8088D494:
{
    ...
    cr = ctx->cr;
    r3 = 0x808E0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + -11312));
...
loc_8088D4EC:
{
    ...
    ctx->fpr[4] = f4;
    ctx->cr = cr;
    InvokeDirectCpu<0x8088E2D8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8088D6C4:
{
    ...
    r5 = (r27 & 65535);
    r0 = MemoryInline::FlatRead8((r23 + 56));
    r3_addr_2 = (r3 + r5);
...
loc_8088D6DC:
{
    ...
    r3_addr_4 = (r3 + r4);
    MemoryInline::FlatWrite8(r3_addr_4, static_cast<uint8_t>(r24));
...
loc_8088D7BC:
{
    ...
    r8 = 0;
    r4_addr_7 = (r4 + r0);
    r7 = MemoryInline::FlatRead16(r4_addr_7);
    r9 = 0;
    r5_addr_3 = (r5 + r7);
    r6 = MemoryInline::FlatRead8(r5_addr_3);
    r5_rot_3 = PpcRotl32Inline(static_cast<uint32_t>(r7), static_cast<uint32_t>(2));
    r5 = (r5_rot_3 & -4);
    goto loc_8088D804;
}
...
loc_8088D7E0:
{
    ...
    r4_addr_10 = (r4 + r0);
    r0 = MemoryInline::FlatRead8(r4_addr_10);
}
...
loc_8088D818:
{
    r0 = MemoryInline::ReadResolved8(guest_range_1, 44u, (r23 + 56));
}
...
loc_8088D824:
{
    ...
    r4_addr_13 = (r4 + r6);
    MemoryInline::FlatWrite8(r4_addr_13, static_cast<uint8_t>(r24));
    r5 = MemoryInline::ReadResolved32(guest_range_1, 40u, (r23 + 52));
    r5_addr_4 = (r5 + r7);
...
// RECOMP_REGISTRATION base 0x8088D438 func_8088D438 preserves=false fpr_mask=0xF0000000
