...
extern "C" void func_800D37BC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800D37BC:
{
    ...
    r25 = 0;
    r22 = 0;
    // inline leaf 0x800DAE44 (4 guest instruction(s))
    r0 = MemoryInline::FlatRead32((r13 + -26868));
    r0 = PPC_CntlzwInline(static_cast<uint32_t>(r0));
    r3_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(27));
    r3 = (r3_rot_0 & 134217727);
    // end of inlined leaf 0x800DAE44
...
loc_800D381C:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r18), static_cast<int32_t>(2));
}
...
loc_800D388C:
{
    r19 = MemoryInline::FlatRead8((r3 + 1));
}
...
{
    r0 = (r0 | r3);
    r21_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(1));
    r21 = (r21_rot_1 & 1);
    if (((cr & 0x20000000u) == 0)) {
        goto loc_800D38B4;
    }
...
{
    r3 = (r19 & 255);
    // inline leaf 0x800E8CEC (31 guest instruction(s))
}
...
loc_inl3_0x800E8CF8:
{
    r5_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(6));
    r5 = (r5_rot_1 & 16320);
    r4 = 0;
    r3 = (r0 + r5);
...
loc_inl3_cont_800E8CEC:
{
    // end of inlined leaf 0x800E8CEC
}
...
loc_800D38B4:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    // inline leaf 0x800E7E4C (8 guest instruction(s))
}
...
loc_inl4_cont_800E7E4C:
{
    // end of inlined leaf 0x800E7E4C
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(0));
}
...
loc_800D3918:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800E7C34u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
...
loc_800D3934:
{
    r4 = MemoryInline::FlatRead32((r5 + 892));
    r0 = PPC_Slw(static_cast<uint32_t>(r3), static_cast<uint32_t>(r0));
    r0 = (r4 & ~r0);
    MemoryInline::FlatWrite32((r5 + 892), r0);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_800D3960;
    }
}
...
loc_800D3948:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800E6A8Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800D3954:
{
    ...
    r0 = 255;
    MemoryInline::FlatWrite8((r3 + 908), static_cast<uint8_t>(r0));
}
...
{
    r3 = MemoryInline::FlatRead32((r13 + -26896));
    r25 = MemoryInline::FlatRead32((r3 + 2456));
}
...
loc_800D3A2C:
{
    ...
    r29 = 0x802F0000u;
    r23 = 0;
    MemoryInline::FlatWrite32((r3 + 3052), r0);
    r30 = (r29 + 4960);
    r31 = 1;
    goto loc_800D3B58;
}
...
loc_inl8_cont_800E7E6C:
{
    // end of inlined leaf 0x800E7E6C
    r5 = MemoryInline::FlatRead32((r13 + -26896));
    r28 = r3;
    r4 = MemoryInline::FlatRead32(r3);
    r0 = MemoryInline::FlatRead32((r5 + 2776));
}
...
loc_800D3AA4:
{
    r0_rot_8 = PpcRotl32Inline(static_cast<uint32_t>(r17), static_cast<uint32_t>(2));
    r0 = (r0_rot_8 & -4);
    r30_addr_2 = (r30 + r0);
...
loc_800D3ABC:
{
    if ((static_cast<int32_t>(r17) < static_cast<int32_t>(32))) {
        goto loc_800D3A88;
    }
}
...
loc_800D3ACC:
{
    r26 = MemoryInline::FlatRead32((r13 + -26896));
...
loc_800D3ADC:
{
    r0 = PPC_CntlzwInline(static_cast<uint32_t>(r18));
    r3 = MemoryInline::FlatRead32(r28);
    r17_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(27));
    r17 = (r17_rot_2 & 134217727);
    ctx->lr = 0x800D3AECu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r3 = r20;
    r4 = r17;
    r12 = MemoryInline::FlatRead32((r5 + 144));
    r5 = r22;
    r6 = MemoryInline::FlatRead8((r28 + 22));
    r8 = MemoryInline::FlatRead32((r26 + 148));
    ctr = r12;
    ctx->lr = 0x800D3B14u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_800D3B14:
{
    r17 = MemoryInline::FlatRead8((r28 + 22));
    r3 = r17;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_inl10_0x800E7E6C:
{
    r4 = MemoryInline::FlatRead32((r13 + -26868));
    r0 = MemoryInline::FlatRead32((r4 + 48));
}

loc_inl10_0x800E7E78:
{
    if ((static_cast<int32_t>(r3) >= static_cast<int32_t>(r0))) {
        goto loc_inl10_0x800E7E8C;
    }
}

loc_inl10_0x800E7E7C:
{
    r0 = (r3 * 48);
    r3 = (r4 + r0);
    r3 = (r3 + 56);
    goto loc_inl10_cont_800E7E6C;
}

loc_inl10_0x800E7E8C:
{
    r3 = 0;
}

loc_inl10_cont_800E7E6C:
{
    // end of inlined leaf 0x800E7E6C
    r4 = MemoryInline::FlatRead32((r13 + -26896));
    r23 = (r23 + 1);
    r3 = MemoryInline::FlatRead8((r3 + 22));
    r0 = MemoryInline::FlatRead32((r4 + 3052));
    r3 = PPC_Slw(static_cast<uint32_t>(r31), static_cast<uint32_t>(r3));
    r0 = (r0 | r3);
    MemoryInline::FlatWrite32((r4 + 3052), r0);
}
...
loc_800D3B58:
{
    ...
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r23), static_cast<int32_t>(r3));
}
...
loc_800D3B64:
{
    ...
    r4 = (r27 + 2908);
    r3 = 4;
    r5 = MemoryInline::FlatRead32((r5 + 3052));
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x800D3B7Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_inl12_0x800E7E6C:
{
    r4 = MemoryInline::FlatRead32((r13 + -26868));
    r0 = MemoryInline::FlatRead32((r4 + 48));
}

loc_inl12_0x800E7E78:
{
    if ((static_cast<int32_t>(r3) >= static_cast<int32_t>(r0))) {
        goto loc_inl12_0x800E7E8C;
    }
}

loc_inl12_0x800E7E7C:
{
    r0 = (r3 * 48);
    r3 = (r4 + r0);
    r3 = (r3 + 56);
    goto loc_inl12_cont_800E7E6C;
}

loc_inl12_0x800E7E8C:
{
    r3 = 0;
}

loc_inl12_cont_800E7E6C:
{
    // end of inlined leaf 0x800E7E6C
...
loc_800D3C18:
{
    r3 = MemoryInline::FlatRead32((r13 + -26896));
    r0 = 0;
    MemoryInline::FlatWrite32((r3 + 3068), r0);
    MemoryInline::FlatWrite32((r3 + 3064), r0);
}
...
loc_800D3C60:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800DAC9Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800D3C84:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800DA83Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800D3D3C:
{
    ...
    r5 = 0;
    r16 = (r0 + r17);
    r3 = MemoryInline::FlatRead32((r16 + 924));
    r4 = MemoryInline::FlatRead16((r16 + 932));
    ctx->lr = 0x800D3D54u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r6 = MemoryInline::FlatRead8((r16 + 942));
    r8 = r3;
    r7 = MemoryInline::FlatRead32((r16 + 920));
    r5 = r23;
    r4 = (r27 + 1320);
    r3 = 4;
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
...
{
    r3 = MemoryInline::FlatRead32((r13 + -26896));
    r0 = MemoryInline::FlatRead32((r3 + 912));
...
loc_800D3DA8:
{
    ...
    r3 = 4;
    r10 = (r0 + r17);
    r6 = MemoryInline::FlatRead8((r10 + 942));
    r7 = MemoryInline::FlatRead8((r10 + 960));
    r8 = MemoryInline::FlatRead8((r10 + 961));
    r9 = MemoryInline::FlatRead8((r10 + 962));
    r10 = MemoryInline::FlatRead8((r10 + 963));
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x800D3DD8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_800D3DE0:
{
    r16 = MemoryInline::FlatRead32((r13 + -26896));
    r0 = MemoryInline::FlatRead32((r16 + 912));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r23), static_cast<int32_t>(r0));
}
...
loc_800D3DF0:
{
    r0 = MemoryInline::FlatRead32((r16 + 144));
}
...
loc_800D3E04:
{
    r0 = PPC_CntlzwInline(static_cast<uint32_t>(r18));
    r3 = r25;
    r17_rot_5 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(27));
    r17 = (r17_rot_5 & 134217727);
    ctx->lr = 0x800D3E14u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r5 = r22;
    r6 = (r19 & 255);
    r8 = MemoryInline::FlatRead32((r16 + 148));
    ctr = r12;
    ctx->lr = 0x800D3E3Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_800D3E88:
{
    ...
    r3 = MemoryInline::FlatRead32((r13 + -26896));
    r0 = 0;
    MemoryInline::FlatWrite8((r3 + 886), static_cast<uint8_t>(r0));
    goto loc_800D3F08;
}
...
loc_800D3EE8:
{
    // inline leaf 0x800E7BF8 (7 guest instruction(s))
    r3 = MemoryInline::FlatRead32((r13 + -26868));
    ...
    r3 = (r3_rot_1 & 1);
    // end of inlined leaf 0x800E7BF8
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(0));
}
...
// RECOMP_REGISTRATION base 0x800D37BC func_800D37BC preserves=true fpr_mask=0x00000000
