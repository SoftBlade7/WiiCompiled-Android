...
extern "C" void func_8062B240(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8062B240:
{
    ...
    r11 = MemoryInline::FlatRead32((r29 + 3040));
    ...
    r8 = MemoryInline::FlatRead32((r29 + 3052));
    ...
    r12 = 0x808C0000u;
    r10 = 0x808C0000u;
    guest_range_4 = MemoryInline::ResolveRangeHost((r29 + 3064), 0, 60u, true, false);
    r6 = MemoryInline::ReadResolved32(guest_range_4, 0u, (r29 + 3064));
    r12 = (r12 + -11676);
    ...
    MemoryInline::WriteResolved32(guest_range_1, 16u, (r28 + 1636), r0);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r21 = MemoryInline::ReadResolved32(guest_range_4, 12u, (r29 + 3076));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r24 = MemoryInline::ReadResolved32(guest_range_4, 24u, (r29 + 3088));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r27 = MemoryInline::ReadResolved32(guest_range_4, 36u, (r29 + 3100));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r9 = MemoryInline::ReadResolved32(guest_range_4, 48u, (r29 + 3112));
        }
    }
...
// RECOMP_REGISTRATION base 0x8062B240 func_8062B240 preserves=true fpr_mask=0x00000000
