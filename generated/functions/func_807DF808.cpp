...
extern "C" void func_807DF808(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807DF828:
{
    ...
    r28 = MemoryInline::FlatRead32((r30 + 16216));
...
{
    r31 = 0;
    MemoryInline::FlatWriteRam32((r30 + 16216), r31);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_807DF8D4;
    }
}
...
loc_807DF864:
{
    ...
    r27 = MemoryInline::FlatRead32((r30 + 16216));
...
loc_807DF890:
{
    ...
    r3 = MemoryInline::FlatRead32((r30 + 16216));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(0));
}
...
loc_807DF8A0:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x807DFEE4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x807DF808 func_807DF808 preserves=true fpr_mask=0x00000000
