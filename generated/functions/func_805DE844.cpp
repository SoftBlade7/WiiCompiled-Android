...
extern "C" void func_805DE844(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805DE844:
{
    r3 = MemoryInline::FlatRead32((r3 + 864));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x805DE844 func_805DE844 preserves=true fpr_mask=0x00000000
