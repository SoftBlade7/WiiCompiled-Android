...
extern "C" void func_8014D724(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8014D724:
{
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r21), static_cast<uint32_t>(r24));
}
...
loc_8014D730:
{
    ...
    r0 = (r0_rot_1 & -256);
    r7 = MemoryInline::FlatRead8(r21);
    r0 = (r3 + r0);
    r25 = MemoryInline::FlatRead8((r21 + 1));
    r17 = (r0 & 65535);
    r3 = (r21 + r17);
    r21 = (r3 + 4);
}
...
loc_8014D788:
{
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r7), static_cast<uint32_t>(11));
}
...
// RECOMP_REGISTRATION base 0x8014D724 func_8014D724 preserves=true fpr_mask=0x00000000
