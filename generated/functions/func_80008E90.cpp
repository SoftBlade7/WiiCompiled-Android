...
extern "C" void func_80008E90(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80008E90:
{
    ...
    r4 = r3;
    r5 = (r5 + 16512);
    r3 = MemoryInline::FlatRead32((r5 + 92));
...
// RECOMP_REGISTRATION base 0x80008E90 func_80008E90 preserves=true fpr_mask=0x00000000
