...
extern "C" void func_806FEAA0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806FEAA0:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8009DFE0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r31 = 0x809C0000u;
    r0 = r3;
    MemoryInline::FlatWriteRam32((r31 + 9056), r3);
    r3 = r30;
...
loc_806FEB08:
{
    r12 = MemoryInline::FlatRead32(r30);
    r31 = 0x809C0000u;
    r0 = MemoryInline::FlatRead32((r31 + 9056));
    r3 = r30;
    r12 = MemoryInline::FlatRead32((r12 + 12));
...
loc_806FEB90:
{
    ...
    r31 = (r0 + 9068);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r0)) + static_cast<uint64_t>(static_cast<uint32_t>(9068)) + (static_cast<uint64_t>(static_cast<uint32_t>(0)) & 1u);
...
// RECOMP_REGISTRATION base 0x806FEAA0 func_806FEAA0 preserves=true fpr_mask=0x00000000
