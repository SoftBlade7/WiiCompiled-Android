...
extern "C" void func_8060AD38(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8060AD38:
{
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 68u, ((static_cast<uint64_t>(static_cast<uint32_t>(r5)) << 32) | static_cast<uint32_t>(r30)))) {
        MemoryInline::WriteResolved32(guest_range_0, 68u, (r30 + 68), r5);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 88u, ((static_cast<uint64_t>(static_cast<uint32_t>(r4)) << 32) | static_cast<uint32_t>(r30)))) {
        MemoryInline::WriteResolved32(guest_range_0, 88u, (r30 + 88), r4);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 96u, ((static_cast<uint64_t>(static_cast<uint32_t>(r6)) << 32) | static_cast<uint32_t>(r5)))) {
        MemoryInline::WriteResolved32(guest_range_0, 96u, (r30 + 96), r6);
        MemoryInline::WriteResolved32(guest_range_0, 100u, (r30 + 100), r5);
    }
    ...
    r3 = 0x80890000u;
    r5 = 0x808D0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 28864));
    r5 = (r5 + 14156);
    r4 = 2001;
    r0 = 0;
    MemoryInline::FlatWrite32(r31, r5);
    r3 = (r30 + 1268);
    MemoryInline::FlatWrite32((r31 + 596), r4);
    MemoryInline::FlatWrite32((r31 + 600), r0);
...
// RECOMP_REGISTRATION base 0x8060AD38 func_8060AD38 preserves=true fpr_mask=0x00000000
