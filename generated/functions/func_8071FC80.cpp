...
extern "C" void func_8071FC80(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lfsx_8071FE58_loc_0 = 0;
    uint32_t cr0_0 = 0;
...
loc_8071FC80:
{
    ...
    r7 = 0x808D0000u;
    r30 = 0x808A0000u;
    f2.d = MemoryInline::FlatReadFloat32((r7 + -27364));
    r30 = (r30 + 8376);
    ...
    r8 = MemoryInline::FlatRead32((r7 + 26316));
    r9 = 1693188096;
    r27 = r6;
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 120u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f0.d))))) {
        ...
        MemoryInline::WriteResolvedFloat32(guest_range_1, 124u, (r1 + 124), f0.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 92u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f0.d))))) {
        ...
        MemoryInline::WriteResolvedFloat32(guest_range_1, 96u, (r1 + 96), f0.d);
    }
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 80u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f0.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 80u, (r1 + 80), f0.d);
...
loc_8071FDB4:
{
    r24 = 0x808D0000u;
    r3 = 0x809C0000u;
    f1.d = MemoryInline::FlatReadFloat32((r24 + -27364));
    r4 = r26;
    ...
    r23 = 0x809C0000u;
    f1.d = MemoryInline::FlatReadFloat32((r24 + -27364));
    r3 = MemoryInline::FlatRead32((r23 + 17200));
    r4 = r26;
    ctx->lr = 0x8071FDE4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8082AFECu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r24 = r3;
    f30.d = MemoryInline::FlatReadFloat32((r30 + 32));
    r28 = 0;
    f29.d = MemoryInline::FlatReadFloat32((r30 + 28));
    r31 = 0;
    r30 = 0;
    goto loc_8071FF14;
}
...
loc_8071FE04:
{
    ...
    r3_addr_2 = (r3 + r31);
    r21 = MemoryInline::FlatRead32(r3_addr_2);
...
loc_8071FE3C:
{
    if ((static_cast<int32_t>(r0) != static_cast<int32_t>(328))) {
        goto loc_8071FE44;
    }
}
...
loc_8071FE4C:
{
    r4 = MemoryInline::FlatRead32((r23 + 17200));
    r3 = (r1 + 44);
    r0 = MemoryInline::FlatRead32((r4 + 68));
    addr_lfsx_8071FE58_loc_0 = (r30 + r0);
    f0.d = MemoryInline::FlatReadFloat32(addr_lfsx_8071FE58_loc_0);
    r22 = (r0 + r30);
...
loc_8071FECC:
{
    if ((static_cast<int32_t>(r0) == static_cast<int32_t>(219))) {
        goto loc_8071FED8;
    }
}
...
loc_8071FED4:
{
    if ((static_cast<int32_t>(r0) != static_cast<int32_t>(413))) {
        goto loc_8071FEDC;
    }
}
...
loc_8071FF1C:
{
    ...
    r4 = 0x808D0000u;
    r3 = 0x808D0000u;
    f2.d = MemoryInline::FlatReadFloat32((r4 + -27360));
    f0.d = MemoryInline::FlatReadFloat32((r3 + -27364));
...
loc_8071FFA0:
{
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8071FA2Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8071FC80 func_8071FC80 preserves=false fpr_mask=0xE0000000
