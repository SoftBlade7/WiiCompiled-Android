...
extern "C" void func_8075E98C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8075E98C:
{
    ...
    r30 = r3;
    r4 = MemoryInline::FlatRead32((r4 + 6552));
...
loc_8075E9C4:
{
    ...
    r31 = 0x808A0000u;
    r5 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r31 + 14440));
    r3 = MemoryInline::FlatRead32((r3 + 40));
    r4 = 0;
    f2.d = MemoryInline::FlatReadFloat32((r5 + 14444));
    ctx->lr = 0x8075E9E4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8075E98C func_8075E98C preserves=true fpr_mask=0x00000000
