...
extern "C" void func_8059FE94(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8059FE94:
{
    ...
    f10.d = MemoryInline::FlatReadFloat32((r3 + 96));
    f0.d = MemoryInline::FlatReadFloat32((r4 + 12));
    f31.d = MemoryInline::FlatReadFloat32((r3 + 84));
    f13.d = MemoryInline::FlatReadFloat32(r4);
    f7.d = PpcFmulsInline(f10.d, f0.d);
    f12.d = MemoryInline::FlatReadFloat32((r3 + 88));
    f5.d = PpcFmulsInline(f31.d, f0.d);
    f9.d = MemoryInline::FlatReadFloat32((r3 + 92));
...
// RECOMP_REGISTRATION base 0x8059FE94 func_8059FE94 preserves=true fpr_mask=0x00000000
