...
extern "C" void func_8088D1CC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8088D1F4:
{
    r6 = 0x809C0000u;
    r4 = 0x80890000u;
    r5 = MemoryInline::FlatRead8((r6 + 19584));
    r4 = (r4 + -12300);
    r0 = (r5 + -1);
    MemoryInline::FlatWriteRam8((r6 + 19584), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x8088D1CC func_8088D1CC preserves=true fpr_mask=0x00000000
