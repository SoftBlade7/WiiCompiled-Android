...
extern "C" void func_80545D90(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r3 = (r3 + 65536);
    MemoryInline::FlatWrite32((r3 + -28028), r4);
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
...
// RECOMP_REGISTRATION base 0x80545D90 func_80545D90 preserves=true fpr_mask=0x00000000
