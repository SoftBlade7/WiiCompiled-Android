...
extern "C" void func_800B1920(CpuContext* MKW_RESTRICT ctx)
{
    goto loc_800B1920;

loc_800B1920:
{
    InvokeDirectCpu<0x801A1894u>(ctx);
    return;
}
...
// RECOMP_REGISTRATION base 0x800B1920 func_800B1920 preserves=true fpr_mask=0x00000000
