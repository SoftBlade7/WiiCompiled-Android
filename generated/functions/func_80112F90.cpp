...
extern "C" void func_80112F90(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80112FBC:
{
    ...
    r4 = MemoryInline::FlatRead32((r5 + 76));
    ctx->lr = 0x80112FC8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80112F90 func_80112F90 preserves=true fpr_mask=0x00000000
