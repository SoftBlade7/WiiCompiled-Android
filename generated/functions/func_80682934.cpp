...
extern "C" void func_80682934(CpuContext* MKW_RESTRICT ctx)
{
    goto loc_80682934;

loc_80682934:
{
    InvokeDirectCpu<0x80685374u>(ctx);
    return;
}
...
// RECOMP_REGISTRATION base 0x80682934 func_80682934 preserves=true fpr_mask=0x00000000
