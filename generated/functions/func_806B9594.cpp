...
extern "C" void func_806B9594(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_806B9594:
{
    ...
    r5 = 0x808A0000u;
    r27 = r4;
    f0.d = MemoryInline::FlatReadFloat32((r5 + -3576));
    r26 = r3;
...
// RECOMP_REGISTRATION base 0x806B9594 func_806B9594 preserves=true fpr_mask=0x00000000
