...
extern "C" void func_8017AC5C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8017AC5C:
{
    ...
    r29 = (r29_rot_0 & 65535);
    r30 = MemoryInline::FlatRead32((r4 + 18768));
    r28 = (r3 & 65535);
    r3 = r29;
    ctx->lr = 0x8017AC94u;
    ctx->gpr[0] = r0;
...
{
    r4 = (r29 * 48);
    r3_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r29), static_cast<uint32_t>(16));
    r3 = (r3_rot_1 & -65536);
    r0 = (r29 + 2);
    r5 = (r30 + r4);
    r30 = (r5 + 1240);
...
// RECOMP_REGISTRATION base 0x8017AC5C func_8017AC5C preserves=true fpr_mask=0x00000000
