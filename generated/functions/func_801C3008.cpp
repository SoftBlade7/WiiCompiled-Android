...
extern "C" void func_801C3008(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_801C3008:
{
    ...
    r31 = MemoryInline::FlatRead32((r31 + 2268));
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x801C3008 func_801C3008 preserves=true fpr_mask=0x00000000
