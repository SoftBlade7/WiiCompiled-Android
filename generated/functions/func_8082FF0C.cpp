...
extern "C" void func_8082FF0C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8083002C:
{
    ...
    r30 = MemoryInline::FlatRead32((r5 + 100));
...
// RECOMP_REGISTRATION base 0x8082FF0C func_8082FF0C preserves=true fpr_mask=0x00000000
