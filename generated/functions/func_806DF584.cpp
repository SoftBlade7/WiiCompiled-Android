...
extern "C" void func_806DF584(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806DF584:
{
    ...
    r3 = (r1 + 20);
    f1.d = MemoryInline::FlatReadFloat32((r5 + 26116));
    r4 = (r4 + 16688);
...
// RECOMP_REGISTRATION base 0x806DF584 func_806DF584 preserves=true fpr_mask=0x00000000
