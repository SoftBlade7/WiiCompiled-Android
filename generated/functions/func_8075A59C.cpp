...
extern "C" void func_8075A59C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8075A648:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r3 + -14116));
    r3 = (r1 + 32);
    r4 = (r31 + 48);
    r5 = (r1 + 104);
    f1.d = (-(f1.d));
...
loc_8075A6A0:
{
    ...
    r0 = 1;
    MemoryInline::FlatWrite8((r31 + 325), static_cast<uint8_t>(r0));
    r3 = MemoryInline::FlatRead32((r31 + 260));
    MemoryInline::FlatWrite32((r31 + 328), r30);
    MemoryInline::FlatWrite8((r31 + 324), static_cast<uint8_t>(r30));
...
loc_8075A744:
{
    ...
    f31 = ctx->fpr[31];
    cr = ctx->cr;
    f0.d = MemoryInline::FlatReadFloat32((r29 + 172));
...
loc_8075A784:
{
    ...
    MemoryInline::FlatWrite8((r31 + 336), static_cast<uint8_t>(r3));
    MemoryInline::FlatWrite16((r31 + 44), static_cast<uint16_t>(r0));
    MemoryInline::FlatWriteFloat32((r31 + 48), f2.d);
    MemoryInline::FlatWriteFloat32((r31 + 52), f1.d);
    MemoryInline::FlatWriteFloat32((r31 + 56), f0.d);
...
loc_8075A7B4:
{
    ...
    f31 = ctx->fpr[31];
    cr = ctx->cr;
    f1.d = MemoryInline::FlatReadFloat32((r29 + 172));
    r3 = (r1 + 20);
    r4 = (r1 + 68);
...
// RECOMP_REGISTRATION base 0x8075A59C func_8075A59C preserves=false fpr_mask=0x80000000
