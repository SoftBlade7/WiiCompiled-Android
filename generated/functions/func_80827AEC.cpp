...
extern "C" void func_80827AEC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80827B2C:
{
    ...
    xer = ctx->xer;
    r3 = 0x808B0000u;
    f31.d = MemoryInline::FlatReadFloat32((r3 + -17628));
...
{
    r3 = 0x808B0000u;
    f31.d = MemoryInline::FlatReadFloat32((r3 + -17624));
    SetCRFloatResident(cr, 0, f1.d, f31.d);
}
...
// RECOMP_REGISTRATION base 0x80827AEC func_80827AEC preserves=false fpr_mask=0x80000000
