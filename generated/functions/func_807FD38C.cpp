...
extern "C" void func_807FD38C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807FD38C:
{
    ...
    r5 = (r6 - r5);
    f1.d = MemoryInline::FlatReadFloat64((r4 + -21528));
    r4 = (r5 ^ -2147483648);
...
loc_807FD428:
{
    ...
    r28 = 0x808B0000u;
    r29 = 0x808D0000u;
    f4.d = MemoryInline::FlatReadFloat64((r28 + -21528));
    f0.d = MemoryInline::FlatReadFloat64((r1 + 8));
    f3.d = MemoryInline::FlatReadFloat32((r29 + 17356));
...
loc_807FD450:
{
    ...
    r4 = 0x808D0000u;
    f31.d = MemoryInline::FlatReadFloat32((r4 + 17360));
    r4 = 1;
    f2.d = f1.d;
...
loc_807FD4A0:
{
    ...
    f0.d = MemoryInline::FlatReadFloat64((r1 + 16));
    r4 = 1;
    f1.d = MemoryInline::FlatReadFloat32((r5 + 17360));
    f2.d = static_cast<double>(PpcForceSingleValueInline(f0.d - f4.d));
    MemoryInline::FlatWriteRam32((r1 + 12), r0);
    r3 = MemoryInline::FlatRead32((r3 + 40));
    f0.d = MemoryInline::FlatReadFloat64((r1 + 8));
    f1.d = PpcFmulsInline(f1.d, f2.d);
    f2.d = MemoryInline::FlatReadFloat32((r30 + -21568));
    f0.d = static_cast<double>(PpcForceSingleValueInline(f0.d - f4.d));
    f31.d = static_cast<double>(PpcForceSingleValueInline(f1.d / f3.d));
    ...
    f0.d = MemoryInline::FlatReadFloat32((r29 + 17356));
...
// RECOMP_REGISTRATION base 0x807FD38C func_807FD38C preserves=false fpr_mask=0x80000000
