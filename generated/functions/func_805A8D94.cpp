...
extern "C" void func_805A8D94(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805A8D94:
{
    ...
    r30 = r8;
    r4 = 0;
    r3 = MemoryInline::FlatRead32((r9 + -10456));
...
loc_805A8E10:
{
    r24 = MemoryInline::FlatRead32((r25 + 52));
    goto loc_805A8E1C;
}
...
loc_805A8E5C:
{
    ...
    r0 = (r3 + 48);
    MemoryInline::FlatWriteRam32((r31 + 136), r0);
    goto loc_805A8F30;
}
...
{
    r0 = 0;
    MemoryInline::FlatWrite8((r31 + 830), static_cast<uint8_t>(r0));
}
...
loc_805A8F54:
{
    ...
    r0 = (r0_rot_4 & 1020);
    r3_addr_0 = (r3 + r0);
    MemoryInline::FlatWrite32(r3_addr_0, r31);
...
// RECOMP_REGISTRATION base 0x805A8D94 func_805A8D94 preserves=true fpr_mask=0x00000000
