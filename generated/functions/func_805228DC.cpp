...
extern "C" void func_805228DC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r3_rot_0 = 0;
...
loc_805228DC:
{
    r4 = MemoryInline::FlatRead32((r3 + 2264));
    r3 = (2 - r4);
...
// RECOMP_REGISTRATION base 0x805228DC func_805228DC preserves=true fpr_mask=0x00000000
