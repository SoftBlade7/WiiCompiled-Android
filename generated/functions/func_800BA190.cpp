...
extern "C" void func_800BA190(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800BA190:
{
    ...
    r31_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r6), static_cast<uint32_t>(1));
    r31 = (r31_rot_0 & -2);
...
// RECOMP_REGISTRATION base 0x800BA190 func_800BA190 preserves=false fpr_mask=0xF8000000
