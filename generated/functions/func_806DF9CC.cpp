...
extern "C" void func_806DF9CC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lhax_806DFA1C_loc_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_806DF9CC:
{
    ...
    addr_lhax_806DFA1C_loc_0 = (r6 + r3);
    r0 = MemoryInline::FlatRead16(addr_lhax_806DFA1C_loc_0);
    r0 = (r0 << 16);
    r0 = (static_cast<int32_t>(r0) >> 16);
    f2.d = MemoryInline::FlatReadFloat64((r5 + 1552));
    r0 = (r0 * 116);
    f0.d = MemoryInline::FlatReadFloat32((r4 + 1520));
    r3 = (r7 + r0);
...
// RECOMP_REGISTRATION base 0x806DF9CC func_806DF9CC preserves=true fpr_mask=0x00000000
