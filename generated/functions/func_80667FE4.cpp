...
extern "C" void func_80667FE4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80667FE4:
{
    ...
    ctx->gpr[31] = r31;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x805EE958u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80667FE4 func_80667FE4 preserves=true fpr_mask=0x00000000
