...
extern "C" void func_800C5420(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800C5448:
{
    r31 = MemoryInline::FlatRead32((r30 + 36));
    ctx->lr = 0x800C5450u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x800C5420 func_800C5420 preserves=true fpr_mask=0x00000000
