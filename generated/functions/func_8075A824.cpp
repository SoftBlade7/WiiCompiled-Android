...
extern "C" void func_8075A824(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8075A824:
{
    ...
    r3 = 1;
    r0 = 0;
    MemoryInline::FlatWrite8((r31 + 325), static_cast<uint8_t>(r3));
...
// RECOMP_REGISTRATION base 0x8075A824 func_8075A824 preserves=true fpr_mask=0x00000000
