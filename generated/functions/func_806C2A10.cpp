...
extern "C" void func_806C2A10(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806C2A10:
{
    ...
    r4 = (r1 + 12);
    r7 = 0;
    r0 = MemoryInline::FlatRead32((r5 + -2456));
    r5 = (r1 + 8);
...
// RECOMP_REGISTRATION base 0x806C2A10 func_806C2A10 preserves=true fpr_mask=0x00000000
