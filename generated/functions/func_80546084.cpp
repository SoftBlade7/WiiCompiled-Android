...
extern "C" void func_80546084(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r3 = (r3 + 65536);
    MemoryInline::FlatWrite32((r3 + -27980), r0);
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[5] = r5;
    ctx->cr = cr;
...
// RECOMP_REGISTRATION base 0x80546084 func_80546084 preserves=true fpr_mask=0x00000000
