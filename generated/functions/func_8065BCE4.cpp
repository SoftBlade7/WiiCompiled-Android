...
extern "C" void func_8065BCE4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8065BD34:
{
    ...
    r3 = PPC_Slw(static_cast<uint32_t>(r31), static_cast<uint32_t>(r4));
...
loc_8065BD60:
{
    ...
    r3 = (r3_rot_2 & 1020);
    r4 = (r6 + r0);
    r0 = MemoryInline::FlatRead32((r4 + 10168));
    r0 = (r0 * 48);
    r0 = (r6 + r0);
    r3 = (r3 + r0);
...
loc_8065BDA0:
{
    ...
    r24 = (r24 + 1);
    r3 = (r0 & 31);
    MemoryInline::FlatWrite8((r25 + 26), static_cast<uint8_t>(r3));
}
...
loc_8065BDB4:
{
    ...
    r0 = (r0_rot_4 & 7);
    MemoryInline::FlatWrite8((r25 + 27), static_cast<uint8_t>(r0));
...
loc_8065BDC0:
{
    MemoryInline::FlatWrite8((r25 + 28), static_cast<uint8_t>(r26));
    goto loc_8065BDE4;
}

loc_8065BDC8:
{
    r4 = MemoryInline::FlatRead8((r25 + 27));
...
loc_8065BDDC:
{
    ...
    ctx->gpr[4] = r4;
    ctx->cr = cr;
    InvokeDirectCpu<0x8079D76Cu>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    cr = ctx->cr;
...
loc_8065BDE4:
{
    r5 = MemoryInline::FlatRead8((r25 + 28));
...
loc_8065BE10:
{
    if ((static_cast<uint32_t>(r22) < static_cast<uint32_t>(24))) {
        goto loc_8065BDA0;
    }
}
...
// RECOMP_GUEST_ABI gpr_read=0xFFC0007B gpr_write=0xFFC0007B gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x8065BCE4 func_8065BCE4 preserves=true fpr_mask=0x00000000
