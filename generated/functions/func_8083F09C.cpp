...
extern "C" void func_8083F09C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8083F09C:
{
    ...
    r5 = (r5 ^ -2147483648);
    r0 = (r3 + r0);
    f5.d = MemoryInline::FlatReadFloat64((r8 + -12368));
    ...
    f4.d = MemoryInline::FlatReadFloat32((r7 + -12356));
...
// RECOMP_REGISTRATION base 0x8083F09C func_8083F09C preserves=true fpr_mask=0x00000000
