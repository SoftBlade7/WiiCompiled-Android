...
extern "C" void func_8019F9BC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_8019FB80:
{
    ...
    r6 = (r6_rot_0 & 15);
    r4 = (r3 * 10);
    r5_rot_5 = PpcRotl32Inline(static_cast<uint32_t>(r30), static_cast<uint32_t>(20));
    r5 = (r5_rot_5 & 15);
    r0 = (r30 & 15);
...
// RECOMP_REGISTRATION base 0x8019F9BC func_8019F9BC preserves=true fpr_mask=0x00000000
