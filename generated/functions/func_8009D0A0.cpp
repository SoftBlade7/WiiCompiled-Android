...
extern "C" void func_8009D0A0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8009D130:
{
    ...
    ctx->fpr[1] = f1;
    ctx->cr = cr;
    InvokeDirectCpu<0x8009C660u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8009D194:
{
    ...
    ctx->fpr[1] = f1;
    ctx->cr = cr;
    InvokeDirectCpu<0x8009C790u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
...
loc_8009D1D8:
{
    ...
    ctx->fpr[1] = f1;
    ctx->cr = cr;
    InvokeDirectCpu<0x8009C8F0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
...
loc_8009D1F8:
{
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r27), static_cast<uint32_t>(r18));
}
...
// RECOMP_REGISTRATION base 0x8009D0A0 func_8009D0A0 preserves=true fpr_mask=0x00000000
