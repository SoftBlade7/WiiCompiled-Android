...
extern "C" void func_800E8654(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_800E86BC:
{
    ...
    r3 = MemoryInline::FlatRead16((r3 + 2064));
    r6 = (r3 + -8);
...
loc_800E86F4:
{
    ...
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r13 + -26856));
    r12 = MemoryInline::FlatRead32((r3 + 2048));
...
// RECOMP_REGISTRATION base 0x800E8654 func_800E8654 preserves=true fpr_mask=0x00000000
