...
extern "C" void func_80129D0C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80129D80:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r27 + 76), r31);
}
...
loc_80129DA8:
{
    r3 = MemoryInline::FlatRead32((r27 + 172));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(0));
}
...
loc_80129DB4:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r27 + 172), r31);
}
...
loc_80129DE0:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r30 + 228), r31);
}
...
// RECOMP_REGISTRATION base 0x80129D0C func_80129D0C preserves=true fpr_mask=0x00000000
