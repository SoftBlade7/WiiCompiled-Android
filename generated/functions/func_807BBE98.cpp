...
extern "C" void func_807BBE98(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807BBEBC:
{
    ...
    if (MkwStateFreeAbiEnabled(0x80550730u) && KnownTranslatedCpuCall<0x80550730u>::kAvailable && !KnownTranslatedCpuCall<0x80550730u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80550730u>()) {
        const auto state_free_result_80550730_561 = func_80550730_statefree();
        r3 = static_cast<uint32_t>(state_free_result_80550730_561);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x807BBE98 func_807BBE98 preserves=true fpr_mask=0x00000000
