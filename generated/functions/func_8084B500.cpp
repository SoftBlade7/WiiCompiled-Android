...
extern "C" void func_8084B500(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8084B538:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r31 = MemoryInline::FlatRead32((r28 + 576));
    r3 = 0x809C0000u;
...
loc_8084B5D4:
{
    r4 = (r3 + 65536);
    r3 = 0x809C0000u;
    MemoryInline::FlatWrite32((r4 + -28380), r0);
    r3 = MemoryInline::FlatRead32((r3 + 7736));
...
loc_8084B60C:
{
    ...
    r3 = (r5 + r3);
    MemoryInline::FlatWrite32((r3 + 356), r6);
...
loc_8084B64C:
{
    ...
    if (MkwStateFreeAbiEnabled(0x80860484u) && KnownTranslatedCpuCall<0x80860484u>::kAvailable && !KnownTranslatedCpuCall<0x80860484u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80860484u>()) {
        const auto state_free_result_80860484_2C77 = func_80860484_statefree_v0(r3, xer);
        r0 = static_cast<uint32_t>(state_free_result_80860484_2C77[0]);
        r3 = static_cast<uint32_t>(state_free_result_80860484_2C77[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_8084B668:
{
    r4 = MemoryInline::FlatRead32((r27 + 1740));
...
{
    r0 = -1;
    MemoryInline::FlatWrite32((r27 + 1000), r0);
    r3 = r28;
    ctx->lr = 0x8084B684u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x8084B500 func_8084B500 preserves=true fpr_mask=0x00000000
