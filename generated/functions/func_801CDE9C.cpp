...
extern "C" void func_801CDE9C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801CDE9C:
{
    ...
    r0 = 1;
    r29 = 0x80350000u;
    MemoryInline::FlatWrite32((r13 + -24468), r0);
    r29 = (r29 + 16608);
    r30 = 0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x801CDE9C func_801CDE9C preserves=true fpr_mask=0x00000000
