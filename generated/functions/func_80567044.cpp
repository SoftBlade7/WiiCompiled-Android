...
extern "C" void func_80567044(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80567044:
{
    ...
    ctx->gpr[5] = r5;
    ctx->fpr[0] = f0;
    InvokeDirectCpu<0x805670B4u>(ctx);
    f0 = ctx->fpr[0];
...
// RECOMP_REGISTRATION base 0x80567044 func_80567044 preserves=true fpr_mask=0x00000000
