...
extern "C" void func_805E78F0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805E78F0:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r31 = MemoryInline::FlatRead32((r21 + 20));
    r30 = (r21 + 20);
    r22 = 0x808C0000u;
    r23 = 0x808C0000u;
    r24 = 0x808C0000u;
...
loc_805E79D0:
{
    ...
    xer = ctx->xer;
    r26 = (r26 + 20);
    r27 = MemoryInline::FlatRead32(r26);
    goto loc_805E7A38;
}
...
// RECOMP_REGISTRATION base 0x805E78F0 func_805E78F0 preserves=true fpr_mask=0x00000000
