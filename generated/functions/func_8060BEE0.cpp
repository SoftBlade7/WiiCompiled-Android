...
extern "C" void func_8060BEE0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r0 = 0;
    MemoryInline::FlatWrite32((r3 + 1140), r0);
    goto loc_8060BF3C;
}
...
// RECOMP_REGISTRATION base 0x8060BEE0 func_8060BEE0 preserves=true fpr_mask=0x00000000
