...
extern "C" void func_8016B2C0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80193E88u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->cr = cr;
...
// RECOMP_REGISTRATION base 0x8016B2C0 func_8016B2C0 preserves=true fpr_mask=0x00000000
