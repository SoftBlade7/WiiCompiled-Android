...
extern "C" void func_8012409C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
{
    r3 = -855638016;
    r0 = MemoryInline::FlatRead32((r3 + 27648));
...
// RECOMP_REGISTRATION base 0x8012409C func_8012409C preserves=true fpr_mask=0x00000000
