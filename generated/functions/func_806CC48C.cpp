...
extern "C" void func_806CC48C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806CC48C:
{
    ...
    r4 = MemoryInline::FlatRead32((r3 + 216));
    r31 = 0x808C0000u;
    r28 = 0x808A0000u;
    r30 = r3;
    r0 = MemoryInline::FlatRead8((r4 + 218));
    r31 = (r31 + 17160);
    r28 = (r28 + -1560);
}
...
loc_806CC4D4:
{
    ...
    r0 = MemoryInline::FlatRead8((r26 + 210));
...
loc_806CC4E8:
{
    ...
    xer = ctx->xer;
    r29 = 0;
    MemoryInline::FlatWrite32((r26 + 196), r29);
    ...
    f2 = ctx->fpr[2];
    cr = ctx->cr;
    MemoryInline::FlatWrite32((r26 + 200), r3);
    f0.d = MemoryInline::FlatReadFloat32((r26 + 52));
    MemoryInline::FlatWriteFloat32((r26 + 204), f0.d);
    MemoryInline::FlatWrite8((r26 + 208), static_cast<uint8_t>(r29));
}

loc_806CC52C:
{
    f31.d = MemoryInline::FlatReadFloat64((r28 + 96));
    r27 = 0;
    r26 = 0;
    r29 = 1127219200;
    goto loc_806CC5BC;
...
loc_806CC62C:
{
    r0 = MemoryInline::FlatRead8((r30 + 314));
}
...
loc_806CC638:
{
    MemoryInline::FlatWrite16((r6 + 220), static_cast<uint16_t>(r4));
    r0 = MemoryInline::FlatRead8((r31 + 20));
    MemoryInline::FlatWrite8((r6 + 212), static_cast<uint8_t>(r0));
    MemoryInline::FlatWrite8((r6 + 213), static_cast<uint8_t>(r4));
    MemoryInline::FlatWrite8((r6 + 214), static_cast<uint8_t>(r4));
    MemoryInline::FlatWrite8((r6 + 215), static_cast<uint8_t>(r3));
}
...
{
    r0 = 0;
    MemoryInline::FlatWrite8((r30 + 314), static_cast<uint8_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x806CC48C func_806CC48C preserves=false fpr_mask=0xC0000000
