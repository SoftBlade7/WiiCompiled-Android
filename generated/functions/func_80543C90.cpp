...
extern "C" void func_80543C90(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80543CC0:
{
    ...
    r4 = MemoryInline::FlatRead32((r28 + 3188));
...
loc_80543CE8:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r29), static_cast<uint32_t>(100));
}
...
// RECOMP_REGISTRATION base 0x80543C90 func_80543C90 preserves=true fpr_mask=0x00000000
