...
extern "C" void func_805C87A8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805C87A8:
{
    ...
    r31 = ctx->gpr[31];
    r0 = -1;
    MemoryInline::FlatWrite32((r31 + 3180), r0);
...
// RECOMP_REGISTRATION base 0x805C87A8 func_805C87A8 preserves=true fpr_mask=0x00000000
