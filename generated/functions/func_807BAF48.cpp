...
extern "C" void func_807BAF48(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lbzux_807BB054_loc_0 = 0;
    uint32_t addr_lbzux_807BB064_loc_0 = 0;
    uint32_t addr_lbzux_807BB14C_loc_0 = 0;
    uint32_t addr_lbzux_807BB258_loc_0 = 0;
    uint32_t addr_lbzux_807BB268_loc_0 = 0;
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
    uint32_t r0_rot_2 = 0;
...
loc_807BAF7C:
{
    ...
    r4 = 0x809C0000u;
    r3 = 0x809C0000u;
    r0 = MemoryInline::FlatRead8((r4 + 14520));
...
loc_807BAFC0:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x807BBB00u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_807BAFDC:
{
    ...
    r3 = MemoryInline::FlatRead32((r29 + -10440));
    r5 = (r30 + 15);
    r4 = 1;
    r6 = 0;
    ctx->lr = 0x807BB014u;
...
loc_807BB034:
{
    ...
    r0 = (r0 * r4);
    r7 = 0;
    addr_lbzux_807BB054_loc_0 = (r8 + r0);
    r4 = MemoryInline::FlatRead8(addr_lbzux_807BB054_loc_0);
    r8 = addr_lbzux_807BB054_loc_0;
    r0 = MemoryInline::FlatRead8((r8 + 1));
    r8 = (r8 + 2);
    r0 = (r0 * r4);
    addr_lbzux_807BB064_loc_0 = (r8 + r0);
    r4 = MemoryInline::FlatRead8(addr_lbzux_807BB064_loc_0);
    r8 = addr_lbzux_807BB064_loc_0;
    r0 = MemoryInline::FlatRead8((r8 + 1));
    r8 = (r8 + 2);
    r0 = (r0 * r4);
    r4 = (r8 + r0);
    ...
    if (MkwStateFreeAbiEnabled(0x80550730u) && KnownTranslatedCpuCall<0x80550730u>::kAvailable && !KnownTranslatedCpuCall<0x80550730u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80550730u>()) {
        const auto state_free_result_80550730_33A6 = func_80550730_statefree();
        r3 = static_cast<uint32_t>(state_free_result_80550730_33A6);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
{
    r3 = 0x809C0000u;
    r0 = MemoryInline::FlatRead8((r3 + 14522));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_807BB12C:
{
    ...
    r0 = (r0 * r4);
    r7 = 0;
    addr_lbzux_807BB14C_loc_0 = (r8 + r0);
    r4 = MemoryInline::FlatRead8(addr_lbzux_807BB14C_loc_0);
    r8 = addr_lbzux_807BB14C_loc_0;
    r0 = MemoryInline::FlatRead8((r8 + 1));
    r8 = (r8 + 2);
    r0 = (r0 * r4);
    r4 = (r8 + r0);
...
loc_807BB208:
{
    ...
    r0 = (r0 * r4);
    r7 = 1;
    addr_lbzux_807BB258_loc_0 = (r8 + r0);
    r4 = MemoryInline::FlatRead8(addr_lbzux_807BB258_loc_0);
    r8 = addr_lbzux_807BB258_loc_0;
    r0 = MemoryInline::FlatRead8((r8 + 1));
    r8 = (r8 + 2);
    r0 = (r0 * r4);
    addr_lbzux_807BB268_loc_0 = (r8 + r0);
    r4 = MemoryInline::FlatRead8(addr_lbzux_807BB268_loc_0);
    r8 = addr_lbzux_807BB268_loc_0;
    r0 = MemoryInline::FlatRead8((r8 + 1));
    r8 = (r8 + 2);
    r0 = (r0 * r4);
    r4 = (r8 + r0);
...
loc_807BB33C:
{
    if ((static_cast<int32_t>(r10) < static_cast<int32_t>(19))) {
        goto loc_807BB2C4;
    }
}
...
// RECOMP_REGISTRATION base 0x807BAF48 func_807BAF48 preserves=true fpr_mask=0x00000000
