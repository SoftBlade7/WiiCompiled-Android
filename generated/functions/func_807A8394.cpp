...
extern "C" void func_807A8394(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807A83C4:
{
    r29 = MemoryInline::FlatRead32((r28 + 68));
    r4 = 0;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite16((r29 + 14), static_cast<uint16_t>(r30));
    r28 = (r28 + 4);
    r27 = (r27 + 1);
...
// RECOMP_REGISTRATION base 0x807A8394 func_807A8394 preserves=true fpr_mask=0x00000000
