...
extern "C" void func_806DED74(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806DED74:
{
    ...
    r30 = r3;
    MemoryInline::FlatWrite32((r3 + 196), r31);
    MemoryInline::FlatWrite8((r3 + 200), static_cast<uint8_t>(r31));
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead8((r30 + 192));
    r0 = 10;
    MemoryInline::FlatWrite8((r30 + 201), static_cast<uint8_t>(r31));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(0));
}

loc_806DEDC0:
{
    MemoryInline::FlatWrite8((r30 + 202), static_cast<uint8_t>(r31));
...
loc_806DEDCC:
{
    ...
    r3 = 0x808A0000u;
    r5 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + 1344));
    r3 = MemoryInline::FlatRead32((r4 + 40));
    r4 = 0;
    f2.d = MemoryInline::FlatReadFloat32((r5 + 1372));
    ctx->lr = 0x806DEE04u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x806DED74 func_806DED74 preserves=true fpr_mask=0x00000000
