...
extern "C" void func_80874570(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80874578:
{
    r8 = 0x808E0000u;
    r7 = 0x808E0000u;
    f2.d = MemoryInline::FlatReadFloat32((r8 + -14836));
    f0.d = MemoryInline::FlatReadFloat32((r3 + 228));
    f1.d = MemoryInline::FlatReadFloat32((r7 + -14900));
...
loc_808745A0:
{
    r8 = MemoryInline::FlatRead32((r3 + 772));
    r7 = 0;
    ...
    r5 = (r3 + r0);
    MemoryInline::FlatWriteFloat32((r5 + 388), f2.d);
    MemoryInline::FlatWriteFloat32((r5 + 392), f1.d);
    MemoryInline::FlatWriteFloat32((r5 + 396), f0.d);
    r0 = MemoryInline::FlatRead32((r3 + 772));
    r0 = (r0 * 24);
    r5 = (r3 + r0);
    MemoryInline::FlatWrite8((r5 + 400), static_cast<uint8_t>(r7));
    r0 = MemoryInline::FlatRead32((r3 + 772));
    r0 = (r0 * 24);
    r5 = (r3 + r0);
    MemoryInline::FlatWrite32((r5 + 404), r7);
    r10 = MemoryInline::FlatRead32((r3 + 360));
    r0 = MemoryInline::FlatRead32((r3 + 348));
    r8 = (r10 + 1);
    r7 = MemoryInline::FlatRead32((r3 + 772));
    r5 = (r8 - r0);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(r8) >= static_cast<uint32_t>(r0) ? 1u : 0u) << 29);
...
loc_80874628:
{
    ...
    r0_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r10), static_cast<uint32_t>(4));
    r0 = (r0_rot_1 & -16);
...
loc_8087464C:
{
    MemoryInline::FlatWrite32((r3 + 360), r9);
    r0_rot_3 = PpcRotl32Inline(static_cast<uint32_t>(r9), static_cast<uint32_t>(4));
    r0 = (r0_rot_3 & -16);
    r5 = 1;
    r7_addr_2 = (r7 + r0);
...
loc_8087469C:
{
    r4 = MemoryInline::FlatRead32((r3 + 772));
    r5 = 1;
    r0 = (r4 + 1);
    r0 = (r0 & 15);
    MemoryInline::FlatWrite32((r3 + 772), r0);
    r0 = (r0 * 24);
    r4 = (r3 + r0);
    MemoryInline::FlatWrite8((r4 + 389), static_cast<uint8_t>(r5));
    r0 = MemoryInline::FlatRead32((r3 + 772));
    r0 = (r0 * 24);
    r4 = (r3 + r0);
    MemoryInline::FlatWrite8((r4 + 388), static_cast<uint8_t>(r6));
...
loc_80874700:
{
    ...
    r0_rot_8 = PpcRotl32Inline(static_cast<uint32_t>(r9), static_cast<uint32_t>(4));
    r0 = (r0_rot_8 & -16);
...
loc_80874724:
{
    ...
    r0_rot_10 = PpcRotl32Inline(static_cast<uint32_t>(r8), static_cast<uint32_t>(4));
    r0 = (r0_rot_10 & -16);
    r4 = 2;
    r5 = -1;
    r6_addr_2 = (r6 + r0);
...
// RECOMP_GUEST_ABI gpr_read=0x000007F9 gpr_write=0x000007F9 gpr_return=0x00000018 fpr_read=0x00000007 fpr_write=0x00000007 fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x80874570 func_80874570 preserves=true fpr_mask=0x00000000
