...
extern "C" void func_806C723C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806C723C:
{
    ...
    ctr = ctx->ctr;
    r31 = 0;
    MemoryInline::FlatWrite32((r30 + 196), r31);
    r3 = 0x808A0000u;
    r4 = 0x808C0000u;
    ...
    MemoryInline::FlatWrite8((r30 + 208), static_cast<uint8_t>(r31));
...
// RECOMP_REGISTRATION base 0x806C723C func_806C723C preserves=true fpr_mask=0x00000000
