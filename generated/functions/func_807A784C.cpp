...
extern "C" void func_807A784C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807A7874:
{
    r0 = MemoryInline::FlatRead32((r31 + 120));
    r3 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 22136));
    r0 = (r0 | 2048);
...
// RECOMP_REGISTRATION base 0x807A784C func_807A784C preserves=true fpr_mask=0x00000000
