...
extern "C" void func_806C818C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806C81B8:
{
    ...
    r4 = 0x808A0000u;
    r3 = r31;
    f1.d = MemoryInline::FlatReadFloat32((r4 + -1456));
    r4 = (r1 + 8);
...
loc_806C81E8:
{
    MemoryInline::FlatWrite32((r30 + 172), r31);
...
// RECOMP_REGISTRATION base 0x806C818C func_806C818C preserves=true fpr_mask=0x00000000
