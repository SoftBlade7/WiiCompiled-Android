...
extern "C" void func_80103F70(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80104000:
{
    ...
    r0 = MemoryInline::FlatRead32((r29 + 1464));
...
loc_80104020:
{
    ...
    MemoryInline::FlatWrite32((r29 + 416), r0);
}
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFEFFF gpr_write=0xFC0019FB gpr_return=0x00000018 fpr_read=0xFFFFFFFF fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x80103F70 func_80103F70 preserves=true fpr_mask=0x00000000
