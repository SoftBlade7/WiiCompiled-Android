...
extern "C" void func_806BBB80(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806BBB80:
{
    ...
    f31.d = MemoryInline::FlatReadFloat32((r30 + 356));
    r12 = MemoryInline::FlatRead32((r12 + 48));
    ctr = r12;
    ctx->lr = 0x806BBC00u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x806BBB80 func_806BBB80 preserves=false fpr_mask=0x80000000
