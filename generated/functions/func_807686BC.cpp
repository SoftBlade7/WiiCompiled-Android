...
extern "C" void func_807686BC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807686BC:
{
    ...
    r0 = 0;
    r7 = (r1 + 8);
    r8 = MemoryInline::FlatRead32((r4 + 15324));
    r4 = (r1 + 16);
...
// RECOMP_REGISTRATION base 0x807686BC func_807686BC preserves=true fpr_mask=0x00000000
