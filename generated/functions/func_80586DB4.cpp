...
extern "C" void func_80586DB4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80586DB4:
{
    ...
    r29 = r3;
    r0 = MemoryInline::FlatRead16((r3 + 580));
    r0 = (r0 << 16);
...
loc_80586E54:
{
    r0 = MemoryInline::FlatRead16((r3 + 22890));
    r0 = (r0 << 16);
    r0 = (static_cast<int32_t>(r0) >> 16);
    MemoryInline::FlatWrite16((r29 + 580), static_cast<uint16_t>(r0));
    if (((cr & 0x20000000u) != 0)) {
        goto loc_80586E6C;
    }
}
...
// RECOMP_GUEST_ABI gpr_read=0xE000007F gpr_write=0xE00000FB gpr_return=0x00000018 fpr_read=0x800003FF fpr_write=0x800003FF fpr_return=0x00000002 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80586DB4 func_80586DB4 preserves=false fpr_mask=0x80000000
