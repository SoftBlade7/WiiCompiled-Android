...
extern "C" void func_800D8E78(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800D9068:
{
    ...
    r0 = MemoryInline::FlatRead32((r5 + 1692));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(14));
}
...
loc_800D90B4:
{
    if ((static_cast<int32_t>(r29) != static_cast<int32_t>(6))) {
        goto loc_800D91D8;
    }
}
...
loc_800D90B8:
{
    r3 = MemoryInline::FlatRead8((r5 + 12));
    r0 = (r3 + 1);
...
loc_inl3_cont_800CCC68:
{
    ...
    r3 = MemoryInline::FlatRead32((r29 + 1920));
    r0 = (r4 + -2);
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r12 = MemoryInline::FlatRead32((r29 + 2160));
    r7 = r3;
    r5 = r28;
    r6 = r27;
    r8 = MemoryInline::FlatRead32((r29 + 2164));
    r3 = 6;
    r4 = 0;
    ctr = r12;
    ctx->lr = 0x800D9364u;
...
loc_800D936C:
{
    ...
    MemoryInline::FlatWriteRam32(r31, r30);
    r28 = r3;
    MemoryInline::FlatWriteRam8(r3, static_cast<uint8_t>(r27));
    r4 = MemoryInline::FlatRead32((r13 + -26868));
    r0 = MemoryInline::FlatRead32((r4 + 1692));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(14));
}
...
loc_800D93B0:
{
    r0 = MemoryInline::FlatRead8((r4 + 1718));
    MemoryInline::FlatWriteRam8((r3 + 1), static_cast<uint8_t>(r0));
    r4 = MemoryInline::FlatRead32((r13 + -26868));
...
// RECOMP_REGISTRATION base 0x800D8E78 func_800D8E78 preserves=true fpr_mask=0x00000000
