...
extern "C" void func_806AC618(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806AC618:
{
    ...
    r31 = r3;
    r4 = MemoryInline::FlatRead32((r3 + 596));
    r3 = (r4 + 116);
...
// RECOMP_REGISTRATION base 0x806AC618 func_806AC618 preserves=true fpr_mask=0x00000000
