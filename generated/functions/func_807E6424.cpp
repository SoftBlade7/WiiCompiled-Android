...
extern "C" void func_807E6424(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807E6424:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r28 + 5580), r3);
    r5 = (r27 + 80);
    r11 = (r27 + 160);
    r10 = (r27 + 240);
    MemoryInline::FlatWriteRam32(r3, r27);
    r9 = (r27 + 320);
    r8 = (r27 + 400);
    r7 = (r27 + 480);
    r3 = MemoryInline::FlatRead32((r28 + 5580));
    r6 = (r27 + 560);
    r0 = 0;
    r4 = r28;
    MemoryInline::FlatWrite32((r3 + 4), r5);
    r3 = (r1 + 80);
    r5 = MemoryInline::FlatRead32((r28 + 5580));
    ...
    MemoryInline::FlatWrite32((r28 + 5180), r0);
...
loc_807E650C:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r26 + 948), r25);
    r3 = (r25 + 1);
    r4 = 0;
    // inline leaf 0x8083381C (7 guest instruction(s))
}
...
loc_inl1_cont_8083381C:
{
    // end of inlined leaf 0x8083381C
    r4 = r3;
    r3 = r27;
    r5 = 0;
    ctx->lr = 0x807E6574u;
...
// RECOMP_REGISTRATION base 0x807E6424 func_807E6424 preserves=true fpr_mask=0x00000000
