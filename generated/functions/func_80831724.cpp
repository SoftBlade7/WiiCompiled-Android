...
extern "C" void func_80831724(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80831724:
{
    ...
    r3 = MemoryInline::FlatRead32((r3 + 1044));
    ctx->lr = 0x8083175Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r27 = 0;
    MemoryInline::FlatWrite32((r3 + 1044), r27);
    r3 = MemoryInline::FlatRead32((r28 + 4));
    r3 = MemoryInline::FlatRead32((r3 + 1084));
    ctx->lr = 0x80831774u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r28 + 4));
    MemoryInline::FlatWrite32((r3 + 1084), r27);
...
loc_80831788:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r28 + 80), r27);
}
...
loc_808317DC:
{
    r8 = 0x809C0000u;
    r6 = 0x80380000u;
    r7 = MemoryInline::FlatRead32((r8 + 6224));
    r4 = r27;
    r3 = 76;
    r5 = 4;
    MemoryInline::FlatWrite32((r7 + 16), r27);
    r7 = MemoryInline::FlatRead32((r8 + 6224));
    MemoryInline::FlatWrite32((r7 + 24), r0);
    MemoryInline::FlatWriteRam32((r6 + 28260), r0);
    ctx->lr = 0x80831808u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_80831824:
{
    ...
    r3 = (r1 + 16);
    MemoryInline::FlatWrite32((r4 + 1044), r0);
...
loc_80831848:
{
    ...
    r5 = r29;
    r3 = (r1 + 16);
    r4 = MemoryInline::FlatRead32((r4 + 1044));
    ctx->lr = 0x8083185Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_80831884:
{
    ...
    r5 = MemoryInline::FlatRead32((r5 + 1044));
    ctx->lr = 0x808318A0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_808318A4:
{
    r6 = 0x809C0000u;
    r5 = 0x80380000u;
    r7 = MemoryInline::FlatRead32((r6 + 6224));
    r3 = (r1 + 16);
    r4 = -1;
    r0 = MemoryInline::FlatRead32((r7 + 20));
    MemoryInline::FlatWrite32((r7 + 16), r0);
    r6 = MemoryInline::FlatRead32((r6 + 6224));
...
loc_80831900:
{
    ...
    r6 = MemoryInline::FlatRead32((r28 + 28));
...
loc_808319EC:
{
    ...
    MemoryInline::FlatWrite32((r28 + 28), r29);
    r3 = (r0 + r31);
    ...
    r3 = (r0 + r31);
    r3 = MemoryInline::FlatRead32((r3 + 4));
    r27 = MemoryInline::FlatRead32((r3 + 40));
...
// RECOMP_REGISTRATION base 0x80831724 func_80831724 preserves=true fpr_mask=0x00000000
