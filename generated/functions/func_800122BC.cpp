...
extern "C" void func_800122BC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800122BC:
{
    guest_range_0 = MemoryInline::ResolveRangeHost((r1 + 8), 0, 56u, true, false);
    r5 = MemoryInline::ReadResolved32(guest_range_0, 0u, (r1 + 8));
    r3 = (r3 + 1);
    r0 = MemoryInline::ReadResolved32(guest_range_0, 4u, (r1 + 12));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r5 = MemoryInline::ReadResolved32(guest_range_0, 16u, (r1 + 24));
            r0 = MemoryInline::ReadResolved32(guest_range_0, 20u, (r1 + 28));
        }
    }
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r5 = MemoryInline::ReadResolved32(guest_range_0, 24u, (r1 + 32));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r5 = MemoryInline::ReadResolved32(guest_range_0, 32u, (r1 + 40));
            r0 = MemoryInline::ReadResolved32(guest_range_0, 36u, (r1 + 44));
        }
    }
...
// RECOMP_REGISTRATION base 0x800122BC func_800122BC preserves=true fpr_mask=0x00000000
