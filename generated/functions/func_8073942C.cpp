...
extern "C" void func_8073942C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_807394B8:
{
    ...
    // inline leaf 0x8073C390 (1 guest instruction(s))
    // end of inlined leaf 0x8073C390
...
loc_807394E0:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80727CA4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8073942C func_8073942C preserves=true fpr_mask=0x00000000
