...
extern "C" void func_80521844(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805218C0:
{
    ...
    r29 = 8;
    MemoryInline::FlatWrite32((r26 + 144), r31);
    r30 = 0;
    r28 = r31;
    MemoryInline::FlatWrite8((r26 + 81), static_cast<uint8_t>(r27));
}

loc_805218D8:
{
    r3 = MemoryInline::FlatRead32((r26 + 148));
    r12 = MemoryInline::FlatRead32(r3);
    ...
    r30 = (r30 + 1);
    r5 = MemoryInline::FlatRead32((r26 + 148));
    r0 = (r31 + r29);
    r3 = (r4 * r3);
...
// RECOMP_REGISTRATION base 0x80521844 func_80521844 preserves=true fpr_mask=0x00000000
