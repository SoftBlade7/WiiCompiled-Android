...
extern "C" void func_806AC73C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806AC784:
{
    r31 = MemoryInline::FlatRead32((r3 + 604));
...
// RECOMP_REGISTRATION base 0x806AC73C func_806AC73C preserves=true fpr_mask=0x00000000
