...
extern "C" void func_801529D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r3 = 589824;
    r6 = MemoryInline::FlatRead8((r28 + 108));
    r5 = r29;
    r4 = (r31 + 112);
    r3 = (r3 + 3);
    ctx->lr = 0x801529FCu;
...
// RECOMP_REGISTRATION base 0x801529D0 func_801529D0 preserves=true fpr_mask=0x00000000
