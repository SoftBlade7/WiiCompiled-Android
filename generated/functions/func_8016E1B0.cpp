...
extern "C" void func_8016E1B0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
    uint32_t r0_rot_2 = 0;
...
loc_8016E1B0:
{
    ...
    r0 = MemoryInline::FlatRead32((r3 + 60));
    r0_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(19));
    r0 = (r0_rot_2 & 31);
...
// RECOMP_REGISTRATION base 0x8016E1B0 func_8016E1B0 preserves=true fpr_mask=0x00000000
