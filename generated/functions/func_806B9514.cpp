...
extern "C" void func_806B9514(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806B954C:
{
    r3 = MemoryInline::FlatRead32((r29 + 8656));
...
loc_806B9564:
{
    r3 = MemoryInline::FlatRead32((r27 + 176));
    r3_addr_5 = (r3 + r28);
    MemoryInline::FlatWrite8(r3_addr_5, static_cast<uint8_t>(r30));
    r28 = (r28 + 1);
}
...
// RECOMP_REGISTRATION base 0x806B9514 func_806B9514 preserves=true fpr_mask=0x00000000
