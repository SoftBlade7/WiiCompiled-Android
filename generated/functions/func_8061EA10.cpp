...
extern "C" void func_8061EA10(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8061EAA0:
{
    ...
    r3 = MemoryInline::FlatRead32((r3 + 964));
...
// RECOMP_REGISTRATION base 0x8061EA10 func_8061EA10 preserves=true fpr_mask=0x00000000
