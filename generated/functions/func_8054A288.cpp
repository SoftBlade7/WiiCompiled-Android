...
extern "C" void func_8054A288(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8054A288:
{
    ...
    r30 = MemoryInline::FlatRead32((r4 + -10424));
    r4 = (r3 + 32764);
    ...
    r5 = (r4 + -32768);
    r6 = 0;
    r3 = MemoryInline::FlatRead32((r31 + -10464));
    r7 = 1;
...
// RECOMP_REGISTRATION base 0x8054A288 func_8054A288 preserves=true fpr_mask=0x00000000
