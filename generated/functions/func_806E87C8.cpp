...
extern "C" MkwStateFreeResult2 func_80590100_statefree(uint32_t, uint32_t);
extern "C" uint64_t func_8059020C_statefree(uint32_t);

extern "C" void func_806E87C8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806E87C8:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r27 + 1252));
    ...
    f0.d = MemoryInline::FlatReadFloat32((r27 + 1252));
    r3 = (r1 + 56);
    f3.d = MemoryInline::FlatReadFloat32((r27 + 1096));
    r4 = (r1 + 68);
    f2.d = MemoryInline::FlatReadFloat32((r27 + 1092));
    ...
    f31 = ctx->fpr[31];
    cr = ctx->cr;
    f1.d = MemoryInline::FlatReadFloat32((r27 + 1084));
    r3 = (r1 + 32);
    r4 = (r1 + 44);
    ...
    r3 = (r1 + 8);
    MemoryInline::FlatWriteFloat32((r27 + 1184), f0.d);
    r4 = (r27 + 1184);
    r5 = (r27 + 48);
    f0.d = MemoryInline::FlatReadFloat32((r1 + 24));
    MemoryInline::FlatWriteFloat32((r27 + 1188), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r1 + 28));
    MemoryInline::FlatWriteFloat32((r27 + 1192), f0.d);
    // inline leaf 0x8051486C (13 guest instruction(s))
    f1.d = MemoryInline::FlatReadFloat32((r4 + 8));
    f0.d = MemoryInline::FlatReadFloat32((r5 + 8));
    f3.d = MemoryInline::FlatReadFloat32((r4 + 4));
    ...
    r3 = (r27 + 1196);
    MemoryInline::FlatWriteFloat32((r27 + 1196), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r29 + 4));
    f1.d = MemoryInline::FlatReadFloat32((r1 + 12));
    MemoryInline::FlatWriteFloat32((r27 + 1200), f1.d);
    f1.d = MemoryInline::FlatReadFloat32((r1 + 16));
    MemoryInline::FlatWriteFloat32((r27 + 1204), f1.d);
    MemoryInline::FlatWriteFloat32((r27 + 1200), f0.d);
    ctx->lr = 0x806E88D0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_806E88E4:
{
    ...
    r4 = r28;
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x80590100u) && KnownTranslatedCpuCall<0x80590100u>::kAvailable && !KnownTranslatedCpuCall<0x80590100u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80590100u>()) {
        const auto state_free_result_80590100_27D2 = func_80590100_statefree(r3, r4);
        r0 = static_cast<uint32_t>(state_free_result_80590100_27D2[0]);
        r3 = static_cast<uint32_t>(state_free_result_80590100_27D2[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
        ...
        ctx->fpr[31] = f31;
        ctx->cr = cr;
        InvokeDirectCpu<0x80590100u>(ctx);
        r0 = ctx->gpr[0];
        r1 = ctx->gpr[1];
        r3 = ctx->gpr[3];
        r4 = ctx->gpr[4];
    ...
    if (MkwStateFreeAbiEnabled(0x8059020Cu) && KnownTranslatedCpuCall<0x8059020Cu>::kAvailable && !KnownTranslatedCpuCall<0x8059020Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x8059020Cu>()) {
        const auto state_free_result_8059020C_2DED = func_8059020C_statefree(r3);
        r3 = static_cast<uint32_t>(state_free_result_8059020C_2DED);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    f0.d = MemoryInline::FlatReadFloat32((r27 + 1184));
    f2.d = MemoryInline::FlatReadFloat32((r3 + 8));
    f1.d = MemoryInline::FlatReadFloat32((r27 + 1192));
    f3.d = static_cast<double>(PpcForceSingleValueInline(f3.d - f0.d));
    f0.d = MemoryInline::FlatReadFloat32((r27 + 1080));
...
loc_806E892C:
{
    MemoryInline::FlatWrite32((r27 + 1232), r28);
    goto loc_806E894C;
}

loc_806E8934:
{
    MemoryInline::FlatWrite32((r27 + 1232), r30);
    r28 = (r28 + 1);
}
...
// RECOMP_GUEST_ABI gpr_read=0xF800001E gpr_write=0xF8000FFB gpr_return=0x00000018 fpr_read=0xC000000F fpr_write=0xC0003FFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x806E87C8 func_806E87C8 preserves=false fpr_mask=0x80000000
