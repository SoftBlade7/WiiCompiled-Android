...
extern "C" void func_80138A90(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80138AC0:
{
    ...
    r8 = MemoryInline::FlatRead8((r29 + 3));
    r9 = MemoryInline::FlatRead8((r29 + 4));
    r10 = MemoryInline::FlatRead8((r29 + 5));
    ctx->lr = 0x80138AECu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80138A90 func_80138A90 preserves=true fpr_mask=0x00000000
