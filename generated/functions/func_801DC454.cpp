...
extern "C" void func_801DC454(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801DC454:
{
    ...
    r0 = (r3 + 4864);
    MemoryInline::FlatWrite32((r13 + -24392), r0);
    ctx->lr = 0x801DC47Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801DC4CCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x801DC454 func_801DC454 preserves=true fpr_mask=0x00000000
