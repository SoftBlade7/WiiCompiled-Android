...
extern "C" void func_8001D17C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8001D1EC:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r30), static_cast<int32_t>(768));
}
...
// RECOMP_REGISTRATION base 0x8001D17C func_8001D17C preserves=true fpr_mask=0x00000000
