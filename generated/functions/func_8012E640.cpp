...
extern "C" void func_8012E640(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8012E640:
{
    // sync @ 0x8012E640 (no-op)
    // mfspr 921 unsupported @ 0x8012E644
    r3 = PPC_ReadSpr(921);
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8012E640 func_8012E640 preserves=true fpr_mask=0x00000000
