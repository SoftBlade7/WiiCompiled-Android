...
extern "C" void func_80153364(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r4 = 0x80280000u;
    r5 = MemoryInline::FlatRead8((r30 + 104));
    r6 = r31;
    r3 = 589824;
    r4 = (r4 + 29508);
    ctx->lr = 0x80153390u;
...
// RECOMP_REGISTRATION base 0x80153364 func_80153364 preserves=true fpr_mask=0x00000000
