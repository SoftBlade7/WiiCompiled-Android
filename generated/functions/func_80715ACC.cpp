...
extern "C" void func_80715ACC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80715B08:
{
    ...
    if (MkwStateFreeAbiEnabled(0x80631EF8u) && KnownTranslatedCpuCall<0x80631EF8u>::kAvailable && !KnownTranslatedCpuCall<0x80631EF8u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80631EF8u>()) {
        const auto state_free_result_80631EF8_6B6 = func_80631EF8_statefree(r3, cr, xer);
        r3 = static_cast<uint32_t>(state_free_result_80631EF8_6B6[0]);
        cr = static_cast<uint32_t>(state_free_result_80631EF8_6B6[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80715ACC func_80715ACC preserves=true fpr_mask=0x00000000
