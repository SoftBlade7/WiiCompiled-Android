...
extern "C" void func_80183B28(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80183B4C:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead32((r30 + 88));
...
// RECOMP_REGISTRATION base 0x80183B28 func_80183B28 preserves=true fpr_mask=0x00000000
