...
extern "C" void func_800A0910(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800A0910:
{
    ...
    r29 = r7;
    r30 = r8;
    // inline leaf 0x800A4450 (2 guest instruction(s))
    r3 = MemoryInline::FlatRead8((r13 + -27128));
    // end of inlined leaf 0x800A4450
...
loc_800A0950:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800A0CE0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800A09C8:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800A4C50u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x800A0910 func_800A0910 preserves=true fpr_mask=0x00000000
