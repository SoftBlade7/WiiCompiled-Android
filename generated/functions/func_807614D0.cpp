...
extern "C" void func_807614D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807614D0:
{
    ...
    r4 = 2;
    r5 = 0;
    MemoryInline::FlatWrite32((r24 + 176), r6);
...
loc_8076159C:
{
    MemoryInline::FlatWriteRam32((r28 + 260), r3);
    r4 = (r29 + 220);
    ...
    r3 = (r3 & 65535);
    r0 = (r3 + 1);
    MemoryInline::FlatWriteRam32((r28 + 264), r0);
    MemoryInline::FlatWriteRam32((r28 + 184), r21);
    MemoryInline::FlatWriteRam32((r28 + 268), r22);
    MemoryInline::FlatWriteRam32(r28, r23);
    MemoryInline::FlatWriteRam32((r28 + 292), r24);
}
...
{
    r0 = 1;
    MemoryInline::FlatWrite8((r24 + 208), static_cast<uint8_t>(r0));
    r3 = MemoryInline::FlatRead32((r24 + 160));
    r3 = MemoryInline::FlatRead32(r3);
    r0 = MemoryInline::FlatRead16((r3 + 46));
    r0 = (r0 << 16);
    r0 = (static_cast<int32_t>(r0) >> 16);
    MemoryInline::FlatWrite32((r24 + 204), r0);
    goto loc_807616B0;
}
...
// RECOMP_REGISTRATION base 0x807614D0 func_807614D0 preserves=true fpr_mask=0x00000000
