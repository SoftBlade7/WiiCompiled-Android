...
extern "C" void func_806A36C8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806A36C8:
{
    ...
    r30 = r3;
    r31 = MemoryInline::FlatRead32((r3 + 1556));
...
loc_806A3740:
{
    r31 = MemoryInline::FlatRead32((r30 + 1556));
...
// RECOMP_REGISTRATION base 0x806A36C8 func_806A36C8 preserves=true fpr_mask=0x00000000
