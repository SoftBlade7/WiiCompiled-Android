...
extern "C" void func_80175EC4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r3_rot_0 = 0;
...
loc_80176908:
{
    r0 = (r4 * 104);
    r3 = (r3 + r0);
    r3 = MemoryInline::FlatRead8((r3 + 98));
    r0 = (0 - r3);
    r0 = (r0 | r3);
...
// RECOMP_REGISTRATION base 0x80175EC4 func_80175EC4 preserves=true fpr_mask=0x00000000
