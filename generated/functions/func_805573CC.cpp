...
extern "C" void func_805573CC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805574A8:
{
    ...
    r29_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r30), static_cast<uint32_t>(2));
    r29 = (r29_rot_0 & -4);
...
// RECOMP_REGISTRATION base 0x805573CC func_805573CC preserves=false fpr_mask=0xC0000000
