...
extern "C" void func_807002BC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807002BC:
{
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 140u, ((static_cast<uint64_t>(static_cast<uint32_t>(r19)) << 32) | static_cast<uint32_t>(r20)))) {
        MemoryInline::WriteResolved32(guest_range_0, 140u, (r1 + 140), r19);
        MemoryInline::WriteResolved32(guest_range_0, 144u, (r1 + 144), r20);
    }
...
loc_807002F0:
{
    ...
    r5 = -1;
    r27 = MemoryInline::FlatRead8((r3 + 4));
    r0 = 0;
    r4 = r3;
...
loc_80700340:
{
    MemoryInline::FlatWriteRam8((r30 + 31472), static_cast<uint8_t>(r29));
    if (((cr & 0x20000000u) != 0)) {
        goto loc_807003DC;
    }
}
...
loc_80700348:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x806FF17Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80700360:
{
    r3 = MemoryInline::FlatRead32((r31 + 10392));
    r4 = r28;
    r5 = MemoryInline::FlatRead32((r19 + 9040));
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r21 = MemoryInline::FlatRead32((r19 + 9040));
    r20 = r3;
    r22 = (r21 + 8);
    r3 = r22;
    ctx->lr = 0x8070038Cu;
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80092810u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_807003A8:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8009DEF0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_807003DC:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x806FF8A4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_807003E4:
{
    MemoryInline::FlatWriteRam8((r30 + 31472), static_cast<uint8_t>(r24));
    r3 = (r25 + 9856);
    r4 = 0;
    // inline leaf 0x800AF180 (8 guest instruction(s))
}
...
loc_80700404:
{
    ...
    MemoryInline::FlatWrite8((r3 + 4), static_cast<uint8_t>(r29));
    r3 = (r25 + 9856);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_8070042C:
{
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 140), 0, 60u, true, false);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r19 = MemoryInline::ReadResolved32(guest_range_1, 0u, (r1 + 140));
            r20 = MemoryInline::ReadResolved32(guest_range_1, 4u, (r1 + 144));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r21 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r1 + 148));
            r22 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r1 + 152));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r23 = MemoryInline::ReadResolved32(guest_range_1, 16u, (r1 + 156));
            r24 = MemoryInline::ReadResolved32(guest_range_1, 20u, (r1 + 160));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r25 = MemoryInline::ReadResolved32(guest_range_1, 24u, (r1 + 164));
            r26 = MemoryInline::ReadResolved32(guest_range_1, 28u, (r1 + 168));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r27 = MemoryInline::ReadResolved32(guest_range_1, 32u, (r1 + 172));
            r28 = MemoryInline::ReadResolved32(guest_range_1, 36u, (r1 + 176));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r29 = MemoryInline::ReadResolved32(guest_range_1, 40u, (r1 + 180));
            r30 = MemoryInline::ReadResolved32(guest_range_1, 44u, (r1 + 184));
        }
    }
    r31 = MemoryInline::ReadResolved32(guest_range_1, 48u, (r1 + 188));
    r0 = MemoryInline::ReadResolved32(guest_range_1, 56u, (r1 + 196));
    ctx->lr = r0;
    r1 = (r1 + 192);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x807002BC func_807002BC preserves=true fpr_mask=0x00000000
