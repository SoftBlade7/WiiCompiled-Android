...
extern "C" void func_8021C564(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8021C564:
{
    r3 = (r3 + -8);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x8021C53Cu>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8021C564 func_8021C564 preserves=true fpr_mask=0x00000000
