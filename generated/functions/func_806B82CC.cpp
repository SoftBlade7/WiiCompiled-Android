...
extern "C" void func_806B82CC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr6_0 = 0;
    uint32_t cr7_0 = 0;
...
loc_806B83F4:
{
    ...
    ctx->fpr[3] = f3;
    ctx->fpr[31] = f31;
    InvokeDirectCpu<0x806B8E54u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    f0.d = MemoryInline::FlatReadFloat32((r3 + 8704));
...
loc_806B84D0:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x806B89A8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x806B82CC func_806B82CC preserves=false fpr_mask=0x80000000
