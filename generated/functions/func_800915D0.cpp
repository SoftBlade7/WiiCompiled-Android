...
extern "C" void func_800915D0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800915D0:
{
    r3 = MemoryInline::FlatRead8((r3 + 108));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x800915D0 func_800915D0 preserves=true fpr_mask=0x00000000
