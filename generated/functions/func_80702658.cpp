...
extern "C" void func_80702658(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r3 = (r3 + -148);
    // inline leaf 0x80701768 (5 guest instruction(s))
    r0 = MemoryInline::FlatRead32((r3 + 96));
    r0 = (r0 & -16);
    r0 = (r0 | r4);
    MemoryInline::FlatWrite32((r3 + 96), r0);
    // end of inlined leaf 0x80701768
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80702658 func_80702658 preserves=true fpr_mask=0x00000000
