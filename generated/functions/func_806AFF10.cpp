...
extern "C" void func_806AFF10(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806AFF3C:
{
    r0 = MemoryInline::FlatRead32((r3 + 840));
...
loc_806AFF50:
{
    r0 = MemoryInline::FlatRead32((r3 + 816));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_806B0000:
{
    r3 = MemoryInline::FlatRead32((r3 + 816));
    r12 = MemoryInline::FlatRead32(r3);
    r12 = MemoryInline::FlatRead32((r12 + 20));
    ctr = r12;
    ctx->lr = 0x806B0014u;
...
// RECOMP_REGISTRATION base 0x806AFF10 func_806AFF10 preserves=true fpr_mask=0x00000000
