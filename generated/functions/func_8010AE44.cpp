...
extern "C" void func_8010AE44(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8010B054:
{
    ...
    r3 = r31;
    r29 = MemoryInline::FlatRead32((r31 + 60));
    r6 = (r1 + 8);
    r0 = MemoryInline::FlatRead32((r4 + 68));
    r4 = 3;
    r30 = MemoryInline::FlatRead32((r31 + 56));
    r5 = (r29 + r0);
    r5 = (r5 + 39);
    ctx->lr = 0x8010B088u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x8010AE44 func_8010AE44 preserves=true fpr_mask=0x00000000
