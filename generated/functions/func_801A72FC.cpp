...
extern "C" void func_801A72FC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801A72FC:
{
    ...
    // end of inlined leaf 0x801A98A0
    r0 = 0;
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 16u, ((static_cast<uint64_t>(static_cast<uint32_t>(r30)) << 32) | static_cast<uint32_t>(r31)))) {
        MemoryInline::WriteResolved32(guest_range_0, 16u, (r29 + 16), r30);
        MemoryInline::WriteResolved32(guest_range_0, 20u, (r29 + 20), r31);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_0, 24u, (r29 + 24), r0);
...
// RECOMP_GUEST_ABI gpr_read=0xE000003A gpr_write=0xE000000B gpr_return=0x00000008 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x00 cr_write=0x00 xer_read=0 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x801A72FC func_801A72FC preserves=true fpr_mask=0x00000000
