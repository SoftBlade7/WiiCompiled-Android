...
extern "C" void func_8076AFA8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8076B044:
{
    r0 = 0;
    r3 = 1;
    MemoryInline::FlatWrite32((r28 + 184), r3);
    MemoryInline::FlatWrite32((r28 + 208), r0);
    MemoryInline::FlatWriteFloat32((r28 + 216), f31.d);
...
// RECOMP_REGISTRATION base 0x8076AFA8 func_8076AFA8 preserves=false fpr_mask=0x80000000
