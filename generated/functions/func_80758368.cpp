...
extern "C" void func_80758368(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807583AC:
{
    r29 = MemoryInline::FlatRead32(r27);
...
loc_807583BC:
{
    ...
    r0 = MemoryInline::FlatRead8((r29 + 416));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_807583E4:
{
    f1.d = MemoryInline::FlatReadFloat32((r31 + 13280));
    r3 = r29;
    r4 = 642;
    ctx->lr = 0x807583F4u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x80758368 func_80758368 preserves=true fpr_mask=0x00000000
