...
extern "C" void func_80224348(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
// RECOMP_REGISTRATION base 0x80224348 func_80224348 preserves=true fpr_mask=0x00000000
