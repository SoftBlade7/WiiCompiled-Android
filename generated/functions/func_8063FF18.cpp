...
extern "C" void func_8063FF18(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8063FF18:
{
    ...
    r31 = 0x808A0000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r31 + -29580));
    ctx->lr = 0x8063FF50u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8063FF18 func_8063FF18 preserves=true fpr_mask=0x00000000
