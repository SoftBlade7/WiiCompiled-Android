...
extern "C" void func_807F94CC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807F94CC:
{
    ...
    MemoryInline::FlatWriteFloat32((r4 + 84), f1.d);
...
// RECOMP_REGISTRATION base 0x807F94CC func_807F94CC preserves=false fpr_mask=0x80000000
