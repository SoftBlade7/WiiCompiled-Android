...
extern "C" void func_807EF810(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807EF864:
{
    ...
    MemoryInline::FlatWrite8((r30 + 408), static_cast<uint8_t>(r0));
    ...
    r4 = 0x808B0000u;
    f1.d = MemoryInline::FlatReadFloat64((r4 + -25568));
    r4 = 0;
...
// RECOMP_REGISTRATION base 0x807EF810 func_807EF810 preserves=true fpr_mask=0x00000000
