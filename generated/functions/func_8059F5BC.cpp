...
extern "C" void func_8059F5BC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8059F604:
{
    ...
    ctx->fpr[0] = f0;
    ctx->fpr[1] = f1;
    InvokeDirectCpu<0x805B4AF8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8059F64C:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r4 + 8208));
    r3 = r30;
...
// RECOMP_REGISTRATION base 0x8059F5BC func_8059F5BC preserves=true fpr_mask=0x00000000
