...
extern "C" void func_80218028(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80217E1C:
{
    ...
    ctx->gpr[31] = r31;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80217E1Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
...
// RECOMP_REGISTRATION base 0x80218028 func_80218028 preserves=true fpr_mask=0x00000000
