...
extern "C" void func_80836B9C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_80836B9C:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead8((r29 + 989));
    r3 = 0;
    MemoryInline::FlatWrite32((r29 + 1064), r3);
...
loc_80836C50:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805F5D58u) && KnownTranslatedCpuCall<0x805F5D58u>::kAvailable && !KnownTranslatedCpuCall<0x805F5D58u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805F5D58u>()) {
        const auto state_free_result_805F5D58_2458 = func_805F5D58_statefree(r0, r3, cr, xer);
        r3 = static_cast<uint32_t>(state_free_result_805F5D58_2458[0]);
        cr = static_cast<uint32_t>(state_free_result_805F5D58_2458[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    r3 = (r3 & 255);
    r0 = (r0 + r3);
    MemoryInline::FlatWrite32((r29 + 1064), r0);
    goto loc_80836CC8;
}
...
loc_80836CBC:
{
    r3 = MemoryInline::FlatRead32((r29 + 1064));
    r0 = (r3 + 1);
    MemoryInline::FlatWrite32((r29 + 1064), r0);
}
...
loc_80836CC8:
{
    r0 = MemoryInline::FlatRead32((r29 + 1016));
    r30 = 0;
...
loc_80836CE4:
{
    r4 = MemoryInline::FlatRead32((r29 + 984));
    r3 = r29;
    r0 = MemoryInline::FlatRead32((r29 + 1064));
    r4 = (r4 + 1);
    r30 = (r4 + r0);
...
loc_80836D54:
{
    MemoryInline::FlatWrite32((r29 + 696), r28);
    r3 = r29;
    r4 = MemoryInline::FlatRead32((r29 + 984));
    r5 = r28;
    r6 = 0;
...
loc_80836DA0:
{
    ...
    r4 = (r5 + r4);
    r5 = MemoryInline::FlatRead32((r29 + 1064));
    r4 = (r4 + r0);
    r0 = (r4 + 2);
    r30 = (r5 + r0);
    r4 = r30;
...
loc_80836DF0:
{
    r7 = MemoryInline::FlatRead32((r29 + 76));
    r3 = r29;
    r0 = MemoryInline::FlatRead32((r29 + 984));
    r5 = r28;
    r4 = MemoryInline::FlatRead8((r29 + 988));
    r6 = 0;
    r0 = (r7 + r0);
    MemoryInline::FlatWrite32((r29 + 696), r28);
    r4 = (r4 + r0);
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead32((r29 + 696));
    r3 = 372;
...
loc_80836E54:
{
    ...
    r6 = 0;
    r0 = (r7 + r0);
    MemoryInline::FlatWrite32((r29 + 700), r28);
    r4 = (r0 + r4);
    r4 = (r4 + 1);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80837058:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805F0DB4u) && KnownTranslatedCpuCall<0x805F0DB4u>::kAvailable && !KnownTranslatedCpuCall<0x805F0DB4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805F0DB4u>()) {
        const auto state_free_result_805F0DB4_B5DE = func_805F0DB4_statefree_v2(r3, r4, xer);
        r4 = static_cast<uint32_t>(state_free_result_805F0DB4_B5DE);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_80837064:
{
    r27 = MemoryInline::FlatRead32((r29 + 1064));
...
loc_80837070:
{
    ...
    xer = ctx->xer;
    r31 = 0x808B0000u;
    MemoryInline::FlatWrite32((r29 + 992), r3);
    r31 = (r31 + -13512);
    r26 = 0;
    r27 = 0;
    r28 = 0x809C0000u;
...
loc_80837108:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x805F4348u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80837140:
{
    r4 = MemoryInline::FlatRead32((r29 + 1064));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r26), static_cast<int32_t>(r4));
}
...
// RECOMP_REGISTRATION base 0x80836B9C func_80836B9C preserves=true fpr_mask=0x00000000
