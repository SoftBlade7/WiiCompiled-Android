...
extern "C" void func_80097D60(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80097D60:
{
    r3 = MemoryInline::FlatRead8((r3 + 361));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80097D60 func_80097D60 preserves=true fpr_mask=0x00000000
