...
extern "C" void func_80099440(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80099474:
{
    r31 = MemoryInline::FlatRead32((r31 + 276));
    if (((cr & 0x20000000u) != 0)) {
        goto loc_80099494;
    }
}
...
// RECOMP_REGISTRATION base 0x80099440 func_80099440 preserves=true fpr_mask=0x00000000
