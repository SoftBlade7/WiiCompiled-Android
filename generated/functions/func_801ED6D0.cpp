...
extern "C" void func_801ED6D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
    ...
    uint32_t r0_rot_3 = 0;
    uint32_t r0_rot_4 = 0;
    uint32_t r5_subfc_min_0 = 0;
    uint32_t r5_subfc_min_1 = 0;
    uint32_t r5_subfc_min_2 = 0;
    uint32_t r5_subfc_min_3 = 0;
    uint32_t r6_ca_0 = 0;
    uint32_t r6_ca_1 = 0;
    uint32_t r6_ca_2 = 0;
    uint32_t r6_ca_3 = 0;
...
loc_801ED744:
{
    ...
    r26 = (r3 + 32);
    r5_subfc_min_1 = r5;
    r5 = (r5_subfc_min_1 - r4);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(r5_subfc_min_1) >= static_cast<uint32_t>(r4) ? 1u : 0u) << 29);
    r6_not_1 = ~(r6);
    r6_ca_1 = (xer >> 29) & 1u;
    r6 = (r6_not_1 + r0);
    r6 = (r6 + r6_ca_1);
...
loc_801ED780:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r27 + 4), r4);
...
// RECOMP_REGISTRATION base 0x801ED6D0 func_801ED6D0 preserves=true fpr_mask=0x00000000
