...
extern "C" void func_80854AE0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80854AE0:
{
    ...
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80862D58u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r5 = r3;
    r3 = r29;
    ...
    ctx->gpr[30] = r30;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x80854B40u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80854AE0 func_80854AE0 preserves=true fpr_mask=0x00000000
