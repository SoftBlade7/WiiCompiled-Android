...
extern "C" void func_807F98A4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807F98A4:
{
    ...
    ctx->gpr[10] = r10;
    ctx->fpr[1] = f1;
    InvokeDirectCpu<0x807FA51Cu>(ctx);
    r9 = ctx->gpr[9];
    r10 = ctx->gpr[10];
    f1 = ctx->fpr[1];
    ctx->gpr[9] = r9;
...
// RECOMP_REGISTRATION base 0x807F98A4 func_807F98A4 preserves=true fpr_mask=0x00000000
