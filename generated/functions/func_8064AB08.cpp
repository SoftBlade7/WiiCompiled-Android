...
extern "C" void func_8064AB08(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8064AB08:
{
    ...
    r9 = 0x809C0000u;
    r27 = r3;
    r3 = MemoryInline::FlatRead32((r9 + 7736));
    r23 = r4;
    r28 = r5;
    r29 = r6;
...
loc_8064ABA8:
{
    ...
    r26 = (r26 + -26452);
    r0 = 0;
    MemoryInline::FlatWrite8((r3 + 2104), static_cast<uint8_t>(r0));
    r3 = r24;
    r6 = r28;
    r4 = (r26 + 77);
    r5 = (r25 + 656);
    ...
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_2841 = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_2841[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_2841[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_3665 = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_3665[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_3665[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_8064AC50:
{
    r0 = (r28 * 12);
    r3 = (r25 + r0);
    r3 = MemoryInline::FlatRead16((r3 + 508));
...
loc_8064AC84:
{
    r0 = (r28 * 12);
    r3 = (r25 + r0);
    r3 = MemoryInline::FlatRead16((r3 + 510));
    MemoryInline::FlatWriteRam32((r1 + 8), r3);
    r0 = (r3 + 0);
}
...
// RECOMP_REGISTRATION base 0x8064AB08 func_8064AB08 preserves=true fpr_mask=0x00000000
