...
extern "C" void func_807A5CFC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807A5CFC:
{
    ...
    ctx->fpr[1] = f1;
    ctx->fpr[2] = f2;
    InvokeDirectCpu<0x8079DA9Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x807A5CFC func_807A5CFC preserves=true fpr_mask=0x00000000
