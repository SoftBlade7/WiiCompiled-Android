...
extern "C" void func_8061C2E4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_inl0_cont_8061B358:
{
    ...
    r4 = 0x80890000u;
    r3 = r30;
    f1.d = MemoryInline::FlatReadFloat32((r4 + 31556));
    r4 = 0;
...
loc_inl1_cont_80602488:
{
    ...
    r5 = MemoryInline::FlatRead32((r30 + 1200));
    r3 = r30;
    r4 = 32;
    ctx->lr = 0x8061C36Cu;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x8061C2E4 func_8061C2E4 preserves=true fpr_mask=0x00000000
