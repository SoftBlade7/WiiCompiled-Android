...
extern "C" void func_80040100(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80040100:
{
    ...
    PPC_PsqStStackInline<0u, 0u>(ctx, r6, f1.d);
    PpcSetPairedFprInline(f1, PPC_PsSubInline(f3.d, f2.d));
    f2.d = MemoryInline::FlatReadFloat32((r1 + 12));
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r6_psq_tmp_0 = (r6 + 8);
    PPC_PsqStStackInline<1u, 0u>(ctx, r6_psq_tmp_0, f1.d);
...
// RECOMP_GUEST_ABI gpr_read=0xC000003E gpr_write=0xC0000043 gpr_return=0x00000000 fpr_read=0x0000001F fpr_write=0x0000001F fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80040100 func_80040100 preserves=true fpr_mask=0x00000000
