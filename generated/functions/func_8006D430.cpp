...
extern "C" void func_8006D430(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8006D430:
{
    ...
    f11.d = MemoryInline::FlatReadFloat32(r4);
    f4.d = PpcFmulsInline(f2.d, f5.d);
    f8.d = MemoryInline::FlatReadFloat32(r3);
    f2.d = PpcFmulsInline(f11.d, f6.d);
    f10.d = PpcFmulsInline(f8.d, f11.d);
    f0.d = static_cast<double>(PpcForceSingleValueInline(f7.d + f0.d));
    f9.d = MemoryInline::FlatReadFloat32((r3 + 4));
...
// RECOMP_GUEST_ABI gpr_read=0x0000001C gpr_write=0x00000000 gpr_return=0x00000000 fpr_read=0x00000000 fpr_write=0x00000FFF fpr_return=0x00000002 cr_read=0x00 cr_write=0x00 xer_read=0 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8006D430 func_8006D430 preserves=true fpr_mask=0x00000000
