...
extern "C" void func_801795A4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80179798:
{
    ...
    r5 = 0;
    r0_rot_10 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(26));
    r0 = (r0_rot_10 & 67108863);
    r6 = (r0 * 100);
    ctx->lr = 0x801797E0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8017A738:
{
    r0_rot_16 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(2));
    r0 = (r0_rot_16 & -4);
    r3 = (r28 + r0);
...
// RECOMP_REGISTRATION base 0x801795A4 func_801795A4 preserves=true fpr_mask=0x00000000
