...
extern "C" void func_805A3EE0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805A3EE0:
{
    ...
    cr = ctx->cr;
    r3 = 0x80890000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 8728));
...
// RECOMP_GUEST_ABI gpr_read=0x0000001E gpr_write=0x0000003B gpr_return=0x00000018 fpr_read=0x80000002 fpr_write=0x800000FF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x805A3EE0 func_805A3EE0 preserves=false fpr_mask=0x80000000
