...
extern "C" void func_806BF434(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r3_rot_0 = 0;
...
loc_806BF434:
{
    r3 = MemoryInline::FlatRead8((r3 + 144));
    r0 = (0 - r3);
    r0 = (r0 | r3);
...
// RECOMP_REGISTRATION base 0x806BF434 func_806BF434 preserves=true fpr_mask=0x00000000
