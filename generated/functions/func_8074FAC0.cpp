...
extern "C" void func_8074FAC0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8074FAC0:
{
    ...
    f3.d = MemoryInline::FlatReadFloat32((r5 + 64));
...
// RECOMP_REGISTRATION base 0x8074FAC0 func_8074FAC0 preserves=true fpr_mask=0x00000000
