...
extern "C" void func_8010414C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80104178:
{
    ...
    r3 = r30;
    r7 = MemoryInline::FlatRead32((r1 + 64));
    r5 = r28;
...
// RECOMP_REGISTRATION base 0x8010414C func_8010414C preserves=true fpr_mask=0x00000000
