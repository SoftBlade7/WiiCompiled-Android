...
extern "C" void func_807D8F88(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807D8FCC:
{
    ...
    r3 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 29892));
    PpcSetPairedFprInline(f1, PPC_PsMulInline(f1.d, f1.d));
    f2.d = MemoryInline::FlatReadFloat32((r31 + 1068));
...
loc_807D9000:
{
    f1.d = MemoryInline::FlatReadFloat32((r31 + 1108));
    r4 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r4 + 29896));
...
// RECOMP_REGISTRATION base 0x807D8F88 func_807D8F88 preserves=true fpr_mask=0x00000000
