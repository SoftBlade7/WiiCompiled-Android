...
extern "C" void func_8016D790(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8016D790:
{
    ...
    r6_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(10));
    r6_mrot_0 = (r6_rot_0 & 3072);
    r6_mdest_0 = (r6 & -3073);
...
// RECOMP_REGISTRATION base 0x8016D790 func_8016D790 preserves=true fpr_mask=0x00000000
