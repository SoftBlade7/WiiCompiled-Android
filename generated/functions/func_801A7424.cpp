...
extern "C" void func_801A7424(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_801A74A4:
{
    ...
    r5 = PPC_Divw(static_cast<int32_t>(r7), static_cast<int32_t>(r6));
    r0 = (r4 + -1);
...
// RECOMP_REGISTRATION base 0x801A7424 func_801A7424 preserves=true fpr_mask=0x00000000
