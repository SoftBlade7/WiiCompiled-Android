...
extern "C" void func_80152B44(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r3 = 589824;
    r6 = MemoryInline::FlatRead8((r31 + 108));
    r5 = r28;
    r4 = (r30 + 112);
    r3 = (r3 + 3);
    ctx->lr = 0x80152B70u;
...
// RECOMP_REGISTRATION base 0x80152B44 func_80152B44 preserves=true fpr_mask=0x00000000
