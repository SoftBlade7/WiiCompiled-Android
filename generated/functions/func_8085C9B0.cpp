...
extern "C" void func_8085C9B0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8085C9B0:
{
    ...
    r29 = (r29 + 16104);
    f31.d = MemoryInline::FlatReadFloat32((r4 + -3584));
    r27 = 0;
    r30 = 0;
    goto loc_8085CABC;
}
...
loc_8085CA60:
{
    ...
    r30 = ctx->gpr[30];
    r31 = ctx->gpr[31];
    MemoryInline::FlatWriteRam32(r28, r29);
    r0 = (r27 + 1);
    MemoryInline::FlatWriteRam8((r28 + 372), static_cast<uint8_t>(r0));
    MemoryInline::FlatWriteRam8((r28 + 380), static_cast<uint8_t>(r30));
    MemoryInline::FlatWriteRamFloat32((r28 + 384), f31.d);
    MemoryInline::FlatWriteRam32((r28 + 404), r30);
}

loc_8085CA7C:
{
    r5 = MemoryInline::FlatRead32((r31 + 416));
    r25_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r27), static_cast<uint32_t>(2));
    r25 = (r25_rot_2 & 1020);
    r3 = r31;
    r4 = (r27 & 255);
    r5_addr_2 = (r5 + r25);
...
// RECOMP_REGISTRATION base 0x8085C9B0 func_8085C9B0 preserves=false fpr_mask=0x80000000
