...
extern "C" void func_80886574(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80886574:
{
    ...
    r30 = 0;
    f30.d = MemoryInline::FlatReadFloat32((r5 + 9776));
    r29 = 0;
    f31.d = MemoryInline::FlatReadFloat32((r4 + 9796));
    r31 = 0;
    goto loc_8088668C;
}
...
loc_80886604:
{
    guest_range_2 = MemoryInline::ResolveRangeHost((r28 + 180), 0, 4u, true, false);
    r3 = MemoryInline::ReadResolved32(guest_range_2, 0u, (r28 + 180));
    r3_addr_2 = (r3 + r29);
    MemoryInline::FlatWrite32(r3_addr_2, r31);
    r0 = MemoryInline::ReadResolved32(guest_range_2, 0u, (r28 + 180));
    r3 = (r0 + r29);
...
loc_80886698:
{
    ...
    r3 = 0x809C0000u;
    r0 = MemoryInline::FlatRead16((r4 + 18872));
    MemoryInline::FlatWrite16((r28 + 184), static_cast<uint16_t>(r0));
...
loc_808866EC:
{
    ...
    r6 = MemoryInline::ReadResolved32(guest_range_4, 0u, (r28 + 180));
    r4 = 0x808B0000u;
    r29 = 0x808B0000u;
    r5 = 1;
    MemoryInline::FlatWrite32(r6, r3);
    r0 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r4 + 9776));
    r3 = MemoryInline::ReadResolved32(guest_range_4, 0u, (r28 + 180));
    f0.d = MemoryInline::FlatReadFloat32((r29 + 9796));
...
loc_80886768:
{
    r5 = 0x809C0000u;
    r3 = r28;
    r4 = MemoryInline::FlatRead16((r5 + 18872));
    r0 = (r4 + 1);
    MemoryInline::FlatWriteRam16((r5 + 18872), static_cast<uint16_t>(r0));
...
// RECOMP_REGISTRATION base 0x80886574 func_80886574 preserves=false fpr_mask=0xC0000000
