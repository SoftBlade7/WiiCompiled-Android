...
extern "C" void func_8001DAD4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8001DAD4:
{
    ...
    ctx->gpr[5] = r5;
    ctx->gpr[6] = r6;
    InvokeDirectCpu<0x8001C4E4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8001DAD4 func_8001DAD4 preserves=true fpr_mask=0x00000000
