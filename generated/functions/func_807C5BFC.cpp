...
extern "C" void func_807C5BFC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807C5C3C:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r3 + 26408));
...
loc_807C5CA8:
{
    r4 = 0x808A0000u;
    r3 = 0x809C0000u;
    f0.d = MemoryInline::FlatReadFloat32((r4 + 26400));
...
loc_807C5CE4:
{
    ...
    ctx->fpr[12] = f12;
    ctx->cr = cr;
    InvokeDirectCpu<0x807C4018u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFFFFF gpr_write=0xFFC01FFB gpr_return=0x00000018 fpr_read=0xFFFFFFFF fpr_write=0x80003FFF fpr_return=0x00000002 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=0 fence=1
// RECOMP_REGISTRATION base 0x807C5BFC func_807C5BFC preserves=true fpr_mask=0x00000000
