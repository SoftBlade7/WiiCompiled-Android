...
extern "C" void func_8007B180(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_8007B180:
{
    ...
    r0 = (r0_rot_0 & -4);
    r7 = (r4 + r0);
    r6 = MemoryInline::FlatRead8((r7 + 216));
    r5 = MemoryInline::FlatRead8((r7 + 217));
    r4 = MemoryInline::FlatRead8((r7 + 218));
    r0 = MemoryInline::FlatRead8((r7 + 219));
...
// RECOMP_REGISTRATION base 0x8007B180 func_8007B180 preserves=true fpr_mask=0x00000000
