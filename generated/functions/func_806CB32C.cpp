...
extern "C" void func_806CB32C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806CB32C:
{
    ...
    f2 = ctx->fpr[2];
    ctr = ctx->ctr;
    r29 = MemoryInline::FlatRead32((r28 + 216));
    r4 = 0;
    r3 = MemoryInline::FlatRead32((r29 + 8));
    r3 = MemoryInline::FlatRead32((r3 + 40));
...
// RECOMP_REGISTRATION base 0x806CB32C func_806CB32C preserves=true fpr_mask=0x00000000
