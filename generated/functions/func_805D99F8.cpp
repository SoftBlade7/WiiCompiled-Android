...
extern "C" void func_805D99F8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805D9A30:
{
    ...
    r3 = 0x80890000u;
    f3.d = MemoryInline::FlatReadFloat64((r3 + 18720));
    r5 = 0x80890000u;
...
// RECOMP_REGISTRATION base 0x805D99F8 func_805D99F8 preserves=true fpr_mask=0x00000000
