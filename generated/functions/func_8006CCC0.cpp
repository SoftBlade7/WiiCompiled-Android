...
extern "C" void func_8006CCC0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8006CCC0:
{
    ...
    f2.d = MemoryInline::FlatReadFloat32((r2 + -29320));
    f1.d = (-(f0.d));
...
// RECOMP_REGISTRATION base 0x8006CCC0 func_8006CCC0 preserves=true fpr_mask=0x00000000
