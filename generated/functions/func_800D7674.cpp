...
extern "C" void func_800D7674(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800D76A4:
{
    r5 = MemoryInline::FlatRead32((r29 + 1820));
    goto loc_800D76B0;
}
...
loc_800D76C0:
{
    ...
    r0 = MemoryInline::FlatRead32((r29 + 1912));
    r0 = (r0 - r3);
...
loc_800D76DC:
{
    ...
    r4 = ctx->gpr[4];
    r6 = 0x80000000u;
    r8 = MemoryInline::FlatRead32((r26 + 1908));
    r0 = MemoryInline::FlatRead32((r6 + 248));
    r5 = 274857984;
    r6 = (r5 + 19923);
    r7 = MemoryInline::FlatRead32((r26 + 1904));
...
loc_800D773C:
{
    ...
    r3 = MemoryInline::FlatRead8((r4 + 2198));
    r3 = (r3 + 1);
    r0 = (r3 & 255);
    MemoryInline::FlatWrite8((r4 + 2198), static_cast<uint8_t>(r3));
...
loc_800D775C:
{
    ...
    r27 = 0;
    r28 = 1;
    r3 = MemoryInline::FlatRead32((r4 + 2184));
    r0 = MemoryInline::FlatRead32((r4 + 2188));
    r29 = ~(r3 & r0);
    goto loc_800D77C8;
}
...
loc_800D7794:
{
    r6 = MemoryInline::FlatRead8((r26 + 22));
...
loc_800D77D8:
{
    r0 = MemoryInline::FlatRead32((r3 + 2188));
...
loc_800D77F4:
{
    r29 = MemoryInline::FlatRead32((r4 + 1820));
...
loc_800D7928:
{
    ...
    r4 = -65536;
    r3 = 6;
    MemoryInline::FlatWrite8((r5 + 1825), static_cast<uint8_t>(r28));
    r4 = (r4 + -14894);
...
loc_800D82A4:
{
    ...
    r6 = 0x80000000u;
    r4_subfc_min_7 = r4;
    r4 = (r4_subfc_min_7 - r27);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(r4_subfc_min_7) >= static_cast<uint32_t>(r27) ? 1u : 0u) << 29);
    MemoryInline::FlatWrite32((r13 + -26864), r3);
    r7 = (r28 + 19923);
    r3_subfe_rb_7 = r3;
    r3_not_7 = ~(r26);
...
loc_800D83B8:
{
    ...
    if (MkwStateFreeAbiEnabled(0x8011E43Cu) && KnownTranslatedCpuCall<0x8011E43Cu>::kAvailable && !KnownTranslatedCpuCall<0x8011E43Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x8011E43Cu>()) {
        const auto state_free_result_8011E43C_11F2F = func_8011E43C_statefree_v0(r3, xer);
        r0 = static_cast<uint32_t>(state_free_result_8011E43C_11F2F[0]);
        r3 = static_cast<uint32_t>(state_free_result_8011E43C_11F2F[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_800D8614:
{
    ...
    r4_subfc_min_10 = r4;
    r4 = (r4_subfc_min_10 - r8);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(r4_subfc_min_10) >= static_cast<uint32_t>(r8) ? 1u : 0u) << 29);
    r0 = (static_cast<uint32_t>((static_cast<uint64_t>(r6) * static_cast<uint64_t>(r0)) >> 32));
    r5 = 0;
    r3_subfe_rb_10 = r3;
    r3_not_10 = ~(r7);
...
// RECOMP_REGISTRATION base 0x800D7674 func_800D7674 preserves=true fpr_mask=0x00000000
