...
extern "C" void func_8073F7A8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8073F7D4:
{
    ...
    r4 = (r4 + 1);
    r0 = PPC_Divw(static_cast<int32_t>(r4), static_cast<int32_t>(r31));
    r0 = (r0 * r31);
    r4 = (r4 - r0);
    goto loc_8073F810;
}
...
// RECOMP_REGISTRATION base 0x8073F7A8 func_8073F7A8 preserves=true fpr_mask=0x00000000
