...
extern "C" void func_800AD830(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800AD830:
{
    r3 = MemoryInline::FlatRead8((r3 + 572));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x800AD830 func_800AD830 preserves=true fpr_mask=0x00000000
