...
extern "C" void func_8012DE7C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lfsx_8012DFB4_loc_0 = 0;
    uint32_t addr_lfsx_8012DFD0_loc_0 = 0;
    uint32_t addr_lfsx_8012DFDC_loc_0 = 0;
    uint32_t addr_lfsx_8012DFE8_loc_0 = 0;
    uint32_t addr_stfsx_8012E130_loc_0 = 0;
    uint32_t cr0_0 = 0;
...
{
    r0 = (r0 & -3);
    MemoryInline::FlatWrite32((r4 + 144), r0);
    goto loc_8012E1E0;
}

loc_8012DEB4:
{
    r8 = MemoryInline::FlatRead32((r4 + 164));
...
loc_8012DF00:
{
    r7 = MemoryInline::FlatRead32((r4 + 168));
...
loc_8012DF2C:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8012E408u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r5 = ctx->gpr[5];
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    f31.d = MemoryInline::FlatReadFloat64((r2 + -26984));
    r30 = (r1 + 56);
    r29 = 0;
    r31 = 1127219200;
    r25 = 0;
...
loc_8012DF50:
{
    ...
    r4 = MemoryInline::FlatRead32((r27 + 28));
    r6 = (r3 + r0);
}
...
loc_8012DF90:
{
    ...
    r9 = (r9_rot_2 & 65535);
    r28 = MemoryInline::FlatRead32((r27 + 140));
    ctr = r7;
...
loc_8012DFA4:
{
    ...
    r0 = (r0_rot_3 & -4);
    r28 = (r28 + 1);
    addr_lfsx_8012DFB4_loc_0 = (r3 + r4);
    f0.d = MemoryInline::FlatReadFloat32(addr_lfsx_8012DFB4_loc_0);
    r5 = (r27 + r0);
    r9 = (r9 + 1);
    r28 = (r28 & 3);
    ...
    addr_lfsx_8012DFD0_loc_0 = (r3 + r4);
    f0.d = MemoryInline::FlatReadFloat32(addr_lfsx_8012DFD0_loc_0);
    MemoryInline::FlatWriteFloat32((r5 + 92), f0.d);
    r3 = MemoryInline::FlatRead32((r27 + 8));
    addr_lfsx_8012DFDC_loc_0 = (r3 + r4);
    f0.d = MemoryInline::FlatReadFloat32(addr_lfsx_8012DFDC_loc_0);
    MemoryInline::FlatWriteFloat32((r5 + 108), f0.d);
    r3 = MemoryInline::FlatRead32((r27 + 12));
    addr_lfsx_8012DFE8_loc_0 = (r3 + r4);
    f0.d = MemoryInline::FlatReadFloat32(addr_lfsx_8012DFE8_loc_0);
...
loc_8012E02C:
{
    ...
    r28 = (r28 + 1);
    r10 = (r4 + r0);
    r0 = MemoryInline::FlatRead32((r27 + 164));
    r28 = (r28 & 3);
    f1.d = MemoryInline::FlatReadFloat32(r3);
    r9_rot_4 = PpcRotl32Inline(static_cast<uint32_t>(r28), static_cast<uint32_t>(2));
    r9 = (r9_rot_4 & -4);
    f0.d = MemoryInline::FlatReadFloat32((r10 + 76));
    r28 = (r28 + 1);
    f5.d = MemoryInline::FlatReadFloat32((r2 + -26988));
    ...
    r9 = (r9_rot_5 & -4);
    f0.d = MemoryInline::FlatReadFloat32((r11 + 76));
    r28 = (r28 + 1);
...
loc_8012E0F0:
{
    ...
    MemoryInline::FlatWriteRam32((r1 + 448), r31);
    r0 = MemoryInline::FlatRead32(r9);
    r0 = (r0 ^ -2147483648);
    MemoryInline::FlatWriteRam32((r1 + 452), r0);
    f0.d = MemoryInline::FlatReadFloat64((r1 + 448));
    f1.d = static_cast<double>(PpcForceSingleValueInline(f0.d - f31.d));
}
...
loc_8012E10C:
{
    ...
    addr_stfsx_8012E130_loc_0 = (r11 + r10);
    MemoryInline::FlatWriteFloat32(addr_stfsx_8012E130_loc_0, f0.d);
...
loc_8012E194:
{
    ...
    r0 = MemoryInline::FlatRead32((r27 + 32));
    r3 = (r3 + 1);
    MemoryInline::FlatWrite32((r27 + 140), r28);
}
...
loc_8012E1CC:
{
    MemoryInline::FlatWrite32((r27 + 20), r25);
}
...
// RECOMP_REGISTRATION base 0x8012DE7C func_8012DE7C preserves=false fpr_mask=0x80000000
