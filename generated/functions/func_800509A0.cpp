...
extern "C" void func_800509A0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800509CC:
{
    ...
    r0 = MemoryInline::FlatRead8((r31 + 171));
    r0 = (r0 & 254);
    MemoryInline::FlatWrite8((r31 + 171), static_cast<uint8_t>(r0));
    goto loc_800509FC;
}
...
// RECOMP_GUEST_ABI gpr_read=0x8000003F gpr_write=0x8000001B gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x0000003F fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x800509A0 func_800509A0 preserves=true fpr_mask=0x00000000
