...
extern "C" void func_805E90E8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805E90E8:
{
    ...
    r28 = 0;
    r31 = 0;
    r30 = MemoryInline::FlatRead32((r3 + 120));
    goto loc_805E9140;
}

loc_805E9110:
{
    r29 = MemoryInline::FlatRead32((r26 + 116));
    r4 = r27;
    r29_addr_2 = (r29 + r31);
...
// RECOMP_REGISTRATION base 0x805E90E8 func_805E90E8 preserves=true fpr_mask=0x00000000
