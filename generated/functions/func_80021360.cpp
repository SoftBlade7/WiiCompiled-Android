...
extern "C" void func_80021360(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80021360:
{
    ...
    r4 = -1;
    MemoryInline::FlatWrite32((r13 + -27476), r0);
...
// RECOMP_REGISTRATION base 0x80021360 func_80021360 preserves=true fpr_mask=0x00000000
