...
extern "C" void func_80851F70(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_80851F70:
{
    ...
    r31 = r3;
    r4 = MemoryInline::FlatRead32((r3 + 1732));
    r3 = (r3 + 1736);
    r4 = (r4 + 50);
    ctx->lr = 0x80851F98u;
    ctx->gpr[0] = r0;
    ...
    r5 = ctx->gpr[5];
    r31 = ctx->gpr[31];
    r3 = MemoryInline::FlatRead32((r31 + 1732));
    r4 = 0x808E0000u;
    MemoryInline::FlatWrite32((r31 + 996), r3);
    r4 = (r4 + -24264);
    r0 = (r3 + -3900);
    r3 = r31;
...
// RECOMP_REGISTRATION base 0x80851F70 func_80851F70 preserves=true fpr_mask=0x00000000
