...
extern "C" void func_8007D410(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8007D410:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead8((r27 + 249));
    r31 = r3;
    ctx->lr = 0x8007D468u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8007D47C:
{
    guest_range_0 = MemoryInline::ResolveRangeHost((r27 + 76), 0, 180u, true, false);
    f1.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 4u, (r27 + 80));
    r8 = r30;
    f4.d = MemoryInline::FlatReadFloat32((r29 + 8));
    r3 = (r1 + 16);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 0u, (r27 + 76));
    r4 = (r1 + 8);
    f6.d = MemoryInline::FlatReadFloat32(r29);
    f3.d = static_cast<double>(PpcForceSingleValueInline(f1.d - f4.d));
    f10.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 148u, (r27 + 224));
    f2.d = static_cast<double>(PpcForceSingleValueInline(f0.d - f6.d));
    f1.d = MemoryInline::FlatReadFloat32((r28 + 4));
    f9.d = static_cast<double>(PpcForceSingleValueInline(f10.d + f3.d));
    f0.d = MemoryInline::FlatReadFloat32(r28);
    f1.d = static_cast<double>(PpcForceSingleValueInline(f1.d - f4.d));
    f5.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 140u, (r27 + 216));
    ...
    f7.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 152u, (r27 + 228));
    f3.d = static_cast<double>(PpcForceSingleValueInline(f4.d - f3.d));
    f2.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 144u, (r27 + 220));
    r6 = MemoryInline::ReadResolved32(guest_range_0, 176u, (r27 + 252));
    f4.d = static_cast<double>(PpcForceSingleValueInline(f7.d + f8.d));
    r5 = MemoryInline::ReadResolved8(guest_range_0, 173u, (r27 + 249));
...
// RECOMP_REGISTRATION base 0x8007D410 func_8007D410 preserves=true fpr_mask=0x00000000
