...
extern "C" void func_8064FB14(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8064FB14:
{
    r3 = MemoryInline::FlatRead32((r3 + 2836));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8064FB14 func_8064FB14 preserves=true fpr_mask=0x00000000
