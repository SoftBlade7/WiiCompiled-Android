...
extern "C" void func_80667BB4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r4_rot_0 = 0;
...
loc_80667BB4:
{
    ...
    r30 = MemoryInline::FlatRead32((r3 + 772));
...
loc_80667C4C:
{
    ...
    r3 = 1717960704;
    r0 = (r3 + 26215);
    MemoryInline::FlatWrite32((r30 + 88), r5);
    ...
    r0 = (r0 * 5);
    r0 = (r5 - r0);
    MemoryInline::FlatWrite32((r28 + 10504), r0);
    ctx->lr = 0x80667C80u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80667BB4 func_80667BB4 preserves=true fpr_mask=0x00000000
