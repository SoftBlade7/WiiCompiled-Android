...
extern "C" void func_800F5580(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_inl1_cont_800EF4B0:
{
    ...
    // inline leaf 0x8010ACDC (2 guest instruction(s))
    r3 = MemoryInline::FlatRead32((r3 + 84));
    // end of inlined leaf 0x8010ACDC
...
// RECOMP_REGISTRATION base 0x800F5580 func_800F5580 preserves=true fpr_mask=0x00000000
