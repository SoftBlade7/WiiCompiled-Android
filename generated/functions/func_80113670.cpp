...
extern "C" void func_80113670(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80113710:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801126D4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8011373C:
{
    MemoryInline::FlatWrite32((r24 + 20), r3);
    if (((cr & 0x20000000u) == 0)) {
        goto loc_80113754;
    }
}
...
loc_80113774:
{
    MemoryInline::FlatWrite32((r24 + 44), r3);
    if (((cr & 0x20000000u) == 0)) {
        goto loc_8011378C;
    }
}
...
loc_8011378C:
{
    MemoryInline::FlatWrite32((r24 + 352), r26);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r26), static_cast<int32_t>(0));
}

loc_80113794:
{
    MemoryInline::FlatWrite32((r24 + 52), r28);
    MemoryInline::FlatWrite32((r24 + 64), r29);
    MemoryInline::FlatWrite32((r24 + 68), r30);
    MemoryInline::FlatWrite32((r24 + 72), r31);
    MemoryInline::FlatWrite32((r24 + 344), r27);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_801137CC;
    }
}
...
loc_801137AC:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801141CCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801137E0:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801131ECu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80113670 func_80113670 preserves=true fpr_mask=0x00000000
