...
extern "C" void func_806DC790(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806DC790:
{
    ...
    r3 = MemoryInline::FlatRead16((r31 + 308));
    r0 = MemoryInline::FlatRead16((r31 + 208));
    r0 = (r0 << 16);
...
{
    r30 = 0;
    MemoryInline::FlatWrite8((r31 + 316), static_cast<uint8_t>(r30));
    r3 = r31;
    r4 = 1;
    ...
    MemoryInline::FlatWrite32((r31 + 328), r30);
    goto loc_806DC960;
}

loc_806DC80C:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r4), static_cast<int32_t>(71));
}
...
loc_806DC834:
{
    if ((static_cast<int32_t>(r4) <= static_cast<int32_t>(70))) {
        goto loc_806DC894;
    }
}
...
loc_806DC954:
{
    ...
    r0 = (r3 + 1);
    MemoryInline::FlatWrite32((r31 + 320), r0);
}
...
// RECOMP_REGISTRATION base 0x806DC790 func_806DC790 preserves=true fpr_mask=0x00000000
