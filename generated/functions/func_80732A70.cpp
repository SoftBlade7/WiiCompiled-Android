...
extern "C" void func_80732A70(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80732A70:
{
    ...
    MemoryInline::FlatWrite16((r5 + 12), static_cast<uint16_t>(r30));
    ...
    r0 = MemoryInline::FlatRead8((r31 + 352));
...
loc_80732AC4:
{
    r0 = MemoryInline::FlatRead8((r31 + 354));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_80732B14:
{
    MemoryInline::FlatWrite8((r31 + 353), static_cast<uint8_t>(r30));
}
...
loc_80732B18:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead8((r31 + 355));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_80732BDC:
{
    ...
    f1 = ctx->fpr[1];
    f2 = ctx->fpr[2];
    r30 = MemoryInline::FlatRead32((r31 + 336));
    r3 = r29;
...
// RECOMP_REGISTRATION base 0x80732A70 func_80732A70 preserves=true fpr_mask=0x00000000
