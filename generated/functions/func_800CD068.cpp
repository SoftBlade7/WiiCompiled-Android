...
extern "C" void func_800CD068(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr1_0 = 0;
...
loc_800CD0A0:
{
    r0 = MemoryInline::FlatRead32((r13 + -26944));
    r11 = 0x80270000u;
...
// RECOMP_REGISTRATION base 0x800CD068 func_800CD068 preserves=true fpr_mask=0x00000000
