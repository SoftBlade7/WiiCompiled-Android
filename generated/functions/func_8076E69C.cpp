...
extern "C" void func_8076E69C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8076E6BC:
{
    ...
    f4 = ctx->fpr[4];
    cr = ctx->cr;
    guest_range_0 = MemoryInline::ResolveRangeHost((r31 + 32), 0, 144u, true, false);
    r5 = MemoryInline::ReadResolved32(guest_range_0, 56u, (r31 + 88));
    r6 = 0x808A0000u;
    r0 = MemoryInline::ReadResolved32(guest_range_0, 60u, (r31 + 92));
    r4 = 0x808A0000u;
    ...
    r5 = (r1 + 8);
    f0.d = MemoryInline::FlatReadFloat32((r6 + 15796));
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_0, 64u, (r31 + 96));
            r0 = MemoryInline::ReadResolved32(guest_range_0, 68u, (r31 + 100));
        }
    }
    ...
    MemoryInline::FlatWriteRam32((r1 + 56), r6);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_0, 72u, (r31 + 104));
            r0 = MemoryInline::ReadResolved32(guest_range_0, 76u, (r31 + 108));
        }
    }
    ...
    MemoryInline::FlatWriteRam32((r1 + 64), r6);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_0, 80u, (r31 + 112));
            r0 = MemoryInline::ReadResolved32(guest_range_0, 84u, (r31 + 116));
        }
    }
    ...
    MemoryInline::FlatWriteRam32((r1 + 72), r6);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_0, 88u, (r31 + 120));
            r0 = MemoryInline::ReadResolved32(guest_range_0, 92u, (r31 + 124));
        }
    }
    ...
    MemoryInline::FlatWriteRam32((r1 + 80), r6);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_0, 96u, (r31 + 128));
            r0 = MemoryInline::ReadResolved32(guest_range_0, 100u, (r31 + 132));
        }
    }
    ...
    r3 = MemoryInline::ReadResolved32(guest_range_0, 140u, (r31 + 172));
    r4 = (r1 + 48);
    r5 = (r31 + 60);
    r6 = (r1 + 20);
...
// RECOMP_REGISTRATION base 0x8076E69C func_8076E69C preserves=true fpr_mask=0x00000000
