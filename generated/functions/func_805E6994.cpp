...
extern "C" void func_805E6994(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805E6994:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_541 = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_541[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_541[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    MemoryInline::FlatWriteRam32((r1 + 80), r31);
    r3 = r28;
    r4 = r29;
    r5 = (r1 + 8);
    ctx->lr = 0x805E69DCu;
...
// RECOMP_REGISTRATION base 0x805E6994 func_805E6994 preserves=true fpr_mask=0x00000000
