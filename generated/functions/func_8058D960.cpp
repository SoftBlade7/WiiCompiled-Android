...
extern "C" void func_8058D960(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8058D960:
{
    ...
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80580648u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
...
// RECOMP_REGISTRATION base 0x8058D960 func_8058D960 preserves=true fpr_mask=0x00000000
