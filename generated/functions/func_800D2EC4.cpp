...
extern "C" void func_800D2EC4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800D2EC4:
{
    ...
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    InvokeDirectCpu<0x800D2EF0u>(ctx);
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
// RECOMP_REGISTRATION base 0x800D2EC4 func_800D2EC4 preserves=true fpr_mask=0x00000000
