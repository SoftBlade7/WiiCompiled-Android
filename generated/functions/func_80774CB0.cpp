...
extern "C" void func_80774CB0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80774DEC:
{
    MemoryInline::FlatWriteFloat32((r29 + 220), f1.d);
    r3 = (r1 + 20);
    r4 = (r29 + 48);
    r5 = (r29 + 208);
    ctx->gpr[1] = r1;
...
loc_80774E34:
{
    ...
    if (MkwStateFreeAbiEnabled(0x80557340u) && KnownTranslatedCpuCall<0x80557340u>::kAvailable && !KnownTranslatedCpuCall<0x80557340u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80557340u>()) {
        const auto state_free_result_80557340_34AA = func_80557340_statefree(r3, r4);
        r0 = static_cast<uint32_t>(state_free_result_80557340_34AA[0]);
        r3 = static_cast<uint32_t>(state_free_result_80557340_34AA[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80774CB0 func_80774CB0 preserves=false fpr_mask=0x80000000
