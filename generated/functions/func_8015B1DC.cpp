...
extern "C" void func_8015B1DC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr1_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8015B204:
{
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r6), static_cast<uint32_t>(7));
}
...
// RECOMP_REGISTRATION base 0x8015B1DC func_8015B1DC preserves=true fpr_mask=0x00000000
