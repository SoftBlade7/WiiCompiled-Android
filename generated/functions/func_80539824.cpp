...
extern "C" void func_80539824(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lfsx_8053997C_loc_0 = 0;
    uint32_t addr_lfsx_805399E0_loc_0 = 0;
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
    uint32_t r0_rot_2 = 0;
...
loc_80539854:
{
    ...
    r6 = (r9 & 255);
    r7 = MemoryInline::FlatRead32((r8 + 18796));
    ...
    r0 = MemoryInline::FlatRead8((r6 + 7954));
...
loc_80539974:
{
    ...
    r0 = (r0_rot_3 & 1020);
    addr_lfsx_8053997C_loc_0 = (r3 + r0);
    f0.d = MemoryInline::FlatReadFloat32(addr_lfsx_8053997C_loc_0);
    SetCRFloatResident(cr, 0, f1.d, f0.d);
}
...
loc_805399DC:
{
    ...
    addr_lfsx_805399E0_loc_0 = (r3 + r0);
    f0.d = MemoryInline::FlatReadFloat32(addr_lfsx_805399E0_loc_0);
    SetCRFloatResident(cr, 0, f1.d, f0.d);
}
...
// RECOMP_REGISTRATION base 0x80539824 func_80539824 preserves=true fpr_mask=0x00000000
