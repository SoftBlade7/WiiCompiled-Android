...
extern "C" void func_8009AA30(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8009AA30:
{
    r3 = (r3 + 256);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80099880u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8009AA30 func_8009AA30 preserves=true fpr_mask=0x00000000
