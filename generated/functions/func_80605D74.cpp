...
extern "C" void func_80605D74(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80605D74:
{
    ...
    r0 = (r5 * 380);
    MemoryInline::FlatWrite32((r30 + 520), r5);
    r3 = (r3 + r0);
    r3 = (r3 + 152);
    // inline leaf 0x8063C820 (4 guest instruction(s))
    r0 = (r4 * 68);
...
// RECOMP_REGISTRATION base 0x80605D74 func_80605D74 preserves=true fpr_mask=0x00000000
