...
extern "C" void func_806D01D4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806D0200:
{
    ...
    r3 = (r1 + 72);
    f1.d = MemoryInline::FlatReadFloat32((r4 + 19028));
    r4 = (r1 + 8);
...
// RECOMP_REGISTRATION base 0x806D01D4 func_806D01D4 preserves=true fpr_mask=0x00000000
