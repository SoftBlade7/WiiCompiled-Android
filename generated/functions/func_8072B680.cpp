...
extern "C" void func_8072B680(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8072B82C:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r3 + -25184));
...
// RECOMP_REGISTRATION base 0x8072B680 func_8072B680 preserves=false fpr_mask=0xC0000000
