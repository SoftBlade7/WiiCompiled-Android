...
extern "C" void func_806F56D4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806F5768:
{
    f1.d = MemoryInline::FlatReadFloat32((r27 + 8896));
    r3 = (r1 + 8);
    r4 = (r1 + 20);
...
// RECOMP_REGISTRATION base 0x806F56D4 func_806F56D4 preserves=true fpr_mask=0x00000000
