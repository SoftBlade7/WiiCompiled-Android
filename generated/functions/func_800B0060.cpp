...
extern "C" void func_800B0060(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = (r13 + -27072);
    MemoryInline::FlatWrite32((r13 + -27064), r0);
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x800B0060 func_800B0060 preserves=true fpr_mask=0x00000000
