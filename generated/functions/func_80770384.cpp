...
extern "C" void func_80770384(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80770384:
{
    ...
    r3 = 0x808A0000u;
    r4 = 0x808D0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 16024));
    r4 = (r4 + -3056);
...
// RECOMP_REGISTRATION base 0x80770384 func_80770384 preserves=true fpr_mask=0x00000000
