...
extern "C" void func_8014B1A0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8014B1A0:
{
    ...
    r4 = MemoryInline::FlatRead8((r29 + 54));
...
// RECOMP_REGISTRATION base 0x8014B1A0 func_8014B1A0 preserves=true fpr_mask=0x00000000
