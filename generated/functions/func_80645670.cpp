...
extern "C" void func_80645670(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8064571C:
{
    ...
    r31 = 0x808A0000u;
    r4 = 1;
    f1.d = MemoryInline::FlatReadFloat32((r31 + -27884));
    ctx->lr = 0x80645760u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80645670 func_80645670 preserves=true fpr_mask=0x00000000
