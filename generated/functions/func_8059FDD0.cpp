...
extern "C" void func_8059FDD0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8059FDD0:
{
    ...
    f10.d = MemoryInline::FlatReadFloat32((r3 + 48));
    ...
    f12.d = MemoryInline::FlatReadFloat32((r3 + 40));
    f5.d = PpcFmulsInline(f31.d, f0.d);
    f9.d = MemoryInline::FlatReadFloat32((r3 + 44));
...
// RECOMP_REGISTRATION base 0x8059FDD0 func_8059FDD0 preserves=true fpr_mask=0x00000000
