...
extern "C" void func_800894D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8008953C:
{
    ...
    ctx->gpr[4] = r4;
    ctx->cr = cr;
    InvokeDirectCpu<0x800AF2F0u>(ctx);
    r0 = ctx->gpr[0];
    r4 = ctx->gpr[4];
    cr = ctx->cr;
...
loc_80089578:
{
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWrite32((r26 + 248), r0);
    goto loc_800895A4;
}
...
loc_80089590:
{
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWrite32((r26 + 252), r0);
}
...
// RECOMP_REGISTRATION base 0x800894D0 func_800894D0 preserves=true fpr_mask=0x00000000
