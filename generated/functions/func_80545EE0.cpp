...
extern "C" void func_80545EE0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r3 = (r3 + 65536);
    MemoryInline::FlatWrite32((r3 + -28004), r0);
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[5] = r5;
    ctx->cr = cr;
...
// RECOMP_REGISTRATION base 0x80545EE0 func_80545EE0 preserves=true fpr_mask=0x00000000
