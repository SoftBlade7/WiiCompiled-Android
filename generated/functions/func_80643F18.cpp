...
extern "C" void func_80643F18(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80643F18:
{
    r0 = MemoryInline::FlatRead32((r3 + 5792));
...
// RECOMP_REGISTRATION base 0x80643F18 func_80643F18 preserves=true fpr_mask=0x00000000
