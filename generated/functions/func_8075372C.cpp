...
extern "C" void func_8075372C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8075372C:
{
    ...
    r5 = 0x808D0000u;
    r0 = 0;
    MemoryInline::FlatWrite32((r24 + 180), r0);
    r3 = (r3 + -15752);
    r5 = (r5 + -15516);
    MemoryInline::FlatWrite32(r24, r3);
    r3 = 0x809C0000u;
    r4 = r20;
    MemoryInline::FlatWrite32((r24 + 176), r5);
    MemoryInline::FlatWrite32((r24 + 184), r0);
    MemoryInline::FlatWrite32((r24 + 188), r20);
    MemoryInline::FlatWrite32((r24 + 192), r26);
    ...
    MemoryInline::FlatWrite32((r24 + 204), r3);
    r30 = 0x808D0000u;
    r3 = (r24 + 176);
    r5 = 0;
    r12 = MemoryInline::FlatRead32((r24 + 176));
    r4 = MemoryInline::FlatRead32((r30 + -16096));
...
loc_807537E8:
{
    ...
    r20 = MemoryInline::FlatRead32((r24 + 204));
    r22 = r3;
    r3 = r21;
    r4 = r25;
    r5 = (r29 + 38);
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32(r21, r23);
    r3 = r20;
    MemoryInline::FlatWriteRam32((r21 + 180), r22);
    MemoryInline::FlatWriteRam32((r21 + 184), r20);
...
loc_inl2_cont_80590E04:
{
    ...
    MemoryInline::FlatWriteRam32((r21 + 188), r3);
    MemoryInline::FlatWriteRam32((r21 + 192), r26);
}
...
loc_8075386C:
{
    r3 = 0;
    r4_addr_2 = (r4 + r28);
    MemoryInline::FlatWrite32(r4_addr_2, r21);
    if ((static_cast<int32_t>(r27) < static_cast<int32_t>(0))) {
        goto loc_80753888;
    }
}
...
loc_807538C4:
{
    r0 = MemoryInline::FlatRead32((r30 + -16096));
...
// RECOMP_REGISTRATION base 0x8075372C func_8075372C preserves=true fpr_mask=0x00000000
