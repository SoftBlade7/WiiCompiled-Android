...
extern "C" void func_805E0C38(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805E0C38:
{
    ...
    r3 = (r30 + 68);
    r4 = (r4 + -28072);
    guest_range_0 = MemoryInline::ResolveRangeHost(r30, 0, 776u, false, true);
    ...
    r0 = 0;
    MemoryInline::WriteResolved32(guest_range_0, 772u, (r30 + 772), r30);
    r3 = (r30 + 780);
    MemoryInline::WriteResolved32(guest_range_0, 768u, (r30 + 768), r0);
    ctx->lr = 0x805E0C7Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80229DD8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFFFCE gpr_write=0xFFFFFFFF gpr_return=0x00000018 fpr_read=0xFFFFFFFE fpr_write=0xFFFFFFFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x805E0C38 func_805E0C38 preserves=true fpr_mask=0x00000000
