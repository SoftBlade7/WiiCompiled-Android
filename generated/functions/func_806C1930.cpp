...
extern "C" void func_806C1930(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806C1970:
{
    ...
    MemoryInline::FlatWriteFloat32((r31 + 1328), f2.d);
...
// RECOMP_REGISTRATION base 0x806C1930 func_806C1930 preserves=true fpr_mask=0x00000000
