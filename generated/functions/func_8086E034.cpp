...
extern "C" void func_8086E034(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8086E09C:
{
    ...
    r3 = 0x808B0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 8416));
    r3 = (r1 + 32);
...
// RECOMP_REGISTRATION base 0x8086E034 func_8086E034 preserves=true fpr_mask=0x00000000
