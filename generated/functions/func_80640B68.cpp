...
extern "C" void func_80640B68(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80640CA4:
{
    ...
    ctx->fpr[3] = f3;
    ctx->cr = cr;
    InvokeDirectCpu<0x806412F8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80640B68 func_80640B68 preserves=true fpr_mask=0x00000000
