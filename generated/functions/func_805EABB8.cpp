...
extern "C" void func_805EABB8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_805EABB8:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r12 = MemoryInline::FlatRead32((r28 + 208));
    r3 = (r28 + 208);
    r4 = 1;
    r5 = 0;
    ...
    if (MkwStateFreeAbiEnabled(0x805F0DB4u) && KnownTranslatedCpuCall<0x805F0DB4u>::kAvailable && !KnownTranslatedCpuCall<0x805F0DB4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805F0DB4u>()) {
        const auto state_free_result_805F0DB4_17E9 = func_805F0DB4_statefree_v0(r3, r4, cr, xer);
        cr = static_cast<uint32_t>(state_free_result_805F0DB4_17E9);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_805EAC98:
{
    ...
    r4 = (r28 + r23);
    r3 = r30;
    MemoryInline::FlatWrite32((r4 + 1704), r22);
    r4 = (r28 + 68);
    r5 = 0;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    r6 = ctx->gpr[6];
    r4 = (r29 & 255);
    r5 = MemoryInline::FlatRead32((r25 + -10424));
    r0 = (r4 * r26);
...
loc_805EAD54:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x805EAE94u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_805EAD78:
{
    ...
    xer = ctx->xer;
    r0 = 5;
    MemoryInline::FlatWrite32((r28 + 4088), r0);
    r3 = (r28 + 3512);
    r4 = (r28 + 88);
    r5 = 0;
    ctx->gpr[0] = r0;
    ...
    xer = ctx->xer;
    r0 = 6;
    MemoryInline::FlatWrite32((r28 + 4684), r0);
    r3 = (r28 + 4108);
    r4 = (r28 + 108);
    r5 = 0;
    ctx->gpr[0] = r0;
...
loc_805EAE4C:
{
    ...
    r0 = MemoryInline::FlatRead8((r3 + 1256));
...
loc_805EAE80:
{
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 40), 0, 48u, true, false);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r22 = MemoryInline::ReadResolved32(guest_range_1, 0u, (r1 + 40));
            r23 = MemoryInline::ReadResolved32(guest_range_1, 4u, (r1 + 44));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r24 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r1 + 48));
            r25 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r1 + 52));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r26 = MemoryInline::ReadResolved32(guest_range_1, 16u, (r1 + 56));
            r27 = MemoryInline::ReadResolved32(guest_range_1, 20u, (r1 + 60));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r28 = MemoryInline::ReadResolved32(guest_range_1, 24u, (r1 + 64));
            r29 = MemoryInline::ReadResolved32(guest_range_1, 28u, (r1 + 68));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r30 = MemoryInline::ReadResolved32(guest_range_1, 32u, (r1 + 72));
            r31 = MemoryInline::ReadResolved32(guest_range_1, 36u, (r1 + 76));
        }
    }
...
// RECOMP_REGISTRATION base 0x805EABB8 func_805EABB8 preserves=true fpr_mask=0x00000000
