...
extern "C" void func_8058348C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFFF3F gpr_write=0xFFFFFFFF gpr_return=0x00000018 fpr_read=0xFFFFFFFE fpr_write=0xFFFFFFFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x8058348C func_8058348C preserves=true fpr_mask=0x00000000
