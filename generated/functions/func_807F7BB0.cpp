...
extern "C" void func_807F7BB0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807F7BB0:
{
    ...
    r3 = 0x809C0000u;
    r4 = (r4 + 16400);
    MemoryInline::FlatWriteRam32((r3 + 16792), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x807F7BB0 func_807F7BB0 preserves=true fpr_mask=0x00000000
