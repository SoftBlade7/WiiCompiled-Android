...
extern "C" void func_807A43FC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807A4428:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x807A38E8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_807A44A8:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x807A38ECu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r3 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 21600));
    r3 = 90;
    r0 = (r4 & 16);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_807A44C0:
{
    MemoryInline::FlatWrite32((r31 + 476), r3);
    r0 = 0;
...
// RECOMP_REGISTRATION base 0x807A43FC func_807A43FC preserves=false fpr_mask=0x80000000
