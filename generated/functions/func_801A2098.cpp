...
extern "C" void func_801A2098(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801A2098:
{
    r5 = 0;
    r4 = 0x80000000u;
    MemoryInline::FlatWrite16((r3 + 416), static_cast<uint16_t>(r5));
...
loc_801A20B4:
{
    MemoryInline::FlatWriteRam32((r4 + 216), r5);
    ctx->gpr[0] = r0;
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
    ctx->cr = cr;
...
// RECOMP_REGISTRATION base 0x801A2098 func_801A2098 preserves=true fpr_mask=0x00000000
