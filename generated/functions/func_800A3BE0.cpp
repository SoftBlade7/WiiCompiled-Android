...
extern "C" void func_800A3BE0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800A3C54:
{
    r3 = MemoryInline::FlatRead8((r4 + 140));
...
// RECOMP_REGISTRATION base 0x800A3BE0 func_800A3BE0 preserves=true fpr_mask=0x00000000
