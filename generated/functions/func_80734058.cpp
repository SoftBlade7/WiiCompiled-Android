...
extern "C" void func_80734058(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80734058:
{
    r3 = MemoryInline::FlatRead8((r3 + 417));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80734058 func_80734058 preserves=true fpr_mask=0x00000000
