...
extern "C" void func_80188580(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80188580:
{
    ...
    r0 = MemoryInline::FlatRead32((r24 + 96));
    f3.d = MemoryInline::FlatReadFloat32((r24 + 76));
    r28 = (r24 + r0);
    r24_addr_0 = (r24 + r0);
    r5 = MemoryInline::FlatRead32(r24_addr_0);
    r7 = MemoryInline::FlatRead8((r28 + 18));
    f2.d = MemoryInline::FlatReadFloat32((r24 + 80));
...
loc_801885FC:
{
    f0.d = MemoryInline::FlatReadFloat32((r24 + 88));
    ...
    guest_range_2 = MemoryInline::ResolveRangeHost((r23 + 212), 0, 32u, false, true);
    MemoryInline::WriteResolvedFloat32(guest_range_2, 0u, (r23 + 212), f3.d);
    r27 = (r6 + 12);
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 4u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f2.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f1.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_2, 4u, (r23 + 216), f2.d);
        MemoryInline::WriteResolvedFloat32(guest_range_2, 8u, (r23 + 220), f1.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 12u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | static_cast<uint32_t>(r5)))) {
        MemoryInline::WriteResolvedFloat32(guest_range_2, 12u, (r23 + 224), f0.d);
        MemoryInline::WriteResolved32(guest_range_2, 16u, (r23 + 228), r5);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 20u, ((static_cast<uint64_t>(static_cast<uint32_t>(r4)) << 32) | static_cast<uint32_t>(r3)))) {
        MemoryInline::WriteResolved32(guest_range_2, 20u, (r23 + 232), r4);
        MemoryInline::WriteResolved32(guest_range_2, 24u, (r23 + 236), r3);
    }
    MemoryInline::WriteResolved32(guest_range_2, 28u, (r23 + 240), r0);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_80188670;
    }
}
...
loc_80188648:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead8((r23 + 244));
...
loc_801886A8:
{
    MemoryInline::FlatWrite32((r23 + 40), r3);
}

loc_801886AC:
{
    r0 = MemoryInline::FlatRead8((r24 + 92));
    r30 = 0;
    MemoryInline::FlatWrite8((r23 + 256), static_cast<uint8_t>(r30));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}

loc_801886BC:
{
    MemoryInline::FlatWrite32((r23 + 252), r30);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_80188774;
    }
}
...
loc_801886D8:
{
    MemoryInline::FlatWrite32((r23 + 252), r3);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_80188774;
    }
}
...
loc_801886E0:
{
    r3 = MemoryInline::FlatRead8((r24 + 92));
    r26 = 0;
    r0 = MemoryInline::FlatRead32((r24 + 100));
    r28 = 0;
    MemoryInline::FlatWrite8((r23 + 256), static_cast<uint8_t>(r3));
    r29 = (r24 + r0);
    goto loc_80188768;
}
...
loc_801886FC:
{
    ...
    r4 = 92;
    r3 = MemoryInline::FlatRead32((r23 + 252));
    r22 = (r24 + r0);
    r0 = MemoryInline::FlatRead8((r22 + 2));
    r3_addr_2 = (r3 + r28);
    MemoryInline::FlatWrite8(r3_addr_2, static_cast<uint8_t>(r0));
    r0 = MemoryInline::FlatRead32((r23 + 252));
    r3 = (r0 + r28);
...
loc_80188730:
{
    ...
    r0 = (r0_rot_4 & -4);
    r27_addr_4 = (r27 + r0);
    r0 = MemoryInline::FlatRead32(r27_addr_4);
    r4 = (r4 + r0);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_80188750;
    }
...
loc_80188768:
{
    r0 = MemoryInline::FlatRead8((r23 + 256));
...
// RECOMP_REGISTRATION base 0x80188580 func_80188580 preserves=true fpr_mask=0x00000000
