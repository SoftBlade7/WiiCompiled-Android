...
extern "C" void func_807A45E0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807A45E0:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r29 + 468));
    r4 = (r1 + 8);
...
{
    r3 = 0x809C0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 13872));
}
...
loc_807A46FC:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r4 + 1108));
...
// RECOMP_REGISTRATION base 0x807A45E0 func_807A45E0 preserves=true fpr_mask=0x00000000
