...
extern "C" void func_806B7334(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806B736C:
{
    ...
    r3_addr_2 = (r3 + r29);
    r28 = MemoryInline::FlatRead32(r3_addr_2);
...
loc_806B7380:
{
    MemoryInline::FlatWrite8((r28 + 240), static_cast<uint8_t>(r30));
    r3 = r28;
    r4 = 0;
...
loc_806B73EC:
{
    r4 = 0x808A0000u;
    r3 = 0x808A0000u;
    f30.d = MemoryInline::FlatReadFloat64((r4 + -3784));
    r27 = 0;
    f31.d = MemoryInline::FlatReadFloat32((r3 + -3764));
    r30 = 1127219200;
    goto loc_806B7458;
}
...
// RECOMP_REGISTRATION base 0x806B7334 func_806B7334 preserves=false fpr_mask=0xC0000000
