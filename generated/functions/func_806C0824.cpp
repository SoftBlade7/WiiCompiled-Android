...
extern "C" void func_806C0824(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806C0834:
{
    r4 = 0x808A0000u;
    r3 = r5;
    f0.d = MemoryInline::FlatReadFloat32((r4 + -2656));
...
// RECOMP_REGISTRATION base 0x806C0824 func_806C0824 preserves=true fpr_mask=0x00000000
