...
extern "C" void func_801A81B8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801A81B8:
{
    ...
    r4 = (r30 | -2147483648);
    r5 = (r1 + 8);
    r0 = MemoryInline::FlatRead32((r6 + 12692));
...
// RECOMP_REGISTRATION base 0x801A81B8 func_801A81B8 preserves=true fpr_mask=0x00000000
