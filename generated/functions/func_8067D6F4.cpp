...
extern "C" void func_8067D6F4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8067D6F4:
{
    ...
    r12 = MemoryInline::FlatRead32((r4 + 112));
    r3 = (r4 + 112);
    ...
    guest_range_1 = MemoryInline::ResolveRangeHost(r3, 0, 48u, true, false);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r24 = MemoryInline::ReadResolved32(guest_range_1, 0u, r3);
            r23 = MemoryInline::ReadResolved32(guest_range_1, 4u, (r3 + 4));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r12 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r3 + 8));
            r11 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r3 + 12));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r10 = MemoryInline::ReadResolved32(guest_range_1, 16u, (r3 + 16));
            r9 = MemoryInline::ReadResolved32(guest_range_1, 20u, (r3 + 20));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r8 = MemoryInline::ReadResolved32(guest_range_1, 24u, (r3 + 24));
            r7 = MemoryInline::ReadResolved32(guest_range_1, 28u, (r3 + 28));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r5 = MemoryInline::ReadResolved32(guest_range_1, 36u, (r3 + 36));
        }
    }
    {
    ...
    r4 = 0x808A0000u;
    r3 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r4 + -18568));
    r23 = 0;
    r25 = 255;
    f0.d = MemoryInline::FlatReadFloat32((r3 + -18564));
    r26 = r24;
    ...
    MemoryInline::FlatWriteRam8((r1 + 152), static_cast<uint8_t>(r23));
    MemoryInline::FlatWriteRam32((r1 + 156), r23);
    MemoryInline::FlatWriteRam32((r1 + 160), r23);
    MemoryInline::FlatWriteRam8((r1 + 164), static_cast<uint8_t>(r24));
    MemoryInline::FlatWriteRam32((r1 + 168), r23);
    ...
    MemoryInline::FlatWriteRam8((r1 + 210), static_cast<uint8_t>(r25));
    MemoryInline::FlatWriteRam8((r1 + 209), static_cast<uint8_t>(r25));
    MemoryInline::FlatWriteRam8((r1 + 208), static_cast<uint8_t>(r25));
    MemoryInline::FlatWriteRam8((r1 + 211), static_cast<uint8_t>(r25));
    MemoryInline::FlatWriteRam8((r1 + 214), static_cast<uint8_t>(r23));
    MemoryInline::FlatWriteRam8((r1 + 213), static_cast<uint8_t>(r23));
    MemoryInline::FlatWriteRam8((r1 + 212), static_cast<uint8_t>(r23));
    MemoryInline::FlatWriteRam8((r1 + 215), static_cast<uint8_t>(r25));
    MemoryInline::FlatWriteRam32((r1 + 56), r26);
...
loc_8067D8A4:
{
    r3 = MemoryInline::FlatRead32((r28 + 8660));
    r4 = (r1 + 56);
    r5 = (r30 + 2);
    r6 = 2;
    ctx->lr = 0x8067D8B8u;
...
// RECOMP_REGISTRATION base 0x8067D6F4 func_8067D6F4 preserves=true fpr_mask=0x00000000
