...
extern "C" void func_807369BC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807369BC:
{
    ...
    r6 = 0x809C0000u;
    r5 = MemoryInline::FlatRead32((r3 + 496));
    r26 = MemoryInline::FlatRead32((r6 + 11240));
    r29 = 0x808D0000u;
    r25 = MemoryInline::FlatRead32((r3 + 516));
    r30 = r3;
...
loc_80736A50:
{
    ...
    r24 = 1;
    MemoryInline::FlatWrite32(r31, r22);
    goto loc_80736AB0;
}
...
loc_80736A64:
{
    ...
    ctx->fpr[2] = f2;
    ctx->cr = cr;
    InvokeDirectCpu<0x8073684Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80736A94:
{
    r25 = (r25 + 1);
    r23 = (r23 + 1);
    r0 = PPC_Divw(static_cast<int32_t>(r25), static_cast<int32_t>(r28));
...
// RECOMP_REGISTRATION base 0x807369BC func_807369BC preserves=true fpr_mask=0x00000000
