...
extern "C" void func_808437A0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_808437A0:
{
    ...
    r3 = 0x809C0000u;
    r4 = (r4 + 17720);
    MemoryInline::FlatWriteRam32((r3 + 17816), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x808437A0 func_808437A0 preserves=true fpr_mask=0x00000000
