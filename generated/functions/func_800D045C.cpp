...
extern "C" void func_800D045C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800D045C:
{
    ...
    ctx->gpr[6] = r6;
    ctx->cr = cr;
    InvokeDirectCpu<0x800E9F08u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
    ...
    r30 = r4;
    r31 = r3;
    // inline leaf 0x800E9F00 (2 guest instruction(s))
    r3 = (r13 + -31928);
    // end of inlined leaf 0x800E9F00
    r6 = r3;
    r8 = r30;
    r7 = r31;
    r9 = r29;
...
loc_800D0558:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x800D2808u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x800D045C func_800D045C preserves=true fpr_mask=0x00000000
