...
extern "C" void func_80717004(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8071702C:
{
    ...
    r31 = (r29 + 2196);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r29)) + static_cast<uint64_t>(static_cast<uint32_t>(2196)) + (static_cast<uint64_t>(static_cast<uint32_t>(0)) & 1u);
...
// RECOMP_REGISTRATION base 0x80717004 func_80717004 preserves=true fpr_mask=0x00000000
