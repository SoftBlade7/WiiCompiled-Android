...
extern "C" void func_8065C0EC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8065C0EC:
{
    ...
    r0 = MemoryInline::FlatRead32((r3 + 8440));
...
{
    r4 = 0x809C0000u;
    MemoryInline::FlatWriteRam32((r4 + 8440), r3);
}
...
// RECOMP_REGISTRATION base 0x8065C0EC func_8065C0EC preserves=true fpr_mask=0x00000000
