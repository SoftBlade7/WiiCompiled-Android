...
extern "C" void func_807C6E64(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_807C6E64:
{
    ...
    r31 = MemoryInline::FlatRead32((r5 + 108));
...
// RECOMP_REGISTRATION base 0x807C6E64 func_807C6E64 preserves=true fpr_mask=0x00000000
