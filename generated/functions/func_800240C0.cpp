...
extern "C" void func_800240C0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800240C0:
{
    r3 = MemoryInline::FlatRead32((r13 + -27444));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x800240C0 func_800240C0 preserves=true fpr_mask=0x00000000
