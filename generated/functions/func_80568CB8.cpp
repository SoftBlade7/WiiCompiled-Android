...
extern "C" void func_80568CB8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80568CB8:
{
    ...
    r30 = r3;
    f4.d = MemoryInline::FlatReadFloat32((r5 + 160));
    r4 = 1;
    ctx->lr = 0x80568CF4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x80568CB8 func_80568CB8 preserves=true fpr_mask=0x00000000
