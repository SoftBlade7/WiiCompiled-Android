...
extern "C" void func_8006C220(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8006C220:
{
    ...
    f5.d = MemoryInline::FlatReadFloat32((r2 + -29336));
...
// RECOMP_REGISTRATION base 0x8006C220 func_8006C220 preserves=true fpr_mask=0x00000000
