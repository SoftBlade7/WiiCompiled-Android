...
extern "C" void func_801E6098(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
    uint32_t r3_rot_1 = 0;
...
{
    r6 = (r30 + 64);
    MemoryInline::FlatWriteRam32((r30 + 64), r26);
    r4 = MemoryInline::FlatRead32((r1 + 8));
    r3 = (r31 + 8624);
    MemoryInline::FlatWriteRam32((r6 + 4), r27);
    r8 = (r30 + 96);
    r5 = 14;
    r7 = 32;
    MemoryInline::FlatWriteRam32((r6 + 8), r28);
    r9 = 32;
    ctx->lr = 0x801E61DCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x801E6098 func_801E6098 preserves=true fpr_mask=0x00000000
