...
extern "C" void func_8064A698(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8064A714:
{
    ...
    r21 = MemoryInline::ReadResolved32(guest_range_0, 0u, r31);
    r6 = r29;
    r22 = MemoryInline::ReadResolved32(guest_range_0, 4u, (r31 + 4));
    r3 = (r1 + 8);
    r23 = MemoryInline::ReadResolved32(guest_range_0, 8u, (r31 + 8));
    r5 = (r26 + 40);
    r24 = MemoryInline::ReadResolved32(guest_range_0, 12u, (r31 + 12));
    r4 = 15;
    {
        ...
        if (resolved_pair.valid) {
            ...
            r25 = MemoryInline::ReadResolved32(guest_range_0, 16u, (r31 + 16));
            r12 = MemoryInline::ReadResolved32(guest_range_0, 20u, (r31 + 20));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r11 = MemoryInline::ReadResolved32(guest_range_0, 24u, (r31 + 24));
            r10 = MemoryInline::ReadResolved32(guest_range_0, 28u, (r31 + 28));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r9 = MemoryInline::ReadResolved32(guest_range_0, 32u, (r31 + 32));
            r8 = MemoryInline::ReadResolved32(guest_range_0, 36u, (r31 + 36));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r7 = MemoryInline::ReadResolved32(guest_range_0, 40u, (r31 + 40));
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 0u, ((static_cast<uint64_t>(static_cast<uint32_t>(r21)) << 32) | static_cast<uint32_t>(r22)))) {
        MemoryInline::WriteResolved32(guest_range_1, 0u, (r1 + 24), r21);
        MemoryInline::WriteResolved32(guest_range_1, 4u, (r1 + 28), r22);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 8u, ((static_cast<uint64_t>(static_cast<uint32_t>(r23)) << 32) | static_cast<uint32_t>(r24)))) {
        MemoryInline::WriteResolved32(guest_range_1, 8u, (r1 + 32), r23);
        MemoryInline::WriteResolved32(guest_range_1, 12u, (r1 + 36), r24);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 16u, ((static_cast<uint64_t>(static_cast<uint32_t>(r25)) << 32) | static_cast<uint32_t>(r12)))) {
        MemoryInline::WriteResolved32(guest_range_1, 16u, (r1 + 40), r25);
        MemoryInline::WriteResolved32(guest_range_1, 20u, (r1 + 44), r12);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r11)) << 32) | static_cast<uint32_t>(r10)))) {
        MemoryInline::WriteResolved32(guest_range_1, 24u, (r1 + 48), r11);
        MemoryInline::WriteResolved32(guest_range_1, 28u, (r1 + 52), r10);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 32u, ((static_cast<uint64_t>(static_cast<uint32_t>(r9)) << 32) | static_cast<uint32_t>(r8)))) {
        MemoryInline::WriteResolved32(guest_range_1, 32u, (r1 + 56), r9);
        MemoryInline::WriteResolved32(guest_range_1, 36u, (r1 + 60), r8);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 40u, ((static_cast<uint64_t>(static_cast<uint32_t>(r7)) << 32) | static_cast<uint32_t>(r0)))) {
...
// RECOMP_REGISTRATION base 0x8064A698 func_8064A698 preserves=true fpr_mask=0x00000000
