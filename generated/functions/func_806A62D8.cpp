...
extern "C" void func_806A62D8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806A6314:
{
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWrite8((r31 + 1973), static_cast<uint8_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x806A62D8 func_806A62D8 preserves=true fpr_mask=0x00000000
