...
extern "C" void func_8014B2B0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8014B2B0:
{
    r5 = MemoryInline::FlatRead16((r26 + 14));
    r0 = 5;
    r3 = (r29 + 24);
    r4 = 3;
...
// RECOMP_REGISTRATION base 0x8014B2B0 func_8014B2B0 preserves=true fpr_mask=0x00000000
