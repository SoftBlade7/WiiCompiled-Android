...
extern "C" void func_801D5F44(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801D5F8C:
{
    ...
    r31 = r30;
    r3 = (256 - r0);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(256) >= static_cast<uint32_t>(r0) ? 1u : 0u) << 29);
...
// RECOMP_REGISTRATION base 0x801D5F44 func_801D5F44 preserves=true fpr_mask=0x00000000
