...
extern "C" void func_805D13C4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r4 = 0x809C0000u;
    MemoryInline::FlatWriteRam32((r4 + 7160), r3);
...
// RECOMP_REGISTRATION base 0x805D13C4 func_805D13C4 preserves=true fpr_mask=0x00000000
