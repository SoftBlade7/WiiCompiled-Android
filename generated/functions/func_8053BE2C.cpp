...
extern "C" void func_8053BE2C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8053C0A4:
{
    r0_rot_3 = PpcRotl32Inline(static_cast<uint32_t>(r19), static_cast<uint32_t>(1));
    r0 = (r0_rot_3 & 510);
    r4 = (r15 + r0);
...
{
    r4 = 0x809C0000u;
    r3_rot_7 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(5));
    r3 = (r3_rot_7 & 8160);
...
loc_8053C404:
{
    ...
    r3_addr_17 = (r3 + r11);
    r3 = MemoryInline::FlatRead8(r3_addr_17);
}
...
loc_8053C454:
{
    r3_rot_15 = PpcRotl32Inline(static_cast<uint32_t>(r12), static_cast<uint32_t>(2));
    r3 = (r3_rot_15 & 1020);
    r3 = (r6 + r3);
...
loc_8053C798:
{
    ...
    // inline leaf 0x80536230 (6 guest instruction(s))
    r0 = MemoryInline::FlatRead32((r3 + 40));
    r3_rot_18 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(1));
    r3 = (r3_rot_18 & 1);
    r5 = (static_cast<int32_t>(r0) >> 31);
    r0_subfc_min_9 = r0;
    r0 = (r0_subfc_min_9 - r4);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(r0_subfc_min_9) >= static_cast<uint32_t>(r4) ? 1u : 0u) << 29);
    r3_adde_right_9 = r3;
    r3_ca_9 = (xer >> 29) & 1u;
    r3 = (r5 + r3_adde_right_9);
    r3 = (r3 + r3_ca_9);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r5)) + static_cast<uint64_t>(static_cast<uint32_t>(r3_adde_right_9)) + (static_cast<uint64_t>(static_cast<uint32_t>(r3_ca_9)) & 1u);
        xer = (xer & 0xDFFFFFFFu) | (static_cast<uint32_t>((ppcCarryWide >> 32) & 1u) << 29);
    }
    // end of inlined leaf 0x80536230
}
...
{
    r3 = MemoryInline::FlatRead32((r15 + 4));
    r0_rot_22 = PpcRotl32Inline(static_cast<uint32_t>(r16), static_cast<uint32_t>(2));
    r0 = (r0_rot_22 & 1020);
    r3 = MemoryInline::FlatRead32((r3 + 12));
    r3_addr_27 = (r3 + r0);
...
{
    r3 = MemoryInline::FlatRead32((r15 + 4));
    r0_rot_24 = PpcRotl32Inline(static_cast<uint32_t>(r17), static_cast<uint32_t>(2));
    r0 = (r0_rot_24 & 1020);
    r3 = MemoryInline::FlatRead32((r3 + 12));
    r3_addr_29 = (r3 + r0);
...
loc_8053C924:
{
    ...
    r3 = MemoryInline::FlatRead32((r3 + 12));
    r3_addr_32 = (r3 + r7);
    r6 = MemoryInline::FlatRead32(r3_addr_32);
...
// RECOMP_REGISTRATION base 0x8053BE2C func_8053BE2C preserves=true fpr_mask=0x00000000
