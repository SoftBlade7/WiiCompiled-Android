...
extern "C" void func_806FF8A4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806FF8C8:
{
    r6 = MemoryInline::FlatRead32((r4 + 10392));
    r29 = r3;
    r31 = 0;
    r5 = (r6 + 12);
    r27 = r5;
...
loc_806FF924:
{
    if ((static_cast<uint32_t>(r0) <= static_cast<uint32_t>(417))) {
        goto loc_806FF954;
    }
}
...
loc_806FF9C4:
{
    ...
    f1.d = MemoryInline::FlatReadFloat64((r5 + 5696));
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8009DEE0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_806FFA58:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x806FFAB4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x806FA604u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_806FFA78:
{
    ...
    xer = ctx->xer;
    r4 = 0x809C0000u;
    MemoryInline::FlatWriteRam32((r4 + 9868), r3);
}
...
// RECOMP_REGISTRATION base 0x806FF8A4 func_806FF8A4 preserves=false fpr_mask=0x80000000
