...
extern "C" void func_8077ACBC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8077ACBC:
{
    ...
    r3 = 0x808A0000u;
    r5 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + 17312));
...
// RECOMP_REGISTRATION base 0x8077ACBC func_8077ACBC preserves=true fpr_mask=0x00000000
