...
extern "C" void func_80176824(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80176854:
{
    ...
    ctx->gpr[5] = r5;
    ctx->cr = cr;
    InvokeDirectCpu<0x80124844u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r6 = ctx->gpr[6];
    ...
    MemoryInline::FlatWrite32((r3 + 88), r28);
    MemoryInline::FlatWrite32((r3 + 84), r31);
    MemoryInline::FlatWrite8((r3 + 93), static_cast<uint8_t>(r29));
    MemoryInline::FlatWrite32((r3 + 80), r30);
}
...
// RECOMP_REGISTRATION base 0x80176824 func_80176824 preserves=true fpr_mask=0x00000000
