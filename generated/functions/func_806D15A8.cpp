...
extern "C" void func_806D15A8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806D1618:
{
    r3 = 0x808C0000u;
    r4 = 1127219200;
    r5 = MemoryInline::FlatRead32((r3 + 19388));
    r6 = 0x808A0000u;
    r0 = MemoryInline::FlatRead32((r30 + 192));
    r3 = 0x808A0000u;
    r5 = (r5 ^ -2147483648);
    MemoryInline::FlatWriteRam32((r1 + 140), r5);
    f1.d = MemoryInline::FlatReadFloat64((r6 + -624));
    ...
    f1.d = MemoryInline::FlatReadFloat64((r3 + -608));
...
loc_806D1714:
{
    r4 = 0x808C0000u;
    r3 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + -596));
    f1.d = MemoryInline::FlatReadFloat32((r4 + 19384));
...
loc_806D17E8:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite8((r30 + 304), static_cast<uint8_t>(r31));
...
// RECOMP_REGISTRATION base 0x806D15A8 func_806D15A8 preserves=false fpr_mask=0x80000000
