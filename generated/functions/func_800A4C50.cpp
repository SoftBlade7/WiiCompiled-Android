...
extern "C" void func_800A4C50(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800A4C7C:
{
    ...
    r3 = ctx->gpr[3];
    r4 = PPC_Divwu(static_cast<uint32_t>(r29), static_cast<uint32_t>(r30));
    r0 = 0;
    r31 = r3;
...
// RECOMP_REGISTRATION base 0x800A4C50 func_800A4C50 preserves=true fpr_mask=0x00000000
