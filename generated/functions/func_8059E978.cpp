...
extern "C" void func_8059E978(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8059E978:
{
    ...
    ctx->gpr[5] = r5;
    ctx->gpr[6] = r6;
    InvokeDirectCpu<0x80563410u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
...
// RECOMP_REGISTRATION base 0x8059E978 func_8059E978 preserves=true fpr_mask=0x00000000
