...
extern "C" void func_801DB154(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_801DB184:
{
    if ((static_cast<uint32_t>(r0) != static_cast<uint32_t>(266))) {
        goto loc_801DB240;
    }
}
...
{
    r0 = MemoryInline::FlatRead32((r3 + 4));
    r5_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(27));
    r5 = (r5_rot_1 & -134217728);
    r6_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(1));
    r6 = (r6_rot_1 & 1);
    r0 = (r0 & 256);
...
// RECOMP_REGISTRATION base 0x801DB154 func_801DB154 preserves=true fpr_mask=0x00000000
