...
extern "C" void func_80753A0C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80753A94:
{
    r30 = MemoryInline::FlatRead32((r31 + 196));
    r3 = 0x808D0000u;
    r0 = MemoryInline::FlatRead32((r3 + -16092));
    r3 = 0;
}
...
loc_80753AF4:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80753268u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80753AF8:
{
    ...
    r3 = 0x808D0000u;
    r4 = (r4 + 1);
    MemoryInline::FlatWrite32((r31 + 196), r4);
    r0 = MemoryInline::FlatRead32((r3 + -16096));
...
// RECOMP_REGISTRATION base 0x80753A0C func_80753A0C preserves=true fpr_mask=0x00000000
