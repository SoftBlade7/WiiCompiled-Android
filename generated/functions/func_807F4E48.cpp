...
extern "C" void func_807F4E48(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807F4E48:
{
    ...
    r3 = 0x809C0000u;
    r4 = (r4 + 7812);
    MemoryInline::FlatWriteRam32((r3 + 16576), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x807F4E48 func_807F4E48 preserves=true fpr_mask=0x00000000
