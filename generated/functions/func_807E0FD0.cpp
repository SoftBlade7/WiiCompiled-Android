...
extern "C" void func_807E0FD0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807E0FD0:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r3 + 5968));
    r31 = 0x808A0000u;
    r0 = (r30 + 0);
    r28 = (r26 + 372);
    r3 = (r3 * 20);
...
// RECOMP_REGISTRATION base 0x807E0FD0 func_807E0FD0 preserves=true fpr_mask=0x00000000
