...
extern "C" void func_807F4A08(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807F4A08:
{
    ...
    r0 = MemoryInline::FlatRead8((r30 + 408));
...
loc_807F4A94:
{
    ...
    r5 = 0x808B0000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r5 + -24504));
    ctx->lr = 0x807F4AB0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_807F4ADC:
{
    r5 = MemoryInline::FlatRead8((r30 + 400));
    r3 = r30;
    r4 = 229;
    ctx->lr = 0x807F4AECu;
    ctx->gpr[0] = r0;
...
loc_807F4B1C:
{
    MemoryInline::FlatWrite8((r30 + 408), static_cast<uint8_t>(r31));
    r3 = (r30 + 152);
    r4 = 0;
    // inline leaf 0x8063C820 (4 guest instruction(s))
    r0 = (r4 * 68);
    ...
    r3 = (r3 + r0);
    // end of inlined leaf 0x8063C820
    r4 = MemoryInline::FlatRead8((r30 + 408));
    r0 = 1127219200;
    MemoryInline::FlatWriteRam32((r1 + 12), r4);
    r4 = 0x808B0000u;
    f2.d = MemoryInline::FlatReadFloat64((r4 + -24496));
    r5 = 0x808B0000u;
    MemoryInline::FlatWriteRam32((r1 + 8), r0);
    r4 = 0;
    f0.d = MemoryInline::FlatReadFloat32((r5 + -24500));
...
loc_807F4B60:
{
    ...
    r4 = MemoryInline::FlatRead32((r30 + 416));
    r0 = (r3 + 1);
...
// RECOMP_REGISTRATION base 0x807F4A08 func_807F4A08 preserves=true fpr_mask=0x00000000
