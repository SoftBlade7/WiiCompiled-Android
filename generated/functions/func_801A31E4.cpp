...
extern "C" void func_801A31E4(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = 1;
    MemoryInline::FlatWrite32((r13 + -25392), r0);
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x801A31E4 func_801A31E4 preserves=true fpr_mask=0x00000000
