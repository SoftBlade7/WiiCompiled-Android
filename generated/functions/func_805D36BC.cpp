...
extern "C" void func_805D36BC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805D36BC:
{
    ...
    r31 = r3;
    r0 = MemoryInline::FlatRead8((r3 + 120));
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFE07B gpr_write=0xFFFFC07B gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x805D36BC func_805D36BC preserves=true fpr_mask=0x00000000
