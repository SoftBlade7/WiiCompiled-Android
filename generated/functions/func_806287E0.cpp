...
extern "C" void func_806287E0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806287E0:
{
    ...
    r11 = MemoryInline::FlatRead32((r29 + 2020));
    ...
    r8 = MemoryInline::FlatRead32((r29 + 2032));
    ...
    r25 = 0x808C0000u;
    r31 = 0x808C0000u;
    guest_range_4 = MemoryInline::ResolveRangeHost((r29 + 2044), 0, 60u, true, false);
    r9 = MemoryInline::ReadResolved32(guest_range_4, 0u, (r29 + 2044));
    r4 = 0x80630000u;
    ...
    MemoryInline::WriteResolved32(guest_range_1, 16u, (r28 + 1636), r8);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r19 = MemoryInline::ReadResolved32(guest_range_4, 12u, (r29 + 2056));
        }
    }
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r22 = MemoryInline::ReadResolved32(guest_range_4, 24u, (r29 + 2068));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r25 = MemoryInline::ReadResolved32(guest_range_4, 36u, (r29 + 2080));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r12 = MemoryInline::ReadResolved32(guest_range_4, 48u, (r29 + 2092));
        }
    }
...
// RECOMP_REGISTRATION base 0x806287E0 func_806287E0 preserves=true fpr_mask=0x00000000
