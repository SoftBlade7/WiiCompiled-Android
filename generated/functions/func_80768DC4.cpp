...
extern "C" void func_80768DC4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80768E04:
{
    ...
    r4 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r4 + 15424));
    r4 = 0;
...
// RECOMP_REGISTRATION base 0x80768DC4 func_80768DC4 preserves=true fpr_mask=0x00000000
