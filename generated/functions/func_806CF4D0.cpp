...
extern "C" void func_806CF4D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806CF4D0:
{
    ...
    r0 = (r0_rot_0 & -16);
    r4_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(4));
    r4 = (r4_rot_0 & -16);
    r3 = (r1 + 68);
    r4 = (r5 + r4);
    r5 = (r5 + r0);
...
loc_806CF600:
{
    ...
    r5 = (r1 + 104);
    // inline leaf 0x80514838 (13 guest instruction(s))
    guest_range_0 = MemoryInline::ResolveRangeHost((r4 + -4), 0, 268u, true, false);
    f1.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 12u, (r4 + 8));
    f0.d = MemoryInline::FlatReadFloat32((r5 + 8));
    f3.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 8u, (r4 + 4));
    f4.d = static_cast<double>(PpcForceSingleValueInline(f1.d + f0.d));
    f2.d = MemoryInline::FlatReadFloat32((r5 + 4));
    f1.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 4u, r4);
    f0.d = MemoryInline::FlatReadFloat32(r5);
    f2.d = static_cast<double>(PpcForceSingleValueInline(f3.d + f2.d));
    MemoryInline::FlatWriteRamFloat32((r3 + 8), f4.d);
    f0.d = static_cast<double>(PpcForceSingleValueInline(f1.d + f0.d));
    ...
    {
        const auto resolved_pair = MemoryInline::ReadResolvedPair32(guest_range_0, 240u);
        if (resolved_pair.valid) {
            f3.d = PpcBitCastToFloatInline(resolved_pair.second);
            f2.d = PpcBitCastToFloatInline(resolved_pair.first);
        } else {
            f3.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 244u, (r4 + 8));
            f2.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 240u, (r4 + 4));
        }
    }
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 236u, r4);
    ...
    MemoryInline::FlatWriteRamFloat32(r3, f0.d);
    // end of inlined leaf 0x8051486C
    r0 = MemoryInline::ReadResolved32(guest_range_0, 264u, (r30 + 308));
...
// RECOMP_REGISTRATION base 0x806CF4D0 func_806CF4D0 preserves=false fpr_mask=0x80000000
