...
extern "C" void func_80773C5C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80773C5C:
{
    ...
    r3 = r30;
    f1.d = MemoryInline::FlatReadFloat64((r4 + 16608));
    r5 = MemoryInline::FlatRead16((r5 + 44));
    r5 = (r5 << 16);
    r5 = (static_cast<int32_t>(r5) >> 16);
    MemoryInline::FlatWrite32((r30 + 180), r5);
...
// RECOMP_REGISTRATION base 0x80773C5C func_80773C5C preserves=true fpr_mask=0x00000000
