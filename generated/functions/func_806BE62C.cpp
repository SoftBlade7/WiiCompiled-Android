...
extern "C" void func_806BE62C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_806BE62C:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r4 + 10032));
    f0.d = MemoryInline::FlatReadFloat32((r31 + 10036));
    ...
    f3 = ctx->fpr[3];
    f0.d = MemoryInline::FlatReadFloat32((r31 + 10036));
    f31.d = MemoryInline::FlatReadFloat32((r29 + 152));
    f0.d = static_cast<double>(PpcForceSingleValueInline(f0.d + f1.d));
    f1.d = f31.d;
    MemoryInline::FlatWriteFloat32((r28 + 348), f0.d);
    ...
    f2 = ctx->fpr[2];
    f3 = ctx->fpr[3];
    r4 = MemoryInline::FlatRead32((r28 + 340));
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFF00E gpr_write=0xFFFFFFFF gpr_return=0x00000018 fpr_read=0xFFFFC018 fpr_write=0xFFFFFFFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x806BE62C func_806BE62C preserves=false fpr_mask=0x80000000
