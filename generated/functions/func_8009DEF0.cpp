...
extern "C" void func_8009DEF0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8009DEF0:
{
    ...
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x8009F340u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8009DEF0 func_8009DEF0 preserves=true fpr_mask=0x00000000
