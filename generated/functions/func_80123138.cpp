...
extern "C" void func_80123138(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80123138:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800FAE70u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80123184:
{
    r3 = MemoryInline::FlatRead32((r15 + 28));
    r4 = (r21 + 0);
    ctx->lr = 0x80123190u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800FB778u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801231D0:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r0_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r16), static_cast<uint32_t>(4));
    r0 = (r0_rot_1 & -16);
    MemoryInline::FlatWrite32(r18, r14);
    r26 = (r13 + -29792);
    r25 = 0;
...
loc_80123254:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32(r14, r19);
    r4 = (r21 + 20);
    r3 = MemoryInline::FlatRead32((r15 + 28));
    ctx->lr = 0x80123270u;
    ctx->gpr[0] = r0;
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r16), static_cast<int32_t>(r3));
}
...
loc_80123280:
{
    r20 = MemoryInline::FlatRead32((r1 + 12));
    r18 = 0;
    goto loc_80123614;
}
...
loc_801232E4:
{
    MemoryInline::FlatWrite32((r19 + 4), r25);
    r0 = MemoryInline::FlatRead32((r1 + 56));
    MemoryInline::FlatWrite8((r19 + 8), static_cast<uint8_t>(r0));
    goto loc_80123608;
}
...
loc_80123328:
{
    MemoryInline::FlatWrite32((r19 + 4), r22);
    r0 = MemoryInline::FlatRead32((r1 + 52));
    MemoryInline::FlatWrite16((r19 + 8), static_cast<uint16_t>(r0));
    goto loc_80123608;
}
...
loc_8012336C:
{
    MemoryInline::FlatWrite32((r19 + 4), r23);
    r0 = MemoryInline::FlatRead32((r1 + 48));
    MemoryInline::FlatWrite32((r19 + 8), r0);
    goto loc_80123608;
}
...
loc_80123390:
{
    ...
    ctx->fpr[0] = f0;
    ctx->cr = cr;
    InvokeDirectCpu<0x800FB5ACu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801233B0:
{
    MemoryInline::FlatWrite32((r19 + 4), r24);
...
loc_80123414:
{
    MemoryInline::FlatWrite32((r19 + 4), r27);
...
loc_80123468:
{
    ...
    r3_addr_5 = (r3 + r0);
    MemoryInline::FlatWrite8(r3_addr_5, static_cast<uint8_t>(r25));
    goto loc_80123478;
}
...
loc_80123478:
{
    ...
    ctx->fpr[0] = f0;
    ctx->cr = cr;
    InvokeDirectCpu<0x800F4774u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80123490:
{
    MemoryInline::FlatWrite32((r19 + 4), r28);
    MemoryInline::FlatWrite32((r19 + 8), r3);
    goto loc_80123608;
}
...
loc_801234E0:
{
    ...
    r4 = (r13 + -29788);
    r3_addr_7 = (r3 + r0);
    MemoryInline::FlatWrite8(r3_addr_7, static_cast<uint8_t>(r25));
    r3 = MemoryInline::FlatRead32((r1 + 24));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_80123504:
{
    MemoryInline::FlatWrite32((r19 + 4), r29);
    MemoryInline::FlatWrite32((r19 + 8), r0);
    goto loc_80123608;
}
...
loc_80123524:
{
    ...
    ctx->fpr[0] = f0;
    ctx->cr = cr;
    InvokeDirectCpu<0x800FB478u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80123544:
{
    MemoryInline::FlatWrite32((r19 + 4), r30);
    r0 = MemoryInline::FlatRead32((r1 + 64));
    r3 = MemoryInline::FlatRead32((r1 + 68));
    MemoryInline::FlatWrite32((r19 + 12), r3);
    MemoryInline::FlatWrite32((r19 + 8), r0);
    goto loc_80123608;
}
...
loc_80123570:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800FB26Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
{
    r17 = 0;
    MemoryInline::FlatWriteRam32((r1 + 16), r17);
}
...
loc_801235EC:
{
    ...
    MemoryInline::FlatWrite32((r19 + 12), r0);
    MemoryInline::FlatWrite32((r19 + 8), r17);
    goto loc_80123608;
}
...
// RECOMP_REGISTRATION base 0x80123138 func_80123138 preserves=true fpr_mask=0x00000000
