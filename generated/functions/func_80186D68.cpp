...
extern "C" void func_80186D68(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80186D68:
{
    ...
    r3 = (r3 + r5);
    r3 = (r3 + r0);
    r3 = MemoryInline::FlatRead8((r3 + 212));
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[5] = r5;
    return;
...
// RECOMP_REGISTRATION base 0x80186D68 func_80186D68 preserves=true fpr_mask=0x00000000
