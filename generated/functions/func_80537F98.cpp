...
extern "C" void func_80537F98(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80537FF8:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r3 + 540));
...
// RECOMP_GUEST_ABI gpr_read=0xC000001F gpr_write=0xC000001B gpr_return=0x00000018 fpr_read=0x8000001F fpr_write=0x8000001F fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80537F98 func_80537F98 preserves=false fpr_mask=0x80000000
