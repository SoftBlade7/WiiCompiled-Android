...
extern "C" void func_80636D08(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80636E44:
{
    r3 = r28;
    r4 = r31;
    // inline leaf 0x805F2134 (14 guest instruction(s))
}
...
loc_inl3_cont_805F2134:
{
    // end of inlined leaf 0x805F2134
...
loc_80636EE0:
{
    r0 = MemoryInline::FlatRead32((r30 + 564));
}
...
loc_80636F48:
{
    r3 = MemoryInline::FlatRead32((r28 + 156));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(0));
}
...
// RECOMP_REGISTRATION base 0x80636D08 func_80636D08 preserves=true fpr_mask=0x00000000
