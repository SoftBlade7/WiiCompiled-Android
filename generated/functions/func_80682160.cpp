...
extern "C" void func_80682160(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_80682160:
{
    ...
    f12 = ctx->fpr[12];
    r6 = (r31 + 20);
    r8 = MemoryInline::FlatRead8((r31 + 20));
...
loc_inl2_cont_8019A0C0:
{
    ...
    r3 = 4;
    r0 = MemoryInline::FlatRead8((r30 + 245));
    ...
    r6 = (r31 + 24);
    r8 = MemoryInline::FlatRead8((r31 + 24));
    r7 = MemoryInline::FlatRead8((r6 + 1));
    r4 = (r1 + 8);
    r5 = MemoryInline::FlatRead8((r6 + 2));
    r3 = 4;
    ...
    r5 = MemoryInline::FlatRead32((r30 + 232));
    r3 = 144;
    r4 = 0;
...
{
    r6 = (r6 + 1);
    guest_range_2 = MemoryInline::ResolveRangeHost((r30 + 172), 0, 48u, true, false);
    r7 = MemoryInline::ReadResolved32(guest_range_2, 0u, (r30 + 172));
    r6 = (r6 * r4);
    r6 = (r5 + r6);
    r6 = (r6 * 12);
    r6 = (r7 + r6);
    ...
    r6 = MemoryInline::ReadResolved32(guest_range_2, 44u, (r30 + 216));
    r7 = MemoryInline::ReadResolved32(guest_range_2, 16u, (r30 + 188));
    r6 = (r6 + 1);
    r6 = (r6 * r4);
    r6 = (r5 + r6);
    r6 = (r6 * 12);
...
loc_80682708:
{
    r6 = MemoryInline::FlatRead32((r30 + 216));
}
...
// RECOMP_REGISTRATION base 0x80682160 func_80682160 preserves=true fpr_mask=0x00000000
