...
extern "C" void func_801342D8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801342F8:
{
    ...
    r3 = 7;
    MemoryInline::WriteResolved8(guest_range_0, 8u, (r1 + 16), static_cast<uint8_t>(r0));
    ctr = r12;
    ctx->lr = 0x80134330u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x801342D8 func_801342D8 preserves=true fpr_mask=0x00000000
