...
extern "C" void func_8051F37C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8051F37C:
{
    MemoryInline::FlatWrite8((r3 + 81), static_cast<uint8_t>(r4));
    return;
}
...
// RECOMP_REGISTRATION base 0x8051F37C func_8051F37C preserves=true fpr_mask=0x00000000
