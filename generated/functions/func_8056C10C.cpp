...
extern "C" void func_8056C10C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8056C10C:
{
    r5 = r3;
    r3 = r4;
    r4 = MemoryInline::FlatRead32((r5 + 148));
    r6 = (r5 + 152);
    ...
    ctx->gpr[5] = r5;
    ctx->gpr[6] = r6;
    InvokeDirectCpu<0x805776D4u>(ctx);
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
    r6 = ctx->gpr[6];
...
// RECOMP_REGISTRATION base 0x8056C10C func_8056C10C preserves=true fpr_mask=0x00000000
