...
extern "C" void func_8077CC78(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8077CC78:
{
    ...
    r8 = 0;
    r7 = (r1 + 8);
    r0 = MemoryInline::FlatRead8((r4 + 17520));
    r4 = (r1 + 16);
...
// RECOMP_REGISTRATION base 0x8077CC78 func_8077CC78 preserves=true fpr_mask=0x00000000
