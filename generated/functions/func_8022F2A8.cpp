...
extern "C" void func_8022F2A8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8022F2D8:
{
    r29 = MemoryInline::FlatRead16((r24 + 6));
    r31 = 0;
    r30 = 0;
    goto loc_8022F324;
}
...
loc_8022F2E8:
{
    r28 = MemoryInline::FlatRead32((r24 + 8));
    r3 = (r27 + 20);
    r28_addr_3 = (r28 + r30);
    r4 = MemoryInline::FlatRead32(r28_addr_3);
    r4 = (r4 + 80);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_8022F304:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8022F3E8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8022F324:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r31), static_cast<int32_t>(r29));
}
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFEFFF gpr_write=0xFF0011FB gpr_return=0x00000018 fpr_read=0xFFFFFFFF fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x8022F2A8 func_8022F2A8 preserves=true fpr_mask=0x00000000
