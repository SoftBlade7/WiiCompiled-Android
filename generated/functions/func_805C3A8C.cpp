...
extern "C" void func_805C3A8C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805C3A98:
{
    r0 = MemoryInline::FlatRead8((r3 + 1544));
}
...
// RECOMP_REGISTRATION base 0x805C3A8C func_805C3A8C preserves=true fpr_mask=0x00000000
