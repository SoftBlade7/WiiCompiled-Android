...
extern "C" void func_8073D98C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8073DA30:
{
    ...
    f4.d = std::fabs(f31.d);
    f2.d = MemoryInline::FlatReadFloat32((r4 + 10416));
...
// RECOMP_REGISTRATION base 0x8073D98C func_8073D98C preserves=false fpr_mask=0x80000000
