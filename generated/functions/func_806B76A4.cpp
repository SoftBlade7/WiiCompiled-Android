...
extern "C" void func_806B76A4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806B76A4:
{
    ...
    r0 = MemoryInline::FlatRead32((r4 + -3792));
    r4 = (r1 + 12);
...
// RECOMP_REGISTRATION base 0x806B76A4 func_806B76A4 preserves=true fpr_mask=0x00000000
