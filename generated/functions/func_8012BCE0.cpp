...
extern "C" void func_8012BCE0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r5_rot_0 = 0;
    uint32_t r5_rot_1 = 0;
...
loc_8012BD54:
{
    r0 = MemoryInline::FlatRead32((r29 + 92));
    r4 = 0;
...
// RECOMP_REGISTRATION base 0x8012BCE0 func_8012BCE0 preserves=true fpr_mask=0x00000000
