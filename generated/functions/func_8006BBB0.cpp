...
extern "C" void func_8006BBB0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8006BBB0:
{
    ...
    f7.d = MemoryInline::FlatReadFloat32((r2 + -29348));
    f4.d = PpcFmulsInline(f27.d, f2.d);
    f1.d = MemoryInline::FlatReadFloat32((r30 + 28));
    f9.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 0u, (r1 + 8));
    ...
    f6.d = MemoryInline::FlatReadFloat32((r30 + 12));
    f30.d = (-(f4.d));
    f28.d = MemoryInline::FlatReadFloat32((r30 + 16));
    f10.d = static_cast<double>(PpcForceSingleValueInline(f7.d - f1.d));
    f3.d = PpcFmulsInline(f27.d, f9.d);
    f26.d = MemoryInline::FlatReadFloat32(r30);
    f1.d = PpcFmulsInline(f0.d, f9.d);
    f9.d = static_cast<double>(PpcForceSingleValueInline(f6.d - f7.d));
    f13.d = MemoryInline::FlatReadFloat32((r30 + 20));
    f4.d = static_cast<double>(PpcForceSingleValueInline(f7.d + f6.d));
    f5.d = PpcFmulsInline(f5.d, f27.d);
    f31.d = MemoryInline::FlatReadFloat32((r30 + 4));
    f2.d = PpcFmulsInline(f0.d, f2.d);
    f7.d = PpcFmulsInline(f30.d, f4.d);
...
// RECOMP_REGISTRATION base 0x8006BBB0 func_8006BBB0 preserves=false fpr_mask=0xFC000000
