...
extern "C" void func_8072C33C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8072C33C:
{
    r0 = MemoryInline::FlatRead8((r3 + 437));
    r4 = 9;
...
// RECOMP_REGISTRATION base 0x8072C33C func_8072C33C preserves=true fpr_mask=0x00000000
