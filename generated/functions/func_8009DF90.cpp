...
extern "C" void func_8009DF90(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8009DF90:
{
    ...
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x8009F140u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8009DF90 func_8009DF90 preserves=true fpr_mask=0x00000000
