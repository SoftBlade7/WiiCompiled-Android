...
extern "C" void func_807C4CE8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807C4D1C:
{
    ...
    r4 = 0x808A0000u;
    r3 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 26400));
    r3 = r30;
    f1.d = MemoryInline::FlatReadFloat32((r4 + 26404));
...
// RECOMP_REGISTRATION base 0x807C4CE8 func_807C4CE8 preserves=true fpr_mask=0x00000000
