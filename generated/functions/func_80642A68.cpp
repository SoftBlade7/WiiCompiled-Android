...
extern "C" void func_80642A68(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80642A68:
{
    r3 = (r3 + -372);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80640E68u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80642A68 func_80642A68 preserves=true fpr_mask=0x00000000
