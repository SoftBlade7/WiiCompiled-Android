...
extern "C" void func_801B0220(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801B0220:
{
    ...
    r3 = ctx->gpr[3];
    r29 = MemoryInline::FlatRead8((r13 + -25144));
...
loc_801B0248:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801B07D4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801B02AC:
{
    ...
    InvokeDirectCpu<0x801A65ACu>(ctx);
    r3 = ctx->gpr[3];
    r31 = MemoryInline::FlatRead32((r31 + 364));
    r29 = r3;
    r30 = 16384;
    r4 = 0;
    r3 = r31;
...
{
    r29 = 0;
    MemoryInline::FlatWrite8((r13 + -25144), static_cast<uint8_t>(r29));
    goto loc_801B031C;
}
...
// RECOMP_REGISTRATION base 0x801B0220 func_801B0220 preserves=true fpr_mask=0x00000000
