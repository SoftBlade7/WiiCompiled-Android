...
extern "C" void func_8005F410(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8005F410:
{
    ...
    r3 = MemoryInline::FlatRead16((r3 + 66));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8005F410 func_8005F410 preserves=true fpr_mask=0x00000000
