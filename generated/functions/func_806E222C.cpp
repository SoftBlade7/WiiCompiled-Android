...
extern "C" void func_806E222C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806E2250:
{
    ...
    r31 = MemoryInline::FlatRead16((r3 + 6));
    goto loc_806E2298;
}
...
loc_806E22BC:
{
    ...
    r4 = PPC_Divw(static_cast<int32_t>(r31), static_cast<int32_t>(r4));
    r12 = MemoryInline::FlatRead32(r3);
...
// RECOMP_REGISTRATION base 0x806E222C func_806E222C preserves=true fpr_mask=0x00000000
