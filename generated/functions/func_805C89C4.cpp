...
extern "C" void func_805C89C4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805C89C4:
{
    ...
    r3 = r31;
    MemoryInline::FlatWrite8((r31 + 372), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x805C89C4 func_805C89C4 preserves=true fpr_mask=0x00000000
