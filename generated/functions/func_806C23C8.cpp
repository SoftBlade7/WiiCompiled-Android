...
extern "C" void func_806C23C8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806C23C8:
{
    ...
    f4 = ctx->fpr[4];
    cr = ctx->cr;
    f3.d = MemoryInline::FlatReadFloat32((r30 + 232));
    ...
    f2.d = MemoryInline::FlatReadFloat32((r3 + 12912));
...
// RECOMP_REGISTRATION base 0x806C23C8 func_806C23C8 preserves=false fpr_mask=0x80000000
