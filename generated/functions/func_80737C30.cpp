...
extern "C" void func_80737C30(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80737C30:
{
    r5 = 0x808A0000u;
    r0 = 0;
    f0.d = MemoryInline::FlatReadFloat32((r5 + 9968));
...
// RECOMP_REGISTRATION base 0x80737C30 func_80737C30 preserves=true fpr_mask=0x00000000
