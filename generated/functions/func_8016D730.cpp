...
extern "C" void func_8016D730(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8016D730:
{
    ...
    r6_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(15));
    r6_mrot_0 = (r6_rot_0 & 98304);
    r6_mdest_0 = (r6 & -98305);
...
// RECOMP_REGISTRATION base 0x8016D730 func_8016D730 preserves=true fpr_mask=0x00000000
