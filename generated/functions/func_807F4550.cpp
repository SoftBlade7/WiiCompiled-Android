...
extern "C" void func_807F4550(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807F4550:
{
    ...
    r31 = 0x808B0000u;
    f0.d = MemoryInline::FlatReadFloat32((r31 + -25288));
...
loc_807F45B0:
{
    ...
    r3 = (r3 + r0);
    // end of inlined leaf 0x8063C820
    f1.d = MemoryInline::FlatReadFloat32((r31 + -25288));
    r4 = 3;
    ctx->lr = 0x807F45C8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_807F45CC:
{
    ...
    r3 = 0x808B0000u;
    f3.d = MemoryInline::FlatReadFloat64((r3 + -25048));
    r5 = 0x808B0000u;
...
// RECOMP_REGISTRATION base 0x807F4550 func_807F4550 preserves=false fpr_mask=0x80000000
