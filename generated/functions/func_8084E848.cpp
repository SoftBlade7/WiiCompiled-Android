...
extern "C" void func_8084E848(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8084E848:
{
    ...
    r3 = 0x809C0000u;
    r4 = (r4 + 17720);
    MemoryInline::FlatWriteRam32((r3 + 17896), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x8084E848 func_8084E848 preserves=true fpr_mask=0x00000000
