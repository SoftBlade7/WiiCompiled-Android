...
extern "C" void func_8012C8D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
    uint32_t r3_rot_1 = 0;
...
loc_8012C978:
{
    MemoryInline::FlatWrite32((r28 + 60), r3);
    if (((cr & 0x20000000u) == 0)) {
        goto loc_8012C988;
    }
}
...
loc_8012C9C0:
{
    MemoryInline::FlatWrite32((r27 + 124), r3);
    if (((cr & 0x20000000u) == 0)) {
        goto loc_8012C9D0;
    }
}
...
// RECOMP_REGISTRATION base 0x8012C8D0 func_8012C8D0 preserves=true fpr_mask=0x00000000
