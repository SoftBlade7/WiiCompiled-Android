...
extern "C" void func_807677EC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807677EC:
{
    ...
    r0 = 0;
    r7 = (r1 + 8);
    r8 = MemoryInline::FlatRead32((r4 + 15172));
    r4 = (r1 + 16);
...
// RECOMP_REGISTRATION base 0x807677EC func_807677EC preserves=true fpr_mask=0x00000000
