...
extern "C" void func_805FEBDC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805FEBDC:
{
    MemoryInline::FlatWrite8((r3 + 3820), static_cast<uint8_t>(r4));
    return;
}
...
// RECOMP_REGISTRATION base 0x805FEBDC func_805FEBDC preserves=true fpr_mask=0x00000000
