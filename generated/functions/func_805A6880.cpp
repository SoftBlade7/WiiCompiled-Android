...
extern "C" void func_805A6880(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805A6880:
{
    ...
    f31.d = f1.d;
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r4), static_cast<int32_t>(44));
}
...
// RECOMP_REGISTRATION base 0x805A6880 func_805A6880 preserves=false fpr_mask=0x80000000
