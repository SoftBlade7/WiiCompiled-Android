...
extern "C" void func_8001C34C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8001C34C:
{
    ...
    r0 = 0;
    // mtspr 1010 (privileged/OS register) @ 0x8001C3AC
    PPC_WriteSpr(1010, r0);
    // mtspr 1013 (privileged/OS register) @ 0x8001C3B0
...
// RECOMP_REGISTRATION base 0x8001C34C func_8001C34C preserves=true fpr_mask=0x00000000
