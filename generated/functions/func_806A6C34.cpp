...
extern "C" void func_806A6C34(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806A6C7C:
{
    r31 = MemoryInline::FlatRead32((r3 + 616));
...
// RECOMP_REGISTRATION base 0x806A6C34 func_806A6C34 preserves=true fpr_mask=0x00000000
