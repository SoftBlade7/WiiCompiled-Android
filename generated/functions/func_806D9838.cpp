...
extern "C" void func_806D9838(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806D9838:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r5 + 172));
    ...
    f2 = ctx->fpr[2];
    ctr = ctx->ctr;
    r30 = MemoryInline::FlatRead32((r29 + 212));
    r4 = 0;
...
// RECOMP_REGISTRATION base 0x806D9838 func_806D9838 preserves=true fpr_mask=0x00000000
