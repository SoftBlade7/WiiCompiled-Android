...
extern "C" void func_801D6128(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801D6190:
{
    MemoryInline::FlatWrite32((r26 + 40), r30);
    r3 = r19;
    r4 = r26;
    r5 = r22;
    r6 = r29;
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801D9B24u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801D61B8:
{
    r28 = MemoryInline::FlatRead32((r26 + 40));
    r7 = MemoryInline::FlatRead32((r26 + 36));
...
// RECOMP_REGISTRATION base 0x801D6128 func_801D6128 preserves=true fpr_mask=0x00000000
