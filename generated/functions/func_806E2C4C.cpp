...
extern "C" void func_806E2C4C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806E2C4C:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r5 + 1944));
...
// RECOMP_REGISTRATION base 0x806E2C4C func_806E2C4C preserves=true fpr_mask=0x00000000
