...
extern "C" void func_8007F1A0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8007F1A0:
{
    r3 = MemoryInline::FlatRead8((r3 + 260));
    r0 = (r3 + 1);
    r3 = (r0 & 255);
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8007F1A0 func_8007F1A0 preserves=true fpr_mask=0x00000000
