...
extern "C" void func_8084AAC4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr1_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_8084AAC4:
{
    ...
    r27 = 0;
    MemoryInline::FlatWrite32((r3 + 1732), r27);
    r29 = r3;
    ...
    r0 = 1;
    MemoryInline::FlatWrite8((r29 + 989), static_cast<uint8_t>(r0));
    r4 = 0x809C0000u;
    r31 = (r3 & 255);
    ...
    if (MkwStateFreeAbiEnabled(0x805F5D58u) && KnownTranslatedCpuCall<0x805F5D58u>::kAvailable && !KnownTranslatedCpuCall<0x805F5D58u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805F5D58u>()) {
        const auto state_free_result_805F5D58_B61 = func_805F5D58_statefree(r0, r3, cr, xer);
        r3 = static_cast<uint32_t>(state_free_result_805F5D58_B61[0]);
        cr = static_cast<uint32_t>(state_free_result_805F5D58_B61[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_8084AC4C:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805F0DB4u) && KnownTranslatedCpuCall<0x805F0DB4u>::kAvailable && !KnownTranslatedCpuCall<0x805F0DB4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805F0DB4u>()) {
        const auto state_free_result_805F0DB4_420D = func_805F0DB4_statefree_v2(r3, r4, xer);
        r4 = static_cast<uint32_t>(state_free_result_805F0DB4_420D);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_8084AE24:
{
    ...
    r3 = 0x808B0000u;
    r0 = -100;
    f0.d = MemoryInline::FlatReadFloat32((r3 + -9056));
    r3 = r29;
...
// RECOMP_REGISTRATION base 0x8084AAC4 func_8084AAC4 preserves=true fpr_mask=0x00000000
