...
extern "C" void func_80547BD4(CpuContext* MKW_RESTRICT ctx)
{
...
extern "C" MKW_PPC_NO_INLINE void func_80547BD4_statefree(uint32_t native_r3, uint32_t native_r4, uint32_t native_r5, uint32_t native_r6)
{
...
loc_80547BD4:
{
    ...
    r0_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(cached_r5), static_cast<uint32_t>(6));
    r0_mrot_0 = (r0_rot_1 & 192);
    r0_mdest_0 = (cached_r0 & -193);
...
// RECOMP_STATE_FREE_ABI address=0x80547BD4 symbol=func_80547BD4_statefree gpr_in=0x00000078 gpr_out=0x00000000 fpr_in=0x00000000 fpr_out=0x00000000 cr_in=0x00 cr_out=0x00 gqr_in=0x00 hid_in=0x00 hid_out=0x00 xer_in=0 ctr_in=0 lr_in=0
...
// RECOMP_REGISTRATION base 0x80547BD4 func_80547BD4 preserves=true fpr_mask=0x00000000
