...
extern "C" void func_801A8A9C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_801A8B14:
{
    r3_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r31), static_cast<uint32_t>(6));
    r3 = (r3_rot_1 & -64);
    r4 = (r1 + 8);
    r0 = (r3 + 256);
    r5 = 4;
...
// RECOMP_REGISTRATION base 0x801A8A9C func_801A8A9C preserves=true fpr_mask=0x00000000
