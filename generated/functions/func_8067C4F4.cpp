...
extern "C" void func_8067C4F4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8067C530:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8068DF98u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8067C54C:
{
    r3 = MemoryInline::FlatRead32((r26 + 104));
    r27 = (r27 + 1);
    r3_addr_4 = (r3 + r28);
    MemoryInline::FlatWrite32(r3_addr_4, r29);
    r28 = (r28 + 4);
}
...
// RECOMP_REGISTRATION base 0x8067C4F4 func_8067C4F4 preserves=true fpr_mask=0x00000000
