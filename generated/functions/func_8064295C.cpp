...
extern "C" void func_8064295C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8064295C:
{
    MemoryInline::FlatWrite32((r3 + 652), r4);
    return;
}
...
// RECOMP_REGISTRATION base 0x8064295C func_8064295C preserves=true fpr_mask=0x00000000
