...
extern "C" void func_80079910(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80079910:
{
    ...
    r31 = r3;
    r5 = 17;
    guest_range_0 = MemoryInline::ResolveRangeHost(r3, 0, 42u, false, true);
    ...
    MemoryInline::WriteResolved8(guest_range_0, 41u, (r3 + 41), static_cast<uint8_t>(r0));
    r3 = (r3 + 24);
    ctx->lr = 0x80079968u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_GUEST_ABI gpr_read=0x8000000A gpr_write=0x800000FB gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x80079910 func_80079910 preserves=true fpr_mask=0x00000000
