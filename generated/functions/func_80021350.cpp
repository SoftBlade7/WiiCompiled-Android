...
extern "C" void func_80021350(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80021350:
{
    ...
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    InvokeDirectCpu<0x8002137Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x80021350 func_80021350 preserves=true fpr_mask=0x00000000
