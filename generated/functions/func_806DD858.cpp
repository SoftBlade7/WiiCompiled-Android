...
extern "C" void func_806DD858(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806DD878:
{
    ...
    ctx->fpr[5] = f5;
    ctx->cr = cr;
    InvokeDirectCpu<0x80821974u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x806DD858 func_806DD858 preserves=true fpr_mask=0x00000000
