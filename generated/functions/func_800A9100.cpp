...
extern "C" void func_800A9100(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800A9100:
{
    ...
    r0 = (r31 * 12);
    r4 = 1;
    MemoryInline::FlatWrite8((r30 + 12), static_cast<uint8_t>(r4));
    r31 = r3;
    r4 = (r1 + 8);
    r3 = (r29 + r0);
    r0 = (r3 + 4);
...
// RECOMP_REGISTRATION base 0x800A9100 func_800A9100 preserves=true fpr_mask=0x00000000
