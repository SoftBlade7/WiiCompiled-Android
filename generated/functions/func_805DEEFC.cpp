...
extern "C" void func_805DEEFC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805DEF40:
{
    ...
    if (MkwStateFreeAbiEnabled(0x80623054u) && KnownTranslatedCpuCall<0x80623054u>::kAvailable && !KnownTranslatedCpuCall<0x80623054u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80623054u>()) {
        const auto state_free_result_80623054_E78 = func_80623054_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_80623054_E78[0]);
        r3 = static_cast<uint32_t>(state_free_result_80623054_E78[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x805DEEFC func_805DEEFC preserves=true fpr_mask=0x00000000
