...
extern "C" void func_807CA0B8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807CA0B8:
{
    ...
    MemoryInline::FlatWriteRamFloat64((r1 + 400), f31.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_0 = (r1 + 408);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_0, PPC_PsFromScalarInline(f31.d));
    MemoryInline::FlatWriteRamFloat64((r1 + 384), f30.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_1 = (r1 + 392);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_1, PPC_PsFromScalarInline(f30.d));
    MemoryInline::FlatWriteRamFloat64((r1 + 368), f29.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_2 = (r1 + 376);
...
loc_807CA124:
{
    ...
    r3 = 0;
    MemoryInline::FlatWrite32((r26 + 4), r0);
...
loc_807CA13C:
{
    r3 = MemoryInline::FlatRead32((r22 + 108));
    r4 = 5;
    r3 = MemoryInline::FlatRead32((r3 + 40));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_807CA1E4:
{
    r31 = MemoryInline::FlatRead16((r3 + 32));
    if (((cr & 0x20000000u) == 0)) {
        goto loc_807CA218;
    }
}
...
loc_807CA34C:
{
    ...
    cr = ctx->cr;
    r0 = MemoryInline::FlatRead32((r1 + 24));
    r28 = MemoryInline::FlatRead32((r28 + 8));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_807CA4FC:
{
    ...
    r24 = MemoryInline::FlatRead32((r26 + 4));
    r22 = 0;
    r23 = MemoryInline::FlatRead32((r26 + 8));
    r26 = 1127219200;
    f29.d = MemoryInline::FlatReadFloat64((r3 + 28960));
    goto loc_807CA6A8;
}
...
loc_807CA51C:
{
    ...
    r5 = r30;
    r3 = (r1 + 24);
    MemoryInline::FlatWriteRam32((r1 + 304), r26);
    r4 = (r1 + 224);
    ...
    MemoryInline::FlatWriteFloat32((r25 + 20), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r1 + 76));
    MemoryInline::FlatWriteFloat32((r25 + 24), f0.d);
    ctx->lr = 0x807CA580u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    PpcSetPairedFprInline(f2, PPC_PsqLGqrInline<0u, 0u>(ctx, mkw_gqr0, r25_psq_tmp_2));
    r0 = (r22 ^ -2147483648);
    MemoryInline::FlatWriteRam32((r1 + 316), r0);
    r5 = r29;
    PpcSetPairedFprInline(f0, PPC_PsMuls0Inline(f2.d, PPC_PsFromScalarInline(f31.d)));
    r3 = (r1 + 24);
    MemoryInline::FlatWriteRam32((r1 + 312), r26);
    r4 = (r1 + 224);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r25_psq_tmp_3 = (r25 + 16);
    PPC_PsqStGqrInline<0u, 0u>(ctx, mkw_gqr0, r25_psq_tmp_3, f0.d);
    f0.d = MemoryInline::FlatReadFloat64((r1 + 312));
    // psq_load w=1 quant=0 (using PPC_PsqL)
    r25_psq_tmp_4 = (r25 + 24);
    PpcSetPairedFprInline(f2, PPC_PsqLGqrInline<1u, 0u>(ctx, mkw_gqr0, r25_psq_tmp_4));
    f1.d = static_cast<double>(PpcForceSingleValueInline(f0.d - f29.d));
    PpcSetPairedFprInline(f0, PPC_PsMuls0Inline(f2.d, PPC_PsFromScalarInline(f31.d)));
...
loc_807CA624:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r1 + 44));
    r3 = r23;
    MemoryInline::FlatWriteFloat32((r23 + 16), f0.d);
    r4 = (r1 + 32);
    f0.d = MemoryInline::FlatReadFloat32((r1 + 60));
    MemoryInline::FlatWriteFloat32((r23 + 20), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r1 + 76));
    MemoryInline::FlatWriteFloat32((r23 + 24), f0.d);
    ctx->lr = 0x807CA688u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_807CA6A8:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r22), static_cast<int32_t>(r31));
}
...
{
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f31.d = MemoryInline::FlatReadFloat64((r1 + 400));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f30.d = MemoryInline::FlatReadFloat64((r1 + 384));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r11 = (r1 + 368);
    f29.d = MemoryInline::FlatReadFloat64((r1 + 368));
...
// RECOMP_REGISTRATION base 0x807CA0B8 func_807CA0B8 preserves=false fpr_mask=0xE0000000
