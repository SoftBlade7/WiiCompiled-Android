...
extern "C" void func_80887A58(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80887A58:
{
    ...
    r3 = r31;
    r0 = MemoryInline::FlatRead32((r5 + 18904));
    MemoryInline::FlatWrite32((r31 + 176), r0);
    r4 = MemoryInline::FlatRead32((r5 + 18904));
    r0 = (r4 + 1);
    MemoryInline::FlatWriteRam32((r5 + 18904), r0);
...
// RECOMP_REGISTRATION base 0x80887A58 func_80887A58 preserves=true fpr_mask=0x00000000
