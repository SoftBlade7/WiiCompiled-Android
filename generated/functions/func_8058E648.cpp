...
extern "C" void func_8058E648(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8058E648:
{
    ...
    r3 = 0x809C0000u;
    r5 = 0x80890000u;
    f3.d = MemoryInline::FlatReadFloat32((r6 + 7124));
    f2.d = MemoryInline::FlatReadFloat32((r7 + 44));
    r4 = (r4 + 104);
    f1.d = MemoryInline::FlatReadFloat32((r5 + 7120));
    r5 = 0;
...
// RECOMP_REGISTRATION base 0x8058E648 func_8058E648 preserves=true fpr_mask=0x00000000
