...
extern "C" void func_805AD8AC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r0 = 1;
    MemoryInline::FlatWrite8((r30 + 200), static_cast<uint8_t>(r0));
    r3 = 0x809C0000u;
...
// RECOMP_REGISTRATION base 0x805AD8AC func_805AD8AC preserves=true fpr_mask=0x00000000
