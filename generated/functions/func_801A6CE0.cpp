...
extern "C" void func_801A6CE0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801A6CE0:
{
    ...
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    InvokeDirectCpu<0x801A6A3Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x801A6CE0 func_801A6CE0 preserves=true fpr_mask=0x00000000
