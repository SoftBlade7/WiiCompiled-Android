...
extern "C" void func_806EBE90(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806EBE90:
{
    ...
    f2 = ctx->fpr[2];
    cr = ctx->cr;
    guest_range_0 = MemoryInline::ResolveRangeHost((r30 + 16), 0, 1020u, true, false);
    ...
    r3 = MemoryInline::ReadResolved32(guest_range_0, 924u, (r30 + 940));
    MemoryInline::FlatWriteRam32((r1 + 8), r3);
    r0 = MemoryInline::ReadResolved32(guest_range_0, 932u, (r30 + 948));
    MemoryInline::FlatWriteRam32((r1 + 16), r0);
    r3 = MemoryInline::ReadResolved32(guest_range_0, 928u, (r30 + 944));
    f2.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 1016u, (r30 + 1032));
...
// RECOMP_REGISTRATION base 0x806EBE90 func_806EBE90 preserves=true fpr_mask=0x00000000
