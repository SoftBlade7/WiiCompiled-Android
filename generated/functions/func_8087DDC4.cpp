...
extern "C" void func_8087DDC4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_ca_0 = 0;
    uint32_t r0_not_0 = 0;
...
loc_8087DDC4:
{
    ...
    r0 = (r0 + r0_ca_0);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r0_not_0)) + static_cast<uint64_t>(static_cast<uint32_t>(r6)) + (static_cast<uint64_t>(static_cast<uint32_t>(r0_ca_0)) & 1u);
        xer = (xer & 0xDFFFFFFFu) | (static_cast<uint32_t>((ppcCarryWide >> 32) & 1u) << 29);
    }
...
// RECOMP_REGISTRATION base 0x8087DDC4 func_8087DDC4 preserves=true fpr_mask=0x00000000
