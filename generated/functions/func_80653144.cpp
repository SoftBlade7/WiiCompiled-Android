...
extern "C" void func_80653144(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80653144:
{
    r3 = 0x809C0000u;
    r5 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r5 + -24608));
    r4 = 3;
...
// RECOMP_REGISTRATION base 0x80653144 func_80653144 preserves=true fpr_mask=0x00000000
