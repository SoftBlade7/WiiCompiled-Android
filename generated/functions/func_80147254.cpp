...
extern "C" void func_80147254(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80147254:
{
    ...
    r31 = ctx->gpr[31];
    r0 = 1;
    MemoryInline::FlatWriteRam8((r31 + 111), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x80147254 func_80147254 preserves=true fpr_mask=0x00000000
