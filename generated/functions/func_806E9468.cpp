...
extern "C" void func_806E9468(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806E9468:
{
    ...
    r4 = (r1 + 12);
    r7 = 0;
    r0 = MemoryInline::FlatRead32((r5 + 2180));
    r5 = (r1 + 8);
...
// RECOMP_REGISTRATION base 0x806E9468 func_806E9468 preserves=true fpr_mask=0x00000000
