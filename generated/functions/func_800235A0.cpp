...
extern "C" void func_800235A0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr1_0 = 0;
    uint32_t r0_rot_0 = 0;
...
{
    r28 = 0x802A0000u;
    guest_range_2 = MemoryInline::ResolveRangeHost((r1 + 8), 0, 120u, false, true);
    ...
    r4 = (r1 + 116);
    r27 = MemoryInline::FlatRead32((r28 + 836));
    r3 = r26;
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 108u, ((static_cast<uint64_t>(static_cast<uint32_t>(r29)) << 32) | static_cast<uint32_t>(r30)))) {
        MemoryInline::WriteResolved32(guest_range_2, 108u, (r1 + 116), r29);
        MemoryInline::WriteResolved32(guest_range_2, 112u, (r1 + 120), r30);
    }
    MemoryInline::WriteResolved32(guest_range_2, 116u, (r1 + 124), r31);
    ctx->lr = 0x8002362Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801A265Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead32((r28 + 832));
...
loc_80023638:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead16((r27 + 4));
    r5 = MemoryInline::FlatRead16((r27 + 8));
    // inline leaf 0x80021E30 (13 guest instruction(s))
    r0 = (r4 + 15);
    r8 = 0x802A0000u;
    r6 = (r0 & 65520);
    ...
    // end of inlined leaf 0x80021E30
    MemoryInline::FlatWriteRam32((r1 + 104), r29);
    r6 = (r1 + 104);
    r4 = MemoryInline::FlatRead32((r28 + 832));
    r5 = r26;
    MemoryInline::FlatWriteRam32((r1 + 108), r30);
    r3 = 1;
    MemoryInline::FlatWriteRam32((r1 + 112), r31);
    ctx->lr = 0x80023668u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80022EE0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x800235A0 func_800235A0 preserves=true fpr_mask=0x00000000
