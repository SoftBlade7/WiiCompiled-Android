...
extern "C" void func_80097520(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80097520:
{
    r3 = (r3 + 8);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80095A30u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80097520 func_80097520 preserves=true fpr_mask=0x00000000
