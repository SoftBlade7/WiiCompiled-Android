...
extern "C" void func_806DFA64(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806DFA90:
{
    ...
    r3 = 0x808A0000u;
    r5 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + 1520));
    r3 = MemoryInline::FlatRead32((r4 + 40));
    r4 = 0;
    f2.d = MemoryInline::FlatReadFloat32((r5 + 1524));
    ctx->lr = 0x806DFAB0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x806DFA64 func_806DFA64 preserves=true fpr_mask=0x00000000
