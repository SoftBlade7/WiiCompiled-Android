...
extern "C" void func_8056C964(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8056C964:
{
    ...
    f1.d = MemoryInline::FlatReadFloat64((r4 + 5920));
...
// RECOMP_REGISTRATION base 0x8056C964 func_8056C964 preserves=true fpr_mask=0x00000000
