...
extern "C" void func_807EE25C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807EE25C:
{
    ...
    r4 = 0x808B0000u;
    r3 = (r1 + 32);
    f0.d = MemoryInline::FlatReadFloat32((r4 + -26012));
    r4 = -1;
...
// RECOMP_REGISTRATION base 0x807EE25C func_807EE25C preserves=true fpr_mask=0x00000000
