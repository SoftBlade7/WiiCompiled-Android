...
extern "C" void func_806381A4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_80638328:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r31 + 572), r3);
...
// RECOMP_REGISTRATION base 0x806381A4 func_806381A4 preserves=true fpr_mask=0x00000000
