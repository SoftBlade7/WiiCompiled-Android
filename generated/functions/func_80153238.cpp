...
extern "C" void func_80153238(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r7_rot_0 = 0;
...
loc_80153238:
{
    ...
    r9 = r30;
    r7_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(31));
...
// RECOMP_REGISTRATION base 0x80153238 func_80153238 preserves=true fpr_mask=0x00000000
