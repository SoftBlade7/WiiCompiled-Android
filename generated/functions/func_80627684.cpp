...
extern "C" void func_80627684(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80627684:
{
    ...
    r11 = MemoryInline::FlatRead32((r29 + 1636));
    ...
    r8 = MemoryInline::FlatRead32((r29 + 1648));
    ...
    r9 = 0x808C0000u;
    r7 = 0x808C0000u;
    guest_range_5 = MemoryInline::ResolveRangeHost((r29 + 1660), 0, 60u, true, false);
    r20 = MemoryInline::ReadResolved32(guest_range_5, 0u, (r29 + 1660));
    r9 = (r9 + -12180);
    ...
    MemoryInline::WriteResolved32(guest_range_1, 16u, (r27 + 1636), r21);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r23 = MemoryInline::ReadResolved32(guest_range_5, 12u, (r29 + 1672));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r26 = MemoryInline::ReadResolved32(guest_range_5, 24u, (r29 + 1684));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r10 = MemoryInline::ReadResolved32(guest_range_5, 36u, (r29 + 1696));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_5, 48u, (r29 + 1708));
    ...
    ctr = ctx->ctr;
    r3 = (r29 + 1720);
    r11 = MemoryInline::FlatRead32((r29 + 1720));
    ...
    r7 = MemoryInline::FlatRead32((r29 + 1732));
...
// RECOMP_REGISTRATION base 0x80627684 func_80627684 preserves=true fpr_mask=0x00000000
