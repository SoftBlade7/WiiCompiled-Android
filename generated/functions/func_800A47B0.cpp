...
extern "C" void func_800A47B0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800A47B0:
{
    ...
    r30 = r3;
    r0 = MemoryInline::FlatRead8((r3 + 916));
...
loc_800A47E0:
{
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 40u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | static_cast<uint32_t>(r6)))) {
        ...
        MemoryInline::WriteResolved32(guest_range_0, 44u, (r31 + 892), r6);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 48u, ((static_cast<uint64_t>(static_cast<uint32_t>(r6)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_0, 48u, (r31 + 896), r6);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 56u, ((static_cast<uint64_t>(static_cast<uint32_t>(r7)) << 32) | static_cast<uint32_t>(r7)))) {
        MemoryInline::WriteResolved32(guest_range_0, 56u, (r31 + 904), r7);
        MemoryInline::WriteResolved32(guest_range_0, 60u, (r31 + 908), r7);
    }
...
loc_800A486C:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801A7500u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801AA3ACu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWrite8((r30 + 916), static_cast<uint8_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x800A47B0 func_800A47B0 preserves=true fpr_mask=0x00000000
