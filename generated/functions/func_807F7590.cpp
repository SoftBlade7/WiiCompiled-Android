...
extern "C" void func_807F7590(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807F7590:
{
    ...
    r31 = r3;
    MemoryInline::FlatWrite8((r3 + 408), static_cast<uint8_t>(r0));
    r3 = (r3 + 152);
    ...
    r5 = 0x808B0000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r5 + -23136));
    ctx->lr = 0x807F75C8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x807F7590 func_807F7590 preserves=true fpr_mask=0x00000000
