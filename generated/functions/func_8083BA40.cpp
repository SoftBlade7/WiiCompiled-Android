...
extern "C" void func_8083BA40(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8083BA40:
{
    r3 = MemoryInline::FlatRead32((r3 + 1728));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8083BA40 func_8083BA40 preserves=true fpr_mask=0x00000000
