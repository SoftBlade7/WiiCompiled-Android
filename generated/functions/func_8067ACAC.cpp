...
extern "C" void func_8067ACAC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8067ACAC:
{
    ...
    r31 = ctx->gpr[31];
    ctr = ctx->ctr;
    MemoryInline::FlatWrite32((r31 + 88), r3);
    r0 = 0;
    r3 = r31;
    r4 = 0;
...
// RECOMP_REGISTRATION base 0x8067ACAC func_8067ACAC preserves=true fpr_mask=0x00000000
