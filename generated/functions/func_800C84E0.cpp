...
extern "C" void func_800C84E0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800C852C:
{
    ...
    r4 = r3;
    r31 = 0;
    MemoryInline::FlatWrite32((r30 + 68), r28);
    r3 = r27;
    r7 = (r7 + -32224);
    r5 = 1504;
    MemoryInline::FlatWrite32((r30 + 96), r29);
    r6 = 0;
    MemoryInline::FlatWrite8((r30 + 104), static_cast<uint8_t>(r31));
    ctx->lr = 0x800C8564u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x800C84E0 func_800C84E0 preserves=true fpr_mask=0x00000000
