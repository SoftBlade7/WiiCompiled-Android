...
extern "C" void func_8056E56C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8056E56C:
{
    ...
    r3 = 0x80890000u;
    r4 = 0x808B0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 5944));
    r4 = (r4 + 22184);
    r0 = 0;
...
loc_8056E5C4:
{
    ...
    ctx->fpr[0] = f0;
    ctx->cr = cr;
    InvokeDirectCpu<0x80593FA4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8056E56C func_8056E56C preserves=true fpr_mask=0x00000000
