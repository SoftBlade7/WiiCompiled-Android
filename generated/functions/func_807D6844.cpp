...
extern "C" void func_807D6844(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807D68A0:
{
    ...
    f4.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 12u, (r28 + 12));
    r3 = r30;
    f2.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 28u, (r28 + 28));
    r4 = (r1 + 8);
    f8.d = MemoryInline::FlatReadFloat32((r30 + 44));
    f0.d = static_cast<double>(PpcForceSingleValueInline(f5.d - f4.d));
    f3.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 0u, r28);
    f1.d = static_cast<double>(PpcForceSingleValueInline(f7.d - f2.d));
    f9.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 16u, (r28 + 16));
    f3.d = PpcFmulsInline(f0.d, f3.d);
    f6.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 44u, (r28 + 44));
    ...
    f9.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 32u, (r28 + 32));
    ...
    f11.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 8u, (r28 + 8));
    ...
    f7.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 24u, (r28 + 24));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    ...
    f5.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 40u, (r28 + 40));
    ...
    MemoryInline::FlatWriteFloat32((r30 + 8), f11.d);
    MemoryInline::FlatWriteFloat32((r30 + 24), f7.d);
    PpcSetPairedFprInline(f0, PPC_PsSum0Inline(f0.d, f1.d, f1.d));
    MemoryInline::FlatWriteFloat32((r30 + 40), f5.d);
    ...
    r6 = MemoryInline::FlatRead32((r31 + 276));
    r0 = MemoryInline::FlatRead32((r5 + 4));
    MemoryInline::WriteResolvedFloat32(guest_range_2, 20u, (r1 + 28), f3.d);
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 0u, ((static_cast<uint64_t>(static_cast<uint32_t>(r6)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_2, 0u, (r1 + 8), r6);
        MemoryInline::WriteResolved32(guest_range_2, 4u, (r1 + 12), r0);
    }
    MemoryInline::WriteResolvedFloat32(guest_range_2, 8u, (r1 + 16), PPC_PsToScalarInline(f0.d));
    ctx->lr = 0x807D6974u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x807DD8C0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
{
    // psq_load w=0 quant=0 (using PPC_PsqL)
    guest_range_3 = MemoryInline::ResolveRangeHost((r1 + 92), 0, 60u, true, false);
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_3, 36u, (r1 + 128));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r11 = (r1 + 112);
    f30.d = MemoryInline::ReadResolvedFloat64(guest_range_3, 20u, (r1 + 112));
    // inline leaf 0x800215EC (6 guest instruction(s))
    {
        ...
        if (resolved_pair.valid) {
            ...
            r27 = MemoryInline::ReadResolved32(guest_range_3, 0u, (r11 + -20));
            r28 = MemoryInline::ReadResolved32(guest_range_3, 4u, (r11 + -16));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r29 = MemoryInline::ReadResolved32(guest_range_3, 8u, (r11 + -12));
            r30 = MemoryInline::ReadResolved32(guest_range_3, 12u, (r11 + -8));
        }
    }
    r31 = MemoryInline::ReadResolved32(guest_range_3, 16u, (r11 + -4));
    // end of inlined leaf 0x800215EC
    r0 = MemoryInline::ReadResolved32(guest_range_3, 56u, (r1 + 148));
    ctx->lr = r0;
    r1 = (r1 + 144);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFFFFE gpr_write=0xFFFFFFFF gpr_return=0x00000018 fpr_read=0xFFFFF007 fpr_write=0xFFFFFFFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x807D6844 func_807D6844 preserves=false fpr_mask=0xC0000000
