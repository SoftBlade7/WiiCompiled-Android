...
extern "C" void func_801456D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80145718:
{
    ...
    r0 = (r0_rot_1 & 255);
    MemoryInline::WriteResolved8(guest_range_0, 7u, (r3 + 9), static_cast<uint8_t>(r9));
    ...
    MemoryInline::WriteResolved8(guest_range_0, 13u, (r3 + 15), static_cast<uint8_t>(r29));
...
// RECOMP_REGISTRATION base 0x801456D0 func_801456D0 preserves=true fpr_mask=0x00000000
