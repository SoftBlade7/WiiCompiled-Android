...
extern "C" void func_805391E4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80539294:
{
    MemoryInline::FlatWrite16((r28 + 12), static_cast<uint16_t>(r25));
    r31 = r3;
    goto loc_805392B0;
}
...
// RECOMP_REGISTRATION base 0x805391E4 func_805391E4 preserves=true fpr_mask=0x00000000
