...
extern "C" void func_80656F40(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80656F64:
{
    r26 = MemoryInline::FlatRead32((r27 + 240));
    r30 = 0;
}
...
loc_80656F94:
{
    r26 = MemoryInline::FlatRead32((r27 + 336));
    r30 = 0;
}
...
// RECOMP_REGISTRATION base 0x80656F40 func_80656F40 preserves=true fpr_mask=0x00000000
