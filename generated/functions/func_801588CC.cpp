...
extern "C" void func_801588CC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lbzux_80158948_loc_0 = 0;
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
    uint32_t r3_rot_1 = 0;
    uint32_t r3_rot_2 = 0;
...
loc_80158928:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead16((r27 + 36));
    r0 = (r0 + r26);
    MemoryInline::FlatWrite16((r27 + 36), static_cast<uint16_t>(r0));
    addr_lbzux_80158948_loc_0 = (r28 + r26);
    r0 = MemoryInline::FlatRead8(addr_lbzux_80158948_loc_0);
    r28 = addr_lbzux_80158948_loc_0;
}
...
loc_801589A4:
{
    ...
    r3 = (r29 + 2);
    r0 = MemoryInline::FlatRead16((r27 + 1136));
    {
    ...
    MemoryInline::FlatWriteRam8((r31 + 1), static_cast<uint8_t>(r0));
    r0 = MemoryInline::FlatRead16((r27 + 1136));
    MemoryInline::FlatWriteRam8((r31 + 2), static_cast<uint8_t>(r0));
    r4 = MemoryInline::FlatRead16((r27 + 1136));
    r6 = MemoryInline::FlatRead32((r27 + 1040));
    r0 = (r4 + 1);
    MemoryInline::FlatWrite16((r27 + 1136), static_cast<uint16_t>(r0));
    r5 = (r6 + 16);
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8015814Cu>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
    ...
    r4 = MemoryInline::FlatRead32((r27 + 1040));
...
loc_80158A80:
{
    ...
    MemoryInline::FlatWriteRam8((r29 + 1), static_cast<uint8_t>(r5));
    MemoryInline::FlatWriteRam16((r30 + 2), static_cast<uint16_t>(r0));
    r3 = MemoryInline::FlatRead16((r27 + 34));
    ctx->lr = 0x80158AA8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_80158ABC:
{
    r5 = MemoryInline::FlatRead8((r27 + 38));
    r3 = (r27 + 39);
    {
...
// RECOMP_REGISTRATION base 0x801588CC func_801588CC preserves=true fpr_mask=0x00000000
