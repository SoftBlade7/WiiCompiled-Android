...
extern "C" void func_80772CFC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80772D30:
{
    r3 = MemoryInline::FlatRead32((r19 + 6392));
    r4 = r20;
...
{
    r3 = 0x809C0000u;
    r20 = MemoryInline::FlatRead32((r3 + 17200));
    r0 = MemoryInline::FlatRead32((r20 + 92));
...
loc_80772DE0:
{
    MemoryInline::FlatWrite32((r20 + 92), r19);
}

loc_80772DE4:
{
    r0 = MemoryInline::FlatRead8((r28 + 176));
    r30 = MemoryInline::FlatRead32((r20 + 92));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_80772DF4:
{
    r19 = 0x808A0000u;
    r26 = 0x808A0000u;
    f31.d = MemoryInline::FlatReadFloat32((r19 + 16344));
    r21 = (r1 + 144);
    r26 = (r26 + 16376);
    r29 = 0;
    r31 = 0x809C0000u;
...
loc_80772E44:
{
    r0_rot_7 = PpcRotl32Inline(static_cast<uint32_t>(r25), static_cast<uint32_t>(1));
    r0 = (r0_rot_7 & 131070);
    r18 = (r27 * r0);
...
loc_inl5_cont_8051BED0:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    f1.d = MemoryInline::FlatReadFloat32((r19 + 16344));
    r3 = (r1 + 144);
    r4 = 1;
    r5 = 1;
    f2.d = f1.d;
...
loc_80772F44:
{
    r3 = MemoryInline::FlatRead32((r20 + 11760));
    r4 = r25;
    r5 = r27;
    ...
    r4 = (r1 + 16);
    r3 = MemoryInline::FlatRead32((r20 + 11760));
    MemoryInline::FlatWriteRam8((r1 + 140), static_cast<uint8_t>(r23));
    r5 = MemoryInline::FlatRead32((r1 + 136));
    r0 = MemoryInline::FlatRead32((r1 + 140));
    MemoryInline::FlatWriteRam32((r1 + 112), r21);
    MemoryInline::FlatWriteRam32((r1 + 116), r30);
    MemoryInline::FlatWriteRam32((r1 + 120), r22);
    MemoryInline::FlatWriteRam32((r1 + 124), r23);
    MemoryInline::FlatWriteRam32((r1 + 128), r24);
...
loc_80773054:
{
    MemoryInline::FlatWrite8((r28 + 176), static_cast<uint8_t>(r23));
}
...
// RECOMP_REGISTRATION base 0x80772CFC func_80772CFC preserves=false fpr_mask=0x80000000
