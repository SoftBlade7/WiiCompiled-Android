...
extern "C" void func_808400D4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_808400D4:
{
    r3 = MemoryInline::FlatRead32((r3 + 1724));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x808400D4 func_808400D4 preserves=true fpr_mask=0x00000000
