...
extern "C" void func_8069B748(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8069B77C:
{
    r31_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(31));
    r31 = (r31_rot_0 & 1);
...
loc_8069B7AC:
{
    r29 = MemoryInline::FlatRead32((r3 + 508));
...
loc_8069B8FC:
{
    r28 = MemoryInline::FlatRead32((r30 + 512));
...
loc_8069B978:
{
    r0 = MemoryInline::FlatRead8((r30 + 137));
}
...
loc_8069B988:
{
    r0 = MemoryInline::FlatRead8((r30 + 152));
    r4 = 0;
}
...
loc_8069BAD4:
{
    MemoryInline::FlatWrite8((r30 + 137), static_cast<uint8_t>(r29));
...
// RECOMP_REGISTRATION base 0x8069B748 func_8069B748 preserves=true fpr_mask=0x00000000
