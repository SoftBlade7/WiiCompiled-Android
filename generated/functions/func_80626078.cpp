...
extern "C" void func_80626078(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80626078:
{
    ...
    MemoryInline::WriteResolved32(guest_range_0, 984u, (r30 + 984), r0);
    r6 = 0x808C0000u;
    r7 = 0x808C0000u;
    r5 = 0x808C0000u;
    ...
    r4 = (r4 + -29168);
    r3 = (r30 + 1072);
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 996u, ((static_cast<uint64_t>(static_cast<uint32_t>(r12)) << 32) | static_cast<uint32_t>(r12)))) {
    ...
    r12 = MemoryInline::FlatRead32((r30 + 1072));
    r3 = (r30 + 1072);
    r4 = 0;
    r5 = 0;
...
// RECOMP_REGISTRATION base 0x80626078 func_80626078 preserves=true fpr_mask=0x00000000
