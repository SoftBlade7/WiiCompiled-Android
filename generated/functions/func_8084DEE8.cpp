...
extern "C" void func_8084DEE8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8084DF30:
{
    ...
    r7 = ctx->gpr[7];
    r8 = ctx->gpr[8];
    r3 = MemoryInline::FlatRead32((r29 + 1620));
    r4 = 0x808B0000u;
    r4 = (r4 + -8504);
...
loc_8084DF7C:
{
    ...
    if (MkwStateFreeAbiEnabled(0x80631588u) && KnownTranslatedCpuCall<0x80631588u>::kAvailable && !KnownTranslatedCpuCall<0x80631588u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80631588u>()) {
        const auto state_free_result_80631588_1A2E = func_80631588_statefree(r3, cr, xer);
        r3 = static_cast<uint32_t>(state_free_result_80631588_1A2E[0]);
        cr = static_cast<uint32_t>(state_free_result_80631588_1A2E[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_8084DFB4:
{
    ...
    r0 = (r0_rot_1 & -4);
    r4 = (r4 + 1);
    MemoryInline::FlatWrite32((r29 + 1620), r4);
    r3 = (r3 + -25184);
    r5 = (r5 + -8504);
    r3_addr_1 = (r3 + r0);
...
loc_8084E068:
{
    ...
    r0 = (r30 + 1);
    r0 = (r0 ^ -2147483648);
    f5.d = MemoryInline::FlatReadFloat64((r31 + 64));
    ...
    f3.d = MemoryInline::FlatReadFloat32((r31 + 56));
...
// RECOMP_REGISTRATION base 0x8084DEE8 func_8084DEE8 preserves=true fpr_mask=0x00000000
