...
extern "C" void func_800209E8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800209E8:
{
    ...
    f31.d = PPC_Mffs();
    MemoryInline::FlatWriteFloat64(r3, f31.d);
...
extern "C" MKW_PPC_NO_INLINE MkwStateFreeResult2 func_800209E8_statefree(uint32_t native_r1, uint32_t native_r3, PPC_FPR native_f31, uint32_t native_lr, uint32_t native_gqr0)
{
...
loc_800209E8:
{
    ...
    cached_f31.d = PPC_Mffs();
    MemoryInline::FlatWriteFloat64(cached_r3, cached_f31.d);
    // psq_load w=0 quant=0 (using PPC_PsqL)
...
// RECOMP_STATE_FREE_ABI address=0x800209E8 symbol=func_800209E8_statefree gpr_in=0x0000000A gpr_out=0x00000002 fpr_in=0x80000000 fpr_out=0x80000000 cr_in=0x00 cr_out=0x00 gqr_in=0x01 hid_in=0x00 hid_out=0x00 xer_in=0 ctr_in=0 lr_in=1
...
// RECOMP_REGISTRATION base 0x800209E8 func_800209E8 preserves=true fpr_mask=0x00000000
