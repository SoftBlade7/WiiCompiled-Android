...
extern "C" void func_801E4B24(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801E4B88:
{
    ...
    r3 = 0;
    r26 = MemoryInline::FlatRead32((r13 + -24384));
    r0 = (r4 & 16);
}
...
loc_801E4BD0:
{
    r27 = MemoryInline::FlatRead32((r30 + 232));
}
...
loc_801E4BE0:
{
    r27 = MemoryInline::FlatRead32((r30 + 76));
}
...
loc_801E4CCC:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801E1738u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801E4D88:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801E5094u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x801E4B24 func_801E4B24 preserves=true fpr_mask=0x00000000
