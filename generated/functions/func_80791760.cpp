...
extern "C" void func_80791760(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807917D4:
{
    MemoryInline::FlatWrite32((r4 + 328), r3);
    r30 = (r30 + 4);
    if (((cr & 0x80000000u) != 0)) {
        goto loc_807917C0;
    }
...
// RECOMP_REGISTRATION base 0x80791760 func_80791760 preserves=true fpr_mask=0x00000000
