...
extern "C" void func_801564EC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801564EC:
{
    ...
    r0 = MemoryInline::FlatRead8((r5 + 114));
...
loc_80156510:
{
    ...
    r5 = (r5 + -25816);
    r6 = (r0 + r4);
    MemoryInline::FlatWrite16((r3 + 152), static_cast<uint16_t>(r6));
...
// RECOMP_REGISTRATION base 0x801564EC func_801564EC preserves=true fpr_mask=0x00000000
