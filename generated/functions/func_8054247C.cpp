...
extern "C" void func_8054247C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8054247C:
{
    r0 = (r4 * 24);
    r3 = (r3 + r0);
    r3 = MemoryInline::FlatRead32((r3 + 1456));
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8054247C func_8054247C preserves=true fpr_mask=0x00000000
