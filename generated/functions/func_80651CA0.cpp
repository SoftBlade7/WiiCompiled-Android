...
extern "C" void func_80651CA0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80651CA0:
{
    ...
    r6 = (r1 + 8);
    r0 = MemoryInline::FlatRead32((r12 + 16));
    r7 = (r1 + 24);
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFE73E gpr_write=0xFFFFFFFF gpr_return=0x00000018 fpr_read=0xFFFFFFFF fpr_write=0xFFFFFFFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x80651CA0 func_80651CA0 preserves=true fpr_mask=0x00000000
