...
extern "C" void func_80784C58(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80784C88:
{
    ...
    f4 = ctx->fpr[4];
    cr = ctx->cr;
    r3 = MemoryInline::FlatRead32((r26 + 44));
    r0 = MemoryInline::FlatRead32((r26 + 48));
    MemoryInline::FlatWriteRam32((r1 + 116), r0);
    f3.d = MemoryInline::FlatReadFloat32((r30 + 6056));
    MemoryInline::FlatWriteRam32((r1 + 112), r3);
    r0 = MemoryInline::FlatRead32((r26 + 52));
    MemoryInline::FlatWriteRam32((r1 + 120), r0);
    f2.d = MemoryInline::FlatReadFloat32((r26 + 44));
    ...
    MemoryInline::FlatWriteFloat32((r26 + 44), f2.d);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}

loc_80784CD0:
{
    MemoryInline::FlatWriteFloat32((r26 + 48), f1.d);
...
loc_80784CDC:
{
    r12 = MemoryInline::FlatRead32((r26 + 4));
    r3 = (r26 + 4);
...
loc_80784CF0:
{
    ...
    ctx->fpr[4] = f4;
    ctx->cr = cr;
    InvokeDirectCpu<0x80782FA8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r29 = ctx->gpr[29];
...
{
    r4 = 0;
    r24 = MemoryInline::FlatRead32(r5);
...
{
    r4 = MemoryInline::FlatRead32((r26 + 12));
    r28_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r27), static_cast<uint32_t>(2));
    r28 = (r28_rot_2 & 1020);
    r5 = r24;
    r3 = (r1 + 96);
    r4_addr_2 = (r4 + r28);
    ...
    ctx->fpr[4] = f4;
    ctx->cr = cr;
    InvokeDirectCpu<0x80783254u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    f0 = ctx->fpr[0];
...
loc_80784D98:
{
    f1.d = MemoryInline::FlatReadFloat32((r31 + 18392));
    r3 = (r1 + 32);
    r4 = (r26 + 44);
...
loc_80784E7C:
{
    ...
    MemoryInline::FlatWriteRamFloat32(r3, f0.d);
    // end of inlined leaf 0x8051486C
    f1.d = MemoryInline::FlatReadFloat32((r25 + 18388));
    r3 = (r1 + 56);
    r4 = (r1 + 8);
    // inline leaf 0x80514810 (10 guest instruction(s))
    f3.d = MemoryInline::FlatReadFloat32((r4 + 8));
...
// RECOMP_REGISTRATION base 0x80784C58 func_80784C58 preserves=true fpr_mask=0x00000000
