...
extern "C" void func_805D380C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805D380C:
{
    ...
    r3 = r31;
    MemoryInline::FlatWrite8((r31 + 608), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x805D380C func_805D380C preserves=true fpr_mask=0x00000000
