...
extern "C" void func_805D2B80(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805D2B80:
{
    MemoryInline::FlatWrite32((r16 + 464), r28);
}
...
// RECOMP_REGISTRATION base 0x805D2B80 func_805D2B80 preserves=true fpr_mask=0x00000000
