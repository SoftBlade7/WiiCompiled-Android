...
extern "C" void func_80146718(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80146744:
{
    r7 = 5;
    r6 = 0;
    MemoryInline::FlatWriteRam16((r3 + 2), static_cast<uint16_t>(r7));
    r5 = 20;
    r4 = 2;
    ...
    MemoryInline::FlatWriteRam8((r3 + 8), static_cast<uint8_t>(r7));
    MemoryInline::FlatWriteRam8((r3 + 9), static_cast<uint8_t>(r5));
    MemoryInline::FlatWriteRam8((r3 + 10), static_cast<uint8_t>(r4));
    MemoryInline::FlatWriteRam8((r3 + 11), static_cast<uint8_t>(r31));
...
// RECOMP_REGISTRATION base 0x80146718 func_80146718 preserves=true fpr_mask=0x00000000
