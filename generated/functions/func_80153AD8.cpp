...
extern "C" void func_80153AD8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80153B10:
{
    ...
    r4 = r31;
    r6 = MemoryInline::FlatRead8((r30 + 10));
    r7 = MemoryInline::FlatRead8((r30 + 17));
    ctx->lr = 0x80153B24u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801503D4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80153B80:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r5 = MemoryInline::FlatRead16((r30 + 14));
    r3 = r29;
    r6 = MemoryInline::FlatRead8((r30 + 10));
    r4 = r31;
    r7 = MemoryInline::FlatRead8((r30 + 17));
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80150584u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80153AD8 func_80153AD8 preserves=true fpr_mask=0x00000000
