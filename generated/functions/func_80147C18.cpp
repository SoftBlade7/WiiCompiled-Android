...
extern "C" void func_80147C18(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80147C18:
{
    ...
    r9 = (r9 + -28872);
    r25 = r3;
    r0 = MemoryInline::FlatRead8((r9 + 1024));
    r26 = r4;
    r27 = r5;
    r28 = r6;
}
...
loc_80147C64:
{
    r0 = MemoryInline::FlatRead8((r9 + 1025));
...
loc_80147C84:
{
    if ((static_cast<uint32_t>(r25) > static_cast<uint32_t>(16))) {
        goto loc_80147CA0;
    }
}
...
loc_80147D1C:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80149C9Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80147C18 func_80147C18 preserves=true fpr_mask=0x00000000
