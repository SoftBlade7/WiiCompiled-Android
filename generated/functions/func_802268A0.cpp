...
extern "C" void func_802268A0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_802268A0:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80022720u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80226908:
{
    MemoryInline::FlatWrite32((r13 + -24004), r3);
    if (((cr & 0x20000000u) == 0)) {
        goto loc_80226918;
    }
}
...
loc_80226940:
{
    ...
    // inline leaf 0x80024080 (7 guest instruction(s))
    r5 = 0x802A0000u;
    r0 = r3;
    r5 = (r5 + 28856);
    ...
    // end of inlined leaf 0x80024080
    r6 = MemoryInline::FlatRead32((r13 + -24004));
    r7 = 0;
    r0 = 30;
    r5 = r30;
    MemoryInline::FlatWrite16((r6 + 28), static_cast<uint16_t>(r7));
    r3 = (r31 * 20);
    r4 = 4;
    MemoryInline::FlatWrite16((r6 + 30), static_cast<uint16_t>(r0));
    r6 = MemoryInline::FlatRead32((r13 + -24004));
    MemoryInline::FlatWrite8((r6 + 34), static_cast<uint8_t>(r7));
    MemoryInline::FlatWrite32((r13 + -23996), r31);
    MemoryInline::FlatWrite32((r13 + -23992), r7);
    ctx->lr = 0x8022697Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r13 + -24000), r3);
    r3 = 0x80220000u;
    r3 = (r3 + 25700);
    r4 = 0;
...
// RECOMP_REGISTRATION base 0x802268A0 func_802268A0 preserves=true fpr_mask=0x00000000
