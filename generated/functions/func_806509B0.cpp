...
extern "C" void func_806509B0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806509B0:
{
    r4 = 110;
    ctx->gpr[4] = r4;
    InvokeDirectCpu<0x806509BCu>(ctx);
    r4 = ctx->gpr[4];
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x806509B0 func_806509B0 preserves=true fpr_mask=0x00000000
