...
extern "C" void func_8051B3C8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8051B3F8:
{
    r0 = MemoryInline::FlatRead8((r31 + 9537));
...
{
    r0 = 1;
    MemoryInline::FlatWrite8((r31 + 9537), static_cast<uint8_t>(r0));
    r3 = 0x809C0000u;
...
loc_8051B46C:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80529C0Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x805A1AF0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead32((r31 + 9524));
    r3 = r31;
    r0 = (r4 + 1);
...
loc_8051B508:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite8((r31 + 9536), static_cast<uint8_t>(r3));
    r4 = 0x809C0000u;
    r5 = (r3 & 255);
    r3 = MemoryInline::FlatRead32((r4 + -10484));
    r0 = MemoryInline::FlatRead8((r3 + 16724));
}
...
loc_8051B54C:
{
    MemoryInline::FlatWrite8((r3 + 16724), static_cast<uint8_t>(r5));
}
...
loc_8051B56C:
{
    r0 = MemoryInline::FlatRead8((r3 + 908));
}
...
loc_8051B590:
{
    MemoryInline::FlatWrite8((r3 + 5772), static_cast<uint8_t>(r4));
}
...
loc_8051B5BC:
{
    r0 = MemoryInline::FlatRead8((r31 + 9536));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_8051B610:
{
    ...
    xer = ctx->xer;
    r30 = 0x809C0000u;
    r3 = MemoryInline::FlatRead32((r30 + -10504));
    ctx->lr = 0x8051B638u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead32((r31 + 9516));
}
...
{
    r4 = 0;
    MemoryInline::FlatWrite8((r31 + 9521), static_cast<uint8_t>(r4));
    r3 = MemoryInline::FlatRead32((r30 + -10504));
...
loc_8051B65C:
{
    r0 = MemoryInline::FlatRead8((r31 + 9520));
}
...
{
    r0 = 1;
    MemoryInline::FlatWrite8((r31 + 9521), static_cast<uint8_t>(r0));
    goto loc_8051B684;
}
...
loc_8051B680:
{
    MemoryInline::FlatWrite8((r31 + 9520), static_cast<uint8_t>(r4));
}

loc_8051B684:
{
    r3 = 0x809C0000u;
    r3 = MemoryInline::FlatRead32((r3 + 10416));
    // inline leaf 0x8071B864 (1 guest instruction(s))
    // end of inlined leaf 0x8071B864
    r3 = MemoryInline::FlatRead32((r31 + 9524));
    r0 = (r3 + 1);
    MemoryInline::FlatWrite32((r31 + 9524), r0);
}
...
loc_8051B6AC:
{
    ...
    r5 = MemoryInline::FlatRead32((r4 + 76));
    r4 = MemoryInline::FlatRead32((r5 + 104));
...
loc_8051B718:
{
    r0 = MemoryInline::FlatRead8((r31 + 9529));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
{
    r30 = 0x80380000u;
    r3 = MemoryInline::FlatRead32((r30 + 24520));
    r12 = MemoryInline::FlatRead32(r3);
...
// RECOMP_REGISTRATION base 0x8051B3C8 func_8051B3C8 preserves=true fpr_mask=0x00000000
