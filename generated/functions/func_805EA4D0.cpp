...
extern "C" void func_805EA4D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805EA50C:
{
    r25 = MemoryInline::FlatRead32((r25 + 944));
}
...
loc_805EA52C:
{
    ...
    r27 = 0;
    r5 = 0x805F0000u;
    MemoryInline::FlatWriteRam32((r31 + 32), r27);
    r3 = (r31 + 40);
    r4 = (r4 + 16160);
    r5 = (r5 + -23720);
    MemoryInline::FlatWriteRam16((r31 + 36), static_cast<uint16_t>(r27));
    r6 = 140;
    r7 = 6;
    ctx->lr = 0x805EA568u;
    ctx->gpr[0] = r0;
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r31 + 944), r27);
}
...
loc_inl0_cont_8051BED0:
{
    ...
    r4 = 0x809C0000u;
    r26 = MemoryInline::FlatRead32((r3 + 3220));
...
loc_805EA614:
{
    r5 = MemoryInline::FlatRead32((r28 + 7160));
    r3 = r25;
    r27_addr_2 = (r27 + r29);
    ...
    r26 = (r26 + 1);
    r29 = (r29 + 4);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r26), static_cast<int32_t>(6));
}
...
// RECOMP_REGISTRATION base 0x805EA4D0 func_805EA4D0 preserves=true fpr_mask=0x00000000
