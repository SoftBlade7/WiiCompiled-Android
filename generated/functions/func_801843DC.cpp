...
extern "C" void func_801843DC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80184408:
{
    ...
    r0_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(9));
    r0 = (r0_rot_1 & 480);
    r30_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(4));
    r30 = (r30_rot_1 & 15);
    r31 = (r3 + r0);
    goto loc_80184438;
}
...
loc_80184440:
{
    ...
    r0_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r29), static_cast<uint32_t>(28));
    r0_mrot_1 = (r0_rot_2 & -268435456);
...
// RECOMP_REGISTRATION base 0x801843DC func_801843DC preserves=true fpr_mask=0x00000000
