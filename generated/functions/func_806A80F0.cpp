...
extern "C" void func_806A80F0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806A80F0:
{
    ...
    r31 = r3;
    r4 = MemoryInline::FlatRead32((r3 + 1324));
    ctx->lr = 0x806A8120u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r9 = ctx->gpr[9];
    r31 = ctx->gpr[31];
    r4 = MemoryInline::FlatRead32((r31 + 1324));
    r3 = r31;
    r7 = (r31 + 1780);
    r8 = (r31 + 1992);
    r5 = 5;
...
// RECOMP_REGISTRATION base 0x806A80F0 func_806A80F0 preserves=true fpr_mask=0x00000000
