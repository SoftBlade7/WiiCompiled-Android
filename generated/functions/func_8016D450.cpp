...
extern "C" void func_8016D450(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8016D450:
{
    ...
    r0_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(7));
    r0_mrot_0 = (r0_rot_0 & 128);
    r0_mdest_0 = (r0 & -129);
...
// RECOMP_REGISTRATION base 0x8016D450 func_8016D450 preserves=true fpr_mask=0x00000000
