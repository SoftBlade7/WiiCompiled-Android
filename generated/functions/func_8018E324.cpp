...
extern "C" void func_8018E324(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8018E324:
{
    ...
    r26 = 0;
    MemoryInline::WriteResolved32(guest_range_0, 40u, (r1 + 40), r3);
    r27 = r3;
    r28 = r4;
    MemoryInline::WriteResolved32(guest_range_0, 48u, (r1 + 48), r26);
    r29 = r5;
    r30 = r6;
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 52u, ((static_cast<uint64_t>(static_cast<uint32_t>(r26)) << 32) | static_cast<uint32_t>(r26)))) {
        MemoryInline::WriteResolved32(guest_range_0, 52u, (r1 + 52), r26);
    ...
    r25 = 0x80250000u;
    r4 = r3;
    f31.d = MemoryInline::FlatReadFloat32((r25 + 11264));
    r3 = (r1 + 24);
    r31 = 0;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8018E494:
{
    ...
    r5 = 0x80250000u;
    r4 = 0x80250000u;
    f28.d = MemoryInline::FlatReadFloat32((r5 + 11264));
    r25 = r3;
    f30.d = MemoryInline::FlatReadFloat64((r4 + 11272));
    r26 = 1127219200;
    goto loc_8018E698;
}
...
loc_8018E4D4:
{
    ...
    MemoryInline::FlatWriteRamFloat32((r1 + 16), f28.d);
...
loc_8018E618:
{
    ...
    xer = ctx->xer;
    r0 = (r3 ^ -2147483648);
    MemoryInline::FlatWriteRam32((r1 + 72), r26);
...
loc_8018E6C8:
{
    ...
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 84), 0, 100u, true, false);
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 76u, (r1 + 160));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f30.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 60u, (r1 + 144));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f29.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 44u, (r1 + 128));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r11 = (r1 + 112);
    f28.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 28u, (r1 + 112));
    ...
    r0 = MemoryInline::ReadResolved32(guest_range_1, 96u, (r1 + 180));
    ctx->lr = r0;
    r1 = (r1 + 176);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x8018E324 func_8018E324 preserves=false fpr_mask=0xF0000000
