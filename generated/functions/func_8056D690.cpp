...
extern "C" void func_8056D690(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8056D6B8:
{
    ...
    r7 = MemoryInline::FlatRead32((r29 + 144));
    r6 = 0x80890000u;
    f0.d = MemoryInline::FlatReadFloat32(r3);
    r4 = (r1 + 8);
    f1.d = MemoryInline::FlatReadFloat32(r7);
    r5 = (r1 + 56);
    f2.d = MemoryInline::FlatReadFloat32((r6 + 5912));
    ...
    f3.d = MemoryInline::FlatReadFloat32((r7 + 4));
...
// RECOMP_REGISTRATION base 0x8056D690 func_8056D690 preserves=true fpr_mask=0x00000000
