...
extern "C" void func_800EAF54(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800EB00C:
{
    ...
    r4 = (r4 + 7224);
    r0 = 0;
    MemoryInline::FlatWriteRam32((r4 + 12), r29);
...
// RECOMP_REGISTRATION base 0x800EAF54 func_800EAF54 preserves=true fpr_mask=0x00000000
