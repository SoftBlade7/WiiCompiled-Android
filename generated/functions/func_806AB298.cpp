...
extern "C" void func_806AB298(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806AB298:
{
    ...
    r31 = r3;
    r4 = MemoryInline::FlatRead32((r3 + 580));
...
// RECOMP_REGISTRATION base 0x806AB298 func_806AB298 preserves=true fpr_mask=0x00000000
