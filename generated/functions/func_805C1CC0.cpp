...
extern "C" void func_805C1CC0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805C1CC0:
{
    ...
    r3 = 0x80890000u;
    r5 = 0x808D0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 12768));
    r5 = (r5 + 14156);
    r4 = 2001;
    r0 = 0;
    ...
    r7 = (r7 + 31944);
    guest_range_0 = MemoryInline::ResolveRangeHost((r30 + 2020), 0, 60u, false, true);
    MemoryInline::WriteResolved32(guest_range_0, 16u, (r30 + 2036), r11);
    r4 = 0x808B0000u;
    r6 = (r31 + 12);
    r5 = (r31 + 24);
    MemoryInline::WriteResolved32(guest_range_0, 0u, (r30 + 2020), r7);
    r4 = (r4 + 31920);
    r3 = (r30 + 2088);
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 4u, ((static_cast<uint64_t>(static_cast<uint32_t>(r30)) << 32) | static_cast<uint32_t>(r29)))) {
        MemoryInline::WriteResolved32(guest_range_0, 4u, (r30 + 2024), r30);
        MemoryInline::WriteResolved32(guest_range_0, 8u, (r30 + 2028), r29);
    }
    MemoryInline::WriteResolved32(guest_range_0, 12u, (r30 + 2032), r12);
    {
    ...
    MemoryInline::WriteResolved32(guest_range_0, 36u, (r30 + 2056), r8);
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 20u, ((static_cast<uint64_t>(static_cast<uint32_t>(r7)) << 32) | static_cast<uint32_t>(r30)))) {
        MemoryInline::WriteResolved32(guest_range_0, 20u, (r30 + 2040), r7);
        MemoryInline::WriteResolved32(guest_range_0, 24u, (r30 + 2044), r30);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 28u, ((static_cast<uint64_t>(static_cast<uint32_t>(r10)) << 32) | static_cast<uint32_t>(r9)))) {
        MemoryInline::WriteResolved32(guest_range_0, 28u, (r30 + 2048), r10);
        MemoryInline::WriteResolved32(guest_range_0, 32u, (r30 + 2052), r9);
    }
    {
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 40u, ((static_cast<uint64_t>(static_cast<uint32_t>(r4)) << 32) | static_cast<uint32_t>(r30)))) {
        MemoryInline::WriteResolved32(guest_range_0, 40u, (r30 + 2060), r4);
        MemoryInline::WriteResolved32(guest_range_0, 44u, (r30 + 2064), r30);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 48u, ((static_cast<uint64_t>(static_cast<uint32_t>(r7)) << 32) | static_cast<uint32_t>(r6)))) {
        MemoryInline::WriteResolved32(guest_range_0, 48u, (r30 + 2068), r7);
        MemoryInline::WriteResolved32(guest_range_0, 52u, (r30 + 2072), r6);
    }
    MemoryInline::WriteResolved32(guest_range_0, 56u, (r30 + 2076), r0);
    ctx->lr = 0x805C1DF8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x805C1CC0 func_805C1CC0 preserves=true fpr_mask=0x00000000
