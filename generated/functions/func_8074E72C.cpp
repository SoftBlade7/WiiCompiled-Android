...
extern "C" void func_8074E72C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8074E72C:
{
    ...
    f31.d = MemoryInline::FlatReadFloat32((r4 + -17012));
}
...
// RECOMP_REGISTRATION base 0x8074E72C func_8074E72C preserves=false fpr_mask=0x80000000
