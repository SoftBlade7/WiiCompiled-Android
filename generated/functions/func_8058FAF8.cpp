...
extern "C" void func_8058FAF8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r0 = 0;
    MemoryInline::FlatWriteRam32((r4 + 6392), r0);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_return;
    }
}
...
// RECOMP_REGISTRATION base 0x8058FAF8 func_8058FAF8 preserves=true fpr_mask=0x00000000
