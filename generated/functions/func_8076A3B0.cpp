...
extern "C" void func_8076A3B0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8076A45C:
{
    ...
    f2.d = MemoryInline::FlatReadFloat32((r3 + -6276));
    ...
    f3.d = MemoryInline::FlatReadFloat32((r30 + 208));
    f4.d = PpcFmulsInline(f4.d, f5.d);
    f2.d = MemoryInline::FlatReadFloat32((r31 + 8));
    f1.d = static_cast<double>(PpcForceSingleValueInline(f1.d / f0.d));
    MemoryInline::FlatWriteFloat32((r30 + 184), f4.d);
...
// RECOMP_REGISTRATION base 0x8076A3B0 func_8076A3B0 preserves=false fpr_mask=0x80000000
