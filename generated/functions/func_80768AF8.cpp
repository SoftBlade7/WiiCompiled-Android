...
extern "C" void func_80768AF8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80768B48:
{
    ...
    r4 = 0x808A0000u;
    r3 = r28;
    f1.d = MemoryInline::FlatReadFloat32((r4 + 15392));
    r4 = 466;
    ctx->lr = 0x80768B9Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80768BB0:
{
    ...
    r0 = (r0_rot_3 & 1020);
    f1.d = MemoryInline::FlatReadFloat32((r31 + 15396));
    r4 = 35;
...
// RECOMP_REGISTRATION base 0x80768AF8 func_80768AF8 preserves=true fpr_mask=0x00000000
