...
extern "C" void func_80790AC0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80790AC0:
{
    r3 = 0x809C0000u;
    r0 = 12;
    MemoryInline::FlatWriteRam32((r3 + 12096), r0);
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80790AC0 func_80790AC0 preserves=true fpr_mask=0x00000000
