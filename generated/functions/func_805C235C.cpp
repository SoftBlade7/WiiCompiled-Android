...
extern "C" void func_805C235C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805C235C:
{
    r3 = MemoryInline::FlatRead32((r3 + 2644));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x805C235C func_805C235C preserves=true fpr_mask=0x00000000
