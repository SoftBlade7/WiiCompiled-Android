...
extern "C" void func_800A8420(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800A8420:
{
    r3 = MemoryInline::FlatRead8((r3 + 286));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x800A8420 func_800A8420 preserves=true fpr_mask=0x00000000
