...
extern "C" void func_801E1A6C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801E1AD0:
{
    if ((static_cast<uint32_t>(r29) <= static_cast<uint32_t>(r23))) {
        goto loc_801E1ADC;
    }
}
...
loc_801E1AEC:
{
    if ((static_cast<int32_t>(r4) != static_cast<int32_t>(34))) {
        goto loc_801E1AF8;
    }
}
...
loc_801E1B34:
{
    if ((static_cast<int32_t>(r4) == static_cast<int32_t>(9))) {
        goto loc_801E1B90;
    }
}
...
loc_801E1B5C:
{
    if ((static_cast<int32_t>(r4) != static_cast<int32_t>(62))) {
        goto loc_801E1B68;
    }
}
...
loc_801E1B80:
{
    if ((static_cast<int32_t>(r4) != static_cast<int32_t>(64))) {
        goto loc_801E1B88;
    }
}
...
{
    r24_addr_2 = (r24 + r28);
    MemoryInline::FlatWrite8(r24_addr_2, static_cast<uint8_t>(r3));
    r28 = (r28 + 1);
}
...
{
    r24_addr_4 = (r24 + r28);
    MemoryInline::FlatWrite8(r24_addr_4, static_cast<uint8_t>(r0));
    if (((cr & 0x20000000u) != 0)) {
        goto loc_801E1BCC;
    }
}
...
// RECOMP_REGISTRATION base 0x801E1A6C func_801E1A6C preserves=true fpr_mask=0x00000000
