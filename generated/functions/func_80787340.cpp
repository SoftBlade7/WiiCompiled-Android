...
extern "C" void func_80787340(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807873A8:
{
    ...
    r29 = MemoryInline::FlatRead32((r4 + 12024));
...
loc_807873C4:
{
    ...
    r28 = MemoryInline::FlatRead32((r4 + 12024));
...
// RECOMP_REGISTRATION base 0x80787340 func_80787340 preserves=true fpr_mask=0x00000000
