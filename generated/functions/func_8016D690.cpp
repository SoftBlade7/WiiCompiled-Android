...
extern "C" void func_8016D690(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8016D690:
{
    ...
    r6_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(5));
    r6_mrot_0 = (r6_rot_0 & 32);
    r6_mdest_0 = (r6 & -33);
...
// RECOMP_REGISTRATION base 0x8016D690 func_8016D690 preserves=true fpr_mask=0x00000000
