...
extern "C" void func_800973A0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800973A0:
{
    ...
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
    InvokeDirectCpu<0x800962E0u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
...
// RECOMP_REGISTRATION base 0x800973A0 func_800973A0 preserves=true fpr_mask=0x00000000
