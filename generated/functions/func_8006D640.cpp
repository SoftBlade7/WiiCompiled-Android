...
extern "C" void func_8006D640(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8006D670:
{
    ...
    r4 = r5;
    r6_addr_1 = (r6 + r0);
    r12 = MemoryInline::FlatRead32(r6_addr_1);
    ctr = r12;
    ctx->lr = 0x8006D68Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8006D690:
{
    ...
    r4 = r5;
    r6_addr_2 = (r6 + r0);
    r12 = MemoryInline::FlatRead32(r6_addr_2);
    ctr = r12;
    ctx->lr = 0x8006D6ACu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8006D6AC:
{
    f1.d = MemoryInline::FlatReadFloat32((r2 + -29320));
    r3 = 1;
...
// RECOMP_REGISTRATION base 0x8006D640 func_8006D640 preserves=true fpr_mask=0x00000000
