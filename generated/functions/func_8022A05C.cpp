...
extern "C" void func_8022A05C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8022A0A8:
{
    r3 = MemoryInline::FlatRead32((r13 + -23964));
    goto loc_8022A0B4;
}
...
loc_8022A0B4:
{
    ...
    ctx->fpr[2] = f2;
    ctx->cr = cr;
    InvokeDirectCpu<0x800771D0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
    ...
    ctx->fpr[2] = f2;
    ctx->cr = cr;
    InvokeDirectCpu<0x8006DC20u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r7 = (r0 + r26);
    r6 = 1;
    MemoryInline::FlatWrite16((r7 + 8), static_cast<uint16_t>(r30));
    r7 = MemoryInline::FlatRead32(r28);
    r7_addr_2 = (r7 + r26);
    MemoryInline::FlatWrite32(r7_addr_2, r28);
    r0 = MemoryInline::FlatRead32(r28);
    r7 = (r0 + r26);
    MemoryInline::FlatWrite8((r7 + 10), static_cast<uint8_t>(r27));
    ctx->lr = 0x8022A13Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8022A05C func_8022A05C preserves=true fpr_mask=0x00000000
