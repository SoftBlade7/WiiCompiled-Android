...
extern "C" void func_806DE5D0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806DE5D0:
{
    ...
    r0 = MemoryInline::FlatRead32((r4 + 1188));
    r4 = (r1 + 12);
...
// RECOMP_REGISTRATION base 0x806DE5D0 func_806DE5D0 preserves=true fpr_mask=0x00000000
