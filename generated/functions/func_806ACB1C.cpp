...
extern "C" void func_806ACB1C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806ACBC8:
{
    f1.d = MemoryInline::FlatReadFloat32((r31 + 2508));
    r3 = (r1 + 140);
    r4 = (r31 + 1756);
...
loc_806ACCE0:
{
    ...
    guest_range_2 = MemoryInline::ResolveRangeHost((r1 + 120), 0, 176u, false, true);
    MemoryInline::WriteResolved32(guest_range_2, 132u, (r1 + 252), r0);
    f0.d = MemoryInline::FlatReadFloat32((r4 + -10592));
    MemoryInline::WriteResolved32(guest_range_2, 128u, (r1 + 248), r5);
    {
    ...
    r3 = (r1 + 116);
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 168u, ((static_cast<uint64_t>(static_cast<uint32_t>(r4)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_2, 172u, (r1 + 292), r0);
        MemoryInline::WriteResolved32(guest_range_2, 168u, (r1 + 288), r4);
    }
...
loc_806ACED8:
{
    r3 = MemoryInline::FlatRead32((r31 + 716));
    r12 = MemoryInline::FlatRead32(r3);
    ...
    MemoryInline::FlatWriteRamFloat64((r1 + 344), f0.d);
    r12 = MemoryInline::FlatRead32(r3);
    r4 = fctiwzword0;
...
// RECOMP_REGISTRATION base 0x806ACB1C func_806ACB1C preserves=false fpr_mask=0xC0000000
