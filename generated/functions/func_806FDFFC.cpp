...
extern "C" void func_806FDFFC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_806FDFFC:
{
    ...
    ctx->gpr[5] = r5;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x8021318Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r5 = ctx->gpr[5];
...
// RECOMP_REGISTRATION base 0x806FDFFC func_806FDFFC preserves=true fpr_mask=0x00000000
