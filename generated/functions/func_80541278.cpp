...
extern "C" void func_80541278(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
{
    r3 = 0x80890000u;
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r30), static_cast<int32_t>(48));
}
...
// RECOMP_REGISTRATION base 0x80541278 func_80541278 preserves=true fpr_mask=0x00000000
