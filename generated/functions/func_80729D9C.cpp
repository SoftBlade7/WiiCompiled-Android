...
extern "C" void func_80729D9C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80729D9C:
{
    ...
    r0 = 0;
    r3 = (r3 + -25348);
    guest_range_0 = MemoryInline::ResolveRangeHost((r30 + 52), 0, 44u, false, true);
    MemoryInline::WriteResolved32(guest_range_0, 0u, (r30 + 52), r3);
    r3 = 64;
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 4u, ((static_cast<uint64_t>(static_cast<uint32_t>(r31)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_0, 4u, (r30 + 56), r31);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 12u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_0, 12u, (r30 + 64), r0);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 20u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | static_cast<uint32_t>(r0)))) {
        ...
        MemoryInline::WriteResolved32(guest_range_0, 24u, (r30 + 76), r0);
    }
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 36u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_0, 36u, (r30 + 88), r0);
...
loc_80729E04:
{
    ...
    ctx->fpr[1] = f1;
    ctx->cr = cr;
    InvokeDirectCpu<0x8073B0F8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80729E1C:
{
    ...
    ctx->fpr[1] = f1;
    ctx->cr = cr;
    InvokeDirectCpu<0x80744730u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80729E38:
{
    ...
    ctx->fpr[0] = f0;
    ctx->fpr[1] = f1;
    InvokeDirectCpu<0x80726574u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80729E54:
{
    r5 = 0x808A0000u;
    r4 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r5 + 9544));
    r0 = 0;
    ...
    f0.d = MemoryInline::FlatReadFloat32((r4 + 9548));
    ...
    MemoryInline::WriteResolved8(guest_range_1, 36u, (r3 + 36), static_cast<uint8_t>(r0));
    MemoryInline::WriteResolved8(guest_range_1, 37u, (r3 + 37), static_cast<uint8_t>(r0));
    MemoryInline::WriteResolved8(guest_range_1, 38u, (r3 + 38), static_cast<uint8_t>(r0));
    MemoryInline::WriteResolved8(guest_range_1, 39u, (r3 + 39), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x80729D9C func_80729D9C preserves=true fpr_mask=0x00000000
