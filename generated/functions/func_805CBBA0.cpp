...
extern "C" void func_805CBBA0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805CBBA0:
{
    ...
    MemoryInline::WriteResolved32(guest_range_0, 48u, r3, r4);
    // end of inlined leaf 0x805C2C18
    r5 = (r30 + 592);
    r7 = MemoryInline::FlatRead32((r30 + 592));
    r12 = MemoryInline::FlatRead32((r5 + 4));
    r31 = 0x80890000u;
    r11 = MemoryInline::FlatRead32((r5 + 8));
    r31 = (r31 + 15520);
    r10 = MemoryInline::FlatRead32((r5 + 12));
    r6 = r29;
    r9 = MemoryInline::FlatRead32((r5 + 16));
    r3 = (r1 + 48);
    r8 = MemoryInline::FlatRead32((r5 + 20));
    r4 = (r31 + 243);
    r0 = MemoryInline::FlatRead32((r5 + 24));
    r5 = (r31 + 250);
    MemoryInline::WriteResolved32(guest_range_0, 16u, (r1 + 16), r7);
    r7 = (r1 + 16);
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 20u, ((static_cast<uint64_t>(static_cast<uint32_t>(r12)) << 32) | static_cast<uint32_t>(r11)))) {
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 36u, ((static_cast<uint64_t>(static_cast<uint32_t>(r8)) << 32) | static_cast<uint32_t>(r0)))) {
...
loc_805CBC54:
{
    f1.d = MemoryInline::FlatReadFloat32((r30 + 620));
...
// RECOMP_REGISTRATION base 0x805CBBA0 func_805CBBA0 preserves=true fpr_mask=0x00000000
