...
extern "C" void func_806C9BC0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806C9BC0:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    f30.d = MemoryInline::FlatReadFloat64((r29 + 96));
    r28 = 0;
    f31.d = MemoryInline::FlatReadFloat32((r29 + 192));
    r27 = 0;
    r26 = 80;
    r30 = 1127219200;
    goto loc_806C9C98;
...
loc_806C9C24:
{
    ...
    r3 = MemoryInline::FlatRead32((r3 + 40));
    f29.d = static_cast<double>(PpcForceSingleValueInline(f0.d / f31.d));
...
loc_806C9CA4:
{
    r30 = MemoryInline::FlatRead32((r31 + 216));
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32(r29);
    r5 = 1;
    ...
    r3 = 0x808C0000u;
    r0 = 0;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 17200));
    MemoryInline::FlatWriteFloat32((r31 + 272), f0.d);
    MemoryInline::FlatWrite16((r31 + 276), static_cast<uint16_t>(r0));
    MemoryInline::FlatWrite8((r31 + 278), static_cast<uint8_t>(r0));
    MemoryInline::FlatWrite16((r31 + 280), static_cast<uint16_t>(r0));
    MemoryInline::FlatWrite16((r31 + 282), static_cast<uint16_t>(r0));
    MemoryInline::FlatWrite16((r31 + 284), static_cast<uint16_t>(r0));
...
// RECOMP_REGISTRATION base 0x806C9BC0 func_806C9BC0 preserves=false fpr_mask=0xE0000000
