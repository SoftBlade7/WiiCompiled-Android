...
extern "C" void func_8014CD54(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8014CDBC:
{
    ...
    r0 = (r0 & 65535);
    r4 = MemoryInline::FlatRead16((r3 + 52));
}
...
loc_8014CDF4:
{
    MemoryInline::FlatWrite16((r3 + 56), static_cast<uint16_t>(r27));
}
...
loc_8014CDF8:
{
    ...
    r5 = 0;
    r0 = (r0 + r26);
    MemoryInline::FlatWriteRam16((r28 + 4), static_cast<uint16_t>(r0));
    ctx->lr = 0x8014CE10u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8014CD54 func_8014CD54 preserves=true fpr_mask=0x00000000
