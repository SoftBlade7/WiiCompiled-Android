...
extern "C" void func_801D5E68(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = 1;
    MemoryInline::FlatWrite32((r3 + 840), r0);
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x801D5E68 func_801D5E68 preserves=true fpr_mask=0x00000000
