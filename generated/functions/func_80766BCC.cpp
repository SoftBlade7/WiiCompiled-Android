...
extern "C" void func_80766BCC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80766C3C:
{
    r4 = MemoryInline::FlatRead32((r28 + 208));
    r3 = r29;
    r5 = (r1 + 20);
    ctx->lr = 0x80766C4Cu;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x80766BCC func_80766BCC preserves=true fpr_mask=0x00000000
