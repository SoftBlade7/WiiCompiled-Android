...
extern "C" void func_80623BE4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80623BF4:
{
    ...
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x805FB5BCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
}
...
// RECOMP_REGISTRATION base 0x80623BE4 func_80623BE4 preserves=true fpr_mask=0x00000000
