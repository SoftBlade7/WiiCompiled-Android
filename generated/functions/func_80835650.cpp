...
extern "C" void func_80835650(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80835650:
{
    ...
    r24 = r5;
    MemoryInline::FlatWriteFloat32(r6, f31.d);
    r25 = r6;
    r26 = r7;
    r31 = (r4 + r0);
    MemoryInline::FlatWriteFloat32((r6 + 4), f31.d);
    r30 = (r4 + 64);
    r29 = (r4 + 112);
    r28 = 0;
    MemoryInline::FlatWriteFloat32((r6 + 8), f31.d);
    r27 = 1;
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 44u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f31.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f31.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_2, 44u, (r1 + 44), f31.d);
        MemoryInline::WriteResolvedFloat32(guest_range_2, 48u, (r1 + 48), f31.d);
    }
    MemoryInline::WriteResolvedFloat32(guest_range_2, 52u, (r1 + 52), f31.d);
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 32u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f31.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f31.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_2, 32u, (r1 + 32), f31.d);
        MemoryInline::WriteResolvedFloat32(guest_range_2, 36u, (r1 + 36), f31.d);
    }
    MemoryInline::WriteResolvedFloat32(guest_range_2, 40u, (r1 + 40), f31.d);
    MemoryInline::FlatWriteFloat32(r7, f31.d);
    MemoryInline::FlatWriteFloat32((r7 + 4), f31.d);
    MemoryInline::FlatWriteFloat32((r7 + 8), f31.d);
}
...
{
    r28 = (r28 + 1);
    r27_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r27), static_cast<uint32_t>(1));
    r27 = (r27_rot_2 & -2);
...
loc_80835770:
{
    ...
    MemoryInline::FlatWriteFloat32(r25, f2.d);
...
// RECOMP_GUEST_ABI gpr_read=0xFF0000FB gpr_write=0xFF00081B gpr_return=0x00000018 fpr_read=0x8000000F fpr_write=0x8000000F fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80835650 func_80835650 preserves=true fpr_mask=0x00000000
