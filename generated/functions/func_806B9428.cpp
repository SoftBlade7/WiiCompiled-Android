...
extern "C" void func_806B9428(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806B9454:
{
    ...
    r4 = 0x808A0000u;
    r3 = r31;
    f1.d = MemoryInline::FlatReadFloat32((r4 + -3528));
    r4 = (r1 + 8);
...
// RECOMP_REGISTRATION base 0x806B9428 func_806B9428 preserves=true fpr_mask=0x00000000
