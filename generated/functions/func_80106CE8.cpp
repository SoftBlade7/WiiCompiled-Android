...
extern "C" void func_80106CE8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80106CE8:
{
    MemoryInline::FlatWriteRam32((r1 + -1344), r1);
    r1 = (r1 + -1344);
    r0 = ctx->lr;
    MemoryInline::FlatWriteRam32((r1 + 1348), r0);
    r11 = (r1 + 1344);
...
loc_80106D14:
{
    ...
    r29 = r4;
    r20 = (r20 + -16664);
    r18_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(1));
    r18 = (r18_rot_0 & 1);
    if (((cr & 0x20000000u) == 0)) {
        goto loc_80106D70;
    }
...
loc_80106D8C:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x800FF498u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80106F38:
{
    r0 = MemoryInline::FlatRead8((r31 + 143));
    r0 = (static_cast<int32_t>(static_cast<int8_t>(r0)));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
    if (((cr & 0x20000000u) != 0)) {
        goto loc_80106F64;
...
loc_80106F64:
{
    r0 = MemoryInline::FlatRead8((r31 + 174));
    r0 = (static_cast<int32_t>(static_cast<int8_t>(r0)));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
    if (((cr & 0x20000000u) != 0)) {
        goto loc_80106F90;
...
loc_80106FBC:
{
    r0 = MemoryInline::FlatRead32((r31 + 312));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_80106FC8:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r5 = MemoryInline::FlatRead32((r31 + 312));
    r3 = r28;
    r4 = (r31 + 24);
    ctx->lr = 0x80106FE8u;
    ctx->gpr[0] = r0;
...
loc_801070F8:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r5 = MemoryInline::FlatRead32((r31 + 316));
    r3 = r28;
    r4 = (r31 + 24);
    ctx->lr = 0x80107168u;
    ctx->gpr[0] = r0;
...
loc_80107474:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r5 = MemoryInline::FlatRead32((r31 + 332));
    r3 = r28;
    r4 = (r31 + 24);
    r5_addr_3 = (r5 + r16);
...
loc_80107528:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r29 + 20), r22);
    goto loc_801089B4;
}
...
loc_80107568:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x800FF350u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80107624:
{
    ...
    r3 = r28;
    r5 = 1;
    MemoryInline::FlatWrite32((r29 + 20), r23);
...
loc_80107660:
{
    ...
    MemoryInline::FlatWriteRam32((r1 + 188), r24);
...
loc_80107674:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8010914Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80107750:
{
    r6 = MemoryInline::FlatRead32((r1 + 180));
    r4 = 0;
    r5 = 172;
    r0 = (r6 + -1);
    r0 = (r0 * 172);
...
loc_80107780:
{
    r15 = MemoryInline::FlatRead32((r1 + 32));
    r3 = r28;
    r4 = MemoryInline::FlatRead32((r31 + 8));
    r5 = (r1 + 32);
    r6 = (r1 + 752);
...
loc_801078E8:
{
    MemoryInline::FlatWriteRam32((r1 + 168), r12);
    r15 = MemoryInline::FlatRead32((r1 + 184));
    MemoryInline::FlatWriteRam32((r1 + 172), r5);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_80107908;
    }
}
...
loc_80107908:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r15), static_cast<int32_t>(1536));
}
...
loc_8010791C:
{
    ...
    r10 = MemoryInline::FlatRead32((r1 + 180));
    r0 = MemoryInline::FlatRead32((r31 + 312));
    r9 = MemoryInline::FlatRead32((r31 + 308));
    r10 = (r10 + r0);
    ctx->lr = 0x80107960u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80107A24:
{
    MemoryInline::FlatWriteRam32(r3, r24);
    r4 = (r31 + 92);
    r5 = 51;
    r3 = (r3 + 4);
    ctx->lr = 0x80107A38u;
...
loc_80107A44:
{
    MemoryInline::FlatWriteRam32((r15 + 56), r24);
    goto loc_80107A50;
}

loc_80107A4C:
{
    MemoryInline::FlatWriteRam32((r15 + 56), r27);
}
...
loc_80107ACC:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r19 + 56), r24);
    r3 = r28;
    r5 = (r1 + 32);
    r6 = (r1 + 752);
    MemoryInline::FlatWriteRam32((r19 + 60), r24);
    r7 = (r1 + 240);
    MemoryInline::FlatWriteRam32((r19 + 64), r24);
    r4 = MemoryInline::FlatRead32((r31 + 8));
    ctx->lr = 0x80107B00u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80107B84:
{
    r4 = MemoryInline::FlatRead32((r19 + 56));
    r3 = MemoryInline::FlatRead32((r19 + 60));
    r0 = (r4 + 1);
...
loc_80107BB4:
{
    MemoryInline::FlatWriteRam32((r19 + 60), r3);
    r3 = 31;
    ctx->lr = 0x80107BC0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80107BDC:
{
    r0 = MemoryInline::FlatRead32((r19 + 56));
    r4 = (r1 + 240);
    r6 = MemoryInline::FlatRead32((r19 + 60));
    r5 = 31;
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r19 + 56));
    r0 = (r3 + 1);
    MemoryInline::FlatWriteRam32((r19 + 56), r0);
    goto loc_80107D04;
}
...
loc_80107C38:
{
    r3 = MemoryInline::FlatRead32((r19 + 64));
    r4_rot_4 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(2));
    r4 = (r4_rot_4 & -4);
    ctx->lr = 0x80107C44u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80107C60:
{
    MemoryInline::FlatWriteRam32((r19 + 64), r3);
    r3 = 21;
    ctx->lr = 0x80107C6Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80107C88:
{
    r0 = MemoryInline::FlatRead32((r19 + 56));
    r4 = (r1 + 240);
    r6 = MemoryInline::FlatRead32((r19 + 64));
    r5 = 21;
...
loc_80107D88:
{
    ...
    MemoryInline::FlatWriteRam32(r3, r24);
    MemoryInline::FlatWriteRam32((r3 + 8), r24);
    MemoryInline::FlatWriteRam32((r3 + 12), r24);
}
...
loc_80107DF4:
{
    r3 = MemoryInline::FlatRead32((r19 + 8));
    r0 = (r3 + 1);
    MemoryInline::FlatWriteRam32((r19 + 8), r0);
    r4 = (r0 * 296);
...
loc_80107E10:
{
    MemoryInline::FlatWriteRam32((r19 + 12), r3);
    if (((cr & 0x20000000u) == 0)) {
        goto loc_80107E2C;
    }
}
...
loc_80107E2C:
{
    r6 = MemoryInline::FlatRead32((r19 + 8));
    r4 = 0;
    r5 = 296;
    r0 = (r6 + -1);
    r0 = (r0 * 296);
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r17 + 36), r27);
    r3 = (r1 + 240);
    ctx->lr = 0x80107E58u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80107EE8:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r17 + 36), r3);
    goto loc_80107F28;
}
...
loc_8010802C:
{
    MemoryInline::FlatWrite32((r30 + 1464), r3);
    r15 = 0;
    goto loc_80108088;
}
...
loc_80108038:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80108FB4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801080AC:
{
    ...
    r4 = (r1 + 136);
    MemoryInline::FlatWriteRam32((r1 + 136), r7);
    r7 = 0;
...
loc_80108288:
{
    ...
    r6 = (r1 + 752);
    r7 = (r1 + 240);
    MemoryInline::FlatWriteRam32((r3 + 4), r24);
    MemoryInline::FlatWriteRam32((r3 + 8), r24);
    r3 = r28;
    r4 = MemoryInline::FlatRead32((r31 + 8));
    ctx->lr = 0x801082ACu;
...
loc_8010837C:
{
    MemoryInline::FlatWriteRam32((r19 + 8), r3);
    r4 = 0;
    r5 = 172;
    ...
    r3 = (r1 + 240);
    r0 = (r4 + 1);
    MemoryInline::FlatWriteRam32((r19 + 4), r0);
    ctx->lr = 0x801083B0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32(r16, r3);
    r17 = 0;
}
...
loc_80108654:
{
    r4 = MemoryInline::FlatRead32((r17 + 4));
    r3 = MemoryInline::FlatRead32((r17 + 8));
    r0 = (r4 + 1);
    r4 = (r0 * 28);
    ctx->lr = 0x80108668u;
    ctx->gpr[0] = r0;
...
loc_80108684:
{
    MemoryInline::FlatWriteRam32((r17 + 8), r3);
    r4 = 0;
    r5 = 28;
    r0 = MemoryInline::FlatRead32((r17 + 4));
    r0 = (r0 * 28);
    r19 = (r3 + r0);
    r3 = r19;
    ctx->lr = 0x801086A4u;
    ...
    r3 = (r1 + 240);
    r0 = (r4 + 1);
    MemoryInline::FlatWriteRam32((r17 + 4), r0);
    ctx->lr = 0x801086B8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_80108868:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r16 + 4), r3);
...
loc_80108880:
{
    MemoryInline::FlatWriteRam32((r16 + 8), r3);
    if (((cr & 0x20000000u) == 0)) {
        goto loc_8010889C;
    }
}
...
loc_801088DC:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead32((r16 + 8));
    r4_addr_3 = (r4 + r19);
    MemoryInline::FlatWrite32(r4_addr_3, r3);
    r3 = MemoryInline::FlatRead32((r16 + 8));
    r3_addr_6 = (r3 + r19);
...
loc_8010893C:
{
    MemoryInline::FlatWriteRam32((r16 + 4), r17);
    r18 = 1;
    goto loc_80108970;
}
...
loc_801089AC:
{
    MemoryInline::FlatWrite32((r31 + 324), r27);
    r18 = 0;
}
...
loc_801089D0:
{
    ...
    r0 = MemoryInline::FlatRead32((r1 + 1348));
    ctx->lr = r0;
    r1 = (r1 + 1344);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x80106CE8 func_80106CE8 preserves=true fpr_mask=0x00000000
