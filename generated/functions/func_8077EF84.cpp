...
extern "C" void func_8077EF84(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8077EF84:
{
    ...
    r0 = MemoryInline::FlatRead32((r3 + 11760));
...
loc_8077EFB8:
{
    ...
    r3 = (r31 + 356);
    MemoryInline::FlatWriteRam32((r31 + 284), r0);
    MemoryInline::FlatWriteRam32((r31 + 288), r0);
    MemoryInline::FlatWriteRam32((r31 + 304), r0);
    ctx->lr = 0x8077EFE0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
{
    r3 = 0x809C0000u;
    MemoryInline::FlatWriteRam32((r3 + 11760), r31);
}
...
// RECOMP_REGISTRATION base 0x8077EF84 func_8077EF84 preserves=true fpr_mask=0x00000000
