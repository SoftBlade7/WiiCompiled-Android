...
extern "C" void func_802006A0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_802006A0:
{
    ...
    r28 = r3;
    r0 = MemoryInline::FlatRead32((r3 + 5576));
...
loc_80200748:
{
    ...
    r3 = 0;
    MemoryInline::FlatWrite32((r29 + 564), r3);
...
loc_80200774:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite8((r29 + 524), static_cast<uint8_t>(r3));
}
...
// RECOMP_REGISTRATION base 0x802006A0 func_802006A0 preserves=true fpr_mask=0x00000000
