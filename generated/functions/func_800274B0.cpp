...
extern "C" void func_800274B0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800274B0:
{
    MemoryInline::FlatWriteRam32((r1 + -4144), r1);
    r1 = (r1 + -4144);
    r0 = ctx->lr;
    MemoryInline::FlatWriteRam32((r1 + 4148), r0);
    r11 = (r1 + 4144);
    ...
    r5 = (r3 + 65536);
    r30 = r3;
    r3 = MemoryInline::FlatRead32((r5 + -16360));
    r4 = (r1 + 8);
    r3 = (r3 + r0);
...
loc_800274FC:
{
    ...
    r0 = (r0_rot_2 & 262140);
    r27_addr_2 = (r27 + r0);
    r25 = MemoryInline::FlatRead32(r27_addr_2);
...
loc_80027510:
{
    r0 = MemoryInline::FlatRead32((r25 + 64));
    r3 = (r30 + 65536);
    r4 = MemoryInline::FlatRead32((r3 + -16360));
    r3 = r25;
    r0 = (r0 * 28);
    r5 = (r4 + r0);
    r4 = MemoryInline::FlatRead16((r5 + 24));
    r0 = (r4 + -1);
    MemoryInline::FlatWrite16((r5 + 24), static_cast<uint16_t>(r0));
    r12 = MemoryInline::FlatRead32((r25 + 28));
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r25 + 12), r28);
...
loc_8002757C:
{
    ...
    r0 = MemoryInline::ReadResolved32(guest_range_0, 32u, (r1 + 4148));
    ctx->lr = r0;
    r1 = (r1 + 4144);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x800274B0 func_800274B0 preserves=true fpr_mask=0x00000000
