...
extern "C" MkwStateFreeResult2 func_8063C820_statefree(uint32_t, uint32_t);

extern "C" void func_807E45C0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807E45C0:
{
    ...
    xer = ctx->xer;
    r30 = 0x808B0000u;
    r26 = MemoryInline::FlatRead32((r3 + 9172));
    r27 = r23;
    r28 = (r23 + 372);
    r30 = (r30 + -32224);
    r25 = 0;
...
loc_inl3_cont_80860B54:
{
    ...
    r4 = 0;
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x8063C820u) && KnownTranslatedCpuCall<0x8063C820u>::kAvailable && !KnownTranslatedCpuCall<0x8063C820u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x8063C820u>()) {
        const auto state_free_result_8063C820_3826 = func_8063C820_statefree(r3, r4);
        r0 = static_cast<uint32_t>(state_free_result_8063C820_3826[0]);
        r3 = static_cast<uint32_t>(state_free_result_8063C820_3826[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
        ...
        ctx->cr = cr;
        ctx->ctr = ctr;
        InvokeDirectCpu<0x8063C820u>(ctx);
        r0 = ctx->gpr[0];
        r1 = ctx->gpr[1];
        r3 = ctx->gpr[3];
        r4 = ctx->gpr[4];
    ...
    f1.d = MemoryInline::FlatReadFloat32((r31 + -32284));
    r4 = 0;
    ctx->lr = 0x807E46A4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x8063C820u) && KnownTranslatedCpuCall<0x8063C820u>::kAvailable && !KnownTranslatedCpuCall<0x8063C820u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x8063C820u>()) {
        const auto state_free_result_8063C820_4386 = func_8063C820_statefree(r3, r4);
        r0 = static_cast<uint32_t>(state_free_result_8063C820_4386[0]);
        r3 = static_cast<uint32_t>(state_free_result_8063C820_4386[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x8063C820u) && KnownTranslatedCpuCall<0x8063C820u>::kAvailable && !KnownTranslatedCpuCall<0x8063C820u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x8063C820u>()) {
        const auto state_free_result_8063C820_4EE8 = func_8063C820_statefree(r3, r4);
        r0 = static_cast<uint32_t>(state_free_result_8063C820_4EE8[0]);
        r3 = static_cast<uint32_t>(state_free_result_8063C820_4EE8[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x8063C820u) && KnownTranslatedCpuCall<0x8063C820u>::kAvailable && !KnownTranslatedCpuCall<0x8063C820u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x8063C820u>()) {
        const auto state_free_result_8063C820_5996 = func_8063C820_statefree(r3, r4);
        r0 = static_cast<uint32_t>(state_free_result_8063C820_5996[0]);
        r3 = static_cast<uint32_t>(state_free_result_8063C820_5996[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    xer = ctx->xer;
    r25 = (r25 + 1);
    MemoryInline::FlatWrite8((r27 + 764), static_cast<uint8_t>(r24));
...
// RECOMP_REGISTRATION base 0x807E45C0 func_807E45C0 preserves=true fpr_mask=0x00000000
