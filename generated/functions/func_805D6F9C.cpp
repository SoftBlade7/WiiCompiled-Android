...
extern "C" void func_805D6F9C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
{
    r30 = 0x809C0000u;
    r4 = MemoryInline::FlatRead32((r29 + 4360));
...
{
    r0 = 153;
    MemoryInline::FlatWrite32((r31 + 2852), r0);
    r3 = r28;
    ctx->lr = 0x805D7164u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x805D6F9C func_805D6F9C preserves=true fpr_mask=0x00000000
