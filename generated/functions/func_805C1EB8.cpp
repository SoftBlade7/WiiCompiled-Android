...
extern "C" void func_805C1EB8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_805C1EB8:
{
    ...
    r4 = 1;
    MemoryInline::FlatWrite32((r3 + 2080), r6);
    MemoryInline::FlatWrite32((r3 + 2084), r6);
    MemoryInline::FlatWrite32((r3 + 2640), r0);
    MemoryInline::FlatWrite32((r3 + 2644), r0);
    r3 = (r3 + 2088);
...
// RECOMP_REGISTRATION base 0x805C1EB8 func_805C1EB8 preserves=true fpr_mask=0x00000000
