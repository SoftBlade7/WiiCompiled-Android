...
extern "C" void func_80756838(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80756838:
{
    ...
    f1.d = (-(f1.d));
    f0.d = (-(f0.d));
    MemoryInline::WriteResolvedFloat32(guest_range_0, 40u, (r3 + 8), f2.d);
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 32u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f1.d))))) {
        ...
        MemoryInline::WriteResolvedFloat32(guest_range_0, 36u, (r3 + 4), f1.d);
    }
...
loc_807569D8:
{
    ...
    r4 = 0x808D0000u;
    f1.d = f0.d;
    f2.d = MemoryInline::FlatReadFloat32((r4 + -15104));
    r3 = MemoryInline::FlatRead32((r3 + 40));
    r4 = 4;
    ctx->lr = 0x807569F4u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x80756838 func_80756838 preserves=true fpr_mask=0x00000000
