...
extern "C" void func_8070E72C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8070E72C:
{
    ...
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r0), static_cast<uint32_t>(115));
}
...
// RECOMP_REGISTRATION base 0x8070E72C func_8070E72C preserves=true fpr_mask=0x00000000
