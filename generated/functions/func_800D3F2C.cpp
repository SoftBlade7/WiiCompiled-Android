...
extern "C" void func_800D3F2C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800D3F2C:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800E88F8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x800D3F2C func_800D3F2C preserves=true fpr_mask=0x00000000
