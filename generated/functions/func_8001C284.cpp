...
extern "C" void func_8001C284(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8001C284:
{
    ...
    ctx->gpr[3] = r3;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x8001D9E0u>(ctx);
    r3 = ctx->gpr[3];
    r30 = ctx->gpr[30];
    r31 = ctx->gpr[31];
    r31 = r3;
...
// RECOMP_REGISTRATION base 0x8001C284 func_8001C284 preserves=true fpr_mask=0x00000000
