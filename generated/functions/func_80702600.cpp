...
extern "C" void func_80702600(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80702600:
{
    r3 = (r3 + -148);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x807011E0u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80702600 func_80702600 preserves=true fpr_mask=0x00000000
