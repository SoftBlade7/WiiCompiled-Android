...
extern "C" void func_80831534(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8083158C:
{
    ...
    r31 = (r31_rot_0 & 1020);
    r7 = MemoryInline::FlatRead32((r6 + -10480));
    r6 = 0x809C0000u;
    MemoryInline::FlatWrite8((r7 + 613), static_cast<uint8_t>(r0));
    r7 = MemoryInline::FlatRead32((r3 + 68));
    r7_addr_0 = (r7 + r31);
    MemoryInline::FlatWrite32(r7_addr_0, r5);
...
loc_808315BC:
{
    r26_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(1));
    r26 = (r26_rot_1 & 510);
...
// RECOMP_REGISTRATION base 0x80831534 func_80831534 preserves=true fpr_mask=0x00000000
