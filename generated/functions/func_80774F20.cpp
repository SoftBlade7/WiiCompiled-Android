...
extern "C" void func_80774F20(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80774FF4:
{
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWrite8((r31 + 228), static_cast<uint8_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x80774F20 func_80774F20 preserves=true fpr_mask=0x00000000
