...
extern "C" void func_80222408(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80222408:
{
    ...
    r31 = r3;
    MemoryInline::FlatWrite32((r3 + 120), r3);
    r3 = (r3 + 8);
    ctx->lr = 0x80222428u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x80222408 func_80222408 preserves=true fpr_mask=0x00000000
