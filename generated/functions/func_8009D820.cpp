...
extern "C" void func_8009D820(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8009D820:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r2 + -28128));
    r0 = 1;
...
// RECOMP_GUEST_ABI gpr_read=0x8000000E gpr_write=0x80000003 gpr_return=0x00000000 fpr_read=0x00000000 fpr_write=0x00000001 fpr_return=0x00000000 cr_read=0x00 cr_write=0x00 xer_read=0 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8009D820 func_8009D820 preserves=true fpr_mask=0x00000000
