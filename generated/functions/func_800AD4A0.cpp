...
extern "C" void func_800AD4A0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800AD4A0:
{
    ...
    ctx->gpr[5] = r5;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x800ADD80u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r31 = ctx->gpr[31];
    r0 = 0;
    MemoryInline::FlatWrite32((r30 + 564), r0);
    r3 = r30;
    MemoryInline::FlatWrite32((r30 + 568), r31);
...
// RECOMP_REGISTRATION base 0x800AD4A0 func_800AD4A0 preserves=true fpr_mask=0x00000000
