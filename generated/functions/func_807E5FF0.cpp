...
extern "C" void func_807E5FF0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_807E6028:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r30 + -31376));
    r4 = 0;
    ctx->lr = 0x807E6040u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x807E5FF0 func_807E5FF0 preserves=true fpr_mask=0x00000000
