...
extern "C" void func_80836998(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80836998:
{
    ...
    r0 = 0;
    f0.d = MemoryInline::FlatReadFloat32((r6 + -13536));
...
// RECOMP_GUEST_ABI gpr_read=0xE000003B gpr_write=0xE000007B gpr_return=0x00000018 fpr_read=0x0000104F fpr_write=0x00001F7F fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80836998 func_80836998 preserves=true fpr_mask=0x00000000
