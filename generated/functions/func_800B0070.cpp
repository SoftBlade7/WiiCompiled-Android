...
extern "C" void func_800B0070(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800B0070:
{
    ...
    r0 = 0;
    MemoryInline::FlatWrite8((r4 + 108), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x800B0070 func_800B0070 preserves=true fpr_mask=0x00000000
