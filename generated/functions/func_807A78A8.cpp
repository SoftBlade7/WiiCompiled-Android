...
extern "C" void func_807A78A8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_807A7920:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r26), static_cast<int32_t>(r25));
}
...
// RECOMP_REGISTRATION base 0x807A78A8 func_807A78A8 preserves=true fpr_mask=0x00000000
