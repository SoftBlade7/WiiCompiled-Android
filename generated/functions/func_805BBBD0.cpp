...
extern "C" void func_805BBBD0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805BBBD0:
{
    ...
    r31 = (r7 + r0);
    r30 = r6;
    r0 = MemoryInline::FlatRead32((r31 + 6168));
...
loc_805BBC2C:
{
    r3 = MemoryInline::FlatRead8((r31 + 6376));
...
loc_805BBC6C:
{
    r3 = MemoryInline::FlatRead32((r31 + 6164));
...
loc_805BBCAC:
{
    r26 = 0x809C0000u;
    r25 = 0x80890000u;
    r4 = MemoryInline::FlatRead32((r26 + 7736));
    r25 = (r25 + 11064);
    r3 = r27;
    r6 = r28;
...
loc_805BBD28:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_2FD0 = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_2FD0[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_2FD0[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_805BBD90:
{
    r26 = MemoryInline::FlatRead16((r31 + 6368));
    r3 = (r1 + 8);
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_41BE = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_41BE[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_41BE[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_805BBDE4:
{
    r0 = MemoryInline::FlatRead32((r31 + 6356));
...
loc_805BBEDC:
{
    ...
    r28 = 0x80890000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r28 + 10588));
    ctx->lr = 0x805BBEF8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x805BBBD0 func_805BBBD0 preserves=true fpr_mask=0x00000000
