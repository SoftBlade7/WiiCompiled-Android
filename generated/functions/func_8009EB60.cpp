...
extern "C" void func_8009EB60(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8009EBD0:
{
    r3 = MemoryInline::FlatRead8((r3 + 13));
    r0 = (0 - r3);
    r0 = (r0 | r3);
...
// RECOMP_REGISTRATION base 0x8009EB60 func_8009EB60 preserves=true fpr_mask=0x00000000
