...
extern "C" void func_8014A920(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
    uint32_t r3_rot_1 = 0;
...
loc_8014A9D0:
{
    ...
    r3 = MemoryInline::FlatRead8((r3 + 65));
    r0 = (0 - r3);
    r0 = (r0 | r3);
...
// RECOMP_REGISTRATION base 0x8014A920 func_8014A920 preserves=true fpr_mask=0x00000000
