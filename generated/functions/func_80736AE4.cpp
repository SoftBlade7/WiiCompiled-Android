...
extern "C" void func_80736AE4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80736AE4:
{
    ...
    MemoryInline::WriteResolvedFloat32(guest_range_0, 16u, (r3 + 8), f4.d);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 8u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f2.d))))) {
        ...
        MemoryInline::WriteResolvedFloat32(guest_range_0, 8u, r3, f0.d);
    }
...
// RECOMP_GUEST_ABI gpr_read=0xC000001E gpr_write=0xC000003B gpr_return=0x00000018 fpr_read=0x80000003 fpr_write=0x8000001F fpr_return=0x00000002 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80736AE4 func_80736AE4 preserves=false fpr_mask=0x80000000
