...
extern "C" void func_806284C8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806284C8:
{
    ...
    r11 = MemoryInline::FlatRead32((r29 + 1936));
    ...
    r8 = MemoryInline::FlatRead32((r29 + 1948));
    ...
    r25 = 0x808C0000u;
    r31 = 0x808C0000u;
    guest_range_4 = MemoryInline::ResolveRangeHost((r29 + 1960), 0, 60u, true, false);
    r9 = MemoryInline::ReadResolved32(guest_range_4, 0u, (r29 + 1960));
    r4 = 0x80600000u;
    ...
    MemoryInline::WriteResolved32(guest_range_1, 16u, (r28 + 1636), r8);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r19 = MemoryInline::ReadResolved32(guest_range_4, 12u, (r29 + 1972));
        }
    }
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r22 = MemoryInline::ReadResolved32(guest_range_4, 24u, (r29 + 1984));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r25 = MemoryInline::ReadResolved32(guest_range_4, 36u, (r29 + 1996));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r12 = MemoryInline::ReadResolved32(guest_range_4, 48u, (r29 + 2008));
        }
    }
...
// RECOMP_REGISTRATION base 0x806284C8 func_806284C8 preserves=true fpr_mask=0x00000000
