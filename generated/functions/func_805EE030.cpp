...
extern "C" void func_805EE030(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_805EE030:
{
    ...
    xer = ctx->xer;
    r0 = 2;
    MemoryInline::FlatWrite32((r30 + 2016), r0);
    r3 = (r30 + 1440);
    r4 = (r30 + 68);
    r5 = 0;
    ctx->gpr[0] = r0;
    ...
    xer = ctx->xer;
    r0 = 4;
    MemoryInline::FlatWrite32((r30 + 3208), r0);
    r3 = (r30 + 2632);
    r4 = (r30 + 88);
    r5 = 0;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x805EE030 func_805EE030 preserves=true fpr_mask=0x00000000
