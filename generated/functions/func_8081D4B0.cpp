...
extern "C" void func_8081D4B0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8081D4B0:
{
    guest_range_0 = MemoryInline::ResolveRangeHost(r31, 0, 120u, true, false);
    ...
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 1112), 0, 48u, false, true);
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 0u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f7.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f6.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 0u, (r1 + 1112), f7.d);
        MemoryInline::WriteResolvedFloat32(guest_range_1, 4u, (r1 + 1116), f6.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 8u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f5.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f4.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 8u, (r1 + 1120), f5.d);
        MemoryInline::WriteResolvedFloat32(guest_range_1, 12u, (r1 + 1124), f4.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 16u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f3.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f2.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 16u, (r1 + 1128), f3.d);
        MemoryInline::WriteResolvedFloat32(guest_range_1, 20u, (r1 + 1132), f2.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 24u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f1.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f3.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 24u, (r1 + 1136), f1.d);
        MemoryInline::WriteResolvedFloat32(guest_range_1, 28u, (r1 + 1140), f3.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 32u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f2.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f7.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 32u, (r1 + 1144), f2.d);
        MemoryInline::WriteResolvedFloat32(guest_range_1, 36u, (r1 + 1148), f7.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 40u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f3.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f0.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 40u, (r1 + 1152), f3.d);
        MemoryInline::WriteResolvedFloat32(guest_range_1, 44u, (r1 + 1156), f0.d);
    }
    ctx->lr = 0x8081D508u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x8081D4B0 func_8081D4B0 preserves=true fpr_mask=0x00000000
