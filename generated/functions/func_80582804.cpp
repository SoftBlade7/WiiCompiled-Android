...
extern "C" void func_80582804(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80582834:
{
    ...
    f1 = ctx->fpr[1];
    cr = ctx->cr;
    r3 = MemoryInline::FlatRead16((r30 + 452));
    r3 = (r3 << 16);
    r3 = (static_cast<int32_t>(r3) >> 16);
    r0 = (r3 + -1);
    MemoryInline::FlatWrite16((r30 + 452), static_cast<uint16_t>(r0));
...
// RECOMP_REGISTRATION base 0x80582804 func_80582804 preserves=true fpr_mask=0x00000000
