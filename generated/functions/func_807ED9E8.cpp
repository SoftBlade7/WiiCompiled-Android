...
extern "C" void func_807ED9E8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807EDA38:
{
    ...
    r4 = 16;
    r6 = 4;
    r0 = MemoryInline::FlatRead8((r7 + 39));
...
loc_807EDA70:
{
    ...
    r0 = (r0 & 254);
    MemoryInline::FlatWrite8((r5 + 187), static_cast<uint8_t>(r0));
    r5 = MemoryInline::FlatRead32((r31 + 436));
    r0 = MemoryInline::FlatRead8((r5 + 187));
    r0 = (r0 & 254);
    MemoryInline::FlatWrite8((r5 + 187), static_cast<uint8_t>(r0));
    ctx->lr = 0x807EDB6Cu;
...
// RECOMP_REGISTRATION base 0x807ED9E8 func_807ED9E8 preserves=true fpr_mask=0x00000000
