...
extern "C" void func_80875740(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = 1;
    MemoryInline::FlatWrite8((r3 + 365), static_cast<uint8_t>(r0));
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x80875740 func_80875740 preserves=true fpr_mask=0x00000000
