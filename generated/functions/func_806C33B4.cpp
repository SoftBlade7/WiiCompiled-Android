...
extern "C" void func_806C33B4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806C33B4:
{
    r5 = 0x808A0000u;
    r4 = 599;
    f1.d = MemoryInline::FlatReadFloat32((r5 + -2304));
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
    ctx->fpr[1] = f1;
...
// RECOMP_REGISTRATION base 0x806C33B4 func_806C33B4 preserves=true fpr_mask=0x00000000
