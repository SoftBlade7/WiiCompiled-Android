...
extern "C" void func_8077D38C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8077D38C:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r4 + 17608));
    r0 = (r0 ^ -2147483648);
...
// RECOMP_REGISTRATION base 0x8077D38C func_8077D38C preserves=true fpr_mask=0x00000000
