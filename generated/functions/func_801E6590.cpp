...
extern "C" void func_801E6590(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801E6688:
{
    r30 = MemoryInline::FlatRead32((r31 + 96));
}
...
loc_801E6694:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r30), static_cast<int32_t>(-33));
}
...
// RECOMP_REGISTRATION base 0x801E6590 func_801E6590 preserves=true fpr_mask=0x00000000
