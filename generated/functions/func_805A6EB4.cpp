...
extern "C" void func_805A6EB4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805A6EB4:
{
    ...
    ctx->gpr[7] = r7;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x805A6F44u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x805A6EB4 func_805A6EB4 preserves=true fpr_mask=0x00000000
