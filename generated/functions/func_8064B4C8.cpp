...
extern "C" void func_8064B4C8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8064B4C8:
{
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWrite32((r27 + 596), r0);
    r30 = 0;
    r29 = 0;
}
...
loc_8064B554:
{
    if ((static_cast<int32_t>(r29) < static_cast<int32_t>(30))) {
        goto loc_8064B504;
    }
}
...
loc_8064B558:
{
    r0 = MemoryInline::FlatRead32((r27 + 600));
...
loc_8064B624:
{
    MemoryInline::FlatWrite32((r27 + 600), r30);
}
...
// RECOMP_REGISTRATION base 0x8064B4C8 func_8064B4C8 preserves=true fpr_mask=0x00000000
