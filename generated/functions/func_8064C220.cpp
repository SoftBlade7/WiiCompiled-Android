...
extern "C" void func_8064C220(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8064C260:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805F0DB4u) && KnownTranslatedCpuCall<0x805F0DB4u>::kAvailable && !KnownTranslatedCpuCall<0x805F0DB4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805F0DB4u>()) {
        const auto state_free_result_805F0DB4_C9E = func_805F0DB4_statefree_v0(r3, r4, cr, xer);
        cr = static_cast<uint32_t>(state_free_result_805F0DB4_C9E);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    xer = ctx->xer;
    r0 = 1;
    MemoryInline::FlatWrite32((r31 + 1096), r0);
    r3 = (r31 + 520);
    r4 = (r31 + 68);
    r5 = 0;
    ctx->gpr[0] = r0;
    ...
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_2105 = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_2105[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_2105[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_8064C354:
{
    ...
    xer = ctx->xer;
    r0 = 2;
    MemoryInline::FlatWrite32((r31 + 1692), r0);
    r3 = (r31 + 1116);
    r4 = (r31 + 68);
    r5 = 0;
    ctx->gpr[0] = r0;
    ...
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_33FD = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_33FD[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_33FD[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_8064C410:
{
    ...
    xer = ctx->xer;
    r0 = 3;
    MemoryInline::FlatWrite32((r31 + 2288), r0);
    r3 = (r31 + 1712);
    r4 = (r31 + 88);
    r5 = 0;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x8064C220 func_8064C220 preserves=true fpr_mask=0x00000000
