...
extern "C" void func_805446E8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805446E8:
{
    ...
    MemoryInline::FlatWrite8((r5 + 20482), static_cast<uint8_t>(r0));
    MemoryInline::FlatWrite8((r5 + 20481), static_cast<uint8_t>(r0));
    MemoryInline::FlatWrite16((r3 + 54), static_cast<uint16_t>(r0));
    MemoryInline::FlatWrite32((r5 + 20484), r0);
}
...
// RECOMP_REGISTRATION base 0x805446E8 func_805446E8 preserves=true fpr_mask=0x00000000
