...
extern "C" void func_800AD5F0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800AD5F0:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r30 = MemoryInline::FlatRead32((r29 + 568));
    r31 = (r30 + 16);
    r3 = r31;
    ctx->lr = 0x800AD620u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x800AD5F0 func_800AD5F0 preserves=true fpr_mask=0x00000000
