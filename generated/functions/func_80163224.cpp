...
extern "C" void func_80163224(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80163224:
{
    MemoryInline::FlatWrite32((r13 + -25948), r3);
    return;
}
...
// RECOMP_REGISTRATION base 0x80163224 func_80163224 preserves=true fpr_mask=0x00000000
