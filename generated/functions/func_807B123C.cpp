...
extern "C" void func_807B123C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807B1288:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8068DAF4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_807B12C0:
{
    r5 = MemoryInline::FlatRead32((r29 + 152));
}
...
// RECOMP_REGISTRATION base 0x807B123C func_807B123C preserves=true fpr_mask=0x00000000
