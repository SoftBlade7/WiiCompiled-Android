...
extern "C" void func_807527EC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_inl3_cont_80782F74:
{
    ...
    if (MkwStateFreeAbiEnabled(0x80782F74u) && KnownTranslatedCpuCall<0x80782F74u>::kAvailable && !KnownTranslatedCpuCall<0x80782F74u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80782F74u>()) {
        const auto state_free_result_80782F74_1BDB = func_80782F74_statefree_v0(cr, xer);
        r3 = static_cast<uint32_t>(state_free_result_80782F74_1BDB[0]);
        cr = static_cast<uint32_t>(state_free_result_80782F74_1BDB[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    MemoryInline::FlatWriteFloat32((r27 + 216), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r1 + 72));
    MemoryInline::FlatWriteFloat32((r27 + 220), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r1 + 76));
    MemoryInline::FlatWriteFloat32((r27 + 224), f0.d);
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x80782F74u) && KnownTranslatedCpuCall<0x80782F74u>::kAvailable && !KnownTranslatedCpuCall<0x80782F74u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80782F74u>()) {
        const auto state_free_result_80782F74_2934 = func_80782F74_statefree_v0(cr, xer);
        r3 = static_cast<uint32_t>(state_free_result_80782F74_2934[0]);
        cr = static_cast<uint32_t>(state_free_result_80782F74_2934[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x80782F74u) && KnownTranslatedCpuCall<0x80782F74u>::kAvailable && !KnownTranslatedCpuCall<0x80782F74u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80782F74u>()) {
        const auto state_free_result_80782F74_3382 = func_80782F74_statefree_v0(cr, xer);
        r3 = static_cast<uint32_t>(state_free_result_80782F74_3382[0]);
        cr = static_cast<uint32_t>(state_free_result_80782F74_3382[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x80782F74u) && KnownTranslatedCpuCall<0x80782F74u>::kAvailable && !KnownTranslatedCpuCall<0x80782F74u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80782F74u>()) {
        const auto state_free_result_80782F74_3F79 = func_80782F74_statefree_v0(cr, xer);
        r3 = static_cast<uint32_t>(state_free_result_80782F74_3F79[0]);
        cr = static_cast<uint32_t>(state_free_result_80782F74_3F79[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x80782F74u) && KnownTranslatedCpuCall<0x80782F74u>::kAvailable && !KnownTranslatedCpuCall<0x80782F74u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80782F74u>()) {
        const auto state_free_result_80782F74_4CB8 = func_80782F74_statefree_v0(cr, xer);
        r3 = static_cast<uint32_t>(state_free_result_80782F74_4CB8[0]);
        cr = static_cast<uint32_t>(state_free_result_80782F74_4CB8[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    r11 = (r1 + 160);
    r0 = (r0 + r3);
    MemoryInline::FlatWrite32((r27 + 252), r0);
    {
...
// RECOMP_GUEST_ABI gpr_read=0xF800000A gpr_write=0xF8000FFB gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x0000001F fpr_return=0x00000002 cr_read=0x00 cr_write=0x01 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x807527EC func_807527EC preserves=true fpr_mask=0x00000000
