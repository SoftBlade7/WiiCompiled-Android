...
extern "C" void func_801C4D00(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801C4D00:
{
    ...
    MemoryInline::FlatWrite8((r30 + 1), static_cast<uint8_t>(r4));
    r4 = 0;
    ctx->lr = 0x801C4D40u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x801C4D00 func_801C4D00 preserves=true fpr_mask=0x00000000
