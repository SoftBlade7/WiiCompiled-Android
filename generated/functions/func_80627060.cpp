...
extern "C" void func_80627060(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80627060:
{
    ...
    r11 = MemoryInline::FlatRead32((r29 + 1468));
    ...
    r8 = MemoryInline::FlatRead32((r29 + 1480));
    ...
    r9 = 0x808C0000u;
    r7 = 0x808C0000u;
    guest_range_4 = MemoryInline::ResolveRangeHost((r29 + 1492), 0, 60u, true, false);
    r22 = MemoryInline::ReadResolved32(guest_range_4, 0u, (r29 + 1492));
    r9 = (r9 + -11844);
    ...
    MemoryInline::WriteResolved32(guest_range_1, 16u, (r28 + 1636), r23);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r25 = MemoryInline::ReadResolved32(guest_range_4, 12u, (r29 + 1504));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r30 = MemoryInline::ReadResolved32(guest_range_4, 24u, (r29 + 1516));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r10 = MemoryInline::ReadResolved32(guest_range_4, 36u, (r29 + 1528));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_4, 48u, (r29 + 1540));
...
// RECOMP_REGISTRATION base 0x80627060 func_80627060 preserves=true fpr_mask=0x00000000
