...
extern "C" void func_801B7C88(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801B7D8C:
{
    ...
    r0 = 2;
    r3 = r27;
    MemoryInline::FlatWrite16(r26, static_cast<uint16_t>(r21));
    r4 = 32;
    MemoryInline::FlatWrite32(r28, r27);
    MemoryInline::FlatWrite32((r28 + 4), r5);
    MemoryInline::FlatWrite32((r28 + 8), r26);
    MemoryInline::FlatWrite32((r28 + 12), r0);
    MemoryInline::FlatWrite32((r28 + 16), r22);
    MemoryInline::FlatWrite32((r28 + 20), r21);
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
loc_801B7E60:
{
    ...
    r4 = r23;
    r7 = r28;
    MemoryInline::FlatWrite32((r30 + 20), r27);
    r9 = r30;
    r8 = (r8 + 30840);
    r5 = 2;
    MemoryInline::FlatWrite32((r30 + 24), r26);
    r6 = 1;
    MemoryInline::FlatWrite32((r30 + 28), r28);
    MemoryInline::FlatWrite32((r30 + 64), r22);
    MemoryInline::FlatWrite16((r30 + 68), static_cast<uint16_t>(r21));
    ctx->lr = 0x801B7ECCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x801B7C88 func_801B7C88 preserves=true fpr_mask=0x00000000
