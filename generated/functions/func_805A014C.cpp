...
extern "C" void func_805A014C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805A014C:
{
    ...
    f5.d = MemoryInline::FlatReadFloat32((r3 + 148));
    f0.d = MemoryInline::FlatReadFloat32((r4 + 8));
    f2.d = static_cast<double>(PpcForceSingleValueInline(f2.d - f5.d));
    f6.d = MemoryInline::FlatReadFloat32((r3 + 152));
    f3.d = MemoryInline::FlatReadFloat32(r4);
    f8.d = MemoryInline::FlatReadFloat32((r3 + 144));
    ...
    MemoryInline::FlatWriteFloat32((r4 + 200), f1.d);
...
// RECOMP_REGISTRATION base 0x805A014C func_805A014C preserves=true fpr_mask=0x00000000
