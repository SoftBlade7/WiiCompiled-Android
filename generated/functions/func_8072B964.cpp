...
extern "C" void func_8072B964(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8072B964:
{
    r3 = MemoryInline::FlatRead32((r3 + 404));
    r0 = 0;
...
// RECOMP_REGISTRATION base 0x8072B964 func_8072B964 preserves=true fpr_mask=0x00000000
