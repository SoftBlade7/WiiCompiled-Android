...
extern "C" void func_806B25AC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806B25E4:
{
    MemoryInline::FlatWrite32((r29 + 344), r3);
    r31 = 0x808A0000u;
    r31 = (r31 + -10364);
    r30 = 0;
...
// RECOMP_REGISTRATION base 0x806B25AC func_806B25AC preserves=true fpr_mask=0x00000000
