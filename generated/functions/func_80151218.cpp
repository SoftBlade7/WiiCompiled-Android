...
extern "C" void func_80151218(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8015126C:
{
    MemoryInline::FlatWrite8((r26 + 113), static_cast<uint8_t>(r28));
    goto loc_80151298;
}
...
loc_801512D8:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r12 = MemoryInline::FlatRead32((r29 + 140));
    r3 = (r31 | r3);
    r0 = MemoryInline::FlatRead32((r29 + 136));
}
...
// RECOMP_REGISTRATION base 0x80151218 func_80151218 preserves=true fpr_mask=0x00000000
