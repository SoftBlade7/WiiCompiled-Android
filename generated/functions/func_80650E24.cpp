...
extern "C" void func_80650E24(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80650E24:
{
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 40u, ((static_cast<uint64_t>(static_cast<uint32_t>(r14)) << 32) | static_cast<uint32_t>(r15)))) {
        MemoryInline::WriteResolved32(guest_range_1, 40u, (r1 + 40), r14);
        MemoryInline::WriteResolved32(guest_range_1, 44u, (r1 + 44), r15);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 48u, ((static_cast<uint64_t>(static_cast<uint32_t>(r16)) << 32) | static_cast<uint32_t>(r17)))) {
        MemoryInline::WriteResolved32(guest_range_1, 48u, (r1 + 48), r16);
        MemoryInline::WriteResolved32(guest_range_1, 52u, (r1 + 52), r17);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 56u, ((static_cast<uint64_t>(static_cast<uint32_t>(r18)) << 32) | static_cast<uint32_t>(r19)))) {
        MemoryInline::WriteResolved32(guest_range_1, 56u, (r1 + 56), r18);
        MemoryInline::WriteResolved32(guest_range_1, 60u, (r1 + 60), r19);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 64u, ((static_cast<uint64_t>(static_cast<uint32_t>(r20)) << 32) | static_cast<uint32_t>(r21)))) {
...
{
    r16 = 0x809C0000u;
    r3 = MemoryInline::FlatRead32((r16 + 8448));
    // inline leaf 0x80660470 (7 guest instruction(s))
}
...
loc_inl0_cont_80660470:
{
    // end of inlined leaf 0x80660470
    r14 = 0x809C0000u;
    r0 = 0;
    guest_range_0 = MemoryInline::ResolveRangeHost((r14 + -10456), 0, 4u, true, false);
    r4 = MemoryInline::ReadResolved32(guest_range_0, 0u, (r14 + -10456));
    MemoryInline::FlatWrite32((r4 + 6020), r3);
    r3 = MemoryInline::ReadResolved32(guest_range_0, 0u, (r14 + -10456));
...
loc_inl1_cont_80660450:
{
    // end of inlined leaf 0x80660450
    r5 = MemoryInline::ReadResolved32(guest_range_0, 0u, (r14 + -10456));
    r4 = 0x809C0000u;
    MemoryInline::FlatWrite32((r5 + 5976), r3);
...
{
    if ((static_cast<uint32_t>(r4) != static_cast<uint32_t>(r0))) {
        goto loc_inl4_0x80660508;
    }
}

loc_inl4_0x806604F4:
{
    r0_rot_12 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(3));
    r0 = (r0_rot_12 & -8);
    r3 = (r3 + r0);
    r3 = MemoryInline::FlatRead8((r3 + 28));
    r3 = (static_cast<int32_t>(static_cast<int8_t>(r3)));
    goto loc_inl4_cont_806604D4;
}
...
{
    if ((static_cast<uint32_t>(r4) != static_cast<uint32_t>(r0))) {
        goto loc_inl5_0x80660558;
    }
}

loc_inl5_0x80660544:
{
    r0_rot_15 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(3));
    r0 = (r0_rot_15 & -8);
    r3 = (r3 + r0);
    r3 = MemoryInline::FlatRead8((r3 + 29));
    r3 = (static_cast<int32_t>(static_cast<int8_t>(r3)));
    goto loc_inl5_cont_80660524;
}
...
{
    if ((static_cast<uint32_t>(r4) != static_cast<uint32_t>(r0))) {
        goto loc_inl6_0x806605F4;
    }
}

loc_inl6_0x806605E4:
{
    r0_rot_18 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(3));
    r0 = (r0_rot_18 & -8);
    r3 = (r3 + r0);
    r3 = (r3 + 24);
    goto loc_inl6_cont_806605C4;
}
...
{
    if ((static_cast<uint32_t>(r4) != static_cast<uint32_t>(r0))) {
        goto loc_inl7_0x8066063C;
    }
}

loc_inl7_0x8066062C:
{
    r0_rot_21 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(3));
    r0 = (r0_rot_21 & -8);
    r3 = (r3 + r0);
    r3 = MemoryInline::FlatRead8((r3 + 31));
    goto loc_inl7_cont_8066060C;
}

loc_inl7_0x8066063C:
{
    r4 = (r4 * 56);
    r0_rot_22 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(3));
    r0 = (r0_rot_22 & -8);
    r3 = (r3 + r4);
    r3 = (r3 + r0);
...
loc_inl7_cont_8066060C:
{
    ...
    r6 = 12;
    r0_rot_24 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(2));
    r0 = (r0_rot_24 & 1020);
    r6_subfc_sub_2 = r6;
...
loc_8065159C:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    guest_range_2 = MemoryInline::ResolveRangeHost((r1 + 40), 0, 80u, true, false);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r14 = MemoryInline::ReadResolved32(guest_range_2, 0u, (r1 + 40));
            r15 = MemoryInline::ReadResolved32(guest_range_2, 4u, (r1 + 44));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r16 = MemoryInline::ReadResolved32(guest_range_2, 8u, (r1 + 48));
            r17 = MemoryInline::ReadResolved32(guest_range_2, 12u, (r1 + 52));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r18 = MemoryInline::ReadResolved32(guest_range_2, 16u, (r1 + 56));
            r19 = MemoryInline::ReadResolved32(guest_range_2, 20u, (r1 + 60));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r20 = MemoryInline::ReadResolved32(guest_range_2, 24u, (r1 + 64));
            r21 = MemoryInline::ReadResolved32(guest_range_2, 28u, (r1 + 68));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r22 = MemoryInline::ReadResolved32(guest_range_2, 32u, (r1 + 72));
            r23 = MemoryInline::ReadResolved32(guest_range_2, 36u, (r1 + 76));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r24 = MemoryInline::ReadResolved32(guest_range_2, 40u, (r1 + 80));
            r25 = MemoryInline::ReadResolved32(guest_range_2, 44u, (r1 + 84));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r26 = MemoryInline::ReadResolved32(guest_range_2, 48u, (r1 + 88));
            r27 = MemoryInline::ReadResolved32(guest_range_2, 52u, (r1 + 92));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r28 = MemoryInline::ReadResolved32(guest_range_2, 56u, (r1 + 96));
            r29 = MemoryInline::ReadResolved32(guest_range_2, 60u, (r1 + 100));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r30 = MemoryInline::ReadResolved32(guest_range_2, 64u, (r1 + 104));
            r31 = MemoryInline::ReadResolved32(guest_range_2, 68u, (r1 + 108));
        }
    }
    r0 = MemoryInline::ReadResolved32(guest_range_2, 76u, (r1 + 116));
    ctx->lr = r0;
    r1 = (r1 + 112);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x80650E24 func_80650E24 preserves=true fpr_mask=0x00000000
