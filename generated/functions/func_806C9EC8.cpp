...
extern "C" void func_806C9EC8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806C9EC8:
{
    ...
    r31 = 0x808A0000u;
    f2.d = MemoryInline::FlatReadFloat32((r31 + -1504));
    MemoryInline::FlatWriteRam32((r1 + 24), r30);
    r30 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r30 + -1560));
    MemoryInline::FlatWriteRam32((r1 + 20), r29);
    MemoryInline::FlatWriteRam32((r1 + 16), r28);
    r28 = r3;
    r29 = MemoryInline::FlatRead32((r3 + 216));
    ...
    f2 = ctx->fpr[2];
    ctr = ctx->ctr;
    r30 = MemoryInline::FlatRead32((r28 + 216));
    r4 = 0;
    ...
    f1.d = MemoryInline::FlatReadFloat32((r31 + -1504));
...
// RECOMP_REGISTRATION base 0x806C9EC8 func_806C9EC8 preserves=true fpr_mask=0x00000000
