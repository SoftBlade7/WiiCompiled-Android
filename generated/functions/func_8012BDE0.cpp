...
extern "C" void func_8012BDE0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8012BE84:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r28 + 108), r31);
}
...
// RECOMP_REGISTRATION base 0x8012BDE0 func_8012BDE0 preserves=true fpr_mask=0x00000000
