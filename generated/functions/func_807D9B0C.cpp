...
extern "C" void func_807D9B0C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807D9B38:
{
    ...
    r3 = MemoryInline::FlatRead32((r5 + 1760));
    r0 = (r0 * 48);
    r4 = (r4 + r0);
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_807D9B4C:
{
    ...
    r0 = 1;
    MemoryInline::FlatWrite8((r30 + 121), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x807D9B0C func_807D9B0C preserves=true fpr_mask=0x00000000
