...
extern "C" void func_80549C44(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80549C44:
{
    ...
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80549C50u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80549C44 func_80549C44 preserves=true fpr_mask=0x00000000
