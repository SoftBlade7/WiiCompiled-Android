...
extern "C" void func_8014B9C8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8014B9C8:
{
    ...
    r30 = 0x80280000u;
    r29 = MemoryInline::FlatRead32((r7 + 24));
    r31 = r3;
...
loc_8014B9F8:
{
    r28 = MemoryInline::FlatRead16((r3 + 20));
    r26 = r4;
    r27 = r5;
    r30 = (r30 + 23600);
    if (((cr & 0x80000000u) != 0)) {
...
loc_8014BB60:
{
    ...
    r4 = 1;
    r3 = MemoryInline::FlatRead16((r31 + 20));
    r12 = MemoryInline::FlatRead32((r5 + 24));
    ctr = r12;
    ctx->lr = 0x8014BB78u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8014BBD4:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8014FC6Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8014E9DCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8014B9C8 func_8014B9C8 preserves=true fpr_mask=0x00000000
