...
extern "C" void func_805D7DD0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805D7DD0:
{
    r3 = MemoryInline::FlatRead32((r3 + 6652));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x805D7DD0 func_805D7DD0 preserves=true fpr_mask=0x00000000
