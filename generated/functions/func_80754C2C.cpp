...
extern "C" void func_80754C2C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80754C2C:
{
    ...
    ctx->lr = 0x80754C34u;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80756838u>(ctx);
    r3 = ctx->gpr[3];
    r29 = ctx->gpr[29];
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80754C2C func_80754C2C preserves=true fpr_mask=0x00000000
