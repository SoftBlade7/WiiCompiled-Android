...
extern "C" void func_8013B3F0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r5_rot_0 = 0;
...
loc_8013B430:
{
    ...
    r5 = (r5_rot_0 & 1);
    r0 = (r0 + r5);
    MemoryInline::FlatWriteRam16((r4 + 1612), static_cast<uint16_t>(r0));
    ctx->lr = 0x8013B460u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_8013B468:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80146138u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8013B3F0 func_8013B3F0 preserves=true fpr_mask=0x00000000
