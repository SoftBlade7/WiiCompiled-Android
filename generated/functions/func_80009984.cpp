...
extern "C" void func_80009984(CpuContext* MKW_RESTRICT ctx)
{
    goto loc_80009984;

loc_80009984:
{
    InvokeDirectCpu<0x8023AE60u>(ctx);
    return;
}
...
// RECOMP_REGISTRATION base 0x80009984 func_80009984 preserves=true fpr_mask=0x00000000
