...
extern "C" void func_805AD5B4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805AD5B4:
{
    ...
    r0 = MemoryInline::FlatRead32((r4 + 76));
...
// RECOMP_REGISTRATION base 0x805AD5B4 func_805AD5B4 preserves=true fpr_mask=0x00000000
