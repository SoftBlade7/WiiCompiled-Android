...
extern "C" void func_806EAAE8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806EAB34:
{
    ...
    ctx->fpr[3] = f3;
    ctx->fpr[4] = f4;
    InvokeDirectCpu<0x806EAC4Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    MemoryInline::FlatWriteFloat32((r30 + 980), f1.d);
    f1.d = PpcFmulsInline(f1.d, f1.d);
    f3.d = MemoryInline::FlatReadFloat32((r1 + 28));
    MemoryInline::FlatWriteFloat32((r30 + 984), f3.d);
...
loc_806EAB9C:
{
    ...
    MemoryInline::FlatWriteFloat32((r30 + 976), f1.d);
    MemoryInline::FlatWriteFloat32((r30 + 980), f1.d);
...
loc_806EABBC:
{
    ...
    MemoryInline::FlatWriteFloat32((r30 + 992), f1.d);
    f1.d = PpcFmulsInline(f1.d, f1.d);
    f3.d = MemoryInline::FlatReadFloat32((r1 + 16));
    MemoryInline::FlatWriteFloat32((r30 + 996), f3.d);
    f3.d = PpcFmulsInline(f3.d, f3.d);
    f1.d = static_cast<double>(PpcForceSingleValueInline(f2.d + f1.d));
    f1.d = static_cast<double>(PpcForceSingleValueInline(f3.d + f1.d));
    SetCRFloatResident(cr, 0, f1.d, f0.d);
...
loc_806EAC14:
{
    f1.d = MemoryInline::FlatReadFloat32(r31);
    f0.d = MemoryInline::FlatReadFloat32((r31 + 24));
    MemoryInline::FlatWriteFloat32((r30 + 988), f1.d);
    MemoryInline::FlatWriteFloat32((r30 + 992), f0.d);
    MemoryInline::FlatWriteFloat32((r30 + 996), f1.d);
    goto loc_806EAC34;
}
...
// RECOMP_GUEST_ABI gpr_read=0xC000000E gpr_write=0xC000003B gpr_return=0x00000018 fpr_read=0x8000000F fpr_write=0x8000003F fpr_return=0x00000002 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x806EAAE8 func_806EAAE8 preserves=true fpr_mask=0x00000000
