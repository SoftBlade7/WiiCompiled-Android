...
extern "C" void func_805C1B54(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805C1B54:
{
    r3 = MemoryInline::FlatRead32((r3 + 5036));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x805C1B54 func_805C1B54 preserves=true fpr_mask=0x00000000
