...
extern "C" void func_806CBFF8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806CC044:
{
    ...
    xer = ctx->xer;
    r30 = 0;
    MemoryInline::FlatWrite32((r26 + 196), r30);
    ...
    MemoryInline::FlatWrite8((r26 + 208), static_cast<uint8_t>(r30));
}

loc_806CC088:
{
    f31.d = MemoryInline::FlatReadFloat64((r29 + 96));
    r27 = 0;
    r26 = 0;
    r30 = 1127219200;
    goto loc_806CC118;
...
loc_806CC09C:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r28 + 104));
...
// RECOMP_REGISTRATION base 0x806CBFF8 func_806CBFF8 preserves=false fpr_mask=0xC0000000
