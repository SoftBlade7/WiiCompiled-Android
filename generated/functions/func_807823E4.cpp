...
extern "C" void func_807823E4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807823E4:
{
    ...
    r0 = (r3 + 292);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r3)) + static_cast<uint64_t>(static_cast<uint32_t>(292)) + (static_cast<uint64_t>(static_cast<uint32_t>(0)) & 1u);
...
loc_inl0_cont_800AF180:
{
    ...
    r9 = MemoryInline::FlatRead8((r31 + 20));
    ctx->lr = 0x8078245Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x807823E4 func_807823E4 preserves=true fpr_mask=0x00000000
