...
extern "C" void func_80828440(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lhax_808284A4_loc_0 = 0;
    uint32_t addr_lhax_808284F8_loc_0 = 0;
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80828440:
{
    ...
    r0 = (r0_rot_0 & 131070);
    r4 = MemoryInline::FlatRead32((r28 + 17200));
    r30 = 1127219200;
    r29 = 0x808B0000u;
    ...
    addr_lhax_808284A4_loc_0 = (r4 + r0);
    r0 = MemoryInline::FlatRead16(addr_lhax_808284A4_loc_0);
    r0 = (r0 << 16);
    r0 = (static_cast<int32_t>(r0) >> 16);
    f1.d = MemoryInline::FlatReadFloat64((r29 + -14656));
    r0 = (r0 * 116);
    ...
    addr_lhax_808284F8_loc_0 = (r3 + r0);
    r0 = MemoryInline::FlatRead16(addr_lhax_808284F8_loc_0);
    r0 = (r0 << 16);
    r0 = (static_cast<int32_t>(r0) >> 16);
...
{
    r3 = 0x808B0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + -14628));
...
// RECOMP_REGISTRATION base 0x80828440 func_80828440 preserves=false fpr_mask=0x80000000
