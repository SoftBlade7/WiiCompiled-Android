...
extern "C" void func_80760964(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80760964:
{
    ...
    r3 = 0x808A0000u;
    r5 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + 14504));
    r3 = MemoryInline::FlatRead32((r4 + 40));
    r4 = 0;
    f2.d = MemoryInline::FlatReadFloat32((r5 + 14544));
    ctx->lr = 0x80760A24u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80760964 func_80760964 preserves=true fpr_mask=0x00000000
