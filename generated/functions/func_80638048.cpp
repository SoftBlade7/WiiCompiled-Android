...
extern "C" void func_80638048(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80638048:
{
    ...
    r31 = ctx->gpr[31];
    r3 = (r30 + 96);
    guest_range_1 = MemoryInline::ResolveRangeHost((r30 + 96), 0, 36u, true, false);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r31 = MemoryInline::ReadResolved32(guest_range_1, 0u, (r30 + 96));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r9 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r30 + 108));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_1, 24u, (r30 + 120));
...
// RECOMP_REGISTRATION base 0x80638048 func_80638048 preserves=true fpr_mask=0x00000000
