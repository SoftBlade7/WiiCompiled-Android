...
extern "C" void func_80795B60(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
{
    r0 = 0;
    MemoryInline::FlatWrite8((r3 + 340), static_cast<uint8_t>(r0));
}
...
loc_80795BF8:
{
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 0u, ((static_cast<uint64_t>(static_cast<uint32_t>(r27)) << 32) | static_cast<uint32_t>(r28)))) {
        MemoryInline::WriteResolved32(guest_range_1, 0u, (r31 + 20), r27);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 8u, ((static_cast<uint64_t>(static_cast<uint32_t>(r29)) << 32) | static_cast<uint32_t>(r30)))) {
        MemoryInline::WriteResolved32(guest_range_1, 8u, (r31 + 28), r29);
        MemoryInline::WriteResolved32(guest_range_1, 12u, (r31 + 32), r30);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 16u, ((static_cast<uint64_t>(static_cast<uint32_t>(r30)) << 32) | static_cast<uint32_t>(r30)))) {
        MemoryInline::WriteResolved32(guest_range_1, 16u, (r31 + 36), r30);
        MemoryInline::WriteResolved32(guest_range_1, 20u, (r31 + 40), r30);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 60u, ((static_cast<uint64_t>(static_cast<uint32_t>(r30)) << 32) | static_cast<uint32_t>(r30)))) {
        MemoryInline::WriteResolved32(guest_range_1, 60u, (r31 + 80), r30);
        MemoryInline::WriteResolved32(guest_range_1, 64u, (r31 + 84), r30);
    }
}
...
// RECOMP_REGISTRATION base 0x80795B60 func_80795B60 preserves=true fpr_mask=0x00000000
