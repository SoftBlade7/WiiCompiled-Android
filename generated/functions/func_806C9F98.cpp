...
extern "C" void func_806C9F98(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806CA080:
{
    r28 = MemoryInline::FlatRead32((r29 + 216));
    r4 = 2;
    f1.d = MemoryInline::FlatReadFloat32(r31);
    r5 = 1;
...
loc_806CA0BC:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead8((r29 + 260));
    r3 = (r3 & 65535);
    r0 = (r0 + r3);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r28), static_cast<uint32_t>(r0));
}
...
loc_806CA124:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead16((r29 + 284));
}
...
loc_806CA158:
{
    ...
    r3 = r29;
    f3.d = MemoryInline::FlatReadFloat32((r29 + 248));
    r4 = (r0 & 65535);
    ctx->lr = 0x806CA174u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_806CA178:
{
    r3 = MemoryInline::FlatRead16((r29 + 286));
}
...
loc_806CA1BC:
{
    f1.d = MemoryInline::FlatReadFloat32((r29 + 272));
...
// RECOMP_REGISTRATION base 0x806C9F98 func_806C9F98 preserves=true fpr_mask=0x00000000
