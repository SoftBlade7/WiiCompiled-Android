...
extern "C" void func_80097D70(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80097D70:
{
    r3 = MemoryInline::FlatRead8((r3 + 360));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80097D70 func_80097D70 preserves=true fpr_mask=0x00000000
