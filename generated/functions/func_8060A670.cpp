...
extern "C" void func_8060A670(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8060A670:
{
    r3 = MemoryInline::FlatRead32((r3 + 7424));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8060A670 func_8060A670 preserves=true fpr_mask=0x00000000
