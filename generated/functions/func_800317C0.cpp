...
extern "C" void func_800317C0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800317C0:
{
    ...
    r0 = MemoryInline::FlatRead8((r5 + 41));
    r22 = r4;
    r27 = MemoryInline::FlatRead32((r1 + 120));
    r18 = r3;
...
loc_800317F0:
{
    r28 = MemoryInline::FlatRead32((r1 + 124));
    ...
    r26 = r8;
    r4 = MemoryInline::FlatRead8((r5 + 42));
    r19 = r9;
    r20 = r10;
    if (((cr & 0x20000000u) != 0)) {
        goto loc_80031850;
...
loc_80031894:
{
    ...
    PpcSetPairedFprInline(f1, PPC_PsqLGqrInline<0u, 0u>(ctx, mkw_gqr0, r20));
    r8 = (r1 + 28);
    // psq_load w=0 quant=0 (using PPC_PsqL)
    PpcSetPairedFprInline(f0, PPC_PsqLGqrInline<0u, 0u>(ctx, mkw_gqr0, r19));
    f31.d = MemoryInline::FlatReadFloat32((r2 + -31020));
    PpcSetPairedFprInline(f0, PPC_PsSubInline(f1.d, f0.d));
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    PPC_PsqStStackInline<0u, 0u>(ctx, r8, f0.d);
    // psq_load w=1 quant=0 (using PPC_PsqL)
    r20_psq_tmp_0 = (r20 + 8);
    PpcSetPairedFprInline(f1, PPC_PsqLGqrInline<1u, 0u>(ctx, mkw_gqr0, r20_psq_tmp_0));
    // psq_load w=1 quant=0 (using PPC_PsqL)
    r19_psq_tmp_0 = (r19 + 8);
    PpcSetPairedFprInline(f0, PPC_PsqLGqrInline<1u, 0u>(ctx, mkw_gqr0, r19_psq_tmp_0));
    PpcSetPairedFprInline(f0, PPC_PsSubInline(f1.d, f0.d));
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r8_psq_tmp_0 = (r8 + 8);
    PPC_PsqStStackInline<1u, 0u>(ctx, r8_psq_tmp_0, f0.d);
    r0 = MemoryInline::FlatRead8((r23 + 41));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_800318F4:
{
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8002F280u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
...
loc_80031920:
{
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8002F720u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
...
loc_8003194C:
{
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8002FCC0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
...
loc_80031978:
{
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80031080u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
...
loc_800319A4:
{
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80030250u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800319D0:
{
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80030890u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
...
loc_800319F8:
{
    f0.d = MemoryInline::FlatReadFloat32((r2 + -30984));
...
loc_80031A0C:
{
    guest_range_1 = MemoryInline::ResolveRangeHost((r23 + 44), 0, 16u, true, false);
    r3 = MemoryInline::ReadResolved16(guest_range_1, 0u, (r23 + 44));
    r0 = (r3 & 2);
}
...
loc_80031A38:
{
    ...
    r26 = (r1 + 16);
    f1.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 4u, (r23 + 48));
    r6 = (r1 + 28);
    ...
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 8u, (r23 + 52));
    f0.d = PpcFmulsInline(f1.d, f0.d);
    MemoryInline::FlatWriteFloat32((r31 + 4), f0.d);
    f1.d = MemoryInline::FlatReadFloat32((r31 + 8));
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 12u, (r23 + 56));
    f0.d = PpcFmulsInline(f1.d, f0.d);
    ...
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r26_psq_tmp_1 = (r26 + 8);
    PPC_PsqStStackInline<1u, 0u>(ctx, r26_psq_tmp_1, f0.d);
    // inline leaf 0x8019A91C (21 guest instruction(s))
    // psq_load w=0 quant=0 (using PPC_PsqL)
    ...
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 4u, (r23 + 48));
    ...
    // psq_load w=1 quant=0 (using PPC_PsqL)
    r26_psq_tmp_2 = (r26 + 8);
    PpcSetPairedFprInline(f2, PPC_PsqLStackInline<1u, 0u>(ctx, r26_psq_tmp_2));
    PpcSetPairedFprInline(f0, PPC_PsAddInline(f0.d, f2.d));
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r30_psq_tmp_1 = (r30 + 8);
...
loc_80031B00:
{
    r0 = MemoryInline::ReadResolved16(guest_range_1, 0u, (r23 + 44));
    r0 = (r0 & 64);
}
...
loc_80031B40:
{
    r3 = MemoryInline::FlatRead32((r25 + 200));
    r5 = r25;
    r7 = MemoryInline::FlatRead16((r25 + 226));
    r6 = r24;
...
// RECOMP_REGISTRATION base 0x800317C0 func_800317C0 preserves=false fpr_mask=0x80000000
