...
extern "C" void func_80678850(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806788D8:
{
    ...
    if (MkwStateFreeAbiEnabled(0x80208B70u) && KnownTranslatedCpuCall<0x80208B70u>::kAvailable && !KnownTranslatedCpuCall<0x80208B70u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80208B70u>()) {
        const auto state_free_result_80208B70_1555 = func_80208B70_statefree(r13);
        r3 = static_cast<uint32_t>(state_free_result_80208B70_1555);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_806788EC:
{
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x80208B70u) && KnownTranslatedCpuCall<0x80208B70u>::kAvailable && !KnownTranslatedCpuCall<0x80208B70u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80208B70u>()) {
        const auto state_free_result_80208B70_1B4E = func_80208B70_statefree(r13);
        r3 = static_cast<uint32_t>(state_free_result_80208B70_1B4E);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_8067890C:
{
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x80208B70u) && KnownTranslatedCpuCall<0x80208B70u>::kAvailable && !KnownTranslatedCpuCall<0x80208B70u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80208B70u>()) {
        const auto state_free_result_80208B70_246E = func_80208B70_statefree(r13);
        r3 = static_cast<uint32_t>(state_free_result_80208B70_246E);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80678850 func_80678850 preserves=true fpr_mask=0x00000000
