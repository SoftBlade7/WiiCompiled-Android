...
extern "C" void func_80762054(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80762054:
{
    ...
    MemoryInline::FlatWrite16((r3 + 44), static_cast<uint16_t>(r7));
...
loc_807620A8:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r5 + -11940));
...
// RECOMP_REGISTRATION base 0x80762054 func_80762054 preserves=true fpr_mask=0x00000000
