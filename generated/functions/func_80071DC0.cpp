...
extern "C" void func_80071DC0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80071E5C:
{
    r0 = MemoryInline::FlatRead16((r28 + 258));
    r3 = (r30 * 48);
    r6 = MemoryInline::FlatRead8((r28 + 257));
    r4 = r29;
    r7 = MemoryInline::FlatRead32((r28 + 244));
    r5 = (r0 * 48);
    r0 = (r5 + 31);
    r0 = (r0 & -32);
    r0 = (r6 * r0);
...
// RECOMP_GUEST_ABI gpr_read=0xF00000FB gpr_write=0xF00000FB gpr_return=0x00000018 fpr_read=0x8000FF80 fpr_write=0x8000FFFF fpr_return=0x00000002 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80071DC0 func_80071DC0 preserves=true fpr_mask=0x00000000
