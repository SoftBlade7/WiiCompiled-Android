...
extern "C" void func_80543F10(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80543F10:
{
    ...
    r4 = (r4 + 16396);
    r5 = (r5 + 17752);
    MemoryInline::FlatWrite8((r29 + 52), static_cast<uint8_t>(r30));
    r6 = (r6 + -27664);
    r7 = 4;
    ctx->lr = 0x80543F74u;
    ctx->gpr[0] = r0;
    ...
    r6 = (r29 + 131072);
    r31 = 0x809C0000u;
    MemoryInline::FlatWrite8((r6 + 20480), static_cast<uint8_t>(r30));
    r3 = 2;
    r4 = 20;
    r5 = 65536;
    MemoryInline::FlatWrite8((r6 + 20472), static_cast<uint8_t>(r30));
    MemoryInline::FlatWrite32((r6 + 20476), r30);
    MemoryInline::FlatWrite32((r6 + 20484), r30);
    ...
    r3 = (r3 + -32768);
    r5 = 32;
    r4 = MemoryInline::FlatRead32((r31 + -10432));
...
// RECOMP_REGISTRATION base 0x80543F10 func_80543F10 preserves=true fpr_mask=0x00000000
