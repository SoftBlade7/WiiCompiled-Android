...
extern "C" void func_80641AC0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80641C00:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead32((r29 + 648));
    r3 = (r29 + 372);
...
// RECOMP_REGISTRATION base 0x80641AC0 func_80641AC0 preserves=true fpr_mask=0x00000000
