...
extern "C" void func_801A75D0(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r3 = 0x80000000u;
    r3 = MemoryInline::FlatRead32((r3 + 12544));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x801A75D0 func_801A75D0 preserves=true fpr_mask=0x00000000
