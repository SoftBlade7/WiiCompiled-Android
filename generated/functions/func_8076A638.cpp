...
extern "C" void func_8076A638(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8076A638:
{
    ...
    r24 = 0x808D0000u;
    r3 = (r27 + 220);
    MemoryInline::FlatWrite32((r27 + 196), r5);
    r5 = 0;
    MemoryInline::FlatWrite32((r27 + 200), r23);
    MemoryInline::FlatWrite32((r27 + 204), r23);
    MemoryInline::FlatWrite32((r27 + 220), r4);
    MemoryInline::FlatWrite32((r27 + 224), r23);
    MemoryInline::FlatWrite32((r27 + 228), r23);
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r12 = MemoryInline::FlatRead32((r27 + 196));
    r3 = (r27 + 196);
    r4 = MemoryInline::FlatRead32((r24 + -6252));
    r5 = 0;
    r12 = MemoryInline::FlatRead32((r12 + 12));
...
loc_8076A704:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32(r22, r25);
    r3 = 124;
    ctx->lr = 0x8076A71Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8076A728:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32(r21, r26);
}

loc_8076A738:
{
    MemoryInline::FlatWriteRam32((r22 + 276), r21);
    r3 = 124;
    ctx->lr = 0x8076A744u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8076A760:
{
    MemoryInline::FlatWriteRam32((r22 + 280), r21);
    MemoryInline::FlatWriteRam32((r22 + 284), r23);
}
...
loc_8076A7A0:
{
    r4 = MemoryInline::FlatRead32((r27 + 228));
}
...
loc_8076A7A8:
{
    r3 = 0;
    r4_addr_2 = (r4 + r30);
    MemoryInline::FlatWrite32(r4_addr_2, r22);
    if ((static_cast<int32_t>(r29) < static_cast<int32_t>(0))) {
        goto loc_8076A7C4;
    }
}
...
// RECOMP_REGISTRATION base 0x8076A638 func_8076A638 preserves=true fpr_mask=0x00000000
