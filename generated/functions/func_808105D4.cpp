...
extern "C" void func_808105D4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_808105D4:
{
    ...
    ctx->gpr[10] = r10;
    ctx->fpr[1] = f1;
    InvokeDirectCpu<0x80810780u>(ctx);
    r9 = ctx->gpr[9];
    r10 = ctx->gpr[10];
    f1 = ctx->fpr[1];
    ctx->gpr[9] = r9;
...
// RECOMP_REGISTRATION base 0x808105D4 func_808105D4 preserves=true fpr_mask=0x00000000
