...
extern "C" void func_806EE72C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806EE72C:
{
    ...
    f2.d = MemoryInline::FlatReadFloat32((r4 + 2852));
    MemoryInline::FlatWriteRam32((r1 + 88), r30);
    f0.d = PpcFmulsInline(f2.d, f3.d);
    r31 = r5;
    f2.d = PpcFmulsInline(f2.d, f1.d);
    f5.d = PpcFmulsInline(f4.d, f4.d);
    r30 = r3;
    f31.d = PpcFmulsInline(f3.d, f1.d);
    f29.d = PpcFmulsInline(f0.d, f4.d);
    r4 = r31;
    f1.d = PpcFmulsInline(f5.d, f4.d);
    f30.d = PpcFmulsInline(f2.d, f5.d);
    r3 = (r1 + 68);
...
// RECOMP_GUEST_ABI gpr_read=0xC000002A gpr_write=0xC000003B gpr_return=0x00000018 fpr_read=0xE0000002 fpr_write=0xE000003F fpr_return=0x00000002 cr_read=0x00 cr_write=0x00 xer_read=0 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x806EE72C func_806EE72C preserves=false fpr_mask=0xE0000000
