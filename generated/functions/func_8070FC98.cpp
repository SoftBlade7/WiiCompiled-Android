...
extern "C" void func_8070FC98(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_8070FCB8:
{
    r4 = 0x808A0000u;
    r3 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r4 + 7808));
    r0 = 3;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 7812));
...
// RECOMP_REGISTRATION base 0x8070FC98 func_8070FC98 preserves=true fpr_mask=0x00000000
