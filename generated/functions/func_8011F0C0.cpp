...
extern "C" void func_8011F0C0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_addic_src_0 = 0;
    uint32_t r0_addic_src_1 = 0;
    uint32_t r0_addic_src_10 = 0;
    uint32_t r0_addic_src_11 = 0;
    uint32_t r0_addic_src_12 = 0;
    uint32_t r0_addic_src_13 = 0;
    uint32_t r0_addic_src_14 = 0;
    uint32_t r0_addic_src_15 = 0;
    uint32_t r0_addic_src_16 = 0;
    uint32_t r0_addic_src_17 = 0;
...
loc_8011F0F0:
{
    r3 = MemoryInline::FlatRead32((r26 + 1716));
    r4 = r27;
    r5 = r28;
    r6 = 0;
    r29 = (r29 + -1);
...
{
    r3 = MemoryInline::FlatRead32((r26 + 1716));
    MemoryInline::FlatWrite32((r26 + 124), r23);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(-1));
}

loc_8011F144:
{
    MemoryInline::FlatWrite32((r26 + 128), r23);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_8011F150;
    }
}
...
loc_8011F150:
{
    ...
    MemoryInline::FlatWrite32((r26 + 1716), r24);
}
...
loc_8011F1CC:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r26 + 8), r23);
}

loc_8011F1D8:
{
    MemoryInline::FlatWrite32((r26 + 1156), r24);
    r22 = r26;
    r31 = 0;
    goto loc_8011F230;
}
...
loc_8011F1E8:
{
    r0 = MemoryInline::FlatRead32((r22 + 132));
    r3 = r26;
...
loc_8011F208:
{
    ...
    r0 = (r0_addic_src_7 + -1);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r0_addic_src_7)) + static_cast<uint64_t>(static_cast<uint32_t>(-1)) + (static_cast<uint64_t>(static_cast<uint32_t>(0)) & 1u);
        xer = (xer & 0xDFFFFFFFu) | (static_cast<uint32_t>((ppcCarryWide >> 32) & 1u) << 29);
    }
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_8011F230:
{
    r0 = MemoryInline::FlatRead32((r26 + 1152));
...
loc_8011F23C:
{
    MemoryInline::FlatWrite32((r26 + 1152), r23);
    r3 = r26;
    r4 = 0;
    r5 = 0;
    r6 = 2;
...
loc_8011F264:
{
    r22 = MemoryInline::FlatRead32((r26 + 128));
...
loc_8011F270:
{
    r23 = MemoryInline::FlatRead32((r13 + -29900));
    r3 = r23;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_8011F284:
{
    r24 = MemoryInline::FlatRead32((r13 + -29900));
    r22 = MemoryInline::FlatRead32((r26 + 124));
    r3 = r24;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_8011F304:
{
    r3 = MemoryInline::FlatRead32((r26 + 1716));
    r0 = 0;
    MemoryInline::FlatWrite32((r26 + 124), r0);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(-1));
}

loc_8011F314:
{
    MemoryInline::FlatWrite32((r26 + 128), r0);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_8011F320;
    }
}
...
loc_8011F320:
{
    ...
    r4 = -1;
    r3 = 1;
    MemoryInline::FlatWrite32((r26 + 1716), r4);
}
...
loc_8011F370:
{
    r0 = MemoryInline::FlatRead32((r3 + 4));
    r0_addic_src_10 = r0;
    r0 = (r0_addic_src_10 + -1);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r0_addic_src_10)) + static_cast<uint64_t>(static_cast<uint32_t>(-1)) + (static_cast<uint64_t>(static_cast<uint32_t>(0)) & 1u);
        xer = (xer & 0xDFFFFFFFu) | (static_cast<uint32_t>((ppcCarryWide >> 32) & 1u) << 29);
    }
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_8011F3C8:
{
    r0 = MemoryInline::FlatRead32((r24 + 132));
    r3 = r26;
...
loc_8011F3E8:
{
    r0 = MemoryInline::FlatRead32((r3 + 4));
    r0_addic_src_14 = r0;
    r0 = (r0_addic_src_14 + -1);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r0_addic_src_14)) + static_cast<uint64_t>(static_cast<uint32_t>(-1)) + (static_cast<uint64_t>(static_cast<uint32_t>(0)) & 1u);
        xer = (xer & 0xDFFFFFFFu) | (static_cast<uint32_t>((ppcCarryWide >> 32) & 1u) << 29);
    }
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
// RECOMP_REGISTRATION base 0x8011F0C0 func_8011F0C0 preserves=true fpr_mask=0x00000000
