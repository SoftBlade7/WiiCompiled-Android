...
extern "C" void func_805B3A78(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805B3A78:
{
    ...
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x805B8F40u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x805B3A78 func_805B3A78 preserves=true fpr_mask=0x00000000
