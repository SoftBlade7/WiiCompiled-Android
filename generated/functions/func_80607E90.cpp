...
extern "C" void func_80607E90(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80607E90:
{
    ...
    r31 = 0x80890000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r31 + 28288));
    ctx->lr = 0x80607EC4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80607E90 func_80607E90 preserves=true fpr_mask=0x00000000
