...
extern "C" void func_807C613C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807C6240:
{
    ...
    ctx->fpr[12] = f12;
    ctx->cr = cr;
    InvokeDirectCpu<0x807C44BCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x807C613C func_807C613C preserves=true fpr_mask=0x00000000
