...
extern "C" void func_80711198(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807111EC:
{
    r4 = MemoryInline::FlatRead32((r28 + 324));
    r0 = MemoryInline::FlatRead32((r28 + 328));
    r3 = MemoryInline::FlatRead32((r29 + 6552));
...
loc_80711234:
{
    r3 = MemoryInline::FlatRead32((r31 + 6584));
    r4 = r26;
    r6 = MemoryInline::FlatRead32((r30 + 10392));
    r5 = (r1 + 8);
    r3 = MemoryInline::FlatRead32((r3 + 24));
    f1.d = MemoryInline::FlatReadFloat32((r6 + 2236));
    r3_addr_2 = (r3 + r27);
    ...
    ctx->fpr[1] = f1;
    ctx->cr = cr;
    InvokeDirectCpu<0x805A6C58u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80711258:
{
    r3 = MemoryInline::FlatRead32((r31 + 6584));
    r4 = r26;
    f1.d = MemoryInline::FlatReadFloat32((r20 + 7824));
    r5 = (r1 + 8);
    r3 = MemoryInline::FlatRead32((r3 + 24));
    r3_addr_4 = (r3 + r27);
...
loc_80711278:
{
    r3 = MemoryInline::FlatRead32((r31 + 6584));
    r4 = r26;
    f1.d = MemoryInline::FlatReadFloat32((r21 + 7936));
    r5 = (r1 + 8);
    r3 = MemoryInline::FlatRead32((r3 + 24));
    r3_addr_3 = (r3 + r27);
...
loc_80711294:
{
    r0 = MemoryInline::FlatRead32((r30 + 10392));
    r4 = r25;
    r3 = (r0 + r24);
    r3 = (r3 + 1764);
    ctx->lr = 0x807112A8u;
...
loc_807112A8:
{
    ...
    r26 = (r26 + 48);
    MemoryInline::FlatWriteFloat32((r28 + 324), f0.d);
    r25 = (r25 + 48);
    r27 = (r27 + 4);
    r24 = (r24 + 88);
    f0.d = MemoryInline::FlatReadFloat32((r1 + 12));
    r23 = (r23 + 1);
    MemoryInline::FlatWriteFloat32((r28 + 328), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r1 + 16));
    MemoryInline::FlatWriteFloat32((r28 + 332), f0.d);
    r28 = (r28 + 12);
}

loc_807112D8:
{
    r0 = MemoryInline::FlatRead8((r22 + 76));
...
// RECOMP_GUEST_ABI gpr_read=0xFFF000FF gpr_write=0xFFF01FFB gpr_return=0x00000018 fpr_read=0xC0003FFF fpr_write=0xC0003FFF fpr_return=0x00000002 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80711198 func_80711198 preserves=true fpr_mask=0x00000000
