...
extern "C" void func_805BE130(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805BE294:
{
    ...
    r3 = 0x80890000u;
    f3.d = MemoryInline::FlatReadFloat64((r3 + 11824));
    r5 = 0x80890000u;
...
loc_805BE2E8:
{
    r5 = 0x80890000u;
    r4 = 3;
    f1.d = MemoryInline::FlatReadFloat32((r5 + 11812));
    ctx->lr = 0x805BE2F8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_805BE2F8:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r30 + 572));
...
// RECOMP_REGISTRATION base 0x805BE130 func_805BE130 preserves=true fpr_mask=0x00000000
