...
extern "C" void func_8082F8F8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8082FA08:
{
    ...
    r0 = (r0_addic_src_1 + 4);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r0_addic_src_1)) + static_cast<uint64_t>(static_cast<uint32_t>(4)) + (static_cast<uint64_t>(static_cast<uint32_t>(0)) & 1u);
...
// RECOMP_REGISTRATION base 0x8082F8F8 func_8082F8F8 preserves=true fpr_mask=0x00000000
