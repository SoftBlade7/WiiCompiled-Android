...
extern "C" void func_801314B0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80131530:
{
    r3 = 0x80330000u;
    r4 = 0x80130000u;
    r3 = MemoryInline::FlatRead32((r3 + 9440));
    r4 = (r4 + 2472);
    r5 = 0;
    ctx->lr = 0x80131548u;
    ctx->gpr[0] = r0;
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801B7B64u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x801314B0 func_801314B0 preserves=true fpr_mask=0x00000000
