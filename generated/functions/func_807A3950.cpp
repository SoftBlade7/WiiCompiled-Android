...
extern "C" void func_807A3950(CpuContext* MKW_RESTRICT ctx)
{
    goto loc_807A3950;

loc_807A3950:
{
    InvokeDirectCpu<0x807A6F6Cu>(ctx);
    return;
}
...
// RECOMP_REGISTRATION base 0x807A3950 func_807A3950 preserves=true fpr_mask=0x00000000
