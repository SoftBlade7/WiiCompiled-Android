...
extern "C" void func_8075AAC8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8075AAC8:
{
    ...
    r28 = r3;
    r0 = MemoryInline::FlatRead32((r3 + 320));
    r29 = r4;
    r30 = r5;
    r31 = r6;
}
...
loc_8075AAFC:
{
    ...
    r0 = MemoryInline::FlatRead32((r4 + -14108));
...
loc_8075AB58:
{
    r0 = MemoryInline::FlatRead32((r28 + 228));
...
loc_8075AB64:
{
    ...
    f2 = ctx->fpr[2];
    cr = ctx->cr;
    guest_range_1 = MemoryInline::ResolveRangeHost((r28 + 8), 0, 272u, true, false);
    r3 = MemoryInline::ReadResolved32(guest_range_1, 80u, (r28 + 88));
    r5 = (r1 + 20);
    r0 = MemoryInline::ReadResolved32(guest_range_1, 84u, (r28 + 92));
    guest_range_2 = MemoryInline::ResolveRangeHost((r1 + 128), 0, 48u, false, true);
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 0u, ((static_cast<uint64_t>(static_cast<uint32_t>(r3)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_2, 4u, (r1 + 132), r0);
        MemoryInline::WriteResolved32(guest_range_2, 0u, (r1 + 128), r3);
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r3 = MemoryInline::ReadResolved32(guest_range_1, 88u, (r28 + 96));
            r0 = MemoryInline::ReadResolved32(guest_range_1, 92u, (r28 + 100));
        }
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 8u, ((static_cast<uint64_t>(static_cast<uint32_t>(r3)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_2, 12u, (r1 + 140), r0);
        MemoryInline::WriteResolved32(guest_range_2, 8u, (r1 + 136), r3);
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r3 = MemoryInline::ReadResolved32(guest_range_1, 96u, (r28 + 104));
            r0 = MemoryInline::ReadResolved32(guest_range_1, 100u, (r28 + 108));
        }
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 16u, ((static_cast<uint64_t>(static_cast<uint32_t>(r3)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_2, 20u, (r1 + 148), r0);
        MemoryInline::WriteResolved32(guest_range_2, 16u, (r1 + 144), r3);
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r3 = MemoryInline::ReadResolved32(guest_range_1, 104u, (r28 + 112));
            r0 = MemoryInline::ReadResolved32(guest_range_1, 108u, (r28 + 116));
        }
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r3)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_2, 28u, (r1 + 156), r0);
        MemoryInline::WriteResolved32(guest_range_2, 24u, (r1 + 152), r3);
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r3 = MemoryInline::ReadResolved32(guest_range_1, 112u, (r28 + 120));
            r0 = MemoryInline::ReadResolved32(guest_range_1, 116u, (r28 + 124));
        }
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 32u, ((static_cast<uint64_t>(static_cast<uint32_t>(r3)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_2, 36u, (r1 + 164), r0);
        MemoryInline::WriteResolved32(guest_range_2, 32u, (r1 + 160), r3);
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r3 = MemoryInline::ReadResolved32(guest_range_1, 120u, (r28 + 128));
            r0 = MemoryInline::ReadResolved32(guest_range_1, 124u, (r28 + 132));
        }
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 40u, ((static_cast<uint64_t>(static_cast<uint32_t>(r3)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_2, 44u, (r1 + 172), r0);
        MemoryInline::WriteResolved32(guest_range_2, 40u, (r1 + 168), r3);
    }
    r0 = MemoryInline::ReadResolved32(guest_range_1, 220u, (r28 + 228));
    r4 = MemoryInline::ReadResolved32(guest_range_1, 268u, (r28 + 276));
    r0_subfic_ra_0 = r0;
    r0 = (4 - r0_subfic_ra_0);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(4) >= static_cast<uint32_t>(r0_subfic_ra_0) ? 1u : 0u) << 29);
    r3 = MemoryInline::ReadResolved32(guest_range_1, 0u, (r28 + 8));
    r27 = (r4 + r0);
    r4 = r27;
    ctx->lr = 0x8075ABECu;
    ctx->gpr[0] = r0;
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80782E50u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8075ACBC:
{
    r3 = MemoryInline::FlatRead32((r28 + 8));
    r5 = (r1 + 8);
    r4 = MemoryInline::FlatRead32((r28 + 288));
    ctx->lr = 0x8075ACCCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_8075AD94:
{
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWrite32((r28 + 304), r0);
    r3 = 0x809C0000u;
    r4 = 0x809C0000u;
    MemoryInline::FlatWrite8((r28 + 324), static_cast<uint8_t>(r0));
...
loc_8075AE54:
{
    ...
    r3 = 0x808D0000u;
    r11 = (r1 + 208);
    r0 = MemoryInline::FlatRead32((r3 + -14092));
...
// RECOMP_REGISTRATION base 0x8075AAC8 func_8075AAC8 preserves=true fpr_mask=0x00000000
