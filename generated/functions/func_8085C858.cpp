...
extern "C" void func_8085C858(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8085C8A4:
{
    ...
    r3 = (r0 + r4);
    r24 = MemoryInline::FlatRead8((r3 + -1));
    r3 = r26;
    r5 = r24;
    ctx->lr = 0x8085C8D0u;
    ctx->gpr[0] = r0;
    ...
    r5 = 1313;
    r4 = (r0 + r23);
    r22 = MemoryInline::FlatRead16((r4 + 256));
    r4 = r22;
    ctx->lr = 0x8085C8F0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8085C920:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x807F595Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8085C858 func_8085C858 preserves=true fpr_mask=0x00000000
