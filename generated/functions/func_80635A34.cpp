...
extern "C" void func_80635A34(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80635A34:
{
    ...
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80622B4Cu>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80635A34 func_80635A34 preserves=true fpr_mask=0x00000000
