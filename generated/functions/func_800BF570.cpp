...
extern "C" void func_800BF570(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800BF5C0:
{
    ...
    r3 = r23;
    MemoryInline::FlatWrite32((r29 + 4), r24);
    MemoryInline::FlatWrite32((r29 + 8), r25);
    MemoryInline::FlatWrite32((r29 + 12), r27);
    // inline leaf 0x800BC5E0 (9 guest instruction(s))
}
...
loc_inl9_cont_800BC5E0:
{
    ...
    r31 = r3;
    MemoryInline::FlatWrite32((r3 + 456), r23);
...
loc_800BF6E8:
{
    ...
    if (MkwStateFreeAbiEnabled(0x800BC470u) && KnownTranslatedCpuCall<0x800BC470u>::kAvailable && !KnownTranslatedCpuCall<0x800BC470u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x800BC470u>()) {
        const auto state_free_result_800BC470_32B3 = func_800BC470_statefree(r13);
        r3 = static_cast<uint32_t>(state_free_result_800BC470_32B3);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x800BC470u) && KnownTranslatedCpuCall<0x800BC470u>::kAvailable && !KnownTranslatedCpuCall<0x800BC470u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x800BC470u>()) {
        const auto state_free_result_800BC470_38DD = func_800BC470_statefree(r13);
        r3 = static_cast<uint32_t>(state_free_result_800BC470_38DD);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_800BF718:
{
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x800BC470u) && KnownTranslatedCpuCall<0x800BC470u>::kAvailable && !KnownTranslatedCpuCall<0x800BC470u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x800BC470u>()) {
        const auto state_free_result_800BC470_3FB2 = func_800BC470_statefree(r13);
        r3 = static_cast<uint32_t>(state_free_result_800BC470_3FB2);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_800BF730:
{
    ...
    if (MkwStateFreeAbiEnabled(0x800BC460u) && KnownTranslatedCpuCall<0x800BC460u>::kAvailable && !KnownTranslatedCpuCall<0x800BC460u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x800BC460u>()) {
        const auto state_free_result_800BC460_47F5 = func_800BC460_statefree(r3, r13);
        r4 = static_cast<uint32_t>(state_free_result_800BC460_47F5);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x800BC470u) && KnownTranslatedCpuCall<0x800BC470u>::kAvailable && !KnownTranslatedCpuCall<0x800BC470u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x800BC470u>()) {
        const auto state_free_result_800BC470_4DFC = func_800BC470_statefree(r13);
        r3 = static_cast<uint32_t>(state_free_result_800BC470_4DFC);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x800BC470u) && KnownTranslatedCpuCall<0x800BC470u>::kAvailable && !KnownTranslatedCpuCall<0x800BC470u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x800BC470u>()) {
        const auto state_free_result_800BC470_5426 = func_800BC470_statefree(r13);
        r3 = static_cast<uint32_t>(state_free_result_800BC470_5426);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x800BF570 func_800BF570 preserves=true fpr_mask=0x00000000
