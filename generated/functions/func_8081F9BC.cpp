...
extern "C" void func_8081F9BC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8081F9BC:
{
    ...
    MemoryInline::WriteResolved16(guest_range_0, 136u, (r3 + 136), static_cast<uint16_t>(r4));
    MemoryInline::WriteResolved8(guest_range_0, 153u, (r3 + 153), static_cast<uint8_t>(r8));
    MemoryInline::WriteResolved8(guest_range_0, 154u, (r3 + 154), static_cast<uint8_t>(r8));
    MemoryInline::WriteResolved8(guest_range_0, 155u, (r3 + 155), static_cast<uint8_t>(r8));
    MemoryInline::WriteResolved8(guest_range_0, 156u, (r3 + 156), static_cast<uint8_t>(r8));
    MemoryInline::WriteResolved8(guest_range_0, 157u, (r3 + 157), static_cast<uint8_t>(r31));
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 160u, ((static_cast<uint64_t>(static_cast<uint32_t>(r8)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_0, 160u, (r3 + 160), r8);
    ...
    r3 = MemoryInline::FlatRead16((r27 + 44));
    ...
    f8.d = MemoryInline::FlatReadFloat32(r30);
    ...
    MemoryInline::FlatWrite8((r27 + 84), static_cast<uint8_t>(r31));
    MemoryInline::FlatWriteFloat32((r27 + 72), f5.d);
    MemoryInline::FlatWriteFloat32((r27 + 76), f4.d);
    MemoryInline::FlatWriteFloat32((r27 + 80), f3.d);
    MemoryInline::FlatWrite16((r27 + 44), static_cast<uint16_t>(r0));
    MemoryInline::FlatWriteFloat32((r27 + 60), f8.d);
    MemoryInline::FlatWriteFloat32((r27 + 64), f7.d);
    MemoryInline::FlatWriteFloat32((r27 + 68), f6.d);
...
loc_inl2_cont_8051BED0:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r27 + 40), r3);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r27 + 140), r3);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r27 + 148), r3);
    r11 = (r1 + 32);
    r3 = r27;
...
// RECOMP_REGISTRATION base 0x8081F9BC func_8081F9BC preserves=true fpr_mask=0x00000000
