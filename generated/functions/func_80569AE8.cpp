...
extern "C" void func_80569AE8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_80569AE8:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r3 + 5660));
...
// RECOMP_GUEST_ABI gpr_read=0x8000000E gpr_write=0x800000FB gpr_return=0x00000018 fpr_read=0x800003FF fpr_write=0x800003FF fpr_return=0x00000002 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80569AE8 func_80569AE8 preserves=true fpr_mask=0x00000000
