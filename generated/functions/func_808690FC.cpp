...
extern "C" void func_808690FC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r4_rot_0 = 0;
...
loc_808690FC:
{
    ...
    r4_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(4));
    r4 = (r4_rot_0 & -16);
    r0 = (r5 + 1);
    r4 = (r3 + r4);
...
// RECOMP_REGISTRATION base 0x808690FC func_808690FC preserves=true fpr_mask=0x00000000
