...
MKW_PPC_NO_INLINE static void func_801B4DA8_gqr_impl(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
extern "C" void func_801B4DA8(CpuContext* MKW_RESTRICT ctx)
{
    if (ctx->gqr[5u] == 0x00070007u && ctx->gqr[6u] == 0x3D043D04u)
        func_801B4DA8_gqr_impl<true>(ctx);
    else
        func_801B4DA8_gqr_impl<false>(ctx);
}
...
// RECOMP_REGISTRATION base 0x801B4DA8 func_801B4DA8 preserves=true fpr_mask=0x00000000
