...
extern "C" void func_807FDC50(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
{
    r4 = 0x809C0000u;
    r5 = MemoryInline::FlatRead16((r3 + 312));
    r5 = (r5 << 16);
...
loc_807FDD94:
{
    ...
    f2.d = MemoryInline::FlatReadFloat32((r31 + 308));
    ...
    f0.d = MemoryInline::FlatReadFloat32((r4 + 16836));
    r4 = 2;
...
loc_807FDE28:
{
    ...
    r3 = 0x808B0000u;
    f2.d = MemoryInline::FlatReadFloat32((r3 + -21328));
    r4 = 0;
...
// RECOMP_REGISTRATION base 0x807FDC50 func_807FDC50 preserves=false fpr_mask=0x80000000
