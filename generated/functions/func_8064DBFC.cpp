...
extern "C" void func_8064DBFC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8064DBFC:
{
    ...
    r29 = 0x808A0000u;
    r29 = (r29 + -25464);
    guest_range_0 = MemoryInline::ResolveRangeHost(r29, 0, 44u, true, false);
    r30 = MemoryInline::ReadResolved32(guest_range_0, 0u, r29);
    MemoryInline::WriteResolved32(guest_range_1, 8u, (r1 + 8), r30);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r12 = MemoryInline::ReadResolved32(guest_range_0, 4u, (r29 + 4));
            r11 = MemoryInline::ReadResolved32(guest_range_0, 8u, (r29 + 8));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r10 = MemoryInline::ReadResolved32(guest_range_0, 12u, (r29 + 12));
            r9 = MemoryInline::ReadResolved32(guest_range_0, 16u, (r29 + 16));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r8 = MemoryInline::ReadResolved32(guest_range_0, 20u, (r29 + 20));
            r7 = MemoryInline::ReadResolved32(guest_range_0, 24u, (r29 + 24));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_0, 28u, (r29 + 28));
            r5 = MemoryInline::ReadResolved32(guest_range_0, 32u, (r29 + 32));
        }
    }
    {
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 12u, ((static_cast<uint64_t>(static_cast<uint32_t>(r12)) << 32) | static_cast<uint32_t>(r11)))) {
        MemoryInline::WriteResolved32(guest_range_1, 12u, (r1 + 12), r12);
        MemoryInline::WriteResolved32(guest_range_1, 16u, (r1 + 16), r11);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 20u, ((static_cast<uint64_t>(static_cast<uint32_t>(r10)) << 32) | static_cast<uint32_t>(r9)))) {
        MemoryInline::WriteResolved32(guest_range_1, 20u, (r1 + 20), r10);
        MemoryInline::WriteResolved32(guest_range_1, 24u, (r1 + 24), r9);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 28u, ((static_cast<uint64_t>(static_cast<uint32_t>(r8)) << 32) | static_cast<uint32_t>(r7)))) {
        MemoryInline::WriteResolved32(guest_range_1, 28u, (r1 + 28), r8);
        MemoryInline::WriteResolved32(guest_range_1, 32u, (r1 + 32), r7);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 36u, ((static_cast<uint64_t>(static_cast<uint32_t>(r6)) << 32) | static_cast<uint32_t>(r5)))) {
        ...
        MemoryInline::WriteResolved32(guest_range_1, 40u, (r1 + 40), r5);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 44u, ((static_cast<uint64_t>(static_cast<uint32_t>(r4)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_1, 44u, (r1 + 44), r4);
...
loc_8064DC88:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805BDBD4u) && KnownTranslatedCpuCall<0x805BDBD4u>::kAvailable && !KnownTranslatedCpuCall<0x805BDBD4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805BDBD4u>()) {
        const auto state_free_result_805BDBD4_1C71 = func_805BDBD4_statefree(r3, r4);
        r3 = static_cast<uint32_t>(state_free_result_805BDBD4_1C71);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_8064DCE8:
{
    ...
    r30 = 0x808A0000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r30 + -25420));
    ctx->lr = 0x8064DD04u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8064DBFC func_8064DBFC preserves=true fpr_mask=0x00000000
