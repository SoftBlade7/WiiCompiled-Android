...
extern "C" void func_800D6194(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800D6194:
{
    ...
    r24 = MemoryInline::FlatRead32((r13 + -26868));
    r22 = r3;
    r31 = MemoryInline::FlatRead32((r1 + 72));
    r27 = r4;
    r0 = MemoryInline::FlatRead32((r24 + 1756));
    r28 = r5;
    r29 = r6;
    r30 = r7;
...
loc_800D61DC:
{
    r3 = MemoryInline::FlatRead32((r24 + 1924));
    r0 = 0;
    r10 = 0x800E0000u;
    r6 = 0;
    ...
    r10 = (r10 + 12736);
    r7 = 20;
    r5 = MemoryInline::FlatRead32((r24 + 1928));
    r8 = 1;
    r9 = 0;
    ctx->lr = 0x800D620Cu;
    ctx->gpr[0] = r0;
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r24 + 1756), r3);
}
...
loc_800D6258:
{
    MemoryInline::FlatWrite32((r3 + 2192), r22);
    r3 = MemoryInline::FlatRead32((r13 + -26868));
    MemoryInline::FlatWrite8((r3 + 2196), static_cast<uint8_t>(r0));
    r3 = MemoryInline::FlatRead32((r13 + -26868));
    MemoryInline::FlatWrite8((r3 + 2197), static_cast<uint8_t>(r23));
    r3 = MemoryInline::FlatRead32((r13 + -26868));
    MemoryInline::FlatWrite32((r3 + 2212), r26);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_800D6290;
    }
}
...
loc_800D62E4:
{
    r25 = MemoryInline::FlatRead32((r13 + -26864));
    r24 = MemoryInline::FlatRead32((r13 + -26860));
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->xer = xer;
    ...
    r6 = 0x80000000u;
    r4_subfc_min_1 = r4;
    r4 = (r4_subfc_min_1 - r24);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(r4_subfc_min_1) >= static_cast<uint32_t>(r24) ? 1u : 0u) << 29);
...
loc_800D6380:
{
    ...
    r4 = 3;
    r0 = 1;
    MemoryInline::FlatWrite32((r3 + 1820), r5);
    r3 = MemoryInline::ReadResolved32(guest_range_2, 0u, (r13 + -26868));
    MemoryInline::FlatWrite32((r3 + 2160), r27);
    r3 = MemoryInline::ReadResolved32(guest_range_2, 0u, (r13 + -26868));
    MemoryInline::FlatWrite32((r3 + 2164), r28);
    r3 = MemoryInline::ReadResolved32(guest_range_2, 0u, (r13 + -26868));
    MemoryInline::FlatWrite32((r3 + 2168), r29);
    r3 = MemoryInline::ReadResolved32(guest_range_2, 0u, (r13 + -26868));
    MemoryInline::FlatWrite32((r3 + 2172), r30);
    r3 = MemoryInline::ReadResolved32(guest_range_2, 0u, (r13 + -26868));
    ...
    r3 = MemoryInline::FlatRead32((r5 + 1912));
    ctx->lr = 0x800D63F4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x800D6194 func_800D6194 preserves=true fpr_mask=0x00000000
