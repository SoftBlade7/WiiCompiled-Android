...
extern "C" void func_80100150(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80100150:
{
    ...
    r31 = 0x80280000u;
    r17 = MemoryInline::FlatRead32((r1 + 88));
    r18 = r3;
    r0 = MemoryInline::FlatRead32((r30 + 500));
    r19 = r4;
    r26 = MemoryInline::FlatRead32((r1 + 92));
    r20 = r5;
...
loc_80100188:
{
    ...
    r28 = MemoryInline::FlatRead32((r1 + 100));
    r21 = r6;
    r29 = MemoryInline::FlatRead32((r1 + 104));
    r22 = r7;
    r23 = r8;
    r24 = r9;
    r25 = r10;
...
loc_80100294:
{
    ...
    MemoryInline::FlatWriteRam32((r19 + 772), r26);
...
loc_80100320:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800FFE28u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80100150 func_80100150 preserves=true fpr_mask=0x00000000
