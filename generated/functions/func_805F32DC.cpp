...
extern "C" void func_805F32DC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_805F32DC:
{
    ...
    r3 = (r31 + 60);
    r8 = (r31 + 160);
    r22 = MemoryInline::FlatRead32((r31 + 60));
    r5 = r26;
    ...
    r3 = (r1 + 64);
    r26 = MemoryInline::FlatRead32((r31 + 160));
    r4 = (r4 + 92);
    ...
    r0 = 1;
    MemoryInline::FlatWrite8((r30 + 384), static_cast<uint8_t>(r0));
    r3 = 0x809C0000u;
...
// RECOMP_REGISTRATION base 0x805F32DC func_805F32DC preserves=true fpr_mask=0x00000000
