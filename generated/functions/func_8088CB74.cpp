...
extern "C" void func_8088CB74(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8088CB74:
{
    ...
    r30 = r5;
    r0 = MemoryInline::FlatRead8((r7 + 19586));
    ...
    MemoryInline::WriteResolved8(guest_range_0, 24u, (r3 + 24), static_cast<uint8_t>(r5));
    MemoryInline::WriteResolvedFloat32(guest_range_0, 32u, (r3 + 32), f1.d);
    MemoryInline::WriteResolved8(guest_range_0, 56u, (r3 + 56), static_cast<uint8_t>(r6));
...
loc_8088CC94:
{
    r5 = 0x809C0000u;
    r3 = r31;
    r4 = MemoryInline::FlatRead8((r5 + 19586));
    r0 = (r4 + 1);
    MemoryInline::FlatWriteRam8((r5 + 19586), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x8088CB74 func_8088CB74 preserves=true fpr_mask=0x00000000
