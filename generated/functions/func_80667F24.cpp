...
extern "C" void func_80667F24(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80667F24:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805EE8D0u) && KnownTranslatedCpuCall<0x805EE8D0u>::kAvailable && !KnownTranslatedCpuCall<0x805EE8D0u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805EE8D0u>()) {
        const auto state_free_result_805EE8D0_745 = func_805EE8D0_statefree(r1, r3, r31, 0x80667F58u);
        r1 = static_cast<uint32_t>(state_free_result_805EE8D0_745[0]);
        r31 = static_cast<uint32_t>(state_free_result_805EE8D0_745[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80667F24 func_80667F24 preserves=true fpr_mask=0x00000000
