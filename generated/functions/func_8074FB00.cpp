...
extern "C" void func_8074FB00(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8074FB00:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r5 + 11444));
    f2.d = MemoryInline::FlatReadFloat32((r6 + 68));
    f3.d = MemoryInline::FlatReadFloat32((r6 + 72));
...
// RECOMP_REGISTRATION base 0x8074FB00 func_8074FB00 preserves=true fpr_mask=0x00000000
