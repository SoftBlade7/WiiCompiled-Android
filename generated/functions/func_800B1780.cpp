...
extern "C" void func_800B1780(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = (r13 + -27064);
    MemoryInline::FlatWrite32((r13 + -27024), r0);
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x800B1780 func_800B1780 preserves=true fpr_mask=0x00000000
