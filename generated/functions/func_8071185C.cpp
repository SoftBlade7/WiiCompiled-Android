...
extern "C" void func_8071185C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8071185C:
{
    ...
    r12 = MemoryInline::FlatRead32((r3 + 92));
    r0 = (0 - r4);
    r0 = (r0 | r4);
...
{
    r31 = 0x809C0000u;
    f31.d = MemoryInline::FlatReadFloat32((r30 + 104));
...
// RECOMP_REGISTRATION base 0x8071185C func_8071185C preserves=false fpr_mask=0x80000000
