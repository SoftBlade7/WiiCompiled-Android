...
extern "C" void func_80134ACC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80134B1C:
{
    MemoryInline::FlatWriteRam8((r31 + 14), static_cast<uint8_t>(r28));
    if (((cr & 0x20000000u) != 0)) {
        goto loc_80134B38;
    }
}
...
// RECOMP_GUEST_ABI gpr_read=0xF80023FB gpr_write=0xF8000BFB gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x80134ACC func_80134ACC preserves=true fpr_mask=0x00000000
