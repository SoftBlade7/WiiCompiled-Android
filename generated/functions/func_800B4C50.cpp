...
extern "C" void func_800B4C50(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr1_0 = 0;
...
loc_800B4C50:
{
    ...
    r31 = r1;
    MemoryInline::FlatWriteRam32((r31 + 104), r4);
    r29 = r3;
    if (((cr & 0x02000000u) == 0)) {
        goto loc_800B4C94;
    }
...
loc_800B4CA8:
{
    guest_range_4 = MemoryInline::ResolveRangeHost((r31 + 8), 0, 112u, false, true);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_4, 100u, ((static_cast<uint64_t>(static_cast<uint32_t>(r12)) << 32) | static_cast<uint32_t>(r11)))) {
        MemoryInline::WriteResolved32(guest_range_4, 100u, (r31 + 108), r12);
        MemoryInline::WriteResolved32(guest_range_4, 104u, (r31 + 112), r11);
    }
    MemoryInline::WriteResolved32(guest_range_4, 108u, (r31 + 116), r0);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_800B4CDC;
    }
}
...
loc_800B4D18:
{
    ...
    MemoryInline::FlatWriteRam32((r31 + 220), r16);
    r16 = MemoryInline::ReadResolved8(guest_range_1, 26u, (r29 + 26));
    MemoryInline::FlatWriteRam32((r31 + 224), r16);
    r16 = MemoryInline::ReadResolved8(guest_range_1, 27u, (r29 + 27));
    MemoryInline::FlatWriteRam8((r31 + 141), static_cast<uint8_t>(r0));
    r0 = MemoryInline::FlatRead32((r31 + 300));
    MemoryInline::FlatWriteRam32((r31 + 228), r16);
    r16 = MemoryInline::ReadResolved8(guest_range_1, 28u, (r29 + 28));
    MemoryInline::FlatWriteRam8((r31 + 144), static_cast<uint8_t>(r0));
    r0 = MemoryInline::FlatRead32((r31 + 220));
    MemoryInline::FlatWriteRam32((r31 + 232), r16);
    r16 = MemoryInline::ReadResolved8(guest_range_1, 29u, (r29 + 29));
    MemoryInline::FlatWriteRam8((r31 + 145), static_cast<uint8_t>(r0));
    ...
    MemoryInline::FlatWriteRam8((r31 + 146), static_cast<uint8_t>(r0));
    ...
    MemoryInline::FlatWriteRam8((r31 + 147), static_cast<uint8_t>(r0));
    ...
    MemoryInline::FlatWriteRam8((r31 + 148), static_cast<uint8_t>(r0));
    ...
    MemoryInline::FlatWriteRam8((r31 + 149), static_cast<uint8_t>(r0));
    ...
    MemoryInline::FlatWriteRam8((r31 + 150), static_cast<uint8_t>(r0));
    ...
    MemoryInline::FlatWriteRam8((r31 + 151), static_cast<uint8_t>(r0));
    ...
    MemoryInline::FlatWriteRam32((r31 + 156), r0);
    ...
    MemoryInline::FlatWriteRam32((r31 + 160), r0);
    ...
    MemoryInline::FlatWriteRam32((r31 + 164), r0);
    ...
    MemoryInline::FlatWriteRam8((r31 + 184), static_cast<uint8_t>(r0));
    r0 = MemoryInline::FlatRead32((r31 + 284));
    MemoryInline::FlatWriteRam8((r31 + 185), static_cast<uint8_t>(r0));
    ...
    MemoryInline::FlatWriteRam8((r31 + 186), static_cast<uint8_t>(r0));
    r0 = MemoryInline::FlatRead32((r31 + 292));
    MemoryInline::FlatWriteRam8((r31 + 187), static_cast<uint8_t>(r0));
    r0 = r16;
    MemoryInline::FlatWriteRam32((r31 + 296), r16);
    MemoryInline::FlatWriteRam8((r31 + 120), static_cast<uint8_t>(r17));
    MemoryInline::FlatWriteRam8((r31 + 121), static_cast<uint8_t>(r18));
    MemoryInline::FlatWriteRam8((r31 + 122), static_cast<uint8_t>(r19));
    MemoryInline::FlatWriteRam8((r31 + 123), static_cast<uint8_t>(r20));
    MemoryInline::FlatWriteRam8((r31 + 124), static_cast<uint8_t>(r21));
    MemoryInline::FlatWriteRam8((r31 + 125), static_cast<uint8_t>(r22));
    MemoryInline::FlatWriteRam8((r31 + 126), static_cast<uint8_t>(r23));
    MemoryInline::FlatWriteRam8((r31 + 127), static_cast<uint8_t>(r24));
    MemoryInline::FlatWriteRam8((r31 + 128), static_cast<uint8_t>(r25));
    MemoryInline::FlatWriteRam8((r31 + 129), static_cast<uint8_t>(r26));
    MemoryInline::FlatWriteRam8((r31 + 130), static_cast<uint8_t>(r27));
    MemoryInline::FlatWriteRam8((r31 + 131), static_cast<uint8_t>(r28));
    MemoryInline::FlatWriteRam8((r31 + 132), static_cast<uint8_t>(r12));
    MemoryInline::FlatWriteRam8((r31 + 133), static_cast<uint8_t>(r11));
    MemoryInline::FlatWriteRam8((r31 + 134), static_cast<uint8_t>(r10));
    MemoryInline::FlatWriteRam8((r31 + 135), static_cast<uint8_t>(r9));
    MemoryInline::FlatWriteRam8((r31 + 136), static_cast<uint8_t>(r8));
    MemoryInline::FlatWriteRam8((r31 + 137), static_cast<uint8_t>(r7));
    MemoryInline::FlatWriteRam8((r31 + 138), static_cast<uint8_t>(r6));
    MemoryInline::FlatWriteRam8((r31 + 139), static_cast<uint8_t>(r5));
    MemoryInline::FlatWriteRam8((r31 + 140), static_cast<uint8_t>(r4));
    MemoryInline::FlatWriteRam8((r31 + 142), static_cast<uint8_t>(r15));
    MemoryInline::FlatWriteRam8((r31 + 143), static_cast<uint8_t>(r14));
    MemoryInline::FlatWriteRamFloat32((r31 + 188), f3.d);
    MemoryInline::FlatWriteRam32((r31 + 192), r0);
    MemoryInline::FlatWriteRamFloat32((r31 + 196), f2.d);
    MemoryInline::FlatWriteRamFloat32((r31 + 200), f1.d);
    MemoryInline::FlatWriteRamFloat32((r31 + 204), f0.d);
    ...
    MemoryInline::FlatWriteRam32((r31 + 208), r8);
    MemoryInline::FlatWriteRam32((r31 + 212), r7);
    MemoryInline::FlatWriteRam32((r31 + 216), r0);
    ctx->lr = 0x800B4F74u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x800B4C50 func_800B4C50 preserves=true fpr_mask=0x00000000
