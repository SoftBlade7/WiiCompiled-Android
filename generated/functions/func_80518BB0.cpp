...
extern "C" void func_80518BB0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80518BB0:
{
    ...
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r0), static_cast<uint32_t>(2320));
}
...
// RECOMP_REGISTRATION base 0x80518BB0 func_80518BB0 preserves=true fpr_mask=0x00000000
