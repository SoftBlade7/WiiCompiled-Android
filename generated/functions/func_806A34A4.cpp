...
extern "C" void func_806A34A4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806A3538:
{
    r3 = MemoryInline::FlatRead32((r29 + 1556));
    r31 = 11;
    r30 = (r3 + 44);
}
...
// RECOMP_REGISTRATION base 0x806A34A4 func_806A34A4 preserves=true fpr_mask=0x00000000
