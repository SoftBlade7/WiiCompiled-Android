...
extern "C" void func_801065C8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801065C8:
{
    ...
    r30 = ctx->gpr[30];
    r31 = ctx->gpr[31];
    MemoryInline::FlatWrite32((r30 + 56), r31);
    r3 = r30;
    ctx->lr = 0x80106628u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x801065C8 func_801065C8 preserves=true fpr_mask=0x00000000
