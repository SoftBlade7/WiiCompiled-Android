...
extern "C" void func_80058F20(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80058FB8:
{
    ...
    r3_addr_5 = (r3 + r4);
    MemoryInline::FlatWrite16(r3_addr_5, static_cast<uint16_t>(r31));
}
...
// RECOMP_REGISTRATION base 0x80058F20 func_80058F20 preserves=true fpr_mask=0x00000000
