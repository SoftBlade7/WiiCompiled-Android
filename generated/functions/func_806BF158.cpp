...
extern "C" void func_806BF158(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806BF158:
{
    ...
    r30_addr_0 = (r30 + r5);
    r5 = MemoryInline::FlatRead32(r30_addr_0);
    r4 = (r4 + 48);
    r5 = (r5 + 48);
...
loc_806BF184:
{
    ...
    r5 = (r1 + 44);
    r30_addr_1 = (r30 + r0);
    r4 = MemoryInline::FlatRead32(r30_addr_1);
    r4 = (r4 + 48);
    // inline leaf 0x8051486C (13 guest instruction(s))
    f1.d = MemoryInline::FlatReadFloat32((r4 + 8));
    f0.d = MemoryInline::FlatReadFloat32((r5 + 8));
...
loc_806BF280:
{
    ...
    r4_addr_4 = (r4 + r28);
    r5 = MemoryInline::FlatRead32(r4_addr_4);
    r4 = (r6 + 48);
    r5 = (r5 + 48);
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x806BF158 func_806BF158 preserves=false fpr_mask=0x80000000
