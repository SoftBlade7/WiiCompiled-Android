...
extern "C" void func_80520730(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80520730:
{
    ...
    MemoryInline::FlatWrite16((r3 + 8), static_cast<uint16_t>(r30));
    MemoryInline::FlatWrite16((r3 + 10), static_cast<uint16_t>(r30));
    ...
    MemoryInline::FlatWrite8((r3 + 22), static_cast<uint8_t>(r30));
    MemoryInline::FlatWrite8((r3 + 23), static_cast<uint8_t>(r30));
    MemoryInline::FlatWrite8((r3 + 24), static_cast<uint8_t>(r8));
    MemoryInline::FlatWrite32((r3 + 28), r7);
    MemoryInline::FlatWrite16((r3 + 32), static_cast<uint16_t>(r30));
    ...
    MemoryInline::FlatWrite8((r3 + 80), static_cast<uint8_t>(r30));
    MemoryInline::FlatWrite32((r3 + 84), r9);
    MemoryInline::FlatWrite8((r3 + 88), static_cast<uint8_t>(r30));
    MemoryInline::FlatWrite32((r3 + 92), r7);
    MemoryInline::FlatWrite16((r3 + 96), static_cast<uint16_t>(r30));
    MemoryInline::FlatWrite16((r3 + 98), static_cast<uint16_t>(r30));
...
// RECOMP_REGISTRATION base 0x80520730 func_80520730 preserves=true fpr_mask=0x00000000
