...
extern "C" void func_807E780C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807E780C:
{
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x808442B8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r5 = r30;
    r6 = r27;
    // inline leaf 0x808444A0 (1 guest instruction(s))
    // end of inlined leaf 0x808444A0
    r28 = (r28 + 396);
    r0 = -1;
}
...
{
    r30 = 0x808B0000u;
    f29.d = MemoryInline::FlatReadFloat64((r29 + 320));
    f30.d = MemoryInline::FlatReadFloat32((r29 + 312));
    r30 = (r30 + -30048);
    f31.d = MemoryInline::FlatReadFloat32((r29 + 328));
    r31 = (r0 ^ -2147483648);
    r27 = 0;
}
...
loc_807E7910:
{
    ...
    r3 = (r27 ^ -2147483648);
    r0 = (r27 + 1);
    f3.d = MemoryInline::FlatReadFloat32((r29 + 220));
    f0.d = MemoryInline::FlatReadFloat64((r1 + 8));
    r0 = (r0 ^ -2147483648);
    MemoryInline::FlatWriteRam32((r1 + 20), r3);
    r3 = r28;
    f1.d = static_cast<double>(PpcForceSingleValueInline(f0.d - f29.d));
    f4.d = MemoryInline::FlatReadFloat32((r29 + 316));
...
loc_807E7988:
{
    ...
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 28), 0, 76u, true, false);
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 52u, (r1 + 80));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f30.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 36u, (r1 + 64));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r11 = (r1 + 48);
    f29.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 20u, (r1 + 48));
    ...
    r0 = MemoryInline::ReadResolved32(guest_range_1, 72u, (r1 + 100));
    ctx->lr = r0;
    r1 = (r1 + 96);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x807E780C func_807E780C preserves=false fpr_mask=0xE0000000
