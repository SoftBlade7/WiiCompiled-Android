...
extern "C" void func_806A66A4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806A66E8:
{
    r0 = MemoryInline::FlatRead8((r3 + 1975));
...
loc_806A6714:
{
    r4 = MemoryInline::FlatRead32((r31 + 1756));
    r3 = (r1 + 8);
    r0 = MemoryInline::FlatRead32((r31 + 1760));
    MemoryInline::FlatWriteRam32((r1 + 12), r0);
    MemoryInline::FlatWriteRam32((r1 + 8), r4);
    r0 = MemoryInline::FlatRead32((r31 + 1764));
    ...
    r3 = MemoryInline::FlatRead32((r31 + 656));
...
loc_806A67A8:
{
    ...
    r3 = 0;
    MemoryInline::FlatWrite8((r31 + 1975), static_cast<uint8_t>(r3));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
// RECOMP_REGISTRATION base 0x806A66A4 func_806A66A4 preserves=true fpr_mask=0x00000000
