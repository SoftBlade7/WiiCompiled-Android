...
extern "C" void func_801F5EB8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801F5EB8:
{
    ...
    ctx->gpr[6] = r6;
    ctx->xer = xer;
    InvokeDirectCpu<0x801F5474u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x801F5EB8 func_801F5EB8 preserves=true fpr_mask=0x00000000
