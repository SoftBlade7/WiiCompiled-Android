...
extern "C" void func_806AA784(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806AA7E0:
{
    r30 = MemoryInline::FlatRead32((r3 + 564));
...
loc_806AA824:
{
    ...
    f3 = ctx->fpr[3];
    f4 = ctx->fpr[4];
    guest_range_0 = MemoryInline::ResolveRangeHost((r31 + 564), 0, 1264u, true, false);
    r6 = MemoryInline::ReadResolved32(guest_range_0, 1216u, (r31 + 1780));
    r3 = (r1 + 8);
    r0 = MemoryInline::ReadResolved32(guest_range_0, 1220u, (r31 + 1784));
    r4 = (r31 + 1744);
    ...
    MemoryInline::FlatWriteRam32((r1 + 48), r6);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_0, 1224u, (r31 + 1788));
            r0 = MemoryInline::ReadResolved32(guest_range_0, 1228u, (r31 + 1792));
        }
    }
    ...
    MemoryInline::FlatWriteRam32((r1 + 56), r6);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_0, 1232u, (r31 + 1796));
            r0 = MemoryInline::ReadResolved32(guest_range_0, 1236u, (r31 + 1800));
        }
    }
    ...
    MemoryInline::FlatWriteRam32((r1 + 64), r6);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_0, 1240u, (r31 + 1804));
            r0 = MemoryInline::ReadResolved32(guest_range_0, 1244u, (r31 + 1808));
        }
    }
    ...
    MemoryInline::FlatWriteRam32((r1 + 72), r6);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_0, 1248u, (r31 + 1812));
            r0 = MemoryInline::ReadResolved32(guest_range_0, 1252u, (r31 + 1816));
        }
    }
    MemoryInline::FlatWriteRam32((r1 + 84), r0);
    MemoryInline::FlatWriteRam32((r1 + 80), r6);
    {
        const auto resolved_pair = MemoryInline::ReadResolvedPair32(guest_range_0, 1256u);
        if (resolved_pair.valid) {
            r6 = resolved_pair.first;
            r0 = resolved_pair.second;
        } else {
            r6 = MemoryInline::ReadResolved32(guest_range_0, 1256u, (r31 + 1820));
            r0 = MemoryInline::ReadResolved32(guest_range_0, 1260u, (r31 + 1824));
        }
    }
    ...
    r30 = MemoryInline::ReadResolved32(guest_range_0, 0u, (r31 + 564));
}
...
// RECOMP_REGISTRATION base 0x806AA784 func_806AA784 preserves=true fpr_mask=0x00000000
