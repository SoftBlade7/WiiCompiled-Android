...
extern "C" void func_8017FFC4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8017FFC4:
{
    ...
    r1_psq_tmp_0 = (r1 + 8);
    PPC_PsqStStackInline<1u, 5u>(ctx, r1_psq_tmp_0, PPC_PsFromScalarInline(f0.d));
    r6 = -1024;
...
loc_8017FF60:
{
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8017FF60u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8017FFC4 func_8017FFC4 preserves=false fpr_mask=0xE0000000
