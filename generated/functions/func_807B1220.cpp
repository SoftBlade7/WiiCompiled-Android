...
extern "C" void func_807B1220(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807B1220:
{
    r5 = 0x808A0000u;
    r0 = 0;
    f0.d = MemoryInline::FlatReadFloat32((r5 + 24048));
    MemoryInline::FlatWrite8((r3 + 436), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x807B1220 func_807B1220 preserves=true fpr_mask=0x00000000
