...
extern "C" void func_80123BBC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80123C34:
{
    ...
    r4 = (r13 + -29780);
    r29 = MemoryInline::FlatRead32((r28 + 12));
    r5 = (r13 + -29736);
    r3 = MemoryInline::FlatRead32((r27 + 24));
    ctx->lr = 0x80123C60u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x80123BBC func_80123BBC preserves=true fpr_mask=0x00000000
