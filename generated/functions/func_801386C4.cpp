...
extern "C" void func_801386C4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
    uint32_t r3_rot_1 = 0;
...
loc_801386C4:
{
    ...
    r28 = r3;
    r3 = (r31 + 1452);
    r30 = MemoryInline::FlatRead32((r31 + 1476));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
loc_80138704:
{
    MemoryInline::FlatWriteRam32((r31 + 1476), r3);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_801387A8;
    }
}
...
loc_8013871C:
{
    ...
    r3 = MemoryInline::FlatRead8((r28 + 4));
...
// RECOMP_REGISTRATION base 0x801386C4 func_801386C4 preserves=true fpr_mask=0x00000000
