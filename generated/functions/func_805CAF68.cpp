...
extern "C" void func_805CAF68(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805CAF68:
{
    ...
    r5 = 0x80890000u;
    r4 = 1;
    f1.d = MemoryInline::FlatReadFloat32((r5 + 14836));
    ctx->lr = 0x805CAF90u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x805CAF68 func_805CAF68 preserves=true fpr_mask=0x00000000
