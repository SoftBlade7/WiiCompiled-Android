...
extern "C" void func_805BDF88(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805BDF88:
{
    ...
    f2.d = MemoryInline::FlatReadFloat64((r3 + 11824));
...
// RECOMP_REGISTRATION base 0x805BDF88 func_805BDF88 preserves=true fpr_mask=0x00000000
