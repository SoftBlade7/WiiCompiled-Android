...
extern "C" void func_805FAA84(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805FAAB0:
{
    ...
    if (MkwStateFreeAbiEnabled(0x80631588u) && KnownTranslatedCpuCall<0x80631588u>::kAvailable && !KnownTranslatedCpuCall<0x80631588u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80631588u>()) {
        const auto state_free_result_80631588_11F5 = func_80631588_statefree(r3, cr, xer);
        r3 = static_cast<uint32_t>(state_free_result_80631588_11F5[0]);
        cr = static_cast<uint32_t>(state_free_result_80631588_11F5[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_805FAACC:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80782498u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_805FAB0C:
{
    ...
    r26_addr_2 = (r26 + r29);
    r5 = MemoryInline::FlatRead16(r26_addr_2);
    r25 = (r3 + -2147483648);
    r3 = r25;
    r4 = 0;
    ...
    r0 = MemoryInline::FlatRead32((r22 + 8));
    r3 = (r23 + r0);
    MemoryInline::FlatWrite8((r3 + 32), static_cast<uint8_t>(r27));
}
...
{
    r29 = (r29 + 16);
    if ((static_cast<int32_t>(r21) < static_cast<int32_t>(7))) {
        goto loc_805FAAFC;
    }
}
...
// RECOMP_REGISTRATION base 0x805FAA84 func_805FAA84 preserves=true fpr_mask=0x00000000
