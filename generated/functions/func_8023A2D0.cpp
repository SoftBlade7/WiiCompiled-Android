...
extern "C" void func_8023A2D0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8023A2D0:
{
    ...
    f10.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 8u, (r4 + 8));
    ...
    f11.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 12u, (r4 + 12));
    ...
    f7.d = MemoryInline::FlatReadFloat32((r1 + 36));
    ...
    f11.d = MemoryInline::FlatReadFloat32((r1 + 32));
...
// RECOMP_GUEST_ABI gpr_read=0x8000003A gpr_write=0x80000073 gpr_return=0x00000010 fpr_read=0xC0000000 fpr_write=0xC0003FFF fpr_return=0x00000002 cr_read=0x00 cr_write=0x00 xer_read=0 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8023A2D0 func_8023A2D0 preserves=true fpr_mask=0x00000000
