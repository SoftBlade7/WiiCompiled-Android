...
extern "C" void func_80794B78(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80794B78:
{
    ...
    r5 = 20;
    r4 = 4;
    guest_range_0 = MemoryInline::ResolveRangeHost((r3 + 20), 0, 68u, false, true);
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 0u, ((static_cast<uint64_t>(static_cast<uint32_t>(r6)) << 32) | static_cast<uint32_t>(r5)))) {
        MemoryInline::WriteResolved32(guest_range_0, 0u, (r3 + 20), r6);
        MemoryInline::WriteResolved32(guest_range_0, 4u, (r3 + 24), r5);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 8u, ((static_cast<uint64_t>(static_cast<uint32_t>(r4)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_0, 8u, (r3 + 28), r4);
        MemoryInline::WriteResolved32(guest_range_0, 12u, (r3 + 32), r0);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 16u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_0, 16u, (r3 + 36), r0);
        MemoryInline::WriteResolved32(guest_range_0, 20u, (r3 + 40), r0);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 60u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_0, 60u, (r3 + 80), r0);
        MemoryInline::WriteResolved32(guest_range_0, 64u, (r3 + 84), r0);
    }
    ctx->gpr[0] = r0;
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
...
// RECOMP_REGISTRATION base 0x80794B78 func_80794B78 preserves=true fpr_mask=0x00000000
