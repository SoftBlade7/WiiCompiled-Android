...
extern "C" void func_80812E48(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80812E7C:
{
    ...
    r4 = MemoryInline::FlatRead32((r3 + 324));
}

loc_80812EA0:
{
    r5 = (r4 + 1);
    MemoryInline::FlatWrite32((r3 + 324), r5);
...
loc_80812ED8:
{
    r4 = 1;
    r0 = 0;
    MemoryInline::FlatWrite32((r3 + 320), r4);
    r4 = 0;
    r5 = MemoryInline::FlatRead32((r3 + 8));
    MemoryInline::FlatWrite32((r3 + 324), r0);
    ...
    r4 = 0x808D0000u;
    f31.d = MemoryInline::FlatReadFloat32((r4 + 24960));
    r4 = 1;
...
loc_80812F30:
{
    r4 = MemoryInline::FlatRead32((r3 + 300));
...
loc_80812FA0:
{
    r0_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(29));
...
loc_80812FC0:
{
    r0_subfic_ra_1 = r0;
    r0 = (4 - r0_subfic_ra_1);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(4) >= static_cast<uint32_t>(r0_subfic_ra_1) ? 1u : 0u) << 29);
}
...
loc_80812FC4:
{
    ...
    r4 = 0x808D0000u;
    r3 = (r1 + 68);
    f1.d = MemoryInline::FlatReadFloat32((r4 + 24952));
    r4 = (r1 + 80);
    // inline leaf 0x80514810 (10 guest instruction(s))
    f3.d = MemoryInline::FlatReadFloat32((r4 + 8));
    f2.d = MemoryInline::FlatReadFloat32((r4 + 4));
...
loc_80813038:
{
    ...
    MemoryInline::FlatWrite8((r3 + 393), static_cast<uint8_t>(r0));
    goto loc_808131B0;
}
...
// RECOMP_REGISTRATION base 0x80812E48 func_80812E48 preserves=false fpr_mask=0x80000000
