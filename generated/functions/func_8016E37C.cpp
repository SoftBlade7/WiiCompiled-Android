...
extern "C" void func_8016E37C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8016E380:
{
    ...
    r12 = 0;
    r10 = 5;
    if ((static_cast<uint32_t>(r5) > static_cast<uint32_t>(20))) {
        goto loc_8016E424;
    }
}
...
loc_8016E390:
{
    ...
    r9 = (r9 + -24080);
    r9_addr_1 = (r9 + r0);
    r9 = MemoryInline::FlatRead32(r9_addr_1);
    ctr = r9;
...
loc_8016E518:
{
    ...
    r0_rot_3 = PpcRotl32Inline(static_cast<uint32_t>(r6), static_cast<uint32_t>(6));
    r0_mrot_0 = (r0_rot_3 & 4032);
    r0_mdest_0 = (r0 & -4033);
...
{
    r0 = MemoryInline::FlatRead32((r10 + 128));
    r0_rot_4 = PpcRotl32Inline(static_cast<uint32_t>(r6), static_cast<uint32_t>(12));
    r0_mrot_1 = (r0_rot_4 & 258048);
...
{
    r0 = MemoryInline::FlatRead32((r10 + 128));
    r0_rot_5 = PpcRotl32Inline(static_cast<uint32_t>(r6), static_cast<uint32_t>(18));
    r0_mrot_2 = (r0_rot_5 & 16515072);
...
{
    r0 = MemoryInline::FlatRead32((r10 + 128));
    r0_rot_6 = PpcRotl32Inline(static_cast<uint32_t>(r6), static_cast<uint32_t>(24));
    r0_mrot_3 = (r0_rot_6 & 1056964608);
...
{
    r0 = MemoryInline::FlatRead32((r10 + 132));
    r0_rot_7 = PpcRotl32Inline(static_cast<uint32_t>(r6), static_cast<uint32_t>(6));
    r0_mrot_5 = (r0_rot_7 & 4032);
    r0_mdest_5 = (r0 & -4033);
...
{
    r0 = MemoryInline::FlatRead32((r10 + 132));
    r0_rot_8 = PpcRotl32Inline(static_cast<uint32_t>(r6), static_cast<uint32_t>(12));
    r0_mrot_6 = (r0_rot_8 & 258048);
...
// RECOMP_GUEST_ABI gpr_read=0x00001FFD gpr_write=0x00001F39 gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8016E37C func_8016E37C preserves=true fpr_mask=0x00000000
