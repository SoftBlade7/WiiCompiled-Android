...
extern "C" void func_80764054(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80764084:
{
    ...
    MemoryInline::FlatWrite8((r31 + 257), static_cast<uint8_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x80764054 func_80764054 preserves=true fpr_mask=0x00000000
