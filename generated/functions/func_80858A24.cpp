...
extern "C" void func_80858A24(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80858A24:
{
    r3 = 0x809C0000u;
    r0 = 0;
    MemoryInline::FlatWriteRam32((r3 + 18048), r0);
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80858A24 func_80858A24 preserves=true fpr_mask=0x00000000
