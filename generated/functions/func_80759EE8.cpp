...
extern "C" void func_80759EE8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80759EE8:
{
    ...
    MemoryInline::WriteResolvedFloat64(guest_range_0, 208u, (r1 + 208), f30.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_1 = (r1 + 216);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_1, PPC_PsFromScalarInline(f30.d));
    MemoryInline::WriteResolvedFloat64(guest_range_0, 192u, (r1 + 192), f29.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_2 = (r1 + 200);
...
loc_80759FA4:
{
    ...
    r0 = 1;
    MemoryInline::FlatWrite8((r30 + 240), static_cast<uint8_t>(r29));
...
loc_8075A348:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(71));
}
...
loc_8075A368:
{
    ...
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 172), 0, 76u, true, false);
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 52u, (r1 + 224));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f30.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 36u, (r1 + 208));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r11 = (r1 + 192);
    f29.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 20u, (r1 + 192));
    ...
    r0 = MemoryInline::ReadResolved32(guest_range_1, 72u, (r1 + 244));
    ctx->lr = r0;
    r1 = (r1 + 240);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x80759EE8 func_80759EE8 preserves=false fpr_mask=0xE0000000
