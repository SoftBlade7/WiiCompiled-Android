...
extern "C" void func_8063E674(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8063E674:
{
    ...
    r0 = 0;
    guest_range_3 = MemoryInline::ResolveRangeHost((r3 + -324), 0, 372u, false, true);
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 324u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_3, 324u, r3, r0);
        MemoryInline::WriteResolved32(guest_range_3, 328u, (r3 + 4), r0);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 332u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_3, 332u, (r3 + 8), r0);
        MemoryInline::WriteResolved32(guest_range_3, 336u, (r3 + 12), r0);
    }
    MemoryInline::WriteResolved32(guest_range_3, 340u, (r3 + 16), r0);
    // end of inlined leaf 0x805F8B34
    r3 = (r29 + 344);
    // inline leaf 0x805F8B34 (7 guest instruction(s))
    r0 = 0;
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 344u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_3, 344u, r3, r0);
        MemoryInline::WriteResolved32(guest_range_3, 348u, (r3 + 4), r0);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 352u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_3, 352u, (r3 + 8), r0);
        MemoryInline::WriteResolved32(guest_range_3, 356u, (r3 + 12), r0);
    }
    MemoryInline::WriteResolved32(guest_range_3, 360u, (r3 + 16), r0);
    // end of inlined leaf 0x805F8B34
    r4 = 0x808C0000u;
    MemoryInline::WriteResolved32(guest_range_3, 364u, (r29 + 364), r31);
    r4 = (r4 + -4232);
    r3 = r29;
    MemoryInline::WriteResolved32(guest_range_3, 368u, (r29 + 368), r31);
    MemoryInline::WriteResolved32(guest_range_3, 0u, r29, r4);
...
// RECOMP_REGISTRATION base 0x8063E674 func_8063E674 preserves=true fpr_mask=0x00000000
