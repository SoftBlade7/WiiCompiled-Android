...
extern "C" void func_805F058C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805F058C:
{
    ...
    r4 = -1;
    r0 = 1;
    guest_range_0 = MemoryInline::ResolveRangeHost(r3, 0, 37u, false, true);
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 0u, ((static_cast<uint64_t>(static_cast<uint32_t>(r5)) << 32) | PpcBitCastToU32Inline(static_cast<float>(f0.d))))) {
    ...
    MemoryInline::WriteResolved8(guest_range_0, 36u, (r3 + 36), static_cast<uint8_t>(r0));
    ctx->gpr[0] = r0;
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
    ctx->fpr[0] = f0;
...
// RECOMP_REGISTRATION base 0x805F058C func_805F058C preserves=true fpr_mask=0x00000000
