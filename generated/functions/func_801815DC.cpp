...
extern "C" void func_801815DC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801815DC:
{
    ...
    MemoryInline::WriteResolved32(guest_range_1, 16u, (r3 + 16), r29);
    r7 = (r3 + 16);
    r6 = (r6 + -17184);
    r24 = r4;
    MemoryInline::WriteResolved32(guest_range_1, 20u, (r3 + 20), r29);
    r25 = r5;
    r23 = r3;
    r5 = 16;
    MemoryInline::WriteResolved32(guest_range_1, 0u, r3, r6);
    r4 = (r4 + 8);
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 4u, ((static_cast<uint64_t>(static_cast<uint32_t>(r29)) << 32) | static_cast<uint32_t>(r29)))) {
        MemoryInline::WriteResolved32(guest_range_1, 4u, (r3 + 4), r29);
        MemoryInline::WriteResolved32(guest_range_1, 8u, (r3 + 8), r29);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 12u, ((static_cast<uint64_t>(static_cast<uint32_t>(r29)) << 32) | static_cast<uint32_t>(r7)))) {
        MemoryInline::WriteResolved32(guest_range_1, 12u, (r3 + 12), r29);
        MemoryInline::WriteResolved32(guest_range_1, 16u, (r3 + 16), r7);
    }
    MemoryInline::WriteResolved32(guest_range_1, 20u, (r3 + 20), r7);
    MemoryInline::WriteResolved8(guest_range_1, 40u, (r3 + 40), static_cast<uint8_t>(r29));
    r3 = (r3 + 24);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_8018167C:
{
    r3 = MemoryInline::FlatRead32((r31 + 18848));
    r4 = 12;
    ctx->lr = 0x80181688u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x801815DC func_801815DC preserves=true fpr_mask=0x00000000
