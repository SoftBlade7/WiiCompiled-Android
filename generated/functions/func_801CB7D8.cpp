...
extern "C" void func_801CB7D8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_801CB7D8:
{
    ...
    r25 = r3;
    r8_addr_0 = (r8 + r0);
    r30 = MemoryInline::FlatRead32(r8_addr_0);
    r26 = r4;
    r27 = r5;
    r28 = r6;
    r29 = r7;
...
loc_801CB84C:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x801CB8BCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x801CB7D8 func_801CB7D8 preserves=true fpr_mask=0x00000000
