...
extern "C" void func_805249B0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805249B0:
{
    ...
    ctx->gpr[3] = r3;
    ctx->gpr[6] = r6;
    InvokeDirectCpu<0x80521ED0u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r6 = ctx->gpr[6];
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x805249B0 func_805249B0 preserves=true fpr_mask=0x00000000
