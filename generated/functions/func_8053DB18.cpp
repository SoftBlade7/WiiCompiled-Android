...
extern "C" void func_8053DB18(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r3_rot_0 = 0;
...
loc_8053DB18:
{
    ...
    r0 = MemoryInline::FlatRead16((r3 + 3046));
    r0 = (r0 - r4);
...
// RECOMP_REGISTRATION base 0x8053DB18 func_8053DB18 preserves=true fpr_mask=0x00000000
