...
extern "C" void func_806ABD3C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806ABE24:
{
    ...
    xer = ctx->xer;
    mkw_gqr0 = ctx->gqr[0];
    r29 = MemoryInline::FlatRead32((r31 + 348));
...
// RECOMP_REGISTRATION base 0x806ABD3C func_806ABD3C preserves=true fpr_mask=0x00000000
