...
extern "C" void func_8054797C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_8054797C:
{
    ...
    r3 = (r3 + r4);
    r3 = (r3 + r0);
    MemoryInline::FlatWrite16((r3 + 294), static_cast<uint16_t>(r5));
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->gpr[7] = r7;
...
// RECOMP_REGISTRATION base 0x8054797C func_8054797C preserves=true fpr_mask=0x00000000
