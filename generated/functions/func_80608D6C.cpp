...
extern "C" void func_80608D6C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80608D6C:
{
    ...
    r4 = 1127219200;
    r31 = 0x80890000u;
    MemoryInline::WriteResolved32(guest_range_2, 24u, (r1 + 24), r4);
...
loc_80608DF8:
{
    ...
    r23 = MemoryInline::FlatRead32((r3 + 316));
...
{
    r0 = 0;
    MemoryInline::FlatWrite32((r23 + 392), r0);
    r3 = r27;
    r4 = 77;
    ...
    xer = ctx->xer;
    r0 = 7;
    MemoryInline::FlatWrite32((r27 + 68), r0);
}
...
loc_80608F14:
{
    r0 = MemoryInline::FlatRead32((r27 + 7408));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_80608F20:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80609CF8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
{
    r0 = 1;
    MemoryInline::FlatWrite8((r27 + 7360), static_cast<uint8_t>(r0));
    r3 = (r27 + 6424);
    ctx->lr = 0x80608F50u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80608F5C:
{
    r26 = MemoryInline::FlatRead32((r27 + 7184));
    r28 = MemoryInline::FlatRead32((r27 + 7180));
...
loc_80608F6C:
{
    r0 = (r28 * 440);
    r25 = 0x80890000u;
    f25.d = MemoryInline::FlatReadFloat64((r31 + 312));
    r24 = 0x809C0000u;
    f26.d = MemoryInline::FlatReadFloat32((r31 + 296));
    r25 = (r25 + 28400);
    r30 = (r27 + r0);
    f27.d = MemoryInline::FlatReadFloat32((r31 + 300));
    f28.d = MemoryInline::FlatReadFloat32((r31 + 292));
    r29 = (r30 + 772);
    f29.d = MemoryInline::FlatReadFloat32((r31 + 304));
    r26 = 1;
    f31.d = MemoryInline::FlatReadFloat64((r31 + 344));
    f30.d = MemoryInline::FlatReadFloat32((r31 + 340));
    goto loc_80609120;
}

loc_80608FA8:
{
    r0 = MemoryInline::FlatRead32((r27 + 396));
...
loc_80608FB4:
{
    r3 = MemoryInline::FlatRead32((r24 + -10424));
    r4 = (r1 + 10);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r5 = (r27 + 7200);
    r8 = MemoryInline::FlatRead16((r1 + 8));
    r3 = r29;
    r6 = r28;
    r4 = (r25 + 348);
    MemoryInline::FlatWrite32((r30 + 1196), r5);
    r7 = 2;
    MemoryInline::FlatWrite32((r30 + 1200), r28);
    r0 = MemoryInline::FlatRead16((r1 + 10));
    MemoryInline::FlatWrite16((r30 + 1204), static_cast<uint16_t>(r0));
    MemoryInline::FlatWrite16((r30 + 1206), static_cast<uint16_t>(r8));
    MemoryInline::FlatWrite32((r30 + 1208), r9);
    ctx->lr = 0x80609010u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r3 = r29;
    r6 = MemoryInline::FlatRead32((r30 + 1200));
    r4 = (r25 + 354);
    r7 = 2;
    ctx->lr = 0x80609028u;
    ctx->gpr[0] = r0;
...
loc_80609050:
{
    MemoryInline::FlatWrite32((r30 + 1168), r26);
    r0 = MemoryInline::FlatRead32((r30 + 1172));
    r0 = (r0 ^ -2147483648);
    ...
    MemoryInline::FlatWriteFloat32((r30 + 1184), f1.d);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->fpr[0] = f0;
    ...
    MemoryInline::FlatWriteFloat32((r30 + 1176), f0.d);
    f1.d = MemoryInline::FlatReadFloat32((r30 + 1184));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ...
    r3 = (r29 + 152);
    r4 = 4;
    MemoryInline::FlatWriteFloat32((r30 + 1180), f0.d);
...
loc_80609120:
{
    r0 = MemoryInline::FlatRead32((r27 + 7184));
}
...
{
    r0 = (r26 * 440);
    f30.d = MemoryInline::FlatReadFloat64((r31 + 344));
    f31.d = MemoryInline::FlatReadFloat32((r31 + 340));
    r28 = 0;
    r24 = (r27 + r0);
    r25 = (r24 + 772);
    goto loc_806091D0;
...
loc_80609150:
{
    MemoryInline::FlatWrite32((r24 + 1168), r28);
    r3 = (r25 + 152);
    r4 = 4;
    // inline leaf 0x8063C820 (4 guest instruction(s))
    r0 = (r4 * 68);
...
loc_806091D0:
{
    r0 = MemoryInline::FlatRead32((r27 + 7180));
}
...
loc_806091DC:
{
    r3 = MemoryInline::FlatRead32((r27 + 7184));
    r0 = MemoryInline::FlatRead32((r27 + 396));
    MemoryInline::FlatWrite32((r27 + 7180), r3);
...
loc_80609218:
{
    ...
    r0 = (r3 & 65535);
    MemoryInline::FlatWriteRam32((r1 + 36), r0);
    f2.d = MemoryInline::FlatReadFloat64((r31 + 344));
    r3 = r23;
    f0.d = MemoryInline::FlatReadFloat64((r1 + 32));
    r4 = 3;
    f1.d = MemoryInline::FlatReadFloat32((r23 + 60));
...
// RECOMP_REGISTRATION base 0x80608D6C func_80608D6C preserves=false fpr_mask=0xFE000000
