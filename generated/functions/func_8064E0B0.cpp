...
extern "C" void func_8064E0B0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8064E228:
{
    ...
    r30 = 0x808A0000u;
    r30 = (r30 + -25464);
    guest_range_0 = MemoryInline::ResolveRangeHost(r30, 0, 44u, true, false);
    r12 = MemoryInline::ReadResolved32(guest_range_0, 0u, r30);
    ...
    MemoryInline::WriteResolved32(guest_range_1, 0u, (r1 + 8), r12);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r11 = MemoryInline::ReadResolved32(guest_range_0, 4u, (r30 + 4));
            r10 = MemoryInline::ReadResolved32(guest_range_0, 8u, (r30 + 8));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r8 = MemoryInline::ReadResolved32(guest_range_0, 16u, (r30 + 16));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r7 = MemoryInline::ReadResolved32(guest_range_0, 20u, (r30 + 20));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r5 = MemoryInline::ReadResolved32(guest_range_0, 28u, (r30 + 28));
    ...
    r3 = MemoryInline::FlatRead32((r31 + 1684));
...
loc_8064E2BC:
{
    ...
    xer = ctx->xer;
    r0 = 1;
    MemoryInline::FlatWrite8((r31 + 1712), static_cast<uint8_t>(r0));
    r3 = (r31 + 1584);
    r4 = 0;
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x805BDBD4u) && KnownTranslatedCpuCall<0x805BDBD4u>::kAvailable && !KnownTranslatedCpuCall<0x805BDBD4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805BDBD4u>()) {
        const auto state_free_result_805BDBD4_4680 = func_805BDBD4_statefree(r3, r4);
        r3 = static_cast<uint32_t>(state_free_result_805BDBD4_4680);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8064E0B0 func_8064E0B0 preserves=true fpr_mask=0x00000000
