...
extern "C" void func_80724F70(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_inl1_cont_8055586C:
{
    ...
    if (MkwStateFreeAbiEnabled(0x80557340u) && KnownTranslatedCpuCall<0x80557340u>::kAvailable && !KnownTranslatedCpuCall<0x80557340u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80557340u>()) {
        const auto state_free_result_80557340_1871 = func_80557340_statefree(r3, r4);
        r0 = static_cast<uint32_t>(state_free_result_80557340_1871[0]);
        r3 = static_cast<uint32_t>(state_free_result_80557340_1871[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x80557340u) && KnownTranslatedCpuCall<0x80557340u>::kAvailable && !KnownTranslatedCpuCall<0x80557340u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80557340u>()) {
        const auto state_free_result_80557340_1FF6 = func_80557340_statefree(r3, r4);
        r0 = static_cast<uint32_t>(state_free_result_80557340_1FF6[0]);
        r3 = static_cast<uint32_t>(state_free_result_80557340_1FF6[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFEFEE gpr_write=0xFFFFFFFF gpr_return=0x00000018 fpr_read=0xFFFFFFFD fpr_write=0xFFFFFFFF fpr_return=0x00000002 cr_read=0xFE cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x80724F70 func_80724F70 preserves=true fpr_mask=0x00000000
