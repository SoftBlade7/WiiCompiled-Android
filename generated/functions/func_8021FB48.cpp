...
extern "C" void func_8021FB48(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8021FB48:
{
    ...
    MemoryInline::WriteResolvedFloat64(guest_range_2, 320u, (r1 + 320), f27.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_4 = (r1 + 328);
    ...
    r26 = MemoryInline::FlatRead32((r13 + -23936));
    r0 = 1127219200;
...
loc_8021FBBC:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead32((r24 + 124));
    r0 = 0;
...
loc_8021FBF8:
{
    ...
    r3 = 1;
    r25 = (r25 + 17696);
    r29 = MemoryInline::FlatRead8((r25 + 12));
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x801727CCu>(ctx);
    r0 = 1;
    MemoryInline::FlatWriteRam8((r25 + 12), static_cast<uint8_t>(r0));
    r28 = MemoryInline::FlatRead8((r25 + 13));
    r3 = 0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x801727F8u>(ctx);
    r23 = 0;
    MemoryInline::FlatWriteRam8((r25 + 13), static_cast<uint8_t>(r23));
    r27 = MemoryInline::FlatRead8((r25 + 14));
    r3 = 0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80172930u>(ctx);
    MemoryInline::FlatWriteRam8((r25 + 14), static_cast<uint8_t>(r23));
    r3 = r26;
    ctx->lr = 0x8021FC40u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8021FC5C:
{
    ...
    MemoryInline::FlatWriteRamFloat64((r1 + 248), f1.d);
    r12 = MemoryInline::FlatRead32((r3 + 36));
    fctiwzword1 = PPC_FprLowWordInline(f0.d);
    MemoryInline::FlatWriteRamFloat64((r1 + 256), f0.d);
    r0 = fctiwzword0;
    r5 = fctiwzword1;
    r4 = (r0 & 65535);
    r12 = MemoryInline::FlatRead32((r12 + 12));
    r4 = PPC_Divw(static_cast<int32_t>(r4), static_cast<int32_t>(r23));
    r0 = (r5 & 65535);
    r0 = PPC_Divw(static_cast<int32_t>(r0), static_cast<int32_t>(r23));
    r4 = (r4 & 65535);
    ...
    f4.d = MemoryInline::FlatReadFloat64((r2 + -25344));
    f0.d = MemoryInline::FlatReadFloat64((r1 + 232));
    MemoryInline::FlatWriteRam32((r1 + 244), r0);
    ...
    MemoryInline::FlatWriteRamFloat64((r1 + 264), f2.d);
    r23 = fctiwzword2;
    r0 = (r23 & 65535);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_8021FD70:
{
    MemoryInline::FlatWrite32((r24 + 132), r23);
    r3 = r23;
    r6 = 0;
    r7 = -1;
    ...
    MemoryInline::FlatWriteRamFloat64((r1 + 264), f0.d);
    r4 = fctiwzword4;
    r5 = fctiwzword5;
    r4 = (r4 & 65535);
    r5 = (r5 & 65535);
    ...
    r3 = r28;
    r23 = (r23 + 17696);
    MemoryInline::FlatWriteRam8((r23 + 14), static_cast<uint8_t>(r27));
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x801727F8u>(ctx);
    MemoryInline::FlatWriteRam8((r23 + 13), static_cast<uint8_t>(r28));
    r3 = r29;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x801727CCu>(ctx);
    MemoryInline::FlatWriteRam8((r23 + 12), static_cast<uint8_t>(r29));
    goto loc_8022010C;
}
...
loc_8021FDE8:
{
    ...
    r3 = 1;
    r25 = (r25 + 17696);
    r27 = MemoryInline::FlatRead8((r25 + 12));
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x801727CCu>(ctx);
    r23 = 1;
    MemoryInline::FlatWriteRam8((r25 + 12), static_cast<uint8_t>(r23));
    r28 = MemoryInline::FlatRead8((r25 + 13));
    r3 = 0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x801727F8u>(ctx);
    r0 = 0;
    MemoryInline::FlatWriteRam8((r25 + 13), static_cast<uint8_t>(r0));
    r29 = MemoryInline::FlatRead8((r25 + 14));
    r3 = 1;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80172930u>(ctx);
    ...
    r31 = ctx->gpr[31];
    f0 = ctx->fpr[0];
    r0 = MemoryInline::FlatRead16((r1 + 180));
    r3 = (r1 + 128);
    ...
    MemoryInline::FlatWriteRam16((r1 + 180), static_cast<uint16_t>(r0));
    ctx->lr = 0x8021FE78u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    f27.d = MemoryInline::FlatReadFloat64((r2 + -25368));
    r30 = (r1 + 24);
    f28.d = MemoryInline::FlatReadFloat32((r2 + -25384));
    r23 = (r23 ^ -2147483648);
    f31.d = MemoryInline::FlatReadFloat64((r2 + -25344));
    r31 = 0;
    f30.d = MemoryInline::FlatReadFloat32((r2 + -25424));
}
...
loc_8022006C:
{
    ...
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r3_psq_tmp_6 = (r3 + 8);
    PpcSetPairedFprInline(f5, PPC_PsqLStackInline<0u, 0u>(ctx, r3_psq_tmp_6));
    ...
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r3_psq_tmp_9 = (r3 + 16);
    PpcSetPairedFprInline(f6, PPC_PsqLStackInline<0u, 0u>(ctx, r3_psq_tmp_9));
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r4_psq_tmp_2 = (r4 + 8);
    ...
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r3_psq_tmp_10 = (r3 + 32);
    PpcSetPairedFprInline(f9, PPC_PsqLStackInline<0u, 0u>(ctx, r3_psq_tmp_10));
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r4_psq_tmp_3 = (r4 + 16);
    ...
    r0 = MemoryInline::FlatRead16((r24 + 24));
    r3_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(24));
    r3 = (r3_rot_2 & 1);
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8021FB48 func_8021FB48 preserves=false fpr_mask=0xF8000000
