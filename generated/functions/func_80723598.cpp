...
extern "C" void func_80723598(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80723598:
{
    ...
    xer = ctx->xer;
    r28 = 0;
    MemoryInline::FlatWrite32((r27 + 484), r28);
    r29 = 0x808A0000u;
    r30 = 0x808A0000u;
    MemoryInline::FlatWrite32((r27 + 488), r28);
    r4 = 1;
    r3 = MemoryInline::FlatRead32((r27 + 4));
    MemoryInline::FlatWrite32((r27 + 492), r28);
    f1.d = MemoryInline::FlatReadFloat32((r29 + 8440));
    MemoryInline::FlatWrite32((r27 + 496), r28);
    f2.d = MemoryInline::FlatReadFloat32((r30 + 8444));
    ...
    r3 = MemoryInline::FlatRead32((r27 + 4));
    r31 = 0x808D0000u;
    f1.d = MemoryInline::FlatReadFloat32((r31 + -27280));
    r4 = 0;
    r3 = MemoryInline::FlatRead32((r3 + 40));
...
loc_inl2_cont_8055586C:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r31 = MemoryInline::FlatRead32((r27 + 528));
    r3 = 0x808D0000u;
    f3.d = MemoryInline::FlatReadFloat32((r3 + -27272));
    r4 = 3;
...
loc_inl4_cont_8071EFA8:
{
    ...
    f3 = ctx->fpr[3];
    cr = ctx->cr;
    MemoryInline::FlatWrite8((r29 + 328), static_cast<uint8_t>(r28));
    r11 = (r1 + 48);
    {
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFF78E gpr_write=0xFFFFFFFF gpr_return=0x00000018 fpr_read=0xFFFFFFFF fpr_write=0xFFFFFFFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x80723598 func_80723598 preserves=true fpr_mask=0x00000000
