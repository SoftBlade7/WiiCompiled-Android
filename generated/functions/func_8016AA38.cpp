...
extern "C" void func_8016AA38(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8016AAD0:
{
    MemoryInline::FlatWrite32((r3 + 256), r27);
    r0 = 0;
    r4 = r25;
    r5 = (r30 + 1);
    MemoryInline::FlatWrite32((r3 + 260), r28);
...
// RECOMP_REGISTRATION base 0x8016AA38 func_8016AA38 preserves=true fpr_mask=0x00000000
