...
extern "C" void func_8074210C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807421B4:
{
    MemoryInline::FlatWrite32((r30 + 8), r23);
    r3 = r23;
    r4 = r30;
...
// RECOMP_REGISTRATION base 0x8074210C func_8074210C preserves=true fpr_mask=0x00000000
