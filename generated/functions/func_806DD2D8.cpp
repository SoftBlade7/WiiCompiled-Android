...
extern "C" void func_806DD2D8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lhax_806DD314_loc_0 = 0;
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_806DD2D8:
{
    ...
    r30 = r4;
    r6 = MemoryInline::FlatRead32((r6 + 17200));
    ...
    addr_lhax_806DD314_loc_0 = (r5 + r0);
    r0 = MemoryInline::FlatRead16(addr_lhax_806DD314_loc_0);
    r0 = (r0 << 16);
    ...
    r0 = (r0 << 16);
    r0 = (static_cast<int32_t>(r0) >> 16);
    f1.d = MemoryInline::FlatReadFloat64((r4 + 1008));
    r0 = (r0 ^ -2147483648);
...
// RECOMP_REGISTRATION base 0x806DD2D8 func_806DD2D8 preserves=true fpr_mask=0x00000000
