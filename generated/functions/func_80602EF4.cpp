...
extern "C" void func_80602EF4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80602EF4:
{
    r3 = 0x809C0000u;
    r0 = 0;
    MemoryInline::FlatWriteRam32((r3 + 7440), r0);
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80602EF4 func_80602EF4 preserves=true fpr_mask=0x00000000
