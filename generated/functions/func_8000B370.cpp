...
extern "C" void func_8000B370(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8000B370:
{
    ...
    xer = ctx->xer;
    r4 = 0x80010000u;
    MemoryInline::FlatWrite32((r31 + 64), r27);
    r3 = MemoryInline::FlatRead32((r31 + 232));
    r4 = (r4 + -19140);
    MemoryInline::FlatWrite8((r31 + 68), static_cast<uint8_t>(r28));
    r5 = 0;
    r6 = 0;
    MemoryInline::FlatWrite32((r31 + 72), r29);
...
loc_8000B490:
{
    r0 = MemoryInline::FlatRead8((r31 + 181));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_8000B49C:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x801A8688u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8000B370 func_8000B370 preserves=true fpr_mask=0x00000000
