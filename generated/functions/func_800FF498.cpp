...
extern "C" void func_800FF498(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800FF4E4:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800FF0D0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800FF568:
{
    MemoryInline::FlatWrite32((r23 + 8), r27);
    MemoryInline::FlatWrite32((r23 + 12), r28);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_800FF57C;
    }
}
...
// RECOMP_REGISTRATION base 0x800FF498 func_800FF498 preserves=true fpr_mask=0x00000000
