...
extern "C" void func_806055CC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806055CC:
{
    r3 = MemoryInline::FlatRead32((r3 + 3264));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x806055CC func_806055CC preserves=true fpr_mask=0x00000000
