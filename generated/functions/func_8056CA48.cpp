...
extern "C" void func_8056CA48(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8056CA48:
{
    ...
    r28 = r4;
    r29 = r5;
    r31 = MemoryInline::FlatRead32((r7 + 40));
    r30 = r6;
...
loc_8056CAB4:
{
    r3 = MemoryInline::FlatRead32((r27 + 124));
    r4 = (r28 & 65535);
...
loc_8056CAFC:
{
    r4 = MemoryInline::FlatRead32((r27 + 124));
    r3 = 0x80890000u;
    r5 = 0x80890000u;
...
// RECOMP_REGISTRATION base 0x8056CA48 func_8056CA48 preserves=true fpr_mask=0x00000000
