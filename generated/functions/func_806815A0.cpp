...
extern "C" void func_806815A0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lhax_80681604_loc_0 = 0;
    uint32_t addr_lhax_80681658_loc_0 = 0;
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806815A0:
{
    ...
    addr_lhax_80681604_loc_0 = (r4 + r0);
    r0 = MemoryInline::FlatRead16(addr_lhax_80681604_loc_0);
    r0 = (r0 << 16);
    r0 = (static_cast<int32_t>(r0) >> 16);
    f1.d = MemoryInline::FlatReadFloat64((r29 + -11752));
    r0 = (r0 * 116);
    ...
    addr_lhax_80681658_loc_0 = (r3 + r0);
    r0 = MemoryInline::FlatRead16(addr_lhax_80681658_loc_0);
    r0 = (r0 << 16);
    r0 = (static_cast<int32_t>(r0) >> 16);
...
// RECOMP_REGISTRATION base 0x806815A0 func_806815A0 preserves=false fpr_mask=0x80000000
