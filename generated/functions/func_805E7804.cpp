...
extern "C" void func_805E7804(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805E7870:
{
    ...
    ctx->gpr[5] = r5;
    ctx->cr = cr;
    InvokeDirectCpu<0x805F8CF0u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
...
// RECOMP_REGISTRATION base 0x805E7804 func_805E7804 preserves=true fpr_mask=0x00000000
