...
extern "C" void func_80675848(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80675848:
{
    ...
    r4 = 0x808C0000u;
    r3 = r15;
    r5 = MemoryInline::FlatRead32((r4 + 3420));
    r4 = r16;
...
loc_806758B0:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(r16));
}
...
{
    r29 = 65536;
    f30.d = MemoryInline::FlatReadFloat64((r26 + 1120));
    f31.d = MemoryInline::FlatReadFloat32((r26 + 1112));
    r31 = (r1 + 40);
    f29.d = MemoryInline::FlatReadFloat32((r26 + 1108));
    r28 = (r29 + -29504);
    r21 = 0;
    r20 = 0;
    r30 = 1127219200;
...
loc_80675954:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80675B80u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80675968:
{
    ...
    MemoryInline::FlatWrite32(r25, r17);
...
loc_80675A10:
{
    ...
    r6 = r20;
    r3_addr_2 = (r3 + r5);
    r9 = MemoryInline::FlatRead32(r3_addr_2);
    r8 = r20;
    r7 = MemoryInline::FlatRead32((r4 + -28716));
    r10 = r20;
    r5 = MemoryInline::FlatRead32((r14 + 3424));
    r3 = (r15 + r22);
    r4 = (r16 - r22);
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x80675A58u;
...
loc_80675A60:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r22), static_cast<int32_t>(r16));
}
...
// RECOMP_REGISTRATION base 0x80675848 func_80675848 preserves=false fpr_mask=0xE0000000
