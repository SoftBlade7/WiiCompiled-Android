...
extern "C" void func_805B3A9C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805B3A9C:
{
    ...
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x8054F8E0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r3 = 0x809C0000u;
...
// RECOMP_REGISTRATION base 0x805B3A9C func_805B3A9C preserves=true fpr_mask=0x00000000
