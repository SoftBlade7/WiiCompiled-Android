...
extern "C" void func_80238D8C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80238DEC:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8016D138u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80238DF0:
{
    ...
    MemoryInline::FlatWrite32((r27 + 108), r0);
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_80238E20:
{
    ...
    MemoryInline::FlatWrite16((r28 + 84), static_cast<uint16_t>(r30));
    goto loc_80238DA8;
}
...
loc_80238E2C:
{
    ...
    MemoryInline::FlatWrite16((r28 + 84), static_cast<uint16_t>(r31));
    goto loc_80238DA8;
}
...
// RECOMP_REGISTRATION base 0x80238D8C func_80238D8C preserves=true fpr_mask=0x00000000
