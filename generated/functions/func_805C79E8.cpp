...
extern "C" void func_805C79E8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805C79E8:
{
    ...
    r4 = MemoryInline::FlatRead32((r28 + 6424));
...
loc_805C7B64:
{
    r3 = MemoryInline::FlatRead32((r28 + 6420));
    r4 = MemoryInline::FlatRead32((r28 + 6424));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x805C79E8 func_805C79E8 preserves=true fpr_mask=0x00000000
