...
extern "C" void func_8063F694(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8063F740:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r29 + 676));
...
// RECOMP_REGISTRATION base 0x8063F694 func_8063F694 preserves=true fpr_mask=0x00000000
