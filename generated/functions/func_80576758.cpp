...
extern "C" void func_80576758(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80576758:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80576230u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    MemoryInline::FlatWrite16((r31 + 56), static_cast<uint16_t>(r3));
    r3 = MemoryInline::FlatRead32(r31);
    r3 = MemoryInline::FlatRead32((r3 + 4));
    MemoryInline::FlatWrite16((r3 + 166), static_cast<uint16_t>(r0));
    r3 = MemoryInline::FlatRead32(r31);
    r3 = MemoryInline::FlatRead32(r3);
...
loc_8057683C:
{
    ...
    r3 = MemoryInline::FlatRead32((r3 + 60));
    // end of inlined leaf 0x80591440
    MemoryInline::FlatWrite8((r3 + 85), static_cast<uint8_t>(r30));
    r3 = r31;
    r4 = 9;
...
// RECOMP_REGISTRATION base 0x80576758 func_80576758 preserves=true fpr_mask=0x00000000
