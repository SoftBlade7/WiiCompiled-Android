...
extern "C" void func_8072D9D4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8072DA68:
{
    ...
    f0 = ctx->fpr[0];
    cr = ctx->cr;
    MemoryInline::FlatWrite32((r26 + 72), r29);
    r5 = r27;
    r3 = (r1 + 8);
    r4 = (r26 + 16);
...
// RECOMP_REGISTRATION base 0x8072D9D4 func_8072D9D4 preserves=true fpr_mask=0x00000000
