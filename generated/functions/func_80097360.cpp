...
extern "C" void func_80097360(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80097360:
{
    ...
    ctx->gpr[4] = r4;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x8009AE10u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80097360 func_80097360 preserves=true fpr_mask=0x00000000
