...
extern "C" void func_806117A0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806117A0:
{
    r3 = MemoryInline::FlatRead32((r3 + 10360));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x806117A0 func_806117A0 preserves=true fpr_mask=0x00000000
