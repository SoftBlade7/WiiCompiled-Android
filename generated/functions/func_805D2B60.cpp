...
extern "C" void func_805D2B60(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805D2B60:
{
    MemoryInline::FlatWrite32((r16 + 464), r24);
}
...
// RECOMP_REGISTRATION base 0x805D2B60 func_805D2B60 preserves=true fpr_mask=0x00000000
