...
extern "C" void func_807B532C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807B532C:
{
    ...
    r3 = (r31 + 432);
    f1.d = MemoryInline::FlatReadFloat32((r31 + 436));
    r4 = (r31 + 200);
    f0.d = MemoryInline::FlatReadFloat32((r31 + 440));
    r5 = (r31 + 444);
    MemoryInline::FlatWriteFloat32((r31 + 420), f2.d);
    MemoryInline::FlatWriteFloat32((r31 + 424), f1.d);
...
// RECOMP_GUEST_ABI gpr_read=0xC000000E gpr_write=0xC000007B gpr_return=0x00000018 fpr_read=0x0000000F fpr_write=0x000007FF fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x807B532C func_807B532C preserves=true fpr_mask=0x00000000
