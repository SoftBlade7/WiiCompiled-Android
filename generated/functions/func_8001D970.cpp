...
extern "C" void func_8001D970(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8001D970:
{
    ...
    r0 = 1;
    r3 = (r1 + 8);
    MemoryInline::FlatWrite32((r13 + -27516), r0);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
// RECOMP_REGISTRATION base 0x8001D970 func_8001D970 preserves=true fpr_mask=0x00000000
