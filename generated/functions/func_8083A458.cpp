...
extern "C" void func_8083A458(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8083A458:
{
    ...
    if (MkwStateFreeAbiEnabled(0x80860484u) && KnownTranslatedCpuCall<0x80860484u>::kAvailable && !KnownTranslatedCpuCall<0x80860484u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80860484u>()) {
        const auto state_free_result_80860484_B9D = func_80860484_statefree_v0(r3, xer);
        r0 = static_cast<uint32_t>(state_free_result_80860484_B9D[0]);
        r3 = static_cast<uint32_t>(state_free_result_80860484_B9D[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_8083A48C:
{
    ...
    r28 = MemoryInline::FlatRead32((r3 + 3300));
}
...
loc_8083A50C:
{
    ...
    if (MkwStateFreeAbiEnabled(0x80833510u) && KnownTranslatedCpuCall<0x80833510u>::kAvailable && !KnownTranslatedCpuCall<0x80833510u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80833510u>()) {
        const auto state_free_result_80833510_1ADE = func_80833510_statefree(r3, r4, cr, xer);
        r3 = static_cast<uint32_t>(state_free_result_80833510_1ADE[0]);
        cr = static_cast<uint32_t>(state_free_result_80833510_1ADE[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    MemoryInline::FlatWrite32((r27 + 576), r30);
    r3 = r30;
    r4 = r28;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctx->gpr[5] = r5;
    ctx->cr = cr;
    InvokeDirectCpu<0x80860BF0u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r5 = ctx->gpr[5];
    cr = ctx->cr;
...
loc_8083A618:
{
    ...
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x80833510u) && KnownTranslatedCpuCall<0x80833510u>::kAvailable && !KnownTranslatedCpuCall<0x80833510u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80833510u>()) {
        const auto state_free_result_80833510_46EC = func_80833510_statefree(r3, r4, cr, xer);
        r3 = static_cast<uint32_t>(state_free_result_80833510_46EC[0]);
        cr = static_cast<uint32_t>(state_free_result_80833510_46EC[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    MemoryInline::FlatWrite32((r27 + 576), r26);
    r3 = r26;
    r4 = r28;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x8083A458 func_8083A458 preserves=true fpr_mask=0x00000000
