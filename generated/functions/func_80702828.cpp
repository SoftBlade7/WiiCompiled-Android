...
extern "C" void func_80702828(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80702838:
{
    r3 = MemoryInline::FlatRead8((r3 + 112));
    ctx->gpr[3] = r3;
    ctx->cr = cr;
    return;
}
...
// RECOMP_REGISTRATION base 0x80702828 func_80702828 preserves=true fpr_mask=0x00000000
