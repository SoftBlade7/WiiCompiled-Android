...
extern "C" void func_805A8434(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r0 = 0;
    MemoryInline::FlatWriteRam32((r4 + 6584), r0);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_return;
    }
}
...
// RECOMP_REGISTRATION base 0x805A8434 func_805A8434 preserves=true fpr_mask=0x00000000
