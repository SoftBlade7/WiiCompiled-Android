...
extern "C" void func_801B7624(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr1_0 = 0;
...
loc_801B765C:
{
    r0 = MemoryInline::FlatRead8((r13 + -24784));
...
// RECOMP_REGISTRATION base 0x801B7624 func_801B7624 preserves=true fpr_mask=0x00000000
