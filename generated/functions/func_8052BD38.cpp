...
extern "C" void func_8052BD38(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8052BD38:
{
    ...
    ctx->gpr[1] = r1;
    ctx->gpr[4] = r4;
    InvokeDirectCpu<0x8052BC3Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8052BD38 func_8052BD38 preserves=true fpr_mask=0x00000000
