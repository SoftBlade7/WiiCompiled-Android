...
extern "C" void func_8085A208(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8085BBE0:
{
    ...
    if (MkwStateFreeAbiEnabled(0x80621410u) && KnownTranslatedCpuCall<0x80621410u>::kAvailable && !KnownTranslatedCpuCall<0x80621410u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80621410u>()) {
        const auto state_free_result_80621410_163C = func_80621410_statefree_v0(r3, cr, xer);
        cr = static_cast<uint32_t>(state_free_result_80621410_163C);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8085A208 func_8085A208 preserves=false fpr_mask=0x80000000
