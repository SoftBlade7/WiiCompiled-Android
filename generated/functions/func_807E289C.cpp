...
extern "C" void func_807E289C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807E28FC:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite8((r26 + 420), static_cast<uint8_t>(r3));
    r3 = 26;
    ctx->lr = 0x807E2910u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite8((r26 + 421), static_cast<uint8_t>(r3));
...
// RECOMP_REGISTRATION base 0x807E289C func_807E289C preserves=true fpr_mask=0x00000000
