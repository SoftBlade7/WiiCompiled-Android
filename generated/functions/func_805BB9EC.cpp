...
extern "C" void func_805BB9EC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805BBAB8:
{
    ...
    r30 = 0x80890000u;
    r4 = 1;
    f1.d = MemoryInline::FlatReadFloat32((r30 + 10588));
    ctx->lr = 0x805BBAFCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x805BB9EC func_805BB9EC preserves=true fpr_mask=0x00000000
