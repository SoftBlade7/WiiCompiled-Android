...
extern "C" void func_80588D74(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80588D74:
{
    ...
    if (!MemoryInline::WriteResolvedPair16(guest_range_0, 0u, ((static_cast<uint32_t>(static_cast<uint16_t>(r0)) << 16) | static_cast<uint16_t>(r0)))) {
        MemoryInline::WriteResolved16(guest_range_0, 0u, (r3 + 4), r0);
        MemoryInline::WriteResolved16(guest_range_0, 2u, (r3 + 6), r0);
    }
    if (!MemoryInline::WriteResolvedPair16(guest_range_0, 4u, ((static_cast<uint32_t>(static_cast<uint16_t>(r0)) << 16) | static_cast<uint16_t>(r0)))) {
        MemoryInline::WriteResolved16(guest_range_0, 4u, (r3 + 8), r0);
        MemoryInline::WriteResolved16(guest_range_0, 6u, (r3 + 10), r0);
    }
    if (!MemoryInline::WriteResolvedPair16(guest_range_0, 8u, ((static_cast<uint32_t>(static_cast<uint16_t>(r0)) << 16) | static_cast<uint16_t>(r0)))) {
        MemoryInline::WriteResolved16(guest_range_0, 8u, (r3 + 12), r0);
        MemoryInline::WriteResolved16(guest_range_0, 10u, (r3 + 14), r0);
    }
...
// RECOMP_REGISTRATION base 0x80588D74 func_80588D74 preserves=true fpr_mask=0x00000000
