...
extern "C" void func_80843CDC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80843CDC:
{
    ...
    r3 = 0x809C0000u;
    r4 = (r4 + 17720);
    MemoryInline::FlatWriteRam32((r3 + 17824), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x80843CDC func_80843CDC preserves=true fpr_mask=0x00000000
