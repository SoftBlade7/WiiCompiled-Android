...
extern "C" void func_801D7CF0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801D7D5C:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r26 = MemoryInline::FlatRead32((r28 + 52));
    r24 = (r1 + 8);
    MemoryInline::FlatWrite32((r25 + 808), r31);
}
...
loc_801D7D90:
{
    r0 = MemoryInline::FlatRead32((r25 + 808));
...
loc_801D7E1C:
{
    r0 = 1;
    r3 = 0;
    MemoryInline::FlatWrite32((r25 + 816), r0);
    goto loc_801D7EC4;
}
...
loc_801D7E80:
{
    ...
    r3 = (r1 + 8);
    r4 = (r0 + r4);
    MemoryInline::FlatWrite32((r25 + 808), r4);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
    ctx->cr = cr;
    InvokeDirectCpu<0x801D5E7Cu>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r5 = ctx->gpr[5];
    cr = ctx->cr;
...
// RECOMP_REGISTRATION base 0x801D7CF0 func_801D7CF0 preserves=true fpr_mask=0x00000000
