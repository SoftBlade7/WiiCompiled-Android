...
extern "C" void func_8065B4E8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8065B530:
{
    MemoryInline::FlatWrite32(r23, r31);
    r3 = (r23 + 4);
    r4 = 0;
    r5 = 21;
    MemoryInline::FlatWrite8((r23 + 25), static_cast<uint8_t>(r31));
    MemoryInline::FlatWrite8((r23 + 26), static_cast<uint8_t>(r30));
    MemoryInline::FlatWrite8((r23 + 27), static_cast<uint8_t>(r31));
    MemoryInline::FlatWrite8((r23 + 28), static_cast<uint8_t>(r31));
    ctx->lr = 0x8065B554u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_8065B584:
{
    ...
    r4 = 0;
    r5 = 21;
    MemoryInline::FlatWrite8((r24 + 25), static_cast<uint8_t>(r30));
    MemoryInline::FlatWrite8((r24 + 26), static_cast<uint8_t>(r31));
    MemoryInline::FlatWrite8((r24 + 27), static_cast<uint8_t>(r30));
    MemoryInline::FlatWrite8((r24 + 28), static_cast<uint8_t>(r30));
    ctx->lr = 0x8065B5A8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    xer = ctx->xer;
    r28 = (r28 + 1);
    MemoryInline::FlatWrite32((r23 + 9988), r30);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r28), static_cast<uint32_t>(24));
}
...
{
    r0 = 224;
    MemoryInline::FlatWriteRam32((r29 + 11140), r0);
    r0 = 1;
    MemoryInline::FlatWriteRam8(r29, static_cast<uint8_t>(r0));
}

loc_8065B5E4:
{
    r3 = 0x809C0000u;
    MemoryInline::FlatWriteRam32((r3 + 8432), r29);
}
...
// RECOMP_REGISTRATION base 0x8065B4E8 func_8065B4E8 preserves=true fpr_mask=0x00000000
