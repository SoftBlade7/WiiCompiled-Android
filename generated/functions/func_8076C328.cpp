...
extern "C" void func_8076C328(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8076C378:
{
    r12 = MemoryInline::FlatRead32((r29 + 180));
    r3 = (r29 + 180);
...
loc_8076C3D8:
{
    ...
    r23 = (r23 + 4);
    MemoryInline::FlatWrite32((r3 + 284), r30);
}

loc_8076C3EC:
{
    r0 = MemoryInline::FlatRead32((r27 + -6252));
}
...
loc_8076C400:
{
    r0 = MemoryInline::FlatRead32((r28 + -6232));
...
// RECOMP_REGISTRATION base 0x8076C328 func_8076C328 preserves=true fpr_mask=0x00000000
