...
extern "C" void func_805E0B08(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805E0B08:
{
    r3 = MemoryInline::FlatRead32((r3 + 10352));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x805E0B08 func_805E0B08 preserves=true fpr_mask=0x00000000
