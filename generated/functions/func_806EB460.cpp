...
extern "C" void func_806EB460(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_806EB460:
{
    ...
    r4 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat64((r4 + 2568));
    r4 = 4;
...
// RECOMP_REGISTRATION base 0x806EB460 func_806EB460 preserves=false fpr_mask=0x80000000
