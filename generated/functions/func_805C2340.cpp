...
extern "C" void func_805C2340(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805C2340:
{
    r3 = 0x809C0000u;
    r5 = 0x80890000u;
    f1.d = MemoryInline::FlatReadFloat32((r5 + 12776));
    r4 = 3;
...
// RECOMP_REGISTRATION base 0x805C2340 func_805C2340 preserves=true fpr_mask=0x00000000
