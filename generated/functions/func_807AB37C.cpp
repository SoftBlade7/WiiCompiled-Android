...
extern "C" void func_807AB37C(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r4 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r4 + 23248));
    ctx->gpr[4] = r4;
    ctx->fpr[1] = f1;
...
// RECOMP_REGISTRATION base 0x807AB37C func_807AB37C preserves=true fpr_mask=0x00000000
