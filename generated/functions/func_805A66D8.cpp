...
extern "C" void func_805A66D8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_805A6740:
{
    r0 = MemoryInline::FlatRead16((r30 + 820));
    r4 = 0x809C0000u;
    r3 = r31;
    r0 = (r0 | 32);
...
// RECOMP_GUEST_ABI gpr_read=0xFC00003B gpr_write=0xFC00003B gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x805A66D8 func_805A66D8 preserves=true fpr_mask=0x00000000
