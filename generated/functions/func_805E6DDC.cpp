...
extern "C" void func_805E6DDC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805E6E0C:
{
    r3 = MemoryInline::FlatRead32((r27 + 8516));
    ctx->lr = 0x805E6E14u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x805E6DDC func_805E6DDC preserves=true fpr_mask=0x00000000
