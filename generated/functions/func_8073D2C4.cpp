...
extern "C" void func_8073D2C4(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r3 = 0x808D0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + -20412));
    ctx->gpr[3] = r3;
    ctx->fpr[1] = f1;
    return;
}
...
// RECOMP_REGISTRATION base 0x8073D2C4 func_8073D2C4 preserves=true fpr_mask=0x00000000
