...
extern "C" void func_80242D7C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80242DCC:
{
    ...
    MemoryInline::FlatWrite32((r29 + 72), r30);
...
loc_80242E38:
{
    ...
    MemoryInline::FlatWrite32((r29 + 72), r31);
    MemoryInline::FlatWrite32(r30, r31);
...
// RECOMP_REGISTRATION base 0x80242D7C func_80242D7C preserves=true fpr_mask=0x00000000
