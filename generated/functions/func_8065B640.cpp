...
extern "C" void func_8065B640(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8065B664:
{
    ...
    r29 = (r29 + 1);
    r24 = (r24 + 32);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r29), static_cast<uint32_t>(24));
}
...
// RECOMP_REGISTRATION base 0x8065B640 func_8065B640 preserves=true fpr_mask=0x00000000
