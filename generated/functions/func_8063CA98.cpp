...
extern "C" void func_8063CA98(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_8063CA98:
{
    ...
    r3 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat64((r3 + -29768));
    r3 = r30;
...
// RECOMP_REGISTRATION base 0x8063CA98 func_8063CA98 preserves=false fpr_mask=0x80000000
