...
extern "C" void func_805D3980(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805D3980:
{
    ...
    r30 = r3;
    MemoryInline::FlatWrite32((r3 + 600), r4);
...
loc_805D39C0:
{
    r3 = MemoryInline::FlatRead32((r30 + 596));
    r4 = MemoryInline::FlatRead32((r30 + 600));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
{
    r31 = 0x80890000u;
    r5 = MemoryInline::FlatRead32((r30 + 596));
    r31 = (r31 + 17280);
    r6 = MemoryInline::FlatRead32((r30 + 600));
    r3 = r30;
    r7 = 0;
    r4 = (r31 + 47);
    ctx->lr = 0x805D39F4u;
    ...
    xer = ctx->xer;
    r0 = 2;
    MemoryInline::FlatWrite32((r30 + 604), r0);
    r4 = (r31 + 109);
    r3 = (r30 + 168);
    ctx->lr = 0x805D3A68u;
    ctx->gpr[0] = r0;
...
loc_805D3AF4:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805BDBD4u) && KnownTranslatedCpuCall<0x805BDBD4u>::kAvailable && !KnownTranslatedCpuCall<0x805BDBD4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805BDBD4u>()) {
        const auto state_free_result_805BDBD4_3020 = func_805BDBD4_statefree(r3, r4);
        r3 = static_cast<uint32_t>(state_free_result_805BDBD4_3020);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x805D3980 func_805D3980 preserves=true fpr_mask=0x00000000
