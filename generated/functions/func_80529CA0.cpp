...
extern "C" void func_80529CA0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80529CA0:
{
    r4 = 0x809C0000u;
    r4 = (r4 + -5376);
    r3 = MemoryInline::FlatRead32((r4 + 248));
...
loc_80529CC4:
{
    r3 = MemoryInline::FlatRead32((r4 + 192));
    r3 = (r3 + -1);
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
// RECOMP_REGISTRATION base 0x80529CA0 func_80529CA0 preserves=true fpr_mask=0x00000000
