...
extern "C" void func_807F5FEC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807F6054:
{
    r3 = MemoryInline::FlatRead32((r6 + 52));
    r27 = (r5 + 392);
...
loc_807F6158:
{
    ...
    r0 = (r0 & 254);
    r0 = (r0 | 1);
    MemoryInline::FlatWrite8((r28 + 187), static_cast<uint8_t>(r0));
    r4 = (r4 + 440);
    ctx->lr = 0x807F617Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_807F61E0:
{
    r0 = MemoryInline::FlatRead8((r27 + 187));
    r0 = (r0 & 254);
    r0 = (r0 | 1);
    MemoryInline::FlatWrite8((r27 + 187), static_cast<uint8_t>(r0));
}
...
loc_807F6344:
{
    ...
    r4 = 4;
    r5 = (r5 + r0);
    r6 = MemoryInline::FlatRead32((r5 + 244));
    r5 = (r6 + -1);
    r0 = (1 - r6);
    r0 = ~(r5 | r0);
    {
...
loc_807F63A8:
{
    ...
    r5 = 0x808B0000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r5 + -23840));
    ctx->lr = 0x807F63C4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x807F5FEC func_807F5FEC preserves=true fpr_mask=0x00000000
