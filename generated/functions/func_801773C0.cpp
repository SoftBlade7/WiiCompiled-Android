...
extern "C" void func_801773C0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801773C0:
{
    r5 = 0x80290000u;
    r4 = r3;
    r3 = MemoryInline::FlatRead32((r5 + -21020));
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
...
// RECOMP_REGISTRATION base 0x801773C0 func_801773C0 preserves=true fpr_mask=0x00000000
