...
extern "C" void func_806A290C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806A290C:
{
    ...
    r5 = MemoryInline::FlatRead32((r3 + 1328));
}
...
loc_806A297C:
{
    ...
    r4 = MemoryInline::FlatRead32((r29 + 1328));
}
...
loc_806A298C:
{
    ...
    r0 = MemoryInline::FlatRead8((r29 + 2784));
...
// RECOMP_REGISTRATION base 0x806A290C func_806A290C preserves=true fpr_mask=0x00000000
