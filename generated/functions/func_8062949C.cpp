...
extern "C" void func_8062949C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8062949C:
{
    ...
    r11 = MemoryInline::FlatRead32((r29 + 2356));
    ...
    r8 = MemoryInline::FlatRead32((r29 + 2368));
    ...
    r9 = 0x808C0000u;
    r7 = 0x808C0000u;
    guest_range_5 = MemoryInline::ResolveRangeHost((r29 + 2380), 0, 60u, true, false);
    r20 = MemoryInline::ReadResolved32(guest_range_5, 0u, (r29 + 2380));
    r9 = (r9 + -12228);
    ...
    MemoryInline::WriteResolved32(guest_range_1, 16u, (r27 + 1636), r21);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r23 = MemoryInline::ReadResolved32(guest_range_5, 12u, (r29 + 2392));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r26 = MemoryInline::ReadResolved32(guest_range_5, 24u, (r29 + 2404));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r10 = MemoryInline::ReadResolved32(guest_range_5, 36u, (r29 + 2416));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_5, 48u, (r29 + 2428));
    ...
    ctr = ctx->ctr;
    r3 = (r29 + 2440);
    r11 = MemoryInline::FlatRead32((r29 + 2440));
    r10 = MemoryInline::FlatRead32((r3 + 4));
    r8 = 0x808C0000u;
    r9 = MemoryInline::FlatRead32((r3 + 8));
    r8 = (r8 + -12156);
    guest_range_3 = MemoryInline::ResolveRangeHost((r28 + 1564), 0, 64u, false, true);
    MemoryInline::WriteResolved32(guest_range_3, 16u, (r28 + 1580), r9);
    r4 = 0x808D0000u;
    r5 = (r29 + 2452);
    r3 = (r28 + 1632);
    MemoryInline::WriteResolved32(guest_range_3, 0u, (r28 + 1564), r8);
    r4 = (r4 + 13832);
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 4u, ((static_cast<uint64_t>(static_cast<uint32_t>(r28)) << 32) | static_cast<uint32_t>(r11)))) {
        MemoryInline::WriteResolved32(guest_range_3, 4u, (r28 + 1568), r28);
        MemoryInline::WriteResolved32(guest_range_3, 8u, (r28 + 1572), r11);
    }
    MemoryInline::WriteResolved32(guest_range_3, 12u, (r28 + 1576), r10);
    r7 = MemoryInline::FlatRead32((r29 + 2452));
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 20u, ((static_cast<uint64_t>(static_cast<uint32_t>(r8)) << 32) | static_cast<uint32_t>(r28)))) {
        MemoryInline::WriteResolved32(guest_range_3, 20u, (r28 + 1584), r8);
        MemoryInline::WriteResolved32(guest_range_3, 24u, (r28 + 1588), r28);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 28u, ((static_cast<uint64_t>(static_cast<uint32_t>(r7)) << 32) | static_cast<uint32_t>(r6)))) {
        MemoryInline::WriteResolved32(guest_range_3, 28u, (r28 + 1592), r7);
        MemoryInline::WriteResolved32(guest_range_3, 32u, (r28 + 1596), r6);
    }
    MemoryInline::WriteResolved32(guest_range_3, 36u, (r28 + 1600), r0);
    MemoryInline::WriteResolved32(guest_range_3, 44u, (r28 + 1608), r4);
    MemoryInline::WriteResolved8(guest_range_3, 56u, (r28 + 1620), static_cast<uint8_t>(r30));
    MemoryInline::WriteResolved32(guest_range_3, 60u, (r28 + 1624), r30);
    ctx->lr = 0x80629798u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r20 = (r27 + 3736);
    r3 = (r3 + 13488);
    MemoryInline::FlatWrite32((r28 + 1608), r3);
    r0 = (r3 + 24);
    MemoryInline::FlatWrite32((r28 + 1632), r0);
    r3 = r20;
    ctx->lr = 0x806297B8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x8062949C func_8062949C preserves=true fpr_mask=0x00000000
