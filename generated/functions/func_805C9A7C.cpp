...
extern "C" void func_805C9A7C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805C9A7C:
{
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 120u, ((static_cast<uint64_t>(static_cast<uint32_t>(r18)) << 32) | static_cast<uint32_t>(r19)))) {
        MemoryInline::WriteResolved32(guest_range_0, 120u, (r1 + 120), r18);
        MemoryInline::WriteResolved32(guest_range_0, 124u, (r1 + 124), r19);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 128u, ((static_cast<uint64_t>(static_cast<uint32_t>(r20)) << 32) | static_cast<uint32_t>(r21)))) {
        MemoryInline::WriteResolved32(guest_range_0, 128u, (r1 + 128), r20);
        MemoryInline::WriteResolved32(guest_range_0, 132u, (r1 + 132), r21);
    }
    ...
    r27 = (r4 + 1);
    r25 = MemoryInline::FlatRead8((r1 + 187));
    r19 = r3;
    r26 = MemoryInline::FlatRead8((r1 + 191));
    r20 = r5;
    r21 = r6;
    r22 = r7;
    r23 = r8;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead32((r19 + 476));
    r0 = 0;
    MemoryInline::FlatWrite32((r19 + 624), r3);
    r3 = r19;
    r4 = (r4 + 1);
    MemoryInline::FlatWrite32((r19 + 480), r0);
    MemoryInline::FlatWrite32((r19 + 472), r18);
    ctx->lr = 0x805C9B00u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r19 + 476));
    r27 = 0;
    r0 = (r3 + 1);
    {
...
loc_805C9B2C:
{
    r0 = MemoryInline::FlatRead32((r19 + 624));
    r3 = r19;
    r4 = r27;
    r5 = (r0 + r28);
    ctx->gpr[0] = r0;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r18 + 372), r31);
    r3 = (r1 + 40);
    r4 = -1;
    ctx->lr = 0x805C9B7Cu;
    ctx->gpr[0] = r0;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r19 + 480));
    r4 = r29;
    r0 = MemoryInline::FlatRead32((r19 + 624));
    r3 = (r3 - r27);
    r5 = PPC_CntlzwInline(static_cast<uint32_t>(r3));
    r3 = (r0 + r28);
    r18_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(27));
    r18 = (r18_rot_2 & 134217727);
    r3 = (r3 + 168);
    ctx->lr = 0x805C9BA0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_805C9CD4:
{
    ...
    r0 = (r19 + 392);
    r18 = 0x80380000u;
    MemoryInline::FlatWrite32((r19 + 496), r20);
    r18 = (r18 + 24976);
    r25 = 0;
    MemoryInline::FlatWrite32((r19 + 520), r3);
    r23 = 0;
    r24 = 0;
    r21 = 0x808C0000u;
    MemoryInline::FlatWrite32((r19 + 524), r0);
    r20 = 0;
    goto loc_805C9D98;
}
...
loc_805C9D78:
{
    r3 = MemoryInline::FlatRead32((r19 + 536));
    r23 = (r23 + 376);
    r25 = (r25 + 1);
    r3_addr_2 = (r3 + r24);
    MemoryInline::FlatWrite32(r3_addr_2, r22);
    r0 = MemoryInline::FlatRead32((r19 + 536));
    r3 = (r0 + r24);
    r24 = (r24 + 40);
    MemoryInline::FlatWrite8((r3 + 36), static_cast<uint8_t>(r20));
}
...
loc_805C9E60:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r19 + 616), r3);
    r4 = (r20 + 56);
    r3 = (r19 + 168);
    ctx->lr = 0x805C9E90u;
    ctx->gpr[0] = r0;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r19 + 620), r3);
    r3 = r19;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 120), 0, 64u, true, false);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r18 = MemoryInline::ReadResolved32(guest_range_1, 0u, (r1 + 120));
            r19 = MemoryInline::ReadResolved32(guest_range_1, 4u, (r1 + 124));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r20 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r1 + 128));
            r21 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r1 + 132));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r22 = MemoryInline::ReadResolved32(guest_range_1, 16u, (r1 + 136));
            r23 = MemoryInline::ReadResolved32(guest_range_1, 20u, (r1 + 140));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r24 = MemoryInline::ReadResolved32(guest_range_1, 24u, (r1 + 144));
            r25 = MemoryInline::ReadResolved32(guest_range_1, 28u, (r1 + 148));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r26 = MemoryInline::ReadResolved32(guest_range_1, 32u, (r1 + 152));
            r27 = MemoryInline::ReadResolved32(guest_range_1, 36u, (r1 + 156));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r28 = MemoryInline::ReadResolved32(guest_range_1, 40u, (r1 + 160));
            r29 = MemoryInline::ReadResolved32(guest_range_1, 44u, (r1 + 164));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r30 = MemoryInline::ReadResolved32(guest_range_1, 48u, (r1 + 168));
            r31 = MemoryInline::ReadResolved32(guest_range_1, 52u, (r1 + 172));
        }
    }
    r0 = MemoryInline::ReadResolved32(guest_range_1, 60u, (r1 + 180));
    ctx->lr = r0;
    r1 = (r1 + 176);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x805C9A7C func_805C9A7C preserves=true fpr_mask=0x00000000
