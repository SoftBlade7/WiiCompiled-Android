...
extern "C" void func_8064A3E0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8064A3E0:
{
    ...
    r3 = 0x809C0000u;
    r4 = (r4 + 7440);
    MemoryInline::FlatWriteRam32((r3 + 7904), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x8064A3E0 func_8064A3E0 preserves=true fpr_mask=0x00000000
