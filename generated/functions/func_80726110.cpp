...
extern "C" void func_80726110(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_80726110:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r4 + 9136));
...
// RECOMP_REGISTRATION base 0x80726110 func_80726110 preserves=true fpr_mask=0x00000000
