...
extern "C" void func_8015E81C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8015E81C:
{
    r12 = MemoryInline::FlatRead32((r4 + 56));
...
// RECOMP_REGISTRATION base 0x8015E81C func_8015E81C preserves=true fpr_mask=0x00000000
