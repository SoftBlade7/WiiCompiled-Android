...
extern "C" void func_801632F4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801632F4:
{
    ...
    r0 = 0;
    MemoryInline::FlatWrite32((r13 + -25948), r0);
...
loc_8016331C:
{
    r0 = MemoryInline::FlatRead32((r13 + -25948));
...
// RECOMP_REGISTRATION base 0x801632F4 func_801632F4 preserves=true fpr_mask=0x00000000
