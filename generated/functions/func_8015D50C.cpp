...
extern "C" void func_8015D50C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8015D50C:
{
    ...
    ctx->gpr[3] = r3;
    ctx->cr = cr;
    InvokeDirectCpu<0x8015DDECu>(ctx);
    r0 = ctx->gpr[0];
    cr = ctx->cr;
    r3 = 0;
    r0 = 1;
...
loc_8015D558:
{
    ...
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x8015DC60u>(ctx);
}
...
// RECOMP_REGISTRATION base 0x8015D50C func_8015D50C preserves=true fpr_mask=0x00000000
