...
extern "C" void func_805DEF88(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805DEF88:
{
    ...
    if (MkwStateFreeAbiEnabled(0x80623054u) && KnownTranslatedCpuCall<0x80623054u>::kAvailable && !KnownTranslatedCpuCall<0x80623054u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80623054u>()) {
        const auto state_free_result_80623054_6E5 = func_80623054_statefree_v0(r3);
        r3 = static_cast<uint32_t>(state_free_result_80623054_6E5);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x805DEF88 func_805DEF88 preserves=true fpr_mask=0x00000000
