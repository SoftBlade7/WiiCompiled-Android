...
extern "C" void func_805731C8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805731C8:
{
    r0 = MemoryInline::FlatRead8((r4 + 472));
    r3 = 7;
...
// RECOMP_REGISTRATION base 0x805731C8 func_805731C8 preserves=true fpr_mask=0x00000000
