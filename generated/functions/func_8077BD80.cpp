...
extern "C" void func_8077BD80(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8077BD80:
{
    ...
    r3 = 192;
    MemoryInline::FlatWrite32((r30 + 180), r4);
...
loc_8077BDDC:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r29 + 188), r30);
    r3 = 0x808D0000u;
    r3 = (r3 + 3048);
...
loc_8077BDF8:
{
    MemoryInline::FlatWrite32((r30 + 176), r29);
    r3 = r29;
...
loc_8077BE2C:
{
    ...
    r3 = (r30 + 180);
    r5 = 0;
    r12 = MemoryInline::FlatRead32((r30 + 180));
...
loc_8077BE70:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r28 + 188), r30);
    MemoryInline::FlatWriteRam32(r28, r29);
    MemoryInline::FlatWriteRam32((r28 + 192), r26);
}
...
loc_8077BEC8:
{
    r3 = 0;
    r4_addr_2 = (r4 + r27);
    MemoryInline::FlatWrite32(r4_addr_2, r28);
    if ((static_cast<int32_t>(r26) < static_cast<int32_t>(0))) {
        goto loc_8077BEE4;
    }
}
...
// RECOMP_REGISTRATION base 0x8077BD80 func_8077BD80 preserves=true fpr_mask=0x00000000
