...
extern "C" void func_8072FB7C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
{
    r3 = 0x808D0000u;
    f31.d = MemoryInline::FlatReadFloat32((r3 + -23596));
    goto loc_8072FC40;
}
...
{
    r3 = 0x808D0000u;
    f31.d = MemoryInline::FlatReadFloat32((r3 + -23592));
}
...
// RECOMP_GUEST_ABI gpr_read=0xC000000E gpr_write=0xC000003B gpr_return=0x00000018 fpr_read=0x80000018 fpr_write=0x8000001F fpr_return=0x00000002 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8072FB7C func_8072FB7C preserves=false fpr_mask=0x80000000
