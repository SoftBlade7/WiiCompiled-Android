...
extern "C" void func_805BDAC8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_805BDAC8:
{
    MemoryInline::FlatWrite32((r3 + 564), r4);
    r6 = r5;
    r5 = (r3 + 544);
    r4 = 0;
    r3 = (r3 + 372);
...
// RECOMP_REGISTRATION base 0x805BDAC8 func_805BDAC8 preserves=true fpr_mask=0x00000000
