...
extern "C" void func_80170F2C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80170F2C:
{
    ...
    r30 = r3;
    r12 = MemoryInline::FlatRead32((r5 + 1304));
    ctr = r12;
    ctx->lr = 0x80170F58u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    InvokeDirectCpu<0x80170DC8u>(ctx);
...
// RECOMP_REGISTRATION base 0x80170F2C func_80170F2C preserves=true fpr_mask=0x00000000
