...
extern "C" void func_8020FCD4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8020FCD4:
{
    ...
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80210024u>(ctx);
    r3 = ctx->gpr[3];
    r13 = ctx->gpr[13];
    ctx->gpr[3] = r3;
    return;
...
// RECOMP_REGISTRATION base 0x8020FCD4 func_8020FCD4 preserves=true fpr_mask=0x00000000
