...
extern "C" void func_8011A054(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8011A07C:
{
    r0 = MemoryInline::FlatRead32((r13 + -26656));
    r5 = 0x802F0000u;
    r5 = (r5 + 14880);
    r6 = (r0 ^ 1);
    r0 = (r6 * 22);
    MemoryInline::FlatWrite32((r13 + -26656), r6);
    r31 = (r5 + r0);
}
...
// RECOMP_REGISTRATION base 0x8011A054 func_8011A054 preserves=true fpr_mask=0x00000000
