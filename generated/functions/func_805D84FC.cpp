...
extern "C" void func_805D84FC(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = -1;
    MemoryInline::FlatWrite32((r3 + 3508), r0);
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x805D84FC func_805D84FC preserves=true fpr_mask=0x00000000
