...
extern "C" void func_801EC184(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801EC184:
{
    ...
    r3 = (r3 + -5536);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x801EC190u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x801EC184 func_801EC184 preserves=true fpr_mask=0x00000000
