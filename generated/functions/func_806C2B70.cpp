...
extern "C" void func_806C2B70(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806C2B70:
{
    ...
    r3 = 0x808A0000u;
    r4 = (r5 + 244);
    guest_range_0 = MemoryInline::ResolveRangeHost(r30, 0, 1364u, false, true);
    MemoryInline::WriteResolved32(guest_range_0, 0u, r30, r5);
    f4.d = MemoryInline::FlatReadFloat64((r3 + -2272));
    r3 = r30;
    MemoryInline::WriteResolved32(guest_range_0, 180u, (r30 + 180), r4);
    ...
    MemoryInline::WriteResolved16(guest_range_0, 1354u, (r30 + 1354), static_cast<uint16_t>(r0));
    ...
    r0 = (r0 << 16);
    r0 = (static_cast<int32_t>(r0) >> 16);
    MemoryInline::WriteResolved16(guest_range_0, 1356u, (r30 + 1356), static_cast<uint16_t>(r0));
    r4 = MemoryInline::FlatRead32(r31);
    ...
    MemoryInline::WriteResolvedFloat32(guest_range_0, 232u, (r30 + 232), f2.d);
    f2.d = static_cast<double>(PpcForceSingleValueInline(f3.d - f4.d));
    MemoryInline::WriteResolvedFloat32(guest_range_0, 236u, (r30 + 236), f1.d);
    MemoryInline::WriteResolvedFloat32(guest_range_0, 1360u, (r30 + 1360), f2.d);
    MemoryInline::WriteResolvedFloat32(guest_range_0, 240u, (r30 + 240), f0.d);
    ctx->lr = 0x806C2C10u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r4 = (r30 + 292);
    f1.d = MemoryInline::FlatReadFloat32((r30 + 1360));
...
// RECOMP_REGISTRATION base 0x806C2B70 func_806C2B70 preserves=true fpr_mask=0x00000000
