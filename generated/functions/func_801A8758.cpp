...
extern "C" void func_801A8758(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801A8758:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r31 = MemoryInline::FlatRead8((r1 + 22));
    ctx->lr = 0x801A878Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_801A8820:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801AB9D8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x801A8758 func_801A8758 preserves=true fpr_mask=0x00000000
