...
extern "C" void func_807439F0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807439F0:
{
    ...
    r12 = MemoryInline::FlatRead32((r4 + 52));
...
loc_80743BAC:
{
    ...
    f2.d = static_cast<double>(PpcForceSingleValueInline(f29.d - f28.d));
...
loc_80743BFC:
{
    ...
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 100), 0, 100u, true, false);
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 76u, (r1 + 176));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f30.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 60u, (r1 + 160));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f29.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 44u, (r1 + 144));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f28.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 28u, (r1 + 128));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f27.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 12u, (r1 + 112));
    {
        ...
        if (resolved_pair.valid) {
            ...
            r31 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r1 + 108));
            r30 = MemoryInline::ReadResolved32(guest_range_1, 4u, (r1 + 104));
        }
    }
    r0 = MemoryInline::ReadResolved32(guest_range_1, 96u, (r1 + 196));
    r29 = MemoryInline::ReadResolved32(guest_range_1, 0u, (r1 + 100));
    ctx->lr = r0;
    r1 = (r1 + 192);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x807439F0 func_807439F0 preserves=false fpr_mask=0xF8000000
