...
extern "C" void func_800250C0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800250C0:
{
    r7 = MemoryInline::FlatRead8((r4 + 16));
    r6 = MemoryInline::FlatRead8((r4 + 17));
    r5 = MemoryInline::FlatRead8((r4 + 18));
...
// RECOMP_REGISTRATION base 0x800250C0 func_800250C0 preserves=true fpr_mask=0x00000000
