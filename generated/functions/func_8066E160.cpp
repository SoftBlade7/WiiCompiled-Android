...
extern "C" void func_8066E160(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8066E160:
{
    ...
    r4 = (r4 + -21928);
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 272u, ((static_cast<uint64_t>(static_cast<uint32_t>(r24)) << 32) | static_cast<uint32_t>(r25)))) {
...
loc_8066E1DC:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801DEAB8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8066E1FC:
{
    r4 = -131072;
    r0 = (r4 + 21966);
    MemoryInline::FlatWrite32((r24 + 28), r0);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->cr = cr;
...
loc_8066E324:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8066E35Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8066E348:
{
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 272), 0, 40u, true, false);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r24 = MemoryInline::ReadResolved32(guest_range_1, 0u, (r1 + 272));
            r25 = MemoryInline::ReadResolved32(guest_range_1, 4u, (r1 + 276));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r26 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r1 + 280));
            r27 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r1 + 284));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r28 = MemoryInline::ReadResolved32(guest_range_1, 16u, (r1 + 288));
            r29 = MemoryInline::ReadResolved32(guest_range_1, 20u, (r1 + 292));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r30 = MemoryInline::ReadResolved32(guest_range_1, 24u, (r1 + 296));
            r31 = MemoryInline::ReadResolved32(guest_range_1, 28u, (r1 + 300));
        }
    }
    r0 = MemoryInline::ReadResolved32(guest_range_1, 36u, (r1 + 308));
    ctx->lr = r0;
    r1 = (r1 + 304);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x8066E160 func_8066E160 preserves=true fpr_mask=0x00000000
