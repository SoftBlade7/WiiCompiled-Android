...
extern "C" void func_8009DF70(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8009DF70:
{
    ...
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x8009ECE0u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8009DF70 func_8009DF70 preserves=true fpr_mask=0x00000000
