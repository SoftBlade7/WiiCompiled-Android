...
extern "C" void func_8008A630(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8008A664:
{
    MemoryInline::FlatWrite16((r4 + 58), static_cast<uint16_t>(r31));
...
// RECOMP_REGISTRATION base 0x8008A630 func_8008A630 preserves=true fpr_mask=0x00000000
