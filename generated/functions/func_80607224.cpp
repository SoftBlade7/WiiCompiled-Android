...
extern "C" void func_80607224(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80607224:
{
    ...
    r29 = r3;
    MemoryInline::FlatWrite32((r3 + 400), r4);
    r4 = r29;
    r3 = (r1 + 16);
...
// RECOMP_REGISTRATION base 0x80607224 func_80607224 preserves=true fpr_mask=0x00000000
