...
extern "C" void func_8055C9F0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8055C9F0:
{
    ...
    r0_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(11));
    r0 = (r0_rot_0 & 1);
...
// RECOMP_REGISTRATION base 0x8055C9F0 func_8055C9F0 preserves=true fpr_mask=0x00000000
