...
extern "C" void func_806C6214(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806C6214:
{
    ...
    r0 = MemoryInline::FlatRead8((r3 + 205));
    r28 = 0x808C0000u;
    r29 = 0x808A0000u;
    r25 = r3;
...
loc_806C6268:
{
    f28.d = MemoryInline::FlatReadFloat32(r29);
    r26 = 0;
    f29.d = MemoryInline::FlatReadFloat64((r29 + 40));
    r27 = 0;
...
loc_806C628C:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead8((r25 + 196));
...
loc_806C6370:
{
    ...
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 36), 0, 100u, true, false);
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 76u, (r1 + 112));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f30.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 60u, (r1 + 96));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f29.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 44u, (r1 + 80));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r11 = (r1 + 64);
    f28.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 28u, (r1 + 64));
    ...
    r0 = MemoryInline::ReadResolved32(guest_range_1, 96u, (r1 + 132));
    ctx->lr = r0;
    r1 = (r1 + 128);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x806C6214 func_806C6214 preserves=false fpr_mask=0xF0000000
