...
extern "C" void func_80645110(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80645134:
{
    ...
    r4 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r4 + -28032));
    r4 = 125;
...
// RECOMP_REGISTRATION base 0x80645110 func_80645110 preserves=true fpr_mask=0x00000000
