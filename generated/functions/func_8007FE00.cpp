...
extern "C" void func_8007FE00(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8007FE00:
{
    ...
    r0_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(19));
    r0_mrot_1 = (r0_rot_1 & 524288);
    r0_mdest_1 = (r0 & -524289);
...
// RECOMP_REGISTRATION base 0x8007FE00 func_8007FE00 preserves=true fpr_mask=0x00000000
