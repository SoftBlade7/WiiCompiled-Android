...
extern "C" void func_800BD9C0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_inl2_cont_800BC5E0:
{
    ...
    r12 = MemoryInline::FlatRead32((r3 + 460));
    r3 = MemoryInline::FlatRead32(r31);
    ctr = r12;
    ctx->lr = 0x800BD9FCu;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x800BD9C0 func_800BD9C0 preserves=true fpr_mask=0x00000000
