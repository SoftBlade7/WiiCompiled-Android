...
extern "C" void func_807539FC(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r4 = 0x808D0000u;
    r0 = MemoryInline::FlatRead32((r4 + -16092));
...
// RECOMP_REGISTRATION base 0x807539FC func_807539FC preserves=true fpr_mask=0x00000000
