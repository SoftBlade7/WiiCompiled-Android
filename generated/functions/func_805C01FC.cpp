...
extern "C" void func_805C01FC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_805C01FC:
{
    ...
    r7 = 0;
    r0 = -1;
    MemoryInline::FlatWrite32((r3 + 5036), r0);
    r5 = (r4 + -29504);
    r6 = 0x809C0000u;
    MemoryInline::FlatWrite32((r3 + 5032), r7);
    r0 = (r7 * r5);
    r31 = r3;
...
{
    r0 = (r7 + 1);
    MemoryInline::FlatWrite32((r3 + 5032), r0);
}
...
loc_805C027C:
{
    r4 = MemoryInline::FlatRead32((r3 + 5032));
    r0 = (r4 + 1);
    MemoryInline::FlatWrite32((r3 + 5032), r0);
}
...
loc_805C02E8:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805F0DB4u) && KnownTranslatedCpuCall<0x805F0DB4u>::kAvailable && !KnownTranslatedCpuCall<0x805F0DB4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805F0DB4u>()) {
        const auto state_free_result_805F0DB4_19EC = func_805F0DB4_statefree_v0(r3, r4, cr, xer);
        cr = static_cast<uint32_t>(state_free_result_805F0DB4_19EC);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    xer = ctx->xer;
    r0 = 1;
    MemoryInline::FlatWrite32((r31 + 1564), r0);
    r3 = (r31 + 988);
    r4 = (r31 + 4972);
    r5 = 0;
    ctx->gpr[0] = r0;
...
loc_805C04A4:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_5D45 = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_5D45[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_5D45[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_805C0544:
{
    ...
    xer = ctx->xer;
    r0 = 3;
    MemoryInline::FlatWrite32((r31 + 2756), r0);
    r3 = (r31 + 2180);
    r4 = (r31 + 4972);
    r5 = 0;
    ctx->gpr[0] = r0;
    ...
    xer = ctx->xer;
    r0 = 4;
    MemoryInline::FlatWrite32((r31 + 3352), r0);
    r3 = (r31 + 2776);
    r4 = (r31 + 4972);
    r5 = 0;
    ctx->gpr[0] = r0;
    ...
    r4 = (r1 + 8);
    r30 = MemoryInline::FlatRead32((r27 + 8));
    r5 = (r26 + 236);
    r12 = MemoryInline::FlatRead32((r27 + 12));
    r6 = (r26 + 243);
    r11 = MemoryInline::FlatRead32((r27 + 16));
    r7 = (r26 + 256);
    r10 = MemoryInline::FlatRead32((r27 + 20));
    r8 = 1;
    ...
    xer = ctx->xer;
    r0 = 5;
    MemoryInline::FlatWrite32((r31 + 3948), r0);
    r3 = (r31 + 3372);
    r4 = (r31 + 4992);
    // inline leaf 0x805BDAE0 (2 guest instruction(s))
    MemoryInline::FlatWrite32((r3 + 568), r4);
    ...
    xer = ctx->xer;
    r0 = 6;
    MemoryInline::FlatWrite32((r31 + 4564), r0);
    r3 = (r31 + 3988);
    r4 = (r31 + 4972);
    r5 = 0;
    ctx->gpr[0] = r0;
...
loc_805C0798:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(136));
}
...
// RECOMP_REGISTRATION base 0x805C01FC func_805C01FC preserves=true fpr_mask=0x00000000
