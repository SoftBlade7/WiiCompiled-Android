...
extern "C" void func_8084EDF8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8084EDF8:
{
    ...
    r3 = 0x809C0000u;
    r4 = (r4 + 17720);
    MemoryInline::FlatWriteRam32((r3 + 17904), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x8084EDF8 func_8084EDF8 preserves=true fpr_mask=0x00000000
