...
extern "C" void func_8073FC34(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r3 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + 10484));
    ctx->gpr[3] = r3;
    ctx->fpr[1] = f1;
    return;
}
...
// RECOMP_REGISTRATION base 0x8073FC34 func_8073FC34 preserves=true fpr_mask=0x00000000
