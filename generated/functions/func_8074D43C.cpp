...
extern "C" void func_8074D43C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8074D4F8:
{
    ...
    mkw_gqr0 = ctx->gqr[0];
    r0 = 0;
    MemoryInline::FlatWrite8((r29 + 100), static_cast<uint8_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x8074D43C func_8074D43C preserves=true fpr_mask=0x00000000
