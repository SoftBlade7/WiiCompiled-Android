...
extern "C" void func_80101810(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801018DC:
{
    ...
    r7 = (r1 + 320);
    r0 = (r1 + 152);
    MemoryInline::FlatWriteRam32((r1 + 404), r4);
    r3 = r28;
    r4 = (r13 + -31064);
    MemoryInline::FlatWriteRam32((r1 + 400), r5);
    r6 = 31;
    MemoryInline::FlatWriteRam32((r1 + 408), r10);
    MemoryInline::FlatWriteRam32((r1 + 412), r9);
...
loc_80101958:
{
    r3 = MemoryInline::FlatRead32((r1 + 400));
    r0 = 0;
...
loc_80101964:
{
    r5 = MemoryInline::FlatRead32((r1 + 404));
    r3 = r28;
    r4 = (r31 + 112);
    r6 = 21;
    ctx->lr = 0x80101978u;
...
loc_8010198C:
{
    r5 = MemoryInline::FlatRead32((r1 + 408));
    r3 = r28;
    r4 = (r13 + -31056);
    r6 = 51;
    ctx->lr = 0x801019A0u;
...
loc_801019B4:
{
    r5 = MemoryInline::FlatRead32((r1 + 412));
    r3 = r28;
    r4 = (r31 + 128);
    r6 = 31;
    ctx->lr = 0x801019C8u;
...
loc_801019D0:
{
    r3 = MemoryInline::FlatRead32((r1 + 412));
    r0 = 0;
    MemoryInline::FlatWrite8(r3, static_cast<uint8_t>(r0));
}
...
loc_801019DC:
{
    r5 = MemoryInline::FlatRead32((r1 + 416));
    r3 = r28;
    r4 = (r31 + 140);
    r6 = 31;
    ctx->lr = 0x801019F0u;
...
loc_801019F8:
{
    r3 = MemoryInline::FlatRead32((r1 + 416));
    r0 = 0;
    MemoryInline::FlatWrite8(r3, static_cast<uint8_t>(r0));
}
...
loc_80101A38:
{
    r5 = MemoryInline::FlatRead32((r1 + 420));
    r3 = r28;
    r4 = (r31 + 164);
    r6 = 76;
    ctx->lr = 0x80101A4Cu;
...
loc_80101A54:
{
    r3 = MemoryInline::FlatRead32((r1 + 420));
    r0 = 0;
    MemoryInline::FlatWrite8(r3, static_cast<uint8_t>(r0));
}
...
{
    r0 = 0;
    MemoryInline::FlatWriteRam8((r1 + 439), static_cast<uint8_t>(r0));
}
...
loc_80101AC4:
{
    f0.d = MemoryInline::FlatReadFloat32((r2 + -27440));
    MemoryInline::FlatWriteRamFloat32((r1 + 444), f0.d);
    goto loc_80101AE0;
}
...
{
    f0.d = MemoryInline::FlatReadFloat32((r2 + -27440));
    MemoryInline::FlatWriteRamFloat32((r1 + 448), f0.d);
    goto loc_80101B18;
}
...
{
    r0 = 0;
    MemoryInline::FlatWriteRam8((r1 + 452), static_cast<uint8_t>(r0));
}
...
loc_80101B6C:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r24_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(16));
    r24 = (r24_rot_1 & 255);
    r25 = (r3 & 65535);
    r23_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(8));
    r23 = (r23_rot_1 & 255);
    r3 = r23;
    r4 = r24;
    r5 = r25;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80101470u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r6 = ctx->gpr[6];
    cr = ctx->cr;
...
loc_80101BAC:
{
    ...
    r3 = 0;
    MemoryInline::FlatWriteRam32((r1 + 584), r24);
    MemoryInline::FlatWriteRam32((r1 + 588), r25);
}
...
loc_80101C5C:
{
    r5 = MemoryInline::FlatRead32((r1 + 600));
    r3 = r28;
    r4 = (r13 + -31008);
    r6 = 51;
    ctx->lr = 0x80101C70u;
...
loc_80101C78:
{
    r3 = MemoryInline::FlatRead32((r1 + 600));
    r0 = 0;
    MemoryInline::FlatWrite8(r3, static_cast<uint8_t>(r0));
}
...
loc_80101CAC:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r1 + 604), r3);
}
...
{
    r0 = 0;
    MemoryInline::FlatWriteRam32((r1 + 608), r0);
    goto loc_80101CEC;
}
...
loc_80101D14:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r1 + 612), r3);
}
...
loc_80101D7C:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r1 + 620), r3);
}
...
loc_80101DB0:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r1 + 624), r3);
}
...
loc_80101DE4:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r1 + 628), r3);
}
...
loc_80101E18:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r1 + 632), r3);
}
...
loc_80101E9C:
{
    r24 = MemoryInline::FlatRead32((r30 + 256));
    r28 = 102;
    r23 = MemoryInline::FlatRead32((r30 + 1492));
    goto loc_80101EEC;
}
...
loc_80101ED0:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80106084u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
...
loc_80101EE0:
{
    MemoryInline::FlatWrite32(r23, r28);
    r24 = 1;
}

loc_80101EE8:
{
    r23 = MemoryInline::FlatRead32((r23 + 84));
}
...
loc_80101F6C:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80103834u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
...
loc_8010205C:
{
    ...
    MemoryInline::FlatWriteRam32(r23, r0);
    r3 = r26;
    r0 = MemoryInline::FlatRead32((r1 + 28));
    r5 = r23;
    MemoryInline::FlatWriteRam32((r23 + 4), r29);
    r6 = r27;
    r4 = (r1 + 16);
    r7 = 0;
...
// RECOMP_REGISTRATION base 0x80101810 func_80101810 preserves=true fpr_mask=0x00000000
