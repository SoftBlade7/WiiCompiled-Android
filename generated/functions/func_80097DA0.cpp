...
extern "C" void func_80097DA0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80097DA0:
{
    r3 = MemoryInline::FlatRead8((r3 + 362));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80097DA0 func_80097DA0 preserves=true fpr_mask=0x00000000
