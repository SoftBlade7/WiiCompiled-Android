...
extern "C" void func_80132DE8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80132E24:
{
    ...
    guest_range_0 = MemoryInline::ResolveRangeHost(r3, 0, 260u, false, true);
    ...
    r4 = (r1 + 8);
    MemoryInline::WriteResolved8(guest_range_0, 6u, (r1 + 14), static_cast<uint8_t>(r30));
    r3 = 2;
    MemoryInline::WriteResolved32(guest_range_0, 256u, (r1 + 264), r30);
    ctr = r12;
    ctx->lr = 0x80132E4Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x80132DE8 func_80132DE8 preserves=true fpr_mask=0x00000000
