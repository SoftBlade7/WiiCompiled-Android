...
extern "C" void func_805F924C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805F924C:
{
    ...
    r3 = 0x809C0000u;
    r5 = 0x80890000u;
    f1.d = MemoryInline::FlatReadFloat32((r5 + 24928));
    r4 = 5;
...
// RECOMP_REGISTRATION base 0x805F924C func_805F924C preserves=true fpr_mask=0x00000000
