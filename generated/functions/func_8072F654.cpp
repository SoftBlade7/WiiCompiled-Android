...
extern "C" void func_8072F654(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_8072F654:
{
    ...
    r31 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r31 + 9792));
...
loc_8072F70C:
{
    ...
    r0 = (r0_rot_0 & 1);
    MemoryInline::FlatWrite8((r29 + 296), static_cast<uint8_t>(r0));
...
// RECOMP_GUEST_ABI gpr_read=0xE000000A gpr_write=0xE000003B gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x0000001F fpr_return=0x00000002 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8072F654 func_8072F654 preserves=true fpr_mask=0x00000000
