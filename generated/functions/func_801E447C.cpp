...
extern "C" void func_801E447C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_801E4508:
{
    ...
    if (MkwStateFreeAbiEnabled(0x801DA140u) && KnownTranslatedCpuCall<0x801DA140u>::kAvailable && !KnownTranslatedCpuCall<0x801DA140u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x801DA140u>()) {
        const auto state_free_result_801DA140_135D = func_801DA140_statefree_v0(r3, xer);
        r3 = static_cast<uint32_t>(state_free_result_801DA140_135D[0]);
        r4 = static_cast<uint32_t>(state_free_result_801DA140_135D[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFF7DF gpr_write=0xFFFFFFFF gpr_return=0x00000018 fpr_read=0xFFFFFFFF fpr_write=0xFFFFFFFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x801E447C func_801E447C preserves=true fpr_mask=0x00000000
