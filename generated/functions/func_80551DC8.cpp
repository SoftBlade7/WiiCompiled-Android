...
extern "C" void func_80551DC8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r3 = 0x80890000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + 4520));
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->fpr[1] = f1;
    ctx->cr = cr;
...
// RECOMP_REGISTRATION base 0x80551DC8 func_80551DC8 preserves=true fpr_mask=0x00000000
