...
extern "C" void func_806C06F0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806C07C0:
{
    r3 = MemoryInline::FlatRead8((r27 + 176));
    r0 = 0;
    MemoryInline::FlatWrite8((r27 + 177), static_cast<uint8_t>(r3));
    MemoryInline::FlatWrite8((r27 + 176), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x806C06F0 func_806C06F0 preserves=true fpr_mask=0x00000000
