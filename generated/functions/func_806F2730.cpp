...
extern "C" void func_806F2730(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806F2868:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r3 + 30656));
    r3 = (r1 + 128);
    r4 = (r1 + 68);
...
// RECOMP_REGISTRATION base 0x806F2730 func_806F2730 preserves=false fpr_mask=0xC0000000
