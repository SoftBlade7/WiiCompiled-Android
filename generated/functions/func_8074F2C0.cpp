...
extern "C" void func_8074F2C0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8074F2C0:
{
    ...
    r4 = 0x809C0000u;
    r5 = (r5 + -17064);
    f1.d = MemoryInline::FlatReadFloat32((r4 + 11444));
    f2.d = MemoryInline::FlatReadFloat32((r5 + 68));
    r4 = 1;
    f3.d = MemoryInline::FlatReadFloat32((r5 + 72));
...
// RECOMP_REGISTRATION base 0x8074F2C0 func_8074F2C0 preserves=true fpr_mask=0x00000000
