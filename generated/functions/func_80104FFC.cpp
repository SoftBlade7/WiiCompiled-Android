...
extern "C" void func_80104FFC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80105008:
{
    ...
    r28 = r3;
    r30 = MemoryInline::FlatRead32((r4 + 76));
    if (((cr & 0x20000000u) == 0)) {
        goto loc_80105030;
    }
}
...
loc_8010506C:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r9 = MemoryInline::FlatRead32((r30 + 8));
    r5 = r3;
    r8 = MemoryInline::FlatRead32((r30 + 4));
    r4 = (r1 + 8);
...
loc_801050C4:
{
    r30 = MemoryInline::FlatRead32((r30 + 12));
}
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFEFFF gpr_write=0xFC001FFB gpr_return=0x00000018 fpr_read=0xFFFFFFFF fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x80104FFC func_80104FFC preserves=true fpr_mask=0x00000000
