...
extern "C" void func_8076198C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807619F0:
{
    r12 = MemoryInline::FlatRead32((r29 + 176));
    r3 = (r29 + 176);
...
loc_80761A80:
{
    ...
    MemoryInline::FlatWrite8((r29 + 216), static_cast<uint8_t>(r0));
    goto loc_8076202C;
}
...
loc_80761ACC:
{
    ...
    MemoryInline::FlatWrite8((r29 + 216), static_cast<uint8_t>(r4));
    if (((cr & 0x40000000u) != 0)) {
        goto loc_80761AEC;
    }
}
...
loc_80761B10:
{
    ...
    MemoryInline::FlatWriteRamFloat64((r1 + 96), f3.d);
    ...
    r7 = fctiwzword1;
    r6 = fctiwzword2;
    r3 = MemoryInline::FlatRead32((r10 + 12088));
    ctx->lr = 0x80761B68u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_80761B6C:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x807624F0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x807625F0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80761BD0:
{
    ...
    r3 = (r1 + 68);
    r4_addr_2 = (r4 + r25);
    r26 = MemoryInline::FlatRead32(r4_addr_2);
    MemoryInline::FlatWrite32((r26 + 180), r27);
    r4 = (r26 + 276);
    r0 = MemoryInline::FlatRead32((r30 + 12));
    MemoryInline::FlatWrite32((r26 + 188), r0);
    ...
    f2.d = PPC_Fctiwz(f1.d);
    fctiwzword3 = PPC_FprLowWordInline(f3.d);
    MemoryInline::FlatWriteRamFloat64((r1 + 112), f3.d);
...
loc_80761C78:
{
    MemoryInline::FlatWrite8((r26 + 84), static_cast<uint8_t>(r27));
    r3 = (r1 + 80);
    r4 = (r26 + 88);
    ctx->lr = 0x80761C88u;
    ctx->gpr[0] = r0;
...
loc_80761CA4:
{
    ...
    MemoryInline::FlatWriteFloat32((r26 + 252), f0.d);
...
loc_80761CB4:
{
    f0.d = MemoryInline::FlatReadFloat32((r26 + 252));
    goto loc_80761CC4;
}
...
loc_80761CD0:
{
    ...
    MemoryInline::FlatWrite32((r26 + 240), r0);
    if (((cr & 0x80000000u) != 0)) {
        goto loc_80761B98;
    }
}
...
loc_80761D2C:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8075F254u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
{
    r3 = MemoryInline::FlatRead32((r29 + 32));
    r0 = MemoryInline::FlatRead8((r29 + 228));
...
loc_80761DAC:
{
    r5 = 0;
    r0 = 5;
    MemoryInline::FlatWrite32((r29 + 256), r5);
    r4 = 0;
    r3 = MemoryInline::FlatRead32((r29 + 32));
    MemoryInline::FlatWrite32((r29 + 188), r0);
    f1.d = MemoryInline::FlatReadFloat32(r31);
    MemoryInline::FlatWrite8((r29 + 228), static_cast<uint8_t>(r5));
    r12 = MemoryInline::FlatRead32(r3);
...
// RECOMP_REGISTRATION base 0x8076198C func_8076198C preserves=false fpr_mask=0xC0000000
