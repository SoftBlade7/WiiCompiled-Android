...
extern "C" void func_80547458(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r3 = (r3 + 65536);
    r3 = MemoryInline::FlatRead8((r3 + -27752));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80547458 func_80547458 preserves=true fpr_mask=0x00000000
