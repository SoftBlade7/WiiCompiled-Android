...
extern "C" void func_806E0DF0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806E0DF0:
{
    ...
    r0 = MemoryInline::FlatRead16((r7 + 70));
    r0 = (r0 << 16);
...
loc_806E0E2C:
{
    ...
    r3 = r7;
    r4 = MemoryInline::FlatRead16((r7 + 72));
    r4 = (r4 << 16);
...
loc_806E0F08:
{
    ...
    r6 = MemoryInline::FlatRead32((r3 + 268));
...
// RECOMP_REGISTRATION base 0x806E0DF0 func_806E0DF0 preserves=true fpr_mask=0x00000000
