...
extern "C" void func_805B46E8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r3 = MemoryInline::FlatRead32((r28 + 32));
    r27 = MemoryInline::FlatRead8((r3 + 136));
...
loc_805B47EC:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r3 + 10052));
    r3 = 0x80890000u;
...
loc_805B480C:
{
    ...
    ctx->fpr[0] = f0;
    ctx->cr = cr;
    InvokeDirectCpu<0x80566278u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x805B46E8 func_805B46E8 preserves=true fpr_mask=0x00000000
