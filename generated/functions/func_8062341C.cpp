...
extern "C" void func_8062341C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8062342C:
{
    ...
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x806200BCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
}
...
// RECOMP_REGISTRATION base 0x8062341C func_8062341C preserves=true fpr_mask=0x00000000
