...
extern "C" void func_805D2B90(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805D2B90:
{
    r0 = MemoryInline::FlatRead32((r20 + 8408));
    r3 = (r0 + r31);
    r0 = MemoryInline::FlatRead8((r3 + 9715));
}
...
loc_805D2BC0:
{
    MemoryInline::FlatWrite32((r16 + 464), r14);
    goto loc_805D2D1C;
}
...
{
    r0 = 6;
    MemoryInline::FlatWrite32((r16 + 464), r0);
    goto loc_805D2D1C;
}
...
loc_805D2AA8:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x805D2AA8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r14 = ctx->gpr[14];
...
// RECOMP_REGISTRATION base 0x805D2B90 func_805D2B90 preserves=true fpr_mask=0x00000000
