...
extern "C" void func_805F5984(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805F599C:
{
    ...
    ctx->gpr[3] = r3;
    ctx->cr = cr;
    InvokeDirectCpu<0x8059E598u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    cr = ctx->cr;
    xer = ctx->xer;
...
// RECOMP_REGISTRATION base 0x805F5984 func_805F5984 preserves=true fpr_mask=0x00000000
