...
extern "C" void func_801213D4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80121418:
{
    if ((static_cast<uint32_t>(r5) <= static_cast<uint32_t>(4096))) {
        goto loc_80121424;
    }
}
...
loc_80121478:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80120CB8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80121490:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80121224u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801214A8:
{
    r3 = MemoryInline::FlatRead32((r30 + 1716));
    r6 = 0;
    ctx->lr = 0x801214B4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80121558:
{
    if ((static_cast<int32_t>(r26) < static_cast<int32_t>(r31))) {
        goto loc_80121518;
    }
}
...
loc_inl6_cont_800EF4B0:
{
    ...
    r3 = r30;
    r12 = MemoryInline::FlatRead32((r30 + 1160));
    r4 = 2;
    r5 = r31;
    r6 = MemoryInline::FlatRead32((r30 + 1172));
    ctr = r12;
    ctx->lr = 0x8012159Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead32((r30 + 2008));
}
...
loc_801215CC:
{
    MemoryInline::FlatWrite32((r30 + 2008), r31);
    r31 = 0;
    goto loc_80121604;
}
...
loc_801215D8:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80121054u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801215F0:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80120E90u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80121604:
{
    ...
    r0 = MemoryInline::FlatRead32((r30 + 128));
    r5 = (r0 - r4);
    MemoryInline::FlatWrite32((r30 + 128), r5);
...
loc_80121648:
{
    r26 = MemoryInline::FlatRead32((r30 + 128));
...
loc_80121654:
{
    r27 = MemoryInline::FlatRead32((r13 + -29900));
    r3 = r27;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_80121668:
{
    ...
    r26 = MemoryInline::FlatRead32((r30 + 124));
    r3 = r28;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_80121690:
{
    ...
    r0 = (r26 + r3);
    r12 = MemoryInline::FlatRead32((r30 + 1160));
    MemoryInline::FlatWrite32((r30 + 1712), r0);
    r3 = r30;
    r6 = MemoryInline::FlatRead32((r30 + 1172));
    r4 = 5;
...
loc_80121704:
{
    ...
    r4 = -1;
    r3 = 1;
    MemoryInline::FlatWrite32((r30 + 1716), r4);
}
...
loc_80121798:
{
    r0 = -1;
    r27 = r30;
    MemoryInline::FlatWrite32((r30 + 1156), r0);
    r26 = 0;
    goto loc_801217F4;
}
...
loc_801217F4:
{
    r0 = MemoryInline::FlatRead32((r30 + 1152));
...
{
    r0 = 0;
    MemoryInline::FlatWrite32((r30 + 1152), r0);
}
...
// RECOMP_REGISTRATION base 0x801213D4 func_801213D4 preserves=true fpr_mask=0x00000000
