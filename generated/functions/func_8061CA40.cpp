...
extern "C" void func_8061CA40(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8061CA78:
{
    ...
    r3 = MemoryInline::FlatRead32((r4 + 7736));
    r3 = MemoryInline::FlatRead32(r3);
    MemoryInline::FlatWrite8((r3 + 906), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x8061CA40 func_8061CA40 preserves=true fpr_mask=0x00000000
