...
extern "C" void func_80738A4C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80738A7C:
{
    ...
    MemoryInline::FlatWrite32((r31 + 504), r0);
...
// RECOMP_REGISTRATION base 0x80738A4C func_80738A4C preserves=true fpr_mask=0x00000000
