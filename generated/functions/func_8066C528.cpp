...
extern "C" void func_8066C528(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8066C528:
{
    ...
    r0 = (r0_rot_0 & -4);
    r3 = (r3 + r0);
    r0 = MemoryInline::FlatRead32((r3 + 31220));
    r0 = (r6 & r0);
...
// RECOMP_REGISTRATION base 0x8066C528 func_8066C528 preserves=true fpr_mask=0x00000000
