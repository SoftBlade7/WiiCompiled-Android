...
extern "C" void func_80808A8C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80808B18:
{
    ...
    f1.d = MemoryInline::FlatReadFloat64((r28 + 40));
    r27 = 0;
    r0 = (r26 + r3);
...
// RECOMP_REGISTRATION base 0x80808A8C func_80808A8C preserves=false fpr_mask=0x80000000
