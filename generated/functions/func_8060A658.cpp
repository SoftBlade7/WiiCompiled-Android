...
extern "C" void func_8060A658(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r0 = 1;
    MemoryInline::FlatWrite8((r3 + 7196), static_cast<uint8_t>(r0));
    ctx->gpr[0] = r0;
    ctx->cr = cr;
    return;
}
...
// RECOMP_REGISTRATION base 0x8060A658 func_8060A658 preserves=true fpr_mask=0x00000000
