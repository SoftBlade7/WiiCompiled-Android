...
extern "C" void func_8053B884(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8053B8BC:
{
    MemoryInline::FlatWrite16((r31 + 34), static_cast<uint16_t>(r30));
    r0 = 0;
    r3 = 0x808B0000u;
    r5 = 1;
    r3 = (r3 + 11588);
...
// RECOMP_REGISTRATION base 0x8053B884 func_8053B884 preserves=true fpr_mask=0x00000000
