...
extern "C" void func_805E1108(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805E1190:
{
    r0 = MemoryInline::FlatRead32((r26 + 156));
...
// RECOMP_REGISTRATION base 0x805E1108 func_805E1108 preserves=true fpr_mask=0x00000000
