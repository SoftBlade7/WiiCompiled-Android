...
extern "C" void func_80076250(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800762D0:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead32((r28 + 232));
    r3 = 0x80270000u;
    r3 = (r3 + 13004);
...
loc_80076468:
{
    r0 = MemoryInline::FlatRead16((r28 + 218));
    r0 = (r0 & 16);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_80076474:
{
    r0 = MemoryInline::FlatRead8((r28 + 216));
    r0 = (r0 & 4);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
// RECOMP_REGISTRATION base 0x80076250 func_80076250 preserves=true fpr_mask=0x00000000
