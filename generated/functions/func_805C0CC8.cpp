...
extern "C" void func_805C0CC8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805C0CC8:
{
    ...
    r3 = (r29 + 212);
    r4 = 0x808B0000u;
    guest_range_1 = MemoryInline::ResolveRangeHost((r29 + 212), 0, 36u, true, false);
    r30 = MemoryInline::ReadResolved32(guest_range_1, 0u, (r29 + 212));
    r7 = (r7 + 31536);
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r10 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r29 + 224));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r7 = MemoryInline::ReadResolved32(guest_range_1, 24u, (r29 + 236));
...
// RECOMP_REGISTRATION base 0x805C0CC8 func_805C0CC8 preserves=true fpr_mask=0x00000000
