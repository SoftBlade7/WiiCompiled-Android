...
extern "C" void func_800CD4E0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800CD4E0:
{
    ...
    r29 = MemoryInline::FlatRead32((r7 + 12));
    r27 = r6;
    r31 = r7;
    r5 = r25;
    r4 = (r4 + 22908);
...
loc_800CD5A4:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x800CDAE4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800CD610:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x800CDC0Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x800CD4E0 func_800CD4E0 preserves=true fpr_mask=0x00000000
