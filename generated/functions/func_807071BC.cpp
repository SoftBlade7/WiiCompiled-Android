...
extern "C" void func_807071BC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
{
    r3 = (r3 + -136);
    // inline leaf 0x807053B0 (6 guest instruction(s))
    ...
    // end of inlined leaf 0x807053B0
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[5] = r5;
    return;
...
// RECOMP_REGISTRATION base 0x807071BC func_807071BC preserves=true fpr_mask=0x00000000
