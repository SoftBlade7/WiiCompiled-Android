...
extern "C" void func_805D38A8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805D38A8:
{
    ...
    r8 = 1;
    r10 = MemoryInline::FlatRead32((r28 + 20));
    r9 = 0;
    ...
    cr = ctx->cr;
    r0 = 0;
    MemoryInline::FlatWrite32((r26 + 596), r27);
    r3 = (r26 + 152);
    r4 = 4;
    MemoryInline::FlatWrite32((r26 + 604), r0);
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFE7BE gpr_write=0xFFFFFFFF gpr_return=0x00000018 fpr_read=0xFFFFFFFF fpr_write=0xFFFFFFFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x805D38A8 func_805D38A8 preserves=true fpr_mask=0x00000000
