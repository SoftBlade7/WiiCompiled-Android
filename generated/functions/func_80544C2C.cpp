...
extern "C" void func_80544C2C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80544C2C:
{
    ...
    r29 = r3;
    r0 = MemoryInline::FlatRead8((r4 + 20482));
...
loc_80544C58:
{
    ...
    MemoryInline::FlatWrite32((r4 + 20484), r0);
    goto loc_80544CBC;
}
...
// RECOMP_REGISTRATION base 0x80544C2C func_80544C2C preserves=true fpr_mask=0x00000000
