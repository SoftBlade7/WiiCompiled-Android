...
extern "C" void func_80546388(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_80546388:
{
    ...
    r3_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(18));
    r3 = (r3_rot_0 & 3);
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
extern "C" MKW_PPC_NO_INLINE uint64_t func_80546388_statefree(uint32_t native_r3, uint32_t native_r4, uint32_t native_r5)
{
...
loc_80546388:
{
    ...
    r3_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(cached_r0), static_cast<uint32_t>(18));
...
// RECOMP_STATE_FREE_ABI address=0x80546388 symbol=func_80546388_statefree gpr_in=0x00000038 gpr_out=0x00000008 fpr_in=0x00000000 fpr_out=0x00000000 cr_in=0x00 cr_out=0x00 gqr_in=0x00 hid_in=0x00 hid_out=0x00 xer_in=0 ctr_in=0 lr_in=0
...
// RECOMP_REGISTRATION base 0x80546388 func_80546388 preserves=true fpr_mask=0x00000000
