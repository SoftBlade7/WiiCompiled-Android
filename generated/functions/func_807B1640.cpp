...
extern "C" void func_807B1640(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807B175C:
{
    r3 = 0x809C0000u;
    // psq_load w=0 quant=0 (using PPC_PsqL)
    PpcSetPairedFprInline(f0, PPC_PsqLGqrInline<0u, 0u>(ctx, mkw_gqr0, r25));
...
loc_807B17E4:
{
    ...
    // psq_load w=1 quant=0 (using PPC_PsqL)
    r27_psq_tmp_5 = (r27 + 8);
    PpcSetPairedFprInline(f0, PPC_PsqLStackInline<1u, 0u>(ctx, r27_psq_tmp_5));
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    PPC_PsqStStackInline<0u, 0u>(ctx, r27, f1.d);
    // psq_load w=1 quant=0 (using PPC_PsqL)
    r26_psq_tmp_2 = (r26 + 8);
    ...
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r27_psq_tmp_6 = (r27 + 8);
    PPC_PsqStStackInline<1u, 0u>(ctx, r27_psq_tmp_6, f1.d);
    r0 = MemoryInline::FlatRead8((r24 + 24));
    ...
    r3 = 60;
    MemoryInline::FlatWrite32((r28 + 468), r3);
    r4 = r29;
...
// RECOMP_REGISTRATION base 0x807B1640 func_807B1640 preserves=false fpr_mask=0x80000000
