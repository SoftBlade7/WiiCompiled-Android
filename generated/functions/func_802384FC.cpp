...
extern "C" void func_802384FC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80238528:
{
    // inline leaf 0x80238580 (14 guest instruction(s))
    r4 = 0x802A0000u;
    r0 = 0;
    r4 = (r4 + 15568);
    ...
    // end of inlined leaf 0x80238580
}

loc_8023852C:
{
    MemoryInline::FlatWrite32((r13 + -23832), r3);
...
// RECOMP_REGISTRATION base 0x802384FC func_802384FC preserves=true fpr_mask=0x00000000
