...
extern "C" void func_80024190(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80024190:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r13 + -27448), r3);
    r4 = 0;
    ctx->lr = 0x800241C4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80024230:
{
    MemoryInline::FlatWrite32((r13 + -27444), r31);
...
// RECOMP_REGISTRATION base 0x80024190 func_80024190 preserves=true fpr_mask=0x00000000
