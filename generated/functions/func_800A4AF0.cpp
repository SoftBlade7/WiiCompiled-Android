...
extern "C" void func_800A4AF0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
    uint32_t r3_rot_1 = 0;
...
loc_800A4B24:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r31 = MemoryInline::FlatRead32((r27 + 892));
    r30 = (r27 + 892);
    goto loc_800A4B54;
}
...
loc_800A4B5C:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8008CFA0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80088AE0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r30 = MemoryInline::FlatRead32((r27 + 904));
    r31 = (r27 + 904);
    goto loc_800A4B98;
}
...
loc_800A4BA0:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8008FC80u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x800AC940u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    // end of inlined leaf 0x801AAD74
    r0 = (r3 - r29);
    r30 = MemoryInline::FlatRead32((r27 + 892));
    MemoryInline::FlatWrite32((r27 + 912), r0);
    r31 = (r27 + 892);
    goto loc_800A4BE4;
}
...
// RECOMP_REGISTRATION base 0x800A4AF0 func_800A4AF0 preserves=true fpr_mask=0x00000000
