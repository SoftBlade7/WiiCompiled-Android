...
extern "C" void func_806190E0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806190E0:
{
    ...
    f2.d = MemoryInline::FlatReadFloat32((r5 + 80));
    f3.d = MemoryInline::FlatReadFloat32((r5 + 96));
    ctx->gpr[5] = r5;
    ctx->fpr[1] = f1;
    ctx->fpr[2] = f2;
    ctx->fpr[3] = f3;
...
// RECOMP_REGISTRATION base 0x806190E0 func_806190E0 preserves=true fpr_mask=0x00000000
