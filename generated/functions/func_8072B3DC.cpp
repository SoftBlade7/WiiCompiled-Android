...
extern "C" void func_8072B3DC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8072B3DC:
{
    ...
    r4 = 0x808A0000u;
    r3 = 0x808D0000u;
    f1.d = MemoryInline::FlatReadFloat32((r4 + 9560));
    r5 = 0;
    f0.d = MemoryInline::FlatReadFloat32((r3 + -25208));
    r0 = 1;
...
// RECOMP_REGISTRATION base 0x8072B3DC func_8072B3DC preserves=true fpr_mask=0x00000000
