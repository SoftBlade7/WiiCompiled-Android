...
extern "C" void func_802301D0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_802301D0:
{
    f2.d = MemoryInline::FlatReadFloat32((r2 + -24944));
    ...
    f2.d = MemoryInline::FlatReadFloat32((r2 + -24956));
    ...
    f4.d = PpcFmulsInline(f6.d, f7.d);
    f3.d = PpcFmulsInline(f3.d, f8.d);
    f1.d = static_cast<double>(PpcForceSingleValueInline(f2.d - f11.d));
...
// RECOMP_REGISTRATION base 0x802301D0 func_802301D0 preserves=true fpr_mask=0x00000000
