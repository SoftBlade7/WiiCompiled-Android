...
extern "C" void func_80733B1C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80733B1C:
{
    ...
    MemoryInline::FlatWrite8((r31 + 418), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x80733B1C func_80733B1C preserves=true fpr_mask=0x00000000
