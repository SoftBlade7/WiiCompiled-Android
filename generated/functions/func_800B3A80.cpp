...
extern "C" void func_800B3A80(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800B3A80:
{
    ...
    f2.d = MemoryInline::FlatReadFloat64((r2 + -27832));
...
// RECOMP_REGISTRATION base 0x800B3A80 func_800B3A80 preserves=true fpr_mask=0x00000000
