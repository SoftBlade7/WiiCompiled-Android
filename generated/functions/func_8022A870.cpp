...
extern "C" void func_8022A870(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8022A89C:
{
    ...
    r5 = r28;
    r0 = MemoryInline::FlatRead32((r27 + 10364));
    r3_addr_2 = (r3 + r30);
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8022C09Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_GUEST_ABI gpr_read=0xFC00003E gpr_write=0xFC00003B gpr_return=0x00000018 fpr_read=0x00001F7F fpr_write=0x00001FFF fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8022A870 func_8022A870 preserves=true fpr_mask=0x00000000
