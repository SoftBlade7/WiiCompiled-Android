...
extern "C" void func_80725170(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80725170:
{
    ...
    r28 = MemoryInline::FlatRead32((r3 + 528));
    ...
    MemoryInline::WriteResolvedFloat32(guest_range_0, 64u, (r3 + 8), f4.d);
    f0.d = static_cast<double>(PpcForceSingleValueInline(f1.d - f0.d));
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 56u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f2.d))))) {
    ...
    r0 = MemoryInline::FlatRead32((r29 + 484));
...
loc_80725268:
{
    ...
    // end of inlined leaf 0x8071EFD8
    r3 = 0x808D0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + -27204));
...
loc_807252E8:
{
    ...
    MemoryInline::FlatWrite8((r30 + 320), static_cast<uint8_t>(r0));
    r0 = 0;
    MemoryInline::FlatWrite8((r30 + 328), static_cast<uint8_t>(r0));
    goto loc_80725304;
}
...
// RECOMP_REGISTRATION base 0x80725170 func_80725170 preserves=false fpr_mask=0x80000000
