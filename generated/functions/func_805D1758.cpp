...
extern "C" void func_805D1758(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805D17AC:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x805D1214u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    xer = ctx->xer;
    r29_addr_0 = (r29 + r30);
    MemoryInline::FlatWrite32(r29_addr_0, r31);
...
// RECOMP_REGISTRATION base 0x805D1758 func_805D1758 preserves=true fpr_mask=0x00000000
