...
extern "C" void func_805AD81C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805AD854:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r3 + 27808));
...
// RECOMP_REGISTRATION base 0x805AD81C func_805AD81C preserves=true fpr_mask=0x00000000
