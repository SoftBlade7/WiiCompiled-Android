...
extern "C" void func_80159D50(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80159DA4:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite16((r30 + 1138), static_cast<uint16_t>(r31));
    goto loc_80159DD4;
}
...
// RECOMP_REGISTRATION base 0x80159D50 func_80159D50 preserves=true fpr_mask=0x00000000
