...
extern "C" void func_80170614(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80170618:
{
    if ((static_cast<uint32_t>(r5) > static_cast<uint32_t>(60))) {
        goto loc_80170658;
    }
}
...
loc_8017061C:
{
    ...
    r8 = (r8 + -23656);
    r8_addr_1 = (r8 + r0);
    r8 = MemoryInline::FlatRead32(r8_addr_1);
    ctr = r8;
...
// RECOMP_REGISTRATION base 0x80170614 func_80170614 preserves=true fpr_mask=0x00000000
