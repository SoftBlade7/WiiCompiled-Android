...
extern "C" void func_8077763C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8077763C:
{
    ...
    r27 = 0;
    MemoryInline::FlatWrite32((r3 + 176), r27);
    r4 = 0x808A0000u;
    r5 = MemoryInline::FlatRead32((r3 + 160));
    MemoryInline::FlatWrite32((r3 + 180), r27);
    r6 = 0x808A0000u;
    r26 = MemoryInline::FlatRead32((r4 + 26316));
    r6 = (r6 + 17024);
    MemoryInline::FlatWrite32((r3 + 192), r27);
    r31 = r3;
    ...
    f31.d = MemoryInline::FlatReadFloat32(r6);
    MemoryInline::FlatWrite32((r3 + 184), r27);
    f29.d = MemoryInline::FlatReadFloat32((r6 + 12));
...
loc_807776C0:
{
    ...
    MemoryInline::FlatWriteRamFloat32((r1 + 120), f31.d);
    MemoryInline::FlatWriteRamFloat32((r1 + 124), f31.d);
    ...
    MemoryInline::FlatWriteRamFloat32((r1 + 64), f31.d);
...
loc_8077773C:
{
    ...
    MemoryInline::FlatWriteFloat32((r31 + 216), f1.d);
    MemoryInline::FlatWrite16((r31 + 44), static_cast<uint16_t>(r0));
...
loc_807777FC:
{
    ...
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 216), 0, 80u, true, false);
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 56u, (r1 + 272));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f30.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 40u, (r1 + 256));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f29.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 24u, (r1 + 240));
    r11 = (r1 + 240);
    ...
    r0 = MemoryInline::ReadResolved32(guest_range_1, 76u, (r1 + 292));
    ctx->lr = r0;
    r1 = (r1 + 288);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x8077763C func_8077763C preserves=false fpr_mask=0xE0000000
