...
extern "C" void func_800DB838(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800DB838:
{
    ...
    MemoryInline::FlatWrite32((r3 + 1916), r28);
}
...
// RECOMP_REGISTRATION base 0x800DB838 func_800DB838 preserves=true fpr_mask=0x00000000
