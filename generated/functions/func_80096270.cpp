...
extern "C" void func_80096270(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80096270:
{
    r3 = MemoryInline::FlatRead8((r3 + 234));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80096270 func_80096270 preserves=true fpr_mask=0x00000000
