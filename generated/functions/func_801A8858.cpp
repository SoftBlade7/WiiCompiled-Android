...
extern "C" void func_801A8858(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801A8858:
{
    ...
    ctx->gpr[5] = r5;
    ctx->cr = cr;
    InvokeDirectCpu<0x801A8758u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x801A8858 func_801A8858 preserves=true fpr_mask=0x00000000
