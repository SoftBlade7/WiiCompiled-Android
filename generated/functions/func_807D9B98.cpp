...
extern "C" void func_807D9B98(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_807D9B98:
{
    ...
    r31 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r31 + 30112));
    MemoryInline::FlatWriteRam32((r1 + 40), r30);
    r30 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r30 + 30116));
    MemoryInline::FlatWriteRam32((r1 + 36), r29);
    r29 = r4;
    MemoryInline::FlatWriteRam32((r1 + 32), r28);
    r28 = r3;
    guest_range_0 = MemoryInline::ResolveRangeHost((r3 + 4), 0, 64u, false, true);
    ...
    f1.d = MemoryInline::FlatReadFloat32((r30 + 30116));
    f0.d = MemoryInline::FlatReadFloat32((r3 + 4));
    MemoryInline::WriteResolvedFloat32(guest_range_0, 16u, (r28 + 20), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r31 + 30112));
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 20u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f2.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f1.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 20u, (r28 + 24), f2.d);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 28u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f0.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 28u, (r28 + 32), f0.d);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 32u, (r28 + 36), f0.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 36u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f1.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 36u, (r28 + 40), f0.d);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 40u, (r28 + 44), f1.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 44u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f0.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 44u, (r28 + 48), f0.d);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 48u, (r28 + 52), f0.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 52u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f1.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 52u, (r28 + 56), f0.d);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 56u, (r28 + 60), f1.d);
    }
    ctx->lr = 0x807D9C30u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_807D9C3C:
{
    r4 = 0x809C0000u;
    r3 = r29;
    r31 = MemoryInline::FlatRead32((r4 + 6484));
...
loc_807D9C70:
{
    ...
    // inline leaf 0x807D37B4 (7 guest instruction(s))
    ...
    // end of inlined leaf 0x807D37B4
...
loc_807D9D08:
{
    ...
    r3 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 30112));
    r3 = r28;
...
// RECOMP_REGISTRATION base 0x807D9B98 func_807D9B98 preserves=true fpr_mask=0x00000000
