...
extern "C" uint64_t func_8063F160_statefree(uint32_t, uint32_t);
extern "C" void func_8063F160_statefree_v0(uint32_t, uint32_t);

extern "C" void func_80849C24(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80849C60:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8084A3F8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80849C98:
{
    r3 = MemoryInline::FlatRead32((r5 + 1752));
...
{
    r3 = r26;
    r4 = PPC_Slw(static_cast<uint32_t>(r29), static_cast<uint32_t>(r24));
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x8063F160u) && KnownTranslatedCpuCall<0x8063F160u>::kAvailable && !KnownTranslatedCpuCall<0x8063F160u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x8063F160u>()) {
        func_8063F160_statefree_v0(r3, r4);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
        ...
        ctx->cr = cr;
        ctx->ctr = ctr;
        InvokeDirectCpu<0x8063F160u>(ctx);
        r0 = ctx->gpr[0];
        r1 = ctx->gpr[1];
        r3 = ctx->gpr[3];
        r4 = ctx->gpr[4];
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r25 + 3996), r24);
    r27 = (r27 + 4);
    r26 = (r26 + 1480);
    r24 = (r24 + 1);
    MemoryInline::FlatWrite8((r25 + 4001), static_cast<uint8_t>(r29));
    r25 = (r25 + 1480);
}
...
loc_80849D1C:
{
    MemoryInline::FlatWrite8((r28 + 2112), static_cast<uint8_t>(r29));
    r3 = r27;
    r4 = 0;
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x8063F160u) && KnownTranslatedCpuCall<0x8063F160u>::kAvailable && !KnownTranslatedCpuCall<0x8063F160u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x8063F160u>()) {
        const auto state_free_result_8063F160_2992 = func_8063F160_statefree(r3, r4);
        r3 = static_cast<uint32_t>(state_free_result_8063F160_2992);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_80849D60:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805BDBD4u) && KnownTranslatedCpuCall<0x805BDBD4u>::kAvailable && !KnownTranslatedCpuCall<0x805BDBD4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805BDBD4u>()) {
        const auto state_free_result_805BDBD4_33D3 = func_805BDBD4_statefree(r3, r4);
        r3 = static_cast<uint32_t>(state_free_result_805BDBD4_33D3);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80849C24 func_80849C24 preserves=true fpr_mask=0x00000000
