...
extern "C" void func_80526C4C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r0 = 0;
    MemoryInline::FlatWriteRam32((r4 + -10480), r0);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_return;
    }
}
...
// RECOMP_REGISTRATION base 0x80526C4C func_80526C4C preserves=true fpr_mask=0x00000000
