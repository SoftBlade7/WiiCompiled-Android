...
extern "C" void func_807025C8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807025C8:
{
    r3 = (r3 + -84);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80701794u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x807025C8 func_807025C8 preserves=true fpr_mask=0x00000000
