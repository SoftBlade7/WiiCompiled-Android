...
extern "C" void func_806AEAC8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806AEAC8:
{
    ...
    r30 = r3;
    guest_range_0 = MemoryInline::ResolveRangeHost((r3 + 11), 0, 2721u, true, false);
    r4 = MemoryInline::ReadResolved32(guest_range_0, 281u, (r3 + 292));
}
...
loc_806AEB5C:
{
    f31.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 1257u, (r3 + 1268));
    goto loc_806AEB70;
}
...
loc_806AEB6C:
{
    f31.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 1249u, (r3 + 1260));
}
...
loc_806AEBAC:
{
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 2717u, (r3 + 2728));
...
loc_806AEBC4:
{
    f0.d = static_cast<double>(PpcForceSingleValueInline(f31.d - f3.d));
...
// RECOMP_REGISTRATION base 0x806AEAC8 func_806AEAC8 preserves=false fpr_mask=0x80000000
