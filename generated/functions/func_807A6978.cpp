...
extern "C" void func_807A6978(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r5 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r5 + 22080));
    ctx->lr = 0x807A69E4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x807A6978 func_807A6978 preserves=true fpr_mask=0x00000000
