...
extern "C" void func_8060D4B4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_8060D4B4:
{
    ...
    r30 = r3;
    r12 = MemoryInline::FlatRead32((r3 + 2832));
    ...
    if (MkwStateFreeAbiEnabled(0x805F0DB4u) && KnownTranslatedCpuCall<0x805F0DB4u>::kAvailable && !KnownTranslatedCpuCall<0x805F0DB4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805F0DB4u>()) {
        const auto state_free_result_805F0DB4_9F4 = func_805F0DB4_statefree_v0(r3, r4, cr, xer);
        cr = static_cast<uint32_t>(state_free_result_805F0DB4_9F4);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    xer = ctx->xer;
    r0 = -1;
    MemoryInline::FlatWrite32((r30 + 3460), r0);
    r3 = 0x809C0000u;
...
// RECOMP_REGISTRATION base 0x8060D4B4 func_8060D4B4 preserves=true fpr_mask=0x00000000
