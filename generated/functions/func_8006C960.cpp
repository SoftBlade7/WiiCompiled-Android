...
extern "C" void func_8006C960(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8006C9CC:
{
    f1.d = MemoryInline::FlatReadFloat32((r2 + -29336));
    r3 = 1;
...
// RECOMP_REGISTRATION base 0x8006C960 func_8006C960 preserves=true fpr_mask=0x00000000
