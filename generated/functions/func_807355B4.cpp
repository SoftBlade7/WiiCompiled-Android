...
extern "C" void func_807355B4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807355B4:
{
    ...
    ctx->gpr[31] = r31;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80735600u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r12 = ctx->gpr[12];
...
// RECOMP_REGISTRATION base 0x807355B4 func_807355B4 preserves=true fpr_mask=0x00000000
