...
extern "C" void func_80615378(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80615378:
{
    ...
    r5 = 0x80890000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r5 + 29736));
    ctx->lr = 0x806153A0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80615378 func_80615378 preserves=true fpr_mask=0x00000000
