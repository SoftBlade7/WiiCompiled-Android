...
extern "C" void func_807070BC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807070BC:
{
    r3 = (r3 + -140);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x807054CCu>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x807070BC func_807070BC preserves=true fpr_mask=0x00000000
