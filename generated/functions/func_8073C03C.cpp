...
extern "C" void func_8073C03C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
// RECOMP_GUEST_ABI gpr_read=0xC0000073 gpr_write=0xC000003B gpr_return=0x00000018 fpr_read=0x0000005F fpr_write=0x0000007F fpr_return=0x00000002 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8073C03C func_8073C03C preserves=true fpr_mask=0x00000000
