...
extern "C" void func_8022DA48(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8022DA48:
{
    ...
    ctx->gpr[4] = r4;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x802189D8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8022DA48 func_8022DA48 preserves=true fpr_mask=0x00000000
