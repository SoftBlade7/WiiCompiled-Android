...
extern "C" void func_80723AF8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80723AF8:
{
    ...
    f31.d = MemoryInline::FlatReadFloat32((r4 + 24));
    ctx->lr = 0x80723B50u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFEFEE gpr_write=0x800018FB gpr_return=0x00000018 fpr_read=0xFFFFFFE2 fpr_write=0xC000001F fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x80723AF8 func_80723AF8 preserves=false fpr_mask=0xC0000000
