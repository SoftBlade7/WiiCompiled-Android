...
extern "C" void func_80848F94(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8084903C:
{
    r5 = MemoryInline::FlatRead32((r29 + 3484));
}
...
loc_808490C0:
{
    r5 = MemoryInline::FlatRead32((r29 + 68));
    r3 = r22;
    r4 = (r26 + 335);
    r6 = (r31 & 255);
    r7 = 0;
...
loc_8084913C:
{
    MemoryInline::FlatWrite8((r22 + 128), static_cast<uint8_t>(r27));
    if (((cr & 0x20000000u) == 0)) {
        goto loc_8084914C;
    }
}
...
loc_80849198:
{
    r4 = MemoryInline::FlatRead32((r29 + 1724));
    r3 = r22;
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x805BDBD4u) && KnownTranslatedCpuCall<0x805BDBD4u>::kAvailable && !KnownTranslatedCpuCall<0x805BDBD4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805BDBD4u>()) {
        const auto state_free_result_805BDBD4_4786 = func_805BDBD4_statefree(r3, r4);
        r3 = static_cast<uint32_t>(state_free_result_805BDBD4_4786);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_808491AC:
{
    MemoryInline::FlatWrite8((r22 + 128), static_cast<uint8_t>(r28));
    if (((cr & 0x20000000u) == 0)) {
        goto loc_808491BC;
    }
}
...
loc_80849208:
{
    ...
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x805BDBD4u) && KnownTranslatedCpuCall<0x805BDBD4u>::kAvailable && !KnownTranslatedCpuCall<0x805BDBD4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805BDBD4u>()) {
        const auto state_free_result_805BDBD4_572B = func_805BDBD4_statefree(r3, r4);
        r3 = static_cast<uint32_t>(state_free_result_805BDBD4_572B);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80848F94 func_80848F94 preserves=true fpr_mask=0x00000000
