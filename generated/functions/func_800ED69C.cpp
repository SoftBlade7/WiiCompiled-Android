...
extern "C" void func_800ED69C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800ED69C:
{
    ...
    r4 = r3;
    r3 = 12;
    r12 = MemoryInline::FlatRead32((r5 + 23344));
    ctr = r12;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
...
// RECOMP_REGISTRATION base 0x800ED69C func_800ED69C preserves=true fpr_mask=0x00000000
