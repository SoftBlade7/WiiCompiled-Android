...
extern "C" void func_8073BC28(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8073BC60:
{
    ...
    r3 = MemoryInline::FlatRead32((r31 + -10520));
    r31 = MemoryInline::FlatRead8((r4 + 45));
    r4 = r31;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8073BC28 func_8073BC28 preserves=true fpr_mask=0x00000000
