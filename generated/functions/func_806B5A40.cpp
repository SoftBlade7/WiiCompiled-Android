...
extern "C" void func_806B5A40(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806B5A40:
{
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 68u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f1.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 68u, r3, f0.d);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 72u, (r3 + 4), f1.d);
    }
    MemoryInline::WriteResolvedFloat32(guest_range_0, 76u, (r3 + 8), f2.d);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 56u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f1.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 56u, r3, f0.d);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 60u, (r3 + 4), f1.d);
    }
    MemoryInline::WriteResolvedFloat32(guest_range_0, 64u, (r3 + 8), f2.d);
    // end of inlined leaf 0x80537B80
    r4 = r31;
    r3 = (r1 + 44);
    r5 = 3;
...
// RECOMP_REGISTRATION base 0x806B5A40 func_806B5A40 preserves=true fpr_mask=0x00000000
