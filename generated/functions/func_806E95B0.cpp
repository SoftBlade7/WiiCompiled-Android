...
extern "C" void func_806E95B0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
    uint32_t r0_rot_2 = 0;
...
loc_806E95B0:
{
    ...
    r30 = (r29 + 16052);
    r0 = 3;
    guest_range_0 = MemoryInline::ResolveRangeHost(r31, 0, 208u, false, true);
    MemoryInline::WriteResolved16(guest_range_0, 180u, (r31 + 180), static_cast<uint16_t>(r28));
    r3 = 6;
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 184u, ((static_cast<uint64_t>(static_cast<uint32_t>(r6)) << 32) | static_cast<uint32_t>(r28)))) {
        MemoryInline::WriteResolved32(guest_range_0, 184u, (r31 + 184), r6);
        MemoryInline::WriteResolved32(guest_range_0, 188u, (r31 + 188), r28);
    }
    MemoryInline::WriteResolved32(guest_range_0, 0u, r31, r5);
    MemoryInline::WriteResolved32(guest_range_0, 176u, (r31 + 176), r4);
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 200u, ((static_cast<uint64_t>(static_cast<uint32_t>(r30)) << 32) | static_cast<uint32_t>(r31)))) {
        MemoryInline::WriteResolved32(guest_range_0, 204u, (r31 + 204), r31);
        MemoryInline::WriteResolved32(guest_range_0, 200u, (r31 + 200), r30);
    }
    MemoryInline::WriteResolved16(guest_range_0, 192u, (r31 + 192), static_cast<uint16_t>(r0));
    ctx->lr = 0x806E9624u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r0 = MemoryInline::FlatRead16((r29 + 16052));
    r4 = MemoryInline::FlatRead32((r31 + 196));
    ...
    MemoryInline::FlatWriteFloat32((r31 + 928), f2.d);
    MemoryInline::FlatWriteFloat32((r31 + 932), f1.d);
    MemoryInline::FlatWriteFloat32((r31 + 936), f0.d);
    ctx->lr = 0x806E969Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->fpr[1] = f1;
    ctx->fpr[2] = f2;
    InvokeDirectCpu<0x806EB86Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x806E95B0 func_806E95B0 preserves=true fpr_mask=0x00000000
