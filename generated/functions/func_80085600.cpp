...
extern "C" void func_80085600(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80085600:
{
    ...
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r3_psq_tmp_2 = (r3 + 16);
    PPC_PsqStGqrInline<0u, 0u>(ctx, mkw_gqr0, r3_psq_tmp_2, f2.d);
...
// RECOMP_REGISTRATION base 0x80085600 func_80085600 preserves=true fpr_mask=0x00000000
