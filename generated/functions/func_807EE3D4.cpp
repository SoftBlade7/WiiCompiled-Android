...
extern "C" void func_807EE3D4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807EE3D4:
{
    ...
    r5 = 0x808B0000u;
    r4 = 1;
    f1.d = MemoryInline::FlatReadFloat32((r5 + -26008));
    ctx->lr = 0x807EE3FCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x807EE3D4 func_807EE3D4 preserves=true fpr_mask=0x00000000
