...
extern "C" void func_80616A48(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr1_0 = 0;
...
loc_80616A48:
{
    ...
    r29 = MemoryInline::FlatRead32((r7 + 8));
...
{
    r30 = 0x80890000u;
    MemoryInline::FlatWrite32((r31 + 392), r29);
    r30 = (r30 + 30688);
    r3 = (r31 + 168);
    r4 = (r30 + 12);
    ctx->lr = 0x80616B50u;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r31 + 396), r3);
...
loc_80616B60:
{
    ...
    MemoryInline::FlatWrite32((r31 + 372), r26);
    MemoryInline::FlatWrite32((r31 + 376), r27);
    MemoryInline::FlatWrite32((r31 + 380), r28);
    if (((cr & 0x08000000u) != 0)) {
        goto loc_80616BFC;
    }
}
...
loc_80616B78:
{
    r5 = MemoryInline::FlatRead32((r31 + 392));
    r3 = r31;
    r6 = r28;
    r4 = (r30 + 21);
    r5 = (r5 + 372);
...
// RECOMP_REGISTRATION base 0x80616A48 func_80616A48 preserves=true fpr_mask=0x00000000
