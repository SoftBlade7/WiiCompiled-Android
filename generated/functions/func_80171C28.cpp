...
extern "C" void func_80171C28(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80171C28:
{
    ...
    r3 = MemoryInline::FlatRead32((r5 + 372));
...
// RECOMP_REGISTRATION base 0x80171C28 func_80171C28 preserves=true fpr_mask=0x00000000
