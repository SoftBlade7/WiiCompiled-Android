...
extern "C" void func_806AABA8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806AABD8:
{
    r3 = MemoryInline::FlatRead32((r3 + 556));
...
// RECOMP_REGISTRATION base 0x806AABA8 func_806AABA8 preserves=true fpr_mask=0x00000000
