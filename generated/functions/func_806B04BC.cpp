...
extern "C" void func_806B04BC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806B04E4:
{
    r0 = MemoryInline::FlatRead32((r3 + 856));
...
loc_806B04F8:
{
    r0 = MemoryInline::FlatRead32((r3 + 824));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_806B0540:
{
    f0.d = MemoryInline::FlatReadFloat32((r3 + 1316));
...
loc_806B0554:
{
    f0.d = MemoryInline::FlatReadFloat32((r3 + 1284));
    MemoryInline::FlatWriteFloat32((r3 + 2716), f0.d);
}
...
loc_806B056C:
{
    r0 = MemoryInline::FlatRead8((r3 + 186));
}
...
{
    r4 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 1776));
...
loc_806B05A0:
{
    f0.d = MemoryInline::FlatReadFloat32((r3 + 2716));
    f2.d = MemoryInline::FlatReadFloat32((r3 + 2720));
    r0 = MemoryInline::FlatRead8((r3 + 12));
    f0.d = static_cast<double>(PpcForceSingleValueInline(f0.d - f2.d));
    f1.d = MemoryInline::FlatReadFloat32((r3 + 1776));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_806B05E0:
{
    r3 = MemoryInline::FlatRead32((r3 + 856));
...
loc_806B06A4:
{
    r3 = MemoryInline::FlatRead32((r3 + 824));
    r12 = MemoryInline::FlatRead32(r3);
    r12 = MemoryInline::FlatRead32((r12 + 12));
    ctr = r12;
    ctx->lr = 0x806B06B8u;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r31 + 824));
    r4 = (r31 + 1780);
    r12 = MemoryInline::FlatRead32(r3);
    r12 = MemoryInline::FlatRead32((r12 + 120));
    ctr = r12;
...
// RECOMP_REGISTRATION base 0x806B04BC func_806B04BC preserves=false fpr_mask=0x80000000
