...
extern "C" void func_802261A8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_802261A8:
{
    f0.d = MemoryInline::FlatReadFloat32((r2 + -25260));
    r4 = 0;
    r0 = 128;
    guest_range_0 = MemoryInline::ResolveRangeHost((r3 + 8), 0, 30u, false, true);
    ...
    MemoryInline::WriteResolved16(guest_range_0, 20u, (r3 + 28), static_cast<uint16_t>(r4));
    MemoryInline::WriteResolved8(guest_range_0, 22u, (r3 + 30), static_cast<uint8_t>(r4));
    MemoryInline::WriteResolved8(guest_range_0, 23u, (r3 + 31), static_cast<uint8_t>(r4));
    MemoryInline::WriteResolved8(guest_range_0, 24u, (r3 + 32), static_cast<uint8_t>(r4));
    MemoryInline::WriteResolved8(guest_range_0, 25u, (r3 + 33), static_cast<uint8_t>(r0));
    MemoryInline::WriteResolved8(guest_range_0, 27u, (r3 + 35), static_cast<uint8_t>(r4));
    MemoryInline::WriteResolved8(guest_range_0, 28u, (r3 + 36), static_cast<uint8_t>(r4));
    MemoryInline::WriteResolved8(guest_range_0, 29u, (r3 + 37), static_cast<uint8_t>(r4));
    ctx->gpr[0] = r0;
    ctx->gpr[4] = r4;
    ctx->fpr[0] = f0;
    return;
...
// RECOMP_REGISTRATION base 0x802261A8 func_802261A8 preserves=true fpr_mask=0x00000000
