...
extern "C" void func_805D7DB0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805D7DB0:
{
    r3 = MemoryInline::FlatRead32((r3 + 4520));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x805D7DB0 func_805D7DB0 preserves=true fpr_mask=0x00000000
