...
extern "C" void func_806DB764(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806DB7A8:
{
    ...
    f3 = ctx->fpr[3];
    cr = ctx->cr;
    r0 = MemoryInline::FlatRead8((r29 + 310));
...
loc_806DB7C8:
{
    ...
    r10 = 0;
    r0 = 1;
    MemoryInline::FlatWrite8((r29 + 310), static_cast<uint8_t>(r0));
    r3 = (r29 + 48);
    ...
    MemoryInline::FlatWrite16((r29 + 308), static_cast<uint16_t>(r10));
    r0 = MemoryInline::FlatRead8((r7 + 3));
    MemoryInline::FlatWrite32((r29 + 312), r10);
...
// RECOMP_REGISTRATION base 0x806DB764 func_806DB764 preserves=true fpr_mask=0x00000000
