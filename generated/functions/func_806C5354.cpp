...
extern "C" void func_806C5354(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806C5354:
{
    ...
    MemoryInline::FlatWrite8((r29 + 196), static_cast<uint8_t>(r0));
    ctx->lr = 0x806C53A4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_806C53AC:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x806E95B0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_806C53B4:
{
    ...
    r4 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r4 + -1632));
    r0 = MemoryInline::FlatRead16((r3 + 44));
    r0 = (r0 | 8);
    MemoryInline::FlatWriteRam16((r3 + 44), static_cast<uint16_t>(r0));
...
loc_806C541C:
{
    MemoryInline::FlatWrite32((r29 + 180), r25);
    r3 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + -1632));
    r0 = MemoryInline::FlatRead16((r25 + 44));
    r0 = (r0 | 8);
    MemoryInline::FlatWriteRam16((r25 + 44), static_cast<uint16_t>(r0));
    MemoryInline::FlatWriteRamFloat32((r25 + 60), f0.d);
    MemoryInline::FlatWriteRamFloat32((r25 + 64), f0.d);
    MemoryInline::FlatWriteRamFloat32((r25 + 68), f0.d);
    r3 = MemoryInline::FlatRead32((r29 + 176));
    r12 = MemoryInline::FlatRead32(r3);
...
loc_806C5484:
{
    MemoryInline::FlatWrite8((r29 + 204), static_cast<uint8_t>(r20));
}
...
loc_806C5488:
{
    ...
    r25 = (r25 + 16856);
    f31.d = MemoryInline::FlatReadFloat32((r4 + -1632));
    r21 = 0;
    r20 = 0;
    r26 = 0x808C0000u;
    goto loc_806C5544;
...
loc_806C54CC:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32(r27, r25);
}
...
loc_806C5560:
{
    ...
    r5 = 0x808C0000u;
    r4 = MemoryInline::FlatRead8((r29 + 204));
    r6 = MemoryInline::FlatRead32(r6);
    r0 = (r4 + 1);
    f1.d = MemoryInline::FlatReadFloat32((r5 + 16000));
...
loc_806C55C0:
{
    MemoryInline::FlatWrite8((r29 + 205), static_cast<uint8_t>(r4));
    if (((cr & 0x20000000u) != 0)) {
        goto loc_806C56B8;
    }
}
...
loc_806C55C8:
{
    r0 = MemoryInline::FlatRead8((r29 + 196));
    ...
    r26 = (r26 + 16376);
    f31.d = MemoryInline::FlatReadFloat64((r4 + -1616));
    r31 = 0;
    r21 = 0;
    r20 = 0;
    r25 = 0x802A0000u;
...
loc_806C5628:
{
    ...
    r4 = (r25 + 16640);
    r24 = MemoryInline::FlatRead16((r5 + 40));
    r24 = (r24 << 16);
    r24 = (static_cast<int32_t>(r24) >> 16);
    r23 = MemoryInline::FlatRead16((r5 + 42));
    r23 = (r23 << 16);
    r23 = (static_cast<int32_t>(r23) >> 16);
    ctx->lr = 0x806C563Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_806C5640:
{
    MemoryInline::FlatWriteRam32(r22, r26);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_806C5678;
    }
}
...
loc_806C5674:
{
    MemoryInline::FlatWriteRam32((r22 + 32), r3);
}
...
loc_806C5678:
{
    ...
    r3_addr_6 = (r3 + r21);
    MemoryInline::FlatWrite32(r3_addr_6, r22);
    r3 = MemoryInline::FlatRead32((r29 + 188));
    r3_addr_7 = (r3 + r21);
    ...
    r31 = (r31 + 1);
    r3_addr_8 = (r3 + r20);
    MemoryInline::FlatWrite16(r3_addr_8, static_cast<uint16_t>(r28));
    r20 = (r20 + 2);
}
...
// RECOMP_REGISTRATION base 0x806C5354 func_806C5354 preserves=false fpr_mask=0x80000000
