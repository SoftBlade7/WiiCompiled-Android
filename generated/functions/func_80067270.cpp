...
extern "C" void func_80067270(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80067384:
{
    r5_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r19), static_cast<uint32_t>(27));
...
loc_80067388:
{
    ...
    ctx->gpr[5] = r5;
    ctx->gpr[6] = r6;
    InvokeDirectCpu<0x800B1920u>(ctx);
    r4 = ctx->gpr[4];
    r6 = ctx->gpr[6];
    r0 = MemoryInline::FlatRead32((r1 + 20));
}
...
loc_800673B8:
{
    ...
    r30 = (r30 + 32424);
    MemoryInline::FlatWriteRam32((r1 + 116), r18);
    r21 = 0;
    r31 = 0;
...
{
    r20 = r19;
    if ((static_cast<uint32_t>(r19) <= static_cast<uint32_t>(40))) {
        goto loc_80067410;
    }
}
...
loc_8006746C:
{
    r5 = (r5 * 48);
    r0 = (r5 + 31);
    r5_rot_4 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(27));
    r5 = (r5_rot_4 & 134217727);
}
...
loc_800674D8:
{
    ...
    r5_rot_8 = PpcRotl32Inline(static_cast<uint32_t>(r8), static_cast<uint32_t>(3));
    r5 = (r5_rot_8 & 1);
    r4 = r15;
    r6 = r16;
    r7 = (r1 + 24);
...
loc_80067658:
{
    r24 = MemoryInline::FlatRead32((r1 + 108));
    r19 = r22;
    r25 = r14;
    r26 = r14;
    r27 = 0;
...
loc_inl5_cont_8019A0C0:
{
    ...
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r4_psq_tmp_23 = (r4 + 8);
    PpcSetPairedFprInline(f1, PPC_PsqLGqrInline<0u, 0u>(ctx, mkw_gqr0, r4_psq_tmp_23));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r4_psq_tmp_24 = (r4 + 16);
    PpcSetPairedFprInline(f2, PPC_PsqLGqrInline<0u, 0u>(ctx, mkw_gqr0, r4_psq_tmp_24));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r4_psq_tmp_25 = (r4 + 24);
    PpcSetPairedFprInline(f3, PPC_PsqLGqrInline<0u, 0u>(ctx, mkw_gqr0, r4_psq_tmp_25));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r4_psq_tmp_26 = (r4 + 32);
    PpcSetPairedFprInline(f4, PPC_PsqLGqrInline<0u, 0u>(ctx, mkw_gqr0, r4_psq_tmp_26));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r4_psq_tmp_27 = (r4 + 40);
    PpcSetPairedFprInline(f5, PPC_PsqLGqrInline<0u, 0u>(ctx, mkw_gqr0, r4_psq_tmp_27));
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    PPC_PsqStGqrInline<0u, 0u>(ctx, mkw_gqr0, r3, f0.d);
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r3_psq_tmp_26 = (r3 + 8);
    PPC_PsqStGqrInline<1u, 0u>(ctx, mkw_gqr0, r3_psq_tmp_26, f1.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r3_psq_tmp_27 = (r3 + 12);
    PPC_PsqStGqrInline<0u, 0u>(ctx, mkw_gqr0, r3_psq_tmp_27, f2.d);
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r3_psq_tmp_28 = (r3 + 20);
    PPC_PsqStGqrInline<1u, 0u>(ctx, mkw_gqr0, r3_psq_tmp_28, f3.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r3_psq_tmp_29 = (r3 + 24);
    PPC_PsqStGqrInline<0u, 0u>(ctx, mkw_gqr0, r3_psq_tmp_29, f4.d);
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r3_psq_tmp_30 = (r3 + 32);
    PPC_PsqStGqrInline<1u, 0u>(ctx, mkw_gqr0, r3_psq_tmp_30, f5.d);
    // end of inlined leaf 0x80085630
    f0.d = PPC_PsToScalarInline(f0.d);
    f1.d = PPC_PsToScalarInline(f1.d);
    f2.d = PPC_PsToScalarInline(f2.d);
...
// RECOMP_REGISTRATION base 0x80067270 func_80067270 preserves=false fpr_mask=0x80000000
