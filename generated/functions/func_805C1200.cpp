...
extern "C" void func_805C1200(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805C1200:
{
    ...
    MemoryInline::FlatWrite32((r3 + 3228), r4);
...
// RECOMP_REGISTRATION base 0x805C1200 func_805C1200 preserves=true fpr_mask=0x00000000
