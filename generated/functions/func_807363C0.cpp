...
extern "C" void func_807363C0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807363C0:
{
    ...
    ctr = ctx->ctr;
    r0 = 0;
    MemoryInline::FlatWrite8((r31 + 524), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x807363C0 func_807363C0 preserves=true fpr_mask=0x00000000
