...
extern "C" void func_8073DBCC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8073DBCC:
{
    ...
    MemoryInline::FlatWrite8((r3 + 13), static_cast<uint8_t>(r7));
    MemoryInline::FlatWrite8((r3 + 12), static_cast<uint8_t>(r6));
...
// RECOMP_REGISTRATION base 0x8073DBCC func_8073DBCC preserves=true fpr_mask=0x00000000
