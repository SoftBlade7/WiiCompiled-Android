...
extern "C" void func_805E92D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805E9398:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x805CDBE4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x805E92D0 func_805E92D0 preserves=true fpr_mask=0x00000000
