...
extern "C" void func_8007D110(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_8007D110:
{
    ...
    r0 = (r0_rot_0 & -4);
    r7 = (r4 + r0);
    r6 = MemoryInline::FlatRead8((r7 + 232));
    r5 = MemoryInline::FlatRead8((r7 + 233));
    r4 = MemoryInline::FlatRead8((r7 + 234));
    r0 = MemoryInline::FlatRead8((r7 + 235));
...
// RECOMP_REGISTRATION base 0x8007D110 func_8007D110 preserves=true fpr_mask=0x00000000
