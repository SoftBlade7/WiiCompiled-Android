...
extern "C" void func_80863928(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80863928:
{
    ...
    ctx->gpr[8] = r8;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x80701018u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r3 = (r31 + 336);
    r4 = (r4 + 30432);
    MemoryInline::FlatWrite32((r31 + 84), r6);
    r5 = (r5 + 14824);
    r6 = 48;
    r7 = 29;
    MemoryInline::FlatWrite32((r31 + 148), r8);
...
// RECOMP_REGISTRATION base 0x80863928 func_80863928 preserves=true fpr_mask=0x00000000
