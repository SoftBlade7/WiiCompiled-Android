...
extern "C" void func_80813C40(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80813C68:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r5 = MemoryInline::FlatRead32((r25 + 8));
    r3 = (r1 + 8);
    r4 = (r1 + 12);
...
loc_80813CCC:
{
    ...
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r26), static_cast<int32_t>(19));
}
...
{
    r0 = 1000;
    MemoryInline::FlatWrite32((r25 + 172), r0);
...
// RECOMP_REGISTRATION base 0x80813C40 func_80813C40 preserves=true fpr_mask=0x00000000
