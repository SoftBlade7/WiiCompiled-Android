...
extern "C" void func_8055AADC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8055AADC:
{
    ...
    r31 = r3;
    f1.d = MemoryInline::FlatReadFloat32((r4 + 4992));
...
// RECOMP_REGISTRATION base 0x8055AADC func_8055AADC preserves=false fpr_mask=0x80000000
