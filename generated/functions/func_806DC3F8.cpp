...
extern "C" void func_806DC3F8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806DC3F8:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead8((r31 + 310));
...
// RECOMP_REGISTRATION base 0x806DC3F8 func_806DC3F8 preserves=true fpr_mask=0x00000000
