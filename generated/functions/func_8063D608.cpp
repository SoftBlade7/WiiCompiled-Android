...
extern "C" void func_8063D608(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8063D608:
{
    ...
    ctx->gpr[3] = r3;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8063D648u>(ctx);
    r0 = ctx->gpr[0];
    ctr = ctx->ctr;
...
// RECOMP_REGISTRATION base 0x8063D608 func_8063D608 preserves=true fpr_mask=0x00000000
