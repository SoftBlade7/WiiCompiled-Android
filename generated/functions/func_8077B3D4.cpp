...
extern "C" void func_8077B3D4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8077B3D4:
{
    ...
    r4 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r4 + 17312));
    r0 = 0;
    r4 = (r5 | 555810816);
    r4 = (r4 | 8481);
...
// RECOMP_REGISTRATION base 0x8077B3D4 func_8077B3D4 preserves=true fpr_mask=0x00000000
