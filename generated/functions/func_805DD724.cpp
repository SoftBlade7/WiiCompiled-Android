...
extern "C" void func_805DD724(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805DD724:
{
    ...
    MemoryInline::FlatWrite32((r3 + 852), r0);
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x805DD724 func_805DD724 preserves=true fpr_mask=0x00000000
