...
extern "C" void func_8013279C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8013279C:
{
    r3 = (r3 + 8);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x8013AEE8u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8013279C func_8013279C preserves=true fpr_mask=0x00000000
