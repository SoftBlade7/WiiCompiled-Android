...
extern "C" void func_8077318C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r3 = 0x809C0000u;
    r23 = MemoryInline::FlatRead32((r3 + 17200));
...
loc_80773294:
{
    MemoryInline::FlatWrite32((r23 + 92), r25);
}

loc_80773298:
{
    r3 = MemoryInline::FlatRead32((r23 + 92));
    r4 = 100;
    ...
    xer = ctx->xer;
    r0 = (r3 & 65535);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r0), static_cast<uint32_t>(744));
}
...
loc_807732E0:
{
    ...
    xer = ctx->xer;
    r0 = (r3 & 65535);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r0), static_cast<uint32_t>(745));
}
...
loc_80773300:
{
    ...
    xer = ctx->xer;
    r0 = (r3 & 65535);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r0), static_cast<uint32_t>(746));
}
...
loc_80773320:
{
    ...
    xer = ctx->xer;
    r0 = (r3 & 65535);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r0), static_cast<uint32_t>(359));
}
...
loc_80773340:
{
    ...
    xer = ctx->xer;
    r0 = (r3 & 65535);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r0), static_cast<uint32_t>(360));
}
...
loc_80773360:
{
    ...
    xer = ctx->xer;
    r0 = (r3 & 65535);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r0), static_cast<uint32_t>(361));
}
...
loc_80773380:
{
    ...
    xer = ctx->xer;
    r0 = (r3 & 65535);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r0), static_cast<uint32_t>(333));
}
...
loc_807733A0:
{
    ...
    xer = ctx->xer;
    r0 = (r3 & 65535);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r0), static_cast<uint32_t>(334));
}
...
loc_807733C0:
{
    ...
    xer = ctx->xer;
    r0 = (r3 & 65535);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r0), static_cast<uint32_t>(335));
}
...
loc_8077343C:
{
    r3 = MemoryInline::FlatRead32((r25 + -10480));
    r5 = 0;
...
loc_80773468:
{
    ...
    r28 = r23;
    f3.d = MemoryInline::FlatReadFloat64((r30 + 16));
...
loc_807734B8:
{
    ...
    r9 = 2;
    r10 = 0;
    // inline leaf 0x80529804 (8 guest instruction(s))
    ...
    // end of inlined leaf 0x80529804
    r23_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r28), static_cast<uint32_t>(2));
    r23 = (r23_rot_1 & -4);
    r22 = 0;
    r24 = 0;
    r25 = 0x809C0000u;
...
loc_807734F0:
{
    ...
    r0 = (r24 + r23);
    r4_addr_5 = (r4 + r0);
    MemoryInline::FlatWrite32(r4_addr_5, r3);
    r3 = MemoryInline::FlatRead32((r31 + 8));
    r3_addr_5 = (r3 + r0);
...
loc_8077357C:
{
    ...
    r24 = (r24 + 1);
    r4_addr_8 = (r4 + r0);
    MemoryInline::FlatWrite32(r4_addr_8, r3);
}
...
loc_807735AC:
{
    r25_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r29), static_cast<uint32_t>(2));
    r25 = (r25_rot_1 & -4);
    r22 = 0;
    r28 = 0x809C0000u;
    goto loc_80773604;
...
loc_807735BC:
{
    ...
    r5 = MemoryInline::FlatRead32((r28 + -10448));
    r27 = r3;
    r4 = r29;
    ...
    r4_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r27), static_cast<uint32_t>(2));
    r4 = (r4_rot_2 & -4);
    r5_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(2));
    r5 = (r5_rot_2 & -4);
    r22 = (r22 + 1);
    r6_addr_2 = (r6 + r4);
    r7 = MemoryInline::FlatRead32(r6_addr_2);
    r6_addr_3 = (r6 + r5);
    r0 = MemoryInline::FlatRead32(r6_addr_3);
    r6_addr_4 = (r6 + r4);
    MemoryInline::FlatWrite32(r6_addr_4, r0);
    r3 = MemoryInline::FlatRead32((r31 + 8));
    r3_addr_8 = (r3 + r5);
...
loc_8077360C:
{
    r28 = 0x809C0000u;
    r4 = 64;
    r3 = MemoryInline::FlatRead32((r28 + 11760));
    r5 = 64;
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80781584u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8055F3E8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8077318C func_8077318C preserves=true fpr_mask=0x00000000
