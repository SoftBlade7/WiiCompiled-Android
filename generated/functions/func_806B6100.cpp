...
extern "C" void func_806B6100(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806B6174:
{
    ...
    r4 = (r1 + 32);
    MemoryInline::WriteResolved32(guest_range_1, 0u, (r1 + 32), r5);
    r5 = (r31 + 228);
    ...
    f1.d = MemoryInline::FlatReadFloat32((r5 + -3800));
...
// RECOMP_REGISTRATION base 0x806B6100 func_806B6100 preserves=true fpr_mask=0x00000000
