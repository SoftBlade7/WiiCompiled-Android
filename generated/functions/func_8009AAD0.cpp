...
extern "C" void func_8009AAD0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r3_rot_0 = 0;
...
loc_8009AAD0:
{
    r3 = MemoryInline::FlatRead32((r3 + 632));
    r0 = (0 - r3);
    r0 = (r0 | r3);
...
// RECOMP_REGISTRATION base 0x8009AAD0 func_8009AAD0 preserves=true fpr_mask=0x00000000
