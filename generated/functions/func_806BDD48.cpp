...
extern "C" void func_806BDD48(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806BDDAC:
{
    ...
    r10 = -1;
    MemoryInline::FlatWrite16((r31 + 300), static_cast<uint16_t>(r11));
    r3 = (r1 + 32);
    r4 = (r31 + 48);
    r5 = (r31 + 328);
    MemoryInline::FlatWrite32((r31 + 304), r10);
    MemoryInline::FlatWrite32((r31 + 308), r11);
    MemoryInline::FlatWrite16((r31 + 312), static_cast<uint16_t>(r11));
    MemoryInline::FlatWrite32((r31 + 320), r11);
    MemoryInline::FlatWrite32((r31 + 324), r11);
    MemoryInline::FlatWrite32(r31, r9);
    MemoryInline::FlatWrite32((r31 + 296), r8);
    MemoryInline::FlatWrite32((r31 + 328), r7);
    MemoryInline::FlatWrite32((r31 + 332), r6);
...
loc_806BDEE0:
{
    ...
    MemoryInline::FlatWriteFloat32((r31 + 76), f30.d);
    r3 = 6;
    MemoryInline::FlatWrite32((r31 + 324), r31);
    MemoryInline::FlatWrite32((r31 + 320), r30);
    MemoryInline::FlatWrite16((r31 + 312), static_cast<uint16_t>(r0));
    ctx->lr = 0x806BDF04u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r0 = MemoryInline::FlatRead16((r29 + 10128));
    r4 = MemoryInline::FlatRead32((r31 + 316));
...
// RECOMP_REGISTRATION base 0x806BDD48 func_806BDD48 preserves=false fpr_mask=0xC0000000
