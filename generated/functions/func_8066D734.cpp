...
extern "C" void func_8066D734(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8066D734:
{
    ...
    MemoryInline::FlatWrite8((r5 + -30288), static_cast<uint8_t>(r31));
...
loc_8066D79C:
{
    ...
    MemoryInline::FlatWrite8((r29 + 40), static_cast<uint8_t>(r31));
...
// RECOMP_REGISTRATION base 0x8066D734 func_8066D734 preserves=true fpr_mask=0x00000000
