...
extern "C" void func_8071646C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r23_addic_src_0 = 0;
    uint32_t r23_addic_src_1 = 0;
    uint32_t r23_addic_src_2 = 0;
...
loc_8071646C:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x806F8A64u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r5 = (r4 + 10304);
    r28 = 0;
    MemoryInline::FlatWriteRam32((r4 + 10304), r28);
    r4 = 1;
    r3 = MemoryInline::FlatRead32((r3 + 10392));
    MemoryInline::FlatWriteRam32((r5 + 4), r28);
    MemoryInline::FlatWriteRam32((r5 + 8), r28);
    MemoryInline::FlatWriteRam32((r5 + 12), r28);
...
{
    r27_addic_src_2 = r27;
    r27 = (r27_addic_src_2 + -232);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r27_addic_src_2)) + static_cast<uint64_t>(static_cast<uint32_t>(-232)) + (static_cast<uint64_t>(static_cast<uint32_t>(0)) & 1u);
...
{
    r23_addic_src_2 = r23;
    r23 = (r23_addic_src_2 + -232);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r23_addic_src_2)) + static_cast<uint64_t>(static_cast<uint32_t>(-232)) + (static_cast<uint64_t>(static_cast<uint32_t>(0)) & 1u);
        xer = (xer & 0xDFFFFFFFu) | (static_cast<uint32_t>((ppcCarryWide >> 32) & 1u) << 29);
    }
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r23), static_cast<int32_t>(0));
}
...
loc_807165D0:
{
    if ((static_cast<uint32_t>(r29) != static_cast<uint32_t>(r30))) {
        goto loc_80716570;
    }
}
...
loc_807165E0:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80710CA0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x807156F4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8071646C func_8071646C preserves=true fpr_mask=0x00000000
