...
extern "C" void func_807D1C78(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807D1C84:
{
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r4), static_cast<uint32_t>(39));
}
...
// RECOMP_REGISTRATION base 0x807D1C78 func_807D1C78 preserves=true fpr_mask=0x00000000
