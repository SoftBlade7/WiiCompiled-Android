...
extern "C" void func_8064A674(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8064A674:
{
    ...
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
    InvokeDirectCpu<0x8064A698u>(ctx);
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
    r28 = ctx->gpr[28];
...
// RECOMP_REGISTRATION base 0x8064A674 func_8064A674 preserves=true fpr_mask=0x00000000
