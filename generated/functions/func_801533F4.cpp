...
extern "C" void func_801533F4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801533F4:
{
    ...
    r5 = MemoryInline::FlatRead16((r3 + 106));
    ctx->lr = 0x80153408u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x801533F4 func_801533F4 preserves=true fpr_mask=0x00000000
