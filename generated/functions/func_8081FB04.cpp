...
extern "C" void func_8081FB04(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8081FB04:
{
    ...
    r3 = MemoryInline::FlatRead32((r8 + 17200));
    ...
    xer = ctx->xer;
    r31 = 1;
    MemoryInline::FlatWrite16((r26 + 136), static_cast<uint16_t>(r3));
    r0 = -1;
    r3 = (r26 + 88);
    MemoryInline::FlatWrite8((r26 + 138), static_cast<uint8_t>(r30));
    MemoryInline::FlatWrite8((r26 + 144), static_cast<uint8_t>(r30));
    MemoryInline::FlatWrite8((r26 + 152), static_cast<uint8_t>(r30));
    MemoryInline::FlatWrite8((r26 + 153), static_cast<uint8_t>(r30));
    MemoryInline::FlatWrite8((r26 + 154), static_cast<uint8_t>(r30));
    MemoryInline::FlatWrite8((r26 + 155), static_cast<uint8_t>(r30));
    MemoryInline::FlatWrite8((r26 + 156), static_cast<uint8_t>(r30));
    MemoryInline::FlatWrite8((r26 + 157), static_cast<uint8_t>(r31));
    MemoryInline::FlatWrite32((r26 + 160), r30);
    MemoryInline::FlatWrite32((r26 + 164), r0);
    MemoryInline::FlatWrite8((r26 + 168), static_cast<uint8_t>(r31));
    ...
    r3 = MemoryInline::FlatRead16((r26 + 44));
    ...
    MemoryInline::FlatWriteFloat32((r26 + 72), f5.d);
    MemoryInline::FlatWriteFloat32((r26 + 76), f4.d);
    MemoryInline::FlatWriteFloat32((r26 + 80), f3.d);
    MemoryInline::FlatWrite16((r26 + 44), static_cast<uint16_t>(r0));
    MemoryInline::FlatWriteFloat32((r26 + 60), f8.d);
    MemoryInline::FlatWriteFloat32((r26 + 64), f7.d);
    MemoryInline::FlatWriteFloat32((r26 + 68), f6.d);
...
loc_inl2_cont_8051BED0:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r26 + 40), r3);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r26 + 140), r3);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r26 + 148), r3);
    r11 = (r1 + 32);
    r3 = r26;
...
// RECOMP_REGISTRATION base 0x8081FB04 func_8081FB04 preserves=true fpr_mask=0x00000000
