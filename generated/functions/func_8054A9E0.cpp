...
extern "C" void func_8054A9E0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r5_rot_0 = 0;
...
loc_8054A9E0:
{
    ...
    ctx->gpr[5] = r5;
    ctx->gpr[6] = r6;
    InvokeDirectCpu<0x8000AFECu>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r5 = ctx->gpr[5];
    r6 = ctx->gpr[6];
...
// RECOMP_REGISTRATION base 0x8054A9E0 func_8054A9E0 preserves=true fpr_mask=0x00000000
