...
extern "C" void func_80679AA8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80679AA8:
{
    ...
    r31 = r6;
    r30 = r7;
    r0 = MemoryInline::FlatRead32((r8 + 25432));
...
// RECOMP_REGISTRATION base 0x80679AA8 func_80679AA8 preserves=true fpr_mask=0x00000000
