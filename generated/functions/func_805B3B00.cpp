...
extern "C" void func_805B3B00(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805B3B84:
{
    ...
    MemoryInline::FlatWriteRam16((r3 + 4), static_cast<uint16_t>(r22));
...
loc_805B3B90:
{
    ...
    r4 = r31;
    r5 = 9;
    // inline leaf 0x8056417C (23 guest instruction(s))
}
...
loc_inl0_cont_8056417C:
{
    // end of inlined leaf 0x8056417C
    r4 = r3;
    r3 = r20;
    ctx->lr = 0x805B3BBCu;
    ctx->gpr[0] = r0;
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8022A210u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r4 = r20;
    r5 = MemoryInline::FlatRead8((r21 + 108));
    r7 = 0;
    r6 = MemoryInline::FlatRead8((r21 + 110));
    ctx->lr = 0x805B3BD4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_inl1_cont_8056417C:
{
    ...
    r3 = MemoryInline::FlatRead32((r30 + 48));
    r4 = r20;
    r5 = MemoryInline::FlatRead8((r21 + 240));
    r7 = 0;
    r6 = MemoryInline::FlatRead8((r21 + 242));
    ctx->lr = 0x805B3C40u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_inl2_cont_8056417C:
{
    ...
    r3 = MemoryInline::FlatRead32((r30 + 48));
    r4 = r20;
    r5 = MemoryInline::FlatRead8((r21 + 96));
    r7 = 0;
    r6 = MemoryInline::FlatRead8((r21 + 98));
    ctx->lr = 0x805B3CACu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_inl3_0x805641A8:
{
    ...
    r0 = (r0_rot_11 & -4);
    r4 = MemoryInline::FlatRead32((r3 + 128));
    r3_rot_8 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(2));
    r3 = (r3_rot_8 & -4);
    r4_addr_8 = (r4 + r3);
    r3 = MemoryInline::FlatRead32(r4_addr_8);
    r3 = (r3 + r0);
    r3 = MemoryInline::FlatRead32((r3 + 4));
    goto loc_inl3_cont_8056417C;
}
...
loc_inl3_cont_8056417C:
{
    ...
    r3 = MemoryInline::FlatRead32((r30 + 48));
    r4 = r20;
    r5 = MemoryInline::FlatRead8((r21 + 228));
    r7 = 0;
    r6 = MemoryInline::FlatRead8((r21 + 230));
    ctx->lr = 0x805B3D18u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_805B3D34:
{
    MemoryInline::FlatWriteRam32(r3, r22);
    MemoryInline::FlatWriteRam16((r3 + 4), static_cast<uint16_t>(r22));
    MemoryInline::FlatWriteRam32((r3 + 8), r27);
}
...
loc_inl4_0x805641A8:
{
    ...
    r3 = (r3_rot_10 & -4);
    r4_addr_10 = (r4 + r3);
    r3 = MemoryInline::FlatRead32(r4_addr_10);
    r3 = (r3 + r0);
    r3 = MemoryInline::FlatRead32((r3 + 4));
    goto loc_inl4_cont_8056417C;
}
...
loc_inl4_cont_8056417C:
{
    ...
    r3 = MemoryInline::FlatRead32((r30 + 48));
    r4 = r20;
    r5 = MemoryInline::FlatRead8((r21 + 252));
    r7 = 0;
    r6 = MemoryInline::FlatRead8((r21 + 254));
    ctx->lr = 0x805B3D84u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_805B3DAC:
{
    ...
    ctx->gpr[5] = r5;
    ctx->cr = cr;
    InvokeDirectCpu<0x8056417Cu>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
    ...
    r3 = MemoryInline::FlatRead32((r30 + 48));
    r4 = r20;
    r5 = MemoryInline::FlatRead8((r21 + 264));
    r7 = 0;
    r6 = MemoryInline::FlatRead8((r21 + 266));
    ctx->lr = 0x805B3DF0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_805B3E18:
{
    ...
    r3 = MemoryInline::FlatRead32((r30 + 48));
    r4 = r20;
    r5 = MemoryInline::FlatRead8((r21 + 276));
    r7 = 0;
    r6 = MemoryInline::FlatRead8((r21 + 278));
    ctx->lr = 0x805B3E5Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_805B3E80:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x805AE440u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_805B3E8C:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x805AFD14u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x805B3B00 func_805B3B00 preserves=true fpr_mask=0x00000000
