...
extern "C" void func_8001F5B0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8001F5B0:
{
    MemoryInline::FlatWrite8((r13 + -27496), static_cast<uint8_t>(r3));
    return;
}
...
// RECOMP_REGISTRATION base 0x8001F5B0 func_8001F5B0 preserves=true fpr_mask=0x00000000
