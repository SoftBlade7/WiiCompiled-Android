...
extern "C" void func_80522858(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80522858:
{
    ...
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    InvokeDirectCpu<0x801AF908u>(ctx);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x80522858 func_80522858 preserves=true fpr_mask=0x00000000
