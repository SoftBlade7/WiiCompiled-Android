...
extern "C" void func_806D5D4C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806D5DF0:
{
    ...
    r25_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r29), static_cast<uint32_t>(2));
    r25 = (r25_rot_2 & 1020);
    r3_addr_4 = (r3 + r25);
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r27 + 8656));
    r3 = MemoryInline::FlatRead32((r3 + 104));
    r3_addr_6 = (r3 + r25);
    r3 = MemoryInline::FlatRead32(r3_addr_6);
    MemoryInline::FlatWrite8((r3 + 168), static_cast<uint8_t>(r26));
    goto loc_806D5E58;
}
...
{
    r3 = MemoryInline::FlatRead32((r28 + 176));
    r25_rot_3 = PpcRotl32Inline(static_cast<uint32_t>(r29), static_cast<uint32_t>(2));
    r25 = (r25_rot_3 & 1020);
    r3_addr_7 = (r3 + r25);
...
loc_806D5E74:
{
    r0 = MemoryInline::FlatRead8((r28 + 180));
    r3 = (r29 & 255);
...
// RECOMP_REGISTRATION base 0x806D5D4C func_806D5D4C preserves=true fpr_mask=0x00000000
