...
extern "C" void func_80026410(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80026410:
{
    ...
    r30 = 0;
    r31 = 1;
    guest_range_0 = MemoryInline::ResolveRangeHost((r3 + 12), 0, 148u, false, true);
    MemoryInline::WriteResolved32(guest_range_0, 4u, (r3 + 16), r30);
    r26 = r3;
    r27 = r4;
    r28 = r5;
    MemoryInline::WriteResolved32(guest_range_0, 0u, (r3 + 12), r31);
    r29 = r6;
    MemoryInline::WriteResolved32(guest_range_0, 24u, (r3 + 36), r30);
    MemoryInline::WriteResolved16(guest_range_0, 32u, (r3 + 44), static_cast<uint16_t>(r30));
    MemoryInline::WriteResolved32(guest_range_0, 28u, (r3 + 40), r30);
    MemoryInline::WriteResolved32(guest_range_0, 36u, (r3 + 48), r30);
    MemoryInline::WriteResolved16(guest_range_0, 44u, (r3 + 56), static_cast<uint16_t>(r30));
    MemoryInline::WriteResolved32(guest_range_0, 40u, (r3 + 52), r30);
    MemoryInline::WriteResolved16(guest_range_0, 48u, (r3 + 60), static_cast<uint16_t>(r30));
    r0 = MemoryInline::FlatRead32((r4 + 4));
    MemoryInline::WriteResolved32(guest_range_0, 144u, (r3 + 156), r0);
    r3 = (r3 + 84);
    ...
    f0.d = MemoryInline::FlatReadFloat32((r2 + -31152));
    guest_range_2 = MemoryInline::ResolveRangeHost((r26 + 32), 0, 112u, false, true);
    MemoryInline::WriteResolved32(guest_range_2, 0u, (r26 + 32), r27);
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 36u, ((static_cast<uint64_t>(static_cast<uint32_t>(r30)) << 32) | static_cast<uint32_t>(r30)))) {
        MemoryInline::WriteResolved32(guest_range_2, 36u, (r26 + 68), r30);
        MemoryInline::WriteResolved32(guest_range_2, 40u, (r26 + 72), r30);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 44u, ((static_cast<uint64_t>(static_cast<uint32_t>(r30)) << 32) | static_cast<uint32_t>(r30)))) {
        MemoryInline::WriteResolved32(guest_range_2, 44u, (r26 + 76), r30);
        MemoryInline::WriteResolved32(guest_range_2, 48u, (r26 + 80), r30);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 100u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f0.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_2, 100u, (r26 + 132), f0.d);
        MemoryInline::WriteResolvedFloat32(guest_range_2, 104u, (r26 + 136), f0.d);
    }
    MemoryInline::WriteResolvedFloat32(guest_range_2, 108u, (r26 + 140), f0.d);
...
loc_80026500:
{
    ...
    r6 = ctx->gpr[6];
    cr = ctx->cr;
    r4 = MemoryInline::FlatRead16((r26 + 60));
    r3 = 1;
    r0 = (r4 + 1);
    MemoryInline::FlatWrite16((r26 + 60), static_cast<uint16_t>(r0));
    MemoryInline::FlatWrite32((r30 + 12), r31);
    r0 = MemoryInline::FlatRead16((r30 + 232));
    r0 = (r0 + r29);
    MemoryInline::FlatWrite16((r30 + 232), static_cast<uint16_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x80026410 func_80026410 preserves=true fpr_mask=0x00000000
