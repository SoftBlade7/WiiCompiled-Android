...
extern "C" void func_80553C50(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80553C50:
{
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 52u, ((static_cast<uint64_t>(static_cast<uint32_t>(r17)) << 32) | static_cast<uint32_t>(r18)))) {
        MemoryInline::WriteResolved32(guest_range_0, 52u, (r1 + 52), r17);
        MemoryInline::WriteResolved32(guest_range_0, 56u, (r1 + 56), r18);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 60u, ((static_cast<uint64_t>(static_cast<uint32_t>(r19)) << 32) | static_cast<uint32_t>(r20)))) {
        MemoryInline::WriteResolved32(guest_range_0, 60u, (r1 + 60), r19);
        MemoryInline::WriteResolved32(guest_range_0, 64u, (r1 + 64), r20);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 68u, ((static_cast<uint64_t>(static_cast<uint32_t>(r21)) << 32) | static_cast<uint32_t>(r22)))) {
...
loc_80553C78:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80530864u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80553C88:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80531070u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_inl0_cont_8051BED0:
{
    ...
    r4 = r3;
    r3 = r18;
    r4 = MemoryInline::FlatRead32((r4 + 6356));
    r5 = 0;
    ctx->lr = 0x80553CD4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r17 + 9576), r3);
    // inline leaf 0x8051BED0 (12 guest instruction(s))
}
...
loc_inl1_cont_8051BED0:
{
    ...
    r5 = r3;
    r19 = 0x809C0000u;
    r3 = MemoryInline::FlatRead32((r19 + -10440));
    r4 = 0;
    r5 = MemoryInline::FlatRead32((r5 + 6356));
    r6 = 0;
    ctx->lr = 0x80553CF8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8051AA58u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    xer = ctx->xer;
    r18 = 0x809C0000u;
    r3 = MemoryInline::FlatRead32((r18 + -10456));
...
loc_80553D44:
{
    ...
    r18 = MemoryInline::FlatRead16((r3 + 64));
    // inline leaf 0x8051BED0 (12 guest instruction(s))
}
...
loc_inl2_cont_8051BED0:
{
    ...
    r7 = MemoryInline::FlatRead32((r7 + 6360));
    r6 = (r0 - r6);
    ctx->lr = 0x80553D7Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80540B14u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80553D90:
{
    ...
    r20_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(1));
    r20 = (r20_rot_1 & 1);
    // inline leaf 0x8051BED0 (12 guest instruction(s))
}
...
{
    // end of inlined leaf 0x8051BED0
    r5 = MemoryInline::FlatRead32((r18 + -10456));
    r6 = r3;
    r3 = MemoryInline::FlatRead32((r19 + -10440));
    r7 = r20;
    r4 = MemoryInline::FlatRead32((r5 + 2920));
    r5 = MemoryInline::FlatRead16((r5 + 2972));
    r6 = MemoryInline::FlatRead32((r6 + 6360));
    ctx->lr = 0x80553DC0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80540918u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_inl4_cont_8051BED0:
{
    ...
    r5 = MemoryInline::FlatRead32((r5 + 6360));
    ctx->lr = 0x80553E14u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80540760u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_inl5_cont_8051BED0:
{
    ...
    r4 = r3;
    r3 = 0x809C0000u;
    r5 = MemoryInline::FlatRead32((r4 + 6360));
    r6 = r18;
    r3 = MemoryInline::FlatRead32((r3 + -10440));
    r4 = 7;
    ctx->lr = 0x80553E7Cu;
...
loc_80553F14:
{
    ...
    r23 = 0;
    r31 = 0x809C0000u;
    r27 = MemoryInline::FlatRead8((r3 + 36));
    r30 = 1;
    goto loc_805541D4;
}
...
{
    // end of inlined leaf 0x8051BED0
    r22 = MemoryInline::FlatRead32((r3 + 6360));
    r21 = 0;
    r3 = MemoryInline::FlatRead32((r17 + 9576));
    r4 = 4;
...
loc_80553F68:
{
    r22 = MemoryInline::FlatRead32((r17 + 9576));
}
...
loc_80553FA0:
{
    r4 = PPC_Slw(static_cast<uint32_t>(r30), static_cast<uint32_t>(r4));
    r4 = (r4 & 193);
}
...
loc_80553FB8:
{
    ...
    r4 = (r4 * 240);
    r4 = (r3 + r4);
    r20 = MemoryInline::FlatRead32((r4 + 244));
}

loc_80553FC8:
{
    r4 = MemoryInline::FlatRead8((r3 + 39));
    r19 = 0;
...
loc_inl11_0x8051BEF0:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(5));
}

loc_inl11_0x8051BEF4:
{
    if (((cr & 0x20000000u) != 0)) {
        goto loc_inl11_return;
    }
...
loc_inl11_0x8051BEF8:
{
    r3 = r4;
    goto loc_inl11_cont_8051BED0;
}
...
loc_inl11_cont_8051BED0:
{
    // end of inlined leaf 0x8051BED0
    r0 = MemoryInline::FlatRead32((r26 + -10456));
    r5 = r3;
    r3 = MemoryInline::FlatRead32((r31 + -10440));
    r7 = r20;
    r4 = (r0 + r25);
    r10 = MemoryInline::FlatRead32((r5 + 6360));
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80540E3Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80554108:
{
    ...
    xer = ctx->xer;
    r18 = (r18 + 1);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r18), static_cast<int32_t>(5));
}
...
loc_inl12_0x8051BEF0:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(5));
}

loc_inl12_0x8051BEF4:
{
    if (((cr & 0x20000000u) != 0)) {
        goto loc_inl12_return;
    }
...
loc_inl12_0x8051BEF8:
{
    r3 = r4;
    goto loc_inl12_cont_8051BED0;
}
...
loc_inl12_cont_8051BED0:
{
    // end of inlined leaf 0x8051BED0
    r18 = MemoryInline::FlatRead32((r3 + 6360));
    r4 = 4;
    r3 = MemoryInline::FlatRead32((r17 + 9576));
    r12 = MemoryInline::FlatRead32(r3);
    r12 = MemoryInline::FlatRead32((r12 + 36));
...
loc_80554160:
{
    r18 = MemoryInline::FlatRead32((r17 + 9576));
}
...
loc_inl13_0x8051BEF0:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(5));
}

loc_inl13_0x8051BEF4:
{
    if (((cr & 0x20000000u) != 0)) {
        goto loc_inl13_return;
    }
...
loc_inl13_0x8051BEF8:
{
    r3 = r4;
    goto loc_inl13_cont_8051BED0;
}
...
loc_inl13_cont_8051BED0:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80540F90u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_805541E0:
{
    ...
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 52), 0, 68u, true, false);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r17 = MemoryInline::ReadResolved32(guest_range_1, 0u, (r1 + 52));
            r18 = MemoryInline::ReadResolved32(guest_range_1, 4u, (r1 + 56));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r19 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r1 + 60));
            r20 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r1 + 64));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r21 = MemoryInline::ReadResolved32(guest_range_1, 16u, (r1 + 68));
            r22 = MemoryInline::ReadResolved32(guest_range_1, 20u, (r1 + 72));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r23 = MemoryInline::ReadResolved32(guest_range_1, 24u, (r1 + 76));
            r24 = MemoryInline::ReadResolved32(guest_range_1, 28u, (r1 + 80));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r25 = MemoryInline::ReadResolved32(guest_range_1, 32u, (r1 + 84));
            r26 = MemoryInline::ReadResolved32(guest_range_1, 36u, (r1 + 88));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r27 = MemoryInline::ReadResolved32(guest_range_1, 40u, (r1 + 92));
            r28 = MemoryInline::ReadResolved32(guest_range_1, 44u, (r1 + 96));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r29 = MemoryInline::ReadResolved32(guest_range_1, 48u, (r1 + 100));
            r30 = MemoryInline::ReadResolved32(guest_range_1, 52u, (r1 + 104));
        }
    }
    r31 = MemoryInline::ReadResolved32(guest_range_1, 56u, (r1 + 108));
...
// RECOMP_REGISTRATION base 0x80553C50 func_80553C50 preserves=true fpr_mask=0x00000000
