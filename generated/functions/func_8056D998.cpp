...
extern "C" void func_8056D998(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8056D998:
{
    ...
    r31 = ctx->gpr[31];
    ctr = ctx->ctr;
    r12 = MemoryInline::FlatRead32((r30 + 580));
    r3 = (r30 + 568);
    r4 = r31;
    r12 = MemoryInline::FlatRead32((r12 + 20));
    ctr = r12;
    ...
    r31 = ctx->gpr[31];
    ctr = ctx->ctr;
    r12 = MemoryInline::FlatRead32((r30 + 728));
    r3 = (r30 + 716);
    r4 = r31;
    r12 = MemoryInline::FlatRead32((r12 + 20));
    ctr = r12;
...
// RECOMP_REGISTRATION base 0x8056D998 func_8056D998 preserves=true fpr_mask=0x00000000
