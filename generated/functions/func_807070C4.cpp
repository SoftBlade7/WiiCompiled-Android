...
extern "C" void func_807070C4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807070C4:
{
    r3 = (r3 + -140);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80705540u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x807070C4 func_807070C4 preserves=true fpr_mask=0x00000000
