...
extern "C" void func_805C407C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805C40D0:
{
    r3 = MemoryInline::FlatRead32((r29 + 372));
    r31 = 1717960704;
    ...
    f1.d = MemoryInline::FlatReadFloat64((r30 + 320));
    r4 = 0;
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    f0.d = MemoryInline::FlatReadFloat32((r30 + 312));
...
loc_805C42E4:
{
    ...
    r28 = cr;
    r28_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r28), static_cast<uint32_t>(3));
    r28 = (r28_rot_1 & 1);
}
...
loc_805C42F8:
{
    r0 = MemoryInline::FlatRead8((r29 + 376));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_805C4354:
{
    MemoryInline::FlatWrite8((r29 + 376), static_cast<uint8_t>(r28));
}
...
// RECOMP_REGISTRATION base 0x805C407C func_805C407C preserves=false fpr_mask=0x80000000
