...
extern "C" void func_80702648(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r3 = (r3 + -148);
    // inline leaf 0x80700B80 (7 guest instruction(s))
    ...
    // end of inlined leaf 0x80700B80
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
...
// RECOMP_REGISTRATION base 0x80702648 func_80702648 preserves=true fpr_mask=0x00000000
