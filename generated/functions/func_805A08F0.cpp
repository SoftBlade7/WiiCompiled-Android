...
extern "C" void func_805A08F0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805A0958:
{
    ...
    r29 = MemoryInline::FlatRead32((r4 + 6552));
...
loc_805A0974:
{
    ...
    r28 = MemoryInline::FlatRead32((r4 + 6552));
...
loc_805A0990:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x805A0ABCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x805A08F0 func_805A08F0 preserves=true fpr_mask=0x00000000
