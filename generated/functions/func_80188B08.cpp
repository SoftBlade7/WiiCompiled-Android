...
extern "C" void func_80188B08(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_80188B08:
{
    ...
    r0 = (r0_rot_0 & -4);
    r7 = (r4 + r0);
    r6 = MemoryInline::FlatRead8((r7 + 228));
    r5 = MemoryInline::FlatRead8((r7 + 229));
    r4 = MemoryInline::FlatRead8((r7 + 230));
    r0 = MemoryInline::FlatRead8((r7 + 231));
...
// RECOMP_REGISTRATION base 0x80188B08 func_80188B08 preserves=true fpr_mask=0x00000000
