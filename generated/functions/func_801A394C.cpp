...
extern "C" void func_801A394C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr1_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_801A3A68:
{
    r5 = 0x80000000u;
    r0 = 0;
    MemoryInline::FlatWriteRam32((r5 + 12684), r29);
    r3 = (r1 + 16);
    r4 = (r30 + 332);
    MemoryInline::FlatWriteRam32((r5 + 12688), r0);
    MemoryInline::FlatWriteRam8((r5 + 12678), static_cast<uint8_t>(r31));
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x801A3A8Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_801A3C8C:
{
    ...
    MemoryInline::FlatWrite32((r26 + 24), r0);
    MemoryInline::FlatWrite8((r26 + 10), static_cast<uint8_t>(r31));
    ctx->lr = 0x801A3CA4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x801A394C func_801A394C preserves=true fpr_mask=0x00000000
