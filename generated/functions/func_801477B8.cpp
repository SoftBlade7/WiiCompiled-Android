...
extern "C" void func_801477B8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801477B8:
{
    ...
    r3 = (r31 + -28872);
    r0 = 0;
    MemoryInline::FlatWriteRam8((r3 + 1025), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x801477B8 func_801477B8 preserves=true fpr_mask=0x00000000
