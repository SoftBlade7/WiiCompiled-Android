...
extern "C" void func_80755AD8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80755AD8:
{
    ...
    f31.d = MemoryInline::FlatReadFloat32((r30 + 228));
...
loc_80755BEC:
{
    r3 = MemoryInline::FlatRead32((r29 + 420));
    r0 = 1;
    MemoryInline::FlatWrite8((r29 + 376), static_cast<uint8_t>(r0));
    r0 = (r3 + 1);
    MemoryInline::FlatWrite32((r29 + 420), r0);
}
...
// RECOMP_REGISTRATION base 0x80755AD8 func_80755AD8 preserves=false fpr_mask=0x80000000
