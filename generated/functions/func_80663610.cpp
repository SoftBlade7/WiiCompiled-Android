...
extern "C" void func_80663610(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80663610:
{
    r3 = (r3 + 92);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x800EC320u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80663610 func_80663610 preserves=true fpr_mask=0x00000000
