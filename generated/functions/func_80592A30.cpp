...
extern "C" void func_80592A30(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80592A74:
{
    r5 = 0x809C0000u;
    r4 = 10;
    r5 = MemoryInline::FlatRead32((r5 + 6484));
    r6 = 8736;
    ctx->lr = 0x80592A88u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80592A90:
{
    MemoryInline::FlatWrite32((r29 + 136), r4);
    r3 = 0;
    if (((cr & 0x20000000u) == 0)) {
        goto loc_80592AA4;
    }
...
loc_80592A9C:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80577220u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80592ABC:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r6 + 7856));
...
loc_80592AD0:
{
    MemoryInline::FlatWrite32((r29 + 132), r3);
    r3 = 0x809C0000u;
    r3 = MemoryInline::FlatRead32((r3 + -10456));
    r4 = MemoryInline::FlatRead8((r31 + 19));
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8055B1F8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80592B28:
{
    r0 = MemoryInline::FlatRead32((r31 + 19440));
    r3 = (r30 & 255);
...
// RECOMP_REGISTRATION base 0x80592A30 func_80592A30 preserves=true fpr_mask=0x00000000
