...
extern "C" void func_806E3EDC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806E3EE8:
{
    ctx->gpr[0] = r0;
    ctx->cr = cr;
    InvokeDirectCpu<0x806E3F20u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    cr = ctx->cr;
    xer = ctx->xer;
...
// RECOMP_REGISTRATION base 0x806E3EDC func_806E3EDC preserves=true fpr_mask=0x00000000
