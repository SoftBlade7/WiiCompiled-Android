...
extern "C" void func_80789B94(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80789B94:
{
    ...
    r23 = r19;
    f31.d = MemoryInline::FlatReadFloat64((r4 + 18680));
    r25 = (r5 + 30272);
...
loc_80789BF8:
{
    r0 = MemoryInline::FlatRead32((r23 + 1184));
    r21 = MemoryInline::FlatRead32((r23 + 1232));
...
loc_80789C08:
{
    ...
    r0 = (r0_rot_2 & -8);
    r3 = MemoryInline::FlatRead8((r3 + 1140));
    r0 = (r19 + r0);
    r4 = 0;
    ...
    r3 = MemoryInline::FlatRead32((r20 + 40));
    ctx->lr = 0x80789C30u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_80789C6C:
{
    r0 = MemoryInline::FlatRead32((r19 + 1328));
    r24 = 3;
...
loc_80789C98:
{
    ...
    r6 = ctx->gpr[6];
    cr = ctx->cr;
    r18 = MemoryInline::FlatRead32((r3 + 12));
    r17 = 0;
...
loc_80789CEC:
{
    r18 = MemoryInline::FlatRead32((r18 + 44));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r18), static_cast<int32_t>(0));
}
...
loc_80789D14:
{
    r0 = MemoryInline::FlatRead16((r18 + 32));
...
loc_80789D68:
{
    f1.d = f30.d;
    r3 = MemoryInline::FlatRead32((r20 + 40));
    f2.d = MemoryInline::FlatReadFloat32((r31 + 18672));
    r4 = r24;
    ctx->lr = 0x80789D7Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
{
    r3 = (r19 + r21);
    r0_rot_4 = PpcRotl32Inline(static_cast<uint32_t>(r21), static_cast<uint32_t>(3));
    r0 = (r0_rot_4 & -8);
    r3 = MemoryInline::FlatRead8((r3 + 1140));
    r0 = (r19 + r0);
    r4 = 0;
...
loc_80789EBC:
{
    r21 = MemoryInline::FlatRead32((r18 + 44));
...
loc_80789EE4:
{
    r0 = MemoryInline::FlatRead16((r21 + 32));
    r3 = MemoryInline::FlatRead32((r30 + -10448));
    r0 = (r0 ^ -2147483648);
    MemoryInline::FlatWriteRam32((r1 + 20), r0);
    r3 = MemoryInline::FlatRead32((r3 + 8));
...
loc_80789FA4:
{
    r22 = (r22 + 1);
    r23 = (r23 + 4);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r22), static_cast<int32_t>(12));
}
...
// RECOMP_REGISTRATION base 0x80789B94 func_80789B94 preserves=false fpr_mask=0xC0000000
