...
extern "C" void func_807AE180(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807AE180:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8068D448u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_807AE23C:
{
    r3 = MemoryInline::FlatRead32((r30 + 816));
    r4 = 1;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x807A2F00u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_807AE30C:
{
    ...
    r3 = 0x809C0000u;
    r4 = (r4 + 12104);
    f0.d = MemoryInline::FlatReadFloat32((r3 + 13904));
    f1.d = MemoryInline::FlatReadFloat32((r4 + 644));
    r3 = MemoryInline::FlatRead32((r30 + 176));
    f1.d = PpcFmulsInline(f0.d, f1.d);
    f2.d = MemoryInline::FlatReadFloat32(r31);
    // inline leaf 0x80786F7C (7 guest instruction(s))
    ...
    // end of inlined leaf 0x80786F7C
...
// RECOMP_REGISTRATION base 0x807AE180 func_807AE180 preserves=true fpr_mask=0x00000000
