...
extern "C" void func_807025B8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807025B8:
{
    r3 = (r3 + -148);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80700A80u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x807025B8 func_807025B8 preserves=true fpr_mask=0x00000000
