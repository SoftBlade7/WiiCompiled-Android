...
extern "C" void func_807B1218(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807B1218:
{
    r3 = MemoryInline::FlatRead8((r3 + 420));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x807B1218 func_807B1218 preserves=true fpr_mask=0x00000000
