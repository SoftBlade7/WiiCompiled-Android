...
extern "C" void func_800A5B20(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800A5B20:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead8((r31 + 284));
...
{
    r29 = 0;
    MemoryInline::FlatWrite32((r31 + 2080), r29);
    r3 = (r31 + 412);
    r4 = (r31 + 416);
    r5 = 1664;
    ctx->lr = 0x800A5BB4u;
    ...
    r31 = ctx->gpr[31];
    cr = ctx->cr;
    MemoryInline::FlatWrite8((r31 + 284), static_cast<uint8_t>(r29));
    ctx->lr = 0x800A5BBCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_800A5BC4:
{
    ...
    ctx->gpr[4] = r4;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x800A6530u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800A5BDC:
{
    MemoryInline::FlatWrite32((r31 + 2092), r0);
    r4 = r31;
    r5 = 0;
    r0 = 1;
    goto loc_800A5C10;
...
loc_800A5C00:
{
    MemoryInline::FlatWrite8((r4 + 2932), static_cast<uint8_t>(r0));
}

loc_800A5C04:
{
    r27_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r27), static_cast<uint32_t>(31));
    r27 = (r27_rot_2 & 2147483647);
    r4 = (r4 + 56);
    r5 = (r5 + 1);
}
...
loc_800A5C2C:
{
    MemoryInline::FlatWrite32((r31 + 2088), r0);
    if (((cr & 0x20000000u) == 0)) {
        goto loc_800A5C48;
    }
}
...
loc_800A5C48:
{
    MemoryInline::FlatWrite32((r31 + 2096), r26);
    MemoryInline::FlatWrite32((r31 + 2080), r30);
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_800A5D00:
{
    ...
    r3 = ctx->gpr[3];
    r0 = 1;
    MemoryInline::FlatWrite8((r31 + 284), static_cast<uint8_t>(r0));
    ctx->lr = 0x800A5D14u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x800A5B20 func_800A5B20 preserves=true fpr_mask=0x00000000
