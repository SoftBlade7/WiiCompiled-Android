...
extern "C" void func_80615FB4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_80615FB4:
{
    ...
    r29 = r4;
    r30 = MemoryInline::FlatRead32((r3 + 7036));
    r3 = r29;
    r4 = (r30 + 9300);
    ctx->lr = 0x80615FECu;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x80615FB4 func_80615FB4 preserves=true fpr_mask=0x00000000
