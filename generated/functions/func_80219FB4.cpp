...
extern "C" void func_80219FB4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r5_rot_0 = 0;
...
loc_80219FD4:
{
    ...
    ctx->gpr[5] = r5;
    ctx->gpr[6] = r6;
    InvokeDirectCpu<0x8016F9C8u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r5 = ctx->gpr[5];
    r6 = ctx->gpr[6];
...
loc_8021A004:
{
    ...
    r3 = MemoryInline::FlatRead8((r5 + 25));
    r4 = (r5 + 26);
    r6 = (r5 + 50);
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80244268u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80219FB4 func_80219FB4 preserves=true fpr_mask=0x00000000
