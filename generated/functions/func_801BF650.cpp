...
extern "C" void func_801BF650(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_801BF650:
{
    ...
    r3 = ctx->gpr[3];
    r31 = MemoryInline::FlatRead8((r31 + 2435));
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x801BF650 func_801BF650 preserves=true fpr_mask=0x00000000
