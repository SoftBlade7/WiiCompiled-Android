...
extern "C" void func_806F2490(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806F2534:
{
    r0 = MemoryInline::FlatRead8((r30 + 88));
...
loc_806F2540:
{
    f30.d = static_cast<double>(PpcForceSingleValueInline(f31.d - f30.d));
    r3 = (r1 + 68);
    r4 = (r1 + 152);
    f1.d = f30.d;
    ...
    r4 = 0x809C0000u;
    r3 = (r1 + 56);
    f1.d = MemoryInline::FlatReadFloat32((r4 + 8904));
    r4 = (r1 + 68);
    // inline leaf 0x80514810 (10 guest instruction(s))
    f3.d = MemoryInline::FlatReadFloat32((r4 + 8));
    f2.d = MemoryInline::FlatReadFloat32((r4 + 4));
...
loc_806F2614:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r3 + 8908));
    r3 = (r1 + 176);
    r4 = (r1 + 116);
...
// RECOMP_REGISTRATION base 0x806F2490 func_806F2490 preserves=false fpr_mask=0xC0000000
