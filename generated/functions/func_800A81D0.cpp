...
extern "C" void func_800A81D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800A81D0:
{
    ...
    r8 = MemoryInline::FlatRead32((r29 + 36));
    r9 = MemoryInline::FlatRead8((r29 + 40));
    ctx->lr = 0x800A820Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x800A6970u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800A826C:
{
    r5 = MemoryInline::FlatRead32((r29 + 16));
    r3 = r31;
    r4 = MemoryInline::FlatRead32((r5 + 356));
    r0 = (r4 + -1);
    MemoryInline::FlatWrite32((r5 + 356), r0);
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x800A81D0 func_800A81D0 preserves=true fpr_mask=0x00000000
