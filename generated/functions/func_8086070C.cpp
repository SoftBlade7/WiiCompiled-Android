...
extern "C" void func_8086070C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8086070C:
{
    ...
    MemoryInline::FlatWrite32((r4 + 968), r3);
...
// RECOMP_REGISTRATION base 0x8086070C func_8086070C preserves=true fpr_mask=0x00000000
