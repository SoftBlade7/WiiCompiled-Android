...
extern "C" void func_80023380(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80023380:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead32((r31 + 832));
...
// RECOMP_REGISTRATION base 0x80023380 func_80023380 preserves=true fpr_mask=0x00000000
