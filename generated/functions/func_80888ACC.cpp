...
extern "C" void func_80888ACC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80888ACC:
{
    ...
    r29 = r3;
    r5 = MemoryInline::FlatRead8((r3 + 222));
    r0 = (0 - r5);
    r0 = (r0 | r5);
    {
...
loc_80888B1C:
{
    ...
    r4 = (r29 + r0);
    r4 = MemoryInline::FlatRead8((r4 + 222));
...
// RECOMP_REGISTRATION base 0x80888ACC func_80888ACC preserves=true fpr_mask=0x00000000
