...
extern "C" void func_80159C3C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80159CF8:
{
    MemoryInline::FlatWrite16((r30 + 34), static_cast<uint16_t>(r3));
    r3 = r30;
    goto loc_80159D34;
}
...
// RECOMP_REGISTRATION base 0x80159C3C func_80159C3C preserves=true fpr_mask=0x00000000
