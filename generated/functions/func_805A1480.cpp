...
extern "C" void func_805A1480(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805A1480:
{
    r3 = MemoryInline::FlatRead8((r3 + 421));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x805A1480 func_805A1480 preserves=true fpr_mask=0x00000000
