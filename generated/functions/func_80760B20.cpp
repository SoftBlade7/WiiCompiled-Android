...
extern "C" void func_80760B20(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80760B70:
{
    MemoryInline::FlatWrite32((r30 + 260), r3);
    r4 = 0x809C0000u;
    r3 = 0x808A0000u;
    ...
    r3 = r30;
    MemoryInline::FlatWrite32((r30 + 184), r5);
...
// RECOMP_REGISTRATION base 0x80760B20 func_80760B20 preserves=true fpr_mask=0x00000000
