...
extern "C" void func_807242F4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807242F4:
{
    ...
    xer = ctx->xer;
    r29 = 0;
    MemoryInline::FlatWrite32((r28 + 484), r29);
    r30 = 0x808A0000u;
    r31 = 0x808A0000u;
    MemoryInline::FlatWrite32((r28 + 488), r29);
    r4 = 0;
    r3 = MemoryInline::FlatRead32((r28 + 4));
    f1.d = MemoryInline::FlatReadFloat32((r30 + 8440));
    r3 = MemoryInline::FlatRead32((r3 + 40));
    f2.d = MemoryInline::FlatReadFloat32((r31 + 8444));
    ctx->lr = 0x80724350u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r30 = MemoryInline::FlatRead32((r28 + 520));
    r3 = r30;
    ctx->lr = 0x807243E4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_inl3_cont_8071EFA8:
{
    ...
    f4 = ctx->fpr[4];
    cr = ctx->cr;
    MemoryInline::FlatWrite8((r30 + 328), static_cast<uint8_t>(r29));
...
// RECOMP_REGISTRATION base 0x807242F4 func_807242F4 preserves=true fpr_mask=0x00000000
