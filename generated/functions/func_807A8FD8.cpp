...
extern "C" void func_807A8FD8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807A8FD8:
{
    ...
    r29 = 0;
    r31 = 3;
    r27 = MemoryInline::FlatRead32((r4 + 13896));
    MemoryInline::FlatWrite16((r27 + 4), static_cast<uint16_t>(r3));
    r28 = r27;
...
{
    r0 = 0;
    guest_range_0 = MemoryInline::ResolveRangeHost((r27 + 16), 0, 48u, false, true);
...
// RECOMP_REGISTRATION base 0x807A8FD8 func_807A8FD8 preserves=true fpr_mask=0x00000000
