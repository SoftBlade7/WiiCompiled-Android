...
extern "C" void func_80601060(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80601060:
{
    r3 = MemoryInline::FlatRead32((r3 + 3428));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80601060 func_80601060 preserves=true fpr_mask=0x00000000
