...
extern "C" void func_8016DE64(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8016DE64:
{
    ...
    r0_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r10), static_cast<uint32_t>(10));
...
// RECOMP_REGISTRATION base 0x8016DE64 func_8016DE64 preserves=true fpr_mask=0x00000000
