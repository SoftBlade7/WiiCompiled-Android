...
extern "C" void func_801A735C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_801A73B4:
{
    ...
    r6 = MemoryInline::FlatRead32((r28 + 20));
...
loc_801A73C4:
{
    ...
    r0 = (r0_rot_1 & -4);
    r5_addr_1 = (r5 + r0);
    MemoryInline::FlatWrite32(r5_addr_1, r29);
    r4 = MemoryInline::FlatRead32((r28 + 28));
    r0 = (r4 + 1);
...
// RECOMP_REGISTRATION base 0x801A735C func_801A735C preserves=true fpr_mask=0x00000000
