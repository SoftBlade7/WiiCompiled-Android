...
extern "C" void func_8063CE6C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8063CE6C:
{
    ...
    r0 = -1;
    r4 = 1;
    MemoryInline::WriteResolvedFloat32(guest_range_1, 20u, (r29 + 124), f0.d);
    r3 = r29;
    MemoryInline::WriteResolved8(guest_range_1, 24u, (r29 + 128), static_cast<uint8_t>(r31));
    MemoryInline::WriteResolved32(guest_range_1, 28u, (r29 + 132), r31);
    MemoryInline::WriteResolved8(guest_range_1, 32u, (r29 + 136), static_cast<uint8_t>(r4));
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 36u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 36u, (r29 + 140), f0.d);
        MemoryInline::WriteResolved32(guest_range_1, 40u, (r29 + 144), r0);
    }
    MemoryInline::WriteResolved32(guest_range_1, 44u, (r29 + 148), r0);
...
// RECOMP_GUEST_ABI gpr_read=0xE000000A gpr_write=0xE000003B gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000003 fpr_return=0x00000002 cr_read=0x00 cr_write=0x00 xer_read=0 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8063CE6C func_8063CE6C preserves=true fpr_mask=0x00000000
