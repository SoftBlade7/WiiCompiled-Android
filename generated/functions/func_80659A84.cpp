...
extern "C" void func_80659A84(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_ca_0 = 0;
    uint32_t r0_ca_1 = 0;
...
loc_80659A84:
{
    ...
    r4 = r6;
    r3 = r25;
    r22 = MemoryInline::FlatRead32((r5 + 4));
...
loc_80659AC0:
{
    r26_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r27), static_cast<uint32_t>(3));
    r26 = (r26_rot_1 & 2040);
    r24 = (r28 + r26);
    r22 = MemoryInline::FlatRead32((r24 + 576));
    r23 = MemoryInline::FlatRead32((r24 + 580));
    r0 = (r23 | r22);
...
loc_80659AD8:
{
    ...
    MemoryInline::FlatWrite32((r24 + 772), r0);
    r0_not_1 = ~(r22);
    r0_ca_1 = (xer >> 29) & 1u;
    r0 = (r0_not_1 + r3);
    r0 = (r0 + r0_ca_1);
    ...
    MemoryInline::FlatWrite32((r24 + 768), r0);
}
...
loc_80659AEC:
{
    ...
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    MemoryInline::FlatWrite32((r24 + 580), r4);
    r4_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r27), static_cast<uint32_t>(5));
    r4 = (r4_rot_1 & 8160);
    r0_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r27), static_cast<uint32_t>(2));
    r0 = (r0_rot_1 & 1020);
    r27 = r25;
    MemoryInline::FlatWrite32((r24 + 576), r3);
    r31 = (r28 + r4);
    r29 = (r28 + r0);
    r26 = 0;
    r30 = 0;
...
loc_80659B28:
{
    r0 = MemoryInline::FlatRead32((r31 + 10140));
    r4 = 0;
    r0 = (r0 ^ 1);
    r0 = (r0 * 48);
    r3 = (r29 + r0);
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r23 + 8), r24);
    r4 = r25;
    r0 = MemoryInline::FlatRead32((r31 + 10140));
    r23 = MemoryInline::FlatRead8((r28 + 8));
    r0 = (r0 ^ 1);
    r0 = (r0 * 48);
    r5 = r23;
    r3 = (r29 + r0);
    r3 = MemoryInline::FlatRead32((r3 + 336));
    r3_addr_3 = (r3 + r30);
    r22 = MemoryInline::FlatRead32(r3_addr_3);
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r22 + 8), r23);
    r3 = MemoryInline::FlatRead8((r28 + 8));
    r0 = MemoryInline::FlatRead32((r31 + 10140));
    r25 = (r25 + r3);
    r0 = (r0 ^ 1);
    MemoryInline::FlatWrite32((r31 + 10140), r0);
}
...
// RECOMP_GUEST_ABI gpr_read=0xFFC003FB gpr_write=0xFFC003FB gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x80659A84 func_80659A84 preserves=true fpr_mask=0x00000000
