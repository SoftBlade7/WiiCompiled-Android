...
extern "C" void func_805B3A90(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805B3A90:
{
    ...
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x8082A884u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x805B3A90 func_805B3A90 preserves=true fpr_mask=0x00000000
