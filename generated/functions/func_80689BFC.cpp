...
extern "C" void func_80689BFC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80689BFC:
{
    ...
    MemoryInline::FlatWriteRamFloat64((r1 + 304), f28.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_3 = (r1 + 312);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_3, PPC_PsFromScalarInline(f28.d));
    MemoryInline::FlatWriteRamFloat64((r1 + 288), f27.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_4 = (r1 + 296);
...
loc_80689C94:
{
    ...
    f3 = ctx->fpr[3];
    f4 = ctx->fpr[4];
    r5 = MemoryInline::FlatRead32((r21 + 192));
    r3 = 0x808A0000u;
    r0 = 1127219200;
...
loc_80689D3C:
{
    ...
    r3 = 0x808A0000u;
    r5 = 0x808A0000u;
    f29.d = MemoryInline::FlatReadFloat32((r4 + -11304));
    f30.d = MemoryInline::FlatReadFloat32((r3 + -11300));
    r29 = (r1 + 56);
    f28.d = MemoryInline::FlatReadFloat32((r5 + -11252));
    r30 = (r1 + 44);
    r27 = 0;
    r20 = 0;
    r28 = 0;
...
// RECOMP_REGISTRATION base 0x80689BFC func_80689BFC preserves=false fpr_mask=0xF8000000
