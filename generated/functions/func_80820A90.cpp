...
extern "C" void func_80820A90(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80820B1C:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead8((r28 + 144));
...
loc_80820B90:
{
    ...
    r6 = MemoryInline::FlatRead32((r28 + 148));
    ctx->lr = 0x80820BC0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80820A90 func_80820A90 preserves=false fpr_mask=0xC0000000
