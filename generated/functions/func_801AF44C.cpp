...
extern "C" void func_801AF44C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_801AF4A4:
{
    ...
    r20 = PPC_Srw(static_cast<uint32_t>(r25), static_cast<uint32_t>(r18));
    r0 = (r0 & r20);
...
loc_801AF4B4:
{
    ...
    r3 = ctx->gpr[3];
    MemoryInline::FlatWrite8((r16 + 10), static_cast<uint8_t>(r26));
    r3 = r16;
    r4 = 0;
    r5 = 10;
    ctx->lr = 0x801AF4D0u;
...
loc_801AF4E0:
{
    ...
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(r18));
}
...
loc_801AF510:
{
    MemoryInline::FlatWrite8((r16 + 10), static_cast<uint8_t>(r27));
    r3 = r16;
    r4 = 0;
    r5 = 10;
    ctx->lr = 0x801AF524u;
...
{
    r3 = r18;
    // inline leaf 0x801B2568 (14 guest instruction(s))
}
...
loc_inl1_cont_801B2568:
{
    // end of inlined leaf 0x801B2568
...
loc_801AF538:
{
    MemoryInline::FlatWrite8((r16 + 10), static_cast<uint8_t>(r28));
    r3 = r16;
    r4 = 0;
    r5 = 10;
    ctx->lr = 0x801AF54Cu;
...
loc_801AF550:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x801B3050u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801AF578:
{
    MemoryInline::FlatWrite8((r16 + 10), static_cast<uint8_t>(r29));
    r3 = r16;
    r4 = 0;
    r5 = 10;
    ctx->lr = 0x801AF58Cu;
...
loc_801AF690:
{
    r12 = MemoryInline::FlatRead32((r13 + -28900));
    r3 = r18;
    r4 = r16;
    r5 = (r1 + 8);
    ctr = r12;
...
loc_801AF6BC:
{
    r0 = MemoryInline::FlatRead16(r16);
    r0 = (r0 & 128);
    r0 = (r0 ^ 128);
}
...
loc_801AF6DC:
{
    ...
    r3 = MemoryInline::FlatRead8((r16 + 2));
...
loc_801AF71C:
{
    r4 = MemoryInline::FlatRead8((r22 + 3));
...
loc_801AF79C:
{
    r4 = MemoryInline::FlatRead8((r22 + 5));
    r3 = MemoryInline::FlatRead8((r16 + 5));
    r5 = (static_cast<int32_t>(static_cast<int8_t>(r4)));
    r6 = (static_cast<int32_t>(r5) >> 31);
    r3 = (static_cast<int32_t>(static_cast<int8_t>(r3)));
    r4 = (static_cast<int32_t>(r3) >> 31);
...
loc_801AF7DC:
{
    r5 = MemoryInline::FlatRead8((r22 + 6));
...
loc_801AF814:
{
    r5 = MemoryInline::FlatRead8((r22 + 7));
    r3 = MemoryInline::FlatRead8((r16 + 7));
    r6 = (static_cast<int32_t>(r5) >> 31);
    r4 = (static_cast<int32_t>(r3) >> 31);
    r5 = (r6 ^ r5);
    r3 = (r4 ^ r3);
...
loc_801AF85C:
{
    // inline leaf 0x801BB0D0 (4 guest instruction(s))
    r0 = 0;
    r3 = 1;
    MemoryInline::FlatWrite32((r13 + -24632), r0);
    // end of inlined leaf 0x801BB0D0
}
...
loc_801AF8B8:
{
    ...
    r0 = MemoryInline::FlatRead16(r16);
    r0 = (r0 & -129);
    MemoryInline::FlatWrite16(r16, static_cast<uint16_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x801AF44C func_801AF44C preserves=true fpr_mask=0x00000000
