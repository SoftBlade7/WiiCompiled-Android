...
extern "C" void func_8059AA44(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8059AA44:
{
    ...
    r3 = 0x80890000u;
    r4 = 0x808B0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 8088));
    r4 = (r4 + 26592);
    MemoryInline::FlatWrite32((r29 + 12), r4);
    r3 = r29;
    MemoryInline::FlatWrite32((r29 + 144), r30);
    MemoryInline::FlatWrite32((r29 + 148), r31);
...
// RECOMP_REGISTRATION base 0x8059AA44 func_8059AA44 preserves=true fpr_mask=0x00000000
