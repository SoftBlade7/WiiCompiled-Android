...
extern "C" void func_80529BE4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80529BE4:
{
    r4 = 0x809C0000u;
    r3 = 0;
    r4 = MemoryInline::FlatRead32((r4 + -10472));
...
// RECOMP_REGISTRATION base 0x80529BE4 func_80529BE4 preserves=true fpr_mask=0x00000000
