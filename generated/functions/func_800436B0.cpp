...
extern "C" void func_800436B0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800436B0:
{
    ...
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    InvokeDirectCpu<0x8003C0B0u>(ctx);
    r0 = ctx->gpr[0];
    r4 = ctx->gpr[4];
    r4 = 0x80270000u;
    r3 = r31;
...
// RECOMP_REGISTRATION base 0x800436B0 func_800436B0 preserves=true fpr_mask=0x00000000
