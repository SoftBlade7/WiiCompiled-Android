...
extern "C" void func_8061FD9C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8061FD9C:
{
    ...
    r30 = MemoryInline::FlatRead32((r3 + 340));
...
// RECOMP_REGISTRATION base 0x8061FD9C func_8061FD9C preserves=true fpr_mask=0x00000000
