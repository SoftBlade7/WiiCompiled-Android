...
extern "C" void func_801F4680(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801F469C:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x801F2C80u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    cr = ctx->cr;
    r0 = (0 - r3);
...
// RECOMP_REGISTRATION base 0x801F4680 func_801F4680 preserves=true fpr_mask=0x00000000
