...
extern "C" void func_80238820(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80238820:
{
    ...
    r0 = (r0 | 1);
    MemoryInline::FlatWrite8((r3 + 72), static_cast<uint8_t>(r0));
    ctx->gpr[0] = r0;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x80238820 func_80238820 preserves=true fpr_mask=0x00000000
