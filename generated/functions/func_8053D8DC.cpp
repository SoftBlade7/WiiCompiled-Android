...
extern "C" void func_8053D8DC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8053D8DC:
{
    ...
    r3 = MemoryInline::FlatRead32((r3 + 4));
    r0 = MemoryInline::FlatRead16((r3 + 1804));
    r0 = (r0 << 16);
...
// RECOMP_REGISTRATION base 0x8053D8DC func_8053D8DC preserves=true fpr_mask=0x00000000
