...
extern "C" void func_805D7F40(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805D7F40:
{
    ...
    MemoryInline::FlatWriteRam32((r5 + 24), r3);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
    return;
...
// RECOMP_REGISTRATION base 0x805D7F40 func_805D7F40 preserves=true fpr_mask=0x00000000
