...
extern "C" void func_80837C5C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80837C5C:
{
    ...
    r30 = r3;
    r0 = MemoryInline::FlatRead8((r3 + 1068));
...
// RECOMP_REGISTRATION base 0x80837C5C func_80837C5C preserves=false fpr_mask=0x80000000
