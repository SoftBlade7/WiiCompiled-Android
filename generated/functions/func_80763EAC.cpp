...
extern "C" void func_80763EAC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80763EAC:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r4 + 14628));
...
// RECOMP_REGISTRATION base 0x80763EAC func_80763EAC preserves=true fpr_mask=0x00000000
