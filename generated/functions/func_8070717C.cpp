...
extern "C" void func_8070717C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8070717C:
{
    r3 = (r3 + -136);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x8070516Cu>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8070717C func_8070717C preserves=true fpr_mask=0x00000000
