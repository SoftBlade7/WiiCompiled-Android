...
extern "C" void func_800CED8C(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = 0;
    MemoryInline::FlatWrite32((r13 + -26928), r0);
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x800CED8C func_800CED8C preserves=true fpr_mask=0x00000000
