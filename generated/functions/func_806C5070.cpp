...
extern "C" void func_806C5070(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806C5070:
{
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80828860u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_806C50D4:
{
    ...
    f1.d = MemoryInline::FlatReadFloat64((r30 + 32));
...
loc_806C5180:
{
    f30.d = MemoryInline::FlatReadFloat32((r30 + 20));
}
...
loc_806C51DC:
{
    r0 = MemoryInline::FlatRead32((r31 + 208));
    MemoryInline::FlatWriteRam32((r1 + 20), r0);
    f3.d = MemoryInline::FlatReadFloat64((r30 + 32));
...
// RECOMP_REGISTRATION base 0x806C5070 func_806C5070 preserves=false fpr_mask=0xC0000000
