...
extern "C" void func_808648C4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_808648C4:
{
    ...
    r4 = ctx->gpr[4];
    ctx->gpr[4] = r4;
    InvokeDirectCpu<0x808648ECu>(ctx);
    r4 = ctx->gpr[4];
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x808648C4 func_808648C4 preserves=true fpr_mask=0x00000000
