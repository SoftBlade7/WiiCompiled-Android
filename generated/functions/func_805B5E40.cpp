...
extern "C" void func_805B5E40(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805B5E40:
{
    ...
    f5 = ctx->fpr[5];
    f6 = ctx->fpr[6];
    guest_range_0 = MemoryInline::ResolveRangeHost((r1 + 20), 0, 68u, true, false);
    f2.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 0u, (r1 + 20));
    r3 = 0x80890000u;
    f1.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 28u, (r1 + 48));
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 8u, (r1 + 28));
    f6.d = PpcFmulsInline(f2.d, f1.d);
    f4.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 4u, (r1 + 24));
    f2.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 24u, (r1 + 44));
    f0.d = PpcFmulsInline(f0.d, f1.d);
    f1.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 32u, (r1 + 52));
    f5.d = PpcFmulsInline(f4.d, f2.d);
    f4.d = PpcFmulsInline(f4.d, f1.d);
    f3.d = MemoryInline::FlatReadFloat32((r3 + 10064));
    ...
    MemoryInline::FlatWriteFloat32((r30 + 292), f0.d);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r31 = MemoryInline::ReadResolved32(guest_range_0, 56u, (r1 + 76));
            r30 = MemoryInline::ReadResolved32(guest_range_0, 52u, (r1 + 72));
        }
    }
    r0 = MemoryInline::ReadResolved32(guest_range_0, 64u, (r1 + 84));
...
// RECOMP_GUEST_ABI gpr_read=0xC000003A gpr_write=0xC00000FB gpr_return=0x00000018 fpr_read=0xC0000000 fpr_write=0xC0003FFF fpr_return=0x00000002 cr_read=0x00 cr_write=0x00 xer_read=0 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x805B5E40 func_805B5E40 preserves=true fpr_mask=0x00000000
