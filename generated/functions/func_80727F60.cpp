...
extern "C" void func_80727F60(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80727F60:
{
    ...
    r25 = r5;
    r3 = 28;
    r6 = MemoryInline::FlatRead32((r6 + 11240));
    r28 = MemoryInline::FlatRead32((r6 + 20));
    ctx->lr = 0x80727F90u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_80727F98:
{
    MemoryInline::FlatWriteRam32((r3 + 24), r26);
    r0 = 0;
...
loc_80727FCC:
{
    MemoryInline::FlatWriteRam32((r3 + 24), r25);
    r0 = 0;
    MemoryInline::FlatWriteRam32(r3, r0);
    MemoryInline::FlatWriteRam32((r3 + 4), r0);
    MemoryInline::FlatWriteRam32((r3 + 8), r0);
...
// RECOMP_REGISTRATION base 0x80727F60 func_80727F60 preserves=true fpr_mask=0x00000000
