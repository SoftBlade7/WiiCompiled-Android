...
extern "C" void func_80511034(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
{
    r0 = 1;
    r31 = (static_cast<int32_t>(static_cast<int16_t>(r5)));
    r22 = PPC_Slw(static_cast<uint32_t>(r0), static_cast<uint32_t>(r4));
    r30 = 0;
    goto loc_805110EC;
}
...
// RECOMP_REGISTRATION base 0x80511034 func_80511034 preserves=true fpr_mask=0x00000000
