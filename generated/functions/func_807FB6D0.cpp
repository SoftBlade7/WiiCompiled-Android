...
extern "C" void func_807FB6D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807FB80C:
{
    ...
    r0 = PPC_Slw(static_cast<uint32_t>(r0), static_cast<uint32_t>(r26));
    r3 = 0x808D0000u;
    r0 = (r4 | r0);
...
// RECOMP_GUEST_ABI gpr_read=0xFE0003FF gpr_write=0xFE000BFB gpr_return=0x00000018 fpr_read=0xF000005F fpr_write=0xF000007F fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x807FB6D0 func_807FB6D0 preserves=false fpr_mask=0x80000000
