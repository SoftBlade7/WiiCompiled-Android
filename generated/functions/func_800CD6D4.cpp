...
extern "C" void func_800CD6D4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_800CD754:
{
    ...
    MemoryInline::FlatWriteRam32((r3 + 24), r31);
    MemoryInline::FlatWriteRam32((r3 + 16), r31);
    r0 = MemoryInline::FlatRead32((r13 + -26936));
}
...
loc_800CD788:
{
    MemoryInline::FlatWrite32((r13 + -26936), r3);
    r31 = r3;
    goto loc_800CD7A0;
}
...
loc_800CD7E8:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8011364Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800CD838:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801138E8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r31 = ctx->gpr[31];
...
// RECOMP_REGISTRATION base 0x800CD6D4 func_800CD6D4 preserves=true fpr_mask=0x00000000
