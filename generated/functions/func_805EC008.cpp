...
extern "C" void func_805EC008(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_805EC008:
{
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 0u, ((static_cast<uint64_t>(static_cast<uint32_t>(r24)) << 32) | static_cast<uint32_t>(r25)))) {
        MemoryInline::WriteResolved32(guest_range_3, 0u, (r1 + 8), r24);
        MemoryInline::WriteResolved32(guest_range_3, 4u, (r1 + 12), r25);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 8u, ((static_cast<uint64_t>(static_cast<uint32_t>(r26)) << 32) | static_cast<uint32_t>(r27)))) {
        MemoryInline::WriteResolved32(guest_range_3, 8u, (r1 + 16), r26);
        MemoryInline::WriteResolved32(guest_range_3, 12u, (r1 + 20), r27);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 16u, ((static_cast<uint64_t>(static_cast<uint32_t>(r28)) << 32) | static_cast<uint32_t>(r29)))) {
        MemoryInline::WriteResolved32(guest_range_3, 16u, (r1 + 24), r28);
        MemoryInline::WriteResolved32(guest_range_3, 20u, (r1 + 28), r29);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r30)) << 32) | static_cast<uint32_t>(r12)))) {
        MemoryInline::WriteResolved32(guest_range_3, 24u, (r1 + 32), r30);
    ...
    MemoryInline::WriteResolved32(guest_range_3, 48u, (r1 + 56), r0);
    ctx->lr = 0x805EC170u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x805EC008 func_805EC008 preserves=true fpr_mask=0x00000000
