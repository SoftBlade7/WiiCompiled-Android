...
extern "C" void func_80786FC0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80786FC0:
{
    ...
    r27 = 0;
    r26 = 0;
    r28 = MemoryInline::FlatRead32((r5 + -10520));
...
loc_8078702C:
{
    ...
    r29 = PPC_Slw(static_cast<uint32_t>(r31), static_cast<uint32_t>(r0));
    r0 = (r27 & r29);
...
loc_8078703C:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x805160B0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80786FC0 func_80786FC0 preserves=true fpr_mask=0x00000000
