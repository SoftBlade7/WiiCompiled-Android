...
extern "C" void func_806AF038(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806AF038:
{
    ...
    guest_range_0 = MemoryInline::ResolveRangeHost((r3 + 11), 0, 2679u, true, false);
    r5 = MemoryInline::ReadResolved32(guest_range_0, 281u, (r3 + 292));
}
...
loc_806AF080:
{
    r0 = MemoryInline::ReadResolved32(guest_range_0, 813u, (r3 + 824));
...
loc_806AF094:
{
    r0 = MemoryInline::ReadResolved32(guest_range_0, 797u, (r3 + 808));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_806AF0A0:
{
    f9.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 1765u, (r3 + 1776));
...
loc_806AF0B8:
{
    f9.d = MemoryInline::FlatReadFloat32(r7);
    SetCRFloatResident(cr, 0, f0.d, f9.d);
}
...
loc_806AF0D0:
{
    r0 = MemoryInline::ReadResolved8(guest_range_0, 56u, (r3 + 67));
    r4 = 0;
}
...
loc_806AF0E0:
{
    r0 = MemoryInline::ReadResolved8(guest_range_0, 175u, (r3 + 186));
}
...
loc_806AF104:
{
    ...
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 1765u, (r3 + 1776));
    f9.d = PpcFmulsInline(f1.d, f0.d);
}

loc_806AF110:
{
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 2661u, (r3 + 2672));
    r5 = 1127219200;
    f7.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 2665u, (r3 + 2676));
    r4 = (r1 + 8);
    {
        const auto resolved_pair = MemoryInline::ReadResolvedPair32(guest_range_0, 2669u);
        if (resolved_pair.valid) {
            f1.d = PpcBitCastToFloatInline(resolved_pair.first);
            f8.d = PpcBitCastToFloatInline(resolved_pair.second);
        } else {
            f1.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 2669u, (r3 + 2680));
            f8.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 2673u, (r3 + 2684));
        }
    }
    f0.d = static_cast<double>(PpcForceSingleValueInline(f0.d - f7.d));
    f6.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 1765u, (r3 + 1776));
    r6 = MemoryInline::ReadResolved8(guest_range_0, 2677u, (r3 + 2688));
    f4.d = static_cast<double>(PpcForceSingleValueInline(f1.d - f8.d));
    r0 = MemoryInline::ReadResolved8(guest_range_0, 2678u, (r3 + 2689));
    f5.d = static_cast<double>(PpcForceSingleValueInline(f0.d / f6.d));
    f0.d = MemoryInline::FlatReadFloat32((r7 + 4));
    r3 = (r1 + 16);
    MemoryInline::FlatWriteRamFloat32((r1 + 8), f0.d);
    f3.d = MemoryInline::FlatReadFloat64((r7 + 88));
    ...
    f30.d = static_cast<double>(PpcForceSingleValueInline(f7.d + f4.d));
...
loc_806AF348:
{
    r3 = MemoryInline::FlatRead32((r30 + 808));
    r12 = MemoryInline::FlatRead32(r3);
    r12 = MemoryInline::FlatRead32((r12 + 12));
    ctr = r12;
    ctx->lr = 0x806AF35Cu;
...
loc_806AF3C8:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r30 + 812));
    r12 = MemoryInline::FlatRead32(r3);
    r12 = MemoryInline::FlatRead32((r12 + 12));
    ctr = r12;
    ctx->lr = 0x806AF3F0u;
...
// RECOMP_REGISTRATION base 0x806AF038 func_806AF038 preserves=false fpr_mask=0xC0000000
