...
extern "C" void func_805BD518(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_805BD518:
{
    ...
    r28 = r9;
    r4 = r31;
    MemoryInline::FlatWrite32((r3 + 580), r7);
    r3 = (r1 + 8);
...
loc_805BD5F0:
{
    ...
    r4 = MemoryInline::FlatRead32((r31 + 580));
    r3 = (r31 + 372);
...
loc_805BD6A8:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r31 + 584), r3);
    r4 = (r30 + 31);
    r3 = (r31 + 168);
    ctx->lr = 0x805BD6D8u;
    ctx->gpr[0] = r0;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r31 + 588), r3);
    r3 = r31;
...
// RECOMP_REGISTRATION base 0x805BD518 func_805BD518 preserves=true fpr_mask=0x00000000
