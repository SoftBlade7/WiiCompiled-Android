...
extern "C" void func_80812384(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80812384:
{
    ...
    r30 = MemoryInline::FlatRead16((r3 + 42));
    r30 = (r30 << 16);
...
loc_808123C0:
{
    ...
    r3_addr_2 = (r3 + r31);
    r25 = MemoryInline::FlatRead32(r3_addr_2);
    ...
    xer = ctx->xer;
    r0 = (r3 & 65535);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r0), static_cast<uint32_t>(529));
}
...
loc_80812400:
{
    MemoryInline::FlatWrite32((r27 + 332), r25);
}
...
loc_80812420:
{
    if ((static_cast<uint32_t>(r0) != static_cast<uint32_t>(529))) {
        goto loc_80812440;
    }
}
...
{
    r0 = 1;
    MemoryInline::FlatWrite32((r27 + 260), r0);
}
...
// RECOMP_REGISTRATION base 0x80812384 func_80812384 preserves=true fpr_mask=0x00000000
