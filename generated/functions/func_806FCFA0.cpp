...
extern "C" void func_806FCFA0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r3 = (r29 + r28);
    f1.d = MemoryInline::FlatReadFloat32((r31 + 4960));
    r4 = r26;
    r3 = (r3 + 4);
    ctx->lr = 0x806FD010u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x806FCFA0 func_806FCFA0 preserves=true fpr_mask=0x00000000
