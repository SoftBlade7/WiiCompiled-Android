...
extern "C" void func_80538EB4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_80538F2C:
{
    MemoryInline::FlatWrite16((r31 + 28), static_cast<uint16_t>(r30));
...
// RECOMP_REGISTRATION base 0x80538EB4 func_80538EB4 preserves=true fpr_mask=0x00000000
