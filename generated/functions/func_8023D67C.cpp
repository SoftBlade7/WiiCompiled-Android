...
extern "C" void func_8023D67C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8023D6C4:
{
    ...
    r6 = (r13 + -23768);
    r5 = (r13 + -23776);
    f30.d = MemoryInline::FlatReadFloat32((r13 + -23984));
    f0.d = MemoryInline::FlatReadFloat32((r13 + -23776));
    f31.d = MemoryInline::FlatReadFloat32((r8 + 4));
    f1.d = MemoryInline::FlatReadFloat32((r5 + 4));
    f29.d = MemoryInline::FlatReadFloat32((r13 + -23976));
    f2.d = MemoryInline::FlatReadFloat32((r13 + -23768));
    f28.d = MemoryInline::FlatReadFloat32((r7 + 4));
    f3.d = MemoryInline::FlatReadFloat32((r6 + 4));
    MemoryInline::FlatWriteFloat32((r13 + -23984), f0.d);
    MemoryInline::FlatWriteFloat32((r8 + 4), f1.d);
    MemoryInline::FlatWriteFloat32((r13 + -23976), f2.d);
    MemoryInline::FlatWriteFloat32((r7 + 4), f3.d);
...
loc_8023D714:
{
    ...
    ctx->fpr[4] = f4;
    ctx->cr = cr;
    InvokeDirectCpu<0x80227868u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8023D724:
{
    ...
    ctx->fpr[4] = f4;
    ctx->cr = cr;
    InvokeDirectCpu<0x802277FCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8023D730:
{
    r4 = (r13 + -23984);
    r3 = (r13 + -23976);
    MemoryInline::FlatWriteFloat32((r13 + -23984), f30.d);
    MemoryInline::FlatWriteFloat32((r4 + 4), f31.d);
    MemoryInline::FlatWriteFloat32((r13 + -23976), f29.d);
    MemoryInline::FlatWriteFloat32((r3 + 4), f28.d);
    goto loc_8023D778;
}
...
loc_8023D778:
{
    ...
    r3 = r27;
    f2.d = f30.d;
    // inline leaf 0x8006A6D0 (6 guest instruction(s))
}
...
loc_inl1_cont_8006A6D0:
{
    // end of inlined leaf 0x8006A6D0
...
loc_inl3_cont_8006A610:
{
    // end of inlined leaf 0x8006A610
    // psq_load w=0 quant=0 (using PPC_PsqL)
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 28), 0, 92u, true, false);
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 68u, (r1 + 96));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f30.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 52u, (r1 + 80));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f29.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 36u, (r1 + 64));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r11 = (r1 + 48);
    f28.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 20u, (r1 + 48));
    ...
    r0 = MemoryInline::ReadResolved32(guest_range_1, 88u, (r1 + 116));
    ctx->lr = r0;
    r1 = (r1 + 112);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_GUEST_ABI gpr_read=0xFFC0271E gpr_write=0xFFC009FB gpr_return=0x00000018 fpr_read=0xFF003FFF fpr_write=0xFF0003FF fpr_return=0x00000002 cr_read=0xC1 cr_write=0xC1 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8023D67C func_8023D67C preserves=false fpr_mask=0xF0000000
