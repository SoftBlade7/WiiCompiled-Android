...
extern "C" void func_800709C0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
    uint32_t r3_rot_1 = 0;
...
loc_800709C0:
{
    ...
    r5 = MemoryInline::FlatRead8((r4 + 209));
...
// RECOMP_REGISTRATION base 0x800709C0 func_800709C0 preserves=false fpr_mask=0x80000000
