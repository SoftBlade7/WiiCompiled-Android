...
extern "C" void func_807D0D68(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807D0E00:
{
    ...
    r5 = ctx->gpr[5];
    cr = ctx->cr;
    r8 = MemoryInline::FlatRead8(r25);
    r5 = (r1 + 8);
    r7 = MemoryInline::FlatRead8((r25 + 1));
    r4 = 1;
...
// RECOMP_REGISTRATION base 0x807D0D68 func_807D0D68 preserves=true fpr_mask=0x00000000
