...
extern "C" void func_80760A44(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80760A64:
{
    r4 = 0x808A0000u;
    r0 = 5;
    f0.d = MemoryInline::FlatReadFloat32((r4 + 14588));
    r4 = 3;
...
// RECOMP_REGISTRATION base 0x80760A44 func_80760A44 preserves=true fpr_mask=0x00000000
