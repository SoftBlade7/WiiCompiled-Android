...
extern "C" void func_806A7D30(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806A7D30:
{
    ...
    r30 = r3;
    r31 = MemoryInline::FlatRead32((r3 + 640));
...
// RECOMP_REGISTRATION base 0x806A7D30 func_806A7D30 preserves=true fpr_mask=0x00000000
