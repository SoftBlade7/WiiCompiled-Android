...
extern "C" void func_801533C4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801533C4:
{
    ...
    r5 = ctx->gpr[5];
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80153480u>(ctx);
    r3 = ctx->gpr[3];
    r5 = ctx->gpr[5];
    ctx->gpr[3] = r3;
    return;
...
// RECOMP_REGISTRATION base 0x801533C4 func_801533C4 preserves=true fpr_mask=0x00000000
