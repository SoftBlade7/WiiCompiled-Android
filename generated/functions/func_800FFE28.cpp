...
extern "C" void func_800FFE28(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800FFE6C:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800F5154u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
{
    r0 = (r28 & 65535);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r0), static_cast<uint32_t>(6600));
}
...
loc_800FFF34:
{
    MemoryInline::FlatWrite16((r29 + 560), static_cast<uint16_t>(r28));
    goto loc_800FFF44;
}

loc_800FFF3C:
{
    // inline leaf 0x800F576C (9 guest instruction(s))
}
...
loc_inl2_cont_800F576C:
{
    // end of inlined leaf 0x800F576C
    MemoryInline::FlatWrite16((r29 + 560), static_cast<uint16_t>(r3));
}
...
loc_800FFF44:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800F5790u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
{
    r0 = 0;
    MemoryInline::FlatWrite16((r29 + 560), static_cast<uint16_t>(r0));
}
...
loc_800FFFD0:
{
    MemoryInline::FlatWrite32((r29 + 496), r3);
    if (((cr & 0x20000000u) == 0)) {
        goto loc_80100000;
    }
}
...
loc_80100128:
{
    ...
    MemoryInline::FlatWrite32((r29 + 500), r0);
}
...
// RECOMP_REGISTRATION base 0x800FFE28 func_800FFE28 preserves=true fpr_mask=0x00000000
