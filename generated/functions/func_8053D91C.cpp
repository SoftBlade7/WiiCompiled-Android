...
extern "C" void func_8053D91C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8053D91C:
{
    ...
    r3 = MemoryInline::FlatRead32((r3 + 4));
    r0 = MemoryInline::FlatRead16((r3 + 472));
    r0 = (r0 << 16);
...
// RECOMP_REGISTRATION base 0x8053D91C func_8053D91C preserves=true fpr_mask=0x00000000
