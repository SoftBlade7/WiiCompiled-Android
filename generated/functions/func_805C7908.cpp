...
extern "C" void func_805C7908(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805C792C:
{
    r4 = MemoryInline::FlatRead32((r3 + 6424));
    r0 = (r4 + -1);
    {
...
loc_805C793C:
{
    ...
    r4 = MemoryInline::FlatRead32((r4 + 608));
    r0 = (r4 + -1);
    MemoryInline::FlatWrite32((r3 + 6424), r0);
}
...
loc_inl1_cont_805E2500:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_1705 = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_1705[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_1705[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x805C7908 func_805C7908 preserves=true fpr_mask=0x00000000
