...
extern "C" void func_8070EB38(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8070EB6C:
{
    f31.d = MemoryInline::FlatReadFloat32((r26 + 4));
    r24 = (r1 + 8);
    r22 = 0;
    r30 = 0;
    r27 = 0x809C0000u;
...
loc_8070EB8C:
{
    r0 = MemoryInline::FlatRead32((r27 + 10232));
    r3 = MemoryInline::FlatRead32((r28 + 8880));
    r5 = (r0 + r30);
    r4 = MemoryInline::FlatRead16((r31 + 172));
    r4 = (r4 << 16);
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x806B475Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8070EBCC:
{
    r0 = MemoryInline::FlatRead8((r29 + 9908));
...
loc_8070EC1C:
{
    ...
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r0), static_cast<uint32_t>(866));
}
...
loc_8070EC4C:
{
    r0 = MemoryInline::FlatRead16((r31 + 144));
...
// RECOMP_REGISTRATION base 0x8070EB38 func_8070EB38 preserves=false fpr_mask=0x80000000
