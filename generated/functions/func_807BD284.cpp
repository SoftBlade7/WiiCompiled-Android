...
extern "C" void func_807BD284(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807BD284:
{
    ...
    MemoryInline::WriteResolved8(guest_range_0, 1u, (r5 + 2), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x807BD284 func_807BD284 preserves=true fpr_mask=0x00000000
