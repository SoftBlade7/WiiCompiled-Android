...
extern "C" void func_8054755C(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r3 = (r3 + 65536);
    r3 = MemoryInline::FlatRead32((r3 + -28036));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8054755C func_8054755C preserves=true fpr_mask=0x00000000
