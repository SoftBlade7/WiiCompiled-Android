...
extern "C" void func_8081B428(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8081B428:
{
    ...
    r0 = MemoryInline::FlatRead32((r3 + 17168));
...
{
    r3 = 0x809C0000u;
    MemoryInline::FlatWriteRam32((r3 + 17168), r31);
}
...
// RECOMP_REGISTRATION base 0x8081B428 func_8081B428 preserves=true fpr_mask=0x00000000
