...
extern "C" void func_8006CFC0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8006CFC0:
{
    ...
    f6.d = MemoryInline::FlatReadFloat32((r2 + -29316));
    ...
    f5.d = PpcFmulsInline(f10.d, f1.d);
    f9.d = PpcFmulsInline(f2.d, f10.d);
    f8.d = MemoryInline::FlatReadFloat32((r3 + 4));
...
// RECOMP_GUEST_ABI gpr_read=0x0000001C gpr_write=0x00000000 gpr_return=0x00000000 fpr_read=0x00000000 fpr_write=0x000007FF fpr_return=0x00000002 cr_read=0x00 cr_write=0x00 xer_read=0 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8006CFC0 func_8006CFC0 preserves=true fpr_mask=0x00000000
