...
extern "C" void func_806C7EA8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806C7EFC:
{
    MemoryInline::FlatWrite32((r30 + 228), r27);
    r29 = 0x808A0000u;
    r29 = (r29 + -1340);
    r31 = 0;
...
loc_806C8174:
{
    MemoryInline::FlatWrite32((r30 + 240), r28);
...
// RECOMP_REGISTRATION base 0x806C7EA8 func_806C7EA8 preserves=true fpr_mask=0x00000000
