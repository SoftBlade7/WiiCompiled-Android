...
extern "C" void func_807E8C5C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_stfsx_807E8D2C_loc_0 = 0;
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_807E8CE8:
{
    ...
    addr_stfsx_807E8D2C_loc_0 = (r30 + r0);
    MemoryInline::FlatWriteFloat32(addr_stfsx_807E8D2C_loc_0, f0.d);
    r30 = (r30 + 8);
...
// RECOMP_REGISTRATION base 0x807E8C5C func_807E8C5C preserves=true fpr_mask=0x00000000
