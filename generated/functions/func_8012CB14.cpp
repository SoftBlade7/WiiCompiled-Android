...
extern "C" void func_8012CB14(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8012CB84:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r28 + 60), r31);
}
...
loc_8012CBB8:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r28 + 124), r31);
}
...
// RECOMP_REGISTRATION base 0x8012CB14 func_8012CB14 preserves=true fpr_mask=0x00000000
