...
extern "C" void func_801B7878(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801B7878:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x801B7624u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801B78E8:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x801B76CCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801B7924:
{
    r3 = MemoryInline::FlatRead32((r13 + -28560));
    r4 = r30;
    ctx->lr = 0x801B7930u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_801B7938:
{
    r4 = MemoryInline::FlatRead32((r13 + -28560));
    r6 = r3;
    r5 = r30;
    r3 = (r31 + 264);
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
...
loc_801B79AC:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r12 = MemoryInline::FlatRead32((r27 + 4));
    r3 = r26;
...
// RECOMP_REGISTRATION base 0x801B7878 func_801B7878 preserves=true fpr_mask=0x00000000
