...
extern "C" void func_80584334(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80584334:
{
    ...
    ctx->fpr[2] = f2;
    ctx->cr = cr;
    InvokeDirectCpu<0x8053621Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->fpr[2] = f2;
    ctx->cr = cr;
    InvokeDirectCpu<0x806AC400u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    f1.d = MemoryInline::FlatReadFloat32((r4 + 23480));
    r3 = r29;
...
loc_805844D8:
{
    ...
    r31_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(24));
    r31 = (r31_rot_1 & 7);
}
...
loc_805844E8:
{
    ...
    r4 = 0x809C0000u;
    r3 = r29;
    r27 = MemoryInline::FlatRead32((r4 + 10424));
    // inline leaf 0x80590A5C (4 guest instruction(s))
    r3 = MemoryInline::FlatRead32(r3);
    r3 = MemoryInline::FlatRead32(r3);
    r3 = MemoryInline::FlatRead8((r3 + 16));
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8071E734u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r27 = ctx->gpr[27];
    ...
    MemoryInline::FlatWrite8((r3 + 105), static_cast<uint8_t>(r28));
    r0 = MemoryInline::FlatRead32((r31 + 18248));
}
...
loc_80584574:
{
    ...
    r3 = MemoryInline::FlatRead8((r3 + 16));
    // end of inlined leaf 0x80590A5C
    r4 = MemoryInline::FlatRead32((r31 + 18248));
    r0 = (r3 & 255);
    r3 = (r4 + r0);
    MemoryInline::FlatWrite8((r3 + 1260), static_cast<uint8_t>(r28));
}

loc_8058458C:
{
    r31 = 0x809C0000u;
    r0 = MemoryInline::FlatRead32((r31 + 18796));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_8058459C:
{
    ...
    r3 = MemoryInline::FlatRead8((r3 + 16));
    // end of inlined leaf 0x80590A5C
    r4 = MemoryInline::FlatRead32((r31 + 18796));
    r0 = (r3 & 255);
    r5 = 1;
    r3 = (r4 + r0);
...
loc_805845B8:
{
    ...
    ctx->fpr[2] = f2;
    ctx->cr = cr;
    InvokeDirectCpu<0x807263B0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r27 = MemoryInline::FlatRead8((r30 + 41));
    r3 = 0x809C0000u;
...
loc_80584614:
{
    r27 = MemoryInline::FlatRead16((r30 + 44));
    r27 = (r27 << 16);
...
// RECOMP_REGISTRATION base 0x80584334 func_80584334 preserves=true fpr_mask=0x00000000
