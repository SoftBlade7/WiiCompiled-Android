...
extern "C" void func_806F2074(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806F2074:
{
    ...
    r6 = MemoryInline::FlatRead32((r7 + 40));
    ...
    r4 = 0x808C0000u;
    f1.d = MemoryInline::FlatReadFloat32((r4 + 30640));
...
loc_806F210C:
{
    ...
    guest_range_0 = MemoryInline::ResolveRangeHost((r4 + -12), 0, 24u, true, false);
    {
    ...
    f3.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 0u, (r1 + 44));
    r5 = 0x809C0000u;
    f2.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 12u, (r1 + 56));
    r3 = (r1 + 20);
    f1.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 4u, (r1 + 48));
    r4 = (r1 + 56);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 16u, (r1 + 60));
    f2.d = PpcFmulsInline(f3.d, f2.d);
    f4.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 8u, (r1 + 52));
    f1.d = PpcFmulsInline(f1.d, f0.d);
    f3.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 20u, (r1 + 64));
    f0.d = MemoryInline::FlatReadFloat32((r5 + 8892));
...
// RECOMP_GUEST_ABI gpr_read=0x8000003F gpr_write=0x800000FB gpr_return=0x00000018 fpr_read=0x8000001F fpr_write=0x8000001F fpr_return=0x00000002 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x806F2074 func_806F2074 preserves=false fpr_mask=0x80000000
