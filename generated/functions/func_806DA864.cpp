...
extern "C" void func_806DA864(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806DA864:
{
    ...
    r4 = (r1 + 12);
    r7 = 0;
    r0 = MemoryInline::FlatRead32((r5 + 212));
    r5 = (r1 + 8);
...
// RECOMP_REGISTRATION base 0x806DA864 func_806DA864 preserves=true fpr_mask=0x00000000
