...
extern "C" void func_807849BC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80784AA0:
{
    ...
    f4 = ctx->fpr[4];
    cr = ctx->cr;
    f0.d = MemoryInline::FlatReadFloat32((r31 + 6060));
...
loc_80784AD0:
{
    ...
    f4 = ctx->fpr[4];
    cr = ctx->cr;
    f1.d = MemoryInline::FlatReadFloat32((r31 + 6060));
    r3 = (r1 + 56);
    r4 = (r1 + 68);
...
loc_80784B30:
{
    ...
    MemoryInline::FlatWriteRamFloat32(r3, f0.d);
    // end of inlined leaf 0x8051486C
    f1.d = MemoryInline::FlatReadFloat32((r26 + 18388));
    r3 = (r1 + 44);
    r4 = (r1 + 20);
    // inline leaf 0x80514810 (10 guest instruction(s))
    f3.d = MemoryInline::FlatReadFloat32((r4 + 8));
...
// RECOMP_REGISTRATION base 0x807849BC func_807849BC preserves=true fpr_mask=0x00000000
