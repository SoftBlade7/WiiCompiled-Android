...
extern "C" void func_805718D4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80571950:
{
    ...
    r3 = (r25 + 4);
    f0.d = (-(f0.d));
    f30.d = PpcFmulsInline(f0.d, f30.d);
    ...
    f2.d = MemoryInline::FlatReadFloat32((r25 + 80));
...
loc_80571A40:
{
    ...
    f6.d = PpcFmulsInline(f6.d, f30.d);
...
loc_80571AA8:
{
    r4 = 0x808A0000u;
    r3 = 0x809C0000u;
    r29 = MemoryInline::FlatRead32((r4 + 26368));
    f1.d = f31.d;
...
loc_80571AE8:
{
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8056F510u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80571B50:
{
    ...
    r0 = (r0 | 1);
    MemoryInline::FlatWrite32((r25 + 44), r0);
}
...
// RECOMP_REGISTRATION base 0x805718D4 func_805718D4 preserves=false fpr_mask=0xC0000000
