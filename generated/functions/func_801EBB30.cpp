...
extern "C" void func_801EBB30(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_801EBB48:
{
    ...
    r0 = (r0_rot_0 & 1048560);
    r3 = (r4 + r0);
    r3 = MemoryInline::FlatRead32((r3 + 136));
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->cr = cr;
...
// RECOMP_REGISTRATION base 0x801EBB30 func_801EBB30 preserves=true fpr_mask=0x00000000
