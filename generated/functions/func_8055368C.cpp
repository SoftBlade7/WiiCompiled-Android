...
extern "C" void func_8055368C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8055368C:
{
    ...
    r25 = 0;
    r28 = MemoryInline::FlatRead16((r4 + -470));
    r4 = 274857984;
    r29 = MemoryInline::FlatRead16((r5 + -472));
    r24 = r3;
    r23 = (r28 * r25);
    r21 = (r4 + 19923);
    r27 = 1;
...
loc_805536D8:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80207EB0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8055368C func_8055368C preserves=true fpr_mask=0x00000000
