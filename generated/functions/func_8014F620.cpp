...
extern "C" void func_8014F620(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r4_rot_0 = 0;
    uint32_t r4_rot_1 = 0;
...
loc_8014F680:
{
    ...
    r5 = r3;
    r4 = 0;
    MemoryInline::FlatWrite8((r3 + 22), static_cast<uint8_t>(r6));
...
// RECOMP_REGISTRATION base 0x8014F620 func_8014F620 preserves=true fpr_mask=0x00000000
