...
extern "C" void func_8076A024(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8076A024:
{
    ...
    f2.d = MemoryInline::FlatReadFloat32((r4 + 15544));
...
loc_8076A094:
{
    ...
    cr = ctx->cr;
    ctr = ctx->ctr;
    r5 = MemoryInline::FlatRead32((r30 + 260));
    r31 = 0x808A0000u;
...
// RECOMP_REGISTRATION base 0x8076A024 func_8076A024 preserves=true fpr_mask=0x00000000
