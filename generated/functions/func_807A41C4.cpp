...
extern "C" void func_807A41C4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807A41C4:
{
    ...
    f30.d = MemoryInline::FlatReadFloat32((r5 + 21752));
    r17 = r3;
    f31.d = MemoryInline::FlatReadFloat32((r4 + 21756));
    r21 = (r21 + 7136);
    r24 = (r24 + 12104);
    r31 = (r30 + 6936);
    r16 = 0;
...
loc_807A4268:
{
    ...
    r31 = ctx->gpr[31];
    f0 = ctx->fpr[0];
    guest_range_2 = MemoryInline::ResolveRangeHost(r18, 0, 452u, false, true);
    MemoryInline::WriteResolved16(guest_range_2, 424u, (r18 + 424), static_cast<uint16_t>(r19));
    r0 = (r21 + 56);
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 428u, ((static_cast<uint64_t>(static_cast<uint32_t>(r20)) << 32) | static_cast<uint32_t>(r19)))) {
        MemoryInline::WriteResolved32(guest_range_2, 428u, (r18 + 428), r20);
        MemoryInline::WriteResolved32(guest_range_2, 432u, (r18 + 432), r19);
    }
    MemoryInline::WriteResolved16(guest_range_2, 436u, (r18 + 436), static_cast<uint16_t>(r19));
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 444u, ((static_cast<uint64_t>(static_cast<uint32_t>(r19)) << 32) | static_cast<uint32_t>(r19)))) {
        MemoryInline::WriteResolved32(guest_range_2, 444u, (r18 + 444), r19);
        MemoryInline::WriteResolved32(guest_range_2, 448u, (r18 + 448), r19);
    }
    MemoryInline::WriteResolved32(guest_range_2, 0u, r18, r21);
    MemoryInline::WriteResolved32(guest_range_2, 420u, (r18 + 420), r0);
    f0.d = MemoryInline::FlatReadFloat32((r24 + 1108));
    MemoryInline::FlatWriteRamFloat32((r22 + 13872), f30.d);
    f0.d = PpcFmulsInline(f30.d, f0.d);
    r3 = MemoryInline::FlatRead32((r26 + -10456));
    MemoryInline::FlatWriteRamFloat32((r23 + 13876), f31.d);
    f0.d = PpcFmulsInline(f0.d, f0.d);
    MemoryInline::FlatWriteRamFloat32((r25 + 13880), f0.d);
...
loc_807A42C0:
{
    MemoryInline::FlatWriteRam32((r29 + 13884), r27);
    goto loc_807A42D4;
}

loc_807A42C8:
{
    MemoryInline::FlatWriteRam32((r29 + 13884), r28);
    goto loc_807A42D4;
}

loc_807A42D0:
{
    MemoryInline::FlatWriteRam32((r29 + 13884), r14);
}

loc_807A42D4:
{
    MemoryInline::FlatWriteRam32((r18 + 448), r18);
    r0 = 3;
    r3 = 6;
    MemoryInline::FlatWriteRam32((r18 + 444), r31);
    MemoryInline::FlatWriteRam16((r18 + 436), static_cast<uint16_t>(r0));
    ctx->lr = 0x807A42ECu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_807A4344:
{
    MemoryInline::FlatWrite32(r17, r18);
    r17 = (r17 + 4);
    r16 = (r16 + 1);
}
...
// RECOMP_REGISTRATION base 0x807A41C4 func_807A41C4 preserves=false fpr_mask=0xC0000000
