...
extern "C" void func_807560C8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80756180:
{
    ...
    r3 = 0x808D0000u;
    r0 = 0;
    r3 = MemoryInline::FlatRead32((r3 + -15192));
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFEFFF gpr_write=0xFFFFFFFF gpr_return=0x00000018 fpr_read=0xFFFFFFE7 fpr_write=0xFFFFFFFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x807560C8 func_807560C8 preserves=false fpr_mask=0x80000000
