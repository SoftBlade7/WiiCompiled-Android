...
extern "C" void func_8023C394(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
// RECOMP_REGISTRATION base 0x8023C394 func_8023C394 preserves=true fpr_mask=0x00000000
