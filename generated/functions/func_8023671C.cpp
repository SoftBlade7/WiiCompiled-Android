...
extern "C" void func_8023671C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lfsx_80236B3C_loc_0 = 0;
    uint32_t cr0_0 = 0;
...
loc_80236A18:
{
    ...
    ctx->gpr[7] = r7;
    InvokeDirectCpu<0x80171D20u>(ctx);
    r7 = MemoryInline::FlatRead8((r27 + 49));
    r3 = 7;
    r4 = 0;
    r5 = 0;
    r6 = 4;
...
loc_80236A94:
{
    ...
    InvokeDirectCpu<0x801717ACu>(ctx);
    r31 = 0x80260000u;
    f30.d = MemoryInline::FlatReadFloat32((r2 + -24732));
    f31.d = MemoryInline::FlatReadFloat32((r2 + -24728));
    r31 = (r31 + -32408);
    r28 = 0;
    r29 = 0;
}
...
loc_80236B18:
{
    r3 = MemoryInline::FlatRead16((r27 + 52));
    r3 = (r3 << 16);
...
loc_80236B20:
{
    f1.d = MemoryInline::FlatReadFloat32((r2 + -24732));
    goto loc_80236B2C;
}

loc_80236B28:
{
    f1.d = MemoryInline::FlatReadFloat32((r2 + -24764));
}
...
loc_80236B34:
{
    r0 = (r0 * 12);
    r0 = (r29 + r0);
    addr_lfsx_80236B3C_loc_0 = (r31 + r0);
    f0.d = MemoryInline::FlatReadFloat32(addr_lfsx_80236B3C_loc_0);
...
loc_80236B54:
{
    f0.d = MemoryInline::FlatReadFloat32((r2 + -24768));
}
...
loc_80236B58:
{
    ...
    r0 = (r3 + -2);
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 48), 0, 24u, false, true);
    MemoryInline::WriteResolved32(guest_range_1, 4u, (r1 + 52), r30);
    f1.d = PpcFmulsInline(f2.d, f31.d);
    r3 = (r28 + 1);
    r4 = (r1 + 48);
    MemoryInline::WriteResolved32(guest_range_1, 0u, (r1 + 48), r30);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 12u, ((static_cast<uint64_t>(static_cast<uint32_t>(r30)) << 32) | static_cast<uint32_t>(r30)))) {
        MemoryInline::WriteResolved32(guest_range_1, 16u, (r1 + 64), r30);
        MemoryInline::WriteResolved32(guest_range_1, 12u, (r1 + 60), r30);
    }
    MemoryInline::WriteResolved32(guest_range_1, 8u, (r1 + 56), r30);
    MemoryInline::WriteResolved32(guest_range_1, 20u, (r1 + 68), r30);
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 0u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f1.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f2.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 0u, (r1 + 48), f1.d);
        MemoryInline::WriteResolvedFloat32(guest_range_1, 4u, (r1 + 52), f2.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 12u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f3.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 12u, (r1 + 60), f0.d);
        MemoryInline::WriteResolvedFloat32(guest_range_1, 16u, (r1 + 64), f3.d);
    }
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
// RECOMP_REGISTRATION base 0x8023671C func_8023671C preserves=false fpr_mask=0xC0000000
