...
extern "C" void func_80239690(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80239690:
{
    r3 = (r3 + -72);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80239338u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80239690 func_80239690 preserves=true fpr_mask=0x00000000
