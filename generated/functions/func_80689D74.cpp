...
extern "C" void func_80689D74(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80689D74:
{
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r27), static_cast<uint32_t>(9));
}
...
// RECOMP_REGISTRATION base 0x80689D74 func_80689D74 preserves=false fpr_mask=0xF8000000
