...
extern "C" void func_8061F528(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8061F528:
{
    ...
    r4 = 0x80890000u;
    r3 = r31;
    f1.d = MemoryInline::FlatReadFloat32((r4 + 31928));
    r4 = -1;
...
// RECOMP_REGISTRATION base 0x8061F528 func_8061F528 preserves=true fpr_mask=0x00000000
