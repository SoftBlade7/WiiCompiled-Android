...
extern "C" void func_80671390(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806713E8:
{
    ...
    r0 = 18;
    r4 = 0x80670000u;
    MemoryInline::FlatWrite8((r30 + 16896), static_cast<uint8_t>(r31));
    r5 = r30;
...
// RECOMP_REGISTRATION base 0x80671390 func_80671390 preserves=true fpr_mask=0x00000000
