...
extern "C" void func_801D17EC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801D17EC:
{
    r3 = MemoryInline::FlatRead32((r13 + -28440));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x801D17EC func_801D17EC preserves=true fpr_mask=0x00000000
