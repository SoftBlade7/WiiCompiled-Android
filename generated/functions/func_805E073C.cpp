...
extern "C" void func_805E073C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_805E073C:
{
    ...
    ctr = ctx->ctr;
    r0 = 2;
    MemoryInline::FlatWrite32((r30 + 2192), r0);
    r3 = (r30 + 1616);
    r4 = (r30 + 68);
    r5 = 0;
    ctx->gpr[0] = r0;
    ...
    ctr = ctx->ctr;
    r0 = 3;
    MemoryInline::FlatWrite32((r30 + 2788), r0);
    r3 = (r30 + 2212);
    r4 = (r30 + 68);
    r5 = 0;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x805E073C func_805E073C preserves=true fpr_mask=0x00000000
