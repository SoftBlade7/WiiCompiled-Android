...
extern "C" void func_8052292C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8052292C:
{
    r3 = MemoryInline::FlatRead32((r3 + 2268));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8052292C func_8052292C preserves=true fpr_mask=0x00000000
