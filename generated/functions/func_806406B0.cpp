...
extern "C" void func_806406B0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8064077C:
{
    ...
    r3 = (r24 + 380);
    r0 = (r24 + 752);
    MemoryInline::FlatWrite32((r24 + 1124), r3);
    r31 = (r31 + -28796);
    r3 = (r24 + 168);
    MemoryInline::FlatWrite32((r24 + 1128), r0);
    r4 = (r31 + 229);
    ctx->lr = 0x806407A0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r24 + 1132), r3);
    r4 = (r31 + 243);
    r3 = (r24 + 168);
    ctx->lr = 0x806407B0u;
    ctx->gpr[0] = r0;
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r24 + 1136), r3);
    r3 = (r1 + 48);
    r4 = -1;
    ctx->lr = 0x806407C0u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x806406B0 func_806406B0 preserves=true fpr_mask=0x00000000
