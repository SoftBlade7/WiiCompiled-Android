...
extern "C" void func_807585D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807585D0:
{
    ...
    r0 = (r1 + 104);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r1)) + static_cast<uint64_t>(static_cast<uint32_t>(104)) + (static_cast<uint64_t>(static_cast<uint32_t>(0)) & 1u);
...
loc_807585E8:
{
    ...
    f31.d = MemoryInline::FlatReadFloat32((r3 + 304));
    if (((cr & 0x20000000u) != 0)) {
        goto loc_80758608;
    }
}
...
loc_80758608:
{
    ...
    r3 = 0x808A0000u;
    r4 = 0x802A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 13544));
    r3 = (r1 + 56);
    r4 = (r4 + 16688);
...
// RECOMP_REGISTRATION base 0x807585D0 func_807585D0 preserves=false fpr_mask=0x80000000
