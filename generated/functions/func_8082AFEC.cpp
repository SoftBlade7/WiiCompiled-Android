...
extern "C" void func_8082AFEC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8082B098:
{
    ...
    r3_addr_3 = (r3 + r27);
    MemoryInline::FlatWrite32(r3_addr_3, r29);
    r27 = (r27 + 4);
}
...
loc_8082B0C8:
{
    MemoryInline::FlatWrite32((r25 + 76), r26);
    r11 = (r1 + 48);
    r3 = r26;
...
// RECOMP_REGISTRATION base 0x8082AFEC func_8082AFEC preserves=true fpr_mask=0x00000000
