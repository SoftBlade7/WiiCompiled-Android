...
extern "C" void func_8078DE04(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8078DE04:
{
    ...
    ctx->gpr[5] = r5;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x805B9010u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r4 = (r3 + 40);
    MemoryInline::FlatWrite32((r31 + 76), r4);
    r3 = r31;
...
// RECOMP_REGISTRATION base 0x8078DE04 func_8078DE04 preserves=true fpr_mask=0x00000000
