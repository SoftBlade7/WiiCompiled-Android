...
extern "C" void func_806CA6CC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806CA6CC:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r5 + -1560));
...
// RECOMP_REGISTRATION base 0x806CA6CC func_806CA6CC preserves=true fpr_mask=0x00000000
