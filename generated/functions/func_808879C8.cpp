...
extern "C" void func_808879C8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_808879C8:
{
    ...
    r0 = 0;
    r7 = (r1 + 8);
    r5 = MemoryInline::FlatRead32((r4 + 9792));
    r4 = (r1 + 16);
...
// RECOMP_REGISTRATION base 0x808879C8 func_808879C8 preserves=true fpr_mask=0x00000000
