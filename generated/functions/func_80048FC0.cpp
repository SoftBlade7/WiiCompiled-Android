...
extern "C" void func_80048FC0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80048FC0:
{
    ...
    MemoryInline::FlatWriteRamFloat64((r1 + 272), f29.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_2 = (r1 + 280);
    ...
    r3 = MemoryInline::FlatRead32((r22 + 36));
    r27 = r4;
    ...
    r0 = MemoryInline::FlatRead8((r23 + 169));
    r25 = r3;
...
loc_800490E4:
{
    f29.d = MemoryInline::FlatReadFloat32((r2 + -29928));
    goto loc_80049108;
}
...
loc_80049118:
{
    r3_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r25), static_cast<uint32_t>(1));
    r3 = (r3_rot_1 & -2);
    r17 = -2;
    r18 = (r3 + 1);
}
...
loc_80049248:
{
    r4 = (r15 + 1);
    r0 = (r18 ^ -2147483648);
    r3 = (static_cast<int32_t>((static_cast<int64_t>(static_cast<int32_t>(r25)) * static_cast<int64_t>(static_cast<int32_t>(r4))) >> 32));
    MemoryInline::FlatWriteRam32((r1 + 188), r0);
    r20 = r16;
    f1.d = f30.d;
    f0.d = MemoryInline::FlatReadFloat64((r1 + 184));
...
// RECOMP_REGISTRATION base 0x80048FC0 func_80048FC0 preserves=false fpr_mask=0xE0000000
