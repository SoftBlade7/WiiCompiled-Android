...
extern "C" void func_800991A0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800991A0:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead8((r29 + 233));
}
...
loc_80099208:
{
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWrite8((r29 + 233), static_cast<uint8_t>(r0));
}
...
loc_80099238:
{
    ...
    r6 = ctx->gpr[6];
    r0 = 0;
    MemoryInline::FlatWrite8((r29 + 232), static_cast<uint8_t>(r0));
}
...
loc_80099274:
{
    r3 = MemoryInline::FlatRead32((r26 + 276));
}
...
loc_80099290:
{
    ...
    r4 = MemoryInline::FlatRead32((r26 + 276));
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r26 + 276), r28);
    ctx->lr = 0x800992B4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_800992CC:
{
    ...
    ctx->gpr[30] = r30;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x80099080u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800993AC:
{
    MemoryInline::FlatWrite32((r27 + 276), r25);
    r3 = r25;
    r4 = r26;
    // inline leaf 0x8009AE00 (2 guest instruction(s))
    MemoryInline::FlatWrite8((r3 + 4), static_cast<uint8_t>(r4));
    // end of inlined leaf 0x8009AE00
    ctx->lr = 0x800993C0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_800993F4:
{
    ...
    r6 = ctx->gpr[6];
    r0 = 1;
    MemoryInline::FlatWrite32((r29 + 272), r30);
    MemoryInline::FlatWrite8((r29 + 232), static_cast<uint8_t>(r0));
    ctx->lr = 0x80099410u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x800991A0 func_800991A0 preserves=true fpr_mask=0x00000000
