...
extern "C" void func_80629954(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80629954:
{
    ...
    r11 = MemoryInline::FlatRead32((r29 + 2464));
    ...
    r8 = MemoryInline::FlatRead32((r29 + 2476));
    ...
    r9 = 0x808C0000u;
    r7 = 0x808C0000u;
    guest_range_5 = MemoryInline::ResolveRangeHost((r29 + 2488), 0, 60u, true, false);
    r21 = MemoryInline::ReadResolved32(guest_range_5, 0u, (r29 + 2488));
    r9 = (r9 + -12252);
    ...
    MemoryInline::WriteResolved32(guest_range_1, 16u, (r28 + 1636), r22);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r24 = MemoryInline::ReadResolved32(guest_range_5, 12u, (r29 + 2500));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r27 = MemoryInline::ReadResolved32(guest_range_5, 24u, (r29 + 2512));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r10 = MemoryInline::ReadResolved32(guest_range_5, 36u, (r29 + 2524));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_5, 48u, (r29 + 2536));
    ...
    f0 = ctx->fpr[0];
    r3 = (r29 + 2548);
    r30 = MemoryInline::FlatRead32((r29 + 2548));
    r11 = MemoryInline::FlatRead32((r3 + 4));
    r9 = 0x808C0000u;
    r10 = MemoryInline::FlatRead32((r3 + 8));
    r9 = (r9 + -12168);
    guest_range_3 = MemoryInline::ResolveRangeHost((r21 + 3844), 0, 40u, false, true);
    MemoryInline::WriteResolved32(guest_range_3, 16u, (r21 + 3860), r10);
    r6 = (r29 + 2560);
    r3 = (r28 + 1072);
    r4 = 1;
    MemoryInline::WriteResolved32(guest_range_3, 0u, (r21 + 3844), r9);
    r5 = 0;
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 4u, ((static_cast<uint64_t>(static_cast<uint32_t>(r21)) << 32) | static_cast<uint32_t>(r30)))) {
        MemoryInline::WriteResolved32(guest_range_3, 4u, (r21 + 3848), r21);
        MemoryInline::WriteResolved32(guest_range_3, 8u, (r21 + 3852), r30);
    }
    MemoryInline::WriteResolved32(guest_range_3, 12u, (r21 + 3856), r11);
    r8 = MemoryInline::FlatRead32((r29 + 2560));
    r7 = MemoryInline::FlatRead32((r6 + 4));
    r0 = MemoryInline::FlatRead32((r6 + 8));
    MemoryInline::WriteResolved32(guest_range_3, 36u, (r21 + 3880), r0);
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 20u, ((static_cast<uint64_t>(static_cast<uint32_t>(r9)) << 32) | static_cast<uint32_t>(r21)))) {
        MemoryInline::WriteResolved32(guest_range_3, 20u, (r21 + 3864), r9);
        MemoryInline::WriteResolved32(guest_range_3, 24u, (r21 + 3868), r21);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 28u, ((static_cast<uint64_t>(static_cast<uint32_t>(r8)) << 32) | static_cast<uint32_t>(r7)))) {
        MemoryInline::WriteResolved32(guest_range_3, 28u, (r21 + 3872), r8);
        MemoryInline::WriteResolved32(guest_range_3, 32u, (r21 + 3876), r7);
    }
...
// RECOMP_REGISTRATION base 0x80629954 func_80629954 preserves=true fpr_mask=0x00000000
