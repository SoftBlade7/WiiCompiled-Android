...
extern "C" void func_8070EA24(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8070EA24:
{
    ...
    r28 = r4;
    r0 = MemoryInline::FlatRead8((r3 + 147));
...
loc_8070EACC:
{
    ...
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r0), static_cast<uint32_t>(546));
}
...
// RECOMP_REGISTRATION base 0x8070EA24 func_8070EA24 preserves=true fpr_mask=0x00000000
