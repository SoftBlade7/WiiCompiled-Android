...
extern "C" void func_801D4A34(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801D4A9C:
{
    ...
    r4 = (r4 + 12104);
    r5 = MemoryInline::FlatRead32((r30 + 1080));
    ctr = r12;
    ctx->lr = 0x801D4AB4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x801D4A34 func_801D4A34 preserves=true fpr_mask=0x00000000
