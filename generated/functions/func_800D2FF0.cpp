...
extern "C" void func_800D2FF0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800D3030:
{
    ...
    r0 = MemoryInline::FlatRead32((r4 + 2684));
...
loc_800D30B0:
{
    ...
    r5 = 0;
    r24 = (r0 + r25);
    r3 = MemoryInline::FlatRead32((r24 + 924));
    r4 = MemoryInline::FlatRead16((r24 + 932));
    ctx->lr = 0x800D30C8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r6 = MemoryInline::FlatRead8((r24 + 942));
    r8 = r3;
    r7 = MemoryInline::FlatRead32((r24 + 920));
    r5 = r23;
    r4 = (r31 + 1320);
    r3 = 4;
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
...
loc_800D3164:
{
    ...
    r4 = r27;
    r5 = r28;
    r12 = MemoryInline::FlatRead32((r8 + 136));
    r6 = r29;
    r7 = r30;
    r8 = MemoryInline::FlatRead32((r8 + 140));
    ctr = r12;
    ctx->lr = 0x800D318Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x800D2FF0 func_800D2FF0 preserves=true fpr_mask=0x00000000
