...
extern "C" void func_807E9D9C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807E9D9C:
{
    ...
    r3 = 0x809C0000u;
    r4 = (r4 + 7812);
    MemoryInline::FlatWriteRam32((r3 + 16352), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x807E9D9C func_807E9D9C preserves=true fpr_mask=0x00000000
