...
extern "C" void func_806CC8E8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806CC8E8:
{
    ...
    r4 = 0x808A0000u;
    r25 = r3;
    f31.d = MemoryInline::FlatReadFloat32((r4 + -1344));
    r26 = 1;
    r27 = 4;
    r30 = 0x808C0000u;
    r31 = 0x809C0000u;
...
loc_806CC928:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r29 + 17276));
    r3 = (r1 + 8);
    r4 = (r1 + 32);
    ...
    f2 = ctx->fpr[2];
    f3 = ctx->fpr[3];
    r3 = MemoryInline::FlatRead8((r25 + 208));
    r0 = (r3 + -1);
...
loc_806CC980:
{
    f1.d = MemoryInline::FlatReadFloat32((r30 + 17272));
    r4 = (r1 + 20);
...
loc_806CC998:
{
    f0.d = MemoryInline::FlatReadFloat32((r30 + 17272));
    r4 = (r1 + 20);
    r3 = MemoryInline::FlatRead32((r31 + 13848));
    r5 = 9;
...
// RECOMP_REGISTRATION base 0x806CC8E8 func_806CC8E8 preserves=false fpr_mask=0x80000000
