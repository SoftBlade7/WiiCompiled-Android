...
extern "C" void func_8076BDF4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8076BDF4:
{
    ...
    r24 = MemoryInline::FlatRead32((r3 + 192));
    r25 = r4;
    f29.d = f1.d;
    r26 = r3;
}
...
loc_8076BE6C:
{
    ...
    r0_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r24), static_cast<uint32_t>(2));
    r0 = (r0_rot_0 & -4);
}
...
loc_8076BE78:
{
    ...
    MemoryInline::FlatWrite32((r31 + 176), r25);
    MemoryInline::FlatWrite32((r31 + 192), r23);
    MemoryInline::FlatWrite32((r31 + 188), r28);
...
{
    r3 = 0x808D0000u;
    r0 = MemoryInline::FlatRead32((r3 + -6252));
    MemoryInline::FlatWrite32((r31 + 180), r0);
}
...
loc_8076BEA4:
{
    ...
    r3 = 0x808A0000u;
    r25 = 0x802A0000u;
    f30.d = MemoryInline::FlatReadFloat32((r4 + 15536));
    f31.d = MemoryInline::FlatReadFloat32((r3 + 15540));
    r26 = (r25 + 16712);
    r30 = 0;
    r29 = 0;
    r24 = 0;
...
loc_8076BEF4:
{
    r12 = MemoryInline::FlatRead32((r31 + 220));
    r3 = (r31 + 220);
    r12 = MemoryInline::FlatRead32((r12 + 24));
    ctr = r12;
    ctx->lr = 0x8076BF08u;
...
loc_8076BF08:
{
    ...
    r3 = (r1 + 8);
    r5 = MemoryInline::FlatRead32((r31 + 192));
    r4_addr_2 = (r4 + r29);
    r23 = MemoryInline::FlatRead32(r4_addr_2);
    MemoryInline::FlatWrite8((r23 + 289), static_cast<uint8_t>(r24));
    MemoryInline::FlatWrite32((r23 + 264), r28);
    ...
    MemoryInline::FlatWriteFloat32((r23 + 48), f2.d);
    MemoryInline::FlatWriteFloat32((r23 + 52), f1.d);
    MemoryInline::FlatWriteFloat32((r23 + 56), f0.d);
    MemoryInline::FlatWrite32((r23 + 260), r5);
...
loc_8076BF70:
{
    f2.d = MemoryInline::FlatReadFloat32((r25 + 16712));
...
loc_8076BF88:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteFloat32((r23 + 192), f31.d);
    f1.d = f31.d;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r23 + 176), r24);
    r3 = r23;
    MemoryInline::FlatWriteFloat32((r23 + 272), f29.d);
    MemoryInline::FlatWrite8((r23 + 268), static_cast<uint8_t>(r24));
    r12 = MemoryInline::FlatRead32(r23);
...
// RECOMP_REGISTRATION base 0x8076BDF4 func_8076BDF4 preserves=false fpr_mask=0xE0000000
