...
extern "C" void func_805C2AD0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805C2B24:
{
    ...
    r24 = 0;
    r3_addr_4 = (r3 + r25);
    r31 = MemoryInline::FlatRead32(r3_addr_4);
    goto loc_805C2BD0;
}
...
loc_805C2B54:
{
    ...
    r23 = 0;
    r3_addr_6 = (r3 + r24);
    r19 = MemoryInline::FlatRead32(r3_addr_6);
    goto loc_805C2BBC;
}
...
loc_805C2B84:
{
    r12 = MemoryInline::FlatRead32(r21);
    r3 = r21;
    r4 = MemoryInline::FlatRead32((r19 + 104));
    r12 = MemoryInline::FlatRead32((r12 + 8));
    r4_addr_8 = (r4 + r23);
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r19 + 104));
    r4 = r21;
    r3_addr_8 = (r3 + r23);
...
loc_805C2BBC:
{
    r0 = MemoryInline::FlatRead32((r19 + 120));
...
// RECOMP_REGISTRATION base 0x805C2AD0 func_805C2AD0 preserves=true fpr_mask=0x00000000
