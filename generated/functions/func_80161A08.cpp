...
extern "C" void func_80161A08(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80161AEC:
{
    ...
    r6 = (r6 + 7916);
    r0_rot_3 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(30));
...
// RECOMP_REGISTRATION base 0x80161A08 func_80161A08 preserves=true fpr_mask=0x00000000
