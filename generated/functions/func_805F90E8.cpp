...
extern "C" void func_805F90E8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_805F90E8:
{
    ...
    r4 = 0x80890000u;
    r3 = r30;
    f0.d = MemoryInline::FlatReadFloat32((r4 + 24924));
    r4 = 5;
    MemoryInline::FlatWriteFloat32((r30 + 1292), f0.d);
    r5 = 0;
...
// RECOMP_REGISTRATION base 0x805F90E8 func_805F90E8 preserves=true fpr_mask=0x00000000
