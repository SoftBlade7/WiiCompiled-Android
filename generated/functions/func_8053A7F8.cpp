...
extern "C" void func_8053A7F8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8053A7F8:
{
    ...
    r0 = (r4 + 3);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r4)) + static_cast<uint64_t>(static_cast<uint32_t>(3)) + (static_cast<uint64_t>(static_cast<uint32_t>(0)) & 1u);
...
// RECOMP_REGISTRATION base 0x8053A7F8 func_8053A7F8 preserves=true fpr_mask=0x00000000
