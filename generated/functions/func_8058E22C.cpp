...
extern "C" void func_8058E22C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8058E22C:
{
    ...
    r5 = r27;
    r3 = (r1 + 8);
    r6 = MemoryInline::FlatRead8((r6 + 16));
    ctx->lr = 0x8058E2BCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80576D8Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8058E804u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8058E2E8:
{
    ...
    r3 = (r3 + 26012);
    MemoryInline::FlatWriteRam32((r27 + 12), r3);
    MemoryInline::FlatWriteRamFloat32((r27 + 36), f0.d);
    MemoryInline::FlatWriteRamFloat32((r27 + 40), f0.d);
    MemoryInline::FlatWriteRamFloat32((r27 + 44), f0.d);
    MemoryInline::FlatWriteRamFloat32((r27 + 48), f0.d);
    MemoryInline::FlatWriteRamFloat32((r27 + 52), f0.d);
    MemoryInline::FlatWriteRamFloat32((r27 + 56), f0.d);
}

loc_8058E314:
{
    MemoryInline::FlatWrite32((r28 + 16), r27);
    r3 = r27;
    r4 = MemoryInline::FlatRead32((r28 + 20));
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x805A04A0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r28 + 108), r3);
    r5 = 0x809C0000u;
    r4 = r27;
    MemoryInline::FlatWriteRam32((r5 + 6484), r3);
    r3 = r28;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8056C458u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r28 + 36), r27);
    r3 = r28;
    r4 = (r1 + 8);
    r12 = MemoryInline::FlatRead32((r28 + 12));
...
loc_8058E43C:
{
    r4 = MemoryInline::FlatRead32((r28 + 108));
    r5 = 1;
    r6 = 0;
    ctx->lr = 0x8058E44Cu;
    ctx->gpr[0] = r0;
...
loc_8058E450:
{
    ...
    r5 = MemoryInline::FlatRead32((r27 + 72));
    r4 = r27;
    r3 = (r1 + 8);
    ...
    r6 = ctx->gpr[6];
    cr = ctx->cr;
    MemoryInline::FlatWrite32((r28 + 60), r27);
    r3 = r28;
    r12 = MemoryInline::FlatRead32((r28 + 12));
...
loc_8058E4A8:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8059B658u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8058E4B0:
{
    MemoryInline::FlatWrite32((r28 + 124), r3);
    r3 = 16;
    ctx->lr = 0x8058E4BCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
{
    r0 = 0;
    MemoryInline::FlatWrite32((r28 + 80), r3);
    r3 = 0x809C0000u;
    MemoryInline::FlatWrite32((r28 + 88), r0);
    MemoryInline::FlatWrite32((r28 + 92), r0);
...
loc_8058E510:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8058D3CCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8058E518:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8058CA28u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8058E524:
{
    MemoryInline::FlatWrite32((r28 + 88), r27);
    goto loc_8058E57C;
}
...
loc_8058E564:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8058D4A0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8058E56C:
{
    ...
    ctx->fpr[0] = f0;
    ctx->cr = cr;
    InvokeDirectCpu<0x8058985Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8058E578:
{
    MemoryInline::FlatWrite32((r28 + 92), r27);
}
...
loc_8058E57C:
{
    ...
    MemoryInline::FlatWrite32((r28 + 96), r30);
    MemoryInline::FlatWrite32((r28 + 100), r29);
    ctx->lr = 0x8058E594u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_8058E59C:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8056B8A8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8058E5B4:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8056A264u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8058E5CC:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8056A5ECu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8058E5D0:
{
    MemoryInline::FlatWrite32((r28 + 120), r3);
    r3 = (r1 + 8);
    r4 = -1;
    ctx->lr = 0x8058E5E0u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x8058E22C func_8058E22C preserves=true fpr_mask=0x00000000
