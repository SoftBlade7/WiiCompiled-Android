...
extern "C" void func_806DEA1C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806DEA80:
{
    r31 = 0x809C0000u;
    r4 = (r30 + 48);
    r3 = MemoryInline::FlatRead32((r31 + 8832));
    r12 = MemoryInline::FlatRead32(r3);
...
loc_806DEB14:
{
    r4 = 0x808A0000u;
    r3 = r30;
    f1.d = MemoryInline::FlatReadFloat32((r4 + 1296));
    r4 = 472;
    ctx->lr = 0x806DEB28u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x806DEA1C func_806DEA1C preserves=true fpr_mask=0x00000000
