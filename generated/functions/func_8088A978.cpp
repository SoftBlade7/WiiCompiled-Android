...
extern "C" void func_8088A978(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8088A9CC:
{
    ...
    f1.d = MemoryInline::FlatReadFloat64((r30 + 208));
    r0 = (r0 * r3);
    r0 = (r4 - r0);
...
loc_8088AA14:
{
    ...
    MemoryInline::FlatWriteFloat32((r31 + 376), f2.d);
...
// RECOMP_REGISTRATION base 0x8088A978 func_8088A978 preserves=false fpr_mask=0x80000000
