...
extern "C" void func_805BAD8C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805BAD8C:
{
    ...
    ctr = ctx->ctr;
    r3 = 0x80890000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 10260));
    MemoryInline::FlatWriteFloat32((r30 + 956), f0.d);
...
// RECOMP_REGISTRATION base 0x805BAD8C func_805BAD8C preserves=true fpr_mask=0x00000000
