...
extern "C" void func_8061C86C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r3_rot_0 = 0;
...
loc_8061C86C:
{
    r3 = MemoryInline::FlatRead32((r3 + 1212));
    r0 = (0 - r3);
    r0 = (r0 | r3);
...
// RECOMP_REGISTRATION base 0x8061C86C func_8061C86C preserves=true fpr_mask=0x00000000
