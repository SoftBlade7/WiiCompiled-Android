...
extern "C" void func_8083F580(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8083F580:
{
    ...
    r29 = r4;
    r4 = (r31 + 56);
    guest_range_1 = MemoryInline::ResolveRangeHost((r31 + 56), 0, 80u, true, false);
    r11 = MemoryInline::ReadResolved32(guest_range_1, 0u, (r31 + 56));
    r5 = (r31 + 120);
    {
    ...
    r3 = 620;
    r8 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r4 + 12));
    {
        ...
        if (resolved_pair.valid) {
            ...
            r7 = MemoryInline::ReadResolved32(guest_range_1, 64u, (r31 + 120));
            r6 = MemoryInline::ReadResolved32(guest_range_1, 68u, (r5 + 4));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r4 = MemoryInline::ReadResolved32(guest_range_1, 72u, (r5 + 8));
            r0 = MemoryInline::ReadResolved32(guest_range_1, 76u, (r5 + 12));
        }
    }
...
{
    r4 = 0x808B0000u;
    r27_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r29), static_cast<uint32_t>(2));
    r27 = (r27_rot_0 & -4);
    r3 = (r1 + 24);
...
{
    r5 = 0x808B0000u;
    r27_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r29), static_cast<uint32_t>(2));
    r27 = (r27_rot_1 & -4);
    r3 = (r1 + 24);
    r7 = MemoryInline::FlatRead32((r28 + 1724));
    r5 = (r5 + -11856);
...
loc_8083F708:
{
    ...
    r0 = (r29 + 1);
    r0 = (r0 ^ -2147483648);
    f5.d = MemoryInline::FlatReadFloat64((r31 + 152));
...
// RECOMP_REGISTRATION base 0x8083F580 func_8083F580 preserves=true fpr_mask=0x00000000
