...
extern "C" void func_80731204(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80731204:
{
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 68u, ((static_cast<uint64_t>(static_cast<uint32_t>(r9)) << 32) | static_cast<uint32_t>(r8)))) {
        MemoryInline::WriteResolved32(guest_range_0, 68u, (r1 + 68), r9);
        MemoryInline::WriteResolved32(guest_range_0, 72u, (r1 + 72), r8);
    }
    MemoryInline::WriteResolved32(guest_range_0, 76u, (r1 + 76), r7);
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 56u, ((static_cast<uint64_t>(static_cast<uint32_t>(r6)) << 32) | static_cast<uint32_t>(r4)))) {
        MemoryInline::WriteResolved32(guest_range_0, 56u, (r1 + 56), r6);
        MemoryInline::WriteResolved32(guest_range_0, 60u, (r1 + 60), r4);
    }
...
// RECOMP_GUEST_ABI gpr_read=0xE000003E gpr_write=0xE00003FB gpr_return=0x00000018 fpr_read=0x8000001F fpr_write=0x800000FF fpr_return=0x00000002 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80731204 func_80731204 preserves=true fpr_mask=0x00000000
