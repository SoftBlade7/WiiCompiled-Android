...
extern "C" void func_80223A30(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
    uint32_t r3_rot_1 = 0;
...
loc_80223A8C:
{
    // inline leaf 0x80029CC0 (2 guest instruction(s))
    r3 = MemoryInline::FlatRead16((r3 + 200));
    // end of inlined leaf 0x80029CC0
    r28 = (r3 & 65535);
    r27 = 0;
    goto loc_80223AC8;
}
...
loc_80223A9C:
{
    ...
    ctx->gpr[4] = r4;
    ctx->cr = cr;
    InvokeDirectCpu<0x80029CD0u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    cr = ctx->cr;
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(0));
...
// RECOMP_REGISTRATION base 0x80223A30 func_80223A30 preserves=true fpr_mask=0x00000000
