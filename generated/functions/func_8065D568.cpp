...
extern "C" void func_8065D568(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8065D5CC:
{
    ...
    r0 = (r0_rot_1 & -8);
    r3 = (r29 + r0);
    r3 = MemoryInline::FlatRead8((r3 + 19));
    goto loc_8065D5E0;
}
...
// RECOMP_REGISTRATION base 0x8065D568 func_8065D568 preserves=true fpr_mask=0x00000000
