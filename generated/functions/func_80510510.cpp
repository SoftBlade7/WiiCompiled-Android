...
extern "C" void func_80510510(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80510510:
{
    ...
    r5 = 0x808B0000u;
    r4 = r3;
    r5 = MemoryInline::FlatRead32((r5 + 11248));
    r3 = (r30 + 24);
    r6 = 0;
    r7 = 255;
    ctx->lr = 0x80510554u;
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8016420Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r3 = 0x808B0000u;
    r4 = r31;
    r3 = MemoryInline::FlatRead32((r3 + 11252));
    r5 = 1;
    r6 = 0;
    ctx->lr = 0x8051056Cu;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x80510510 func_80510510 preserves=true fpr_mask=0x00000000
