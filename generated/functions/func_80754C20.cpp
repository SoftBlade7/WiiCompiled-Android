...
extern "C" void func_80754C20(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80754C20:
{
    ...
    ctx->lr = 0x80754C28u;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80756578u>(ctx);
    r3 = ctx->gpr[3];
    r29 = ctx->gpr[29];
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80754C20 func_80754C20 preserves=true fpr_mask=0x00000000
