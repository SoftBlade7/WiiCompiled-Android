...
extern "C" void func_80782528(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_inl0_cont_800AF180:
{
    ...
    r7 = MemoryInline::FlatRead32((r27 + 12));
    r8 = MemoryInline::FlatRead32((r27 + 16));
    ctx->lr = 0x80782580u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r4 = r27;
    r3 = (r26 + 292);
    MemoryInline::FlatWrite8(r5, static_cast<uint8_t>(r28));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ...
    MemoryInline::FlatWrite32((r26 + 284), r27);
}
...
loc_807825BC:
{
    r0 = MemoryInline::FlatRead16((r26 + 300));
...
// RECOMP_REGISTRATION base 0x80782528 func_80782528 preserves=true fpr_mask=0x00000000
