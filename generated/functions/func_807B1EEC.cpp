...
extern "C" void func_807B1EEC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807B1EEC:
{
    ...
    r25 = r3;
    r27 = MemoryInline::FlatRead8((r5 + 14520));
    r26 = r4;
    r30 = (r30 + 24448);
    r28 = 0;
    r31 = 0x809C0000u;
...
loc_807B1F88:
{
    ...
    MemoryInline::FlatWrite32((r24 + 8), r28);
    MemoryInline::FlatWrite8((r24 + 12), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x807B1EEC func_807B1EEC preserves=true fpr_mask=0x00000000
