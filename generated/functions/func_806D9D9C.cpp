...
extern "C" void func_806D9D9C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806D9E0C:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r3 + 22644));
...
loc_806D9E34:
{
    ...
    f31 = ctx->fpr[31];
    cr = ctx->cr;
    r27 = MemoryInline::FlatRead32((r31 + 220));
    r29 = (r31 + 88);
    r28 = 0;
}
...
// RECOMP_REGISTRATION base 0x806D9D9C func_806D9D9C preserves=false fpr_mask=0x80000000
