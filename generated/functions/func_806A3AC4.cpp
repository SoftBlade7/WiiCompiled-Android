...
extern "C" void func_806A3AC4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806A3B80:
{
    r0_rot_4 = PpcRotl32Inline(static_cast<uint32_t>(r29), static_cast<uint32_t>(30));
...
loc_806A3BDC:
{
    r0_rot_8 = PpcRotl32Inline(static_cast<uint32_t>(r29), static_cast<uint32_t>(30));
...
loc_806A3CCC:
{
    r0_rot_18 = PpcRotl32Inline(static_cast<uint32_t>(r29), static_cast<uint32_t>(30));
    r0 = (r0_rot_18 & -1073741824);
    r4_rot_5 = PpcRotl32Inline(static_cast<uint32_t>(r29), static_cast<uint32_t>(1));
    r4 = (r4_rot_5 & 1);
    r0 = (r0 - r4);
...
{
    r0 = 0;
    MemoryInline::FlatWrite16((r30 + 26), static_cast<uint16_t>(r31));
...
// RECOMP_REGISTRATION base 0x806A3AC4 func_806A3AC4 preserves=true fpr_mask=0x00000000
