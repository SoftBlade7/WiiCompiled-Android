...
extern "C" void func_807DC2C0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807DC2C0:
{
    MemoryInline::FlatWrite32((r3 + 76), r7);
    r5 = 1;
    r7 = 12;
...
// RECOMP_REGISTRATION base 0x807DC2C0 func_807DC2C0 preserves=true fpr_mask=0x00000000
