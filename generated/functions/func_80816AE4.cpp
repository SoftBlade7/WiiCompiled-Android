...
extern "C" void func_80816AE4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80816AE4:
{
    ...
    r30 = 0x808B0000u;
    f1.d = MemoryInline::FlatReadFloat32((r30 + -19392));
...
loc_80816B80:
{
    f0.d = MemoryInline::FlatReadFloat32((r30 + -19392));
}
...
loc_80816B9C:
{
    ...
    r12 = MemoryInline::FlatRead32(r3);
    r28 = 0x808B0000u;
    f1.d = MemoryInline::FlatReadFloat32((r28 + -19392));
...
loc_80816BE8:
{
    ...
    r3 = (r3 ^ -2147483648);
    r0 = (r0 ^ -2147483648);
    f4.d = MemoryInline::FlatReadFloat64((r4 + -19384));
    MemoryInline::FlatWriteRam32((r1 + 20), r0);
...
loc_80816C38:
{
    r0 = MemoryInline::FlatRead8((r29 + 332));
...
{
    r0 = 0;
    MemoryInline::FlatWrite8((r29 + 332), static_cast<uint8_t>(r0));
}
...
loc_80816C4C:
{
    ...
    r4 = 0;
    r0 = (r30 - r0);
    f2.d = MemoryInline::FlatReadFloat64((r5 + -19384));
    r0 = (r0 ^ -2147483648);
    MemoryInline::FlatWriteRam32((r1 + 12), r0);
    f0.d = MemoryInline::FlatReadFloat32((r31 + 4));
    ...
    r4 = 0x808B0000u;
    r3 = r29;
    f1.d = MemoryInline::FlatReadFloat32((r4 + -19392));
    r4 = 773;
    ctx->lr = 0x80816CACu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80816DF8:
{
    r0 = MemoryInline::FlatRead32((r31 + 8));
    r4 = 0x808B0000u;
    f2.d = MemoryInline::FlatReadFloat64((r4 + -19384));
    r5 = 0x808B0000u;
    r0 = (r0 ^ -2147483648);
    MemoryInline::FlatWriteRam32((r1 + 20), r0);
    r3 = MemoryInline::FlatRead32((r29 + 8));
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat64((r1 + 16));
    f0.d = MemoryInline::FlatReadFloat32((r5 + -19388));
    f1.d = static_cast<double>(PpcForceSingleValueInline(f1.d - f2.d));
    r3 = MemoryInline::FlatRead32((r3 + 40));
    f31.d = static_cast<double>(PpcForceSingleValueInline(f1.d - f0.d));
    // inline leaf 0x80557340 (4 guest instruction(s))
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead8((r29 + 333));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_80816E50:
{
    ...
    xer = ctx->xer;
    r0 = 1;
    MemoryInline::FlatWrite8((r29 + 333), static_cast<uint8_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x80816AE4 func_80816AE4 preserves=false fpr_mask=0x80000000
