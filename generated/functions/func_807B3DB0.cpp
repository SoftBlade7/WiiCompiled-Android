...
extern "C" void func_807B3DB0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807B3E58:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r4 + 24656));
    PpcSetPairedFprInline(f0, PPC_PsMuls0Inline(f0.d, PPC_PsFromScalarInline(f1.d)));
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r31_psq_tmp_0 = (r31 + 660);
    PPC_PsqStGqrInline<0u, 0u>(ctx, mkw_gqr0, r31_psq_tmp_0, f0.d);
    ...
    PPC_PsqStGqrInline<1u, 0u>(ctx, mkw_gqr0, r31_psq_tmp_1, f0.d);
    // psq_load w=0 quant=0 (using PPC_PsqL)
...
// RECOMP_REGISTRATION base 0x807B3DB0 func_807B3DB0 preserves=false fpr_mask=0x80000000
