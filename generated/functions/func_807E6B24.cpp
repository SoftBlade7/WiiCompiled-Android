...
extern "C" void func_807E6B24(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807E6B24:
{
    ...
    r25 = r3;
    r29 = (r3 + 372);
    r27_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(2));
    r27 = (r27_rot_0 & -4);
    r31 = (r4 + 1);
    r26 = 0;
    r28 = 0;
...
loc_807E6B54:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_1CBB = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_1CBB[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_1CBB[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x807E6B24 func_807E6B24 preserves=true fpr_mask=0x00000000
