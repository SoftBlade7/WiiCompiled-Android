...
extern "C" void func_806BE794(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806BE7C8:
{
    f1.d = MemoryInline::FlatReadFloat32((r3 + 228));
...
{
    r4 = 0x808C0000u;
    f0.d = MemoryInline::FlatReadFloat32((r4 + 10028));
...
loc_806BE7E8:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r4 + 10028));
...
loc_806BE810:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r3 + 10040));
...
// RECOMP_REGISTRATION base 0x806BE794 func_806BE794 preserves=false fpr_mask=0x80000000
