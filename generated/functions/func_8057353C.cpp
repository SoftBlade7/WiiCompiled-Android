...
extern "C" void func_8057353C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8057353C:
{
    ...
    ctx->gpr[31] = r31;
    ctx->fpr[0] = f0;
    InvokeDirectCpu<0x80573464u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8057353C func_8057353C preserves=true fpr_mask=0x00000000
