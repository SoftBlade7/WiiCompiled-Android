...
extern "C" void func_8082E6A8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8082E7A0:
{
    ...
    r3 = 0x809C0000u;
    r5 = 0x809C0000u;
    r4 = MemoryInline::FlatRead32((r3 + 6224));
    r3 = 0x808B0000u;
    r0 = MemoryInline::FlatRead32((r5 + 17624));
    r3 = (r3 + -14072);
    MemoryInline::FlatWrite32((r4 + 132), r0);
    r4 = (r3 + 11);
    r5 = MemoryInline::FlatRead32((r5 + 17624));
    r3 = MemoryInline::FlatRead32((r31 + 8));
    r5 = (r5 + 8);
    ctx->lr = 0x8082E7FCu;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x8082E6A8 func_8082E6A8 preserves=true fpr_mask=0x00000000
