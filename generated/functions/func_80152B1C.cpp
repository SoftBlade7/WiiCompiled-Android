...
extern "C" void func_80152B1C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80152B1C:
{
    ...
    r31 = ctx->gpr[31];
    r0 = 0;
    r3 = MemoryInline::FlatRead16((r31 + 104));
...
// RECOMP_REGISTRATION base 0x80152B1C func_80152B1C preserves=true fpr_mask=0x00000000
