...
extern "C" void func_80832D00(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80832D6C:
{
    r0_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r18), static_cast<uint32_t>(4));
    r0 = (r0_rot_2 & 4080);
    r20 = (r31 + r0);
    r0 = MemoryInline::FlatRead8((r20 + 16));
}
...
loc_80832D80:
{
    r0 = MemoryInline::FlatRead8((r20 + 17));
}
...
loc_80832D8C:
{
    ...
    r4 = 0;
    r3 = (r3 + r0);
    r0 = MemoryInline::FlatRead32((r3 + 1456));
}
...
loc_80832DAC:
{
    r0 = MemoryInline::FlatRead32((r3 + 1464));
}
...
loc_80832DDC:
{
    r3 = MemoryInline::FlatRead32((r25 + 6536));
...
loc_80832DE8:
{
    r3 = MemoryInline::FlatRead32((r21 + -10440));
    r4 = (r18 & 255);
    // inline leaf 0x8054247C (4 guest instruction(s))
    r0 = (r4 * 24);
    r3 = (r3 + r0);
    r3 = MemoryInline::FlatRead32((r3 + 1456));
    // end of inlined leaf 0x8054247C
    MemoryInline::FlatWrite32((r20 + 12), r22);
    r30 = r3;
    r4 = r30;
    r5 = 4;
    r16 = MemoryInline::FlatRead8((r31 + 4));
    r3 = (r16 * 44);
    r3 = (r3 + 16);
    ctx->lr = 0x80832E14u;
    ctx->gpr[0] = r0;
...
loc_80832E3C:
{
    ...
    r3 = (r19 + r0);
    r16 = MemoryInline::FlatRead32((r3 + 16));
    r3 = r16;
    ctx->lr = 0x80832E58u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8081CEF4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r0 = (r0 * 44);
    r6 = r3;
    r8 = MemoryInline::FlatRead16((r31 + 72));
    r5 = r16;
    r9 = MemoryInline::FlatRead16((r31 + 74));
    r7 = r30;
    r3 = (r4 + r0);
    r4 = (r18 & 255);
    ctx->lr = 0x80832E84u;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80831FC4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80832E98:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80830C64u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80832EE0:
{
    ...
    r0_rot_3 = PpcRotl32Inline(static_cast<uint32_t>(r18), static_cast<uint32_t>(4));
    r0 = (r0_rot_3 & 4080);
    r30 = (r31 + r0);
    r19 = 0;
    r0 = MemoryInline::FlatRead32((r3 + 20));
    ...
    MemoryInline::FlatWriteRam32((r27 + 28260), r0);
    MemoryInline::FlatWrite8((r20 + 16), static_cast<uint8_t>(r28));
    MemoryInline::FlatWrite8((r20 + 17), static_cast<uint8_t>(r29));
    MemoryInline::FlatWrite8((r30 + 18), static_cast<uint8_t>(r28));
    goto loc_80832F3C;
}
...
loc_80832F84:
{
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 16), 0, 72u, true, false);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r16 = MemoryInline::ReadResolved32(guest_range_1, 0u, (r1 + 16));
            r17 = MemoryInline::ReadResolved32(guest_range_1, 4u, (r1 + 20));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r18 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r1 + 24));
            r19 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r1 + 28));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r20 = MemoryInline::ReadResolved32(guest_range_1, 16u, (r1 + 32));
            r21 = MemoryInline::ReadResolved32(guest_range_1, 20u, (r1 + 36));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r22 = MemoryInline::ReadResolved32(guest_range_1, 24u, (r1 + 40));
            r23 = MemoryInline::ReadResolved32(guest_range_1, 28u, (r1 + 44));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r24 = MemoryInline::ReadResolved32(guest_range_1, 32u, (r1 + 48));
            r25 = MemoryInline::ReadResolved32(guest_range_1, 36u, (r1 + 52));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r26 = MemoryInline::ReadResolved32(guest_range_1, 40u, (r1 + 56));
            r27 = MemoryInline::ReadResolved32(guest_range_1, 44u, (r1 + 60));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r28 = MemoryInline::ReadResolved32(guest_range_1, 48u, (r1 + 64));
...
// RECOMP_REGISTRATION base 0x80832D00 func_80832D00 preserves=true fpr_mask=0x00000000
