...
extern "C" void func_80106518(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80106518:
{
    ...
    r3 = MemoryInline::FlatRead32((r7 + 1480));
    ctx->lr = 0x80106560u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80106518 func_80106518 preserves=true fpr_mask=0x00000000
