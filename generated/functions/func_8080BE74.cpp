...
extern "C" void func_8080BE74(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8080BE74:
{
    ...
    ctx->gpr[10] = r10;
    ctx->fpr[1] = f1;
    InvokeDirectCpu<0x8080D12Cu>(ctx);
    r9 = ctx->gpr[9];
    r10 = ctx->gpr[10];
    f1 = ctx->fpr[1];
    ctx->gpr[9] = r9;
...
// RECOMP_REGISTRATION base 0x8080BE74 func_8080BE74 preserves=true fpr_mask=0x00000000
