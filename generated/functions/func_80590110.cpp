...
extern "C" void func_80590110(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_80590110:
{
    ...
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    InvokeDirectCpu<0x8058F04Cu>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x80590110 func_80590110 preserves=true fpr_mask=0x00000000
