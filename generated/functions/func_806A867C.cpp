...
extern "C" void func_806A867C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806A867C:
{
    ...
    r31 = r3;
    r0 = MemoryInline::FlatRead8((r3 + 67));
...
// RECOMP_REGISTRATION base 0x806A867C func_806A867C preserves=true fpr_mask=0x00000000
