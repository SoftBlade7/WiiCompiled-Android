...
extern "C" void func_807025E0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807025E0:
{
    r3 = (r3 + -148);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80700728u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x807025E0 func_807025E0 preserves=true fpr_mask=0x00000000
