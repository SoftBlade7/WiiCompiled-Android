...
extern "C" void func_8009DBB0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8009DBB0:
{
    r3 = (r3 + -4);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x8009DAF0u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8009DBB0 func_8009DBB0 preserves=true fpr_mask=0x00000000
