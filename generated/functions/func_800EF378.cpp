...
extern "C" void func_800EF378(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800EF3C0:
{
    ...
    MemoryInline::FlatWriteRam32((r3 + 16), r30);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_800EF3EC;
    }
}
...
// RECOMP_REGISTRATION base 0x800EF378 func_800EF378 preserves=true fpr_mask=0x00000000
