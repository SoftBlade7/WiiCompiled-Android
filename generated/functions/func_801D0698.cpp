...
extern "C" void func_801D0698(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_801D0738:
{
    ...
    r0 = (r0_rot_3 & -2);
    r3_addr_1 = (r3 + r0);
    MemoryInline::FlatWrite16(r3_addr_1, static_cast<uint16_t>(r6));
    if (((cr & 0x20000000u) != 0)) {
        goto loc_801D094C;
    }
}
...
// RECOMP_REGISTRATION base 0x801D0698 func_801D0698 preserves=true fpr_mask=0x00000000
