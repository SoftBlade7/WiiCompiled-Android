...
extern "C" void func_80624ED0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80624ED0:
{
    ...
    ctx->gpr[3] = r3;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x80858CA4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r31 = ctx->gpr[31];
...
// RECOMP_REGISTRATION base 0x80624ED0 func_80624ED0 preserves=true fpr_mask=0x00000000
