...
extern "C" void func_8016D6D0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8016D6D0:
{
    ...
    r6_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(9));
    r6_mrot_0 = (r6_rot_0 & 1536);
    r6_mdest_0 = (r6 & -1537);
...
// RECOMP_REGISTRATION base 0x8016D6D0 func_8016D6D0 preserves=true fpr_mask=0x00000000
