...
extern "C" void func_800470B0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800471A4:
{
    ...
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r3_psq_tmp_0 = (r3 + 8);
    PPC_PsqStStackInline<1u, 0u>(ctx, r3_psq_tmp_0, f0.d);
    goto loc_800471F0;
}
...
// RECOMP_REGISTRATION base 0x800470B0 func_800470B0 preserves=true fpr_mask=0x00000000
