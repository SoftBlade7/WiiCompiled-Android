...
extern "C" void func_8081C7C8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8081C7C8:
{
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 16u, ((static_cast<uint64_t>(static_cast<uint32_t>(r22)) << 32) | static_cast<uint32_t>(r23)))) {
        MemoryInline::WriteResolved32(guest_range_0, 16u, (r1 + 16), r22);
...
loc_8081C810:
{
    ...
    ctx->fpr[1] = f1;
    ctx->cr = cr;
    InvokeDirectCpu<0x80786E60u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r6 = ctx->gpr[6];
    f1 = ctx->fpr[1];
...
loc_8081C860:
{
    r3 = MemoryInline::FlatRead32((r25 + 88));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(0));
}
...
loc_8081C8CC:
{
    ...
    ctx->gpr[4] = r4;
    ctx->cr = cr;
    InvokeDirectCpu<0x80785F2Cu>(ctx);
    r0 = ctx->gpr[0];
    r4 = ctx->gpr[4];
    cr = ctx->cr;
    goto loc_8081C92C;
...
loc_8081C92C:
{
    ...
    ctx->gpr[5] = r5;
    ctx->cr = cr;
    InvokeDirectCpu<0x80785EC4u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
...
loc_8081C940:
{
    ...
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 40u, (r1 + 56));
    {
        ...
        if (resolved_pair.valid) {
            ...
            r22 = MemoryInline::ReadResolved32(guest_range_1, 0u, (r1 + 16));
            r23 = MemoryInline::ReadResolved32(guest_range_1, 4u, (r1 + 20));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r24 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r1 + 24));
            r25 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r1 + 28));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r26 = MemoryInline::ReadResolved32(guest_range_1, 16u, (r1 + 32));
            r27 = MemoryInline::ReadResolved32(guest_range_1, 20u, (r1 + 36));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r28 = MemoryInline::ReadResolved32(guest_range_1, 24u, (r1 + 40));
            r29 = MemoryInline::ReadResolved32(guest_range_1, 28u, (r1 + 44));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r30 = MemoryInline::ReadResolved32(guest_range_1, 32u, (r1 + 48));
            r31 = MemoryInline::ReadResolved32(guest_range_1, 36u, (r1 + 52));
        }
    }
...
// RECOMP_REGISTRATION base 0x8081C7C8 func_8081C7C8 preserves=false fpr_mask=0x80000000
