...
extern "C" void func_805215D4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r4 = 0;
    MemoryInline::FlatWrite32((r31 + 220), r4);
    r3 = MemoryInline::FlatRead32((r31 + 232));
    r0 = 1;
    MemoryInline::FlatWrite32((r31 + 224), r4);
...
// RECOMP_REGISTRATION base 0x805215D4 func_805215D4 preserves=true fpr_mask=0x00000000
