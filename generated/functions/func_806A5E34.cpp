...
extern "C" void func_806A5E34(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806A5E34:
{
    ...
    r27 = MemoryInline::FlatRead32((r3 + 1828));
    r30 = r4;
    r29 = r3;
    r31 = r5;
}
...
loc_806A5E98:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r27 = MemoryInline::FlatRead32((r29 + 1828));
    r3 = 0;
}
...
loc_806A5F00:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r29 + 2448));
...
loc_806A5F38:
{
    ...
    guest_range_0 = MemoryInline::ResolveRangeHost((r29 + 1780), 0, 48u, true, false);
    r6 = MemoryInline::ReadResolved32(guest_range_0, 0u, (r29 + 1780));
    r3 = (r1 + 44);
    r0 = MemoryInline::ReadResolved32(guest_range_0, 4u, (r29 + 1784));
    r4 = (r29 + 1780);
    ...
    MemoryInline::FlatWriteRam32((r1 + 96), r6);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_0, 8u, (r29 + 1788));
            r0 = MemoryInline::ReadResolved32(guest_range_0, 12u, (r29 + 1792));
        }
    }
    ...
    MemoryInline::FlatWriteRam32((r1 + 104), r6);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_0, 16u, (r29 + 1796));
            r0 = MemoryInline::ReadResolved32(guest_range_0, 20u, (r29 + 1800));
        }
    }
    ...
    MemoryInline::FlatWriteRam32((r1 + 112), r6);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_0, 24u, (r29 + 1804));
            r0 = MemoryInline::ReadResolved32(guest_range_0, 28u, (r29 + 1808));
        }
    }
    ...
    MemoryInline::FlatWriteRam32((r1 + 120), r6);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_0, 32u, (r29 + 1812));
            r0 = MemoryInline::ReadResolved32(guest_range_0, 36u, (r29 + 1816));
        }
    }
    ...
    MemoryInline::FlatWriteRam32((r1 + 128), r6);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_0, 40u, (r29 + 1820));
            r0 = MemoryInline::ReadResolved32(guest_range_0, 44u, (r29 + 1824));
        }
    }
    ...
    f11.d = MemoryInline::FlatReadFloat32((r1 + 44));
    f10.d = MemoryInline::FlatReadFloat32((r1 + 48));
    f9.d = MemoryInline::FlatReadFloat32((r1 + 52));
    ...
    MemoryInline::FlatWriteRamFloat32((r1 + 112), f10.d);
    MemoryInline::FlatWriteRamFloat32((r1 + 128), f9.d);
...
{
    r3 = MemoryInline::FlatRead32((r29 + 680));
    f1.d = MemoryInline::FlatReadFloat32((r29 + 2628));
    r12 = MemoryInline::FlatRead32(r3);
...
loc_806A60A8:
{
    r3 = MemoryInline::FlatRead32((r29 + 680));
    r4 = 255;
    r7 = MemoryInline::FlatRead8((r29 + 2636));
    r5 = 255;
    r12 = MemoryInline::FlatRead32(r3);
    r6 = 255;
...
loc_806A60F8:
{
    r0 = MemoryInline::FlatRead8((r29 + 246));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_806A6104:
{
    r0 = MemoryInline::FlatRead8((r29 + 250));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_806A6148:
{
    r0 = MemoryInline::FlatRead8((r29 + 195));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_806A6154:
{
    ...
    xer = ctx->xer;
    r0 = 1;
    MemoryInline::FlatWrite8((r29 + 195), static_cast<uint8_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x806A5E34 func_806A5E34 preserves=true fpr_mask=0x00000000
