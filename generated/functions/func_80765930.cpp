...
extern "C" void func_80765930(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lhax_80765994_loc_0 = 0;
    uint32_t addr_lhax_807659E8_loc_0 = 0;
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80765930:
{
    ...
    addr_lhax_80765994_loc_0 = (r4 + r0);
    r0 = MemoryInline::FlatRead16(addr_lhax_80765994_loc_0);
    r0 = (r0 << 16);
    r0 = (static_cast<int32_t>(r0) >> 16);
    f1.d = MemoryInline::FlatReadFloat64((r29 + 14992));
    r0 = (r0 * 116);
    ...
    addr_lhax_807659E8_loc_0 = (r3 + r0);
    r0 = MemoryInline::FlatRead16(addr_lhax_807659E8_loc_0);
    r0 = (r0 << 16);
    r0 = (static_cast<int32_t>(r0) >> 16);
...
{
    r3 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 15008));
...
// RECOMP_REGISTRATION base 0x80765930 func_80765930 preserves=false fpr_mask=0x80000000
