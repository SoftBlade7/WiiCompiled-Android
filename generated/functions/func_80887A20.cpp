...
extern "C" void func_80887A20(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80887A20:
{
    r3 = 0x808B0000u;
    r4 = 0x808B0000u;
    f0.d = MemoryInline::FlatReadFloat32((r4 + 9856));
    r6 = 0x809C0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + 9776));
    r3 = (r6 + 18888);
    r4 = 0x80510000u;
    r5 = 0x809C0000u;
    MemoryInline::FlatWriteRamFloat32((r6 + 18888), f1.d);
    r4 = (r4 + 13824);
    r5 = (r5 + 18876);
...
// RECOMP_REGISTRATION base 0x80887A20 func_80887A20 preserves=true fpr_mask=0x00000000
