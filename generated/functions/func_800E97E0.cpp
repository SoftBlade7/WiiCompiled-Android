...
extern "C" void func_800E97E0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800E97E0:
{
    ...
    r4 = (r4 + 2);
    guest_range_1 = MemoryInline::ResolveRangeHost(r6, 0, 20u, false, true);
...
// RECOMP_REGISTRATION base 0x800E97E0 func_800E97E0 preserves=true fpr_mask=0x00000000
