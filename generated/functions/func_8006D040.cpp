...
extern "C" void func_8006D040(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8006D040:
{
    ...
    f5.d = MemoryInline::FlatReadFloat32((r31 + 20));
    f8.d = MemoryInline::FlatReadFloat32((r31 + 8));
    ...
    f4.d = MemoryInline::FlatReadFloat32((r31 + 24));
    ...
    f1.d = PpcFmulsInline(f0.d, f10.d);
...
// RECOMP_GUEST_ABI gpr_read=0x8000003E gpr_write=0x8000003B gpr_return=0x00000018 fpr_read=0x0000000C fpr_write=0x00000FFF fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8006D040 func_8006D040 preserves=true fpr_mask=0x00000000
