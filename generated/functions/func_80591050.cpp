...
extern "C" void func_80591050(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80591050:
{
    ...
    ctx->gpr[6] = r6;
    ctx->gpr[7] = r7;
    InvokeDirectCpu<0x8056CB5Cu>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
...
// RECOMP_REGISTRATION base 0x80591050 func_80591050 preserves=true fpr_mask=0x00000000
