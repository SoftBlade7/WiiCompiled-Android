...
extern "C" void func_805478F4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805478F4:
{
    ...
    r0 = (r5 * r0);
    r3 = (r3 + r0);
    MemoryInline::FlatWrite16((r3 + 240), static_cast<uint16_t>(r4));
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[6] = r6;
    return;
...
// RECOMP_REGISTRATION base 0x805478F4 func_805478F4 preserves=true fpr_mask=0x00000000
