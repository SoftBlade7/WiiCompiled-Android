...
extern "C" void func_8001DA68(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8001DA68:
{
    ...
    ctx->gpr[5] = r5;
    ctx->gpr[6] = r6;
    InvokeDirectCpu<0x8001C660u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8001DA68 func_8001DA68 preserves=true fpr_mask=0x00000000
