...
extern "C" void func_807D0E70(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807D0E70:
{
    ...
    r4 = MemoryInline::FlatRead32((r5 + 10636));
    ctx->lr = 0x807D0EA0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x807D0E70 func_807D0E70 preserves=true fpr_mask=0x00000000
