...
extern "C" void func_807B854C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807B854C:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r29 + 112));
    r3 = r29;
    f0.d = MemoryInline::FlatReadFloat32((r31 + 25224));
    ...
    MemoryInline::FlatWriteFloat32((r29 + 36), f4.d);
    ...
    f2.d = PpcFmulsInline(f31.d, f3.d);
    f0.d = MemoryInline::FlatReadFloat32((r31 + 25224));
...
loc_807B85D8:
{
    MemoryInline::FlatWriteFloat32((r29 + 108), f1.d);
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFFFDE gpr_write=0xFFFFFFFF gpr_return=0x00000018 fpr_read=0xFFFFFFE2 fpr_write=0xFFFFFFFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x807B854C func_807B854C preserves=false fpr_mask=0x80000000
