...
extern "C" void func_805C56AC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805C56AC:
{
    ...
    r4 = 0x80890000u;
    f1.d = MemoryInline::FlatReadFloat32((r4 + 13488));
    r4 = 123;
...
// RECOMP_REGISTRATION base 0x805C56AC func_805C56AC preserves=true fpr_mask=0x00000000
