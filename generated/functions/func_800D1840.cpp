...
extern "C" void func_800D1840(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_800D1840:
{
    ...
    r28 = MemoryInline::FlatRead32((r1 + 88));
    r11 = 0x80270000u;
    r21 = r3;
    r22 = r4;
...
loc_800D18CC:
{
    ...
    r0 = (r21 + -1);
    r12 = 0;
    MemoryInline::FlatWrite32((r3 + 136), r31);
    r31 = 5;
    r4 = r22;
    r7 = r24;
    r3 = MemoryInline::FlatRead32((r13 + -26896));
    ...
    r9 = r26;
    r10 = r27;
    MemoryInline::FlatWrite32((r3 + 140), r23);
    r3 = (r0 & 255);
    r5 = (r5 + 12272);
    r6 = 0;
    r11 = MemoryInline::FlatRead32((r13 + -26896));
    r0 = MemoryInline::FlatRead32((r11 + 36));
    MemoryInline::FlatWrite32((r11 + 40), r0);
    r11 = MemoryInline::FlatRead32((r13 + -26896));
    MemoryInline::FlatWrite32((r11 + 36), r31);
    r11 = MemoryInline::FlatRead32((r13 + -26896));
    MemoryInline::FlatWrite8((r11 + 885), static_cast<uint8_t>(r12));
    r11 = MemoryInline::FlatRead32((r13 + -26896));
    MemoryInline::FlatWrite8((r11 + 3061), static_cast<uint8_t>(r12));
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800D4FE4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x800D1840 func_800D1840 preserves=true fpr_mask=0x00000000
