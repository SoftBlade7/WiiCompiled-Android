...
extern "C" void func_800932D0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800932D0:
{
    ...
    r0 = ctx->lr;
    r5 = 0x80270000u;
    f2.d = MemoryInline::FlatReadFloat32((r2 + -28544));
    MemoryInline::WriteResolved32(guest_range_1, 52u, (r1 + 52), r0);
    r0 = 0;
    f0.d = MemoryInline::FlatReadFloat32((r2 + -28536));
    r5 = (r5 + 17288);
    MemoryInline::WriteResolved32(guest_range_1, 44u, (r1 + 44), r31);
    r31 = r3;
    f1.d = MemoryInline::FlatReadFloat32((r2 + -28540));
    r4 = (r1 + 8);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 24u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f2.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f1.d))))) {
...
// RECOMP_REGISTRATION base 0x800932D0 func_800932D0 preserves=true fpr_mask=0x00000000
