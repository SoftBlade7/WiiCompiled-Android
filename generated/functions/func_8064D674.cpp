...
extern "C" void func_8064D674(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8064D674:
{
    r3 = MemoryInline::FlatRead32((r3 + 3244));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8064D674 func_8064D674 preserves=true fpr_mask=0x00000000
