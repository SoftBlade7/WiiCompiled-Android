...
extern "C" void func_8074C980(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8074CAE8:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8055B754u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite8((r30 + 24), static_cast<uint8_t>(r31));
    r31 = 0x809C0000u;
    r5 = (r28 + 320);
    r4 = 7;
...
loc_8074CC84:
{
    MemoryInline::FlatWrite32((r30 + 76), r3);
    r3 = 124;
    ctx->lr = 0x8074CC90u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8074CCD4:
{
    MemoryInline::FlatWrite32((r30 + 84), r3);
    r3 = 124;
    ctx->lr = 0x8074CCE0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8074CCFC:
{
    MemoryInline::FlatWrite32((r30 + 88), r3);
...
// RECOMP_REGISTRATION base 0x8074C980 func_8074C980 preserves=true fpr_mask=0x00000000
