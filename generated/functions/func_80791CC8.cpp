...
extern "C" void func_80791CC8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_80791CF4:
{
    ...
    ctx->fpr[1] = f1;
    ctx->cr = cr;
    InvokeDirectCpu<0x8079EBBCu>(ctx);
    r0 = ctx->gpr[0];
    r5 = ctx->gpr[5];
    f0 = ctx->fpr[0];
    f1 = ctx->fpr[1];
...
loc_80791D38:
{
    r26 = MemoryInline::FlatRead32((r28 + 32));
...
// RECOMP_REGISTRATION base 0x80791CC8 func_80791CC8 preserves=false fpr_mask=0x80000000
