...
extern "C" void func_800AB150(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800AB184:
{
    ...
    f31.d = MemoryInline::FlatReadFloat32((r25 + 252));
}
...
loc_800AB1B4:
{
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8008B6F0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800AB1C8:
{
    r0 = MemoryInline::FlatRead32((r25 + 140));
}
...
// RECOMP_GUEST_ABI gpr_read=0xFE00007F gpr_write=0xFE00087B gpr_return=0x00000018 fpr_read=0x8000001F fpr_write=0x8000001F fpr_return=0x00000002 cr_read=0xC1 cr_write=0xC1 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x800AB150 func_800AB150 preserves=false fpr_mask=0x80000000
