...
extern "C" void func_80012C94(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80012D60:
{
    r4 = (r30 - r0);
    r3 = (r30 | ~r0);
    r0_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(31));
...
// RECOMP_REGISTRATION base 0x80012C94 func_80012C94 preserves=true fpr_mask=0x00000000
