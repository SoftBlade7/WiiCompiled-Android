...
extern "C" void func_800A8B70(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800A8B70:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8008F2C0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r30 = MemoryInline::FlatRead32((r29 + 3640));
    r31 = (r30 + 16);
    r3 = r31;
    ctx->lr = 0x800A8BA0u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x800A8B70 func_800A8B70 preserves=true fpr_mask=0x00000000
