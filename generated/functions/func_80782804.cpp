...
extern "C" void func_80782804(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8078283C:
{
    ...
    r3 = 0x808A0000u;
    r4 = 0x802A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 17916));
    r3 = (r1 + 56);
    r4 = (r4 + 16688);
...
// RECOMP_REGISTRATION base 0x80782804 func_80782804 preserves=false fpr_mask=0x80000000
