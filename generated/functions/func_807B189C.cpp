...
extern "C" void func_807B189C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807B18DC:
{
    r4 = MemoryInline::FlatRead32((r3 + 452));
...
// RECOMP_REGISTRATION base 0x807B189C func_807B189C preserves=true fpr_mask=0x00000000
