...
extern "C" void func_80097118(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_ca_0 = 0;
...
loc_80097118:
{
    ...
    r3 = (r3_rot_0 & 1);
    r0_subfc_sub_0 = r0;
    r0 = (r29 - r0_subfc_sub_0);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(r29) >= static_cast<uint32_t>(r0_subfc_sub_0) ? 1u : 0u) << 29);
    r0_ca_0 = (xer >> 29) & 1u;
    r0 = (r4 + r3);
    r0 = (r0 + r0_ca_0);
    {
...
// RECOMP_REGISTRATION base 0x80097118 func_80097118 preserves=true fpr_mask=0x00000000
