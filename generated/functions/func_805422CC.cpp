...
extern "C" void func_805422CC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_inl0_cont_8051BED0:
{
    ...
    r31_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r26), static_cast<uint32_t>(2));
    r31 = (r31_rot_0 & -4);
    r5 = 851968;
    r3 = (r3 + r31);
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r28 + 1552), r3);
    r30 = 0;
    r26 = 917504;
    r27 = 0;
}
...
loc_80542358:
{
    MemoryInline::FlatWrite32((r4 + 1456), r3);
}

loc_8054235C:
{
    r0 = MemoryInline::FlatRead32((r4 + 1460));
    r3 = MemoryInline::FlatRead32((r28 + 1552));
}
...
loc_8054236C:
{
    MemoryInline::FlatWrite32((r4 + 1460), r3);
    goto loc_8054239C;
}
...
loc_80542388:
{
    MemoryInline::FlatWrite32((r3 + 1456), r27);
}

loc_8054238C:
{
    r0 = MemoryInline::FlatRead32((r3 + 1460));
}
...
loc_80542398:
{
    MemoryInline::FlatWrite32((r3 + 1460), r27);
}
...
// RECOMP_REGISTRATION base 0x805422CC func_805422CC preserves=true fpr_mask=0x00000000
