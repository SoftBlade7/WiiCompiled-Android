...
extern "C" void func_806BE580(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_806BE5FC:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r31 + 384));
...
// RECOMP_REGISTRATION base 0x806BE580 func_806BE580 preserves=true fpr_mask=0x00000000
