...
extern "C" void func_80640CDC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80640CEC:
{
    ...
    r4 = MemoryInline::FlatRead32((r6 + 1124));
...
// RECOMP_REGISTRATION base 0x80640CDC func_80640CDC preserves=true fpr_mask=0x00000000
