...
extern "C" void func_806ECCC0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806ECD3C:
{
    r3 = 0x808A0000u;
    r22 = 0x802A0000u;
    r26 = MemoryInline::FlatRead32((r3 + 26316));
    r23 = (r22 + 16688);
    f30.d = MemoryInline::FlatReadFloat32(r27);
    r28 = 0;
    f31.d = MemoryInline::FlatReadFloat32((r27 + 12));
    r29 = 0x809C0000u;
    r30 = 0x809C0000u;
    r31 = 552075264;
    goto loc_806ECE1C;
...
loc_806ECD68:
{
    ...
    r0_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r25), static_cast<uint32_t>(4));
    r0 = (r0_rot_2 & 1048560);
    r3 = MemoryInline::FlatRead32((r29 + 12100));
    r8 = r26;
...
loc_806ECDF4:
{
    ...
    r3 = MemoryInline::FlatRead32((r24 + 20));
    r0 = (r0 * 12);
    f0.d = MemoryInline::FlatReadFloat32((r22 + 16688));
    r3 = (r3 + r0);
    MemoryInline::FlatWriteFloat32(r3, f0.d);
...
{
    r0 = 1;
    MemoryInline::FlatWrite8((r24 + 16), static_cast<uint8_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x806ECCC0 func_806ECCC0 preserves=false fpr_mask=0xC0000000
