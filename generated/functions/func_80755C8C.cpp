...
extern "C" void func_80755C8C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80755CD4:
{
    ...
    f4 = ctx->fpr[4];
    cr = ctx->cr;
    f2.d = MemoryInline::FlatReadFloat32((r30 + 392));
...
loc_80755E54:
{
    MemoryInline::FlatWrite32((r30 + 468), r0);
    if (((cr & 0x40000000u) != 0)) {
        goto loc_80755F80;
    }
}
...
loc_80755F48:
{
    ...
    r3 = 0;
    r0 = 2;
    MemoryInline::FlatWrite8((r30 + 324), static_cast<uint8_t>(r3));
...
// RECOMP_REGISTRATION base 0x80755C8C func_80755C8C preserves=true fpr_mask=0x00000000
