...
extern "C" void func_8007AEE0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr1_0 = 0;
...
loc_8007AF08:
{
    r31 = MemoryInline::FlatRead32((r3 + 40));
    r4 = 0x80270000u;
    r4 = (r4 + 13568);
...
// RECOMP_REGISTRATION base 0x8007AEE0 func_8007AEE0 preserves=true fpr_mask=0x00000000
