...
extern "C" void func_80729ACC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80729ACC:
{
    ...
    r0 = MemoryInline::FlatRead16((r4 + -25590));
    r0 = (r0 << 16);
    r0 = (static_cast<int32_t>(r0) >> 16);
    r6 = MemoryInline::FlatRead32((r3 + 196));
...
loc_80729B04:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80729944u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80729ACC func_80729ACC preserves=true fpr_mask=0x00000000
