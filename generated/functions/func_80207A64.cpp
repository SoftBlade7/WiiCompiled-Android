...
extern "C" void func_80207A64(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80207A64:
{
    ...
    ctx->gpr[5] = r5;
    ctx->cr = cr;
    InvokeDirectCpu<0x80207778u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
...
loc_80207A90:
{
    ...
    r3 = (r3 + -20912);
    r4 = 10;
    MemoryInline::FlatWriteRam32((r3 + 28), r4);
...
// RECOMP_REGISTRATION base 0x80207A64 func_80207A64 preserves=true fpr_mask=0x00000000
