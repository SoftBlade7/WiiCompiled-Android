...
extern "C" void func_8020CEB4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8020CECC:
{
    ...
    r29 = r4;
    r28 = r5;
    if ((static_cast<uint32_t>(r6) >= static_cast<uint32_t>(26))) {
        goto loc_8020CF94;
    }
}
...
// RECOMP_REGISTRATION base 0x8020CEB4 func_8020CEB4 preserves=true fpr_mask=0x00000000
