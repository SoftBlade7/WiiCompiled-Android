...
extern "C" void func_805A0FA0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805A1184:
{
    ...
    r3 = MemoryInline::FlatRead32((r5 + 6224));
    ...
    ctx->fpr[2] = f2;
    ctx->cr = cr;
    InvokeDirectCpu<0x80563C38u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x805A0FA0 func_805A0FA0 preserves=true fpr_mask=0x00000000
