...
extern "C" void func_8083D42C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8083D42C:
{
    ...
    r3 = 0x809C0000u;
    r4 = (r4 + 17720);
    MemoryInline::FlatWriteRam32((r3 + 17768), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x8083D42C func_8083D42C preserves=true fpr_mask=0x00000000
