...
extern "C" void func_8008BCC0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_8008BCC0:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r5 = MemoryInline::FlatRead16((r31 + 32));
}
...
loc_8008BD30:
{
    r3_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r6), static_cast<uint32_t>(1));
    r3 = (r3_rot_0 & -2);
    r31 = (r3 + 2);
    if ((static_cast<int32_t>(r26) == static_cast<int32_t>(0))) {
        goto loc_8008BD40;
...
{
    r3 = 613548032;
    r0_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r26), static_cast<uint32_t>(1));
    r0 = (r0_rot_0 & -2);
    r3 = (r3 + 18725);
    r4 = (static_cast<uint32_t>((static_cast<uint64_t>(r3) * static_cast<uint64_t>(r30)) >> 32));
    r3 = (r30 - r4);
...
loc_8008BD84:
{
    r3_rot_5 = PpcRotl32Inline(static_cast<uint32_t>(r31), static_cast<uint32_t>(31));
...
loc_8008BD98:
{
    r3_rot_7 = PpcRotl32Inline(static_cast<uint32_t>(r31), static_cast<uint32_t>(31));
...
loc_8008BDCC:
{
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 42), 0, 46u, true, false);
    r0 = MemoryInline::ReadResolved16(guest_range_1, 0u, (r1 + 42));
    r11 = (r1 + 80);
    MemoryInline::FlatWrite16(r27, static_cast<uint16_t>(r0));
    r0 = MemoryInline::ReadResolved16(guest_range_1, 2u, (r1 + 44));
    MemoryInline::FlatWrite16(r28, static_cast<uint16_t>(r0));
    r0 = MemoryInline::ReadResolved16(guest_range_1, 4u, (r1 + 46));
    MemoryInline::FlatWrite16(r29, static_cast<uint16_t>(r0));
    // inline leaf 0x800215E8 (7 guest instruction(s))
    {
        const auto resolved_pair = MemoryInline::ReadResolvedPair32(guest_range_1, 14u);
        if (resolved_pair.valid) {
            r26 = resolved_pair.first;
            r27 = resolved_pair.second;
        } else {
            r26 = MemoryInline::ReadResolved32(guest_range_1, 14u, (r11 + -24));
            r27 = MemoryInline::ReadResolved32(guest_range_1, 18u, (r11 + -20));
        }
    }
    {
        const auto resolved_pair = MemoryInline::ReadResolvedPair32(guest_range_1, 22u);
        if (resolved_pair.valid) {
            r28 = resolved_pair.first;
            r29 = resolved_pair.second;
        } else {
            r28 = MemoryInline::ReadResolved32(guest_range_1, 22u, (r11 + -16));
            r29 = MemoryInline::ReadResolved32(guest_range_1, 26u, (r11 + -12));
        }
    }
    {
        const auto resolved_pair = MemoryInline::ReadResolvedPair32(guest_range_1, 30u);
        if (resolved_pair.valid) {
            r30 = resolved_pair.first;
            r31 = resolved_pair.second;
        } else {
            r30 = MemoryInline::ReadResolved32(guest_range_1, 30u, (r11 + -8));
            r31 = MemoryInline::ReadResolved32(guest_range_1, 34u, (r11 + -4));
        }
    }
    // end of inlined leaf 0x800215E8
    r0 = MemoryInline::ReadResolved32(guest_range_1, 42u, (r1 + 84));
    ctx->lr = r0;
    r1 = (r1 + 80);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x8008BCC0 func_8008BCC0 preserves=true fpr_mask=0x00000000
