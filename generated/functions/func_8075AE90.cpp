...
extern "C" void func_8075AE90(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8075AEDC:
{
    MemoryInline::FlatWrite8((r3 + 249), static_cast<uint8_t>(r5));
}
...
loc_8075AEE0:
{
    ...
    r3 = MemoryInline::FlatRead32((r4 + 180));
...
// RECOMP_REGISTRATION base 0x8075AE90 func_8075AE90 preserves=true fpr_mask=0x00000000
