...
extern "C" void func_805E50B4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805E50B4:
{
    ...
    r28 = 0x80890000u;
    r28 = (r28 + 21216);
    MemoryInline::FlatWrite32((r3 + 1036), r4);
    r4 = 0;
    r3 = (r3 + 236);
...
loc_805E5160:
{
    ...
    cr = ctx->cr;
    r3 = 0x809C0000u;
    r30 = MemoryInline::FlatRead32((r29 + 11448));
    ...
    MemoryInline::FlatWriteRam32((r1 + 20), r3);
    r0 = (r0 ^ -2147483648);
    f3.d = MemoryInline::FlatReadFloat64((r28 + 24));
...
// RECOMP_REGISTRATION base 0x805E50B4 func_805E50B4 preserves=true fpr_mask=0x00000000
