...
extern "C" void func_8022450C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8022450C:
{
    ...
    ctx->gpr[30] = r30;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x8022464Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8022450C func_8022450C preserves=true fpr_mask=0x00000000
