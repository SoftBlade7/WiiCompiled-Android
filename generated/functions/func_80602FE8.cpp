...
extern "C" void func_80602FE8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80602FE8:
{
    ...
    r0 = (r3 & 255);
    MemoryInline::FlatWrite32((r27 + 1636), r0);
    r3 = (r27 + 1620);
    r4 = 0;
    r12 = MemoryInline::FlatRead32((r27 + 1620));
    r5 = 0;
    ...
    r4 = MemoryInline::FlatRead32((r27 + 1636));
    r3 = r27;
    ctx->lr = 0x8060303Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x80602FE8 func_80602FE8 preserves=true fpr_mask=0x00000000
