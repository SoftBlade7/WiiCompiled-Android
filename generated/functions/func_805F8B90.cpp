...
extern "C" void func_805F8B90(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805F8B90:
{
    ...
    r3 = 0x809C0000u;
    r0 = 0;
    MemoryInline::FlatWriteRam8((r1 + 103), static_cast<uint8_t>(r0));
    r5 = (r1 + 8);
...
// RECOMP_REGISTRATION base 0x805F8B90 func_805F8B90 preserves=true fpr_mask=0x00000000
