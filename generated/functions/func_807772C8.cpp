...
extern "C" void func_807772C8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807772C8:
{
    ...
    r8 = 0;
    r7 = (r1 + 8);
    r0 = MemoryInline::FlatRead8((r4 + 16768));
    r4 = (r1 + 16);
...
// RECOMP_REGISTRATION base 0x807772C8 func_807772C8 preserves=true fpr_mask=0x00000000
