...
extern "C" void func_801D7854(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r4_rot_0 = 0;
    uint32_t r4_rot_1 = 0;
...
loc_801D78CC:
{
    MemoryInline::FlatWrite32((r27 + 816), r0);
    r25 = r3;
    r3 = 0;
...
{
    r0 = 0;
    MemoryInline::FlatWrite32((r27 + 804), r0);
...
loc_801D798C:
{
    ...
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r25), static_cast<int32_t>(r4));
}
...
loc_801D7AB8:
{
    r5 = MemoryInline::FlatRead32((r26 + 576));
    r3 = r27;
    r4 = (r26 + 484);
    ctx->lr = 0x801D7AC8u;
    ctx->gpr[0] = r0;
...
loc_801D7B00:
{
    ...
    r3 = MemoryInline::FlatRead32(r3);
    r26 = MemoryInline::FlatRead32((r3 + 12));
    r0 = MemoryInline::FlatRead32((r26 + 168));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_801D7B40:
{
    r5 = MemoryInline::FlatRead32((r26 + 168));
    r3 = r27;
    r4 = (r26 + 76);
    ctx->lr = 0x801D7B50u;
    ctx->gpr[0] = r0;
...
loc_801D7B88:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x801D68D0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801D7BB4:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x801D69C8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801D7C20:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x801D6B50u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801D7C2C:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x801D6EF4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801D7C6C:
{
    r6 = MemoryInline::FlatRead32((r27 + 804));
    r26 = 0;
...
loc_801D7C7C:
{
    r4 = MemoryInline::FlatRead32((r31 + 2000));
    r3 = r29;
    r5 = r28;
    r7 = 0;
    ctx->lr = 0x801D7C90u;
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x801D5374u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x801D7854 func_801D7854 preserves=true fpr_mask=0x00000000
