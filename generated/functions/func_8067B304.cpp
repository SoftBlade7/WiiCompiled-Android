...
extern "C" void func_8067B304(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8067B304:
{
    ...
    r3 = 0x809C0000u;
    r4 = (r4 + 7440);
    MemoryInline::FlatWriteRam32((r3 + 8648), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x8067B304 func_8067B304 preserves=true fpr_mask=0x00000000
