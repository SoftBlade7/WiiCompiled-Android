...
extern "C" void func_80663AA4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80663AA4:
{
    ...
    r0 = MemoryInline::FlatRead32((r3 + 8472));
...
loc_80663ADC:
{
    ...
    MemoryInline::FlatWriteRam8((r3 + 1), static_cast<uint8_t>(r31));
    ...
    r0 = 6;
    r5 = 0;
    MemoryInline::FlatWriteRam32((r30 + 8), r31);
    r3 = -1;
    MemoryInline::FlatWriteRam32((r30 + 12), r31);
    MemoryInline::FlatWriteRam8((r30 + 16), static_cast<uint8_t>(r4));
    MemoryInline::FlatWriteRam32((r30 + 28), r31);
    MemoryInline::FlatWriteRam32((r30 + 24), r31);
    ctr = r0;
}
...
loc_80663C08:
{
    ...
    MemoryInline::FlatWrite32((r3 + 10688), r0);
}

loc_80663C18:
{
    r3 = 0x809C0000u;
    MemoryInline::FlatWriteRam32((r3 + 8472), r30);
}
...
// RECOMP_REGISTRATION base 0x80663AA4 func_80663AA4 preserves=true fpr_mask=0x00000000
