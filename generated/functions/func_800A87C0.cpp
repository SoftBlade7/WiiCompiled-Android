...
extern "C" void func_800A87C0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800A87C0:
{
    ...
    ctx->gpr[31] = r31;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x800A5B20u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x800A87C0 func_800A87C0 preserves=true fpr_mask=0x00000000
