...
extern "C" void func_8086B878(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8086B91C:
{
    f0.d = MemoryInline::FlatReadFloat32((r29 + 428));
    f1.d = MemoryInline::FlatReadFloat32((r29 + 436));
    f3.d = static_cast<double>(PpcForceSingleValueInline(f0.d + f31.d));
    f2.d = MemoryInline::FlatReadFloat32((r29 + 432));
...
loc_8086B974:
{
    ...
    r0 = (0 - r3);
    r0 = (r0 | r3);
    r28_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(1));
    r28 = (r28_rot_1 & 1);
}
...
loc_8086BA34:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r3 + 8352));
    SetCRFloatResident(cr, 0, f1.d, f0.d);
}
...
// RECOMP_REGISTRATION base 0x8086B878 func_8086B878 preserves=false fpr_mask=0x80000000
