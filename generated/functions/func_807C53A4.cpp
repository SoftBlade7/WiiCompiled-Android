...
extern "C" void func_807C53A4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_807C5490:
{
    ...
    ctx->fpr[12] = f12;
    ctx->cr = cr;
    InvokeDirectCpu<0x807C3554u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x807C53A4 func_807C53A4 preserves=true fpr_mask=0x00000000
