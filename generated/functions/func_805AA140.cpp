...
extern "C" void func_805AA140(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_inl1_cont_805909C8:
{
    ...
    f2.d = MemoryInline::FlatReadFloat32((r7 + 44));
    ...
    f2.d = MemoryInline::FlatReadFloat32((r7 + 56));
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFEFFE gpr_write=0xFFFFFFFF gpr_return=0x00000018 fpr_read=0xFFFFFFF8 fpr_write=0xFFFFFFFF fpr_return=0x00000002 cr_read=0xFE cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x805AA140 func_805AA140 preserves=true fpr_mask=0x00000000
