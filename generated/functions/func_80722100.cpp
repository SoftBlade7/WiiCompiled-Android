...
extern "C" void func_80722100(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r4 = 0x808A0000u;
    r3 = MemoryInline::FlatRead32((r29 + 520));
    f0.d = MemoryInline::FlatReadFloat32((r4 + 8440));
    MemoryInline::FlatWriteFloat32((r29 + 476), f0.d);
    MemoryInline::FlatWriteFloat32((r29 + 472), f0.d);
    MemoryInline::FlatWriteFloat32((r29 + 468), f0.d);
    ctx->lr = 0x80722174u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r5 = 1096;
    r4 = MemoryInline::FlatRead32((r29 + 520));
    r12 = MemoryInline::FlatRead32(r3);
    ...
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r29 + 532));
    r4 = MemoryInline::FlatRead32((r29 + 460));
    ctx->lr = 0x807221A8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80722100 func_80722100 preserves=true fpr_mask=0x00000000
