...
extern "C" void func_80237624(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80237624:
{
    ...
    if (MkwStateFreeAbiEnabled(0x80234A54u) && KnownTranslatedCpuCall<0x80234A54u>::kAvailable && !KnownTranslatedCpuCall<0x80234A54u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80234A54u>()) {
        const auto state_free_result_80234A54_70D = func_80234A54_statefree_v0(r1, r2, r3);
        r1 = static_cast<uint32_t>(state_free_result_80234A54_70D);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    f1.d = MemoryInline::FlatReadFloat32((r2 + -24660));
    r4 = 0x802A0000u;
    r0 = 2;
    f2.d = MemoryInline::FlatReadFloat32((r2 + -24664));
    f0.d = MemoryInline::FlatReadFloat32((r2 + -24656));
    r4 = (r4 + 15504);
    r3 = 8;
    guest_range_0 = MemoryInline::ResolveRangeHost((r28 + 36), 0, 60u, false, true);
    MemoryInline::WriteResolved32(guest_range_0, 0u, (r28 + 36), r4);
    r29 = 0;
    r30 = 0;
    MemoryInline::WriteResolved8(guest_range_0, 4u, (r28 + 40), static_cast<uint8_t>(r3));
    r31 = 0;
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 28u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f2.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f1.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 28u, (r28 + 64), f2.d);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 32u, (r28 + 68), f1.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 36u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f1.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 36u, (r28 + 72), f0.d);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 40u, (r28 + 76), f1.d);
    }
    MemoryInline::WriteResolvedFloat32(guest_range_0, 44u, (r28 + 80), f1.d);
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 52u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_0, 52u, (r28 + 88), r0);
        MemoryInline::WriteResolved32(guest_range_0, 56u, (r28 + 92), r0);
    }
}
...
loc_802376B4:
{
    ...
    r4 = (r28 + r30);
    r29 = (r29 + 1);
    r3 = MemoryInline::FlatRead32((r4 + 44));
...
loc_80237720:
{
    MemoryInline::FlatWrite32((r28 + 56), r3);
    r12 = MemoryInline::FlatRead32((r3 + 16));
    r12 = MemoryInline::FlatRead32((r12 + 12));
    ctr = r12;
    ctx->lr = 0x80237734u;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead32((r28 + 56));
    r31 = 0;
    r3 = r28;
    MemoryInline::FlatWrite8((r4 + 6), static_cast<uint8_t>(r31));
    r4 = MemoryInline::FlatRead32((r28 + 56));
    MemoryInline::FlatWrite8((r4 + 7), static_cast<uint8_t>(r31));
    ctx->lr = 0x8023775Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80237784u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
...
// RECOMP_REGISTRATION base 0x80237624 func_80237624 preserves=true fpr_mask=0x00000000
