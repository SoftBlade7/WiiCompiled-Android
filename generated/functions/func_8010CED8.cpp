...
extern "C" void func_8010CED8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8010CF78:
{
    ...
    r3 = (r3 & 65535);
    // end of inlined leaf 0x801ED990
    r26 = MemoryInline::FlatRead32((r1 + 20));
    r30 = r3;
    r3 = r24;
    r4 = r26;
    r5 = (r30 & 65535);
...
loc_8010D038:
{
    MemoryInline::FlatWrite32((r25 + 20), r31);
}
...
loc_8010D0A4:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8010E930u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8010D0B4:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8010C6FCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8010CED8 func_8010CED8 preserves=true fpr_mask=0x00000000
