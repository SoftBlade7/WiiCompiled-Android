...
extern "C" void func_80689D8C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80689D8C:
{
    ...
    guest_range_0 = MemoryInline::ResolveRangeHost(r3, 0, 72u, true, false);
    ...
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 48u, (r3 + 48));
    MemoryInline::WriteResolvedFloat32(guest_range_1, 12u, (r1 + 104), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 52u, (r3 + 52));
    ...
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 60u, (r3 + 60));
...
// RECOMP_REGISTRATION base 0x80689D8C func_80689D8C preserves=false fpr_mask=0xF8000000
