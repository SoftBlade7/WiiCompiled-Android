...
extern "C" void func_807AF1BC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFFE6E gpr_write=0xFFFFFFFF gpr_return=0x00000018 fpr_read=0xFFFFFFFF fpr_write=0xFFFFFFFF fpr_return=0x00000002 cr_read=0xFE cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x807AF1BC func_807AF1BC preserves=true fpr_mask=0x00000000
