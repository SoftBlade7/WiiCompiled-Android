...
extern "C" void func_805F3830(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805F38C8:
{
    r4 = MemoryInline::FlatRead32((r29 + 380));
    r3 = (r31 + 148);
    ...
    xer = ctx->xer;
    r5 = 0x80890000u;
    f8.d = MemoryInline::FlatReadFloat32((r29 + 388));
...
// RECOMP_REGISTRATION base 0x805F3830 func_805F3830 preserves=true fpr_mask=0x00000000
