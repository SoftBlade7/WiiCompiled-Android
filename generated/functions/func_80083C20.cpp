...
extern "C" void func_80083C20(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80083C68:
{
    ...
    MemoryInline::FlatWrite8((r28 + 14), static_cast<uint8_t>(r29));
}
...
// RECOMP_REGISTRATION base 0x80083C20 func_80083C20 preserves=true fpr_mask=0x00000000
