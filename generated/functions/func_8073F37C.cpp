...
extern "C" void func_8073F37C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8073F37C:
{
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | PpcBitCastToU32Inline(static_cast<float>(f0.d))))) {
...
// RECOMP_REGISTRATION base 0x8073F37C func_8073F37C preserves=true fpr_mask=0x00000000
