...
extern "C" void func_80687DC0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80687DC0:
{
    ...
    r4 = (r1 + 12);
    r7 = 0;
    r0 = MemoryInline::FlatRead32((r5 + -11456));
    r5 = (r1 + 8);
...
// RECOMP_REGISTRATION base 0x80687DC0 func_80687DC0 preserves=true fpr_mask=0x00000000
