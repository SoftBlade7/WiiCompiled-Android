...
extern "C" void func_806C4178(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806C4178:
{
    ...
    r31 = 0x808A0000u;
    r5 = 0x808C0000u;
    f0.d = MemoryInline::FlatReadFloat32((r31 + -2120));
    r3 = (r30 + 256);
    MemoryInline::FlatWriteFloat32((r30 + 268), f0.d);
    r4 = (r30 + 252);
    f2.d = MemoryInline::FlatReadFloat32((r30 + 248));
    f1.d = MemoryInline::FlatReadFloat32((r5 + 15180));
    // inline leaf 0x806B5A0C (9 guest instruction(s))
    r5 = 0x808A0000u;
    ...
    // end of inlined leaf 0x806B5A0C
    f1.d = MemoryInline::FlatReadFloat32((r31 + -2120));
    r3 = r30;
    r4 = 474;
    ctx->lr = 0x806C41D8u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x806C4178 func_806C4178 preserves=true fpr_mask=0x00000000
