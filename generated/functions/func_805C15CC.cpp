...
extern "C" void func_805C15CC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_805C15CC:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805F0DB4u) && KnownTranslatedCpuCall<0x805F0DB4u>::kAvailable && !KnownTranslatedCpuCall<0x805F0DB4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805F0DB4u>()) {
        const auto state_free_result_805F0DB4_A08 = func_805F0DB4_statefree_v0(r3, r4, cr, xer);
        cr = static_cast<uint32_t>(state_free_result_805F0DB4_A08);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    xer = ctx->xer;
    r0 = 1;
    MemoryInline::FlatWrite32((r30 + 1624), r0);
    r3 = (r30 + 1048);
    r4 = (r30 + 68);
    r5 = 0;
    ctx->gpr[0] = r0;
    ...
    xer = ctx->xer;
    r0 = 2;
    MemoryInline::FlatWrite32((r30 + 2220), r0);
    r3 = (r30 + 1644);
    r4 = (r30 + 68);
    r5 = 0;
    ctx->gpr[0] = r0;
    ...
    xer = ctx->xer;
    r0 = 3;
    MemoryInline::FlatWrite32((r30 + 2816), r0);
    r3 = (r30 + 2240);
    r4 = (r30 + 68);
    r5 = 0;
    ctx->gpr[0] = r0;
...
loc_805C17BC:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(162));
}
...
// RECOMP_REGISTRATION base 0x805C15CC func_805C15CC preserves=true fpr_mask=0x00000000
