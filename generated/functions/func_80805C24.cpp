...
extern "C" void func_80805C24(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80805CD8:
{
    ...
    r28 = (r29 + 4);
    guest_range_0 = MemoryInline::ResolveRangeHost((r31 + 24), 0, 48u, true, false);
    f1.d = MemoryInline::ReadResolvedFloat64(guest_range_0, 32u, (r31 + 56));
    r27 = 1;
    f0.d = MemoryInline::FlatReadFloat64((r1 + 16));
    f26.d = MemoryInline::ReadResolvedFloat64(guest_range_0, 40u, (r31 + 64));
    f0.d = static_cast<double>(PpcForceSingleValueInline(f0.d - f1.d));
    {
        ...
        if (resolved_pair.valid) {
            ...
            f27.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 8u, (r31 + 32));
            f28.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 12u, (r31 + 36));
        }
    }
    f29.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 4u, (r31 + 28));
    f30.d = PPC_Fctiwz(f0.d);
    f31.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 16u, (r31 + 40));
    f23.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 0u, (r31 + 24));
    {
        ...
        if (resolved_pair.valid) {
            ...
            f24.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 20u, (r31 + 44));
            f25.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 24u, (r31 + 48));
        }
    }
}
...
loc_80805D14:
{
    ...
    r27 = (r27 + 1);
    r28 = (r28 + 4);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r27), static_cast<int32_t>(37));
}
...
// RECOMP_REGISTRATION base 0x80805C24 func_80805C24 preserves=false fpr_mask=0x40600000
