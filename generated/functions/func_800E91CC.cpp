...
extern "C" void func_800E91CC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800E922C:
{
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r28), static_cast<uint32_t>(20));
}
...
loc_800E9250:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x800E5830u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800E928C:
{
    ...
    r30 = MemoryInline::FlatRead8((r27 + 3));
    ...
    r0 = (r3 | r0);
    r25_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(16));
    r25 = (r25_rot_1 & -1);
    ctx->lr = 0x800E92B0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
{
    r23 = (r23 + 1);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r23), static_cast<uint32_t>(32));
}
...
loc_800E9354:
{
    ...
    r0_rot_4 = PpcRotl32Inline(static_cast<uint32_t>(r30), static_cast<uint32_t>(6));
    r0 = (r0_rot_4 & 16320);
    r25 = (r3 + r0);
...
{
    r3 = MemoryInline::FlatRead32((r13 + -26856));
    r12 = MemoryInline::FlatRead32((r3 + 2052));
...
loc_800E93F0:
{
    ...
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    MemoryInline::FlatWrite32((r25 + 44), r4);
...
// RECOMP_REGISTRATION base 0x800E91CC func_800E91CC preserves=true fpr_mask=0x00000000
