...
extern "C" void func_806AE8EC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806AE918:
{
    r0 = MemoryInline::FlatRead32((r3 + 800));
...
loc_806AE92C:
{
    r0 = MemoryInline::FlatRead32((r3 + 796));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_806AEA00:
{
    r3 = MemoryInline::FlatRead32((r3 + 796));
    r12 = MemoryInline::FlatRead32(r3);
    r12 = MemoryInline::FlatRead32((r12 + 20));
    ctr = r12;
    ctx->lr = 0x806AEA14u;
...
// RECOMP_REGISTRATION base 0x806AE8EC func_806AE8EC preserves=true fpr_mask=0x00000000
