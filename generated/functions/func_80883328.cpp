...
extern "C" void func_80883328(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80883364:
{
    MemoryInline::FlatWrite8((r25 + 796), static_cast<uint8_t>(r28));
    r27 = 0;
    r26 = 0;
}
...
loc_80883370:
{
    r0 = MemoryInline::FlatRead32((r25 + 788));
    r3 = (r0 + r26);
    MemoryInline::FlatWrite8((r3 + 12), static_cast<uint8_t>(r29));
    r0 = MemoryInline::FlatRead32((r25 + 788));
    r26_addr_3 = (r26 + r0);
...
loc_80883404:
{
    r0 = MemoryInline::FlatRead8((r30 + 7916));
    r3 = (r5 & 255);
...
// RECOMP_REGISTRATION base 0x80883328 func_80883328 preserves=true fpr_mask=0x00000000
