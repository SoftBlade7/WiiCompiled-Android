...
extern "C" void func_80720F44(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80720F44:
{
    ...
    r4 = 1;
    r5 = (r5 + -26816);
    guest_range_0 = MemoryInline::ResolveRangeHost(r3, 0, 94u, false, true);
    MemoryInline::WriteResolved32(guest_range_0, 0u, r3, r5);
    r0 = 0;
    MemoryInline::WriteResolved8(guest_range_0, 92u, (r3 + 92), static_cast<uint8_t>(r4));
    MemoryInline::WriteResolved8(guest_range_0, 93u, (r3 + 93), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x80720F44 func_80720F44 preserves=true fpr_mask=0x00000000
