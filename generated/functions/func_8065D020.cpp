...
extern "C" void func_8065D020(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8065D05C:
{
    ...
    r0 = (r0_rot_0 & -8);
    r3 = (r28 + r0);
    r31 = MemoryInline::FlatRead8((r3 + 1));
    goto loc_8065D0A0;
}
...
// RECOMP_REGISTRATION base 0x8065D020 func_8065D020 preserves=true fpr_mask=0x00000000
