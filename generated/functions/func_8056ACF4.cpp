...
extern "C" void func_8056ACF4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8056ACF4:
{
    ...
    r31 = r4;
    r4 = (r1 + 12);
    r0 = MemoryInline::FlatRead32((r3 + 6320));
    r3 = (r1 + 8);
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFEE56 gpr_write=0x800011FB gpr_return=0x00000018 fpr_read=0xFFFFFFFF fpr_write=0x00000007 fpr_return=0x00000002 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=0 fence=1
// RECOMP_REGISTRATION base 0x8056ACF4 func_8056ACF4 preserves=true fpr_mask=0x00000000
