...
extern "C" void func_8062A3E8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8062A3E8:
{
    ...
    r11 = MemoryInline::FlatRead32((r29 + 2680));
    ...
    r8 = MemoryInline::FlatRead32((r29 + 2692));
    ...
    r9 = 0x808C0000u;
    r7 = 0x808C0000u;
    guest_range_5 = MemoryInline::ResolveRangeHost((r29 + 2704), 0, 60u, true, false);
    r21 = MemoryInline::ReadResolved32(guest_range_5, 0u, (r29 + 2704));
    r9 = (r9 + -12060);
    ...
    MemoryInline::WriteResolved32(guest_range_1, 16u, (r28 + 1636), r22);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r24 = MemoryInline::ReadResolved32(guest_range_5, 12u, (r29 + 2716));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r27 = MemoryInline::ReadResolved32(guest_range_5, 24u, (r29 + 2728));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r10 = MemoryInline::ReadResolved32(guest_range_5, 36u, (r29 + 2740));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_5, 48u, (r29 + 2752));
    ...
    f0 = ctx->fpr[0];
    r3 = (r29 + 2764);
    r30 = MemoryInline::FlatRead32((r29 + 2764));
    r11 = MemoryInline::FlatRead32((r3 + 4));
    r9 = 0x808C0000u;
    r10 = MemoryInline::FlatRead32((r3 + 8));
    r9 = (r9 + -11604);
    guest_range_3 = MemoryInline::ResolveRangeHost((r21 + 5704), 0, 40u, false, true);
    MemoryInline::WriteResolved32(guest_range_3, 16u, (r21 + 5720), r10);
    r6 = (r29 + 2776);
    r3 = (r28 + 1072);
    r4 = 1;
    MemoryInline::WriteResolved32(guest_range_3, 0u, (r21 + 5704), r9);
    r5 = 0;
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 4u, ((static_cast<uint64_t>(static_cast<uint32_t>(r21)) << 32) | static_cast<uint32_t>(r30)))) {
        MemoryInline::WriteResolved32(guest_range_3, 4u, (r21 + 5708), r21);
        MemoryInline::WriteResolved32(guest_range_3, 8u, (r21 + 5712), r30);
    }
    MemoryInline::WriteResolved32(guest_range_3, 12u, (r21 + 5716), r11);
    r8 = MemoryInline::FlatRead32((r29 + 2776));
    r7 = MemoryInline::FlatRead32((r6 + 4));
    r0 = MemoryInline::FlatRead32((r6 + 8));
    MemoryInline::WriteResolved32(guest_range_3, 36u, (r21 + 5740), r0);
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 20u, ((static_cast<uint64_t>(static_cast<uint32_t>(r9)) << 32) | static_cast<uint32_t>(r21)))) {
        MemoryInline::WriteResolved32(guest_range_3, 20u, (r21 + 5724), r9);
        MemoryInline::WriteResolved32(guest_range_3, 24u, (r21 + 5728), r21);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 28u, ((static_cast<uint64_t>(static_cast<uint32_t>(r8)) << 32) | static_cast<uint32_t>(r7)))) {
        MemoryInline::WriteResolved32(guest_range_3, 28u, (r21 + 5732), r8);
        MemoryInline::WriteResolved32(guest_range_3, 32u, (r21 + 5736), r7);
    }
...
// RECOMP_REGISTRATION base 0x8062A3E8 func_8062A3E8 preserves=true fpr_mask=0x00000000
