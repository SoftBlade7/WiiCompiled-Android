...
extern "C" void func_80849F68(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80849FE4:
{
    ...
    r6 = (r31 + r0);
    r5 = -1;
    MemoryInline::FlatWrite8((r6 + 4001), static_cast<uint8_t>(r7));
    ctx->lr = 0x8084A024u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_8084A0D0:
{
    f1.d = MemoryInline::FlatReadFloat32((r30 + -9312));
    r3 = r31;
    ctx->lr = 0x8084A0DCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x80849F68 func_80849F68 preserves=true fpr_mask=0x00000000
