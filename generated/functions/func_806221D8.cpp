...
extern "C" void func_806221D8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80622220:
{
    ...
    r3 = MemoryInline::FlatRead32((r31 + 892));
    r0 = (r3 + -1);
    MemoryInline::FlatWrite32((r31 + 892), r0);
}
...
loc_80622280:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80601ADCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_806222B0:
{
    if ((static_cast<int32_t>(r30) < static_cast<int32_t>(211))) {
        goto loc_80622274;
    }
}
...
loc_80622304:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x805CDB68u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r31 + 1004));
    r4 = 1;
    ctx->lr = 0x80622314u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x805E9EF8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r31 + 1000));
    r4 = 1;
    ctx->lr = 0x80622320u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x805EA298u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80622338:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x805FCDECu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8062233C:
{
    r0 = MemoryInline::FlatRead8((r31 + 910));
...
// RECOMP_REGISTRATION base 0x806221D8 func_806221D8 preserves=true fpr_mask=0x00000000
