...
extern "C" void func_8014A28C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8014A45C:
{
    MemoryInline::FlatWrite32((r3 + 48), r30);
    r0 = MemoryInline::FlatRead32((r29 + 4));
...
// RECOMP_REGISTRATION base 0x8014A28C func_8014A28C preserves=true fpr_mask=0x00000000
