...
extern "C" void func_807056B4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807056B4:
{
    ...
    r31 = r3;
    r3 = (r3 + 140);
    // inline leaf 0x8070296C (1 guest instruction(s))
    // end of inlined leaf 0x8070296C
    r4 = 0x809C0000u;
    r3 = r31;
    r4 = (r4 + 10328);
    // inline leaf 0x8009C5E0 (7 guest instruction(s))
    ...
    // end of inlined leaf 0x8009C5E0
...
// RECOMP_REGISTRATION base 0x807056B4 func_807056B4 preserves=true fpr_mask=0x00000000
