...
extern "C" void func_807E0B50(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807E0B50:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r26 = MemoryInline::FlatRead32((r3 + 5968));
}
...
{
    r30 = 0x808A0000u;
    f30.d = MemoryInline::FlatReadFloat64((r29 + 56));
...
loc_807E0BC0:
{
    r0 = MemoryInline::FlatRead32((r28 + 948));
...
loc_807E0BCC:
{
    ...
    r0 = MemoryInline::FlatRead32((r28 + 948));
    r3 = 120;
    MemoryInline::FlatWrite32((r24 + 1604), r0);
    ctx->lr = 0x807E0BF8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r5 = MemoryInline::FlatRead32((r24 + 1604));
    r3 = (r24 + 1632);
...
// RECOMP_REGISTRATION base 0x807E0B50 func_807E0B50 preserves=false fpr_mask=0xC0000000
