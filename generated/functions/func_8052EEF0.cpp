...
extern "C" void func_8052EEF0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8052EEF0:
{
    ...
    r28 = r3;
    r3 = MemoryInline::FlatRead32((r3 + 3052));
    ctx->lr = 0x8052EF24u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_8052EF2C:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead32((r28 + 3052));
    r3 = (r1 + 8);
    ctx->lr = 0x8052EF40u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    r0 = MemoryInline::FlatRead32((r28 + 2888));
...
loc_8052EF70:
{
    ...
    MemoryInline::FlatWrite8((r3 + 14), static_cast<uint8_t>(r30));
...
// RECOMP_REGISTRATION base 0x8052EEF0 func_8052EEF0 preserves=true fpr_mask=0x00000000
