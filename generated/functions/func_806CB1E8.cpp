...
extern "C" void func_806CB1E8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lfsx_806CB270_loc_0 = 0;
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
    uint32_t r0_rot_2 = 0;
...
loc_806CB25C:
{
    r3 = MemoryInline::FlatRead32((r27 + 220));
    r4 = 0;
    r5 = MemoryInline::FlatRead32((r27 + 256));
    r3_addr_4 = (r3 + r29);
    r3 = MemoryInline::FlatRead32(r3_addr_4);
    f1.d = MemoryInline::FlatReadFloat32((r31 + 17196));
    addr_lfsx_806CB270_loc_0 = (r5 + r29);
    f0.d = MemoryInline::FlatReadFloat32(addr_lfsx_806CB270_loc_0);
    r3 = MemoryInline::FlatRead32((r3 + 8));
...
loc_806CB2A0:
{
    r0 = MemoryInline::FlatRead32((r27 + 212));
...
loc_806CB2AC:
{
    r5 = MemoryInline::FlatRead32((r27 + 256));
    r3 = 0x808C0000u;
    r30 = MemoryInline::FlatRead32((r27 + 216));
    r4 = 0;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 17196));
...
// RECOMP_REGISTRATION base 0x806CB1E8 func_806CB1E8 preserves=false fpr_mask=0x80000000
