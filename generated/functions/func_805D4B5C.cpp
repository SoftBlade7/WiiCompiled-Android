...
extern "C" void func_805D4B5C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805D4B5C:
{
    ...
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x805D2A04u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x805D4B5C func_805D4B5C preserves=true fpr_mask=0x00000000
