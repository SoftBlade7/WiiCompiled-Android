...
extern "C" void func_8005F8A0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8005F8A0:
{
    ...
    ctx->gpr[5] = r5;
    ctx->cr = cr;
    InvokeDirectCpu<0x80056A00u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r5 = ctx->gpr[5];
    cr = ctx->cr;
...
loc_8005F8DC:
{
    r26 = MemoryInline::FlatRead8((r3 + 26));
    r28 = 7;
    r27 = 0;
}
...
loc_8005F8F8:
{
    r4 = MemoryInline::FlatRead16((r29 + 60));
...
loc_8005F990:
{
    r4 = MemoryInline::FlatRead16((r30 + 24));
    r3 = (r24 + 32);
    ctx->lr = 0x8005F99Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x8005F8A0 func_8005F8A0 preserves=true fpr_mask=0x00000000
