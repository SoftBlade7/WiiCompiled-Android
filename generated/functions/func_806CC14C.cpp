...
extern "C" void func_806CC14C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806CC14C:
{
    ...
    r4 = 0x808A0000u;
    r24 = r3;
    f31.d = MemoryInline::FlatReadFloat64((r4 + -1464));
    r25 = 0;
    r26 = 0;
    r27 = 0x808A0000u;
    r28 = 0x808A0000u;
...
loc_806CC19C:
{
    r3 = MemoryInline::FlatRead32((r24 + 220));
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r27 + -1560));
    r5 = 1;
    r3_addr_2 = (r3 + r26);
    r3 = MemoryInline::FlatRead32(r3_addr_2);
    f2.d = MemoryInline::FlatReadFloat32((r28 + -1504));
    ...
    f1.d = MemoryInline::FlatReadFloat32((r30 + 17264));
    f2.d = static_cast<double>(PpcForceSingleValueInline(f0.d - f31.d));
    r3 = MemoryInline::FlatRead32((r3 + 8));
    f0.d = MemoryInline::FlatReadFloat32((r31 + 17260));
    r3 = MemoryInline::FlatRead32((r3 + 40));
...
loc_806CC218:
{
    r0 = MemoryInline::FlatRead32((r24 + 212));
...
// RECOMP_REGISTRATION base 0x806CC14C func_806CC14C preserves=false fpr_mask=0xC0000000
