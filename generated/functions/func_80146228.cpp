...
extern "C" void func_80146228(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80146254:
{
    ...
    MemoryInline::FlatWriteRam8((r3 + 9), static_cast<uint8_t>(r4));
...
// RECOMP_REGISTRATION base 0x80146228 func_80146228 preserves=true fpr_mask=0x00000000
