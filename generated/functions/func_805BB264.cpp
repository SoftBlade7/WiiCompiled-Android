...
extern "C" void func_805BB264(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805BB264:
{
    r3 = MemoryInline::FlatRead32((r3 + 836));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x805BB264 func_805BB264 preserves=true fpr_mask=0x00000000
