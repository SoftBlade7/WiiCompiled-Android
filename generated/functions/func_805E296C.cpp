...
extern "C" void func_805E296C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805E296C:
{
    ...
    r29 = r3;
    MemoryInline::FlatWriteRam32((r1 + 432), r28);
...
loc_805E2A34:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_240D = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_240D[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_240D[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    r3 = MemoryInline::FlatRead16((r30 + 168));
    r0 = 99;
}
...
loc_805E2A88:
{
    r0 = MemoryInline::FlatRead8((r30 + 170));
}
...
loc_805E2AA8:
{
    ...
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_332A = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_332A[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_332A[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_inl2_cont_80860ACC:
{
    ...
    MemoryInline::FlatWrite8((r3 + 187), static_cast<uint8_t>(r0));
    r3 = (r1 + 16);
    r6 = MemoryInline::FlatRead32((r30 + 180));
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x805E2C14u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_805E2C60:
{
    ...
    r28 = MemoryInline::FlatRead32((r1 + 432));
    ctx->lr = r0;
    r1 = (r1 + 448);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x805E296C func_805E296C preserves=true fpr_mask=0x00000000
