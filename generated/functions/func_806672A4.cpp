...
extern "C" void func_806672A4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806672A4:
{
    ...
    r3 = (r31 + 24);
    r8 = 0x808C0000u;
    guest_range_3 = MemoryInline::ResolveRangeHost((r31 + 24), 0, 60u, true, false);
    r22 = MemoryInline::ReadResolved32(guest_range_3, 0u, (r31 + 24));
    r4 = 0x808C0000u;
    ...
    MemoryInline::WriteResolved32(guest_range_1, 80u, (r30 + 80), r23);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r26 = MemoryInline::ReadResolved32(guest_range_3, 12u, (r31 + 36));
            r27 = MemoryInline::ReadResolved32(guest_range_3, 16u, (r9 + 4));
        }
    }
    r28 = MemoryInline::ReadResolved32(guest_range_3, 20u, (r9 + 8));
    MemoryInline::WriteResolved32(guest_range_1, 104u, (r30 + 104), r28);
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 88u, ((static_cast<uint64_t>(static_cast<uint32_t>(r8)) << 32) | static_cast<uint32_t>(r30)))) {
        MemoryInline::WriteResolved32(guest_range_1, 88u, (r30 + 88), r8);
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r29 = MemoryInline::ReadResolved32(guest_range_3, 24u, (r31 + 48));
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 108u, ((static_cast<uint64_t>(static_cast<uint32_t>(r8)) << 32) | static_cast<uint32_t>(r30)))) {
        MemoryInline::WriteResolved32(guest_range_1, 108u, (r30 + 108), r8);
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r10 = MemoryInline::ReadResolved32(guest_range_3, 36u, (r31 + 60));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r7 = MemoryInline::ReadResolved32(guest_range_3, 48u, (r31 + 72));
    ...
    r3 = 0x808A0000u;
    r5 = 0x808D0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + -23608));
    r5 = (r5 + 14156);
    r23 = (r30 + 10112);
    r4 = 2001;
    r0 = 0;
...
// RECOMP_REGISTRATION base 0x806672A4 func_806672A4 preserves=true fpr_mask=0x00000000
