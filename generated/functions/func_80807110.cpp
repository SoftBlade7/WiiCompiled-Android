...
extern "C" void func_80807110(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_inl7_cont_807BDA9C:
{
    ...
    r3 = 0x809C0000u;
    r5 = MemoryInline::FlatRead32((r5 + 15320));
    r0_rot_7 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(13));
    r0 = (r0_rot_7 & 57344);
    r3 = (r3 + 14552);
    r4 = (r5 + -1);
    r4 = (r4 * 12);
...
// RECOMP_REGISTRATION base 0x80807110 func_80807110 preserves=false fpr_mask=0xF0000000
