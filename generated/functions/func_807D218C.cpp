...
extern "C" void func_807D218C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807D2198:
{
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r4), static_cast<uint32_t>(23));
}
...
// RECOMP_REGISTRATION base 0x807D218C func_807D218C preserves=true fpr_mask=0x00000000
