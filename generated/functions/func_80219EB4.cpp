...
extern "C" void func_80219EB4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
    uint32_t r3_rot_1 = 0;
...
loc_80219EB4:
{
    ...
    r28 = r3;
    r31 = MemoryInline::FlatRead8((r3 + 8));
    ctx->lr = 0x80219ED0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80219EB4 func_80219EB4 preserves=true fpr_mask=0x00000000
