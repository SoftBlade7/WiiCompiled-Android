...
extern "C" void func_8072E7E0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8072E7E0:
{
    ...
    r7 = 0;
    r8 = (r8 + -23240);
    guest_range_0 = MemoryInline::ResolveRangeHost((r30 + 52), 0, 196u, false, true);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 108u, ((static_cast<uint64_t>(static_cast<uint32_t>(r6)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_0, 112u, (r30 + 164), r0);
        MemoryInline::WriteResolved32(guest_range_0, 108u, (r30 + 160), r6);
    }
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 120u, ((static_cast<uint64_t>(static_cast<uint32_t>(r6)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_0, 124u, (r30 + 176), r0);
        MemoryInline::WriteResolved32(guest_range_0, 120u, (r30 + 172), r6);
    }
    r0 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r4 + 8));
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 132u, ((static_cast<uint64_t>(static_cast<uint32_t>(r6)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_0, 136u, (r30 + 188), r0);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 140u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | static_cast<uint32_t>(r8)))) {
        ...
        MemoryInline::WriteResolved32(guest_range_0, 144u, (r30 + 196), r8);
    }
    MemoryInline::WriteResolved32(guest_range_0, 148u, (r30 + 200), r7);
    {
        const auto resolved_pair = MemoryInline::ReadResolvedPair32(guest_range_1, 0u);
        if (resolved_pair.valid) {
            r6 = resolved_pair.first;
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 152u, ((static_cast<uint64_t>(static_cast<uint32_t>(r6)) << 32) | static_cast<uint32_t>(r0)))) {
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 164u, ((static_cast<uint64_t>(static_cast<uint32_t>(r6)) << 32) | static_cast<uint32_t>(r0)))) {
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 176u, ((static_cast<uint64_t>(static_cast<uint32_t>(r6)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_0, 180u, (r30 + 232), r0);
        MemoryInline::WriteResolved32(guest_range_0, 176u, (r30 + 228), r6);
    }
    r0 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r4 + 8));
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 184u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | static_cast<uint32_t>(r7)))) {
        MemoryInline::WriteResolved32(guest_range_0, 184u, (r30 + 236), r0);
        MemoryInline::WriteResolved32(guest_range_0, 188u, (r30 + 240), r7);
    }
    MemoryInline::WriteResolved32(guest_range_0, 192u, (r30 + 244), r7);
    {
        const auto resolved_pair = MemoryInline::ReadResolvedPair32(guest_range_1, 0u);
        if (resolved_pair.valid) {
    ...
    guest_range_2 = MemoryInline::ResolveRangeHost((r31 + 84), 0, 48u, true, false);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r9 = MemoryInline::ReadResolved32(guest_range_2, 0u, (r31 + 84));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_2, 12u, (r31 + 96));
        }
    }
    {
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 104u, ((static_cast<uint64_t>(static_cast<uint32_t>(r30)) << 32) | static_cast<uint32_t>(r6)))) {
        MemoryInline::WriteResolved32(guest_range_0, 104u, (r30 + 156), r30);
        MemoryInline::WriteResolved32(guest_range_0, 108u, (r30 + 160), r6);
    }
    ...
    MemoryInline::WriteResolved32(guest_range_0, 120u, (r30 + 172), r9);
    r6 = (r31 + 108);
    r5 = (r31 + 120);
    r3 = r30;
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 132u, ((static_cast<uint64_t>(static_cast<uint32_t>(r12)) << 32) | static_cast<uint32_t>(r11)))) {
        MemoryInline::WriteResolved32(guest_range_0, 132u, (r30 + 184), r12);
        MemoryInline::WriteResolved32(guest_range_0, 136u, (r30 + 188), r11);
    }
    MemoryInline::WriteResolved32(guest_range_0, 140u, (r30 + 192), r10);
    {
        const auto resolved_pair = MemoryInline::ReadResolvedPair32(guest_range_1, 0u);
        if (resolved_pair.valid) {
            r12 = resolved_pair.first;
    ...
    r10 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r4 + 8));
    {
        ...
        if (resolved_pair.valid) {
            ...
            r9 = MemoryInline::ReadResolved32(guest_range_2, 24u, (r31 + 108));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_2, 36u, (r31 + 120));
        }
    }
    {
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 148u, ((static_cast<uint64_t>(static_cast<uint32_t>(r30)) << 32) | static_cast<uint32_t>(r6)))) {
        MemoryInline::WriteResolved32(guest_range_0, 148u, (r30 + 200), r30);
        MemoryInline::WriteResolved32(guest_range_0, 152u, (r30 + 204), r6);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 156u, ((static_cast<uint64_t>(static_cast<uint32_t>(r4)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_0, 156u, (r30 + 208), r4);
        MemoryInline::WriteResolved32(guest_range_0, 160u, (r30 + 212), r0);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 164u, ((static_cast<uint64_t>(static_cast<uint32_t>(r9)) << 32) | static_cast<uint32_t>(r8)))) {
        MemoryInline::WriteResolved32(guest_range_0, 164u, (r30 + 216), r9);
        MemoryInline::WriteResolved32(guest_range_0, 168u, (r30 + 220), r8);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 172u, ((static_cast<uint64_t>(static_cast<uint32_t>(r7)) << 32) | static_cast<uint32_t>(r12)))) {
        MemoryInline::WriteResolved32(guest_range_0, 172u, (r30 + 224), r7);
        MemoryInline::WriteResolved32(guest_range_0, 176u, (r30 + 228), r12);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 180u, ((static_cast<uint64_t>(static_cast<uint32_t>(r11)) << 32) | static_cast<uint32_t>(r10)))) {
        MemoryInline::WriteResolved32(guest_range_0, 180u, (r30 + 232), r11);
        MemoryInline::WriteResolved32(guest_range_0, 184u, (r30 + 236), r10);
    }
...
// RECOMP_REGISTRATION base 0x8072E7E0 func_8072E7E0 preserves=true fpr_mask=0x00000000
