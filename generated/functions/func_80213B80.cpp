...
extern "C" void func_80213B80(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80213B80:
{
    ...
    r26 = 0;
    r30 = 1;
    MemoryInline::FlatWrite8((r13 + -24160), static_cast<uint8_t>(r27));
}
...
loc_80213BF8:
{
    ...
    MemoryInline::FlatWrite8(r4, static_cast<uint8_t>(r30));
    MemoryInline::FlatWrite32((r4 + 8), r31);
    MemoryInline::FlatWrite8((r4 + 1), static_cast<uint8_t>(r27));
...
loc_80213C10:
{
    MemoryInline::FlatWrite32((r13 + -24152), r27);
}
...
loc_80213C14:
{
    ...
    r0 = (r0 * 12);
    r3 = (r29 + r0);
    MemoryInline::FlatWrite8((r3 + 1), static_cast<uint8_t>(r30));
}
...
// RECOMP_REGISTRATION base 0x80213B80 func_80213B80 preserves=true fpr_mask=0x00000000
