...
extern "C" void func_800B38D0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800B38D0:
{
    ...
    f1.d = MemoryInline::FlatReadFloat64((r2 + -27832));
    ...
    MemoryInline::FlatWriteFloat32((r30 + 40), f31.d);
    f0.d = static_cast<double>(PpcForceSingleValueInline(f0.d - f1.d));
...
// RECOMP_REGISTRATION base 0x800B38D0 func_800B38D0 preserves=false fpr_mask=0xC0000000
