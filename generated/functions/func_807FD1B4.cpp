...
extern "C" void func_807FD1B4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807FD284:
{
    r6 = MemoryInline::FlatRead32((r31 + 184));
    r4 = 0x808B0000u;
    ...
    f4.d = MemoryInline::FlatReadFloat64((r5 + -21512));
...
loc_807FD2C8:
{
    r4 = 0x808B0000u;
    r3 = r31;
    f1.d = MemoryInline::FlatReadFloat32((r4 + -21568));
    r4 = 670;
    ctx->lr = 0x807FD2DCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_807FD2E0:
{
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r30), static_cast<uint32_t>(r6));
}
...
// RECOMP_REGISTRATION base 0x807FD1B4 func_807FD1B4 preserves=true fpr_mask=0x00000000
