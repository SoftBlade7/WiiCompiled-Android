...
extern "C" void func_80211320(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80211320:
{
    ...
    r31 = (r30 + 1724);
    r3 = r31;
    // inline leaf 0x8009D8A0 (23 guest instruction(s))
    r5 = 0;
    r7 = 0x80270000u;
    r7 = (r7 + 18792);
    ...
    // end of inlined leaf 0x8009D8A0
    r4 = 0x800A0000u;
    r5 = 0x80210000u;
    r3 = (r31 + 40);
    r6 = 88;
    ...
    ctx->fpr[0] = f0;
    ctx->fpr[1] = f1;
    InvokeDirectCpu<0x80211C14u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
...
// RECOMP_REGISTRATION base 0x80211320 func_80211320 preserves=true fpr_mask=0x00000000
