...
extern "C" void func_80186E80(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80186E80:
{
    ...
    r3 = 0x80340000u;
    r4 = (r4 + 18856);
    MemoryInline::FlatWriteRam32((r3 + 18864), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x80186E80 func_80186E80 preserves=true fpr_mask=0x00000000
