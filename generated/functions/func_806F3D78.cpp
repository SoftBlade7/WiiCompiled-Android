...
extern "C" void func_806F3D78(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806F3E64:
{
    ...
    r4 = (r1 + 8);
    r5_addr_4 = (r5 + r29);
    r30 = MemoryInline::FlatRead32(r5_addr_4);
...
// RECOMP_GUEST_ABI gpr_read=0xF00000FF gpr_write=0xF00000FB gpr_return=0x00000018 fpr_read=0x8000001F fpr_write=0x8000001F fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x806F3D78 func_806F3D78 preserves=false fpr_mask=0x80000000
