...
extern "C" void func_80079900(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = 0;
    MemoryInline::FlatWrite32((r13 + -27288), r0);
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x80079900 func_80079900 preserves=true fpr_mask=0x00000000
