...
extern "C" void func_801BB0E0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
// RECOMP_REGISTRATION base 0x801BB0E0 func_801BB0E0 preserves=true fpr_mask=0x00000000
