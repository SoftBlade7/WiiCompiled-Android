...
extern "C" void func_8053D060(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8053D09C:
{
    r27 = 0x809C0000u;
    r30 = (r29 * 24);
    r3 = MemoryInline::FlatRead32((r27 + 18248));
    r4 = (r3 + r30);
...
loc_8053D0CC:
{
    ...
    r0 = (r0_rot_1 & 1020);
    r9 = MemoryInline::FlatRead32((r6 + 8212));
    r4 = r29;
    r5_addr_1 = (r5 + r0);
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead32((r27 + 18248));
    r3 = (r0 + r30);
...
// RECOMP_REGISTRATION base 0x8053D060 func_8053D060 preserves=true fpr_mask=0x00000000
