...
extern "C" void func_8082CD60(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8082CFAC:
{
    ...
    r0 = (r0_rot_5 & -4);
    r3 = (r30 + r0);
    MemoryInline::FlatWrite32((r3 + 184), r25);
    goto loc_8082CFC8;
}
...
loc_8082CFE0:
{
    ...
    r0 = (r0_rot_7 & -4);
    r3 = (r25 + r0);
    MemoryInline::FlatWrite32((r3 + 184), r30);
    goto loc_8082CFFC;
}
...
loc_8082D008:
{
    ...
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    InvokeDirectCpu<0x8082B3A0u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r3 = r30;
    ...
    r11 = (r1 + 208);
    guest_range_0 = MemoryInline::ResolveRangeHost((r1 + 180), 0, 52u, true, false);
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_0, 28u, (r1 + 208));
    ...
    r0 = MemoryInline::ReadResolved32(guest_range_0, 48u, (r1 + 228));
    ctx->lr = r0;
    r1 = (r1 + 224);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x8082CD60 func_8082CD60 preserves=false fpr_mask=0x80000000
