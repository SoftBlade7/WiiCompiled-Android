...
extern "C" void func_805D6BA4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_805D6BA4:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805F0DB4u) && KnownTranslatedCpuCall<0x805F0DB4u>::kAvailable && !KnownTranslatedCpuCall<0x805F0DB4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805F0DB4u>()) {
        const auto state_free_result_805F0DB4_972 = func_805F0DB4_statefree_v0(r3, r4, cr, xer);
        cr = static_cast<uint32_t>(state_free_result_805F0DB4_972);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x805D6BA4 func_805D6BA4 preserves=true fpr_mask=0x00000000
