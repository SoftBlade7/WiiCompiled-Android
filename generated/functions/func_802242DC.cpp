...
extern "C" void func_802242DC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_802242DC:
{
    ...
    r1 = (r1 + -16);
    r0 = ctx->lr;
    f1.d = MemoryInline::FlatReadFloat32((r2 + -25276));
    MemoryInline::FlatWriteRam32((r1 + 20), r0);
    r0 = 0;
    f0.d = MemoryInline::FlatReadFloat32((r2 + -25280));
    MemoryInline::FlatWriteRam32((r1 + 12), r31);
    r31 = r3;
    guest_range_0 = MemoryInline::ResolveRangeHost((r3 + 40), 0, 84u, false, true);
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 0u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | PpcBitCastToU32Inline(static_cast<float>(f1.d))))) {
        MemoryInline::WriteResolved32(guest_range_0, 0u, (r3 + 40), r0);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 4u, (r3 + 44), f1.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 8u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f1.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f1.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 8u, (r3 + 48), f1.d);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 12u, (r3 + 52), f1.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 16u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f0.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 16u, (r3 + 56), f0.d);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 20u, (r3 + 60), f0.d);
    }
    MemoryInline::WriteResolvedFloat32(guest_range_0, 24u, (r3 + 64), f0.d);
    r3 = (r3 + 68);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 76u, ((static_cast<uint64_t>(static_cast<uint32_t>(r5)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_0, 76u, r3, r5);
        MemoryInline::WriteResolved32(guest_range_0, 80u, (r3 + 4), r0);
    }
...
// RECOMP_GUEST_ABI gpr_read=0x8000200E gpr_write=0x8000003B gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000007 fpr_return=0x00000002 cr_read=0x00 cr_write=0x00 xer_read=0 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x802242DC func_802242DC preserves=true fpr_mask=0x00000000
