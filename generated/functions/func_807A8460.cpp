...
extern "C" void func_807A8460(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807A8460:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80704BD4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_807A85C4:
{
    MemoryInline::FlatWrite8((r29 + 28), static_cast<uint8_t>(r30));
    goto loc_807A85D4;
}
...
// RECOMP_REGISTRATION base 0x807A8460 func_807A8460 preserves=true fpr_mask=0x00000000
