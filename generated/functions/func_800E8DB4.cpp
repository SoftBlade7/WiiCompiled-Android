...
extern "C" void func_800E8DB4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800E8ED0:
{
    ...
    xer = ctx->xer;
    r0 = 1;
    MemoryInline::FlatWriteRam8((r29 + 3), static_cast<uint8_t>(r24));
    r7 = PPC_Slw(static_cast<uint32_t>(r0), static_cast<uint32_t>(r25));
    r4 = r26;
...
// RECOMP_REGISTRATION base 0x800E8DB4 func_800E8DB4 preserves=true fpr_mask=0x00000000
