...
extern "C" void func_80642964(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80642964:
{
    MemoryInline::FlatWrite32((r3 + 660), r4);
    return;
}
...
// RECOMP_REGISTRATION base 0x80642964 func_80642964 preserves=true fpr_mask=0x00000000
