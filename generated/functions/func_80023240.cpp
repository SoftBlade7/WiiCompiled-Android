...
extern "C" void func_80023240(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80023240:
{
    ...
    r4 = 0x802A0000u;
    r4 = (r4 + 28856);
    MemoryInline::FlatWriteRam32((r4 + 848), r3);
    r3 = r29;
    r0 = MemoryInline::FlatRead32((r29 + 404));
    MemoryInline::FlatWriteRam32((r4 + 852), r0);
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[5] = r5;
    ctx->cr = cr;
    InvokeDirectCpu<0x801A24A4u>(ctx);
    r5 = ctx->gpr[5];
    cr = ctx->cr;
    r3 = r28;
    r4 = 0;
    ...
    r31 = ctx->gpr[31];
    cr = ctx->cr;
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r28), static_cast<uint32_t>(15));
}
...
loc_800232A0:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801A7684u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80023324:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80023410u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80023240 func_80023240 preserves=true fpr_mask=0x00000000
