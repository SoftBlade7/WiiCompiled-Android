...
extern "C" void func_8077F0C8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_inl0_cont_8051BED0:
{
    ...
    r0 = MemoryInline::FlatRead32((r3 + 3224));
    r3 = r31;
...
// RECOMP_REGISTRATION base 0x8077F0C8 func_8077F0C8 preserves=true fpr_mask=0x00000000
