...
extern "C" void func_8014F254(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r5_rot_0 = 0;
    uint32_t r5_rot_1 = 0;
...
loc_8014F2BC:
{
    MemoryInline::FlatWrite8((r3 + 20), static_cast<uint8_t>(r30));
    {
...
// RECOMP_REGISTRATION base 0x8014F254 func_8014F254 preserves=true fpr_mask=0x00000000
