...
extern "C" void func_80068D60(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80068D78:
{
    ...
    MemoryInline::WriteResolved32(guest_range_2, 0u, (r1 + 32), r27);
    r28 = r3;
    r29 = r5;
    r30 = r6;
    MemoryInline::WriteResolved32(guest_range_2, 4u, (r1 + 36), r27);
    r31 = 1;
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 8u, ((static_cast<uint64_t>(static_cast<uint32_t>(r27)) << 32) | static_cast<uint32_t>(r27)))) {
        MemoryInline::WriteResolved32(guest_range_2, 8u, (r1 + 40), r27);
        MemoryInline::WriteResolved32(guest_range_2, 12u, (r1 + 44), r27);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 16u, ((static_cast<uint64_t>(static_cast<uint32_t>(r27)) << 32) | static_cast<uint32_t>(r27)))) {
        MemoryInline::WriteResolved32(guest_range_2, 16u, (r1 + 48), r27);
        MemoryInline::WriteResolved32(guest_range_2, 20u, (r1 + 52), r27);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r27)) << 32) | static_cast<uint32_t>(r27)))) {
        MemoryInline::WriteResolved32(guest_range_2, 24u, (r1 + 56), r27);
        MemoryInline::WriteResolved32(guest_range_2, 28u, (r1 + 60), r27);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 32u, ((static_cast<uint64_t>(static_cast<uint32_t>(r27)) << 32) | static_cast<uint32_t>(r27)))) {
        MemoryInline::WriteResolved32(guest_range_2, 32u, (r1 + 64), r27);
        MemoryInline::WriteResolved32(guest_range_2, 36u, (r1 + 68), r27);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 40u, ((static_cast<uint64_t>(static_cast<uint32_t>(r27)) << 32) | static_cast<uint32_t>(r27)))) {
        MemoryInline::WriteResolved32(guest_range_2, 40u, (r1 + 72), r27);
        MemoryInline::WriteResolved32(guest_range_2, 44u, (r1 + 76), r27);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 48u, ((static_cast<uint64_t>(static_cast<uint32_t>(r27)) << 32) | static_cast<uint32_t>(r27)))) {
        MemoryInline::WriteResolved32(guest_range_2, 48u, (r1 + 80), r27);
        MemoryInline::WriteResolved32(guest_range_2, 52u, (r1 + 84), r27);
    }
...
loc_80068DF4:
{
    r4 = MemoryInline::FlatRead16((r20 + 10));
    r3 = r28;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_80068EA0:
{
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r18), static_cast<uint32_t>(r29));
}
...
// RECOMP_REGISTRATION base 0x80068D60 func_80068D60 preserves=true fpr_mask=0x00000000
