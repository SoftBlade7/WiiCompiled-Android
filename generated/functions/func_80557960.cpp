...
extern "C" void func_80557960(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805579AC:
{
    ...
    r30 = MemoryInline::FlatRead16((r4 + 8));
    ctx->lr = 0x805579C8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_80557AD0:
{
    ...
    r3 = r31;
    f2.d = MemoryInline::FlatReadFloat32((r4 + 5000));
    r4 = (r0 & 65535);
    r5 = 0;
    ctx->lr = 0x80557AF0u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x80557960 func_80557960 preserves=false fpr_mask=0x80000000
