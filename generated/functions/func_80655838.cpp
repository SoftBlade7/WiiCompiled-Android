...
extern "C" void func_80655838(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r3_rot_0 = 0;
...
loc_80655838:
{
    ...
    r3_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(r0));
    r3 = (r3_rot_0 & 1);
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    return;
...
// RECOMP_REGISTRATION base 0x80655838 func_80655838 preserves=true fpr_mask=0x00000000
