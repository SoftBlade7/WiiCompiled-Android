...
extern "C" void func_8077708C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8077708C:
{
    ...
    r4 = 0x808D0000u;
    r3 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 16900));
    r4 = (r4 + 592);
...
loc_80777104:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r3 + 16936));
    r3 = r30;
...
// RECOMP_REGISTRATION base 0x8077708C func_8077708C preserves=true fpr_mask=0x00000000
