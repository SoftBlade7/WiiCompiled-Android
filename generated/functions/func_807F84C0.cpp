...
extern "C" void func_807F84C0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r5_rot_0 = 0;
    uint32_t r5_rot_1 = 0;
...
loc_807F84C0:
{
    ...
    r5 = MemoryInline::FlatRead8((r4 + 10));
    r0 = 1127219200;
...
loc_807F84F0:
{
    ...
    r29 = MemoryInline::FlatRead8((r4 + 6));
    r28 = MemoryInline::FlatRead16((r4 + 8));
}

loc_807F8500:
{
    MemoryInline::FlatWrite16((r3 + 416), static_cast<uint16_t>(r0));
    MemoryInline::FlatWrite8((r3 + 418), static_cast<uint8_t>(r29));
    MemoryInline::FlatWrite16((r3 + 420), static_cast<uint16_t>(r28));
    MemoryInline::FlatWrite8((r3 + 422), static_cast<uint8_t>(r5));
...
loc_807F852C:
{
    if ((static_cast<uint32_t>(r26) <= static_cast<uint32_t>(99))) {
        goto loc_807F8534;
    }
}
...
loc_807F8554:
{
    ...
    r31 = 0x808B0000u;
    r0 = (r26 & 255);
    f1.d = MemoryInline::FlatReadFloat64((r31 + -22056));
    r5 = (r30 + 26215);
    r4 = 0;
    ...
    r0 = (static_cast<int32_t>(r0) >> 2);
    r5_rot_8 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(1));
    r5 = (r5_rot_8 & 1);
    r0 = (r0 + r5);
    r0 = (r0 * 10);
    r0 = (r6 - r0);
...
// RECOMP_REGISTRATION base 0x807F84C0 func_807F84C0 preserves=true fpr_mask=0x00000000
