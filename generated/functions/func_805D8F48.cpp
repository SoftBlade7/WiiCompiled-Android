...
extern "C" void func_805D8F48(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_inl0_cont_806568F0:
{
    ...
    r0 = 1;
    MemoryInline::FlatWrite8((r31 + 3520), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x805D8F48 func_805D8F48 preserves=true fpr_mask=0x00000000
