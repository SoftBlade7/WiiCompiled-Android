...
extern "C" void func_8021BDC8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8021BDC8:
{
    ...
    guest_range_0 = MemoryInline::ResolveRangeHost((r2 + -25672), 0, 152u, true, false);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 148u, (r2 + -25524));
    guest_range_1 = MemoryInline::ResolveRangeHost((r28 + -32768), 0, 4u, false, true);
    MemoryInline::WriteResolvedFloat32(guest_range_1, 0u, (r28 + -32768), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 12u, (r2 + -25660));
    MemoryInline::WriteResolvedFloat32(guest_range_1, 0u, (r28 + -32768), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 0u, (r2 + -25672));
    MemoryInline::WriteResolvedFloat32(guest_range_1, 0u, (r28 + -32768), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 12u, (r2 + -25660));
    MemoryInline::WriteResolvedFloat32(guest_range_1, 0u, (r28 + -32768), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 12u, (r2 + -25660));
...
// RECOMP_REGISTRATION base 0x8021BDC8 func_8021BDC8 preserves=false fpr_mask=0xFE000000
