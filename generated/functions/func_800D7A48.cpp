...
extern "C" void func_800D7A48(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800D7BEC:
{
    ...
    r26 = 0;
    r27 = 0;
    MemoryInline::FlatWrite32((r3 + 2204), r0);
    MemoryInline::FlatWrite32((r3 + 2200), r0);
    goto loc_800D7C58;
}
...
loc_800D7C68:
{
    r0 = MemoryInline::FlatRead8((r28 + 44));
...
loc_800D7C90:
{
    ...
    r3 = 1;
    r5 = (r13 + -32136);
    r0 = MemoryInline::FlatRead8((r6 + 44));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_800D7D44:
{
    ...
    r6 = (r29 + 19923);
    r4_subfc_min_2 = r4;
    r4 = (r4_subfc_min_2 - r27);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(r4_subfc_min_2) >= static_cast<uint32_t>(r27) ? 1u : 0u) << 29);
    r5 = 0;
...
loc_800D83B8:
{
    ...
    if (MkwStateFreeAbiEnabled(0x8011E43Cu) && KnownTranslatedCpuCall<0x8011E43Cu>::kAvailable && !KnownTranslatedCpuCall<0x8011E43Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x8011E43Cu>()) {
        const auto state_free_result_8011E43C_11C73 = func_8011E43C_statefree_v0(r3, xer);
        r0 = static_cast<uint32_t>(state_free_result_8011E43C_11C73[0]);
        r3 = static_cast<uint32_t>(state_free_result_8011E43C_11C73[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x800D7A48 func_800D7A48 preserves=true fpr_mask=0x00000000
