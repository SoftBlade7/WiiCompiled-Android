...
extern "C" void func_805735EC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805735EC:
{
    ...
    r4 = MemoryInline::FlatRead32((r3 + 592));
    r0 = 0;
    r4 = (r4 | 4);
...
// RECOMP_REGISTRATION base 0x805735EC func_805735EC preserves=true fpr_mask=0x00000000
