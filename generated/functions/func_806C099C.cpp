...
extern "C" void func_806C099C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806C099C:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r6 + -2608));
...
loc_806C0AFC:
{
    r4 = 0x808A0000u;
    r3 = r30;
    f1.d = MemoryInline::FlatReadFloat32((r4 + -2608));
    r4 = 740;
    ctx->lr = 0x806C0B10u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x806C099C func_806C099C preserves=true fpr_mask=0x00000000
