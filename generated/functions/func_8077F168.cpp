...
extern "C" void func_8077F168(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8077F1AC:
{
    ...
    MemoryInline::FlatWriteRam8((r31 + 240), static_cast<uint8_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x8077F168 func_8077F168 preserves=true fpr_mask=0x00000000
