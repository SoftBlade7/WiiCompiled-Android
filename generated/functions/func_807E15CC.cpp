...
extern "C" void func_807E15CC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807E15CC:
{
    ...
    r4 = (r4 + 31728);
    f0.d = MemoryInline::FlatReadFloat32((r5 + 31588));
    r4 = (r4 + 239);
    ...
    r5 = (r6 + 16640);
    f0.d = MemoryInline::FlatReadFloat32((r4 + 31592));
    r0 = 255;
...
// RECOMP_REGISTRATION base 0x807E15CC func_807E15CC preserves=true fpr_mask=0x00000000
