...
extern "C" void func_80608268(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806082E0:
{
    ...
    xer = ctx->xer;
    r0 = 1;
    MemoryInline::FlatWrite8((r29 + 528), static_cast<uint8_t>(r0));
    r30 = (r29 + 772);
    r31 = 0;
}
...
loc_80608374:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80607224u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_806083A4:
{
    ...
    xer = ctx->xer;
    r0 = 1;
    MemoryInline::FlatWrite8((r29 + 6932), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x80608268 func_80608268 preserves=true fpr_mask=0x00000000
