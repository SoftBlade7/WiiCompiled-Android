...
extern "C" void func_8086AA74(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8086AAEC:
{
    ...
    r31_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r30), static_cast<uint32_t>(5));
    r31 = (r31_rot_2 & 2097120);
    r3 = (r0 + r31);
...
// RECOMP_REGISTRATION base 0x8086AA74 func_8086AA74 preserves=true fpr_mask=0x00000000
