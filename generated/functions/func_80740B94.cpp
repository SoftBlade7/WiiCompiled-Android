...
extern "C" void func_80740B94(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80740B94:
{
    ...
    r4 = 0x808D0000u;
    r26 = r3;
    r5 = MemoryInline::FlatRead16((r4 + -19828));
    r5 = (r5 << 16);
...
loc_80740BF4:
{
    ...
    r4 = 0x808A0000u;
    r3 = 0x808A0000u;
    f29.d = MemoryInline::FlatReadFloat32((r5 + -19824));
...
// RECOMP_REGISTRATION base 0x80740B94 func_80740B94 preserves=false fpr_mask=0xE0000000
