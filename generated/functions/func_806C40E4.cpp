...
extern "C" void func_806C40E4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806C40E4:
{
    ...
    r4 = 0x808A0000u;
    r3 = r31;
    f1.d = MemoryInline::FlatReadFloat32((r4 + -2120));
    r4 = 473;
    ctx->lr = 0x806C411Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x806C40E4 func_806C40E4 preserves=true fpr_mask=0x00000000
