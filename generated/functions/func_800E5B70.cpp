...
extern "C" void func_800E5B70(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr6_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_800E5BFC:
{
    SetCRResident(cr, xer, 6, static_cast<int32_t>(r29), static_cast<int32_t>(0));
}
...
loc_800E5C0C:
{
    r3 = MemoryInline::FlatRead16((r26 + 2));
...
loc_800E5C50:
{
    ...
    r3 = (r3 & 65535);
    // end of inlined leaf 0x801ED990
    MemoryInline::FlatWrite16((r27 + 1612), static_cast<uint16_t>(r3));
    r4 = (r31 + 8780);
    r3 = 64;
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x800E5C7Cu;
    ...
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r13 + -26868));
    MemoryInline::FlatWrite8((r3 + 1784), static_cast<uint8_t>(r28));
    r3 = MemoryInline::FlatRead32((r13 + -26868));
    MemoryInline::FlatWrite32((r3 + 1788), r28);
    r3 = MemoryInline::FlatRead32((r13 + -26868));
    MemoryInline::FlatWrite32((r3 + 1796), r28);
    MemoryInline::FlatWrite32((r3 + 1792), r28);
...
loc_800E5E00:
{
    ...
    r3 = MemoryInline::FlatRead32((r4 + 1608));
    r4 = MemoryInline::FlatRead16((r4 + 1612));
    ctx->lr = 0x800E5E20u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r4 = 24;
    r5 = (r13 + -32180);
    r6 = MemoryInline::FlatRead32((r6 + 1912));
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x800E5E50u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    r27 = MemoryInline::FlatRead32((r13 + -26868));
    r5 = 0;
    r3 = MemoryInline::FlatRead32((r27 + 1608));
    r4 = MemoryInline::FlatRead16((r27 + 1612));
    ctx->lr = 0x800E5E64u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8010A9BCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800E5FCC:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800E2FC4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800E6048:
{
    ...
    r4 = ctx->gpr[4];
    r5 = MemoryInline::FlatRead32((r13 + -26868));
    MemoryInline::FlatWrite32((r5 + 1804), r4);
    MemoryInline::FlatWrite32((r5 + 1800), r3);
    r29 = MemoryInline::FlatRead32((r5 + 1820));
...
loc_800E6064:
{
    ...
    r6 = 0x80000000u;
    r4_subfc_min_8 = r4;
    r4 = (r4_subfc_min_8 - r30);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(r4_subfc_min_8) >= static_cast<uint32_t>(r30) ? 1u : 0u) << 29);
    MemoryInline::FlatWrite32((r13 + -26864), r3);
    r7 = (r28 + 19923);
    r3_subfe_rb_8 = r3;
    r3_not_8 = ~(r27);
...
loc_800E612C:
{
    r0 = MemoryInline::FlatRead32((r5 + 1688));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_800E61B0:
{
    ...
    r6 = 0x80000000u;
    r4_subfc_min_10 = r4;
    r4 = (r4_subfc_min_10 - r30);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(r4_subfc_min_10) >= static_cast<uint32_t>(r30) ? 1u : 0u) << 29);
    MemoryInline::FlatWrite32((r13 + -26864), r3);
    r7 = (r28 + 19923);
    r3_subfe_rb_10 = r3;
    r3_not_10 = ~(r27);
    ...
    r6 = (static_cast<int32_t>(r6) >> 6);
    r0_rot_20 = PpcRotl32Inline(static_cast<uint32_t>(r6), static_cast<uint32_t>(1));
    r0 = (r0_rot_20 & 1);
    r3 = 1;
    r6 = (r6 + r0);
    r7 = (r4 - r6);
...
loc_800E644C:
{
    ...
    r0 = MemoryInline::FlatRead8((r7 + 21));
...
loc_800E6474:
{
    r5 = MemoryInline::FlatRead8((r7 + 1785));
    r4 = (r31 + 9000);
    r3 = 64;
    r6 = 5;
    r0 = (r5 + 1);
    MemoryInline::FlatWrite8((r7 + 1785), static_cast<uint8_t>(r0));
    r5 = MemoryInline::FlatRead32((r13 + -26868));
    r5 = MemoryInline::FlatRead8((r5 + 1785));
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x800E649Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_inl5_cont_800CCC68:
{
    ...
    r4 = PPC_CntlzwInline(static_cast<uint32_t>(r0));
    r0 = PPC_CntlzwInline(static_cast<uint32_t>(r3));
    r27_rot_3 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(27));
...
loc_800E6624:
{
    r3 = MemoryInline::FlatRead8((r30 + 1));
    r0 = MemoryInline::FlatRead8(r30);
    r3 = (r3 + 1);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_800E6634:
{
    MemoryInline::FlatWrite8((r30 + 1), static_cast<uint8_t>(r3));
    if (((cr & 0x20000000u) == 0)) {
        goto loc_800E668C;
    }
}
...
loc_800E66F4:
{
    ...
    r3 = 64;
    r6 = 1;
    r5 = MemoryInline::FlatRead8((r5 + 1784));
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x800E6710u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_800E671C:
{
    MemoryInline::FlatWrite32((r5 + 1796), r4);
    MemoryInline::FlatWrite32((r5 + 1792), r3);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_800E6744;
    }
}
...
loc_800E6738:
{
    r0 = MemoryInline::FlatRead8((r5 + 1784));
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r0), static_cast<uint32_t>(1));
}
...
loc_inl7_cont_800CCC68:
{
    ...
    r4 = PPC_CntlzwInline(static_cast<uint32_t>(r0));
    r0 = PPC_CntlzwInline(static_cast<uint32_t>(r3));
    r27_rot_6 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(27));
    r27 = (r27_rot_6 & 134217727);
    r28_rot_6 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(27));
    r28 = (r28_rot_6 & 134217727);
    ctx->lr = 0x800E68D4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x800E5B70 func_800E5B70 preserves=true fpr_mask=0x00000000
