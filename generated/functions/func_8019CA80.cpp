...
extern "C" void func_8019CA80(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_8019CAA8:
{
    r0 = MemoryInline::FlatRead8((r31 + 138));
...
// RECOMP_REGISTRATION base 0x8019CA80 func_8019CA80 preserves=true fpr_mask=0x00000000
