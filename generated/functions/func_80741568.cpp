...
extern "C" void func_80741568(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
    uint32_t r4_rot_0 = 0;
...
loc_80741568:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead32((r31 + 400));
    r0 = 0;
    r3 = 0x808A0000u;
    MemoryInline::FlatWrite32(r4, r0);
    f0.d = MemoryInline::FlatReadFloat32((r3 + 10520));
...
loc_807415DC:
{
    ...
    r0 = MemoryInline::FlatRead8((r4 + 2956));
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80741CECu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_807415FC:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80741A10u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80741618:
{
    ...
    MemoryInline::FlatWrite32((r31 + 388), r5);
    MemoryInline::FlatWrite32((r31 + 392), r5);
...
// RECOMP_REGISTRATION base 0x80741568 func_80741568 preserves=true fpr_mask=0x00000000
