...
extern "C" void func_805BF470(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805BF470:
{
    ...
    MemoryInline::WriteResolved32(guest_range_0, 8u, (r1 + 8), r29);
    r30 = MemoryInline::FlatRead32((r9 + 4));
    r31 = MemoryInline::FlatRead32((r9 + 8));
    r12 = MemoryInline::FlatRead32((r9 + 12));
    r11 = MemoryInline::FlatRead32((r9 + 16));
    r10 = MemoryInline::FlatRead32((r9 + 20));
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 28u, ((static_cast<uint64_t>(static_cast<uint32_t>(r10)) << 32) | static_cast<uint32_t>(r0)))) {
...
// RECOMP_REGISTRATION base 0x805BF470 func_805BF470 preserves=true fpr_mask=0x00000000
