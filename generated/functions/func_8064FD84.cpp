...
extern "C" void func_8064FD84(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8064FD84:
{
    ...
    ctx->gpr[31] = r31;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8065FFA4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r31 = ctx->gpr[31];
    ctr = ctx->ctr;
    r12 = MemoryInline::FlatRead32((r31 + 88));
    r3 = (r31 + 88);
    r4 = 0;
    r5 = 0;
    ...
    r3 = 0;
    r0 = 2;
    MemoryInline::FlatWrite32((r31 + 644), r3);
    MemoryInline::FlatWrite32((r31 + 648), r3);
    MemoryInline::FlatWrite32((r31 + 652), r0);
...
// RECOMP_REGISTRATION base 0x8064FD84 func_8064FD84 preserves=true fpr_mask=0x00000000
