...
extern "C" void func_80060CE0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80060CFC:
{
    r3 = MemoryInline::FlatRead32((r13 + -27336));
...
loc_80060D48:
{
    ...
    r4 = 0;
    r7 = MemoryInline::FlatRead32((r30 + 64));
    r8 = MemoryInline::FlatRead32((r31 + 64));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ...
    r6 = ctx->gpr[6];
    cr = ctx->cr;
    r5 = MemoryInline::FlatRead32((r30 + 96));
    r3 = r27;
    ...
    r6 = ctx->gpr[6];
    cr = ctx->cr;
    r5 = MemoryInline::FlatRead32((r30 + 128));
    r3 = r26;
    r6 = MemoryInline::FlatRead32((r31 + 128));
    r4 = 0;
    r7 = MemoryInline::FlatRead32((r30 + 160));
    r8 = MemoryInline::FlatRead32((r31 + 160));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ...
    r3 = r25;
    r6 = MemoryInline::FlatRead32((r31 + 192));
    r4 = 0;
    r7 = MemoryInline::FlatRead32((r30 + 224));
    r8 = MemoryInline::FlatRead32((r31 + 224));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ...
    r8 = MemoryInline::FlatRead32((r31 + 288));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ...
    r23 = (r23 + 1);
    r30 = (r30 + 4);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r23), static_cast<int32_t>(8));
}
...
// RECOMP_REGISTRATION base 0x80060CE0 func_80060CE0 preserves=true fpr_mask=0x00000000
