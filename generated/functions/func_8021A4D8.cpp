...
extern "C" void func_8021A4D8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8021A500:
{
    ...
    ctx->fpr[3] = f3;
    ctx->cr = cr;
    InvokeDirectCpu<0x8021B6A4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFF80F gpr_write=0xFFFFFFFF gpr_return=0x00000018 fpr_read=0xFFFFFFFF fpr_write=0xFFFFFFFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x8021A4D8 func_8021A4D8 preserves=true fpr_mask=0x00000000
