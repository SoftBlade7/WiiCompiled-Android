...
extern "C" void func_80224768(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8022478C:
{
    r0 = MemoryInline::FlatRead32((r13 + -23904));
...
loc_80224838:
{
    r22 = MemoryInline::FlatRead32((r30 + 16));
    r23 = MemoryInline::FlatRead32((r30 + 12));
    r24 = MemoryInline::FlatRead32((r30 + 8));
    r25 = MemoryInline::FlatRead32((r30 + 4));
    r30 = MemoryInline::FlatRead32((r28 + 44));
    // inline leaf 0x8022500C (4 guest instruction(s))
    r4 = 0x802A0000u;
    r4 = (r4 + 12040);
    MemoryInline::FlatWriteRam32(r3, r4);
    // end of inlined leaf 0x8022500C
    r4 = 0x802A0000u;
    r3 = 24;
    r4 = (r4 + 11888);
    MemoryInline::FlatWriteRam32(r31, r4);
    r4 = 32;
    // inline leaf 0x80224FF4 (6 guest instruction(s))
    r0 = (r4 + -1);
    r3 = (r4 + r3);
    r4 = ~(r0 | r0);
    r0 = (r3 + -1);
    r3 = (r4 & r0);
    // end of inlined leaf 0x80224FF4
    r27 = 0;
    MemoryInline::FlatWriteRam32((r31 + 4), r27);
    r26 = r3;
    r0 = (r30 + r29);
    MemoryInline::FlatWriteRam32((r31 + 16), r27);
    r3 = r30;
    r4 = 32;
    MemoryInline::FlatWriteRam32((r31 + 28), r27);
    MemoryInline::FlatWriteRam32((r31 + 40), r27);
    MemoryInline::FlatWriteRam32((r31 + 8), r27);
    MemoryInline::FlatWriteRam32((r31 + 20), r27);
    MemoryInline::FlatWriteRam32((r31 + 32), r27);
    MemoryInline::FlatWriteRam32((r31 + 44), r27);
    MemoryInline::FlatWriteRam32((r31 + 12), r27);
    MemoryInline::FlatWriteRam32((r31 + 24), r27);
    MemoryInline::FlatWriteRam32((r31 + 36), r27);
    MemoryInline::FlatWriteRam32((r31 + 48), r27);
    MemoryInline::FlatWriteRam32((r31 + 60), r27);
    MemoryInline::FlatWriteRam32((r31 + 64), r27);
    MemoryInline::FlatWriteRam32((r31 + 68), r27);
    MemoryInline::FlatWriteRam32((r31 + 72), r27);
    ...
    r3 = (r4 & r0);
    // end of inlined leaf 0x80224FF4
    MemoryInline::FlatWriteRam32((r31 + 52), r3);
    r30 = 0;
    MemoryInline::FlatWriteRam32((r31 + 4), r25);
    MemoryInline::FlatWriteRam32((r31 + 16), r24);
    MemoryInline::FlatWriteRam32((r31 + 28), r23);
    MemoryInline::FlatWriteRam32((r31 + 40), r22);
    MemoryInline::FlatWriteRam32((r31 + 8), r25);
    MemoryInline::FlatWriteRam32((r31 + 20), r24);
    MemoryInline::FlatWriteRam32((r31 + 32), r23);
    MemoryInline::FlatWriteRam32((r31 + 44), r22);
    MemoryInline::FlatWriteRam32((r31 + 64), r3);
    MemoryInline::FlatWrite32(r3, r27);
    ...
    r3 = MemoryInline::FlatRead32((r31 + 64));
    MemoryInline::FlatWrite8((r3 + 20), static_cast<uint8_t>(r27));
    ...
    MemoryInline::FlatWriteRam32((r31 + 60), r27);
    r22 = MemoryInline::FlatRead32((r31 + 4));
...
loc_80224944:
{
    ...
    r4 = r3;
    r3 = (r5 + 16);
    // inline leaf 0x80224E9C (2 guest instruction(s))
    r3 = r4;
    // end of inlined leaf 0x80224E9C
    r4 = 0x80020000u;
    r5 = 0x80020000u;
    r7 = r22;
    r6 = 160;
...
loc_80224990:
{
    ...
    r4 = r3;
    r3 = 36;
    // inline leaf 0x80224E94 (2 guest instruction(s))
    r3 = r4;
    // end of inlined leaf 0x80224E94
...
loc_802249BC:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80224DF0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_802249C8:
{
    ...
    r22 = 0;
    r23 = MemoryInline::FlatRead32((r31 + 16));
...
loc_80224A54:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80224D4Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80224A60:
{
    ...
    r22 = 0;
    r23 = MemoryInline::FlatRead32((r31 + 28));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r23), static_cast<int32_t>(0));
}
...
loc_80224AEC:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80224CA8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80224AF8:
{
    ...
    r22 = 0;
    r23 = MemoryInline::FlatRead32((r31 + 40));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r23), static_cast<int32_t>(0));
}
...
loc_80224B84:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80224C04u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80224BA8:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80027140u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80224768 func_80224768 preserves=true fpr_mask=0x00000000
