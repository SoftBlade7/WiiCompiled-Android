...
extern "C" void func_807771DC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807771DC:
{
    ...
    r29 = r3;
    MemoryInline::FlatWrite32((r3 + 192), r31);
    ...
    f1.d = MemoryInline::FlatReadFloat32((r30 + 16752));
    r3 = r29;
    f0.d = MemoryInline::FlatReadFloat32((r31 + 16900));
    r4 = 0;
    MemoryInline::FlatWriteFloat32((r29 + 180), f1.d);
    MemoryInline::FlatWriteFloat32((r29 + 184), f1.d);
    ...
    ctr = ctx->ctr;
    r0 = 1;
    MemoryInline::FlatWrite8((r29 + 212), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x807771DC func_807771DC preserves=true fpr_mask=0x00000000
