...
extern "C" void func_806E2574(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806E2574:
{
    ...
    r31 = MemoryInline::FlatRead32((r7 + 8));
    r12 = MemoryInline::FlatRead32((r7 + 12));
    r7 = 0;
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r29)) << 32) | static_cast<uint32_t>(r30)))) {
        MemoryInline::WriteResolved32(guest_range_0, 24u, (r1 + 24), r29);
        MemoryInline::WriteResolved32(guest_range_0, 28u, (r1 + 28), r30);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 32u, ((static_cast<uint64_t>(static_cast<uint32_t>(r31)) << 32) | static_cast<uint32_t>(r12)))) {
        MemoryInline::WriteResolved32(guest_range_0, 32u, (r1 + 32), r31);
        MemoryInline::WriteResolved32(guest_range_0, 36u, (r1 + 36), r12);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 8u, ((static_cast<uint64_t>(static_cast<uint32_t>(r10)) << 32) | static_cast<uint32_t>(r9)))) {
        MemoryInline::WriteResolved32(guest_range_0, 8u, (r1 + 8), r10);
...
// RECOMP_REGISTRATION base 0x806E2574 func_806E2574 preserves=true fpr_mask=0x00000000
