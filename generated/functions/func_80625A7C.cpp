...
extern "C" void func_80625A7C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80625A7C:
{
    ...
    r3 = r21;
    MemoryInline::FlatWrite32((r28 + 76), r20);
    ctx->lr = 0x80625AC0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 1012u, ((static_cast<uint64_t>(static_cast<uint32_t>(r12)) << 32) | static_cast<uint32_t>(r20)))) {
        MemoryInline::WriteResolved32(guest_range_2, 1012u, (r28 + 1012), r12);
        MemoryInline::WriteResolved32(guest_range_2, 1016u, (r28 + 1016), r20);
    }
    r11 = MemoryInline::FlatRead32((r29 + 844));
    ...
    r8 = MemoryInline::FlatRead32((r29 + 856));
    ...
    r12 = 0x808C0000u;
    r10 = 0x808C0000u;
    guest_range_4 = MemoryInline::ResolveRangeHost((r29 + 868), 0, 60u, true, false);
    r6 = MemoryInline::ReadResolved32(guest_range_4, 0u, (r29 + 868));
    r12 = (r12 + -11508);
    ...
    MemoryInline::WriteResolved32(guest_range_1, 16u, (r28 + 1636), r0);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r21 = MemoryInline::ReadResolved32(guest_range_4, 12u, (r29 + 880));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r24 = MemoryInline::ReadResolved32(guest_range_4, 24u, (r29 + 892));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r27 = MemoryInline::ReadResolved32(guest_range_4, 36u, (r29 + 904));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r9 = MemoryInline::ReadResolved32(guest_range_4, 48u, (r29 + 916));
        }
    }
...
// RECOMP_REGISTRATION base 0x80625A7C func_80625A7C preserves=true fpr_mask=0x00000000
