...
extern "C" void func_80181520(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80181520:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r5 + 11032));
    r5 = 0x80290000u;
    MemoryInline::FlatWriteRam32((r1 + 12), r31);
    r5 = (r5 + -17232);
    f0.d = MemoryInline::FlatReadFloat32((r4 + 11036));
    r31 = r3;
...
// RECOMP_REGISTRATION base 0x80181520 func_80181520 preserves=true fpr_mask=0x00000000
