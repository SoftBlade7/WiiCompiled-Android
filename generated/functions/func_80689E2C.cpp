...
extern "C" void func_80689E2C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80689E2C:
{
    ...
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 48u, (r3 + 60));
    MemoryInline::WriteResolvedFloat32(guest_range_1, 12u, (r1 + 104), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 52u, (r3 + 64));
    MemoryInline::WriteResolvedFloat32(guest_range_1, 16u, (r1 + 108), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 56u, (r3 + 68));
...
// RECOMP_REGISTRATION base 0x80689E2C func_80689E2C preserves=false fpr_mask=0xF8000000
