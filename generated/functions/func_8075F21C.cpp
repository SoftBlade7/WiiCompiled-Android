...
extern "C" void func_8075F21C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8075F21C:
{
    ...
    r5 = MemoryInline::FlatRead16((r4 + 46));
    r5 = (r5 << 16);
...
// RECOMP_REGISTRATION base 0x8075F21C func_8075F21C preserves=true fpr_mask=0x00000000
