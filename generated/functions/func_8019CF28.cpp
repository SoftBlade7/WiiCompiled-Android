...
extern "C" void func_8019CF28(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8019CF28:
{
    r4 = 0;
    ctx->gpr[4] = r4;
    InvokeDirectCpu<0x8019CF30u>(ctx);
    r4 = ctx->gpr[4];
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x8019CF28 func_8019CF28 preserves=true fpr_mask=0x00000000
