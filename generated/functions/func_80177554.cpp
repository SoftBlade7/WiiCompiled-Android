...
extern "C" void func_80177554(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80177554:
{
    ...
    r31 = 0x80340000u;
    r3 = MemoryInline::FlatRead32((r31 + 18768));
    ctx->lr = 0x80177574u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80177554 func_80177554 preserves=true fpr_mask=0x00000000
