...
extern "C" void func_80702660(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80702660:
{
    r3 = (r3 + -148);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x8058BDE0u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80702660 func_80702660 preserves=true fpr_mask=0x00000000
