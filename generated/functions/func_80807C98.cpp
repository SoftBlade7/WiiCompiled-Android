...
extern "C" void func_80807C98(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80807C98:
{
    ...
    r31 = r3;
    r5 = MemoryInline::FlatRead16((r3 + 344));
    r5 = (r5 << 16);
    r5 = (static_cast<int32_t>(r5) >> 16);
    MemoryInline::FlatWriteRam32((r1 + 56), r0);
    r0 = (r5 ^ -2147483648);
    f0.d = MemoryInline::FlatReadFloat32((r3 + 356));
    ...
    f3 = ctx->fpr[3];
    f4 = ctx->fpr[4];
    r4 = MemoryInline::FlatRead16((r31 + 344));
    r4 = (r4 << 16);
...
loc_80807D3C:
{
    ...
    MemoryInline::FlatWrite16((r31 + 344), static_cast<uint16_t>(r3));
    if (((cr & 0x80000000u) != 0)) {
        goto loc_80807D70;
    }
}
...
// RECOMP_GUEST_ABI gpr_read=0xE000006E gpr_write=0xE000007B gpr_return=0x00000018 fpr_read=0xFC000018 fpr_write=0xFC003FFF fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80807C98 func_80807C98 preserves=true fpr_mask=0x00000000
