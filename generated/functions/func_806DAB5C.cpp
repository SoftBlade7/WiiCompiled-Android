...
extern "C" void func_806DAB5C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806DAC2C:
{
    r4 = MemoryInline::FlatRead8((r5 + 36));
    r31 = 0;
    r12 = MemoryInline::FlatRead32(r3);
    r0 = PPC_Divwu(static_cast<uint32_t>(r6), static_cast<uint32_t>(r4));
...
loc_806DAC8C:
{
    r5 = MemoryInline::FlatRead32((r29 + 204));
    r30 = 0;
    r4 = MemoryInline::FlatRead32((r29 + 200));
...
// RECOMP_REGISTRATION base 0x806DAB5C func_806DAB5C preserves=true fpr_mask=0x00000000
