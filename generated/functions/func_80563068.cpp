...
extern "C" void func_80563068(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80563090:
{
    r31 = MemoryInline::FlatRead32((r30 + 16));
...
// RECOMP_REGISTRATION base 0x80563068 func_80563068 preserves=true fpr_mask=0x00000000
