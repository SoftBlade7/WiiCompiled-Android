...
extern "C" void func_806B28C8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806B28FC:
{
    MemoryInline::FlatWrite32((r30 + 352), r3);
    r31 = 0x808A0000u;
    r31 = (r31 + -10364);
    r0 = 0;
...
// RECOMP_REGISTRATION base 0x806B28C8 func_806B28C8 preserves=true fpr_mask=0x00000000
