...
extern "C" void func_80516138(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80516138:
{
    ...
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r0), static_cast<uint32_t>(2200));
}
...
// RECOMP_REGISTRATION base 0x80516138 func_80516138 preserves=true fpr_mask=0x00000000
