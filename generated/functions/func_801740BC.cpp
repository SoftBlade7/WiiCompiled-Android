...
extern "C" void func_801740BC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801740BC:
{
    ...
    r4 = 0x80250000u;
    r3 = (r1 + 8);
    f1.d = MemoryInline::FlatReadFloat32((r4 + 10024));
    f2.d = f1.d;
    f3.d = f1.d;
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 40u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f4.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f3.d))))) {
        ...
        MemoryInline::WriteResolvedFloat32(guest_range_0, 44u, (r3 + 44), f3.d);
    }
    ...
    guest_range_2 = MemoryInline::ResolveRangeHost((r1 + 56), 0, 96u, true, false);
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_2, 72u, (r1 + 128));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f30.d = MemoryInline::ReadResolvedFloat64(guest_range_2, 56u, (r1 + 112));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f29.d = MemoryInline::ReadResolvedFloat64(guest_range_2, 40u, (r1 + 96));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f28.d = MemoryInline::ReadResolvedFloat64(guest_range_2, 24u, (r1 + 80));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f27.d = MemoryInline::ReadResolvedFloat64(guest_range_2, 8u, (r1 + 64));
    r31 = MemoryInline::ReadResolved32(guest_range_2, 4u, (r1 + 60));
    r0 = MemoryInline::ReadResolved32(guest_range_2, 92u, (r1 + 148));
    r30 = MemoryInline::ReadResolved32(guest_range_2, 0u, (r1 + 56));
    ctx->lr = r0;
    r1 = (r1 + 144);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_GUEST_ABI gpr_read=0xC000001E gpr_write=0xC00003FB gpr_return=0x00000018 fpr_read=0xF800003E fpr_write=0xF800001F fpr_return=0x00000002 cr_read=0x00 cr_write=0x00 xer_read=0 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x801740BC func_801740BC preserves=false fpr_mask=0xF8000000
