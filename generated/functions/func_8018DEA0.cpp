...
extern "C" void func_8018DEA0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8018DEA0:
{
    MemoryInline::FlatWriteFloat32((r3 + 80), f1.d);
    return;
}
...
// RECOMP_REGISTRATION base 0x8018DEA0 func_8018DEA0 preserves=true fpr_mask=0x00000000
