...
extern "C" void func_8074C3F0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8074C3F0:
{
    ...
    r31 = (r31 + 11472);
    f31.d = f2.d;
    f5.d = MemoryInline::FlatReadFloat32((r4 + -17284));
    f4.d = MemoryInline::FlatReadFloat32((r3 + -17288));
...
// RECOMP_GUEST_ABI gpr_read=0x80000006 gpr_write=0x8000001B gpr_return=0x00000018 fpr_read=0xC000000F fpr_write=0xC000003F fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8074C3F0 func_8074C3F0 preserves=false fpr_mask=0xC0000000
