...
extern "C" void func_80697788(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8069785C:
{
    if ((static_cast<uint32_t>(r0) > static_cast<uint32_t>(18))) {
        goto loc_80697874;
    }
}
...
loc_80697894:
{
    r0 = MemoryInline::FlatRead32((r25 + 292));
    r5 = 0;
    r6 = 0;
}
...
loc_806978E0:
{
    r0 = MemoryInline::FlatRead8((r25 + 176));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
// RECOMP_REGISTRATION base 0x80697788 func_80697788 preserves=true fpr_mask=0x00000000
