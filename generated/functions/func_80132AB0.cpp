...
extern "C" void func_80132AB0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80132AB0:
{
    ...
    MemoryInline::FlatWriteRam32((r4 + 24216), r5);
    r4 = 0x80130000u;
    r5 = MemoryInline::FlatRead32((r3 + 16));
    r3 = (r4 + 14544);
    MemoryInline::FlatWriteRam32((r31 + 8), r5);
    MemoryInline::FlatWriteRam32((r31 + 12), r5);
    MemoryInline::FlatWriteRam8((r31 + 112), static_cast<uint8_t>(r0));
...
loc_80132B88:
{
    ...
    r3 = 0;
    r0 = 516;
    MemoryInline::FlatWriteRam8((r30 + 14), static_cast<uint8_t>(r3));
    r3 = r30;
...
// RECOMP_REGISTRATION base 0x80132AB0 func_80132AB0 preserves=true fpr_mask=0x00000000
