...
extern "C" void func_8062BE24(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8062BE24:
{
    ...
    r3 = (r28 + 788);
    MemoryInline::FlatWrite32((r22 + 596), r0);
    MemoryInline::FlatWrite32((r22 + 600), r31);
    ...
    MemoryInline::WriteResolved32(guest_range_2, 984u, (r28 + 984), r0);
    r8 = (r29 + 3376);
    r7 = 0x808C0000u;
    r5 = 0x808C0000u;
    ...
    r4 = (r4 + -23344);
    r3 = (r28 + 1072);
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 996u, ((static_cast<uint64_t>(static_cast<uint32_t>(r31)) << 32) | static_cast<uint32_t>(r12)))) {
        MemoryInline::WriteResolved32(guest_range_2, 996u, (r28 + 996), r31);
    ...
    r11 = MemoryInline::FlatRead32((r29 + 3376));
    ...
    r8 = MemoryInline::FlatRead32((r29 + 3388));
    ...
    r9 = 0x808C0000u;
    r7 = 0x808C0000u;
    guest_range_4 = MemoryInline::ResolveRangeHost((r29 + 3400), 0, 60u, true, false);
    r22 = MemoryInline::ReadResolved32(guest_range_4, 0u, (r29 + 3400));
    r9 = (r9 + -12300);
    r23 = MemoryInline::ReadResolved32(guest_range_4, 4u, (r3 + 4));
    r8 = (r29 + 3412);
    r24 = MemoryInline::ReadResolved32(guest_range_4, 8u, (r3 + 8));
    r6 = (r29 + 3424);
    MemoryInline::WriteResolved32(guest_range_1, 20u, (r28 + 1640), r24);
    r5 = (r29 + 3436);
    r7 = (r7 + -12312);
    r4 = (r29 + 3448);
    MemoryInline::WriteResolved32(guest_range_1, 4u, (r28 + 1624), r9);
    r3 = (r28 + 1732);
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 8u, ((static_cast<uint64_t>(static_cast<uint32_t>(r28)) << 32) | static_cast<uint32_t>(r22)))) {
        MemoryInline::WriteResolved32(guest_range_1, 8u, (r28 + 1628), r28);
        MemoryInline::WriteResolved32(guest_range_1, 12u, (r28 + 1632), r22);
    }
    MemoryInline::WriteResolved32(guest_range_1, 16u, (r28 + 1636), r23);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r25 = MemoryInline::ReadResolved32(guest_range_4, 12u, (r29 + 3412));
            r26 = MemoryInline::ReadResolved32(guest_range_4, 16u, (r8 + 4));
        }
    }
    r27 = MemoryInline::ReadResolved32(guest_range_4, 20u, (r8 + 8));
    MemoryInline::WriteResolved32(guest_range_1, 40u, (r28 + 1660), r27);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 32u, ((static_cast<uint64_t>(static_cast<uint32_t>(r25)) << 32) | static_cast<uint32_t>(r26)))) {
        MemoryInline::WriteResolved32(guest_range_1, 32u, (r28 + 1652), r25);
        MemoryInline::WriteResolved32(guest_range_1, 36u, (r28 + 1656), r26);
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r31 = MemoryInline::ReadResolved32(guest_range_4, 24u, (r29 + 3424));
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 52u, ((static_cast<uint64_t>(static_cast<uint32_t>(r31)) << 32) | static_cast<uint32_t>(r12)))) {
        MemoryInline::WriteResolved32(guest_range_1, 52u, (r28 + 1672), r31);
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r10 = MemoryInline::ReadResolved32(guest_range_4, 36u, (r29 + 3436));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_4, 48u, (r29 + 3448));
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_5, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r31)) << 32) | static_cast<uint32_t>(r12)))) {
        MemoryInline::WriteResolved32(guest_range_5, 24u, (r1 + 56), r31);
    ...
    ctx->gpr[31] = r31;
    ctx->fpr[0] = f0;
    InvokeDirectCpu<0x805F39BCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8062BE24 func_8062BE24 preserves=true fpr_mask=0x00000000
