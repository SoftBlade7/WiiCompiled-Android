...
extern "C" void func_80105D78(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80105E3C:
{
    ...
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r31 + 12));
    MemoryInline::FlatWrite32((r3 + 56), r30);
}
...
loc_80105E58:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r31 + 28), r30);
...
// RECOMP_REGISTRATION base 0x80105D78 func_80105D78 preserves=true fpr_mask=0x00000000
