...
extern "C" void func_8009F520(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8009F520:
{
    ...
    r28 = r3;
    r3 = MemoryInline::FlatRead8((r6 + 24));
...
// RECOMP_REGISTRATION base 0x8009F520 func_8009F520 preserves=true fpr_mask=0x00000000
