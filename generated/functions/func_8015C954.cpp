...
extern "C" void func_8015C954(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8015C998:
{
    r19 = MemoryInline::FlatRead32(r26);
    r3 = r19;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r4 = ctx->gpr[4];
    cr = ctx->cr;
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r3), static_cast<uint32_t>(260));
}
...
loc_8015CA70:
{
    ...
    xer = ctx->xer;
    r30_addr_4 = (r30 + r29);
    MemoryInline::FlatWrite8(r30_addr_4, static_cast<uint8_t>(r31));
    r3 = (r1 + 268);
    r4 = (r1 + 8);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8015CAF4:
{
    MemoryInline::FlatWrite32(r15, r22);
    r3 = 1;
    MemoryInline::FlatWrite32(r14, r21);
}
...
// RECOMP_REGISTRATION base 0x8015C954 func_8015C954 preserves=true fpr_mask=0x00000000
