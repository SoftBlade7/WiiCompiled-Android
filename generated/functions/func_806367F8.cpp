...
extern "C" void func_806367F8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80636954:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead8((r29 + 572));
...
// RECOMP_REGISTRATION base 0x806367F8 func_806367F8 preserves=true fpr_mask=0x00000000
