...
extern "C" void func_8079F8B4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r4 = 0x809C0000u;
    MemoryInline::FlatWriteRam32((r4 + 13864), r3);
...
// RECOMP_REGISTRATION base 0x8079F8B4 func_8079F8B4 preserves=true fpr_mask=0x00000000
