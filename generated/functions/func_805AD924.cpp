...
extern "C" void func_805AD924(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805AD9D8:
{
    ...
    MemoryInline::FlatWrite8((r30 + 81), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x805AD924 func_805AD924 preserves=true fpr_mask=0x00000000
