...
extern "C" void func_807F9770(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807F9770:
{
    ...
    r3 = 0x808D0000u;
    r4 = 0x808B0000u;
    f2.d = MemoryInline::FlatReadFloat32((r3 + 16752));
    r3 = (r1 + 8);
    f0.d = MemoryInline::FlatReadFloat32((r4 + -21712));
    r4 = (r1 + 20);
...
// RECOMP_REGISTRATION base 0x807F9770 func_807F9770 preserves=false fpr_mask=0x80000000
