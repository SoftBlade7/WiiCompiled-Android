...
extern "C" void func_807E3EFC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807E3F28:
{
    ...
    MemoryInline::FlatWrite16((r3 + 22), static_cast<uint16_t>(r31));
    ...
    MemoryInline::FlatWrite16((r3 + 30), static_cast<uint16_t>(r31));
    ...
    MemoryInline::FlatWriteRam8((r1 + 47), static_cast<uint8_t>(r31));
...
loc_807E3FAC:
{
    ...
    r31_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r30), static_cast<uint32_t>(1));
    r31 = (r31_rot_1 & -2);
...
// RECOMP_REGISTRATION base 0x807E3EFC func_807E3EFC preserves=true fpr_mask=0x00000000
