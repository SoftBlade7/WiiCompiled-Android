...
extern "C" void func_80665A2C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80665A2C:
{
    ...
    r4 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r4 + -23872));
    r4 = 122;
...
// RECOMP_REGISTRATION base 0x80665A2C func_80665A2C preserves=true fpr_mask=0x00000000
