...
extern "C" void func_806BC3F0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806BC440:
{
    r29 = 0x808A0000u;
    r0 = 0;
    f0.d = MemoryInline::FlatReadFloat32((r29 + -3288));
    ...
    r5 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r29 + -3288));
    r4 = 5;
...
// RECOMP_REGISTRATION base 0x806BC3F0 func_806BC3F0 preserves=true fpr_mask=0x00000000
