...
extern "C" void func_805E86F4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805E86F4:
{
    ...
    r25 = MemoryInline::FlatRead32((r3 + 1000));
...
loc_805E873C:
{
    r26 = MemoryInline::FlatRead32((r26 + 944));
}
...
loc_805E875C:
{
    ...
    r28 = 0;
    r5 = 0x805F0000u;
    MemoryInline::FlatWriteRam32((r26 + 32), r28);
    r3 = (r26 + 40);
    r4 = (r4 + 16160);
    r5 = (r5 + -23720);
    MemoryInline::FlatWriteRam16((r26 + 36), static_cast<uint16_t>(r28));
    r6 = 140;
    r7 = 6;
    ctx->lr = 0x805E8798u;
    ctx->gpr[0] = r0;
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r26 + 944), r28);
}
...
loc_inl0_cont_8051BED0:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r26 + 32), r3);
    r0 = 0;
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(0));
}
...
loc_805E8804:
{
    MemoryInline::FlatWriteRam16((r26 + 36), static_cast<uint16_t>(r0));
    if (((cr & 0x20000000u) != 0)) {
        goto loc_805E8810;
    }
}
...
loc_805E8844:
{
    r5 = MemoryInline::FlatRead32((r29 + 7160));
    r3 = r24;
    r28_addr_2 = (r28 + r30);
...
loc_805E8878:
{
    ...
    MemoryInline::FlatWriteRam32((r26 + 944), r0);
...
// RECOMP_REGISTRATION base 0x805E86F4 func_805E86F4 preserves=true fpr_mask=0x00000000
