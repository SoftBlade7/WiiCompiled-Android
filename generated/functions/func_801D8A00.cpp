...
extern "C" void func_801D8A00(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801D8A78:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801D4070u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801D8AC0:
{
    ...
    r4 = r29;
    MemoryInline::FlatWriteRam32(r29, r31);
    MemoryInline::FlatWriteRam32((r29 + 28), r26);
    MemoryInline::FlatWriteRam32((r29 + 36), r31);
    MemoryInline::FlatWriteRam32((r29 + 40), r31);
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801D9994u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r3 = r29;
    r4 = 0;
    MemoryInline::FlatWriteRam32((r29 + 8), r31);
...
loc_inl4_0x801D9F28:
{
    MemoryInline::FlatWriteRam32((r3 + 44), r4);
    goto loc_inl4_cont_801D9F20;
}
...
loc_inl4_cont_801D9F20:
{
    // end of inlined leaf 0x801D9F20
    MemoryInline::FlatWriteRam32((r29 + 48), r31);
    r5 = (r29 + 65536);
    r3 = (r29 + 64);
    r4 = (r30 + -32768);
    MemoryInline::FlatWriteRam32((r5 + -32704), r31);
    MemoryInline::FlatWriteRam32((r5 + -32700), r31);
    ctx->lr = 0x801D8B2Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x801D8A00 func_801D8A00 preserves=true fpr_mask=0x00000000
