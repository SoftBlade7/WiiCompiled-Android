...
extern "C" void func_801ABEE0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_ca_0 = 0;
    uint32_t r3_ca_1 = 0;
...
loc_801ABEE8:
{
    ...
    r8_subfc_sub_0 = r8;
    r8 = (r4 - r8_subfc_sub_0);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(r4) >= static_cast<uint32_t>(r8_subfc_sub_0) ? 1u : 0u) << 29);
    r7_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(30));
    r7 = (r7_rot_0 & 1073741823);
    r6 = 0;
    r3_subfe_rb_0 = r3;
    r3_not_0 = ~(r9);
    r3_ca_0 = (xer >> 29) & 1u;
...
// RECOMP_REGISTRATION base 0x801ABEE0 func_801ABEE0 preserves=true fpr_mask=0x00000000
