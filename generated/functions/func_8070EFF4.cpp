...
extern "C" void func_8070EFF4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8070EFF4:
{
    ...
    r3 = 0x809C0000u;
    r0 = MemoryInline::FlatRead32((r3 + 10220));
...
loc_8070F060:
{
    r12 = MemoryInline::FlatRead32((r27 + 8));
    r3 = r27;
...
loc_8070F078:
{
    f0.d = MemoryInline::FlatReadFloat32((r30 + 7540));
...
{
    r3 = 0x809C0000u;
    MemoryInline::FlatWriteRam32((r3 + 10220), r29);
}
...
// RECOMP_REGISTRATION base 0x8070EFF4 func_8070EFF4 preserves=false fpr_mask=0x80000000
