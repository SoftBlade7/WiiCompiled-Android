...
extern "C" void func_805C0888(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805C0888:
{
    ...
    MemoryInline::FlatWrite32((r3 + 5036), r4);
...
// RECOMP_REGISTRATION base 0x805C0888 func_805C0888 preserves=true fpr_mask=0x00000000
