...
extern "C" void func_80091BC0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80091BC0:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead8((r30 + 140));
...
loc_80091D10:
{
    ...
    r3 = r30;
    r4 = r29;
    // inline leaf 0x8008F490 (2 guest instruction(s))
    MemoryInline::FlatWrite32((r3 + 24), r4);
    // end of inlined leaf 0x8008F490
    ctx->lr = 0x80091D38u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80091BC0 func_80091BC0 preserves=true fpr_mask=0x00000000
