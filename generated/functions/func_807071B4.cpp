...
extern "C" void func_807071B4(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r3 = (r3 + -136);
    // inline leaf 0x807053C8 (7 guest instruction(s))
    ...
    // end of inlined leaf 0x807053C8
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
...
// RECOMP_REGISTRATION base 0x807071B4 func_807071B4 preserves=true fpr_mask=0x00000000
