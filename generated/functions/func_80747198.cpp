...
extern "C" void func_80747198(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80747198:
{
    ...
    r4 = 0x808A0000u;
    r3 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r4 + 11280));
    r5 = (r5 + -18488);
    f0.d = MemoryInline::FlatReadFloat32((r3 + 11284));
    r0 = 0;
    MemoryInline::FlatWrite32(r31, r5);
    r4 = (r5 + 236);
    r3 = r31;
    MemoryInline::FlatWrite32((r31 + 228), r4);
    MemoryInline::FlatWrite32((r31 + 232), r0);
    MemoryInline::FlatWrite32((r31 + 236), r0);
    MemoryInline::FlatWriteFloat32((r31 + 360), f1.d);
...
// RECOMP_REGISTRATION base 0x80747198 func_80747198 preserves=true fpr_mask=0x00000000
