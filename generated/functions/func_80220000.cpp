...
extern "C" void func_80220000(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8021FF0C:
{
    ...
    InvokeDirectCpu<0x8021FF0Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
...
// RECOMP_REGISTRATION base 0x80220000 func_80220000 preserves=false fpr_mask=0xF8000000
