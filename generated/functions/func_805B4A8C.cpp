...
extern "C" void func_805B4A8C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805B4A8C:
{
    ...
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
    InvokeDirectCpu<0x805B46E8u>(ctx);
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
...
// RECOMP_REGISTRATION base 0x805B4A8C func_805B4A8C preserves=true fpr_mask=0x00000000
