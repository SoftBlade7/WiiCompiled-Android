...
extern "C" void func_806B4108(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806B4108:
{
    ...
    r29 = MemoryInline::ReadResolved32(guest_range_0, 12u, (r3 + 12));
    r6 = (r7 + 16640);
    r11 = MemoryInline::ReadResolved32(guest_range_0, 28u, (r3 + 28));
    r0 = MemoryInline::ReadResolved32(guest_range_0, 44u, (r3 + 44));
    r25 = r5;
    r26 = MemoryInline::ReadResolved32(guest_range_0, 0u, r3);
    r5 = r4;
    r27 = MemoryInline::ReadResolved32(guest_range_0, 4u, (r3 + 4));
    r4 = (r1 + 24);
    r28 = MemoryInline::ReadResolved32(guest_range_0, 8u, (r3 + 8));
    {
        ...
        if (resolved_pair.valid) {
            ...
            r30 = MemoryInline::ReadResolved32(guest_range_0, 16u, (r3 + 16));
            r31 = MemoryInline::ReadResolved32(guest_range_0, 20u, (r3 + 20));
        }
    }
    r12 = MemoryInline::ReadResolved32(guest_range_0, 24u, (r3 + 24));
    {
    ...
    MemoryInline::WriteResolved32(guest_range_1, 64u, (r1 + 64), r8);
...
// RECOMP_GUEST_ABI gpr_read=0xFE00003A gpr_write=0xFE001FFB gpr_return=0x00000018 fpr_read=0x00001040 fpr_write=0x00001F7F fpr_return=0x00000002 cr_read=0x00 cr_write=0x00 xer_read=0 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x806B4108 func_806B4108 preserves=true fpr_mask=0x00000000
