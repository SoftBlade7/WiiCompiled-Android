...
extern "C" void func_8082B3A0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_8082B3A0:
{
    ...
    // inline leaf 0x806C4ED4 (7 guest instruction(s))
    ...
    // end of inlined leaf 0x806C4ED4
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
...
// RECOMP_REGISTRATION base 0x8082B3A0 func_8082B3A0 preserves=true fpr_mask=0x00000000
