...
extern "C" void func_801D6EF4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801D6EF4:
{
    ...
    r28 = (r28 + 864);
    r25 = MemoryInline::FlatRead32((r29 + 52));
    goto loc_801D6FD4;
}
...
loc_801D6F58:
{
    ...
    ctx->gpr[4] = r4;
    ctx->cr = cr;
    InvokeDirectCpu<0x801D55CCu>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    cr = ctx->cr;
...
loc_801D6F7C:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801D6024u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801D6FDC:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801D5914u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801D7090:
{
    ...
    ctx->gpr[5] = r5;
    ctx->cr = cr;
    InvokeDirectCpu<0x801D56B0u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
...
loc_801D70BC:
{
    ...
    r3_addr_3 = (r3 + r25);
    r4 = MemoryInline::FlatRead8(r3_addr_3);
...
loc_801D70F4:
{
    ...
    r3 = r30;
    r7 = MemoryInline::FlatRead32((r31 + 2000));
    r4 = r29;
    r5 = r28;
    r8 = (r27 + 804);
    r9 = 2;
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801D6128u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801D7190:
{
    r26 = MemoryInline::FlatRead32((r26 + 4));
}
...
// RECOMP_REGISTRATION base 0x801D6EF4 func_801D6EF4 preserves=true fpr_mask=0x00000000
