...
extern "C" void func_8004F550(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8004F584:
{
    ...
    r3 = (r1 + 24);
    r4 = MemoryInline::FlatRead16((r4 + 72));
    r4 = (r4 << 16);
    ...
    ctx->gpr[4] = r4;
    ctx->cr = cr;
    InvokeDirectCpu<0x8004E490u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    cr = ctx->cr;
    ...
    r28 = MemoryInline::FlatRead8((r1 + 8));
    r3 = (r3 + 24);
...
loc_8004F678:
{
    ...
    r0 = (r0_rot_2 & 255);
    r8 = 8;
    guest_range_2 = MemoryInline::ResolveRangeHost(r3, 0, 12u, false, true);
    MemoryInline::WriteResolved8(guest_range_2, 0u, r3, static_cast<uint8_t>(r8));
    ...
    MemoryInline::WriteResolved8(guest_range_2, 5u, (r3 + 5), static_cast<uint8_t>(r5));
    // end of inlined leaf 0x8004BDC0
    r5 = r28;
    r3 = (r30 + 6);
    r4 = 177;
    ...
    r0 = (r0_rot_3 & 255);
    r8 = 8;
    MemoryInline::WriteResolved8(guest_range_2, 6u, r3, static_cast<uint8_t>(r8));
    MemoryInline::WriteResolved8(guest_range_2, 7u, (r3 + 1), static_cast<uint8_t>(r4));
    MemoryInline::WriteResolved8(guest_range_2, 8u, (r3 + 2), static_cast<uint8_t>(r7));
    MemoryInline::WriteResolved8(guest_range_2, 9u, (r3 + 3), static_cast<uint8_t>(r6));
    MemoryInline::WriteResolved8(guest_range_2, 10u, (r3 + 4), static_cast<uint8_t>(r0));
    MemoryInline::WriteResolved8(guest_range_2, 11u, (r3 + 5), static_cast<uint8_t>(r5));
    // end of inlined leaf 0x8004BDC0
}
...
loc_8004F750:
{
    ...
    r0 = (r0_rot_6 & 255);
    r8 = 8;
    guest_range_3 = MemoryInline::ResolveRangeHost(r3, 0, 12u, false, true);
    MemoryInline::WriteResolved8(guest_range_3, 0u, r3, static_cast<uint8_t>(r8));
    MemoryInline::WriteResolved8(guest_range_3, 1u, (r3 + 1), static_cast<uint8_t>(r4));
    MemoryInline::WriteResolved8(guest_range_3, 2u, (r3 + 2), static_cast<uint8_t>(r7));
    MemoryInline::WriteResolved8(guest_range_3, 3u, (r3 + 3), static_cast<uint8_t>(r6));
    MemoryInline::WriteResolved8(guest_range_3, 4u, (r3 + 4), static_cast<uint8_t>(r0));
    MemoryInline::WriteResolved8(guest_range_3, 5u, (r3 + 5), static_cast<uint8_t>(r5));
    // end of inlined leaf 0x8004BDC0
    r0 = (r28 + 176);
    r5 = r27;
    r3 = (r26 + 6);
    r4 = (r0 & 255);
    // inline leaf 0x8004BDC0 (11 guest instruction(s))
    r7_rot_7 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(8));
    r7 = (r7_rot_7 & 255);
    r6_rot_7 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(16));
    r6 = (r6_rot_7 & 255);
    r0_rot_7 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(24));
    r0 = (r0_rot_7 & 255);
    r8 = 8;
    MemoryInline::WriteResolved8(guest_range_3, 6u, r3, static_cast<uint8_t>(r8));
    MemoryInline::WriteResolved8(guest_range_3, 7u, (r3 + 1), static_cast<uint8_t>(r4));
    MemoryInline::WriteResolved8(guest_range_3, 8u, (r3 + 2), static_cast<uint8_t>(r7));
    MemoryInline::WriteResolved8(guest_range_3, 9u, (r3 + 3), static_cast<uint8_t>(r6));
    MemoryInline::WriteResolved8(guest_range_3, 10u, (r3 + 4), static_cast<uint8_t>(r0));
    MemoryInline::WriteResolved8(guest_range_3, 11u, (r3 + 5), static_cast<uint8_t>(r5));
    // end of inlined leaf 0x8004BDC0
}
...
loc_8004F83C:
{
    ...
    r5 = (r5 + -2147483648);
    // inline leaf 0x8004BDC0 (11 guest instruction(s))
    r7_rot_10 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(8));
    r7 = (r7_rot_10 & 255);
    r6_rot_10 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(16));
    r6 = (r6_rot_10 & 255);
    r0_rot_10 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(24));
    r0 = (r0_rot_10 & 255);
    r8 = 8;
    guest_range_4 = MemoryInline::ResolveRangeHost(r3, 0, 12u, false, true);
    MemoryInline::WriteResolved8(guest_range_4, 0u, r3, static_cast<uint8_t>(r8));
    MemoryInline::WriteResolved8(guest_range_4, 1u, (r3 + 1), static_cast<uint8_t>(r4));
    MemoryInline::WriteResolved8(guest_range_4, 2u, (r3 + 2), static_cast<uint8_t>(r7));
    MemoryInline::WriteResolved8(guest_range_4, 3u, (r3 + 3), static_cast<uint8_t>(r6));
    MemoryInline::WriteResolved8(guest_range_4, 4u, (r3 + 4), static_cast<uint8_t>(r0));
    MemoryInline::WriteResolved8(guest_range_4, 5u, (r3 + 5), static_cast<uint8_t>(r5));
    // end of inlined leaf 0x8004BDC0
    r0 = (r28 + 176);
    r5 = r26;
    r3 = (r27 + 6);
    r4 = (r0 & 255);
    // inline leaf 0x8004BDC0 (11 guest instruction(s))
    r7_rot_11 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(8));
    r7 = (r7_rot_11 & 255);
    r6_rot_11 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(16));
    r6 = (r6_rot_11 & 255);
    r0_rot_11 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(24));
    r0 = (r0_rot_11 & 255);
    r8 = 8;
    MemoryInline::WriteResolved8(guest_range_4, 6u, r3, static_cast<uint8_t>(r8));
    MemoryInline::WriteResolved8(guest_range_4, 7u, (r3 + 1), static_cast<uint8_t>(r4));
    MemoryInline::WriteResolved8(guest_range_4, 8u, (r3 + 2), static_cast<uint8_t>(r7));
    MemoryInline::WriteResolved8(guest_range_4, 9u, (r3 + 3), static_cast<uint8_t>(r6));
    MemoryInline::WriteResolved8(guest_range_4, 10u, (r3 + 4), static_cast<uint8_t>(r0));
    MemoryInline::WriteResolved8(guest_range_4, 11u, (r3 + 5), static_cast<uint8_t>(r5));
    // end of inlined leaf 0x8004BDC0
}
...
// RECOMP_REGISTRATION base 0x8004F550 func_8004F550 preserves=true fpr_mask=0x00000000
