...
extern "C" void func_8081A85C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8081A85C:
{
    ...
    r5 = 0x808B0000u;
    f1.d = f31.d;
    f2.d = MemoryInline::FlatReadFloat32((r5 + -19160));
    r6 = 0x809C0000u;
    r4 = r3;
    r3 = MemoryInline::FlatRead32((r6 + 12016));
    r6 = r31;
    r5 = 0;
    ctx->lr = 0x8081A8B0u;
    ctx->gpr[0] = r0;
    ...
    ctx->fpr[31] = f31;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80786120u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8081A85C func_8081A85C preserves=false fpr_mask=0x80000000
