...
extern "C" void func_80113814(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80113814:
{
    ...
    r3 = (r3 + 12780);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80112A7Cu>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80113814 func_80113814 preserves=true fpr_mask=0x00000000
