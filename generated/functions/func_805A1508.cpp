...
extern "C" void func_805A1508(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805A1508:
{
    r5 = 0x80890000u;
    r0 = 0;
    f0.d = MemoryInline::FlatReadFloat32((r5 + 8688));
    r5 = 0x808B0000u;
    r5 = (r5 + 27380);
...
// RECOMP_REGISTRATION base 0x805A1508 func_805A1508 preserves=true fpr_mask=0x00000000
