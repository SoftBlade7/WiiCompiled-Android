...
extern "C" void func_800AE740(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800AE740:
{
    ...
    r3 = r31;
    r4 = MemoryInline::FlatRead8((r29 + 248));
    r10 = r30;
    ...
    r8 = MemoryInline::FlatRead32((r29 + 264));
    r9 = 0;
    ctr = r12;
    ctx->lr = 0x800AE7A8u;
    ctx->gpr[0] = r0;
...
loc_800AE7D0:
{
    r30 = MemoryInline::FlatRead32((r29 + 272));
    goto loc_800AE800;
}
...
loc_800AE86C:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead8((r29 + 236));
    r3 = r31;
    MemoryInline::FlatWrite8((r31 + 57), static_cast<uint8_t>(r0));
    r6 = r30;
    r4 = (r1 + 32);
    r5 = -1;
    ctx->lr = 0x800AE8C0u;
    ...
    xer = ctx->xer;
    r0 = 1;
    MemoryInline::FlatWrite32((r29 + 304), r31);
    MemoryInline::FlatWrite8((r29 + 235), static_cast<uint8_t>(r0));
    ctx->lr = 0x800AE8D0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x800AE740 func_800AE740 preserves=true fpr_mask=0x00000000
