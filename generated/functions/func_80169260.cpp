...
extern "C" void func_80169260(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r5_rot_0 = 0;
...
loc_801692D4:
{
    r29 = MemoryInline::FlatRead32((r31 + 44));
    r0 = (r3 + -1);
    {
...
// RECOMP_REGISTRATION base 0x80169260 func_80169260 preserves=true fpr_mask=0x00000000
