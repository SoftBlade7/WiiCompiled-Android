...
extern "C" void func_80136690(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_801366EC:
{
    if ((static_cast<uint32_t>(r6) == static_cast<uint32_t>(14))) {
        goto loc_801366FC;
    }
}
...
loc_80136750:
{
    ...
    ctx->gpr[9] = r9;
    ctx->cr = cr;
    InvokeDirectCpu<0x801D09B4u>(ctx);
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    cr = ctx->cr;
    r4 = MemoryInline::FlatRead8((r31 + 21));
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80131F58u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r0 = 0;
    r4 = (r4 + 24648);
    r3 = MemoryInline::FlatRead8((r4 + 557));
    r3 = (r3 + -1);
    MemoryInline::FlatWriteRam8((r4 + 557), static_cast<uint8_t>(r3));
...
loc_801367D4:
{
    ...
    r0 = MemoryInline::FlatRead8((r3 + 557));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_801367F8:
{
    r0 = MemoryInline::FlatRead8((r3 + 558));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
// RECOMP_REGISTRATION base 0x80136690 func_80136690 preserves=true fpr_mask=0x00000000
