...
extern "C" void func_8070CA64(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
{
    r3 = (r3 + -148);
    // inline leaf 0x80707514 (8 guest instruction(s))
    r4 = 0x809C0000u;
    ...
    // end of inlined leaf 0x80707514
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
...
// RECOMP_REGISTRATION base 0x8070CA64 func_8070CA64 preserves=true fpr_mask=0x00000000
