...
extern "C" void func_800D7094(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800D7094:
{
    ...
    r0 = 0;
    MemoryInline::FlatWrite32((r29 + 2184), r0);
    MemoryInline::FlatWrite8((r29 + 2198), static_cast<uint8_t>(r0));
    MemoryInline::FlatWrite8((r29 + 2199), static_cast<uint8_t>(r0));
...
loc_800D7284:
{
    r6 = MemoryInline::FlatRead32((r13 + -26868));
    r4 = 0;
    r3 = MemoryInline::FlatRead32((r29 + 1912));
...
loc_800D72D4:
{
    r4 = MemoryInline::FlatRead32((r29 + 2184));
    r3 = 1;
...
loc_800D74A0:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800E6974u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r29), static_cast<int32_t>(9));
}
...
loc_800D75B0:
{
    ...
    r6 = 0x80000000u;
    r4_subfc_min_3 = r4;
    r4 = (r4_subfc_min_3 - r27);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(r4_subfc_min_3) >= static_cast<uint32_t>(r27) ? 1u : 0u) << 29);
    MemoryInline::FlatWrite32((r13 + -26864), r3);
    r7 = (r28 + 19923);
    r3_subfe_rb_3 = r3;
    r3_not_3 = ~(r26);
...
loc_800D7FF4:
{
    ...
    r4_subfc_min_6 = r4;
    r4 = (r4_subfc_min_6 - r8);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(r4_subfc_min_6) >= static_cast<uint32_t>(r8) ? 1u : 0u) << 29);
...
loc_800D82A4:
{
    ...
    r6 = (static_cast<int32_t>(r6) >> 6);
    r0_rot_18 = PpcRotl32Inline(static_cast<uint32_t>(r6), static_cast<uint32_t>(1));
    r0 = (r0_rot_18 & 1);
    r3 = 1;
    r6 = (r6 + r0);
    r7 = (r4 - r6);
...
loc_800D83B8:
{
    ...
    if (MkwStateFreeAbiEnabled(0x8011E43Cu) && KnownTranslatedCpuCall<0x8011E43Cu>::kAvailable && !KnownTranslatedCpuCall<0x8011E43Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x8011E43Cu>()) {
        const auto state_free_result_8011E43C_16E6E = func_8011E43C_statefree_v0(r3, xer);
        r0 = static_cast<uint32_t>(state_free_result_8011E43C_16E6E[0]);
        r3 = static_cast<uint32_t>(state_free_result_8011E43C_16E6E[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_inl2_cont_800CCC68:
{
    ...
    r4 = PPC_CntlzwInline(static_cast<uint32_t>(r0));
    r0 = PPC_CntlzwInline(static_cast<uint32_t>(r3));
    r26_rot_4 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(27));
    r26 = (r26_rot_4 & 134217727);
    r27_rot_4 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(27));
    r27 = (r27_rot_4 & 134217727);
    ctx->lr = 0x800D8504u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_800D8614:
{
    ...
    r4_subfc_min_11 = r4;
    r4 = (r4_subfc_min_11 - r8);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(r4_subfc_min_11) >= static_cast<uint32_t>(r8) ? 1u : 0u) << 29);
    r0 = (static_cast<uint32_t>((static_cast<uint64_t>(r6) * static_cast<uint64_t>(r0)) >> 32));
    r5 = 0;
    r3_subfe_rb_11 = r3;
    r3_not_11 = ~(r7);
    ...
    r6_rot_11 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(26));
    r6 = (r6_rot_11 & 67108863);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
// RECOMP_REGISTRATION base 0x800D7094 func_800D7094 preserves=true fpr_mask=0x00000000
