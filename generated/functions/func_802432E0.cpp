...
extern "C" void func_802432E0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80243318:
{
    r7 = MemoryInline::FlatRead32((r13 + -23904));
}
...
loc_8024331C:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r7 = MemoryInline::FlatRead32((r29 + 56));
    r4 = 0x80240000u;
...
// RECOMP_REGISTRATION base 0x802432E0 func_802432E0 preserves=true fpr_mask=0x00000000
