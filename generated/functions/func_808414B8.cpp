...
extern "C" void func_808414B8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_808414E0:
{
    r3 = MemoryInline::FlatRead32((r3 + 9176));
...
loc_808415A8:
{
    ...
    cr = ctx->cr;
    ctr = ctx->ctr;
    r3 = MemoryInline::FlatRead32((r31 + 9176));
}
...
// RECOMP_REGISTRATION base 0x808414B8 func_808414B8 preserves=true fpr_mask=0x00000000
