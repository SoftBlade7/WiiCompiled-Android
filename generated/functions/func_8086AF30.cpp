...
extern "C" void func_8086AF30(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8086AF30:
{
    ...
    f28.d = MemoryInline::FlatReadFloat32((r29 + 32));
...
loc_8086B00C:
{
    ...
    f29.d = MemoryInline::FlatReadFloat32(r29);
    ...
    f28.d = MemoryInline::FlatReadFloat32((r29 + 44));
    goto loc_8086B13C;
}
...
loc_8086B04C:
{
    ...
    f1.d = f30.d;
    r3 = MemoryInline::FlatRead32((r31 + 12100));
    r5 = r22;
    r6 = r24;
    r7 = r25;
    r8 = r26;
...
loc_8086B0DC:
{
    ...
    f2.d = MemoryInline::FlatReadFloat32((r22 + 4));
    f0.d = static_cast<double>(PpcForceSingleValueInline(f1.d + f0.d));
...
loc_8086B114:
{
    ...
    f1.d = PpcFmulsInline(f1.d, f28.d);
...
loc_8086B13C:
{
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r28), static_cast<uint32_t>(1000));
}
...
// RECOMP_REGISTRATION base 0x8086AF30 func_8086AF30 preserves=false fpr_mask=0xF0000000
