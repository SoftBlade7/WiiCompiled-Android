...
extern "C" void func_8075FB50(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8075FB8C:
{
    ...
    r0 = (r4 | 2);
    r4 = 1;
    f31.d = MemoryInline::FlatReadFloat32((r3 + 252));
...
// RECOMP_REGISTRATION base 0x8075FB50 func_8075FB50 preserves=false fpr_mask=0xC0000000
