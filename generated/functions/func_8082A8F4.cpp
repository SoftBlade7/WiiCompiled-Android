...
extern "C" void func_8082A8F4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8082A8F4:
{
    ...
    r30 = r27;
    f27.d = MemoryInline::FlatReadFloat32((r4 + 40));
    r28 = 0;
    f28.d = MemoryInline::FlatReadFloat32((r4 + 44));
    r31 = 0x802A0000u;
    f30.d = MemoryInline::FlatReadFloat32((r4 + 48));
    f31.d = MemoryInline::FlatReadFloat32((r4 + 52));
}
...
loc_8082A974:
{
    MemoryInline::FlatWriteFloat32((r30 + 292), f29.d);
}
...
loc_8082AA38:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8081B618u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8082AA54:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80869B2Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8082AA68:
{
    // inline leaf 0x80881990 (1 guest instruction(s))
    // end of inlined leaf 0x80881990
}

loc_8082AA6C:
{
    r3 = 0x809C0000u;
    r3 = MemoryInline::FlatRead32((r3 + 19576));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(0));
}
...
loc_8082AA7C:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8088C5A0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8082A8F4 func_8082A8F4 preserves=false fpr_mask=0xF8000000
