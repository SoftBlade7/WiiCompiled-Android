...
extern "C" void func_80068940(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80068990:
{
    ...
    r3 = r24;
    r4 = MemoryInline::FlatRead8((r25 + 6));
    ...
    r21 = r3;
    r4 = MemoryInline::FlatRead8((r25 + 4));
    r3 = r24;
...
loc_800689C8:
{
    r0 = MemoryInline::FlatRead32((r21 + 20));
...
loc_800689E0:
{
    r0 = MemoryInline::FlatRead32((r22 + 52));
    r0 = (r0 & 2);
...
loc_80068A04:
{
    ...
    r27 = r3;
    r23 = r26;
    MemoryInline::FlatWriteRam32((r1 + 12), r21);
...
loc_80068A20:
{
    MemoryInline::FlatWriteRam32((r1 + 20), r22);
    r3 = r29;
    r4 = r30;
    r5 = r31;
...
// RECOMP_REGISTRATION base 0x80068940 func_80068940 preserves=true fpr_mask=0x00000000
