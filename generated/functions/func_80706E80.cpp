...
extern "C" void func_80706E80(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80706E80:
{
    ...
    r29 = r3;
    r3 = MemoryInline::FlatRead32((r6 + 28056));
...
// RECOMP_REGISTRATION base 0x80706E80 func_80706E80 preserves=true fpr_mask=0x00000000
