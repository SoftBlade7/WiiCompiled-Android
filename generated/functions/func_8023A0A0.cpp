...
extern "C" void func_8023A0A0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8023A0A0:
{
    ...
    MemoryInline::FlatWriteFloat32((r30 + 12), f31.d);
...
// RECOMP_GUEST_ABI gpr_read=0xC000001E gpr_write=0xC000001B gpr_return=0x00000018 fpr_read=0xC000001A fpr_write=0xC000001F fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8023A0A0 func_8023A0A0 preserves=false fpr_mask=0xC0000000
