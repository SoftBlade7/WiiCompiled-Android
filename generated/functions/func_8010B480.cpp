...
extern "C" void func_8010B480(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr1_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8010B480:
{
    ...
    r7 = MemoryInline::FlatRead16((r3 + 102));
}
...
loc_8010B49C:
{
    ...
    r0 = (r7 + 1);
    r25 = r6;
    MemoryInline::FlatWrite16((r3 + 102), static_cast<uint16_t>(r0));
...
loc_8010B4B4:
{
    ...
    SetCRResident(cr, xer, 1, static_cast<int32_t>(r4), static_cast<int32_t>(5));
}
...
loc_8010B844:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8010AE44u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8010B868:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8010B178u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8010BADC:
{
    ...
    r29 = 0;
    r28 = MemoryInline::FlatRead16((r3 + 4));
...
loc_8010BBD8:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r0 = PPC_CntlzwInline(static_cast<uint32_t>(r26));
    r3 = r30;
...
// RECOMP_REGISTRATION base 0x8010B480 func_8010B480 preserves=true fpr_mask=0x00000000
