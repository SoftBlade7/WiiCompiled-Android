...
extern "C" void func_8075102C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8075102C:
{
    ...
    r30 = (r30 + 12848);
    r4 = 0x802A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r5 + -16800));
    r25 = r3;
    ...
    r26 = 0;
    r31 = 0x808D0000u;
    f0.d = MemoryInline::FlatReadFloat32((r25 + 400));
    MemoryInline::FlatWriteRamFloat32((r1 + 36), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r25 + 404));
...
loc_807510C4:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r31 + -16784));
...
{
    r0 = 0;
    MemoryInline::FlatWrite8((r25 + 412), static_cast<uint8_t>(r0));
    r11 = (r1 + 96);
    MemoryInline::FlatWrite32((r25 + 416), r0);
    MemoryInline::FlatWrite32((r25 + 420), r0);
...
// RECOMP_REGISTRATION base 0x8075102C func_8075102C preserves=true fpr_mask=0x00000000
