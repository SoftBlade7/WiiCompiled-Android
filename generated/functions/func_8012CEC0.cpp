...
extern "C" void func_8012CEC0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8012CFDC:
{
    f1.d = MemoryInline::FlatReadFloat32((r2 + -27040));
    r0 = 0;
...
loc_8012D07C:
{
    ...
    ctx->fpr[1] = f1;
    ctx->cr = cr;
    InvokeDirectCpu<0x8012D6BCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8012CEC0 func_8012CEC0 preserves=true fpr_mask=0x00000000
