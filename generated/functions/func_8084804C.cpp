...
extern "C" void func_8084804C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8084810C:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r3 + -9840));
...
// RECOMP_REGISTRATION base 0x8084804C func_8084804C preserves=true fpr_mask=0x00000000
