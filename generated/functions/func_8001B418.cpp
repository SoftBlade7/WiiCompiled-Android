...
extern "C" void func_8001B418(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr1_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_8001B458:
{
    f2.d = MemoryInline::FlatReadFloat64((r2 + -31296));
    f0.d = MemoryInline::FlatReadFloat64((r2 + -31288));
    f1.d = (f2.d + f1.d);
...
// RECOMP_REGISTRATION base 0x8001B418 func_8001B418 preserves=true fpr_mask=0x00000000
