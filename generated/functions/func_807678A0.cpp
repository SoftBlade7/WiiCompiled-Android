...
extern "C" void func_807678A0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lhax_807678D4_loc_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_807678A0:
{
    ...
    addr_lhax_807678D4_loc_0 = (r3 + r0);
    r0 = MemoryInline::FlatRead16(addr_lhax_807678D4_loc_0);
    r0 = (r0 << 16);
...
// RECOMP_REGISTRATION base 0x807678A0 func_807678A0 preserves=true fpr_mask=0x00000000
