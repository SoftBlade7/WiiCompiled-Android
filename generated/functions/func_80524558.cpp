...
extern "C" void func_80524558(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80524558:
{
    ...
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80521930u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x80524558 func_80524558 preserves=true fpr_mask=0x00000000
