...
extern "C" void func_8009AEA0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8009AEC8:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r31 = MemoryInline::FlatRead32((r29 + 240));
    goto loc_8009AF14;
}
...
loc_8009AF50:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite8((r29 + 5), static_cast<uint8_t>(r31));
    ctx->lr = 0x8009AF6Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8009AEA0 func_8009AEA0 preserves=true fpr_mask=0x00000000
