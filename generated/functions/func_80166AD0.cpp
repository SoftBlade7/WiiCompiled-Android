...
extern "C" void func_80166AD0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80166AD0:
{
    ...
    r0 = MemoryInline::FlatRead32((r13 + -25792));
    r23 = r3;
    r31 = r4;
    r24 = r5;
...
loc_80166B14:
{
    r3 = MemoryInline::FlatRead32((r13 + -29448));
    ctx->lr = 0x80166B1Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    xer = ctx->xer;
    r0 = 1;
    MemoryInline::FlatWrite32((r13 + -25792), r0);
}
...
// RECOMP_REGISTRATION base 0x80166AD0 func_80166AD0 preserves=true fpr_mask=0x00000000
