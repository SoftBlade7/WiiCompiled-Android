...
extern "C" void func_8067DAF4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8067DB14:
{
    ...
    guest_range_1 = MemoryInline::ResolveRangeHost(r3, 0, 48u, true, false);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r25 = MemoryInline::ReadResolved32(guest_range_1, 0u, r3);
            r24 = MemoryInline::ReadResolved32(guest_range_1, 4u, (r3 + 4));
        }
    }
    {
    ...
    r3 = 0x808A0000u;
    r4 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + -18568));
    r3 = 0x809C0000u;
    r24 = 0;
    r26 = 255;
    f0.d = MemoryInline::FlatReadFloat32((r4 + -18564));
    r25 = 1;
    r27 = MemoryInline::FlatRead32((r1 + 8));
    r4 = (r1 + 56);
    ...
    r12 = MemoryInline::FlatRead32((r1 + 28));
    r11 = MemoryInline::FlatRead32((r1 + 32));
    ...
    MemoryInline::FlatWriteRam8((r1 + 152), static_cast<uint8_t>(r24));
    r3 = MemoryInline::FlatRead32((r3 + 8660));
    MemoryInline::FlatWriteRam32((r1 + 156), r24);
    MemoryInline::FlatWriteRam32((r1 + 160), r24);
    ...
    MemoryInline::FlatWriteRam8((r1 + 210), static_cast<uint8_t>(r26));
    MemoryInline::FlatWriteRam8((r1 + 209), static_cast<uint8_t>(r26));
    MemoryInline::FlatWriteRam8((r1 + 208), static_cast<uint8_t>(r26));
    MemoryInline::FlatWriteRam8((r1 + 211), static_cast<uint8_t>(r26));
    MemoryInline::FlatWriteRam8((r1 + 214), static_cast<uint8_t>(r24));
    MemoryInline::FlatWriteRam8((r1 + 213), static_cast<uint8_t>(r24));
    MemoryInline::FlatWriteRam8((r1 + 212), static_cast<uint8_t>(r24));
    MemoryInline::FlatWriteRam8((r1 + 215), static_cast<uint8_t>(r26));
...
// RECOMP_REGISTRATION base 0x8067DAF4 func_8067DAF4 preserves=true fpr_mask=0x00000000
