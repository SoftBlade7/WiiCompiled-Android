...
extern "C" void func_80829764(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80829764:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r3 + -14532));
    r0 = -1;
    ...
    r3 = (r3 + -1);
    MemoryInline::FlatWrite16((r26 + 186), static_cast<uint16_t>(r0));
    r0 = PPC_CntlzwInline(static_cast<uint32_t>(r3));
    r0_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(27));
    r0 = (r0_rot_0 & 134217727);
    MemoryInline::FlatWrite8((r26 + 184), static_cast<uint8_t>(r0));
    MemoryInline::FlatWrite32((r26 + 192), r25);
    MemoryInline::FlatWriteFloat32((r26 + 196), f0.d);
    r3 = MemoryInline::FlatRead32((r30 + 31920));
...
loc_808297E8:
{
    ...
    r4 = MemoryInline::FlatRead32((r31 + 31924));
    ...
    MemoryInline::FlatWrite8((r26 + 188), static_cast<uint8_t>(r3));
    r28 = 0;
    r29 = 0;
    goto loc_808298B4;
}
...
loc_80829848:
{
    r7 = MemoryInline::FlatRead32((r30 + 31920));
    r4 = r26;
    r0 = MemoryInline::FlatRead32((r26 + 192));
    r6 = r25;
    r5_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r7), static_cast<uint32_t>(1));
    r5 = (r5_rot_2 & 1);
    r5 = (r5 + r7);
    {
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80829D68u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80829878:
{
    r4 = (r26 + r29);
    r28 = (r28 + 1);
    MemoryInline::FlatWrite32((r4 + 176), r3);
    r5 = MemoryInline::FlatRead32((r30 + 31920));
    r0 = MemoryInline::FlatRead32((r26 + 192));
...
loc_808298B4:
{
    r0 = MemoryInline::FlatRead32((r31 + 31924));
...
// RECOMP_REGISTRATION base 0x80829764 func_80829764 preserves=true fpr_mask=0x00000000
