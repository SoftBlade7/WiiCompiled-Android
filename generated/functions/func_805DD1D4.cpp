...
extern "C" void func_805DD1D4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805DD250:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805BDBD4u) && KnownTranslatedCpuCall<0x805BDBD4u>::kAvailable && !KnownTranslatedCpuCall<0x805BDBD4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805BDBD4u>()) {
        const auto state_free_result_805BDBD4_CE6 = func_805BDBD4_statefree(r3, r4);
        r3 = static_cast<uint32_t>(state_free_result_805BDBD4_CE6);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_805DD27C:
{
    r3 = MemoryInline::FlatRead32((r29 + 9348));
    r0 = (r3 + -1);
    MemoryInline::FlatWrite32((r29 + 9352), r0);
}
...
// RECOMP_REGISTRATION base 0x805DD1D4 func_805DD1D4 preserves=true fpr_mask=0x00000000
