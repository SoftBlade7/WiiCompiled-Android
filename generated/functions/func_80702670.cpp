...
extern "C" void func_80702670(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80702670:
{
    r3 = (r3 + -148);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x807007CCu>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80702670 func_80702670 preserves=true fpr_mask=0x00000000
