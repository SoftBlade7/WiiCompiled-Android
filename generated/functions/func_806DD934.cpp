...
extern "C" void func_806DD934(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806DD934:
{
    ...
    ctx->gpr[4] = r4;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8070010Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x806DD934 func_806DD934 preserves=true fpr_mask=0x00000000
