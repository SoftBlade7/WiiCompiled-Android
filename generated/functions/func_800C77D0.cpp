...
extern "C" void func_800C77D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
    uint32_t r3_rot_1 = 0;
...
loc_800C7830:
{
    ...
    if (MkwStateFreeAbiEnabled(0x800BC3E0u) && KnownTranslatedCpuCall<0x800BC3E0u>::kAvailable && !KnownTranslatedCpuCall<0x800BC3E0u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x800BC3E0u>()) {
        const auto state_free_result_800BC3E0_F18 = func_800BC3E0_statefree_v0(r13, cr, xer);
        r3 = static_cast<uint32_t>(state_free_result_800BC3E0_F18[0]);
        cr = static_cast<uint32_t>(state_free_result_800BC3E0_F18[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x800C77D0 func_800C77D0 preserves=true fpr_mask=0x00000000
