...
extern "C" void func_806ED704(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806ED754:
{
    ...
    r4 = 0;
    f2.d = MemoryInline::FlatReadFloat64((r6 + 2840));
    f1.d = MemoryInline::FlatReadFloat64((r1 + 8));
    f0.d = MemoryInline::FlatReadFloat32((r5 + 2832));
    f1.d = static_cast<double>(PpcForceSingleValueInline(f1.d - f2.d));
    MemoryInline::FlatWrite32((r31 + 44), r3);
    r3 = r31;
    MemoryInline::FlatWrite32((r31 + 48), r7);
...
// RECOMP_REGISTRATION base 0x806ED704 func_806ED704 preserves=true fpr_mask=0x00000000
