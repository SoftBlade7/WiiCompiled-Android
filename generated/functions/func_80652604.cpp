...
extern "C" void func_80652604(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_80652604:
{
    ...
    r0 = (r0_rot_0 & -4);
    r3 = (r28 + r0);
    MemoryInline::FlatWrite32((r3 + 628), r30);
    MemoryInline::FlatWrite32((r3 + 68), r31);
...
// RECOMP_REGISTRATION base 0x80652604 func_80652604 preserves=true fpr_mask=0x00000000
