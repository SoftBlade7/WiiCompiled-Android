...
extern "C" void func_807308DC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80730938:
{
    ...
    r4 = 0x809C0000u;
    r30 = MemoryInline::FlatRead32((r4 + 11240));
    r3 = MemoryInline::FlatRead32((r3 + 4));
    r0 = MemoryInline::FlatRead32((r3 + 12));
    r0 = (r0 & -16777217);
    MemoryInline::FlatWrite32((r3 + 12), r0);
    r3 = MemoryInline::FlatRead32((r26 + 144));
...
loc_80730960:
{
    ...
    if (MkwStateFreeAbiEnabled(0x8073F4D4u) && KnownTranslatedCpuCall<0x8073F4D4u>::kAvailable && !KnownTranslatedCpuCall<0x8073F4D4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x8073F4D4u>()) {
        const auto state_free_result_8073F4D4_1307 = func_8073F4D4_statefree(r3);
        r3 = static_cast<uint32_t>(state_free_result_8073F4D4_1307);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_8073098C:
{
    ...
    f30.d = MemoryInline::FlatReadFloat32((r1 + 20));
...
loc_807309CC:
{
    ...
    f4.d = static_cast<double>(PpcForceSingleValueInline(f30.d - f3.d));
    ...
    f0.d = MemoryInline::FlatReadFloat32((r28 + -23180));
    f3.d = std::fabs(f4.d);
    f4.d = std::fabs(f5.d);
...
loc_80730A20:
{
    if ((static_cast<int32_t>(r26) < static_cast<int32_t>(r27))) {
        goto loc_807309CC;
    }
}
...
// RECOMP_GUEST_ABI gpr_read=0xFC00003B gpr_write=0xFC00083B gpr_return=0x00000018 fpr_read=0xC000003F fpr_write=0xC000003F fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x807308DC func_807308DC preserves=false fpr_mask=0xC0000000
