...
extern "C" void func_807F48FC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807F48FC:
{
    ...
    r31 = 0x808B0000u;
    r4 = 1;
    f1.d = MemoryInline::FlatReadFloat32((r31 + -24504));
    ctx->lr = 0x807F4930u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x807F48FC func_807F48FC preserves=true fpr_mask=0x00000000
