...
extern "C" void func_806A5A00(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806A5A68:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r29 = MemoryInline::FlatRead32((r30 + 1828));
    r3 = 0;
}
...
loc_806A5B2C:
{
    ...
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 176), 0, 48u, false, true);
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 0u, ((static_cast<uint64_t>(static_cast<uint32_t>(r5)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_1, 4u, (r1 + 180), r0);
        MemoryInline::WriteResolved32(guest_range_1, 0u, (r1 + 176), r5);
    }
    {
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 8u, ((static_cast<uint64_t>(static_cast<uint32_t>(r5)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_1, 12u, (r1 + 188), r0);
        MemoryInline::WriteResolved32(guest_range_1, 8u, (r1 + 184), r5);
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r5 = MemoryInline::ReadResolved32(guest_range_0, 16u, (r3 + 16));
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 16u, ((static_cast<uint64_t>(static_cast<uint32_t>(r5)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_1, 20u, (r1 + 196), r0);
        MemoryInline::WriteResolved32(guest_range_1, 16u, (r1 + 192), r5);
    }
    {
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r5)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_1, 28u, (r1 + 204), r0);
        MemoryInline::WriteResolved32(guest_range_1, 24u, (r1 + 200), r5);
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r5 = MemoryInline::ReadResolved32(guest_range_0, 32u, (r3 + 32));
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 32u, ((static_cast<uint64_t>(static_cast<uint32_t>(r5)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_1, 36u, (r1 + 212), r0);
        MemoryInline::WriteResolved32(guest_range_1, 32u, (r1 + 208), r5);
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r5 = MemoryInline::ReadResolved32(guest_range_0, 40u, (r3 + 40));
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 40u, ((static_cast<uint64_t>(static_cast<uint32_t>(r5)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_1, 44u, (r1 + 220), r0);
        MemoryInline::WriteResolved32(guest_range_1, 40u, (r1 + 216), r5);
    }
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
// RECOMP_REGISTRATION base 0x806A5A00 func_806A5A00 preserves=true fpr_mask=0x00000000
