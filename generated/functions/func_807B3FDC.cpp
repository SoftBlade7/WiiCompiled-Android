...
extern "C" void func_807B3FDC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807B3FDC:
{
    ...
    r4 = r3;
    MemoryInline::FlatWriteFloat32((r31 + 644), f0.d);
    r0 = MemoryInline::FlatRead8((r31 + 681));
    f0.d = MemoryInline::FlatReadFloat32((r3 + 120));
    MemoryInline::FlatWriteFloat32((r31 + 648), f0.d);
...
loc_807B4058:
{
    ...
    MemoryInline::FlatWriteFloat32((r31 + 652), f0.d);
    if (((cr & 0x20000000u) == 0)) {
        goto loc_807B40E0;
    }
}
...
loc_807B4070:
{
    ...
    f1.d = MemoryInline::FlatReadFloat64((r29 + 24));
...
loc_807B40E0:
{
    ...
    f8.d = MemoryInline::FlatReadFloat32((r31 + 644));
    f0.d = MemoryInline::FlatReadFloat32((r29 + 16));
    f6.d = MemoryInline::FlatReadFloat32((r31 + 648));
    PpcSetPairedFprInline(f9, PPC_PsMuls0Inline(f5.d, PPC_PsFromScalarInline(f3.d)));
    f4.d = MemoryInline::FlatReadFloat32((r31 + 652));
    f2.d = PpcFmulsInline(f8.d, f0.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r31_psq_tmp_0 = (r31 + 684);
    PPC_PsqStGqrInline<0u, 0u>(ctx, mkw_gqr0, r31_psq_tmp_0, f9.d);
    f1.d = PpcFmulsInline(f6.d, f0.d);
    f0.d = PpcFmulsInline(f4.d, f0.d);
    // psq_load w=1 quant=0 (using PPC_PsqL)
    r3_psq_tmp_0 = (r3 + 8);
    PpcSetPairedFprInline(f5, PPC_PsqLStackInline<1u, 0u>(ctx, r3_psq_tmp_0));
    f7.d = MemoryInline::FlatReadFloat32((r31 + 684));
    PpcSetPairedFprInline(f9, PPC_PsMuls0Inline(f5.d, PPC_PsFromScalarInline(f3.d)));
    f5.d = MemoryInline::FlatReadFloat32((r31 + 688));
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r31_psq_tmp_1 = (r31 + 692);
    PPC_PsqStGqrInline<1u, 0u>(ctx, mkw_gqr0, r31_psq_tmp_1, f9.d);
    f9.d = MemoryInline::FlatReadFloat32((r1 + 16));
    f3.d = MemoryInline::FlatReadFloat32((r31 + 692));
    f9.d = PpcFmulsInline(f29.d, f9.d);
...
{
    r0 = 0;
    MemoryInline::FlatWrite8((r31 + 680), static_cast<uint8_t>(r0));
}

loc_807B41D8:
{
    r0 = MemoryInline::FlatRead8((r31 + 680));
}
...
loc_807B41E4:
{
    ...
    MemoryInline::FlatWriteFloat32((r31 + 668), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r3 + 4));
    MemoryInline::FlatWriteFloat32((r31 + 672), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r3 + 8));
    MemoryInline::FlatWriteFloat32((r31 + 676), f0.d);
}
...
loc_807B4204:
{
    r3 = (r1 + 20);
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r31_psq_tmp_2 = (r31 + 668);
    PpcSetPairedFprInline(f2, PPC_PsqLGqrInline<0u, 0u>(ctx, mkw_gqr0, r31_psq_tmp_2));
    // psq_load w=0 quant=0 (using PPC_PsqL)
...
loc_807B4214:
{
    ...
    PpcSetPairedFprInline(f0, PPC_PsSubInline(f3.d, f1.d));
    PpcSetPairedFprInline(f1, PPC_PsMuls0Inline(f2.d, PPC_PsFromScalarInline(f30.d)));
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r31_psq_tmp_7 = (r31 + 664);
    PPC_PsqStGqrInline<1u, 0u>(ctx, mkw_gqr0, r31_psq_tmp_7, f0.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
...
loc_807B4264:
{
    f3.d = MemoryInline::FlatReadFloat32((r31 + 80));
...
loc_807B42F4:
{
    ...
    f2.d = PpcFmulsInline(f28.d, f1.d);
    // psq_load w=0 quant=0 (using PPC_PsqL)
    ...
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r28_psq_tmp_2 = (r28 + 8);
    PPC_PsqStStackInline<1u, 0u>(ctx, r28_psq_tmp_2, f1.d);
}
...
loc_807B4314:
{
    ...
    r4 = (r31 + 68);
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r31_psq_tmp_8 = (r31 + 80);
    PpcSetPairedFprInline(f0, PPC_PsqLGqrInline<0u, 0u>(ctx, mkw_gqr0, r31_psq_tmp_8));
    r3 = 0x808A0000u;
    // psq_load w=0 quant=0 (using PPC_PsqL)
    ...
    r10 = 0x809C0000u;
    PpcSetPairedFprInline(f3, PPC_PsSubInline(f2.d, f0.d));
    ...
    r6 = (r6 + -9217);
    PpcSetPairedFprInline(f3, PPC_PsMadds0Inline(f3.d, PPC_PsFromScalarInline(f31.d), f0.d));
    // psq_load w=1 quant=0 (using PPC_PsqL)
    r31_psq_tmp_9 = (r31 + 88);
    PpcSetPairedFprInline(f0, PPC_PsqLGqrInline<1u, 0u>(ctx, mkw_gqr0, r31_psq_tmp_9));
    r7 = (r31 + 216);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r31_psq_tmp_10 = (r31 + 80);
    PPC_PsqStGqrInline<0u, 0u>(ctx, mkw_gqr0, r31_psq_tmp_10, f3.d);
    ...
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r31_psq_tmp_11 = (r31 + 88);
    PPC_PsqStGqrInline<1u, 0u>(ctx, mkw_gqr0, r31_psq_tmp_11, f3.d);
    PpcSetPairedFprInline(f2, PPC_PsAddInline(f5.d, f3.d));
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r4_psq_tmp_1 = (r4 + 8);
    PPC_PsqStGqrInline<1u, 0u>(ctx, mkw_gqr0, r4_psq_tmp_1, f2.d);
...
{
    // psq_load w=0 quant=0 (using PPC_PsqL)
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 44), 0, 92u, true, false);
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 68u, (r1 + 112));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f30.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 52u, (r1 + 96));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f29.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 36u, (r1 + 80));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r11 = (r1 + 64);
    f28.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 20u, (r1 + 64));
    ...
    r0 = MemoryInline::ReadResolved32(guest_range_1, 88u, (r1 + 132));
    ctx->lr = r0;
    r1 = (r1 + 128);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x807B3FDC func_807B3FDC preserves=false fpr_mask=0xF0000000
