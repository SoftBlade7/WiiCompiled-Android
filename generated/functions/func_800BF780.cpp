...
extern "C" void func_800BF780(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800BF7C8:
{
    ...
    r31 = MemoryInline::FlatRead32((r3 + 6980));
    // inline leaf 0x800BC470 (2 guest instruction(s))
    r3 = MemoryInline::FlatRead32((r13 + -26984));
    // end of inlined leaf 0x800BC470
...
loc_inl15_0x800BC440:
{
    r3 = MemoryInline::FlatRead32((r13 + -26984));
}

loc_inl15_0x800BC448:
{
    if ((static_cast<int32_t>(r3) != static_cast<int32_t>(0))) {
        goto loc_inl15_0x800BC454;
    }
}

loc_inl15_0x800BC44C:
{
    r3 = 0;
    goto loc_inl15_cont_800BC440;
}

loc_inl15_0x800BC454:
{
    r3 = MemoryInline::FlatRead32((r3 + 6964));
}

loc_inl15_cont_800BC440:
{
...
// RECOMP_REGISTRATION base 0x800BF780 func_800BF780 preserves=true fpr_mask=0x00000000
