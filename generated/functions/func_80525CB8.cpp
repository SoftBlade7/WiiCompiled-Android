...
extern "C" void func_80525CB8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_inl1_cont_800C97C0:
{
    ...
    cr = ctx->cr;
    r0 = 99;
    MemoryInline::FlatWrite16((r28 + 32), static_cast<uint16_t>(r0));
...
// RECOMP_REGISTRATION base 0x80525CB8 func_80525CB8 preserves=true fpr_mask=0x00000000
