...
extern "C" void func_80776B7C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80776B7C:
{
    r4 = 0x808A0000u;
    r0 = 1;
    f0.d = MemoryInline::FlatReadFloat32((r4 + 16900));
...
// RECOMP_REGISTRATION base 0x80776B7C func_80776B7C preserves=true fpr_mask=0x00000000
