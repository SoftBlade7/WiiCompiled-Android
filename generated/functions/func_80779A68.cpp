...
extern "C" void func_80779A68(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80779B20:
{
    ...
    r29 = 0x808A0000u;
    r28 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r29 + 17216));
    r3 = MemoryInline::FlatRead32((r3 + 40));
    r4 = 1;
    f2.d = MemoryInline::FlatReadFloat32((r28 + 17264));
    ctx->lr = 0x80779B48u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
{
    r28 = 1;
    MemoryInline::FlatWrite8((r3 + 180), static_cast<uint8_t>(r28));
    r3 = 0x808D0000u;
    r4 = 0x802A0000u;
...
loc_80779C80:
{
    MemoryInline::FlatWrite32((r30 + 176), r28);
    r29 = 0x808A0000u;
    r3 = MemoryInline::FlatRead32((r30 + 8));
    r28 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r29 + 17216));
...
loc_80779CD0:
{
    ...
    r28 = 0x808A0000u;
    r29 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r28 + 17216));
    r3 = MemoryInline::FlatRead32((r3 + 40));
    r4 = 0;
    f2.d = MemoryInline::FlatReadFloat32((r29 + 17264));
    ctx->lr = 0x80779CF8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80779A68 func_80779A68 preserves=false fpr_mask=0x80000000
