...
extern "C" void func_807D99EC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807D9A20:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r31 + 30108));
    f1.d = MemoryInline::FlatReadFloat32((r5 + 292));
    MemoryInline::FlatWriteRamFloat32((r1 + 12), f1.d);
    f1.d = MemoryInline::FlatReadFloat32((r5 + 308));
    ...
    f0.d = MemoryInline::FlatReadFloat32((r31 + 30108));
    r4 = (r1 + 8);
    f1.d = MemoryInline::FlatReadFloat32((r5 + 280));
    MemoryInline::FlatWriteRamFloat32((r1 + 8), f1.d);
    f1.d = MemoryInline::FlatReadFloat32((r5 + 296));
    MemoryInline::FlatWriteRamFloat32((r1 + 12), f1.d);
    f1.d = MemoryInline::FlatReadFloat32((r5 + 312));
    MemoryInline::FlatWriteRamFloat32((r1 + 16), f1.d);
...
// RECOMP_REGISTRATION base 0x807D99EC func_807D99EC preserves=true fpr_mask=0x00000000
