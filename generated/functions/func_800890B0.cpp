...
extern "C" void func_800890B0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8008913C:
{
    ...
    MemoryInline::FlatWrite32((r13 + -27476), r5);
    // end of inlined leaf 0x80021338
    MemoryInline::FlatWrite8((r13 + -27232), static_cast<uint8_t>(r29));
}
...
// RECOMP_REGISTRATION base 0x800890B0 func_800890B0 preserves=true fpr_mask=0x00000000
