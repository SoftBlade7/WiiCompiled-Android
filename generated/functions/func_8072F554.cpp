...
extern "C" void func_8072F554(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8072F554:
{
    ...
    f3.d = MemoryInline::FlatReadFloat32((r3 + 9816));
    r3 = (r1 + 8);
    ...
    r6 = MemoryInline::FlatRead8((r30 + 296));
    ctx->lr = 0x8072F614u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->fpr[4] = f4;
    ctx->cr = cr;
    InvokeDirectCpu<0x8072EE9Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8072F620:
{
    r7 = MemoryInline::FlatRead8((r30 + 296));
    r3 = r30;
    r8 = r31;
    r4 = (r30 + 284);
    r5 = (r30 + 276);
    ...
    ctx->fpr[4] = f4;
    ctx->cr = cr;
    InvokeDirectCpu<0x8072F00Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8072F554 func_8072F554 preserves=true fpr_mask=0x00000000
