...
extern "C" void func_806DA728(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806DA728:
{
    ...
    r31 = ctx->gpr[31];
    cr = ctx->cr;
    r29 = MemoryInline::FlatRead32((r30 + 16));
    r31 = (r30 + 88);
    r30 = 0;
}
...
// RECOMP_REGISTRATION base 0x806DA728 func_806DA728 preserves=true fpr_mask=0x00000000
