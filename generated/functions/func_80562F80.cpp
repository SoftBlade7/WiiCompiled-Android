...
extern "C" void func_80562F80(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80562FB4:
{
    ...
    r25 = MemoryInline::FlatRead32((r31 + 40));
...
{
    r28 = (r28 + 1);
    MemoryInline::FlatWrite32((r30 + 28), r25);
...
// RECOMP_REGISTRATION base 0x80562F80 func_80562F80 preserves=true fpr_mask=0x00000000
