...
extern "C" void func_80889744(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80889744:
{
    ...
    r3 = r31;
    r0 = MemoryInline::FlatRead32((r5 + 19200));
    MemoryInline::FlatWrite32((r31 + 176), r0);
    r4 = MemoryInline::FlatRead32((r5 + 19200));
    r0 = (r4 + 1);
    MemoryInline::FlatWriteRam32((r5 + 19200), r0);
...
// RECOMP_REGISTRATION base 0x80889744 func_80889744 preserves=true fpr_mask=0x00000000
