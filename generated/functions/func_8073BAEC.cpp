...
extern "C" void func_8073BAEC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8073BAEC:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r5 + 10164));
...
// RECOMP_REGISTRATION base 0x8073BAEC func_8073BAEC preserves=true fpr_mask=0x00000000
