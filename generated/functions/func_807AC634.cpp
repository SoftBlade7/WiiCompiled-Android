...
extern "C" void func_807AC634(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807AC634:
{
    ...
    r6 = MemoryInline::FlatRead8((r5 + 68));
    r5 = (255 - r6);
...
loc_807AC67C:
{
    ...
    r5 = 20;
    r9 = MemoryInline::FlatRead8((r3 + 748));
    r6 = 1;
    r7 = 1;
    r8 = 0;
    r10 = 1;
    ...
    r3 = -1;
    r0 = 0;
    MemoryInline::FlatWrite16((r30 + 704), static_cast<uint16_t>(r4));
...
loc_807AC6B4:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    guest_range_0 = MemoryInline::ResolveRangeHost((r29 + 88), 0, 36u, true, false);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 0u, (r29 + 88));
    MemoryInline::FlatWriteFloat32((r30 + 32), f0.d);
    r0 = MemoryInline::FlatRead32((r30 + 124));
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 4u, (r29 + 92));
...
loc_807AC6D4:
{
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 8u, (r29 + 96));
    MemoryInline::FlatWriteFloat32((r30 + 40), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 12u, (r29 + 100));
    MemoryInline::FlatWriteFloat32((r30 + 44), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 16u, (r29 + 104));
    MemoryInline::FlatWriteFloat32((r30 + 48), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 20u, (r29 + 108));
    MemoryInline::FlatWriteFloat32((r30 + 52), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 24u, (r29 + 112));
    MemoryInline::FlatWriteFloat32((r30 + 56), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 28u, (r29 + 116));
    MemoryInline::FlatWriteFloat32((r30 + 60), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 32u, (r29 + 120));
...
loc_807AC720:
{
    r0 = MemoryInline::FlatRead8((r30 + 681));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_807AC72C:
{
    ...
    xer = ctx->xer;
    r0 = r3;
    MemoryInline::FlatWrite8((r30 + 748), static_cast<uint8_t>(r3));
    r3 = r30;
    r4 = (r0 & 255);
    ctx->lr = 0x807AC770u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x807AC634 func_807AC634 preserves=true fpr_mask=0x00000000
