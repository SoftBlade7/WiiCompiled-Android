...
extern "C" void func_8081E78C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8081E854:
{
    ...
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r6 + -17928));
    f2.d = MemoryInline::FlatReadFloat32((r5 + -17924));
    ctx->lr = 0x8081E8A4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8081E78C func_8081E78C preserves=true fpr_mask=0x00000000
