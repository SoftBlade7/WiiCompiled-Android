...
extern "C" void func_80592DF8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80592E1C:
{
    // inline leaf 0x80591070 (3 guest instruction(s))
    r3 = MemoryInline::FlatRead32(r3);
    r3 = MemoryInline::FlatRead32((r3 + 84));
    // end of inlined leaf 0x80591070
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r31 = MemoryInline::FlatRead32((r30 + 136));
...
// RECOMP_REGISTRATION base 0x80592DF8 func_80592DF8 preserves=true fpr_mask=0x00000000
