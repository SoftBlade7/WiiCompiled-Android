...
extern "C" void func_806ED57C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r0 = 0;
    MemoryInline::FlatWrite8((r31 + 68), static_cast<uint8_t>(r0));
    // inline leaf 0x8051BED0 (12 guest instruction(s))
}
...
// RECOMP_REGISTRATION base 0x806ED57C func_806ED57C preserves=true fpr_mask=0x00000000
