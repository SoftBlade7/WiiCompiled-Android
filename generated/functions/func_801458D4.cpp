...
extern "C" void func_801458D4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80145908:
{
    ...
    MemoryInline::FlatWrite8((r3 + 11), static_cast<uint8_t>(r31));
...
// RECOMP_REGISTRATION base 0x801458D4 func_801458D4 preserves=true fpr_mask=0x00000000
