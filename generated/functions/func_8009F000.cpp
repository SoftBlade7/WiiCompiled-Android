...
extern "C" void func_8009F000(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8009F000:
{
    ...
    r28 = r3;
    r3 = MemoryInline::FlatRead8((r7 + 32));
    r4 = MemoryInline::FlatRead32((r7 + 36));
...
loc_8009F0C4:
{
    r0_rot_3 = PpcRotl32Inline(static_cast<uint32_t>(r30), static_cast<uint32_t>(3));
    r0 = (r0_rot_3 & -8);
    r5 = MemoryInline::FlatRead32((r28 + 40));
    r4 = (r3 + r0);
    r3 = MemoryInline::FlatRead8((r4 + 4));
...
// RECOMP_REGISTRATION base 0x8009F000 func_8009F000 preserves=true fpr_mask=0x00000000
