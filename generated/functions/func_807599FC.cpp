...
extern "C" void func_807599FC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807599FC:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8075A59Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8075A864u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80759AA4:
{
    r0 = MemoryInline::FlatRead8((r30 + 249));
}
...
loc_80759AE0:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8075A4B8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8075AAC8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80759B40:
{
    r3 = 0x808D0000u;
    r4 = MemoryInline::FlatRead32((r30 + 252));
    r0 = MemoryInline::FlatRead32((r3 + -14108));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r4), static_cast<int32_t>(r0));
}
...
loc_80759B84:
{
    MemoryInline::FlatWrite32((r30 + 244), r0);
    if (((cr & 0x20000000u) == 0)) {
        goto loc_80759BB0;
    }
}
...
loc_80759D08:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8075AE90u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80759D80:
{
    ...
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 144), 0, 72u, true, false);
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 48u, (r1 + 192));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f30.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 32u, (r1 + 176));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f29.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 16u, (r1 + 160));
    {
        ...
        if (resolved_pair.valid) {
            ...
            r31 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r1 + 156));
            r30 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r1 + 152));
        }
    }
    r29 = MemoryInline::ReadResolved32(guest_range_1, 4u, (r1 + 148));
    r0 = MemoryInline::ReadResolved32(guest_range_1, 68u, (r1 + 212));
    r28 = MemoryInline::ReadResolved32(guest_range_1, 0u, (r1 + 144));
    ctx->lr = r0;
    r1 = (r1 + 208);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x807599FC func_807599FC preserves=false fpr_mask=0xE0000000
