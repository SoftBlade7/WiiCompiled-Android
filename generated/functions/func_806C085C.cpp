...
extern "C" void func_806C085C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
    uint32_t r3_rot_1 = 0;
...
loc_806C085C:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x806C050Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_806C0960:
{
    ...
    MemoryInline::FlatWrite32((r31 + 184), r29);
}
...
// RECOMP_REGISTRATION base 0x806C085C func_806C085C preserves=true fpr_mask=0x00000000
