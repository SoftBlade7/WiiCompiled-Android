...
extern "C" void func_806A6234(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806A6254:
{
    r4 = MemoryInline::FlatRead32((r31 + 1968));
    r0 = 1127219200;
    MemoryInline::FlatWriteRam32((r1 + 24), r0);
    r3 = 0x808A0000u;
    r0 = (r4 ^ -2147483648);
    f1.d = MemoryInline::FlatReadFloat64((r3 + -10544));
...
// RECOMP_REGISTRATION base 0x806A6234 func_806A6234 preserves=true fpr_mask=0x00000000
