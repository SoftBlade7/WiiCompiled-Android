...
extern "C" void func_80170474(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_801704A8:
{
    ...
    r7 = MemoryInline::FlatRead32((r3 + 176));
    r7_mrot_0 = (r0 & -256);
    r7_mdest_0 = (r7 & 255);
...
loc_801704C0:
{
    ...
    r8 = 1;
    r0 = MemoryInline::FlatRead32(r4);
    r7 = MemoryInline::FlatRead32((r3 + 180));
    r7_mrot_2 = (r0 & -256);
    r7_mdest_2 = (r7 & 255);
...
loc_80170524:
{
    ...
    MemoryInline::FlatWrite32((r3 + 176), r7);
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
...
// RECOMP_REGISTRATION base 0x80170474 func_80170474 preserves=true fpr_mask=0x00000000
