...
extern "C" void func_80781474(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80781474:
{
    ...
    r30 = ctx->gpr[30];
    r31 = ctx->gpr[31];
    guest_range_0 = MemoryInline::ResolveRangeHost(r30, 0, 32u, true, false);
    r31 = MemoryInline::ReadResolved32(guest_range_0, 0u, r30);
    r3 = r29;
    r12 = MemoryInline::ReadResolved32(guest_range_0, 4u, (r30 + 4));
    r4 = (r1 + 8);
    r11 = MemoryInline::ReadResolved32(guest_range_0, 8u, (r30 + 8));
    r5 = 0;
    r10 = MemoryInline::ReadResolved32(guest_range_0, 12u, (r30 + 12));
    r6 = 0;
    {
        ...
        if (resolved_pair.valid) {
            ...
            r9 = MemoryInline::ReadResolved32(guest_range_0, 16u, (r30 + 16));
            r8 = MemoryInline::ReadResolved32(guest_range_0, 20u, (r30 + 20));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r7 = MemoryInline::ReadResolved32(guest_range_0, 24u, (r30 + 24));
...
loc_80781538:
{
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWrite8((r29 + 440), static_cast<uint8_t>(r0));
    r3 = (r1 + 40);
    r4 = 0;
    ctx->lr = 0x80781564u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x80781474 func_80781474 preserves=true fpr_mask=0x00000000
