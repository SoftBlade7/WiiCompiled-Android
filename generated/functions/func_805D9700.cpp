...
extern "C" void func_805D9700(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805D9740:
{
    ...
    f3.d = MemoryInline::FlatReadFloat32((r29 + 408));
...
loc_805D977C:
{
    ...
    r4 = MemoryInline::FlatRead32((r29 + 400));
...
loc_805D97BC:
{
    r0 = MemoryInline::FlatRead8((r29 + 412));
...
{
    r31 = 0x80890000u;
    r5 = MemoryInline::FlatRead32((r29 + 392));
    r31 = (r31 + 19268);
    ...
    xer = ctx->xer;
    r0 = 1;
    MemoryInline::FlatWrite8((r29 + 412), static_cast<uint8_t>(r0));
    r3 = r29;
    r4 = 59;
    r5 = -1;
    ctx->lr = 0x805D9860u;
...
// RECOMP_REGISTRATION base 0x805D9700 func_805D9700 preserves=true fpr_mask=0x00000000
