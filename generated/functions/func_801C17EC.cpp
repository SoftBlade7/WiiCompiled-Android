...
extern "C" void func_801C17EC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_801C17EC:
{
    ...
    r3 = ctx->gpr[3];
    r31 = MemoryInline::FlatRead32((r31 + 2108));
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x801C17EC func_801C17EC preserves=true fpr_mask=0x00000000
