...
extern "C" void func_806ADE6C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806ADE6C:
{
    ...
    r31 = r3;
    r3 = MemoryInline::FlatRead32((r3 + 712));
    ...
    r31 = ctx->gpr[31];
    ctr = ctx->ctr;
    r3 = MemoryInline::FlatRead32((r31 + 712));
    r4 = 0x802A0000u;
    r4 = (r4 + 16640);
    r12 = MemoryInline::FlatRead32(r3);
...
// RECOMP_REGISTRATION base 0x806ADE6C func_806ADE6C preserves=true fpr_mask=0x00000000
