...
extern "C" MkwStateFreeResult2 func_80635CDC_statefree(uint32_t, uint32_t, uint32_t, uint32_t);

extern "C" void func_8051AB58(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8051AB58:
{
    ...
    r31 = r3;
    r5 = MemoryInline::FlatRead32((r4 + -10440));
    r4 = 0x809C0000u;
    MemoryInline::FlatWrite8((r5 + 1549), static_cast<uint8_t>(r6));
    MemoryInline::FlatWrite8((r3 + 9520), static_cast<uint8_t>(r0));
    MemoryInline::FlatWrite8((r3 + 9521), static_cast<uint8_t>(r0));
...
loc_8051AB98:
{
    ...
    ctx->gpr[31] = r31;
    ctx->xer = xer;
    InvokeDirectCpu<0x805554D0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r31 = ctx->gpr[31];
...
loc_8051AC00:
{
    r27 = MemoryInline::FlatRead32((r31 + 28));
...
loc_8051AC30:
{
    ...
    r4 = (r4_rot_0 & -32);
    MemoryInline::FlatWrite32((r31 + 9492), r4);
    r5 = 4;
    r12 = MemoryInline::FlatRead32(r29);
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r31 + 9500), r3);
    r3 = (r1 + 8);
    r4 = 8;
    // inline leaf 0x805555CC (23 guest instruction(s))
    r5 = -1293680640;
    ...
    r4 = (r4_rot_1 & -32);
    MemoryInline::FlatWrite32((r31 + 9496), r4);
    r5 = 4;
    r12 = MemoryInline::FlatRead32(r29);
    r12 = MemoryInline::FlatRead32((r12 + 20));
    ctr = r12;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r31 + 9504), r3);
    r3 = (r1 + 8);
    r4 = -1;
    ctx->lr = 0x8051ACACu;
    ctx->gpr[0] = r0;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r31 + 3200), r3);
    r3 = r26;
    r4 = r28;
    r5 = 0;
    ctx->lr = 0x8051AD08u;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead32((r31 + 3200));
    r0 = 0;
    MemoryInline::FlatWrite32((r31 + 3204), r3);
    MemoryInline::FlatWrite32((r31 + 6360), r3);
    r3 = r31;
    MemoryInline::FlatWrite32((r31 + 6356), r4);
    MemoryInline::FlatWrite32((r31 + 6364), r0);
    ...
    r4 = 0x809C0000u;
    r3 = 0x809C0000u;
    r30 = MemoryInline::FlatRead32((r4 + -10440));
    r3 = MemoryInline::FlatRead32((r3 + 7736));
    ctx->gpr[1] = r1;
    ctx->xer = xer;
    if (MkwStateFreeAbiEnabled(0x80635CDCu) && KnownTranslatedCpuCall<0x80631734u>::kAvailable && !KnownTranslatedCpuCall<0x80631734u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80631734u>() && KnownTranslatedCpuCall<0x80635CDCu>::kAvailable && !KnownTranslatedCpuCall<0x80635CDCu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80635CDCu>()) {
        const auto state_free_result_80635CDC_5900 = func_80635CDC_statefree(r3, cr, xer, 0x8051AD48u);
        r3 = static_cast<uint32_t>(state_free_result_80635CDC_5900[0]);
        cr = static_cast<uint32_t>(state_free_result_80635CDC_5900[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
        ...
        ctx->ctr = ctr;
        ctx->xer = xer;
        InvokeDirectCpu<0x80635CDCu>(ctx);
        r0 = ctx->gpr[0];
        r1 = ctx->gpr[1];
        r3 = ctx->gpr[3];
        r4 = ctx->gpr[4];
    ...
    r5 = MemoryInline::FlatRead32((r31 + 3204));
    r4 = r3;
    r3 = r30;
    ctx->lr = 0x8051AD58u;
    ctx->gpr[0] = r0;
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80540680u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8051AD88:
{
    r4 = MemoryInline::FlatRead32((r4 + 6360));
    r3 = 16;
    r5 = 4;
    ctx->lr = 0x8051AD98u;
    ctx->gpr[0] = r0;
...
loc_inl2_cont_800AEF80:
{
    ...
    r3 = MemoryInline::FlatRead32((r31 + 3200));
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r31 + 3204));
    r12 = MemoryInline::FlatRead32(r3);
    r12 = MemoryInline::FlatRead32((r12 + 40));
    ctr = r12;
    ctx->lr = 0x8051ADD8u;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r31 + 3208), r3);
    r3 = r28;
    r4 = 4;
    r12 = MemoryInline::FlatRead32(r28);
    r12 = MemoryInline::FlatRead32((r12 + 36));
...
loc_8051AE28:
{
    MemoryInline::FlatWrite32((r31 + 3212), r3);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_8051AE5C;
    }
}
...
loc_8051AE30:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r31 + 3216), r3);
    goto loc_8051AE64;
}
...
{
    r0 = 0;
    MemoryInline::FlatWrite32((r31 + 3216), r0);
}
...
loc_8051AED0:
{
    r5 = MemoryInline::FlatRead32((r31 + 3216));
    r3 = 0x80380000u;
    r4 = MemoryInline::FlatRead32((r31 + 3212));
    r6 = 0;
    r0 = MemoryInline::FlatRead32((r31 + 3208));
    MemoryInline::FlatWrite32((r31 + 3220), r0);
    MemoryInline::FlatWrite32((r31 + 3224), r4);
    MemoryInline::FlatWrite32((r31 + 3228), r5);
...
loc_8051AF14:
{
    r3 = MemoryInline::FlatRead32((r6 + 3220));
    ctx->lr = 0x8051AF1Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_8051AF48:
{
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWrite8((r31 + 9536), static_cast<uint8_t>(r0));
    r3 = 0x809C0000u;
    r3 = MemoryInline::FlatRead32((r3 + -10440));
    MemoryInline::FlatWrite8((r3 + 1549), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x8051AB58 func_8051AB58 preserves=true fpr_mask=0x00000000
