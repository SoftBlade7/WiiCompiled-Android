...
extern "C" void func_806C0E00(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806C0E00:
{
    ...
    r3 = 0x808A0000u;
    r5 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + -2496));
    r3 = MemoryInline::FlatRead32((r4 + 40));
    r4 = 0;
    f2.d = MemoryInline::FlatReadFloat32((r5 + -2452));
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
    ctx->fpr[1] = f1;
...
// RECOMP_REGISTRATION base 0x806C0E00 func_806C0E00 preserves=true fpr_mask=0x00000000
