...
extern "C" void func_80243A00(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80243A00:
{
    ...
    r1 = (r1 + -16);
    r0 = ctx->lr;
    f3.d = MemoryInline::FlatReadFloat32((r2 + -24232));
...
// RECOMP_REGISTRATION base 0x80243A00 func_80243A00 preserves=true fpr_mask=0x00000000
