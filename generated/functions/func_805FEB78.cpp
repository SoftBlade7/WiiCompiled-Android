...
extern "C" void func_805FEB78(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_805FEB78:
{
    ...
    r0 = (r0_rot_0 & 1020);
    r3 = (r29 + r0);
    MemoryInline::FlatWrite32((r3 + 3800), r31);
...
// RECOMP_REGISTRATION base 0x805FEB78 func_805FEB78 preserves=true fpr_mask=0x00000000
