...
extern "C" void func_807A8FA0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807A8FA0:
{
    ...
    r31 = 0x809C0000u;
    r3 = MemoryInline::FlatRead32((r31 + 13896));
    ctx->lr = 0x807A8FBCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r31 = ctx->gpr[31];
    r0 = 0;
    MemoryInline::FlatWriteRam32((r31 + 13896), r0);
...
// RECOMP_REGISTRATION base 0x807A8FA0 func_807A8FA0 preserves=true fpr_mask=0x00000000
