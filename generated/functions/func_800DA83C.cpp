...
extern "C" void func_800DA83C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr6_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_800DA89C:
{
    SetCRResident(cr, xer, 6, static_cast<int32_t>(r30), static_cast<int32_t>(0));
}
...
loc_800DA9E4:
{
    r0 = MemoryInline::FlatRead8((r3 + 1825));
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r0), static_cast<uint32_t>(1));
}
...
loc_800DAB90:
{
    ...
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r29), static_cast<int32_t>(19));
}
...
loc_800DABB0:
{
    ...
    r0 = (r0_rot_2 & -4);
    r8 = MemoryInline::FlatRead32((r3 + 76));
    r9 = (r5 + -31457);
    r3_addr_1 = (r3 + r0);
...
loc_800DAC48:
{
    ...
    r4 = ctx->gpr[4];
    r5 = MemoryInline::FlatRead32((r13 + -26868));
    MemoryInline::FlatWrite32((r5 + 1900), r4);
    MemoryInline::FlatWrite32((r5 + 1896), r3);
    goto loc_800DAC80;
}
...
// RECOMP_REGISTRATION base 0x800DA83C func_800DA83C preserves=true fpr_mask=0x00000000
