...
extern "C" void func_8061799C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8061799C:
{
    ...
    r31 = 0x80890000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r31 + 30436));
    ctx->lr = 0x806179DCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8061799C func_8061799C preserves=true fpr_mask=0x00000000
