...
extern "C" void func_8081EDC0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8081EE4C:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r4 + -17928));
...
{
    r3 = 0x808B0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + -17924));
}
...
loc_8081EED0:
{
    ...
    f2.d = MemoryInline::FlatReadFloat32((r5 + -17928));
    r4 = 0;
    ctx->lr = 0x8081EEE4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x8081EDC0 func_8081EDC0 preserves=true fpr_mask=0x00000000
