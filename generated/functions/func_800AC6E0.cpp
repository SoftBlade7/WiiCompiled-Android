...
extern "C" void func_800AC6E0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800AC744:
{
    r4 = MemoryInline::FlatRead32((r28 + 140));
    r3 = r28;
...
loc_800AC798:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x800AA1A0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
{
    r0 = (r25 & 255);
    MemoryInline::FlatWrite32((r28 + 164), r0);
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x801A65ACu>(ctx);
    r3 = ctx->gpr[3];
...
loc_800AC800:
{
    ...
    r0 = MemoryInline::FlatRead32((r28 + 164));
    r4 = MemoryInline::FlatRead32((r6 + -112));
}
...
loc_800AC844:
{
    r0 = MemoryInline::FlatRead32((r27 + -112));
    r3 = (r27 + -276);
...
loc_800AC85C:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800AAD80u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x800AC6E0 func_800AC6E0 preserves=true fpr_mask=0x00000000
