...
extern "C" void func_80057AA0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80057B78:
{
    ...
    r3 = 0x80270000u;
    f1.d = MemoryInline::FlatReadFloat32((r2 + -29704));
    r5_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(2));
    r5 = (r5_rot_1 & -4);
    r4 = (r4 ^ -2147483648);
    MemoryInline::FlatWriteRam32((r1 + 12), r4);
    f0.d = MemoryInline::FlatReadFloat32((r2 + -29700));
    r4 = (r13 + -32488);
    MemoryInline::FlatWriteRam32((r1 + 8), r0);
    r3 = (r3 + 10528);
    f3.d = MemoryInline::FlatReadFloat64((r2 + -29696));
...
// RECOMP_REGISTRATION base 0x80057AA0 func_80057AA0 preserves=false fpr_mask=0x80000000
