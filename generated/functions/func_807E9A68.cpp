...
extern "C" void func_807E9A68(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807E9A68:
{
    ...
    f4.d = std::fabs(f1.d);
    f3.d = MemoryInline::FlatReadFloat32((r6 + -28992));
...
// RECOMP_REGISTRATION base 0x807E9A68 func_807E9A68 preserves=true fpr_mask=0x00000000
