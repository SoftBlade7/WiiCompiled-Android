...
extern "C" void func_80104348(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801043A4:
{
    guest_range_1 = MemoryInline::ResolveRangeHost(r3, 0, 36u, false, true);
    MemoryInline::WriteResolved32(guest_range_1, 0u, r3, r25);
...
{
    r0 = 0;
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 4u, ((static_cast<uint64_t>(static_cast<uint32_t>(r26)) << 32) | static_cast<uint32_t>(r28)))) {
        MemoryInline::WriteResolved32(guest_range_1, 4u, (r3 + 4), r26);
        MemoryInline::WriteResolved32(guest_range_1, 8u, (r3 + 8), r28);
    }
...
loc_801043CC:
{
    r4 = MemoryInline::FlatRead32((r31 + 564));
    r0 = (r4 + 1);
    MemoryInline::WriteResolved32(guest_range_1, 24u, (r3 + 24), r4);
...
loc_801043EC:
{
    ...
    r0 = MemoryInline::FlatRead32((r31 + 1476));
    MemoryInline::WriteResolved32(guest_range_1, 32u, (r3 + 32), r0);
    MemoryInline::FlatWrite32((r31 + 1476), r3);
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFE7FF gpr_write=0xFF00187B gpr_return=0x00000018 fpr_read=0xFFFFFFFF fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x80104348 func_80104348 preserves=true fpr_mask=0x00000000
