...
extern "C" void func_805F9A48(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805F9A48:
{
    ...
    r31 = 0x80890000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r31 + 25132));
    ctx->lr = 0x805F9A7Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x805F9A48 func_805F9A48 preserves=true fpr_mask=0x00000000
