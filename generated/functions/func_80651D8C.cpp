...
extern "C" void func_80651D8C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80651D8C:
{
    ...
    r31 = 0x809C0000u;
    r29 = (static_cast<int32_t>(static_cast<int8_t>(r3)));
...
loc_80651DEC:
{
    ...
    // end of inlined leaf 0x80590100
    // inline leaf 0x805917B0 (4 guest instruction(s))
    r3 = MemoryInline::FlatRead32(r3);
    r3 = MemoryInline::FlatRead32((r3 + 4));
    f1.d = MemoryInline::FlatReadFloat32((r3 + 152));
    // end of inlined leaf 0x805917B0
...
loc_80651E08:
{
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8063CB54u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80651D8C func_80651D8C preserves=false fpr_mask=0x80000000
