...
extern "C" void func_806220B0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806220FC:
{
    ...
    r0 = (r0_rot_4 & -4);
    r3 = (r31 + r0);
    MemoryInline::FlatWrite32((r3 + 852), r30);
    r3 = MemoryInline::FlatRead32((r31 + 892));
    r0 = (r3 + -1);
...
loc_80622134:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80630094u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    f1.d = MemoryInline::FlatReadFloat32((r3 + 32112));
    r3 = 0x80890000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 32068));
    r0 = (r0 & -17);
    MemoryInline::FlatWrite8((r31 + 992), static_cast<uint8_t>(r0));
    r3 = 0x809C0000u;
    r0 = 0;
    r4 = 0x809C0000u;
    MemoryInline::FlatWriteFloat32((r31 + 980), f1.d);
    MemoryInline::FlatWriteFloat32((r31 + 984), f0.d);
...
// RECOMP_REGISTRATION base 0x806220B0 func_806220B0 preserves=true fpr_mask=0x00000000
