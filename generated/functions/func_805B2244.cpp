...
extern "C" void func_805B2244(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805B2244:
{
    ...
    ctx->fpr[30] = f30;
    ctx->fpr[31] = f31;
    InvokeDirectCpu<0x805B2568u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
    ...
    f0.d = MemoryInline::FlatReadFloat32((r29 + 328));
    r3 = (r29 + 204);
    f31.d = MemoryInline::FlatReadFloat32((r29 + 324));
    ...
    MemoryInline::FlatWriteFloat32((r29 + 248), f2.d);
    f0.d = MemoryInline::FlatReadFloat32((r31 + 40));
    MemoryInline::FlatWriteFloat32((r29 + 228), f3.d);
...
// RECOMP_REGISTRATION base 0x805B2244 func_805B2244 preserves=false fpr_mask=0xC0000000
