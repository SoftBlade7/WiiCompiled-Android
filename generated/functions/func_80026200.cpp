...
extern "C" void func_80026200(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80026200:
{
    r3 = MemoryInline::FlatRead32((r13 + -27428));
...
// RECOMP_REGISTRATION base 0x80026200 func_80026200 preserves=true fpr_mask=0x00000000
