...
extern "C" void func_8084C1C4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r6_rot_0 = 0;
...
loc_8084C218:
{
    ...
    r4 = (r28 & 1);
    r0 = (r6 + r28);
    r3 = MemoryInline::FlatRead32((r29 + 1732));
    {
...
loc_8084C280:
{
    r0 = 1;
    r8 = 0;
    r7 = PPC_Slw(static_cast<uint32_t>(r0), static_cast<uint32_t>(r28));
    r9 = 0;
    ctx->lr = 0x8084C294u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x8084C1C4 func_8084C1C4 preserves=true fpr_mask=0x00000000
