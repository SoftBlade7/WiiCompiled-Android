...
extern "C" void func_807DDED0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807DDED0:
{
    ...
    f28.d = MemoryInline::FlatReadFloat32((r4 + 8));
    f3.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 4u, (r3 + 4));
...
loc_807DDF48:
{
    ...
    f3.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 36u, (r3 + 36));
    ...
    f2.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 32u, (r3 + 32));
...
// RECOMP_REGISTRATION base 0x807DDED0 func_807DDED0 preserves=false fpr_mask=0xF0000000
