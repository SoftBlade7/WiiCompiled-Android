...
extern "C" void func_80553A88(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80553A88:
{
    ...
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80750018u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
...
// RECOMP_REGISTRATION base 0x80553A88 func_80553A88 preserves=true fpr_mask=0x00000000
