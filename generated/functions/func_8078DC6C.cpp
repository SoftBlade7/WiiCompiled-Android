...
extern "C" void func_8078DC6C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8078DC6C:
{
    ...
    r28 = r5;
    r27 = r4;
    r3 = MemoryInline::FlatRead32((r24 + 12016));
    r29 = r6;
    r30 = r7;
    r31 = r9;
    r4 = r28;
    ...
    xer = ctx->xer;
    r3 = 0x808A0000u;
    f30.d = PpcFmulsInline(f30.d, f30.d);
    f31.d = MemoryInline::FlatReadFloat32((r3 + 19280));
    r25 = 2;
    goto loc_8078DD78;
}
...
loc_8078DD28:
{
    ...
    MemoryInline::FlatWrite32((r3 + 208), r27);
    r0 = MemoryInline::FlatRead32((r4 + 700));
}
...
loc_8078DD44:
{
    MemoryInline::FlatWriteFloat32((r4 + 696), f31.d);
    MemoryInline::FlatWrite32((r4 + 700), r25);
}
...
loc_8078DD58:
{
    ...
    MemoryInline::FlatWriteFloat32((r4 + 680), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r27 + 4));
    MemoryInline::FlatWriteFloat32((r4 + 684), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r27 + 8));
    MemoryInline::FlatWriteFloat32((r4 + 688), f0.d);
}

loc_8078DD70:
{
    r3 = (r26 + r5);
    MemoryInline::FlatWrite32((r3 + 304), r29);
    f1.d = PPC_PsToScalarInline(f1.d);
    f2.d = PPC_PsToScalarInline(f2.d);
    f3.d = PPC_PsToScalarInline(f3.d);
}
...
// RECOMP_REGISTRATION base 0x8078DC6C func_8078DC6C preserves=false fpr_mask=0xC0000000
