...
extern "C" void func_806DEF0C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806DEF70:
{
    r0 = MemoryInline::FlatRead8((r31 + 202));
}
...
{
    r3 = 0x809C0000u;
    r0 = MemoryInline::FlatRead16((r3 + 8842));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_806DF310:
{
    r0 = MemoryInline::FlatRead8((r31 + 201));
    r27 = 0;
    MemoryInline::FlatWrite8((r31 + 202), static_cast<uint8_t>(r0));
    r28 = 0;
    r29 = 0x809C0000u;
    r30 = 0x809C0000u;
    goto loc_806DF3BC;
...
// RECOMP_REGISTRATION base 0x806DEF0C func_806DEF0C preserves=true fpr_mask=0x00000000
