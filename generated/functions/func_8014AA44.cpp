...
extern "C" void func_8014AA44(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8014AA68:
{
    r3 = 0x80340000u;
    r3 = (r3 + -27840);
    MemoryInline::FlatWriteRam16((r3 + 1978), static_cast<uint16_t>(r4));
    goto loc_8014AAF0;
}
...
// RECOMP_REGISTRATION base 0x8014AA44 func_8014AA44 preserves=true fpr_mask=0x00000000
