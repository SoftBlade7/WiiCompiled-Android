...
extern "C" void func_80563A78(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80563B08:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8055F2FCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80563B1C:
{
    r28 = MemoryInline::FlatRead32((r26 + 16));
    ...
    xer = ctx->xer;
    r27 = (r27 + 1);
    MemoryInline::FlatWrite32((r25 + 28), r28);
...
// RECOMP_REGISTRATION base 0x80563A78 func_80563A78 preserves=true fpr_mask=0x00000000
