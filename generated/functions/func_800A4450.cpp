...
extern "C" void func_800A4450(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800A4450:
{
    r3 = MemoryInline::FlatRead8((r13 + -27128));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x800A4450 func_800A4450 preserves=true fpr_mask=0x00000000
