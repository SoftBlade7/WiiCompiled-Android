...
extern "C" void func_805D14A4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805D14F0:
{
    ...
    r4 = 3;
    r5 = MemoryInline::FlatRead32((r5 + -30808));
    r6 = 0;
    ctx->lr = 0x805D150Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x805D14A4 func_805D14A4 preserves=true fpr_mask=0x00000000
