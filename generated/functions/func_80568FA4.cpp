...
extern "C" void func_80568FA4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80568FA4:
{
    ...
    r5 = (r5 + 5448);
    f1.d = MemoryInline::FlatReadFloat32((r5 + 164));
    MemoryInline::FlatWriteRam32((r1 + 12), r31);
    r31 = r4;
    f2.d = MemoryInline::FlatReadFloat32((r5 + 168));
    r4 = 2;
    MemoryInline::FlatWriteRam32((r1 + 8), r30);
    r30 = r3;
    f3.d = MemoryInline::FlatReadFloat32((r5 + 172));
...
// RECOMP_REGISTRATION base 0x80568FA4 func_80568FA4 preserves=true fpr_mask=0x00000000
