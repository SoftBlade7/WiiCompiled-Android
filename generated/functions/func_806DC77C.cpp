...
extern "C" void func_806DC77C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806DC77C:
{
    ...
    MemoryInline::FlatWrite32((r3 + 320), r0);
    ctx->gpr[0] = r0;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x806DC77C func_806DC77C preserves=true fpr_mask=0x00000000
