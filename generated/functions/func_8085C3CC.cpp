...
extern "C" void func_8085C3CC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8085C3CC:
{
    ...
    r3 = 0x809C0000u;
    r4 = (r4 + 7440);
    MemoryInline::FlatWriteRam32((r3 + 18160), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x8085C3CC func_8085C3CC preserves=true fpr_mask=0x00000000
