...
extern "C" void func_8010E9C0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8010E9E8:
{
    r0 = MemoryInline::FlatRead32((r13 + -26784));
    r5 = 0x802F0000u;
    r5 = (r5 + 13440);
    r6 = (r0 ^ 1);
    r0 = (r6 * 22);
    MemoryInline::FlatWrite32((r13 + -26784), r6);
    r31 = (r5 + r0);
}
...
// RECOMP_REGISTRATION base 0x8010E9C0 func_8010E9C0 preserves=true fpr_mask=0x00000000
