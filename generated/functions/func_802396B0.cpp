...
extern "C" void func_802396B0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_802396B0:
{
    r3 = (r3 + -72);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80238D10u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x802396B0 func_802396B0 preserves=true fpr_mask=0x00000000
