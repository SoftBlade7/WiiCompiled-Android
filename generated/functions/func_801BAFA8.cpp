...
extern "C" void func_801BAFA8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_801BAFA8:
{
    ...
    r30 = MemoryInline::FlatRead32((r13 + -24624));
...
// RECOMP_REGISTRATION base 0x801BAFA8 func_801BAFA8 preserves=true fpr_mask=0x00000000
