...
extern "C" void func_807040CC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807040CC:
{
    r3 = (r3 + -148);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80702AF4u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x807040CC func_807040CC preserves=true fpr_mask=0x00000000
