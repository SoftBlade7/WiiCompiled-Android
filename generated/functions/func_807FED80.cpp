...
extern "C" void func_807FED80(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807FEE14:
{
    ...
    f3.d = MemoryInline::FlatReadFloat64((r7 + -21152));
...
loc_807FEE40:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r4 + -21160));
    f2.d = MemoryInline::FlatReadFloat64((r1 + 24));
    f0.d = MemoryInline::FlatReadFloat32((r3 + -21156));
...
loc_807FEED4:
{
    MemoryInline::FlatWrite32((r31 + 340), r30);
    r3 = 184;
    ctx->lr = 0x807FEEE0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_807FEEEC:
{
    r29 = MemoryInline::FlatRead32((r31 + 160));
    r30 = 0x808B0000u;
    r30 = (r30 + -21112);
    r4 = r29;
    r5 = (r30 + 26);
    ...
    r3 = 0x809C0000u;
    r4 = (r4 + 19600);
    MemoryInline::FlatWriteRam32(r28, r4);
    r4 = (r30 + 40);
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam16((r28 + 176), static_cast<uint16_t>(r3));
    r3 = 0x809C0000u;
    r3 = MemoryInline::FlatRead32((r3 + -10456));
    r0 = MemoryInline::FlatRead32((r3 + 2924));
...
loc_807FEF50:
{
    ...
    r0 = (r0 << 16);
    r0 = (static_cast<int32_t>(r0) >> 16);
    MemoryInline::FlatWriteRam32((r28 + 180), r0);
    goto loc_807FEF7C;
}
...
loc_807FEF7C:
{
    MemoryInline::FlatWrite32((r31 + 344), r28);
    ...
    r3 = r31;
    r0 = (r4 + -1);
    MemoryInline::FlatWrite32((r31 + 396), r0);
...
// RECOMP_REGISTRATION base 0x807FED80 func_807FED80 preserves=true fpr_mask=0x00000000
