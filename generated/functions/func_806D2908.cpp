...
extern "C" void func_806D2908(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806D2908:
{
    ...
    r3 = MemoryInline::FlatRead32((r22 + 17200));
...
loc_806D2A50:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r20), static_cast<int32_t>(r27));
}
...
loc_806D2AC0:
{
    ...
    r0 = (r0_rot_5 & -4);
    r3_addr_5 = (r3 + r0);
    MemoryInline::FlatWrite32(r3_addr_5, r28);
    goto loc_806D2AEC;
}
...
loc_806D2B1C:
{
    ...
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead32((r31 + 244));
    MemoryInline::FlatWrite32((r31 + 204), r3);
    r0_rot_8 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(2));
    r0 = (r0_rot_8 & -4);
    r3_addr_8 = (r3 + r0);
    MemoryInline::FlatWrite32(r3_addr_8, r28);
    goto loc_806D2B48;
}
...
loc_806D2B78:
{
    ...
    r0 = (r0_rot_11 & -4);
    r3_addr_11 = (r3 + r0);
    MemoryInline::FlatWrite32(r3_addr_11, r28);
    goto loc_806D2BA4;
}
...
loc_806D2B98:
{
    ...
    r0 = (r0_rot_12 & -4);
    r3_addr_12 = (r3 + r0);
    MemoryInline::FlatWrite32(r3_addr_12, r28);
}
...
loc_806D2BD4:
{
    ...
    r0 = (r0_rot_14 & -4);
    r3_addr_14 = (r3 + r0);
    MemoryInline::FlatWrite32(r3_addr_14, r28);
    goto loc_806D2C00;
}
...
loc_806D2BF4:
{
    ...
    r0 = (r0_rot_15 & -4);
    r3_addr_15 = (r3 + r0);
    MemoryInline::FlatWrite32(r3_addr_15, r28);
}
...
loc_806D2C18:
{
    r4 = MemoryInline::FlatRead32((r31 + 232));
    r0 = MemoryInline::FlatRead32((r31 + 220));
    r3 = MemoryInline::FlatRead32((r31 + 224));
    r0 = (r4 + r0);
    r0 = (r3 + r0);
    MemoryInline::FlatWrite32((r31 + 236), r0);
    r3_rot_11 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(2));
    r3 = (r3_rot_11 & -4);
    ctx->lr = 0x806D2C38u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_806D2C48:
{
    ...
    r3_addr_19 = (r3 + r5);
    MemoryInline::FlatWrite32(r3_addr_19, r0);
    r5 = (r5 + 4);
}
...
loc_806D2C78:
{
    ...
    r0 = (r0_rot_19 & -4);
    r3_addr_21 = (r3 + r0);
    MemoryInline::FlatWrite32(r3_addr_21, r4);
    r5 = (r5 + 4);
    r6 = (r6 + 1);
}
...
loc_806D2CB4:
{
    ...
    r0 = (r0_rot_21 & -4);
    r3_addr_23 = (r3 + r0);
    MemoryInline::FlatWrite32(r3_addr_23, r4);
    r5 = (r5 + 4);
    r6 = (r6 + 1);
}
...
loc_806D2CF8:
{
    ...
    r4 = (r4 + 4);
    MemoryInline::FlatWrite32((r3 + 216), r31);
}
...
loc_806D2D18:
{
    ...
    r3 = MemoryInline::FlatRead32((r3 + -10456));
    r0 = MemoryInline::FlatRead8((r3 + 36));
    r3_rot_12 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(2));
    r3 = (r3_rot_12 & -4);
    ctx->lr = 0x806D2D2Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    r21 = 0x809C0000u;
    r4 = 0;
    r3 = MemoryInline::FlatRead32((r21 + 8880));
    ...
    r22 = MemoryInline::FlatRead16((r3 + 8));
    r4 = 1;
    r3 = MemoryInline::FlatRead32((r21 + 8880));
    // inline leaf 0x806F10FC (4 guest instruction(s))
    r3 = MemoryInline::FlatRead32((r3 + 4));
    ...
    // end of inlined leaf 0x806F10FC
    r21 = MemoryInline::FlatRead16((r3 + 8));
    r3_rot_13 = PpcRotl32Inline(static_cast<uint32_t>(r22), static_cast<uint32_t>(1));
    r3 = (r3_rot_13 & 131070);
    ctx->lr = 0x806D2D5Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r31 + 260), r3);
    r3_rot_14 = PpcRotl32Inline(static_cast<uint32_t>(r21), static_cast<uint32_t>(1));
    r3 = (r3_rot_14 & 131070);
    ctx->lr = 0x806D2D68u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctx->fpr[0] = f0;
    ctx->cr = cr;
    InvokeDirectCpu<0x806D30BCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r3_rot_15 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(2));
    r3 = (r3_rot_15 & -4);
    ctx->lr = 0x806D2D94u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_806D2DE0:
{
    r7 = MemoryInline::FlatRead32((r31 + 200));
    r4 = (r30 + 22304);
    r5 = (r29 + 16640);
    r6 = (r28 + 16712);
    ...
    MemoryInline::FlatWriteRam8((r20 + 176), static_cast<uint8_t>(r26));
    MemoryInline::FlatWriteRam32((r20 + 180), r25);
}
...
loc_806D2E0C:
{
    ...
    r3_addr_29 = (r3 + r24);
    MemoryInline::FlatWrite32(r3_addr_29, r20);
    r3 = MemoryInline::FlatRead32((r31 + 184));
    r3_addr_30 = (r3 + r24);
...
loc_806D2E40:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32(r20, r21);
    MemoryInline::FlatWriteRam8((r20 + 176), static_cast<uint8_t>(r26));
    MemoryInline::FlatWriteRam32((r20 + 180), r25);
}
...
loc_806D2E6C:
{
    ...
    r3_addr_31 = (r3 + r24);
    MemoryInline::FlatWrite32(r3_addr_31, r20);
    r3 = MemoryInline::FlatRead32((r31 + 188));
    r3_addr_32 = (r3 + r24);
...
loc_806D2EA0:
{
    ...
    r3_rot_16 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(2));
    r3 = (r3_rot_16 & -4);
    ctx->lr = 0x806D2EC0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_806D2F0C:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32(r20, r28);
    MemoryInline::FlatWriteRam8((r20 + 176), static_cast<uint8_t>(r29));
    MemoryInline::FlatWriteRam32((r20 + 180), r30);
}
...
loc_806D2F38:
{
    ...
    r3_addr_34 = (r3 + r24);
    MemoryInline::FlatWrite32(r3_addr_34, r20);
    r3 = MemoryInline::FlatRead32((r31 + 192));
    r3_addr_35 = (r3 + r24);
...
loc_806D2F6C:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32(r20, r22);
    MemoryInline::FlatWriteRam8((r20 + 176), static_cast<uint8_t>(r29));
    MemoryInline::FlatWriteRam32((r20 + 180), r30);
}
...
loc_806D2F98:
{
    ...
    r3_addr_36 = (r3 + r24);
    MemoryInline::FlatWrite32(r3_addr_36, r20);
    r3 = MemoryInline::FlatRead32((r31 + 196));
    r3_addr_37 = (r3 + r24);
...
// RECOMP_REGISTRATION base 0x806D2908 func_806D2908 preserves=true fpr_mask=0x00000000
