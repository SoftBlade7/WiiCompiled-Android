...
extern "C" void func_805F9678(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805F9678:
{
    r3 = MemoryInline::FlatRead32((r3 + 1540));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x805F9678 func_805F9678 preserves=true fpr_mask=0x00000000
