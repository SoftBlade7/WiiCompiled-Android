...
extern "C" void func_80754104(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807541C4:
{
    MemoryInline::FlatWrite32((r31 + 344), r3);
    r3 = 124;
    ctx->lr = 0x807541D0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8075423C:
{
    ...
    MemoryInline::FlatWrite8((r31 + 452), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x80754104 func_80754104 preserves=true fpr_mask=0x00000000
