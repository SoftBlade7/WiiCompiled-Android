...
extern "C" void func_8009B180(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r31 = 0;
    MemoryInline::FlatWrite32((r30 + 240), r31);
    ctx->lr = 0x8009B220u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite8((r30 + 5), static_cast<uint8_t>(r31));
    ctx->lr = 0x8009B230u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8009B180 func_8009B180 preserves=true fpr_mask=0x00000000
