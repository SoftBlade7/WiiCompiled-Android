...
extern "C" void func_80682960(CpuContext* MKW_RESTRICT ctx)
{
    goto loc_80682960;

loc_80682960:
{
    InvokeDirectCpu<0x80684598u>(ctx);
    return;
}
...
// RECOMP_REGISTRATION base 0x80682960 func_80682960 preserves=true fpr_mask=0x00000000
