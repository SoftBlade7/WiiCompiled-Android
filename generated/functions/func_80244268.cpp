...
extern "C" void func_80244268(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_802442AC:
{
    ...
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    InvokeDirectCpu<0x8016FC38u>(ctx);
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x80244268 func_80244268 preserves=true fpr_mask=0x00000000
