...
extern "C" void func_8009EEF0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8009EEF0:
{
    ...
    r28 = r3;
    r3 = MemoryInline::FlatRead8((r6 + 32));
...
loc_8009EF7C:
{
    r3 = MemoryInline::FlatRead8((r30 + 32));
...
// RECOMP_GUEST_ABI gpr_read=0xF000003B gpr_write=0xF000007B gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8009EEF0 func_8009EEF0 preserves=true fpr_mask=0x00000000
