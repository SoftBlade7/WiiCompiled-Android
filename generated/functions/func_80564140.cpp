...
extern "C" void func_80564140(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r4_rot_0 = 0;
...
loc_80564140:
{
    ...
    r5 = r3;
    r5 = MemoryInline::FlatRead32((r5 + 128));
    ...
    r5 = (r4 + r0);
    r4 = MemoryInline::FlatRead32((r6 + 228));
...
// RECOMP_REGISTRATION base 0x80564140 func_80564140 preserves=true fpr_mask=0x00000000
