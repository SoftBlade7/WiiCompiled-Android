...
extern "C" void func_80758674(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80758748:
{
    r26 = MemoryInline::FlatRead32((r30 + 16));
...
loc_80758770:
{
    r0 = MemoryInline::FlatRead8((r26 + 376));
...
loc_8075877C:
{
    r3 = MemoryInline::FlatRead32((r26 + 348));
    r12 = MemoryInline::FlatRead32(r3);
    r12 = MemoryInline::FlatRead32((r12 + 12));
    ctr = r12;
    ctx->lr = 0x80758790u;
...
loc_80758894:
{
    r3 = MemoryInline::FlatRead32((r26 + 344));
    r12 = MemoryInline::FlatRead32(r3);
    r12 = MemoryInline::FlatRead32((r12 + 12));
    ctr = r12;
    ctx->lr = 0x807588A8u;
...
loc_80758918:
{
    r3 = MemoryInline::FlatRead32((r26 + 352));
    r12 = MemoryInline::FlatRead32(r3);
    r12 = MemoryInline::FlatRead32((r12 + 12));
    ctr = r12;
    ctx->lr = 0x8075892Cu;
...
// RECOMP_REGISTRATION base 0x80758674 func_80758674 preserves=true fpr_mask=0x00000000
