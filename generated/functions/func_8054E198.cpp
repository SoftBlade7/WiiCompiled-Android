...
extern "C" void func_8054E198(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8054E198:
{
    ...
    r22 = 0x808B0000u;
    r23 = 0x808B0000u;
    MemoryInline::FlatWrite32((r15 + 4), r3);
    r22 = (r22 + 15912);
...
loc_8054E238:
{
    ...
    MemoryInline::WriteResolved16(guest_range_2, 4u, (r3 + 4), static_cast<uint16_t>(r20));
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 8u, ((static_cast<uint64_t>(static_cast<uint32_t>(r21)) << 32) | static_cast<uint32_t>(r20)))) {
        MemoryInline::WriteResolved32(guest_range_2, 8u, (r3 + 8), r21);
        MemoryInline::WriteResolved32(guest_range_2, 12u, (r3 + 12), r20);
    }
    MemoryInline::WriteResolved32(guest_range_2, 0u, r3, r22);
    MemoryInline::WriteResolved32(guest_range_2, 40u, (r3 + 40), r17);
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r24)) << 32) | static_cast<uint32_t>(r3)))) {
        MemoryInline::WriteResolved32(guest_range_2, 28u, (r3 + 28), r3);
        MemoryInline::WriteResolved32(guest_range_2, 24u, (r3 + 24), r24);
    }
    MemoryInline::WriteResolved16(guest_range_2, 16u, (r3 + 16), static_cast<uint16_t>(r25));
    r3 = 10;
    ctx->lr = 0x8054E260u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r19 + 20), r3);
    r4 = (r26 + -1);
    r0 = MemoryInline::FlatRead16((r23 + 15736));
}
...
loc_8054E270:
{
    ...
    r3 = 0;
    r6 = MemoryInline::FlatRead16((r24 + 28));
    r0_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(1));
    r0 = (r0_rot_2 & -2);
    guest_range_3 = MemoryInline::ResolveRangeHost((r19 + 20), 0, 4u, true, false);
    r7 = MemoryInline::ReadResolved32(guest_range_3, 0u, (r19 + 20));
    r8_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r6), static_cast<uint32_t>(1));
    r8 = (r8_rot_2 & -2);
    r6 = MemoryInline::FlatRead16((r24 + 84));
    MemoryInline::FlatWrite16((r7 + 2), static_cast<uint16_t>(r4));
    r5 = MemoryInline::FlatRead16((r24 + 56));
    r6_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r6), static_cast<uint32_t>(1));
    r6 = (r6_rot_2 & -2);
    r9 = MemoryInline::ReadResolved32(guest_range_3, 0u, (r19 + 20));
    r7_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(1));
    r7 = (r7_rot_2 & -2);
    r5 = MemoryInline::FlatRead16((r24 + 112));
    MemoryInline::FlatWrite16((r9 + 4), static_cast<uint16_t>(r4));
    r5_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(1));
    r5 = (r5_rot_2 & -2);
    r9 = MemoryInline::ReadResolved32(guest_range_3, 0u, (r19 + 20));
    MemoryInline::FlatWrite16((r9 + 6), static_cast<uint16_t>(r4));
    r9 = MemoryInline::ReadResolved32(guest_range_3, 0u, (r19 + 20));
    MemoryInline::FlatWrite16((r9 + 8), static_cast<uint16_t>(r4));
    r4 = MemoryInline::ReadResolved32(guest_range_3, 0u, (r19 + 20));
    r4_addr_2 = (r4 + r0);
    MemoryInline::FlatWrite16(r4_addr_2, static_cast<uint16_t>(r20));
    r0 = 3;
    r4 = MemoryInline::ReadResolved32(guest_range_3, 0u, (r19 + 20));
    r4_addr_3 = (r4 + r8);
    MemoryInline::FlatWrite16(r4_addr_3, static_cast<uint16_t>(r27));
    r4 = MemoryInline::ReadResolved32(guest_range_3, 0u, (r19 + 20));
    r4_addr_4 = (r4 + r7);
    MemoryInline::FlatWrite16(r4_addr_4, static_cast<uint16_t>(r14));
    r4 = MemoryInline::ReadResolved32(guest_range_3, 0u, (r19 + 20));
    r4_addr_5 = (r4 + r6);
    MemoryInline::FlatWrite16(r4_addr_5, static_cast<uint16_t>(r0));
    r4 = MemoryInline::ReadResolved32(guest_range_3, 0u, (r19 + 20));
    r4_addr_6 = (r4 + r5);
    MemoryInline::FlatWrite16(r4_addr_6, static_cast<uint16_t>(r28));
...
loc_8054E2F4:
{
    if ((static_cast<int32_t>(r17) >= static_cast<int32_t>(r0))) {
        goto loc_8054E2FC;
    }
}
...
loc_8054E328:
{
    ...
    MemoryInline::FlatWriteRamFloat32((r19 + 44), f0.d);
    if (((cr & 0x80000000u) != 0)) {
        goto loc_8054E350;
    }
}
...
loc_8054E36C:
{
    ...
    f0.d = MemoryInline::FlatReadFloat64((r1 + 8));
    f0.d = static_cast<double>(PpcForceSingleValueInline(f0.d - f31.d));
    MemoryInline::FlatWriteRamFloat32((r19 + 48), f0.d);
    MemoryInline::FlatWriteRam32((r19 + 8), r28);
}
...
loc_8054E38C:
{
    ...
    r17 = (r17 + 1);
    r3_addr_4 = (r3 + r18);
    MemoryInline::FlatWrite32(r3_addr_4, r19);
    r18 = (r18 + 4);
}
...
// RECOMP_REGISTRATION base 0x8054E198 func_8054E198 preserves=false fpr_mask=0x80000000
