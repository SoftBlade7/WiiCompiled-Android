...
extern "C" void func_806BCB28(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806BCB28:
{
    ...
    r5 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r31 + -3288));
    r4 = 5;
...
// RECOMP_REGISTRATION base 0x806BCB28 func_806BCB28 preserves=true fpr_mask=0x00000000
