...
extern "C" void func_807D6E60(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807D6E60:
{
    ...
    r0 = (r3 + 276);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r3)) + static_cast<uint64_t>(static_cast<uint32_t>(276)) + (static_cast<uint64_t>(static_cast<uint32_t>(0)) & 1u);
...
// RECOMP_REGISTRATION base 0x807D6E60 func_807D6E60 preserves=true fpr_mask=0x00000000
