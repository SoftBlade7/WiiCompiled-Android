...
extern "C" void func_80104648(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80104724:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r5 = MemoryInline::FlatRead32((r28 + 416));
    r3 = r30;
    r4 = (r31 + 52);
    ctx->lr = 0x80104754u;
    ctx->gpr[0] = r0;
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead32((r28 + 1492));
    goto loc_801047DC;
}
...
loc_801048C4:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80103534u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80104944:
{
    ...
    r3 = r30;
    r5 = MemoryInline::FlatRead16((r31 + 12));
    r6 = (r31 + 52);
    r7 = (r1 + 20);
    r8 = 1;
    ctx->lr = 0x80104960u;
...
// RECOMP_REGISTRATION base 0x80104648 func_80104648 preserves=true fpr_mask=0x00000000
