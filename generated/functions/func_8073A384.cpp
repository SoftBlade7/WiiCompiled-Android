...
extern "C" void func_8073A384(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lhax_8073A440_loc_0 = 0;
    uint32_t addr_lhax_8073A44C_loc_0 = 0;
    uint32_t cr0_0 = 0;
...
loc_8073A400:
{
    ...
    addr_lhax_8073A440_loc_0 = (r4 + r3);
    r3 = MemoryInline::FlatRead16(addr_lhax_8073A440_loc_0);
    r3 = (r3 << 16);
    ...
    addr_lhax_8073A44C_loc_0 = (r3 + r0);
    r0 = MemoryInline::FlatRead16(addr_lhax_8073A44C_loc_0);
    r0 = (r0 << 16);
...
loc_8073A4CC:
{
    f1.d = MemoryInline::FlatReadFloat32((r27 + -20516));
...
// RECOMP_REGISTRATION base 0x8073A384 func_8073A384 preserves=true fpr_mask=0x00000000
