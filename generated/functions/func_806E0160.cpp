...
extern "C" void func_806E0160(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806E0184:
{
    r5 = MemoryInline::FlatRead32((r31 + 212));
    r6 = 0x808C0000u;
    r4 = MemoryInline::FlatRead32((r31 + 8));
    r5 = MemoryInline::FlatRead32((r5 + 8));
    f1.d = MemoryInline::FlatReadFloat32((r6 + 26668));
...
// RECOMP_REGISTRATION base 0x806E0160 func_806E0160 preserves=true fpr_mask=0x00000000
