...
extern "C" void func_807F8878(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807F8878:
{
    ...
    r5 = 0x808B0000u;
    r4 = 1;
    f1.d = MemoryInline::FlatReadFloat32((r5 + -22444));
    ctx->lr = 0x807F88A0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x807F8878 func_807F8878 preserves=true fpr_mask=0x00000000
