...
extern "C" void func_801A88F0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801A892C:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801AE06Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x801A88F0 func_801A88F0 preserves=true fpr_mask=0x00000000
