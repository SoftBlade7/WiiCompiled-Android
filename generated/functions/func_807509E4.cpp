...
extern "C" void func_807509E4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807509E4:
{
    ...
    guest_range_0 = MemoryInline::ResolveRangeHost(r29, 0, 76u, false, true);
    ...
    f1.d = MemoryInline::FlatReadFloat32((r30 + 624));
    r3 = (r29 + 36);
    f0.d = MemoryInline::FlatReadFloat32((r30 + 712));
    r4 = (r31 + 13824);
    MemoryInline::WriteResolvedFloat32(guest_range_0, 36u, (r29 + 36), f1.d);
    r5 = (r29 + 24);
    ...
    f1.d = MemoryInline::FlatReadFloat32((r30 + 624));
    r3 = (r29 + 60);
    f0.d = MemoryInline::FlatReadFloat32((r30 + 628));
    r4 = (r31 + 13824);
    MemoryInline::WriteResolvedFloat32(guest_range_0, 60u, (r29 + 60), f1.d);
    r5 = (r29 + 48);
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 64u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f1.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 64u, (r3 + 4), f0.d);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 68u, (r3 + 8), f1.d);
    }
    // inline leaf 0x8088F334 (7 guest instruction(s))
    r6 = 0x809C0000u;
    r0 = MemoryInline::FlatRead32((r6 + 19592));
    ...
    r3 = 0x808D0000u;
    r4 = 90;
    r0 = MemoryInline::FlatRead32((r3 + -17056));
...
// RECOMP_REGISTRATION base 0x807509E4 func_807509E4 preserves=true fpr_mask=0x00000000
