...
extern "C" void func_80643218(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r0 = 1;
    MemoryInline::FlatWrite32((r3 + 5788), r0);
    r3 = (r3 + 88);
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead32((r31 + 5788));
...
loc_806433B4:
{
    r26 = MemoryInline::FlatRead32((r1 + 200));
    r27 = MemoryInline::FlatRead32((r1 + 204));
...
// RECOMP_REGISTRATION base 0x80643218 func_80643218 preserves=true fpr_mask=0x00000000
