...
extern "C" void func_8000B154(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8000B154:
{
    ...
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x801A856Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
...
// RECOMP_REGISTRATION base 0x8000B154 func_8000B154 preserves=true fpr_mask=0x00000000
