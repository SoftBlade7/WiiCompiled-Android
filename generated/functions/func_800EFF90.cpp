...
extern "C" void func_800EFF90(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800EFFB8:
{
    ...
    r31_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(2));
    r31 = (r31_rot_1 & -4);
...
// RECOMP_REGISTRATION base 0x800EFF90 func_800EFF90 preserves=true fpr_mask=0x00000000
