...
extern "C" void func_806ABB5C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806ABB90:
{
    ...
    r0 = MemoryInline::FlatRead8((r29 + 297));
}
...
loc_806ABC38:
{
    ...
    xer = ctx->xer;
    mkw_gqr0 = ctx->gqr[0];
    r30 = MemoryInline::FlatRead32((r29 + 344));
...
// RECOMP_REGISTRATION base 0x806ABB5C func_806ABB5C preserves=false fpr_mask=0x80000000
