...
extern "C" void func_805C9534(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805C9534:
{
    ...
    r31 = ctx->gpr[31];
    r0 = 0;
    MemoryInline::FlatWrite32((r31 + 1972), r0);
    r3 = r31;
...
// RECOMP_REGISTRATION base 0x805C9534 func_805C9534 preserves=true fpr_mask=0x00000000
