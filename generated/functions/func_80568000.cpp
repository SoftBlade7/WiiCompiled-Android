...
extern "C" void func_80568000(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80568000:
{
    ...
    ctx->gpr[31] = r31;
    ctx->fpr[1] = f1;
    InvokeDirectCpu<0x80567D3Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80568000 func_80568000 preserves=true fpr_mask=0x00000000
