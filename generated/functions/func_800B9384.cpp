...
extern "C" void func_800B9384(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800B9384:
{
    ...
    r15 = MemoryInline::ReadResolved8(guest_range_1, 24u, (r3 + 24));
    MemoryInline::FlatWriteRam32((r1 + 188), r15);
    r15 = MemoryInline::ReadResolved8(guest_range_1, 25u, (r3 + 25));
    r0 = MemoryInline::ReadResolved8(guest_range_1, 22u, (r3 + 22));
    ...
    r15 = MemoryInline::ReadResolved32(guest_range_1, 72u, (r3 + 72));
    MemoryInline::FlatWriteRam8((r1 + 72), static_cast<uint8_t>(r0));
    ...
    r16 = MemoryInline::ReadResolved8(guest_range_1, 0u, r3);
    r17 = MemoryInline::ReadResolved8(guest_range_1, 1u, (r3 + 1));
    r18 = MemoryInline::ReadResolved8(guest_range_1, 2u, (r3 + 2));
    r19 = MemoryInline::ReadResolved8(guest_range_1, 3u, (r3 + 3));
    r20 = MemoryInline::ReadResolved8(guest_range_1, 4u, (r3 + 4));
    r21 = MemoryInline::ReadResolved8(guest_range_1, 5u, (r3 + 5));
    r22 = MemoryInline::ReadResolved8(guest_range_1, 6u, (r3 + 6));
    r23 = MemoryInline::ReadResolved8(guest_range_1, 7u, (r3 + 7));
    r24 = MemoryInline::ReadResolved8(guest_range_1, 8u, (r3 + 8));
    r25 = MemoryInline::ReadResolved8(guest_range_1, 9u, (r3 + 9));
    r26 = MemoryInline::ReadResolved8(guest_range_1, 10u, (r3 + 10));
    r27 = MemoryInline::ReadResolved8(guest_range_1, 11u, (r3 + 11));
    r28 = MemoryInline::ReadResolved8(guest_range_1, 12u, (r3 + 12));
    r29 = MemoryInline::ReadResolved8(guest_range_1, 13u, (r3 + 13));
    r30 = MemoryInline::ReadResolved8(guest_range_1, 14u, (r3 + 14));
    r31 = MemoryInline::ReadResolved8(guest_range_1, 15u, (r3 + 15));
    r12 = MemoryInline::ReadResolved8(guest_range_1, 16u, (r3 + 16));
    r11 = MemoryInline::ReadResolved8(guest_range_1, 17u, (r3 + 17));
    r10 = MemoryInline::ReadResolved8(guest_range_1, 18u, (r3 + 18));
    r9 = MemoryInline::ReadResolved8(guest_range_1, 19u, (r3 + 19));
    r8 = MemoryInline::ReadResolved8(guest_range_1, 20u, (r3 + 20));
    r7 = MemoryInline::ReadResolved8(guest_range_1, 21u, (r3 + 21));
    r14 = MemoryInline::ReadResolved8(guest_range_1, 23u, (r3 + 23));
    f2.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 68u, (r3 + 68));
    {
        ...
        if (resolved_pair.valid) {
            ...
            f1.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 76u, (r3 + 76));
    ...
    MemoryInline::FlatWriteRam8((r1 + 8), static_cast<uint8_t>(r16));
    MemoryInline::FlatWriteRam8((r1 + 9), static_cast<uint8_t>(r17));
    MemoryInline::FlatWriteRam8((r1 + 10), static_cast<uint8_t>(r18));
    MemoryInline::FlatWriteRam8((r1 + 11), static_cast<uint8_t>(r19));
    MemoryInline::FlatWriteRam8((r1 + 12), static_cast<uint8_t>(r20));
    MemoryInline::FlatWriteRam8((r1 + 13), static_cast<uint8_t>(r21));
    MemoryInline::FlatWriteRam8((r1 + 14), static_cast<uint8_t>(r22));
    MemoryInline::FlatWriteRam8((r1 + 15), static_cast<uint8_t>(r23));
    MemoryInline::FlatWriteRam8((r1 + 16), static_cast<uint8_t>(r24));
    MemoryInline::FlatWriteRam8((r1 + 17), static_cast<uint8_t>(r25));
    MemoryInline::FlatWriteRam8((r1 + 18), static_cast<uint8_t>(r26));
    MemoryInline::FlatWriteRam8((r1 + 19), static_cast<uint8_t>(r27));
    MemoryInline::FlatWriteRam8((r1 + 20), static_cast<uint8_t>(r28));
    MemoryInline::FlatWriteRam8((r1 + 21), static_cast<uint8_t>(r29));
    MemoryInline::FlatWriteRam8((r1 + 22), static_cast<uint8_t>(r30));
    MemoryInline::FlatWriteRam8((r1 + 23), static_cast<uint8_t>(r31));
    MemoryInline::FlatWriteRam8((r1 + 24), static_cast<uint8_t>(r12));
    MemoryInline::FlatWriteRam8((r1 + 25), static_cast<uint8_t>(r11));
    MemoryInline::FlatWriteRam8((r1 + 26), static_cast<uint8_t>(r10));
    MemoryInline::FlatWriteRam8((r1 + 27), static_cast<uint8_t>(r9));
    MemoryInline::FlatWriteRam8((r1 + 28), static_cast<uint8_t>(r8));
    MemoryInline::FlatWriteRam8((r1 + 29), static_cast<uint8_t>(r7));
    MemoryInline::FlatWriteRam8((r1 + 31), static_cast<uint8_t>(r14));
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFE07E gpr_write=0xFFFFFFFF gpr_return=0x00000018 fpr_read=0xFFFFFFF8 fpr_write=0xFFFFFFFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x800B9384 func_800B9384 preserves=true fpr_mask=0x00000000
