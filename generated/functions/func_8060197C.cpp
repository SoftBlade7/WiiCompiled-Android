...
extern "C" void func_8060197C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8060197C:
{
    ...
    r0 = 6;
    MemoryInline::WriteResolved32(guest_range_1, 20u, (r30 + 56), r31);
    r3 = r30;
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r31)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_1, 24u, (r30 + 60), r31);
        MemoryInline::WriteResolved32(guest_range_1, 28u, (r30 + 64), r0);
    }
...
// RECOMP_REGISTRATION base 0x8060197C func_8060197C preserves=true fpr_mask=0x00000000
