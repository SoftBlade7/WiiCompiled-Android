...
extern "C" void func_807FF17C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807FF1F4:
{
    ...
    MemoryInline::FlatWrite32((r3 + 260), r0);
    r3 = r30;
    f1.d = MemoryInline::FlatReadFloat32((r4 + -21184));
    r4 = 714;
    ctx->lr = 0x807FF210u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_807FF228:
{
    f31.d = MemoryInline::FlatReadFloat32((r3 + 268));
    goto loc_807FF284;
}
...
loc_807FF230:
{
    ...
    f3.d = MemoryInline::FlatReadFloat64((r1 + 184));
...
loc_807FF290:
{
    ...
    MemoryInline::FlatWrite8((r30 + 84), static_cast<uint8_t>(r4));
    r0 = (r0 | 4);
    ...
    r0 = (r0 | 2);
    MemoryInline::FlatWrite16((r30 + 44), static_cast<uint16_t>(r0));
    MemoryInline::FlatWrite8((r30 + 84), static_cast<uint8_t>(r31));
...
// RECOMP_REGISTRATION base 0x807FF17C func_807FF17C preserves=false fpr_mask=0x80000000
