...
extern "C" void func_801630D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8016315C:
{
    ...
    r30 = 1;
    r0_addic_src_1 = r0;
    r0 = (r0_addic_src_1 + 12812);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r0_addic_src_1)) + static_cast<uint64_t>(static_cast<uint32_t>(12812)) + (static_cast<uint64_t>(static_cast<uint32_t>(0)) & 1u);
...
loc_801631C8:
{
    r0 = MemoryInline::FlatRead32((r13 + -25988));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
// RECOMP_REGISTRATION base 0x801630D0 func_801630D0 preserves=true fpr_mask=0x00000000
