...
extern "C" void func_80089BB0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80089BB0:
{
    ...
    MemoryInline::WriteResolved16(guest_range_0, 10u, (r3 + 10), static_cast<uint16_t>(r5));
    ...
    MemoryInline::WriteResolved8(guest_range_0, 29u, (r3 + 29), static_cast<uint8_t>(r5));
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 56u, ((static_cast<uint64_t>(static_cast<uint32_t>(r5)) << 32) | static_cast<uint32_t>(r5)))) {
        MemoryInline::WriteResolved32(guest_range_0, 56u, (r3 + 56), r5);
        MemoryInline::WriteResolved32(guest_range_0, 60u, (r3 + 60), r5);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 64u, ((static_cast<uint64_t>(static_cast<uint32_t>(r5)) << 32) | static_cast<uint32_t>(r5)))) {
...
// RECOMP_REGISTRATION base 0x80089BB0 func_80089BB0 preserves=true fpr_mask=0x00000000
