...
extern "C" void func_8052CB10(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8052CB10:
{
    ...
    r31 = r4;
    r4 = (r1 + 8);
    r3 = MemoryInline::FlatRead32((r3 + 12864));
    ctx->lr = 0x8052CB34u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8052CB10 func_8052CB10 preserves=true fpr_mask=0x00000000
