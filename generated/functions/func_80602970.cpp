...
extern "C" void func_80602970(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r3 = 0x80890000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 26660));
    goto loc_806029C4;
}
...
{
    r3 = 0x80890000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 26664));
}
...
// RECOMP_REGISTRATION base 0x80602970 func_80602970 preserves=true fpr_mask=0x00000000
