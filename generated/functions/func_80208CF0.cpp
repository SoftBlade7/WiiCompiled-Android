...
extern "C" void func_80208CF0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80208D2C:
{
    ...
    ctx->gpr[4] = r4;
    ctx->cr = cr;
    InvokeDirectCpu<0x8020B22Cu>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    cr = ctx->cr;
    r31 = r3;
...
// RECOMP_REGISTRATION base 0x80208CF0 func_80208CF0 preserves=true fpr_mask=0x00000000
