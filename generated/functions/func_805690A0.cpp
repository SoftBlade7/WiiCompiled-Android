...
extern "C" void func_805690A0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805691B4:
{
    ...
    guest_range_0 = MemoryInline::ResolveRangeHost((r28 + 84), 0, 56u, false, true);
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 4u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f1.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f1.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 8u, (r28 + 92), f1.d);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 4u, (r28 + 88), f1.d);
    }
    MemoryInline::WriteResolvedFloat32(guest_range_0, 0u, (r28 + 84), f0.d);
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 40u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f1.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f1.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 40u, (r28 + 124), f1.d);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 44u, (r28 + 128), f1.d);
    }
    MemoryInline::WriteResolvedFloat32(guest_range_0, 48u, (r28 + 132), f1.d);
    // inline leaf 0x8059020C (6 guest instruction(s))
    r3 = MemoryInline::FlatRead32(r3);
    r3 = MemoryInline::FlatRead32((r3 + 8));
    r3 = MemoryInline::FlatRead32((r3 + 144));
    ...
    f0.d = MemoryInline::FlatReadFloat32((r3 + 4));
    r3 = 0x802A0000u;
    MemoryInline::WriteResolvedFloat32(guest_range_0, 52u, (r28 + 136), f0.d);
    r7 = 0x802A0000u;
    r8 = (r3 + 16664);
    f1.d = MemoryInline::FlatReadFloat32((r31 + 4));
    f0.d = MemoryInline::FlatReadFloat32((r3 + 16664));
    r6 = (r7 + 16712);
    MemoryInline::WriteResolvedFloat32(guest_range_0, 12u, (r28 + 96), f0.d);
    r3 = r28;
    r4 = r30;
    r5 = 1;
    f0.d = MemoryInline::FlatReadFloat32((r8 + 4));
    MemoryInline::WriteResolvedFloat32(guest_range_0, 16u, (r28 + 100), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r8 + 8));
    MemoryInline::WriteResolvedFloat32(guest_range_0, 20u, (r28 + 104), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r7 + 16712));
    MemoryInline::WriteResolvedFloat32(guest_range_0, 24u, (r28 + 108), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r6 + 4));
    MemoryInline::WriteResolvedFloat32(guest_range_0, 28u, (r28 + 112), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r6 + 8));
    MemoryInline::WriteResolvedFloat32(guest_range_0, 32u, (r28 + 116), f0.d);
    ctx->lr = 0x80569270u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->fpr[1] = f1;
    ctx->cr = cr;
    InvokeDirectCpu<0x80590E70u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
    ...
    cr = ctx->cr;
    r0 = 0;
    MemoryInline::FlatWrite16((r28 + 244), static_cast<uint16_t>(r0));
...
// RECOMP_REGISTRATION base 0x805690A0 func_805690A0 preserves=true fpr_mask=0x00000000
