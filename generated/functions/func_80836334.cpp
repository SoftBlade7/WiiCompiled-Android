...
extern "C" void func_80836334(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80836334:
{
    ...
    r29 = r3;
    r4 = (r29 + 40);
    guest_range_0 = MemoryInline::ResolveRangeHost((r3 + 16), 0, 56u, false, true);
    MemoryInline::WriteResolvedFloat32(guest_range_0, 0u, (r3 + 16), f1.d);
    f1.d = MemoryInline::FlatReadFloat32(r5);
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 4u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f2.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f0.d))))) {
    ...
    r4 = r30;
    MemoryInline::WriteResolvedFloat32(guest_range_0, 44u, (r29 + 60), f0.d);
    r3 = (r1 + 80);
    f1.d = MemoryInline::FlatReadFloat32((r29 + 36));
    r5 = (r29 + 60);
    f0.d = MemoryInline::FlatReadFloat32((r1 + 96));
    MemoryInline::WriteResolvedFloat32(guest_range_0, 48u, (r29 + 64), f0.d);
    ...
    MemoryInline::WriteResolvedFloat32(guest_range_0, 52u, (r29 + 68), f3.d);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 36u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f2.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 40u, (r29 + 56), f2.d);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 36u, (r29 + 52), f0.d);
    }
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_GUEST_ABI gpr_read=0xE000007A gpr_write=0xE000003B gpr_return=0x00000018 fpr_read=0x00001040 fpr_write=0x00001F7F fpr_return=0x00000002 cr_read=0x00 cr_write=0x00 xer_read=0 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80836334 func_80836334 preserves=true fpr_mask=0x00000000
