...
extern "C" void func_8080BEE4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8080BEE4:
{
    ...
    MemoryInline::WriteResolvedFloat32(guest_range_3, 32u, (r1 + 32), f27.d);
    r24 = 0x802A0000u;
    r4 = (r1 + 80);
    r5 = (r1 + 32);
    MemoryInline::WriteResolvedFloat32(guest_range_3, 36u, (r1 + 36), f27.d);
    r6 = (r24 + 16640);
    MemoryInline::WriteResolvedFloat32(guest_range_3, 40u, (r1 + 40), f27.d);
...
loc_8080C218:
{
    ...
    // end of inlined leaf 0x802302C4
    MemoryInline::WriteResolvedFloat32(guest_range_5, 0u, (r1 + 8), f30.d);
    r4 = (r1 + 80);
    r5 = (r1 + 8);
    r6 = (r24 + 16640);
    if (!MemoryInline::WriteResolvedPair32(guest_range_5, 4u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f29.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f30.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_5, 4u, (r1 + 12), f29.d);
        MemoryInline::WriteResolvedFloat32(guest_range_5, 8u, (r1 + 16), f30.d);
    }
    r3 = MemoryInline::FlatRead32((r28 + 172));
    r12 = MemoryInline::FlatRead32(r3);
    r12 = MemoryInline::FlatRead32((r12 + 16));
...
loc_8080C3D0:
{
    ...
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f29.d = MemoryInline::FlatReadFloat64((r1 + 272));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f28.d = MemoryInline::FlatReadFloat64((r1 + 256));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f27.d = MemoryInline::FlatReadFloat64((r1 + 240));
    r11 = (r1 + 240);
...
// RECOMP_REGISTRATION base 0x8080BEE4 func_8080BEE4 preserves=false fpr_mask=0xF8000000
