...
extern "C" void func_807070F4(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r3 = (r3 + -140);
    // inline leaf 0x807042EC (7 guest instruction(s))
    ...
    // end of inlined leaf 0x807042EC
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
...
// RECOMP_REGISTRATION base 0x807070F4 func_807070F4 preserves=true fpr_mask=0x00000000
