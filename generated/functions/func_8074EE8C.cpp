...
extern "C" void func_8074EE8C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8074EFB4:
{
    ...
    MemoryInline::FlatWriteFloat32((r29 + 168), f2.d);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_8074F034;
    }
}
...
loc_8074EFC4:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r31 + 676));
...
loc_8074F034:
{
    ...
    r3 = 0x802A0000u;
    f2.d = MemoryInline::FlatReadFloat32((r31 + 624));
    r3 = (r3 + 16664);
    f1.d = PpcFmulsInline(f28.d, f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r31 + 692));
    ...
    MemoryInline::FlatWriteRamFloat32((r1 + 72), f29.d);
...
loc_8074F138:
{
    ...
    MemoryInline::FlatWriteFloat32((r29 + 188), f1.d);
    ...
    MemoryInline::FlatWrite32((r29 + 140), r28);
    MemoryInline::FlatWriteFloat32((r29 + 252), f31.d);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_8074F194;
    }
}
...
loc_8074F174:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite8((r29 + 256), static_cast<uint8_t>(r28));
    goto loc_8074F1C8;
}
...
loc_8074F1A8:
{
    ...
    r3 = MemoryInline::FlatRead32((r3 + 40));
    f2.d = MemoryInline::FlatReadFloat32((r31 + 628));
    ctx->lr = 0x8074F1C0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_8074F1C8:
{
    ...
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 128), 0, 88u, true, false);
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 64u, (r1 + 192));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f30.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 48u, (r1 + 176));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f29.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 32u, (r1 + 160));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f28.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 16u, (r1 + 144));
    {
        ...
        if (resolved_pair.valid) {
            ...
            r31 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r1 + 140));
            r30 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r1 + 136));
        }
    }
    r29 = MemoryInline::ReadResolved32(guest_range_1, 4u, (r1 + 132));
    r0 = MemoryInline::ReadResolved32(guest_range_1, 84u, (r1 + 212));
    r28 = MemoryInline::ReadResolved32(guest_range_1, 0u, (r1 + 128));
    ctx->lr = r0;
    r1 = (r1 + 208);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x8074EE8C func_8074EE8C preserves=false fpr_mask=0xF0000000
