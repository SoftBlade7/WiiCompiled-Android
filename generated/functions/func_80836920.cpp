...
extern "C" void func_80836920(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8083692C:
{
    ...
    f5.d = MemoryInline::FlatReadFloat32((r3 + 84));
...
// RECOMP_GUEST_ABI gpr_read=0x00000018 gpr_write=0x00000009 gpr_return=0x00000008 fpr_read=0x00000000 fpr_write=0x0000007F fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80836920 func_80836920 preserves=true fpr_mask=0x00000000
