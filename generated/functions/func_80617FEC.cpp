...
extern "C" void func_80617FEC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80617FEC:
{
    ...
    f3.d = MemoryInline::FlatReadFloat32((r5 + 88));
    ctx->gpr[5] = r5;
    ctx->fpr[1] = f1;
    ctx->fpr[2] = f2;
    ctx->fpr[3] = f3;
...
// RECOMP_REGISTRATION base 0x80617FEC func_80617FEC preserves=true fpr_mask=0x00000000
