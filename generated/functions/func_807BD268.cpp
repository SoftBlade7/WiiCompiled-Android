...
extern "C" void func_807BD268(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807BD268:
{
    ...
    MemoryInline::WriteResolved8(guest_range_0, 0u, (r5 + 1), static_cast<uint8_t>(r0));
    MemoryInline::WriteResolved8(guest_range_0, 2u, (r5 + 3), static_cast<uint8_t>(r0));
    MemoryInline::WriteResolved8(guest_range_0, 3u, (r5 + 4), static_cast<uint8_t>(r3));
}
...
// RECOMP_REGISTRATION base 0x807BD268 func_807BD268 preserves=true fpr_mask=0x00000000
