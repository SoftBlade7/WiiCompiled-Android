...
extern "C" void func_80767250(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80767250:
{
    ...
    ctx->fpr[1] = f1;
    ctx->fpr[2] = f2;
    InvokeDirectCpu<0x8076EDD4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r4 = 0;
    f2.d = MemoryInline::FlatReadFloat32((r5 + 15176));
    ctx->lr = 0x80767288u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80767250 func_80767250 preserves=true fpr_mask=0x00000000
