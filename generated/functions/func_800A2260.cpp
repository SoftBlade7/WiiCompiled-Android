...
extern "C" void func_8009A920_statefree(uint32_t, uint32_t);
extern "C" void func_8009A930_statefree(uint32_t, uint32_t);

extern "C" void func_800A2260(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800A22CC:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80098CF0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800A22EC:
{
    ...
    r5 = (r1 + 8);
    // inline leaf 0x80097320 (15 guest instruction(s))
}
...
loc_inl2_0x8009732C:
{
    if ((static_cast<uint32_t>(r0) == static_cast<uint32_t>(254))) {
        goto loc_inl2_0x80097340;
    }
}
...
loc_inl2_cont_80097320:
{
    // end of inlined leaf 0x80097320
...
loc_800A2374:
{
    r3 = MemoryInline::FlatRead32((r22 + 16));
    r5 = (r31 + 660);
    r4 = MemoryInline::FlatRead32(r23);
    r6 = 512;
    ctx->lr = 0x800A2388u;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8009E010u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
...
loc_800A239C:
{
    ...
    r30 = r3;
    r3 = r29;
    // inline leaf 0x80097FF0 (4 guest instruction(s))
    r4 = MemoryInline::FlatRead32((r3 + 20));
    r0 = MemoryInline::FlatRead32((r3 + 16));
    r3 = (r0 - r4);
    // end of inlined leaf 0x80097FF0
...
loc_800A23DC:
{
    r4 = MemoryInline::FlatRead32((r22 + 44));
    r3 = r31;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8009A550u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
...
loc_800A243C:
{
    r3 = MemoryInline::FlatRead32((r22 + 64));
    r3 = (r3 + -224);
}
...
loc_800A24A0:
{
    r4 = MemoryInline::FlatRead32((r23 + 16));
    r0 = 1127219200;
...
{
    if (((cr & 0x40000000u) == 0)) {
        goto loc_inl4_0x8008F540;
    }
}

loc_inl4_0x8008F53C:
{
    goto loc_inl4_0x8008F554;
}
...
loc_inl4_cont_8008F530:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead32((r23 + 28));
    r3 = r31;
    ctx->lr = 0x800A24F4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    r3 = r31;
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x8009A920u) && KnownTranslatedCpuCall<0x8009A920u>::kAvailable && !KnownTranslatedCpuCall<0x8009A920u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x8009A920u>()) {
        func_8009A920_statefree(r3, r4);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
        ...
        ctx->cr = cr;
        ctx->ctr = ctr;
        InvokeDirectCpu<0x8009A920u>(ctx);
        r0 = ctx->gpr[0];
        r1 = ctx->gpr[1];
        r2 = ctx->gpr[2];
        r3 = ctx->gpr[3];
    ...
    r4 = MemoryInline::FlatRead8((r24 + 16));
    r3 = r31;
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x8009A930u) && KnownTranslatedCpuCall<0x8009A930u>::kAvailable && !KnownTranslatedCpuCall<0x8009A930u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x8009A930u>()) {
        func_8009A930_statefree(r3, r4);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
        ...
        ctx->cr = cr;
        ctx->ctr = ctr;
        InvokeDirectCpu<0x8009A930u>(ctx);
        r0 = ctx->gpr[0];
        r1 = ctx->gpr[1];
        r2 = ctx->gpr[2];
        r3 = ctx->gpr[3];
...
loc_800A2554:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8009A5D0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
...
loc_800A2584:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8009A640u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
...
// RECOMP_REGISTRATION base 0x800A2260 func_800A2260 preserves=true fpr_mask=0x00000000
