...
extern "C" void func_801302FC(CpuContext* MKW_RESTRICT ctx)
{
    goto loc_801302FC;

loc_801302FC:
{
    InvokeDirectCpu<0x801CBA28u>(ctx);
    return;
}
...
// RECOMP_REGISTRATION base 0x801302FC func_801302FC preserves=true fpr_mask=0x00000000
