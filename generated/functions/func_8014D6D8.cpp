...
extern "C" void func_8014D6D8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8014D7FC:
{
    if ((static_cast<uint32_t>(r17) != static_cast<uint32_t>(2))) {
        goto loc_8014D724;
    }
}
...
// RECOMP_REGISTRATION base 0x8014D6D8 func_8014D6D8 preserves=true fpr_mask=0x00000000
