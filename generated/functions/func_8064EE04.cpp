...
extern "C" void func_8064EE04(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8064EE28:
{
    r5 = MemoryInline::FlatRead32((r3 + 2232));
    r4 = 0x808A0000u;
...
// RECOMP_REGISTRATION base 0x8064EE04 func_8064EE04 preserves=true fpr_mask=0x00000000
