...
extern "C" void func_806E56C4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806E574C:
{
    ...
    r31 = ctx->gpr[31];
    cr = ctx->cr;
    r4 = MemoryInline::FlatRead32((r31 + 1100));
    r3 = MemoryInline::FlatRead32((r31 + 220));
    r0 = (r4 + -1);
    r4 = (r0 & 255);
    ctx->lr = 0x806E57B0u;
    ...
    f4 = ctx->fpr[4];
    cr = ctx->cr;
    f1.d = MemoryInline::FlatReadFloat32((r28 + 136));
    r3 = (r1 + 20);
    r4 = (r1 + 92);
    // inline leaf 0x80514810 (10 guest instruction(s))
    f3.d = MemoryInline::FlatReadFloat32((r4 + 8));
...
loc_806E5848:
{
    r0 = MemoryInline::FlatRead32((r31 + 1100));
    r5 = (r1 + 80);
    r3 = MemoryInline::FlatRead32((r31 + 220));
    r4 = (r0 & 255);
    ctx->lr = 0x806E585Cu;
...
loc_806E58B0:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x806F5440u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->fpr[4] = f4;
    ctx->cr = cr;
    InvokeDirectCpu<0x806E8014u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
{
    f3.d = MemoryInline::FlatReadFloat32((r1 + 104));
    f2.d = MemoryInline::FlatReadFloat32((r31 + 1140));
    f1.d = MemoryInline::FlatReadFloat32((r1 + 108));
    f2.d = static_cast<double>(PpcForceSingleValueInline(f3.d - f2.d));
    f0.d = MemoryInline::FlatReadFloat32((r31 + 1144));
    f3.d = MemoryInline::FlatReadFloat32((r1 + 112));
    f4.d = static_cast<double>(PpcForceSingleValueInline(f1.d - f0.d));
    f1.d = MemoryInline::FlatReadFloat32((r31 + 1148));
    f2.d = PpcFmulsInline(f2.d, f2.d);
    f3.d = static_cast<double>(PpcForceSingleValueInline(f3.d - f1.d));
    f0.d = MemoryInline::FlatReadFloat32((r31 + 1308));
    f1.d = PpcFmulsInline(f4.d, f4.d);
...
// RECOMP_REGISTRATION base 0x806E56C4 func_806E56C4 preserves=true fpr_mask=0x00000000
