...
extern "C" void func_80241380(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8024143C:
{
    if ((static_cast<uint32_t>(r31) < static_cast<uint32_t>(16))) {
        goto loc_802413A0;
    }
}
...
loc_80241440:
{
    r5 = MemoryInline::FlatRead8((r2 + -24248));
    r30 = 0;
    r4 = MemoryInline::FlatRead8((r2 + -24247));
    r3 = MemoryInline::FlatRead8((r2 + -24246));
    r0 = MemoryInline::FlatRead8((r2 + -24245));
...
// RECOMP_GUEST_ABI gpr_read=0xC00001FE gpr_write=0xC00001FB gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80241380 func_80241380 preserves=true fpr_mask=0x00000000
