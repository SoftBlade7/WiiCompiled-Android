...
extern "C" void func_80640F74(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80640F74:
{
    ...
    r29 = r3;
    r0 = MemoryInline::FlatRead32((r3 + 1132));
...
loc_80640FA4:
{
    ...
    r3 = MemoryInline::FlatRead32((r29 + 1132));
    r12 = MemoryInline::FlatRead32(r3);
    r12 = MemoryInline::FlatRead32((r12 + 104));
    ctr = r12;
    ctx->lr = 0x80640FECu;
...
// RECOMP_REGISTRATION base 0x80640F74 func_80640F74 preserves=true fpr_mask=0x00000000
