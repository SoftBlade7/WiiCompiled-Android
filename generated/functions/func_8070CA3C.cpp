...
extern "C" void func_8070CA3C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8070CA3C:
{
    r3 = (r3 + -148);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x807092B4u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8070CA3C func_8070CA3C preserves=true fpr_mask=0x00000000
