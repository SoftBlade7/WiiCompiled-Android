...
extern "C" void func_807071CC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807071CC:
{
    r3 = (r3 + -136);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80705354u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x807071CC func_807071CC preserves=true fpr_mask=0x00000000
