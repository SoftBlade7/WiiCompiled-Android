...
extern "C" void func_807A0040(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807A0040:
{
    ...
    r6 = (r12 * 116);
    f2.d = MemoryInline::FlatReadFloat32((r11 + 21016));
    r23 = r4;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r27 + 164), r3);
...
{
    r12 = r25;
    r3 = MemoryInline::FlatRead32((r27 + 164));
    ctr = r12;
    ctx->lr = 0x807A00FCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_807A0110:
{
    r5 = MemoryInline::FlatRead32((r27 + 164));
    r6 = r26;
    r4 = 11;
    ctx->lr = 0x807A0120u;
    ctx->gpr[0] = r0;
...
loc_807A0120:
{
    MemoryInline::FlatWrite32((r27 + 156), r3);
    r0 = 0;
...
loc_807A019C:
{
    r4 = MemoryInline::FlatRead32((r27 + 156));
    r5 = 0;
...
loc_807A0210:
{
    ...
    r4 = 1;
    MemoryInline::FlatWrite16((r3 + 290), static_cast<uint16_t>(r0));
    r3 = MemoryInline::FlatRead32(r28);
...
loc_807A0280:
{
    r4 = MemoryInline::FlatRead32((r27 + 164));
    r5 = 0;
    r6 = 0;
    ctx->lr = 0x807A0290u;
    ctx->gpr[0] = r0;
...
loc_807A0290:
{
    MemoryInline::FlatWrite32((r27 + 160), r3);
    r3 = 0x808A0000u;
    r3 = (r3 + 21156);
    r0 = 0;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r27 + 160));
    r4 = r29;
    r5 = (r1 + 20);
    r6 = 0;
    ctx->lr = 0x807A02D8u;
...
{
    r3 = 0x809C0000u;
    r4 = MemoryInline::FlatRead32((r27 + 160));
    ...
    ctx->gpr[6] = r6;
    ctx->cr = cr;
    InvokeDirectCpu<0x805B8E68u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r5 = ctx->gpr[5];
    r6 = ctx->gpr[6];
...
{
    r0 = 0;
    MemoryInline::FlatWrite32((r27 + 160), r0);
}
...
// RECOMP_REGISTRATION base 0x807A0040 func_807A0040 preserves=true fpr_mask=0x00000000
