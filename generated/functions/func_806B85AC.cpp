...
extern "C" void func_806B85AC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806B85E0:
{
    ...
    r3 = 0x808A0000u;
    f2.d = MemoryInline::FlatReadFloat32((r3 + -3668));
    r4 = 0;
...
// RECOMP_REGISTRATION base 0x806B85AC func_806B85AC preserves=true fpr_mask=0x00000000
