...
extern "C" void func_8012C1DC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r3 = 0x80280000u;
    f0.d = MemoryInline::FlatReadFloat32((r2 + -27104));
    r3 = (r3 + 7184);
    ...
    ctx->fpr[1] = f1;
    ctx->cr = cr;
    InvokeDirectCpu<0x8012C8D0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
...
// RECOMP_REGISTRATION base 0x8012C1DC func_8012C1DC preserves=true fpr_mask=0x00000000
