...
extern "C" void func_807A6F64(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807A6F64:
{
    r4 = 1;
    ctx->gpr[4] = r4;
    InvokeDirectCpu<0x807A69F8u>(ctx);
    r4 = ctx->gpr[4];
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x807A6F64 func_807A6F64 preserves=true fpr_mask=0x00000000
