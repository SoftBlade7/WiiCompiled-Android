...
extern "C" void func_800ED6B4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800ED6B4:
{
    ...
    r3 = 12;
    r5 = 0;
    r12 = MemoryInline::FlatRead32((r6 + 23348));
    ctr = r12;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
...
// RECOMP_REGISTRATION base 0x800ED6B4 func_800ED6B4 preserves=true fpr_mask=0x00000000
