...
extern "C" void func_807070FC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
{
    r3 = (r3 + -140);
    // inline leaf 0x80705710 (6 guest instruction(s))
    ...
    // end of inlined leaf 0x80705710
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[5] = r5;
    return;
...
// RECOMP_REGISTRATION base 0x807070FC func_807070FC preserves=true fpr_mask=0x00000000
