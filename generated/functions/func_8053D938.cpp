...
extern "C" void func_8053D938(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8053D938:
{
    ...
    r3 = MemoryInline::FlatRead32((r3 + 4));
    r0 = MemoryInline::FlatRead16((r3 + 470));
    r0 = (r0 << 16);
...
// RECOMP_REGISTRATION base 0x8053D938 func_8053D938 preserves=true fpr_mask=0x00000000
