...
extern "C" void func_806F3370(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_stfsx_806F3424_loc_0 = 0;
    uint32_t cr0_0 = 0;
...
loc_806F339C:
{
    ...
    addr_stfsx_806F3424_loc_0 = (r9 + r0);
    MemoryInline::FlatWriteFloat32(addr_stfsx_806F3424_loc_0, f2.d);
    r9 = (r9 + 12);
}
...
// RECOMP_REGISTRATION base 0x806F3370 func_806F3370 preserves=true fpr_mask=0x00000000
