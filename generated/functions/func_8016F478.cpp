...
extern "C" void func_8016F478(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8016F478:
{
    ...
    r0 = 74;
    MemoryInline::FlatWrite32((r5 + 576), r7);
    ...
    MemoryInline::FlatWrite32((r5 + 580), r3);
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
...
// RECOMP_REGISTRATION base 0x8016F478 func_8016F478 preserves=true fpr_mask=0x00000000
