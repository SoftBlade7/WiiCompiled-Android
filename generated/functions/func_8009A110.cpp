...
extern "C" void func_8009A110(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r3 = (r31 + r30);
    r29 = MemoryInline::FlatRead32((r3 + 276));
...
loc_8009A184:
{
    f29.d = MemoryInline::FlatReadFloat64((r2 + -28296));
    r28 = 0;
    f30.d = MemoryInline::FlatReadFloat32((r2 + -28288));
    r30 = 1127219200;
...
loc_8009A19C:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r28), static_cast<int32_t>(768));
}
...
// RECOMP_REGISTRATION base 0x8009A110 func_8009A110 preserves=false fpr_mask=0xE0000000
