...
extern "C" void func_8071D5A0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r4 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r4 + 8320));
    goto loc_8071D5E8;
}
...
{
    r4 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r4 + 8324));
}
...
// RECOMP_REGISTRATION base 0x8071D5A0 func_8071D5A0 preserves=true fpr_mask=0x00000000
