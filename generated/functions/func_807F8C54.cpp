...
extern "C" void func_807F8C54(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807F8C54:
{
    ...
    r31 = ctx->gpr[31];
    cr = ctx->cr;
    MemoryInline::FlatWrite32((r29 + 408), r3);
    r0 = 0;
    r3 = r29;
    ...
    r31 = ctx->gpr[31];
    cr = ctx->cr;
    MemoryInline::FlatWrite8((r29 + 400), static_cast<uint8_t>(r30));
    r3 = (r1 + 40);
    r4 = -1;
    ctx->lr = 0x807F8CECu;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x807F8C54 func_807F8C54 preserves=true fpr_mask=0x00000000
