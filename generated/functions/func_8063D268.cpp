...
extern "C" void func_8063D268(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8063D268:
{
    ...
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
    InvokeDirectCpu<0x805C2460u>(ctx);
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8063D268 func_8063D268 preserves=true fpr_mask=0x00000000
