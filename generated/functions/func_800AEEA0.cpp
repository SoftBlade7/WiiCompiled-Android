...
extern "C" void func_800AEEA0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800AEEA0:
{
    r3 = (r3 + -220);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x800AEDF0u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x800AEEA0 func_800AEEA0 preserves=true fpr_mask=0x00000000
