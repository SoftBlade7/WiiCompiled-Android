...
extern "C" void func_80773714(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_inl0_cont_8051BED0:
{
    ...
    r4 = 0x808A0000u;
    r3 = (r1 + 72);
    f1.d = MemoryInline::FlatReadFloat32((r4 + 16504));
    r4 = 1;
    r5 = 1;
    r6 = 0;
    f2.d = f1.d;
    ...
    r3 = 0x809C0000u;
    r30 = MemoryInline::FlatRead32((r3 + 17200));
...
loc_8077380C:
{
    MemoryInline::FlatWrite32((r30 + 92), r29);
}

loc_80773810:
{
    r29 = MemoryInline::FlatRead32((r30 + 92));
    r4 = 100;
    r5 = 1;
    r6 = 1;
    r3 = r29;
    ...
    r30 = 0x809C0000u;
    r4 = 64;
    r3 = MemoryInline::FlatRead32((r30 + 11760));
    r5 = 64;
    ...
    r3 = 0x808A0000u;
    r7 = 0;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 16504));
    r6 = 3;
...
// RECOMP_REGISTRATION base 0x80773714 func_80773714 preserves=true fpr_mask=0x00000000
