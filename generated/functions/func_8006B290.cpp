...
extern "C" void func_8006B290(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8006B290:
{
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 8u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f2.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f2.d))))) {
...
// RECOMP_REGISTRATION base 0x8006B290 func_8006B290 preserves=true fpr_mask=0x00000000
