...
extern "C" void func_80652B8C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80652B8C:
{
    ...
    r3 = 0x809C0000u;
    r5 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r5 + -24604));
    r4 = 3;
...
// RECOMP_REGISTRATION base 0x80652B8C func_80652B8C preserves=true fpr_mask=0x00000000
