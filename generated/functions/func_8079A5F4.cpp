...
extern "C" void func_8079A5F4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8079A5F4:
{
    ...
    r28 = MemoryInline::FlatRead32((r31 + 340));
    goto loc_8079A638;
}
...
loc_8079A620:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x807A7D90u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8079A5F4 func_8079A5F4 preserves=true fpr_mask=0x00000000
