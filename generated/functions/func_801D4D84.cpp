...
extern "C" void func_801D4D84(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801D4D84:
{
    ...
    MemoryInline::WriteResolved16(guest_range_0, 10u, (r1 + 10), static_cast<uint16_t>(r3));
    r3 = r30;
    r4 = (r1 + 8);
...
// RECOMP_REGISTRATION base 0x801D4D84 func_801D4D84 preserves=true fpr_mask=0x00000000
