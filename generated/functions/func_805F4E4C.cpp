...
extern "C" void func_805F4E4C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805F4EE4:
{
    ...
    MemoryInline::FlatWriteFloat32((r3 + 72), f3.d);
}
...
// RECOMP_REGISTRATION base 0x805F4E4C func_805F4E4C preserves=true fpr_mask=0x00000000
