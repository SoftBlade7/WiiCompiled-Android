...
extern "C" void func_805E9C20(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805E9C20:
{
    ...
    r30 = MemoryInline::FlatRead32((r3 + 1000));
...
loc_805E9C68:
{
    r31 = MemoryInline::FlatRead32((r31 + 944));
}
...
loc_805E9C88:
{
    ...
    ctx->gpr[6] = r6;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x80084070u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r4 = 0x80080000u;
    r3 = (r3 + -27320);
    MemoryInline::FlatWriteRam32((r31 + 28), r3);
    r25 = 0;
    r5 = 0x805F0000u;
    MemoryInline::FlatWriteRam32((r31 + 32), r25);
    r3 = (r31 + 40);
    r4 = (r4 + 16160);
    r5 = (r5 + -23720);
    MemoryInline::FlatWriteRam16((r31 + 36), static_cast<uint16_t>(r25));
    r6 = 140;
    r7 = 6;
    ctx->lr = 0x805E9CC4u;
    ctx->gpr[0] = r0;
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r31 + 944), r25);
}
...
loc_inl0_cont_8051BED0:
{
    ...
    r4 = 0x809C0000u;
    r24 = MemoryInline::FlatRead32((r3 + 3220));
    r3 = MemoryInline::FlatRead32((r4 + -10440));
    // inline leaf 0x80541794 (4 guest instruction(s))
    r3 = MemoryInline::FlatRead32((r3 + 4));
    r3 = MemoryInline::FlatRead32((r3 + 8));
    r3 = MemoryInline::FlatRead16((r3 + 8));
    // end of inlined leaf 0x80541794
    r26 = (r3 & 65535);
    r25 = r3;
    r3 = (r26 * 164);
    r4 = r24;
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r31 + 32), r3);
    r0 = 0;
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(0));
}
...
loc_805E9D30:
{
    MemoryInline::FlatWriteRam16((r31 + 36), static_cast<uint16_t>(r0));
    if (((cr & 0x20000000u) != 0)) {
        goto loc_805E9D3C;
    }
}
...
loc_805E9D3C:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80541878u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_805E9D70:
{
    r5 = MemoryInline::FlatRead32((r26 + 7160));
    r3 = r23;
    r25_addr_2 = (r25 + r27);
    r4 = MemoryInline::FlatRead32(r25_addr_2);
    r5_addr_2 = (r5 + r27);
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80083F40u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->gpr[5] = r5;
    ctx->gpr[6] = r6;
    InvokeDirectCpu<0x80084230u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r24 = (r24 + 1);
    r27 = (r27 + 4);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r24), static_cast<int32_t>(6));
}
...
loc_805E9DA4:
{
    ...
    MemoryInline::FlatWriteRam32((r31 + 944), r0);
    MemoryInline::FlatWrite32(r30, r31);
}

loc_805E9DB0:
{
    MemoryInline::FlatWrite32((r28 + 36), r31);
    r4 = r29;
    r3 = (r28 + 40);
    r5 = 64;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x805E9C20 func_805E9C20 preserves=true fpr_mask=0x00000000
