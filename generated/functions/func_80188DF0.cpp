...
extern "C" void func_80188DF0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80188DF0:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead8((r27 + 245));
    r31 = r3;
    ctx->lr = 0x80188E48u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80188E5C:
{
    guest_range_0 = MemoryInline::ResolveRangeHost((r27 + 76), 0, 176u, true, false);
    ...
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 136u, (r27 + 212));
    f5.d = static_cast<double>(PpcForceSingleValueInline(f2.d + f3.d));
    f3.d = MemoryInline::FlatReadFloat32((r29 + 12));
    r6 = MemoryInline::ReadResolved32(guest_range_0, 172u, (r27 + 248));
    f2.d = static_cast<double>(PpcForceSingleValueInline(f0.d + f1.d));
    f1.d = MemoryInline::FlatReadFloat32((r29 + 4));
    f5.d = static_cast<double>(PpcForceSingleValueInline(f5.d - f3.d));
    f3.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 148u, (r27 + 224));
    f1.d = static_cast<double>(PpcForceSingleValueInline(f2.d - f1.d));
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 140u, (r27 + 216));
    f3.d = static_cast<double>(PpcForceSingleValueInline(f3.d + f5.d));
    r5 = MemoryInline::ReadResolved8(guest_range_0, 169u, (r27 + 245));
    f2.d = static_cast<double>(PpcForceSingleValueInline(f0.d + f1.d));
...
// RECOMP_REGISTRATION base 0x80188DF0 func_80188DF0 preserves=true fpr_mask=0x00000000
