...
extern "C" void func_80550C68(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80550C68:
{
    ...
    r4 = 0x809C0000u;
    r31 = r3;
    r3 = MemoryInline::FlatRead32((r4 + -3932));
...
loc_80550C98:
{
    ...
    r3 = 0x809C0000u;
    r0 = 0;
    MemoryInline::FlatWriteRam32((r3 + -4880), r0);
...
// RECOMP_REGISTRATION base 0x80550C68 func_80550C68 preserves=true fpr_mask=0x00000000
