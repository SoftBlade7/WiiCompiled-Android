...
extern "C" void func_80545A18(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_80545A40:
{
    ...
    r3 = (r3_rot_0 & 7);
    r8_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(24));
    r8 = (r8_rot_0 & 1023);
    r9_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(14));
    r9 = (r9_rot_0 & 127);
    r10_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(7));
    r10 = (r10_rot_0 & 127);
    ...
    MemoryInline::WriteResolved16(guest_range_0, 0u, (r4 + 4), static_cast<uint16_t>(r10));
    MemoryInline::WriteResolved8(guest_range_0, 2u, (r4 + 6), static_cast<uint8_t>(r9));
    MemoryInline::WriteResolved16(guest_range_0, 4u, (r4 + 8), static_cast<uint16_t>(r8));
...
// RECOMP_GUEST_ABI gpr_read=0x000000F8 gpr_write=0x000007E9 gpr_return=0x00000008 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80545A18 func_80545A18 preserves=true fpr_mask=0x00000000
