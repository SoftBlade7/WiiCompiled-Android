...
extern "C" void func_8082CCB4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_8082CCB4:
{
    ...
    r3 = MemoryInline::FlatRead32((r30 + 8));
    r4 = 1;
    f31.d = MemoryInline::FlatReadFloat32((r30 + 180));
    r3 = MemoryInline::FlatRead32((r3 + 40));
...
// RECOMP_REGISTRATION base 0x8082CCB4 func_8082CCB4 preserves=false fpr_mask=0x80000000
