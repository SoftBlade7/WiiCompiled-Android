...
extern "C" void func_80642424(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80642454:
{
    ...
    r0 = MemoryInline::FlatRead32((r30 + 656));
    r4 = (r3 + 1);
...
// RECOMP_REGISTRATION base 0x80642424 func_80642424 preserves=true fpr_mask=0x00000000
