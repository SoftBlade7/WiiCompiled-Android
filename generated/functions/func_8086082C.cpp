...
extern "C" void func_8086082C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8086082C:
{
    ...
    r31 = 0x809C0000u;
    r4 = MemoryInline::FlatRead32((r31 + -10424));
...
loc_8086087C:
{
    ...
    r0 = 3;
    r3 = 0x809C0000u;
    MemoryInline::FlatWrite32((r4 + 3352), r0);
    r31 = MemoryInline::FlatRead32((r3 + -10424));
...
// RECOMP_REGISTRATION base 0x8086082C func_8086082C preserves=true fpr_mask=0x00000000
