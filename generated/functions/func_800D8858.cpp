...
extern "C" void func_800D8858(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800D88DC:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8010A9B8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800D893C:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800D29D0u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    cr = ctx->cr;
...
loc_800D898C:
{
    ...
    r0 = 0;
    r4 = (r31 + 1948);
    MemoryInline::FlatWrite8((r3 + 2008), static_cast<uint8_t>(r5));
    r3 = 128;
    r5 = MemoryInline::FlatRead32((r13 + -26868));
    MemoryInline::FlatWrite8((r5 + 2009), static_cast<uint8_t>(r0));
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x800D89B4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_inl1_cont_800CCC68:
{
    ...
    r25_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(27));
    r25 = (r25_rot_1 & 134217727);
    r26_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(27));
...
loc_800D8B9C:
{
    r25 = MemoryInline::FlatRead32((r13 + -26868));
    r0 = MemoryInline::FlatRead32((r25 + 1608));
}
...
loc_800D8BAC:
{
    ...
    r0 = MemoryInline::FlatRead16((r25 + 1612));
    r3 = (r3 & 65535);
...
loc_800D8BD4:
{
    ...
    r3 = r28;
    MemoryInline::FlatWrite32((r4 + 1608), r27);
    r25 = MemoryInline::FlatRead32((r13 + -26868));
    // inline leaf 0x801ED990 (2 guest instruction(s))
    r3 = (r3 & 65535);
    // end of inlined leaf 0x801ED990
    MemoryInline::FlatWrite16((r25 + 1612), static_cast<uint16_t>(r3));
    goto loc_800D8C38;
}
...
loc_800D8C38:
{
    ...
    r25 = 0;
    r3 = r26;
    MemoryInline::FlatWrite32((r4 + 1804), r25);
    MemoryInline::FlatWrite32((r4 + 1800), r25);
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8010A9B4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800D8C78:
{
    ...
    r4 = -65536;
    r3 = 6;
    MemoryInline::FlatWrite8((r5 + 1825), static_cast<uint8_t>(r25));
    r4 = (r4 + -14874);
    // inline leaf 0x800CCC68 (6 guest instruction(s))
}
...
loc_inl4_cont_800CCC68:
{
    ...
    r4 = PPC_CntlzwInline(static_cast<uint32_t>(r0));
    r0 = PPC_CntlzwInline(static_cast<uint32_t>(r3));
    r25_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(27));
    r25 = (r25_rot_2 & 134217727);
    r26_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(27));
...
loc_800D8D98:
{
    ...
    r3 = MemoryInline::FlatRead32((r13 + -26868));
    MemoryInline::FlatWrite8((r3 + 2009), static_cast<uint8_t>(r25));
    r5 = MemoryInline::FlatRead32((r13 + -26868));
...
loc_800D8E08:
{
    MemoryInline::FlatWrite16((r5 + 1834), static_cast<uint16_t>(r0));
}

loc_800D8E0C:
{
    r3 = r30;
    // inline leaf 0x800D2A74 (5 guest instruction(s))
    r4 = 0x802F0000u;
    r0_rot_5 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(2));
    r0 = (r0_rot_5 & -4);
    r4 = (r4 + 4960);
    r3 = (r4 + r0);
    // end of inlined leaf 0x800D2A74
    r27 = r3;
    r3 = r30;
    // inline leaf 0x800D2B10 (5 guest instruction(s))
    r4 = 0x802F0000u;
    r0_rot_6 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(3));
    r0 = (r0_rot_6 & -8);
    r4 = (r4 + 5088);
    r3 = (r4 + r0);
    // end of inlined leaf 0x800D2B10
    MemoryInline::FlatWriteRam32(r27, r26);
    r25 = r3;
    MemoryInline::FlatWriteRam8(r3, static_cast<uint8_t>(r30));
    r4 = MemoryInline::FlatRead32((r13 + -26868));
    r5 = MemoryInline::FlatRead8((r4 + 1614));
    MemoryInline::FlatWriteRam8((r3 + 1), static_cast<uint8_t>(r5));
    r4 = MemoryInline::FlatRead32((r13 + -26868));
    r0 = MemoryInline::FlatRead32((r4 + 1592));
    ...
    r3 = r26;
    r4 = r25;
    // inline leaf 0x8010AD04 (2 guest instruction(s))
    MemoryInline::FlatWrite32((r3 + 64), r4);
    // end of inlined leaf 0x8010AD04
    r3 = 2;
    ctx->lr = 0x800D8E60u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x800D8858 func_800D8858 preserves=true fpr_mask=0x00000000
