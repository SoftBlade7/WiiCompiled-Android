...
extern "C" void func_805E5904(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805E5904:
{
    ...
    r30 = r3;
    MemoryInline::FlatWrite32((r3 + 1016), r4);
    r4 = 0;
    MemoryInline::FlatWrite32((r3 + 1036), r0);
    r3 = (r3 + 236);
...
loc_805E59B4:
{
    ...
    xer = ctx->xer;
    r31 = 0x809C0000u;
    r3 = MemoryInline::FlatRead32((r31 + 11448));
    ctx->lr = 0x805E59C8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->gpr[5] = r5;
    ctx->cr = cr;
    InvokeDirectCpu<0x80750238u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r5 = ctx->gpr[5];
    cr = ctx->cr;
...
// RECOMP_REGISTRATION base 0x805E5904 func_805E5904 preserves=true fpr_mask=0x00000000
