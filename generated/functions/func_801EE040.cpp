...
extern "C" void func_801EE040(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801EE198:
{
    MemoryInline::FlatWriteRam32(r29, r24);
    if (((cr & 0x20000000u) == 0)) {
        goto loc_801EE1A8;
    }
}
...
loc_801EE1DC:
{
    MemoryInline::FlatWriteRam32((r29 + 8), r23);
    if (((cr & 0x20000000u) == 0)) {
        goto loc_801EE1EC;
    }
}
...
loc_801EE264:
{
    MemoryInline::FlatWriteRam32((r29 + 16), r22);
    r3 = 32;
    r0 = 2100;
    r7 = r29;
    MemoryInline::FlatWriteRam32((r29 + 20), r3);
    r4 = 24;
    r5 = 3;
    r6 = 1;
    MemoryInline::FlatWriteRam32((r29 + 24), r30);
...
// RECOMP_REGISTRATION base 0x801EE040 func_801EE040 preserves=true fpr_mask=0x00000000
