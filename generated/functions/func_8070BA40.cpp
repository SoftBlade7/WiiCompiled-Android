...
extern "C" void func_8070BA40(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8070BA54:
{
    ...
    r4 = 0x808A0000u;
    r5 = MemoryInline::FlatRead32((r4 + 6336));
...
// RECOMP_REGISTRATION base 0x8070BA40 func_8070BA40 preserves=true fpr_mask=0x00000000
