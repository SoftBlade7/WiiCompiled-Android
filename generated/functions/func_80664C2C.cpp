...
extern "C" void func_80664C2C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80664D70:
{
    r3 = 0x809C0000u;
    r0 = 0;
    r4 = MemoryInline::FlatRead32((r3 + 8408));
    r3 = r30;
    MemoryInline::FlatWrite32((r4 + 10688), r0);
...
// RECOMP_REGISTRATION base 0x80664C2C func_80664C2C preserves=true fpr_mask=0x00000000
