...
extern "C" void func_805BC03C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805BC03C:
{
    ...
    MemoryInline::FlatWrite32((r30 + 72), r30);
    MemoryInline::FlatWrite32((r30 + 76), r6);
    MemoryInline::FlatWrite32((r30 + 80), r5);
...
// RECOMP_REGISTRATION base 0x805BC03C func_805BC03C preserves=true fpr_mask=0x00000000
