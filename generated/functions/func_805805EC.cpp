...
extern "C" void func_805805EC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_805805EC:
{
    ...
    r3 = r31;
    r4 = 612;
    r7 = MemoryInline::FlatRead32((r5 + 104));
    r5 = 0;
    r6 = 1;
    r7_addr_0 = (r7 + r0);
    r7 = MemoryInline::FlatRead32(r7_addr_0);
    MemoryInline::FlatWrite32((r7 + 80), r8);
    ctx->lr = 0x80580634u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x805805EC func_805805EC preserves=true fpr_mask=0x00000000
