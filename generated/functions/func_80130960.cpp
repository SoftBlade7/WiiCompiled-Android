...
extern "C" void func_80130960(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80130960:
{
    ...
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    InvokeDirectCpu<0x80130324u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80130960 func_80130960 preserves=true fpr_mask=0x00000000
