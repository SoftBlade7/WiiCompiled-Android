...
extern "C" void func_800F5374(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800F5558:
{
    ...
    r0 = (r3 + 1);
    MemoryInline::FlatWriteRam32((r30 + 48), r0);
}
...
// RECOMP_REGISTRATION base 0x800F5374 func_800F5374 preserves=true fpr_mask=0x00000000
