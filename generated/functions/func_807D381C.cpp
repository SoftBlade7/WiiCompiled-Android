...
extern "C" void func_807D381C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807D381C:
{
    ...
    r0 = MemoryInline::FlatRead8((r3 + 328));
...
loc_807D3834:
{
    r0 = MemoryInline::FlatRead8((r3 + 213));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_807D3840:
{
    r3 = MemoryInline::FlatRead32((r3 + 740));
    r3 = (r3 + 72);
...
// RECOMP_GUEST_ABI gpr_read=0x0000001B gpr_write=0x0000000B gpr_return=0x00000008 fpr_read=0x00000000 fpr_write=0x0000003F fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x807D381C func_807D381C preserves=true fpr_mask=0x00000000
