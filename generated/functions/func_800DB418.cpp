...
extern "C" void func_800DB418(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800DB460:
{
    r0 = MemoryInline::FlatRead32((r13 + -26884));
...
{
    r0 = 1;
    MemoryInline::FlatWrite32((r13 + -26880), r0);
}
...
loc_800DB550:
{
    ...
    r4 = MemoryInline::FlatRead32((r13 + -26888));
...
loc_800DB59C:
{
    r28 = (r28 + 1);
    r29 = (r29 + 12);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r28), static_cast<int32_t>(154));
}
...
// RECOMP_REGISTRATION base 0x800DB418 func_800DB418 preserves=true fpr_mask=0x00000000
