...
extern "C" void func_80787BA0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80787BA0:
{
    ...
    r4 = ctx->gpr[4];
    r31 = ctx->gpr[31];
    MemoryInline::FlatWrite16((r31 + 28), static_cast<uint16_t>(r3));
...
// RECOMP_REGISTRATION base 0x80787BA0 func_80787BA0 preserves=true fpr_mask=0x00000000
