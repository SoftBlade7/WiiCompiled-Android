...
extern "C" void func_801AB608(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
{
    r4 = 0x802A0000u;
    r0_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(26));
    r0 = (r0_rot_0 & 1020);
    r4 = (r4 + -15472);
    r4_addr_0 = (r4 + r0);
...
// RECOMP_REGISTRATION base 0x801AB608 func_801AB608 preserves=true fpr_mask=0x00000000
