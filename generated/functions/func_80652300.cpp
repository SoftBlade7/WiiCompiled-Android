...
extern "C" void func_80652300(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80652300:
{
    ...
    MemoryInline::FlatWrite32((r31 + 640), r8);
    MemoryInline::FlatWrite32((r31 + 644), r31);
    MemoryInline::FlatWrite32((r31 + 648), r10);
    MemoryInline::FlatWrite32((r31 + 652), r9);
    MemoryInline::FlatWrite32((r31 + 656), r0);
    ctx->lr = 0x80652384u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80652300 func_80652300 preserves=true fpr_mask=0x00000000
