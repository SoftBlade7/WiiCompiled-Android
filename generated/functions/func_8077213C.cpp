...
extern "C" void func_8077213C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
{
    r4 = 0x808D0000u;
    r0 = MemoryInline::FlatRead32((r4 + -3092));
...
{
    r4 = 0x808D0000u;
    r0 = MemoryInline::FlatRead32((r4 + -3096));
    MemoryInline::FlatWrite32((r3 + 180), r0);
}
...
// RECOMP_REGISTRATION base 0x8077213C func_8077213C preserves=false fpr_mask=0x80000000
