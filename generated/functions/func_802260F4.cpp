...
extern "C" void func_802260F4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
    uint32_t r3_rot_1 = 0;
...
loc_80226130:
{
    ...
    r4 = ctx->gpr[4];
    cr = ctx->cr;
    // inline leaf 0x80026D90 (2 guest instruction(s))
    r3 = MemoryInline::FlatRead32((r3 + 36));
    // end of inlined leaf 0x80026D90
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(0));
}
...
loc_80226154:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r2 + -25264));
...
// RECOMP_REGISTRATION base 0x802260F4 func_802260F4 preserves=true fpr_mask=0x00000000
