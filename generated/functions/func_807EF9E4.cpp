...
extern "C" void func_807EF9E4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807EF9E4:
{
    r3 = 0x809C0000u;
    r0 = (r3 + 16528);
    MemoryInline::FlatWriteRam32((r3 + 16528), r0);
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x807EF9E4 func_807EF9E4 preserves=true fpr_mask=0x00000000
