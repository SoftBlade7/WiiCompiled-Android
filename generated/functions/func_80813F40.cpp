...
extern "C" void func_80813F40(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_80813F40:
{
    ...
    f2.d = MemoryInline::FlatReadFloat32((r6 + 32));
    ...
    f5.d = MemoryInline::FlatReadFloat64((r6 + 56));
...
// RECOMP_REGISTRATION base 0x80813F40 func_80813F40 preserves=false fpr_mask=0xC0000000
