...
extern "C" void func_8020AEF8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
extern "C" MKW_PPC_ALWAYS_INLINE_BODY MkwStateFreeResult2 func_8020AEF8_statefree_v0(uint32_t native_r0, uint32_t native_r3, uint32_t native_cr, uint32_t native_xer)
{
...
// RECOMP_STATE_FREE_ABI address=0x8020AEF8 symbol=func_8020AEF8_statefree_v0 gpr_in=0x00000009 gpr_out=0x00000001 fpr_in=0x00000000 fpr_out=0x00000000 cr_in=0x00 cr_out=0x01 gqr_in=0x00 hid_in=0x00 hid_out=0x00 xer_in=1 ctr_in=0 lr_in=0

extern "C" MKW_PPC_NO_INLINE MkwStateFreeResult2 func_8020AEF8_statefree(uint32_t native_r0, uint32_t native_r3, uint32_t native_r4, uint32_t native_r5, uint32_t native_cr, uint32_t native_xer)
{
...
// RECOMP_STATE_FREE_ABI address=0x8020AEF8 symbol=func_8020AEF8_statefree gpr_in=0x00000039 gpr_out=0x00000001 fpr_in=0x00000000 fpr_out=0x00000000 cr_in=0x01 cr_out=0x01 gqr_in=0x00 hid_in=0x00 hid_out=0x00 xer_in=1 ctr_in=0 lr_in=0
...
// RECOMP_REGISTRATION base 0x8020AEF8 func_8020AEF8 preserves=true fpr_mask=0x00000000
