...
extern "C" void func_80165D20(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80165DE8:
{
    ...
    r0 = (r0_rot_2 & -32);
    r5 = MemoryInline::FlatRead32((r13 + -25816));
    r3 = (r3 + r0);
    r8 = 0;
...
// RECOMP_REGISTRATION base 0x80165D20 func_80165D20 preserves=true fpr_mask=0x00000000
