...
extern "C" void func_80568198(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80568198:
{
    ...
    r5 = 0x80890000u;
    r4 = 0x80890000u;
    f1.d = MemoryInline::FlatReadFloat32((r5 + 5448));
    f0.d = MemoryInline::FlatReadFloat32((r4 + 5580));
...
// RECOMP_REGISTRATION base 0x80568198 func_80568198 preserves=true fpr_mask=0x00000000
