...
extern "C" void func_807DC654(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807DC694:
{
    ...
    r3 = 0;
    r0 = 5;
    MemoryInline::FlatWrite32((r30 + 96), r3);
    MemoryInline::FlatWrite32((r30 + 100), r0);
...
// RECOMP_REGISTRATION base 0x807DC654 func_807DC654 preserves=true fpr_mask=0x00000000
