...
extern "C" void func_8018C5C8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFFC3E gpr_write=0xFFFFFFFF gpr_return=0x00000018 fpr_read=0xFFFFFFE1 fpr_write=0xFFFFFFFF fpr_return=0x00000002 cr_read=0xFE cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x8018C5C8 func_8018C5C8 preserves=true fpr_mask=0x00000000
