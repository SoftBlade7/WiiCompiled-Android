...
extern "C" void func_80104428(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80104454:
{
    r3 = MemoryInline::FlatRead32((r5 + 568));
    r30 = MemoryInline::FlatRead32((r4 + 4));
    r4 = 2;
    r0 = (r3 + -1);
    MemoryInline::FlatWrite32((r5 + 568), r0);
...
// RECOMP_REGISTRATION base 0x80104428 func_80104428 preserves=true fpr_mask=0x00000000
