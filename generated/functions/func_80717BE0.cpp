...
extern "C" void func_80717BE0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80717BE0:
{
    r3 = (r3 + -248);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80717744u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80717BE0 func_80717BE0 preserves=true fpr_mask=0x00000000
