...
extern "C" void func_8083A33C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8083A348:
{
    ...
    r30 = r3;
    MemoryInline::FlatWrite32((r3 + 1736), r31);
    if (((cr & 0x20000000u) == 0)) {
        goto loc_8083A3C0;
    }
}
...
loc_8083A364:
{
    ...
    r6 = ctx->gpr[6];
    r7 = ctx->gpr[7];
    MemoryInline::FlatWrite32((r30 + 2504), r31);
    r3 = (r1 + 8);
    r4 = (r30 + 2132);
...
// RECOMP_REGISTRATION base 0x8083A33C func_8083A33C preserves=true fpr_mask=0x00000000
