...
extern "C" void func_806A8588(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806A8588:
{
    ...
    r4 = MemoryInline::FlatRead32((r31 + 1552));
    ctx->lr = 0x806A8668u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFFC0E gpr_write=0xFFFFFFFF gpr_return=0x00000018 fpr_read=0xFFFFFFF8 fpr_write=0xFFFFFFFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x806A8588 func_806A8588 preserves=true fpr_mask=0x00000000
