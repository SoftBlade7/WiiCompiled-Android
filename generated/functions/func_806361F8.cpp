...
extern "C" void func_806361F8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806361F8:
{
    ...
    r30 = r3;
    r0 = MemoryInline::FlatRead8((r3 + 740));
...
loc_8063622C:
{
    r0 = MemoryInline::FlatRead8((r30 + 1324));
    MemoryInline::FlatWrite32((r30 + 1320), r31);
...
// RECOMP_REGISTRATION base 0x806361F8 func_806361F8 preserves=true fpr_mask=0x00000000
