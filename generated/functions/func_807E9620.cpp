...
extern "C" void func_807E9620(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807E9680:
{
    ...
    r31 = 0x808B0000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r31 + -29196));
    ctx->lr = 0x807E96B4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    f1 = ctx->fpr[1];
    ctr = ctx->ctr;
    MemoryInline::FlatWrite32((r27 + 372), r30);
    r3 = (r1 + 8);
    r4 = -1;
    ctx->lr = 0x807E970Cu;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x807E9620 func_807E9620 preserves=true fpr_mask=0x00000000
