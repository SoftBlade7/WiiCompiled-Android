...
extern "C" void func_8068CEDC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
    uint32_t r3_rot_1 = 0;
...
loc_8068CF34:
{
    r4 = MemoryInline::FlatRead32((r5 + 592));
    r0 = (r4 + 4);
    goto loc_8068CF44;
}
...
loc_8068CF40:
{
    r0 = MemoryInline::FlatRead32((r5 + 592));
}
...
loc_8068CF44:
{
    ...
    r4 = MemoryInline::FlatRead32((r8 + -10456));
    r6 = MemoryInline::FlatRead8((r4 + 37));
    r4 = (r6 + -3);
    r5 = (r6 | ~r5);
...
loc_8068D180:
{
    ...
    r3 = 124;
    r4_addr_10 = (r4 + r29);
    MemoryInline::FlatWrite32(r4_addr_10, r0);
    ctx->lr = 0x8068D190u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_8068D1AC:
{
    ...
    r3 = 124;
    r4_addr_11 = (r4 + r29);
    MemoryInline::FlatWrite32(r4_addr_11, r0);
    ctx->lr = 0x8068D1BCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_8068D1D0:
{
    ...
    r28 = (r28 + 1);
    r4_addr_12 = (r4 + r29);
    MemoryInline::FlatWrite32(r4_addr_12, r3);
    r29 = (r29 + 4);
}
...
loc_8068D1EC:
{
    r4 = 0x808A0000u;
    r3 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + -10964));
    r0 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r4 + -10968));
    r3 = r31;
    ...
    MemoryInline::FlatWrite16((r31 + 60), static_cast<uint16_t>(r0));
...
// RECOMP_REGISTRATION base 0x8068CEDC func_8068CEDC preserves=true fpr_mask=0x00000000
