...
extern "C" void func_8083F838(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8083F838:
{
    ...
    r5 = 0x808B0000u;
    r3 = r29;
    r0 = MemoryInline::FlatRead32((r5 + -11964));
    r4 = (r1 + 8);
...
loc_8083F8F4:
{
    MemoryInline::FlatWrite8((r29 + 1864), static_cast<uint8_t>(r30));
...
// RECOMP_REGISTRATION base 0x8083F838 func_8083F838 preserves=true fpr_mask=0x00000000
