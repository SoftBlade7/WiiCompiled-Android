...
extern "C" void func_807284D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807284D0:
{
    ...
    f2.d = MemoryInline::FlatReadFloat64((r4 + 9360));
    r3 = r30;
...
// RECOMP_REGISTRATION base 0x807284D0 func_807284D0 preserves=true fpr_mask=0x00000000
