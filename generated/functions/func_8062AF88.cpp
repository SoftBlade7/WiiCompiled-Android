...
extern "C" void func_8062AF88(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8062AF88:
{
    ...
    MemoryInline::FlatWrite32((r22 + 600), r30);
    MemoryInline::FlatWriteFloat32((r22 + 604), f0.d);
    MemoryInline::FlatWrite32((r28 + 784), r30);
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_15C6 = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_15C6[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_15C6[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    r5 = (r5 + -11496);
    r4 = (r4 + -24208);
    MemoryInline::WriteResolved32(guest_range_2, 996u, (r28 + 996), r30);
    r3 = (r28 + 1072);
    ...
    r11 = MemoryInline::FlatRead32((r29 + 2956));
    ...
    r8 = MemoryInline::FlatRead32((r29 + 2968));
    ...
    r9 = 0x808C0000u;
    r7 = 0x808C0000u;
    guest_range_4 = MemoryInline::ResolveRangeHost((r29 + 2980), 0, 60u, true, false);
    r22 = MemoryInline::ReadResolved32(guest_range_4, 0u, (r29 + 2980));
    r9 = (r9 + -12276);
    ...
    MemoryInline::WriteResolved32(guest_range_1, 16u, (r28 + 1636), r23);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r25 = MemoryInline::ReadResolved32(guest_range_4, 12u, (r29 + 2992));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r30 = MemoryInline::ReadResolved32(guest_range_4, 24u, (r29 + 3004));
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 52u, ((static_cast<uint64_t>(static_cast<uint32_t>(r30)) << 32) | static_cast<uint32_t>(r12)))) {
        MemoryInline::WriteResolved32(guest_range_1, 52u, (r28 + 1672), r30);
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r10 = MemoryInline::ReadResolved32(guest_range_4, 36u, (r29 + 3016));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_4, 48u, (r29 + 3028));
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_5, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r30)) << 32) | static_cast<uint32_t>(r12)))) {
        MemoryInline::WriteResolved32(guest_range_5, 24u, (r1 + 56), r30);
...
// RECOMP_REGISTRATION base 0x8062AF88 func_8062AF88 preserves=true fpr_mask=0x00000000
