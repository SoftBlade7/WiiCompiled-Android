...
extern "C" void func_80051000(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80051000:
{
    ...
    r30_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(12));
    ...
    r31 = (r7 + 64);
    r0 = (r8 + 224);
    r4_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(12));
    r4_mrot_0 = (r4_rot_0 & 1044480);
    r4_mdest_0 = (r4 & -1044481);
...
// RECOMP_REGISTRATION base 0x80051000 func_80051000 preserves=true fpr_mask=0x00000000
