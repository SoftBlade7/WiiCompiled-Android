...
extern "C" void func_8085354C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80853598:
{
    ...
    r3 = (r4 + r0);
    r29 = 0x808E0000u;
    r27 = MemoryInline::FlatRead32((r3 + -28376));
    r26 = (r1 + 8);
    r29 = (r29 + -23784);
    r25 = 0;
...
loc_808535CC:
{
    ...
    r0 = PPC_Slw(static_cast<uint32_t>(r28), static_cast<uint32_t>(r25));
    r0 = (r3 & r0);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
    if (((cr & 0x20000000u) != 0)) {
        goto loc_808535E8;
...
loc_80853608:
{
    r0 = MemoryInline::FlatRead32((r31 + 2256));
}
...
// RECOMP_REGISTRATION base 0x8085354C func_8085354C preserves=true fpr_mask=0x00000000
