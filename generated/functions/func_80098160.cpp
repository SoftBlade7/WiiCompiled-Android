...
extern "C" void func_80098160(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80098160:
{
    ...
    r3 = ctx->gpr[3];
    r30 = 0;
    MemoryInline::FlatWrite8((r28 + 1), static_cast<uint8_t>(r30));
    r31 = r3;
    r3 = (r28 + 64);
    MemoryInline::FlatWrite8((r28 + 2), static_cast<uint8_t>(r30));
    ctx->lr = 0x800981A0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_800981BC:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite8((r28 + 4), static_cast<uint8_t>(r30));
}
...
// RECOMP_REGISTRATION base 0x80098160 func_80098160 preserves=true fpr_mask=0x00000000
