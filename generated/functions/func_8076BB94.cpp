...
extern "C" void func_8076BB94(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8076BBC4:
{
    r27 = MemoryInline::FlatRead32((r25 + 196));
    r3 = 0;
}
...
loc_8076BC04:
{
    r30 = MemoryInline::FlatRead32((r25 + 188));
    r27_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r27), static_cast<uint32_t>(2));
    r27 = (r27_rot_2 & -4);
    r3 = 0;
...
loc_8076BD10:
{
    ...
    f4 = ctx->fpr[4];
    cr = ctx->cr;
    f0.d = MemoryInline::FlatReadFloat32((r22 + -6236));
...
loc_8076BD78:
{
    ...
    MemoryInline::FlatWrite32((r21 + 176), r23);
    r3 = r21;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite8((r21 + 289), static_cast<uint8_t>(r24));
}
...
// RECOMP_REGISTRATION base 0x8076BB94 func_8076BB94 preserves=true fpr_mask=0x00000000
