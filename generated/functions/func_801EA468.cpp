...
extern "C" void func_801EA468(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801EA468:
{
    ...
    r1 = (r1 + -16);
    r0 = ctx->lr;
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r4), static_cast<uint32_t>(43));
}
...
// RECOMP_REGISTRATION base 0x801EA468 func_801EA468 preserves=true fpr_mask=0x00000000
