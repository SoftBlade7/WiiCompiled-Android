...
extern "C" void func_80779E68(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80779E68:
{
    ...
    r30 = (r30 + 17216);
    r6 = (r30 + 24);
    r31 = MemoryInline::FlatRead32((r30 + 24));
    r12 = MemoryInline::FlatRead32((r6 + 4));
    r9 = (r30 + 32);
    r10 = MemoryInline::FlatRead32((r9 + 4));
    r8 = (r30 + 40);
    r11 = MemoryInline::FlatRead32((r30 + 32));
    r6 = 2;
    r9 = MemoryInline::FlatRead8((r30 + 40));
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 16u, ((static_cast<uint64_t>(static_cast<uint32_t>(r11)) << 32) | static_cast<uint32_t>(r10)))) {
...
// RECOMP_REGISTRATION base 0x80779E68 func_80779E68 preserves=true fpr_mask=0x00000000
