...
extern "C" void func_807A9128(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r26 = 0;
    MemoryInline::FlatWrite8((r3 + 64), static_cast<uint8_t>(r28));
...
loc_807A91A0:
{
    r19 = MemoryInline::FlatRead32((r27 + 68));
    MemoryInline::FlatWrite16((r19 + 12), static_cast<uint16_t>(r25));
    r3 = r19;
    MemoryInline::FlatWrite16((r19 + 14), static_cast<uint16_t>(r29));
    MemoryInline::FlatWrite32(r19, r28);
    ctx->lr = 0x807A91B8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r3 = MemoryInline::FlatRead32((r19 + 4));
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r30 + 22616));
    r3 = MemoryInline::FlatRead32((r3 + 40));
    f2.d = MemoryInline::FlatReadFloat32((r31 + 22620));
    ctx->lr = 0x807A91DCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r12 = MemoryInline::FlatRead32((r19 + 32));
    r3 = (r19 + 32);
    f1.d = MemoryInline::FlatReadFloat32((r30 + 22616));
    r4 = 293;
    ...
    r6 = ctx->gpr[6];
    cr = ctx->cr;
    r19 = MemoryInline::FlatRead32((r3 + 12));
    r17 = 0;
...
loc_807A9250:
{
    r19 = MemoryInline::FlatRead32((r19 + 44));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r19), static_cast<int32_t>(0));
}
...
loc_807A9278:
{
    r3 = MemoryInline::FlatRead16((r19 + 32));
    r27 = (r27 + 4);
    r26 = (r26 + 1);
    r0 = (r3 + 30);
...
// RECOMP_REGISTRATION base 0x807A9128 func_807A9128 preserves=true fpr_mask=0x00000000
