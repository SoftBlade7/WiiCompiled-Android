...
extern "C" void func_8015D504(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8015D504:
{
    r3 = MemoryInline::FlatRead32((r13 + -26104));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8015D504 func_8015D504 preserves=true fpr_mask=0x00000000
