...
extern "C" void func_806CF3A4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806CF3DC:
{
    ...
    r3 = 0x808A0000u;
    r4 = 0x802A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + -716));
    r3 = (r1 + 20);
    r4 = (r4 + 16688);
    ...
    ctx->fpr[4] = f4;
    ctx->cr = cr;
    InvokeDirectCpu<0x806B55C4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead8((r30 + 326));
}
...
loc_806CF440:
{
    ...
    f2.d = MemoryInline::FlatReadFloat32((r30 + 328));
    f0.d = MemoryInline::FlatReadFloat32((r3 + 19032));
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFFFFF gpr_write=0xFFFFFFFF gpr_return=0x00000018 fpr_read=0xFFFFFFE7 fpr_write=0xFFFFFFFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x806CF3A4 func_806CF3A4 preserves=true fpr_mask=0x00000000
