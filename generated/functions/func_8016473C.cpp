...
extern "C" void func_8016473C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8016473C:
{
    ...
    r31 = r4;
    r0 = MemoryInline::FlatRead32((r6 + 13696));
    r6 = 0;
...
// RECOMP_REGISTRATION base 0x8016473C func_8016473C preserves=true fpr_mask=0x00000000
