...
extern "C" void func_801E3ADC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_801E3ADC:
{
    ...
    ctx->gpr[5] = r5;
    ctx->cr = cr;
    InvokeDirectCpu<0x801E15F4u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
    cr = ctx->cr;
    r25 = r3;
    r3 = MemoryInline::FlatRead32((r13 + -28024));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ...
    cr = ctx->cr;
    r28 = r3;
    r3 = MemoryInline::FlatRead32((r13 + -28028));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ...
    cr = ctx->cr;
    r30 = r3;
    r3 = MemoryInline::FlatRead32((r13 + -28020));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
{
    r0 = (r24 + 97);
    r4 = MemoryInline::FlatRead32((r13 + -28028));
...
{
    r27 = (r27 + r3);
    r4 = MemoryInline::FlatRead32((r13 + -28024));
    r3 = r27;
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x801E3BC4u;
    ctx->gpr[0] = r0;
...
{
    r0 = (r24 + 97);
    r4 = MemoryInline::FlatRead32((r13 + -28020));
    r7 = r25;
    r25 = (r30 + r5);
...
// RECOMP_REGISTRATION base 0x801E3ADC func_801E3ADC preserves=true fpr_mask=0x00000000
