...
extern "C" void func_80181AA8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80181AA8:
{
    ...
    r4 = 0x80290000u;
    r4 = (r4 + -17144);
    guest_range_0 = MemoryInline::ResolveRangeHost(r3, 0, 33u, false, true);
...
// RECOMP_REGISTRATION base 0x80181AA8 func_80181AA8 preserves=true fpr_mask=0x00000000
