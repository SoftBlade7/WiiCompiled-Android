...
extern "C" void func_80152D80(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80152D94:
{
    r3 = 589824;
    r4 = 0x80280000u;
    r6 = MemoryInline::FlatRead8((r30 + 108));
    r5 = r31;
    r3 = (r3 + 3);
    r4 = (r4 + 28904);
    ctx->lr = 0x80152DB0u;
...
// RECOMP_REGISTRATION base 0x80152D80 func_80152D80 preserves=true fpr_mask=0x00000000
