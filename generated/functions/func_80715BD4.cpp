...
extern "C" void func_80715BD4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80715BD4:
{
    ...
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
    InvokeDirectCpu<0x8070F554u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
    ...
    // inline leaf 0x806F9724 (1 guest instruction(s))
    // end of inlined leaf 0x806F9724
    r3 = 0x809C0000u;
    r5 = 0x808A0000u;
...
// RECOMP_REGISTRATION base 0x80715BD4 func_80715BD4 preserves=true fpr_mask=0x00000000
