...
extern "C" void func_8058F2E8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8058F2E8:
{
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 12u, ((static_cast<uint64_t>(static_cast<uint32_t>(r6)) << 32) | static_cast<uint32_t>(r5)))) {
        ...
        MemoryInline::WriteResolved32(guest_range_0, 16u, (r1 + 16), r5);
    }
...
loc_8058F3C0:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r21 + 12), r23);
}

loc_8058F3D4:
{
    r4 = MemoryInline::FlatRead32((r27 + 44));
    r3 = 148;
    r4_addr_3 = (r4 + r31);
    MemoryInline::FlatWrite32(r4_addr_3, r21);
    ctx->lr = 0x8058F3E4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_8058F3F0:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r21 + 12), r24);
}
...
loc_8058F3FC:
{
    ...
    r3_addr_3 = (r3 + r31);
    MemoryInline::FlatWrite32(r3_addr_3, r21);
    goto loc_8058F460;
}
...
loc_8058F41C:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r21 + 12), r25);
}
...
loc_8058F44C:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r21 + 12), r26);
}
...
// RECOMP_REGISTRATION base 0x8058F2E8 func_8058F2E8 preserves=true fpr_mask=0x00000000
