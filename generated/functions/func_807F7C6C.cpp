...
extern "C" void func_807F7C6C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_807F7C6C:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r29 + 440));
    r0 = (r3 + -4);
...
loc_807F7CA0:
{
    ...
    r4 = 0x808B0000u;
    r3 = r29;
    f1.d = MemoryInline::FlatReadFloat32((r4 + -22444));
...
loc_807F7CBC:
{
    ...
    r28 = 0x808B0000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r28 + -22444));
    ctx->lr = 0x807F7CD8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    xer = ctx->xer;
    r3 = 0x809C0000u;
    r4 = MemoryInline::FlatRead8((r29 + 424));
    ...
    MemoryInline::FlatWrite32((r29 + 448), r0);
    r28 = (r28 + -22488);
    guest_range_0 = MemoryInline::ResolveRangeHost(r28, 0, 44u, true, false);
    r12 = MemoryInline::ReadResolved32(guest_range_0, 0u, r28);
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 8), 0, 44u, false, true);
    MemoryInline::WriteResolved32(guest_range_1, 0u, (r1 + 8), r12);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r11 = MemoryInline::ReadResolved32(guest_range_0, 4u, (r28 + 4));
            r10 = MemoryInline::ReadResolved32(guest_range_0, 8u, (r28 + 8));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r9 = MemoryInline::ReadResolved32(guest_range_0, 12u, (r28 + 12));
            r8 = MemoryInline::ReadResolved32(guest_range_0, 16u, (r28 + 16));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r7 = MemoryInline::ReadResolved32(guest_range_0, 20u, (r28 + 20));
            r6 = MemoryInline::ReadResolved32(guest_range_0, 24u, (r28 + 24));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r5 = MemoryInline::ReadResolved32(guest_range_0, 28u, (r28 + 28));
            r4 = MemoryInline::ReadResolved32(guest_range_0, 32u, (r28 + 32));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r3 = MemoryInline::ReadResolved32(guest_range_0, 36u, (r28 + 36));
            r0 = MemoryInline::ReadResolved32(guest_range_0, 40u, (r28 + 40));
        }
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 4u, ((static_cast<uint64_t>(static_cast<uint32_t>(r11)) << 32) | static_cast<uint32_t>(r10)))) {
        MemoryInline::WriteResolved32(guest_range_1, 4u, (r1 + 12), r11);
        MemoryInline::WriteResolved32(guest_range_1, 8u, (r1 + 16), r10);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 12u, ((static_cast<uint64_t>(static_cast<uint32_t>(r9)) << 32) | static_cast<uint32_t>(r8)))) {
        MemoryInline::WriteResolved32(guest_range_1, 12u, (r1 + 20), r9);
        MemoryInline::WriteResolved32(guest_range_1, 16u, (r1 + 24), r8);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 20u, ((static_cast<uint64_t>(static_cast<uint32_t>(r7)) << 32) | static_cast<uint32_t>(r6)))) {
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 36u, ((static_cast<uint64_t>(static_cast<uint32_t>(r3)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_1, 36u, (r1 + 44), r3);
...
loc_807F7E30:
{
    ...
    r3 = (static_cast<int32_t>(static_cast<int8_t>(r0)));
    // end of inlined leaf 0x80531F70
    MemoryInline::FlatWrite8((r29 + 425), static_cast<uint8_t>(r3));
...
// RECOMP_REGISTRATION base 0x807F7C6C func_807F7C6C preserves=true fpr_mask=0x00000000
