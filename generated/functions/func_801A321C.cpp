...
extern "C" void func_801A321C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_ca_0 = 0;
    uint32_t r3_ca_1 = 0;
...
loc_801A321C:
{
    ...
    // end of inlined leaf 0x801A1104
    r4 = 0x80000000u;
    r5 = MemoryInline::FlatRead32((r13 + -25408));
    r0 = MemoryInline::FlatRead32((r4 + 12692));
    r30 = r3;
}
...
loc_801A3298:
{
    r0 = MemoryInline::FlatRead32((r4 + 12696));
}
...
loc_801A32F4:
{
    ...
    r3 = ctx->gpr[3];
    // inline leaf 0x801AC93C (6 guest instruction(s))
    ...
    // end of inlined leaf 0x801AC93C
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(0));
}
...
loc_801A3340:
{
    ...
    r0 = MemoryInline::FlatRead32((r3 + 12696));
...
loc_801A335C:
{
    r0 = 0;
    r3 = 0x801A0000u;
    MemoryInline::FlatWrite32((r13 + -25400), r0);
    r3 = (r3 + 12820);
    ctx->lr = 0x801A3370u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_801A3370:
{
    r0 = MemoryInline::FlatRead32((r13 + -25400));
}
...
{
    r3 = 0x80290000u;
    r4 = MemoryInline::FlatRead32((r13 + -25400));
    r3 = (r3 + -2016);
    r5 = 917;
...
loc_801A344C:
{
    r4 = MemoryInline::FlatRead32((r13 + -25408));
    r6 = r29;
    r27 = 0;
    r5 = 0;
    goto loc_801A3478;
...
loc_801A34E4:
{
    ...
    r4 = 0x80000000u;
    r0 = 0;
    MemoryInline::FlatWriteRam32((r4 + 12692), r3);
    r3 = MemoryInline::FlatRead32(r27);
    MemoryInline::FlatWriteRam32((r4 + 12696), r3);
    MemoryInline::FlatWrite32((r13 + -25400), r0);
    r0 = MemoryInline::FlatRead8((r4 + 12679));
...
loc_801A35D0:
{
    r24 = MemoryInline::FlatRead32((r26 + 388));
    r23 = MemoryInline::FlatRead32((r26 + 392));
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->xer = xer;
    InvokeDirectCpu<0x801671D0u>(ctx);
...
loc_801A36A4:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x801647F8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r5 = 0x80000000u;
    r4 = 256;
    r29 = MemoryInline::FlatRead32((r5 + 12572));
    r3 = (r5 + 12544);
    r28 = MemoryInline::FlatRead32((r5 + 12576));
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->xer = xer;
...
loc_801A36F8:
{
    ...
    r3 = MemoryInline::FlatRead32((r31 + 12572));
}
...
loc_801A3718:
{
    r0 = MemoryInline::FlatRead32((r31 + 12576));
    r0 = (r3 - r0);
    r0 = (r29 - r0);
    MemoryInline::FlatWriteRam32((r31 + 12576), r0);
    r3 = MemoryInline::FlatRead32((r31 + 12584));
    r0 = MemoryInline::FlatRead32((r31 + 12572));
    r0 = (r0 - r3);
    r0 = (r29 - r0);
    MemoryInline::FlatWriteRam32((r31 + 12584), r0);
    r3 = MemoryInline::FlatRead32((r31 + 12592));
    r0 = MemoryInline::FlatRead32((r31 + 12572));
    r0 = (r0 - r3);
    r0 = (r29 - r0);
    MemoryInline::FlatWriteRam32((r31 + 12592), r0);
    r3 = MemoryInline::FlatRead32((r31 + 12596));
    r0 = MemoryInline::FlatRead32((r31 + 12572));
    r0 = (r0 - r3);
    r0 = (r29 - r0);
    MemoryInline::FlatWriteRam32((r31 + 12596), r0);
    MemoryInline::FlatWriteRam32((r31 + 12572), r29);
}

loc_801A3768:
{
    r3 = 0x80000000u;
    r0 = MemoryInline::FlatRead32((r3 + 12576));
...
loc_801A377C:
{
    ...
    ctx->gpr[4] = r4;
    ctx->xer = xer;
    InvokeDirectCpu<0x80192FC8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8019352Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x801A321C func_801A321C preserves=true fpr_mask=0x00000000
