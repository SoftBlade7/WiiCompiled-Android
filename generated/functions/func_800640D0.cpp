...
extern "C" void func_800640D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800640F8:
{
    ...
    r31 = ctx->gpr[31];
    cr = ctx->cr;
    r0_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r27), static_cast<uint32_t>(6));
    r0 = (r0_rot_1 & -64);
    r3 = r26;
    r4 = (r31 + r0);
    r4 = (r4 + 1588);
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8006A8A0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8006A970u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r30 = ctx->gpr[30];
...
loc_8006414C:
{
    ...
    MemoryInline::FlatWriteRam16((r31 + 2), static_cast<uint16_t>(r27));
    r0 = (r0 & 65534);
...
// RECOMP_REGISTRATION base 0x800640D0 func_800640D0 preserves=true fpr_mask=0x00000000
