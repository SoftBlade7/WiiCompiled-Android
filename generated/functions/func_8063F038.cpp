...
extern "C" void func_8063F038(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8063F038:
{
    MemoryInline::FlatWrite32((r3 + 680), r4);
    return;
}
...
// RECOMP_REGISTRATION base 0x8063F038 func_8063F038 preserves=true fpr_mask=0x00000000
