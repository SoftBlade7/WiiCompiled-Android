...
extern "C" void func_802262A8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_802262A8:
{
    ...
    ctx->gpr[31] = r31;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x800335F0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x802262A8 func_802262A8 preserves=true fpr_mask=0x00000000
