...
extern "C" void func_80657504(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
    uint32_t r3_rot_1 = 0;
...
loc_80657504:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x806760DCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80658B9Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80657574:
{
    r3 = MemoryInline::FlatRead32((r16 + 24512));
...
loc_80657584:
{
    ...
    xer = ctx->xer;
    r0 = 1;
    MemoryInline::FlatWrite8((r15 + 10071), static_cast<uint8_t>(r0));
    r3 = (r15 + 8);
    ctx->lr = 0x8065759Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_806575A0:
{
    ...
    r0 = (static_cast<int32_t>((static_cast<int64_t>(static_cast<int32_t>(r17)) * static_cast<int64_t>(static_cast<int32_t>(r4))) >> 32));
    {
...
loc_80657614:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800EEFB8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80657620:
{
    r0 = MemoryInline::FlatRead8((r15 + 10072));
...
loc_8065762C:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r15 + 40), r22);
    goto loc_8065767C;
}
...
loc_80657668:
{
    MemoryInline::FlatWrite32((r15 + 44), r23);
    MemoryInline::FlatWrite32((r15 + 48), r24);
    MemoryInline::FlatWrite32((r15 + 40), r25);
}
...
loc_8065767C:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x806581CCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80657688:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800D115Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80663444u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8065A0B4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80657700:
{
    r0 = MemoryInline::FlatRead32((r15 + 232));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_8065770C:
{
    MemoryInline::FlatWrite8((r15 + 864), static_cast<uint8_t>(r27));
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->xer = xer;
    ...
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r0 = MemoryInline::FlatRead32((r15 + 10524));
    r0 = (r0 * 88);
    r5 = (r15 + r0);
...
loc_8065776C:
{
    ...
    r7 = 0;
    r11 = (r15 + r0);
    r0 = MemoryInline::FlatRead8((r11 + 88));
...
loc_806577F4:
{
    MemoryInline::FlatWrite32((r15 + 40), r30);
    goto loc_806579B0;
}
...
loc_80657858:
{
    r0 = MemoryInline::FlatRead32((r15 + 236));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(1));
}
...
loc_8065788C:
{
    r0 = MemoryInline::FlatRead8((r15 + 10071));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_806578A4:
{
    r3 = MemoryInline::FlatRead32((r15 + 44));
...
loc_806578E8:
{
    MemoryInline::FlatWrite32((r15 + 44), r24);
    MemoryInline::FlatWrite32((r15 + 48), r24);
}
...
loc_80657908:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800D409Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80657910:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800D41F4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    cr = ctx->cr;
...
loc_8065791C:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800D4164u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80657924:
{
    MemoryInline::FlatWrite8((r15 + 9705), static_cast<uint8_t>(r23));
    r3 = r15;
    MemoryInline::FlatWrite8((r15 + 9706), static_cast<uint8_t>(r24));
    MemoryInline::FlatWrite8((r15 + 9707), static_cast<uint8_t>(r24));
    MemoryInline::FlatWrite8((r15 + 9704), static_cast<uint8_t>(r14));
    ctx->lr = 0x8065793Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    xer = ctx->xer;
    r0 = 5;
    MemoryInline::FlatWrite32((r15 + 40), r0);
    MemoryInline::FlatWrite32((r15 + 232), r24);
    MemoryInline::FlatWrite32((r15 + 236), r24);
    goto loc_8065798C;
}
...
loc_8065795C:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800D49B0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8065798C:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80658DE0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_806579B4:
{
    r0 = MemoryInline::FlatRead8((r15 + 10069));
}
...
loc_806579D4:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80662944u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_806579D8:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800D0FECu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r7 = 0x80660000u;
    r5 = (r3 + 17226);
    r4 = MemoryInline::FlatRead32((r4 + 2400));
    r6 = (r6 + -31488);
    r7 = (r7 + -31348);
    r3 = 1;
    ctx->lr = 0x80657A08u;
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800CCC80u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x801EC088u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80676130u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
{
    r0 = 0;
    MemoryInline::FlatWrite32((r15 + 44), r0);
    MemoryInline::FlatWrite32((r15 + 48), r0);
}
...
loc_80657A44:
{
    ...
    xer = ctx->xer;
    r14 = 0;
    MemoryInline::FlatWrite32((r15 + 40), r14);
    // inline leaf 0x80008E84 (3 guest instruction(s))
    r3 = 0x802A0000u;
    r3 = (r3 + 16512);
    // end of inlined leaf 0x80008E84
    MemoryInline::FlatWriteRam8((r3 + 108), static_cast<uint8_t>(r14));
...
// RECOMP_REGISTRATION base 0x80657504 func_80657504 preserves=true fpr_mask=0x00000000
