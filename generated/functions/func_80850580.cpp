...
extern "C" void func_80850580(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_80850664:
{
    ...
    r0 = (r3 + 24);
    MemoryInline::FlatWriteRam32((r27 + 24), r0);
}
...
loc_808506EC:
{
    ...
    r0 = 0;
    f4.d = f2.d;
    MemoryInline::FlatWriteRam32((r27 + 600), r0);
    r3 = (r27 + 24);
    r4 = (r4 + 21);
    ctx->lr = 0x8085072Cu;
    ctx->gpr[0] = r0;
...
loc_80850738:
{
    MemoryInline::FlatWrite32((r28 + 3220), r27);
    goto loc_80850D2C;
}
...
loc_808507F0:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r30 + 416));
    r3 = (r27 + 24);
    f4.d = MemoryInline::FlatReadFloat32((r30 + 424));
    r4 = (r4 + 39);
    ctx->lr = 0x80850830u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8085083C:
{
    MemoryInline::FlatWrite32((r28 + 3224), r27);
    r3 = 620;
    ctx->lr = 0x80850848u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_808508E4:
{
    ...
    f2.d = MemoryInline::FlatReadFloat32((r30 + 420));
    r4 = (r4 + 57);
    f3.d = MemoryInline::FlatReadFloat32((r30 + 424));
    f4.d = MemoryInline::FlatReadFloat32((r30 + 428));
    ctx->lr = 0x80850924u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_80850930:
{
    MemoryInline::FlatWrite32((r28 + 3228), r27);
    r3 = 620;
    ctx->lr = 0x8085093Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_808509D8:
{
    ...
    f2.d = MemoryInline::FlatReadFloat32((r30 + 420));
    r4 = (r4 + 75);
    f3.d = MemoryInline::FlatReadFloat32((r30 + 428));
    f4.d = MemoryInline::FlatReadFloat32((r30 + 432));
    ctx->lr = 0x80850A18u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_80850A24:
{
    MemoryInline::FlatWrite32((r28 + 3232), r27);
    goto loc_80850D2C;
}
...
loc_80850ADC:
{
    ...
    r4 = (r4 + 93);
    f3.d = MemoryInline::FlatReadFloat32((r30 + 416));
    f4.d = MemoryInline::FlatReadFloat32((r30 + 436));
    ctx->lr = 0x80850B1Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_80850B28:
{
    MemoryInline::FlatWrite32((r28 + 3236), r27);
    r3 = 620;
    ctx->lr = 0x80850B34u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80850BD0:
{
    ...
    f2.d = MemoryInline::FlatReadFloat32((r30 + 432));
    r3 = (r27 + 24);
    f3.d = MemoryInline::FlatReadFloat32((r30 + 436));
    r4 = (r4 + 111);
    ctx->lr = 0x80850C10u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80850C1C:
{
    MemoryInline::FlatWrite32((r28 + 3240), r27);
    goto loc_80850D2C;
}
...
loc_80850D28:
{
    MemoryInline::FlatWrite32((r28 + 3244), r27);
}
...
// RECOMP_REGISTRATION base 0x80850580 func_80850580 preserves=true fpr_mask=0x00000000
