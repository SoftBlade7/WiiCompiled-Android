...
extern "C" void func_80026050(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr1_0 = 0;
...
loc_800260DC:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80022FC0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead32((r13 + -27428));
    r5 = r29;
    r6 = r31;
    r3 = 3;
    ctx->lr = 0x8002610Cu;
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r31 = MemoryInline::FlatRead32((r13 + -27428));
    r30 = MemoryInline::FlatRead16((r31 + 32));
    r3 = r31;
    ctx->lr = 0x8002612Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80026138:
{
    ...
    r0 = MemoryInline::FlatRead8((r13 + -32624));
...
loc_80026148:
{
    r0 = MemoryInline::FlatRead32((r13 + -27428));
    r30 = MemoryInline::FlatRead32((r13 + -27432));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_80026158:
{
    r0 = MemoryInline::FlatRead8((r13 + -27424));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_80026164:
{
    ...
    r0 = 1;
    MemoryInline::FlatWrite8((r13 + -27424), static_cast<uint8_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x80026050 func_80026050 preserves=true fpr_mask=0x00000000
