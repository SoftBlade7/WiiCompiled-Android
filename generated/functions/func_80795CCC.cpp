...
extern "C" void func_80795CCC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80795CCC:
{
    ...
    r3 = r30;
    r31_addr_0 = (r31 + r29);
    r12 = MemoryInline::FlatRead32(r31_addr_0);
    ctr = r12;
    ctx->lr = 0x80795D14u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    guest_range_1 = MemoryInline::ResolveRangeHost((r25 + 4), 0, 30u, false, true);
    MemoryInline::WriteResolved32(guest_range_1, 0u, (r25 + 4), r3);
    r4 = (r31 + r29);
    r0 = 0;
    r29 = 0;
    MemoryInline::WriteResolved32(guest_range_1, 4u, (r25 + 8), r30);
    r31 = 0;
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 8u, ((static_cast<uint64_t>(static_cast<uint32_t>(r3)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_1, 8u, (r25 + 12), r3);
        MemoryInline::WriteResolved32(guest_range_1, 12u, (r25 + 16), r0);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 16u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_1, 16u, (r25 + 20), r0);
        MemoryInline::WriteResolved32(guest_range_1, 20u, (r25 + 24), r0);
    }
    MemoryInline::WriteResolved16(guest_range_1, 28u, (r25 + 32), static_cast<uint16_t>(r0));
    r0 = MemoryInline::FlatRead32((r4 + 4));
    MemoryInline::WriteResolved32(guest_range_1, 24u, (r25 + 28), r0);
    goto loc_80795D74;
}
...
loc_80795D50:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8079E224u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80795CCC func_80795CCC preserves=true fpr_mask=0x00000000
