...
extern "C" void func_805C3B1C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805C3B1C:
{
    ...
    r3 = 0x809C0000u;
    r5 = 0x80890000u;
    f1.d = MemoryInline::FlatReadFloat32((r5 + 12924));
    r4 = 0;
...
// RECOMP_REGISTRATION base 0x805C3B1C func_805C3B1C preserves=true fpr_mask=0x00000000
