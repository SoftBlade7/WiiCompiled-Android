...
extern "C" void func_800B1790(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800B17C4:
{
    ...
    r0 = 1;
    MemoryInline::FlatWriteRam8((r30 + 4864), static_cast<uint8_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x800B1790 func_800B1790 preserves=true fpr_mask=0x00000000
