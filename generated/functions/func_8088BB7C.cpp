...
extern "C" void func_8088BB7C(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = 0;
    MemoryInline::FlatWrite32((r3 + 408), r4);
    MemoryInline::FlatWrite8((r3 + 412), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x8088BB7C func_8088BB7C preserves=true fpr_mask=0x00000000
