...
extern "C" void func_807C66B4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807C66B4:
{
    ...
    f31.d = f1.d;
    r26 = r3;
    r0 = MemoryInline::FlatRead16((r9 + 140));
    r27 = r5;
    r28 = r6;
    r29 = r7;
...
loc_807C6748:
{
    r4 = 0x809C0000u;
    r3 = (r4 + 15364);
    f2.d = MemoryInline::FlatReadFloat32((r4 + 15364));
...
loc_807C6770:
{
    ...
    r0 = 0;
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 32), 0, 92u, false, true);
    ...
    MemoryInline::WriteResolvedFloat32(guest_range_1, 0u, (r1 + 32), f1.d);
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 16u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f1.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f1.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 20u, (r1 + 52), f1.d);
        MemoryInline::WriteResolvedFloat32(guest_range_1, 16u, (r1 + 48), f1.d);
    }
    MemoryInline::WriteResolvedFloat32(guest_range_1, 12u, (r1 + 44), f1.d);
    ...
    MemoryInline::WriteResolvedFloat32(guest_range_1, 72u, (r1 + 104), f0.d);
    MemoryInline::WriteResolvedFloat32(guest_range_1, 84u, (r1 + 116), f1.d);
...
loc_807C67C4:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r26 + 100));
    r7 = r28;
    r9 = r30;
    r5 = (r1 + 20);
    r6 = (r1 + 8);
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x807C4998u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_807C67F0:
{
    ...
    ctx->fpr[12] = f12;
    ctx->cr = cr;
    InvokeDirectCpu<0x807C26ACu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_807C6840:
{
    ...
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_2, 24u, (r1 + 160));
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFFFFF gpr_write=0xFFF01FFB gpr_return=0x00000018 fpr_read=0xFFFFFFFF fpr_write=0xE0003FFF fpr_return=0x00000002 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=0 fence=1
// RECOMP_REGISTRATION base 0x807C66B4 func_807C66B4 preserves=false fpr_mask=0x80000000
