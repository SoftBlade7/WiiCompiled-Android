...
extern "C" void func_8076734C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8076734C:
{
    ...
    r3 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 15192));
...
// RECOMP_REGISTRATION base 0x8076734C func_8076734C preserves=true fpr_mask=0x00000000
