...
extern "C" void func_800D6424(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800D6424:
{
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + -448), 0, 456u, false, true);
    MemoryInline::WriteResolved32(guest_range_1, 0u, (r1 + -448), r1);
    r1 = (r1 + -448);
    r0 = ctx->lr;
    MemoryInline::WriteResolved32(guest_range_1, 452u, (r1 + 452), r0);
    r11 = (r1 + 448);
    // inline leaf 0x8002159C (7 guest instruction(s))
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 424u, ((static_cast<uint64_t>(static_cast<uint32_t>(r26)) << 32) | static_cast<uint32_t>(r27)))) {
        MemoryInline::WriteResolved32(guest_range_1, 424u, (r11 + -24), r26);
        MemoryInline::WriteResolved32(guest_range_1, 428u, (r11 + -20), r27);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 432u, ((static_cast<uint64_t>(static_cast<uint32_t>(r28)) << 32) | static_cast<uint32_t>(r29)))) {
        MemoryInline::WriteResolved32(guest_range_1, 432u, (r11 + -16), r28);
        MemoryInline::WriteResolved32(guest_range_1, 436u, (r11 + -12), r29);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 440u, ((static_cast<uint64_t>(static_cast<uint32_t>(r30)) << 32) | static_cast<uint32_t>(r31)))) {
        MemoryInline::WriteResolved32(guest_range_1, 440u, (r11 + -8), r30);
        MemoryInline::WriteResolved32(guest_range_1, 444u, (r11 + -4), r31);
    }
...
loc_800D6498:
{
    ...
    r4 = MemoryInline::FlatRead32((r29 + 1820));
...
loc_800D83B8:
{
    ...
    if (MkwStateFreeAbiEnabled(0x8011E43Cu) && KnownTranslatedCpuCall<0x8011E43Cu>::kAvailable && !KnownTranslatedCpuCall<0x8011E43Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x8011E43Cu>()) {
        const auto state_free_result_8011E43C_AAD5 = func_8011E43C_statefree_v0(r3, xer);
        r0 = static_cast<uint32_t>(state_free_result_8011E43C_AAD5[0]);
        r3 = static_cast<uint32_t>(state_free_result_8011E43C_AAD5[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x800D6424 func_800D6424 preserves=true fpr_mask=0x00000000
