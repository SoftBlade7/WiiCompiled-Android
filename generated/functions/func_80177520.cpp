...
extern "C" void func_80177520(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80177520:
{
    ...
    r3 = MemoryInline::FlatRead32((r3 + -21024));
    ctx->lr = 0x80177538u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x801783FCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
...
// RECOMP_REGISTRATION base 0x80177520 func_80177520 preserves=true fpr_mask=0x00000000
