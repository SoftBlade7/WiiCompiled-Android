...
extern "C" void func_805AEF6C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805AEF6C:
{
    ...
    MemoryInline::FlatWriteFloat32((r29 + 4), f5.d);
...
// RECOMP_GUEST_ABI gpr_read=0xE000003E gpr_write=0xE000004B gpr_return=0x00000008 fpr_read=0x80000018 fpr_write=0x8000003F fpr_return=0x00000002 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x805AEF6C func_805AEF6C preserves=true fpr_mask=0x00000000
