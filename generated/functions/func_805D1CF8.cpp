...
extern "C" void func_805D1CF8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805D1D90:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(137));
}
...
loc_805D1D9C:
{
    ...
    r5 = 0x80890000u;
    f1.d = MemoryInline::FlatReadFloat32((r5 + 16804));
    r3 = r29;
...
// RECOMP_REGISTRATION base 0x805D1CF8 func_805D1CF8 preserves=true fpr_mask=0x00000000
