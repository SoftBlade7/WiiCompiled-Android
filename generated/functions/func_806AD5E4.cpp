...
extern "C" void func_806AD5E4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806AD5E4:
{
    ...
    guest_range_0 = MemoryInline::ResolveRangeHost((r3 + 12), 0, 2516u, true, false);
    f2.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 1764u, (r3 + 1776));
...
{
    {
        const auto resolved_pair = MemoryInline::ReadResolvedPair32(guest_range_0, 2500u);
        if (resolved_pair.valid) {
            f0.d = PpcBitCastToFloatInline(resolved_pair.first);
            f4.d = PpcBitCastToFloatInline(resolved_pair.second);
        } else {
            f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 2500u, (r3 + 2512));
            f4.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 2504u, (r3 + 2516));
        }
    }
    r0 = MemoryInline::ReadResolved8(guest_range_0, 0u, (r3 + 12));
    f0.d = static_cast<double>(PpcForceSingleValueInline(f0.d - f4.d));
    f3.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 1764u, (r3 + 1776));
    f6.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 2508u, (r3 + 2520));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}

loc_806AD660:
{
    f5.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 2512u, (r3 + 2524));
    ...
    f31.d = static_cast<double>(PpcForceSingleValueInline(f4.d + f1.d));
...
loc_806AD690:
{
    r30 = MemoryInline::ReadResolved32(guest_range_0, 1816u, (r3 + 1828));
    r4 = 0;
}
...
loc_806AD6D4:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r30 = MemoryInline::FlatRead32((r31 + 1828));
    r3 = 0;
}
...
loc_806AD798:
{
    ...
    r5 = MemoryInline::ReadResolved32(guest_range_1, 0u, r3);
    r4 = 0x808A0000u;
    r0 = MemoryInline::ReadResolved32(guest_range_1, 4u, (r3 + 4));
    guest_range_2 = MemoryInline::ResolveRangeHost((r1 + 120), 0, 168u, false, true);
    MemoryInline::WriteResolved32(guest_range_2, 124u, (r1 + 244), r0);
    f0.d = MemoryInline::FlatReadFloat32((r4 + -10592));
    MemoryInline::WriteResolved32(guest_range_2, 120u, (r1 + 240), r5);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r4 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r3 + 8));
            r0 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r3 + 12));
        }
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 128u, ((static_cast<uint64_t>(static_cast<uint32_t>(r4)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_2, 132u, (r1 + 252), r0);
        MemoryInline::WriteResolved32(guest_range_2, 128u, (r1 + 248), r4);
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r4 = MemoryInline::ReadResolved32(guest_range_1, 16u, (r3 + 16));
            r0 = MemoryInline::ReadResolved32(guest_range_1, 20u, (r3 + 20));
        }
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 136u, ((static_cast<uint64_t>(static_cast<uint32_t>(r4)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_2, 140u, (r1 + 260), r0);
        MemoryInline::WriteResolved32(guest_range_2, 136u, (r1 + 256), r4);
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r4 = MemoryInline::ReadResolved32(guest_range_1, 24u, (r3 + 24));
            r0 = MemoryInline::ReadResolved32(guest_range_1, 28u, (r3 + 28));
        }
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 144u, ((static_cast<uint64_t>(static_cast<uint32_t>(r4)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_2, 148u, (r1 + 268), r0);
        MemoryInline::WriteResolved32(guest_range_2, 144u, (r1 + 264), r4);
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r4 = MemoryInline::ReadResolved32(guest_range_1, 32u, (r3 + 32));
            r0 = MemoryInline::ReadResolved32(guest_range_1, 36u, (r3 + 36));
        }
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 152u, ((static_cast<uint64_t>(static_cast<uint32_t>(r4)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_2, 156u, (r1 + 276), r0);
        MemoryInline::WriteResolved32(guest_range_2, 152u, (r1 + 272), r4);
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r4 = MemoryInline::ReadResolved32(guest_range_1, 40u, (r3 + 40));
            r0 = MemoryInline::ReadResolved32(guest_range_1, 44u, (r3 + 44));
        }
    }
    r3 = (r1 + 116);
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 160u, ((static_cast<uint64_t>(static_cast<uint32_t>(r4)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_2, 164u, (r1 + 284), r0);
        MemoryInline::WriteResolved32(guest_range_2, 160u, (r1 + 280), r4);
    }
    MemoryInline::WriteResolvedFloat32(guest_range_2, 0u, (r1 + 120), f0.d);
    ctx->lr = 0x806AD834u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r4 = 0x808A0000u;
    r3 = (r1 + 144);
    f1.d = MemoryInline::FlatReadFloat32((r4 + -10492));
    r4 = (r1 + 104);
    ctx->lr = 0x806AD88Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    f6 = ctx->fpr[6];
    f31 = ctx->fpr[31];
    f1.d = MemoryInline::FlatReadFloat32((r31 + 2532));
    r3 = (r1 + 56);
    r4 = (r1 + 116);
...
loc_806AD918:
{
    f1.d = MemoryInline::FlatReadFloat32((r31 + 2528));
    r3 = (r1 + 32);
    r4 = (r1 + 80);
    // inline leaf 0x80514810 (10 guest instruction(s))
    f3.d = MemoryInline::FlatReadFloat32((r4 + 8));
...
loc_806AD990:
{
    ...
    MemoryInline::FlatWriteRamFloat64((r1 + 336), f0.d);
    r12 = MemoryInline::FlatRead32(r3);
    r4 = fctiwzword0;
...
// RECOMP_REGISTRATION base 0x806AD5E4 func_806AD5E4 preserves=false fpr_mask=0xC0000000
