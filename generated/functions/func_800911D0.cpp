...
extern "C" void func_800911D0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800911D0:
{
    ...
    r31 = ctx->gpr[31];
    r0 = 0;
    MemoryInline::FlatWrite8((r31 + 392), static_cast<uint8_t>(r0));
    r3 = r31;
...
// RECOMP_REGISTRATION base 0x800911D0 func_800911D0 preserves=true fpr_mask=0x00000000
