...
extern "C" void func_800B06A0(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = (r13 + -27064);
    MemoryInline::FlatWrite32((r13 + -27056), r0);
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x800B06A0 func_800B06A0 preserves=true fpr_mask=0x00000000
