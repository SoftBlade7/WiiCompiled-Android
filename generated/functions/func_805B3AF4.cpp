...
extern "C" void func_805B3AF4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805B3AF4:
{
    ...
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x8067DAF4u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x805B3AF4 func_805B3AF4 preserves=true fpr_mask=0x00000000
