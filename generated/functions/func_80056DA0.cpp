...
extern "C" void func_80056DA0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80056E18:
{
    ...
    r27 = (r31 + 20);
    f0.d = MemoryInline::FlatReadFloat32((r2 + -29712));
    r25 = 0;
...
loc_80056E74:
{
    r22 = MemoryInline::FlatRead16(r29);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_80056E84;
    }
}
...
loc_80056E94:
{
    ...
    r3 = (r24 + r0);
    r24_addr_2 = (r24 + r0);
    r0 = MemoryInline::FlatRead32(r24_addr_2);
    ...
    r30 = (r30 + 16);
    f0.d = MemoryInline::FlatReadFloat32((r23 + 20));
...
// RECOMP_REGISTRATION base 0x80056DA0 func_80056DA0 preserves=false fpr_mask=0x80000000
