...
extern "C" void func_801371F4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80137230:
{
    ...
    r0 = 5898;
    r5 = 11;
    MemoryInline::FlatWriteRam16(r31, static_cast<uint16_t>(r0));
    r0 = 255;
    r4 = r30;
    r3 = (r31 + 20);
    MemoryInline::FlatWriteRam16((r31 + 16), static_cast<uint16_t>(r5));
    r5 = 8;
    MemoryInline::FlatWriteRam16((r31 + 6), static_cast<uint16_t>(r0));
    MemoryInline::FlatWriteRam16((r31 + 14), static_cast<uint16_t>(r27));
    MemoryInline::FlatWriteRam8((r31 + 18), static_cast<uint8_t>(r28));
    MemoryInline::FlatWriteRam8((r31 + 19), static_cast<uint8_t>(r29));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
// RECOMP_GUEST_ABI gpr_read=0xFC0023FB gpr_write=0xFC000BFB gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x801371F4 func_801371F4 preserves=true fpr_mask=0x00000000
