...
extern "C" void func_800AE490(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800AE4EC:
{
    r0 = MemoryInline::FlatRead8((r31 + 234));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_800AE4F8:
{
    r3 = MemoryInline::FlatRead8((r31 + 235));
}
...
loc_800AE608:
{
    ...
    r3 = r31;
    r5 = MemoryInline::FlatRead32((r31 + 256));
    ctx->lr = 0x800AE618u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800AE740u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x800AE490 func_800AE490 preserves=true fpr_mask=0x00000000
