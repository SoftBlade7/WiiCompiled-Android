...
extern "C" void func_8007B7B0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_8007B7B0:
{
    ...
    r0 = (r0_rot_0 & -4);
    r7 = (r4 + r0);
    r6 = MemoryInline::FlatRead8((r7 + 220));
    r5 = MemoryInline::FlatRead8((r7 + 221));
    r4 = MemoryInline::FlatRead8((r7 + 222));
    r0 = MemoryInline::FlatRead8((r7 + 223));
...
// RECOMP_REGISTRATION base 0x8007B7B0 func_8007B7B0 preserves=true fpr_mask=0x00000000
