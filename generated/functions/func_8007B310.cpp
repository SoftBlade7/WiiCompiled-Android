...
extern "C" void func_8007B310(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = (r13 + -27288);
    MemoryInline::FlatWrite32((r13 + -27272), r0);
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x8007B310 func_8007B310 preserves=true fpr_mask=0x00000000
