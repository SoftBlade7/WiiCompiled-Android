...
extern "C" void func_80725424(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80725424:
{
    ...
    r31 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r31 + 8444));
...
// RECOMP_REGISTRATION base 0x80725424 func_80725424 preserves=true fpr_mask=0x00000000
