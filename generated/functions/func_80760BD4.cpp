...
extern "C" void func_80760BD4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80760BD4:
{
    ...
    r3 = 0;
    MemoryInline::FlatWrite32((r31 + 292), r3);
...
loc_80760C38:
{
    ...
    MemoryInline::FlatWrite8((r31 + 300), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x80760BD4 func_80760BD4 preserves=true fpr_mask=0x00000000
