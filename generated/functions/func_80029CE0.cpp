...
extern "C" void func_80029CE0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80029CE0:
{
    ...
    r6 = MemoryInline::FlatRead8((r31 + 12));
    ctx->lr = 0x80029D08u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[4] = r4;
    ...
    ctx->gpr[7] = r7;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x80029D30u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80029CE0 func_80029CE0 preserves=true fpr_mask=0x00000000
