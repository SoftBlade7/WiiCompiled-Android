...
extern "C" void func_8064FBA8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8064FBA8:
{
    ...
    MemoryInline::FlatWriteRam32((r5 + 20), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
    return;
...
// RECOMP_REGISTRATION base 0x8064FBA8 func_8064FBA8 preserves=true fpr_mask=0x00000000
