...
extern "C" void func_800823E0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r5_rot_0 = 0;
...
loc_800823E0:
{
    ...
    r5_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(19));
    r5 = (r5_rot_0 & 3);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
...
// RECOMP_REGISTRATION base 0x800823E0 func_800823E0 preserves=true fpr_mask=0x00000000
