...
extern "C" void func_8012B4DC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r3 = 0x80280000u;
    f0.d = MemoryInline::FlatReadFloat32((r2 + -27168));
    r3 = (r3 + 7040);
    ...
    MemoryInline::FlatWrite32((r30 + 152), r0);
    ctx->lr = 0x8012B59Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->fpr[1] = f1;
    ctx->cr = cr;
    InvokeDirectCpu<0x8012BB9Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
...
// RECOMP_REGISTRATION base 0x8012B4DC func_8012B4DC preserves=true fpr_mask=0x00000000
