...
extern "C" void func_80131684(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr1_0 = 0;
...
loc_801316BC:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800118B4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80131684 func_80131684 preserves=true fpr_mask=0x00000000
