...
extern "C" void func_80869884(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80869934:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8086E224u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80869940:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite8((r30 + 8), static_cast<uint8_t>(r28));
    r29 = (r29 + 1);
}
...
// RECOMP_REGISTRATION base 0x80869884 func_80869884 preserves=true fpr_mask=0x00000000
