...
extern "C" void func_806E3324(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806E3324:
{
    ...
    r0 = MemoryInline::FlatRead16((r31 + 224));
    r0 = (r0 << 16);
...
loc_806E3368:
{
    r0 = MemoryInline::FlatRead8((r31 + 249));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_806E3424:
{
    r4 = 0x808A0000u;
    r3 = r31;
    f1.d = MemoryInline::FlatReadFloat32((r4 + 1944));
    r4 = 727;
    ctx->lr = 0x806E3438u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x806E3324 func_806E3324 preserves=true fpr_mask=0x00000000
