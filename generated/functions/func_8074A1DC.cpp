...
extern "C" void func_8074A1DC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r4 = (r3 + 1);
    MemoryInline::FlatWrite32((r31 + 832), r4);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_8074A238;
    }
}
...
{
    r3 = 0x808D0000u;
    r0 = MemoryInline::FlatRead16((r3 + -18098));
    r0 = (r0 << 16);
...
// RECOMP_REGISTRATION base 0x8074A1DC func_8074A1DC preserves=true fpr_mask=0x00000000
