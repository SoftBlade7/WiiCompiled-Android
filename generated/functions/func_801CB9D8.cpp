...
extern "C" void func_801CB9D8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801CB9D8:
{
    ...
    r3 = r31;
    r4 = (r4 + 16608);
    r12 = MemoryInline::FlatRead32((r4 + 1780));
    ctr = r12;
    ctx->lr = 0x801CBA14u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x801CB9D8 func_801CB9D8 preserves=true fpr_mask=0x00000000
