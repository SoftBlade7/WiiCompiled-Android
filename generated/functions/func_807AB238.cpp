...
extern "C" void func_807AB238(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807AB238:
{
    ...
    r28 = r3;
    r29 = MemoryInline::FlatRead32((r3 + 640));
    r3 = r29;
...
loc_807AB2C0:
{
    r0 = MemoryInline::FlatRead32((r28 + 700));
...
loc_807AB2CC:
{
    ...
    f2.d = MemoryInline::FlatReadFloat32((r28 + 76));
...
// RECOMP_REGISTRATION base 0x807AB238 func_807AB238 preserves=false fpr_mask=0x80000000
