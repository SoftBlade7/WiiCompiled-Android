...
extern "C" void func_80564ADC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80564B00:
{
    ...
    r4 = 0x808B0000u;
    r0 = 0;
    MemoryInline::FlatWriteRam32((r4 + 19444), r0);
...
// RECOMP_REGISTRATION base 0x80564ADC func_80564ADC preserves=true fpr_mask=0x00000000
