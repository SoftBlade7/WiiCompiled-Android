...
extern "C" void func_806DE624(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806DE624:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x806DDA84u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_806DE6C4:
{
    r3 = MemoryInline::FlatRead32((r29 + 17200));
    r4 = r25;
    // inline leaf 0x8082B3A8 (4 guest instruction(s))
    r3 = MemoryInline::FlatRead32((r3 + 88));
...
loc_806DE740:
{
    MemoryInline::FlatWrite32((r31 + 180), r24);
}
...
// RECOMP_REGISTRATION base 0x806DE624 func_806DE624 preserves=true fpr_mask=0x00000000
