...
extern "C" void func_801A199C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr1_0 = 0;
...
loc_801A19DC:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r5 = MemoryInline::FlatRead32((r29 + 412));
    r4 = r30;
    r3 = (r31 + 72);
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x801A1A2Cu;
...
// RECOMP_REGISTRATION base 0x801A199C func_801A199C preserves=true fpr_mask=0x00000000
