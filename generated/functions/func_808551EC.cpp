...
extern "C" void func_808551EC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_808551EC:
{
    ...
    r3 = 0x809C0000u;
    r4 = (r4 + 17720);
    MemoryInline::FlatWriteRam32((r3 + 17960), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x808551EC func_808551EC preserves=true fpr_mask=0x00000000
