...
extern "C" void func_80587C54(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80587C54:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8057829Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80587C88:
{
    r3 = 0x808B0000u;
    r3 = (r3 + 23112);
    MemoryInline::FlatWrite32((r31 + 704), r3);
    goto loc_80587CA8;
}
...
loc_80587C98:
{
    ...
    r3 = (r3 + 23112);
    r0 = (r3 + 48);
    MemoryInline::FlatWrite32((r31 + 704), r0);
}
...
loc_80587CC0:
{
    ...
    MemoryInline::FlatWriteFloat32((r31 + 664), f0.d);
    goto loc_80587CEC;
}
...
// RECOMP_REGISTRATION base 0x80587C54 func_80587C54 preserves=true fpr_mask=0x00000000
