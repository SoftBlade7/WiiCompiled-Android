...
extern "C" void func_807653A8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80765418:
{
    ...
    r3 = 0x808A0000u;
    r28 = 0x802A0000u;
    f30.d = MemoryInline::FlatReadFloat64((r4 + 14992));
    f31.d = MemoryInline::FlatReadFloat32((r3 + 15004));
    r25 = r31;
    r27 = (r31 + 88);
    r29 = (r28 + 16640);
    r24 = 0;
...
// RECOMP_REGISTRATION base 0x807653A8 func_807653A8 preserves=false fpr_mask=0xC0000000
