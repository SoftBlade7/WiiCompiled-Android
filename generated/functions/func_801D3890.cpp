...
extern "C" void func_801D3890(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801D3890:
{
    ...
    r31 = r3;
    MemoryInline::FlatWrite32((r4 + 2012), r0);
    r4 = 0;
    ctx->lr = 0x801D38B8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x801D3890 func_801D3890 preserves=true fpr_mask=0x00000000
