...
extern "C" void func_806C9860(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806C9908:
{
    r4 = -1;
    r5 = 0;
    MemoryInline::FlatWrite16((r29 + 180), static_cast<uint16_t>(r0));
    r0_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(1));
    r0 = (r0_rot_0 & 131070);
    r3 = MemoryInline::FlatRead32((r29 + 196));
    MemoryInline::FlatWrite32((r29 + 184), r4);
    r4 = MemoryInline::FlatRead32((r29 + 200));
    MemoryInline::FlatWrite32((r29 + 188), r5);
    r3_addr_0 = (r3 + r0);
...
loc_806C99A0:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x806CA2F0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    f27.d = MemoryInline::FlatReadFloat32((r31 + 56));
    r26 = (r25 + 16640);
    f28.d = MemoryInline::FlatReadFloat64((r31 + 80));
    r23 = 0;
    f29.d = MemoryInline::FlatReadFloat32((r31 + 68));
    r30 = 0;
    f30.d = MemoryInline::FlatReadFloat32((r31 + 72));
    r24 = 0;
    r27 = 0x808C0000u;
    r28 = 1127219200;
    r31 = 0x808C0000u;
...
loc_806C9A00:
{
    MemoryInline::FlatWrite32((r3 + 180), r24);
    r4 = 622;
...
loc_806C9A10:
{
    r3 = MemoryInline::FlatRead32((r29 + 220));
    r3_addr_5 = (r3 + r30);
    r22 = MemoryInline::FlatRead32(r3_addr_5);
...
loc_806C9A24:
{
    f0.d = MemoryInline::FlatReadFloat32((r25 + 16640));
...
loc_806C9A40:
{
    f3.d = MemoryInline::FlatReadFloat32((r27 + 17160));
    ...
    f3 = ctx->fpr[3];
    cr = ctx->cr;
    f0.d = MemoryInline::FlatReadFloat32((r31 + 17164));
    r3 = r22;
...
loc_806C9AD4:
{
    ...
    MemoryInline::FlatWrite8((r3 + 176), static_cast<uint8_t>(r24));
}
...
loc_806C9B18:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x806CC8E8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_806C9B2C:
{
    ...
    ctx->gpr[6] = r6;
    ctx->cr = cr;
    InvokeDirectCpu<0x806F4864u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r5 = ctx->gpr[5];
    ...
    r23 = (r23 + 4);
    r22 = (r22 + 1);
    MemoryInline::FlatWrite8((r3 + 33), static_cast<uint8_t>(r30));
}
...
// RECOMP_REGISTRATION base 0x806C9860 func_806C9860 preserves=false fpr_mask=0xFC000000
