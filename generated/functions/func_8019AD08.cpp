...
extern "C" void func_8019AD08(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8019AD08:
{
    ...
    f0.d = (-(f0.d));
    r31 = r5;
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 32u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f5.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f4.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 32u, (r1 + 32), f5.d);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 36u, (r1 + 36), f4.d);
    }
    MemoryInline::WriteResolvedFloat32(guest_range_0, 40u, (r1 + 40), f3.d);
    ...
    ctx->fpr[5] = f5;
    ctx->fpr[6] = f6;
    InvokeDirectCpu<0x8019ABE4u>(ctx);
    f2 = ctx->fpr[2];
    f3 = ctx->fpr[3];
    f4 = ctx->fpr[4];
    f5 = ctx->fpr[5];
    ...
    ctx->fpr[4] = f4;
    ctx->fpr[5] = f5;
    InvokeDirectCpu<0x8019ACACu>(ctx);
    ...
    f4 = ctx->fpr[4];
    f5 = ctx->fpr[5];
    f0.d = MemoryInline::FlatReadFloat32((r2 + -26352));
...
// RECOMP_GUEST_ABI gpr_read=0x8000003F gpr_write=0x8000003B gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x000000FF fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8019AD08 func_8019AD08 preserves=true fpr_mask=0x00000000
