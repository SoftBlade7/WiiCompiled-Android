...
extern "C" void func_8019E7FC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8019E820:
{
    r4 = MemoryInline::FlatRead32((r4 + 136));
    r0 = 2;
    r3 = 0;
...
// RECOMP_REGISTRATION base 0x8019E7FC func_8019E7FC preserves=true fpr_mask=0x00000000
