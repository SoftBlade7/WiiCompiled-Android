...
extern "C" void func_8010A920(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8010A920:
{
    ...
    ctx->gpr[5] = r5;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x800F017Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8010A920 func_8010A920 preserves=true fpr_mask=0x00000000
