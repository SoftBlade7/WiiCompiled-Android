...
extern "C" void func_800E6B10(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800E6B34:
{
    ...
    r4 = 0;
    MemoryInline::FlatWrite32((r3 + 2192), r30);
...
// RECOMP_REGISTRATION base 0x800E6B10 func_800E6B10 preserves=true fpr_mask=0x00000000
