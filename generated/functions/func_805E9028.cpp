...
extern "C" void func_805E9028(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805E9028:
{
    ...
    r28 = 0;
    r31 = 0;
    r30 = MemoryInline::FlatRead32((r3 + 112));
    goto loc_805E9080;
}

loc_805E9050:
{
    r29 = MemoryInline::FlatRead32((r26 + 108));
    r4 = r27;
    r29_addr_2 = (r29 + r31);
...
// RECOMP_REGISTRATION base 0x805E9028 func_805E9028 preserves=true fpr_mask=0x00000000
