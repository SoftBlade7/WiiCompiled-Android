...
extern "C" void func_805630EC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80563178:
{
    r12 = MemoryInline::FlatRead32(r31);
    r3 = r31;
    r4 = MemoryInline::FlatRead32((r5 + 228));
    r5 = r8;
    r12 = MemoryInline::FlatRead32((r12 + 52));
    ctr = r12;
    ctx->lr = 0x80563194u;
...
// RECOMP_REGISTRATION base 0x805630EC func_805630EC preserves=true fpr_mask=0x00000000
