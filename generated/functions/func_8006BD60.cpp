...
extern "C" void func_8006BD60(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8006BDCC:
{
    f1.d = MemoryInline::FlatReadFloat32((r2 + -29360));
    r3 = 1;
...
// RECOMP_REGISTRATION base 0x8006BD60 func_8006BD60 preserves=true fpr_mask=0x00000000
