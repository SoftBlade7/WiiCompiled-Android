...
extern "C" uint64_t func_80590D08_statefree(uint32_t);

extern "C" void func_807D3868(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807D38A4:
{
    ...
    // psq_load w=1 quant=0 (using PPC_PsqL)
    r31_psq_tmp_0 = (r31 + 8);
    PpcSetPairedFprInline(f1, PPC_PsqLGqrInline<1u, 0u>(ctx, mkw_gqr0, r31_psq_tmp_0));
    r3 = r28;
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    ...
    r30_psq_tmp_0 = (r30 + 8);
    PPC_PsqStStackInline<1u, 0u>(ctx, r30_psq_tmp_0, f0.d);
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x80590D08u) && KnownTranslatedCpuCall<0x80590D08u>::kAvailable && !KnownTranslatedCpuCall<0x80590D08u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80590D08u>()) {
        const auto state_free_result_80590D08_18A3 = func_80590D08_statefree(r3);
        r3 = static_cast<uint32_t>(state_free_result_80590D08_18A3);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
        ...
        ctx->fpr[5] = f5;
        ctx->cr = cr;
        InvokeDirectCpu<0x80590D08u>(ctx);
        r0 = ctx->gpr[0];
        r1 = ctx->gpr[1];
        r3 = ctx->gpr[3];
        r4 = ctx->gpr[4];
    ...
    // psq_load w=1 quant=0 (using PPC_PsqL)
    r3_psq_tmp_6 = (r3 + 8);
    PpcSetPairedFprInline(f0, PPC_PsqLGqrInline<1u, 0u>(ctx, mkw_gqr0, r3_psq_tmp_6));
    // psq_load w=1 quant=0 (using PPC_PsqL)
    r30_psq_tmp_1 = (r30 + 8);
    PpcSetPairedFprInline(f3, PPC_PsqLStackInline<1u, 0u>(ctx, r30_psq_tmp_1));
    r3 = 1;
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    ...
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r30_psq_tmp_2 = (r30 + 8);
    PPC_PsqStStackInline<1u, 0u>(ctx, r30_psq_tmp_2, f2.d);
    ...
    MemoryInline::FlatWriteFloat32((r29 + 12), f4.d);
...
// RECOMP_GUEST_ABI gpr_read=0xF000001B gpr_write=0xF000000B gpr_return=0x00000008 fpr_read=0x00000000 fpr_write=0x0000003F fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x807D3868 func_807D3868 preserves=true fpr_mask=0x00000000
