...
extern "C" void func_806D9000(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_806D9000:
{
    ...
    f6.d = MemoryInline::FlatReadFloat32((r1 + 152));
    ...
    MemoryInline::FlatWriteRamFloat32((r1 + 224), f6.d);
    f1.d = static_cast<double>(PpcForceSingleValueInline(f2.d + f1.d));
    MemoryInline::FlatWriteRamFloat32((r1 + 228), f5.d);
    MemoryInline::FlatWriteRamFloat32((r1 + 232), f4.d);
...
loc_806D9110:
{
    ...
    r3 = (r31 + 388);
    f3.d = MemoryInline::FlatReadFloat32((r31 + 388));
    f2.d = MemoryInline::FlatReadFloat32((r30 + 148));
    ...
    MemoryInline::FlatWriteFloat32((r31 + 392), f0.d);
    ctx->lr = 0x806D91A8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_806D92C8:
{
    ...
    ctx->fpr[4] = f4;
    ctx->fpr[31] = f31;
    InvokeDirectCpu<0x806D93A8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r0 = (r0 | 1);
    f1.d = MemoryInline::FlatReadFloat32((r6 + 24));
...
// RECOMP_REGISTRATION base 0x806D9000 func_806D9000 preserves=false fpr_mask=0x80000000
