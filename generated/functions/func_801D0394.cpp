...
extern "C" void func_801D0394(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801D0394:
{
    ...
    r4 = 0x80350000u;
    r4 = (r4 + 16608);
    r31 = MemoryInline::FlatRead8((r4 + 1765));
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x801D0394 func_801D0394 preserves=true fpr_mask=0x00000000
