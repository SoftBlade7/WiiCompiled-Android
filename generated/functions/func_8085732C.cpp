...
extern "C" void func_8085732C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8085736C:
{
    ...
    xer = ctx->xer;
    r3 = 0x808B0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + -5040));
...
// RECOMP_REGISTRATION base 0x8085732C func_8085732C preserves=true fpr_mask=0x00000000
