...
extern "C" void func_8064FB34(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8064FB34:
{
    r3 = MemoryInline::FlatRead32((r3 + 476));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8064FB34 func_8064FB34 preserves=true fpr_mask=0x00000000
