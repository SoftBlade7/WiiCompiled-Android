...
extern "C" void func_800AEE30(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r3_rot_0 = 0;
...
loc_800AEE30:
{
    r3 = MemoryInline::FlatRead8((r3 + 233));
    r0 = (0 - r3);
    r0 = (r0 | r3);
...
// RECOMP_REGISTRATION base 0x800AEE30 func_800AEE30 preserves=true fpr_mask=0x00000000
