...
extern "C" void func_805C3A28(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_inl0_cont_8061B358:
{
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWrite8((r31 + 1544), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x805C3A28 func_805C3A28 preserves=true fpr_mask=0x00000000
