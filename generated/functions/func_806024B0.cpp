...
extern "C" void func_806024B0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806024EC:
{
    ...
    r3 = 0x809C0000u;
    r5 = 255;
    MemoryInline::FlatWrite8((r30 + 12), static_cast<uint8_t>(r0));
...
// RECOMP_GUEST_ABI gpr_read=0xF000007A gpr_write=0xF000007B gpr_return=0x00000018 fpr_read=0x80000002 fpr_write=0x80000001 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x806024B0 func_806024B0 preserves=false fpr_mask=0x80000000
