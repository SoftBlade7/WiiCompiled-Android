...
extern "C" void func_80672A00(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80672A00:
{
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 264u, ((static_cast<uint64_t>(static_cast<uint32_t>(r26)) << 32) | static_cast<uint32_t>(r27)))) {
        MemoryInline::WriteResolved32(guest_range_0, 264u, (r1 + 264), r26);
        MemoryInline::WriteResolved32(guest_range_0, 268u, (r1 + 268), r27);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 272u, ((static_cast<uint64_t>(static_cast<uint32_t>(r28)) << 32) | static_cast<uint32_t>(r29)))) {
        MemoryInline::WriteResolved32(guest_range_0, 272u, (r1 + 272), r28);
        MemoryInline::WriteResolved32(guest_range_0, 276u, (r1 + 276), r29);
    }
...
loc_80672B28:
{
    r26 = MemoryInline::FlatRead32((r1 + 264));
...
// RECOMP_REGISTRATION base 0x80672A00 func_80672A00 preserves=true fpr_mask=0x00000000
