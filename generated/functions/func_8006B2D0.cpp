...
extern "C" void func_8006B2D0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8006B2D0:
{
    ...
    f3 = ctx->fpr[3];
    f4 = ctx->fpr[4];
    f4.d = MemoryInline::FlatReadFloat32((r2 + -29348));
...
// RECOMP_REGISTRATION base 0x8006B2D0 func_8006B2D0 preserves=true fpr_mask=0x00000000
