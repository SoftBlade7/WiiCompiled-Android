...
extern "C" void func_806486BC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_806486BC:
{
    ...
    xer = ctx->xer;
    r0 = 2;
    MemoryInline::FlatWrite32((r30 + 1996), r0);
    r3 = (r30 + 1420);
    r4 = (r30 + 68);
    r5 = 0;
    ctx->gpr[0] = r0;
    ...
    xer = ctx->xer;
    r0 = 3;
    MemoryInline::FlatWrite32((r30 + 2592), r0);
    r3 = (r30 + 2016);
    r4 = (r30 + 68);
    r5 = 0;
    ctx->gpr[0] = r0;
    ...
    xer = ctx->xer;
    r0 = 4;
    MemoryInline::FlatWrite32((r30 + 3188), r0);
    r3 = (r30 + 2612);
    r4 = (r30 + 68);
    r5 = 0;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x806486BC func_806486BC preserves=true fpr_mask=0x00000000
