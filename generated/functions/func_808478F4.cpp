...
extern "C" void func_808478F4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_808478F4:
{
    ...
    r4 = (r26 + 344);
    r27 = MemoryInline::FlatRead32((r5 + 300));
    ctx->lr = 0x80847930u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_80847954:
{
    r25 = MemoryInline::FlatRead32((r28 + 576));
    r3 = r27;
    r4 = (r30 & 255);
    ctx->lr = 0x80847964u;
    ctx->gpr[0] = r0;
...
loc_8084796C:
{
    r3 = MemoryInline::FlatRead32((r26 + 6536));
    r5 = (r30 & 255);
    r4 = 0;
...
loc_80847A28:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8059E644u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r31 = ctx->gpr[31];
    ...
    r4 = (r3 + 8);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r3)) + static_cast<uint64_t>(static_cast<uint32_t>(8)) + (static_cast<uint64_t>(static_cast<uint32_t>(0)) & 1u);
...
loc_80847B08:
{
    MemoryInline::FlatWrite32((r28 + 596), r25);
    r3 = r25;
...
// RECOMP_REGISTRATION base 0x808478F4 func_808478F4 preserves=true fpr_mask=0x00000000
