...
extern "C" void func_8067E6EC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8067E6EC:
{
    MemoryInline::FlatWrite8((r3 + 189), static_cast<uint8_t>(r4));
    return;
}
...
// RECOMP_REGISTRATION base 0x8067E6EC func_8067E6EC preserves=true fpr_mask=0x00000000
