...
extern "C" void func_806AC0C0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806AC0C0:
{
    ...
    r31 = MemoryInline::FlatRead32((r3 + 552));
...
// RECOMP_REGISTRATION base 0x806AC0C0 func_806AC0C0 preserves=true fpr_mask=0x00000000
