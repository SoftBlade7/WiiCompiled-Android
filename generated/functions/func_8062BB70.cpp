...
extern "C" void func_8062BB70(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8062BB70:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_174A = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_174A[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_174A[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    r11 = MemoryInline::FlatRead32((r29 + 3292));
    ...
    r8 = MemoryInline::FlatRead32((r29 + 3304));
    ...
    r12 = 0x808C0000u;
    r10 = 0x808C0000u;
    guest_range_4 = MemoryInline::ResolveRangeHost((r29 + 3316), 0, 60u, true, false);
    r6 = MemoryInline::ReadResolved32(guest_range_4, 0u, (r29 + 3316));
    r12 = (r12 + -11748);
    ...
    MemoryInline::WriteResolved32(guest_range_1, 16u, (r28 + 1636), r0);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r21 = MemoryInline::ReadResolved32(guest_range_4, 12u, (r29 + 3328));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r24 = MemoryInline::ReadResolved32(guest_range_4, 24u, (r29 + 3340));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r27 = MemoryInline::ReadResolved32(guest_range_4, 36u, (r29 + 3352));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r9 = MemoryInline::ReadResolved32(guest_range_4, 48u, (r29 + 3364));
        }
    }
...
// RECOMP_REGISTRATION base 0x8062BB70 func_8062BB70 preserves=true fpr_mask=0x00000000
