...
extern "C" void func_805B3A84(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805B3A84:
{
    ...
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x8081B5A8u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x805B3A84 func_805B3A84 preserves=true fpr_mask=0x00000000
