...
extern "C" void func_8064BC90(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r0 = -1;
    MemoryInline::FlatWrite32((r31 + 3888), r0);
...
// RECOMP_REGISTRATION base 0x8064BC90 func_8064BC90 preserves=true fpr_mask=0x00000000
