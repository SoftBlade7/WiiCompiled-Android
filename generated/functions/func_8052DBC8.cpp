...
extern "C" void func_8052DBC8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8052DBC8:
{
    ...
    r31 = ctx->gpr[31];
    r0 = 17;
    MemoryInline::FlatWrite32((r29 + 2888), r0);
    r3 = (r29 + 2940);
    r4 = 0;
    MemoryInline::FlatWrite32((r29 + 2896), r31);
    r5 = 112;
    MemoryInline::FlatWrite32((r29 + 2900), r31);
    MemoryInline::FlatWrite32((r29 + 2920), r31);
    ctx->lr = 0x8052DC44u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r7 = ctx->gpr[7];
    r31 = ctx->gpr[31];
    MemoryInline::FlatWrite32((r29 + 3052), r30);
    r3 = r29;
...
// RECOMP_REGISTRATION base 0x8052DBC8 func_8052DBC8 preserves=true fpr_mask=0x00000000
