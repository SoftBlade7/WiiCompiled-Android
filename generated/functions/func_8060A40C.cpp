...
extern "C" void func_8060A40C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8060A44C:
{
    r5 = 0x80890000u;
    r4 = 0x80890000u;
    f30.d = MemoryInline::FlatReadFloat64((r5 + 28312));
    r26 = r31;
    f31.d = MemoryInline::FlatReadFloat32((r4 + 28308));
    r25 = (r3 + 772);
    r24 = 0;
    r29 = 1127219200;
    r28 = 0;
...
loc_8060A478:
{
    MemoryInline::FlatWrite32((r26 + 1168), r28);
    r3 = (r25 + 152);
    r4 = 4;
...
loc_8060A4E4:
{
    f1.d = MemoryInline::FlatReadFloat32((r30 + 28288));
    r4 = 3;
    ctx->lr = 0x8060A4F0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8060A4FC:
{
    r0 = MemoryInline::FlatRead32((r31 + 7180));
}
...
{
    r0 = 0;
    MemoryInline::FlatWrite32((r31 + 7180), r0);
    r3 = (r31 + 6204);
    r4 = 1;
    // inline leaf 0x8063C820 (4 guest instruction(s))
    r0 = (r4 * 68);
...
// RECOMP_REGISTRATION base 0x8060A40C func_8060A40C preserves=false fpr_mask=0xC0000000
