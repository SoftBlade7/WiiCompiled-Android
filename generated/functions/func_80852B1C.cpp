...
extern "C" void func_80852B1C(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r4 = 0x808B0000u;
    f1.d = MemoryInline::FlatReadFloat32((r4 + -6268));
    ctx->gpr[4] = r4;
    ctx->fpr[1] = f1;
...
// RECOMP_REGISTRATION base 0x80852B1C func_80852B1C preserves=true fpr_mask=0x00000000
