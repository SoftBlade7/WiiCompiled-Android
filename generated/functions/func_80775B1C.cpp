...
extern "C" void func_80775B1C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80775B1C:
{
    ...
    r5 = (r1 + 20);
    f1.d = MemoryInline::FlatReadFloat32((r6 + 16912));
    ...
    ctx->fpr[0] = f0;
    ctx->fpr[1] = f1;
    InvokeDirectCpu<0x80775BA4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80775B1C func_80775B1C preserves=true fpr_mask=0x00000000
