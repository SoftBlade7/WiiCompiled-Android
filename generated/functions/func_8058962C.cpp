...
extern "C" void func_8058962C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8058962C:
{
    ...
    r0 = (r0_rot_0 & 1);
    r3_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(21));
    r3 = (r3_rot_0 & 1);
...
loc_80589670:
{
    ...
    r0 = (r0_rot_1 & 1);
    r3_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(20));
    r3 = (r3_rot_1 & 1);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r3), static_cast<uint32_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x8058962C func_8058962C preserves=true fpr_mask=0x00000000
