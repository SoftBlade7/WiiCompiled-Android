...
extern "C" void func_8056EEF4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8056EEF4:
{
    ...
    r31 = r3;
    f30.d = MemoryInline::FlatReadFloat32((r4 + 5936));
    r26 = (r5 & 65535);
    r25 = (r0 & 65535);
    r24 = 0;
    r19 = 0x808B0000u;
...
loc_8056EF9C:
{
    ...
    r0 = (r0 * 48);
    f28.d = MemoryInline::FlatReadFloat32((r29 + 4));
    r5 = r28;
    r3 = (r1 + 8);
    r4 = (r4 + r0);
    r18 = 0;
    f29.d = MemoryInline::FlatReadFloat32((r4 + 4));
    r4 = (r4 + 12);
    ...
    f5.d = static_cast<double>(PpcForceSingleValueInline(f28.d + f29.d));
    ...
    f29.d = PpcFmulsInline(f5.d, f5.d);
    f0.d = static_cast<double>(PpcForceSingleValueInline(f1.d + f0.d));
    ...
    f0.d = static_cast<double>(PpcForceSingleValueInline(f29.d - f28.d));
...
loc_8056F03C:
{
    ...
    f31.d = PpcFmulsInline(f28.d, f1.d);
}
...
// RECOMP_REGISTRATION base 0x8056EEF4 func_8056EEF4 preserves=false fpr_mask=0xF0000000
