...
extern "C" void func_80024C10(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80024C10:
{
    ...
    r10 = 1127219200;
    r9 = (r4 ^ -2147483648);
    MemoryInline::FlatWriteRam32((r1 + 104), r10);
    r4 = (r4 + r6);
    r8 = (r5 ^ -2147483648);
    f2.d = MemoryInline::FlatReadFloat64((r2 + -31168));
    MemoryInline::FlatWriteRam32((r1 + 108), r9);
    r4 = (r4 ^ -2147483648);
    f5.d = MemoryInline::FlatReadFloat32((r2 + -31172));
    ...
    f6.d = MemoryInline::FlatReadFloat32((r2 + -31160));
    f0.d = MemoryInline::FlatReadFloat64((r1 + 104));
    MemoryInline::FlatWriteRam32((r1 + 112), r10);
    ...
    InvokeDirectCpu<0x80024A70u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFF8FE gpr_write=0xFFFFFFFF gpr_return=0x00000018 fpr_read=0xFFFFE000 fpr_write=0xFFFFFFFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x80024C10 func_80024C10 preserves=true fpr_mask=0x00000000
