...
extern "C" void func_805AF1BC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805AF1BC:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r3 + 9528));
...
// RECOMP_GUEST_ABI gpr_read=0x00000072 gpr_write=0x0000000A gpr_return=0x00000008 fpr_read=0x00000002 fpr_write=0x000000FF fpr_return=0x00000002 cr_read=0x00 cr_write=0x00 xer_read=0 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x805AF1BC func_805AF1BC preserves=true fpr_mask=0x00000000
