...
extern "C" void func_8052C0B0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8052C0EC:
{
    r3 = 0x808B0000u;
    r4 = (r1 + 8);
    r3 = MemoryInline::FlatRead32((r3 + 12840));
    r5 = 1;
    ctx->lr = 0x8052C100u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8052C10C:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8052B228u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8052C0B0 func_8052C0B0 preserves=true fpr_mask=0x00000000
