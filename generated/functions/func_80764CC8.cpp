...
extern "C" void func_80764CC8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r4 = (r26 + r28);
    MemoryInline::FlatWrite32((r4 + 344), r3);
    goto loc_80764D78;
}
...
loc_80764D88:
{
    r12 = MemoryInline::FlatRead32((r26 + 356));
    r3 = (r26 + 356);
    r4 = 3;
    r5 = 0;
...
// RECOMP_REGISTRATION base 0x80764CC8 func_80764CC8 preserves=true fpr_mask=0x00000000
