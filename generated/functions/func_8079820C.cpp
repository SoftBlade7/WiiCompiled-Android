...
extern "C" void func_8079820C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80798218:
{
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r4), static_cast<uint32_t>(226));
}
...
// RECOMP_REGISTRATION base 0x8079820C func_8079820C preserves=true fpr_mask=0x00000000
