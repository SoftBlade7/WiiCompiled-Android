...
extern "C" void func_8014FF40(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8014FF40:
{
    ...
    r31_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(27));
    r31 = (r31_rot_0 & 1);
    ctx->lr = 0x8014FF74u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8014FF7C:
{
    ...
    r6 = MemoryInline::FlatRead8((r3 + 13));
    r7 = (r0 | 32768);
    goto loc_8014FF9C;
}
...
// RECOMP_REGISTRATION base 0x8014FF40 func_8014FF40 preserves=true fpr_mask=0x00000000
