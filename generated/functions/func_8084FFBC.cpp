...
extern "C" void func_8084FFBC(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r4 = 0x808B0000u;
    f1.d = MemoryInline::FlatReadFloat32((r4 + -7564));
    ctx->gpr[4] = r4;
    ctx->fpr[1] = f1;
...
// RECOMP_REGISTRATION base 0x8084FFBC func_8084FFBC preserves=true fpr_mask=0x00000000
