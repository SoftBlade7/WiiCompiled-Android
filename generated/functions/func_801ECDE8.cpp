...
extern "C" void func_801ECDE8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_801ECE14:
{
    ...
    r30 = (r30 + r30_ca_1);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r0)) + static_cast<uint64_t>(static_cast<uint32_t>(r3)) + (static_cast<uint64_t>(static_cast<uint32_t>(r30_ca_1)) & 1u);
        xer = (xer & 0xDFFFFFFFu) | (static_cast<uint32_t>((ppcCarryWide >> 32) & 1u) << 29);
    }
}
...
loc_801ECE68:
{
    ...
    r0 = (static_cast<uint32_t>((static_cast<uint64_t>(r22) * static_cast<uint64_t>(r0)) >> 32));
...
// RECOMP_REGISTRATION base 0x801ECDE8 func_801ECDE8 preserves=true fpr_mask=0x00000000
