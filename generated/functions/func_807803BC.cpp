...
extern "C" void func_807803BC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807803BC:
{
    ...
    ctx->gpr[30] = r30;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x807D0B5Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x807803BC func_807803BC preserves=true fpr_mask=0x00000000
