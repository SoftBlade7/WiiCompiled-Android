...
extern "C" void func_8015260C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80152618:
{
    ...
    r3 = (r31 + 98);
    r5 = MemoryInline::FlatRead16((r31 + 104));
    r6 = 1;
    r7 = 0;
    ctx->lr = 0x80152630u;
    ctx->gpr[0] = r0;
...
loc_80152634:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8015609Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8015260C func_8015260C preserves=true fpr_mask=0x00000000
