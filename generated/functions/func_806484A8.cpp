...
extern "C" void func_806484A8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806484A8:
{
    ...
    r5 = (r29 + 36);
    r6 = 0x808C0000u;
    guest_range_1 = MemoryInline::ResolveRangeHost((r29 + 36), 0, 36u, true, false);
    r30 = MemoryInline::ReadResolved32(guest_range_1, 0u, (r29 + 36));
    r4 = 0x808C0000u;
    r12 = MemoryInline::ReadResolved32(guest_range_1, 4u, (r5 + 4));
    r3 = (r3 + -1508);
    r11 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r5 + 8));
    r7 = (r29 + 48);
    MemoryInline::WriteResolved32(guest_range_0, 84u, (r31 + 84), r11);
    r6 = (r6 + -1520);
    r5 = (r29 + 60);
    r4 = (r4 + -1544);
    MemoryInline::WriteResolved32(guest_range_0, 68u, (r31 + 68), r3);
    r3 = (r31 + 128);
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 72u, ((static_cast<uint64_t>(static_cast<uint32_t>(r31)) << 32) | static_cast<uint32_t>(r30)))) {
    ...
    MemoryInline::WriteResolved32(guest_range_0, 80u, (r31 + 80), r12);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r10 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r29 + 48));
            r9 = MemoryInline::ReadResolved32(guest_range_1, 16u, (r7 + 4));
        }
    }
    r8 = MemoryInline::ReadResolved32(guest_range_1, 20u, (r7 + 8));
    MemoryInline::WriteResolved32(guest_range_0, 104u, (r31 + 104), r8);
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 88u, ((static_cast<uint64_t>(static_cast<uint32_t>(r6)) << 32) | static_cast<uint32_t>(r31)))) {
        MemoryInline::WriteResolved32(guest_range_0, 88u, (r31 + 88), r6);
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r7 = MemoryInline::ReadResolved32(guest_range_1, 24u, (r29 + 60));
    ...
    r3 = 0x808A0000u;
    r5 = 0x808D0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + -27080));
    r5 = (r5 + 14156);
    r4 = 2001;
    r0 = 0;
...
// RECOMP_REGISTRATION base 0x806484A8 func_806484A8 preserves=true fpr_mask=0x00000000
