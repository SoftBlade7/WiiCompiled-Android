...
extern "C" void func_80207B40(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80207B40:
{
    ...
    ctx->gpr[3] = r3;
    ctx->gpr[7] = r7;
    InvokeDirectCpu<0x80201A6Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r7 = ctx->gpr[7];
...
// RECOMP_REGISTRATION base 0x80207B40 func_80207B40 preserves=true fpr_mask=0x00000000
