...
extern "C" void func_8072B5F8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8072B5F8:
{
    r5 = MemoryInline::FlatRead32((r4 + 80));
...
// RECOMP_REGISTRATION base 0x8072B5F8 func_8072B5F8 preserves=true fpr_mask=0x00000000
