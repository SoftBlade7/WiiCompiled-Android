...
extern "C" void func_8082BAE0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8082BB60:
{
    ...
    r4 = 2;
    r7 = MemoryInline::FlatRead32((r31 + 180));
    r6 = 0;
...
loc_8082BB78:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x807DC2F0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8082BAE0 func_8082BAE0 preserves=false fpr_mask=0x80000000
