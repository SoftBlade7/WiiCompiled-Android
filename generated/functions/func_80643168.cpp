...
extern "C" void func_80643168(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
{
    r0 = 1;
    MemoryInline::FlatWrite32((r3 + 5796), r0);
    goto loc_806431D8;
}
...
// RECOMP_REGISTRATION base 0x80643168 func_80643168 preserves=true fpr_mask=0x00000000
