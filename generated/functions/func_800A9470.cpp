...
extern "C" void func_800A9470(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800A94F0:
{
    ...
    r5 = (r28 + -4);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r5), static_cast<uint32_t>(r26));
}
...
loc_800A9504:
{
    ...
    r5 = ctx->gpr[5];
    cr = ctx->cr;
    MemoryInline::FlatWrite8((r28 + 8), static_cast<uint8_t>(r29));
    r3 = (r28 + -4);
...
// RECOMP_REGISTRATION base 0x800A9470 func_800A9470 preserves=true fpr_mask=0x00000000
