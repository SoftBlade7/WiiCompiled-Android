...
extern "C" void func_80131E84(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80131E84:
{
    r4 = 0x80330000u;
    r4 = (r4 + 24024);
    MemoryInline::FlatWriteRam32((r4 + 132), r3);
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x80131E84 func_80131E84 preserves=true fpr_mask=0x00000000
