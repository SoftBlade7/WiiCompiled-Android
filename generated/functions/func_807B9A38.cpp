...
extern "C" void func_807B9A38(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807B9AA8:
{
    ...
    SetCRFloatResident(cr, 0, f31.d, f4.d);
}
...
loc_807B9ABC:
{
    ...
    f4.d = PpcFmulsInline(f31.d, f1.d);
}
...
loc_807B9AC8:
{
    ...
    MemoryInline::FlatWriteFloat32((r29 + 4), f3.d);
    f0.d = (-(f0.d));
...
// RECOMP_REGISTRATION base 0x807B9A38 func_807B9A38 preserves=false fpr_mask=0x80000000
