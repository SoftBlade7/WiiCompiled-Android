...
extern "C" void func_8079BFEC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8079BFEC:
{
    ...
    r29 = r3;
    r31 = MemoryInline::FlatRead8((r3 + 17));
...
{
    r3_addr_4 = (r3 + r4);
    r4 = MemoryInline::FlatRead8(r3_addr_4);
}
...
loc_8079C078:
{
    ...
    r3 = (r0 + r5);
    MemoryInline::FlatWrite8((r3 + 2), static_cast<uint8_t>(r30));
}
...
// RECOMP_GUEST_ABI gpr_read=0xE00000FB gpr_write=0xE000007B gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x8079BFEC func_8079BFEC preserves=true fpr_mask=0x00000000
