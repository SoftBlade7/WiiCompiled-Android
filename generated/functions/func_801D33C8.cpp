...
extern "C" void func_801D33C8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801D3440:
{
    ...
    ctx->gpr[11] = r11;
    ctx->cr = cr;
    InvokeDirectCpu<0x801D5BD4u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r11 = ctx->gpr[11];
...
loc_801D3474:
{
    ...
    r25 = MemoryInline::FlatRead8((r22 + 56));
...
loc_801D3494:
{
    if ((static_cast<uint32_t>(r0) != static_cast<uint32_t>(123))) {
        goto loc_801D34A0;
    }
}
...
loc_801D34A4:
{
    if ((static_cast<uint32_t>(r0) != static_cast<uint32_t>(91))) {
        goto loc_801D34B0;
    }
}
...
loc_801D34BC:
{
    r25 = (static_cast<int32_t>(static_cast<int8_t>(r3)));
    MemoryInline::FlatWrite8((r22 + 56), static_cast<uint8_t>(r3));
...
loc_801D350C:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801D3224u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801D352C:
{
    r3 = MemoryInline::FlatRead32((r27 + 52));
...
// RECOMP_REGISTRATION base 0x801D33C8 func_801D33C8 preserves=true fpr_mask=0x00000000
