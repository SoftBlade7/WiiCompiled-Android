...
extern "C" void func_800E48C8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800E497C:
{
    r3 = MemoryInline::FlatRead32((r6 + 1756));
    r4 = r29;
    ctx->lr = 0x800E4988u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
{
    r4 = MemoryInline::FlatRead32((r13 + -26868));
    r12 = MemoryInline::FlatRead32((r4 + 2176));
...
{
    r3 = r30;
    r4 = MemoryInline::FlatRead32((r4 + 2180));
    ctr = r12;
    ctx->lr = 0x800E49B8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_800E4A44:
{
    ...
    if (MkwStateFreeAbiEnabled(0x8011E488u) && KnownTranslatedCpuCall<0x8011E488u>::kAvailable && !KnownTranslatedCpuCall<0x8011E488u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x8011E488u>()) {
        const auto state_free_result_8011E488_3F25 = func_8011E488_statefree(r3);
        r3 = static_cast<uint32_t>(state_free_result_8011E488_3F25);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_800E4A60:
{
    ...
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x8011E488u) && KnownTranslatedCpuCall<0x8011E488u>::kAvailable && !KnownTranslatedCpuCall<0x8011E488u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x8011E488u>()) {
        const auto state_free_result_8011E488_46D8 = func_8011E488_statefree(r3);
        r3 = static_cast<uint32_t>(state_free_result_8011E488_46D8);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_800E4A98:
{
    ...
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x8011E488u) && KnownTranslatedCpuCall<0x8011E488u>::kAvailable && !KnownTranslatedCpuCall<0x8011E488u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x8011E488u>()) {
        const auto state_free_result_8011E488_53B5 = func_8011E488_statefree(r3);
        r3 = static_cast<uint32_t>(state_free_result_8011E488_53B5);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x800E48C8 func_800E48C8 preserves=true fpr_mask=0x00000000
