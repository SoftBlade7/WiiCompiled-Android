...
extern "C" void func_806EE830(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
    uint32_t r0_rot_2 = 0;
...
loc_806EE830:
{
    ...
    f1 = ctx->fpr[1];
    ctr = ctx->ctr;
    MemoryInline::FlatWrite32((r29 + 88), r3);
    r5 = 0x808A0000u;
    r3 = r29;
    r4 = 0;
    r12 = MemoryInline::FlatRead32(r29);
    f1.d = MemoryInline::FlatReadFloat32((r5 + 2836));
...
// RECOMP_REGISTRATION base 0x806EE830 func_806EE830 preserves=true fpr_mask=0x00000000
