...
extern "C" void func_80121CA8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80121CA8:
{
    ...
    r12 = r1;
    r11_subfic_ra_0 = r11;
    r11 = (-1600 - r11_subfic_ra_0);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(-1600) >= static_cast<uint32_t>(r11_subfic_ra_0) ? 1u : 0u) << 29);
    r1_addr_0 = (r1 + r11);
...
loc_80121CFC:
{
    r29 = MemoryInline::FlatRead16((r1 + 42));
...
loc_80121DD8:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead32((r26 + 1720));
    r0 = (r3 - r0);
...
loc_80121DEC:
{
    ...
    r3 = -1;
    r0 = 1;
    MemoryInline::FlatWrite32((r26 + 1716), r3);
    r3 = r26;
    r12 = MemoryInline::FlatRead32((r26 + 1160));
    r4 = 3;
...
// RECOMP_REGISTRATION base 0x80121CA8 func_80121CA8 preserves=true fpr_mask=0x00000000
