...
extern "C" void func_8008FA60(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8008FAA4:
{
    ...
    r0 = 1;
    r3 = r31;
    MemoryInline::FlatWrite32((r28 + 24), r29);
    MemoryInline::FlatWrite32((r28 + 28), r30);
...
// RECOMP_REGISTRATION base 0x8008FA60 func_8008FA60 preserves=true fpr_mask=0x00000000
