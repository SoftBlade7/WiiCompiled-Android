...
extern "C" void func_8023E53C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8023E560:
{
    ...
    r0 = (r0_rot_0 & 1);
    MemoryInline::FlatWrite32((r13 + -23792), r0);
...
// RECOMP_REGISTRATION base 0x8023E53C func_8023E53C preserves=true fpr_mask=0x00000000
