...
extern "C" void func_8056156C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8056156C:
{
    ...
    r4 = 0x80890000u;
    f31.d = MemoryInline::FlatReadFloat32((r4 + 5104));
...
// RECOMP_GUEST_ABI gpr_read=0xC00000FF gpr_write=0xC0001FFB gpr_return=0x00000018 fpr_read=0x80000007 fpr_write=0x800003FF fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8056156C func_8056156C preserves=false fpr_mask=0x80000000
