...
extern "C" void func_801E3FA4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801E3FDC:
{
    ...
    ctx->gpr[11] = r11;
    ctx->cr = cr;
    InvokeDirectCpu<0x801DA02Cu>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
...
loc_801E4008:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801E12D4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r6 = ctx->gpr[6];
...
// RECOMP_REGISTRATION base 0x801E3FA4 func_801E3FA4 preserves=true fpr_mask=0x00000000
