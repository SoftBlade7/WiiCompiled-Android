...
extern "C" void func_800FFA54(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800FFAEC:
{
    ...
    r28 = (r28 + 1);
    r3_addr_5 = (r3 + r29);
    MemoryInline::FlatWrite32(r3_addr_5, r30);
    r29 = (r29 + 4);
}
...
loc_800FFB28:
{
    ...
    xer = ctx->xer;
    r30 = 0;
    MemoryInline::FlatWrite32((r27 + 60), r30);
    r3 = MemoryInline::FlatRead32((r27 + 64));
    ctx->lr = 0x800FFB40u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r27 + 64), r30);
    goto loc_800FFCD8;
}
...
loc_800FFBC0:
{
    r28 = MemoryInline::FlatRead32((r31 + 8));
    r27 = 0;
    r29 = 0;
    r30 = 0;
    goto loc_800FFBF0;
...
loc_800FFBD4:
{
    ...
    r27 = (r27 + 1);
    r3_addr_8 = (r3 + r29);
    MemoryInline::FlatWrite32(r3_addr_8, r30);
    r29 = (r29 + 4);
}
...
loc_800FFC18:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x800FEC20u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800FFC80:
{
    ...
    r3 = MemoryInline::FlatRead32((r27 + 4));
    r3_addr_11 = (r3 + r29);
    MemoryInline::FlatWrite32(r3_addr_11, r30);
    r3 = MemoryInline::FlatRead32((r27 + 8));
    r3_addr_12 = (r3 + r29);
    ...
    r28 = (r28 + 1);
    r3_addr_13 = (r3 + r29);
    MemoryInline::FlatWrite32(r3_addr_13, r30);
    r29 = (r29 + 4);
}
...
// RECOMP_REGISTRATION base 0x800FFA54 func_800FFA54 preserves=true fpr_mask=0x00000000
