...
extern "C" void func_801C0B54(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_801C0B54:
{
    ...
    r31 = MemoryInline::FlatRead32((r4 + 2232));
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x801C0B54 func_801C0B54 preserves=true fpr_mask=0x00000000
