...
extern "C" void func_80659680(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806597C0:
{
    ...
    MemoryInline::FlatWrite32((r31 + 10084), r0);
    r5 = MemoryInline::FlatRead32((r3 + -10424));
    r0 = MemoryInline::FlatRead16((r5 + 54));
    r0 = (r0 << 16);
    r0 = (static_cast<int32_t>(r0) >> 16);
...
loc_80659800:
{
    ...
    r30 = (r30 + -24072);
    r5 = 0x809C0000u;
    MemoryInline::FlatWrite32((r31 + 10088), r0);
    r4 = (r30 + 161);
    r3 = 100;
    r5 = (r5 + 8152);
    ctx->lr = 0x80659828u;
    ...
    r0 = (r0 * 12);
    r3 = (r31 + r0);
    r3 = MemoryInline::FlatRead32((r3 + 9708));
    ctx->lr = 0x806598ACu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800D2BA0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80659680 func_80659680 preserves=true fpr_mask=0x00000000
