...
extern "C" void func_8063C844(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8063C844:
{
    ...
    ctx->gpr[4] = r4;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x80079910u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r3 = 0x808A0000u;
    r4 = 1;
    f0.d = MemoryInline::FlatReadFloat32((r3 + -29776));
    r0 = -1;
    MemoryInline::FlatWrite8((r30 + 52), static_cast<uint8_t>(r31));
    r3 = r30;
    MemoryInline::FlatWrite8((r30 + 53), static_cast<uint8_t>(r4));
...
// RECOMP_REGISTRATION base 0x8063C844 func_8063C844 preserves=true fpr_mask=0x00000000
