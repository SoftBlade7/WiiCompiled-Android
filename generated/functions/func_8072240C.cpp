...
extern "C" void func_8072240C(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r3 = 0x808D0000u;
    r3 = MemoryInline::FlatRead16((r3 + -27276));
    r3 = (r3 << 16);
...
// RECOMP_REGISTRATION base 0x8072240C func_8072240C preserves=true fpr_mask=0x00000000
