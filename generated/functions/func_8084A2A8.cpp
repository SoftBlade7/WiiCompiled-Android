...
extern "C" void func_8084A2A8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8084A2D8:
{
    r6 = MemoryInline::FlatRead32((r4 + 100));
...
loc_8084A2E8:
{
    ...
    r29 = r8;
    r3 = (r3 + r0);
    r30 = MemoryInline::FlatRead32((r3 + 1752));
    goto loc_8084A310;
}
...
loc_8084A310:
{
    ...
    r4 = (r28 + r31);
    r27 = r3;
    r3 = MemoryInline::FlatRead32((r4 + 1736));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
// RECOMP_REGISTRATION base 0x8084A2A8 func_8084A2A8 preserves=true fpr_mask=0x00000000
