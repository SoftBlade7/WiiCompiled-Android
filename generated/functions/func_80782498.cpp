...
extern "C" void func_80782498(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807824F4:
{
    ...
    r4 = ctx->gpr[4];
    cr = ctx->cr;
    r0 = MemoryInline::FlatRead32((r29 + 284));
    MemoryInline::FlatWrite32(r31, r0);
    MemoryInline::FlatWrite32((r29 + 284), r31);
}
...
// RECOMP_REGISTRATION base 0x80782498 func_80782498 preserves=true fpr_mask=0x00000000
