...
extern "C" void func_800B4440(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800B4488:
{
    ...
    f1.d = MemoryInline::FlatReadFloat64((r2 + -27800));
...
// RECOMP_REGISTRATION base 0x800B4440 func_800B4440 preserves=false fpr_mask=0x80000000
