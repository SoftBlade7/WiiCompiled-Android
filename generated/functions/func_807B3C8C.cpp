...
extern "C" void func_807B3C8C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807B3C8C:
{
    ...
    r4 = (r5 + r4);
    MemoryInline::FlatWrite32((r3 + 640), r4);
    ...
    r3 = 0x808A0000u;
    f31.d = f1.d;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 24648));
...
loc_807B3D34:
{
    ...
    MemoryInline::FlatWriteFloat32((r31 + 656), f0.d);
    r3 = MemoryInline::FlatRead32((r31 + 640));
    ...
    r5 = 0x808A0000u;
    r4 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r5 + 24656));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    PpcSetPairedFprInline(f2, PPC_PsqLGqrInline<0u, 0u>(ctx, mkw_gqr0, r3));
    f0.d = MemoryInline::FlatReadFloat32((r4 + 24648));
    PpcSetPairedFprInline(f2, PPC_PsMuls0Inline(f2.d, PPC_PsFromScalarInline(f1.d)));
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r31_psq_tmp_0 = (r31 + 660);
    PPC_PsqStGqrInline<0u, 0u>(ctx, mkw_gqr0, r31_psq_tmp_0, f2.d);
    ...
    r31_psq_tmp_1 = (r31 + 668);
    PPC_PsqStGqrInline<1u, 0u>(ctx, mkw_gqr0, r31_psq_tmp_1, f2.d);
    MemoryInline::FlatWriteFloat32((r31 + 676), f0.d);
    MemoryInline::FlatWriteFloat32((r31 + 680), f0.d);
    // psq_load w=0 quant=0 (using PPC_PsqL)
...
// RECOMP_REGISTRATION base 0x807B3C8C func_807B3C8C preserves=false fpr_mask=0x80000000
