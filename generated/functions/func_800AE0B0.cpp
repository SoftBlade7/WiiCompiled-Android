...
extern "C" void func_800AE0B0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800AE0B0:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead8((r30 + 233));
}
...
loc_800AE110:
{
    r0 = MemoryInline::FlatRead8((r30 + 232));
...
loc_800AE12C:
{
    ...
    r3 = ctx->gpr[3];
    r0 = 0;
    MemoryInline::FlatWrite8((r30 + 232), static_cast<uint8_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x800AE0B0 func_800AE0B0 preserves=true fpr_mask=0x00000000
