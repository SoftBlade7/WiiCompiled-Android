...
extern "C" void func_801370B0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801370EC:
{
    ...
    r3 = 5888;
    r0 = 255;
    guest_range_0 = MemoryInline::ResolveRangeHost(r31, 0, 16u, false, true);
    MemoryInline::WriteResolved16(guest_range_0, 0u, r31, static_cast<uint16_t>(r3));
    r4 = r28;
    r3 = (r31 + 8);
    MemoryInline::WriteResolved16(guest_range_0, 6u, (r31 + 6), static_cast<uint16_t>(r0));
    MemoryInline::WriteResolved8(guest_range_0, 14u, (r31 + 14), static_cast<uint8_t>(r30));
    MemoryInline::WriteResolved8(guest_range_0, 15u, (r31 + 15), static_cast<uint8_t>(r29));
...
// RECOMP_REGISTRATION base 0x801370B0 func_801370B0 preserves=true fpr_mask=0x00000000
