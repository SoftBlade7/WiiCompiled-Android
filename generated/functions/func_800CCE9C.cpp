...
extern "C" void func_800CCE9C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800CCE9C:
{
    ...
    r4 = (r31 + 32);
    r3 = 9;
    r12 = MemoryInline::FlatRead32((r13 + -26948));
    ctr = r12;
    ctx->lr = 0x800CCEC8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x800CCE9C func_800CCE9C preserves=true fpr_mask=0x00000000
