...
extern "C" void func_8088EA18(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lfsx_8088EAFC_loc_0 = 0;
    uint32_t addr_lfsx_8088EB08_loc_0 = 0;
    uint32_t addr_lfsx_8088EBA4_loc_0 = 0;
    uint32_t addr_stfsx_8088EA54_loc_0 = 0;
    uint32_t addr_stfsx_8088EA80_loc_0 = 0;
    uint32_t addr_stfsx_8088EB28_loc_0 = 0;
    uint32_t cr0_0 = 0;
...
loc_8088EA44:
{
    ...
    r0 = (r0_rot_2 & 131070);
    r9 = (r9 + 1);
    addr_stfsx_8088EA54_loc_0 = (r8 + r6);
    MemoryInline::FlatWriteFloat32(addr_stfsx_8088EA54_loc_0, f0.d);
...
loc_8088EA70:
{
    ...
    r8 = (r8_rot_0 & 131070);
    addr_stfsx_8088EA80_loc_0 = (r7 + r0);
    MemoryInline::FlatWriteFloat32(addr_stfsx_8088EA80_loc_0, f0.d);
    r6 = 65536;
    r0 = (r6 + -1);
    r7 = 0x808B0000u;
    r6 = MemoryInline::ReadResolved32(guest_range_0, 32u, (r3 + 48));
...
loc_8088EAE4:
{
    ...
    addr_lfsx_8088EAFC_loc_0 = (r12 + r31);
    f1.d = MemoryInline::FlatReadFloat32(addr_lfsx_8088EAFC_loc_0);
    r7 = (r8 * 36);
    r0_rot_9 = PpcRotl32Inline(static_cast<uint32_t>(r8), static_cast<uint32_t>(2));
    r0 = (r0_rot_9 & -4);
    addr_lfsx_8088EB08_loc_0 = (r31 + r0);
    f0.d = MemoryInline::FlatReadFloat32(addr_lfsx_8088EB08_loc_0);
    r7 = (r30 + r7);
...
loc_8088EB28:
{
    addr_stfsx_8088EB28_loc_0 = (r31 + r0);
    MemoryInline::FlatWriteFloat32(addr_stfsx_8088EB28_loc_0, f1.d);
...
loc_8088EB94:
{
    ...
    r9 = (r9 + 1);
    addr_lfsx_8088EBA4_loc_0 = (r4 + r8);
    f0.d = MemoryInline::FlatReadFloat32(addr_lfsx_8088EBA4_loc_0);
...
// RECOMP_REGISTRATION base 0x8088EA18 func_8088EA18 preserves=true fpr_mask=0x00000000
