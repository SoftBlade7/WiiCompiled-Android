...
extern "C" void func_800D1754(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_800D17D4:
{
    MemoryInline::FlatWrite32((r3 + 120), r26);
    r5 = 0x800D0000u;
    r0 = 4;
    r7 = r28;
    r3 = MemoryInline::FlatRead32((r13 + -26896));
    ...
    r9 = r30;
    r10 = r31;
    MemoryInline::FlatWrite32((r3 + 124), r27);
    r5 = (r5 + 12220);
    r6 = 0;
    ...
    ctx->gpr[10] = r10;
    ctx->cr = cr;
    InvokeDirectCpu<0x800CE7A8u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    cr = ctx->cr;
...
// RECOMP_REGISTRATION base 0x800D1754 func_800D1754 preserves=true fpr_mask=0x00000000
