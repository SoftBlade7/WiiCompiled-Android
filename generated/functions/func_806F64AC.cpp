...
extern "C" void func_806F64AC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r3 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 2976));
...
loc_inl1_cont_8019AC68:
{
    ...
    f2.d = MemoryInline::FlatReadFloat32((r3 + 2976));
...
loc_806F65C0:
{
    ...
    r4 = 0x808A0000u;
    r3 = (r1 + 20);
    f0.d = MemoryInline::FlatReadFloat32((r4 + 2992));
    f0.d = PpcFmulsInline(f0.d, f1.d);
...
// RECOMP_REGISTRATION base 0x806F64AC func_806F64AC preserves=false fpr_mask=0xC0000000
