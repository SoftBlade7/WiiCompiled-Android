...
extern "C" void func_80565030(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
{
    r30_addr_2 = (r30 + r0);
    MemoryInline::FlatWrite32(r30_addr_2, r29);
    r31_addr_2 = (r31 + r0);
...
loc_80565088:
{
    ...
    r3 = 0;
    MemoryInline::FlatWriteRam32((r27 + 40), r3);
    r0 = (r0 | 8);
    MemoryInline::FlatWriteRam32((r27 + 68), r0);
...
// RECOMP_REGISTRATION base 0x80565030 func_80565030 preserves=true fpr_mask=0x00000000
