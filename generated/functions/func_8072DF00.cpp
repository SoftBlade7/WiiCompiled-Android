...
extern "C" void func_8072DF00(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8072DF00:
{
    MemoryInline::FlatWrite8((r3 + 437), static_cast<uint8_t>(r4));
    return;
}
...
// RECOMP_REGISTRATION base 0x8072DF00 func_8072DF00 preserves=true fpr_mask=0x00000000
