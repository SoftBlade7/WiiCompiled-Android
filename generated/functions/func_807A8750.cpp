...
extern "C" void func_807A8750(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807A878C:
{
    r4 = MemoryInline::FlatRead16((r29 + 14));
}
...
loc_807A8790:
{
    ...
    r27_psq_tmp_0 = (r27 + 8);
    PPC_PsqStStackInline<1u, 0u>(ctx, r27_psq_tmp_0, f1.d);
...
loc_inl5_cont_80590E04:
{
    ...
    xer = ctx->xer;
    mkw_gqr0 = ctx->gqr[0];
    r4 = MemoryInline::FlatRead32((r28 + 6584));
...
loc_807A883C:
{
    ...
    // psq_load w=1 quant=0 (using PPC_PsqL)
    r3_psq_tmp_2 = (r3 + 8);
    PpcSetPairedFprInline(f0, PPC_PsqLStackInline<1u, 0u>(ctx, r3_psq_tmp_2));
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    PPC_PsqStStackInline<0u, 0u>(ctx, r27, f1.d);
    PpcSetPairedFprInline(f1, PPC_PsMuls0Inline(f0.d, PPC_PsFromScalarInline(f2.d)));
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r27_psq_tmp_1 = (r27 + 8);
    PPC_PsqStStackInline<1u, 0u>(ctx, r27_psq_tmp_1, f1.d);
    goto loc_807A886C;
}
...
loc_807A886C:
{
    ...
    r5 = 0x802A0000u;
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 108), 0, 44u, false, true);
    MemoryInline::WriteResolvedFloat32(guest_range_1, 8u, (r1 + 116), f0.d);
    r4 = (r5 + 16688);
    f5.d = MemoryInline::FlatReadFloat32((r1 + 92));
    f0.d = MemoryInline::FlatReadFloat32((r3 + 4));
    MemoryInline::WriteResolvedFloat32(guest_range_1, 24u, (r1 + 132), f0.d);
    f4.d = MemoryInline::FlatReadFloat32((r1 + 96));
    ...
    MemoryInline::WriteResolvedFloat32(guest_range_1, 40u, (r1 + 148), f6.d);
    MemoryInline::WriteResolvedFloat32(guest_range_1, 4u, (r1 + 112), f5.d);
    MemoryInline::WriteResolvedFloat32(guest_range_1, 20u, (r1 + 128), f4.d);
    MemoryInline::WriteResolvedFloat32(guest_range_1, 36u, (r1 + 144), f3.d);
    MemoryInline::WriteResolvedFloat32(guest_range_1, 0u, (r1 + 108), f2.d);
    MemoryInline::WriteResolvedFloat32(guest_range_1, 16u, (r1 + 124), f1.d);
    MemoryInline::WriteResolvedFloat32(guest_range_1, 32u, (r1 + 140), f0.d);
    ctx->lr = 0x807A88CCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->fpr[10] = f10;
    ctx->xer = xer;
    InvokeDirectCpu<0x807DCE78u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_807A8918:
{
    ...
    PpcSetPairedFprInline(f0, PPC_PsqLStackInline<0u, 0u>(ctx, r3));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    PpcSetPairedFprInline(f6, PPC_PsqLStackInline<0u, 0u>(ctx, r4));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r3_psq_tmp_4 = (r3 + 16);
    ...
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r3_psq_tmp_5 = (r3 + 32);
    PpcSetPairedFprInline(f4, PPC_PsqLStackInline<0u, 0u>(ctx, r3_psq_tmp_5));
    PpcSetPairedFprInline(f10, PPC_PsMulInline(f2.d, f6.d));
    // psq_load w=1 quant=0 (using PPC_PsqL)
    r4_psq_tmp_0 = (r4 + 8);
    PpcSetPairedFprInline(f7, PPC_PsqLStackInline<1u, 0u>(ctx, r4_psq_tmp_0));
    ...
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r3_psq_tmp_8 = (r3 + 8);
    PpcSetPairedFprInline(f1, PPC_PsqLStackInline<0u, 0u>(ctx, r3_psq_tmp_8));
    ...
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r5_psq_tmp_0 = (r5 + 4);
    PPC_PsqStStackInline<1u, 0u>(ctx, r5_psq_tmp_0, f11.d);
    PpcSetPairedFprInline(f13, PPC_PsMaddInline(f5.d, f7.d, f12.d));
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r5_psq_tmp_1 = (r5 + 8);
    PPC_PsqStStackInline<1u, 0u>(ctx, r5_psq_tmp_1, f13.d);
...
loc_807A899C:
{
    ...
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r3_psq_tmp_10 = (r3 + 32);
    PpcSetPairedFprInline(f4, PPC_PsqLStackInline<0u, 0u>(ctx, r3_psq_tmp_10));
    PpcSetPairedFprInline(f10, PPC_PsMulInline(f2.d, f6.d));
    // psq_load w=1 quant=0 (using PPC_PsqL)
    r4_psq_tmp_2 = (r4 + 8);
    PpcSetPairedFprInline(f7, PPC_PsqLStackInline<1u, 0u>(ctx, r4_psq_tmp_2));
    PpcSetPairedFprInline(f12, PPC_PsMulInline(f4.d, f6.d));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r3_psq_tmp_11 = (r3 + 24);
    ...
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r3_psq_tmp_13 = (r3 + 8);
    PpcSetPairedFprInline(f1, PPC_PsqLStackInline<0u, 0u>(ctx, r3_psq_tmp_13));
    PpcSetPairedFprInline(f12, PPC_PsSum0Inline(f12.d, f12.d, f12.d));
    PpcSetPairedFprInline(f9, PPC_PsMaddInline(f1.d, f7.d, f8.d));
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    PPC_PsqStStackInline<1u, 0u>(ctx, r5, f9.d);
    ...
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r5_psq_tmp_2 = (r5 + 4);
    PPC_PsqStStackInline<1u, 0u>(ctx, r5_psq_tmp_2, f11.d);
    PpcSetPairedFprInline(f13, PPC_PsMaddInline(f5.d, f7.d, f12.d));
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r5_psq_tmp_3 = (r5 + 8);
    PPC_PsqStStackInline<1u, 0u>(ctx, r5_psq_tmp_3, f13.d);
    // end of inlined leaf 0x8019A970
    f1.d = MemoryInline::FlatReadFloat32((r1 + 116));
...
loc_807A89F4:
{
    r26 = MemoryInline::FlatRead32((r29 + 4));
    r27 = 0;
}
...
loc_807A8A44:
{
    ...
    xer = ctx->xer;
    mkw_gqr0 = ctx->gqr[0];
    r0 = MemoryInline::FlatRead8((r29 + 28));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_807A8A74:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80704D84u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x807A8750 func_807A8750 preserves=true fpr_mask=0x00000000
