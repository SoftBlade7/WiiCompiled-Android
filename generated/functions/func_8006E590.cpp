...
extern "C" void func_8006E590(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8006E63C:
{
    r27 = MemoryInline::FlatRead32((r13 + -27296));
    r0 = 0;
    r26 = 0;
    r28 = 0;
...
loc_8006E68C:
{
    MemoryInline::FlatWrite32((r13 + -27296), r27);
}
...
// RECOMP_REGISTRATION base 0x8006E590 func_8006E590 preserves=true fpr_mask=0x00000000
