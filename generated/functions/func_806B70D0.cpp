...
extern "C" void func_806B70D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806B70D0:
{
    ...
    r29 = MemoryInline::FlatRead16((r4 + 42));
    r29 = (r29 << 16);
    ...
    f3.d = MemoryInline::FlatReadFloat64((r3 + -3784));
...
loc_806B71EC:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x806B5C84u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_806B722C:
{
    ...
    f0.d = MemoryInline::FlatReadFloat64((r1 + 8));
    f2.d = static_cast<double>(PpcForceSingleValueInline(f0.d - f3.d));
    MemoryInline::FlatWriteRamFloat32((r31 + 4), f2.d);
    r4 = MemoryInline::FlatRead32(r5);
...
// RECOMP_REGISTRATION base 0x806B70D0 func_806B70D0 preserves=true fpr_mask=0x00000000
