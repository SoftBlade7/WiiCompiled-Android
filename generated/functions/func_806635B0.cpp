...
extern "C" void func_806635B0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r3_rot_0 = 0;
...
loc_806635B0:
{
    ...
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x800EBFD4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r0 = (0 - r3);
...
// RECOMP_REGISTRATION base 0x806635B0 func_806635B0 preserves=true fpr_mask=0x00000000
