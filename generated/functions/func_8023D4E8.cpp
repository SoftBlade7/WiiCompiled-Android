...
extern "C" void func_8023D4E8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8023D534:
{
    ...
    r5 = (r13 + -23768);
    r4 = (r13 + -23776);
    f31.d = MemoryInline::FlatReadFloat32((r13 + -23984));
    ...
    f28.d = MemoryInline::FlatReadFloat32((r6 + 4));
    ...
    MemoryInline::FlatWriteFloat32((r6 + 4), f3.d);
...
loc_8023D580:
{
    ...
    ctx->fpr[6] = f6;
    ctx->cr = cr;
    InvokeDirectCpu<0x802277D0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8023D588:
{
    ...
    ctx->fpr[6] = f6;
    ctx->cr = cr;
    InvokeDirectCpu<0x802277A4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8023D58C:
{
    r4 = (r13 + -23984);
    r3 = (r13 + -23976);
    MemoryInline::FlatWriteFloat32((r13 + -23984), f31.d);
    MemoryInline::FlatWriteFloat32((r4 + 4), f30.d);
...
loc_8023D5C0:
{
    ...
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 16), 0, 88u, true, false);
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 64u, (r1 + 80));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f30.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 48u, (r1 + 64));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f29.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 32u, (r1 + 48));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f28.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 16u, (r1 + 32));
    {
...
// RECOMP_GUEST_ABI gpr_read=0xFFC0270E gpr_write=0xFFC00FFB gpr_return=0x00000018 fpr_read=0xFF003FFF fpr_write=0xFF0003FF fpr_return=0x00000002 cr_read=0xC1 cr_write=0xC1 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8023D4E8 func_8023D4E8 preserves=false fpr_mask=0xF0000000
