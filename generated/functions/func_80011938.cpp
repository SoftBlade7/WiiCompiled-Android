...
extern "C" void func_80011938(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr1_0 = 0;
...
{
    r4 = (r28 + r29);
    MemoryInline::FlatWrite8((r4 + -1), static_cast<uint8_t>(r31));
}
...
// RECOMP_REGISTRATION base 0x80011938 func_80011938 preserves=true fpr_mask=0x00000000
