...
extern "C" void func_807D2DE4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807D2DE4:
{
    r3 = MemoryInline::FlatRead8((r3 + 254));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x807D2DE4 func_807D2DE4 preserves=true fpr_mask=0x00000000
