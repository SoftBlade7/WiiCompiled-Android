...
extern "C" void func_80645D28(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80645DB0:
{
    ...
    r4 = (r28 + 784);
    // inline leaf 0x805C2C18 (2 guest instruction(s))
    guest_range_2 = MemoryInline::ResolveRangeHost((r3 + -72), 0, 76u, false, true);
    MemoryInline::WriteResolved32(guest_range_2, 72u, r3, r4);
    // end of inlined leaf 0x805C2C18
    r12 = (r31 + 40);
    r26 = MemoryInline::FlatRead32((r31 + 40));
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 0u, ((static_cast<uint64_t>(static_cast<uint32_t>(r26)) << 32) | static_cast<uint32_t>(r25)))) {
        MemoryInline::WriteResolved32(guest_range_2, 0u, (r1 + 24), r26);
        MemoryInline::WriteResolved32(guest_range_2, 4u, (r1 + 28), r25);
    }
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead8((r28 + 5622));
    r30 = 0;
...
loc_80645EDC:
{
    r0 = MemoryInline::FlatRead8((r28 + 5620));
...
// RECOMP_REGISTRATION base 0x80645D28 func_80645D28 preserves=true fpr_mask=0x00000000
