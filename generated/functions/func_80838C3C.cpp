...
extern "C" void func_80838C3C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80838D58:
{
    ...
    r5 = 0x808B0000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r5 + -13440));
    ctx->lr = 0x80838D74u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80838C3C func_80838C3C preserves=true fpr_mask=0x00000000
