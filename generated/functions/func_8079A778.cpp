...
extern "C" void func_8079A778(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8079A7E0:
{
    ...
    r29 = MemoryInline::FlatRead32((r4 + 13856));
...
loc_8079A7FC:
{
    ...
    r28 = MemoryInline::FlatRead32((r4 + 13856));
...
// RECOMP_REGISTRATION base 0x8079A778 func_8079A778 preserves=true fpr_mask=0x00000000
