...
extern "C" void func_8086CA40(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r0 = 0;
    MemoryInline::FlatWrite32((r30 + 260), r0);
}
...
// RECOMP_REGISTRATION base 0x8086CA40 func_8086CA40 preserves=true fpr_mask=0x00000000
