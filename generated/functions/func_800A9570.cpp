...
extern "C" void func_800A9570(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r25_addr_2 = (r25 + r31);
    r0 = MemoryInline::FlatRead32(r25_addr_2);
    r26 = (r25 + r31);
}
...
loc_800A95B0:
{
    ...
    r5 = ctx->gpr[5];
    cr = ctx->cr;
    MemoryInline::FlatWrite8((r28 + 12), static_cast<uint8_t>(r29));
    r3 = r28;
...
// RECOMP_REGISTRATION base 0x800A9570 func_800A9570 preserves=true fpr_mask=0x00000000
