...
extern "C" void func_805D9154(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = 1;
    MemoryInline::FlatWrite8((r3 + 3521), static_cast<uint8_t>(r0));
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x805D9154 func_805D9154 preserves=true fpr_mask=0x00000000
