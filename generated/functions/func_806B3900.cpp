...
extern "C" void func_806B3900(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806B3900:
{
    ...
    r3 = (r1 + 8);
    MemoryInline::WriteResolved32(guest_range_0, 4u, (r1 + 24), r0);
    r4 = (r1 + 32);
    r6 = MemoryInline::FlatRead32(r29);
    r5 = (r1 + 20);
    r0 = MemoryInline::FlatRead32((r29 + 8));
    f0.d = MemoryInline::FlatReadFloat32((r31 + 20));
    MemoryInline::WriteResolved32(guest_range_0, 0u, (r1 + 20), r6);
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 4u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_0, 8u, (r1 + 28), r0);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 4u, (r1 + 24), f0.d);
    }
    ctx->lr = 0x806B39A4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x806B3900 func_806B3900 preserves=false fpr_mask=0x80000000
