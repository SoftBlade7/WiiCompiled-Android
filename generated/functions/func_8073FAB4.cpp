...
extern "C" void func_8073FAB4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8073FAB4:
{
    ...
    r26 = r3;
    f30.d = f2.d;
    f31.d = MemoryInline::FlatReadFloat64((r4 + 10464));
    r29 = r26;
    r28 = 0;
    r30 = 0x809C0000u;
    r31 = 1127219200;
...
// RECOMP_GUEST_ABI gpr_read=0xFC00000A gpr_write=0xFC000FFB gpr_return=0x00000018 fpr_read=0xE000001F fpr_write=0xE000001F fpr_return=0x00000002 cr_read=0xC1 cr_write=0xC1 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x8073FAB4 func_8073FAB4 preserves=false fpr_mask=0xE0000000
