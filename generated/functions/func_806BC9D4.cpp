...
extern "C" void func_806BC9D4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
// RECOMP_GUEST_ABI gpr_read=0xE000000E gpr_write=0xE000007B gpr_return=0x00000018 fpr_read=0x8000000F fpr_write=0x800000FF fpr_return=0x00000002 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x806BC9D4 func_806BC9D4 preserves=true fpr_mask=0x00000000
