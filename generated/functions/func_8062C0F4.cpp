...
extern "C" void func_8062C0F4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8062C0F4:
{
    ...
    MemoryInline::WriteResolved32(guest_range_2, 984u, (r28 + 984), r31);
    r8 = (r29 + 3460);
    r7 = 0x808C0000u;
    r5 = 0x808C0000u;
    ...
    r11 = MemoryInline::FlatRead32((r29 + 3460));
    ...
    r8 = MemoryInline::FlatRead32((r29 + 3472));
    ...
    r12 = 0x808C0000u;
    r10 = 0x808C0000u;
    guest_range_4 = MemoryInline::ResolveRangeHost((r29 + 3484), 0, 60u, true, false);
    r6 = MemoryInline::ReadResolved32(guest_range_4, 0u, (r29 + 3484));
    r12 = (r12 + -12324);
    ...
    MemoryInline::WriteResolved32(guest_range_1, 16u, (r28 + 1636), r0);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r21 = MemoryInline::ReadResolved32(guest_range_4, 12u, (r29 + 3496));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r24 = MemoryInline::ReadResolved32(guest_range_4, 24u, (r29 + 3508));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r27 = MemoryInline::ReadResolved32(guest_range_4, 36u, (r29 + 3520));
            r31 = MemoryInline::ReadResolved32(guest_range_4, 40u, (r8 + 4));
        }
    }
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 72u, ((static_cast<uint64_t>(static_cast<uint32_t>(r27)) << 32) | static_cast<uint32_t>(r31)))) {
        MemoryInline::WriteResolved32(guest_range_1, 72u, (r28 + 1692), r27);
        MemoryInline::WriteResolved32(guest_range_1, 76u, (r28 + 1696), r31);
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r9 = MemoryInline::ReadResolved32(guest_range_4, 48u, (r29 + 3532));
        }
    }
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_5, 12u, ((static_cast<uint64_t>(static_cast<uint32_t>(r27)) << 32) | static_cast<uint32_t>(r31)))) {
        MemoryInline::WriteResolved32(guest_range_5, 12u, (r1 + 44), r27);
        MemoryInline::WriteResolved32(guest_range_5, 16u, (r1 + 48), r31);
    }
...
// RECOMP_REGISTRATION base 0x8062C0F4 func_8062C0F4 preserves=true fpr_mask=0x00000000
