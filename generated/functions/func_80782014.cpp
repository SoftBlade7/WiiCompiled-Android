...
extern "C" void func_80782014(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80782014:
{
    ...
    r30 = r3;
    r31 = r4;
    r0 = MemoryInline::FlatRead8((r28 + 104));
}
...
{
    r0 = 1;
    MemoryInline::FlatWriteRam8((r28 + 104), static_cast<uint8_t>(r0));
}

loc_80782078:
{
    r4 = MemoryInline::FlatRead8((r28 + 240));
    r3 = (r28 + 112);
    r5 = (r4 + 1);
    r4_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(2));
    r4 = (r4_rot_0 & -4);
    r0 = (r5 & 255);
    MemoryInline::FlatWriteRam8((r28 + 240), static_cast<uint8_t>(r5));
}
...
{
    r0 = 0;
    MemoryInline::FlatWriteRam8((r28 + 240), static_cast<uint8_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x80782014 func_80782014 preserves=true fpr_mask=0x00000000
