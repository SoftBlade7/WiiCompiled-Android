...
extern "C" void func_806AF9EC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806AFA2C:
{
    r0 = MemoryInline::FlatRead32((r3 + 804));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
// RECOMP_REGISTRATION base 0x806AF9EC func_806AF9EC preserves=true fpr_mask=0x00000000
