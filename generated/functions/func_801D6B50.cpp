...
extern "C" void func_801D6B50(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801D6B50:
{
    ...
    r27 = (r27 + 864);
    r25 = MemoryInline::FlatRead32((r28 + 52));
    goto loc_801D6C54;
}
...
// RECOMP_REGISTRATION base 0x801D6B50 func_801D6B50 preserves=true fpr_mask=0x00000000
