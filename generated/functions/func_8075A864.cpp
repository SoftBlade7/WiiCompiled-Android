...
extern "C" void func_8075A864(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8075A864:
{
    ...
    r4 = 0x808A0000u;
    r3 = (r1 + 8);
    f1.d = MemoryInline::FlatReadFloat32((r4 + 13928));
    r4 = (r1 + 32);
...
// RECOMP_GUEST_ABI gpr_read=0xF000002E gpr_write=0xF000003B gpr_return=0x00000018 fpr_read=0xFC00001F fpr_write=0xFC003FFF fpr_return=0x00000002 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8075A864 func_8075A864 preserves=true fpr_mask=0x00000000
