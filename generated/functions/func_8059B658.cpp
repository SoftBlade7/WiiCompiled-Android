...
extern "C" void func_8059B658(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8059B6C0:
{
    r4 = 0x809C0000u;
    r5 = 1;
    r4 = MemoryInline::FlatRead32((r4 + 6484));
    r6 = 0;
    ctx->lr = 0x8059B6D4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8059B6D4:
{
    ...
    ctx->fpr[1] = f1;
    ctx->cr = cr;
    InvokeDirectCpu<0x80577E00u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8059B744:
{
    r30 = MemoryInline::FlatRead8((r30 + 19));
    r5 = 0;
    r4 = MemoryInline::FlatRead32((r31 + 52));
    r6 = 4;
    ctx->lr = 0x8059B758u;
    ...
    MemoryInline::FlatWriteRam8((r29 + 20), static_cast<uint8_t>(r30));
}
...
// RECOMP_REGISTRATION base 0x8059B658 func_8059B658 preserves=true fpr_mask=0x00000000
