...
extern "C" void func_806FEFD0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806FEFD0:
{
    ...
    MemoryInline::FlatWriteRam32((r1 + 1148), r31);
    MemoryInline::FlatWriteRam32((r1 + 1144), r30);
    r30 = r5;
    r5 = (r1 + 8);
    MemoryInline::FlatWriteRam32((r1 + 1140), r29);
    r29 = r3;
    ctx->lr = 0x806FEFF8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_806FF0F4:
{
    ...
    r31 = MemoryInline::FlatRead32((r1 + 1148));
    r30 = MemoryInline::FlatRead32((r1 + 1144));
    r29 = MemoryInline::FlatRead32((r1 + 1140));
    ctx->lr = r0;
    r1 = (r1 + 1152);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x806FEFD0 func_806FEFD0 preserves=true fpr_mask=0x00000000
