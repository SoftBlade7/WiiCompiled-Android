...
extern "C" void func_805D7D9C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805D7D9C:
{
    r3 = MemoryInline::FlatRead32((r3 + 2852));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x805D7D9C func_805D7D9C preserves=true fpr_mask=0x00000000
