...
extern "C" void func_8079231C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr6_0 = 0;
    uint32_t cr7_0 = 0;
...
loc_807923B4:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80791CC8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80792434:
{
    ...
    r3 = 0x809C0000u;
    r28 = (r4 + -1);
    MemoryInline::FlatWrite32((r31 + 80), r28);
...
loc_807924DC:
{
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 0u, ((static_cast<uint64_t>(static_cast<uint32_t>(r5)) << 32) | static_cast<uint32_t>(r4)))) {
        MemoryInline::WriteResolved32(guest_range_1, 0u, (r31 + 20), r5);
        MemoryInline::WriteResolved32(guest_range_1, 4u, (r31 + 24), r4);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 8u, ((static_cast<uint64_t>(static_cast<uint32_t>(r3)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_1, 8u, (r31 + 28), r3);
        MemoryInline::WriteResolved32(guest_range_1, 12u, (r31 + 32), r0);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 16u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_1, 16u, (r31 + 36), r0);
        MemoryInline::WriteResolved32(guest_range_1, 20u, (r31 + 40), r0);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 60u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_1, 60u, (r31 + 80), r0);
        MemoryInline::WriteResolved32(guest_range_1, 64u, (r31 + 84), r0);
    }
}
...
// RECOMP_REGISTRATION base 0x8079231C func_8079231C preserves=true fpr_mask=0x00000000
