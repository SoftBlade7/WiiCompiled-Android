...
extern "C" void func_80798DB4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80798DB4:
{
    r3 = (r3 + 68);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x807B897Cu>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80798DB4 func_80798DB4 preserves=true fpr_mask=0x00000000
