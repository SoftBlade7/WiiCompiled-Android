...
extern "C" void func_8014CE38(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8014CE38:
{
    r4 = 0x80340000u;
    r4 = (r4 + -27840);
    MemoryInline::FlatWriteRam16((r4 + 2), static_cast<uint16_t>(r3));
...
// RECOMP_REGISTRATION base 0x8014CE38 func_8014CE38 preserves=true fpr_mask=0x00000000
