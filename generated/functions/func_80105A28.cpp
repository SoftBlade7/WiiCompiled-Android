...
extern "C" void func_80105A28(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80105A6C:
{
    r30 = MemoryInline::FlatRead32((r7 + 1492));
    goto loc_80105A94;
}
...
loc_80105A90:
{
    r30 = MemoryInline::FlatRead32((r30 + 84));
}
...
loc_80105AA8:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8010541Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80105AC4:
{
    ...
    MemoryInline::FlatWrite16((r3 + 12), static_cast<uint16_t>(r27));
    goto loc_80105AE8;
}
...
loc_80105AE8:
{
    r28 = MemoryInline::FlatRead32((r30 + 44));
    r27 = MemoryInline::FlatRead32((r30 + 40));
    r29 = MemoryInline::FlatRead32((r30 + 36));
    r0 = (r27 - r28);
...
loc_80105B00:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r26), static_cast<int32_t>(16384));
}
...
loc_80105B64:
{
    ...
    MemoryInline::FlatWrite32((r30 + 40), r27);
    r29_addr_1 = (r29 + r3);
...
// RECOMP_REGISTRATION base 0x80105A28 func_80105A28 preserves=true fpr_mask=0x00000000
