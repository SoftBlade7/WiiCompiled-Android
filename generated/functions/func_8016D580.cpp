...
extern "C" void func_8016D580(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8016D580:
{
    ...
    r0_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(10));
    r0_mrot_0 = (r0_rot_0 & 3072);
    r0_mdest_0 = (r0 & -3073);
...
// RECOMP_REGISTRATION base 0x8016D580 func_8016D580 preserves=true fpr_mask=0x00000000
