...
extern "C" void func_80619228(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80619228:
{
    ...
    r4 = 0x80890000u;
    f0.d = MemoryInline::FlatReadFloat32((r4 + 30436));
    ...
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_C9F = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_C9F[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_C9F[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_806192B0:
{
    r5 = (static_cast<int32_t>((static_cast<int64_t>(static_cast<int32_t>(r0)) * static_cast<int64_t>(static_cast<int32_t>(r31))) >> 32));
    r3 = 0x88890000u;
    r4 = (r4 + 19923);
    r0 = (r3 + -30583);
    r3 = (static_cast<int32_t>(r5) >> 14);
    r5 = (static_cast<int32_t>((static_cast<int64_t>(static_cast<int32_t>(r4)) * static_cast<int64_t>(static_cast<int32_t>(r31))) >> 32));
    r4_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(1));
    r4 = (r4_rot_0 & 1);
    r3 = (r3 + r4);
    MemoryInline::FlatWriteRam32((r1 + 28), r3);
    r3 = (static_cast<int32_t>(r5) >> 6);
...
// RECOMP_REGISTRATION base 0x80619228 func_80619228 preserves=false fpr_mask=0x80000000
