...
extern "C" void func_80805A4C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80805A4C:
{
    ...
    f3.d = MemoryInline::FlatReadFloat32((r4 + 21192));
...
// RECOMP_REGISTRATION base 0x80805A4C func_80805A4C preserves=true fpr_mask=0x00000000
