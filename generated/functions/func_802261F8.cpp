...
extern "C" void func_802261F8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_802261F8:
{
    ...
    ctx->gpr[3] = r3;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x80033430u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r31 = ctx->gpr[31];
...
// RECOMP_REGISTRATION base 0x802261F8 func_802261F8 preserves=true fpr_mask=0x00000000
