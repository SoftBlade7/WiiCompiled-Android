...
extern "C" void func_8073E1A8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8073E1A8:
{
    ...
    ctx->gpr[30] = r30;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x8073E798u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r6 = ctx->gpr[6];
...
// RECOMP_REGISTRATION base 0x8073E1A8 func_8073E1A8 preserves=true fpr_mask=0x00000000
