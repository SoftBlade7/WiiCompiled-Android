...
extern "C" void func_807507FC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807507FC:
{
    ...
    r3 = MemoryInline::FlatRead8((r3 + 249));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x807507FC func_807507FC preserves=true fpr_mask=0x00000000
