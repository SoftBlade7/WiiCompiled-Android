...
extern "C" void func_800B1C20(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800B1C20:
{
    ...
    r29 = r3;
    r31 = MemoryInline::FlatRead16((r3 + 24));
...
loc_800B1C80:
{
    MemoryInline::FlatWrite16((r29 + 24), static_cast<uint16_t>(r30));
    r3 = 1;
    goto loc_800B1C94;
}
...
loc_800B1C8C:
{
    MemoryInline::FlatWrite16((r29 + 24), static_cast<uint16_t>(r31));
    r3 = 0;
}
...
// RECOMP_REGISTRATION base 0x800B1C20 func_800B1C20 preserves=true fpr_mask=0x00000000
