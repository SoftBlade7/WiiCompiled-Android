...
extern "C" void func_80175B64(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80175B64:
{
    ...
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    InvokeDirectCpu<0x80176798u>(ctx);
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
// RECOMP_REGISTRATION base 0x80175B64 func_80175B64 preserves=true fpr_mask=0x00000000
