...
extern "C" void func_8019C4CC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8019C57C:
{
    ...
    ctx->gpr[7] = r7;
    ctx->cr = cr;
    InvokeDirectCpu<0x8019C12Cu>(ctx);
    r0 = ctx->gpr[0];
    r7 = ctx->gpr[7];
    cr = ctx->cr;
...
loc_8019C5A4:
{
    ...
    r10 = (r10 + -7072);
    r6 = MemoryInline::FlatRead8((r28 + 6));
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8016A3FCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8019C5D4:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8016A2F8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8019C4CC func_8019C4CC preserves=true fpr_mask=0x00000000
