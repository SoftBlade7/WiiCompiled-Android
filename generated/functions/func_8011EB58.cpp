...
extern "C" void func_8011EB58(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_inl0_cont_800EF4B0:
{
    ...
    r3 = r29;
    r12 = MemoryInline::FlatRead32((r29 + 1160));
    r4 = 2;
    r5 = r31;
    r6 = MemoryInline::FlatRead32((r29 + 1172));
    ctr = r12;
    ctx->lr = 0x8011EBA0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead32((r29 + 2008));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r4), static_cast<int32_t>(0));
}
...
loc_8011EBD0:
{
    MemoryInline::FlatWrite32((r29 + 2008), r31);
...
// RECOMP_REGISTRATION base 0x8011EB58 func_8011EB58 preserves=true fpr_mask=0x00000000
