...
extern "C" void func_80113920(CpuContext* MKW_RESTRICT ctx)
{
    goto loc_80113920;

loc_80113920:
{
    InvokeDirectCpu<0x80113A54u>(ctx);
    return;
}
...
// RECOMP_REGISTRATION base 0x80113920 func_80113920 preserves=true fpr_mask=0x00000000
