...
extern "C" void func_806042A8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806042A8:
{
    ...
    ctx->fpr[1] = f1;
    ctx->cr = cr;
    InvokeDirectCpu<0x8061BA80u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_806042DC:
{
    ...
    r31 = 0x80890000u;
    r4 = 1;
    f1.d = MemoryInline::FlatReadFloat32((r31 + 26752));
    ctx->lr = 0x806042F8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r5 = MemoryInline::FlatRead8((r30 + 376));
    r4 = 0x80890000u;
    r4 = (r4 + 27092);
    r3 = r30;
    r4 = (r4 + 214);
...
// RECOMP_REGISTRATION base 0x806042A8 func_806042A8 preserves=true fpr_mask=0x00000000
