...
extern "C" void func_801D02DC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_801D0304:
{
    ...
    r4 = (r4 + 24648);
    r4_addr_0 = (r4 + r0);
    r31 = MemoryInline::FlatRead16(r4_addr_0);
    goto loc_801D031C;
}
...
// RECOMP_REGISTRATION base 0x801D02DC func_801D02DC preserves=true fpr_mask=0x00000000
