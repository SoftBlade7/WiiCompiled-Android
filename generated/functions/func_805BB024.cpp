...
extern "C" void func_805BB024(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805BB024:
{
    ...
    r30 = r3;
    MemoryInline::FlatWrite32((r3 + 836), r4);
    r4 = 0;
    ...
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(199));
}
...
// RECOMP_REGISTRATION base 0x805BB024 func_805BB024 preserves=true fpr_mask=0x00000000
