...
extern "C" void func_8084D260(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8084D2DC:
{
    ...
    r0 = (r0 ^ -2147483648);
    f5.d = MemoryInline::FlatReadFloat64((r30 + 64));
    r3 = (r29 + 24);
...
// RECOMP_REGISTRATION base 0x8084D260 func_8084D260 preserves=true fpr_mask=0x00000000
