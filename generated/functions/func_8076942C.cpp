...
extern "C" void func_8076942C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8076942C:
{
    ...
    ctx->fpr[3] = f3;
    ctx->fpr[4] = f4;
    InvokeDirectCpu<0x80773D00u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r6 = (r7 + 11652);
    MemoryInline::FlatWriteFloat32((r31 + 224), f1.d);
    r5 = (r31 + 48);
    ...
    f0.d = MemoryInline::FlatReadFloat32((r7 + 11652));
...
// RECOMP_REGISTRATION base 0x8076942C func_8076942C preserves=true fpr_mask=0x00000000
