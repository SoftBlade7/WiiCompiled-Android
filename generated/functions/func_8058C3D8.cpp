...
extern "C" void func_8058C3D8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8058C3D8:
{
    ...
    f0 = ctx->fpr[0];
    f1 = ctx->fpr[1];
    r5 = MemoryInline::FlatRead32((r31 + 104));
    r4 = 0x80890000u;
    r0 = MemoryInline::FlatRead32((r31 + 108));
    r3 = r31;
    MemoryInline::FlatWriteRam32((r1 + 12), r0);
    f0.d = MemoryInline::FlatReadFloat32((r4 + 7036));
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFEF0E gpr_write=0xFFFFFFFF gpr_return=0x00000018 fpr_read=0xFFFFFC00 fpr_write=0xFFFFFFFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x8058C3D8 func_8058C3D8 preserves=true fpr_mask=0x00000000
