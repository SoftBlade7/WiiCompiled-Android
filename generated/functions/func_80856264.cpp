...
extern "C" void func_80856264(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80856264:
{
    ...
    r3 = 0x809C0000u;
    r4 = (r4 + 7440);
    MemoryInline::FlatWriteRam32((r3 + 17976), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x80856264 func_80856264 preserves=true fpr_mask=0x00000000
