...
extern "C" void func_8076B304(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8076B3F0:
{
    ...
    f4 = ctx->fpr[4];
    cr = ctx->cr;
    f0.d = MemoryInline::FlatReadFloat32((r25 + -6236));
...
loc_8076B458:
{
    ...
    MemoryInline::FlatWrite32((r24 + 176), r26);
    r3 = r24;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite8((r24 + 289), static_cast<uint8_t>(r27));
}
...
// RECOMP_REGISTRATION base 0x8076B304 func_8076B304 preserves=true fpr_mask=0x00000000
