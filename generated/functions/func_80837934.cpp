...
extern "C" void func_80837934(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_80837934:
{
    ...
    r31 = ctx->gpr[31];
    f1 = ctx->fpr[1];
    MemoryInline::FlatWrite32((r29 + 1000), r30);
    r3 = 0x809C0000u;
...
// RECOMP_REGISTRATION base 0x80837934 func_80837934 preserves=false fpr_mask=0x80000000
