...
extern "C" void func_80542030(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805420D4:
{
    ...
    r4 = (r27 + r26);
    r3 = r30;
    r26 = MemoryInline::FlatRead32((r4 + 1460));
    r27 = MemoryInline::FlatRead32((r31 + 1456));
    r28 = MemoryInline::FlatRead32((r4 + 1472));
    r29 = MemoryInline::FlatRead32((r4 + 1468));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
{
    r4 = 0x80890000u;
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r29), static_cast<int32_t>(48));
}
...
// RECOMP_REGISTRATION base 0x80542030 func_80542030 preserves=true fpr_mask=0x00000000
