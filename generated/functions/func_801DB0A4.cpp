...
extern "C" void func_801DB0A4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_801DB118:
{
    if ((static_cast<uint32_t>(r25) < static_cast<uint32_t>(3))) {
        goto loc_801DB0D8;
    }
}
...
// RECOMP_REGISTRATION base 0x801DB0A4 func_801DB0A4 preserves=true fpr_mask=0x00000000
