...
extern "C" void func_801F2534(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_801F2600:
{
    ...
    r5 = (r5 + -23936);
    r5 = (r5 + r0);
    MemoryInline::FlatWrite32((r5 + 468), r4);
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[5] = r5;
    ctx->gpr[6] = r6;
...
// RECOMP_REGISTRATION base 0x801F2534 func_801F2534 preserves=true fpr_mask=0x00000000
