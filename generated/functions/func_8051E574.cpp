...
extern "C" void func_8051E574(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8051E574:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801B7544u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8051E764:
{
    ...
    {
        const uint32_t mkw_fifo_word = static_cast<uint32_t>(r5);
        mkw_fifo_burst_0[24] = static_cast<uint8_t>((mkw_fifo_word >> 8));
        mkw_fifo_burst_0[25] = static_cast<uint8_t>(mkw_fifo_word);
    }
    {
        const uint32_t mkw_fifo_word = static_cast<uint32_t>(r6);
...
// RECOMP_REGISTRATION base 0x8051E574 func_8051E574 preserves=true fpr_mask=0x00000000
