...
extern "C" void func_80641028(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80641028:
{
    ...
    r30 = r3;
    r0 = MemoryInline::FlatRead32((r3 + 1136));
...
loc_80641050:
{
    ...
    r3 = MemoryInline::FlatRead32((r30 + 1136));
    r12 = MemoryInline::FlatRead32(r3);
    r12 = MemoryInline::FlatRead32((r12 + 104));
    ctr = r12;
    ctx->lr = 0x80641098u;
...
// RECOMP_REGISTRATION base 0x80641028 func_80641028 preserves=true fpr_mask=0x00000000
