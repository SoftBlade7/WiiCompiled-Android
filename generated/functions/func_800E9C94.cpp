...
extern "C" void func_800E9C94(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_800E9C94:
{
    ...
    r4 = (r4 + 8);
    guest_range_1 = MemoryInline::ResolveRangeHost(r6, 0, 40u, false, true);
...
// RECOMP_REGISTRATION base 0x800E9C94 func_800E9C94 preserves=true fpr_mask=0x00000000
