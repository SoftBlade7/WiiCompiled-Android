...
extern "C" void func_8077C7F0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8077C7F0:
{
    ...
    ctx->fpr[4] = f4;
    ctx->cr = cr;
    InvokeDirectCpu<0x8077C8F4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    f0.d = MemoryInline::FlatReadFloat32((r31 + 17504));
    ...
    r3 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r31 + 17504));
    f1.d = MemoryInline::FlatReadFloat32((r3 + 17540));
    r3 = 0x809C0000u;
    r6 = 0x808A0000u;
    r0 = 0;
    r5 = 0x809C0000u;
...
// RECOMP_REGISTRATION base 0x8077C7F0 func_8077C7F0 preserves=true fpr_mask=0x00000000
