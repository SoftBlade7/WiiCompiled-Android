...
extern "C" void func_80678318(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80678318:
{
    ...
    r1 = (r1 + -16);
    r0 = ctx->lr;
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r4), static_cast<int32_t>(10240));
}
...
loc_80678324:
{
    ...
    r31 = r5;
    r6 = MemoryInline::FlatRead32((r5 + 28));
...
// RECOMP_REGISTRATION base 0x80678318 func_80678318 preserves=true fpr_mask=0x00000000
