...
extern "C" void func_8015B0A0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8015B0A0:
{
    ...
    r7 = (r7 + -24768);
    r30 = r4;
    r0 = MemoryInline::FlatRead8((r7 + 17968));
    r25 = r5;
    r24 = r6;
...
loc_8015B0D8:
{
    r3 = 655360;
    r4 = 0x80280000u;
    r6 = MemoryInline::FlatRead16((r31 + 34));
    r3 = (r3 + 1);
    r4 = (r4 + 32236);
    ctx->lr = 0x8015B0F0u;
    ctx->gpr[0] = r0;
...
loc_8015B12C:
{
    ...
    r3 = (static_cast<int32_t>(r30) >> 8);
    MemoryInline::FlatWriteRam8(r28, static_cast<uint8_t>(r0));
    r27 = r29;
    r0_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r25), static_cast<uint32_t>(24));
    r0 = (r0_rot_1 & 255);
...
loc_8015B154:
{
    MemoryInline::FlatWriteRam8((r28 + 1), static_cast<uint8_t>(r3));
    r29 = (r29 + 4);
    MemoryInline::FlatWriteRam8((r28 + 2), static_cast<uint8_t>(r30));
    MemoryInline::FlatWriteRam8((r28 + 5), static_cast<uint8_t>(r0));
    MemoryInline::FlatWriteRam8((r28 + 6), static_cast<uint8_t>(r25));
    if (((cr & 0x20000000u) != 0)) {
        goto loc_8015B19C;
    }
}
...
loc_8015B19C:
{
    ...
    r3 = (r3_rot_1 & 255);
    MemoryInline::FlatWriteRam8(r27, static_cast<uint8_t>(r3));
    MemoryInline::FlatWriteRam8((r27 + 1), static_cast<uint8_t>(r5));
    MemoryInline::FlatWriteRam16((r26 + 2), static_cast<uint16_t>(r0));
...
// RECOMP_REGISTRATION base 0x8015B0A0 func_8015B0A0 preserves=true fpr_mask=0x00000000
