...
extern "C" void func_8054460C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80544690:
{
    MemoryInline::FlatWriteRam32((r4 + -10424), r31);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_805446AC;
    }
}
...
// RECOMP_REGISTRATION base 0x8054460C func_8054460C preserves=true fpr_mask=0x00000000
