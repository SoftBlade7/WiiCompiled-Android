...
extern "C" void func_8063C714(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_8063C714:
{
    ...
    r3 = MemoryInline::FlatRead32((r9 + 36));
    ...
    r4 = r3;
    r30_addr_0 = (r30 + r31);
    r6 = MemoryInline::FlatRead32(r30_addr_0);
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFEDFE gpr_write=0xFFFFFFFF gpr_return=0x00000018 fpr_read=0xFFFFFFFF fpr_write=0xFFFFFFFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x8063C714 func_8063C714 preserves=false fpr_mask=0x80000000
