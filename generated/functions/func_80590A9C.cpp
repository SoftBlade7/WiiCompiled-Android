...
extern "C" void func_80590A9C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80590BC8:
{
    ...
    r0 = MemoryInline::FlatRead32((r4 + 240));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r26), static_cast<int32_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x80590A9C func_80590A9C preserves=true fpr_mask=0x00000000
