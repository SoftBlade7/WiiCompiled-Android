...
extern "C" void func_8022C09C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8022C0EC:
{
    ...
    f9 = ctx->fpr[9];
    r4 = (r1 + 20);
    f1.d = MemoryInline::FlatReadFloat32((r2 + -25048));
    ...
    r4_psq_tmp_2 = (r4 + 8);
    PpcSetPairedFprInline(f3, PPC_PsqLStackInline<1u, 0u>(ctx, r4_psq_tmp_2));
    ...
    r3_psq_tmp_6 = (r3 + 8);
    PPC_PsqStStackInline<1u, 0u>(ctx, r3_psq_tmp_6, f2.d);
...
// RECOMP_GUEST_ABI gpr_read=0xE000003F gpr_write=0xE000003B gpr_return=0x00000018 fpr_read=0x00001F7F fpr_write=0x00001FFF fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8022C09C func_8022C09C preserves=true fpr_mask=0x00000000
