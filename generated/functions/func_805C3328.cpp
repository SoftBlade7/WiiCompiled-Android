...
extern "C" void func_805C3328(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805C3328:
{
    ...
    r30 = MemoryInline::FlatRead16((r5 + 2));
    goto loc_805C3388;
}
...
// RECOMP_REGISTRATION base 0x805C3328 func_805C3328 preserves=true fpr_mask=0x00000000
