...
extern "C" void func_80838B18(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80838B18:
{
    ...
    r3 = 0x809C0000u;
    r4 = (r4 + 7440);
    MemoryInline::FlatWriteRam32((r3 + 17720), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x80838B18 func_80838B18 preserves=true fpr_mask=0x00000000
