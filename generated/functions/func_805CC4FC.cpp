...
extern "C" void func_805CC4FC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_inl5_cont_8051BED0:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80234950u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_805CC6C0:
{
    MemoryInline::FlatWrite32((r30 + 800), r31);
    r3 = (r30 + 1208);
    ctx->lr = 0x805CC6CCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x805649A0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x805CC4FC func_805CC4FC preserves=true fpr_mask=0x00000000
