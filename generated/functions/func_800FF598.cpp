...
extern "C" void func_800FF598(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800FF598:
{
    ...
    r27 = MemoryInline::FlatRead32((r6 + 8));
    r20 = r4;
    r28 = MemoryInline::FlatRead32((r6 + 12));
    r21 = r5;
...
loc_800FF5E4:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800F59E4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800FF5FC:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800F5580u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800FF624:
{
    ...
    xer = ctx->xer;
    r25 = (r3 + -23);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r25), static_cast<uint32_t>(23));
}
...
loc_800FF69C:
{
    MemoryInline::FlatWrite32((r22 + 8), r27);
    r3 = r20;
    r4 = r21;
    r5 = (r1 + 8);
    MemoryInline::FlatWrite32((r22 + 12), r28);
    ctx->lr = 0x800FF6B4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x800FF598 func_800FF598 preserves=true fpr_mask=0x00000000
