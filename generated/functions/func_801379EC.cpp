...
extern "C" void func_801379EC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80137A10:
{
    ...
    r4 = (r4 + 24648);
    r4 = (r4 + r5);
    MemoryInline::FlatWrite8((r4 + 532), static_cast<uint8_t>(r0));
}

loc_80137A24:
{
    r31 = MemoryInline::FlatRead8((r3 + 18));
    r3 = (r3 + 4);
    ctx->lr = 0x80137A30u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    r3 = 1;
    r0 = 255;
    MemoryInline::FlatWrite8((r30 + 18), static_cast<uint8_t>(r31));
    MemoryInline::FlatWrite8((r30 + 28), static_cast<uint8_t>(r3));
...
// RECOMP_REGISTRATION base 0x801379EC func_801379EC preserves=true fpr_mask=0x00000000
