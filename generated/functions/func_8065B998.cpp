...
extern "C" void func_8065B998(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8065B9C0:
{
    MemoryInline::FlatWrite32(r24, r31);
    r3 = (r24 + 4);
    r4 = 0;
    r5 = 21;
    MemoryInline::FlatWrite8((r24 + 25), static_cast<uint8_t>(r31));
    MemoryInline::FlatWrite8((r24 + 26), static_cast<uint8_t>(r30));
    MemoryInline::FlatWrite8((r24 + 27), static_cast<uint8_t>(r31));
    MemoryInline::FlatWrite8((r24 + 28), static_cast<uint8_t>(r31));
    ctx->lr = 0x8065B9E4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r28 = (r28 + 1);
    r24 = (r24 + 32);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r28), static_cast<uint32_t>(24));
}
...
loc_8065BA14:
{
    ...
    r4 = 0;
    r5 = 21;
    MemoryInline::FlatWrite8((r25 + 25), static_cast<uint8_t>(r30));
    MemoryInline::FlatWrite8((r25 + 26), static_cast<uint8_t>(r31));
    MemoryInline::FlatWrite8((r25 + 27), static_cast<uint8_t>(r30));
    MemoryInline::FlatWrite8((r25 + 28), static_cast<uint8_t>(r30));
    ctx->lr = 0x8065BA38u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    xer = ctx->xer;
    r28 = (r28 + 1);
    MemoryInline::FlatWrite32((r24 + 9988), r30);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r28), static_cast<uint32_t>(24));
}
...
loc_8065BA64:
{
    r3 = 224;
    r0 = 1;
    MemoryInline::FlatWrite32((r23 + 11140), r3);
    r3 = r23;
...
// RECOMP_GUEST_ABI gpr_read=0xFF8000FA gpr_write=0xFF8000FB gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x8065B998 func_8065B998 preserves=true fpr_mask=0x00000000
