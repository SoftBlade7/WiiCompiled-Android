...
extern "C" void func_801035F8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_801035F8:
{
    ...
    r0 = (r5 + -1);
    r28 = 0x80280000u;
    MemoryInline::WriteResolved32(guest_range_0, 8u, (r1 + 8), r9);
    r5 = PPC_CntlzwInline(static_cast<uint32_t>(r0));
    r29 = r3;
    r30 = r4;
    r0 = MemoryInline::FlatRead32((r10 + 256));
    r31 = r6;
    r25 = r7;
    r27 = r8;
...
loc_801036B0:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801015D4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWriteRam32((r1 + 24), r25);
    r3 = r29;
    r8 = r25;
    ...
    r6 = (r1 + 8);
    r4 = 2;
    MemoryInline::FlatWriteRam32((r26 + 4), r30);
    r5 = 0;
    r7 = 1;
...
loc_80103700:
{
    ...
    r7 = r25;
    r0 = r27;
    r26 = MemoryInline::FlatRead32((r6 + 24));
    r3 = r29;
    r4 = (r1 + 16);
...
loc_80103774:
{
    ...
    r5 = (r28 + 832);
    r26 = MemoryInline::FlatRead32((r4 + 24));
    r4 = (r27 + 528);
    ctx->lr = 0x80103790u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r5 = MemoryInline::FlatRead32((r27 + 408));
    r3 = r29;
    r4 = (r27 + 528);
    ctx->lr = 0x801037A0u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x801035F8 func_801035F8 preserves=true fpr_mask=0x00000000
