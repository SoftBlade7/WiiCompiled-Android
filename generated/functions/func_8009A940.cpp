...
extern "C" void func_8009A940(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8009A984:
{
    r30 = MemoryInline::FlatRead32((r3 + 636));
    r31 = (r30 + 16);
    r3 = r31;
    ctx->lr = 0x8009A994u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x8009A940 func_8009A940 preserves=true fpr_mask=0x00000000
