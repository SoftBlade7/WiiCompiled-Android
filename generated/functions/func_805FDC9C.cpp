...
extern "C" void func_805FDC9C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_805FDC9C:
{
    ...
    xer = ctx->xer;
    r0 = 5;
    MemoryInline::FlatWrite32((r30 + 3988), r0);
    r3 = (r30 + 3412);
    r4 = (r30 + 68);
    r5 = 0;
    ctx->gpr[0] = r0;
    ...
    xer = ctx->xer;
    r0 = 6;
    MemoryInline::FlatWrite32((r30 + 4584), r0);
    r3 = (r30 + 4008);
    r4 = (r30 + 68);
    r5 = 0;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x805FDC9C func_805FDC9C preserves=true fpr_mask=0x00000000
