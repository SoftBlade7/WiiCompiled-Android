...
extern "C" void func_80114398(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8011441C:
{
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWrite32((r27 + 356), r0);
}

loc_8011442C:
{
    r29 = MemoryInline::FlatRead32((r27 + 352));
...
loc_80114444:
{
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWrite32((r27 + 352), r0);
}
...
// RECOMP_REGISTRATION base 0x80114398 func_80114398 preserves=true fpr_mask=0x00000000
