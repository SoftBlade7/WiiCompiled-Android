...
extern "C" void func_80821B68(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80821BA4:
{
    ...
    r4 = 0x808B0000u;
    r3 = r31;
    f0.d = MemoryInline::FlatReadFloat32((r4 + -17760));
...
{
    r3 = 0x808D0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 28360));
...
loc_80821C84:
{
    ...
    r3 = 0x808B0000u;
    f2.d = MemoryInline::FlatReadFloat32((r3 + -17744));
    r4 = 0;
...
loc_80821CBC:
{
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWrite8((r31 + 155), static_cast<uint8_t>(r0));
    ...
    r3 = 1;
    MemoryInline::FlatWrite8((r31 + 156), static_cast<uint8_t>(r3));
    r0 = (r0 | 4);
    MemoryInline::FlatWrite8((r31 + 152), static_cast<uint8_t>(r3));
...
// RECOMP_REGISTRATION base 0x80821B68 func_80821B68 preserves=true fpr_mask=0x00000000
