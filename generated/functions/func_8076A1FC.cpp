...
extern "C" void func_8076A1FC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8076A1FC:
{
    ...
    r31 = r3;
    r4 = (r31 + 48);
    f0.d = MemoryInline::FlatReadFloat32((r5 + -6280));
    r5 = (r31 + 180);
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8076A3B0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8076A1FC func_8076A1FC preserves=true fpr_mask=0x00000000
