...
extern "C" void func_8074D580(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8074D580:
{
    r3 = 0x808D0000u;
    r4 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r4 + 11516));
    r6 = 0x809C0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + -17216));
    r3 = (r6 + 11352);
    r4 = 0x80510000u;
    r5 = 0x809C0000u;
    MemoryInline::FlatWriteRamFloat32((r6 + 11352), f1.d);
    r4 = (r4 + 13824);
    r5 = (r5 + 11340);
...
// RECOMP_REGISTRATION base 0x8074D580 func_8074D580 preserves=true fpr_mask=0x00000000
