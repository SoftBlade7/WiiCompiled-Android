...
extern "C" void func_806B7BC4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806B7BF0:
{
    ...
    r4 = 0x808A0000u;
    r3 = (r1 + 80);
    f1.d = MemoryInline::FlatReadFloat32((r4 + -3672));
    r4 = (r1 + 56);
...
// RECOMP_REGISTRATION base 0x806B7BC4 func_806B7BC4 preserves=true fpr_mask=0x00000000
