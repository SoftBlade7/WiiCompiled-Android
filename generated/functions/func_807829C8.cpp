...
extern "C" void func_807829C8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807829C8:
{
    r3 = (r3 + -8);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80782804u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x807829C8 func_807829C8 preserves=true fpr_mask=0x00000000
