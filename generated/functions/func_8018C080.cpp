...
extern "C" void func_8018C080(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8018C080:
{
    ...
    f2.d = MemoryInline::FlatReadFloat64((r3 + 11232));
...
// RECOMP_REGISTRATION base 0x8018C080 func_8018C080 preserves=true fpr_mask=0x00000000
