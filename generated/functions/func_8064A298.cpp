...
extern "C" void func_8064A298(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8064A2C4:
{
    r5 = 0x808A0000u;
    r4 = -1;
    f1.d = MemoryInline::FlatReadFloat32((r5 + -26724));
...
// RECOMP_REGISTRATION base 0x8064A298 func_8064A298 preserves=true fpr_mask=0x00000000
