...
extern "C" void func_80854104(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r5_rot_0 = 0;
    uint32_t r5_rot_1 = 0;
...
loc_80854104:
{
    ...
    MemoryInline::FlatWrite32((r3 + 2884), r0);
}
...
loc_8085415C:
{
    ...
    r5 = 0x809C0000u;
    r4 = r3;
    r6 = MemoryInline::FlatRead32((r5 + -10424));
...
loc_8085419C:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80854754u>(ctx);
    r0 = ctx->gpr[0];
    r4 = ctx->gpr[4];
    cr = ctx->cr;
    r3 = r31;
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80854810u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
{
    r29 = (r29 + 1);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r29), static_cast<int32_t>(58));
}
...
loc_80854244:
{
    ...
    r4 = ctx->gpr[4];
    cr = ctx->cr;
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r29), static_cast<int32_t>(52));
}
...
// RECOMP_REGISTRATION base 0x80854104 func_80854104 preserves=true fpr_mask=0x00000000
