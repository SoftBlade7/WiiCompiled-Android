...
extern "C" void func_800E97D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800E97D0:
{
    guest_range_0 = MemoryInline::ResolveRangeHost(r4, 0, 22u, true, false);
    r0 = MemoryInline::ReadResolved16(guest_range_0, 0u, r4);
    r4 = (r4 + 2);
    guest_range_1 = MemoryInline::ResolveRangeHost(r6, 0, 22u, false, true);
...
// RECOMP_REGISTRATION base 0x800E97D0 func_800E97D0 preserves=true fpr_mask=0x00000000
