...
extern "C" void func_80635CF4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
    uint32_t r4_rot_0 = 0;
...
loc_80635DD8:
{
    ...
    if (MkwStateFreeAbiEnabled(0x80634B80u) && KnownTranslatedCpuCall<0x80634B80u>::kAvailable && !KnownTranslatedCpuCall<0x80634B80u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80634B80u>()) {
        const auto state_free_result_80634B80_15EF = func_80634B80_statefree(r3, cr, xer);
        r3 = static_cast<uint32_t>(state_free_result_80634B80_15EF[0]);
        cr = static_cast<uint32_t>(state_free_result_80634B80_15EF[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80635CF4 func_80635CF4 preserves=true fpr_mask=0x00000000
