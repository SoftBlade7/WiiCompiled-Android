...
extern "C" void func_80134A10(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80134A4C:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r31 + 20), r29);
    r3 = r31;
...
// RECOMP_REGISTRATION base 0x80134A10 func_80134A10 preserves=true fpr_mask=0x00000000
