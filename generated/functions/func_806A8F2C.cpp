...
extern "C" void func_806A8F2C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806A8F6C:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead16((r30 + 2460));
    r0 = (r0 << 16);
...
loc_806A8FA4:
{
    ...
    r4 = 0x808A0000u;
    r0 = MemoryInline::FlatRead16((r30 + 2462));
    r0 = (r0 << 16);
    r0 = (static_cast<int32_t>(r0) >> 16);
    r3 = 0x808A0000u;
    MemoryInline::FlatWriteRam32((r1 + 32), r5);
    f3.d = MemoryInline::FlatReadFloat64((r4 + -10544));
    r0 = (r0 ^ -2147483648);
    f1.d = MemoryInline::FlatReadFloat64((r1 + 32));
    r4 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + -10484));
    ...
    f0.d = MemoryInline::FlatReadFloat32((r4 + -10488));
...
// RECOMP_REGISTRATION base 0x806A8F2C func_806A8F2C preserves=true fpr_mask=0x00000000
