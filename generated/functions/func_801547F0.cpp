...
extern "C" void func_801547F0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80154820:
{
    r29_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(1));
    r29 = (r29_rot_0 & 254);
    r3 = 2;
    ctx->lr = 0x8015482Cu;
    ctx->gpr[0] = r0;
...
loc_80154838:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam8((r31 + 3), static_cast<uint8_t>(r3));
    r0 = 4;
    r3 = r27;
    r4 = r30;
...
// RECOMP_REGISTRATION base 0x801547F0 func_801547F0 preserves=true fpr_mask=0x00000000
