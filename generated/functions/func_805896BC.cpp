...
extern "C" void func_805896BC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805896BC:
{
    f1.d = MemoryInline::FlatReadFloat32((r3 + 660));
    ctx->fpr[1] = f1;
    return;
}
...
// RECOMP_REGISTRATION base 0x805896BC func_805896BC preserves=true fpr_mask=0x00000000
