...
extern "C" void func_8075DAEC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8075DAEC:
{
    ...
    r4 = 0x80510000u;
    r5 = 0x809C0000u;
    MemoryInline::FlatWriteRamFloat32((r6 + 11524), f1.d);
    r4 = (r4 + 13824);
    r5 = (r5 + 11512);
...
// RECOMP_REGISTRATION base 0x8075DAEC func_8075DAEC preserves=true fpr_mask=0x00000000
