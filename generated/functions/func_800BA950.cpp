...
extern "C" void func_800BA950(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800BA9DC:
{
    r29 = cr;
    r27 = r23;
    r29_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r29), static_cast<uint32_t>(1));
    r29 = (r29_rot_0 & 1);
    r26 = r23;
    r6 = r23;
    r7 = r24;
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800BB3A0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    f0.d = MemoryInline::FlatReadFloat32((r22 + 48));
    r0 = 0;
    ...
    MemoryInline::FlatWriteRam32((r1 + 112), r23);
...
loc_800BAAA8:
{
    ...
    MemoryInline::WriteResolved32(guest_range_3, 32u, (r1 + 88), r30);
...
loc_800BAD08:
{
    r0 = MemoryInline::FlatRead32((r22 + 92));
    r3 = (r0 & 3);
...
loc_800BAD18:
{
    ...
    MemoryInline::WriteResolved32(guest_range_5, 248u, (r1 + 260), r4);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r5 = MemoryInline::ReadResolved32(guest_range_6, 36u, (r22 + 36));
            r4 = MemoryInline::ReadResolved32(guest_range_6, 40u, (r22 + 40));
        }
    }
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r5 = MemoryInline::ReadResolved32(guest_range_6, 44u, (r22 + 44));
            r4 = MemoryInline::ReadResolved32(guest_range_6, 48u, (r22 + 48));
        }
    }
    ...
    r4 = MemoryInline::ReadResolved32(guest_range_6, 52u, (r22 + 52));
    MemoryInline::WriteResolved32(guest_range_5, 268u, (r1 + 280), r4);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r5 = MemoryInline::ReadResolved32(guest_range_6, 56u, (r22 + 56));
            r4 = MemoryInline::ReadResolved32(guest_range_6, 60u, (r22 + 60));
        }
    }
    ...
    r4 = MemoryInline::ReadResolved8(guest_range_6, 64u, (r22 + 64));
    MemoryInline::WriteResolved8(guest_range_5, 280u, (r1 + 292), static_cast<uint8_t>(r4));
    r4 = MemoryInline::ReadResolved8(guest_range_6, 65u, (r22 + 65));
    MemoryInline::WriteResolved8(guest_range_5, 281u, (r1 + 293), static_cast<uint8_t>(r4));
    r4 = MemoryInline::ReadResolved8(guest_range_6, 66u, (r22 + 66));
    MemoryInline::WriteResolved8(guest_range_5, 282u, (r1 + 294), static_cast<uint8_t>(r4));
    r4 = MemoryInline::ReadResolved8(guest_range_6, 67u, (r22 + 67));
    MemoryInline::WriteResolved8(guest_range_5, 283u, (r1 + 295), static_cast<uint8_t>(r4));
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_6, 68u, (r22 + 68));
    MemoryInline::WriteResolvedFloat32(guest_range_5, 284u, (r1 + 296), f0.d);
    r5 = MemoryInline::ReadResolved32(guest_range_6, 72u, (r22 + 72));
    r4 = (r3 - r23);
    MemoryInline::WriteResolved32(guest_range_5, 288u, (r1 + 300), r5);
    r3_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(1));
    r3 = (r3_rot_2 & 1);
    r4 = (r3 + r4);
    r5 = (r1 + 12);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_6, 76u, (r22 + 76));
    {
    ...
    r6 = (static_cast<int32_t>(r4) >> 1);
    MemoryInline::WriteResolvedFloat32(guest_range_5, 292u, (r1 + 304), f0.d);
    r3 = (r1 + 228);
    r4 = (r1 + 40);
    r6 = (r24 - r6);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_6, 80u, (r22 + 80));
    MemoryInline::WriteResolvedFloat32(guest_range_5, 296u, (r1 + 308), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_6, 84u, (r22 + 84));
    MemoryInline::WriteResolvedFloat32(guest_range_5, 300u, (r1 + 312), f0.d);
    r7 = MemoryInline::ReadResolved32(guest_range_6, 88u, (r22 + 88));
    ...
    r0 = MemoryInline::ReadResolved32(guest_range_6, 96u, (r22 + 96));
...
loc_800BAF30:
{
    ...
    MemoryInline::WriteResolved32(guest_range_7, 152u, (r1 + 160), r4);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r5 = MemoryInline::ReadResolved32(guest_range_8, 36u, (r22 + 36));
            r4 = MemoryInline::ReadResolved32(guest_range_8, 40u, (r22 + 40));
        }
    }
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r5 = MemoryInline::ReadResolved32(guest_range_8, 44u, (r22 + 44));
            r4 = MemoryInline::ReadResolved32(guest_range_8, 48u, (r22 + 48));
        }
    }
    ...
    r4 = MemoryInline::ReadResolved32(guest_range_8, 52u, (r22 + 52));
    MemoryInline::WriteResolved32(guest_range_7, 172u, (r1 + 180), r4);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r5 = MemoryInline::ReadResolved32(guest_range_8, 56u, (r22 + 56));
            r4 = MemoryInline::ReadResolved32(guest_range_8, 60u, (r22 + 60));
        }
    }
    ...
    r4 = MemoryInline::ReadResolved8(guest_range_8, 64u, (r22 + 64));
    MemoryInline::WriteResolved8(guest_range_7, 184u, (r1 + 192), static_cast<uint8_t>(r4));
    r4 = MemoryInline::ReadResolved8(guest_range_8, 65u, (r22 + 65));
    MemoryInline::WriteResolved8(guest_range_7, 185u, (r1 + 193), static_cast<uint8_t>(r4));
    r4 = MemoryInline::ReadResolved8(guest_range_8, 66u, (r22 + 66));
    MemoryInline::WriteResolved8(guest_range_7, 186u, (r1 + 194), static_cast<uint8_t>(r4));
    r4 = MemoryInline::ReadResolved8(guest_range_8, 67u, (r22 + 67));
    MemoryInline::WriteResolved8(guest_range_7, 187u, (r1 + 195), static_cast<uint8_t>(r4));
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_8, 68u, (r22 + 68));
    MemoryInline::WriteResolvedFloat32(guest_range_7, 188u, (r1 + 196), f0.d);
    r5 = MemoryInline::ReadResolved32(guest_range_8, 72u, (r22 + 72));
    r4 = (r3 - r23);
    MemoryInline::WriteResolved32(guest_range_7, 192u, (r1 + 200), r5);
    r3_rot_3 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(1));
    r3 = (r3_rot_3 & 1);
    r4 = (r3 + r4);
    r5 = (r1 + 8);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_8, 76u, (r22 + 76));
    {
        const uint32_t ppcCarryValue = static_cast<uint32_t>(r4);
        const uint32_t ppcCarryShift = static_cast<uint32_t>(1) & 0x3Fu;
        const bool ppcCarryNegative = (ppcCarryValue & 0x80000000u) != 0;
    ...
    r4 = (r1 + 24);
    r6 = (r24 - r6);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_8, 80u, (r22 + 80));
    MemoryInline::WriteResolvedFloat32(guest_range_7, 200u, (r1 + 208), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_8, 84u, (r22 + 84));
    MemoryInline::WriteResolvedFloat32(guest_range_7, 204u, (r1 + 212), f0.d);
    r7 = MemoryInline::ReadResolved32(guest_range_8, 88u, (r22 + 88));
    ...
    r0 = MemoryInline::ReadResolved32(guest_range_8, 96u, (r22 + 96));
...
loc_800BB13C:
{
    f1.d = MemoryInline::FlatReadFloat32((r22 + 44));
    f0.d = MemoryInline::FlatReadFloat32((r1 + 116));
...
loc_800BB1B0:
{
    f27.d = MemoryInline::FlatReadFloat32((r22 + 48));
    if ((static_cast<int32_t>(r29) == static_cast<int32_t>(0))) {
        goto loc_800BB248;
    }
}
...
loc_800BB1C4:
{
    f24.d = MemoryInline::FlatReadFloat32((r22 + 44));
...
loc_800BB1CC:
{
    f23.d = MemoryInline::FlatReadFloat32((r22 + 80));
    goto loc_800BB1D8;
}
...
loc_800BB1E4:
{
    f2.d = MemoryInline::FlatReadFloat32((r22 + 68));
    goto loc_800BB220;
}
...
loc_800BB1EC:
{
    ...
    r4 = (r25 & 65535);
    f22.d = MemoryInline::FlatReadFloat32((r22 + 36));
    r12 = MemoryInline::FlatRead32(r3);
...
loc_800BB250:
{
    f1.d = MemoryInline::FlatReadFloat32((r22 + 80));
...
loc_800BB260:
{
    r3 = MemoryInline::FlatRead32((r22 + 72));
    r28 = 1;
    f22.d = MemoryInline::FlatReadFloat32((r22 + 40));
    r12 = MemoryInline::FlatRead32(r3);
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteFloat32((r22 + 48), f27.d);
}
...
loc_800BB324:
{
    MemoryInline::FlatWriteFloat32((r22 + 48), f28.d);
    goto loc_800BB338;
}
...
// RECOMP_REGISTRATION base 0x800BA950 func_800BA950 preserves=false fpr_mask=0xFFC00000
