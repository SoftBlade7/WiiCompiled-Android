...
extern "C" void func_807A9B5C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807A9C14:
{
    ...
    f2.d = MemoryInline::FlatReadFloat64((r5 + 22808));
    r3 = (r1 + 8);
    MemoryInline::FlatWriteRam32((r1 + 56), r0);
    f0.d = MemoryInline::FlatReadFloat32((r4 + 22800));
...
loc_807A9C4C:
{
    r30 = MemoryInline::FlatRead32((r30 + 156));
    r31 = 0;
}
...
// RECOMP_REGISTRATION base 0x807A9B5C func_807A9B5C preserves=true fpr_mask=0x00000000
