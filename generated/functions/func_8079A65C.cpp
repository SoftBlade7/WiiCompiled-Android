...
extern "C" void func_8079A65C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8079A65C:
{
    ...
    r29 = 0;
    r31 = 0x809C0000u;
    r28 = MemoryInline::FlatRead8((r4 + 14520));
    goto loc_8079A6AC;
}
...
loc_8079A688:
{
    ...
    ctx->gpr[4] = r4;
    ctx->cr = cr;
    InvokeDirectCpu<0x80798F0Cu>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    cr = ctx->cr;
    r30 = (r30 + r3);
...
// RECOMP_REGISTRATION base 0x8079A65C func_8079A65C preserves=true fpr_mask=0x00000000
