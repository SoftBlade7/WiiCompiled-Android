...
extern "C" void func_80547400(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r3 = (r3 + 65536);
    r3 = MemoryInline::FlatRead32((r3 + -28060));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80547400 func_80547400 preserves=true fpr_mask=0x00000000
