...
extern "C" void func_80078D80(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80078D80:
{
    ...
    ctx->gpr[5] = r5;
    ctx->cr = cr;
    InvokeDirectCpu<0x800842E0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80078D80 func_80078D80 preserves=true fpr_mask=0x00000000
