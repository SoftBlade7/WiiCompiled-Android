...
extern "C" void func_807ED268(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807ED268:
{
    ...
    r31 = 0x808B0000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r31 + -27040));
    ctx->lr = 0x807ED29Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x807ED268 func_807ED268 preserves=true fpr_mask=0x00000000
