...
extern "C" void func_800DB788(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800DB788:
{
    r0 = MemoryInline::FlatRead8((r7 + 2208));
    r27 = 0;
...
loc_800DB79C:
{
    ...
    r11 = (r31 + 516);
    r0 = (r31 + 532);
    r12 = MemoryInline::FlatRead8((r4 + 21));
    r28 = 0;
    r10 = MemoryInline::FlatRead8((r4 + 23));
    r3 = (r1 + 248);
    r9 = MemoryInline::FlatRead32((r4 + 1912));
    r5 = (r31 + 392);
    r6 = (r31 + 492);
    r4 = 256;
    ...
    r4 = MemoryInline::FlatRead32((r13 + -26868));
    r5 = r3;
    r0 = MemoryInline::FlatRead8((r4 + 2208));
    r0 = (r0 ^ 1);
    MemoryInline::FlatWrite8((r4 + 2208), static_cast<uint8_t>(r0));
    r6 = MemoryInline::FlatRead32((r13 + -26888));
...
loc_800DB818:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam8((r1 + 503), static_cast<uint8_t>(r28));
}
...
// RECOMP_REGISTRATION base 0x800DB788 func_800DB788 preserves=true fpr_mask=0x00000000
