...
extern "C" void func_8009AC80(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8009AC80:
{
    r3 = MemoryInline::FlatRead8((r3 + 653));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8009AC80 func_8009AC80 preserves=true fpr_mask=0x00000000
