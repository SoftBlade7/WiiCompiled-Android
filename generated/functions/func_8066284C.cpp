...
extern "C" void func_8066284C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806628AC:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8066300Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    xer = ctx->xer;
    r3 = 0x809C0000u;
    r4 = MemoryInline::FlatRead32((r29 + 2520));
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800CC1B0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r3 = 0;
    r0 = 1;
    MemoryInline::FlatWrite32((r29 + 2524), r3);
    MemoryInline::FlatWrite32((r29 + 2528), r3);
    MemoryInline::FlatWrite32((r29 + 2532), r3);
    MemoryInline::FlatWrite32((r29 + 2536), r3);
...
// RECOMP_REGISTRATION base 0x8066284C func_8066284C preserves=true fpr_mask=0x00000000
