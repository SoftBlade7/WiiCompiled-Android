...
extern "C" void func_80229460(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = r4;
    MemoryInline::FlatWrite16((r13 + -23932), static_cast<uint16_t>(r3));
    r4 = 0x80380000u;
    MemoryInline::FlatWrite32((r13 + -23936), r5);
    r3 = r0;
    r4 = (r4 + 17136);
...
// RECOMP_GUEST_ABI gpr_read=0x00002038 gpr_write=0x00000019 gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x0000003F fpr_return=0x00000002 cr_read=0x00 cr_write=0x00 xer_read=0 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80229460 func_80229460 preserves=true fpr_mask=0x00000000
