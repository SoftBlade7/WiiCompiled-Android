...
extern "C" void func_806C0D88(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_806C0D88:
{
    ...
    r12 = MemoryInline::FlatRead32(r3);
    r4 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r4 + -2448));
...
// RECOMP_REGISTRATION base 0x806C0D88 func_806C0D88 preserves=true fpr_mask=0x00000000
