...
extern "C" void func_8070F240(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8070F2A4:
{
    ...
    if ((static_cast<uint32_t>(r29) > static_cast<uint32_t>(1))) {
        goto loc_8070F2B0;
    }
}
...
// RECOMP_REGISTRATION base 0x8070F240 func_8070F240 preserves=false fpr_mask=0x80000000
