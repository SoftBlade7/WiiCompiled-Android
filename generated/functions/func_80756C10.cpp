...
extern "C" void func_80756C10(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80756C38:
{
    r4 = 0x808D0000u;
    r3 = (r1 + 56);
    f1.d = MemoryInline::FlatReadFloat32((r4 + -15120));
    r4 = (r31 + 428);
    ...
    r4 = 0x808A0000u;
    r3 = (r1 + 8);
    f1.d = MemoryInline::FlatReadFloat32((r4 + 13536));
    r4 = (r1 + 44);
    // inline leaf 0x80514810 (10 guest instruction(s))
    f3.d = MemoryInline::FlatReadFloat32((r4 + 8));
    f2.d = MemoryInline::FlatReadFloat32((r4 + 4));
...
// RECOMP_REGISTRATION base 0x80756C10 func_80756C10 preserves=true fpr_mask=0x00000000
