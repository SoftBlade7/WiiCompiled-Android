...
extern "C" void func_800F4234(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800F4278:
{
    ...
    MemoryInline::WriteResolved32(guest_range_0, 0u, r3, r29);
    r0 = 0;
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 4u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | static_cast<uint32_t>(r26)))) {
        MemoryInline::WriteResolved32(guest_range_0, 4u, (r3 + 4), r0);
        MemoryInline::WriteResolved32(guest_range_0, 8u, (r3 + 8), r26);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 12u, ((static_cast<uint64_t>(static_cast<uint32_t>(r27)) << 32) | static_cast<uint32_t>(r28)))) {
        MemoryInline::WriteResolved32(guest_range_0, 12u, (r3 + 12), r27);
        MemoryInline::WriteResolved32(guest_range_0, 16u, (r3 + 16), r28);
    }
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800F41DCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800F42C4:
{
    ...
    r5 = (r5 + 17668);
    r4 = 0x800F0000u;
    MemoryInline::FlatWriteRam32((r3 + 40), r5);
    r7 = (r7 + 17408);
    r6 = 0x800F0000u;
    r5 = 0x800F0000u;
    MemoryInline::FlatWriteRam32((r3 + 36), r7);
    r4 = (r4 + 17348);
    r6 = (r6 + 17700);
    r5 = (r5 + 17584);
    MemoryInline::FlatWriteRam32((r3 + 52), r4);
    r4 = 0;
    MemoryInline::FlatWriteRam32((r3 + 48), r6);
    MemoryInline::FlatWriteRam32((r3 + 44), r5);
    MemoryInline::FlatWriteRam32((r3 + 32), r31);
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800F4148u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x800F4234 func_800F4234 preserves=true fpr_mask=0x00000000
