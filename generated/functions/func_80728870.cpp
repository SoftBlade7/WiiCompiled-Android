...
extern "C" void func_80728870(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807288DC:
{
    r6 = 0x808A0000u;
    r4 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r28 + 420));
    r5 = (r30 & 65535);
    f2.d = MemoryInline::FlatReadFloat32((r6 + 9396));
    r6 = r5;
    r4 = (r4 + 9400);
    ctx->lr = 0x807288FCu;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x80728870 func_80728870 preserves=true fpr_mask=0x00000000
