...
extern "C" void func_8084E25C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8084E280:
{
    r5 = MemoryInline::FlatRead32((r3 + 1732));
...
loc_8084E28C:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r4 + -8552));
...
loc_8084E33C:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8084E388u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8084E25C func_8084E25C preserves=true fpr_mask=0x00000000
