...
extern "C" void func_80877408(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r3 = 0x809C0000u;
    r0 = MemoryInline::FlatRead32((r31 + 332));
...
loc_80877548:
{
    ...
    MemoryInline::FlatWrite32((r31 + 780), r0);
...
// RECOMP_REGISTRATION base 0x80877408 func_80877408 preserves=true fpr_mask=0x00000000
