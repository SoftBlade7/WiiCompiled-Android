...
extern "C" void func_80238770(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80238770:
{
    ...
    r4 = (r31 + 92);
    MemoryInline::FlatWrite16((r31 + 84), static_cast<uint16_t>(r0));
    ctx->lr = 0x802387A8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80238770 func_80238770 preserves=true fpr_mask=0x00000000
