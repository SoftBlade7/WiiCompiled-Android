...
extern "C" void func_800D1AB4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_800D1B3C:
{
    ...
    r0 = 5;
    r3 = r23;
    MemoryInline::FlatWrite32((r4 + 136), r25);
    r4 = MemoryInline::FlatRead32((r13 + -26896));
    MemoryInline::FlatWrite32((r4 + 140), r24);
    r5 = MemoryInline::FlatRead32((r13 + -26896));
    r4 = MemoryInline::FlatRead32((r5 + 36));
    MemoryInline::FlatWrite32((r5 + 40), r4);
    r4 = MemoryInline::FlatRead32((r13 + -26896));
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x800CEB00u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800D1CA0:
{
    ...
    r4 = 0x800D0000u;
    r0 = 0;
    MemoryInline::FlatWrite8((r3 + 885), static_cast<uint8_t>(r5));
    r3 = r25;
    r6 = r26;
    r7 = r27;
    r5 = MemoryInline::FlatRead32((r13 + -26896));
    ...
    r9 = r29;
    r10 = r30;
    MemoryInline::FlatWrite8((r5 + 3061), static_cast<uint8_t>(r0));
    r4 = (r4 + 12272);
    r5 = 0;
    ctx->lr = 0x800D1CE0u;
    ctx->gpr[0] = r0;
...
loc_inl2_cont_800CCC68:
{
    ...
    r7 = MemoryInline::FlatRead32((r13 + -26896));
    r3 = r25;
    r4 = 0;
    r5 = 1;
    r12 = MemoryInline::FlatRead32((r7 + 136));
    r6 = 0;
    r8 = MemoryInline::FlatRead32((r7 + 140));
    r7 = 0;
    ctr = r12;
    ctx->lr = 0x800D1D1Cu;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x800D1AB4 func_800D1AB4 preserves=true fpr_mask=0x00000000
