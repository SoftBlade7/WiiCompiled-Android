...
extern "C" void func_8007C3A0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8007C448:
{
    MemoryInline::FlatWrite16((r29 + 252), static_cast<uint16_t>(r31));
}
...
// RECOMP_REGISTRATION base 0x8007C3A0 func_8007C3A0 preserves=true fpr_mask=0x00000000
