...
extern "C" MkwStateFreeResult2 func_8023FF24_statefree(uint32_t);

extern "C" void func_8023C694(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8023C694:
{
    ...
    r30 = r3;
    guest_range_0 = MemoryInline::ResolveRangeHost(r3, 0, 184u, false, true);
    ...
    if (!MemoryInline::WriteResolvedPair16(guest_range_0, 16u, ((static_cast<uint32_t>(static_cast<uint16_t>(r5)) << 16) | static_cast<uint16_t>(r6)))) {
        MemoryInline::WriteResolved16(guest_range_0, 16u, (r3 + 16), r5);
        MemoryInline::WriteResolved16(guest_range_0, 18u, (r3 + 18), r6);
    }
    ...
    r3 = r31;
    r4 = MemoryInline::FlatRead8((r4 + 244));
    ctx->lr = 0x8023C6FCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
{
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x8023FF24u) && KnownTranslatedCpuCall<0x8023FF24u>::kAvailable && !KnownTranslatedCpuCall<0x8023FF24u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x8023FF24u>()) {
        const auto state_free_result_8023FF24_12A9 = func_8023FF24_statefree(r3);
        r4 = static_cast<uint32_t>(state_free_result_8023FF24_12A9[0]);
        r5 = static_cast<uint32_t>(state_free_result_8023FF24_12A9[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
        ...
        ctx->gpr[31] = r31;
        ctx->cr = cr;
        InvokeDirectCpu<0x8023FF24u>(ctx);
        r0 = ctx->gpr[0];
        r1 = ctx->gpr[1];
        r3 = ctx->gpr[3];
        r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8023C694 func_8023C694 preserves=true fpr_mask=0x00000000
