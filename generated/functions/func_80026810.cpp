...
extern "C" void func_80026810(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80026850:
{
    ...
    r0 = (r0_rot_2 & 262140);
    r29_addr_2 = (r29 + r0);
    r26 = MemoryInline::FlatRead32(r29_addr_2);
...
loc_80026864:
{
    r4 = MemoryInline::FlatRead16((r25 + 60));
    r3 = r26;
    r0 = (r4 + -1);
    MemoryInline::FlatWrite16((r25 + 60), static_cast<uint16_t>(r0));
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r26 + 12), r30);
...
// RECOMP_REGISTRATION base 0x80026810 func_80026810 preserves=true fpr_mask=0x00000000
