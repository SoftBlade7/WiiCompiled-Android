...
extern "C" void func_80128C68(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80128CDC:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r27 + 68), r31);
}
...
loc_80128D10:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r27 + 152), r31);
}
...
// RECOMP_REGISTRATION base 0x80128C68 func_80128C68 preserves=true fpr_mask=0x00000000
