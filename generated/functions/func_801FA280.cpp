...
extern "C" void func_801FA280(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801FA320:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x801F8C48u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x801FA280 func_801FA280 preserves=true fpr_mask=0x00000000
