...
extern "C" void func_807AD7E4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_inl0_cont_8019AC68:
{
    ...
    r3 = 0x808A0000u;
    MemoryInline::FlatWriteFloat32((r31 + 752), f1.d);
    f0.d = MemoryInline::FlatReadFloat32((r3 + 23596));
...
// RECOMP_GUEST_ABI gpr_read=0x8000000E gpr_write=0x8000000B gpr_return=0x00000008 fpr_read=0x00000008 fpr_write=0x0000001F fpr_return=0x00000002 cr_read=0x00 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x807AD7E4 func_807AD7E4 preserves=true fpr_mask=0x00000000
