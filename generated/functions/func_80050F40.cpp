...
extern "C" void func_80050F40(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80050F40:
{
    ...
    r1 = (r1 + -16);
    r9 = (r3 + r0);
    guest_range_0 = MemoryInline::ResolveRangeHost((r9 + 64), 0, 10u, true, false);
    r0 = MemoryInline::ReadResolved8(guest_range_0, 0u, (r9 + 64));
...
loc_80050F64:
{
    r0 = MemoryInline::ReadResolved8(guest_range_0, 3u, (r9 + 67));
    r3 = 1;
    r6 = MemoryInline::ReadResolved8(guest_range_0, 2u, (r9 + 66));
    r4 = MemoryInline::ReadResolved8(guest_range_0, 7u, (r9 + 71));
    r7_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(8));
    r7 = (r7_rot_1 & -256);
    r8 = MemoryInline::ReadResolved8(guest_range_0, 1u, (r9 + 65));
    r10_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r6), static_cast<uint32_t>(16));
    r10 = (r10_rot_1 & -65536);
    r0 = MemoryInline::ReadResolved8(guest_range_0, 8u, (r9 + 72));
    r11_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(16));
    r11 = (r11_rot_1 & -65536);
    r6 = MemoryInline::ReadResolved8(guest_range_0, 6u, (r9 + 70));
    r10_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r8), static_cast<uint32_t>(24));
    ...
    r4 = (r4_rot_1 & -256);
    r0 = MemoryInline::ReadResolved8(guest_range_0, 4u, (r9 + 68));
    r10 = (r10 | r7);
    r11_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r6), static_cast<uint32_t>(24));
    r11_mrot_1 = (r11_rot_2 & -16777216);
    r11_mdest_1 = (r11 & 16777215);
    r11 = (r11_mdest_1 | r11_mrot_1);
    r10 = (r10 | r0);
    r0 = MemoryInline::ReadResolved8(guest_range_0, 9u, (r9 + 73));
    r11 = (r11 | r4);
    MemoryInline::FlatWriteRam8((r1 + 8), static_cast<uint8_t>(r10));
    r11 = (r11 | r0);
    r0_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r10), static_cast<uint32_t>(20));
    r0 = (r0_rot_1 & 255);
    r4_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r11), static_cast<uint32_t>(20));
    r4 = (r4_rot_2 & 255);
...
// RECOMP_REGISTRATION base 0x80050F40 func_80050F40 preserves=true fpr_mask=0x00000000
