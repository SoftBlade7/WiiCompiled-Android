...
extern "C" void func_806BF7B8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806BF7B8:
{
    ...
    r0 = MemoryInline::FlatRead32((r4 + -3048));
    r4 = (r1 + 12);
...
// RECOMP_REGISTRATION base 0x806BF7B8 func_806BF7B8 preserves=true fpr_mask=0x00000000
