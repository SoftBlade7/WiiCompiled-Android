...
extern "C" void func_80634D40(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80634D40:
{
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 0u, ((static_cast<uint64_t>(static_cast<uint32_t>(r31)) << 32) | static_cast<uint32_t>(r5)))) {
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 16u, ((static_cast<uint64_t>(static_cast<uint32_t>(r5)) << 32) | static_cast<uint32_t>(r31)))) {
    ...
    MemoryInline::WriteResolved8(guest_range_0, 32u, (r3 + 32), static_cast<uint8_t>(r31));
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 44u, ((static_cast<uint64_t>(static_cast<uint32_t>(r5)) << 32) | static_cast<uint32_t>(r31)))) {
        MemoryInline::WriteResolved32(guest_range_0, 44u, (r3 + 44), r5);
        MemoryInline::WriteResolved32(guest_range_0, 48u, (r3 + 48), r31);
    }
    r3 = (r3 + 52);
    // inline leaf 0x8061AE6C (4 guest instruction(s))
    r4 = 0x808C0000u;
    r4 = (r4 + -19392);
    MemoryInline::FlatWrite32(r3, r4);
    // end of inlined leaf 0x8061AE6C
    MemoryInline::FlatWrite32((r30 + 152), r31);
    r3 = r30;
...
// RECOMP_GUEST_ABI gpr_read=0xC000000A gpr_write=0xC000003B gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x00 cr_write=0x00 xer_read=0 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80634D40 func_80634D40 preserves=true fpr_mask=0x00000000
