...
extern "C" void func_805EFC48(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805EFCD0:
{
    MemoryInline::FlatWrite8((r28 + 116), static_cast<uint8_t>(r30));
    MemoryInline::FlatWrite8((r28 + 117), static_cast<uint8_t>(r31));
...
// RECOMP_REGISTRATION base 0x805EFC48 func_805EFC48 preserves=true fpr_mask=0x00000000
