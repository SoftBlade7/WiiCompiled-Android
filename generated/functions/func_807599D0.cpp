...
extern "C" void func_807599D0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807599D0:
{
    r3 = MemoryInline::FlatRead8((r3 + 276));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x807599D0 func_807599D0 preserves=true fpr_mask=0x00000000
