...
extern "C" void func_80740CC8(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r3 = 0x808A0000u;
    r3 = MemoryInline::FlatRead32((r3 + 10516));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80740CC8 func_80740CC8 preserves=true fpr_mask=0x00000000
