...
extern "C" void func_800074A4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800074A4:
{
    ...
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
    InvokeDirectCpu<0x8000A188u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x800074A4 func_800074A4 preserves=true fpr_mask=0x00000000
