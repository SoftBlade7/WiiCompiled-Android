...
extern "C" void func_8052816C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805281A0:
{
    ...
    r4 = r28;
    r31_addr_1 = (r31 + r0);
    r31 = MemoryInline::FlatRead16(r31_addr_1);
    r3 = 184;
    r5 = 4;
    ctx->lr = 0x805281C4u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x8052816C func_8052816C preserves=true fpr_mask=0x00000000
