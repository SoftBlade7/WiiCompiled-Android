...
extern "C" void func_8054742C(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r3 = (r3 + 65536);
    r3 = MemoryInline::FlatRead8((r3 + -28056));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8054742C func_8054742C preserves=true fpr_mask=0x00000000
