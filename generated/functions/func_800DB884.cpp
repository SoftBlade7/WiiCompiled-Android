...
extern "C" void func_800DB884(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800DB884:
{
    r0 = MemoryInline::FlatRead32((r7 + 1912));
    r3 = (r1 + 248);
    r5 = (r31 + 3196);
    r6 = (r31 + 3128);
...
// RECOMP_REGISTRATION base 0x800DB884 func_800DB884 preserves=true fpr_mask=0x00000000
