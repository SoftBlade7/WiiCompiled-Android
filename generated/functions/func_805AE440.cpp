...
extern "C" void func_805AE440(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_805AE440:
{
    ...
    r6 = (r6 + 28248);
    f0.d = MemoryInline::FlatReadFloat32((r5 + 9452));
    r5 = 0x80890000u;
...
loc_805AE4D8:
{
    ...
    ctx->fpr[0] = f0;
    ctx->cr = cr;
    InvokeDirectCpu<0x805ADFF0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
...
// RECOMP_REGISTRATION base 0x805AE440 func_805AE440 preserves=true fpr_mask=0x00000000
