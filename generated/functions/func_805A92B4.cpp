...
extern "C" void func_805A92B4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lfsx_805A9330_loc_0 = 0;
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
    uint32_t r0_rot_2 = 0;
...
loc_805A92B4:
{
    ...
    MemoryInline::WriteResolvedFloat64(guest_range_2, 80u, (r1 + 80), f28.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_3 = (r1 + 88);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_3, PPC_PsFromScalarInline(f28.d));
    MemoryInline::WriteResolvedFloat64(guest_range_2, 64u, (r1 + 64), f27.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_4 = (r1 + 72);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_4, PPC_PsFromScalarInline(f27.d));
    MemoryInline::WriteResolvedFloat64(guest_range_2, 48u, (r1 + 48), f26.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_5 = (r1 + 56);
    ...
    r6 = 0x809C0000u;
    f26.d = f1.d;
    r6 = MemoryInline::FlatRead32((r6 + 6584));
    r24 = r3;
    r25 = r5;
    r0 = MemoryInline::FlatRead8((r6 + 37));
...
loc_805A9318:
{
    ...
    r3 = 0x80890000u;
    r4 = (r4 + 8736);
    f31.d = MemoryInline::FlatReadFloat32((r3 + 8728));
    r28 = (r4 + r0);
    addr_lfsx_805A9330_loc_0 = (r4 + r0);
    f27.d = MemoryInline::FlatReadFloat32(addr_lfsx_805A9330_loc_0);
    r27 = (r28 + 12);
    f29.d = MemoryInline::FlatReadFloat32((r28 + 12));
    r26 = 0;
    f28.d = PpcFmulsInline(f27.d, f1.d);
    r29 = 0;
...
loc_805A9358:
{
    ...
    r3 = MemoryInline::FlatRead32((r4 + 824));
    MemoryInline::FlatWrite32((r3 + 20), r28);
...
loc_805A937C:
{
    MemoryInline::FlatWriteFloat32((r3 + 8), f27.d);
}

loc_805A9380:
{
    MemoryInline::FlatWrite8(r3, static_cast<uint8_t>(r30));
    MemoryInline::FlatWrite32((r3 + 48), r27);
...
loc_805A939C:
{
    MemoryInline::FlatWriteFloat32((r3 + 36), f29.d);
}
...
loc_805A93A4:
{
    MemoryInline::FlatWrite8((r3 + 28), static_cast<uint8_t>(r30));
    if ((static_cast<int32_t>(r25) == static_cast<int32_t>(44))) {
        goto loc_805A93D4;
    }
}
...
loc_805A93AC:
{
    SetCRFloatResident(cr, 0, f26.d, f31.d);
}
...
loc_805A93E8:
{
    ...
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r11 = (r1 + 48);
    f26.d = MemoryInline::FlatReadFloat64((r1 + 48));
...
// RECOMP_REGISTRATION base 0x805A92B4 func_805A92B4 preserves=false fpr_mask=0xFC000000
