...
extern "C" void func_801349B8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801349E4:
{
    ...
    MemoryInline::FlatWriteRam8((r3 + 8), static_cast<uint8_t>(r30));
    MemoryInline::FlatWriteRam8((r3 + 9), static_cast<uint8_t>(r31));
    ctx->lr = 0x801349F8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x801349B8 func_801349B8 preserves=true fpr_mask=0x00000000
