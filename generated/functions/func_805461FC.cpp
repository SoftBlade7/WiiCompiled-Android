...
extern "C" void func_805461FC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_805461FC:
{
    ...
    r3 = (r3 + r4);
    r3 = (r3 + r0);
    r3 = MemoryInline::FlatRead16((r3 + 244));
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->gpr[6] = r6;
...
extern "C" MKW_PPC_NO_INLINE uint64_t func_805461FC_statefree(uint32_t native_r3, uint32_t native_r4, uint32_t native_r5)
{
...
loc_805461FC:
{
    ...
    cached_r3 = MemoryInline::FlatRead16((cached_r3 + 244));
...
// RECOMP_STATE_FREE_ABI address=0x805461FC symbol=func_805461FC_statefree gpr_in=0x00000038 gpr_out=0x00000008 fpr_in=0x00000000 fpr_out=0x00000000 cr_in=0x00 cr_out=0x00 gqr_in=0x00 hid_in=0x00 hid_out=0x00 xer_in=0 ctr_in=0 lr_in=0
...
// RECOMP_REGISTRATION base 0x805461FC func_805461FC preserves=true fpr_mask=0x00000000
