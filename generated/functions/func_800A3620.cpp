...
extern "C" void func_800A3620(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800A36A4:
{
    r5 = MemoryInline::FlatRead8((r30 + 140));
...
// RECOMP_REGISTRATION base 0x800A3620 func_800A3620 preserves=true fpr_mask=0x00000000
