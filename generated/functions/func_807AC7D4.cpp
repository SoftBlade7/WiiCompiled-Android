...
extern "C" void func_807AC7D4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807AC880:
{
    ...
    r30 = MemoryInline::FlatRead32((r31 + 816));
    r31 = 0;
}
...
loc_807AC8DC:
{
    guest_range_0 = MemoryInline::ResolveRangeHost((r31 + 10), 0, 696u, true, false);
    r3 = MemoryInline::ReadResolved32(guest_range_0, 146u, (r31 + 156));
...
loc_807AC908:
{
    r0 = MemoryInline::ReadResolved16(guest_range_0, 694u, (r31 + 704));
}
...
loc_807AC914:
{
    r4 = MemoryInline::ReadResolved32(guest_range_0, 106u, (r31 + 116));
    r0 = -1;
    r7 = MemoryInline::ReadResolved32(guest_range_0, 342u, (r31 + 352));
    r3 = 0x809C0000u;
    r8_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(24));
    r8 = (r8_rot_1 & 1);
    r6 = (r31 + 80);
    MemoryInline::FlatWriteRam32((r1 + 8), r0);
    r0 = MemoryInline::ReadResolved32(guest_range_0, 114u, (r31 + 124));
...
loc_807AC93C:
{
    r4 = MemoryInline::ReadResolved16(guest_range_0, 0u, (r31 + 10));
    r4 = (r4 << 16);
...
loc_807AC950:
{
    r5 = MemoryInline::ReadResolved32(guest_range_0, 142u, (r31 + 152));
}

loc_807AC954:
{
    r0 = PPC_CntlzwInline(static_cast<uint32_t>(r8));
    f1.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 94u, (r31 + 104));
    ...
    InvokeDirectCpu<0x8068D32Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
...
loc_807AC970:
{
    r4 = MemoryInline::ReadResolved32(guest_range_0, 630u, (r31 + 640));
    r3 = 0x809C0000u;
    r0 = MemoryInline::ReadResolved32(guest_range_0, 106u, (r31 + 116));
    r6 = (r31 + 80);
    r7 = MemoryInline::ReadResolved32(guest_range_0, 342u, (r31 + 352));
    r4 = MemoryInline::FlatRead8((r4 + 24));
    r8_rot_3 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(24));
    r8 = (r8_rot_3 & 1);
...
loc_807AC9B4:
{
    r0 = PPC_CntlzwInline(static_cast<uint32_t>(r8));
    f1.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 94u, (r31 + 104));
    r8_rot_4 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(27));
    r8 = (r8_rot_4 & 134217727);
    r9 = (r1 + 16);
    r10 = 1;
    ctx->lr = 0x807AC9CCu;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x807AC7D4 func_807AC7D4 preserves=false fpr_mask=0x80000000
