...
extern "C" void func_806EFDC4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_806EFDC4:
{
    ...
    ctx->gpr[31] = r31;
    ctx->fpr[1] = f1;
    InvokeDirectCpu<0x806ED160u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    f1.d = MemoryInline::FlatReadFloat32((r5 + 2888));
    r12 = MemoryInline::FlatRead32((r12 + 16));
    ctr = r12;
    ctx->lr = 0x806EFE34u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x806EFDC4 func_806EFDC4 preserves=true fpr_mask=0x00000000
