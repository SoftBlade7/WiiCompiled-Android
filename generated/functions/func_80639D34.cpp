...
extern "C" void func_80639D34(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80639D34:
{
    ...
    ctx->gpr[3] = r3;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x805E2E60u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r31 = ctx->gpr[31];
    ...
    ctx->gpr[3] = r3;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x805E2E98u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r31 = ctx->gpr[31];
...
// RECOMP_REGISTRATION base 0x80639D34 func_80639D34 preserves=true fpr_mask=0x00000000
