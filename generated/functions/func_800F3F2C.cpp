...
extern "C" void func_800F3F2C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800F3FA4:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800F3D10u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800F3FF0:
{
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWriteRam32((r30 + 40), r0);
}
...
// RECOMP_REGISTRATION base 0x800F3F2C func_800F3F2C preserves=true fpr_mask=0x00000000
