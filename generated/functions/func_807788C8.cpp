...
extern "C" void func_807788C8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807788E8:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r4 + 1228));
    r4 = (r31 + 48);
    r5 = (r31 + 180);
    ...
    ctx->fpr[4] = f4;
    ctx->cr = cr;
    InvokeDirectCpu<0x807789BCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x807788C8 func_807788C8 preserves=true fpr_mask=0x00000000
