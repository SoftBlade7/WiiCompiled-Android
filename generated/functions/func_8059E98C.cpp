...
extern "C" void func_8059E98C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8059E98C:
{
    ...
    r31 = ctx->gpr[31];
    r4 = 0x808B0000u;
    MemoryInline::FlatWrite8((r30 + 152), static_cast<uint8_t>(r31));
    r4 = (r4 + 26912);
    r3 = r30;
...
// RECOMP_REGISTRATION base 0x8059E98C func_8059E98C preserves=true fpr_mask=0x00000000
