...
extern "C" void func_805BA3D8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805BA4A0:
{
    ...
    r3 = 0;
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r0), static_cast<uint32_t>(39));
}
...
// RECOMP_REGISTRATION base 0x805BA3D8 func_805BA3D8 preserves=true fpr_mask=0x00000000
