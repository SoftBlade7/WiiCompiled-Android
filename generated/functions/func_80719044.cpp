...
extern "C" void func_80719044(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr1_0 = 0;
    uint32_t cr6_0 = 0;
...
loc_807190C4:
{
    r28 = (static_cast<int32_t>(static_cast<int8_t>(r22)));
...
loc_80719114:
{
    ...
    r24_addr_2 = (r24 + r5);
    MemoryInline::FlatWrite8(r24_addr_2, static_cast<uint8_t>(r0));
    if ((static_cast<int32_t>(r5) != static_cast<int32_t>(r28))) {
        goto loc_80719128;
    }
}
...
{
    r24_addr_3 = (r24 + r5);
    r25 = MemoryInline::FlatRead8(r24_addr_3);
}
...
loc_8071912C:
{
    r5 = MemoryInline::FlatRead8((r20 + 17));
    r0 = (r26 & 255);
}
...
loc_80719174:
{
    ...
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r3), static_cast<uint32_t>(58));
}
...
// RECOMP_REGISTRATION base 0x80719044 func_80719044 preserves=true fpr_mask=0x00000000
