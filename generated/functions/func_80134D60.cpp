...
extern "C" void func_80134D60(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80134D60:
{
    ...
    MemoryInline::FlatWriteRam16((r7 + 24), static_cast<uint16_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x80134D60 func_80134D60 preserves=true fpr_mask=0x00000000
