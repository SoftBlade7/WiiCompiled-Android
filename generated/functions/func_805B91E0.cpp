...
extern "C" void func_805B91E0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805B91E0:
{
    ...
    r23 = r3;
    r0 = MemoryInline::FlatRead16((r3 + 112));
    r26 = MemoryInline::FlatRead32((r4 + 19440));
...
loc_inl0_cont_8004EA50:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r23 + 100), r3);
    r28_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r30), static_cast<uint32_t>(7));
    r28 = (r28_rot_1 & -128);
    r25 = 0;
    r29 = 0;
    goto loc_805B92AC;
...
loc_805B923C:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead32((r23 + 100));
    r4_addr_2 = (r4 + r29);
...
loc_805B9278:
{
    r3 = MemoryInline::FlatRead32((r23 + 100));
    r5 = 128;
...
// RECOMP_REGISTRATION base 0x805B91E0 func_805B91E0 preserves=true fpr_mask=0x00000000
