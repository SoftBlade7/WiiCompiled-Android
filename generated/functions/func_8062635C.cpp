...
extern "C" void func_8062635C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8062635C:
{
    ...
    r11 = MemoryInline::FlatRead32((r29 + 1060));
    ...
    r8 = MemoryInline::FlatRead32((r29 + 1072));
    ...
    r9 = 0x808C0000u;
    r7 = 0x808C0000u;
    guest_range_4 = MemoryInline::ResolveRangeHost((r29 + 1084), 0, 60u, true, false);
    r22 = MemoryInline::ReadResolved32(guest_range_4, 0u, (r29 + 1084));
    r9 = (r9 + -11556);
    ...
    MemoryInline::WriteResolved32(guest_range_1, 16u, (r28 + 1636), r23);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r25 = MemoryInline::ReadResolved32(guest_range_4, 12u, (r29 + 1096));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r30 = MemoryInline::ReadResolved32(guest_range_4, 24u, (r29 + 1108));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r10 = MemoryInline::ReadResolved32(guest_range_4, 36u, (r29 + 1120));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_4, 48u, (r29 + 1132));
    ...
    ctx->gpr[31] = r31;
    ctx->fpr[0] = f0;
    InvokeDirectCpu<0x80637AD0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8062635C func_8062635C preserves=true fpr_mask=0x00000000
