...
extern "C" void func_8085110C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_808511A0:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x808516BCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_808511F8:
{
    ...
    r28 = MemoryInline::FlatRead32((r3 + 316));
...
loc_808514BC:
{
    ...
    r4 = 0x808B0000u;
    r3 = r30;
    f1.d = MemoryInline::FlatReadFloat32((r4 + -7112));
    r4 = 71;
    ctx->lr = 0x808514DCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x8085110C func_8085110C preserves=true fpr_mask=0x00000000
