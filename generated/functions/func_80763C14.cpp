...
extern "C" void func_80763C14(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80763C44:
{
    MemoryInline::FlatWrite8((r3 + 300), static_cast<uint8_t>(r5));
...
loc_80763CE0:
{
    ...
    MemoryInline::FlatWrite8((r29 + 256), static_cast<uint8_t>(r3));
    MemoryInline::FlatWrite8((r29 + 257), static_cast<uint8_t>(r3));
    if (((cr & 0x20000000u) != 0)) {
        goto loc_80763CF8;
    }
}
...
loc_80763D28:
{
    ...
    r31 = 0x808A0000u;
    r5 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r31 + 14504));
...
// RECOMP_REGISTRATION base 0x80763C14 func_80763C14 preserves=true fpr_mask=0x00000000
