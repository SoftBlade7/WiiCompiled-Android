...
extern "C" void func_801B00C4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801B00E4:
{
    ...
    r12 = MemoryInline::FlatRead32((r13 + -25188));
    ctr = r12;
    ctx->lr = 0x801B0100u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x801B00C4 func_801B00C4 preserves=true fpr_mask=0x00000000
