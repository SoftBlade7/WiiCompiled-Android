...
extern "C" void func_80213C48(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r0 = 1;
    MemoryInline::FlatWrite8((r13 + -24160), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x80213C48 func_80213C48 preserves=true fpr_mask=0x00000000
