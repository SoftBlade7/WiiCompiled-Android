...
extern "C" void func_806AB50C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806AB554:
{
    r3 = MemoryInline::FlatRead32((r3 + 664));
...
loc_806AB59C:
{
    r3 = MemoryInline::FlatRead32((r30 + 664));
...
loc_806AB5B0:
{
    r31 = MemoryInline::FlatRead32((r30 + 664));
...
// RECOMP_REGISTRATION base 0x806AB50C func_806AB50C preserves=true fpr_mask=0x00000000
