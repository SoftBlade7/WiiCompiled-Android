...
extern "C" void func_8088A2A8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8088A2A8:
{
    ...
    r0 = 0;
    r7 = (r1 + 8);
    r5 = MemoryInline::FlatRead32((r4 + 10220));
    r4 = (r1 + 16);
...
// RECOMP_REGISTRATION base 0x8088A2A8 func_8088A2A8 preserves=true fpr_mask=0x00000000
