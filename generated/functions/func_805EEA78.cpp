...
extern "C" void func_805EEA78(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_inl0_cont_805F8CF0:
{
    ...
    r31 = MemoryInline::FlatRead32((r26 + 52));
    r29 = r3;
    r30 = MemoryInline::FlatRead32((r26 + 48));
    r6 = 10000;
    r4 = r31;
    r5 = 0;
    r3 = r30;
...
// RECOMP_REGISTRATION base 0x805EEA78 func_805EEA78 preserves=true fpr_mask=0x00000000
