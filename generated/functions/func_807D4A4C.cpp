...
extern "C" void func_807D4A4C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807D4A4C:
{
    ...
    r5 = (r3 + r9);
    MemoryInline::FlatWrite32((r5 + 292), r8);
    MemoryInline::FlatWrite32((r5 + 296), r7);
...
// RECOMP_REGISTRATION base 0x807D4A4C func_807D4A4C preserves=true fpr_mask=0x00000000
