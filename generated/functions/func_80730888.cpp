...
extern "C" void func_80730888(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80730888:
{
    ...
    ctx->gpr[31] = r31;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8072A570u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80730888 func_80730888 preserves=true fpr_mask=0x00000000
