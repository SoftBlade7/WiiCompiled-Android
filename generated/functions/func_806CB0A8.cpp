...
extern "C" void func_806CB0A8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806CB0A8:
{
    ...
    r30 = (r30 + -1560);
    r27 = 0;
    f30.d = MemoryInline::FlatReadFloat64((r30 + 96));
    r29 = 0;
    f31.d = MemoryInline::FlatReadFloat32((r30 + 192));
    r28 = 80;
    r31 = 1127219200;
    goto loc_806CB170;
}
...
loc_806CB17C:
{
    r31 = MemoryInline::FlatRead32((r26 + 216));
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32(r30);
    r5 = 1;
...
// RECOMP_REGISTRATION base 0x806CB0A8 func_806CB0A8 preserves=false fpr_mask=0xE0000000
