...
extern "C" void func_80781128(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80781128:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r5 + 11860));
    ...
    ctx->fpr[0] = f0;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80780714u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r3 = 0x80380000u;
    r0 = 1127219200;
    r3 = MemoryInline::FlatRead32((r3 + 28432));
    r6 = 0x802A0000u;
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFEF8E gpr_write=0xFFFFFFFF gpr_return=0x00000018 fpr_read=0xFFFFFFFE fpr_write=0xFFFFFFFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x80781128 func_80781128 preserves=true fpr_mask=0x00000000
