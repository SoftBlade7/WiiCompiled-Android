...
extern "C" void func_8079A578(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8079A578:
{
    ...
    r28 = MemoryInline::FlatRead32((r31 + 596));
    goto loc_8079A5D8;
}
...
loc_8079A5A8:
{
    ...
    r3 = r27;
    // inline leaf 0x807B120C (3 guest instruction(s))
    r3 = MemoryInline::FlatRead32((r3 + 416));
    r3 = MemoryInline::FlatRead8((r3 + 24));
    // end of inlined leaf 0x807B120C
    r0 = (r3 & 255);
...
loc_8079A5C4:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x807B0B4Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8079A578 func_8079A578 preserves=true fpr_mask=0x00000000
