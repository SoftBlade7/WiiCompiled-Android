...
extern "C" void func_8014B1E4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8014B214:
{
    r27 = MemoryInline::FlatRead32((r7 + 8));
...
// RECOMP_REGISTRATION base 0x8014B1E4 func_8014B1E4 preserves=true fpr_mask=0x00000000
