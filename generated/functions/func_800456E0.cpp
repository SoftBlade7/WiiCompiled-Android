...
extern "C" void func_800456E0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80045820:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    guest_range_3 = MemoryInline::ResolveRangeHost((r1 + 8), 0, 40u, true, false);
    r18 = MemoryInline::ReadResolved32(guest_range_3, 0u, (r1 + 8));
    r12 = r26;
    r11 = MemoryInline::ReadResolved32(guest_range_3, 4u, (r1 + 12));
    r3 = r29;
    r10 = MemoryInline::ReadResolved32(guest_range_3, 8u, (r1 + 16));
    r4 = r19;
    r9 = MemoryInline::ReadResolved32(guest_range_3, 12u, (r1 + 20));
    r25 = (r25 + r24);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r8 = MemoryInline::ReadResolved32(guest_range_3, 16u, (r1 + 24));
            r7 = MemoryInline::ReadResolved32(guest_range_3, 20u, (r1 + 28));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_3, 24u, (r1 + 32));
            r5 = MemoryInline::ReadResolved32(guest_range_3, 28u, (r1 + 36));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r0 = MemoryInline::ReadResolved32(guest_range_3, 32u, (r1 + 40));
            f0.d = MemoryInline::ReadResolvedFloat32(guest_range_3, 36u, (r1 + 44));
        }
    }
    guest_range_4 = MemoryInline::ResolveRangeHost((r1 + 88), 0, 40u, false, true);
    if (!MemoryInline::WriteResolvedPair32(guest_range_4, 0u, ((static_cast<uint64_t>(static_cast<uint32_t>(r18)) << 32) | static_cast<uint32_t>(r11)))) {
        MemoryInline::WriteResolved32(guest_range_4, 0u, (r1 + 88), r18);
        MemoryInline::WriteResolved32(guest_range_4, 4u, (r1 + 92), r11);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_4, 8u, ((static_cast<uint64_t>(static_cast<uint32_t>(r10)) << 32) | static_cast<uint32_t>(r9)))) {
        MemoryInline::WriteResolved32(guest_range_4, 8u, (r1 + 96), r10);
        MemoryInline::WriteResolved32(guest_range_4, 12u, (r1 + 100), r9);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_4, 16u, ((static_cast<uint64_t>(static_cast<uint32_t>(r8)) << 32) | static_cast<uint32_t>(r7)))) {
        MemoryInline::WriteResolved32(guest_range_4, 16u, (r1 + 104), r8);
        MemoryInline::WriteResolved32(guest_range_4, 20u, (r1 + 108), r7);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_4, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r6)) << 32) | static_cast<uint32_t>(r5)))) {
        MemoryInline::WriteResolved32(guest_range_4, 24u, (r1 + 112), r6);
        MemoryInline::WriteResolved32(guest_range_4, 28u, (r1 + 116), r5);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_4, 32u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | PpcBitCastToU32Inline(static_cast<float>(f0.d))))) {
        MemoryInline::WriteResolved32(guest_range_4, 32u, (r1 + 120), r0);
        MemoryInline::WriteResolvedFloat32(guest_range_4, 36u, (r1 + 124), f0.d);
    }
    ctr = r12;
    ctx->lr = 0x800458D8u;
    ctx->gpr[0] = r0;
...
loc_800458E4:
{
    r0 = (r25 ^ -2147483648);
    MemoryInline::FlatWriteRam32((r1 + 132), r0);
    r18 = MemoryInline::FlatRead32((r1 + 88));
    f1.d = f30.d;
    f0.d = MemoryInline::FlatReadFloat64((r1 + 128));
    f2.d = f29.d;
    r19 = MemoryInline::FlatRead32((r1 + 92));
    r3 = r21;
    f0.d = static_cast<double>(PpcForceSingleValueInline(f0.d - f31.d));
    r20 = MemoryInline::FlatRead32((r1 + 96));
    r5 = r22;
    r27 = MemoryInline::FlatRead32((r1 + 100));
    r6 = r23;
    r12 = MemoryInline::FlatRead32((r1 + 104));
    r11 = MemoryInline::FlatRead32((r1 + 108));
    f3.d = PpcFmulsInline(f28.d, f0.d);
    r10 = MemoryInline::FlatRead32((r1 + 112));
    r7 = r30;
    r9 = MemoryInline::FlatRead32((r1 + 116));
    r8 = r28;
    r0 = MemoryInline::FlatRead32((r1 + 120));
    f0.d = MemoryInline::FlatReadFloat32((r1 + 124));
    r4 = (r1 + 88);
    MemoryInline::FlatWriteRam32((r1 + 48), r18);
    MemoryInline::FlatWriteRam32((r1 + 52), r19);
    MemoryInline::FlatWriteRam32((r1 + 56), r20);
...
// RECOMP_REGISTRATION base 0x800456E0 func_800456E0 preserves=false fpr_mask=0xF0000000
