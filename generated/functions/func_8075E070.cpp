...
extern "C" void func_8075E070(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8075E070:
{
    ...
    r5 = (r1 + 56);
    f1.d = MemoryInline::FlatReadFloat32((r6 + 14380));
    ...
    ctx->fpr[3] = f3;
    ctx->fpr[4] = f4;
    InvokeDirectCpu<0x8075E16Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    cr = ctx->cr;
    r3 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 14336));
...
// RECOMP_GUEST_ABI gpr_read=0xE000003E gpr_write=0xE00001FB gpr_return=0x00000018 fpr_read=0x80000007 fpr_write=0x800000FF fpr_return=0x00000002 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8075E070 func_8075E070 preserves=true fpr_mask=0x00000000
