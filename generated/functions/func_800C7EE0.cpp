...
extern "C" void func_800C7EE0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_800C7F14:
{
    ...
    MemoryInline::FlatWrite16((r3 + 748), static_cast<uint16_t>(r29));
    MemoryInline::FlatWrite16((r3 + 750), static_cast<uint16_t>(r29));
}
...
{
    r24 = (r24 + 1);
    MemoryInline::FlatWrite32((r26 + 16), r29);
...
loc_800C7F74:
{
    ...
    MemoryInline::FlatWrite16((r3 + 748), static_cast<uint16_t>(r0));
    MemoryInline::FlatWrite16((r3 + 750), static_cast<uint16_t>(r0));
}
...
loc_800C8024:
{
    ...
    MemoryInline::FlatWrite32((r31 + 108), r5);
...
// RECOMP_REGISTRATION base 0x800C7EE0 func_800C7EE0 preserves=true fpr_mask=0x00000000
