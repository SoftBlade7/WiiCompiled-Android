...
extern "C" void func_807E8124(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807E8124:
{
    ...
    r3 = 0x809C0000u;
    r4 = (r4 + 7812);
    MemoryInline::FlatWriteRam32((r3 + 16304), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x807E8124 func_807E8124 preserves=true fpr_mask=0x00000000
