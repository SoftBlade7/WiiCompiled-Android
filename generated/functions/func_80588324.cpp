...
extern "C" void func_80588324(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r3 = 0x808B0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + 23256));
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->fpr[1] = f1;
    ctx->cr = cr;
...
// RECOMP_REGISTRATION base 0x80588324 func_80588324 preserves=true fpr_mask=0x00000000
