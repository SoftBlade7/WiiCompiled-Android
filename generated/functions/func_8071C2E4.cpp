...
extern "C" void func_8071C2E4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8071C2E4:
{
    ...
    r4 = 0x808D0000u;
    r0 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r5 + 8272));
    r4 = (r4 + -27504);
...
// RECOMP_REGISTRATION base 0x8071C2E4 func_8071C2E4 preserves=true fpr_mask=0x00000000
