...
extern "C" void func_80145264(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80145290:
{
    r4 = 5;
    r0 = 0;
    MemoryInline::FlatWriteRam16((r3 + 2), static_cast<uint16_t>(r4));
    r6 = 27;
    r5 = 4;
    r4 = 2;
...
// RECOMP_REGISTRATION base 0x80145264 func_80145264 preserves=true fpr_mask=0x00000000
