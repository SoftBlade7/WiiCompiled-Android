...
extern "C" void func_80181AF0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80181B2C:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80181790u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80181B84:
{
    r31 = MemoryInline::FlatRead32((r26 + 8));
    r30 = (r26 + 8);
    r29 = 0x80340000u;
    goto loc_80181BD4;
}
...
loc_80181BDC:
{
    r3 = (r26 + 4);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r26)) + static_cast<uint64_t>(static_cast<uint32_t>(4)) + (static_cast<uint64_t>(static_cast<uint32_t>(0)) & 1u);
...
loc_80181BE4:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8018C9D0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80181AF0 func_80181AF0 preserves=true fpr_mask=0x00000000
