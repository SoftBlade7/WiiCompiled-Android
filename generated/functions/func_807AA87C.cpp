...
extern "C" void func_807AA87C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr6_0 = 0;
    uint32_t cr7_0 = 0;
...
loc_807AA87C:
{
    ...
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(2400));
}
...
loc_807AA8D4:
{
    r5 = -1;
    r6 = 0;
    MemoryInline::FlatWrite16((r3 + 692), static_cast<uint16_t>(r0));
    r0_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(1));
    r0 = (r0_rot_1 & 131070);
    r4 = MemoryInline::FlatRead32((r3 + 708));
    MemoryInline::FlatWrite32((r3 + 696), r5);
    r5 = MemoryInline::FlatRead32((r3 + 712));
    MemoryInline::FlatWrite32((r3 + 700), r6);
    r4_addr_1 = (r4 + r0);
...
loc_807AA924:
{
    r4 = MemoryInline::FlatRead32((r3 + 700));
    r0 = MemoryInline::FlatRead16((r3 + 692));
    r4 = (r4 + 1);
    MemoryInline::FlatWrite32((r3 + 700), r4);
    r4 = MemoryInline::FlatRead32((r3 + 708));
...
loc_807AA96C:
{
    r0 = MemoryInline::FlatRead16((r31 + 692));
    r3 = r31;
    r30 = (r0 & 255);
    ctx->lr = 0x807AA97Cu;
    ctx->gpr[0] = r0;
    ...
    ctx->fpr[1] = f1;
    ctx->cr = cr;
    InvokeDirectCpu<0x807B60A0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_807AA9BC:
{
    r5 = 0x809C0000u;
    r4 = (r3 & 255);
    r3 = MemoryInline::FlatRead32((r5 + 8992));
    // inline leaf 0x806F8210 (4 guest instruction(s))
    r0 = (r4 * 12);
    r3 = (r3 + r0);
    r3 = (r3 + 20);
    // end of inlined leaf 0x806F8210
    f1.d = MemoryInline::FlatReadFloat32((r31 + 644));
    ctx->lr = 0x807AA9D4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_807AAA14:
{
    ...
    r31_psq_tmp_1 = (r31 + 724);
    PPC_PsqStGqrInline<0u, 0u>(ctx, mkw_gqr0, r31_psq_tmp_1, f0.d);
    // psq_load w=1 quant=0 (using PPC_PsqL)
    r3_psq_tmp_1 = (r3 + 8);
    PpcSetPairedFprInline(f0, PPC_PsqLGqrInline<1u, 0u>(ctx, mkw_gqr0, r3_psq_tmp_1));
    PpcSetPairedFprInline(f0, PPC_PsSubInline(f0.d, f1.d));
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r31_psq_tmp_2 = (r31 + 732);
    PPC_PsqStGqrInline<1u, 0u>(ctx, mkw_gqr0, r31_psq_tmp_2, f0.d);
}
...
// RECOMP_REGISTRATION base 0x807AA87C func_807AA87C preserves=true fpr_mask=0x00000000
