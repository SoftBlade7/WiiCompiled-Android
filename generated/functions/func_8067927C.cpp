...
extern "C" void func_8067927C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8067927C:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x802085CCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_806792B8:
{
    ...
    if (MkwStateFreeAbiEnabled(0x80208B70u) && KnownTranslatedCpuCall<0x80208B70u>::kAvailable && !KnownTranslatedCpuCall<0x80208B70u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80208B70u>()) {
        const auto state_free_result_80208B70_D07 = func_80208B70_statefree(r13);
        r3 = static_cast<uint32_t>(state_free_result_80208B70_D07);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_806792F0:
{
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x80208B70u) && KnownTranslatedCpuCall<0x80208B70u>::kAvailable && !KnownTranslatedCpuCall<0x80208B70u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80208B70u>()) {
        const auto state_free_result_80208B70_1784 = func_80208B70_statefree(r13);
        r3 = static_cast<uint32_t>(state_free_result_80208B70_1784);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_80679300:
{
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x80208B70u) && KnownTranslatedCpuCall<0x80208B70u>::kAvailable && !KnownTranslatedCpuCall<0x80208B70u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80208B70u>()) {
        const auto state_free_result_80208B70_1CC0 = func_80208B70_statefree(r13);
        r3 = static_cast<uint32_t>(state_free_result_80208B70_1CC0);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8067927C func_8067927C preserves=true fpr_mask=0x00000000
