...
extern "C" void func_8067F868(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8067F8C0:
{
    ...
    MemoryInline::FlatWrite8((r30 + 453), static_cast<uint8_t>(r31));
    MemoryInline::FlatWrite8((r3 + 189), static_cast<uint8_t>(r31));
...
// RECOMP_REGISTRATION base 0x8067F868 func_8067F868 preserves=true fpr_mask=0x00000000
