...
extern "C" void func_801D5E74(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801D5E74:
{
    r3 = MemoryInline::FlatRead32((r3 + 840));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x801D5E74 func_801D5E74 preserves=true fpr_mask=0x00000000
