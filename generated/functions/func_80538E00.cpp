...
extern "C" void func_80538E00(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80538E30:
{
    ...
    r3 = 0x809C0000u;
    r0 = (r4 * 24);
    r31 = MemoryInline::FlatRead32((r3 + 18248));
    r5 = 0;
    r3 = r31;
    r7 = (r31 + r0);
    r6 = 1;
    r8 = MemoryInline::FlatRead8((r7 + 964));
    r7 = 0;
    r9 = 0;
    ctx->lr = 0x80538E60u;
    ctx->gpr[0] = r0;
    ...
    r0 = (r30 * 240);
    r7 = MemoryInline::FlatRead32((r4 + 8200));
    r3 = 0x808B0000u;
    r9 = MemoryInline::FlatRead32((r3 + 8204));
    r6 = 1;
    r4 = (r5 + r0);
...
// RECOMP_REGISTRATION base 0x80538E00 func_80538E00 preserves=true fpr_mask=0x00000000
