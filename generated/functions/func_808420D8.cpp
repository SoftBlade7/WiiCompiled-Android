...
extern "C" void func_808420D8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80842168:
{
    ...
    cr = ctx->cr;
    ctr = ctx->ctr;
    r3 = MemoryInline::FlatRead32((r29 + 9176));
}
...
// RECOMP_REGISTRATION base 0x808420D8 func_808420D8 preserves=true fpr_mask=0x00000000
