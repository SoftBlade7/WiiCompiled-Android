...
extern "C" void func_806BA7FC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806BA90C:
{
    ...
    r0 = fctiwzword0;
    MemoryInline::FlatWrite16((r30 + 386), static_cast<uint16_t>(r0));
    r12 = MemoryInline::FlatRead32(r3);
    r12 = MemoryInline::FlatRead32((r12 + 12));
    ctr = r12;
    ctx->lr = 0x806BA93Cu;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead16((r30 + 386));
    r0 = 1127219200;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    f0.d = MemoryInline::FlatReadFloat32((r30 + 356));
    f2.d = MemoryInline::FlatReadFloat32((r30 + 244));
    f0.d = static_cast<double>(PpcForceSingleValueInline(f0.d + f1.d));
    MemoryInline::FlatWriteFloat32((r30 + 356), f0.d);
...
loc_806BABB0:
{
    ...
    r0 = MemoryInline::FlatRead16((r3 + 226));
    r0 = (r0 << 16);
    r0 = (static_cast<int32_t>(r0) >> 16);
...
// RECOMP_REGISTRATION base 0x806BA7FC func_806BA7FC preserves=false fpr_mask=0x80000000
