...
extern "C" void func_800A1820(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800A1890:
{
    r3 = MemoryInline::FlatRead32((r18 + 16));
    r4 = r20;
    r5 = (r1 + 64);
    ctx->lr = 0x800A18A0u;
    ctx->gpr[0] = r0;
...
loc_800A18B4:
{
    ...
    r0 = 0;
    r29 = MemoryInline::FlatRead32((r1 + 76));
    r31 = 0;
    r14 = MemoryInline::FlatRead32((r1 + 68));
    r30 = 0;
    r17 = MemoryInline::FlatRead32((r1 + 72));
...
loc_800A18DC:
{
    guest_range_1 = MemoryInline::ResolveRangeHost(r15, 0, 32u, true, false);
    r3 = MemoryInline::ReadResolved32(guest_range_1, 0u, r15);
    r0 = (r3 & 1);
}
...
{
    {
        ...
        if (resolved_pair.valid) {
            ...
            r31 = MemoryInline::ReadResolved32(guest_range_1, 4u, (r15 + 4));
            r30 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r15 + 8));
        }
    }
}
...
loc_800A18F8:
{
    r29 = MemoryInline::ReadResolved32(guest_range_1, 16u, (r15 + 16));
}
...
loc_800A1904:
{
    r14 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r15 + 12));
}
...
loc_800A1910:
{
    r17 = MemoryInline::ReadResolved32(guest_range_1, 20u, (r15 + 20));
}
...
loc_800A191C:
{
    r0 = MemoryInline::ReadResolved32(guest_range_1, 24u, (r15 + 24));
    MemoryInline::FlatWriteRam32((r1 + 100), r0);
    r0 = MemoryInline::ReadResolved32(guest_range_1, 28u, (r15 + 28));
    MemoryInline::FlatWriteRam32((r1 + 96), r0);
}
...
loc_800A194C:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8008F830u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800A1964:
{
    if ((static_cast<int32_t>(r16) <= static_cast<int32_t>(127))) {
        goto loc_800A1970;
    }
}
...
{
    {
        const uint32_t ppcCarryValue = static_cast<uint32_t>(r16);
        const uint32_t ppcCarryShift = static_cast<uint32_t>(31) & 0x3Fu;
        const bool ppcCarryNegative = (ppcCarryValue & 0x80000000u) != 0;
        const uint32_t ppcCarry = ppcCarryShift == 0 ? 0u : (ppcCarryShift >= 32 ? (ppcCarryNegative && ppcCarryValue != 0 ? 1u : 0u) : (ppcCarryNegative && (ppcCarryValue & ((1u << ppcCarryShift) - 1u)) != 0 ? 1u : 0u));
        xer = (xer & 0xDFFFFFFFu) | (ppcCarry << 29);
    }
    r0 = (static_cast<int32_t>(r16) >> 31);
    r15 = (r16 & ~r0);
}
...
loc_800A199C:
{
    r0_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r17), static_cast<uint32_t>(4));
    r0 = (r0_rot_1 & -16);
    r3 = (r22 + r0);
    r26 = (r3 + 8);
}
...
loc_800A19B8:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800A3BE0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800A1A00:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80091E80u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r5 = ctx->gpr[5];
    r6 = ctx->gpr[6];
...
loc_800A1A5C:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r16), static_cast<int32_t>(127));
}
...
loc_800A1AA0:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8009A410u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800A1AB8:
{
    r0 = MemoryInline::FlatRead32((r18 + 60));
}
...
loc_800A1ACC:
{
    r3 = MemoryInline::FlatRead32((r18 + 64));
    r15 = (r3 + -224);
}
...
loc_800A1AEC:
{
    r3 = MemoryInline::FlatRead8((r15 + 140));
    r0 = MemoryInline::FlatRead32((r15 + 72));
    r3 = (r3 + r0);
}
...
loc_800A1B7C:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r16), static_cast<int32_t>(r4));
}
...
loc_800A1BBC:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8008F8D0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800A1BD0:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8008F760u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800A1C44:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800A8480u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800A1C5C:
{
    r0 = MemoryInline::FlatRead32((r18 + 100));
}
...
loc_800A1C70:
{
    r3 = MemoryInline::FlatRead32((r18 + 104));
    r16 = (r3 + -224);
}
...
loc_800A1C90:
{
    r3 = MemoryInline::FlatRead8((r16 + 140));
    r0 = MemoryInline::FlatRead32((r16 + 72));
    r3 = (r3 + r0);
}
...
loc_800A1D24:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r15), static_cast<int32_t>(r4));
}
...
loc_800A1DEC:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800AD4A0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800A1E04:
{
    r0 = MemoryInline::FlatRead32((r18 + 140));
}
...
loc_800A1E18:
{
    r3 = MemoryInline::FlatRead32((r18 + 144));
    r16 = (r3 + -224);
}
...
loc_800A1F64:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800A38D0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800A1FC8:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800A3D30u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800A2014:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800A2260u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800A206C:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8009DF60u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800A20AC:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800A25C0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800A20FC:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8009DF70u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800A213C:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800A2770u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800A21BC:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80091BC0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800A2200:
{
    r3 = r15;
    r4 = r22;
    // inline leaf 0x8008F470 (2 guest instruction(s))
    MemoryInline::FlatWrite32((r3 + 20), r4);
    // end of inlined leaf 0x8008F470
}
...
loc_800A2224:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800A2E30u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x800A1820 func_800A1820 preserves=true fpr_mask=0x00000000
