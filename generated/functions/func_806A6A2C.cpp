...
extern "C" void func_806A6A2C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806A6A74:
{
    r31 = MemoryInline::FlatRead32((r3 + 608));
...
// RECOMP_REGISTRATION base 0x806A6A2C func_806A6A2C preserves=true fpr_mask=0x00000000
