...
extern "C" void func_8007F300(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = (r13 + -27288);
    MemoryInline::FlatWrite32((r13 + -27248), r0);
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x8007F300 func_8007F300 preserves=true fpr_mask=0x00000000
