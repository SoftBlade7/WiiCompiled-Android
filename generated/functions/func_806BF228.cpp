...
extern "C" void func_806BF228(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806BF324:
{
    ...
    r11 = (r1 + 160);
    guest_range_0 = MemoryInline::ResolveRangeHost((r1 + 136), 0, 48u, true, false);
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_0, 24u, (r1 + 160));
    ...
    r0 = MemoryInline::ReadResolved32(guest_range_0, 44u, (r1 + 180));
    ctx->lr = r0;
    r1 = (r1 + 176);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_806BF158:
{
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x806BF158u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_806BF14C:
{
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x806BF14Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x806BF228 func_806BF228 preserves=false fpr_mask=0x80000000
