...
extern "C" void func_8073AB68(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8073AB68:
{
    ...
    ctx->gpr[30] = r30;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x8073ACA8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8073AB68 func_8073AB68 preserves=true fpr_mask=0x00000000
