...
extern "C" void func_805EE630(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805EE630:
{
    r3 = MemoryInline::FlatRead32((r3 + 4404));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x805EE630 func_805EE630 preserves=true fpr_mask=0x00000000
