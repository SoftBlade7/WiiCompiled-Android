...
extern "C" void func_801A3214(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801A3214:
{
    MemoryInline::FlatWrite32((r13 + -25400), r3);
    return;
}
...
// RECOMP_REGISTRATION base 0x801A3214 func_801A3214 preserves=true fpr_mask=0x00000000
