...
extern "C" void func_805B8CFC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r4 = 0x809C0000u;
    r3 = MemoryInline::FlatRead32((r4 + 6976));
...
{
    r0 = 0;
    MemoryInline::FlatWriteRam32((r4 + 6976), r0);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_return;
    }
}
...
// RECOMP_REGISTRATION base 0x805B8CFC func_805B8CFC preserves=true fpr_mask=0x00000000
