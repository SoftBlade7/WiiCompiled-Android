...
extern "C" void func_8078F784(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8078F864:
{
    r30 = MemoryInline::FlatRead32((r26 + 88));
}
...
loc_8078F930:
{
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8081BFA0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8078F784 func_8078F784 preserves=false fpr_mask=0x80000000
