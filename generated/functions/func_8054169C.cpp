...
extern "C" void func_8054169C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8054169C:
{
    ...
    r8_addr_0 = (r8 + r31);
    r3 = MemoryInline::FlatRead32(r8_addr_0);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
// RECOMP_REGISTRATION base 0x8054169C func_8054169C preserves=true fpr_mask=0x00000000
