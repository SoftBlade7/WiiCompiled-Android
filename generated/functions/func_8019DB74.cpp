...
extern "C" void func_8019DB74(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8019DBB0:
{
    ...
    r27_addr_1 = (r27 + r30);
    MemoryInline::FlatWrite8(r27_addr_1, static_cast<uint8_t>(r3));
    r0 = (static_cast<int32_t>(static_cast<int8_t>(r0)));
...
loc_8019DBF8:
{
    ...
    r0 = 0;
    r27_addr_2 = (r27 + r30);
    MemoryInline::FlatWrite8(r27_addr_2, static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x8019DB74 func_8019DB74 preserves=true fpr_mask=0x00000000
