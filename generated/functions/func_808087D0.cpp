...
extern "C" void func_808087D0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_808087D0:
{
    ...
    ctx->gpr[9] = r9;
    ctx->fpr[1] = f1;
    InvokeDirectCpu<0x80808CA8u>(ctx);
    r9 = ctx->gpr[9];
    f1 = ctx->fpr[1];
    ctx->gpr[9] = r9;
    ctx->gpr[10] = r10;
...
// RECOMP_REGISTRATION base 0x808087D0 func_808087D0 preserves=true fpr_mask=0x00000000
