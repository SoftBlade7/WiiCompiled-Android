...
extern "C" void func_8007B610(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr1_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8007B638:
{
    r0 = MemoryInline::FlatRead8((r3 + 257));
    r4 = 0x80270000u;
    r4 = (r4 + 13688);
...
loc_8007B650:
{
    r31 = MemoryInline::FlatRead32((r3 + 228));
...
loc_8007B680:
{
    ...
    r0 = (r0 & -129);
    MemoryInline::FlatWrite8((r29 + 257), static_cast<uint8_t>(r0));
}
...
loc_8007B6EC:
{
    ...
    r31 = MemoryInline::FlatRead32((r29 + 40));
...
// RECOMP_REGISTRATION base 0x8007B610 func_8007B610 preserves=true fpr_mask=0x00000000
