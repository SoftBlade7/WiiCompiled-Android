...
extern "C" void func_801E51C8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
    uint32_t r3_rot_1 = 0;
...
loc_801E51F4:
{
    ...
    r4 = (r3 + 28192);
    r0 = 1;
    MemoryInline::FlatWriteRam32((r3 + 28192), r5);
    r3 = 0;
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 0u, ((static_cast<uint64_t>(static_cast<uint32_t>(r5)) << 32) | static_cast<uint32_t>(r5)))) {
        ...
        MemoryInline::WriteResolved32(guest_range_0, 4u, (r4 + 8), r5);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 8u, ((static_cast<uint64_t>(static_cast<uint32_t>(r5)) << 32) | static_cast<uint32_t>(r5)))) {
        MemoryInline::WriteResolved32(guest_range_0, 8u, (r4 + 12), r5);
        MemoryInline::WriteResolved32(guest_range_0, 12u, (r4 + 16), r5);
    }
    MemoryInline::WriteResolved32(guest_range_0, 16u, (r4 + 20), r0);
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 20u, ((static_cast<uint64_t>(static_cast<uint32_t>(r5)) << 32) | static_cast<uint32_t>(r5)))) {
        MemoryInline::WriteResolved32(guest_range_0, 24u, (r4 + 28), r5);
        MemoryInline::WriteResolved32(guest_range_0, 20u, (r4 + 24), r5);
    }
...
// RECOMP_REGISTRATION base 0x801E51C8 func_801E51C8 preserves=true fpr_mask=0x00000000
