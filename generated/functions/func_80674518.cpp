...
extern "C" void func_80674518(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80674564:
{
    MemoryInline::FlatWrite32((r29 + 17348), r31);
    r3 = 0x80380000u;
    MemoryInline::FlatWrite32((r29 + 17352), r30);
...
loc_806745F0:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead32((r29 + 17344));
    r3 = r29;
    r6 = (r29 + 17120);
    r5 = 0;
    ctx->lr = 0x80674620u;
...
// RECOMP_REGISTRATION base 0x80674518 func_80674518 preserves=true fpr_mask=0x00000000
