...
extern "C" void func_806A9D48(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806A9EA0:
{
    r31 = MemoryInline::FlatRead32((r30 + 540));
...
loc_806A9F50:
{
    r31 = MemoryInline::FlatRead32((r3 + 540));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r31), static_cast<int32_t>(0));
}
...
// RECOMP_REGISTRATION base 0x806A9D48 func_806A9D48 preserves=true fpr_mask=0x00000000
