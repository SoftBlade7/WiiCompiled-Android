...
extern "C" void func_8067B8F0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8067B8F0:
{
    ...
    r3 = MemoryInline::FlatRead32((r30 + 8660));
    ctx->lr = 0x8067B91Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80225070u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->gpr[5] = r5;
    ctx->cr = cr;
    InvokeDirectCpu<0x80225040u>(ctx);
    r0 = ctx->gpr[0];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
    cr = ctx->cr;
...
{
    r29 = (r29 + 4);
    if ((static_cast<int32_t>(r28) < static_cast<int32_t>(9))) {
        goto loc_8067B930;
    }
}
...
loc_8067B988:
{
    ...
    r3 = 0;
    MemoryInline::FlatWrite32((r31 + 108), r3);
}
...
loc_8067B9A8:
{
    MemoryInline::FlatWrite32((r4 + 120), r3);
    r5 = (r5 + 1);
    MemoryInline::FlatWrite32((r4 + 920), r3);
    r4 = (r4 + 4);
}
...
loc_8067BA6C:
{
    ...
    r3 = MemoryInline::FlatRead32((r31 + 2524));
    ctx->lr = 0x8067BA7Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r31 + 2524), r30);
    r28 = 0;
    r30 = 0;
    goto loc_8067BAB8;
}
...
loc_8067BAC4:
{
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWrite32((r31 + 2520), r0);
}
...
// RECOMP_REGISTRATION base 0x8067B8F0 func_8067B8F0 preserves=true fpr_mask=0x00000000
