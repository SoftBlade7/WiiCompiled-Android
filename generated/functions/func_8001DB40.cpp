...
extern "C" void func_8001DB40(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8001DC20:
{
    ...
    r5 = 64;
    MemoryInline::FlatWriteRam8((r1 + 172), static_cast<uint8_t>(r7));
...
// RECOMP_REGISTRATION base 0x8001DB40 func_8001DB40 preserves=true fpr_mask=0x00000000
