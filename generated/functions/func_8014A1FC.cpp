...
extern "C" void func_8014A1FC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8014A248:
{
    // inline leaf 0x8014FA1C (4 guest instruction(s))
    r0 = 0;
    MemoryInline::FlatWrite8(r3, static_cast<uint8_t>(r0));
    MemoryInline::FlatWrite16((r3 + 2), static_cast<uint16_t>(r0));
    // end of inlined leaf 0x8014FA1C
    goto loc_8014A278;
}
...
// RECOMP_REGISTRATION base 0x8014A1FC func_8014A1FC preserves=true fpr_mask=0x00000000
