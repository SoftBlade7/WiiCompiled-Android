...
extern "C" void func_807ABEE4(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = 2;
    MemoryInline::FlatWrite32((r3 + 708), r0);
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x807ABEE4 func_807ABEE4 preserves=true fpr_mask=0x00000000
