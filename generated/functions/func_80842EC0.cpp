...
extern "C" void func_80842EC0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_80842EC0:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead32((r30 + 2112));
    r3 = (r30 + 1736);
    r7 = MemoryInline::FlatRead32((r30 + 2108));
    r5 = (r30 + 788);
    r0_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(2));
    r0 = (r0_rot_0 & -4);
    r8 = MemoryInline::FlatRead32((r30 + 1732));
    r6 = (r7 * 10);
    r4 = (r4 + 1);
    r8_addr_0 = (r8 + r0);
    r8 = MemoryInline::FlatRead32(r8_addr_0);
    r0 = (r7 + 1);
    MemoryInline::FlatWrite32((r30 + 788), r4);
    r31 = (r8 + r6);
    MemoryInline::FlatWrite32((r30 + 792), r0);
    r0 = MemoryInline::FlatRead16((r31 + 2));
    r0 = (r0 << 16);
    r0 = (static_cast<int32_t>(r0) >> 16);
    MemoryInline::FlatWrite32((r30 + 996), r0);
...
loc_80842F3C:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805BDBD4u) && KnownTranslatedCpuCall<0x805BDBD4u>::kAvailable && !KnownTranslatedCpuCall<0x805BDBD4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805BDBD4u>()) {
        const auto state_free_result_805BDBD4_1001 = func_805BDBD4_statefree(r3, r4);
        r3 = static_cast<uint32_t>(state_free_result_805BDBD4_1001);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    r0 = 1;
    MemoryInline::FlatWrite8((r30 + 2840), static_cast<uint8_t>(r0));
    goto loc_80842F8C;
}
...
// RECOMP_REGISTRATION base 0x80842EC0 func_80842EC0 preserves=true fpr_mask=0x00000000
