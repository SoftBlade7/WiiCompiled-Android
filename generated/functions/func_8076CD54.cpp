...
extern "C" void func_8076CD54(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8076CD54:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r4 + 15768));
    r4 = 0;
    MemoryInline::FlatWriteRam32((r1 + 12), r31);
    r31 = 1;
    MemoryInline::FlatWriteRam32((r1 + 8), r30);
    r30 = r3;
    MemoryInline::FlatWrite32((r3 + 200), r31);
...
// RECOMP_REGISTRATION base 0x8076CD54 func_8076CD54 preserves=true fpr_mask=0x00000000
