...
extern "C" void func_80677BF4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80677BF4:
{
    ...
    r3 = (r29 + 28);
    r0 = 1;
    guest_range_0 = MemoryInline::ResolveRangeHost((r29 + 92), 0, 36u, false, true);
    MemoryInline::WriteResolved32(guest_range_0, 0u, (r29 + 92), r3);
    r4 = 0x808C0000u;
    r7 = 0x80680000u;
    r3 = 0x808C0000u;
    MemoryInline::WriteResolved32(guest_range_0, 4u, (r29 + 96), r5);
    r8 = r29;
    r4 = (r4 + 3688);
    r6 = (r29 + 92);
    MemoryInline::WriteResolved32(guest_range_0, 8u, (r29 + 100), r31);
    r7 = (r7 + -32104);
    r5 = 1;
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 12u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | static_cast<uint32_t>(r31)))) {
        MemoryInline::WriteResolved32(guest_range_0, 12u, (r29 + 104), r0);
        MemoryInline::WriteResolved32(guest_range_0, 16u, (r29 + 108), r31);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 20u, ((static_cast<uint64_t>(static_cast<uint32_t>(r31)) << 32) | static_cast<uint32_t>(r31)))) {
        MemoryInline::WriteResolved32(guest_range_0, 20u, (r29 + 112), r31);
        MemoryInline::WriteResolved32(guest_range_0, 24u, (r29 + 116), r31);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 28u, ((static_cast<uint64_t>(static_cast<uint32_t>(r31)) << 32) | static_cast<uint32_t>(r31)))) {
        MemoryInline::WriteResolved32(guest_range_0, 28u, (r29 + 120), r31);
        MemoryInline::WriteResolved32(guest_range_0, 32u, (r29 + 124), r31);
    }
...
// RECOMP_REGISTRATION base 0x80677BF4 func_80677BF4 preserves=true fpr_mask=0x00000000
