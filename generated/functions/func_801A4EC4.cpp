...
extern "C" void func_801A4EC4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_801A4EC4:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x801B90F4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801A4F64:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x801A82C0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801A4F78:
{
    ...
    r0 = (r5 ^ -2147483648);
    r3_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(26));
    r3 = (r3_rot_2 & 67108863);
    r3 = (r3 * 1000);
    r3_subfc_sub_2 = r3;
    r3 = (r6 - r3_subfc_sub_2);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(r6) >= static_cast<uint32_t>(r3_subfc_sub_2) ? 1u : 0u) << 29);
    r4_not_2 = ~(r4);
    r4_ca_2 = (xer >> 29) & 1u;
    r4 = (r4_not_2 + r0);
    r4 = (r4 + r4_ca_2);
...
loc_801A4FB4:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x801685FCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801A502C:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8016E848u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801A5058:
{
    r3 = MemoryInline::FlatRead32((r4 + 12560));
...
loc_801A5068:
{
    r9 = MemoryInline::FlatRead8(r27);
    r10 = 0x80340000u;
    r8 = MemoryInline::FlatRead8((r27 + 1));
    r10_stbu_ea_0 = (r10 + 29736);
    MemoryInline::FlatWriteRam8(r10_stbu_ea_0, static_cast<uint8_t>(r9));
    r10 = r10_stbu_ea_0;
    r7 = MemoryInline::FlatRead8((r27 + 2));
    r6 = MemoryInline::FlatRead8((r27 + 3));
    ...
    guest_range_1 = MemoryInline::ResolveRangeHost((r10 + 1), 0, 11u, false, true);
    MemoryInline::WriteResolved8(guest_range_1, 0u, (r10 + 1), static_cast<uint8_t>(r8));
    MemoryInline::WriteResolved8(guest_range_1, 1u, (r10 + 2), static_cast<uint8_t>(r7));
    MemoryInline::WriteResolved8(guest_range_1, 2u, (r10 + 3), static_cast<uint8_t>(r6));
    MemoryInline::WriteResolved8(guest_range_1, 3u, (r10 + 4), static_cast<uint8_t>(r5));
    MemoryInline::WriteResolved8(guest_range_1, 4u, (r10 + 5), static_cast<uint8_t>(r4));
    MemoryInline::WriteResolved8(guest_range_1, 5u, (r10 + 6), static_cast<uint8_t>(r3));
    MemoryInline::WriteResolved8(guest_range_1, 6u, (r10 + 7), static_cast<uint8_t>(r0));
    MemoryInline::WriteResolved32(guest_range_1, 7u, (r10 + 8), r29);
...
// RECOMP_REGISTRATION base 0x801A4EC4 func_801A4EC4 preserves=true fpr_mask=0x00000000
