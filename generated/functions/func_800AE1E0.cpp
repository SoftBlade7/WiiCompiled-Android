...
extern "C" void func_800AE1E0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800AE1E0:
{
    ...
    xer = ctx->xer;
    r3 = (r31 & 255);
    r5 = MemoryInline::FlatRead32((r30 + 304));
    r0 = (0 - r3);
    r4 = 0;
    r0 = (r0 | r3);
}
...
loc_800AE220:
{
    ...
    r0 = (r0_rot_0 & 1);
    MemoryInline::FlatWrite8((r30 + 234), static_cast<uint8_t>(r0));
...
loc_800AE22C:
{
    r0 = MemoryInline::FlatRead8((r5 + 54));
}
...
{
    r5 = MemoryInline::FlatRead32((r30 + 304));
    r3 = MemoryInline::FlatRead8((r5 + 53));
    r0 = (0 - r3);
    r0 = (r0 | r3);
...
loc_800AE260:
{
    MemoryInline::FlatWrite8((r5 + 53), static_cast<uint8_t>(r31));
    r4 = r31;
    r3 = MemoryInline::FlatRead32((r5 + 236));
...
// RECOMP_REGISTRATION base 0x800AE1E0 func_800AE1E0 preserves=true fpr_mask=0x00000000
