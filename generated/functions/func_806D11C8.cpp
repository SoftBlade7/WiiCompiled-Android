...
extern "C" void func_806D11C8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806D1224:
{
    MemoryInline::FlatWrite32((r29 + 212), r30);
    r31 = 0x808A0000u;
    r31 = (r31 + -588);
    r30 = 0;
...
// RECOMP_REGISTRATION base 0x806D11C8 func_806D11C8 preserves=true fpr_mask=0x00000000
