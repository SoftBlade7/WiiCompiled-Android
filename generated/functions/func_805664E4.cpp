...
extern "C" void func_805664E4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80566514:
{
    f30.d = MemoryInline::FlatReadFloat32((r3 + 28));
    if (((cr & 0x20000000u) != 0)) {
        goto loc_8056652C;
    }
}
...
// RECOMP_REGISTRATION base 0x805664E4 func_805664E4 preserves=false fpr_mask=0xC0000000
