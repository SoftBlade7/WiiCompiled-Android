...
extern "C" void func_800AC600(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800AC684:
{
    ...
    r5 = ctx->gpr[5];
    cr = ctx->cr;
    r12 = MemoryInline::FlatRead32((r30 + -268));
    r3 = (r30 + -276);
    r4 = -1;
...
// RECOMP_REGISTRATION base 0x800AC600 func_800AC600 preserves=true fpr_mask=0x00000000
