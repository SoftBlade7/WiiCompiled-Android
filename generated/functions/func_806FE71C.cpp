...
extern "C" void func_806FE71C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806FE71C:
{
    ...
    MemoryInline::FlatWrite8((r3 + 16), static_cast<uint8_t>(r22));
}
...
loc_806FE774:
{
    r3 = MemoryInline::FlatRead32((r23 + 10392));
    r4 = r21;
...
{
    r24_addic_src_3 = r24;
    r24 = (r24_addic_src_3 + -232);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r24_addic_src_3)) + static_cast<uint64_t>(static_cast<uint32_t>(-232)) + (static_cast<uint64_t>(static_cast<uint32_t>(0)) & 1u);
...
loc_806FE7D0:
{
    ...
    r4 = MemoryInline::FlatRead32((r29 + 9048));
...
{
    r21 = (r21 + 1);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r21), static_cast<uint32_t>(11));
}
...
loc_806FE814:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80211D94u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x806FE71C func_806FE71C preserves=true fpr_mask=0x00000000
