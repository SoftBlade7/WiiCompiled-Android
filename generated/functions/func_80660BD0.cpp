...
extern "C" void func_80660BD0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80660BF8:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite8((r27 + 4), static_cast<uint8_t>(r28));
    r26 = (r26 + 1);
...
// RECOMP_REGISTRATION base 0x80660BD0 func_80660BD0 preserves=true fpr_mask=0x00000000
