...
extern "C" void func_801F9C4C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801F9C80:
{
    ...
    r0 = (r5 + -1);
    r4 = 0;
    MemoryInline::FlatWrite8((r3 + 104), static_cast<uint8_t>(r6));
...
// RECOMP_REGISTRATION base 0x801F9C4C func_801F9C4C preserves=true fpr_mask=0x00000000
