...
extern "C" void func_807D3458(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r4 = 0x808A0000u;
    f31.d = MemoryInline::FlatReadFloat32((r4 + 28944));
    goto loc_807D34A8;
}
...
{
    r4 = 0x808A0000u;
    f31.d = MemoryInline::FlatReadFloat32((r4 + 26416));
}
...
loc_807D3624:
{
    ...
    f31.d = MemoryInline::FlatReadFloat64((r4 + 28960));
    r23 = 0;
    r24 = 0;
    r25 = 1127219200;
    goto loc_807D3788;
...
loc_807D3690:
{
    ...
    r6 = (r1 + 16);
    r4 = 0;
    MemoryInline::FlatWriteRam32((r1 + 264), r25);
    r5 = 0;
...
// RECOMP_REGISTRATION base 0x807D3458 func_807D3458 preserves=false fpr_mask=0x80000000
