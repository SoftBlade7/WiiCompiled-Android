...
extern "C" void func_801AEAE4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801AEAE4:
{
    ...
    r30 = PPC_Srw(static_cast<uint32_t>(r5), static_cast<uint32_t>(r3));
...
// RECOMP_REGISTRATION base 0x801AEAE4 func_801AEAE4 preserves=true fpr_mask=0x00000000
