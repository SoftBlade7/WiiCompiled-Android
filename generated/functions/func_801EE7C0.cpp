...
extern "C" void func_801EE7C0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801EE810:
{
    ...
    MemoryInline::WriteResolved32(guest_range_0, 64u, (r1 + 96), r29);
    r7 = (r1 + 128);
    r4 = 2;
    MemoryInline::WriteResolved32(guest_range_0, 32u, (r1 + 64), r30);
    r5 = 1;
    r6 = 2;
    MemoryInline::WriteResolved32(guest_range_0, 0u, (r1 + 32), r11);
...
// RECOMP_REGISTRATION base 0x801EE7C0 func_801EE7C0 preserves=true fpr_mask=0x00000000
