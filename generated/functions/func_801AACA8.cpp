...
extern "C" void func_801AACA8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801AACA8:
{
    ...
    r4 = 0x80000000u;
    r30 = r3;
    r31 = MemoryInline::FlatRead32((r4 + 228));
...
loc_801AACEC:
{
    ...
    r4 = r31;
    r3 = (r1 + 8);
    // inline leaf 0x801A0CF8 (2 guest instruction(s))
    MemoryInline::FlatWriteRam32((r3 + 4), r4);
    // end of inlined leaf 0x801A0CF8
    r4 = r31;
    r3 = (r1 + 8);
    // inline leaf 0x801A0D8C (2 guest instruction(s))
    MemoryInline::FlatWriteRam32((r3 + 40), r4);
...
// RECOMP_REGISTRATION base 0x801AACA8 func_801AACA8 preserves=true fpr_mask=0x00000000
