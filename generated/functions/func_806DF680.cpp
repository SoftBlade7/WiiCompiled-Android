...
extern "C" uint64_t func_8051201C_statefree(uint32_t, uint32_t, uint32_t, PPC_FPR);

extern "C" void func_806DF680(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806DF680:
{
    ...
    r27 = 0;
    r30 = 0x809C0000u;
    r29 = MemoryInline::FlatRead8((r3 + 38));
    r31 = 0x808C0000u;
    goto loc_806DF744;
}
...
loc_806DF6C0:
{
    ...
    f31.d = MemoryInline::FlatReadFloat32((r3 + 8));
    r4 = r27;
    r3 = MemoryInline::FlatRead32((r30 + 6392));
    // inline leaf 0x80590100 (4 guest instruction(s))
    r3 = MemoryInline::FlatRead32((r3 + 32));
    ...
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x8051201Cu) && KnownTranslatedCpuCall<0x8051201Cu>::kAvailable && !KnownTranslatedCpuCall<0x8051201Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x8051201Cu>()) {
        const auto state_free_result_8051201C_14BD = func_8051201C_statefree(r3, r4, r5, f3);
        f3.raw = static_cast<uint64_t>(state_free_result_8051201C_14BD);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
        ...
        ctx->fpr[31] = f31;
        ctx->cr = cr;
        InvokeDirectCpu<0x8051201Cu>(ctx);
        r0 = ctx->gpr[0];
        r1 = ctx->gpr[1];
        r3 = ctx->gpr[3];
        r4 = ctx->gpr[4];
    ...
    f0.d = MemoryInline::FlatReadFloat32((r31 + 26112));
...
// RECOMP_GUEST_ABI gpr_read=0xFC00002A gpr_write=0xFC00083B gpr_return=0x00000018 fpr_read=0x80000007 fpr_write=0x8000000F fpr_return=0x00000002 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x806DF680 func_806DF680 preserves=false fpr_mask=0x80000000
