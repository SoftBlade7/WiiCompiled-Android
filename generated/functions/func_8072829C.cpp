...
extern "C" void func_8072829C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807282DC:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r31 + 9352));
    ctx->lr = 0x807282ECu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_807282FC:
{
    r31 = 0x808D0000u;
    r3 = MemoryInline::FlatRead32((r30 + 192));
    f1.d = MemoryInline::FlatReadFloat32((r31 + -26048));
    ctx->lr = 0x8072830Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_8072831C:
{
    r31 = 0x808D0000u;
    r3 = MemoryInline::FlatRead32((r30 + 192));
    f1.d = MemoryInline::FlatReadFloat32((r31 + -26040));
    ctx->lr = 0x8072832Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8072829C func_8072829C preserves=true fpr_mask=0x00000000
