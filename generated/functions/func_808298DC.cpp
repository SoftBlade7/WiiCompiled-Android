...
extern "C" void func_808298DC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_808298DC:
{
    ...
    r29 = 0x808B0000u;
    f1.d = MemoryInline::FlatReadFloat32((r29 + -14536));
    ...
    r4 = 0x808D0000u;
    r30 = 1127219200;
    r0 = MemoryInline::FlatRead32((r4 + 31920));
    r3 = 0x808B0000u;
    MemoryInline::FlatWriteRam32((r1 + 8), r30);
    r0 = (r0 ^ -2147483648);
    f31.d = MemoryInline::FlatReadFloat64((r3 + -14528));
    MemoryInline::FlatWriteRam32((r1 + 12), r0);
    f29.d = MemoryInline::FlatReadFloat32((r29 + -14536));
...
loc_808299CC:
{
    ...
    r3 = MemoryInline::FlatRead32((r3 + 31920));
...
loc_80829A20:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead8((r31 + 188));
...
loc_80829A60:
{
    r0 = MemoryInline::FlatRead32((r30 + 31924));
...
// RECOMP_REGISTRATION base 0x808298DC func_808298DC preserves=false fpr_mask=0xE0000000
