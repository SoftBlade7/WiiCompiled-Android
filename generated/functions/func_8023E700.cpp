...
extern "C" void func_8023E700(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8023E700:
{
    f1.d = MemoryInline::FlatReadFloat32((r2 + -24444));
    r4 = (r13 + -23776);
    f0.d = MemoryInline::FlatReadFloat32((r2 + -24448));
    r3 = (r13 + -23768);
    MemoryInline::FlatWriteFloat32((r13 + -23776), f1.d);
    MemoryInline::FlatWriteFloat32((r4 + 4), f1.d);
    MemoryInline::FlatWriteFloat32((r13 + -23768), f0.d);
...
// RECOMP_REGISTRATION base 0x8023E700 func_8023E700 preserves=true fpr_mask=0x00000000
