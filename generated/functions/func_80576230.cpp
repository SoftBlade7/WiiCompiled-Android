...
extern "C" void func_80576230(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80576230:
{
    ...
    f3.d = MemoryInline::FlatReadFloat32((r3 + 124));
    r3 = (r1 + 8);
...
// RECOMP_GUEST_ABI gpr_read=0xF000003E gpr_write=0xF000007B gpr_return=0x00000018 fpr_read=0xC000001F fpr_write=0xC0003FFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80576230 func_80576230 preserves=false fpr_mask=0x80000000
