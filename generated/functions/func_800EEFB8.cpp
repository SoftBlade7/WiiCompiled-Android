...
extern "C" void func_800EEFB8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800EEFEC:
{
    ...
    r4 = 0;
    r5 = MemoryInline::FlatRead32((r29 + 8504));
    ctx->lr = 0x800EF00Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_800EF02C:
{
    r0 = MemoryInline::FlatRead32((r29 + 8504));
...
loc_800EF04C:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    // inline leaf 0x800ED690 (3 guest instruction(s))
    r3 = 0x802F0000u;
    r3 = (r3 + 8192);
    // end of inlined leaf 0x800ED690
    r28 = r3;
...
loc_800EF108:
{
    ...
    r27 = (r27 + 1);
    r3_addr_4 = (r3 + r26);
    MemoryInline::FlatWrite8(r3_addr_4, static_cast<uint8_t>(r31));
    goto loc_800EF150;
}
...
loc_800EF118:
{
    r0 = (r26 - r27);
    r28_addr_2 = (r28 + r0);
    r0 = MemoryInline::FlatRead8(r28_addr_2);
...
loc_800EF138:
{
    r3 = MemoryInline::FlatRead32((r30 + 8));
    r3_addr_6 = (r3 + r26);
    MemoryInline::FlatWrite8(r3_addr_6, static_cast<uint8_t>(r25));
    r4 = MemoryInline::FlatRead32((r30 + 12));
...
loc_800EF1A8:
{
    if ((static_cast<int32_t>(r25) > static_cast<int32_t>(-23000))) {
        goto loc_800EF1B4;
    }
}
...
loc_800EF1B0:
{
    if ((static_cast<int32_t>(r25) >= static_cast<int32_t>(-23999))) {
        goto loc_800EF1BC;
    }
}
...
loc_800EF1B8:
{
    if ((static_cast<int32_t>(r25) != static_cast<int32_t>(-20101))) {
        goto loc_800EF1D0;
    }
}
...
loc_800EF1D4:
{
    if ((static_cast<int32_t>(r25) > static_cast<int32_t>(-29000))) {
        goto loc_800EF1E0;
    }
}
...
loc_800EF1DC:
{
    if ((static_cast<int32_t>(r25) >= static_cast<int32_t>(-29999))) {
        goto loc_800EF1E8;
    }
}
...
loc_800EF1E4:
{
    if ((static_cast<int32_t>(r25) != static_cast<int32_t>(-20100))) {
        goto loc_800EF1FC;
    }
}
...
loc_800EF1FC:
{
    ...
    r3 = 18;
    r0 = (r4 + 19923);
    r0 = (static_cast<int32_t>((static_cast<int64_t>(static_cast<int32_t>(r0)) * static_cast<int64_t>(static_cast<int32_t>(r25))) >> 32));
    {
...
loc_800EF234:
{
    ...
    r4 = (r4 ^ -2147483648);
    r3_subfc_min_1 = r3;
    r3 = (r3_subfc_min_1 - r5);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(r3_subfc_min_1) >= static_cast<uint32_t>(r5) ? 1u : 0u) << 29);
    r4_not_1 = ~(r4);
    r4_ca_1 = (xer >> 29) & 1u;
    r4 = (r4_not_1 + r0);
    r4 = (r4 + r4_ca_1);
...
loc_800EF290:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800ECD80u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x800EEFB8 func_800EEFB8 preserves=true fpr_mask=0x00000000
