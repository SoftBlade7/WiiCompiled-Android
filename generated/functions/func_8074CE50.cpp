...
extern "C" void func_8074CE50(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8074CE50:
{
    ...
    r4 = 0x809C0000u;
    r3 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r4 + 11352));
    r7 = (r4 + 11352);
    guest_range_0 = MemoryInline::ResolveRangeHost((r31 + 32), 0, 44u, false, true);
    MemoryInline::WriteResolvedFloat32(guest_range_0, 0u, (r31 + 32), f0.d);
    r6 = 0x808A0000u;
    f2.d = MemoryInline::FlatReadFloat32((r3 + 11516));
    r5 = 0x808D0000u;
    f0.d = MemoryInline::FlatReadFloat32((r7 + 4));
    r3 = 0x809C0000u;
    MemoryInline::WriteResolvedFloat32(guest_range_0, 4u, (r31 + 36), f0.d);
    r4 = 538;
    f1.d = MemoryInline::FlatReadFloat32((r6 + 11528));
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 24u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f2.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f1.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 24u, (r31 + 56), f2.d);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 28u, (r31 + 60), f1.d);
    }
    MemoryInline::WriteResolvedFloat32(guest_range_0, 32u, (r31 + 64), f2.d);
    f0.d = MemoryInline::FlatReadFloat32((r5 + -17212));
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 36u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f2.d))))) {
        ...
        MemoryInline::WriteResolvedFloat32(guest_range_0, 40u, (r31 + 72), f2.d);
    }
...
// RECOMP_REGISTRATION base 0x8074CE50 func_8074CE50 preserves=true fpr_mask=0x00000000
