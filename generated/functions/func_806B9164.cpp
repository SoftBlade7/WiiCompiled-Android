...
extern "C" void func_806B9164(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_806B9164:
{
    ...
    r31 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r31 + -3576));
    r4 = 615;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    f0.d = MemoryInline::FlatReadFloat32((r31 + -3576));
    r3 = r26;
...
loc_806B91E0:
{
    r30 = MemoryInline::FlatRead32((r31 + 8656));
    r3 = r26;
...
loc_806B9214:
{
    ...
    r3 = r27;
    r4_addr_0 = (r4 + r0);
    MemoryInline::FlatWrite8(r4_addr_0, static_cast<uint8_t>(r31));
...
// RECOMP_REGISTRATION base 0x806B9164 func_806B9164 preserves=true fpr_mask=0x00000000
