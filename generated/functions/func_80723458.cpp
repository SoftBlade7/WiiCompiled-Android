...
extern "C" void func_80723458(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80723458:
{
    ...
    r31 = ctx->gpr[31];
    r0 = 0;
    MemoryInline::FlatWrite32((r31 + 484), r0);
    MemoryInline::FlatWrite32((r31 + 488), r0);
    MemoryInline::FlatWrite32((r31 + 492), r0);
    MemoryInline::FlatWrite32((r31 + 496), r0);
...
// RECOMP_REGISTRATION base 0x80723458 func_80723458 preserves=true fpr_mask=0x00000000
