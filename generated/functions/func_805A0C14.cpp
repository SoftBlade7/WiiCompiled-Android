...
extern "C" void func_805A0C14(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805A0C54:
{
    ...
    MemoryInline::FlatWrite8((r31 + 38), static_cast<uint8_t>(r4));
...
// RECOMP_REGISTRATION base 0x805A0C14 func_805A0C14 preserves=true fpr_mask=0x00000000
