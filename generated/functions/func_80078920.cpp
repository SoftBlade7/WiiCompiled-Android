...
extern "C" void func_80078920(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80078920:
{
    ...
    r3 = MemoryInline::FlatRead32((r13 + -32368));
    ctx->lr = 0x80078934u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80078920 func_80078920 preserves=true fpr_mask=0x00000000
