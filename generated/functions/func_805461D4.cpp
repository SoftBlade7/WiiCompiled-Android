...
extern "C" void func_805461D4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_805461E8:
{
    ...
    r0 = (r0_rot_0 & -2);
    r3 = (r3 + r0);
    MemoryInline::FlatWrite16((r3 + -27958), static_cast<uint16_t>(r6));
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[6] = r6;
    ctx->cr = cr;
...
// RECOMP_REGISTRATION base 0x805461D4 func_805461D4 preserves=true fpr_mask=0x00000000
