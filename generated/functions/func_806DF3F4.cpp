...
extern "C" void func_806DF3F4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806DF3F4:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r6 + 1344));
...
loc_806DF48C:
{
    ...
    r3 = 0x808A0000u;
    f1.d = std::fabs(f1.d);
    f0.d = MemoryInline::FlatReadFloat32((r3 + 1376));
...
// RECOMP_REGISTRATION base 0x806DF3F4 func_806DF3F4 preserves=true fpr_mask=0x00000000
