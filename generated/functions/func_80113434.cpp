...
extern "C" void func_80113434(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr1_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_80113554:
{
    MemoryInline::FlatWrite32((r21 + 44), r3);
    if (((cr & 0x20000000u) == 0)) {
        goto loc_8011356C;
    }
}
...
loc_8011356C:
{
    MemoryInline::FlatWrite32((r21 + 352), r26);
    r0 = (0 - r24);
    r0 = (r0 | r24);
    MemoryInline::FlatWrite32((r21 + 52), r28);
...
loc_80113580:
{
    MemoryInline::FlatWrite32((r21 + 64), r29);
    MemoryInline::FlatWrite32((r21 + 68), r30);
    MemoryInline::FlatWrite32((r21 + 72), r31);
    MemoryInline::FlatWrite32((r21 + 344), r27);
    MemoryInline::FlatWrite32((r21 + 264), r0);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_801135B0;
    }
}
...
loc_80113598:
{
    ...
    ctx->gpr[6] = r6;
    ctx->cr = cr;
    InvokeDirectCpu<0x80111778u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r7 = ctx->gpr[7];
    cr = ctx->cr;
...
// RECOMP_REGISTRATION base 0x80113434 func_80113434 preserves=true fpr_mask=0x00000000
