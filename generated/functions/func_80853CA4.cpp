...
extern "C" void func_80853CA4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80853CA4:
{
    ...
    r3 = 0x809C0000u;
    r4 = (r4 + 17720);
    MemoryInline::FlatWriteRam32((r3 + 17952), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x80853CA4 func_80853CA4 preserves=true fpr_mask=0x00000000
