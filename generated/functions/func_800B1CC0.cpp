...
extern "C" void func_800B1CC0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_800B1CF8:
{
    r31 = MemoryInline::FlatRead16((r30 + 24));
}
...
loc_800B1D24:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x801A64F4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x800B1CC0 func_800B1CC0 preserves=true fpr_mask=0x00000000
