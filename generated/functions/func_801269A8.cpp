...
extern "C" void func_801269A8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801269A8:
{
    r0 = 1;
    r3 = (r13 + -26344);
    MemoryInline::FlatWrite32((r13 + -26332), r0);
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x801269A8 func_801269A8 preserves=true fpr_mask=0x00000000
