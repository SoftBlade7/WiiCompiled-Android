...
extern "C" void func_806F7FCC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806F7FCC:
{
    ...
    r28 = 0x809C0000u;
    r27 = MemoryInline::FlatRead32((r28 + 8992));
...
{
    r29 = 0;
    MemoryInline::FlatWriteRam32((r28 + 8992), r29);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_806F8098;
    }
}
...
loc_806F8018:
{
    ...
    r26 = MemoryInline::FlatRead32((r28 + 8992));
...
loc_806F8054:
{
    ...
    r3 = MemoryInline::FlatRead32((r28 + 8992));
...
loc_806F8064:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x806F80ACu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x806F7FCC func_806F7FCC preserves=true fpr_mask=0x00000000
