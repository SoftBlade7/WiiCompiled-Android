...
extern "C" void func_8073BF24(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8073BF24:
{
    ...
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 32u, (r5 + 8));
    f3.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 16u, (r4 + 4));
    f4.d = static_cast<double>(PpcForceSingleValueInline(f1.d - f0.d));
    f2.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 28u, (r5 + 4));
    f1.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 12u, r4);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 24u, r5);
    f2.d = static_cast<double>(PpcForceSingleValueInline(f3.d - f2.d));
    MemoryInline::FlatWriteRamFloat32((r3 + 8), f4.d);
    f0.d = static_cast<double>(PpcForceSingleValueInline(f1.d - f0.d));
    MemoryInline::FlatWriteRamFloat32((r3 + 4), f2.d);
    ...
    f0.d = MemoryInline::FlatReadFloat32((r3 + 10168));
...
// RECOMP_GUEST_ABI gpr_read=0xC000001F gpr_write=0xC000007B gpr_return=0x00000018 fpr_read=0x0000005F fpr_write=0x0000007F fpr_return=0x00000002 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8073BF24 func_8073BF24 preserves=true fpr_mask=0x00000000
