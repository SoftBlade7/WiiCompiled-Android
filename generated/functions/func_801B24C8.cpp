...
extern "C" void func_801B24C8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801B24C8:
{
    ...
    ctx->gpr[5] = r5;
    ctx->cr = cr;
    InvokeDirectCpu<0x801B2234u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    cr = ctx->cr;
...
loc_801B2520:
{
    r31 = MemoryInline::FlatRead8(r30);
...
// RECOMP_REGISTRATION base 0x801B24C8 func_801B24C8 preserves=true fpr_mask=0x00000000
