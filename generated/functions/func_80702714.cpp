...
extern "C" void func_80702714(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80702744:
{
    ...
    MemoryInline::FlatWrite8((r29 + 10), static_cast<uint8_t>(r4));
    MemoryInline::FlatWrite8((r29 + 11), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x80702714 func_80702714 preserves=true fpr_mask=0x00000000
