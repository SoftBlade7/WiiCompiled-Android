...
extern "C" void func_80721D2C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80721D4C:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8071EA80u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r27 + 528));
    r0 = 0;
    MemoryInline::FlatWrite32((r27 + 520), r0);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(0));
}
...
{
    r31 = 0;
    MemoryInline::FlatWrite32((r27 + 528), r31);
    r30 = 0;
    r29 = 0;
}
...
// RECOMP_REGISTRATION base 0x80721D2C func_80721D2C preserves=true fpr_mask=0x00000000
