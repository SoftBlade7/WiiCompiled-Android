...
extern "C" void func_8060B82C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr1_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8060B8CC:
{
    guest_range_0 = MemoryInline::ResolveRangeHost(r27, 0, 32u, false, true);
    MemoryInline::WriteResolved32(guest_range_0, 0u, r27, r30);
    r4 = (r27 + 28);
    r3 = MemoryInline::FlatRead32((r21 + -10424));
    MemoryInline::WriteResolved32(guest_range_0, 4u, (r27 + 4), r31);
    r0 = MemoryInline::FlatRead16((r5 + -28276));
    MemoryInline::WriteResolved16(guest_range_0, 12u, (r27 + 12), static_cast<uint16_t>(r0));
    r0 = MemoryInline::FlatRead8((r5 + -28274));
    MemoryInline::WriteResolved8(guest_range_0, 14u, (r27 + 14), static_cast<uint8_t>(r0));
    r0 = MemoryInline::FlatRead16((r5 + -28272));
    MemoryInline::WriteResolved16(guest_range_0, 16u, (r27 + 16), static_cast<uint16_t>(r0));
    r0 = MemoryInline::FlatRead8((r5 + -28270));
    MemoryInline::WriteResolved8(guest_range_0, 18u, (r27 + 18), static_cast<uint8_t>(r0));
    r0 = MemoryInline::FlatRead32((r5 + -28264));
    MemoryInline::WriteResolved32(guest_range_0, 20u, (r27 + 20), r0);
    ...
    MemoryInline::WriteResolved8(guest_range_0, 24u, (r27 + 24), static_cast<uint8_t>(r0));
    MemoryInline::WriteResolved32(guest_range_0, 28u, (r27 + 28), r25);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
loc_8060BB1C:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 1348), 0, 52u, true, false);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r21 = MemoryInline::ReadResolved32(guest_range_1, 0u, (r1 + 1348));
            r22 = MemoryInline::ReadResolved32(guest_range_1, 4u, (r1 + 1352));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r23 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r1 + 1356));
            r24 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r1 + 1360));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r25 = MemoryInline::ReadResolved32(guest_range_1, 16u, (r1 + 1364));
            r26 = MemoryInline::ReadResolved32(guest_range_1, 20u, (r1 + 1368));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r27 = MemoryInline::ReadResolved32(guest_range_1, 24u, (r1 + 1372));
            r28 = MemoryInline::ReadResolved32(guest_range_1, 28u, (r1 + 1376));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r29 = MemoryInline::ReadResolved32(guest_range_1, 32u, (r1 + 1380));
            r30 = MemoryInline::ReadResolved32(guest_range_1, 36u, (r1 + 1384));
        }
    }
    r31 = MemoryInline::ReadResolved32(guest_range_1, 40u, (r1 + 1388));
    r0 = MemoryInline::ReadResolved32(guest_range_1, 48u, (r1 + 1396));
    ctx->lr = r0;
    r1 = (r1 + 1392);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x8060B82C func_8060B82C preserves=true fpr_mask=0x00000000
