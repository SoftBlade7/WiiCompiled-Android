...
extern "C" void func_807EBE40(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807EBE40:
{
    r3 = MemoryInline::FlatRead32((r3 + 396));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x807EBE40 func_807EBE40 preserves=true fpr_mask=0x00000000
