...
extern "C" void func_806DF774(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806DF774:
{
    ...
    r4 = (r1 + 12);
    r7 = 0;
    r0 = MemoryInline::FlatRead32((r5 + 1368));
    r5 = (r1 + 8);
...
// RECOMP_REGISTRATION base 0x806DF774 func_806DF774 preserves=true fpr_mask=0x00000000
