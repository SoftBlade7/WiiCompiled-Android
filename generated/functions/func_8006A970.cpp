...
extern "C" void func_8006A970(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8006A99C:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r2 + -29424));
    f0.d = MemoryInline::FlatReadFloat32((r31 + 212));
    MemoryInline::FlatWriteFloat32((r30 + 12), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r2 + -29416));
...
// RECOMP_GUEST_ABI gpr_read=0xC000001F gpr_write=0xC000000B gpr_return=0x00000008 fpr_read=0x00000007 fpr_write=0x00000007 fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8006A970 func_8006A970 preserves=true fpr_mask=0x00000000
