...
extern "C" void func_8005F420(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8005F420:
{
    ...
    r3 = MemoryInline::FlatRead16((r3 + 68));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8005F420 func_8005F420 preserves=true fpr_mask=0x00000000
