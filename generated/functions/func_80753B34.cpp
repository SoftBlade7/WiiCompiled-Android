...
extern "C" void func_80753B34(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80753B34:
{
    ...
    r6 = 0x808D0000u;
    r0 = 0;
    MemoryInline::FlatWrite32((r15 + 180), r0);
    r3 = (r3 + -16016);
    r6 = (r6 + -15780);
    ...
    r4 = 0x809C0000u;
    r3 = (r15 + 176);
    MemoryInline::FlatWrite32((r15 + 176), r6);
    r5 = 0;
    MemoryInline::FlatWrite32((r15 + 184), r0);
    r4 = MemoryInline::FlatRead32((r4 + -10456));
    r4 = MemoryInline::FlatRead8((r4 + 38));
    MemoryInline::FlatWrite32((r15 + 188), r4);
    r12 = MemoryInline::FlatRead32((r15 + 176));
...
loc_80753C0C:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32(r24, r27);
    r0 = 0;
    r4 = r17;
    MemoryInline::FlatWriteRam32((r24 + 176), r14);
    MemoryInline::FlatWriteRam32((r24 + 180), r0);
    r0 = 0;
    MemoryInline::FlatWriteRam32((r24 + 184), r0);
    MemoryInline::FlatWriteRam32((r24 + 188), r17);
    MemoryInline::FlatWriteRam32((r24 + 192), r18);
    r3 = MemoryInline::FlatRead32((r26 + 6392));
    // inline leaf 0x80590100 (4 guest instruction(s))
    r3 = MemoryInline::FlatRead32((r3 + 32));
    ...
    // end of inlined leaf 0x80590100
    MemoryInline::FlatWriteRam32((r24 + 204), r3);
    r3 = (r24 + 176);
    r5 = 0;
    r12 = MemoryInline::FlatRead32((r24 + 176));
    r4 = MemoryInline::FlatRead32((r31 + -16096));
    r12 = MemoryInline::FlatRead32((r12 + 12));
    ctr = r12;
    ctx->lr = 0x80753C64u;
    ctx->gpr[0] = r0;
...
loc_80753C84:
{
    ...
    r23 = MemoryInline::FlatRead32((r24 + 204));
    r29 = r3;
    r3 = r22;
    r4 = r16;
    r5 = (r25 + 69);
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32(r22, r30);
    r3 = r23;
    MemoryInline::FlatWriteRam32((r22 + 180), r29);
    MemoryInline::FlatWriteRam32((r22 + 184), r23);
...
loc_inl4_cont_80590E04:
{
    ...
    MemoryInline::FlatWriteRam32((r22 + 188), r3);
    MemoryInline::FlatWriteRam32((r22 + 192), r18);
}
...
loc_80753CD4:
{
    r0 = MemoryInline::FlatRead32((r24 + 180));
}
...
loc_80753D00:
{
    r4 = MemoryInline::FlatRead32((r24 + 184));
}
...
loc_80753D08:
{
    r3 = 0;
    r4_addr_3 = (r4 + r19);
    MemoryInline::FlatWrite32(r4_addr_3, r22);
    if ((static_cast<int32_t>(r21) < static_cast<int32_t>(0))) {
        goto loc_80753D24;
    }
}
...
loc_80753D40:
{
    r3 = MemoryInline::FlatRead32((r24 + 184));
    r3_addr_5 = (r3 + r19);
...
loc_80753D60:
{
    r0 = MemoryInline::FlatRead32((r31 + -16096));
...
loc_80753D78:
{
    r0 = MemoryInline::FlatRead32((r15 + 180));
}
...
loc_80753DA4:
{
    r4 = MemoryInline::FlatRead32((r15 + 184));
}
...
loc_80753DAC:
{
    r3 = 0;
    r4_addr_5 = (r4 + r20);
    MemoryInline::FlatWrite32(r4_addr_5, r24);
    if ((static_cast<int32_t>(r18) < static_cast<int32_t>(0))) {
        goto loc_80753DC8;
    }
}
...
loc_80753DE4:
{
    r3 = MemoryInline::FlatRead32((r15 + 184));
    r3_addr_7 = (r3 + r20);
...
// RECOMP_REGISTRATION base 0x80753B34 func_80753B34 preserves=true fpr_mask=0x00000000
