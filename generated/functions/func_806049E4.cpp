...
extern "C" void func_806049E4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80604A1C:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80604B00u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead32((r25 + 3048));
...
loc_80604A44:
{
    MemoryInline::FlatWrite32((r25 + 3048), r27);
}
...
// RECOMP_REGISTRATION base 0x806049E4 func_806049E4 preserves=true fpr_mask=0x00000000
