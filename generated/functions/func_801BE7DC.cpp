...
extern "C" void func_801BE7DC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_801BE7DC:
{
    ...
    r28 = 0;
    r0 = MemoryInline::FlatRead32((r29 + 2236));
...
loc_801BE814:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x801BDB24u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801BE860:
{
    r0 = MemoryInline::FlatRead8((r29 + 105));
...
loc_801BE87C:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x801BE6D0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801BE894:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r29 + 2292), r4);
    MemoryInline::FlatWrite32((r29 + 2288), r3);
    goto loc_801BE93C;
}
...
loc_801BE8B4:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r6 = MemoryInline::FlatRead32((r29 + 2292));
    r5 = 0x80000000u;
    ...
    r7 = MemoryInline::FlatRead32((r29 + 2288));
...
{
    r31_addr_1 = (r31 + r30);
    r29 = MemoryInline::FlatRead32(r31_addr_1);
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->xer = xer;
    InvokeDirectCpu<0x801A65ACu>(ctx);
    r3 = ctx->gpr[3];
    r26 = MemoryInline::FlatRead32((r29 + 2236));
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->xer = xer;
    InvokeDirectCpu<0x801A65D4u>(ctx);
...
{
    r0 = 1;
    MemoryInline::FlatWrite8((r29 + 2438), static_cast<uint8_t>(r0));
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->xer = xer;
    InvokeDirectCpu<0x801A65D4u>(ctx);
...
// RECOMP_REGISTRATION base 0x801BE7DC func_801BE7DC preserves=true fpr_mask=0x00000000
