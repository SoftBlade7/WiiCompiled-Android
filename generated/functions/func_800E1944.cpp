...
extern "C" void func_800E1944(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_ca_0 = 0;
    uint32_t r0_ca_1 = 0;
...
loc_800E197C:
{
    ...
    r4 = ctx->gpr[4];
    r6 = 0x80000000u;
    r8 = MemoryInline::FlatRead32((r27 + 1884));
    r0 = MemoryInline::FlatRead32((r6 + 248));
    r5 = 274857984;
    r6 = (r5 + 19923);
    r7 = MemoryInline::FlatRead32((r27 + 1880));
...
loc_800E19EC:
{
    r6 = MemoryInline::FlatRead32((r7 + 1908));
    r5 = MemoryInline::FlatRead32((r7 + 1904));
    r0 = (r6 - r4);
...
loc_800E1A08:
{
    ...
    r5 = 0;
    MemoryInline::FlatWrite32((r3 + 1640), r5);
    r3 = MemoryInline::FlatRead32((r13 + -26868));
...
loc_800E1A54:
{
    ...
    r0 = (r0 + r0_ca_6);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r0_not_6)) + static_cast<uint64_t>(static_cast<uint32_t>(r6)) + (static_cast<uint64_t>(static_cast<uint32_t>(r0_ca_6)) & 1u);
        xer = (xer & 0xDFFFFFFFu) | (static_cast<uint32_t>((ppcCarryWide >> 32) & 1u) << 29);
    }
    r0 = (0 - r0);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
...
loc_800E1A74:
{
    r5 = MemoryInline::FlatRead8((r7 + 1828));
    r4 = (r31 + 6944);
    r3 = 64;
    r0 = (r5 + 1);
    MemoryInline::FlatWrite8((r7 + 1828), static_cast<uint8_t>(r0));
    r5 = MemoryInline::FlatRead32((r13 + -26868));
    r5 = MemoryInline::FlatRead32((r5 + 1872));
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x800E1A98u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r13 + -26868));
    r3 = MemoryInline::FlatRead32((r3 + 1872));
    ctx->lr = 0x800E1AA4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_800E1B5C:
{
    ...
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r29), static_cast<int32_t>(18));
}
...
loc_800E1C2C:
{
    ...
    r3 = MemoryInline::FlatRead32((r5 + 1920));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_800E1C6C:
{
    r6 = MemoryInline::FlatRead16((r7 + 1834));
    r5 = (static_cast<int32_t>(r6) >> 31);
    r0 = (r6 - r4);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(r6) >= static_cast<uint32_t>(r4) ? 1u : 0u) << 29);
    r0_not_3 = ~(r3);
...
// RECOMP_REGISTRATION base 0x800E1944 func_800E1944 preserves=true fpr_mask=0x00000000
