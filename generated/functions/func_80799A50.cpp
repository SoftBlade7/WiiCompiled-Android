...
extern "C" void func_80799A50(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80799A7C:
{
    r0 = MemoryInline::FlatRead32((r31 + 13848));
    r3 = (r0 + r30);
    r3 = (r3 + 72);
    ctx->lr = 0x80799A8Cu;
    ctx->gpr[0] = r0;
...
{
    r0 = (r28 + -30);
    MemoryInline::FlatWrite32((r26 + 1068), r0);
...
// RECOMP_GUEST_ABI gpr_read=0xFC00006B gpr_write=0xFC00007B gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80799A50 func_80799A50 preserves=true fpr_mask=0x00000000
