...
extern "C" void func_805B3330(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805B3330:
{
    ...
    r3 = (r29 + 204);
    f30.d = MemoryInline::FlatReadFloat32((r29 + 324));
    ...
    ctx->fpr[30] = f30;
    ctx->fpr[31] = f31;
    InvokeDirectCpu<0x805B237Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
...
// RECOMP_REGISTRATION base 0x805B3330 func_805B3330 preserves=false fpr_mask=0xC0000000
