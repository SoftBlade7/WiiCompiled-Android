...
extern "C" void func_801888D4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80188960:
{
    r0 = MemoryInline::FlatRead8((r27 + 256));
...
// RECOMP_REGISTRATION base 0x801888D4 func_801888D4 preserves=true fpr_mask=0x00000000
