...
extern "C" void func_8016799C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8016799C:
{
    ...
    r31 = r3;
    r4 = MemoryInline::FlatRead32((r13 + -29432));
...
// RECOMP_REGISTRATION base 0x8016799C func_8016799C preserves=true fpr_mask=0x00000000
