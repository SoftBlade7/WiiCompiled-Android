...
extern "C" void func_80682958(CpuContext* MKW_RESTRICT ctx)
{
    goto loc_80682958;

loc_80682958:
{
    InvokeDirectCpu<0x806829E0u>(ctx);
    return;
}
...
// RECOMP_REGISTRATION base 0x80682958 func_80682958 preserves=true fpr_mask=0x00000000
