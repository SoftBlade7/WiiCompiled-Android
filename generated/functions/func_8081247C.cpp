...
extern "C" void func_8081247C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80812510:
{
    MemoryInline::FlatWrite32((r30 + 336), r3);
}
...
// RECOMP_REGISTRATION base 0x8081247C func_8081247C preserves=true fpr_mask=0x00000000
