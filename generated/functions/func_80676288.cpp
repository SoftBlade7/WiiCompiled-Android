...
extern "C" void func_80676288(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r3 = r31;
    // inline leaf 0x8020FCC4 (4 guest instruction(s))
    r0 = r3;
    r3 = MemoryInline::FlatRead32((r13 + -24184));
    MemoryInline::FlatWrite32((r13 + -24184), r0);
    // end of inlined leaf 0x8020FCC4
}
...
// RECOMP_REGISTRATION base 0x80676288 func_80676288 preserves=true fpr_mask=0x00000000
