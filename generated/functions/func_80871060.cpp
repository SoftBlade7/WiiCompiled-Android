...
extern "C" void func_80871060(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80871094:
{
    r0 = MemoryInline::FlatRead32((r24 + 472));
    r25_addr_2 = (r25 + r0);
...
loc_808710F4:
{
    ...
    r4 = (r4 + 8);
    r7_addr_3 = (r7 + r9);
    guest_range_1 = MemoryInline::ResolveRangeHost(r7_addr_3, 0, 32u, true, false);
    r9 = MemoryInline::ReadResolved32(guest_range_1, 0u, r7_addr_3);
    r7 = r7_addr_3;
    r9 = MemoryInline::FlatRead16((r9 + 820));
    r10 = MemoryInline::ReadResolved32(guest_range_1, 4u, (r7 + 4));
    r9_rot_3 = PpcRotl32Inline(static_cast<uint32_t>(r9), static_cast<uint32_t>(27));
    r9 = (r9_rot_3 & 1);
    r22 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r7 + 8));
    r11 = (r0 | r9);
    r10 = MemoryInline::FlatRead16((r10 + 820));
    r0 = (0 - r11);
    r9 = MemoryInline::FlatRead16((r22 + 820));
    r11 = (r0 | r11);
    r12 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r7 + 12));
    ...
    r10 = (0 - r11);
    r12 = MemoryInline::ReadResolved32(guest_range_1, 16u, (r7 + 16));
    r10 = (r10 | r11);
    ...
    r12 = (r10 | r9);
    r22 = MemoryInline::ReadResolved32(guest_range_1, 20u, (r7 + 20));
    r9 = (0 - r12);
    r0_rot_3 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(27));
    r0 = (r0_rot_3 & 1);
    r9 = (r9 | r12);
    r10 = MemoryInline::FlatRead16((r22 + 820));
    r9_rot_5 = PpcRotl32Inline(static_cast<uint32_t>(r9), static_cast<uint32_t>(1));
    r9 = (r9_rot_5 & 1);
    r22 = MemoryInline::ReadResolved32(guest_range_1, 24u, (r7 + 24));
    r23 = (r9 | r0);
    r7 = MemoryInline::ReadResolved32(guest_range_1, 28u, (r7 + 28));
    r12 = (0 - r23);
...
loc_80871280:
{
    r3 = MemoryInline::FlatRead32((r24 + 472));
    r3_addr_2 = (r3 + r25);
...
loc_80871454:
{
    r0 = MemoryInline::FlatRead32((r24 + 468));
...
{
    r0 = 1;
    MemoryInline::FlatWrite8((r24 + 389), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x80871060 func_80871060 preserves=true fpr_mask=0x00000000
