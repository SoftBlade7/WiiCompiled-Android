...
extern "C" void func_801AFAD8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
    uint32_t r3_rot_1 = 0;
...
loc_801AFAD8:
{
    ...
    r3 = MemoryInline::ReadResolved32(guest_range_0, 0u, r5);
    r3_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(11));
    r3 = (r3_rot_2 & 1);
    r3 = (0 - r3);
    r6_mrot_1 = (r3 & 1024);
    r6_mdest_1 = (r6 & -1025);
    ...
    MemoryInline::WriteResolved16(guest_range_1, 0u, r4, static_cast<uint16_t>(r6));
    r3 = MemoryInline::ReadResolved32(guest_range_0, 0u, r5);
    r3_rot_3 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(12));
    r3 = (r3_rot_3 & 1);
    r3 = (0 - r3);
    r6_mrot_2 = (r3 & 2048);
    r6_mdest_2 = (r6 & -2049);
    ...
    MemoryInline::WriteResolved16(guest_range_1, 0u, r4, static_cast<uint16_t>(r6));
    r3 = MemoryInline::ReadResolved32(guest_range_0, 0u, r5);
    r3_rot_4 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(7));
    r3 = (r3_rot_4 & 1);
    r3 = (0 - r3);
    r6_mrot_3 = (r3 & 4096);
    r6_mdest_3 = (r6 & -4097);
...
// RECOMP_REGISTRATION base 0x801AFAD8 func_801AFAD8 preserves=true fpr_mask=0x00000000
