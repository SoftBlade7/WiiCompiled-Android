...
extern "C" void func_800FEC20(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800FEC7C:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r5 = MemoryInline::FlatRead32((r29 + 408));
    r3 = r28;
    r4 = (r29 + 528);
    ctx->lr = 0x800FECACu;
    ctx->gpr[0] = r0;
...
loc_800FED58:
{
    r6 = MemoryInline::FlatRead32((r29 + 1488));
    r4 = 0x80100000u;
    r3 = r28;
    r5 = r31;
    r0 = (r6 + -1);
    r4 = (r4 + -5164);
    MemoryInline::FlatWrite32((r29 + 1488), r0);
    ctx->lr = 0x800FED78u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_800FEE20:
{
    ...
    r3 = MemoryInline::FlatRead32((r1 + 8));
    r3 = MemoryInline::FlatRead32((r3 + 12));
    MemoryInline::FlatWrite32((r3 + 56), r31);
}
...
// RECOMP_REGISTRATION base 0x800FEC20 func_800FEC20 preserves=true fpr_mask=0x00000000
