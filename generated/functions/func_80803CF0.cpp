...
extern "C" void func_80803CF0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80803CF0:
{
    r3 = MemoryInline::FlatRead16((r3 + 260));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80803CF0 func_80803CF0 preserves=true fpr_mask=0x00000000
