...
extern "C" void func_8011CA4C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8011CAA0:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r12 = MemoryInline::FlatRead32((r28 + 68));
    r3 = r28;
    r5 = r29;
    r6 = MemoryInline::FlatRead32((r28 + 72));
    r4 = 3;
    ctr = r12;
    ctx->lr = 0x8011CAE0u;
    ctx->gpr[0] = r0;
...
loc_8011CB30:
{
    ...
    r0 = (r0_rot_3 & -4);
    r27_addr_3 = (r27 + r0);
    r4 = MemoryInline::FlatRead32(r27_addr_3);
    ctx->lr = 0x8011CB48u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_8011CB98:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8011D8A4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8011CBC4:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8011D6B0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8011CA4C func_8011CA4C preserves=true fpr_mask=0x00000000
