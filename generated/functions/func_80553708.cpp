...
extern "C" void func_80553708(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8055370C:
{
    if ((static_cast<int32_t>(r25) < static_cast<int32_t>(r29))) {
        goto loc_80553718;
    }
}
...
loc_8055373C:
{
    ...
    r4_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(26));
    r4 = (r4_rot_1 & 67108863);
    r0 = (static_cast<uint32_t>((static_cast<uint64_t>(r28) * static_cast<uint64_t>(r4)) >> 32));
    r3 = (r31 * r4);
    r0 = (r0 + r3);
    r4 = (r28 * r4);
    r3 = (r0 + r23);
...
loc_805536D8:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x805536D8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80553708 func_80553708 preserves=true fpr_mask=0x00000000
