...
extern "C" void func_8066588C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8066588C:
{
    ...
    r4 = (r1 + 8);
    MemoryInline::FlatWrite32((r30 + 2764), r0);
    r3 = MemoryInline::FlatRead32((r31 + 8516));
    ctx->lr = 0x806658E0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctx->gpr[30] = r30;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x8066CA64u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r30 = ctx->gpr[30];
    r31 = ctx->gpr[31];
    MemoryInline::FlatWrite32((r30 + 2960), r3);
    r3 = (r30 + 656);
    r5 = (r30 + 2608);
    r4 = 6602;
    ctx->lr = 0x806658F4u;
...
// RECOMP_REGISTRATION base 0x8066588C func_8066588C preserves=true fpr_mask=0x00000000
