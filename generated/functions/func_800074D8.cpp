...
extern "C" void func_800074D8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800074D8:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8000AB88u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8000750C:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r30 + 3184), r3);
    r4 = r3;
    r3 = r22;
    ctx->lr = 0x80007560u;
    ctx->gpr[0] = r0;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80218BA4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r26 = MemoryInline::FlatRead32((r30 + 3184));
    r0 = (r26 & 31);
...
loc_80007580:
{
    MemoryInline::FlatWrite32((r30 + 3188), r26);
    r3 = (r30 + 3188);
    ctx->lr = 0x8000758Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead32((r30 + 3188));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_80007598:
{
    ...
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r30 + 48));
    r4 = MemoryInline::FlatRead32((r30 + 3184));
    r12 = MemoryInline::FlatRead32(r3);
    r12 = MemoryInline::FlatRead32((r12 + 24));
    ctr = r12;
    ctx->lr = 0x800075C8u;
    ...
    xer = ctx->xer;
    r21 = (r21 + 1);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r21), static_cast<int32_t>(100));
}
...
loc_80007610:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8004C4E0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80007678:
{
    r26 = MemoryInline::FlatRead16((r3 + 30));
    if (((cr & 0x20000000u) == 0)) {
        goto loc_8000769C;
    }
}
...
loc_800076A4:
{
    r27 = MemoryInline::FlatRead16((r3 + 28));
    if (((cr & 0x20000000u) == 0)) {
        goto loc_800076C8;
    }
}
...
loc_80007718:
{
    ...
    xer = ctx->xer;
    r4 = 0x80000000u;
    MemoryInline::FlatWrite32((r30 + 3192), r3);
    r4 = (r4 + 29860);
    r5 = 0;
    r6 = 0;
    ctx->lr = 0x80007744u;
    ...
    r4 = 0;
    r0 = 1;
    MemoryInline::FlatWrite32((r30 + 3264), r4);
    MemoryInline::FlatWrite32((r30 + 3268), r4);
    MemoryInline::FlatWrite32((r30 + 3272), r4);
    MemoryInline::FlatWrite8((r30 + 3276), static_cast<uint8_t>(r4));
    MemoryInline::FlatWrite8((r30 + 3197), static_cast<uint8_t>(r0));
    r3 = MemoryInline::FlatRead32((r13 + -27648));
...
loc_80007770:
{
    MemoryInline::FlatWrite8((r30 + 3197), static_cast<uint8_t>(r4));
}

loc_80007774:
{
    r0 = 255;
    MemoryInline::FlatWrite16((r30 + 3278), static_cast<uint16_t>(r0));
    MemoryInline::FlatWrite16((r30 + 3280), static_cast<uint16_t>(r0));
    MemoryInline::FlatWrite16((r30 + 3282), static_cast<uint16_t>(r0));
    MemoryInline::FlatWrite16((r30 + 3284), static_cast<uint16_t>(r0));
    ctx->lr = 0x8000778Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x801E5824u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x800074D8 func_800074D8 preserves=true fpr_mask=0x00000000
