...
extern "C" void func_8081E658(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8081E658:
{
    ...
    MemoryInline::WriteResolved32(guest_range_0, 20u, (r1 + 20), r6);
    r4_addr_0 = (r4 + r0);
...
// RECOMP_REGISTRATION base 0x8081E658 func_8081E658 preserves=true fpr_mask=0x00000000
