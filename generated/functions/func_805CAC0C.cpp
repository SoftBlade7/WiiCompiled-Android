...
extern "C" void func_805CAC0C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805CAC0C:
{
    ...
    r31 = 0x80890000u;
    r4 = 1;
    f1.d = MemoryInline::FlatReadFloat32((r31 + 14456));
    ctx->lr = 0x805CAC44u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x805CAC0C func_805CAC0C preserves=true fpr_mask=0x00000000
