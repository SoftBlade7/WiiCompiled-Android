...
extern "C" void func_8080DED0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8080DED0:
{
    ...
    r3 = 0x808D0000u;
    f2.d = MemoryInline::FlatReadFloat32((r29 + 104));
    r3 = (r3 + 24208);
    f0.d = MemoryInline::FlatReadFloat32((r29 + 112));
    r0 = 1;
    MemoryInline::FlatWrite32(r30, r3);
    r3 = 0x809C0000u;
    MemoryInline::FlatWriteFloat32((r30 + 172), f2.d);
...
loc_8080DF54:
{
    ...
    MemoryInline::FlatWriteRam8((r3 + 17160), static_cast<uint8_t>(r0));
    if (((cr & 0x20000000u) == 0)) {
        goto loc_8080E004;
    }
}
...
loc_8080DF74:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8075EDCCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8080DFB0:
{
    MemoryInline::FlatWriteRam32((r29 + 260), r3);
}

loc_8080DFB4:
{
    MemoryInline::FlatWrite32((r30 + 268), r29);
    r0 = MemoryInline::FlatRead16((r29 + 44));
    f0.d = MemoryInline::FlatReadFloat32((r31 + 24));
    r0 = (r0 | 1);
    MemoryInline::FlatWriteRam16((r29 + 44), static_cast<uint16_t>(r0));
    MemoryInline::FlatWriteRamFloat32((r29 + 52), f0.d);
...
loc_8080E004:
{
    r3 = MemoryInline::FlatRead16((r5 + 44));
    r3 = (r3 << 16);
    r3 = (static_cast<int32_t>(r3) >> 16);
    r0 = 1127219200;
    MemoryInline::FlatWriteRam32((r1 + 8), r0);
    r3 = (r3 ^ -2147483648);
    f1.d = MemoryInline::FlatReadFloat64((r29 + 88));
    ...
    f0.d = static_cast<double>(PpcForceSingleValueInline(f0.d - f1.d));
    MemoryInline::FlatWriteRamFloat32((r31 + 40), f0.d);
}
...
// RECOMP_REGISTRATION base 0x8080DED0 func_8080DED0 preserves=true fpr_mask=0x00000000
