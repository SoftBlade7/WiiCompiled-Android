...
extern "C" void func_807E9F5C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807E9F94:
{
    MemoryInline::FlatWrite8((r21 + 504), static_cast<uint8_t>(r26));
    r3 = (r27 + 152);
    r4 = 0;
    ...
    f1.d = MemoryInline::FlatReadFloat32((r23 + -28032));
    r4 = 0;
    ctx->lr = 0x807E9FB0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_807E9FF4:
{
    r3 = MemoryInline::FlatRead32((r22 + 100));
...
loc_807EA02C:
{
    ...
    r4 = (r0 * 240);
    r0 = MemoryInline::FlatRead32((r22 + 372));
    r3 = (r3 + r4);
...
loc_807EA04C:
{
    r21 = MemoryInline::FlatRead32((r3 + 3108));
    r3 = r21;
...
loc_807EA060:
{
    r5 = MemoryInline::FlatRead32((r29 + 7736));
    r3 = r25;
    r4 = (r28 + 200);
    r6 = (r23 & 255);
    ...
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_34EB = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_34EB[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_34EB[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_807EA140:
{
    ...
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_56BD = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_56BD[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_56BD[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_807EA174:
{
    MemoryInline::FlatWrite8((r26 + 504), static_cast<uint8_t>(r30));
    r3 = (r25 + 152);
    r4 = 0;
    // inline leaf 0x8063C820 (4 guest instruction(s))
    r0 = (r4 * 68);
    ...
    r3 = (r3 + r0);
    // end of inlined leaf 0x8063C820
    f1.d = MemoryInline::FlatReadFloat32((r31 + -28032));
    r4 = 0;
    ctx->lr = 0x807EA190u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    r0 = (r5 - r0);
    r21_rot_3 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(1));
    r21 = (r21_rot_3 & 1);
    // inline leaf 0x8063C820 (4 guest instruction(s))
    r0 = (r4 * 68);
    r3 = MemoryInline::FlatRead32(r3);
...
// RECOMP_REGISTRATION base 0x807E9F5C func_807E9F5C preserves=true fpr_mask=0x00000000
