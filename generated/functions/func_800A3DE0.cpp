...
extern "C" void func_800A3DE0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800A3DE0:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r31 = MemoryInline::FlatRead32((r30 + 4));
...
loc_800A3E28:
{
    r3 = r31;
    r4 = r30;
    // inline leaf 0x80098010 (3 guest instruction(s))
    r0 = 0;
    MemoryInline::FlatWrite32((r3 + 4), r0);
    // end of inlined leaf 0x80098010
    r3 = r30;
    r4 = r31;
    // inline leaf 0x8008F440 (3 guest instruction(s))
    r0 = 0;
    MemoryInline::FlatWrite32((r3 + 4), r0);
    // end of inlined leaf 0x8008F440
    r0 = (r29 + 28);
...
// RECOMP_REGISTRATION base 0x800A3DE0 func_800A3DE0 preserves=true fpr_mask=0x00000000
