...
extern "C" void func_80130DB8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80130DD8:
{
    ...
    r4 = 0x80330000u;
    r4 = (r4 + 9440);
    r3 = MemoryInline::FlatRead8((r4 + 72));
    r0 = (r3 + -1);
    MemoryInline::FlatWriteRam8((r4 + 72), static_cast<uint8_t>(r0));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
loc_80130E1C:
{
    ...
    r5 = 0;
    r6 = (r29 + r0);
    r8 = MemoryInline::FlatRead16((r29 + 2));
    r9 = (r6 + 8);
    r7 = 0;
    r6 = 0;
    ctx->lr = 0x80130E5Cu;
...
loc_80130E74:
{
    ...
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
    r3 = MemoryInline::FlatRead8((r31 + 72));
    r0 = (r3 + 1);
    MemoryInline::FlatWriteRam8((r31 + 72), static_cast<uint8_t>(r0));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
// RECOMP_REGISTRATION base 0x80130DB8 func_80130DB8 preserves=true fpr_mask=0x00000000
