...
extern "C" void func_80047750(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80047954:
{
    ...
    f2.d = MemoryInline::ReadResolvedFloat64(guest_range_0, 24u, (r2 + -29944));
    f1.d = MemoryInline::FlatReadFloat64((r1 + 224));
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 4u, (r2 + -29964));
...
loc_80047980:
{
    ...
    f1.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 4u, (r2 + -29964));
...
loc_80047A2C:
{
    ...
    f2.d = MemoryInline::ReadResolvedFloat64(guest_range_0, 32u, (r2 + -29936));
    r3 = (static_cast<int32_t>(static_cast<int8_t>(r0)));
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 8u, (r2 + -29960));
    r0 = (100 - r3);
...
// RECOMP_REGISTRATION base 0x80047750 func_80047750 preserves=false fpr_mask=0xF8000000
