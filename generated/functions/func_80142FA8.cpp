...
extern "C" void func_80142FA8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80142FA8:
{
    ...
    r0 = (r3 + r0);
    r28 = (r0 & 65535);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r28), static_cast<uint32_t>(3075));
}
...
loc_80142FF4:
{
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r28), static_cast<uint32_t>(3125));
}
...
loc_80143018:
{
    ...
    r0 = (r3 + r0);
    r6 = (r0 & 65535);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r6), static_cast<uint32_t>(r28));
}
...
// RECOMP_REGISTRATION base 0x80142FA8 func_80142FA8 preserves=true fpr_mask=0x00000000
