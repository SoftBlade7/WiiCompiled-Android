...
extern "C" void func_80520B18(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80520B18:
{
    ...
    r30 = r27;
    r28 = 0;
    MemoryInline::FlatWrite8((r3 + 81), static_cast<uint8_t>(r5));
...
loc_80520B44:
{
    ...
    r28 = (r28 + 1);
    r5 = MemoryInline::FlatRead32((r31 + 148));
    r0 = (r27 + r29);
    r3 = (r4 * r3);
...
// RECOMP_REGISTRATION base 0x80520B18 func_80520B18 preserves=true fpr_mask=0x00000000
