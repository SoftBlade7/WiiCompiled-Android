...
extern "C" void func_8005F3F0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8005F3F0:
{
    ...
    r3 = MemoryInline::FlatRead16((r3 + 62));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8005F3F0 func_8005F3F0 preserves=true fpr_mask=0x00000000
