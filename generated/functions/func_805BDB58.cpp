...
extern "C" void func_805BDB58(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805BDB58:
{
    ...
    r31 = 0x80890000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r31 + 11812));
    ctx->lr = 0x805BDB8Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r31 = ctx->gpr[31];
    f1 = ctx->fpr[1];
    r4 = MemoryInline::FlatRead32((r30 + 592));
    r3 = r30;
    r5 = -1;
    ctx->lr = 0x805BDBB4u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x805BDB58 func_805BDB58 preserves=true fpr_mask=0x00000000
