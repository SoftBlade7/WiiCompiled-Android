...
extern "C" void func_8001E820(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8001E820:
{
    ...
    r30 = MemoryInline::FlatRead8((r3 + 24));
...
{
    r3 = r30;
    // inline leaf 0x8001F5B0 (2 guest instruction(s))
    MemoryInline::FlatWrite8((r13 + -27496), static_cast<uint8_t>(r3));
    // end of inlined leaf 0x8001F5B0
}
...
// RECOMP_REGISTRATION base 0x8001E820 func_8001E820 preserves=true fpr_mask=0x00000000
