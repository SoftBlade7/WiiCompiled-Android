...
extern "C" void func_800895D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
{
    r3 = 0x802D0000u;
    r0 = MemoryInline::FlatRead32((r3 + 22320));
}
...
loc_800896B8:
{
    ...
    r24 = (r24 + 22320);
    r23 = (r24 + r29);
    r0 = MemoryInline::FlatRead8((r23 + 240));
}
...
loc_80089704:
{
    r3 = MemoryInline::FlatRead8((r23 + 240));
    r24 = (r1 + 8);
    r25 = 0;
    r0 = (r3 + -1);
    MemoryInline::FlatWrite8((r23 + 240), static_cast<uint8_t>(r0));
    goto loc_80089734;
}
...
loc_8008989C:
{
    r28 = MemoryInline::FlatRead32((r23 + 184));
    r27 = (r23 + 184);
    r23 = 0x802D0000u;
    r24 = 0x80090000u;
    r25 = 0x802D0000u;
...
loc_800898C4:
{
    ...
    MemoryInline::FlatWrite32((r13 + -27476), r5);
    // end of inlined leaf 0x80021338
    MemoryInline::FlatWrite8((r13 + -27232), static_cast<uint8_t>(r26));
}
...
loc_800898E0:
{
    ...
    r6 = 384;
    f1.d = MemoryInline::FlatReadFloat32((r2 + -28804));
    r7 = 0;
    r8 = MemoryInline::FlatRead32((r23 + 22320));
    ctr = r12;
    ctx->lr = 0x8008990Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x800895D0 func_800895D0 preserves=true fpr_mask=0x00000000
