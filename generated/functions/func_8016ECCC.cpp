...
extern "C" void func_8016ECCC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8016ECCC:
{
    ...
    r30 = r4;
    r0 = MemoryInline::FlatRead32((r13 + -25632));
...
loc_8016ECF0:
{
    r31 = MemoryInline::FlatRead16((r3 + 14));
    if (((cr & 0x20000000u) != 0)) {
        goto loc_8016ED28;
    }
}
...
loc_8016ECF8:
{
    ...
    r12 = MemoryInline::FlatRead32((r13 + -25632));
    r3 = r31;
    ctr = r12;
    ctx->lr = 0x8016ED18u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x8016ECCC func_8016ECCC preserves=true fpr_mask=0x00000000
