...
extern "C" void func_8084AFF4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8084B048:
{
    r6_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r28), static_cast<uint32_t>(1));
    r6 = (r6_rot_0 & 1);
    r4 = (r28 & 1);
    r0 = (r6 + r28);
...
loc_8084B0B0:
{
    r0 = 1;
    r8 = 0;
    r7 = PPC_Slw(static_cast<uint32_t>(r0), static_cast<uint32_t>(r30));
    r9 = 0;
    ctx->lr = 0x8084B0C4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x8084AFF4 func_8084AFF4 preserves=true fpr_mask=0x00000000
