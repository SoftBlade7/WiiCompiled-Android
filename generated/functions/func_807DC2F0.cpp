...
extern "C" void func_807DC2F0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807DC2F0:
{
    ...
    r5 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r5 + 30248));
    f31.d = f3.d;
    ...
    MemoryInline::WriteResolvedFloat32(guest_range_0, 20u, (r1 + 20), f1.d);
...
// RECOMP_REGISTRATION base 0x807DC2F0 func_807DC2F0 preserves=false fpr_mask=0x80000000
