...
extern "C" void func_807691F8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807691F8:
{
    ...
    r5 = (r1 + 20);
    f1.d = MemoryInline::FlatReadFloat32((r6 + 15464));
    ...
    ctx->fpr[0] = f0;
    ctx->fpr[1] = f1;
    InvokeDirectCpu<0x80769280u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x807691F8 func_807691F8 preserves=true fpr_mask=0x00000000
