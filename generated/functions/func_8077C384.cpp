...
extern "C" void func_8077C384(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8077C384:
{
    ...
    r27 = 0x808A0000u;
    r28 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r27 + 17504));
    r31 = r3;
    f2.d = MemoryInline::FlatReadFloat32((r28 + 17524));
    r4 = 0;
    ...
    r0 = (r0 ^ -2147483648);
    f1.d = MemoryInline::FlatReadFloat64((r29 + 17528));
...
// RECOMP_REGISTRATION base 0x8077C384 func_8077C384 preserves=true fpr_mask=0x00000000
