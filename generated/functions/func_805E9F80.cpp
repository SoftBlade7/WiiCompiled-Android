...
extern "C" void func_805E9F80(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805E9F80:
{
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 84u, ((static_cast<uint64_t>(static_cast<uint32_t>(r21)) << 32) | static_cast<uint32_t>(r22)))) {
        MemoryInline::WriteResolved32(guest_range_1, 84u, (r1 + 84), r21);
        MemoryInline::WriteResolved32(guest_range_1, 88u, (r1 + 88), r22);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 92u, ((static_cast<uint64_t>(static_cast<uint32_t>(r23)) << 32) | static_cast<uint32_t>(r24)))) {
        MemoryInline::WriteResolved32(guest_range_1, 92u, (r1 + 92), r23);
        MemoryInline::WriteResolved32(guest_range_1, 96u, (r1 + 96), r24);
    }
    ...
    r27 = r4;
    r28 = r5;
    r21 = MemoryInline::FlatRead32(r3);
    goto loc_805E9FE8;
}
...
loc_805E9FE4:
{
    r21 = MemoryInline::FlatRead32((r21 + 172));
}
...
loc_805EA004:
{
    ...
    r4 = 0;
    MemoryInline::FlatWriteRam32((r31 + 36), r4);
    r3 = 0x808C0000u;
    r0 = 8;
    r3 = (r3 + -27464);
...
loc_805EA070:
{
    ...
    r29 = MemoryInline::FlatRead32((r3 + 1000));
    r30 = MemoryInline::FlatRead32(r29);
    goto loc_805EA0A4;
}
...
loc_805EA0A0:
{
    r30 = MemoryInline::FlatRead32((r30 + 944));
}
...
loc_805EA0C0:
{
    ...
    r4 = 0x80080000u;
    r3 = (r3 + -27320);
    MemoryInline::FlatWriteRam32((r30 + 28), r3);
    r23 = 0;
    r5 = 0x805F0000u;
    MemoryInline::FlatWriteRam32((r30 + 32), r23);
    r3 = (r30 + 40);
    r4 = (r4 + 16160);
    r5 = (r5 + -23720);
    MemoryInline::FlatWriteRam16((r30 + 36), static_cast<uint16_t>(r23));
    r6 = 140;
    r7 = 6;
    ctx->lr = 0x805EA0FCu;
    ctx->gpr[0] = r0;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r30 + 944), r23);
}
...
loc_805EA168:
{
    MemoryInline::FlatWriteRam16((r30 + 36), static_cast<uint16_t>(r0));
    if (((cr & 0x20000000u) != 0)) {
        goto loc_805EA174;
    }
}
...
loc_805EA1A8:
{
    r5 = MemoryInline::FlatRead32((r24 + 7160));
    r3 = r21;
    r23_addr_2 = (r23 + r25);
    r4 = MemoryInline::FlatRead32(r23_addr_2);
    r5_addr_2 = (r5 + r25);
...
loc_805EA1DC:
{
    ...
    MemoryInline::FlatWriteRam32((r30 + 944), r0);
    MemoryInline::FlatWrite32(r29, r30);
}

loc_805EA1E8:
{
    MemoryInline::FlatWriteRam32((r31 + 36), r30);
    r4 = r27;
    r3 = (r31 + 40);
    r5 = 64;
    ctx->gpr[0] = r0;
...
loc_805EA278:
{
    guest_range_2 = MemoryInline::ResolveRangeHost((r1 + 84), 0, 52u, true, false);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r21 = MemoryInline::ReadResolved32(guest_range_2, 0u, (r1 + 84));
            r22 = MemoryInline::ReadResolved32(guest_range_2, 4u, (r1 + 88));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r23 = MemoryInline::ReadResolved32(guest_range_2, 8u, (r1 + 92));
            r24 = MemoryInline::ReadResolved32(guest_range_2, 12u, (r1 + 96));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r25 = MemoryInline::ReadResolved32(guest_range_2, 16u, (r1 + 100));
            r26 = MemoryInline::ReadResolved32(guest_range_2, 20u, (r1 + 104));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r27 = MemoryInline::ReadResolved32(guest_range_2, 24u, (r1 + 108));
            r28 = MemoryInline::ReadResolved32(guest_range_2, 28u, (r1 + 112));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r29 = MemoryInline::ReadResolved32(guest_range_2, 32u, (r1 + 116));
            r30 = MemoryInline::ReadResolved32(guest_range_2, 36u, (r1 + 120));
        }
    }
    r31 = MemoryInline::ReadResolved32(guest_range_2, 40u, (r1 + 124));
    r0 = MemoryInline::ReadResolved32(guest_range_2, 48u, (r1 + 132));
    ctx->lr = r0;
    r1 = (r1 + 128);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x805E9F80 func_805E9F80 preserves=true fpr_mask=0x00000000
