...
extern "C" void func_8053B63C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8053B68C:
{
    r0 = MemoryInline::FlatRead8((r30 + 262));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
// RECOMP_REGISTRATION base 0x8053B63C func_8053B63C preserves=true fpr_mask=0x00000000
