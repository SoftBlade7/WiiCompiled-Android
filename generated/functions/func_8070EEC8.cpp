...
extern "C" void func_8070EEC8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8070EF30:
{
    ...
    r29 = MemoryInline::FlatRead32((r4 + 10220));
...
loc_8070EF4C:
{
    ...
    r28 = MemoryInline::FlatRead32((r4 + 10220));
...
// RECOMP_REGISTRATION base 0x8070EEC8 func_8070EEC8 preserves=true fpr_mask=0x00000000
