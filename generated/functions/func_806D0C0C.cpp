...
extern "C" void func_806D0C0C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_806D0C0C:
{
    ...
    r29 = r3;
    r3 = (r1 + 20);
    f1.d = MemoryInline::FlatReadFloat32((r5 + 19380));
    ...
    f1.d = MemoryInline::FlatReadFloat32((r31 + -632));
...
// RECOMP_REGISTRATION base 0x806D0C0C func_806D0C0C preserves=true fpr_mask=0x00000000
