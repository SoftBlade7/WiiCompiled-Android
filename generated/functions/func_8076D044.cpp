...
extern "C" void func_8076D044(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8076D044:
{
    ...
    r3 = r26;
    MemoryInline::FlatWrite32((r26 + 176), r5);
    MemoryInline::FlatWrite32((r26 + 180), r0);
    MemoryInline::FlatWrite32((r26 + 184), r0);
    MemoryInline::FlatWrite32((r26 + 188), r4);
    MemoryInline::FlatWrite32((r26 + 192), r0);
    MemoryInline::FlatWrite32((r26 + 196), r0);
...
loc_8076D0E8:
{
    ...
    r3 = 124;
    MemoryInline::FlatWriteRam8((r25 + 242), static_cast<uint8_t>(r0));
    ctx->lr = 0x8076D10Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_8076D128:
{
    MemoryInline::FlatWriteRam32((r25 + 248), r3);
}

loc_8076D12C:
{
    MemoryInline::FlatWrite32((r26 + 200), r25);
    r3 = r25;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r12 = MemoryInline::FlatRead32((r26 + 188));
    r3 = (r26 + 188);
...
loc_8076D1BC:
{
    MemoryInline::FlatWriteRam32((r29 + 184), r3);
}
...
loc_8076D264:
{
    r12 = MemoryInline::FlatRead32((r26 + 176));
    r3 = (r26 + 176);
    r5 = 0;
    r12 = MemoryInline::FlatRead32((r12 + 12));
    ctr = r12;
...
loc_8076D2D4:
{
    MemoryInline::FlatWriteRam32((r25 + 216), r3);
}
...
loc_8076D318:
{
    r3 = 0;
    r4_addr_4 = (r4 + r29);
    MemoryInline::FlatWrite32(r4_addr_4, r25);
    if ((static_cast<int32_t>(r28) < static_cast<int32_t>(0))) {
        goto loc_8076D334;
    }
}
...
loc_8076D350:
{
    r3 = MemoryInline::FlatRead32((r26 + 184));
    r3_addr_4 = (r3 + r29);
...
loc_8076D3EC:
{
    r25 = MemoryInline::FlatRead32((r26 + 184));
    r3 = 0;
    if ((static_cast<int32_t>(r28) < static_cast<int32_t>(0))) {
        goto loc_8076D408;
    }
...
loc_8076D424:
{
    ...
    r4_addr_6 = (r4 + r29);
    r0 = MemoryInline::FlatRead32(r4_addr_6);
    r29 = (r29 + 4);
...
// RECOMP_REGISTRATION base 0x8076D044 func_8076D044 preserves=true fpr_mask=0x00000000
