...
extern "C" void func_8058ED28(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8058ED4C:
{
    // inline leaf 0x8081E0CC (6 guest instruction(s))
    r4 = 0x808D0000u;
    r0 = 0;
    r4 = (r4 + 28072);
    MemoryInline::FlatWriteRam32(r3, r4);
    MemoryInline::FlatWriteRam32((r3 + 8), r0);
    // end of inlined leaf 0x8081E0CC
}
...
// RECOMP_REGISTRATION base 0x8058ED28 func_8058ED28 preserves=true fpr_mask=0x00000000
