...
extern "C" void func_805463F8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r3_rot_0 = 0;
...
extern "C" MKW_PPC_NO_INLINE uint64_t func_805463F8_statefree(uint32_t native_r3, uint32_t native_r4, uint32_t native_r5)
{
...
loc_805463F8:
{
    ...
    r3_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(cached_r0), static_cast<uint32_t>(22));
...
// RECOMP_STATE_FREE_ABI address=0x805463F8 symbol=func_805463F8_statefree gpr_in=0x00000038 gpr_out=0x00000008 fpr_in=0x00000000 fpr_out=0x00000000 cr_in=0x00 cr_out=0x00 gqr_in=0x00 hid_in=0x00 hid_out=0x00 xer_in=0 ctr_in=0 lr_in=0
...
// RECOMP_REGISTRATION base 0x805463F8 func_805463F8 preserves=true fpr_mask=0x00000000
