...
extern "C" void func_8064AEE4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8064AEE4:
{
    ...
    r3 = 0x809C0000u;
    r4 = (r4 + 7440);
    MemoryInline::FlatWriteRam32((r3 + 7912), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x8064AEE4 func_8064AEE4 preserves=true fpr_mask=0x00000000
