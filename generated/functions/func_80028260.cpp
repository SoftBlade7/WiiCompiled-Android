...
extern "C" void func_80028260(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80028260:
{
    ...
    r31 = r4;
    r29 = r5;
    guest_range_0 = MemoryInline::ResolveRangeHost((r3 + 12), 0, 206u, false, true);
    MemoryInline::WriteResolved32(guest_range_0, 4u, (r3 + 16), r26);
    r28 = r3;
    r30 = r6;
    r4 = r29;
    MemoryInline::WriteResolved32(guest_range_0, 0u, (r3 + 12), r27);
    r5 = r31;
    MemoryInline::WriteResolved32(guest_range_0, 180u, (r3 + 192), r26);
    MemoryInline::WriteResolved16(guest_range_0, 188u, (r3 + 200), static_cast<uint16_t>(r26));
    MemoryInline::WriteResolved32(guest_range_0, 184u, (r3 + 196), r26);
    MemoryInline::WriteResolved32(guest_range_0, 192u, (r3 + 204), r26);
    MemoryInline::WriteResolved16(guest_range_0, 200u, (r3 + 212), static_cast<uint16_t>(r26));
    MemoryInline::WriteResolved32(guest_range_0, 196u, (r3 + 208), r26);
    MemoryInline::WriteResolved16(guest_range_0, 204u, (r3 + 216), static_cast<uint16_t>(r26));
    ctx->lr = 0x800282BCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r28 + 188), r31);
...
loc_80028314:
{
    r6 = MemoryInline::FlatRead32((r28 + 188));
    r4 = r31;
    r3 = (r28 + 192);
...
loc_inl1_cont_800AEF80:
{
    ...
    r3 = MemoryInline::FlatRead16((r28 + 216));
    r0 = (r3 + 1);
    MemoryInline::FlatWrite16((r28 + 216), static_cast<uint16_t>(r0));
    MemoryInline::FlatWrite32((r31 + 12), r27);
    MemoryInline::FlatWrite32((r31 + 40), r26);
...
loc_80028374:
{
    ...
    MemoryInline::FlatWrite8((r31 + 139), static_cast<uint8_t>(r0));
    r0 = MemoryInline::FlatRead32((r29 + 8));
    r0 = (r0 & 1024);
...
loc_80028394:
{
    MemoryInline::FlatWrite8((r31 + 140), static_cast<uint8_t>(r30));
    r5 = r31;
...
// RECOMP_REGISTRATION base 0x80028260 func_80028260 preserves=true fpr_mask=0x00000000
