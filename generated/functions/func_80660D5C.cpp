...
extern "C" void func_80660D5C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_80660D5C:
{
    r5 = MemoryInline::FlatRead32((r3 + 1000));
...
// RECOMP_REGISTRATION base 0x80660D5C func_80660D5C preserves=true fpr_mask=0x00000000
