...
extern "C" void func_80218384(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_80218384:
{
    ...
    r3_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r31), static_cast<uint32_t>(1));
    r3 = (r3_rot_0 & 1);
    f29.d = MemoryInline::FlatReadFloat64((r2 + -25752));
    r0_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r30), static_cast<uint32_t>(1));
    r0 = (r0_rot_0 & 1);
    f0.d = MemoryInline::FlatReadFloat64((r1 + 32));
    r3 = (r3 + r31);
    f2.d = MemoryInline::FlatReadFloat32((r2 + -25764));
    r26 = (static_cast<int32_t>(r3) >> 1);
    f1.d = static_cast<double>(PpcForceSingleValueInline(f0.d - f29.d));
    r0 = (r0 + r30);
    f0.d = MemoryInline::FlatReadFloat32((r2 + -25744));
    {
    ...
    f31.d = MemoryInline::FlatReadFloat32((r2 + -25768));
    r24 = 0;
    f1.d = PpcFmulsInline(f2.d, f1.d);
    f28.d = PpcFmulsInline(f1.d, f0.d);
    f30.d = PpcFmulsInline(f28.d, f28.d);
    goto loc_802184FC;
}
...
loc_80218480:
{
    f1.d = static_cast<double>(PpcForceSingleValueInline(f30.d - f27.d));
...
loc_802184A8:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80228F18u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
...
// RECOMP_GUEST_ABI gpr_read=0xFF801F7F gpr_write=0xFF801FFB gpr_return=0x00000018 fpr_read=0xF800007F fpr_write=0xF800007F fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x80218384 func_80218384 preserves=false fpr_mask=0xF8000000
