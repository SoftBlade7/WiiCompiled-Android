...
extern "C" void func_8077A6D4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8077A718:
{
    r5 = 0x808A0000u;
    r4 = 583;
    f1.d = MemoryInline::FlatReadFloat32((r5 + 17312));
    ctx->lr = 0x8077A728u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8077A6D4 func_8077A6D4 preserves=true fpr_mask=0x00000000
