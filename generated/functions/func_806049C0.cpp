...
extern "C" void func_806049C0(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = 1;
    MemoryInline::FlatWrite32((r3 + 3048), r0);
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x806049C0 func_806049C0 preserves=true fpr_mask=0x00000000
