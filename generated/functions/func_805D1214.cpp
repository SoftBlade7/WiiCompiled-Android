...
extern "C" void func_805D1214(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_805D1214:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r27 + 28), r3);
...
loc_805D1280:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    f1.d = MemoryInline::FlatReadFloat32((r31 + 16448));
    r4 = 1;
...
// RECOMP_REGISTRATION base 0x805D1214 func_805D1214 preserves=true fpr_mask=0x00000000
