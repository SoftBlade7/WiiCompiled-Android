...
extern "C" void func_80542694(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80542694:
{
    ...
    r28 = r3;
    r30 = MemoryInline::FlatRead32((r3 + 1556));
    r3 = 3;
    ...
    MemoryInline::FlatWrite8((r28 + 1548), static_cast<uint8_t>(r31));
...
// RECOMP_REGISTRATION base 0x80542694 func_80542694 preserves=true fpr_mask=0x00000000
