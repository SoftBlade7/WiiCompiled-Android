...
extern "C" void func_80569FB0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80569FF8:
{
    ...
    r30 = MemoryInline::FlatRead32((r4 + 52));
...
// RECOMP_REGISTRATION base 0x80569FB0 func_80569FB0 preserves=true fpr_mask=0x00000000
