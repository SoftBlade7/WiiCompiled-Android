...
extern "C" void func_801B3BA4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801B3BA4:
{
    r3 = MemoryInline::FlatRead32((r13 + -25096));
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x801B3BA4 func_801B3BA4 preserves=true fpr_mask=0x00000000
