...
extern "C" void func_8070714C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8070714C:
{
    r3 = (r3 + -84);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80705404u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8070714C func_8070714C preserves=true fpr_mask=0x00000000
