...
extern "C" void func_8076C85C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8076C85C:
{
    ...
    MemoryInline::FlatWrite32((r30 + 176), r5);
...
loc_8076C8BC:
{
    MemoryInline::FlatWrite32((r30 + 188), r4);
    r3 = (r30 + 176);
    r5 = 0;
...
// RECOMP_REGISTRATION base 0x8076C85C func_8076C85C preserves=true fpr_mask=0x00000000
