...
extern "C" void func_80765A54(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80765A54:
{
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 44u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f2.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f1.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 44u, (r1 + 44), f2.d);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 48u, (r1 + 48), f1.d);
    }
...
loc_80765AD0:
{
    r4 = MemoryInline::FlatRead32((r28 + 364));
    r3 = r29;
    r5 = (r1 + 56);
...
// RECOMP_REGISTRATION base 0x80765A54 func_80765A54 preserves=true fpr_mask=0x00000000
