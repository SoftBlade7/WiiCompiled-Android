...
extern "C" void func_80751144(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8075117C:
{
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWrite8((r31 + 412), static_cast<uint8_t>(r0));
}
...
loc_807511B8:
{
    ...
    r3 = 0x808A0000u;
    r4 = 0x808A0000u;
    f2.d = MemoryInline::FlatReadFloat32((r3 + 12856));
    r0_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(2));
    r0 = (r0_rot_1 & -4);
    f1.d = MemoryInline::FlatReadFloat32((r4 + 12848));
    r3 = (r31 + r0);
    r4 = 0;
...
// RECOMP_REGISTRATION base 0x80751144 func_80751144 preserves=true fpr_mask=0x00000000
