...
extern "C" void func_80133884(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801338A8:
{
    ...
    MemoryInline::FlatWriteRam8((r3 + 8), static_cast<uint8_t>(r0));
    ctx->lr = 0x801338BCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80133884 func_80133884 preserves=true fpr_mask=0x00000000
