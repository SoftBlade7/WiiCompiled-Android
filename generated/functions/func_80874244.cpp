...
extern "C" void func_80874244(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_ca_0 = 0;
    uint32_t r0_ca_1 = 0;
...
loc_80874268:
{
    ...
    r5 = -1;
    r4_addr_0 = (r4 + r0);
    MemoryInline::FlatWrite32(r4_addr_0, r7);
...
// RECOMP_GUEST_ABI gpr_read=0x00000058 gpr_write=0x000000F1 gpr_return=0x00000010 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x80874244 func_80874244 preserves=true fpr_mask=0x00000000
