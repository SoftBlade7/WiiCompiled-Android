...
extern "C" void func_801EF81C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r0 = (r28 + 1);
    r28 = (static_cast<int32_t>(static_cast<int16_t>(r0)));
}
...
// RECOMP_REGISTRATION base 0x801EF81C func_801EF81C preserves=true fpr_mask=0x00000000
