...
extern "C" void func_8009CF50(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_inl1_cont_8019AC68:
{
    ...
    f2.d = MemoryInline::FlatReadFloat32((r2 + -28216));
    f0.d = PpcFmulsInline(f0.d, f1.d);
    MemoryInline::FlatWriteRamFloat32((r1 + 24), f2.d);
    f1.d = static_cast<double>(PpcForceSingleValueInline(f3.d / f30.d));
...
// RECOMP_GUEST_ABI gpr_read=0xE00003FF gpr_write=0xE00003FB gpr_return=0x00000018 fpr_read=0xC0003FFF fpr_write=0xC0003FFF fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x8009CF50 func_8009CF50 preserves=false fpr_mask=0xC0000000
