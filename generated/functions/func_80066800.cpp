...
extern "C" void func_80066800(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lfsx_80066984_loc_0 = 0;
    uint32_t cr0_0 = 0;
...
loc_80066800:
{
    ...
    r4 = (r4 + r30);
    MemoryInline::WriteResolvedFloat32(guest_range_1, 20u, (r1 + 20), f0.d);
    f1.d = MemoryInline::FlatReadFloat32((r4 + 4));
    f0.d = MemoryInline::FlatReadFloat32((r4 + 20));
    f2.d = MemoryInline::FlatReadFloat32((r4 + 36));
...
loc_800668BC:
{
    PpcSetPairedFprInline(f0, PPC_Fres(PPC_PsFromScalarInline(f30.d)));
    r31 = (r1 + 20);
    ...
    PpcSetPairedFprInline(f0, PPC_PsNmsubInline(PPC_PsFromScalarInline(f30.d), f0.d, f1.d));
...
loc_8006691C:
{
    ...
    PpcSetPairedFprInline(f2, PPC_PsqLStackInline<0u, 0u>(ctx, r3));
    r3 = (r1 + 8);
    PpcSetPairedFprInline(f0, PPC_PsMuls0Inline(f0.d, PPC_PsFromScalarInline(f30.d)));
    PpcSetPairedFprInline(f2, PPC_PsMuls0Inline(f2.d, PPC_PsFromScalarInline(f30.d)));
...
{
    r3 = (r28 + r30);
    addr_lfsx_80066984_loc_0 = (r28 + r30);
    f1.d = MemoryInline::FlatReadFloat32(addr_lfsx_80066984_loc_0);
...
loc_80066A08:
{
    ...
    // psq_load w=0 quant=0 (using PPC_PsqL)
    PpcSetPairedFprInline(f1, PPC_PsqLStackInline<0u, 0u>(ctx, r4));
    PpcSetPairedFprInline(f3, PPC_PsMuls0Inline(f3.d, PPC_PsFromScalarInline(f31.d)));
...
// RECOMP_GUEST_ABI gpr_read=0xF800013E gpr_write=0xF800083B gpr_return=0x00000018 fpr_read=0xE000001F fpr_write=0xE00007FF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80066800 func_80066800 preserves=true fpr_mask=0x00000000
