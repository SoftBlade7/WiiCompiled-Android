...
extern "C" void func_805E646C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805E646C:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_4AE = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_4AE[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_4AE[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    r31 = 0x80890000u;
    MemoryInline::FlatWriteRam32((r1 + 80), r30);
    r31 = (r31 + 21384);
    r3 = (r29 + 456);
    r4 = (r31 + 454);
    r6 = (r1 + 8);
...
// RECOMP_REGISTRATION base 0x805E646C func_805E646C preserves=true fpr_mask=0x00000000
