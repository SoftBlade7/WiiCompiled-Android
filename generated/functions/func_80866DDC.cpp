...
extern "C" void func_80866DDC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80866DDC:
{
    ...
    r0 = MemoryInline::FlatRead32((r3 + 18232));
...
{
    r3 = 0x809C0000u;
    MemoryInline::FlatWriteRam32((r3 + 18232), r31);
}
...
// RECOMP_REGISTRATION base 0x80866DDC func_80866DDC preserves=true fpr_mask=0x00000000
