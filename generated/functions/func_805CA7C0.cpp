...
extern "C" void func_805CA7C0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805CA7F8:
{
    ...
    r3 = 0x80890000u;
    f3.d = MemoryInline::FlatReadFloat64((r3 + 14472));
    r5 = 0x80890000u;
    ...
    f0.d = MemoryInline::FlatReadFloat32((r5 + 14464));
...
// RECOMP_REGISTRATION base 0x805CA7C0 func_805CA7C0 preserves=true fpr_mask=0x00000000
