...
extern "C" void func_8055B1F8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8055B21C:
{
    ...
    // inline leaf 0x8055CD30 (6 guest instruction(s))
    r0 = 65536;
    r5 = MemoryInline::FlatRead32((r3 + 4));
    r0 = PPC_Slw(static_cast<uint32_t>(r0), static_cast<uint32_t>(r4));
    r0 = (r5 | r0);
    MemoryInline::FlatWrite32((r3 + 4), r0);
    // end of inlined leaf 0x8055CD30
    r31 = (r31 + 1);
...
// RECOMP_REGISTRATION base 0x8055B1F8 func_8055B1F8 preserves=true fpr_mask=0x00000000
