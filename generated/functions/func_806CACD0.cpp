...
extern "C" void func_806CACD0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lfsx_80537B88_loc_0 = 0;
    uint32_t addr_lfsx_806CAD78_loc_0 = 0;
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
    uint32_t r0_rot_2 = 0;
...
loc_806CACD0:
{
    ...
    MemoryInline::WriteResolvedFloat64(guest_range_0, 192u, (r1 + 192), f28.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_3 = (r1 + 200);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_3, PPC_PsFromScalarInline(f28.d));
    MemoryInline::WriteResolvedFloat64(guest_range_0, 176u, (r1 + 176), f27.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_4 = (r1 + 184);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_4, PPC_PsFromScalarInline(f27.d));
    MemoryInline::WriteResolvedFloat64(guest_range_0, 160u, (r1 + 160), f26.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_5 = (r1 + 168);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_5, PPC_PsFromScalarInline(f26.d));
    MemoryInline::WriteResolvedFloat64(guest_range_0, 144u, (r1 + 144), f25.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_6 = (r1 + 152);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_6, PPC_PsFromScalarInline(f25.d));
    MemoryInline::WriteResolvedFloat64(guest_range_0, 128u, (r1 + 128), f24.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_7 = (r1 + 136);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_7, PPC_PsFromScalarInline(f24.d));
    MemoryInline::WriteResolvedFloat64(guest_range_0, 112u, (r1 + 112), f23.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_8 = (r1 + 120);
    ...
    r30 = (r30 + -1560);
    f29.d = f2.d;
    f25.d = MemoryInline::FlatReadFloat32((r30 + 68));
    f30.d = f3.d;
    f31.d = MemoryInline::FlatReadFloat64((r30 + 80));
    f0.d = PpcFmulsInline(f25.d, f1.d);
    f26.d = MemoryInline::FlatReadFloat32((r30 + 72));
    r25 = r3;
    r26 = r4;
    r27 = 1;
    r28 = 4;
...
loc_806CAD6C:
{
    MemoryInline::FlatWriteRam32((r1 + 76), r26);
    r3 = MemoryInline::FlatRead32((r25 + 244));
    MemoryInline::FlatWriteRam32((r1 + 72), r31);
    addr_lfsx_806CAD78_loc_0 = (r3 + r28);
    f0.d = MemoryInline::FlatReadFloat32(addr_lfsx_806CAD78_loc_0);
    ...
    f1.d = PpcFmulsInline(f26.d, f24.d);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ...
    f4 = ctx->fpr[4];
    cr = ctx->cr;
    r3 = MemoryInline::FlatRead32((r25 + 224));
    f23.d = PpcFmulsInline(f28.d, f1.d);
    r3_addr_2 = (r3 + r28);
...
loc_806CAE10:
{
    r4 = MemoryInline::FlatRead32((r25 + 224));
    r3 = (r1 + 8);
    r5 = (r1 + 56);
    r4_addr_2 = (r4 + r28);
    ...
    r3 = MemoryInline::FlatRead32((r25 + 228));
    r4 = (r27 & 255);
    r5 = (r1 + 8);
    ctx->lr = 0x806CAE38u;
    ctx->gpr[0] = r0;
...
loc_806CAE68:
{
    r0 = MemoryInline::FlatRead8((r25 + 208));
...
loc_806CAE74:
{
    ...
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 84), 0, 180u, true, false);
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 156u, (r1 + 240));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f30.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 140u, (r1 + 224));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f29.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 124u, (r1 + 208));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f28.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 108u, (r1 + 192));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f27.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 92u, (r1 + 176));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f26.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 76u, (r1 + 160));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f25.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 60u, (r1 + 144));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f24.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 44u, (r1 + 128));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r11 = (r1 + 112);
    f23.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 28u, (r1 + 112));
    ...
    r0 = MemoryInline::ReadResolved32(guest_range_1, 176u, (r1 + 260));
    ctx->lr = r0;
    r1 = (r1 + 256);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x806CACD0 func_806CACD0 preserves=false fpr_mask=0xFF800000
