...
extern "C" void func_807C21F4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807C221C:
{
    f1.d = MemoryInline::FlatReadFloat32((r9 + 24));
    r8 = (r1 + 8);
    f2.d = MemoryInline::FlatReadFloat32(r9);
    r7 = (r1 + 20);
...
loc_807C2238:
{
    ...
    r10 = (r10 * 12);
    PpcSetPairedFprInline(f0, PPC_PsSubInline(f5.d, f4.d));
    ...
    // psq_load w=1 quant=0 (using PPC_PsqL)
    PpcSetPairedFprInline(f0, PPC_PsqLGqrInline<1u, 0u>(ctx, mkw_gqr0, r10));
    PpcSetPairedFprInline(f6, PPC_PsMulInline(f6.d, f5.d));
    PpcSetPairedFprInline(f5, PPC_PsMaddInline(f4.d, f0.d, f6.d));
    PpcSetPairedFprInline(f0, PPC_PsSum0Inline(f5.d, f6.d, f6.d));
...
loc_807C22E0:
{
    ...
    f0.d = static_cast<double>(PpcForceSingleValueInline(PPC_PsToScalarInline(f5.d) - f0.d));
...
loc_807C2318:
{
    ...
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r8_psq_tmp_2 = (r8 + 4);
    PpcSetPairedFprInline(f0, PPC_PsqLStackInline<0u, 0u>(ctx, r8_psq_tmp_2));
    MemoryInline::FlatWriteRam32((r1 + 8), r11);
    PpcSetPairedFprInline(f5, PPC_PsMulInline(f5.d, f0.d));
    // psq_load w=1 quant=0 (using PPC_PsqL)
    PpcSetPairedFprInline(f0, PPC_PsqLStackInline<1u, 0u>(ctx, r8));
    PpcSetPairedFprInline(f0, PPC_PsMaddInline(f4.d, f0.d, f5.d));
    PpcSetPairedFprInline(f0, PPC_PsSum0Inline(f0.d, f5.d, f5.d));
    f4.d = static_cast<double>(PpcForceSingleValueInline(f3.d - PPC_PsToScalarInline(f0.d)));
...
// RECOMP_REGISTRATION base 0x807C21F4 func_807C21F4 preserves=true fpr_mask=0x00000000
