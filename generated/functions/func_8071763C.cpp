...
extern "C" void func_8071763C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8071763C:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x802135D0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x802137C8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    xer = ctx->xer;
    r3 = 0x80380000u;
    r0 = MemoryInline::FlatRead8((r28 + 2212));
    r3 = MemoryInline::FlatRead32((r3 + 24512));
    r29 = MemoryInline::FlatRead8((r3 + 81));
}
...
loc_807176A8:
{
    ...
    xer = ctx->xer;
    r30 = (r30 + 1);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r30), static_cast<uint32_t>(11));
}
...
loc_807176D0:
{
    MemoryInline::FlatWrite8((r28 + 2212), static_cast<uint8_t>(r29));
    r3 = 0x809C0000u;
    r3 = MemoryInline::FlatRead32((r3 + -10504));
}
...
loc_807176F8:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8070F3E8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8071763C func_8071763C preserves=true fpr_mask=0x00000000
