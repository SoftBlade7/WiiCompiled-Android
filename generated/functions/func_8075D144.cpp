...
extern "C" void func_8075D144(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8075D144:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8075CC58u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8075D178:
{
    r0 = MemoryInline::FlatRead8((r30 + 376));
...
loc_8075D184:
{
    r0 = MemoryInline::FlatRead8((r30 + 384));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_8075D190:
{
    r29 = MemoryInline::FlatRead32((r30 + 176));
    r0 = 4;
...
// RECOMP_REGISTRATION base 0x8075D144 func_8075D144 preserves=true fpr_mask=0x00000000
