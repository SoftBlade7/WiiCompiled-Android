...
extern "C" void func_8070EEB8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8070EEB8:
{
    r3 = (r3 + -136);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x8070EB30u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8070EEB8 func_8070EEB8 preserves=true fpr_mask=0x00000000
