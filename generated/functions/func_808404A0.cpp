...
extern "C" void func_808404A0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_808404A0:
{
    ...
    xer = ctx->xer;
    r4 = 0x809C0000u;
    r0 = MemoryInline::FlatRead32((r3 + 9172));
...
loc_808404FC:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805F0DB4u) && KnownTranslatedCpuCall<0x805F0DB4u>::kAvailable && !KnownTranslatedCpuCall<0x805F0DB4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805F0DB4u>()) {
        const auto state_free_result_805F0DB4_115F = func_805F0DB4_statefree_v1(r3, r4, cr, xer);
        r4 = static_cast<uint32_t>(state_free_result_805F0DB4_115F[0]);
        cr = static_cast<uint32_t>(state_free_result_805F0DB4_115F[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_179E = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_179E[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_179E[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x808404A0 func_808404A0 preserves=true fpr_mask=0x00000000
