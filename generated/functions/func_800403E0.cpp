...
extern "C" void func_800403E0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80040454:
{
    guest_range_0 = MemoryInline::ResolveRangeHost((r2 + -30216), 0, 1252u, true, false);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 0u, (r2 + -30216));
}
...
loc_8004046C:
{
    ...
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 16u, (r2 + -30200));
...
loc_800404B8:
{
    ...
    f0.d = PPC_Frsqrte(PPC_PsToScalarInline(f1.d));
    {
        ...
        if (resolved_pair.valid) {
            ...
            f2.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 1244u, (r2 + -28972));
            f3.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 1248u, (r2 + -28968));
        }
    }
...
// RECOMP_REGISTRATION base 0x800403E0 func_800403E0 preserves=true fpr_mask=0x00000000
