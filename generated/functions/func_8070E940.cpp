...
extern "C" void func_8070E940(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8070E964:
{
    r0 = MemoryInline::FlatRead8((r3 + 146));
    r5 = 0x808D0000u;
    r5 = (r5 + -29376);
...
// RECOMP_REGISTRATION base 0x8070E940 func_8070E940 preserves=true fpr_mask=0x00000000
