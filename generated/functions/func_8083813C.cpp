...
extern "C" void func_8083813C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_808381E0:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r29 + 1540), r28);
    r0 = 81;
    r3 = 0x809C0000u;
...
// RECOMP_REGISTRATION base 0x8083813C func_8083813C preserves=false fpr_mask=0x80000000
