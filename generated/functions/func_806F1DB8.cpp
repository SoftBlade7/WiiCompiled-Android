...
extern "C" void func_806F1DB8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806F1DB8:
{
    ...
    f2.d = MemoryInline::FlatReadFloat32((r3 + 30640));
    r3 = 0x809C0000u;
    f1.d = static_cast<double>(PpcForceSingleValueInline(f0.d - f1.d));
    f31.d = MemoryInline::FlatReadFloat32((r3 + 8892));
    f0.d = (-(f2.d));
    r3 = (r1 + 32);
    r4 = (r1 + 56);
...
// RECOMP_GUEST_ABI gpr_read=0x8000000E gpr_write=0x800000FB gpr_return=0x00000018 fpr_read=0x80000007 fpr_write=0x8000001F fpr_return=0x00000002 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x806F1DB8 func_806F1DB8 preserves=false fpr_mask=0x80000000
