...
extern "C" void func_8080BE84(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r3 = 0x808B0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + -19908));
    ctx->gpr[3] = r3;
    ctx->fpr[1] = f1;
    return;
}
...
// RECOMP_REGISTRATION base 0x8080BE84 func_8080BE84 preserves=true fpr_mask=0x00000000
