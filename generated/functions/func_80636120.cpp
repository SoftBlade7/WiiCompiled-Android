...
extern "C" void func_80636120(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80636120:
{
    ...
    r25 = r4;
    r31 = MemoryInline::FlatRead8((r1 + 59));
    r24 = r3;
    r26 = r5;
    r27 = r6;
    r28 = r7;
    ...
    r30 = r10;
    r4 = 2;
    MemoryInline::FlatWrite32((r3 + 160), r9);
    ctx->lr = 0x8063615Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->gpr[31] = r31;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x806365CCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80636120 func_80636120 preserves=true fpr_mask=0x00000000
