...
extern "C" void func_805474F0(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r3 = (r3 + 65536);
    r3 = MemoryInline::FlatRead32((r3 + -28048));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x805474F0 func_805474F0 preserves=true fpr_mask=0x00000000
