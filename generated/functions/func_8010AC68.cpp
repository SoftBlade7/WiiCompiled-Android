...
extern "C" void func_8010AC68(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8010AC68:
{
    ...
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    InvokeDirectCpu<0x8010A770u>(ctx);
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
// RECOMP_REGISTRATION base 0x8010AC68 func_8010AC68 preserves=true fpr_mask=0x00000000
