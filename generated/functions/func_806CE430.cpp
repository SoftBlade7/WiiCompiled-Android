...
extern "C" void func_806CE430(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806CE430:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x806CB1E8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_806CE504:
{
    r0 = MemoryInline::FlatRead8((r29 + 358));
...
// RECOMP_REGISTRATION base 0x806CE430 func_806CE430 preserves=false fpr_mask=0x80000000
