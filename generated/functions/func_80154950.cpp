...
extern "C" void func_80154950(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8015499C:
{
    ...
    r0 = 1;
    r3 = (r3 & 16);
    MemoryInline::FlatWriteRam8(r30, static_cast<uint8_t>(r4));
    r3 = (r3 | 15);
    r4 = r30;
    MemoryInline::FlatWriteRam8((r30 + 1), static_cast<uint8_t>(r3));
    r3 = 3;
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam8((r30 + 3), static_cast<uint8_t>(r3));
    r0 = 4;
    r3 = r31;
    r4 = r29;
...
// RECOMP_REGISTRATION base 0x80154950 func_80154950 preserves=true fpr_mask=0x00000000
