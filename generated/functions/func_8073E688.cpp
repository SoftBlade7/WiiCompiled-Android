...
extern "C" void func_8073E688(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8073E688:
{
    ...
    r26 = 0;
    f31.d = MemoryInline::FlatReadFloat32((r5 + 10428));
    r31 = 0x809C0000u;
...
loc_8073E774:
{
    ...
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 52), 0, 52u, true, false);
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 28u, (r1 + 80));
    r11 = (r1 + 80);
    ...
    r0 = MemoryInline::ReadResolved32(guest_range_1, 48u, (r1 + 100));
    ctx->lr = r0;
    r1 = (r1 + 96);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x8073E688 func_8073E688 preserves=false fpr_mask=0x80000000
