...
extern "C" void func_80766E8C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80766E8C:
{
    ...
    r29 = (r29 + 15048);
    r3 = (r30 + 12);
    guest_range_0 = MemoryInline::ResolveRangeHost((r29 + 56), 0, 28u, true, false);
    f2.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 0u, (r29 + 56));
    r5 = (r30 + 0);
    {
        ...
        if (resolved_pair.valid) {
            ...
            f1.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 4u, (r29 + 60));
            f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 8u, (r29 + 64));
        }
    }
    guest_range_1 = MemoryInline::ResolveRangeHost(r30, 0, 72u, false, true);
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 12u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f2.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f1.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 12u, (r30 + 12), f2.d);
    ...
    f2.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 12u, (r29 + 68));
    r3 = (r30 + 36);
    f1.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 16u, (r29 + 72));
    r4 = (r31 + 13824);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 20u, (r29 + 76));
    r5 = (r30 + 24);
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 36u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f2.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f1.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 36u, (r30 + 36), f2.d);
    ...
    f1.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 16u, (r29 + 72));
    r4 = (r31 + 13824);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 24u, (r29 + 80));
    r5 = (r30 + 48);
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 60u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f2.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f1.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 60u, (r30 + 60), f2.d);
...
// RECOMP_REGISTRATION base 0x80766E8C func_80766E8C preserves=true fpr_mask=0x00000000
