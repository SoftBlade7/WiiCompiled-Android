...
extern "C" void func_8085CAE8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8085CB1C:
{
    ...
    r3 = MemoryInline::FlatRead32((r30 + 420));
    r4 = (r0 + r5);
    r0 = MemoryInline::FlatRead16((r4 + 3314));
    r3_addr_2 = (r3 + r7);
    ...
    r5 = (r3 + r5);
    r3 = (r0 + r7);
    r4 = MemoryInline::FlatRead16((r5 + 256));
    r0 = MemoryInline::FlatRead16((r5 + 3314));
    r0 = (r0 - r4);
...
loc_8085CBB0:
{
    ...
    r24 = (r4 & 255);
    r4 = (r0 + r27);
    r23 = MemoryInline::FlatRead8((r4 + 8));
    r4 = r24;
    r3_addr_4 = (r3 + r26);
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead32((r30 + 420));
    r3 = r22;
    r5 = 1313;
    r4_addr_2 = (r4 + r27);
    ...
    r3 = (r3 + r0);
    r25 = (r25 + 1);
    MemoryInline::FlatWrite8((r3 + 3320), static_cast<uint8_t>(r24));
}
...
// RECOMP_REGISTRATION base 0x8085CAE8 func_8085CAE8 preserves=true fpr_mask=0x00000000
