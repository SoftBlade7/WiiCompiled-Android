...
extern "C" void func_806D0D84(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806D0D84:
{
    ...
    f2.d = MemoryInline::FlatReadFloat32((r3 + 19400));
    f0.d = MemoryInline::FlatReadFloat32((r31 + 68));
    r3 = MemoryInline::FlatRead32((r28 + 212));
    f1.d = static_cast<double>(PpcForceSingleValueInline(f3.d - f1.d));
    f1.d = static_cast<double>(PpcForceSingleValueInline(f1.d / f2.d));
    f1.d = static_cast<double>(PpcForceSingleValueInline(f1.d / f2.d));
    MemoryInline::FlatWriteFloat32((r28 + 284), f1.d);
    f1.d = MemoryInline::FlatReadFloat32((r5 + 19384));
    r12 = MemoryInline::FlatRead32(r3);
    ...
    xer = ctx->xer;
    mkw_gqr0 = ctx->gqr[0];
    r29 = MemoryInline::FlatRead32((r28 + 212));
...
loc_806D0E44:
{
    f0.d = MemoryInline::FlatReadFloat32((r28 + 240));
    r30 = 0;
    MemoryInline::FlatWriteRamFloat32((r1 + 20), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r28 + 244));
    MemoryInline::FlatWriteRamFloat32((r1 + 36), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r28 + 248));
...
// RECOMP_REGISTRATION base 0x806D0D84 func_806D0D84 preserves=false fpr_mask=0x80000000
