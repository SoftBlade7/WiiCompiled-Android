...
extern "C" void func_8073EC84(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r3_rot_0 = 0;
...
loc_8073EC84:
{
    ...
    r3_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(25));
    r3 = (r3_rot_0 & 1);
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    return;
...
// RECOMP_REGISTRATION base 0x8073EC84 func_8073EC84 preserves=true fpr_mask=0x00000000
