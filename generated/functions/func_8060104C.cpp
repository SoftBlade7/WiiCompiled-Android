...
extern "C" void func_8060104C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8060104C:
{
    r3 = MemoryInline::FlatRead32((r3 + 4620));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8060104C func_8060104C preserves=true fpr_mask=0x00000000
