...
extern "C" void func_800CCC80(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800CCC80:
{
    ...
    r3 = r29;
    r4 = r30;
    // inline leaf 0x800CCDB4 (3 guest instruction(s))
    MemoryInline::FlatWrite32((r13 + -26948), r3);
    MemoryInline::FlatWrite32((r13 + -26952), r4);
    // end of inlined leaf 0x800CCDB4
    r3 = r26;
    ctx->lr = 0x800CCCCCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800ECA8Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r5 = 0x800D0000u;
    r6 = 0x800D0000u;
    MemoryInline::FlatWrite32((r13 + -26960), r28);
    r3 = (r3 + -12644);
    r4 = (r4 + -12332);
    r5 = (r5 + -12540);
    r6 = (r6 + -12296);
...
// RECOMP_REGISTRATION base 0x800CCC80 func_800CCC80 preserves=true fpr_mask=0x00000000
