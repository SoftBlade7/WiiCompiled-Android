...
extern "C" void func_807A05D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807A05E4:
{
    r5 = 0x808A0000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r5 + 20992));
    ctx->gpr[0] = r0;
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
    ctx->fpr[1] = f1;
...
// RECOMP_REGISTRATION base 0x807A05D0 func_807A05D0 preserves=true fpr_mask=0x00000000
