...
extern "C" void func_8020CC7C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8020CCB8:
{
    ...
    ctx->gpr[5] = r5;
    ctx->xer = xer;
    InvokeDirectCpu<0x8019BBE0u>(ctx);
    r3 = ctx->gpr[3];
...
// RECOMP_REGISTRATION base 0x8020CC7C func_8020CC7C preserves=true fpr_mask=0x00000000
