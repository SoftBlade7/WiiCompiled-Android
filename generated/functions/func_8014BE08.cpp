...
extern "C" void func_8014BE08(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8014BE08:
{
    ...
    r27 = r3;
    r31 = MemoryInline::FlatRead32((r7 + 24));
    r28 = r4;
...
loc_8014BE38:
{
    r30 = MemoryInline::FlatRead16((r3 + 20));
    r29 = r5;
    if (((cr & 0x80000000u) != 0)) {
        goto loc_8014BE5C;
    }
...
// RECOMP_REGISTRATION base 0x8014BE08 func_8014BE08 preserves=true fpr_mask=0x00000000
