...
extern "C" void func_8015D41C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8015D41C:
{
    ...
    r3 = MemoryInline::FlatRead16((r3 + 20486));
...
// RECOMP_REGISTRATION base 0x8015D41C func_8015D41C preserves=true fpr_mask=0x00000000
