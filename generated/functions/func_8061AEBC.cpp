...
extern "C" void func_8061AEBC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8061AEBC:
{
    r0 = 0;
    r4 = 1;
    guest_range_0 = MemoryInline::ResolveRangeHost((r3 + 4), 0, 88u, false, true);
    MemoryInline::WriteResolved8(guest_range_0, 80u, (r3 + 84), static_cast<uint8_t>(r4));
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 48u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_0, 48u, (r3 + 52), r0);
...
// RECOMP_REGISTRATION base 0x8061AEBC func_8061AEBC preserves=true fpr_mask=0x00000000
