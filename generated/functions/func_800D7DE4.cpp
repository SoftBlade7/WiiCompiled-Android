...
extern "C" void func_800D7DE4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800D7DF0:
{
    ...
    r4 = ctx->gpr[4];
    r6 = 0x80000000u;
    r8 = MemoryInline::FlatRead32((r29 + 1772));
    r0 = MemoryInline::FlatRead32((r6 + 248));
    r5 = 274857984;
    r6 = (r5 + 19923);
    r7 = MemoryInline::FlatRead32((r29 + 1768));
...
loc_800D7E4C:
{
    ...
    r3 = MemoryInline::FlatRead8((r4 + 2196));
    r3 = (r3 + 1);
    r0 = (r3 & 255);
    MemoryInline::FlatWrite8((r4 + 2196), static_cast<uint8_t>(r3));
...
loc_800D7F94:
{
    ...
    r3 = 1024;
    r6 = 15;
    r5 = MemoryInline::FlatRead8((r5 + 2196));
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x800D7FB0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
{
    r3 = MemoryInline::FlatRead32((r13 + -26868));
    MemoryInline::FlatWrite32((r3 + 1760), r28);
}
...
loc_800D83B8:
{
    ...
    if (MkwStateFreeAbiEnabled(0x8011E43Cu) && KnownTranslatedCpuCall<0x8011E43Cu>::kAvailable && !KnownTranslatedCpuCall<0x8011E43Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x8011E43Cu>()) {
        const auto state_free_result_8011E43C_E8D5 = func_8011E43C_statefree_v0(r3, xer);
        r0 = static_cast<uint32_t>(state_free_result_8011E43C_E8D5[0]);
        r3 = static_cast<uint32_t>(state_free_result_8011E43C_E8D5[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x800D7DE4 func_800D7DE4 preserves=true fpr_mask=0x00000000
