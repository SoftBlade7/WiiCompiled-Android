...
extern "C" void func_801A7500(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_801A7568:
{
    ...
    r0 = (r0_rot_1 & -4);
    r4_addr_1 = (r4 + r0);
    MemoryInline::FlatWrite32(r4_addr_1, r29);
...
// RECOMP_REGISTRATION base 0x801A7500 func_801A7500 preserves=true fpr_mask=0x00000000
