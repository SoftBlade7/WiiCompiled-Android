...
extern "C" void func_801B86C4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801B86C4:
{
    ...
    r23 = r3;
    r24 = r4;
    r31 = MemoryInline::FlatRead32((r1 + 72));
    r25 = r5;
    r26 = r6;
    r27 = r7;
    r30 = r10;
    ...
    ctx->gpr[30] = r30;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x801B8120u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x801B86C4 func_801B86C4 preserves=true fpr_mask=0x00000000
