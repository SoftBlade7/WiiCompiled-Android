...
extern "C" void func_80210FEC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8021100C:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800A34D0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80211020:
{
    r3 = MemoryInline::FlatRead32((r30 + 1220));
...
// RECOMP_REGISTRATION base 0x80210FEC func_80210FEC preserves=true fpr_mask=0x00000000
