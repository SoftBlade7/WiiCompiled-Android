...
extern "C" void func_8082C234(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8082C234:
{
    ...
    MemoryInline::FlatWrite16((r30 + 198), static_cast<uint16_t>(r4));
...
loc_8082C31C:
{
    MemoryInline::FlatWrite32((r30 + 180), r29);
    r3 = 180;
    ctx->lr = 0x8082C328u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8082C350:
{
    MemoryInline::FlatWrite32((r30 + 184), r29);
    r3 = 180;
    ctx->lr = 0x8082C35Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8082C384:
{
    MemoryInline::FlatWrite32((r30 + 188), r29);
    r3 = 180;
    ctx->lr = 0x8082C390u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8082C3B8:
{
    ...
    MemoryInline::FlatWriteFloat32((r5 + 176), f0.d);
...
// RECOMP_REGISTRATION base 0x8082C234 func_8082C234 preserves=true fpr_mask=0x00000000
