...
extern "C" void func_806AEDBC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806AEDFC:
{
    ...
    r4 = 0x808A0000u;
    r3 = (r1 + 68);
    f1.d = MemoryInline::FlatReadFloat32((r4 + -10464));
    r4 = (r1 + 56);
...
// RECOMP_REGISTRATION base 0x806AEDBC func_806AEDBC preserves=true fpr_mask=0x00000000
