...
extern "C" void func_8076B554(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8076B554:
{
    ...
    r14 = 0x808D0000u;
    r3 = (r25 + 180);
    MemoryInline::FlatWrite32((r25 + 180), r5);
    r5 = 0;
    MemoryInline::FlatWrite32((r25 + 184), r18);
    MemoryInline::FlatWrite32((r25 + 188), r18);
    MemoryInline::FlatWrite32((r25 + 200), r4);
    MemoryInline::FlatWrite32((r25 + 204), r18);
    MemoryInline::FlatWrite32((r25 + 208), r18);
    r12 = MemoryInline::FlatRead32((r25 + 180));
    r4 = MemoryInline::FlatRead32((r14 + -6232));
...
loc_8076B620:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32(r16, r19);
    r3 = (r16 + 220);
    r5 = 0;
    MemoryInline::FlatWriteRam32((r16 + 196), r20);
    MemoryInline::FlatWriteRam32((r16 + 200), r18);
    MemoryInline::FlatWriteRam32((r16 + 204), r18);
    MemoryInline::FlatWriteRam32((r16 + 220), r21);
    MemoryInline::FlatWriteRam32((r16 + 224), r18);
    MemoryInline::FlatWriteRam32((r16 + 228), r18);
    r12 = MemoryInline::FlatRead32((r16 + 220));
    r4 = MemoryInline::FlatRead32((r24 + -6252));
    r12 = MemoryInline::FlatRead32((r12 + 12));
    ctr = r12;
    ctx->lr = 0x8076B664u;
    ctx->gpr[0] = r0;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r12 = MemoryInline::FlatRead32((r16 + 196));
    r3 = (r16 + 196);
    r4 = MemoryInline::FlatRead32((r24 + -6252));
    r5 = 0;
    r12 = MemoryInline::FlatRead32((r12 + 12));
...
loc_8076B6A0:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32(r31, r22);
    r3 = 124;
    ctx->lr = 0x8076B6B8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8076B6C4:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32(r15, r23);
}

loc_8076B6D4:
{
    MemoryInline::FlatWriteRam32((r31 + 276), r15);
    r3 = 124;
    ctx->lr = 0x8076B6E0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8076B6FC:
{
    MemoryInline::FlatWriteRam32((r31 + 280), r15);
    MemoryInline::FlatWriteRam32((r31 + 284), r18);
}
...
loc_8076B710:
{
    r0 = MemoryInline::FlatRead32((r16 + 224));
}
...
loc_8076B73C:
{
    r4 = MemoryInline::FlatRead32((r16 + 228));
}
...
loc_8076B77C:
{
    r3 = MemoryInline::FlatRead32((r16 + 228));
    r3_addr_3 = (r3 + r28);
...
loc_8076B79C:
{
    r0 = MemoryInline::FlatRead32((r24 + -6252));
...
loc_8076B7B4:
{
    r0 = MemoryInline::FlatRead32((r25 + 184));
}
...
loc_8076B7E0:
{
    r4 = MemoryInline::FlatRead32((r25 + 188));
}
...
loc_8076B7E8:
{
    r3 = 0;
    r4_addr_5 = (r4 + r29);
    MemoryInline::FlatWrite32(r4_addr_5, r16);
    if ((static_cast<int32_t>(r27) < static_cast<int32_t>(0))) {
        goto loc_8076B804;
    }
}
...
loc_8076B820:
{
    r3 = MemoryInline::FlatRead32((r25 + 188));
    r3_addr_5 = (r3 + r29);
...
loc_8076B840:
{
    r0 = MemoryInline::FlatRead32((r14 + -6232));
...
loc_8076B84C:
{
    r4 = 0x809C0000u;
    r3 = 3;
    MemoryInline::FlatWriteRam32((r4 + 11664), r25);
    r0 = 0;
    r16 = 0;
    r15 = 0;
    MemoryInline::FlatWrite32((r25 + 176), r3);
    r14 = 0x809C0000u;
    MemoryInline::FlatWrite32((r25 + 212), r0);
    goto loc_8076B8AC;
}
...
loc_8076B894:
{
    if ((static_cast<uint32_t>(r0) != static_cast<uint32_t>(219))) {
        goto loc_8076B8A4;
    }
}
...
loc_8076B898:
{
    r3 = MemoryInline::FlatRead32((r25 + 212));
    r0 = (r3 + 1);
    MemoryInline::FlatWrite32((r25 + 212), r0);
}
...
loc_8076B8AC:
{
    r3 = MemoryInline::FlatRead32((r14 + 17200));
...
loc_8076B8BC:
{
    r12 = MemoryInline::FlatRead32((r25 + 200));
    r3 = (r25 + 200);
...
loc_8076B8EC:
{
    r3 = MemoryInline::FlatRead32((r3 + 28));
    r3_addr_9 = (r3 + r16);
    r19 = MemoryInline::FlatRead32(r3_addr_9);
...
loc_8076B954:
{
    ...
    r0_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r15), static_cast<uint32_t>(2));
    r0 = (r0_rot_2 & -4);
    r3_addr_10 = (r3 + r0);
    MemoryInline::FlatWrite32(r3_addr_10, r19);
}
...
// RECOMP_REGISTRATION base 0x8076B554 func_8076B554 preserves=true fpr_mask=0x00000000
