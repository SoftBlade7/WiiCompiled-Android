...
extern "C" void func_805C4754(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805C4754:
{
    ...
    r3 = 0x809C0000u;
    r4 = (r4 + 7812);
    MemoryInline::FlatWriteRam32((r3 + 7064), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x805C4754 func_805C4754 preserves=true fpr_mask=0x00000000
