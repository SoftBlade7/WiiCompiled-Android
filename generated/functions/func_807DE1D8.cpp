...
extern "C" void func_807DE1D8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807DE1D8:
{
    ...
    f1.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 32u, (r3 + 32));
    ...
    f28.d = MemoryInline::FlatReadFloat32(r4);
    f3.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 8u, (r3 + 8));
...
loc_807DE250:
{
    ...
    f4.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 20u, (r3 + 20));
    ...
    f2.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 36u, (r3 + 36));
...
// RECOMP_REGISTRATION base 0x807DE1D8 func_807DE1D8 preserves=false fpr_mask=0xF0000000
