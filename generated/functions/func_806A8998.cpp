...
extern "C" void func_806A8998(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806A8998:
{
    ...
    r31 = MemoryInline::FlatRead32((r3 + 512));
...
// RECOMP_REGISTRATION base 0x806A8998 func_806A8998 preserves=true fpr_mask=0x00000000
