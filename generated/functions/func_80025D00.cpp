...
extern "C" void func_80025D00(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr1_0 = 0;
...
loc_80025D38:
{
    r30 = MemoryInline::FlatRead32((r13 + -27428));
    r11 = (r1 + 136);
    r0 = (r1 + 8);
    r12 = 16777216;
...
// RECOMP_REGISTRATION base 0x80025D00 func_80025D00 preserves=true fpr_mask=0x00000000
