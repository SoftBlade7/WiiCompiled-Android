...
extern "C" void func_80776498(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80776640:
{
    r4 = 0x808A0000u;
    r3 = r31;
    f1.d = MemoryInline::FlatReadFloat32((r4 + 16752));
    r4 = 842;
    ctx->lr = 0x80776654u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x80776498 func_80776498 preserves=true fpr_mask=0x00000000
