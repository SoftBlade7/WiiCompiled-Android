...
extern "C" void func_8053B584(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8053B5DC:
{
    r0 = MemoryInline::FlatRead8((r29 + 262));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
// RECOMP_REGISTRATION base 0x8053B584 func_8053B584 preserves=true fpr_mask=0x00000000
