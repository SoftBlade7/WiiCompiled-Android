...
extern "C" void func_807DBD80(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_807DBD80:
{
    ...
    r31 = ctx->gpr[31];
    r4 = 0x808D0000u;
    MemoryInline::FlatWrite32((r26 + 76), r30);
    r4 = (r4 + 11792);
    r3 = r26;
    ...
    r7 = 12;
    MemoryInline::FlatWrite32((r26 + 84), r29);
    ctx->lr = 0x807DBDF4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x807DBD80 func_807DBD80 preserves=true fpr_mask=0x00000000
