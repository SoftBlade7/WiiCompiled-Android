...
extern "C" void func_805FE7D4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_805FE7D4:
{
    ...
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(195));
}
...
loc_805FE7F4:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(196));
}
...
{
    r0 = 2;
    MemoryInline::FlatWrite32((r3 + 3812), r0);
    goto loc_805FE814;
}
...
loc_805FE850:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805F0DB4u) && KnownTranslatedCpuCall<0x805F0DB4u>::kAvailable && !KnownTranslatedCpuCall<0x805F0DB4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805F0DB4u>()) {
        const auto state_free_result_805F0DB4_1039 = func_805F0DB4_statefree_v2(r3, r4, xer);
        r4 = static_cast<uint32_t>(state_free_result_805F0DB4_1039);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_805FE860:
{
    ...
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x805F0DB4u) && KnownTranslatedCpuCall<0x805F0DB4u>::kAvailable && !KnownTranslatedCpuCall<0x805F0DB4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805F0DB4u>()) {
        const auto state_free_result_805F0DB4_1625 = func_805F0DB4_statefree_v2(r3, r4, xer);
        r4 = static_cast<uint32_t>(state_free_result_805F0DB4_1625);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_805FE958:
{
    ...
    r7 = ctx->gpr[7];
    r8 = ctx->gpr[8];
    r7 = MemoryInline::FlatRead32((r31 + 3812));
    r6 = r27;
    r3 = (r1 + 8);
    r5 = (r30 + 565);
    r4 = 15;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r28 + 1976), r27);
    r3 = r29;
    r4 = (r31 + 68);
    r5 = 0;
    ctx->gpr[0] = r0;
...
loc_805FE9C8:
{
    r0 = MemoryInline::FlatRead32((r31 + 3812));
...
loc_805FE9D4:
{
    ...
    xer = ctx->xer;
    r0 = -1;
    MemoryInline::FlatWrite32((r31 + 3764), r0);
    r3 = (r31 + 3188);
    r4 = (r31 + 68);
    r5 = 0;
    ctx->gpr[0] = r0;
    ...
    r6 = ctx->gpr[6];
    r0 = 0;
    MemoryInline::FlatWrite8((r31 + 3820), static_cast<uint8_t>(r0));
    r0 = (r0 * 596);
    r4 = 0;
    r3 = (r31 + r0);
    r3 = (r3 + 1400);
...
// RECOMP_REGISTRATION base 0x805FE7D4 func_805FE7D4 preserves=true fpr_mask=0x00000000
