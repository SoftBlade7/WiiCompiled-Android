...
extern "C" void func_806C82AC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806C8350:
{
    ...
    xer = ctx->xer;
    mkw_gqr0 = ctx->gqr[0];
    r29 = MemoryInline::FlatRead32((r31 + 228));
    r30 = 0;
}
...
// RECOMP_REGISTRATION base 0x806C82AC func_806C82AC preserves=true fpr_mask=0x00000000
