...
extern "C" void func_801E3C4C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801E3C98:
{
    r4 = MemoryInline::FlatRead32((r13 + -28016));
    r3 = r31;
    r5 = r30;
    ...
    r0 = (r3 + 1);
    r3 = r31;
    MemoryInline::FlatWrite32((r28 + 84), r0);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
loc_801E3CEC:
{
    r4 = MemoryInline::FlatRead32((r13 + -28012));
    r3 = r31;
    r5 = r30;
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x801E3D00u;
...
// RECOMP_REGISTRATION base 0x801E3C4C func_801E3C4C preserves=true fpr_mask=0x00000000
