...
extern "C" void func_806AC2B8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806AC2DC:
{
    r31 = MemoryInline::FlatRead32((r3 + 592));
...
// RECOMP_REGISTRATION base 0x806AC2B8 func_806AC2B8 preserves=true fpr_mask=0x00000000
