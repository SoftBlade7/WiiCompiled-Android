...
extern "C" void func_80741980(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r3_rot_0 = 0;
...
loc_80741980:
{
    ...
    r0 = MemoryInline::FlatRead8((r3 + 2956));
...
// RECOMP_REGISTRATION base 0x80741980 func_80741980 preserves=true fpr_mask=0x00000000
