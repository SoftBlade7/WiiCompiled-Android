...
extern "C" void func_8056C030(CpuContext* MKW_RESTRICT ctx)
{
    goto loc_8056C030;

loc_8056C030:
{
    InvokeDirectCpu<0x8056BE20u>(ctx);
    return;
}
...
// RECOMP_REGISTRATION base 0x8056C030 func_8056C030 preserves=true fpr_mask=0x00000000
