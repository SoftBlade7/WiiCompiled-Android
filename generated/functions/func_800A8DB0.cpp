...
extern "C" void func_800A8DB0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800A8DB0:
{
    r3 = MemoryInline::FlatRead8((r3 + 543));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x800A8DB0 func_800A8DB0 preserves=true fpr_mask=0x00000000
