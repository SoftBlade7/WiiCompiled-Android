...
extern "C" void func_8056DD54(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8056DDA8:
{
    r30 = MemoryInline::FlatRead32((r28 + 712));
    r3 = r28;
    ...
    r4 = (r1 + 20);
    f3.d = MemoryInline::FlatReadFloat32((r31 + 5912));
    r5 = (r1 + 32);
...
// RECOMP_GUEST_ABI gpr_read=0xF000003E gpr_write=0xF000007B gpr_return=0x00000018 fpr_read=0xFC00C01F fpr_write=0xFC00FFFF fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8056DD54 func_8056DD54 preserves=true fpr_mask=0x00000000
