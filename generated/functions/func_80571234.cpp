...
extern "C" void func_80571234(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80571234:
{
    ...
    f3.d = static_cast<double>(PpcForceSingleValueInline(f30.d + f29.d));
    ...
    f30.d = PpcFmulsInline(f3.d, f3.d);
...
{
    r3 = 0x80890000u;
    f31.d = MemoryInline::FlatReadFloat32((r3 + 5936));
...
// RECOMP_REGISTRATION base 0x80571234 func_80571234 preserves=false fpr_mask=0xE0000000
