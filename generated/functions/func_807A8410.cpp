...
extern "C" void func_807A8410(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807A8410:
{
    ...
    r3 = 12;
    r0 = 3;
    MemoryInline::FlatWrite16((r31 + 14), static_cast<uint16_t>(r3));
...
// RECOMP_REGISTRATION base 0x807A8410 func_807A8410 preserves=true fpr_mask=0x00000000
