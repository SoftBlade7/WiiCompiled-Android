...
extern "C" void func_802226BC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_802226BC:
{
    r6 = MemoryInline::FlatRead32((r4 + 60));
    r4 = r3;
    r5 = 0;
    r3 = (r6 + 160);
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x802226BC func_802226BC preserves=true fpr_mask=0x00000000
