...
extern "C" void func_80771248(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807712CC:
{
    ...
    r3 = 1;
    r0 = 0;
    MemoryInline::FlatWrite8((r30 + 292), static_cast<uint8_t>(r3));
...
// RECOMP_REGISTRATION base 0x80771248 func_80771248 preserves=true fpr_mask=0x00000000
