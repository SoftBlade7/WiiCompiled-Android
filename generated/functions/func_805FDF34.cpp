...
extern "C" void func_805FDF34(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805FDF34:
{
    ...
    r4 = -1;
    MemoryInline::FlatWrite32((r3 + 4620), r4);
...
// RECOMP_REGISTRATION base 0x805FDF34 func_805FDF34 preserves=true fpr_mask=0x00000000
