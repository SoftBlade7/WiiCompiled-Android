...
extern "C" void func_807740EC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807740EC:
{
    ...
    ctx->fpr[4] = f4;
    ctx->cr = cr;
    InvokeDirectCpu<0x80782CD8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80774120:
{
    ...
    r3 = 0x808A0000u;
    r5 = 0x808A0000u;
    f2.d = MemoryInline::FlatReadFloat32((r5 + 16616));
    r5 = 1;
    r4 = MemoryInline::FlatRead32((r31 + 8));
    f1.d = MemoryInline::FlatReadFloat32((r3 + 16568));
...
loc_80774178:
{
    ...
    r4 = 0x808A0000u;
    r3 = (r1 + 8);
    f0.d = MemoryInline::FlatReadFloat32((r4 + 16568));
    ...
    r4 = 0x808D0000u;
    r3 = (r1 + 20);
    f1.d = MemoryInline::FlatReadFloat32((r4 + -1328));
    r4 = (r1 + 8);
...
// RECOMP_REGISTRATION base 0x807740EC func_807740EC preserves=true fpr_mask=0x00000000
