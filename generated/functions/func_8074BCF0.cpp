...
extern "C" void func_8074BCF0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8074BCF0:
{
    ...
    r27 = MemoryInline::ReadResolved32(guest_range_2, 0u, (r1 + 40));
    r26 = 0x80380000u;
    MemoryInline::FlatWriteRam32((r26 + 16704), r27);
    r26 = (r26 + 16704);
    r3 = 1;
    r28 = MemoryInline::ReadResolved32(guest_range_2, 4u, (r1 + 44));
    r4 = 0;
    {
        ...
        if (resolved_pair.valid) {
            ...
            r29 = MemoryInline::ReadResolved32(guest_range_2, 8u, (r1 + 48));
            r12 = MemoryInline::ReadResolved32(guest_range_2, 12u, (r1 + 52));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r11 = MemoryInline::ReadResolved32(guest_range_2, 16u, (r1 + 56));
            r10 = MemoryInline::ReadResolved32(guest_range_2, 20u, (r1 + 60));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r9 = MemoryInline::ReadResolved32(guest_range_2, 24u, (r1 + 64));
            r8 = MemoryInline::ReadResolved32(guest_range_2, 28u, (r1 + 68));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r7 = MemoryInline::ReadResolved32(guest_range_2, 32u, (r1 + 72));
            r6 = MemoryInline::ReadResolved32(guest_range_2, 36u, (r1 + 76));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r5 = MemoryInline::ReadResolved32(guest_range_2, 40u, (r1 + 80));
            r0 = MemoryInline::ReadResolved32(guest_range_2, 44u, (r1 + 84));
        }
    }
    guest_range_0 = MemoryInline::ResolveRangeHost((r26 + 4), 0, 44u, false, true);
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 0u, ((static_cast<uint64_t>(static_cast<uint32_t>(r28)) << 32) | static_cast<uint32_t>(r29)))) {
        MemoryInline::WriteResolved32(guest_range_0, 0u, (r26 + 4), r28);
        MemoryInline::WriteResolved32(guest_range_0, 4u, (r26 + 8), r29);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 8u, ((static_cast<uint64_t>(static_cast<uint32_t>(r12)) << 32) | static_cast<uint32_t>(r11)))) {
        MemoryInline::WriteResolved32(guest_range_0, 8u, (r26 + 12), r12);
        MemoryInline::WriteResolved32(guest_range_0, 12u, (r26 + 16), r11);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 16u, ((static_cast<uint64_t>(static_cast<uint32_t>(r10)) << 32) | static_cast<uint32_t>(r9)))) {
        MemoryInline::WriteResolved32(guest_range_0, 16u, (r26 + 20), r10);
        MemoryInline::WriteResolved32(guest_range_0, 20u, (r26 + 24), r9);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r8)) << 32) | static_cast<uint32_t>(r7)))) {
        MemoryInline::WriteResolved32(guest_range_0, 24u, (r26 + 28), r8);
        MemoryInline::WriteResolved32(guest_range_0, 28u, (r26 + 32), r7);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 32u, ((static_cast<uint64_t>(static_cast<uint32_t>(r6)) << 32) | static_cast<uint32_t>(r5)))) {
        MemoryInline::WriteResolved32(guest_range_0, 32u, (r26 + 36), r6);
        MemoryInline::WriteResolved32(guest_range_0, 36u, (r26 + 40), r5);
    }
    MemoryInline::WriteResolved32(guest_range_0, 40u, (r26 + 44), r0);
    ctx->lr = 0x8074BDB4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r4 = 2;
    guest_range_3 = MemoryInline::ResolveRangeHost((r1 + 8), 0, 32u, false, true);
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 8u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f28.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f29.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_3, 8u, (r1 + 16), f28.d);
        MemoryInline::WriteResolvedFloat32(guest_range_3, 12u, (r1 + 20), f29.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 16u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f30.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_3, 16u, (r1 + 24), f0.d);
        MemoryInline::WriteResolvedFloat32(guest_range_3, 20u, (r1 + 28), f30.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 24u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f31.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f0.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_3, 24u, (r1 + 32), f31.d);
        MemoryInline::WriteResolvedFloat32(guest_range_3, 28u, (r1 + 36), f0.d);
    }
    MemoryInline::WriteResolved8(guest_range_3, 0u, (r1 + 8), static_cast<uint8_t>(r9));
    MemoryInline::WriteResolved8(guest_range_3, 1u, (r1 + 9), static_cast<uint8_t>(r8));
    MemoryInline::WriteResolved8(guest_range_3, 2u, (r1 + 10), static_cast<uint8_t>(r7));
    ...
    ctx->fpr[1] = f1;
    ctx->fpr[2] = f2;
    InvokeDirectCpu<0x8021A884u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    guest_range_4 = MemoryInline::ResolveRangeHost((r1 + 88), 0, 96u, true, false);
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 72u, (r1 + 160));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f30.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 56u, (r1 + 144));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f29.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 40u, (r1 + 128));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r11 = (r1 + 112);
    f28.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 24u, (r1 + 112));
    ...
    r0 = MemoryInline::ReadResolved32(guest_range_4, 92u, (r1 + 180));
    ctx->lr = r0;
    r1 = (r1 + 176);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_GUEST_ABI gpr_read=0xFF80201E gpr_write=0xFF801FFB gpr_return=0x00000018 fpr_read=0xF000001E fpr_write=0xF00003FF fpr_return=0x00000002 cr_read=0x03 cr_write=0x03 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x8074BCF0 func_8074BCF0 preserves=false fpr_mask=0xF0000000
