...
extern "C" void func_807E5118(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r3 = MemoryInline::FlatRead32(r5);
    r25 = MemoryInline::FlatRead32((r3 + 680));
...
loc_807E5204:
{
    r28 = MemoryInline::FlatRead32((r25 + 7032));
}

loc_807E5208:
{
    r3_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r23), static_cast<uint32_t>(4));
    r3 = (r3_rot_0 & -16);
    r0 = (r31 + 0);
    r29 = (r0 + r3);
    r30 = (r26 + 396);
    r24 = 0x808B0000u;
    f29.d = MemoryInline::FlatReadFloat64((r31 + 392));
    f30.d = MemoryInline::FlatReadFloat32((r31 + 400));
    r22 = r29;
    f31.d = MemoryInline::FlatReadFloat32((r31 + 404));
    r21 = r30;
    r20 = r26;
    r24 = (r24 + -32224);
    r27 = 0;
...
loc_807E523C:
{
    r19 = MemoryInline::FlatRead32(r22);
    r3 = r19;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r28), static_cast<int32_t>(r19));
}

loc_807E525C:
{
    MemoryInline::FlatWrite32((r20 + 972), r19);
    if (((cr & 0x20000000u) == 0)) {
        goto loc_807E535C;
    }
}
...
loc_807E5264:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80840728u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
{
    r3 = (r3 + 620);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r3), static_cast<uint32_t>(r21));
}
...
loc_807E52E4:
{
    ...
    r3 = (r23 ^ -2147483648);
    r0 = (r23 + 1);
    f3.d = MemoryInline::FlatReadFloat32((r31 + 348));
...
// RECOMP_REGISTRATION base 0x807E5118 func_807E5118 preserves=false fpr_mask=0xE0000000
