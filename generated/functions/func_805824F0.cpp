...
extern "C" void func_805824F0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80582504:
{
    r4 = MemoryInline::FlatRead16((r3 + 328));
    r4 = (r4 << 16);
...
// RECOMP_REGISTRATION base 0x805824F0 func_805824F0 preserves=true fpr_mask=0x00000000
