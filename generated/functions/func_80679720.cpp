...
extern "C" void func_80679720(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80679920:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x800FB0B8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
{
    r0 = 100;
    if ((static_cast<int32_t>(r24) != static_cast<int32_t>(18))) {
        goto loc_80679A08;
    }
}
...
// RECOMP_REGISTRATION base 0x80679720 func_80679720 preserves=true fpr_mask=0x00000000
