...
extern "C" void func_80709B08(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80709B98:
{
    r0 = MemoryInline::FlatRead8((r30 + 210));
    r0 = (static_cast<int32_t>(static_cast<int8_t>(r0)));
...
{
    r0 = 0;
    MemoryInline::FlatWrite8((r30 + 210), static_cast<uint8_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x80709B08 func_80709B08 preserves=true fpr_mask=0x00000000
