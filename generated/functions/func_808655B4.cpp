...
extern "C" void func_808655B4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r0 = 1;
    MemoryInline::FlatWrite8((r31 + 1784), static_cast<uint8_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x808655B4 func_808655B4 preserves=true fpr_mask=0x00000000
