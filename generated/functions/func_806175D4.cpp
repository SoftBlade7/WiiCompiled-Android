...
extern "C" void func_806175D4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80617600:
{
    ...
    r5 = r17;
    r16 = (r16 + 30572);
    guest_range_0 = MemoryInline::ResolveRangeHost(r16, 0, 60u, true, false);
    r17 = MemoryInline::ReadResolved32(guest_range_0, 0u, r16);
    r25 = 0x80890000u;
    r25 = (r25 + 30688);
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 8), 0, 60u, false, true);
    MemoryInline::WriteResolved32(guest_range_1, 0u, (r1 + 8), r17);
    r18 = MemoryInline::ReadResolved32(guest_range_0, 4u, (r16 + 4));
    r3 = (r1 + 72);
    r19 = MemoryInline::ReadResolved32(guest_range_0, 8u, (r16 + 8));
    r4 = (r25 + 251);
    r20 = MemoryInline::ReadResolved32(guest_range_0, 12u, (r16 + 12));
    r6 = (r25 + 259);
    r21 = MemoryInline::ReadResolved32(guest_range_0, 16u, (r16 + 16));
    r7 = (r1 + 8);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r22 = MemoryInline::ReadResolved32(guest_range_0, 20u, (r16 + 20));
            r23 = MemoryInline::ReadResolved32(guest_range_0, 24u, (r16 + 24));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r24 = MemoryInline::ReadResolved32(guest_range_0, 28u, (r16 + 28));
            r26 = MemoryInline::ReadResolved32(guest_range_0, 32u, (r16 + 32));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r12 = MemoryInline::ReadResolved32(guest_range_0, 36u, (r16 + 36));
            r11 = MemoryInline::ReadResolved32(guest_range_0, 40u, (r16 + 40));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r10 = MemoryInline::ReadResolved32(guest_range_0, 44u, (r16 + 44));
            r9 = MemoryInline::ReadResolved32(guest_range_0, 48u, (r16 + 48));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r8 = MemoryInline::ReadResolved32(guest_range_0, 52u, (r16 + 52));
            r0 = MemoryInline::ReadResolved32(guest_range_0, 56u, (r16 + 56));
        }
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 4u, ((static_cast<uint64_t>(static_cast<uint32_t>(r18)) << 32) | static_cast<uint32_t>(r19)))) {
        MemoryInline::WriteResolved32(guest_range_1, 4u, (r1 + 12), r18);
        MemoryInline::WriteResolved32(guest_range_1, 8u, (r1 + 16), r19);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 12u, ((static_cast<uint64_t>(static_cast<uint32_t>(r20)) << 32) | static_cast<uint32_t>(r21)))) {
        MemoryInline::WriteResolved32(guest_range_1, 12u, (r1 + 20), r20);
        MemoryInline::WriteResolved32(guest_range_1, 16u, (r1 + 24), r21);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 20u, ((static_cast<uint64_t>(static_cast<uint32_t>(r22)) << 32) | static_cast<uint32_t>(r23)))) {
        MemoryInline::WriteResolved32(guest_range_1, 20u, (r1 + 28), r22);
        MemoryInline::WriteResolved32(guest_range_1, 24u, (r1 + 32), r23);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 28u, ((static_cast<uint64_t>(static_cast<uint32_t>(r24)) << 32) | static_cast<uint32_t>(r26)))) {
        MemoryInline::WriteResolved32(guest_range_1, 28u, (r1 + 36), r24);
        MemoryInline::WriteResolved32(guest_range_1, 32u, (r1 + 40), r26);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 36u, ((static_cast<uint64_t>(static_cast<uint32_t>(r12)) << 32) | static_cast<uint32_t>(r11)))) {
        MemoryInline::WriteResolved32(guest_range_1, 36u, (r1 + 44), r12);
        MemoryInline::WriteResolved32(guest_range_1, 40u, (r1 + 48), r11);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 44u, ((static_cast<uint64_t>(static_cast<uint32_t>(r10)) << 32) | static_cast<uint32_t>(r9)))) {
        MemoryInline::WriteResolved32(guest_range_1, 44u, (r1 + 52), r10);
        MemoryInline::WriteResolved32(guest_range_1, 48u, (r1 + 56), r9);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 52u, ((static_cast<uint64_t>(static_cast<uint32_t>(r8)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_1, 52u, (r1 + 60), r8);
    ...
    r26 = 0x80890000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r26 + 30436));
    ctx->lr = 0x806176C4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80616A48u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80617758:
{
    if ((static_cast<uint32_t>(r3) != static_cast<uint32_t>(r16))) {
        goto loc_80617764;
    }
}
...
loc_80617784:
{
    r6 = (r27 + 568);
    r0 = (r27 + 588);
    MemoryInline::FlatWrite32((r27 + 472), r6);
    r3 = (r27 + 436);
    r4 = 0;
    r5 = 0;
    MemoryInline::FlatWrite32((r27 + 448), r17);
    r6 = 0;
...
loc_806177C8:
{
    ...
    r17 = MemoryInline::FlatRead32((r3 + 56));
...
// RECOMP_REGISTRATION base 0x806175D4 func_806175D4 preserves=true fpr_mask=0x00000000
