...
extern "C" void func_80583F2C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80583F2C:
{
    ...
    f31 = ctx->fpr[31];
    f2.d = (-(f31.d));
    f0.d = MemoryInline::FlatReadFloat32((r25 + 360));
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFF7FE gpr_write=0xFFFFFFFF gpr_return=0x00000018 fpr_read=0xFFFFC006 fpr_write=0xFFFFFFFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x80583F2C func_80583F2C preserves=false fpr_mask=0xC0000000
