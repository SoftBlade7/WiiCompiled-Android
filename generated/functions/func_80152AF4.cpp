...
extern "C" void func_80152AF4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80152AF4:
{
    ...
    r3 = 5;
    r0 = 1;
    MemoryInline::FlatWrite8((r31 + 108), static_cast<uint8_t>(r3));
    r3 = r31;
    r4 = 0;
    MemoryInline::FlatWrite8((r31 + 113), static_cast<uint8_t>(r0));
    ctx->lr = 0x80152B18u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80152AF4 func_80152AF4 preserves=true fpr_mask=0x00000000
