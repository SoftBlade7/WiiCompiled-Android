...
extern "C" void func_8074A180(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = 0;
    MemoryInline::FlatWrite8((r3 + 840), static_cast<uint8_t>(r0));
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x8074A180 func_8074A180 preserves=true fpr_mask=0x00000000
