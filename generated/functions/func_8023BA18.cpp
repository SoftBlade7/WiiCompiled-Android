...
extern "C" void func_8023BA18(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8023BAB4:
{
    ...
    xer = ctx->xer;
    r31 = 0;
    MemoryInline::FlatWrite32((r27 + 196), r31);
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r27 + 200), r31);
    r3 = (r27 + 184);
    r4 = 0;
    ctx->lr = 0x8023BADCu;
    ctx->gpr[0] = r0;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8023C748u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8023BA18 func_8023BA18 preserves=true fpr_mask=0x00000000
