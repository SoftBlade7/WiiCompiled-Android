...
extern "C" void func_80740604(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80740604:
{
    ...
    r4 = 0x808D0000u;
    r26 = r3;
    r5 = MemoryInline::FlatRead16((r4 + -19842));
    r5 = (r5 << 16);
...
loc_80740664:
{
    ...
    r4 = 0x808A0000u;
    r3 = 0x808A0000u;
    f29.d = MemoryInline::FlatReadFloat32((r5 + -19840));
    f30.d = MemoryInline::FlatReadFloat64((r4 + 10464));
    r27 = r26;
    f31.d = MemoryInline::FlatReadFloat32((r3 + 10488));
    r28 = 0;
    r30 = 0x809C0000u;
    r31 = 1127219200;
    goto loc_807406C4;
...
// RECOMP_REGISTRATION base 0x80740604 func_80740604 preserves=false fpr_mask=0xE0000000
