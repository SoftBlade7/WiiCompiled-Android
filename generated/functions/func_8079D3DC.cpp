...
extern "C" void func_8079D3DC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8079D3DC:
{
    ...
    r31 = ctx->gpr[31];
    ctr = ctx->ctr;
    r10 = MemoryInline::FlatRead32((r31 + 20));
    r5 = 255;
    r0 = 3;
    r4 = 0;
    r12 = r10;
    ...
    r11 = 0;
    MemoryInline::FlatWrite8((r31 + 16), static_cast<uint8_t>(r5));
    MemoryInline::FlatWrite8((r31 + 17), static_cast<uint8_t>(r4));
    ctr = r0;
}
...
{
    r4 = 255;
    MemoryInline::FlatWrite8((r10 + 284), static_cast<uint8_t>(r4));
    r3 = 0;
    r0 = 3;
    r10 = MemoryInline::FlatRead32((r31 + 36));
    r11 = 0;
    MemoryInline::FlatWrite8((r31 + 32), static_cast<uint8_t>(r4));
    r12 = r10;
...
{
    r0 = 255;
    MemoryInline::FlatWrite8((r10 + 284), static_cast<uint8_t>(r0));
    r3 = 0;
    r4 = 0;
    r5 = 0;
    r6 = 1;
...
// RECOMP_REGISTRATION base 0x8079D3DC func_8079D3DC preserves=true fpr_mask=0x00000000
