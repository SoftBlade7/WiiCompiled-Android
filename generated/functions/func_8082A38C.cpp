...
extern "C" void func_8082A38C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_ca_0 = 0;
...
loc_8082A3D8:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8082C10Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8082A3FC:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x807F9278u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8082A4A4:
{
    ...
    r7 = 1;
    r6 = MemoryInline::FlatRead32((r4 + 2928));
...
loc_8082A4EC:
{
    MemoryInline::FlatWrite8((r31 + 85), static_cast<uint8_t>(r7));
    r3 = 0x809C0000u;
...
{
    r0 = 0;
    MemoryInline::FlatWriteRam32((r3 + 240), r0);
}
...
loc_8082A554:
{
    ...
    MemoryInline::FlatWriteRam32((r1 + 12), r4);
    r4 = 0x808B0000u;
    f4.d = MemoryInline::FlatReadFloat64((r4 + -14472));
    r0 = (r0 ^ -2147483648);
    ...
    r3 = r31;
    MemoryInline::FlatWriteFloat32((r31 + 292), f3.d);
    MemoryInline::FlatWriteFloat32((r31 + 296), f2.d);
    MemoryInline::FlatWriteFloat32((r31 + 300), f1.d);
...
// RECOMP_REGISTRATION base 0x8082A38C func_8082A38C preserves=true fpr_mask=0x00000000
