...
extern "C" void func_80097190(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80097190:
{
    ...
    ctx->gpr[6] = r6;
    ctx->gpr[7] = r7;
    InvokeDirectCpu<0x8009BEB0u>(ctx);
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
    r6 = ctx->gpr[6];
...
// RECOMP_REGISTRATION base 0x80097190 func_80097190 preserves=true fpr_mask=0x00000000
