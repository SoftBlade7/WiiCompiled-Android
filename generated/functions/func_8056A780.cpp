...
extern "C" void func_8056A780(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8056A780:
{
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 76u, ((static_cast<uint64_t>(static_cast<uint32_t>(r23)) << 32) | static_cast<uint32_t>(r24)))) {
...
loc_8056A7BC:
{
    ...
    r3 = (r4 | r5);
    r23 = 0;
    r25_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(1));
    r25 = (r25_rot_1 & 1);
    r24 = (r0 & 1);
    r26 = 0x808B0000u;
    r27 = 0x808B0000u;
...
loc_inl0_cont_8004EA50:
{
    ...
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r23), static_cast<uint32_t>(r3));
}
...
loc_8056A888:
{
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 76), 0, 44u, true, false);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r23 = MemoryInline::ReadResolved32(guest_range_1, 0u, (r1 + 76));
            r24 = MemoryInline::ReadResolved32(guest_range_1, 4u, (r1 + 80));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r25 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r1 + 84));
            r26 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r1 + 88));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r27 = MemoryInline::ReadResolved32(guest_range_1, 16u, (r1 + 92));
            r28 = MemoryInline::ReadResolved32(guest_range_1, 20u, (r1 + 96));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r29 = MemoryInline::ReadResolved32(guest_range_1, 24u, (r1 + 100));
            r30 = MemoryInline::ReadResolved32(guest_range_1, 28u, (r1 + 104));
        }
    }
    r31 = MemoryInline::ReadResolved32(guest_range_1, 32u, (r1 + 108));
    r0 = MemoryInline::ReadResolved32(guest_range_1, 40u, (r1 + 116));
    ctx->lr = r0;
    r1 = (r1 + 112);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x8056A780 func_8056A780 preserves=true fpr_mask=0x00000000
