...
extern "C" void func_806C692C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806C692C:
{
    ...
    f31 = ctx->fpr[31];
    r3 = 0x809C0000u;
    MemoryInline::FlatWriteRamFloat32((r3 + 8908), f31.d);
...
// RECOMP_GUEST_ABI gpr_read=0xC000000A gpr_write=0xC00007FB gpr_return=0x00000018 fpr_read=0x800001FE fpr_write=0x80000002 fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x806C692C func_806C692C preserves=false fpr_mask=0x80000000
