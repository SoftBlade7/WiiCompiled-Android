...
extern "C" void func_8068295C(CpuContext* MKW_RESTRICT ctx)
{
    goto loc_8068295C;

loc_8068295C:
{
    InvokeDirectCpu<0x806837BCu>(ctx);
    return;
}
...
// RECOMP_REGISTRATION base 0x8068295C func_8068295C preserves=true fpr_mask=0x00000000
