...
extern "C" void func_8080D970(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8080D970:
{
    r3 = 0x808B0000u;
    r4 = 0x808B0000u;
    f0.d = MemoryInline::FlatReadFloat32((r4 + -19964));
    r6 = 0x809C0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + -20288));
    r3 = (r6 + 16876);
    r4 = 0x80510000u;
    r5 = 0x809C0000u;
    MemoryInline::FlatWriteRamFloat32((r6 + 16876), f1.d);
    r4 = (r4 + 13824);
    r5 = (r5 + 16864);
...
// RECOMP_REGISTRATION base 0x8080D970 func_8080D970 preserves=true fpr_mask=0x00000000
