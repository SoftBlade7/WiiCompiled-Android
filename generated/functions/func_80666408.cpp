...
extern "C" void func_80666408(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80666508:
{
    r0 = MemoryInline::FlatRead8((r29 + 1612));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_8066656C:
{
    ...
    MemoryInline::FlatWrite32((r29 + 1812), r3);
    r3 = r30;
    r5 = (r29 + 1812);
    r4 = 6609;
    r12 = MemoryInline::FlatRead32(r30);
...
// RECOMP_REGISTRATION base 0x80666408 func_80666408 preserves=true fpr_mask=0x00000000
