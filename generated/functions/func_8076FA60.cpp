...
extern "C" void func_8076FA60(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8076FA60:
{
    ...
    MemoryInline::FlatWriteRamFloat32((r1 + 276), f2.d);
    f31.d = MemoryInline::FlatReadFloat32((r31 + 28));
    MemoryInline::FlatWriteRamFloat32((r1 + 280), f2.d);
    MemoryInline::FlatWriteRamFloat32((r1 + 284), f2.d);
    MemoryInline::FlatWriteRamFloat32((r1 + 288), f2.d);
...
loc_8076FB20:
{
    r3 = 0x808D0000u;
    r0 = 1127219200;
    f0.d = MemoryInline::FlatReadFloat32((r3 + -3380));
    ...
    MemoryInline::FlatWriteFloat32((r30 + 196), f4.d);
    f1.d = PpcFmulsInline(f1.d, f0.d);
    MemoryInline::FlatWriteFloat32((r30 + 188), f2.d);
    ...
    f1.d = MemoryInline::FlatReadFloat64((r1 + 368));
...
loc_8076FC48:
{
    r3 = 0x808D0000u;
    f1.d = MemoryInline::FlatReadFloat32((r30 + 188));
    f0.d = MemoryInline::FlatReadFloat32((r3 + -3372));
    SetCRFloatResident(cr, 0, f1.d, f0.d);
}
...
loc_8076FC78:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r5 = MemoryInline::FlatRead32((r1 + 312));
    r3 = (r1 + 92);
    r4 = MemoryInline::FlatRead32((r1 + 316));
...
// RECOMP_REGISTRATION base 0x8076FA60 func_8076FA60 preserves=false fpr_mask=0x80000000
