...
extern "C" void func_80729188(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807291CC:
{
    ...
    r4 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r29 + 420));
    r7 = (r7 + 9400);
...
// RECOMP_REGISTRATION base 0x80729188 func_80729188 preserves=true fpr_mask=0x00000000
