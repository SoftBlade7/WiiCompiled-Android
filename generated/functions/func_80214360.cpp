...
extern "C" void func_80214360(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_802143E4:
{
    r31 = MemoryInline::FlatRead32((r3 + 252));
    r29 = 0;
    r30 = 0;
    goto loc_80214434;
}
...
loc_8021443C:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80213C48u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80214360 func_80214360 preserves=true fpr_mask=0x00000000
