...
extern "C" void func_80187E88(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r4 = (r4 + 1);
    r0 = MemoryInline::FlatRead16((r3 + 248));
...
loc_80187EE8:
{
    MemoryInline::FlatWrite16((r30 + 248), static_cast<uint16_t>(r31));
}
...
// RECOMP_REGISTRATION base 0x80187E88 func_80187E88 preserves=true fpr_mask=0x00000000
