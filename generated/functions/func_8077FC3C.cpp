...
extern "C" void func_8077FC3C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8077FEC8:
{
    r6 = MemoryInline::FlatRead32((r30 + 240));
    r3 = 0x808A0000u;
...
// RECOMP_REGISTRATION base 0x8077FC3C func_8077FC3C preserves=true fpr_mask=0x00000000
