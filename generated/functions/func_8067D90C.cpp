...
extern "C" void func_8067D90C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8067D92C:
{
    r5 = 0x809C0000u;
    r4 = 538968064;
    r5 = MemoryInline::FlatRead32((r5 + 6216));
    r26 = (r4 + 8224);
    r31 = r27;
    r28 = 0;
    r4 = MemoryInline::FlatRead32((r5 + 16));
    r29 = MemoryInline::FlatRead32((r4 + 104));
    r0 = (r29 * 200);
    r30 = (r3 + r0);
    goto loc_8067DA34;
}
...
loc_8067D9B4:
{
    r4 = (r4 * 200);
    r0 = (r28 + r27);
    r3 = MemoryInline::FlatRead32((r31 + 920));
    r4 = (r4 + r0);
    r3 = (r3 + 116);
    r24 = MemoryInline::FlatRead8((r4 + 1720));
...
loc_8067DA24:
{
    MemoryInline::FlatWrite8((r30 + 1720), static_cast<uint8_t>(r25));
    r31 = (r31 + 4);
    r30 = (r30 + 1);
    r28 = (r28 + 1);
}
...
// RECOMP_REGISTRATION base 0x8067D90C func_8067D90C preserves=true fpr_mask=0x00000000
