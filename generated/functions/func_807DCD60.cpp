...
extern "C" void func_807DCD60(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807DCD60:
{
    ...
    f5.d = MemoryInline::FlatReadFloat32(r3);
    f4.d = (-(f2.d));
...
// RECOMP_REGISTRATION base 0x807DCD60 func_807DCD60 preserves=true fpr_mask=0x00000000
