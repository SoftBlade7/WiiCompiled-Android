...
extern "C" void func_805B1F2C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805B1F2C:
{
    ...
    f30.d = MemoryInline::FlatReadFloat32((r31 + 12));
...
// RECOMP_GUEST_ABI gpr_read=0x80000002 gpr_write=0x800003FB gpr_return=0x00000018 fpr_read=0xE0000001 fpr_write=0xE0000001 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x805B1F2C func_805B1F2C preserves=false fpr_mask=0xE0000000
