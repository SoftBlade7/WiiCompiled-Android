...
extern "C" void func_800DF094(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800DF094:
{
    ...
    MemoryInline::FlatWrite32((r3 + 1916), r30);
    r3 = MemoryInline::FlatRead32((r13 + -26868));
    MemoryInline::FlatWrite8((r3 + 1824), static_cast<uint8_t>(r30));
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->xer = xer;
...
loc_800DF2B4:
{
    ...
    r4 = -65536;
    r3 = 6;
    MemoryInline::FlatWrite8((r5 + 1825), static_cast<uint8_t>(r30));
    r4 = (r4 + -14874);
...
loc_inl0_cont_800CCC68:
{
    ...
    r28_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(27));
...
// RECOMP_REGISTRATION base 0x800DF094 func_800DF094 preserves=true fpr_mask=0x00000000
