...
extern "C" void func_806E6F6C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806E6FE0:
{
    ...
    MemoryInline::FlatWriteFloat32((r28 + 280), f1.d);
    f1.d = PpcFmulsInline(f1.d, f1.d);
    f3.d = MemoryInline::FlatReadFloat32((r1 + 28));
    MemoryInline::FlatWriteFloat32((r28 + 284), f3.d);
...
loc_806E7040:
{
    f2.d = MemoryInline::FlatReadFloat32((r28 + 1196));
    f1.d = MemoryInline::FlatReadFloat32((r28 + 1200));
    f0.d = MemoryInline::FlatReadFloat32((r28 + 1204));
    MemoryInline::FlatWriteFloat32((r28 + 276), f2.d);
    MemoryInline::FlatWriteFloat32((r28 + 280), f1.d);
...
loc_806E7064:
{
    ...
    MemoryInline::FlatWriteFloat32((r28 + 292), f1.d);
    f1.d = PpcFmulsInline(f1.d, f1.d);
    f3.d = MemoryInline::FlatReadFloat32((r1 + 16));
    MemoryInline::FlatWriteFloat32((r28 + 296), f3.d);
    f3.d = PpcFmulsInline(f3.d, f3.d);
    f1.d = static_cast<double>(PpcForceSingleValueInline(f2.d + f1.d));
    f1.d = static_cast<double>(PpcForceSingleValueInline(f3.d + f1.d));
    SetCRFloatResident(cr, 0, f1.d, f0.d);
...
loc_806E70BC:
{
    ...
    MemoryInline::FlatWriteFloat32((r28 + 288), f1.d);
    MemoryInline::FlatWriteFloat32((r28 + 292), f0.d);
    MemoryInline::FlatWriteFloat32((r28 + 296), f1.d);
    goto loc_806E70DC;
}
...
loc_806E70DC:
{
    r0 = MemoryInline::FlatRead8((r28 + 1172));
}
...
loc_806E70E8:
{
    r0 = MemoryInline::FlatRead8((r28 + 1240));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_806E70F4:
{
    f2.d = MemoryInline::FlatReadFloat32((r28 + 276));
    f0.d = MemoryInline::FlatReadFloat32((r29 + 132));
    f1.d = MemoryInline::FlatReadFloat32((r28 + 284));
...
loc_806E7124:
{
    ...
    r3 = 0x808C0000u;
    MemoryInline::FlatWriteRamFloat32((r3 + 30656), f0.d);
    r3 = (r1 + 104);
    r4 = (r28 + 1104);
    r5 = (r28 + 1140);
    ...
    r3 = (r1 + 44);
    MemoryInline::FlatWriteFloat32((r28 + 1184), f0.d);
    r4 = (r28 + 1184);
    f1.d = MemoryInline::FlatReadFloat32((r28 + 52));
    r5 = (r28 + 48);
    f0.d = MemoryInline::FlatReadFloat32((r1 + 60));
    MemoryInline::FlatWriteFloat32((r28 + 1188), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r1 + 64));
    MemoryInline::FlatWriteFloat32((r28 + 1192), f0.d);
    ...
    r3 = (r28 + 1196);
    MemoryInline::FlatWriteFloat32((r28 + 1196), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r30 + 4));
    f1.d = MemoryInline::FlatReadFloat32((r1 + 48));
    MemoryInline::FlatWriteFloat32((r28 + 1200), f1.d);
    f1.d = MemoryInline::FlatReadFloat32((r1 + 52));
    MemoryInline::FlatWriteFloat32((r28 + 1204), f1.d);
    MemoryInline::FlatWriteFloat32((r28 + 1200), f0.d);
    ctx->lr = 0x806E71F0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    f1.d = MemoryInline::FlatReadFloat32((r28 + 1104));
    r0 = (r0 | 1);
    MemoryInline::FlatWrite16((r28 + 44), static_cast<uint16_t>(r0));
    f0.d = MemoryInline::FlatReadFloat32((r28 + 1112));
    r5 = (r1 + 80);
    ...
    f4.d = MemoryInline::FlatReadFloat32((r30 + 4));
...
loc_806E72F8:
{
    r5 = MemoryInline::FlatRead32((r28 + 1232));
    r0 = 1;
    MemoryInline::FlatWrite8((r28 + 1240), static_cast<uint8_t>(r0));
...
loc_806E730C:
{
    r31 = 0x809C0000u;
    r4 = (r28 + 48);
    r3 = MemoryInline::FlatRead32((r31 + 12088));
    r6 = 30;
    r7 = 0;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_806E7348:
{
    f3.d = MemoryInline::FlatReadFloat32((r30 + 4));
    r4 = 4;
    MemoryInline::FlatWriteFloat32((r28 + 248), f3.d);
    f1.d = MemoryInline::FlatReadFloat32((r28 + 244));
    f2.d = MemoryInline::FlatReadFloat32((r29 + 136));
    f0.d = MemoryInline::FlatReadFloat32((r28 + 252));
    f4.d = (-(f2.d));
    r3 = MemoryInline::FlatRead32((r28 + 8));
    f2.d = PpcFmulsInline(f1.d, f4.d);
    f1.d = PpcFmulsInline(f3.d, f4.d);
    f0.d = PpcFmulsInline(f0.d, f4.d);
    MemoryInline::FlatWriteFloat32((r28 + 244), f2.d);
    MemoryInline::FlatWriteFloat32((r28 + 248), f1.d);
    MemoryInline::FlatWriteFloat32((r28 + 252), f0.d);
...
// RECOMP_REGISTRATION base 0x806E6F6C func_806E6F6C preserves=false fpr_mask=0x80000000
