...
extern "C" void func_807DEE8C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807DEE8C:
{
    ...
    MemoryInline::FlatWriteFloat32((r31 + 8), f5.d);
    MemoryInline::FlatWriteFloat32((r31 + 24), f4.d);
    MemoryInline::FlatWriteFloat32((r31 + 40), f3.d);
...
// RECOMP_REGISTRATION base 0x807DEE8C func_807DEE8C preserves=true fpr_mask=0x00000000
