...
extern "C" void func_8016A3FC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8016A488:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32(r30, r22);
    r9 = 0x80170000u;
    r5 = r30;
    r10 = r30;
    MemoryInline::FlatWrite16((r30 + 4), static_cast<uint16_t>(r23));
    r9 = (r9 + -25356);
    r4 = 5;
    r6 = 76;
    MemoryInline::FlatWrite8((r30 + 73), static_cast<uint8_t>(r24));
    r7 = 0;
    r8 = 0;
    MemoryInline::FlatWrite8((r30 + 70), static_cast<uint8_t>(r25));
    MemoryInline::FlatWrite8((r30 + 71), static_cast<uint8_t>(r26));
    MemoryInline::FlatWrite8((r30 + 72), static_cast<uint8_t>(r27));
...
// RECOMP_REGISTRATION base 0x8016A3FC func_8016A3FC preserves=true fpr_mask=0x00000000
