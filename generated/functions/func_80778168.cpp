...
extern "C" void func_80778168(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80778168:
{
    ...
    r31 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r31 + 17024));
    MemoryInline::FlatWriteRam32((r1 + 24), r30);
    r30 = 0x808D0000u;
    MemoryInline::FlatWriteRam32((r1 + 20), r29);
    r29 = r3;
    r3 = MemoryInline::FlatRead32((r3 + 8));
    f2.d = MemoryInline::FlatReadFloat32((r30 + 868));
...
// RECOMP_REGISTRATION base 0x80778168 func_80778168 preserves=true fpr_mask=0x00000000
