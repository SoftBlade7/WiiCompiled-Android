...
extern "C" void func_805E08B4(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = 0;
    MemoryInline::FlatWrite32((r3 + 2824), r0);
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x805E08B4 func_805E08B4 preserves=true fpr_mask=0x00000000
