...
extern "C" void func_80104998(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80104AC0:
{
    r6 = MemoryInline::FlatRead32((r29 + 416));
    r7 = r30;
    r3 = (r1 + 136);
    r5 = (r29 + 375);
    r4 = (r13 + -30824);
...
loc_80104B54:
{
    ...
    xer = ctx->xer;
    r0 = 105;
    MemoryInline::FlatWrite32((r28 + 16), r30);
    MemoryInline::FlatWrite32(r28, r0);
    goto loc_80104B94;
}
...
// RECOMP_REGISTRATION base 0x80104998 func_80104998 preserves=true fpr_mask=0x00000000
