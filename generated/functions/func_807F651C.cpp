...
extern "C" void func_807F651C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807F65A4:
{
    if ((static_cast<int32_t>(r3) != static_cast<int32_t>(49))) {
        goto loc_807F65AC;
    }
}
...
loc_807F6610:
{
    ...
    r12 = (r31 + 80);
    r3 = 0x808B0000u;
    r23 = MemoryInline::FlatRead32((r31 + 80));
    r25 = (r3 + -23056);
    guest_range_1 = MemoryInline::ResolveRangeHost((r12 + 4), 0, 44u, true, false);
    r24 = MemoryInline::ReadResolved32(guest_range_1, 0u, (r12 + 4));
    r30 = (r27 + 496);
    r11 = MemoryInline::ReadResolved32(guest_range_1, 4u, (r12 + 8));
    r29 = 0;
    r10 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r12 + 12));
    r28 = 0;
    r9 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r12 + 16));
    r26 = 0;
    {
        ...
        if (resolved_pair.valid) {
            ...
            r8 = MemoryInline::ReadResolved32(guest_range_1, 16u, (r12 + 20));
            r7 = MemoryInline::ReadResolved32(guest_range_1, 20u, (r12 + 24));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_1, 24u, (r12 + 28));
            r5 = MemoryInline::ReadResolved32(guest_range_1, 28u, (r12 + 32));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r4 = MemoryInline::ReadResolved32(guest_range_1, 32u, (r12 + 36));
            r3 = MemoryInline::ReadResolved32(guest_range_1, 36u, (r12 + 40));
        }
    }
    r0 = MemoryInline::ReadResolved32(guest_range_1, 40u, (r12 + 44));
    guest_range_3 = MemoryInline::ResolveRangeHost((r1 + 128), 0, 48u, false, true);
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 0u, ((static_cast<uint64_t>(static_cast<uint32_t>(r23)) << 32) | static_cast<uint32_t>(r24)))) {
        MemoryInline::WriteResolved32(guest_range_3, 0u, (r1 + 128), r23);
        MemoryInline::WriteResolved32(guest_range_3, 4u, (r1 + 132), r24);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 8u, ((static_cast<uint64_t>(static_cast<uint32_t>(r11)) << 32) | static_cast<uint32_t>(r10)))) {
        MemoryInline::WriteResolved32(guest_range_3, 8u, (r1 + 136), r11);
        MemoryInline::WriteResolved32(guest_range_3, 12u, (r1 + 140), r10);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 16u, ((static_cast<uint64_t>(static_cast<uint32_t>(r9)) << 32) | static_cast<uint32_t>(r8)))) {
        MemoryInline::WriteResolved32(guest_range_3, 16u, (r1 + 144), r9);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r7)) << 32) | static_cast<uint32_t>(r6)))) {
        MemoryInline::WriteResolved32(guest_range_3, 24u, (r1 + 152), r7);
        MemoryInline::WriteResolved32(guest_range_3, 28u, (r1 + 156), r6);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 32u, ((static_cast<uint64_t>(static_cast<uint32_t>(r5)) << 32) | static_cast<uint32_t>(r4)))) {
        MemoryInline::WriteResolved32(guest_range_3, 32u, (r1 + 160), r5);
        MemoryInline::WriteResolved32(guest_range_3, 36u, (r1 + 164), r4);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 40u, ((static_cast<uint64_t>(static_cast<uint32_t>(r3)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_3, 40u, (r1 + 168), r3);
        MemoryInline::WriteResolved32(guest_range_3, 44u, (r1 + 172), r0);
    }
}
...
loc_807F6698:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead32((r27 + 492));
...
loc_807F6724:
{
    ...
    MemoryInline::FlatWrite32((r27 + 2732), r26);
    r3 = r30;
    r4 = (r25 + 135);
    r6 = (r27 + 2732);
    r5 = 1313;
...
loc_807F67EC:
{
    ...
    r31 = ctx->gpr[31];
    f1 = ctx->fpr[1];
    MemoryInline::FlatWriteRam32(r23, r30);
}
...
loc_807F67F4:
{
    ...
    r7 = ctx->gpr[7];
    r8 = ctx->gpr[8];
    r4 = MemoryInline::FlatRead32((r27 + 492));
    r3 = r23;
    r5 = r24;
    ctx->lr = 0x807F6818u;
    ctx->gpr[0] = r0;
...
loc_807F6850:
{
    MemoryInline::FlatWrite32((r27 + 2728), r5);
    r4 = r29;
    r3 = r27;
    r29 = (r29 + 1);
    ctx->gpr[0] = r0;
    ...
    r7 = ctx->gpr[7];
    r8 = ctx->gpr[8];
    r4 = MemoryInline::FlatRead32((r27 + 2728));
    r3 = (r1 + 48);
    // inline leaf 0x805C2C18 (2 guest instruction(s))
    MemoryInline::FlatWriteRam32(r3, r4);
    // end of inlined leaf 0x805C2C18
...
loc_807F68B4:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r27 + 2728));
    r4 = 0;
    r3 = (r3 + 152);
    // inline leaf 0x8063C820 (4 guest instruction(s))
    r0 = (r4 * 68);
...
loc_807F693C:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(49));
}
...
loc_807F697C:
{
    ...
    r31 = ctx->gpr[31];
    f1 = ctx->fpr[1];
    MemoryInline::FlatWriteRam32(r23, r28);
}
...
loc_807F6984:
{
    ...
    r24 = (r27 + r0);
    r3 = r27;
    MemoryInline::FlatWrite32((r24 + 2936), r23);
    r5 = r23;
    r29 = (r29 + 1);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    r7 = ctx->gpr[7];
    r8 = ctx->gpr[8];
    r3 = MemoryInline::FlatRead32((r24 + 2936));
    r5 = (r25 & 255);
    r4 = MemoryInline::FlatRead32((r27 + 492));
    ctx->lr = 0x807F69B4u;
    ctx->gpr[0] = r0;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x807F7468u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x807F651C func_807F651C preserves=true fpr_mask=0x00000000
