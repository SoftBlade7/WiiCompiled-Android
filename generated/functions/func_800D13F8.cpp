...
extern "C" void func_800D13F8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
{
    r3 = MemoryInline::FlatRead32((r13 + -26896));
    MemoryInline::FlatWrite32((r3 + 116), r30);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_800D14AC;
    }
}
...
loc_800D14B4:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800CE020u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    cr = ctx->cr;
...
loc_800D14E8:
{
    r6 = MemoryInline::FlatRead32((r13 + -26896));
    r30 = r3;
...
loc_800D1500:
{
    ...
    r3 = (r31 + 216);
    r4 = (r4 + r0);
    MemoryInline::FlatWrite16((r4 + 48), static_cast<uint16_t>(r5));
    ctx->lr = 0x800D151Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_800D1554:
{
    ...
    r30 = (r0 + 13856);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r0)) + static_cast<uint64_t>(static_cast<uint32_t>(13856)) + (static_cast<uint64_t>(static_cast<uint32_t>(0)) & 1u);
...
{
    r4 = (r7 * r5);
    r7 = (static_cast<int32_t>(static_cast<int8_t>(r3)));
    r0 = 0;
...
loc_800D168C:
{
    if ((static_cast<int32_t>(r7) < static_cast<int32_t>(256))) {
        goto loc_800D1694;
    }
}
...
loc_800D16BC:
{
    ...
    r0 = (r3 + -13107);
    r4 = (r31 + 572);
    r0 = (static_cast<uint32_t>((static_cast<uint64_t>(r0) * static_cast<uint64_t>(r7)) >> 32));
    r3 = (r1 + 8);
    r5 = (r5 + 13856);
...
loc_800D170C:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800F38A4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x800D13F8 func_800D13F8 preserves=true fpr_mask=0x00000000
