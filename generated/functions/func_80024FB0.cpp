...
extern "C" void func_80024FB0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80024FB0:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r13 + -27440), r3);
    r4 = 0;
    ctx->lr = 0x80024FE4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    r31 = ctx->gpr[31];
    cr = ctx->cr;
    r3 = MemoryInline::FlatRead32((r13 + -27440));
    r4 = 28;
    r5 = 4;
    ctx->lr = 0x80024FF4u;
    ctx->gpr[0] = r0;
...
loc_80025000:
{
    ...
    MemoryInline::WriteResolved8(guest_range_0, 24u, (r3 + 24), static_cast<uint8_t>(r8));
    r3 = (r3 + 4);
...
loc_80025050:
{
    MemoryInline::FlatWrite32((r13 + -27436), r31);
...
// RECOMP_REGISTRATION base 0x80024FB0 func_80024FB0 preserves=true fpr_mask=0x00000000
