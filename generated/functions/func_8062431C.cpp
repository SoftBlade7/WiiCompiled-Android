...
extern "C" void func_8062431C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8062432C:
{
    ...
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80615044u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
}
...
// RECOMP_REGISTRATION base 0x8062431C func_8062431C preserves=true fpr_mask=0x00000000
