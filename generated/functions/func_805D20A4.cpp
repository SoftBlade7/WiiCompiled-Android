...
extern "C" void func_805D20A4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805D2160:
{
    r3 = MemoryInline::FlatRead32((r25 + 8464));
    r4 = r29;
    ctx->lr = 0x805D216Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_805D2174:
{
    MemoryInline::FlatWrite32((r30 + 464), r26);
    goto loc_805D2190;
}

loc_805D217C:
{
    MemoryInline::FlatWrite32((r30 + 464), r27);
    goto loc_805D2190;
}
...
loc_805D2184:
{
    ...
    MemoryInline::FlatWrite32((r30 + 464), r28);
}
...
// RECOMP_GUEST_ABI gpr_read=0xFF00007B gpr_write=0xFF00007B gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x805D20A4 func_805D20A4 preserves=true fpr_mask=0x00000000
