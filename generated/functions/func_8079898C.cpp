...
extern "C" void func_8079898C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807989B0:
{
    ...
    r3 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 20912));
...
// RECOMP_GUEST_ABI gpr_read=0xFF80003B gpr_write=0xFF80083B gpr_return=0x00000018 fpr_read=0xC000000F fpr_write=0xC000000F fpr_return=0x00000002 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8079898C func_8079898C preserves=true fpr_mask=0x00000000
