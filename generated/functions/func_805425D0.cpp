...
extern "C" void func_805425D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805425D0:
{
    ...
    r28 = r3;
    r3 = 3;
    r29 = MemoryInline::FlatRead32((r5 + -10440));
    r30 = MemoryInline::FlatRead32((r29 + 1556));
    ...
    MemoryInline::FlatWrite8((r29 + 1548), static_cast<uint8_t>(r31));
...
// RECOMP_REGISTRATION base 0x805425D0 func_805425D0 preserves=true fpr_mask=0x00000000
