...
extern "C" void func_800C5500(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800C5528:
{
    ...
    r3 = 64;
    r30_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(6));
    r30 = (r30_rot_0 & -64);
    ctx->lr = 0x800C5538u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x800C5500 func_800C5500 preserves=true fpr_mask=0x00000000
