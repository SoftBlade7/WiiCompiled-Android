...
extern "C" void func_807C4B40(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807C4BA0:
{
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x807C1DE8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_807C4BF4:
{
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x807C36CCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
{
    r0 = (r5 & 31);
    r4 = PPC_Slw(static_cast<uint32_t>(r28), static_cast<uint32_t>(r0));
    if (((cr & 0x20000000u) != 0)) {
        goto loc_807C4C94;
    }
}
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFFFFF gpr_write=0xFFF01FFB gpr_return=0x00000018 fpr_read=0xFFFFFFFF fpr_write=0xE00003FF fpr_return=0x00000002 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=0 fence=1
// RECOMP_REGISTRATION base 0x807C4B40 func_807C4B40 preserves=false fpr_mask=0xC0000000
