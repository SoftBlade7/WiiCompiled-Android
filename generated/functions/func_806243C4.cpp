...
extern "C" void func_806243C4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806243D4:
{
    ...
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x806446B8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
}
...
// RECOMP_REGISTRATION base 0x806243C4 func_806243C4 preserves=true fpr_mask=0x00000000
