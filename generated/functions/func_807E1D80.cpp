...
extern "C" void func_807E1D80(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807E1E00:
{
    ...
    r4 = (r1 + 8);
    r10 = MemoryInline::FlatRead32((r30 + 16));
    r5 = (r29 + 428);
...
// RECOMP_REGISTRATION base 0x807E1D80 func_807E1D80 preserves=true fpr_mask=0x00000000
