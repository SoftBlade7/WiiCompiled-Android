...
extern "C" void func_8007A540(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8007A540:
{
    ...
    ctx->gpr[30] = r30;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x80083440u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8007A540 func_8007A540 preserves=true fpr_mask=0x00000000
