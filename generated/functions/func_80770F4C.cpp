...
extern "C" void func_80770F4C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80770FA0:
{
    r0 = MemoryInline::FlatRead8((r31 + 212));
...
loc_80770FD8:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    f4.d = MemoryInline::FlatReadFloat32((r29 + 12));
    r3 = r31;
    ...
    MemoryInline::FlatWriteRamFloat64((r1 + 160), f2.d);
    r5 = (r1 + 44);
...
loc_807710F0:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80771624u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
    ...
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 8u, (r1 + 112));
    MemoryInline::FlatWriteFloat32((r31 + 96), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 12u, (r1 + 116));
    MemoryInline::FlatWriteFloat32((r31 + 100), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 16u, (r1 + 120));
    MemoryInline::FlatWriteFloat32((r31 + 104), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 20u, (r1 + 124));
    MemoryInline::FlatWriteFloat32((r31 + 108), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 24u, (r1 + 128));
    MemoryInline::FlatWriteFloat32((r31 + 112), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 28u, (r1 + 132));
    MemoryInline::FlatWriteFloat32((r31 + 116), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 32u, (r1 + 136));
    MemoryInline::FlatWriteFloat32((r31 + 120), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 36u, (r1 + 140));
    MemoryInline::FlatWriteFloat32((r31 + 124), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 40u, (r1 + 144));
    ...
    MemoryInline::FlatWriteFloat32((r31 + 132), f0.d);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r31 = MemoryInline::ReadResolved32(guest_range_1, 84u, (r1 + 188));
            r30 = MemoryInline::ReadResolved32(guest_range_1, 80u, (r1 + 184));
        }
    }
    r29 = MemoryInline::ReadResolved32(guest_range_1, 76u, (r1 + 180));
...
// RECOMP_REGISTRATION base 0x80770F4C func_80770F4C preserves=true fpr_mask=0x00000000
