...
extern "C" void func_8014BD34(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8014BD34:
{
    ...
    r5 = MemoryInline::FlatRead16((r25 + 20));
    r6 = MemoryInline::FlatRead16((r25 + 22));
    ctx->lr = 0x8014BD48u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8014BD34 func_8014BD34 preserves=true fpr_mask=0x00000000
