...
extern "C" void func_8076DAF4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8076DCD4:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r3 + 15792));
    r0 = (r0 | 1);
...
// RECOMP_REGISTRATION base 0x8076DAF4 func_8076DAF4 preserves=true fpr_mask=0x00000000
