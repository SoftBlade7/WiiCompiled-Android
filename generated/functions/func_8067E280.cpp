...
extern "C" void func_8067E280(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8067E280:
{
    ...
    r4 = 0x808A0000u;
    r3 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r4 + -11768));
    r4 = 0x808C0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + -11764));
    r4 = (r4 + 4616);
...
// RECOMP_REGISTRATION base 0x8067E280 func_8067E280 preserves=true fpr_mask=0x00000000
