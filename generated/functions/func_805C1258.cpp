...
extern "C" void func_805C1258(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805C128C:
{
    r0 = MemoryInline::FlatRead8((r3 + 3224));
...
// RECOMP_REGISTRATION base 0x805C1258 func_805C1258 preserves=true fpr_mask=0x00000000
