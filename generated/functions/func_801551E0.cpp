...
extern "C" void func_801551E0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8015522C:
{
    ...
    r0 = 1;
    r30 = (r31 + 21);
    MemoryInline::FlatWriteRam8((r3 + 18), static_cast<uint8_t>(r4));
    MemoryInline::FlatWriteRam8((r3 + 19), static_cast<uint8_t>(r0));
    MemoryInline::FlatWriteRam8((r3 + 20), static_cast<uint8_t>(r29));
    r3 = 2;
...
// RECOMP_REGISTRATION base 0x801551E0 func_801551E0 preserves=true fpr_mask=0x00000000
