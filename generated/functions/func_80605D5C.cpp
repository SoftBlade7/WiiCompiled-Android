...
extern "C" void func_80605D5C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80605D5C:
{
    MemoryInline::FlatWrite32((r3 + 500), r4);
    return;
}
...
// RECOMP_REGISTRATION base 0x80605D5C func_80605D5C preserves=true fpr_mask=0x00000000
