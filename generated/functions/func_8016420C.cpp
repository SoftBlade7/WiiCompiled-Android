...
extern "C" void func_8016420C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80164270:
{
    MemoryInline::FlatWrite8((r27 + 6), static_cast<uint8_t>(r30));
    r11 = (r1 + 32);
    r3 = r27;
...
// RECOMP_REGISTRATION base 0x8016420C func_8016420C preserves=true fpr_mask=0x00000000
