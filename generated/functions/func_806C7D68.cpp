...
extern "C" void func_806C7D68(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r3 = 0x809C0000u;
    r3 = MemoryInline::FlatRead8((r3 + 8664));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x806C7D68 func_806C7D68 preserves=true fpr_mask=0x00000000
