...
extern "C" void func_8081FD10(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8081FDD8:
{
    r3 = MemoryInline::FlatRead8((r30 + 153));
}
...
loc_8081FDE4:
{
    r0 = MemoryInline::FlatRead8((r30 + 154));
...
{
    r0 = 1;
    MemoryInline::FlatWrite8((r30 + 144), static_cast<uint8_t>(r0));
    r3 = 76;
    ctx->lr = 0x8081FEB0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80820158:
{
    r12 = MemoryInline::FlatRead32(r30);
    r3 = r30;
    r12 = MemoryInline::FlatRead32((r12 + 168));
    ctr = r12;
    ctx->lr = 0x8082016Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80820180:
{
    r0 = MemoryInline::FlatRead8((r30 + 138));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_808201DC:
{
    ...
    r5 = (r30 + 20);
    r4 = MemoryInline::FlatRead32((r30 + 148));
    r6 = 0;
    ctx->lr = 0x808201F0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
{
    r0 = 1;
    MemoryInline::FlatWrite8((r30 + 155), static_cast<uint8_t>(r0));
}
...
{
    r0 = 1;
    MemoryInline::FlatWrite8((r30 + 156), static_cast<uint8_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x8081FD10 func_8081FD10 preserves=true fpr_mask=0x00000000
