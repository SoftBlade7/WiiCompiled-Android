...
extern "C" void func_8013E4D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r4_rot_0 = 0;
    uint32_t r4_rot_1 = 0;
...
loc_8013E544:
{
    r0 = MemoryInline::FlatRead8((r28 + 10176));
...
loc_8013E550:
{
    r6 = MemoryInline::FlatRead8((r28 + 6409));
    r3 = (r30 + 2);
    r4 = (r31 + 16076);
    ctx->lr = 0x8013E560u;
    ctx->gpr[0] = r0;
...
loc_8013E560:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead8((r28 + 6408));
...
loc_8013E574:
{
    r0 = MemoryInline::FlatRead16((r26 + 32));
    r3 = (r29 & 65535);
    r4_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(5));
    r4 = (r4_rot_2 & 224);
    ctx->lr = 0x8013E584u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80144948u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8013E594:
{
    r0 = MemoryInline::FlatRead8((r28 + 1590));
    r3 = MemoryInline::FlatRead16((r28 + 1622));
    r4 = MemoryInline::FlatRead16((r26 + 32));
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r0), static_cast<uint32_t>(3));
}
...
loc_8013E5CC:
{
    ...
    r3 = (r30 + 2);
    r6 = MemoryInline::FlatRead32((r26 + 24));
    r4 = (r21 + 15996);
    r7 = MemoryInline::FlatRead16((r26 + 28));
    r10 = (r20 & 65535);
    r8 = MemoryInline::FlatRead16((r26 + 30));
    r9 = MemoryInline::FlatRead8((r26 + 34));
    ctx->lr = 0x8013E5F0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_8013E5F0:
{
    ...
    r3 = (r29 & 65535);
    r5 = MemoryInline::FlatRead32((r26 + 24));
    r9 = (r20 & 65535);
    r6 = MemoryInline::FlatRead16((r26 + 28));
    r7 = MemoryInline::FlatRead16((r26 + 30));
    r8 = MemoryInline::FlatRead8((r26 + 34));
    ctx->lr = 0x8013E610u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_8013E620:
{
    MemoryInline::FlatWrite16((r26 + 32), static_cast<uint16_t>(r20));
}
...
loc_8013E630:
{
    MemoryInline::FlatWrite16((r26 + 8), static_cast<uint16_t>(r22));
}
...
// RECOMP_REGISTRATION base 0x8013E4D0 func_8013E4D0 preserves=true fpr_mask=0x00000000
