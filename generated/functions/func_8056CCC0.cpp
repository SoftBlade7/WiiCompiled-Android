...
extern "C" void func_8056CCC0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8056CCC0:
{
    ...
    r0 = MemoryInline::FlatRead16((r26 + 14));
...
loc_8056CD34:
{
    ...
    MemoryInline::FlatWriteRam32((r28 + 148), r29);
    MemoryInline::FlatWriteRam8((r28 + 152), static_cast<uint8_t>(r31));
}

loc_8056CD4C:
{
    r3 = MemoryInline::FlatRead32((r25 + 568));
...
loc_8056CD5C:
{
    r0 = MemoryInline::FlatRead16((r25 + 572));
    r3 = (r27 & 255);
...
// RECOMP_REGISTRATION base 0x8056CCC0 func_8056CCC0 preserves=true fpr_mask=0x00000000
