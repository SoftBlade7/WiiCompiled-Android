...
extern "C" void func_8019CB80(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
...
{
    r0 = 0;
    MemoryInline::FlatWrite8((r28 + 136), static_cast<uint8_t>(r27));
    r4 = r25;
    r3 = (r28 + 8);
    MemoryInline::FlatWrite8((r28 + 137), static_cast<uint8_t>(r0));
    ctx->lr = 0x8019CBF4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_8019CC14:
{
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r27), static_cast<uint32_t>(1));
}
...
loc_8019CC1C:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8016AE5Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
{
    r0 = 3;
    MemoryInline::FlatWrite8((r28 + 138), static_cast<uint8_t>(r0));
    goto loc_8019CC58;
}
...
loc_8019CD2C:
{
    ...
    r3 = ctx->gpr[3];
    r26 = MemoryInline::FlatRead32((r13 + -25536));
    r0 = (r26 + 1);
...
loc_8019CDE4:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8016AC74u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8019CE6C:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8016B1FCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8019CB80 func_8019CB80 preserves=true fpr_mask=0x00000000
