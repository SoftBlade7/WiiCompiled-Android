...
extern "C" void func_801E0264(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801E02CC:
{
    ...
    r6 = (r5 + -1);
    r5 = 128;
    MemoryInline::FlatWrite32((r28 + 8), r6);
...
// RECOMP_REGISTRATION base 0x801E0264 func_801E0264 preserves=true fpr_mask=0x00000000
