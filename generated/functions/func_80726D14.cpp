...
extern "C" void func_80726D14(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80726D50:
{
    ...
    r4 = 0x80510000u;
    MemoryInline::FlatWriteRamFloat32((r31 + 44), f1.d);
    r4 = (r4 + 13824);
    r5 = (r31 + 32);
...
// RECOMP_GUEST_ABI gpr_read=0xF000007E gpr_write=0xF000007B gpr_return=0x00000018 fpr_read=0x00000003 fpr_write=0x000000FF fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80726D14 func_80726D14 preserves=true fpr_mask=0x00000000
