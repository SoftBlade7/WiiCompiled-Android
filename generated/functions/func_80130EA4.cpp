...
extern "C" void func_80130EA4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80130EC4:
{
    ...
    r4 = 0x80330000u;
    r4 = (r4 + 9440);
    r3 = MemoryInline::FlatRead8((r4 + 56));
    r0 = (r3 + -1);
    MemoryInline::FlatWriteRam8((r4 + 56), static_cast<uint8_t>(r0));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
loc_80130F54:
{
    ...
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
    r3 = MemoryInline::FlatRead8((r31 + 56));
    r0 = (r3 + 1);
    MemoryInline::FlatWriteRam8((r31 + 56), static_cast<uint8_t>(r0));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
// RECOMP_REGISTRATION base 0x80130EA4 func_80130EA4 preserves=true fpr_mask=0x00000000
