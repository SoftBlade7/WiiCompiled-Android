...
extern "C" void func_807346C4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80734774:
{
    ...
    r0 = (r3 - r0);
    r29_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(1));
    r29 = (r29_rot_2 & 1);
    goto loc_80734798;
}
...
// RECOMP_REGISTRATION base 0x807346C4 func_807346C4 preserves=true fpr_mask=0x00000000
