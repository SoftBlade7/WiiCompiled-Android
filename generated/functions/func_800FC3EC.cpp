...
extern "C" void func_800FC3EC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800FC508:
{
    r0 = MemoryInline::FlatRead32((r28 + 572));
...
loc_800FC544:
{
    MemoryInline::FlatWrite32((r28 + 572), r31);
    r3 = (r28 + 952);
    r4 = (r1 + 264);
    r5 = 256;
    ctx->lr = 0x800FC558u;
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r5 = MemoryInline::FlatRead32((r28 + 408));
    r3 = r30;
    r4 = (r28 + 528);
    ctx->lr = 0x800FC5A8u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x800FC3EC func_800FC3EC preserves=true fpr_mask=0x00000000
