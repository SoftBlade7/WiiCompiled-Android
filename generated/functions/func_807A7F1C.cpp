...
extern "C" void func_807A7F1C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
    uint32_t r0_rot_2 = 0;
...
loc_807A7F1C:
{
    ...
    f1.d = MemoryInline::FlatReadFloat64((r5 + 22488));
    r0 = (r6 + -1);
...
// RECOMP_REGISTRATION base 0x807A7F1C func_807A7F1C preserves=false fpr_mask=0x80000000
