...
extern "C" void func_805C3550(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805C3550:
{
    ...
    r0 = MemoryInline::FlatRead16((r6 + 10));
    r5 = (r7 + r0);
    r7_addr_0 = (r7 + r0);
...
loc_805C35D0:
{
    r0 = MemoryInline::FlatRead16((r30 + 58));
...
// RECOMP_REGISTRATION base 0x805C3550 func_805C3550 preserves=true fpr_mask=0x00000000
