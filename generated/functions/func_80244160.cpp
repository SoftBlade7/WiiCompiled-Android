...
extern "C" void func_80244160(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_80244160:
{
    ...
    // inline leaf 0x802441EC (5 guest instruction(s))
    r0 = (r3 + 15);
    r0 = (r0 & 65520);
    r0 = (r0 * r4);
    r3_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(1));
    r3 = (r3_rot_0 & -2);
    // end of inlined leaf 0x802441EC
...
// RECOMP_REGISTRATION base 0x80244160 func_80244160 preserves=true fpr_mask=0x00000000
