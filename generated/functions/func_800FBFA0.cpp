...
extern "C" void func_800FBFA0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800FBFD8:
{
    r0 = MemoryInline::FlatRead32((r3 + 1488));
    r3 = 0;
    MemoryInline::FlatWrite32(r4, r0);
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x800FBFA0 func_800FBFA0 preserves=true fpr_mask=0x00000000
