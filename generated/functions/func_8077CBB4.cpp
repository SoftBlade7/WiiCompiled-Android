...
extern "C" void func_8077CBB4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8077CBB4:
{
    ...
    r6 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r5 + 17504));
    r5 = 0x809C0000u;
    MemoryInline::WriteResolved32(guest_range_0, 124u, (r1 + 124), r31);
    r31 = r3;
    r3 = 0x809C0000u;
    f1.d = MemoryInline::FlatReadFloat32((r4 + 17540));
    r0 = 0;
    r7 = 552075264;
    ...
    MemoryInline::WriteResolved32(guest_range_0, 108u, (r1 + 108), r0);
    ctx->lr = 0x8077CC28u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8077CBB4 func_8077CBB4 preserves=true fpr_mask=0x00000000
