...
extern "C" void func_80703AC8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
    uint32_t r3_rot_1 = 0;
...
loc_80703AC8:
{
    ...
    if (MkwStateFreeAbiEnabled(0x807028E4u) && KnownTranslatedCpuCall<0x807028E4u>::kAvailable && !KnownTranslatedCpuCall<0x807028E4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x807028E4u>()) {
        const auto state_free_result_807028E4_BFA = func_807028E4_statefree_v0(xer);
        r0 = static_cast<uint32_t>(state_free_result_807028E4_BFA[0]);
        r3 = static_cast<uint32_t>(state_free_result_807028E4_BFA[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_80703B10:
{
    r0 = MemoryInline::FlatRead8((r26 + 177));
}
...
loc_80703B38:
{
    r4 = MemoryInline::FlatRead16((r26 + 156));
}

loc_80703B40:
{
    if ((static_cast<int32_t>(r4) == static_cast<int32_t>(219))) {
        goto loc_80703B68;
    }
}
...
loc_80703B48:
{
    if ((static_cast<int32_t>(r4) == static_cast<int32_t>(240))) {
        goto loc_80703BB0;
    }
}
...
loc_80703B58:
{
    if ((static_cast<int32_t>(r4) == static_cast<int32_t>(369))) {
        goto loc_80703C78;
    }
}
...
loc_80703B5C:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r4), static_cast<int32_t>(407));
}
...
loc_80703B7C:
{
    r31 = 0x809C0000u;
    r4 = 3;
    r3 = MemoryInline::FlatRead32((r31 + 10408));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
loc_80703BDC:
{
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r28), static_cast<uint32_t>(619));
}
...
loc_80703D10:
{
    r3 = MemoryInline::FlatRead32((r26 + 152));
    r25 = 2;
...
loc_80703D34:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80700818u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80703AC8 func_80703AC8 preserves=true fpr_mask=0x00000000
