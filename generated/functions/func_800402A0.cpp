...
extern "C" void func_800402A0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800402A0:
{
    f0.d = MemoryInline::FlatReadFloat32((r4 + 152));
    MemoryInline::FlatWriteFloat32(r3, f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r4 + 156));
...
// RECOMP_REGISTRATION base 0x800402A0 func_800402A0 preserves=true fpr_mask=0x00000000
