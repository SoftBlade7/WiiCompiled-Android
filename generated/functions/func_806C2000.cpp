...
extern "C" void func_806C2000(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806C2000:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r4 + 12932));
...
loc_806C207C:
{
    ...
    r3 = (r29 + 1340);
    MemoryInline::FlatWriteFloat32((r29 + 1340), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r1 + 12));
    MemoryInline::FlatWriteFloat32((r29 + 1344), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r1 + 16));
    MemoryInline::FlatWriteFloat32((r29 + 1348), f0.d);
    ctx->lr = 0x806C20ACu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFEFCF gpr_write=0xE0001FFB gpr_return=0x00000018 fpr_read=0xFFFFFFF9 fpr_write=0xC0003FFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x806C2000 func_806C2000 preserves=false fpr_mask=0x80000000
