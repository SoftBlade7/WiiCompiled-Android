...
extern "C" void func_805F9D5C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805F9D5C:
{
    ...
    r5 = 0x80890000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r5 + 25132));
    ctx->lr = 0x805F9D84u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x805F9D5C func_805F9D5C preserves=true fpr_mask=0x00000000
