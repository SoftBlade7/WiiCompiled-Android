...
extern "C" void func_80623854(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80623864:
{
    ...
    ctx->gpr[3] = r3;
    ctx->cr = cr;
    InvokeDirectCpu<0x806255B8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    cr = ctx->cr;
...
// RECOMP_REGISTRATION base 0x80623854 func_80623854 preserves=true fpr_mask=0x00000000
