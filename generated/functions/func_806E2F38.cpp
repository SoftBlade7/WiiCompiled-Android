...
extern "C" void func_806E2F38(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806E2F90:
{
    r4 = MemoryInline::FlatRead8((r4 + 37));
    r0 = (r4 + -2);
    r3 = (r4 | ~r3);
...
// RECOMP_REGISTRATION base 0x806E2F38 func_806E2F38 preserves=true fpr_mask=0x00000000
