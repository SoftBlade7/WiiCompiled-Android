...
extern "C" void func_8072DCE4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8072DCE4:
{
    ...
    MemoryInline::WriteResolved32(guest_range_0, 80u, (r3 + 80), r6);
    ctx->gpr[0] = r0;
    ctx->gpr[5] = r5;
    ctx->gpr[6] = r6;
    return;
...
// RECOMP_REGISTRATION base 0x8072DCE4 func_8072DCE4 preserves=true fpr_mask=0x00000000
