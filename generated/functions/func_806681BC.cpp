...
extern "C" void func_806681BC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806681BC:
{
    ...
    MemoryInline::FlatWriteRam32((r1 + 404), r29);
...
loc_806682EC:
{
    ...
    xer = ctx->xer;
    r3 = 0x809C0000u;
    r29 = MemoryInline::FlatRead32((r3 + 8516));
    r3 = r29;
    ...
    r7 = (r31 + 160);
    r8 = MemoryInline::FlatRead32((r31 + 96));
    r0 = (r0 * 40);
    r4 = (r3 + r0);
    r3 = r29;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80671B4Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80668394:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r3 + -23608));
    r3 = r31;
    MemoryInline::FlatWrite32((r31 + 84), r0);
    r4 = 1;
...
loc_80668468:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_465D = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_465D[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_465D[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_806684BC:
{
    ...
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_5434 = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_5434[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_5434[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x806681BC func_806681BC preserves=true fpr_mask=0x00000000
