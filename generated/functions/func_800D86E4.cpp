...
extern "C" void func_800D86E4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800D8728:
{
    ...
    r30 = MemoryInline::FlatRead8(r28);
}

loc_800D8758:
{
    if ((static_cast<uint32_t>(r30) != static_cast<uint32_t>(254))) {
        goto loc_800D8768;
    }
}
...
loc_800D8768:
{
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r30), static_cast<uint32_t>(92));
}
...
loc_800D87F8:
{
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r30), static_cast<uint32_t>(254));
}
...
// RECOMP_REGISTRATION base 0x800D86E4 func_800D86E4 preserves=true fpr_mask=0x00000000
