...
extern "C" void func_8076E4E8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8076E51C:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r29 + 184));
    r4 = (r29 + 48);
    r12 = MemoryInline::FlatRead32(r3);
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead8((r29 + 188));
    r3 = 1;
    MemoryInline::FlatWrite8((r29 + 181), static_cast<uint8_t>(r3));
...
// RECOMP_REGISTRATION base 0x8076E4E8 func_8076E4E8 preserves=true fpr_mask=0x00000000
