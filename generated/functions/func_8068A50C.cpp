...
extern "C" void func_8068A50C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8068A50C:
{
    ...
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 56u, (r3 + 80));
...
// RECOMP_REGISTRATION base 0x8068A50C func_8068A50C preserves=false fpr_mask=0xF8000000
