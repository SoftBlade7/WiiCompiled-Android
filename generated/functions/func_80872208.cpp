...
extern "C" void func_80872208(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80872208:
{
    ...
    r0 = MemoryInline::FlatRead32((r3 + -15424));
...
// RECOMP_REGISTRATION base 0x80872208 func_80872208 preserves=true fpr_mask=0x00000000
