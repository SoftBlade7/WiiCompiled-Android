...
extern "C" void func_80867CB8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80867CB8:
{
    ...
    r0 = MemoryInline::FlatRead32((r3 + 18240));
...
loc_80867CEC:
{
    ...
    r27 = 0;
    r29 = 0x80860000u;
    MemoryInline::FlatWriteRam32((r26 + 20), r27);
    r3 = (r26 + 48);
    r4 = (r28 + 30432);
    r5 = (r29 + 14824);
    r6 = 48;
    ...
    r30 = 0x80860000u;
    r31 = 0x80860000u;
    MemoryInline::FlatWriteRam32((r26 + 16200), r27);
    r3 = (r26 + 16416);
    r4 = (r30 + 28812);
    r5 = (r31 + 14916);
    r6 = 48;
...
{
    r3 = 0x809C0000u;
    MemoryInline::FlatWriteRam32((r3 + 18240), r26);
}
...
// RECOMP_REGISTRATION base 0x80867CB8 func_80867CB8 preserves=true fpr_mask=0x00000000
