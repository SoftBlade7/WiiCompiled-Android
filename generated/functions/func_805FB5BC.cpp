...
extern "C" void func_805FB5BC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805FB5BC:
{
    ...
    ctx->gpr[4] = r4;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x805F2D30u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x805FB5BC func_805FB5BC preserves=true fpr_mask=0x00000000
