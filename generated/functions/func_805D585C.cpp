...
extern "C" void func_805D585C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805D585C:
{
    ...
    r3 = (r31 + 176);
    r4 = 0x808C0000u;
    guest_range_2 = MemoryInline::ResolveRangeHost((r31 + 176), 0, 48u, true, false);
    r25 = MemoryInline::ReadResolved32(guest_range_2, 0u, (r31 + 176));
    r28 = (r28 + -29696);
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r29 = MemoryInline::ReadResolved32(guest_range_2, 12u, (r31 + 188));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r10 = MemoryInline::ReadResolved32(guest_range_2, 24u, (r31 + 200));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r7 = MemoryInline::ReadResolved32(guest_range_2, 36u, (r31 + 212));
...
// RECOMP_REGISTRATION base 0x805D585C func_805D585C preserves=true fpr_mask=0x00000000
