...
extern "C" void func_8084B280(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8084B2BC:
{
    r0 = MemoryInline::FlatRead32((r25 + 76));
}
...
loc_8084B2E0:
{
    ...
    r0 = (r4 + -2);
    r0 = (r3 | r0);
    r24_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(1));
    r24 = (r24_rot_2 & 1);
    goto loc_8084B34C;
}
...
loc_8084B368:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805BDBD4u) && KnownTranslatedCpuCall<0x805BDBD4u>::kAvailable && !KnownTranslatedCpuCall<0x805BDBD4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805BDBD4u>()) {
        const auto state_free_result_805BDBD4_1FA8 = func_805BDBD4_statefree(r3, r4);
        r3 = static_cast<uint32_t>(state_free_result_805BDBD4_1FA8);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8084B280 func_8084B280 preserves=true fpr_mask=0x00000000
