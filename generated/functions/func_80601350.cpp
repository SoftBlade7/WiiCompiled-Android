...
extern "C" void func_80601350(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80601350:
{
    ...
    r28 = r3;
    r4 = r28;
    MemoryInline::FlatWrite32((r3 + 372), r7);
    MemoryInline::FlatWrite8((r3 + 380), static_cast<uint8_t>(r8));
    MemoryInline::FlatWrite32((r3 + 384), r9);
    MemoryInline::FlatWrite32((r3 + 376), r10);
    r3 = (r1 + 8);
...
// RECOMP_REGISTRATION base 0x80601350 func_80601350 preserves=true fpr_mask=0x00000000
