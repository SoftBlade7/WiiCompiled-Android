...
extern "C" void func_80781584(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80781584:
{
    ...
    r7 = MemoryInline::FlatRead32((r3 + 348));
    r28 = r4;
    ...
    ctx->fpr[0] = f0;
    ctx->cr = cr;
    InvokeDirectCpu<0x80780F0Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->gpr[30] = r30;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x802180D0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r5 = ctx->gpr[5];
    ...
    r31 = MemoryInline::ReadResolved32(guest_range_0, 0u, r28);
    r3 = r27;
    r12 = MemoryInline::ReadResolved32(guest_range_0, 4u, (r28 + 4));
    r5 = r29;
    r11 = MemoryInline::ReadResolved32(guest_range_0, 8u, (r28 + 8));
    r6 = r30;
    r10 = MemoryInline::ReadResolved32(guest_range_0, 12u, (r28 + 12));
    r4 = (r1 + 8);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r9 = MemoryInline::ReadResolved32(guest_range_0, 16u, (r28 + 16));
            r8 = MemoryInline::ReadResolved32(guest_range_0, 20u, (r28 + 20));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r7 = MemoryInline::ReadResolved32(guest_range_0, 24u, (r28 + 24));
    ...
    ctx->fpr[0] = f0;
    ctx->cr = cr;
    InvokeDirectCpu<0x80781694u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8078164C:
{
    ...
    ctx->fpr[0] = f0;
    ctx->cr = cr;
    InvokeDirectCpu<0x80781BC8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWrite8((r27 + 440), static_cast<uint8_t>(r0));
    r3 = (r1 + 40);
    r4 = 0;
    ctx->lr = 0x80781678u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x80781584 func_80781584 preserves=true fpr_mask=0x00000000
