...
extern "C" void func_80080B70(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r3_rot_0 = 0;
    uint32_t r4_rot_0 = 0;
...
loc_80080B70:
{
    ...
    r0 = (r0_rot_0 & 15);
    r5_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r6), static_cast<uint32_t>(27));
    r5 = (r5_rot_0 & 4);
    r4_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r6), static_cast<uint32_t>(26));
    r4 = (r4_rot_0 & 4);
    r5 = (r5 + r4);
    r8_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r6), static_cast<uint32_t>(28));
    r8 = (r8_rot_0 & 4);
    r7_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r6), static_cast<uint32_t>(20));
    r7 = (r7_rot_0 & 4);
...
// RECOMP_REGISTRATION base 0x80080B70 func_80080B70 preserves=true fpr_mask=0x00000000
