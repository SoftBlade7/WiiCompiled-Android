...
extern "C" void func_8005A950(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8005AA28:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r2 + -29668));
    r4 = (r13 + -32488);
    MemoryInline::FlatWriteRam32((r1 + 8), r0);
    r3 = (r3 + 11104);
    f3.d = MemoryInline::FlatReadFloat64((r2 + -29664));
...
// RECOMP_REGISTRATION base 0x8005A950 func_8005A950 preserves=false fpr_mask=0x80000000
