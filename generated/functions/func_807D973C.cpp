...
extern "C" void func_807D973C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807D973C:
{
    r3 = 0x809C0000u;
    r0 = 3;
    MemoryInline::FlatWriteRam32((r3 + 15944), r0);
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x807D973C func_807D973C preserves=true fpr_mask=0x00000000
