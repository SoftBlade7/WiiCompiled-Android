...
extern "C" void func_801D94A0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801D9534:
{
    MemoryInline::FlatWrite32((r31 + 480), r28);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_801D95EC;
    }
}
...
loc_801D9594:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801D5C80u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x801D94A0 func_801D94A0 preserves=true fpr_mask=0x00000000
