...
extern "C" void func_801B31D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_801B31FC:
{
    ...
    r3 = ctx->gpr[3];
    r6 = 0x802A0000u;
    r0_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r31), static_cast<uint32_t>(8));
    r0 = (r0_rot_1 & 240);
    r6 = (r6 + -12464);
    r4 = -855638016;
...
// RECOMP_REGISTRATION base 0x801B31D0 func_801B31D0 preserves=true fpr_mask=0x00000000
