...
extern "C" void func_807E3880(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807E391C:
{
    ...
    MemoryInline::FlatWrite32((r27 + 436), r31);
...
loc_807E392C:
{
    ...
    if (MkwStateFreeAbiEnabled(0x80860484u) && KnownTranslatedCpuCall<0x80860484u>::kAvailable && !KnownTranslatedCpuCall<0x80860484u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80860484u>()) {
        const auto state_free_result_80860484_1178 = func_80860484_statefree_v0(r3, xer);
        r0 = static_cast<uint32_t>(state_free_result_80860484_1178[0]);
        r3 = static_cast<uint32_t>(state_free_result_80860484_1178[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_807E3948:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r3 + 3488), r29);
    r31 = r3;
    r3 = 107;
    ctx->lr = 0x807E3960u;
    ctx->gpr[0] = r0;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r3 + 2312), r31);
    r4 = 96;
    r5 = 0;
...
// RECOMP_REGISTRATION base 0x807E3880 func_807E3880 preserves=true fpr_mask=0x00000000
