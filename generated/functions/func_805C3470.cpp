...
extern "C" void func_805C3470(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lbzux_805C34B4_loc_0 = 0;
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
    uint32_t r0_rot_2 = 0;
...
loc_805C3470:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x805F8B90u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    addr_lbzux_805C34B4_loc_0 = (r4 + r0);
    r0 = MemoryInline::FlatRead8(addr_lbzux_805C34B4_loc_0);
    r4 = addr_lbzux_805C34B4_loc_0;
...
loc_805C3528:
{
    r0 = MemoryInline::FlatRead16((r31 + 54));
...
// RECOMP_REGISTRATION base 0x805C3470 func_805C3470 preserves=true fpr_mask=0x00000000
