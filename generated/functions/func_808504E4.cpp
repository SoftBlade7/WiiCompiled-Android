...
extern "C" void func_808504E4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80850514:
{
    ...
    r3 = r31;
    MemoryInline::FlatWrite32((r31 + 3252), r5);
    r6 = 0;
    r0 = (r4 + 1);
    ...
    r4 = 0x808B0000u;
    r6 = (r6 + -24496);
    r3 = MemoryInline::FlatRead32((r31 + 3252));
    ...
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r31 + 3252));
    MemoryInline::FlatWrite32((r31 + 3248), r3);
...
// RECOMP_REGISTRATION base 0x808504E4 func_808504E4 preserves=true fpr_mask=0x00000000
