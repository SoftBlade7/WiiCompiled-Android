...
extern "C" void func_80725060(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80725060:
{
    ...
    r3 = 0x808D0000u;
    f3.d = MemoryInline::FlatReadFloat32((r3 + -27192));
    r4 = 3;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    f0.d = MemoryInline::FlatReadFloat32((r30 + 8440));
...
// RECOMP_REGISTRATION base 0x80725060 func_80725060 preserves=true fpr_mask=0x00000000
