...
extern "C" void func_8015ECE8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r30 = 0;
    MemoryInline::FlatWrite32((r13 + -25992), r30);
...
// RECOMP_REGISTRATION base 0x8015ECE8 func_8015ECE8 preserves=true fpr_mask=0x00000000
