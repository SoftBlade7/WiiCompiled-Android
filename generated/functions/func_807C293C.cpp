...
extern "C" void func_807C293C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807C293C:
{
    ...
    r8 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r8 + 26388));
    f30.d = f2.d;
...
loc_807C298C:
{
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x807C24C0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x807C293C func_807C293C preserves=false fpr_mask=0xC0000000
