...
extern "C" void func_806D7E0C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806D7E0C:
{
    ...
    r31 = r3;
    f2.d = MemoryInline::FlatReadFloat32((r3 + 372));
    f1.d = MemoryInline::FlatReadFloat32((r4 + 22596));
...
loc_806D7E4C:
{
    ...
    MemoryInline::FlatWriteFloat32((r31 + 360), f0.d);
...
// RECOMP_REGISTRATION base 0x806D7E0C func_806D7E0C preserves=true fpr_mask=0x00000000
