...
extern "C" void func_805A3050(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r3_rot_0 = 0;
...
extern "C" MKW_PPC_NO_INLINE uint64_t func_805A3050_statefree(uint32_t native_r3, uint32_t native_r4)
{
...
// RECOMP_STATE_FREE_ABI address=0x805A3050 symbol=func_805A3050_statefree gpr_in=0x00000018 gpr_out=0x00000008 fpr_in=0x00000000 fpr_out=0x00000000 cr_in=0x00 cr_out=0x00 gqr_in=0x00 hid_in=0x00 hid_out=0x00 xer_in=0 ctr_in=0 lr_in=0
...
// RECOMP_REGISTRATION base 0x805A3050 func_805A3050 preserves=true fpr_mask=0x00000000
