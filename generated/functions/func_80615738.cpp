...
extern "C" void func_80615738(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80615738:
{
    ...
    r0 = -1;
    MemoryInline::FlatWrite32((r3 + 7032), r0);
    r31 = r3;
    r4 = 1;
    r3 = (r3 + 248);
    ...
    if (MkwStateFreeAbiEnabled(0x805F0DB4u) && KnownTranslatedCpuCall<0x805F0DB4u>::kAvailable && !KnownTranslatedCpuCall<0x805F0DB4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805F0DB4u>()) {
        const auto state_free_result_805F0DB4_167E = func_805F0DB4_statefree_v0(r3, r4, cr, xer);
        cr = static_cast<uint32_t>(state_free_result_805F0DB4_167E);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
{
    r3 = r27;
    // inline leaf 0x805E3F68 (14 guest instruction(s))
    ...
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r3_addze_src_2)) + static_cast<uint64_t>(static_cast<uint32_t>(0)) + (static_cast<uint64_t>(static_cast<uint32_t>(r3_ca_2)) & 1u);
    ...
    // end of inlined leaf 0x805E3F68
    r25 = r3;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_80615858:
{
    MemoryInline::FlatWrite32((r29 + 7036), r25);
    r3 = MemoryInline::FlatRead32((r30 + 7736));
    r3 = MemoryInline::FlatRead32((r3 + 152));
    r0 = MemoryInline::FlatRead32((r3 + 956));
}
...
loc_80615894:
{
    ...
    r26 = 1;
    MemoryInline::FlatWrite32((r31 + 7164), r0);
    r28 = 0;
    r29 = 0;
    r27 = 0;
    MemoryInline::FlatWrite8((r31 + 7204), static_cast<uint8_t>(r26));
}
...
loc_806158CC:
{
    ...
    r3 = (r30 + 253);
    r4 = r26;
    MemoryInline::WriteResolved32(guest_range_2, 4u, (r1 + 12), r3);
    r0 = 0;
    r5 = r28;
    r3 = (r31 + 796);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r29)) << 32) | static_cast<uint32_t>(r27)))) {
        MemoryInline::WriteResolved32(guest_range_2, 24u, (r1 + 32), r29);
        MemoryInline::WriteResolved32(guest_range_2, 28u, (r1 + 36), r27);
    }
    ctx->lr = 0x80615940u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_806159B4:
{
    ...
    r3 = MemoryInline::FlatRead32((r3 + 152));
    r0 = MemoryInline::FlatRead32((r3 + 960));
...
loc_80615A00:
{
    ...
    r3 = (r30 + 456);
    r6 = (r30 + 338);
    MemoryInline::WriteResolved32(guest_range_3, 4u, (r1 + 12), r3);
    r0 = 0;
    r3 = (r31 + 3416);
    r7 = (r30 + 346);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_3, 24u, (r1 + 32), r0);
        MemoryInline::WriteResolved32(guest_range_3, 28u, (r1 + 36), r0);
    }
    r5 = MemoryInline::FlatRead32((r31 + 7028));
    ctx->lr = 0x80615A74u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_80615AD4:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x806123C8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80615AD8:
{
    MemoryInline::FlatWrite32((r31 + 6036), r3);
    goto loc_80615AFC;
}
...
loc_80615AF4:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80613CA0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80615AFC:
{
    r5 = MemoryInline::FlatRead32((r31 + 6036));
    r3 = r31;
    r4 = 0;
    r6 = 0;
    ctx->gpr[0] = r0;
    ...
    xer = ctx->xer;
    r3 = 0x80890000u;
    r4 = MemoryInline::FlatRead32((r31 + 6036));
    ...
    xer = ctx->xer;
    r0 = 3;
    MemoryInline::FlatWrite32((r31 + 6616), r0);
    r3 = (r31 + 6040);
    r4 = (r31 + 208);
    r5 = 0;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x80615738 func_80615738 preserves=true fpr_mask=0x00000000
