...
extern "C" void func_800E2FC4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr1_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_800E2FEC:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r30), static_cast<uint32_t>(7));
}
...
loc_inl1_cont_800CCC68:
{
    ...
    r4 = MemoryInline::FlatRead8((r27 + 20));
    r3 = MemoryInline::FlatRead32((r27 + 1920));
    r0 = (r4 + -2);
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r12 = MemoryInline::FlatRead32((r27 + 2160));
    r7 = r3;
    r3 = r31;
    r5 = r28;
    r6 = r29;
    r8 = MemoryInline::FlatRead32((r27 + 2164));
    r4 = 0;
    ctr = r12;
    ctx->lr = 0x800E31A0u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x800E2FC4 func_800E2FC4 preserves=true fpr_mask=0x00000000
