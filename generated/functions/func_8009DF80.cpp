...
extern "C" void func_8009DF80(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8009DF80:
{
    ...
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x8009EE30u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8009DF80 func_8009DF80 preserves=true fpr_mask=0x00000000
