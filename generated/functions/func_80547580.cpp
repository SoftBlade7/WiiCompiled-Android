...
extern "C" void func_80547580(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r3 = (r3 + 65536);
    r3 = MemoryInline::FlatRead32((r3 + -28032));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80547580 func_80547580 preserves=true fpr_mask=0x00000000
