...
extern "C" void func_8058D7D8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8058D804:
{
    r30_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r29), static_cast<uint32_t>(1));
    r30 = (r30_rot_2 & 510);
    r28 = 0;
}
...
loc_8058D80C:
{
    ...
    r4 = PPC_Slw(static_cast<uint32_t>(r31), static_cast<uint32_t>(r4));
    r5 = (r3 & r4);
    r3 = (r0 & r4);
    r4 = (0 - r5);
    r0 = (0 - r3);
...
loc_8058D878:
{
    if ((static_cast<uint32_t>(r28) < static_cast<uint32_t>(2))) {
        goto loc_8058D80C;
    }
}
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFFFFF gpr_write=0xFE00183B gpr_return=0x00000018 fpr_read=0xFFFFFFFF fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=0 fence=1
// RECOMP_REGISTRATION base 0x8058D7D8 func_8058D7D8 preserves=true fpr_mask=0x00000000
