...
extern "C" void func_800E97C0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800E97C0:
{
    ...
    r4 = (r4 + 2);
    guest_range_1 = MemoryInline::ResolveRangeHost(r6, 0, 24u, false, true);
...
// RECOMP_REGISTRATION base 0x800E97C0 func_800E97C0 preserves=true fpr_mask=0x00000000
