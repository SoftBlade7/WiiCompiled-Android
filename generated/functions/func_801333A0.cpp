...
extern "C" void func_801333A0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801333A0:
{
    ...
    r6 = (r6 + 24216);
    r5 = 28;
    MemoryInline::FlatWriteRam32((r6 + 116), r3);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
// RECOMP_REGISTRATION base 0x801333A0 func_801333A0 preserves=true fpr_mask=0x00000000
