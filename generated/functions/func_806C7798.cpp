...
extern "C" void func_806C7798(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806C7798:
{
    ...
    MemoryInline::FlatWrite8((r3 + 213), static_cast<uint8_t>(r4));
    MemoryInline::FlatWrite8((r3 + 214), static_cast<uint8_t>(r4));
...
// RECOMP_REGISTRATION base 0x806C7798 func_806C7798 preserves=true fpr_mask=0x00000000
