...
extern "C" void func_802229E8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_802229F4:
{
    guest_range_0 = MemoryInline::ResolveRangeHost((r1 + 16), 0, 56u, false, true);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 0u, ((static_cast<uint64_t>(static_cast<uint32_t>(r20)) << 32) | static_cast<uint32_t>(r21)))) {
        MemoryInline::WriteResolved32(guest_range_0, 0u, (r1 + 16), r20);
        MemoryInline::WriteResolved32(guest_range_0, 4u, (r1 + 20), r21);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 8u, ((static_cast<uint64_t>(static_cast<uint32_t>(r22)) << 32) | static_cast<uint32_t>(r23)))) {
        MemoryInline::WriteResolved32(guest_range_0, 8u, (r1 + 24), r22);
        MemoryInline::WriteResolved32(guest_range_0, 12u, (r1 + 28), r23);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 16u, ((static_cast<uint64_t>(static_cast<uint32_t>(r24)) << 32) | static_cast<uint32_t>(r25)))) {
        MemoryInline::WriteResolved32(guest_range_0, 16u, (r1 + 32), r24);
        MemoryInline::WriteResolved32(guest_range_0, 20u, (r1 + 36), r25);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r26)) << 32) | static_cast<uint32_t>(r27)))) {
        MemoryInline::WriteResolved32(guest_range_0, 24u, (r1 + 40), r26);
        MemoryInline::WriteResolved32(guest_range_0, 28u, (r1 + 44), r27);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 32u, ((static_cast<uint64_t>(static_cast<uint32_t>(r28)) << 32) | static_cast<uint32_t>(r29)))) {
        MemoryInline::WriteResolved32(guest_range_0, 32u, (r1 + 48), r28);
        MemoryInline::WriteResolved32(guest_range_0, 36u, (r1 + 52), r29);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 40u, ((static_cast<uint64_t>(static_cast<uint32_t>(r30)) << 32) | static_cast<uint32_t>(r31)))) {
        MemoryInline::WriteResolved32(guest_range_0, 40u, (r1 + 56), r30);
        MemoryInline::WriteResolved32(guest_range_0, 44u, (r1 + 60), r31);
    }
    r26 = r3;
    r27 = r4;
    r28 = r5;
...
{
    r3 = (r26 + 60);
    if ((static_cast<uint32_t>(r5) < static_cast<uint32_t>(r31))) {
        goto loc_80222BE4;
    }
}
...
// RECOMP_REGISTRATION base 0x802229E8 func_802229E8 preserves=true fpr_mask=0x00000000
