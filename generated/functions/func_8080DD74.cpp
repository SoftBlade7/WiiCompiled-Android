...
extern "C" void func_8080DD74(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lhax_8080DE98_loc_0 = 0;
    uint32_t addr_lhax_8080DEA4_loc_0 = 0;
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
    uint32_t r0_rot_2 = 0;
...
loc_8080DE64:
{
    ...
    r0 = (r0_rot_1 & -2);
    r5 = MemoryInline::FlatRead32((r27 + 264));
    r3 = r27;
    ...
    addr_lhax_8080DE98_loc_0 = (r6 + r5);
    r5 = MemoryInline::FlatRead16(addr_lhax_8080DE98_loc_0);
    r5 = (r5 << 16);
    ...
    addr_lhax_8080DEA4_loc_0 = (r5 + r0);
    r29 = MemoryInline::FlatRead16(addr_lhax_8080DEA4_loc_0);
    r29 = (r29 << 16);
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFEFFF gpr_write=0xF80018FB gpr_return=0x00000018 fpr_read=0xFFFFFFFF fpr_write=0x800000FF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=0 fence=1
// RECOMP_REGISTRATION base 0x8080DD74 func_8080DD74 preserves=false fpr_mask=0x80000000
