...
extern "C" void func_8064B910(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8064B950:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805F0DB4u) && KnownTranslatedCpuCall<0x805F0DB4u>::kAvailable && !KnownTranslatedCpuCall<0x805F0DB4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805F0DB4u>()) {
        const auto state_free_result_805F0DB4_1728 = func_805F0DB4_statefree_v0(r3, r4, cr, xer);
        cr = static_cast<uint32_t>(state_free_result_805F0DB4_1728);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_8064BA00:
{
    ...
    xer = ctx->xer;
    r0 = 1;
    MemoryInline::FlatWrite32((r30 + 1136), r0);
    r3 = (r30 + 560);
    r4 = (r30 + 68);
    r5 = 0;
    ctx->gpr[0] = r0;
    ...
    xer = ctx->xer;
    r0 = 2;
    MemoryInline::FlatWrite32((r30 + 1732), r0);
    r3 = (r30 + 1156);
    r4 = (r30 + 88);
    r5 = 0;
    ctx->gpr[0] = r0;
    ...
    r22 = 0x808A0000u;
    r22 = (r22 + -26128);
    guest_range_1 = MemoryInline::ResolveRangeHost(r22, 0, 44u, true, false);
    r23 = MemoryInline::ReadResolved32(guest_range_1, 0u, r22);
    guest_range_3 = MemoryInline::ResolveRangeHost((r1 + 8), 0, 44u, false, true);
    MemoryInline::WriteResolved32(guest_range_3, 0u, (r1 + 8), r23);
    r7 = (r31 + 94);
    r24 = MemoryInline::ReadResolved32(guest_range_1, 4u, (r22 + 4));
    r6 = (r31 + 107);
    r25 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r22 + 8));
    r5 = (r31 + 137);
    r26 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r22 + 12));
    r3 = (r30 + 1752);
    r27 = MemoryInline::ReadResolved32(guest_range_1, 16u, (r22 + 16));
    r4 = (r1 + 8);
    r28 = MemoryInline::ReadResolved32(guest_range_1, 20u, (r22 + 20));
    r8 = 1;
    r29 = MemoryInline::ReadResolved32(guest_range_1, 24u, (r22 + 24));
    r9 = 0;
    {
        ...
        if (resolved_pair.valid) {
            ...
            r12 = MemoryInline::ReadResolved32(guest_range_1, 28u, (r22 + 28));
            r11 = MemoryInline::ReadResolved32(guest_range_1, 32u, (r22 + 32));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r10 = MemoryInline::ReadResolved32(guest_range_1, 36u, (r22 + 36));
            r0 = MemoryInline::ReadResolved32(guest_range_1, 40u, (r22 + 40));
        }
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 4u, ((static_cast<uint64_t>(static_cast<uint32_t>(r24)) << 32) | static_cast<uint32_t>(r25)))) {
        MemoryInline::WriteResolved32(guest_range_3, 4u, (r1 + 12), r24);
        MemoryInline::WriteResolved32(guest_range_3, 8u, (r1 + 16), r25);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 12u, ((static_cast<uint64_t>(static_cast<uint32_t>(r26)) << 32) | static_cast<uint32_t>(r27)))) {
        MemoryInline::WriteResolved32(guest_range_3, 12u, (r1 + 20), r26);
        MemoryInline::WriteResolved32(guest_range_3, 16u, (r1 + 24), r27);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 20u, ((static_cast<uint64_t>(static_cast<uint32_t>(r28)) << 32) | static_cast<uint32_t>(r29)))) {
        MemoryInline::WriteResolved32(guest_range_3, 20u, (r1 + 28), r28);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 36u, ((static_cast<uint64_t>(static_cast<uint32_t>(r10)) << 32) | static_cast<uint32_t>(r0)))) {
    ...
    r29 = 0x808A0000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r29 + -26240));
    ctx->lr = 0x8064BB64u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r5 = -1;
    r0 = 3;
    MemoryInline::FlatWrite32((r30 + 2348), r3);
    r3 = (r30 + 1752);
    r4 = (r30 + 108);
    MemoryInline::FlatWrite32((r30 + 2352), r5);
    r5 = 0;
    MemoryInline::FlatWrite32((r30 + 2328), r0);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ...
    xer = ctx->xer;
    r0 = 4;
    MemoryInline::FlatWrite32((r30 + 2932), r0);
    r3 = (r30 + 2356);
    r4 = (r30 + 128);
    r5 = 0;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x8064B910 func_8064B910 preserves=true fpr_mask=0x00000000
