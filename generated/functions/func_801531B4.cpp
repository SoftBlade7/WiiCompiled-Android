...
extern "C" void func_801531B4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80153238:
{
    ...
    r4 = MemoryInline::FlatRead32((r3 + 108));
    r9 = r30;
    r7_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(31));
...
// RECOMP_REGISTRATION base 0x801531B4 func_801531B4 preserves=true fpr_mask=0x00000000
