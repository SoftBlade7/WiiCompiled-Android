...
extern "C" void func_806371AC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806371AC:
{
    ...
    r31 = 0x808A0000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r31 + -32616));
    ctx->lr = 0x806371ECu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_80637270:
{
    r0 = MemoryInline::FlatRead32((r28 + 564));
}
...
// RECOMP_REGISTRATION base 0x806371AC func_806371AC preserves=true fpr_mask=0x00000000
