...
extern "C" void func_8006CC10(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8006CC10:
{
    ...
    f3.d = MemoryInline::FlatReadFloat32((r2 + -29312));
    MemoryInline::WriteResolvedFloat32(guest_range_0, 8u, (r31 + 8), f4.d);
    f2.d = MemoryInline::FlatReadFloat32((r2 + -29304));
    {
    ...
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 0u, (r1 + 8));
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 20u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f4.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 20u, (r31 + 20), f0.d);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 24u, (r31 + 24), f4.d);
    }
    {
        const auto resolved_pair = MemoryInline::ReadResolvedPair32(guest_range_1, 0u);
        if (resolved_pair.valid) {
...
// RECOMP_REGISTRATION base 0x8006CC10 func_8006CC10 preserves=true fpr_mask=0x00000000
