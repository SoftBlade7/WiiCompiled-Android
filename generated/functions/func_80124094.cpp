...
extern "C" void func_80124094(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80124094:
{
    r3 = MemoryInline::FlatRead32((r13 + -26552));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80124094 func_80124094 preserves=true fpr_mask=0x00000000
