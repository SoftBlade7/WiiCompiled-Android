...
extern "C" void func_8059BC44(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8059BC44:
{
    ...
    ctx->fpr[2] = f2;
    ctx->cr = cr;
    InvokeDirectCpu<0x8059D44Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->fpr[2] = f2;
    ctx->cr = cr;
    InvokeDirectCpu<0x8059C29Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8059BD70:
{
    ...
    ctx->fpr[2] = f2;
    ctx->cr = cr;
    InvokeDirectCpu<0x8059C44Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead8((r31 + 61));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_8059BDDC:
{
    ...
    ctx->fpr[2] = f2;
    ctx->cr = cr;
    InvokeDirectCpu<0x8059D658u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->fpr[2] = f2;
    ctx->cr = cr;
    InvokeDirectCpu<0x8059CC60u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    f2 = ctx->fpr[2];
    cr = ctx->cr;
    r0 = MemoryInline::FlatRead8((r31 + 62));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_8059BE1C:
{
    ...
    ctx->fpr[2] = f2;
    ctx->cr = cr;
    InvokeDirectCpu<0x8059DCDCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8059BE50:
{
    ...
    ctx->fpr[0] = f0;
    ctx->cr = cr;
    InvokeDirectCpu<0x8059C888u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8059BC44 func_8059BC44 preserves=true fpr_mask=0x00000000
