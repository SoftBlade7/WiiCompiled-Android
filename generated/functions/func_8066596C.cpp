...
extern "C" void func_8066596C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80665978:
{
    r3 = 0x809C0000u;
    r5 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r5 + -23864));
    r4 = 5;
...
// RECOMP_REGISTRATION base 0x8066596C func_8066596C preserves=true fpr_mask=0x00000000
