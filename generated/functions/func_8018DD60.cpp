...
extern "C" void func_8018DD60(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8018DD60:
{
    ...
    ctx->gpr[31] = r31;
    ctx->fpr[0] = f0;
    InvokeDirectCpu<0x8018AE38u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8018DD60 func_8018DD60 preserves=true fpr_mask=0x00000000
