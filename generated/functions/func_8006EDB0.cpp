...
extern "C" void func_8006EDB0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_8006EDB0:
{
    ...
    r6 = MemoryInline::FlatRead32((r3 + 220));
...
// RECOMP_REGISTRATION base 0x8006EDB0 func_8006EDB0 preserves=true fpr_mask=0x00000000
