...
extern "C" void func_8005F400(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8005F400:
{
    ...
    r3 = MemoryInline::FlatRead16((r3 + 64));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8005F400 func_8005F400 preserves=true fpr_mask=0x00000000
