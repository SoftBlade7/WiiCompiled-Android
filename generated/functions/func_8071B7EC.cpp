...
extern "C" void func_8071B7EC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8071B7EC:
{
    MemoryInline::FlatWrite8((r29 + 18), static_cast<uint8_t>(r21));
    r11 = (r1 + 64);
...
// RECOMP_GUEST_ABI gpr_read=0x20200002 gpr_write=0xFFF00803 gpr_return=0x00000000 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x00 cr_write=0x00 xer_read=0 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8071B7EC func_8071B7EC preserves=true fpr_mask=0x00000000
