...
extern "C" void func_807D6F58(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807D6FA8:
{
    f28.d = MemoryInline::FlatReadFloat32((r5 + 196));
    r31 = (r1 + 8);
    f29.d = MemoryInline::FlatReadFloat32((r5 + 176));
    r29 = 0;
    f30.d = MemoryInline::FlatReadFloat32((r5 + 296));
...
loc_807D6FE4:
{
    f0.d = MemoryInline::FlatReadFloat32((r27 + 588));
...
loc_807D7010:
{
    MemoryInline::FlatWriteFloat32((r27 + 588), f0.d);
}

loc_807D7014:
{
    r0 = MemoryInline::FlatRead8((r27 + 1009));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_807D7020:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x807D710Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_807D7044:
{
    r4 = (r27 + 324);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r27)) + static_cast<uint64_t>(static_cast<uint32_t>(324)) + (static_cast<uint64_t>(static_cast<uint32_t>(0)) & 1u);
...
loc_807D7054:
{
    ...
    r3 = r27;
    f1.d = MemoryInline::FlatReadFloat32((r27 + 588));
    r6 = (r27 + 516);
    r4 = (r5 + 1584);
    r5 = (r5 + 1680);
    ctx->lr = 0x807D707Cu;
...
loc_807D709C:
{
    ...
    r29 = (r29 + 1);
    MemoryInline::FlatWriteFloat32((r27 + 1024), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r1 + 36));
    MemoryInline::FlatWriteFloat32((r27 + 1028), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r1 + 52));
    MemoryInline::FlatWriteFloat32((r27 + 1032), f0.d);
}

loc_807D70B8:
{
    r0 = MemoryInline::FlatRead8((r27 + 575));
...
{
    // psq_load w=0 quant=0 (using PPC_PsqL)
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 60), 0, 92u, true, false);
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 68u, (r1 + 128));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f30.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 52u, (r1 + 112));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f29.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 36u, (r1 + 96));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r11 = (r1 + 80);
    f28.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 20u, (r1 + 80));
    ...
    r0 = MemoryInline::ReadResolved32(guest_range_1, 88u, (r1 + 148));
    ctx->lr = r0;
    r1 = (r1 + 144);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x807D6F58 func_807D6F58 preserves=false fpr_mask=0xF0000000
