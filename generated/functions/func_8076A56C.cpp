...
extern "C" void func_8076A56C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8076A56C:
{
    ...
    r29 = r5;
    r30 = r6;
    r3 = MemoryInline::FlatRead32((r3 + 284));
...
loc_8076A5C4:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead8((r27 + 288));
    r3 = 1;
    MemoryInline::FlatWrite8((r27 + 289), static_cast<uint8_t>(r3));
...
loc_8076A60C:
{
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWrite8((r27 + 288), static_cast<uint8_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x8076A56C func_8076A56C preserves=true fpr_mask=0x00000000
