...
extern "C" void func_806A19D8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r29 = (r7 * 12);
    f1.d = MemoryInline::FlatReadFloat32((r31 + 2428));
    r3 = (r1 + 8);
    r4 = (r31 + r29);
    r4 = (r4 + 2028);
...
loc_806A1A5C:
{
    ...
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32(r30);
    f1.d = MemoryInline::FlatReadFloat32((r31 + 2432));
    r12 = MemoryInline::FlatRead32(r3);
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    f0.d = MemoryInline::FlatReadFloat32((r31 + 2436));
    r3 = MemoryInline::FlatRead32(r30);
...
loc_806A1B00:
{
    r0 = MemoryInline::FlatRead8((r31 + 73));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
// RECOMP_REGISTRATION base 0x806A19D8 func_806A19D8 preserves=true fpr_mask=0x00000000
