...
extern "C" void func_80616700(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80616700:
{
    r3 = MemoryInline::FlatRead32((r3 + 7024));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80616700 func_80616700 preserves=true fpr_mask=0x00000000
