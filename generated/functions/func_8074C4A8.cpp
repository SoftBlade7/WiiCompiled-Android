...
extern "C" void func_8074C4A8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8074C4D0:
{
    ...
    r31 = MemoryInline::FlatRead32((r4 + 11336));
...
// RECOMP_REGISTRATION base 0x8074C4A8 func_8074C4A8 preserves=true fpr_mask=0x00000000
