...
extern "C" void func_80571D04(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80571D04:
{
    ...
    r30 = r3;
    r31 = MemoryInline::FlatRead16((r3 + 108));
    r31 = (r31 << 16);
...
loc_80571D48:
{
    MemoryInline::FlatWrite16((r30 + 108), static_cast<uint16_t>(r3));
...
// RECOMP_REGISTRATION base 0x80571D04 func_80571D04 preserves=true fpr_mask=0x00000000
