...
extern "C" void func_8054621C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_80546230:
{
    ...
    r0 = (r0_rot_0 & -2);
    r3 = (r3 + r0);
    MemoryInline::FlatWrite16((r3 + -27908), static_cast<uint16_t>(r6));
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[6] = r6;
    ctx->cr = cr;
...
// RECOMP_REGISTRATION base 0x8054621C func_8054621C preserves=true fpr_mask=0x00000000
