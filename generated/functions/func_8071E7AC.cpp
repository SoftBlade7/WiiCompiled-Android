...
extern "C" void func_8071E7AC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8071E7E0:
{
    ...
    if (MkwStateFreeAbiEnabled(0x8072239Cu) && KnownTranslatedCpuCall<0x8072239Cu>::kAvailable && !KnownTranslatedCpuCall<0x8072239Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x8072239Cu>()) {
        const auto state_free_result_8072239C_A12 = func_8072239C_statefree(r3);
        r3 = static_cast<uint32_t>(state_free_result_8072239C_A12);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_8071E7F4:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80721090u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_GUEST_ABI gpr_read=0xFC00003B gpr_write=0xFC00003B gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8071E7AC func_8071E7AC preserves=true fpr_mask=0x00000000
