...
extern "C" void func_800A8C70(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800A8CB4:
{
    r30 = MemoryInline::FlatRead32((r3 + 3640));
    r31 = (r30 + 16);
    r3 = r31;
    ctx->lr = 0x800A8CC4u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x800A8C70 func_800A8C70 preserves=true fpr_mask=0x00000000
