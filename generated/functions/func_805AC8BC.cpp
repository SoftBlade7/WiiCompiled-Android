...
extern "C" void func_805AC8BC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_805AC8BC:
{
    ...
    r4 = (r1 + 20);
    r5 = (r1 + 8);
    f2.d = MemoryInline::FlatReadFloat32((r6 + 52));
    ...
    f1.d = MemoryInline::FlatReadFloat32((r6 + 60));
...
// RECOMP_REGISTRATION base 0x805AC8BC func_805AC8BC preserves=true fpr_mask=0x00000000
