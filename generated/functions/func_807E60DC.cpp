...
extern "C" void func_807E60DC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_807E60DC:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r3 + 9172));
    r31 = 0x808B0000u;
    r0 = (r30 + 0);
    r28 = (r26 + 372);
...
loc_807E61C0:
{
    ...
    r11 = (r1 + 32);
    MemoryInline::FlatWriteFloat32((r26 + 124), f0.d);
...
// RECOMP_REGISTRATION base 0x807E60DC func_807E60DC preserves=true fpr_mask=0x00000000
