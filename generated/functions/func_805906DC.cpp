...
extern "C" void func_805906DC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
extern "C" MKW_PPC_NO_INLINE uint64_t func_805906DC_statefree(uint32_t native_r3, uint32_t native_r4)
{
...
// RECOMP_STATE_FREE_ABI address=0x805906DC symbol=func_805906DC_statefree gpr_in=0x00000018 gpr_out=0x00000008 fpr_in=0x00000000 fpr_out=0x00000000 cr_in=0x00 cr_out=0x00 gqr_in=0x00 hid_in=0x00 hid_out=0x00 xer_in=0 ctr_in=0 lr_in=0
...
// RECOMP_REGISTRATION base 0x805906DC func_805906DC preserves=true fpr_mask=0x00000000
