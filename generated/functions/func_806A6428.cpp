...
extern "C" void func_806A6428(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806A6460:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r28 + -10552));
    r27 = 1;
...
loc_806A65A0:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8070C8E4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_806A65D0:
{
    MemoryInline::FlatWrite8((r29 + 184), static_cast<uint8_t>(r31));
}
...
// RECOMP_REGISTRATION base 0x806A6428 func_806A6428 preserves=true fpr_mask=0x00000000
