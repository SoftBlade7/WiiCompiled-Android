...
extern "C" void func_806F9F80(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806F9FE8:
{
    ...
    r29 = MemoryInline::FlatRead32((r4 + 9008));
...
loc_806FA004:
{
    ...
    r28 = MemoryInline::FlatRead32((r4 + 9008));
...
// RECOMP_REGISTRATION base 0x806F9F80 func_806F9F80 preserves=true fpr_mask=0x00000000
