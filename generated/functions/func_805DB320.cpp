...
extern "C" void func_805DB320(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805DB320:
{
    ...
    MemoryInline::FlatWrite8((r3 + 348), static_cast<uint8_t>(r0));
    ctx->gpr[0] = r0;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x805DB320 func_805DB320 preserves=true fpr_mask=0x00000000
