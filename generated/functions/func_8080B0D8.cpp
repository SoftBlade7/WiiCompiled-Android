...
extern "C" void func_8080B0D8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8080B0D8:
{
    ...
    r4 = (r29 + 65536);
    r0 = 0;
    MemoryInline::FlatWrite32((r4 + -8748), r0);
    r5 = (r5 + 23784);
    r3 = 104;
    MemoryInline::FlatWrite32(r29, r5);
    MemoryInline::FlatWrite32((r4 + -3488), r0);
    ctx->lr = 0x8080B12Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_8080B1A0:
{
    ...
    ctx->fpr[5] = f5;
    ctx->cr = cr;
    InvokeDirectCpu<0x8080AD20u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8080B1AC:
{
    ...
    r4 = MemoryInline::FlatRead32((r6 + -8748));
    r3 = r29;
    ...
    MemoryInline::FlatWrite32((r4 + -8744), r7);
    f1.d = MemoryInline::FlatReadFloat32((r31 + 8));
    MemoryInline::FlatWrite32((r6 + -8748), r5);
    f5.d = MemoryInline::FlatReadFloat32((r7 + 56));
    f4.d = MemoryInline::FlatReadFloat32((r7 + 48));
    ...
    r0 = (r0_rot_1 & -4);
    r4 = (r4 + r0);
    MemoryInline::FlatWrite32((r4 + 180), r7);
...
// RECOMP_REGISTRATION base 0x8080B0D8 func_8080B0D8 preserves=true fpr_mask=0x00000000
