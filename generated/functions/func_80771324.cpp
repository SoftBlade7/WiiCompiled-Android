...
extern "C" void func_80771324(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80771324:
{
    ...
    r28 = MemoryInline::FlatRead32((r3 + 228));
...
loc_807713F4:
{
    ...
    r0 = MemoryInline::FlatRead32((r3 + -3080));
...
loc_807714D8:
{
    r5 = 0x808D0000u;
    r3 = 0x809C0000u;
    f0.d = MemoryInline::FlatReadFloat32((r5 + -3084));
    r4 = (r30 + 48);
...
// RECOMP_REGISTRATION base 0x80771324 func_80771324 preserves=true fpr_mask=0x00000000
