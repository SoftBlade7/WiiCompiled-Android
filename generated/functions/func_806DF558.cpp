...
extern "C" void func_806DF558(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806DF568:
{
    r4 = 0x808A0000u;
    r3 = r5;
    f0.d = MemoryInline::FlatReadFloat32((r4 + 1344));
...
// RECOMP_REGISTRATION base 0x806DF558 func_806DF558 preserves=true fpr_mask=0x00000000
