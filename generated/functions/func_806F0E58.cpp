...
extern "C" void func_806F0E58(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806F0EA8:
{
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x806ED704u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_806F0EE8:
{
    ...
    r4 = (r4 << 16);
    r4 = (static_cast<int32_t>(r4) >> 16);
    f1.d = MemoryInline::FlatReadFloat32((r5 + 2904));
    ctx->lr = 0x806F0EF8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_806F0F20:
{
    ...
    r4 = (r4 << 16);
    r4 = (static_cast<int32_t>(r4) >> 16);
    f1.d = MemoryInline::FlatReadFloat32((r5 + 2908));
    r5 = r27;
    r6 = r28;
    r7 = r29;
    r8 = r30;
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x806EFC34u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_806F0F84:
{
    r3 = MemoryInline::FlatRead16((r31 + 18));
    r3 = (r3 << 16);
    ...
    r4 = (r4 + 1);
    r0 = (r3 + -1);
    MemoryInline::FlatWrite16((r31 + 20), static_cast<uint16_t>(r4));
    r3 = (static_cast<int32_t>(static_cast<int16_t>(r0)));
...
// RECOMP_REGISTRATION base 0x806F0E58 func_806F0E58 preserves=false fpr_mask=0x80000000
