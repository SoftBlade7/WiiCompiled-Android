...
extern "C" void func_8074E600(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8074E600:
{
    ...
    f31.d = MemoryInline::FlatReadFloat32((r4 + -17024));
}
...
loc_8074E630:
{
    ...
    r3 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + 12676));
...
// RECOMP_REGISTRATION base 0x8074E600 func_8074E600 preserves=false fpr_mask=0x80000000
