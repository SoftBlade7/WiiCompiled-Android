...
extern "C" void func_80025FB0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr1_0 = 0;
...
loc_80025FE4:
{
    ...
    ctx->gpr[12] = r12;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x80025E70u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80025FB0 func_80025FB0 preserves=true fpr_mask=0x00000000
