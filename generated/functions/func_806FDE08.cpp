...
extern "C" void func_806FDE08(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806FDE08:
{
    ...
    r3 = r30;
    MemoryInline::FlatWrite8((r30 + 256), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x806FDE08 func_806FDE08 preserves=true fpr_mask=0x00000000
