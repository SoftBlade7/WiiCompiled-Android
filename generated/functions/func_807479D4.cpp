...
extern "C" void func_807479D4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80747A24:
{
    ...
    f8.d = MemoryInline::FlatReadFloat32((r1 + 76));
...
{
    r3 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 11280));
...
loc_80747AE4:
{
    ...
    r30 = 0x808A0000u;
    r4 = r29;
    f0.d = MemoryInline::FlatReadFloat32((r30 + 11280));
    r3 = (r1 + 32);
...
// RECOMP_GUEST_ABI gpr_read=0xE000003F gpr_write=0xE000003B gpr_return=0x00000018 fpr_read=0xC00001FF fpr_write=0xC00001FF fpr_return=0x00000002 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x807479D4 func_807479D4 preserves=false fpr_mask=0xC0000000
