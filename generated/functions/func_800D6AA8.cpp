...
extern "C" void func_800D6AA8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800D6AA8:
{
    r0 = MemoryInline::FlatRead32((r29 + 1800));
    r3 = MemoryInline::FlatRead32((r29 + 1804));
    r0 = (r3 | r0);
...
loc_800D6AB8:
{
    ...
    r6 = (r28 + 19923);
    r8 = MemoryInline::FlatRead32((r29 + 1804));
    r5 = 0;
    r0_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(30));
    r0 = (r0_rot_0 & 1073741823);
    r7 = MemoryInline::FlatRead32((r29 + 1800));
    r0 = (static_cast<uint32_t>((static_cast<uint64_t>(r6) * static_cast<uint64_t>(r0)) >> 32));
    r4_subfc_min_0 = r4;
    r4 = (r4_subfc_min_0 - r8);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(r4_subfc_min_0) >= static_cast<uint32_t>(r8) ? 1u : 0u) << 29);
    r3_subfe_rb_0 = r3;
    r3_not_0 = ~(r7);
    r3_ca_0 = (xer >> 29) & 1u;
...
loc_800D6B14:
{
    ...
    MemoryInline::FlatWrite32((r3 + 1804), r27);
    MemoryInline::FlatWrite32((r3 + 1800), r27);
    ctx->lr = 0x800D6B34u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_800D6B5C:
{
    ...
    r6 = (r28 + 19923);
    r4_subfc_min_1 = r4;
    r4 = (r4_subfc_min_1 - r29);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(r4_subfc_min_1) >= static_cast<uint32_t>(r29) ? 1u : 0u) << 29);
    r5 = 0;
...
loc_800D6C4C:
{
    r0 = MemoryInline::FlatRead8((r29 + 2008));
...
loc_800D6C58:
{
    ...
    r6 = (r31 + 19923);
    r8 = MemoryInline::FlatRead32((r29 + 2156));
    r5 = 0;
    r0_rot_6 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(30));
    r0 = (r0_rot_6 & 1073741823);
    r7 = MemoryInline::FlatRead32((r29 + 2152));
    r0 = (static_cast<uint32_t>((static_cast<uint64_t>(r6) * static_cast<uint64_t>(r0)) >> 32));
    r4_subfc_min_4 = r4;
    r4 = (r4_subfc_min_4 - r8);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(r4_subfc_min_4) >= static_cast<uint32_t>(r8) ? 1u : 0u) << 29);
    r3_subfe_rb_4 = r3;
    r3_not_4 = ~(r7);
    r3_ca_4 = (xer >> 29) & 1u;
...
loc_800D6CD0:
{
    ...
    r3 = 64;
    r6 = MemoryInline::FlatRead32((r13 + -26868));
    MemoryInline::FlatWrite8((r6 + 2009), static_cast<uint8_t>(r28));
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x800D6CF8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_800D6D18:
{
    ...
    r5 = 1374420992;
    r3 = (r3 + -26988);
    r0_rot_8 = PpcRotl32Inline(static_cast<uint32_t>(r28), static_cast<uint32_t>(2));
    r0 = (r0_rot_8 & -4);
    r8 = MemoryInline::FlatRead32((r3 + 4));
    r9 = (r5 + -31457);
    r3_addr_3 = (r3 + r0);
...
loc_800D6DD8:
{
    r0 = 255;
    r4 = (r30 + 808);
    MemoryInline::FlatWrite8((r8 + 2008), static_cast<uint8_t>(r0));
    r3 = 64;
    r5 = 6;
    r6 = MemoryInline::FlatRead32((r13 + -26868));
    MemoryInline::FlatWrite8((r6 + 2009), static_cast<uint8_t>(r28));
...
loc_800D6E4C:
{
    r4 = MemoryInline::FlatRead32((r8 + 2144));
    r7 = (r8 + 2016);
    r5 = MemoryInline::FlatRead32((r8 + 2012));
    r3 = 6;
    r6 = MemoryInline::FlatRead16((r8 + 2010));
    r8 = MemoryInline::FlatRead32((r8 + 2148));
    ctx->lr = 0x800D6E68u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_800D7FF4:
{
    ...
    r4_subfc_min_8 = r4;
    r4 = (r4_subfc_min_8 - r8);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(r4_subfc_min_8) >= static_cast<uint32_t>(r8) ? 1u : 0u) << 29);
    r0 = (static_cast<uint32_t>((static_cast<uint64_t>(r6) * static_cast<uint64_t>(r0)) >> 32));
    r5 = 0;
    r3_subfe_rb_8 = r3;
    r3_not_8 = ~(r7);
...
loc_800D82A4:
{
    ...
    r6 = 0x80000000u;
    r4_subfc_min_10 = r4;
    r4 = (r4_subfc_min_10 - r27);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(r4_subfc_min_10) >= static_cast<uint32_t>(r27) ? 1u : 0u) << 29);
    MemoryInline::FlatWrite32((r13 + -26864), r3);
    r7 = (r28 + 19923);
    r3_subfe_rb_10 = r3;
    r3_not_10 = ~(r26);
    ...
    r6 = (static_cast<int32_t>(r6) >> 6);
    r0_rot_16 = PpcRotl32Inline(static_cast<uint32_t>(r6), static_cast<uint32_t>(1));
    r0 = (r0_rot_16 & 1);
    r3 = 1;
    r6 = (r6 + r0);
    r7 = (r4 - r6);
    ...
    r0 = (static_cast<int32_t>(r0) >> 5);
    r7_rot_6 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(1));
    r7 = (r7_rot_6 & 1);
    r7 = (r0 + r7);
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x800D833Cu;
...
loc_800D83B8:
{
    ...
    if (MkwStateFreeAbiEnabled(0x8011E43Cu) && KnownTranslatedCpuCall<0x8011E43Cu>::kAvailable && !KnownTranslatedCpuCall<0x8011E43Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x8011E43Cu>()) {
        const auto state_free_result_8011E43C_12BB7 = func_8011E43C_statefree_v0(r3, xer);
        r0 = static_cast<uint32_t>(state_free_result_8011E43C_12BB7[0]);
        r3 = static_cast<uint32_t>(state_free_result_8011E43C_12BB7[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_800D8614:
{
    ...
    r4_subfc_min_13 = r4;
    r4 = (r4_subfc_min_13 - r8);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(r4_subfc_min_13) >= static_cast<uint32_t>(r8) ? 1u : 0u) << 29);
    r0 = (static_cast<uint32_t>((static_cast<uint64_t>(r6) * static_cast<uint64_t>(r0)) >> 32));
    r5 = 0;
    r3_subfe_rb_13 = r3;
    r3_not_13 = ~(r7);
...
// RECOMP_REGISTRATION base 0x800D6AA8 func_800D6AA8 preserves=true fpr_mask=0x00000000
