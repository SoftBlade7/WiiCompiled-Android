...
extern "C" void func_805D1044(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r3_rot_0 = 0;
    uint32_t r3_rot_1 = 0;
...
loc_805D1044:
{
    ...
    ctx->gpr[7] = r7;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x800B2530u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r9 = MemoryInline::FlatRead16((r27 + 12));
    r0 = MemoryInline::FlatRead16((r27 + 14));
    r6 = MemoryInline::FlatRead8(r27);
    r28 = (r9 * r0);
    r5 = MemoryInline::FlatRead8((r27 + 1));
    r6 = (r6 + 1);
    r0 = (r5 + 1);
    r5 = PPC_Divwu(static_cast<uint32_t>(r4), static_cast<uint32_t>(r28));
    r5 = (r5 * r28);
    r8 = (r4 - r5);
    r7 = PPC_Divwu(static_cast<uint32_t>(r8), static_cast<uint32_t>(r9));
    r5 = (r7 * r9);
    r5 = (r8 - r5);
    r29 = (r5 * r6);
    r30 = (r7 * r0);
    ...
    r6 = ctx->gpr[6];
    r0 = (r31 & 65535);
    r6 = MemoryInline::FlatRead32((r25 + 28));
    r0 = PPC_Divwu(static_cast<uint32_t>(r0), static_cast<uint32_t>(r28));
    r5_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r29), static_cast<uint32_t>(15));
    r5 = (r5_rot_0 & -32768);
    r4_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r30), static_cast<uint32_t>(15));
    r4 = (r4_rot_0 & -32768);
    ...
    MemoryInline::FlatWrite16((r26 + 4), static_cast<uint16_t>(r0));
    r0 = MemoryInline::FlatRead16((r27 + 18));
    r0 = PPC_Divwu(static_cast<uint32_t>(r4), static_cast<uint32_t>(r0));
    MemoryInline::FlatWrite16((r26 + 8), static_cast<uint16_t>(r0));
    ...
    r3 = (r3_rot_1 & -32768);
    r0 = PPC_Divwu(static_cast<uint32_t>(r3), static_cast<uint32_t>(r0));
    MemoryInline::FlatWrite16((r26 + 10), static_cast<uint16_t>(r0));
...
// RECOMP_GUEST_ABI gpr_read=0xFE0000FA gpr_write=0xFE0003FB gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x805D1044 func_805D1044 preserves=true fpr_mask=0x00000000
