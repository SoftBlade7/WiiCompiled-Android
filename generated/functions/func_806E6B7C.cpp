...
extern "C" void func_806E6B7C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806E6B7C:
{
    ...
    r31 = r3;
    f2.d = MemoryInline::FlatReadFloat32((r6 + 100));
    f1.d = MemoryInline::FlatReadFloat32((r6 + 120));
...
// RECOMP_REGISTRATION base 0x806E6B7C func_806E6B7C preserves=true fpr_mask=0x00000000
