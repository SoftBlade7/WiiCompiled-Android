...
extern "C" void func_805479E8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_805479E8:
{
    ...
    r0 = (r0_rot_0 & -2);
    r4 = (r3 + r0);
    r4 = MemoryInline::FlatRead16((r4 + -27836));
    r3 = 65536;
    r0 = (r3 + -1);
...
// RECOMP_REGISTRATION base 0x805479E8 func_805479E8 preserves=true fpr_mask=0x00000000
