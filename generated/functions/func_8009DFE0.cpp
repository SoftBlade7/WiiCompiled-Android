...
extern "C" void func_8009DFE0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8009DFE0:
{
    ...
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x8009F4E0u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8009DFE0 func_8009DFE0 preserves=true fpr_mask=0x00000000
