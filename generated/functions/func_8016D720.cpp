...
extern "C" void func_8016D720(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8016D720:
{
    ...
    r6_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(13));
    r6_mrot_0 = (r6_rot_0 & 24576);
    r6_mdest_0 = (r6 & -24577);
...
// RECOMP_REGISTRATION base 0x8016D720 func_8016D720 preserves=true fpr_mask=0x00000000
