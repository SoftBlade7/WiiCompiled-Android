...
extern "C" void func_8058EC48(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8058EC90:
{
    ...
    ctx->fpr[1] = f1;
    ctx->cr = cr;
    InvokeDirectCpu<0x80577D7Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8058EC48 func_8058EC48 preserves=true fpr_mask=0x00000000
