...
extern "C" void func_801AE7DC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801AE804:
{
    r0 = MemoryInline::FlatRead8((r26 + 10));
...
loc_801AE820:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r5 = MemoryInline::FlatRead8((r29 + 9));
    r3 = (r26 + 4);
...
// RECOMP_REGISTRATION base 0x801AE7DC func_801AE7DC preserves=true fpr_mask=0x00000000
