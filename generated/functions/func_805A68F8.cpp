...
extern "C" void func_805A68F8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lfsx_805A69BC_loc_0 = 0;
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
    uint32_t r0_rot_2 = 0;
...
loc_805A68F8:
{
    ...
    r26 = r3;
    r30 = MemoryInline::FlatRead32((r3 + 824));
...
loc_805A69BC:
{
    addr_lfsx_805A69BC_loc_0 = (r4 + r0);
    f0.d = MemoryInline::FlatReadFloat32(addr_lfsx_805A69BC_loc_0);
...
{
    r0 = 1;
    MemoryInline::FlatWrite8((r30 + 28), static_cast<uint8_t>(r0));
}

loc_805A6A50:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r29), static_cast<int32_t>(44));
}
...
loc_805A6A64:
{
    r4 = MemoryInline::FlatRead8((r26 + 156));
    r3 = 0x809C0000u;
...
// RECOMP_REGISTRATION base 0x805A68F8 func_805A68F8 preserves=false fpr_mask=0xE0000000
