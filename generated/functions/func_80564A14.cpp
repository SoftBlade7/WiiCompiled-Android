...
extern "C" void func_80564A14(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80564A14:
{
    ...
    r30 = 0x809C0000u;
    r0 = MemoryInline::FlatRead32((r30 + 6260));
    r0 = (r0 & 16);
...
loc_80564A38:
{
    ...
    r0 = (r0 + r4);
    r3 = MemoryInline::FlatRead32((r5 + 6264));
    ...
    xer = ctx->xer;
    r3 = 0x808B0000u;
    r3 = MemoryInline::FlatRead32((r3 + 19452));
    ctx->lr = 0x80564AB8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r0 = MemoryInline::FlatRead32((r30 + 6260));
    r0 = (r0 & -17);
    MemoryInline::FlatWriteRam32((r30 + 6260), r0);
}
...
// RECOMP_REGISTRATION base 0x80564A14 func_80564A14 preserves=true fpr_mask=0x00000000
