...
extern "C" void func_80637BA4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80637BA4:
{
    ...
    r11 = (r4 * 576);
    MemoryInline::FlatWrite32((r3 + 376), r9);
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r26 + 392), r3);
    r3 = r26;
    r4 = MemoryInline::FlatRead32((r26 + 380));
    ctx->lr = 0x80637C18u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_80637C28:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x806381A4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r26 + 384));
    r4 = 4;
    r0 = MemoryInline::FlatRead32((r26 + 392));
    r3 = (r3 - r22);
    r5 = PPC_CntlzwInline(static_cast<uint32_t>(r3));
    r3 = (r0 + r23);
    r24_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(27));
...
loc_80637C8C:
{
    f1.d = MemoryInline::FlatReadFloat32((r25 + -30968));
    r4 = 2;
    ctx->lr = 0x80637C98u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80637CB4:
{
    r0 = MemoryInline::FlatRead32((r26 + 380));
...
{
    r0 = MemoryInline::FlatRead32((r26 + 392));
    r4 = MemoryInline::FlatRead32((r26 + 376));
    r3 = (r0 + r24);
    r3 = (r3 + 372);
...
// RECOMP_REGISTRATION base 0x80637BA4 func_80637BA4 preserves=true fpr_mask=0x00000000
