...
extern "C" void func_8084A100(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r8_rot_0 = 0;
...
loc_8084A100:
{
    ...
    r30 = r3;
    r31 = r5;
    r0 = MemoryInline::FlatRead32((r4 + 516));
    ...
    r6 = (r7 + r8);
    r4 = (r0 + r8);
    r28 = MemoryInline::FlatRead32((r6 + 1752));
    MemoryInline::FlatWrite32((r4 + 316), r28);
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWrite8((r27 + 529), static_cast<uint8_t>(r0));
    ...
    if (MkwStateFreeAbiEnabled(0x80860484u) && KnownTranslatedCpuCall<0x80860484u>::kAvailable && !KnownTranslatedCpuCall<0x80860484u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80860484u>()) {
        const auto state_free_result_80860484_14C8 = func_80860484_statefree_v1(r3, xer);
        r3 = static_cast<uint32_t>(state_free_result_80860484_14C8);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_8084A188:
{
    ...
    r3 = (r3 + r0);
    MemoryInline::FlatWrite32((r3 + 548), r28);
    goto loc_8084A1B8;
}
...
loc_8084A1D8:
{
    r12 = MemoryInline::FlatRead32((r30 + 9392));
    r3 = (r30 + 9392);
    ...
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x80860484u) && KnownTranslatedCpuCall<0x80860484u>::kAvailable && !KnownTranslatedCpuCall<0x80860484u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80860484u>()) {
        const auto state_free_result_80860484_2A75 = func_80860484_statefree_v0(r3, xer);
        r0 = static_cast<uint32_t>(state_free_result_80860484_2A75[0]);
        r3 = static_cast<uint32_t>(state_free_result_80860484_2A75[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8084A100 func_8084A100 preserves=false fpr_mask=0x80000000
