...
extern "C" void func_80027750(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80027750:
{
    ...
    r4 = r6;
    MemoryInline::FlatWriteFloat32((r6 + -16352), f2.d);
    r3 = r5;
    r4 = (r4 + -16340);
    MemoryInline::FlatWriteFloat32((r6 + -16348), f1.d);
    MemoryInline::FlatWriteFloat32((r6 + -16344), f0.d);
    ...
    r3 = (r31 + 65536);
    MemoryInline::FlatWriteFloat32((r3 + -16288), f30.d);
    MemoryInline::FlatWriteFloat32((r3 + -16292), f31.d);
    // psq_load w=0 quant=0 (using PPC_PsqL)
...
// RECOMP_GUEST_ABI gpr_read=0x8000003A gpr_write=0x8000005B gpr_return=0x00000018 fpr_read=0xC0000006 fpr_write=0xC000003F fpr_return=0x00000002 cr_read=0x00 cr_write=0x00 xer_read=0 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80027750 func_80027750 preserves=true fpr_mask=0x00000000
