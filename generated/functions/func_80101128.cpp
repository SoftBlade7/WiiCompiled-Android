...
extern "C" void func_80101128(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80101214:
{
    ...
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r30 + 12));
    MemoryInline::FlatWrite32((r3 + 56), r28);
}
...
// RECOMP_REGISTRATION base 0x80101128 func_80101128 preserves=true fpr_mask=0x00000000
