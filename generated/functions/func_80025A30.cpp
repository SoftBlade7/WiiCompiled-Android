...
extern "C" void func_80025A30(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80025A30:
{
    ...
    InvokeDirectCpu<0x80025890u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
...
// RECOMP_REGISTRATION base 0x80025A30 func_80025A30 preserves=true fpr_mask=0x00000000
