...
extern "C" void func_80020D20(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80020D48:
{
    ...
    ctx->gpr[5] = r5;
    ctx->cr = cr;
    InvokeDirectCpu<0x801A1038u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
    cr = ctx->cr;
    // inline leaf 0x801A0FB8 (4 guest instruction(s))
    r0 = MemoryInline::FlatRead32((r13 + -29032));
    MemoryInline::FlatWrite32((r13 + -29032), r3);
    r3 = r0;
    // end of inlined leaf 0x801A0FB8
    r3 = r30;
    // inline leaf 0x801A10FC (2 guest instruction(s))
    MemoryInline::FlatWrite32((r13 + -29024), r3);
    // end of inlined leaf 0x801A10FC
...
// RECOMP_REGISTRATION base 0x80020D20 func_80020D20 preserves=true fpr_mask=0x00000000
