...
extern "C" void func_808122FC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80812328:
{
    ...
    r31 = ctx->gpr[31];
    cr = ctx->cr;
    r29 = MemoryInline::FlatRead32((r30 + 328));
    r30 = (r30 + 88);
    r31 = 0;
}
...
// RECOMP_REGISTRATION base 0x808122FC func_808122FC preserves=true fpr_mask=0x00000000
