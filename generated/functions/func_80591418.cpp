...
extern "C" void func_80591418(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80591418:
{
    ...
    r3 = MemoryInline::FlatRead16((r3 + 588));
    r3 = (r3 << 16);
...
// RECOMP_REGISTRATION base 0x80591418 func_80591418 preserves=true fpr_mask=0x00000000
