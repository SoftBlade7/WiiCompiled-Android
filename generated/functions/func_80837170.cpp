...
extern "C" void func_80837170(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_808371A0:
{
    ...
    r4 = MemoryInline::FlatRead32((r29 + 996));
    ctx->lr = 0x808371C0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_80837234:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r31 = MemoryInline::FlatRead8((r3 + 13));
...
loc_808372B8:
{
    r0 = MemoryInline::FlatRead32((r29 + 784));
...
// RECOMP_REGISTRATION base 0x80837170 func_80837170 preserves=true fpr_mask=0x00000000
