...
extern "C" void func_807C962C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807C96D0:
{
    ...
    r6 = (r1 + 8);
    f1.d = MemoryInline::FlatReadFloat32((r3 + 28944));
    r4 = 0;
...
loc_807C9808:
{
    ...
    InvokeDirectCpu<0x807CA6E4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x807C962C func_807C962C preserves=true fpr_mask=0x00000000
