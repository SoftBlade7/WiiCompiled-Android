...
extern "C" void func_807655B4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lhax_8076568C_loc_0 = 0;
    uint32_t addr_lhax_807656CC_loc_0 = 0;
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
    uint32_t r0_rot_2 = 0;
...
loc_807655B4:
{
    ...
    r3 = 0x808A0000u;
    r28 = 0;
    f31.d = MemoryInline::FlatReadFloat64((r3 + 14992));
    r29 = 0;
    r31 = 0x809C0000u;
    r26 = 1127219200;
}
...
loc_80765614:
{
    r12 = MemoryInline::FlatRead32((r27 + 356));
    r3 = (r27 + 356);
...
loc_80765628:
{
    r30 = MemoryInline::FlatRead32((r27 + 364));
    r3 = 108;
    ctx->lr = 0x80765634u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80765640:
{
    ...
    addr_lhax_8076568C_loc_0 = (r4 + r0);
    r0 = MemoryInline::FlatRead16(addr_lhax_8076568C_loc_0);
    r0 = (r0 << 16);
    r0 = (static_cast<int32_t>(r0) >> 16);
    r0 = (r0 * 116);
    r4 = (r5 + r0);
    r24 = MemoryInline::FlatRead16((r4 + 110));
    r24 = (r24 << 16);
    ...
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead32((r31 + 17200));
    r5_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(1));
    r5 = (r5_rot_2 & 131070);
    r0 = (r24 ^ -2147483648);
    ...
    addr_lhax_807656CC_loc_0 = (r6 + r5);
    r0 = MemoryInline::FlatRead16(addr_lhax_807656CC_loc_0);
    r0 = (r0 << 16);
    r0 = (static_cast<int32_t>(r0) >> 16);
...
loc_80765700:
{
    r28 = (r28 + 1);
    r30_addr_2 = (r30 + r29);
    MemoryInline::FlatWrite32(r30_addr_2, r25);
...
// RECOMP_REGISTRATION base 0x807655B4 func_807655B4 preserves=false fpr_mask=0x80000000
