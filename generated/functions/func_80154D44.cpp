...
extern "C" void func_80154D44(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80154D70:
{
    ...
    r4 = (r4 | 161);
    r5 = r3;
    MemoryInline::FlatWriteRam8((r3 + 20), static_cast<uint8_t>(r4));
    r4 = 0;
...
// RECOMP_REGISTRATION base 0x80154D44 func_80154D44 preserves=true fpr_mask=0x00000000
