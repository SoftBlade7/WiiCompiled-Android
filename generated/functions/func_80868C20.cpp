...
extern "C" void func_80868C20(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_80868C20:
{
    ...
    r27 = r3;
    r30_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(4));
    r30 = (r30_rot_0 & -16);
    r6 = (r27 + r30);
    r28 = r4;
    r29 = r5;
...
{
    r4 = 0x808B0000u;
    f1.d = MemoryInline::FlatReadFloat32((r4 + 8136));
    r4 = 0;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
{
    r4 = 0x808B0000u;
    f1.d = MemoryInline::FlatReadFloat32((r4 + 8140));
...
loc_80868CD4:
{
    r3 = MemoryInline::FlatRead32(r31);
    r4 = (r27 + r30);
    f1.d = MemoryInline::FlatReadFloat32((r4 + 17004));
}
...
// RECOMP_REGISTRATION base 0x80868C20 func_80868C20 preserves=true fpr_mask=0x00000000
