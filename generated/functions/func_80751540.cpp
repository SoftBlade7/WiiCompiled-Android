...
extern "C" void func_80751540(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807515F4:
{
    ...
    f30.d = MemoryInline::FlatReadFloat32((r30 + 12));
}
...
loc_807515FC:
{
    ...
    f31 = ctx->fpr[31];
    cr = ctx->cr;
    f0.d = MemoryInline::FlatReadFloat32((r28 + 396));
    f1.d = f31.d;
    MemoryInline::FlatWriteRamFloat32((r1 + 44), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r28 + 400));
    MemoryInline::FlatWriteRamFloat32((r1 + 60), f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r28 + 404));
...
loc_807516B4:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r28 + 408));
    r12 = MemoryInline::FlatRead32(r3);
    r12 = MemoryInline::FlatRead32((r12 + 12));
    ctr = r12;
    ctx->lr = 0x80751718u;
...
loc_807517C8:
{
    r3 = MemoryInline::FlatRead32((r28 + 388));
    r4 = 5;
    ...
    r0 = fctiwzword0;
    MemoryInline::FlatWrite32((r28 + 420), r0);
    // inline leaf 0x805555CC (23 guest instruction(s))
    r5 = -1293680640;
    r11 = MemoryInline::FlatRead32((r3 + 12));
    r8 = (r5 + -11215);
...
loc_80751894:
{
    ...
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 104), 0, 64u, true, false);
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 40u, (r1 + 144));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r11 = (r1 + 128);
    f30.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 24u, (r1 + 128));
    ...
    r0 = MemoryInline::ReadResolved32(guest_range_1, 60u, (r1 + 164));
    ctx->lr = r0;
    r1 = (r1 + 160);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x80751540 func_80751540 preserves=false fpr_mask=0xC0000000
