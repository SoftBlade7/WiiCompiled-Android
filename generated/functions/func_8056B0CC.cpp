...
extern "C" void func_8056B0CC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lfsx_8056B0EC_loc_0 = 0;
    uint32_t addr_lfsx_8056B0F4_loc_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8056B0CC:
{
    ...
    r5 = (r5 + 20672);
    r4 = (r6 + r0);
    addr_lfsx_8056B0EC_loc_0 = (r3 + r0);
    f9.d = MemoryInline::FlatReadFloat32(addr_lfsx_8056B0EC_loc_0);
    r3 = 0x80890000u;
    addr_lfsx_8056B0F4_loc_0 = (r5 + r0);
    f0.d = MemoryInline::FlatReadFloat32(addr_lfsx_8056B0F4_loc_0);
    r0 = 1;
...
// RECOMP_GUEST_ABI gpr_read=0x00000018 gpr_write=0x00000079 gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x000003FF fpr_return=0x00000002 cr_read=0x00 cr_write=0x00 xer_read=0 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8056B0CC func_8056B0CC preserves=true fpr_mask=0x00000000
