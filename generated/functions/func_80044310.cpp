...
extern "C" void func_80044310(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80044310:
{
    ...
    r21 = r6;
    r22 = r7;
    // inline leaf 0x80040B20 (2 guest instruction(s))
    r3 = (r3 + 156);
    // end of inlined leaf 0x80040B20
    ...
    r3 = r18;
    r4 = r31;
    // inline leaf 0x80044650 (2 guest instruction(s))
    r3 = MemoryInline::FlatRead16((r4 + 80));
    // end of inlined leaf 0x80044650
    r4 = MemoryInline::FlatRead8((r30 + 169));
    r25 = r3;
    r0 = MemoryInline::FlatRead8((r30 + 178));
    r4 = (static_cast<int32_t>(static_cast<int8_t>(r4)));
    f2.d = MemoryInline::FlatReadFloat64((r2 + -30016));
    r4 = (r4 ^ -2147483648);
    MemoryInline::FlatWriteRam32((r1 + 12), r4);
    r5 = (r0 & 7);
    f0.d = MemoryInline::FlatReadFloat32((r2 + -30024));
    ...
    r24_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(27));
    r24 = (r24_rot_0 & 134217727);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r24), static_cast<int32_t>(0));
}

loc_80044414:
{
    r23_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(27));
    r23 = (r23_rot_0 & 134217727);
...
loc_8004442C:
{
    r5_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r25), static_cast<uint32_t>(1));
    r5 = (r5_rot_0 & 65534);
    r3 = 152;
    r4 = 0;
    ctx->gpr[1] = r1;
    ...
    r3 = r18;
    r4 = r30;
    // inline leaf 0x80044660 (3 guest instruction(s))
    r0 = MemoryInline::FlatRead8((r4 + 178));
    r3 = (r0 & 192);
    // end of inlined leaf 0x80044660
}

loc_8004444C:
{
    if ((static_cast<int32_t>(r3) != static_cast<int32_t>(64))) {
        goto loc_80044458;
    }
}
...
loc_80044450:
{
    f30.d = MemoryInline::FlatReadFloat32((r2 + -30020));
    goto loc_80044478;
}
...
loc_80044458:
{
    ...
    // inline leaf 0x80044670 (6 guest instruction(s))
    ...
    f1.d = f0.d;
    // end of inlined leaf 0x80044670
    f30.d = f1.d;
...
loc_800444A8:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80044690u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
...
loc_800444EC:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    f31.d = MemoryInline::FlatReadFloat64((r2 + -30016));
    r17 = r3;
    goto loc_80044560;
}
...
{
    ctx->gpr[1] = r1;
    InvokeDirectCpu<0x80044B30u>(ctx);
...
// RECOMP_REGISTRATION base 0x80044310 func_80044310 preserves=false fpr_mask=0xE0000000
