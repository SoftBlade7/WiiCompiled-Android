...
extern "C" void func_806DDCB0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806DDCB0:
{
    ...
    MemoryInline::FlatWrite8((r30 + 180), static_cast<uint8_t>(r0));
    ctx->lr = 0x806DDCF4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_806DDCFC:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8070E7B8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x806DDCB0 func_806DDCB0 preserves=true fpr_mask=0x00000000
