...
extern "C" void func_80748B70(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80748B70:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r6 + -18116));
    r12 = MemoryInline::FlatRead32((r12 + 16));
    f2.d = MemoryInline::FlatReadFloat32((r5 + -18112));
    ctr = r12;
    ctx->lr = 0x80748BB8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctx->fpr[2] = f2;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x807472F4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80748B70 func_80748B70 preserves=true fpr_mask=0x00000000
