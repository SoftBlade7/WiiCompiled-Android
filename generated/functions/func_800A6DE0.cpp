...
extern "C" void func_800A6DE0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800A6E8C:
{
    ...
    MemoryInline::FlatWrite8((r3 + 161), static_cast<uint8_t>(r30));
}
...
loc_800A6E9C:
{
    r0 = MemoryInline::FlatRead32((r24 + 2088));
...
// RECOMP_REGISTRATION base 0x800A6DE0 func_800A6DE0 preserves=true fpr_mask=0x00000000
