...
extern "C" void func_805EED70(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805EED70:
{
    ...
    r4 = MemoryInline::FlatRead8((r3 + 13));
...
// RECOMP_REGISTRATION base 0x805EED70 func_805EED70 preserves=true fpr_mask=0x00000000
