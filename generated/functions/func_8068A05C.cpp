...
extern "C" void func_8068A05C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8068A05C:
{
    ...
    guest_range_0 = MemoryInline::ResolveRangeHost((r3 + 48), 0, 36u, true, false);
    ...
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 28u, (r3 + 76));
    ...
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 16u, (r3 + 64));
...
// RECOMP_REGISTRATION base 0x8068A05C func_8068A05C preserves=false fpr_mask=0xF8000000
