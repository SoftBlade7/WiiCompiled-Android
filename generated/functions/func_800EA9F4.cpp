...
extern "C" void func_800EA9F4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800EAA5C:
{
    ...
    r4 = (r3 + 20);
    MemoryInline::FlatWrite32((r3 + 24), r26);
    MemoryInline::FlatWrite32((r3 + 28), r27);
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8012219Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x800EA9F4 func_800EA9F4 preserves=true fpr_mask=0x00000000
