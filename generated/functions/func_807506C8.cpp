...
extern "C" void func_807506C8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807506C8:
{
    ...
    r31 = ctx->gpr[31];
    r0 = 0;
    MemoryInline::FlatWrite8((r31 + 50), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x807506C8 func_807506C8 preserves=true fpr_mask=0x00000000
