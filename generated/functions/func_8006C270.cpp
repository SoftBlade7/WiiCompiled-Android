...
extern "C" void func_8006C270(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8006C270:
{
    ...
    f6.d = MemoryInline::FlatReadFloat32((r2 + -29336));
    f8.d = PpcFmulsInline(f5.d, f2.d);
    f3.d = (-(f9.d));
    ...
    MemoryInline::WriteResolvedFloat32(guest_range_0, 0u, r30, f7.d);
    ...
    MemoryInline::WriteResolvedFloat32(guest_range_0, 16u, (r30 + 16), f10.d);
    f0.d = static_cast<double>(PpcForceSingleValueInline(f0.d + f1.d));
    MemoryInline::WriteResolvedFloat32(guest_range_0, 20u, (r30 + 20), f9.d);
    MemoryInline::WriteResolvedFloat32(guest_range_0, 4u, (r30 + 4), f4.d);
    MemoryInline::WriteResolvedFloat32(guest_range_0, 12u, (r30 + 12), f2.d);
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 24u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f6.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f0.d))))) {
...
// RECOMP_GUEST_ABI gpr_read=0xC000003E gpr_write=0xC000003B gpr_return=0x00000018 fpr_read=0x0000000C fpr_write=0x000007FF fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8006C270 func_8006C270 preserves=true fpr_mask=0x00000000
