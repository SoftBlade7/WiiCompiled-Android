...
extern "C" void func_80126948(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = 1;
    MemoryInline::FlatWrite32((r13 + -26328), r0);
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x80126948 func_80126948 preserves=true fpr_mask=0x00000000
