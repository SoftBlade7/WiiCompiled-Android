...
extern "C" void func_805104DC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r4 = 0x809C0000u;
    r3 = MemoryInline::FlatRead32((r4 + -10528));
...
{
    r0 = 0;
    MemoryInline::FlatWriteRam32((r4 + -10528), r0);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_return;
    }
}
...
// RECOMP_REGISTRATION base 0x805104DC func_805104DC preserves=true fpr_mask=0x00000000
