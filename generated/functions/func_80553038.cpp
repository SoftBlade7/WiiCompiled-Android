...
extern "C" void func_80553038(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80553038:
{
    ...
    r27 = 0;
    r30 = MemoryInline::FlatRead16((r4 + -470));
    r4 = 274857984;
    r31 = MemoryInline::FlatRead16((r5 + -472));
    r26 = r3;
    r25 = (r30 * r27);
    r23 = (r4 + 19923);
    r29 = 1;
...
loc_80553134:
{
    ...
    r0 = (static_cast<uint32_t>((static_cast<uint64_t>(r30) * static_cast<uint64_t>(r4)) >> 32));
    r3 = (r22 * r4);
    r0 = (r0 + r3);
    r4 = (r30 * r4);
    r3 = (r0 + r25);
...
// RECOMP_REGISTRATION base 0x80553038 func_80553038 preserves=true fpr_mask=0x00000000
