...
extern "C" void func_8014F180(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8014F180:
{
    ...
    r6 = MemoryInline::FlatRead8((r7 + 49));
    r0 = (r6 + 1);
    MemoryInline::FlatWrite8((r7 + 49), static_cast<uint8_t>(r0));
    r6 = (r0 & 255);
...
loc_8014F1F0:
{
    r5 = MemoryInline::FlatRead16((r31 + 22));
    r0 = 0;
    r4 = r3;
    ...
    r5 = (static_cast<int32_t>(r5) >> 8);
    MemoryInline::FlatWrite8((r3 + 23), static_cast<uint8_t>(r5));
...
// RECOMP_REGISTRATION base 0x8014F180 func_8014F180 preserves=true fpr_mask=0x00000000
