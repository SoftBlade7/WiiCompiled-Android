...
extern "C" void func_805FEA58(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805FEA58:
{
    ...
    r4 = -1;
    MemoryInline::FlatWrite32((r3 + 3816), r4);
...
loc_805FEA6C:
{
    r0 = MemoryInline::FlatRead8((r3 + 3820));
    r4 = 0;
    r0 = (r0 * 596);
    r3 = (r3 + r0);
    r3 = (r3 + 1400);
...
// RECOMP_REGISTRATION base 0x805FEA58 func_805FEA58 preserves=true fpr_mask=0x00000000
