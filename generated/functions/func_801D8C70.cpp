...
extern "C" void func_801D8C70(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801D8CA8:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801D9A2Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801D8CB8:
{
    r3 = MemoryInline::FlatRead32((r3 + 1080));
    goto loc_801D8CCC;
}
...
// RECOMP_REGISTRATION base 0x801D8C70 func_801D8C70 preserves=true fpr_mask=0x00000000
