...
extern "C" void func_80700474(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80700474:
{
    ...
    r29 = r3;
    r5 = MemoryInline::FlatRead32((r31 + 10392));
    ...
    r5 = (r30 + 40);
    r0 = (r4 + 124);
    MemoryInline::FlatWrite32((r29 + 84), r3);
    r3 = r30;
    r4 = r29;
    MemoryInline::FlatWrite32((r29 + 148), r0);
    r6 = 2;
    ctx->lr = 0x8070051Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x80700474 func_80700474 preserves=true fpr_mask=0x00000000
