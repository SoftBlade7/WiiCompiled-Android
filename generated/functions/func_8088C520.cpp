...
extern "C" void func_8088C520(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = 0;
    MemoryInline::FlatWrite32((r3 + 7196), r0);
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x8088C520 func_8088C520 preserves=true fpr_mask=0x00000000
