...
extern "C" void func_80151018(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80151090:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x801519E0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801510DC:
{
    if ((static_cast<uint32_t>(r0) > static_cast<uint32_t>(12000))) {
        goto loc_801510F4;
    }
}
...
loc_801510E0:
{
    r3 = MemoryInline::FlatRead16((r31 + 56));
    r0 = MemoryInline::FlatRead16((r31 + 160));
    r3 = (r3 + 1);
}
...
loc_8015111C:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x801546F4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
{
    r0 = 1;
    MemoryInline::FlatWrite8((r31 + 101), static_cast<uint8_t>(r0));
    goto loc_80151200;
}
...
// RECOMP_REGISTRATION base 0x80151018 func_80151018 preserves=true fpr_mask=0x00000000
