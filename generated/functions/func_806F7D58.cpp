...
extern "C" void func_806F7D58(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806F7D78:
{
    ...
    r27 = MemoryInline::FlatRead32((r29 + 8992));
...
{
    r30 = 0;
    MemoryInline::FlatWriteRam32((r29 + 8992), r30);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_806F7EB4;
    }
}
...
loc_806F7DC0:
{
    ...
    r26 = MemoryInline::FlatRead32((r29 + 8992));
...
loc_806F7DF4:
{
    ...
    r25 = MemoryInline::FlatRead32((r29 + 8992));
...
loc_806F7E28:
{
    MemoryInline::FlatWrite32(r25, r28);
    r24 = MemoryInline::FlatRead32((r29 + 8992));
...
loc_806F7E5C:
{
    MemoryInline::FlatWrite32(r24, r28);
    ctx->lr = 0x806F7E64u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x806F7D58 func_806F7D58 preserves=true fpr_mask=0x00000000
