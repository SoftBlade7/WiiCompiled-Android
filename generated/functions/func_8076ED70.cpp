...
extern "C" void func_8076ED70(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8076ED70:
{
    ...
    r31 = ctx->gpr[31];
    ctr = ctx->ctr;
    MemoryInline::FlatWrite8((r30 + 188), static_cast<uint8_t>(r31));
...
// RECOMP_REGISTRATION base 0x8076ED70 func_8076ED70 preserves=true fpr_mask=0x00000000
