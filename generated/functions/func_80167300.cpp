...
extern "C" void func_80167300(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80167360:
{
    ...
    r4 = 10;
    MemoryInline::FlatWriteRam32((r1 + 252), r5);
    r5 = 1;
...
// RECOMP_REGISTRATION base 0x80167300 func_80167300 preserves=true fpr_mask=0x00000000
