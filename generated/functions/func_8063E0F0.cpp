...
extern "C" void func_8063E0F0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8063E240:
{
    ...
    r3 = r27;
    r22 = (r0 * 28);
    // inline leaf 0x80080990 (2 guest instruction(s))
    r3 = MemoryInline::FlatRead32((r3 + 64));
    // end of inlined leaf 0x80080990
...
loc_8063E294:
{
    ...
    guest_range_2 = MemoryInline::ResolveRangeHost(r27, 0, 28u, true, false);
    r0 = MemoryInline::ReadResolved32(guest_range_2, 0u, r27);
    r24 = (r24 + 1);
    r3_addr_2 = (r3 + r22);
    guest_range_3 = MemoryInline::ResolveRangeHost(r3_addr_2, 0, 28u, false, true);
    MemoryInline::WriteResolved32(guest_range_3, 0u, r3_addr_2, r0);
    r3 = r3_addr_2;
    r0 = MemoryInline::ReadResolved32(guest_range_2, 4u, (r27 + 4));
    MemoryInline::WriteResolved32(guest_range_3, 4u, (r3 + 4), r0);
    r0 = MemoryInline::ReadResolved16(guest_range_2, 8u, (r27 + 8));
    MemoryInline::WriteResolved16(guest_range_3, 8u, (r3 + 8), static_cast<uint16_t>(r0));
    r0 = MemoryInline::ReadResolved16(guest_range_2, 10u, (r27 + 10));
    MemoryInline::WriteResolved16(guest_range_3, 10u, (r3 + 10), static_cast<uint16_t>(r0));
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_2, 12u, (r27 + 12));
    MemoryInline::WriteResolvedFloat32(guest_range_3, 12u, (r3 + 12), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_2, 16u, (r27 + 16));
    MemoryInline::WriteResolvedFloat32(guest_range_3, 16u, (r3 + 16), f0.d);
    r0 = MemoryInline::ReadResolved16(guest_range_2, 20u, (r27 + 20));
    MemoryInline::WriteResolved16(guest_range_3, 20u, (r3 + 20), static_cast<uint16_t>(r0));
    r0 = MemoryInline::ReadResolved16(guest_range_2, 22u, (r27 + 22));
    MemoryInline::WriteResolved16(guest_range_3, 22u, (r3 + 22), static_cast<uint16_t>(r0));
    r0 = MemoryInline::ReadResolved32(guest_range_2, 24u, (r27 + 24));
...
// RECOMP_REGISTRATION base 0x8063E0F0 func_8063E0F0 preserves=true fpr_mask=0x00000000
