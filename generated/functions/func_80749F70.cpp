...
extern "C" void func_80749F70(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80749F70:
{
    ...
    MemoryInline::FlatWriteFloat32((r30 + 764), f0.d);
    MemoryInline::FlatWriteFloat32((r30 + 768), f0.d);
...
loc_8074A048:
{
    f0.d = MemoryInline::FlatReadFloat32((r30 + 272));
    r3 = (r1 + 20);
...
// RECOMP_REGISTRATION base 0x80749F70 func_80749F70 preserves=true fpr_mask=0x00000000
