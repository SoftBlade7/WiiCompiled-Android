...
extern "C" void func_8021B7C0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8021B7C0:
{
    ...
    guest_range_0 = MemoryInline::ResolveRangeHost((r2 + -25684), 0, 20u, true, false);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 12u, (r2 + -25672));
    r4 = (r1 + 36);
    MemoryInline::FlatWriteFloat32((r28 + -32768), f0.d);
    r3 = 4;
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 12u, (r2 + -25672));
    MemoryInline::FlatWriteFloat32((r28 + -32768), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 12u, (r2 + -25672));
    MemoryInline::FlatWriteFloat32((r28 + -32768), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 16u, (r2 + -25668));
    MemoryInline::FlatWriteFloat32((r28 + -32768), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 12u, (r2 + -25672));
    MemoryInline::FlatWriteFloat32((r28 + -32768), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 12u, (r2 + -25672));
    MemoryInline::FlatWriteFloat32((r28 + -32768), f0.d);
    r7 = MemoryInline::ReadResolved8(guest_range_0, 0u, (r2 + -25684));
    r6 = MemoryInline::ReadResolved8(guest_range_0, 1u, (r2 + -25683));
    r5 = MemoryInline::ReadResolved8(guest_range_0, 2u, (r2 + -25682));
    r0 = MemoryInline::ReadResolved8(guest_range_0, 3u, (r2 + -25681));
    ...
    ctx->gpr[5] = r5;
    InvokeDirectCpu<0x8016F0F0u>(ctx);
    guest_range_1 = MemoryInline::ResolveRangeHost((r2 + -25680), 0, 16u, true, false);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 8u, (r2 + -25672));
    r4 = (r1 + 32);
    MemoryInline::FlatWriteFloat32((r28 + -32768), f0.d);
    r3 = 4;
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 8u, (r2 + -25672));
    ...
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 8u, (r2 + -25672));
    MemoryInline::FlatWriteFloat32((r28 + -32768), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 12u, (r2 + -25668));
    MemoryInline::FlatWriteFloat32((r28 + -32768), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 8u, (r2 + -25672));
    MemoryInline::FlatWriteFloat32((r28 + -32768), f0.d);
    r7 = MemoryInline::ReadResolved8(guest_range_1, 0u, (r2 + -25680));
    r6 = MemoryInline::ReadResolved8(guest_range_1, 1u, (r2 + -25679));
    r5 = MemoryInline::ReadResolved8(guest_range_1, 2u, (r2 + -25678));
    r0 = MemoryInline::ReadResolved8(guest_range_1, 3u, (r2 + -25677));
...
// RECOMP_REGISTRATION base 0x8021B7C0 func_8021B7C0 preserves=false fpr_mask=0xFE000000
