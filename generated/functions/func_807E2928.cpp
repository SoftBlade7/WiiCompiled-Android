...
extern "C" void func_807E2928(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807E2928:
{
    ...
    r6 = (r6_rot_0 & -2);
    r3 = (r1 + 8);
    r0 = PPC_Divw(static_cast<int32_t>(r27), static_cast<int32_t>(r6));
    r5 = (r30 + 98);
    r4 = 16;
    r0 = (r0 * r6);
    r6 = (r27 - r0);
...
loc_807E298C:
{
    r6 = MemoryInline::FlatRead32((r26 + 424));
    r4 = 0x808A0000u;
    r4 = (r4 + 32344);
    r3 = (r1 + 24);
    r0_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r6), static_cast<uint32_t>(1));
    r0 = (r0_rot_1 & -2);
    r7 = PPC_Divw(static_cast<int32_t>(r27), static_cast<int32_t>(r0));
    r5 = (r4 + 107);
    r4 = 32;
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x807E29B4u;
...
{
    r30 = (r27 * 608);
    r3 = MemoryInline::FlatRead32((r26 + 432));
    r31 = 0x808A0000u;
    ...
    r0 = (r0_rot_3 & -2);
    r4 = PPC_Divw(static_cast<int32_t>(r27), static_cast<int32_t>(r0));
    ctx->lr = 0x807E2A24u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x807E3CACu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead32((r26 + 432));
    r4 = (r0 + r30);
    MemoryInline::FlatWrite32((r4 + 576), r3);
    r0 = MemoryInline::FlatRead32((r26 + 432));
    r4 = (r0 + r30);
    MemoryInline::FlatWrite8((r4 + 596), static_cast<uint8_t>(r28));
...
loc_807E2BB4:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805BDBD4u) && KnownTranslatedCpuCall<0x805BDBD4u>::kAvailable && !KnownTranslatedCpuCall<0x805BDBD4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805BDBD4u>()) {
        const auto state_free_result_805BDBD4_7D0D = func_805BDBD4_statefree(r3, r4);
        r3 = static_cast<uint32_t>(state_free_result_805BDBD4_7D0D);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_807E2C54:
{
    ...
    r27 = (r0 + r30);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r27), static_cast<int32_t>(0));
    r29 = MemoryInline::FlatRead32((r27 + 576));
    MemoryInline::FlatWrite32((r31 + 372), r29);
    if (((cr & 0x20000000u) == 0)) {
        goto loc_807E2C80;
    }
}
...
loc_807E2CFC:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r24), static_cast<int32_t>(r25));
}
...
// RECOMP_REGISTRATION base 0x807E2928 func_807E2928 preserves=true fpr_mask=0x00000000
