...
extern "C" void func_8088CE9C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8088CE9C:
{
    ...
    r30 = r5;
    r0 = MemoryInline::FlatRead8((r7 + 19584));
...
loc_8088CFC4:
{
    r5 = 0x809C0000u;
    r3 = r31;
    r4 = MemoryInline::FlatRead8((r5 + 19584));
    r0 = (r4 + 1);
    MemoryInline::FlatWriteRam8((r5 + 19584), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x8088CE9C func_8088CE9C preserves=true fpr_mask=0x00000000
