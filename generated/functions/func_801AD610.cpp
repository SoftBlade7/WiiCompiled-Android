...
extern "C" void func_801AD610(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801AD6D4:
{
    r0 = MemoryInline::FlatRead8((r29 + 25));
    r4 = 0;
    r3 = MemoryInline::FlatRead8((r29 + 24));
    r3_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(8));
    r3_mrot_2 = (r3_rot_2 & 65280);
    r3_mdest_2 = (r3 & -65281);
...
// RECOMP_REGISTRATION base 0x801AD610 func_801AD610 preserves=true fpr_mask=0x00000000
