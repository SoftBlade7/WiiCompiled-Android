...
extern "C" void func_80130B50(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80130B84:
{
    ...
    xer = ctx->xer;
    r0 = 255;
    MemoryInline::FlatWriteRam8((r30 + 29), static_cast<uint8_t>(r0));
    goto loc_80130CCC;
}
...
// RECOMP_REGISTRATION base 0x80130B50 func_80130B50 preserves=true fpr_mask=0x00000000
