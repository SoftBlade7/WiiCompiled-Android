...
extern "C" void func_8074EAB0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8074EAB0:
{
    ...
    f31.d = MemoryInline::FlatReadFloat32((r4 + -16980));
}
...
// RECOMP_REGISTRATION base 0x8074EAB0 func_8074EAB0 preserves=false fpr_mask=0x80000000
