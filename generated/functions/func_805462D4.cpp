...
extern "C" void func_805462D4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_805462D4:
{
    ...
    r3 = (r3 + r4);
    r3 = (r3 + r0);
    r3 = MemoryInline::FlatRead16((r3 + 430));
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->gpr[6] = r6;
...
extern "C" MKW_PPC_NO_INLINE MkwStateFreeResult2 func_805462D4_statefree(uint32_t native_r3, uint32_t native_r4, uint32_t native_r5)
{
...
loc_805462D4:
{
    ...
    cached_r3 = MemoryInline::FlatRead16((cached_r3 + 430));
...
// RECOMP_STATE_FREE_ABI address=0x805462D4 symbol=func_805462D4_statefree gpr_in=0x00000038 gpr_out=0x00000048 fpr_in=0x00000000 fpr_out=0x00000000 cr_in=0x00 cr_out=0x00 gqr_in=0x00 hid_in=0x00 hid_out=0x00 xer_in=0 ctr_in=0 lr_in=0
...
// RECOMP_REGISTRATION base 0x805462D4 func_805462D4 preserves=true fpr_mask=0x00000000
