...
extern "C" void func_800A8DD0(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = (r13 + -27208);
    MemoryInline::FlatWrite32((r13 + -27104), r0);
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x800A8DD0 func_800A8DD0 preserves=true fpr_mask=0x00000000
