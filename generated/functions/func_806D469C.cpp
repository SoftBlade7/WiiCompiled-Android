...
extern "C" void func_806D469C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806D469C:
{
    ...
    guest_range_0 = MemoryInline::ResolveRangeHost((r3 + 180), 0, 24u, true, false);
...
loc_806D46D0:
{
    r5 = MemoryInline::ReadResolved32(guest_range_0, 12u, (r3 + 192));
    r5_addr_2 = (r5 + r7);
...
loc_806D4700:
{
    r5 = MemoryInline::ReadResolved32(guest_range_0, 20u, (r3 + 200));
...
loc_806D475C:
{
    ...
    r3 = MemoryInline::ReadResolved32(guest_range_0, 12u, (r3 + 192));
    r3_addr_1 = (r3 + r0);
...
// RECOMP_REGISTRATION base 0x806D469C func_806D469C preserves=true fpr_mask=0x00000000
