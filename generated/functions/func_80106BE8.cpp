...
extern "C" void func_80106BE8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80106C2C:
{
    ...
    r7 = r29;
    r8 = r30;
    MemoryInline::FlatWrite32((r4 + 332), r27);
    r9 = r31;
    r6 = (r1 + 8);
    r4 = 3;
    r5 = MemoryInline::FlatRead32((r1 + 12));
    MemoryInline::FlatWrite32((r5 + 336), r28);
    r11 = MemoryInline::FlatRead32(r26);
    r5 = MemoryInline::FlatRead32((r1 + 12));
...
// RECOMP_REGISTRATION base 0x80106BE8 func_80106BE8 preserves=true fpr_mask=0x00000000
