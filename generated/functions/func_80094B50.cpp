...
extern "C" void func_80094B50(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80094B50:
{
    ...
    r0 = ctx->lr;
    r5 = 0x80270000u;
    f5.d = MemoryInline::FlatReadFloat32((r2 + -28432));
    MemoryInline::WriteResolved32(guest_range_1, 68u, (r1 + 68), r0);
    r6 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r2 + -28416));
    r5 = (r5 + 17448);
    MemoryInline::WriteResolved32(guest_range_1, 60u, (r1 + 60), r31);
    r0 = 5;
    f4.d = MemoryInline::FlatReadFloat32((r2 + -28428));
    r31 = r3;
    f3.d = MemoryInline::FlatReadFloat32((r2 + -28424));
    r4 = (r1 + 8);
    f2.d = MemoryInline::FlatReadFloat32((r2 + -28420));
    f0.d = MemoryInline::FlatReadFloat32((r2 + -28412));
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 24u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f5.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f4.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 24u, (r3 + 24), f5.d);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 28u, (r3 + 28), f4.d);
    }
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 40u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f1.d))) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 40u, (r3 + 40), f1.d);
        MemoryInline::WriteResolved32(guest_range_0, 44u, (r3 + 44), r0);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 48u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f5.d))) << 32) | static_cast<uint32_t>(r6)))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 48u, (r3 + 48), f5.d);
...
// RECOMP_REGISTRATION base 0x80094B50 func_80094B50 preserves=true fpr_mask=0x00000000
