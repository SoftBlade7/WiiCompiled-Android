...
extern "C" void func_806E794C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806E796C:
{
    ...
    r3 = (r1 + 8);
    r4 = (r4 + 16688);
    f1.d = MemoryInline::FlatReadFloat32((r5 + 28772));
...
// RECOMP_GUEST_ABI gpr_read=0x8000000A gpr_write=0x8000003B gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x0000000F fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x806E794C func_806E794C preserves=true fpr_mask=0x00000000
