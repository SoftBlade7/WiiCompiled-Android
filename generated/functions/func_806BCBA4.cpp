...
extern "C" void func_806BCBA4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806BCBA4:
{
    ...
    r29 = r3;
    f1.d = MemoryInline::FlatReadFloat32((r5 + 10012));
    r3 = MemoryInline::FlatRead32((r3 + 288));
    ...
    r3 = 0x808A0000u;
    f2.d = MemoryInline::FlatReadFloat32((r3 + -3288));
    r31 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r31 + -3180));
    r4 = 0x802A0000u;
    ...
    r0 = MemoryInline::FlatRead32((r29 + 288));
    r30 = 0;
...
loc_806BCC2C:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r31 + -3180));
    r4 = (r1 + 8);
...
// RECOMP_REGISTRATION base 0x806BCBA4 func_806BCBA4 preserves=true fpr_mask=0x00000000
