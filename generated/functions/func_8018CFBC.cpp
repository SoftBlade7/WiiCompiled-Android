...
extern "C" void func_8018CFBC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8018CFBC:
{
    ...
    r3 = MemoryInline::FlatRead8((r3 + 21));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8018CFBC func_8018CFBC preserves=true fpr_mask=0x00000000
