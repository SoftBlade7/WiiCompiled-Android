...
extern "C" void func_8054604C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r3 = (r3 + 65536);
    MemoryInline::FlatWrite32((r3 + -27984), r0);
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[5] = r5;
    ctx->cr = cr;
...
// RECOMP_REGISTRATION base 0x8054604C func_8054604C preserves=true fpr_mask=0x00000000
