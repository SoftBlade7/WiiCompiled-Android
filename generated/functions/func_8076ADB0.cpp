...
extern "C" void func_8076ADB0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r4 = 0x808D0000u;
    r0 = MemoryInline::FlatRead32((r4 + -6252));
    MemoryInline::FlatWrite32((r3 + 180), r0);
}
...
// RECOMP_REGISTRATION base 0x8076ADB0 func_8076ADB0 preserves=false fpr_mask=0xE0000000
