...
extern "C" void func_806C31F0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806C3228:
{
    ...
    r4 = 0x808A0000u;
    r3 = r31;
    f1.d = MemoryInline::FlatReadFloat32((r4 + -2304));
...
loc_806C3244:
{
    ...
    r3 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat64((r3 + -2256));
    r7 = 0x808A0000u;
    MemoryInline::FlatWriteRam32((r1 + 108), r5);
    r6 = 0x808C0000u;
    r4 = 0x808C0000u;
    f4.d = MemoryInline::FlatReadFloat32((r7 + -2260));
    f0.d = MemoryInline::FlatReadFloat64((r1 + 104));
    r3 = 0x808A0000u;
    f3.d = MemoryInline::FlatReadFloat32((r6 + 12928));
...
loc_806C327C:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r4 + 12912));
    f6.d = PpcFmulsInline(f4.d, f3.d);
    f1.d = MemoryInline::FlatReadFloat32((r31 + 1340));
    f4.d = MemoryInline::FlatReadFloat32((r31 + 1328));
    r0 = 0;
    f3.d = PpcFmulsInline(f0.d, f2.d);
    f2.d = MemoryInline::FlatReadFloat32((r31 + 1364));
    f0.d = MemoryInline::FlatReadFloat32((r31 + 1348));
    ...
    f3.d = PpcFmulsInline(f0.d, f2.d);
    f2.d = MemoryInline::FlatReadFloat32((r31 + 1336));
    f4.d = static_cast<double>(PpcForceSingleValueInline(f4.d + f5.d));
    f1.d = static_cast<double>(PpcForceSingleValueInline(f1.d + f6.d));
    f0.d = MemoryInline::FlatReadFloat32((r3 + -2304));
    f2.d = static_cast<double>(PpcForceSingleValueInline(f2.d + f3.d));
    MemoryInline::FlatWriteFloat32((r31 + 1328), f4.d);
    MemoryInline::FlatWriteFloat32((r31 + 1336), f2.d);
    MemoryInline::FlatWriteFloat32((r31 + 1332), f1.d);
...
// RECOMP_REGISTRATION base 0x806C31F0 func_806C31F0 preserves=true fpr_mask=0x00000000
