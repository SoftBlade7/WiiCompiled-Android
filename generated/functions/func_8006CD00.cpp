...
extern "C" void func_8006CD00(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8006CD00:
{
    ...
    f9.d = PpcFmulsInline(f0.d, f1.d);
    f7.d = PpcFmulsInline(f3.d, f1.d);
    f5.d = MemoryInline::FlatReadFloat32((r2 + -29320));
    f6.d = PpcFmulsInline(f3.d, f2.d);
    f4.d = MemoryInline::FlatReadFloat32((r2 + -29312));
    f8.d = PpcFmulsInline(f0.d, f2.d);
    f1.d = (-(f9.d));
    f2.d = static_cast<double>(PpcForceSingleValueInline(f6.d + f7.d));
    f3.d = MemoryInline::FlatReadFloat32((r2 + -29304));
    guest_range_0 = MemoryInline::ResolveRangeHost(r30, 0, 32u, false, true);
    MemoryInline::WriteResolvedFloat32(guest_range_0, 0u, r30, f6.d);
    f0.d = static_cast<double>(PpcForceSingleValueInline(f1.d + f8.d));
    ...
    MemoryInline::WriteResolvedFloat32(guest_range_0, 8u, (r30 + 8), f5.d);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 20u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f8.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f5.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 20u, (r30 + 20), f8.d);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 24u, (r30 + 24), f5.d);
    }
...
// RECOMP_REGISTRATION base 0x8006CD00 func_8006CD00 preserves=true fpr_mask=0x00000000
