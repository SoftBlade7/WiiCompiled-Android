...
extern "C" void func_807EAAC0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807EAAC0:
{
    ...
    r31 = r3;
    r4 = MemoryInline::FlatRead32((r4 + 19576));
...
loc_807EAAE4:
{
    r0 = MemoryInline::FlatRead32((r4 + 1028));
...
// RECOMP_REGISTRATION base 0x807EAAC0 func_807EAAC0 preserves=true fpr_mask=0x00000000
