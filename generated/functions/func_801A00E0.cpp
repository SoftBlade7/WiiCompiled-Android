...
extern "C" void func_801A00E0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_801A00E0:
{
    ...
    r22 = 0x80000000u;
    r26 = 0x801A0000u;
    r0 = MemoryInline::FlatRead32((r22 + 96));
    r3 = 0x801A0000u;
    r28 = 0x801A0000u;
    r30 = 0x80290000u;
...
loc_801A022C:
{
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 0u, ((static_cast<uint64_t>(static_cast<uint32_t>(r23)) << 32) | static_cast<uint32_t>(r23)))) {
        MemoryInline::WriteResolved32(guest_range_2, 0u, r4, r23);
        MemoryInline::WriteResolved32(guest_range_2, 4u, (r4 + 4), r23);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 8u, ((static_cast<uint64_t>(static_cast<uint32_t>(r23)) << 32) | static_cast<uint32_t>(r23)))) {
        MemoryInline::WriteResolved32(guest_range_2, 8u, (r4 + 8), r23);
        MemoryInline::WriteResolved32(guest_range_2, 12u, (r4 + 12), r23);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 16u, ((static_cast<uint64_t>(static_cast<uint32_t>(r23)) << 32) | static_cast<uint32_t>(r23)))) {
        MemoryInline::WriteResolved32(guest_range_2, 16u, (r4 + 16), r23);
        MemoryInline::WriteResolved32(guest_range_2, 20u, (r4 + 20), r23);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r23)) << 32) | static_cast<uint32_t>(r23)))) {
        MemoryInline::WriteResolved32(guest_range_2, 24u, (r4 + 24), r23);
...
loc_801A02B0:
{
    ...
    MemoryInline::FlatWriteRam32(r28, r27);
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
// RECOMP_REGISTRATION base 0x801A00E0 func_801A00E0 preserves=true fpr_mask=0x00000000
