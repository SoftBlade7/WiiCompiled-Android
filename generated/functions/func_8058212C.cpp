...
extern "C" void func_8058212C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80582224:
{
    ...
    // inline leaf 0x806A1808 (6 guest instruction(s))
    r5 = 1;
    r0 = 0;
    ...
    // end of inlined leaf 0x806A1808
    r4 = 0x80890000u;
    r3 = r30;
...
// RECOMP_REGISTRATION base 0x8058212C func_8058212C preserves=true fpr_mask=0x00000000
