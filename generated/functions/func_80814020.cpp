...
extern "C" void func_80814020(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80814020:
{
    ...
    r8 = 0x808B0000u;
    r27 = r3;
    f0.d = MemoryInline::FlatReadFloat32((r8 + -19460));
    f31.d = f1.d;
    r31 = r4;
    r28 = r5;
    ...
    r31 = 0x808B0000u;
    f3.d = (-(f1.d));
    f4.d = MemoryInline::FlatReadFloat32((r27 + 184));
    f1.d = MemoryInline::FlatReadFloat32((r3 + 25328));
    f2.d = (-(f0.d));
    f0.d = MemoryInline::FlatReadFloat32((r1 + 12));
    f4.d = PpcFmulsInline(f4.d, f1.d);
    f3.d = PpcFmulsInline(f3.d, f0.d);
    f1.d = MemoryInline::FlatReadFloat32((r1 + 8));
    f0.d = MemoryInline::FlatReadFloat32((r31 + -19496));
...
// RECOMP_GUEST_ABI gpr_read=0xF80000FE gpr_write=0xF800093B gpr_return=0x00000018 fpr_read=0x8000000E fpr_write=0x8000001F fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80814020 func_80814020 preserves=false fpr_mask=0x80000000
