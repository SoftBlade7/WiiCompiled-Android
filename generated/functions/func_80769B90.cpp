...
extern "C" void func_80769B90(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80769C0C:
{
    ...
    MemoryInline::FlatWriteFloat32((r3 + 56), f5.d);
...
loc_80769C28:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r5 = MemoryInline::FlatRead32((r31 + 260));
    r30 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r30 + 15536));
    r3 = (r1 + 44);
...
loc_80769D50:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r4 + -6280));
    r4 = (r31 + 48);
    r5 = (r31 + 180);
...
// RECOMP_REGISTRATION base 0x80769B90 func_80769B90 preserves=true fpr_mask=0x00000000
