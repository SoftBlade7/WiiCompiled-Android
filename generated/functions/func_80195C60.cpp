...
extern "C" void func_80195C60(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80195C60:
{
    ...
    f30.d = MemoryInline::FlatReadFloat32((r13 + -29232));
    r25 = r3;
...
loc_80195CD4:
{
    ...
    f5.d = MemoryInline::FlatReadFloat32((r25 + 176));
    f2.d = MemoryInline::FlatReadFloat32((r25 + 180));
    f1.d = MemoryInline::FlatReadFloat32((r25 + 1296));
    f3.d = static_cast<double>(PpcForceSingleValueInline(f31.d / f0.d));
    f0.d = MemoryInline::FlatReadFloat32((r25 + 1300));
    f27.d = PpcFmulsInline(f27.d, f3.d);
    f28.d = PpcFmulsInline(f28.d, f3.d);
    f6.d = PpcFmulsInline(f1.d, f3.d);
    f4.d = PpcFmulsInline(f5.d, f27.d);
    f3.d = PpcFmulsInline(f2.d, f28.d);
    f2.d = PpcFmulsInline(f2.d, f27.d);
    f1.d = PpcFmulsInline(f5.d, f28.d);
...
loc_80195D5C:
{
    f1.d = MemoryInline::FlatReadFloat32((r25 + 1208));
    f0.d = MemoryInline::FlatReadFloat32((r25 + 1212));
...
loc_80195DC0:
{
    f0.d = MemoryInline::FlatReadFloat32((r13 + -29232));
...
loc_80195DD4:
{
    ...
    MemoryInline::FlatWrite32((r25 + 244), r4);
    MemoryInline::FlatWrite32((r25 + 248), r0);
    ...
    MemoryInline::FlatWrite32((r25 + 256), r4);
    MemoryInline::FlatWrite32((r25 + 260), r0);
    r0 = MemoryInline::FlatRead32((r26 + 8));
    MemoryInline::FlatWrite32((r25 + 264), r0);
}
...
// RECOMP_GUEST_ABI gpr_read=0xFE003FFF gpr_write=0xFE001FFB gpr_return=0x00000018 fpr_read=0xF800007F fpr_write=0xF800007F fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x80195C60 func_80195C60 preserves=false fpr_mask=0xF8000000
