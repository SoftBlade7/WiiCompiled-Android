...
extern "C" void func_807AD5A4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807AD5A4:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r4 + 23588));
...
// RECOMP_REGISTRATION base 0x807AD5A4 func_807AD5A4 preserves=true fpr_mask=0x00000000
