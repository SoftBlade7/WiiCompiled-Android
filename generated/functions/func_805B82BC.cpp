...
extern "C" void func_805B82BC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805B82BC:
{
    ...
    r4 = 0x80890000u;
    r3 = 0x80890000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 10152));
    r3 = (r30 + 8);
    f1.d = MemoryInline::FlatReadFloat32((r4 + 10156));
...
// RECOMP_REGISTRATION base 0x805B82BC func_805B82BC preserves=true fpr_mask=0x00000000
