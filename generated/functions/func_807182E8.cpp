...
extern "C" void func_807182E8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80718350:
{
    ...
    r29 = MemoryInline::FlatRead32((r4 + 10408));
...
loc_8071836C:
{
    ...
    r28 = MemoryInline::FlatRead32((r4 + 10408));
...
loc_80718388:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80718498u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x807182E8 func_807182E8 preserves=true fpr_mask=0x00000000
