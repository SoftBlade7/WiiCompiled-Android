...
extern "C" void func_80051E40(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80051E40:
{
    ...
    r29 = r3;
    r30 = MemoryInline::FlatRead32(r20);
    r28 = 0;
    r26 = MemoryInline::FlatRead32((r4 + 44));
    r27 = 0;
...
loc_80051F54:
{
    ...
    r8 = MemoryInline::FlatRead32((r31 + 24));
    r9 = MemoryInline::FlatRead32((r31 + 28));
...
loc_80051FF0:
{
    ...
    f3.d = MemoryInline::FlatReadFloat32((r31 + 40));
    r6 = MemoryInline::FlatRead8((r31 + 48));
    r7 = MemoryInline::FlatRead8((r31 + 49));
    r8 = MemoryInline::FlatRead32((r31 + 44));
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
...
loc_8005202C:
{
    ...
    r0 = PPC_Slw(static_cast<uint32_t>(r21), static_cast<uint32_t>(r0));
    r0 = (r3 | r0);
...
// RECOMP_REGISTRATION base 0x80051E40 func_80051E40 preserves=true fpr_mask=0x00000000
