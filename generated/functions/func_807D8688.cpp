...
extern "C" void func_807D8688(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807D86D0:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x807D7588u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_GUEST_ABI gpr_read=0xFE0000FF gpr_write=0xFE0008FB gpr_return=0x00000018 fpr_read=0x8000C03F fpr_write=0x8000FFFF fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x807D8688 func_807D8688 preserves=true fpr_mask=0x00000000
