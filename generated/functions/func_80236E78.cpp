...
extern "C" void func_80236E78(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r4_rot_0 = 0;
    uint32_t r4_rot_1 = 0;
...
loc_80236E78:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80236CD8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r0 = MemoryInline::FlatRead8((r31 + 59));
...
// RECOMP_REGISTRATION base 0x80236E78 func_80236E78 preserves=true fpr_mask=0x00000000
