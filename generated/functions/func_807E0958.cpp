...
extern "C" MkwStateFreeResult2 func_80833704_statefree(uint32_t, uint32_t, uint32_t);
extern "C" MkwStateFreeResult2 func_80833704_statefree_v0(uint32_t, uint32_t, uint32_t);

extern "C" void func_807E0958(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807E09DC:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r29 + 948), r28);
    r3 = r28;
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x80833704u) && KnownTranslatedCpuCall<0x80833704u>::kAvailable && !KnownTranslatedCpuCall<0x80833704u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80833704u>()) {
        const auto state_free_result_80833704_2392 = func_80833704_statefree_v0(r3, cr, xer);
        r3 = static_cast<uint32_t>(state_free_result_80833704_2392[0]);
        cr = static_cast<uint32_t>(state_free_result_80833704_2392[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
        ...
        ctx->cr = cr;
        ctx->ctr = ctr;
        InvokeDirectCpu<0x80833704u>(ctx);
        r0 = ctx->gpr[0];
        r1 = ctx->gpr[1];
        r3 = ctx->gpr[3];
        r4 = ctx->gpr[4];
    ...
    xer = ctx->xer;
    r3 = r28;
    // inline leaf 0x80860BBC (13 guest instruction(s))
}
...
loc_inl2_cont_80860BBC:
{
    // end of inlined leaf 0x80860BBC
    r5 = r3;
    r3 = r30;
    r4 = (r31 + 155);
    ctx->lr = 0x807E0A58u;
...
loc_807E0AB8:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x807E8C5Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 132), 0, 36u, true, false);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r25 = MemoryInline::ReadResolved32(guest_range_1, 0u, (r1 + 132));
            r26 = MemoryInline::ReadResolved32(guest_range_1, 4u, (r1 + 136));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r27 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r1 + 140));
            r28 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r1 + 144));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r29 = MemoryInline::ReadResolved32(guest_range_1, 16u, (r1 + 148));
            r30 = MemoryInline::ReadResolved32(guest_range_1, 20u, (r1 + 152));
        }
    }
    r31 = MemoryInline::ReadResolved32(guest_range_1, 24u, (r1 + 156));
    r0 = MemoryInline::ReadResolved32(guest_range_1, 32u, (r1 + 164));
    ctx->lr = r0;
    r1 = (r1 + 160);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x807E0958 func_807E0958 preserves=true fpr_mask=0x00000000
