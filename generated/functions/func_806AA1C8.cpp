...
extern "C" void func_806AA1C8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806AA218:
{
    r31 = MemoryInline::FlatRead32((r3 + 568));
...
// RECOMP_REGISTRATION base 0x806AA1C8 func_806AA1C8 preserves=true fpr_mask=0x00000000
