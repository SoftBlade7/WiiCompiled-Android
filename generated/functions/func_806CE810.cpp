...
extern "C" void func_806CE810(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806CE810:
{
    r3 = MemoryInline::FlatRead8((r3 + 396));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x806CE810 func_806CE810 preserves=true fpr_mask=0x00000000
