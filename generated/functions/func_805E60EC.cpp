...
extern "C" void func_805E60EC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805E619C:
{
    ...
    xer = ctx->xer;
    r30 = 0x809C0000u;
    r3 = MemoryInline::FlatRead32((r30 + 11448));
    ctx->lr = 0x805E61B0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    xer = ctx->xer;
    r0 = 15;
    MemoryInline::FlatWrite32((r31 + 828), r0);
    r11 = (r1 + 48);
...
// RECOMP_REGISTRATION base 0x805E60EC func_805E60EC preserves=true fpr_mask=0x00000000
