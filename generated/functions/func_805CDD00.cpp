...
extern "C" void func_805CDD00(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805CDD00:
{
    ...
    MemoryInline::FlatWriteRamFloat64((r1 + 240), f29.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_2 = (r1 + 248);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_2, PPC_PsFromScalarInline(f29.d));
    MemoryInline::FlatWriteRamFloat64((r1 + 224), f28.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_3 = (r1 + 232);
...
loc_805CDD48:
{
    ...
    r18 = r3;
    r16 = r5;
    MemoryInline::FlatWriteRam32((r1 + 120), r8);
    r14 = r6;
    r17 = r7;
    r21 = r15;
    r24 = (r24 + 15984);
...
loc_805CDDEC:
{
    r14 = 0x809C0000u;
    r4 = r18;
    r3 = MemoryInline::FlatRead32((r14 + 7136));
    ctx->lr = 0x805CDDFCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x805CFC24u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_805CDE08:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r20 = MemoryInline::FlatRead32((r25 + 7136));
    r26 = 0x809C0000u;
    ...
    r0 = (r0_rot_6 & -4);
    r21 = MemoryInline::FlatRead32(r4);
    r3_addr_1 = (r3 + r0);
    r22 = MemoryInline::FlatRead32(r3_addr_1);
    MemoryInline::FlatWrite32((r20 + 12), r22);
    r3 = r22;
    ...
    f2.d = MemoryInline::FlatReadFloat64((r24 + 424));
    r3 = r22;
    f1.d = MemoryInline::FlatReadFloat64((r1 + 112));
    f0.d = MemoryInline::FlatReadFloat32((r21 + 232));
    f1.d = static_cast<double>(PpcForceSingleValueInline(f1.d - f2.d));
    f0.d = static_cast<double>(PpcForceSingleValueInline(f0.d / f1.d));
    MemoryInline::FlatWriteFloat32((r20 + 16), f0.d);
    r12 = MemoryInline::FlatRead32(r22);
    ...
    f0.d = MemoryInline::FlatReadFloat32((r21 + 236));
    f1.d = static_cast<double>(PpcForceSingleValueInline(f1.d - f2.d));
    f0.d = static_cast<double>(PpcForceSingleValueInline(f0.d / f1.d));
    MemoryInline::FlatWriteFloat32((r20 + 20), f0.d);
    r12 = MemoryInline::FlatRead32(r22);
    ...
    r3 = r22;
    f1.d = MemoryInline::FlatReadFloat64((r1 + 112));
    f0.d = MemoryInline::FlatReadFloat32((r20 + 20));
    f1.d = static_cast<double>(PpcForceSingleValueInline(f1.d - f2.d));
    ...
    r0 = (r3 ^ -2147483648);
    MemoryInline::FlatWriteRam32((r1 + 124), r0);
    f29.d = MemoryInline::FlatReadFloat64((r24 + 424));
    r30 = (r1 + 32);
    f1.d = MemoryInline::FlatReadFloat64((r1 + 120));
    r31 = 0x808C0000u;
    f0.d = MemoryInline::FlatReadFloat32((r20 + 20));
    ...
    f28.d = MemoryInline::FlatReadFloat32((r24 + 420));
    f30.d = MemoryInline::FlatReadFloat64((r24 + 432));
    r29 = 65536;
    f31.d = MemoryInline::FlatReadFloat32((r24 + 416));
    f0.d = PpcFmulsInline(f0.d, f1.d);
...
loc_805CDF28:
{
    r0_rot_8 = PpcRotl32Inline(static_cast<uint32_t>(r19), static_cast<uint32_t>(2));
    r0 = (r0_rot_8 & -4);
    r21 = (r1 + 32);
    r20 = (r1 + 16);
    r21 = (r21 + r0);
...
loc_805CDF94:
{
    ...
    r3_addr_4 = (r3 + r0);
    r22 = MemoryInline::FlatRead32(r3_addr_4);
...
loc_805CE074:
{
    ...
    r3 = (r3_rot_2 & -4);
    r30_addr_4 = (r30 + r3);
    r20 = MemoryInline::FlatRead32(r30_addr_4);
...
{
    r3 = 0;
    goto loc_inl3_cont_805F8CF0;
}

loc_inl3_0x805F8D10:
{
    r0_rot_30 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(3));
    r0 = (r0_rot_30 & -8);
    r4 = MemoryInline::FlatRead32((r3 + 8));
    r3 = (r5 + r0);
    r0 = MemoryInline::FlatRead32((r3 + 8));
...
{
    r3 = 0;
    goto loc_inl4_cont_805F8D2C;
}

loc_inl4_0x805F8D4C:
{
    r0_rot_32 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(3));
    r0 = (r0_rot_32 & -8);
    r3 = (r3 + r0);
    r3 = (r3 + 12);
}

loc_inl4_cont_805F8D2C:
{
    // end of inlined leaf 0x805F8D2C
    r0 = MemoryInline::FlatRead8(r3);
...
loc_805CE200:
{
    ...
    r5_rot_3 = PpcRotl32Inline(static_cast<uint32_t>(r19), static_cast<uint32_t>(2));
    r5 = (r5_rot_3 & -4);
    ...
    r4 = (r1 + 16);
    r3_addr_9 = (r3 + r0);
    r21 = MemoryInline::FlatRead32(r3_addr_9);
    MemoryInline::FlatWrite32((r22 + 12), r21);
    r0 = MemoryInline::FlatRead32((r1 + 132));
    r3 = r21;
    r12 = MemoryInline::FlatRead32(r21);
    r30_addr_7 = (r30 + r5);
    MemoryInline::FlatWrite32(r30_addr_7, r0);
    r12 = MemoryInline::FlatRead32((r12 + 12));
    r0 = MemoryInline::FlatRead32((r1 + 136));
    r4_addr_3 = (r4 + r5);
...
loc_805CE300:
{
    r0_rot_36 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(2));
    r0 = (r0_rot_36 & 262140);
    r3 = (r17 + r0);
...
{
    r22 = MemoryInline::FlatRead32((r25 + 7136));
    r0_rot_37 = PpcRotl32Inline(static_cast<uint32_t>(r19), static_cast<uint32_t>(2));
    r0 = (r0_rot_37 & -4);
    r3 = (r1 + 16);
    r19 = (r19 + 1);
    r5 = MemoryInline::FlatRead32(r22);
    r7_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r19), static_cast<uint32_t>(2));
    r7 = (r7_rot_2 & -4);
    r3_addr_10 = (r3 + r0);
    r6 = MemoryInline::FlatRead32(r3_addr_10);
    r4 = MemoryInline::FlatRead32((r26 + 7160));
    r0_rot_38 = PpcRotl32Inline(static_cast<uint32_t>(r6), static_cast<uint32_t>(2));
    r0 = (r0_rot_38 & -4);
    r20 = MemoryInline::FlatRead32(r5);
    r4_addr_4 = (r4 + r0);
    r21 = MemoryInline::FlatRead32(r4_addr_4);
    r4 = (r1 + 16);
    MemoryInline::FlatWrite32((r22 + 12), r21);
    r3 = r21;
    r12 = MemoryInline::FlatRead32(r21);
    r30_addr_8 = (r30 + r7);
    MemoryInline::FlatWrite32(r30_addr_8, r8);
    r12 = MemoryInline::FlatRead32((r12 + 12));
    r4_addr_5 = (r4 + r7);
    MemoryInline::FlatWrite32(r4_addr_5, r6);
    ctr = r12;
    ctx->lr = 0x805CE364u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_inl6_0x8061B368:
{
    r0_rot_19 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(4));
    r0 = (r0_rot_19 & -16);
    r3 = (r3 + r0);
    r3 = MemoryInline::FlatRead32((r3 + 4));
}
...
loc_805CEAC4:
{
    ...
    r17_addr_2 = (r17 + r0);
    r4 = MemoryInline::FlatRead32(r17_addr_2);
}
...
loc_inl10_0x805F8D2C:
{
}

loc_inl10_0x805F8D30:
{
    if ((static_cast<int32_t>(r4) < static_cast<int32_t>(0))) {
        goto loc_inl10_0x805F8D44;
    }
}

loc_inl10_0x805F8D34:
{
    r3 = MemoryInline::FlatRead32((r3 + 4));
    r0 = MemoryInline::FlatRead16(r3);
}

loc_inl10_0x805F8D40:
{
    if ((static_cast<int32_t>(r4) < static_cast<int32_t>(r0))) {
        goto loc_inl10_0x805F8D4C;
    }
}

loc_inl10_0x805F8D44:
{
    r3 = 0;
    goto loc_inl10_cont_805F8D2C;
}

loc_inl10_0x805F8D4C:
{
...
loc_805CEBD8:
{
    ...
    r19 = (r19 + 1);
    r3 = MemoryInline::FlatRead32((r26 + 7160));
    r0_rot_17 = PpcRotl32Inline(static_cast<uint32_t>(r14), static_cast<uint32_t>(2));
    r0 = (r0_rot_17 & -4);
    r4 = MemoryInline::FlatRead32(r22);
    r5_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r19), static_cast<uint32_t>(2));
    r5 = (r5_rot_2 & -4);
    r3_addr_5 = (r3 + r0);
    r21 = MemoryInline::FlatRead32(r3_addr_5);
    r20 = MemoryInline::FlatRead32(r4);
    r4 = (r1 + 16);
    ...
    r12 = MemoryInline::FlatRead32((r12 + 12));
    r4_addr_2 = (r4 + r5);
    MemoryInline::FlatWrite32(r4_addr_2, r14);
    ctr = r12;
    ctx->lr = 0x805CEC20u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_805CED44:
{
    r4_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r19), static_cast<uint32_t>(2));
    r4 = (r4_rot_2 & -4);
    r30_addr_2 = (r30 + r4);
...
// RECOMP_REGISTRATION base 0x805CDD00 func_805CDD00 preserves=false fpr_mask=0xF0000000
