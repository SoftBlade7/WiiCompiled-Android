...
extern "C" void func_80009988(CpuContext* MKW_RESTRICT ctx)
{
    goto loc_80009988;

loc_80009988:
{
    InvokeDirectCpu<0x8023AEACu>(ctx);
    return;
}
...
// RECOMP_REGISTRATION base 0x80009988 func_80009988 preserves=true fpr_mask=0x00000000
