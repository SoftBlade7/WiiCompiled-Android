...
extern "C" void func_80772448(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807724B8:
{
    ...
    r3 = 0x808A0000u;
    r5 = 0x808A0000u;
    f2.d = MemoryInline::FlatReadFloat32((r5 + 16292));
    r5 = 1;
    r4 = MemoryInline::FlatRead32((r30 + 8));
    f1.d = MemoryInline::FlatReadFloat32((r3 + 16256));
...
// RECOMP_REGISTRATION base 0x80772448 func_80772448 preserves=false fpr_mask=0x80000000
