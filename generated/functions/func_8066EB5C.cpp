...
extern "C" void func_8066EB5C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8066EBBC:
{
    ...
    r4 = (r4 + -5076);
    MemoryInline::FlatWrite32((r29 + 16900), r31);
    r6 = 0;
...
// RECOMP_REGISTRATION base 0x8066EB5C func_8066EB5C preserves=true fpr_mask=0x00000000
