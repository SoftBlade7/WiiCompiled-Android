...
extern "C" void func_8056AB6C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_stfsx_8056AC60_loc_0 = 0;
    uint32_t cr0_0 = 0;
...
loc_8056ABD4:
{
    r3 = 0x80890000u;
    r24 = 0x808B0000u;
    f31.d = MemoryInline::FlatReadFloat64((r3 + 5792));
    r24 = (r24 + 20632);
    r25 = (r23 + 0);
    r31 = (r23 + 24);
    r21 = 0;
...
loc_8056AC4C:
{
    ...
    addr_stfsx_8056AC60_loc_0 = (r31 + r22);
    MemoryInline::FlatWriteFloat32(addr_stfsx_8056AC60_loc_0, f0.d);
    if (((cr & 0x80000000u) != 0)) {
        goto loc_8056AC04;
    }
}
...
loc_8056AC68:
{
    r4 = 0x808B0000u;
    r3 = (r1 + 8);
    r4 = MemoryInline::FlatRead32((r4 + 20648));
    ctx->lr = 0x8056AC78u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r23 + 16), r3);
...
// RECOMP_REGISTRATION base 0x8056AB6C func_8056AB6C preserves=false fpr_mask=0x80000000
