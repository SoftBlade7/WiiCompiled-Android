...
extern "C" void func_807D4AF4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807D4AF4:
{
    ...
    r0 = (r0_rot_1 & -4);
    r5 = (r3 + r0);
    MemoryInline::FlatWrite32((r5 + 144), r4);
...
// RECOMP_REGISTRATION base 0x807D4AF4 func_807D4AF4 preserves=true fpr_mask=0x00000000
