...
extern "C" void func_8005F380(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8005F380:
{
    r3 = (r3 + 32);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x800563A0u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8005F380 func_8005F380 preserves=true fpr_mask=0x00000000
