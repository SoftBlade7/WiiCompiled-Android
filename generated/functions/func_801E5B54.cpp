...
extern "C" void func_801E5B54(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
    uint32_t r3_rot_1 = 0;
...
loc_801E5C78:
{
    MemoryInline::FlatWriteRam32((r30 + 64), r28);
    r3 = (r31 + 8564);
...
loc_801E5CA8:
{
    r29 = MemoryInline::FlatRead32((r30 + 96));
}
...
// RECOMP_REGISTRATION base 0x801E5B54 func_801E5B54 preserves=true fpr_mask=0x00000000
