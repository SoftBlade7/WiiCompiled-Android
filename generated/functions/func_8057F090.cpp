...
extern "C" void func_8057F090(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lfsx_8057F134_loc_0 = 0;
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
    uint32_t r0_rot_2 = 0;
...
loc_8057F090:
{
    ...
    r3 = MemoryInline::FlatRead16((r29 + 280));
    r0 = (r5 & 65535);
...
loc_8057F110:
{
    MemoryInline::FlatWrite16((r3 + 268), static_cast<uint16_t>(r31));
    r4 = (r5 & 65535);
    r3 = 0x808B0000u;
    r0_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r30), static_cast<uint32_t>(2));
    r0 = (r0_rot_1 & -4);
    r5 = MemoryInline::FlatRead16((r29 + 280));
    r3 = (r3 + 23696);
    r6 = 1;
    r4 = (r5 | r4);
    MemoryInline::FlatWrite16((r29 + 280), static_cast<uint16_t>(r4));
    addr_lfsx_8057F134_loc_0 = (r3 + r0);
    f0.d = MemoryInline::FlatReadFloat32(addr_lfsx_8057F134_loc_0);
...
// RECOMP_REGISTRATION base 0x8057F090 func_8057F090 preserves=true fpr_mask=0x00000000
