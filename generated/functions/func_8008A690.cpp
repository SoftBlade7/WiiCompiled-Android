...
extern "C" void func_8008A690(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8008A6C4:
{
    MemoryInline::FlatWrite16((r4 + 254), static_cast<uint16_t>(r31));
...
// RECOMP_REGISTRATION base 0x8008A690 func_8008A690 preserves=true fpr_mask=0x00000000
