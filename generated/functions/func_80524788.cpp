...
extern "C" void func_80524788(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805247B0:
{
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x801BF634u>(ctx);
    r3 = ctx->gpr[3];
...
// RECOMP_REGISTRATION base 0x80524788 func_80524788 preserves=true fpr_mask=0x00000000
