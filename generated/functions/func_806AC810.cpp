...
extern "C" void func_806AC810(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806AC810:
{
    ...
    r30 = r3;
    r0 = MemoryInline::FlatRead8((r3 + 337));
...
loc_806AC874:
{
    r31 = MemoryInline::FlatRead32((r30 + 604));
...
// RECOMP_REGISTRATION base 0x806AC810 func_806AC810 preserves=true fpr_mask=0x00000000
