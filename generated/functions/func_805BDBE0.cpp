...
extern "C" void func_805BDBE0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805BDD3C:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead32((r29 + 580));
    r3 = (r29 + 372);
...
// RECOMP_REGISTRATION base 0x805BDBE0 func_805BDBE0 preserves=true fpr_mask=0x00000000
