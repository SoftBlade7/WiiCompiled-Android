...
extern "C" void func_8070E7A8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8070E7A8:
{
    r3 = (r3 + -148);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x8070CD30u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8070E7A8 func_8070E7A8 preserves=true fpr_mask=0x00000000
