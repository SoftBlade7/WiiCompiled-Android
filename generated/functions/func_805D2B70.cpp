...
extern "C" void func_805D2B70(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805D2B70:
{
    MemoryInline::FlatWrite32((r16 + 464), r26);
}
...
// RECOMP_REGISTRATION base 0x805D2B70 func_805D2B70 preserves=true fpr_mask=0x00000000
