...
extern "C" void func_80746970(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80746970:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r5 + 11192));
...
{
    r3 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + 11252));
    goto loc_80746ADC;
}
...
{
    r3 = 0x808A0000u;
    f2.d = MemoryInline::FlatReadFloat32((r3 + 11192));
...
loc_80746AB0:
{
    r3 = 2;
    r0 = 1127219200;
    r3 = PPC_Slw(static_cast<uint32_t>(r3), static_cast<uint32_t>(r31));
    r4 = 0x808A0000u;
    r3 = (r3 ^ -2147483648);
    MemoryInline::FlatWriteRam32((r1 + 20), r3);
    f1.d = MemoryInline::FlatReadFloat64((r4 + 11232));
...
// RECOMP_REGISTRATION base 0x80746970 func_80746970 preserves=false fpr_mask=0x80000000
