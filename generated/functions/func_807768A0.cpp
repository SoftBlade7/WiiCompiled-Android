...
extern "C" void func_807768A0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8077690C:
{
    ...
    r4 = 3;
    f2.d = MemoryInline::FlatReadFloat32((r29 + 16900));
    r5 = 1;
    ctx->lr = 0x80776930u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_807769C4:
{
    ...
    r29 = 0x808A0000u;
    r30 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r29 + 16752));
    r3 = MemoryInline::FlatRead32((r3 + 40));
    r4 = 1;
    f2.d = MemoryInline::FlatReadFloat32((r30 + 16900));
    r5 = 1;
    ctx->lr = 0x807769E8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80776A90:
{
    ...
    r12 = MemoryInline::FlatRead32(r3);
    r5 = (r5 + r0);
    f1.d = MemoryInline::FlatReadFloat64((r4 + 16928));
...
// RECOMP_REGISTRATION base 0x807768A0 func_807768A0 preserves=true fpr_mask=0x00000000
