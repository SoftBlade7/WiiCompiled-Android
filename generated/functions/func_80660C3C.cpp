...
extern "C" void func_80660C3C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_ca_0 = 0;
    uint32_t r0_ca_1 = 0;
...
loc_80660C7C:
{
    r29 = MemoryInline::FlatRead32((r6 + 72));
    r28 = MemoryInline::FlatRead32((r6 + 76));
    r0 = (r28 | r29);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
    if (((cr & 0x20000000u) != 0)) {
        goto loc_80660D0C;
...
loc_80660CC4:
{
    r5_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r31), static_cast<uint32_t>(3));
    r5 = (r5_rot_1 & 2040);
    r0 = (r4 - r28);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(r4) >= static_cast<uint32_t>(r28) ? 1u : 0u) << 29);
    r7 = (r30 + r5);
    ...
    r4 = (r4_not_1 + r3);
    r4 = (r4 + r4_ca_1);
    r5 = MemoryInline::FlatRead32((r7 + 848));
    ...
    r3_mrot_1 = (r3_rot_2 & -2147483648);
    r3_mdest_1 = (r3 & 2147483647);
    r3 = (r3_mdest_1 | r3_mrot_1);
    r6 = MemoryInline::FlatRead32((r7 + 852));
    ...
    r0 = (r0_rot_2 & 1020);
    r3_addc_right_1 = r3;
    r3 = (r6 + r3_addc_right_1);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r6)) + static_cast<uint64_t>(static_cast<uint32_t>(r3_addc_right_1)) + (static_cast<uint64_t>(static_cast<uint32_t>(0)) & 1u);
        xer = (xer & 0xDFFFFFFFu) | (static_cast<uint32_t>((ppcCarryWide >> 32) & 1u) << 29);
    }
    MemoryInline::FlatWrite32((r7 + 852), r3);
    r3_ca_1 = (xer >> 29) & 1u;
    r3 = (r5 + r4);
    r3 = (r3 + r3_ca_1);
    {
    ...
    r4 = (r30 + r0);
    MemoryInline::FlatWrite32((r7 + 848), r3);
    r3 = MemoryInline::FlatRead32((r4 + 944));
    r0 = (r3 + 1);
    MemoryInline::FlatWrite32((r4 + 944), r0);
}
...
// RECOMP_GUEST_ABI gpr_read=0xF000069A gpr_write=0xF00007FB gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x00 cr_write=0x01 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x80660C3C func_80660C3C preserves=true fpr_mask=0x00000000
