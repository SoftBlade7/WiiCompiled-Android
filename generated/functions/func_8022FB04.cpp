...
extern "C" void func_8022FB04(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8022FB04:
{
    ...
    f29.d = MemoryInline::FlatReadFloat32((r3 + 32));
...
loc_8022FB3C:
{
    ...
    f30.d = MemoryInline::FlatReadFloat32((r3 + 16));
...
loc_8022FB5C:
{
    f0.d = MemoryInline::FlatReadFloat32((r2 + -24952));
...
loc_8022FB68:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r2 + -24960));
    f1.d = MemoryInline::FlatReadFloat32((r2 + -24948));
...
loc_8022FBA0:
{
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8022F89Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8022FB04 func_8022FB04 preserves=false fpr_mask=0xE0000000
