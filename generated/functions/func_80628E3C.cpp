...
extern "C" void func_80628E3C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80628E3C:
{
    ...
    r3 = r23;
    MemoryInline::FlatWrite32((r28 + 76), r22);
    ctx->lr = 0x80628E80u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    MemoryInline::FlatWrite32((r23 + 600), r30);
    ...
    MemoryInline::WriteResolved32(guest_range_2, 984u, (r28 + 984), r3);
    r8 = (r29 + 2188);
    r7 = 0x808C0000u;
    r5 = 0x808C0000u;
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 1012u, ((static_cast<uint64_t>(static_cast<uint32_t>(r12)) << 32) | static_cast<uint32_t>(r22)))) {
        MemoryInline::WriteResolved32(guest_range_2, 1012u, (r28 + 1012), r12);
        MemoryInline::WriteResolved32(guest_range_2, 1016u, (r28 + 1016), r22);
    }
    r11 = MemoryInline::FlatRead32((r29 + 2188));
    ...
    r8 = MemoryInline::FlatRead32((r29 + 2200));
    ...
    r9 = 0x808C0000u;
    r7 = 0x808C0000u;
    guest_range_4 = MemoryInline::ResolveRangeHost((r29 + 2212), 0, 60u, true, false);
    r22 = MemoryInline::ReadResolved32(guest_range_4, 0u, (r29 + 2212));
    r9 = (r9 + -12012);
    ...
    MemoryInline::WriteResolved32(guest_range_1, 16u, (r28 + 1636), r23);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r25 = MemoryInline::ReadResolved32(guest_range_4, 12u, (r29 + 2224));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r30 = MemoryInline::ReadResolved32(guest_range_4, 24u, (r29 + 2236));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r10 = MemoryInline::ReadResolved32(guest_range_4, 36u, (r29 + 2248));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_4, 48u, (r29 + 2260));
...
// RECOMP_REGISTRATION base 0x80628E3C func_80628E3C preserves=true fpr_mask=0x00000000
