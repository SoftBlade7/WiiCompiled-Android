...
extern "C" void func_8054429C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8054429C:
{
    ...
    MemoryInline::FlatWrite8((r3 + 82), static_cast<uint8_t>(r0));
    MemoryInline::FlatWrite16((r3 + 84), static_cast<uint16_t>(r0));
...
// RECOMP_REGISTRATION base 0x8054429C func_8054429C preserves=true fpr_mask=0x00000000
