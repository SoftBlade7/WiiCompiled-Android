...
extern "C" void func_8081D798(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8081D798:
{
    ...
    r3 = 68;
    f4.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 12u, (r31 + 12));
    {
        ...
        if (resolved_pair.valid) {
            ...
            f2.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 156u, (r31 + 156));
    ...
    f6.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 60u, (r31 + 60));
    f5.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 20u, (r31 + 20));
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 764), 0, 60u, false, true);
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 0u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f7.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f6.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 0u, (r1 + 764), f7.d);
        MemoryInline::WriteResolvedFloat32(guest_range_1, 4u, (r1 + 768), f6.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 8u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f5.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f4.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 8u, (r1 + 772), f5.d);
        MemoryInline::WriteResolvedFloat32(guest_range_1, 12u, (r1 + 776), f4.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 16u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f3.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f2.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 16u, (r1 + 780), f3.d);
        MemoryInline::WriteResolvedFloat32(guest_range_1, 20u, (r1 + 784), f2.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 24u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f1.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f3.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 24u, (r1 + 788), f1.d);
        MemoryInline::WriteResolvedFloat32(guest_range_1, 28u, (r1 + 792), f3.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 32u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f2.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f4.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 32u, (r1 + 796), f2.d);
        MemoryInline::WriteResolvedFloat32(guest_range_1, 36u, (r1 + 800), f4.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 40u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f3.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f0.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 40u, (r1 + 804), f3.d);
        MemoryInline::WriteResolvedFloat32(guest_range_1, 44u, (r1 + 808), f0.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 48u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f1.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f3.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 48u, (r1 + 812), f1.d);
        MemoryInline::WriteResolvedFloat32(guest_range_1, 52u, (r1 + 816), f3.d);
    }
    MemoryInline::WriteResolvedFloat32(guest_range_1, 56u, (r1 + 820), f0.d);
    ctx->lr = 0x8081D7FCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8081D798 func_8081D798 preserves=true fpr_mask=0x00000000
