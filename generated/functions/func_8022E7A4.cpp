...
extern "C" void func_8022E7A4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8022E7A4:
{
    r3 = (r3 + -40);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x8022E6DCu>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8022E7A4 func_8022E7A4 preserves=true fpr_mask=0x00000000
