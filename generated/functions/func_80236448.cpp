...
extern "C" void func_80236448(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80236448:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r20 + 28));
    r3 = (r1 + 64);
    f0.d = MemoryInline::FlatReadFloat32((r20 + 32));
    f1.d = PpcFmulsInline(f29.d, f1.d);
    f3.d = MemoryInline::FlatReadFloat32((r2 + -24764));
    f2.d = PpcFmulsInline(f28.d, f0.d);
    ...
    r3 = (r1 + 64);
    f1.d = MemoryInline::FlatReadFloat32((r20 + 20));
    f2.d = MemoryInline::FlatReadFloat32((r20 + 24));
    r4 = r3;
    f3.d = MemoryInline::FlatReadFloat32((r2 + -24768));
    ...
    r27 = 0;
    f3.d = MemoryInline::FlatReadFloat64((r2 + -24752));
    r28 = -872349696;
    ...
    f1.d = MemoryInline::FlatReadFloat32((r20 + 64));
    MemoryInline::FlatWriteRam32((r1 + 120), r3);
    r31 = 3;
    f30.d = MemoryInline::FlatReadFloat32((r2 + -24768));
    f0.d = MemoryInline::FlatReadFloat64((r1 + 120));
    f29.d = static_cast<double>(PpcForceSingleValueInline(f1.d / f2.d));
    f31.d = MemoryInline::FlatReadFloat32((r2 + -24736));
...
loc_80236580:
{
    ...
    f4.d = static_cast<double>(PpcForceSingleValueInline(f30.d));
    f7.d = MemoryInline::FlatReadFloat32((r1 + 12));
    f6.d = static_cast<double>(PpcForceSingleValueInline(f30.d));
    f0.d = (-(f8.d));
    guest_range_2 = MemoryInline::ResolveRangeHost((r1 + 32), 0, 32u, false, true);
    MemoryInline::WriteResolvedFloat32(guest_range_2, 0u, (r1 + 32), f8.d);
    f1.d = (-(f7.d));
    f3.d = PpcFmulsInline(f7.d, f4.d);
    r3 = r21;
    f5.d = PpcFmulsInline(f0.d, f6.d);
    MemoryInline::WriteResolvedFloat32(guest_range_2, 4u, (r1 + 36), f1.d);
    f1.d = PpcFmulsInline(f1.d, f6.d);
    f0.d = PpcFmulsInline(f8.d, f4.d);
    f3.d = static_cast<double>(PpcForceSingleValueInline(f5.d + f3.d));
    f2.d = MemoryInline::FlatReadFloat32(r24);
    f0.d = static_cast<double>(PpcForceSingleValueInline(f1.d - f0.d));
    MemoryInline::WriteResolvedFloat32(guest_range_2, 16u, (r1 + 48), f7.d);
    f2.d = PpcFmulsInline(f29.d, f2.d);
    f3.d = static_cast<double>(PpcForceSingleValueInline(f6.d + f3.d));
    MemoryInline::WriteResolvedFloat32(guest_range_2, 20u, (r1 + 52), f8.d);
    f1.d = static_cast<double>(PpcForceSingleValueInline(f4.d + f0.d));
    f0.d = static_cast<double>(PpcForceSingleValueInline(f3.d + f2.d));
    MemoryInline::WriteResolvedFloat32(guest_range_2, 8u, (r1 + 40), f0.d);
    f0.d = MemoryInline::FlatReadFloat32(r23);
    f0.d = PpcFmulsInline(f28.d, f0.d);
    MemoryInline::WriteResolvedFloat32(guest_range_2, 28u, (r1 + 60), f30.d);
    MemoryInline::WriteResolvedFloat32(guest_range_2, 12u, (r1 + 44), f30.d);
    f0.d = static_cast<double>(PpcForceSingleValueInline(f1.d + f0.d));
    MemoryInline::WriteResolvedFloat32(guest_range_2, 24u, (r1 + 56), f0.d);
...
loc_8023667C:
{
    ...
    GX_HLE_FIFO_Write8(static_cast<uint8_t>(r27));
    r25 = (r25 + 8);
    guest_range_3 = MemoryInline::ResolveRangeHost((r20 + 56), 0, 8u, true, false);
    {
        ...
        if (resolved_pair.valid) {
            ...
            f1.d = MemoryInline::ReadResolvedFloat32(guest_range_3, 4u, (r20 + 60));
            f0.d = MemoryInline::ReadResolvedFloat32(guest_range_3, 0u, (r20 + 56));
        }
    }
    {
    ...
    mkw_fifo_burst_0[8] = static_cast<uint8_t>(r29);
    mkw_fifo_burst_0[9] = static_cast<uint8_t>(r29);
    ...
    mkw_fifo_burst_1[8] = static_cast<uint8_t>(r30);
    mkw_fifo_burst_1[9] = static_cast<uint8_t>(r30);
    ...
    mkw_fifo_burst_2[8] = static_cast<uint8_t>(r31);
    mkw_fifo_burst_2[9] = static_cast<uint8_t>(r31);
...
// RECOMP_REGISTRATION base 0x80236448 func_80236448 preserves=false fpr_mask=0xF0000000
