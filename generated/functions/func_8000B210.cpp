...
extern "C" void func_8000B210(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r0 = 1;
    MemoryInline::FlatWrite8((r3 + 181), static_cast<uint8_t>(r0));
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->cr = cr;
    return;
...
// RECOMP_REGISTRATION base 0x8000B210 func_8000B210 preserves=true fpr_mask=0x00000000
