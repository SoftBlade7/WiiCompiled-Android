...
extern "C" void func_8055FF4C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8055FFD8:
{
    ...
    r4 = (r3 + 8);
    MemoryInline::FlatWrite32((r27 + 8), r4);
    r3 = r27;
    MemoryInline::FlatWrite32((r27 + 20), r29);
    MemoryInline::FlatWrite16((r27 + 24), static_cast<uint16_t>(r0));
...
// RECOMP_GUEST_ABI gpr_read=0xF800007B gpr_write=0xF80001BB gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8055FF4C func_8055FF4C preserves=true fpr_mask=0x00000000
