...
extern "C" void func_801B1A94(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801B1AA0:
{
    ...
    r0 = 8;
    r4 = 0x801B0000u;
    MemoryInline::FlatWrite8((r7 + 345), static_cast<uint8_t>(r3));
    r3 = (r7 + 8);
    r5 = (r7 + 148);
...
// RECOMP_REGISTRATION base 0x801B1A94 func_801B1A94 preserves=true fpr_mask=0x00000000
