...
extern "C" void func_80134344(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_801343A4:
{
    ...
    r5 = (r5 + r0);
    r4 = (r4 + 10588);
    r5 = MemoryInline::FlatRead8((r5 + 6));
    ctx->lr = 0x801343CCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_801343CC:
{
    ...
    // inline leaf 0x801D09C4 (2 guest instruction(s))
    r3 = 0;
    // end of inlined leaf 0x801D09C4
    r29 = r3;
    goto loc_8013440C;
}
...
// RECOMP_REGISTRATION base 0x80134344 func_80134344 preserves=true fpr_mask=0x00000000
