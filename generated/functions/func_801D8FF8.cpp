...
extern "C" void func_801D8FF8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801D8FF8:
{
    ...
    ctx->gpr[9] = r9;
    ctx->gpr[10] = r10;
    InvokeDirectCpu<0x801D9004u>(ctx);
    r9 = ctx->gpr[9];
    r10 = ctx->gpr[10];
    ctx->gpr[9] = r9;
    ctx->gpr[10] = r10;
...
// RECOMP_REGISTRATION base 0x801D8FF8 func_801D8FF8 preserves=true fpr_mask=0x00000000
