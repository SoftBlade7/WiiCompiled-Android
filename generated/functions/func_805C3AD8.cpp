...
extern "C" void func_805C3AD8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805C3AD8:
{
    ...
    r3 = 0x809C0000u;
    r5 = 0x80890000u;
    f1.d = MemoryInline::FlatReadFloat32((r5 + 12920));
    r4 = 0;
...
// RECOMP_REGISTRATION base 0x805C3AD8 func_805C3AD8 preserves=true fpr_mask=0x00000000
