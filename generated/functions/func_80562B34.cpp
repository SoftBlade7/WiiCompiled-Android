...
extern "C" void func_80562B34(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80562B8C:
{
    ...
    r3 = (r31 + 112);
    r12 = MemoryInline::FlatRead32((r31 + 112));
...
loc_80562BC8:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8023C98Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80562B34 func_80562B34 preserves=true fpr_mask=0x00000000
