...
extern "C" void func_806A81C4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806A81C4:
{
    ...
    r3 = MemoryInline::FlatRead32((r3 + 1324));
    r30 = (r3 + 8);
}
...
// RECOMP_REGISTRATION base 0x806A81C4 func_806A81C4 preserves=true fpr_mask=0x00000000
