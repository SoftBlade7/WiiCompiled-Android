...
extern "C" void func_80139140(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80139140:
{
    ...
    r31 = (r31 + 25208);
    r28 = r4;
    r30 = MemoryInline::FlatRead32((r31 + 1560));
    r29 = r5;
    r3 = (r31 + 1536);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8013917C:
{
    MemoryInline::FlatWriteRam32((r31 + 1560), r0);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_80139200;
    }
}
...
loc_80139188:
{
    MemoryInline::FlatWriteRam8((r1 + 34), static_cast<uint8_t>(r27));
    MemoryInline::FlatWriteRam16((r1 + 32), static_cast<uint16_t>(r28));
...
// RECOMP_REGISTRATION base 0x80139140 func_80139140 preserves=true fpr_mask=0x00000000
