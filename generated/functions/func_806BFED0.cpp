...
extern "C" void func_806BFED0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806BFF4C:
{
    MemoryInline::FlatWrite8((r28 + 233), static_cast<uint8_t>(r24));
}
...
loc_806BFF50:
{
    r3 = 0x808A0000u;
    r30 = 0;
    f31.d = MemoryInline::FlatReadFloat64((r3 + -2768));
    r29 = 0;
    r31 = 0x809C0000u;
    r24 = 1127219200;
    r25 = 1;
...
loc_806BFF94:
{
    ...
    r23_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(29));
    r23 = (r23_rot_2 & 1);
    if (((cr & 0x20000000u) == 0)) {
        goto loc_806C0004;
    }
...
loc_806BFFB8:
{
    r0 = MemoryInline::FlatRead16((r28 + 236));
    r4 = 761;
    MemoryInline::FlatWriteRam32((r1 + 388), r0);
    r12 = MemoryInline::FlatRead32(r3);
    MemoryInline::FlatWriteRam32((r1 + 384), r24);
    r12 = MemoryInline::FlatRead32((r12 + 224));
    f0.d = MemoryInline::FlatReadFloat64((r1 + 384));
...
loc_806BFFE8:
{
    MemoryInline::FlatWrite8((r28 + 238), static_cast<uint8_t>(r25));
}

loc_806BFFEC:
{
    r3 = MemoryInline::FlatRead16((r28 + 236));
}
...
{
    r0 = (r3 + 1);
    MemoryInline::FlatWrite16((r28 + 236), static_cast<uint16_t>(r0));
}

loc_806C0000:
{
    MemoryInline::FlatWrite16((r28 + 234), static_cast<uint16_t>(r26));
}
...
loc_806C0004:
{
    ...
    r0 = (0 - r3);
    r0 = (r0 | r3);
    r30_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(1));
    r30 = (r30_rot_2 & 1);
}
...
loc_806C004C:
{
    ...
    xer = ctx->xer;
    r3 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + -2904));
...
loc_806C0088:
{
    r0 = MemoryInline::FlatRead8((r28 + 232));
}
...
loc_806C00F4:
{
    ...
    r3 = 0x808A0000u;
    r5 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + -2904));
    r3 = MemoryInline::FlatRead32((r4 + 40));
    r4 = 0;
    f2.d = MemoryInline::FlatReadFloat32((r5 + -2900));
    r5 = 1;
    ctx->lr = 0x806C0118u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_806C0130:
{
    r0 = MemoryInline::FlatRead8((r28 + 238));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_806C013C:
{
    ...
    r3 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat64((r3 + -2768));
    r3 = r28;
...
{
    r0 = 80;
    MemoryInline::FlatWrite16((r28 + 234), static_cast<uint16_t>(r0));
    goto loc_806C01A8;
}
...
loc_806C01A8:
{
    r0 = MemoryInline::FlatRead8((r28 + 233));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_806C0334:
{
    ...
    xer = ctx->xer;
    r30 = 0x808A0000u;
    f2.d = MemoryInline::FlatReadFloat32((r28 + 228));
    f0.d = MemoryInline::FlatReadFloat32((r30 + -2900));
...
loc_806C0370:
{
    ...
    r12 = MemoryInline::FlatRead32(r3);
    r29 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r29 + -2904));
...
loc_806C03A4:
{
    ...
    r5 = 1;
    r3 = MemoryInline::FlatRead32((r3 + 40));
    f2.d = MemoryInline::FlatReadFloat32((r30 + -2900));
    ctx->lr = 0x806C03C0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_806C03C0:
{
    r3 = MemoryInline::FlatRead16((r28 + 234));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(0));
}
...
{
    r0 = 0;
    MemoryInline::FlatWrite8((r28 + 238), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x806BFED0 func_806BFED0 preserves=false fpr_mask=0x80000000
