...
extern "C" void func_8007D190(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8007D190:
{
    ...
    r3 = (r3 + r6);
    r3 = (r3 + r0);
    MemoryInline::FlatWrite8((r3 + 232), static_cast<uint8_t>(r5));
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[6] = r6;
    return;
...
// RECOMP_REGISTRATION base 0x8007D190 func_8007D190 preserves=true fpr_mask=0x00000000
