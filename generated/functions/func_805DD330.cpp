...
extern "C" void func_805DD330(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805DD330:
{
    ...
    ctx->gpr[31] = r31;
    ctx->fpr[0] = f0;
    InvokeDirectCpu<0x80607D98u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x805DD330 func_805DD330 preserves=true fpr_mask=0x00000000
