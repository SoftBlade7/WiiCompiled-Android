...
extern "C" void func_8087A4DC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r3 = 0x808E0000u;
    r0 = MemoryInline::FlatRead8((r3 + -14754));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_8087A654:
{
    r0 = MemoryInline::FlatRead32((r29 + 792));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_8087A670:
{
    r4 = MemoryInline::FlatRead32((r29 + 792));
    r5 = 0;
    r6 = 0;
    ctx->lr = 0x8087A680u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x8087A4DC func_8087A4DC preserves=true fpr_mask=0x00000000
