...
extern "C" void func_807D69E8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807D6A50:
{
    f0.d = MemoryInline::FlatReadFloat32((r29 + 576));
...
loc_807D6AA4:
{
    MemoryInline::FlatWriteFloat32((r29 + 576), f1.d);
}
...
loc_807D6AC8:
{
    ...
    r3 = r29;
    f1.d = MemoryInline::FlatReadFloat32((r29 + 576));
    r6 = (r1 + 8);
    r4 = (r5 + 1344);
    r5 = (r5 + 1440);
    r7 = 0;
...
// RECOMP_REGISTRATION base 0x807D69E8 func_807D69E8 preserves=true fpr_mask=0x00000000
