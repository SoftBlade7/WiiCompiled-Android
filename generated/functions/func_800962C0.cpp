...
extern "C" void func_800962C0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800962C0:
{
    r3 = (r3 + -220);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80096240u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x800962C0 func_800962C0 preserves=true fpr_mask=0x00000000
