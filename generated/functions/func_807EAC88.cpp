...
extern "C" void func_807EAC88(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807EAC88:
{
    ...
    f2 = ctx->fpr[2];
    ctr = ctx->ctr;
    r7 = MemoryInline::FlatRead32((r31 + 408));
    r3 = r31;
    r4 = (r31 + 412);
    r5 = (r31 + 424);
...
// RECOMP_REGISTRATION base 0x807EAC88 func_807EAC88 preserves=true fpr_mask=0x00000000
