...
extern "C" void func_801E3520(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r31 = (r31 + r0);
    if ((static_cast<int32_t>(r21) > static_cast<int32_t>(4))) {
        goto loc_801E35D8;
    }
}
...
loc_801E35D8:
{
    r3 = MemoryInline::FlatRead8((r29 + 200));
    r0 = (r3 + -1);
}
...
loc_801E35E8:
{
    MemoryInline::FlatWrite8(r23, static_cast<uint8_t>(r25));
    r31 = (r31 + 4);
    r21 = (r21 + -4);
    MemoryInline::FlatWrite8((r23 + 1), static_cast<uint8_t>(r26));
    MemoryInline::FlatWrite8((r23 + 2), static_cast<uint8_t>(r27));
    MemoryInline::FlatWrite8((r23 + 3), static_cast<uint8_t>(r28));
    r23 = (r23 + 4);
}
...
// RECOMP_REGISTRATION base 0x801E3520 func_801E3520 preserves=true fpr_mask=0x00000000
