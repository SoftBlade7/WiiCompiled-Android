...
extern "C" void func_806467D4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806467D4:
{
    ...
    r4 = 0x808C0000u;
    r3 = (r3 + -1372);
    guest_range_0 = MemoryInline::ResolveRangeHost(r31, 0, 107u, false, true);
    ...
    r0 = 0;
    r4 = (r4 + -25960);
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 92u, ((static_cast<uint64_t>(static_cast<uint32_t>(r4)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_0, 92u, r3, r4);
        MemoryInline::WriteResolved32(guest_range_0, 96u, (r3 + 4), r0);
    }
    MemoryInline::WriteResolved8(guest_range_0, 104u, (r3 + 12), static_cast<uint8_t>(r0));
    MemoryInline::WriteResolved8(guest_range_0, 105u, (r3 + 13), static_cast<uint8_t>(r0));
    MemoryInline::WriteResolved8(guest_range_0, 106u, (r3 + 14), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x806467D4 func_806467D4 preserves=true fpr_mask=0x00000000
