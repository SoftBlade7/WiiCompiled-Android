...
extern "C" void func_807DC8B8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807DC8B8:
{
    r3 = 0x809C0000u;
    r0 = 11;
    MemoryInline::FlatWriteRam32((r3 + 15952), r0);
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x807DC8B8 func_807DC8B8 preserves=true fpr_mask=0x00000000
