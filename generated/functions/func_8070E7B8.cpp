...
extern "C" void func_8070E7B8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8070E7B8:
{
    ...
    r3 = r31;
    MemoryInline::FlatWrite32((r31 + 84), r7);
    MemoryInline::FlatWrite32((r31 + 136), r6);
    MemoryInline::FlatWrite32((r31 + 168), r5);
    MemoryInline::FlatWrite16((r31 + 172), static_cast<uint16_t>(r4));
...
// RECOMP_REGISTRATION base 0x8070E7B8 func_8070E7B8 preserves=true fpr_mask=0x00000000
