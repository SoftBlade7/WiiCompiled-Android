...
extern "C" void func_800FE648(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800FE648:
{
    MemoryInline::FlatWriteRam32((r1 + -2176), r1);
    r1 = (r1 + -2176);
    r0 = ctx->lr;
    MemoryInline::FlatWriteRam32((r1 + 2180), r0);
    r11 = (r1 + 2176);
...
loc_800FE6A8:
{
    r22 = MemoryInline::FlatRead32((r21 + 76));
    goto loc_800FE6C0;
}
...
loc_800FE6F0:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r9 = MemoryInline::FlatRead32((r22 + 8));
    r0 = 0;
    r8 = MemoryInline::FlatRead32((r22 + 4));
    r5 = r3;
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80105CC0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800FE8A8:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800F2F54u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r3 = (r1 + 1096);
    r30_addr_2 = (r30 + r0);
    MemoryInline::FlatWrite8(r30_addr_2, static_cast<uint8_t>(r28));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80103B64u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800FE958:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80103A10u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800FE978:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80103AACu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800FEA4C:
{
    ...
    r0 = MemoryInline::FlatRead32((r1 + 2180));
    ctx->lr = r0;
    r1 = (r1 + 2176);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x800FE648 func_800FE648 preserves=true fpr_mask=0x00000000
