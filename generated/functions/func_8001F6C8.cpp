...
extern "C" void func_8001F6C8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8001F6FC:
{
    ...
    r0_subfic_ra_3 = r0;
    r0 = (3 - r0_subfic_ra_3);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(3) >= static_cast<uint32_t>(r0_subfic_ra_3) ? 1u : 0u) << 29);
    ...
    r0 = PPC_Slw(static_cast<uint32_t>(r24), static_cast<uint32_t>(r0));
    r3 = (r5 & ~r4);
    r0 = (r4 & r0);
    r0 = (r3 | r0);
    MemoryInline::FlatWrite32(r6, r0);
    // sync @ 0x8001F760 (no-op)
    r30 = (r30 + 1);
    r29 = (r29 + 1);
    r26 = (r26 + -1);
}
...
// RECOMP_GUEST_ABI gpr_read=0xFF0000FA gpr_write=0xFF00007B gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x8001F6C8 func_8001F6C8 preserves=true fpr_mask=0x00000000
