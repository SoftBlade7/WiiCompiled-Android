...
extern "C" void func_806F8188(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806F81B4:
{
    MemoryInline::FlatWrite8((r29 + 20), static_cast<uint8_t>(r28));
    r4 = (r28 & 255);
...
// RECOMP_GUEST_ABI gpr_read=0xF800001A gpr_write=0xF800001B gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x806F8188 func_806F8188 preserves=true fpr_mask=0x00000000
