...
extern "C" void func_8011DB20(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8011DB20:
{
    ...
    ctx->gpr[4] = r4;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x8011ED84u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8011DB20 func_8011DB20 preserves=true fpr_mask=0x00000000
