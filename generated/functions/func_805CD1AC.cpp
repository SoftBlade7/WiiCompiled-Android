...
extern "C" void func_805CD1AC(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = 1;
    MemoryInline::FlatWrite8((r3 + 788), static_cast<uint8_t>(r0));
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x805CD1AC func_805CD1AC preserves=true fpr_mask=0x00000000
