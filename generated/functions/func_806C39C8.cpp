...
extern "C" void func_806C39C8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806C39C8:
{
    ...
    r31 = 0x808A0000u;
    f2.d = MemoryInline::FlatReadFloat32((r31 + -2148));
    MemoryInline::FlatWriteRam32((r1 + 24), r30);
    r30 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r30 + -2176));
...
// RECOMP_REGISTRATION base 0x806C39C8 func_806C39C8 preserves=true fpr_mask=0x00000000
