...
extern "C" void func_8064ECB4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8064ECB4:
{
    ...
    r0 = MemoryInline::FlatRead8((r3 + 2229));
...
// RECOMP_REGISTRATION base 0x8064ECB4 func_8064ECB4 preserves=true fpr_mask=0x00000000
