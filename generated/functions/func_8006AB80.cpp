...
extern "C" void func_8006AB80(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8006AB8C:
{
    r3 = MemoryInline::FlatRead32((r4 + 260));
    r4 = MemoryInline::FlatRead32((r4 + 264));
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
// RECOMP_REGISTRATION base 0x8006AB80 func_8006AB80 preserves=true fpr_mask=0x00000000
