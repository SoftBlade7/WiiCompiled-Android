...
extern "C" void func_8056E35C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8056E35C:
{
    ...
    guest_range_0 = MemoryInline::ResolveRangeHost((r30 + 28), 0, 48u, false, true);
    MemoryInline::WriteResolvedFloat32(guest_range_0, 0u, (r30 + 28), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 4u, (r1 + 12));
    MemoryInline::WriteResolvedFloat32(guest_range_0, 4u, (r30 + 32), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 8u, (r1 + 16));
    MemoryInline::WriteResolvedFloat32(guest_range_0, 8u, (r30 + 36), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 12u, (r1 + 20));
    MemoryInline::WriteResolvedFloat32(guest_range_0, 12u, (r30 + 40), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 16u, (r1 + 24));
    MemoryInline::WriteResolvedFloat32(guest_range_0, 16u, (r30 + 44), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 20u, (r1 + 28));
    MemoryInline::WriteResolvedFloat32(guest_range_0, 20u, (r30 + 48), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 24u, (r1 + 32));
    MemoryInline::WriteResolvedFloat32(guest_range_0, 24u, (r30 + 52), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 28u, (r1 + 36));
    MemoryInline::WriteResolvedFloat32(guest_range_0, 28u, (r30 + 56), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 32u, (r1 + 40));
    MemoryInline::WriteResolvedFloat32(guest_range_0, 32u, (r30 + 60), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 36u, (r1 + 44));
    MemoryInline::WriteResolvedFloat32(guest_range_0, 36u, (r30 + 64), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 40u, (r1 + 48));
    MemoryInline::WriteResolvedFloat32(guest_range_0, 40u, (r30 + 68), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 44u, (r1 + 52));
    MemoryInline::WriteResolvedFloat32(guest_range_0, 44u, (r30 + 72), f0.d);
    {
...
// RECOMP_GUEST_ABI gpr_read=0xE000001E gpr_write=0xE000003B gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00003FFF fpr_return=0x00000002 cr_read=0x00 cr_write=0x00 xer_read=0 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8056E35C func_8056E35C preserves=true fpr_mask=0x00000000
