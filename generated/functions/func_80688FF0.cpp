...
extern "C" void func_80688FF0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80688FF0:
{
    ...
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 80), 0, 36u, false, true);
    MemoryInline::WriteResolvedFloat32(guest_range_1, 24u, (r1 + 104), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 4u, (r3 + 28));
    MemoryInline::WriteResolvedFloat32(guest_range_1, 28u, (r1 + 108), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 8u, (r3 + 32));
    MemoryInline::WriteResolvedFloat32(guest_range_1, 32u, (r1 + 112), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 60u, (r3 + 84));
    MemoryInline::WriteResolvedFloat32(guest_range_1, 12u, (r1 + 92), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 64u, (r3 + 88));
    MemoryInline::WriteResolvedFloat32(guest_range_1, 16u, (r1 + 96), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 68u, (r3 + 92));
    MemoryInline::WriteResolvedFloat32(guest_range_1, 20u, (r1 + 100), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 12u, (r3 + 36));
    MemoryInline::WriteResolvedFloat32(guest_range_1, 0u, (r1 + 80), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 16u, (r3 + 40));
    MemoryInline::WriteResolvedFloat32(guest_range_1, 4u, (r1 + 84), f0.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 20u, (r3 + 44));
    MemoryInline::WriteResolvedFloat32(guest_range_1, 8u, (r1 + 88), f0.d);
}
...
loc_8068928C:
{
    ...
    // psq_load w=1 quant=0 (using PPC_PsqL)
    r4_psq_tmp_3 = (r4 + 8);
    PpcSetPairedFprInline(f1, PPC_PsqLStackInline<1u, 0u>(ctx, r4_psq_tmp_3));
    PpcSetPairedFprInline(f0, PPC_PsAddInline(f0.d, f1.d));
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r25_psq_tmp_0 = (r25 + 8);
...
loc_80688E48:
{
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80688E48u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
...
// RECOMP_REGISTRATION base 0x80688FF0 func_80688FF0 preserves=false fpr_mask=0xF8000000
