...
extern "C" void func_807A5144(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807A5144:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r5 = MemoryInline::FlatRead32((r29 + 156));
    r4 = (r30 + 21972);
    r3 = (r1 + 36);
...
// RECOMP_REGISTRATION base 0x807A5144 func_807A5144 preserves=true fpr_mask=0x00000000
