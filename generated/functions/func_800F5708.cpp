...
extern "C" void func_800F5708(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800F5734:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8010A920u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r31 = ctx->gpr[31];
...
// RECOMP_REGISTRATION base 0x800F5708 func_800F5708 preserves=true fpr_mask=0x00000000
