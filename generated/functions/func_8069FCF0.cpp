...
extern "C" void func_8069FCF0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8069FD1C:
{
    ...
    r30_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(4));
    r30 = (r30_rot_1 & 1);
}
...
loc_8069FD38:
{
    r0 = MemoryInline::FlatRead8((r3 + 149));
}
...
loc_8069FD50:
{
    ...
    r4 = (r4_rot_1 & -4);
    r0 = MemoryInline::FlatRead8((r3 + 276));
...
loc_8069FD84:
{
    r0 = MemoryInline::FlatRead8((r3 + 277));
}
...
loc_8069FDA4:
{
    f0.d = MemoryInline::FlatReadFloat32((r3 + 2760));
    r4 = 0x808B0000u;
    MemoryInline::FlatWriteRamFloat32((r1 + 8), f0.d);
    r0 = 3;
    r7 = MemoryInline::FlatRead32((r4 + 19440));
    r4 = 0;
    MemoryInline::FlatWriteRamFloat32((r1 + 12), f0.d);
    f0.d = MemoryInline::FlatReadFloat32(r31);
    r5 = (static_cast<int32_t>(r7) >> 31);
    f1.d = MemoryInline::FlatReadFloat32((r3 + 2764));
    r0_subfc_sub_1 = r0;
    ...
    r27 = (r27 + r27_ca_1);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r5)) + static_cast<uint64_t>(static_cast<uint32_t>(r4)) + (static_cast<uint64_t>(static_cast<uint32_t>(r27_ca_1)) & 1u);
        xer = (xer & 0xDFFFFFFFu) | (static_cast<uint32_t>((ppcCarryWide >> 32) & 1u) << 29);
    }
    MemoryInline::FlatWriteRamFloat32((r1 + 16), f0.d);
    r28_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r6), static_cast<uint32_t>(27));
...
loc_8069FEB4:
{
    r3 = MemoryInline::FlatRead32((r29 + 692));
    r12 = MemoryInline::FlatRead32(r3);
    r12 = MemoryInline::FlatRead32((r12 + 12));
    ctr = r12;
    ctx->lr = 0x8069FEC8u;
...
loc_8069FF80:
{
    r3 = MemoryInline::FlatRead32((r3 + 688));
    r12 = MemoryInline::FlatRead32(r3);
    r12 = MemoryInline::FlatRead32((r12 + 12));
    ctr = r12;
    ctx->lr = 0x8069FF94u;
...
loc_806A0244:
{
    r0 = MemoryInline::FlatRead8((r29 + 269));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_806A027C:
{
    r3 = MemoryInline::FlatRead32((r28 + 672));
    r5 = 1;
    r4 = MemoryInline::FlatRead32((r29 + 2788));
    r12 = MemoryInline::FlatRead32(r3);
    r12 = MemoryInline::FlatRead32((r12 + 124));
    ctr = r12;
    ctx->lr = 0x806A0298u;
...
loc_806A0298:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite8((r29 + 244), static_cast<uint8_t>(r31));
}
...
{
    r0 = 0;
    MemoryInline::FlatWrite8((r29 + 149), static_cast<uint8_t>(r30));
    MemoryInline::FlatWrite8((r29 + 269), static_cast<uint8_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x8069FCF0 func_8069FCF0 preserves=true fpr_mask=0x00000000
