...
extern "C" void func_801CBA28(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801CBA28:
{
    ...
    r3 = r31;
    r4 = (r4 + 16608);
    r12 = MemoryInline::FlatRead32((r4 + 1784));
    ctr = r12;
    ctx->lr = 0x801CBA64u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x801CBA28 func_801CBA28 preserves=true fpr_mask=0x00000000
