...
extern "C" void func_80662E08(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_80662E08:
{
    ...
    MemoryInline::FlatWrite32((r3 + 2528), r0);
    MemoryInline::FlatWrite32((r3 + 2532), r0);
    ...
    r4 = ctx->gpr[4];
    r31 = ctx->gpr[31];
    MemoryInline::FlatWrite32((r31 + 2520), r3);
    r3 = r31;
...
// RECOMP_REGISTRATION base 0x80662E08 func_80662E08 preserves=true fpr_mask=0x00000000
