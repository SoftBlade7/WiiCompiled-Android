...
extern "C" void func_806B5B88(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806B5B88:
{
    ...
    r4 = r31;
    r3 = (r1 + 8);
    // inline leaf 0x80223D30 (10 guest instruction(s))
    r0 = MemoryInline::FlatRead32((r3 + 40));
    f2.d = MemoryInline::FlatReadFloat32(r4);
    f1.d = MemoryInline::FlatReadFloat32((r4 + 4));
    r0 = (r0 | 4);
    ...
    // end of inlined leaf 0x80223D30
    r3 = (r1 + 8);
    ctx->lr = 0x806B5BE0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x806B5B88 func_806B5B88 preserves=true fpr_mask=0x00000000
