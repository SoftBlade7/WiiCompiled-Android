...
extern "C" void func_80677880(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80677880:
{
    ...
    r5 = 0x80680000u;
    r7 = r31;
    MemoryInline::FlatWrite32((r31 + 28), r6);
    r6 = (r5 + -31976);
    r5 = 1;
    ctx->lr = 0x806778B8u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x80677880 func_80677880 preserves=true fpr_mask=0x00000000
