...
extern "C" void func_805AC744(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r6_rot_0 = 0;
...
loc_inl1_cont_805909C8:
{
    ...
    r4 = (r1 + 8);
    r5 = (r1 + 20);
    f2.d = MemoryInline::FlatReadFloat32((r7 + 52));
    f1.d = MemoryInline::FlatReadFloat32((r7 + 48));
    ...
    r7 = MemoryInline::FlatRead32(r3);
    r3 = r31;
    f2.d = MemoryInline::FlatReadFloat32((r7 + 64));
    f1.d = MemoryInline::FlatReadFloat32((r7 + 60));
...
// RECOMP_REGISTRATION base 0x805AC744 func_805AC744 preserves=true fpr_mask=0x00000000
