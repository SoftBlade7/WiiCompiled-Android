...
extern "C" void func_806003E0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806004C0:
{
    ...
    xer = ctx->xer;
    r27 = 0;
    MemoryInline::FlatWrite32((r30 + 3800), r27);
    r3 = (r30 + 1996);
    r4 = 7103;
    r5 = 0;
    ctx->lr = 0x80600508u;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r30 + 3804), r27);
    r3 = 0x809C0000u;
    ...
    r0 = (r0 & 1);
    r0 = (r0 ^ 1);
    MemoryInline::FlatWrite8((r30 + 3820), static_cast<uint8_t>(r0));
    goto loc_80600764;
}
...
loc_806005A8:
{
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWrite32((r30 + 3800), r0);
    r3 = (r30 + 1996);
    r4 = 7304;
    r5 = 0;
    ctx->lr = 0x806005F0u;
    ...
    xer = ctx->xer;
    r0 = 7306;
    MemoryInline::FlatWrite32((r30 + 3804), r0);
    r0 = 1;
    MemoryInline::FlatWrite8((r30 + 3820), static_cast<uint8_t>(r0));
    goto loc_80600764;
}
...
loc_80600604:
{
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWrite32((r30 + 3808), r0);
    r0 = 2;
    MemoryInline::FlatWrite8((r30 + 3820), static_cast<uint8_t>(r0));
    goto loc_80600764;
}
...
// RECOMP_REGISTRATION base 0x806003E0 func_806003E0 preserves=true fpr_mask=0x00000000
