...
extern "C" void func_805F8D5C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805F8D5C:
{
    ...
    MemoryInline::FlatWrite32((r31 + 404), r6);
    MemoryInline::FlatWrite32((r31 + 408), r5);
...
// RECOMP_REGISTRATION base 0x805F8D5C func_805F8D5C preserves=true fpr_mask=0x00000000
