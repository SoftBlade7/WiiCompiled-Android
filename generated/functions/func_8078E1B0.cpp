...
extern "C" void func_8078E1B0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8078E1B0:
{
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 84u, ((static_cast<uint64_t>(static_cast<uint32_t>(r25)) << 32) | static_cast<uint32_t>(r26)))) {
        MemoryInline::WriteResolved32(guest_range_2, 84u, (r11 + -28), r25);
        MemoryInline::WriteResolved32(guest_range_2, 88u, (r11 + -24), r26);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 92u, ((static_cast<uint64_t>(static_cast<uint32_t>(r27)) << 32) | static_cast<uint32_t>(r28)))) {
        MemoryInline::WriteResolved32(guest_range_2, 92u, (r11 + -20), r27);
        MemoryInline::WriteResolved32(guest_range_2, 96u, (r11 + -16), r28);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 100u, ((static_cast<uint64_t>(static_cast<uint32_t>(r29)) << 32) | static_cast<uint32_t>(r30)))) {
...
loc_8078E20C:
{
    ...
    r3 = (r3 + 40);
    MemoryInline::FlatWriteRam32((r29 + 76), r3);
    MemoryInline::FlatWriteRam32((r29 + 116), r0);
    MemoryInline::FlatWriteRam32((r29 + 120), r0);
    MemoryInline::FlatWriteRam32((r29 + 124), r0);
    MemoryInline::FlatWriteRam32((r29 + 128), r0);
}
...
loc_8078E240:
{
    r3 = 0x809C0000u;
    r4 = 0x808D0000u;
    r0 = MemoryInline::FlatRead32((r3 + 12096));
    r3 = r29;
    r4 = (r4 + 6240);
    r6 = 1;
    r5 = (r0 & 65535);
    // inline leaf 0x805B91D0 (4 guest instruction(s))
    MemoryInline::FlatWriteRam32((r3 + 104), r4);
    MemoryInline::FlatWriteRam16((r3 + 112), static_cast<uint16_t>(r5));
    MemoryInline::FlatWriteRam8((r3 + 114), static_cast<uint8_t>(r6));
    // end of inlined leaf 0x805B91D0
...
loc_8078E288:
{
    ...
    r4 = 0x808A0000u;
    r3 = (r1 + 24);
    f0.d = MemoryInline::FlatReadFloat32((r4 + 19424));
    r4 = (r1 + 12);
...
loc_8078E310:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8055EAE0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
...
// RECOMP_REGISTRATION base 0x8078E1B0 func_8078E1B0 preserves=true fpr_mask=0x00000000
