...
extern "C" void func_801413A0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r0 = 255;
    MemoryInline::FlatWrite8((r31 + 131), static_cast<uint8_t>(r0));
    goto loc_80141474;
}

loc_80141470:
{
    MemoryInline::FlatWrite8((r31 + 131), static_cast<uint8_t>(r27));
}
...
loc_801414FC:
{
    r12 = MemoryInline::FlatRead32((r28 + 6436));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r12), static_cast<int32_t>(0));
}
...
// RECOMP_REGISTRATION base 0x801413A0 func_801413A0 preserves=true fpr_mask=0x00000000
