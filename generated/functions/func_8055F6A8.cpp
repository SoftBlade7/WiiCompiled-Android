...
extern "C" void func_8055F6A8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8055F6D0:
{
    ...
    r6 = ctx->gpr[6];
    cr = ctx->cr;
    MemoryInline::FlatWriteRam8((r1 + 19), static_cast<uint8_t>(r30));
    r4 = r29;
    r3 = (r1 + 20);
    r5 = (r1 + 12);
...
// RECOMP_REGISTRATION base 0x8055F6A8 func_8055F6A8 preserves=true fpr_mask=0x00000000
