...
extern "C" void func_807296B4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r4 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r4 + 9540));
...
// RECOMP_REGISTRATION base 0x807296B4 func_807296B4 preserves=true fpr_mask=0x00000000
