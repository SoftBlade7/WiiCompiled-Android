...
extern "C" void func_801F600C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801F600C:
{
    ...
    r0 = MemoryInline::FlatRead32((r3 + 5584));
    r26 = r3;
    r27 = r4;
    r31 = 0;
    r0 = (r0 & 1);
...
loc_801F603C:
{
    r30 = MemoryInline::FlatRead32((r3 + 5600));
...
// RECOMP_REGISTRATION base 0x801F600C func_801F600C preserves=true fpr_mask=0x00000000
