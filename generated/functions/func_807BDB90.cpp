...
extern "C" void func_807BDB90(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_807BDB90:
{
    ...
    r0_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(11));
    r0 = (r0_rot_0 & 63488);
    r3 = (r3 + 14552);
    r4 = (r5 + -1);
    r4 = (r4 * 12);
...
// RECOMP_REGISTRATION base 0x807BDB90 func_807BDB90 preserves=true fpr_mask=0x00000000
