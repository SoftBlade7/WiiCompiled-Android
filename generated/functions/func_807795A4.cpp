...
extern "C" void func_807795A4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807795A4:
{
    ...
    r31 = 0x808A0000u;
    f2.d = MemoryInline::FlatReadFloat32((r31 + 17264));
    MemoryInline::FlatWriteRam32((r1 + 24), r30);
    r30 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r30 + 17216));
...
// RECOMP_REGISTRATION base 0x807795A4 func_807795A4 preserves=true fpr_mask=0x00000000
