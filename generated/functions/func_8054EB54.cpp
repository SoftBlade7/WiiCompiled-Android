...
extern "C" void func_8054EB54(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8054EBAC:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8054BF50u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8054EBB8:
{
    MemoryInline::FlatWrite32((r15 + 8), r3);
    r3 = 12;
    ctx->lr = 0x8054EBC4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8054EBD0:
{
    ...
    MemoryInline::FlatWriteRam32((r3 + 8), r16);
    r3_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r16), static_cast<uint32_t>(2));
    r3 = (r3_rot_1 & -4);
    ctx->lr = 0x8054EBE8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    r29 = 0x809C0000u;
    r24 = 0x808B0000u;
    MemoryInline::FlatWriteRam32((r21 + 4), r3);
...
loc_8054EC44:
{
    guest_range_2 = MemoryInline::ResolveRangeHost(r3, 0, 40u, false, true);
    MemoryInline::WriteResolved16(guest_range_2, 4u, (r3 + 4), static_cast<uint16_t>(r22));
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 8u, ((static_cast<uint64_t>(static_cast<uint32_t>(r23)) << 32) | static_cast<uint32_t>(r22)))) {
        MemoryInline::WriteResolved32(guest_range_2, 8u, (r3 + 8), r23);
        MemoryInline::WriteResolved32(guest_range_2, 12u, (r3 + 12), r22);
    }
    MemoryInline::WriteResolved32(guest_range_2, 0u, r3, r24);
    MemoryInline::WriteResolved32(guest_range_2, 36u, (r3 + 36), r18);
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r25)) << 32) | static_cast<uint32_t>(r3)))) {
        MemoryInline::WriteResolved32(guest_range_2, 28u, (r3 + 28), r3);
        MemoryInline::WriteResolved32(guest_range_2, 24u, (r3 + 24), r25);
    }
    MemoryInline::WriteResolved16(guest_range_2, 16u, (r3 + 16), static_cast<uint16_t>(r26));
    r3 = 12;
    ctx->lr = 0x8054EC6Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    r10 = (r14 + -1);
    r4 = MemoryInline::FlatRead16((r20 + 8));
}

loc_8054EC7C:
{
    MemoryInline::FlatWriteRam16(r3, static_cast<uint16_t>(r10));
    r0 = 0;
    r8_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(1));
    r8 = (r8_rot_2 & -2);
    r3 = MemoryInline::FlatRead16((r25 + 28));
    guest_range_3 = MemoryInline::ResolveRangeHost((r19 + 20), 0, 4u, true, false);
    r5 = MemoryInline::ReadResolved32(guest_range_3, 0u, (r19 + 20));
    r7_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(1));
    r7 = (r7_rot_2 & -2);
    r4 = MemoryInline::FlatRead16((r25 + 56));
    MemoryInline::FlatWrite16((r5 + 2), static_cast<uint16_t>(r10));
    r6_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(1));
    r6 = (r6_rot_2 & -2);
    r3 = MemoryInline::FlatRead16((r25 + 84));
    ...
    r5 = (r5_rot_2 & -2);
    r4 = MemoryInline::FlatRead16((r25 + 112));
    MemoryInline::FlatWrite16((r9 + 4), static_cast<uint16_t>(r10));
    r3 = MemoryInline::FlatRead16((r25 + 140));
    ...
    r3 = (r3_rot_3 & -2);
    MemoryInline::FlatWrite16((r9 + 6), static_cast<uint16_t>(r10));
    r9 = MemoryInline::ReadResolved32(guest_range_3, 0u, (r19 + 20));
    MemoryInline::FlatWrite16((r9 + 8), static_cast<uint16_t>(r10));
    r9 = MemoryInline::ReadResolved32(guest_range_3, 0u, (r19 + 20));
    MemoryInline::FlatWrite16((r9 + 10), static_cast<uint16_t>(r10));
    r9 = MemoryInline::ReadResolved32(guest_range_3, 0u, (r19 + 20));
    r9_addr_2 = (r9 + r8);
    MemoryInline::FlatWrite16(r9_addr_2, static_cast<uint16_t>(r22));
    r8 = MemoryInline::ReadResolved32(guest_range_3, 0u, (r19 + 20));
    r8_addr_2 = (r8 + r7);
    MemoryInline::FlatWrite16(r8_addr_2, static_cast<uint16_t>(r27));
    r7 = 2;
    r8 = MemoryInline::ReadResolved32(guest_range_3, 0u, (r19 + 20));
    r8_addr_3 = (r8 + r6);
    MemoryInline::FlatWrite16(r8_addr_3, static_cast<uint16_t>(r7));
    r6 = 3;
    r7 = MemoryInline::ReadResolved32(guest_range_3, 0u, (r19 + 20));
    r7_addr_2 = (r7 + r5);
    MemoryInline::FlatWrite16(r7_addr_2, static_cast<uint16_t>(r6));
    r5 = 4;
    r6 = MemoryInline::ReadResolved32(guest_range_3, 0u, (r19 + 20));
    r6_addr_2 = (r6 + r4);
    MemoryInline::FlatWrite16(r6_addr_2, static_cast<uint16_t>(r5));
    r4 = MemoryInline::ReadResolved32(guest_range_3, 0u, (r19 + 20));
    r4_addr_2 = (r4 + r3);
    MemoryInline::FlatWrite16(r4_addr_2, static_cast<uint16_t>(r28));
...
loc_8054ED20:
{
    if ((static_cast<int32_t>(r18) >= static_cast<int32_t>(r3))) {
        goto loc_8054ED28;
    }
}
...
loc_8054ED54:
{
    ...
    MemoryInline::FlatWriteRamFloat32((r19 + 40), f0.d);
    if (((cr & 0x80000000u) != 0)) {
        goto loc_8054ED78;
    }
}
...
loc_8054ED94:
{
    ...
    MemoryInline::FlatWriteRam8((r20 + 176), static_cast<uint8_t>(r31));
    MemoryInline::FlatWriteRam8((r20 + 177), static_cast<uint8_t>(r31));
    MemoryInline::FlatWriteRam8((r20 + 178), static_cast<uint8_t>(r31));
    MemoryInline::FlatWriteRam8((r20 + 179), static_cast<uint8_t>(r27));
    MemoryInline::FlatWriteRam8((r20 + 180), static_cast<uint8_t>(r0));
...
loc_8054EDD8:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r18), static_cast<int32_t>(r16));
}
...
loc_8054EDE0:
{
    MemoryInline::FlatWrite32((r15 + 12), r21);
    r3 = 12;
    ctx->lr = 0x8054EDECu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8054EDF8:
{
    ...
    MemoryInline::FlatWriteRam32(r3, r4);
    MemoryInline::FlatWriteRam32((r3 + 8), r16);
    r3_rot_6 = PpcRotl32Inline(static_cast<uint32_t>(r16), static_cast<uint32_t>(2));
    r3 = (r3_rot_6 & -4);
    ctx->lr = 0x8054EE10u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8054EE6C:
{
    ...
    MemoryInline::WriteResolved16(guest_range_4, 4u, (r3 + 4), static_cast<uint16_t>(r26));
    if (!MemoryInline::WriteResolvedPair32(guest_range_4, 8u, ((static_cast<uint64_t>(static_cast<uint32_t>(r25)) << 32) | static_cast<uint32_t>(r26)))) {
        MemoryInline::WriteResolved32(guest_range_4, 8u, (r3 + 8), r25);
        MemoryInline::WriteResolved32(guest_range_4, 12u, (r3 + 12), r26);
    }
    MemoryInline::WriteResolved32(guest_range_4, 0u, r3, r24);
    MemoryInline::WriteResolved32(guest_range_4, 40u, (r3 + 40), r29);
    if (!MemoryInline::WriteResolvedPair32(guest_range_4, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r23)) << 32) | static_cast<uint32_t>(r3)))) {
        MemoryInline::WriteResolved32(guest_range_4, 28u, (r3 + 28), r3);
        MemoryInline::WriteResolved32(guest_range_4, 24u, (r3 + 24), r23);
    }
    MemoryInline::WriteResolved16(guest_range_4, 16u, (r3 + 16), static_cast<uint16_t>(r22));
    r3 = 10;
    ctx->lr = 0x8054EE94u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32((r28 + 20), r3);
    r4 = (r21 + -1);
    r0 = MemoryInline::FlatRead16((r20 + 184));
}
...
loc_8054EEA4:
{
    ...
    r3 = 0;
    r6 = MemoryInline::FlatRead16((r23 + 28));
    r0_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(1));
    r0 = (r0_rot_2 & -2);
    guest_range_5 = MemoryInline::ResolveRangeHost((r28 + 20), 0, 4u, true, false);
    r7 = MemoryInline::ReadResolved32(guest_range_5, 0u, (r28 + 20));
    r8_rot_6 = PpcRotl32Inline(static_cast<uint32_t>(r6), static_cast<uint32_t>(1));
    r8 = (r8_rot_6 & -2);
    r6 = MemoryInline::FlatRead16((r23 + 84));
    MemoryInline::FlatWrite16((r7 + 2), static_cast<uint16_t>(r4));
    r5 = MemoryInline::FlatRead16((r23 + 56));
    r6_rot_6 = PpcRotl32Inline(static_cast<uint32_t>(r6), static_cast<uint32_t>(1));
    r6 = (r6_rot_6 & -2);
    r9 = MemoryInline::ReadResolved32(guest_range_5, 0u, (r28 + 20));
    r7_rot_6 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(1));
    r7 = (r7_rot_6 & -2);
    r5 = MemoryInline::FlatRead16((r23 + 112));
    ...
    r4 = MemoryInline::ReadResolved32(guest_range_5, 0u, (r28 + 20));
    r4_addr_6 = (r4 + r0);
    MemoryInline::FlatWrite16(r4_addr_6, static_cast<uint16_t>(r26));
    r0 = 3;
    r4 = MemoryInline::ReadResolved32(guest_range_5, 0u, (r28 + 20));
    r4_addr_7 = (r4 + r8);
    MemoryInline::FlatWrite16(r4_addr_7, static_cast<uint16_t>(r19));
    r4 = MemoryInline::ReadResolved32(guest_range_5, 0u, (r28 + 20));
    r4_addr_8 = (r4 + r7);
    MemoryInline::FlatWrite16(r4_addr_8, static_cast<uint16_t>(r31));
    r4 = MemoryInline::ReadResolved32(guest_range_5, 0u, (r28 + 20));
    r4_addr_9 = (r4 + r6);
    MemoryInline::FlatWrite16(r4_addr_9, static_cast<uint16_t>(r0));
    r4 = MemoryInline::ReadResolved32(guest_range_5, 0u, (r28 + 20));
    r4_addr_10 = (r4 + r5);
    MemoryInline::FlatWrite16(r4_addr_10, static_cast<uint16_t>(r18));
...
loc_8054EF20:
{
    r0 = MemoryInline::FlatRead32((r14 + 4));
}
...
loc_8054EF4C:
{
    ...
    r0 = (r0 * 12);
    r3_addr_7 = (r3 + r0);
    r3 = MemoryInline::FlatRead16(r3_addr_7);
    // end of inlined leaf 0x8054ADB4
    r0 = (r3 & 65535);
    MemoryInline::FlatWriteRam32((r1 + 12), r0);
...
loc_8054EF5C:
{
    ...
    f0.d = MemoryInline::FlatReadFloat64((r1 + 8));
    f0.d = static_cast<double>(PpcForceSingleValueInline(f0.d - f31.d));
    MemoryInline::FlatWriteRamFloat32((r28 + 44), f0.d);
    if (((cr & 0x80000000u) != 0)) {
        goto loc_8054EF80;
    }
}
...
loc_8054EF9C:
{
    ...
    f0.d = MemoryInline::FlatReadFloat64((r1 + 16));
    f0.d = static_cast<double>(PpcForceSingleValueInline(f0.d - f31.d));
    MemoryInline::FlatWriteRamFloat32((r28 + 48), f0.d);
    MemoryInline::FlatWriteRam32((r28 + 8), r18);
}
...
loc_8054EFB8:
{
    ...
    r29 = (r29 + 1);
    r3_addr_9 = (r3 + r30);
    MemoryInline::FlatWrite32(r3_addr_9, r28);
    r30 = (r30 + 4);
}

loc_8054EFC8:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r29), static_cast<int32_t>(r16));
}
...
{
    r0 = 0;
    MemoryInline::FlatWrite32((r15 + 16), r27);
    r3 = 0x809C0000u;
    MemoryInline::FlatWrite32((r15 + 20), r0);
...
loc_8054F038:
{
    ...
    r0 = (r0 * 12);
    r3_addr_11 = (r3 + r0);
    r3 = MemoryInline::FlatRead16(r3_addr_11);
    // end of inlined leaf 0x8054ADB4
    r0 = (r3 & 65535);
    MemoryInline::FlatWriteRam32((r1 + 12), r0);
    r4 = 0x80890000u;
    ...
    MemoryInline::FlatWriteRamFloat32((r14 + 4), f0.d);
...
loc_8054F07C:
{
    ...
    f0.d = MemoryInline::FlatReadFloat64((r1 + 16));
    f0.d = static_cast<double>(PpcForceSingleValueInline(f0.d - f1.d));
    MemoryInline::FlatWriteRamFloat32((r14 + 8), f0.d);
    MemoryInline::FlatWriteRam8((r14 + 16), static_cast<uint8_t>(r0));
}

loc_8054F0A4:
{
    MemoryInline::FlatWrite32((r15 + 20), r14);
    r4 = 0x80380000u;
    r3 = 0x80890000u;
...
loc_8054F0D0:
{
    MemoryInline::FlatWriteRam32((r14 + 12), r3);
    r0 = 1;
    MemoryInline::FlatWriteRam8((r14 + 16), static_cast<uint8_t>(r0));
}
...
loc_8054F0DC:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r16), static_cast<int32_t>(1));
}

loc_8054F0E0:
{
    r0 = 1;
    MemoryInline::FlatWrite8((r15 + 24), static_cast<uint8_t>(r0));
    MemoryInline::FlatWrite8((r15 + 25), static_cast<uint8_t>(r0));
    if (((cr & 0x40000000u) == 0)) {
        goto loc_8054F0FC;
    }
}
...
// RECOMP_REGISTRATION base 0x8054EB54 func_8054EB54 preserves=false fpr_mask=0x80000000
