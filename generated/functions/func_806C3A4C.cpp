...
extern "C" void func_806C3A4C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806C3A4C:
{
    ...
    r4 = (r1 + 16);
    r5 = (r1 + 12);
    r9 = MemoryInline::FlatRead32((r10 + 16));
    r7 = (r1 + 8);
    r8 = MemoryInline::FlatRead32((r10 + 20));
    r0 = MemoryInline::FlatRead8((r10 + 24));
...
// RECOMP_REGISTRATION base 0x806C3A4C func_806C3A4C preserves=true fpr_mask=0x00000000
