...
extern "C" void func_8063240C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8063240C:
{
    MemoryInline::FlatWrite32((r3 + 240), r4);
    return;
}
...
// RECOMP_REGISTRATION base 0x8063240C func_8063240C preserves=true fpr_mask=0x00000000
