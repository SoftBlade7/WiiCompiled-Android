...
extern "C" void func_807B1A24(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807B1A24:
{
    r5 = 0x808A0000u;
    r4 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r5 + 24048));
    f0.d = MemoryInline::FlatReadFloat32((r4 + 24420));
    MemoryInline::FlatWriteFloat32((r3 + 504), f1.d);
...
// RECOMP_REGISTRATION base 0x807B1A24 func_807B1A24 preserves=true fpr_mask=0x00000000
