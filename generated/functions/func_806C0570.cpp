...
extern "C" void func_806C0570(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806C0570:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r6 + -2656));
    ...
    r28 = r4;
    r4 = 0;
    MemoryInline::FlatWrite8((r3 + 176), static_cast<uint8_t>(r8));
...
loc_806C0694:
{
    r4 = 0x808A0000u;
    r3 = r30;
    f1.d = MemoryInline::FlatReadFloat32((r4 + -2656));
    r4 = 740;
    ctx->lr = 0x806C06A8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x806C0570 func_806C0570 preserves=true fpr_mask=0x00000000
