...
extern "C" void func_8010DED8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8010DF5C:
{
    ...
    r6 = (r6 + -8656);
    r3 = 4;
    MemoryInline::FlatWriteRam32((r31 + 60), r28);
    r7 = (r7 + -8624);
    r4 = 32;
    r5 = 2;
    MemoryInline::FlatWriteRam32((r31 + 56), r27);
    r8 = 0;
    MemoryInline::FlatWriteRam32((r31 + 36), r29);
    ctx->lr = 0x8010DFA0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_8010E00C:
{
    MemoryInline::FlatWriteRam32((r31 + 64), r30);
...
loc_8010E020:
{
    MemoryInline::FlatWriteRam32((r31 + 68), r30);
}
...
loc_8010E084:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800F122Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8010E0C4:
{
    ...
    MemoryInline::FlatWriteRam16((r31 + 8), static_cast<uint16_t>(r3));
    r3 = 0;
...
// RECOMP_REGISTRATION base 0x8010DED8 func_8010DED8 preserves=true fpr_mask=0x00000000
