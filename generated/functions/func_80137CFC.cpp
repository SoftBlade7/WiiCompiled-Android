...
extern "C" void func_80137CFC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80137D78:
{
    MemoryInline::FlatWrite16(r29, static_cast<uint16_t>(r27));
    r3 = 0x80330000u;
    r3 = (r3 + 25208);
...
loc_80137DE8:
{
    r3 = 1;
    r0 = 0;
    MemoryInline::FlatWrite8((r31 + 281), static_cast<uint8_t>(r3));
    r3 = (r4 & 255);
    MemoryInline::FlatWrite16(r31, static_cast<uint16_t>(r27));
    MemoryInline::FlatWrite8((r31 + 282), static_cast<uint8_t>(r28));
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8013D9D8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80137E48:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8014535Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x801452E0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80137E78:
{
    r0 = (r6 & 255);
    r4 = (r3 + r0);
    r0 = MemoryInline::FlatRead8((r4 + 119));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_80137F88:
{
    MemoryInline::FlatWrite16((r30 + 270), static_cast<uint16_t>(r28));
    r0 = MemoryInline::FlatRead8((r30 + 282));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_80137FE0:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80145264u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80137CFC func_80137CFC preserves=true fpr_mask=0x00000000
