...
extern "C" void func_8063E840(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
{
    r5 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r5 + -29740));
...
{
    r5 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r5 + -29736));
...
// RECOMP_REGISTRATION base 0x8063E840 func_8063E840 preserves=true fpr_mask=0x00000000
