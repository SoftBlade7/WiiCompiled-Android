...
extern "C" void func_80793F04(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80793F38:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r3 + 19760));
    f0.d = static_cast<double>(PpcForceSingleValueInline(f0.d / f1.d));
    PpcSetPairedFprInline(f2, PPC_PsMuls0Inline(f2.d, PPC_PsFromScalarInline(f0.d)));
    ...
    r30_psq_tmp_1 = (r30 + 8);
    PPC_PsqStGqrInline<1u, 0u>(ctx, mkw_gqr0, r30_psq_tmp_1, f2.d);
}
...
// RECOMP_GUEST_ABI gpr_read=0xC000001E gpr_write=0xC000000B gpr_return=0x00000008 fpr_read=0x0000000F fpr_write=0x0000001F fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80793F04 func_80793F04 preserves=true fpr_mask=0x00000000
