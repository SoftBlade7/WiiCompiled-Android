...
extern "C" void func_805EDBF8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805EDBF8:
{
    ...
    MemoryInline::FlatWrite32((r3 + 4404), r4);
...
// RECOMP_REGISTRATION base 0x805EDBF8 func_805EDBF8 preserves=true fpr_mask=0x00000000
