...
extern "C" void func_805D5014(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_805D5078:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_107F = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_107F[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_107F[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    r5 = ctx->gpr[5];
    r6 = ctx->gpr[6];
    r4 = MemoryInline::FlatRead32((r31 + 6644));
    r3 = (r31 + 4660);
    r5 = 1;
    r0 = (0 - r4);
    r0 = (r0 & ~r4);
...
// RECOMP_REGISTRATION base 0x805D5014 func_805D5014 preserves=true fpr_mask=0x00000000
