...
extern "C" void func_807E9C50(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807E9C50:
{
    ...
    r31 = 0x808B0000u;
    r4 = 1;
    f1.d = MemoryInline::FlatReadFloat32((r31 + -28352));
    ctx->lr = 0x807E9C84u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x807E9C50 func_807E9C50 preserves=true fpr_mask=0x00000000
