...
extern "C" void func_8054BF50(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_stfsx_8054C2C4_loc_0 = 0;
    uint32_t addr_stfsx_8054C31C_loc_0 = 0;
    uint32_t cr0_0 = 0;
...
loc_8054BF50:
{
    ...
    r0 = 0;
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 4u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_2, 4u, r3, r0);
        MemoryInline::WriteResolved32(guest_range_2, 8u, (r3 + 4), r0);
    }
    if (!MemoryInline::WriteResolvedPair16(guest_range_2, 12u, ((static_cast<uint32_t>(static_cast<uint16_t>(r0)) << 16) | static_cast<uint16_t>(r4)))) {
        MemoryInline::WriteResolved16(guest_range_2, 12u, (r3 + 8), r0);
        MemoryInline::WriteResolved16(guest_range_2, 14u, (r3 + 10), r4);
    }
    ...
    r4 = 0;
    r5 = MemoryInline::FlatRead32((r5 + 15552));
    r6 = 0;
    ctx->lr = 0x8054BFC4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8054BFEC:
{
    MemoryInline::FlatWrite32((r21 + 16), r16);
    r3 = (r21 + 16);
    ctx->lr = 0x8054BFF8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r21 + 24), r3);
    r17 = 0;
    r16 = 0;
    goto loc_8054C064;
}
...
loc_8054C064:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r17), static_cast<uint32_t>(r3));
}
...
loc_8054C0A0:
{
    r5 = MemoryInline::FlatRead32((r21 + 24));
    r4 = r23;
    r3 = (r21 + 16);
    r5_addr_2 = (r5 + r25);
    r26 = MemoryInline::FlatRead32(r5_addr_2);
    ctx->lr = 0x8054C0B4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_8054C0DC:
{
    r30 = MemoryInline::FlatRead16((r16 + 30));
    r4 = r23;
    r3 = (r21 + 16);
    ctx->lr = 0x8054C0ECu;
    ctx->gpr[0] = r0;
...
loc_8054C114:
{
    r16 = MemoryInline::FlatRead16((r16 + 28));
    r4 = r23;
    r3 = (r21 + 16);
    ctx->lr = 0x8054C124u;
    ctx->gpr[0] = r0;
...
loc_8054C14C:
{
    r4 = MemoryInline::FlatRead32((r17 + 16));
...
loc_8054C1A4:
{
    r16_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r22), static_cast<uint32_t>(2));
    r16 = (r16_rot_0 & -4);
    r3 = r16;
    ctx->lr = 0x8054C1B0u;
    ctx->gpr[0] = r0;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r21 + 60), r3);
    r3 = r16;
    ctx->lr = 0x8054C1C8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    r4 = 0x80890000u;
    r30 = 0x809C0000u;
    MemoryInline::FlatWrite32((r21 + 56), r3);
    r31 = (r30 + 6248);
...
loc_8054C200:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8054B310u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8054C24C:
{
    ...
    MemoryInline::FlatWrite32(r16, r25);
...
loc_8054C264:
{
    r0 = MemoryInline::FlatRead16((r16 + 52));
    r0 = (r0 | 1);
    MemoryInline::FlatWrite16((r16 + 52), static_cast<uint16_t>(r0));
    MemoryInline::FlatWrite32((r16 + 4), r25);
}

loc_8054C274:
{
    r3 = MemoryInline::FlatRead32((r24 + 28512));
    r12 = MemoryInline::FlatRead32(r3);
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    f0.d = MemoryInline::FlatReadFloat32((r16 + 8));
    ...
    addr_stfsx_8054C2C4_loc_0 = (r3 + r26);
    MemoryInline::FlatWriteFloat32(addr_stfsx_8054C2C4_loc_0, f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r16 + 8));
    r3 = MemoryInline::FlatRead32((r24 + 28512));
    f0.d = PPC_Fctiwz(f0.d);
    r12 = MemoryInline::FlatRead32(r3);
    ...
    f1.d = MemoryInline::FlatReadFloat64((r1 + 16));
    f0.d = static_cast<double>(PpcForceSingleValueInline(f0.d - f31.d));
    r3 = MemoryInline::FlatRead32((r21 + 56));
    f1.d = static_cast<double>(PpcForceSingleValueInline(f1.d - f31.d));
    f0.d = static_cast<double>(PpcForceSingleValueInline(f1.d / f0.d));
    addr_stfsx_8054C31C_loc_0 = (r3 + r26);
    MemoryInline::FlatWriteFloat32(addr_stfsx_8054C31C_loc_0, f0.d);
    r26 = (r26 + 4);
}

loc_8054C324:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r23), static_cast<int32_t>(r22));
}
...
// RECOMP_REGISTRATION base 0x8054BF50 func_8054BF50 preserves=false fpr_mask=0x80000000
