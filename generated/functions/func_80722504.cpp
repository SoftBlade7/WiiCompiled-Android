...
extern "C" void func_80722504(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80722504:
{
    guest_range_9 = MemoryInline::ResolveRangeHost((r1 + -128), 0, 136u, false, true);
    MemoryInline::WriteResolved32(guest_range_9, 0u, (r1 + -128), r1);
    r1 = (r1 + -128);
    r0 = ctx->lr;
    MemoryInline::WriteResolved32(guest_range_9, 132u, (r1 + 132), r0);
    r11 = (r1 + 128);
    // inline leaf 0x800215A0 (6 guest instruction(s))
    if (!MemoryInline::WriteResolvedPair32(guest_range_9, 108u, ((static_cast<uint64_t>(static_cast<uint32_t>(r27)) << 32) | static_cast<uint32_t>(r28)))) {
        MemoryInline::WriteResolved32(guest_range_9, 108u, (r11 + -20), r27);
        MemoryInline::WriteResolved32(guest_range_9, 112u, (r11 + -16), r28);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_9, 116u, ((static_cast<uint64_t>(static_cast<uint32_t>(r29)) << 32) | static_cast<uint32_t>(r30)))) {
        MemoryInline::WriteResolved32(guest_range_9, 116u, (r11 + -12), r29);
        MemoryInline::WriteResolved32(guest_range_9, 120u, (r11 + -8), r30);
    }
    MemoryInline::WriteResolved32(guest_range_9, 124u, (r11 + -4), r31);
    // end of inlined leaf 0x800215A0
    MemoryInline::FlatWrite8((r3 + 93), static_cast<uint8_t>(r4));
    r5 = 0x808A0000u;
    r5 = (r5 + 8596);
    r0 = 0;
    MemoryInline::WriteResolved32(guest_range_9, 100u, (r1 + 100), r0);
    r30 = r3;
    r31 = r4;
    r3 = (r1 + 100);
    r5 = (r5 + 34);
...
loc_80722560:
{
    ...
    r3 = 0x808A0000u;
    r5 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + 8440));
...
loc_80722798:
{
    ...
    r29 = 0x808A0000u;
    r28 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r29 + 8440));
    r3 = MemoryInline::FlatRead32((r3 + 40));
    r4 = 0;
    f2.d = MemoryInline::FlatReadFloat32((r28 + 8444));
    ctx->lr = 0x8072283Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_80722D84:
{
    ...
    r7 = (r7 + 18416);
    r0 = (r5 | 77594624);
    guest_range_8 = MemoryInline::ResolveRangeHost(r3, 0, 76u, false, true);
    MemoryInline::WriteResolved32(guest_range_8, 0u, r3, r7);
    MemoryInline::WriteResolved16(guest_range_8, 8u, (r3 + 8), static_cast<uint16_t>(r6));
    MemoryInline::WriteResolved32(guest_range_8, 12u, (r3 + 12), r6);
    if (!MemoryInline::WriteResolvedPair32(guest_range_8, 36u, ((static_cast<uint64_t>(static_cast<uint32_t>(r4)) << 32) | static_cast<uint32_t>(r6)))) {
        MemoryInline::WriteResolved32(guest_range_8, 36u, (r3 + 36), r4);
        MemoryInline::WriteResolved32(guest_range_8, 40u, (r3 + 40), r6);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_8, 60u, ((static_cast<uint64_t>(static_cast<uint32_t>(r6)) << 32) | static_cast<uint32_t>(r6)))) {
        MemoryInline::WriteResolved32(guest_range_8, 60u, (r3 + 60), r6);
        MemoryInline::WriteResolved32(guest_range_8, 64u, (r3 + 64), r6);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_8, 68u, ((static_cast<uint64_t>(static_cast<uint32_t>(r6)) << 32) | static_cast<uint32_t>(r6)))) {
        MemoryInline::WriteResolved32(guest_range_8, 68u, (r3 + 68), r6);
        MemoryInline::WriteResolved32(guest_range_8, 72u, (r3 + 72), r6);
    }
    MemoryInline::WriteResolved32(guest_range_8, 20u, (r3 + 20), r6);
    if (!MemoryInline::WriteResolvedPair32(guest_range_8, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r6)) << 32) | static_cast<uint32_t>(r6)))) {
        MemoryInline::WriteResolved32(guest_range_8, 28u, (r3 + 28), r6);
        MemoryInline::WriteResolved32(guest_range_8, 24u, (r3 + 24), r6);
    }
    MemoryInline::WriteResolved32(guest_range_8, 32u, (r3 + 32), r6);
    MemoryInline::WriteResolved32(guest_range_8, 4u, (r3 + 4), r0);
    // end of inlined leaf 0x8055B50C
}
...
{
    r3 = MemoryInline::FlatRead32((r27 + 4));
    r4 = MemoryInline::FlatRead32((r30 + 524));
    ctx->lr = 0x80722E2Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80722504 func_80722504 preserves=true fpr_mask=0x00000000
