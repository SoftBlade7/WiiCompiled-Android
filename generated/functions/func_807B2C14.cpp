...
extern "C" void func_807B2C14(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807B2C50:
{
    r30 = MemoryInline::FlatRead32((r28 + 24));
    r3 = (r1 + 16);
...
loc_807B2D50:
{
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 40), 0, 64u, true, false);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r18 = MemoryInline::ReadResolved32(guest_range_1, 0u, (r1 + 40));
            r19 = MemoryInline::ReadResolved32(guest_range_1, 4u, (r1 + 44));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r20 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r1 + 48));
            r21 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r1 + 52));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r22 = MemoryInline::ReadResolved32(guest_range_1, 16u, (r1 + 56));
            r23 = MemoryInline::ReadResolved32(guest_range_1, 20u, (r1 + 60));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r24 = MemoryInline::ReadResolved32(guest_range_1, 24u, (r1 + 64));
            r25 = MemoryInline::ReadResolved32(guest_range_1, 28u, (r1 + 68));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r26 = MemoryInline::ReadResolved32(guest_range_1, 32u, (r1 + 72));
            r27 = MemoryInline::ReadResolved32(guest_range_1, 36u, (r1 + 76));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r28 = MemoryInline::ReadResolved32(guest_range_1, 40u, (r1 + 80));
            r29 = MemoryInline::ReadResolved32(guest_range_1, 44u, (r1 + 84));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r30 = MemoryInline::ReadResolved32(guest_range_1, 48u, (r1 + 88));
            r31 = MemoryInline::ReadResolved32(guest_range_1, 52u, (r1 + 92));
        }
    }
...
// RECOMP_REGISTRATION base 0x807B2C14 func_807B2C14 preserves=true fpr_mask=0x00000000
