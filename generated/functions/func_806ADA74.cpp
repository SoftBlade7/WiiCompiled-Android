...
extern "C" void func_806ADA74(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_806ADA74:
{
    ...
    r30 = r3;
    r31 = MemoryInline::FlatRead32((r3 + 1828));
}
...
loc_806ADAD0:
{
    ...
    r3 = MemoryInline::FlatRead32((r30 + 724));
...
// RECOMP_REGISTRATION base 0x806ADA74 func_806ADA74 preserves=true fpr_mask=0x00000000
