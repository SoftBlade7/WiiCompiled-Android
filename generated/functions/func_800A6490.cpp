...
extern "C" void func_800A6490(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r5_rot_0 = 0;
    uint32_t r5_rot_1 = 0;
...
loc_800A6490:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead8((r30 + 287));
...
loc_800A64D8:
{
    r5 = MemoryInline::FlatRead8((r30 + 224));
...
// RECOMP_REGISTRATION base 0x800A6490 func_800A6490 preserves=true fpr_mask=0x00000000
