...
extern "C" void func_800D6E90(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800D6F14:
{
    ...
    r4 = ctx->gpr[4];
    r6 = 0x80000000u;
    r8 = MemoryInline::FlatRead32((r26 + 2156));
    r0 = MemoryInline::FlatRead32((r6 + 248));
    r5 = 274857984;
    r6 = (r5 + 19923);
    r7 = MemoryInline::FlatRead32((r26 + 2152));
...
loc_800D6F70:
{
    ...
    r4 = 255;
    r0 = 0;
    MemoryInline::FlatWrite8((r3 + 2008), static_cast<uint8_t>(r4));
    r3 = MemoryInline::FlatRead32((r13 + -26868));
    MemoryInline::FlatWrite8((r3 + 2009), static_cast<uint8_t>(r0));
    ctx->lr = 0x800D6F9Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_800D705C:
{
    ...
    r3 = MemoryInline::FlatRead32((r5 + 1592));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_800D83B8:
{
    ...
    if (MkwStateFreeAbiEnabled(0x8011E43Cu) && KnownTranslatedCpuCall<0x8011E43Cu>::kAvailable && !KnownTranslatedCpuCall<0x8011E43Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x8011E43Cu>()) {
        const auto state_free_result_8011E43C_DADC = func_8011E43C_statefree_v0(r3, xer);
        r0 = static_cast<uint32_t>(state_free_result_8011E43C_DADC[0]);
        r3 = static_cast<uint32_t>(state_free_result_8011E43C_DADC[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x800D6E90 func_800D6E90 preserves=true fpr_mask=0x00000000
