...
extern "C" void func_805778AC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805778AC:
{
    ...
    r29 = r3;
    r3 = r6;
    r7 = MemoryInline::FlatRead8((r29 + 16));
    r6 = r29;
    ctx->lr = 0x805778E0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x807D21F8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x805778AC func_805778AC preserves=true fpr_mask=0x00000000
