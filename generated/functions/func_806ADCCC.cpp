...
extern "C" void func_806ADCCC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806ADCCC:
{
    r3 = MemoryInline::FlatRead32((r3 + 704));
...
// RECOMP_REGISTRATION base 0x806ADCCC func_806ADCCC preserves=true fpr_mask=0x00000000
