...
extern "C" void func_80109330(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80109330:
{
    ...
    r5 = ctx->gpr[5];
    r0 = 0;
    MemoryInline::FlatWrite8((r31 + 255), static_cast<uint8_t>(r0));
    MemoryInline::FlatWrite32((r31 + 1464), r30);
...
// RECOMP_REGISTRATION base 0x80109330 func_80109330 preserves=true fpr_mask=0x00000000
