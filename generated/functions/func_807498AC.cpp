...
extern "C" void func_807498AC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807498AC:
{
    ...
    r0 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r5 + 11320));
    r5 = 1;
    MemoryInline::FlatWriteRam32((r1 + 12), r31);
    r31 = 0x808A0000u;
    f2.d = MemoryInline::FlatReadFloat32((r31 + 11324));
    ...
    f1 = ctx->fpr[1];
    f2 = ctx->fpr[2];
    f1.d = MemoryInline::FlatReadFloat32((r31 + 11324));
    r3 = r30;
    ctx->lr = 0x80749900u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x807498AC func_807498AC preserves=true fpr_mask=0x00000000
