...
extern "C" void func_80754A08(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80754A9C:
{
    ...
    // inline leaf 0x80756DCC (9 guest instruction(s))
    ...
    // end of inlined leaf 0x80756DCC
...
loc_80754CD8:
{
    ...
    MemoryInline::FlatWriteFloat32((r29 + 204), f4.d);
...
loc_80754E10:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8075547Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80754E24:
{
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x807558C4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80754E4C:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80755AD8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    f2.d = MemoryInline::FlatReadFloat32((r29 + 304));
    f1.d = MemoryInline::FlatReadFloat32((r29 + 300));
...
loc_80754ED4:
{
    r3 = 1;
    r0 = 10;
    MemoryInline::FlatWrite8((r29 + 460), static_cast<uint8_t>(r3));
    r3 = 0x809C0000u;
    r4 = 0x809C0000u;
...
loc_80754F4C:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80754FD4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80754A08 func_80754A08 preserves=false fpr_mask=0x80000000
