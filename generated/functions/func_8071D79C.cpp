...
extern "C" void func_8071D79C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_stfsx_8071D7F8_loc_0 = 0;
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
    uint32_t r5_rot_0 = 0;
...
loc_8071D79C:
{
    ...
    r0 = (r0 * 12);
    addr_stfsx_8071D7F8_loc_0 = (r4 + r0);
    MemoryInline::FlatWriteFloat32(addr_stfsx_8071D7F8_loc_0, f2.d);
    r3 = (r4 + r0);
...
// RECOMP_REGISTRATION base 0x8071D79C func_8071D79C preserves=true fpr_mask=0x00000000
