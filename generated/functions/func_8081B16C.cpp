...
extern "C" void func_8081B16C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8081B1D0:
{
    ...
    r3 = r24;
    r4 = r30;
    r31 = MemoryInline::FlatRead32((r28 + 88));
...
// RECOMP_REGISTRATION base 0x8081B16C func_8081B16C preserves=false fpr_mask=0x80000000
