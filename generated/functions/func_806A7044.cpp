...
extern "C" void func_806A7044(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806A708C:
{
    r31 = MemoryInline::FlatRead32((r3 + 620));
...
// RECOMP_REGISTRATION base 0x806A7044 func_806A7044 preserves=true fpr_mask=0x00000000
