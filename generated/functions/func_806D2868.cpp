...
extern "C" void func_806D2868(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lhax_806D28B0_loc_0 = 0;
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
    uint32_t r0_rot_2 = 0;
...
loc_806D28A8:
{
    ...
    r0 = (r0_rot_1 & -2);
    addr_lhax_806D28B0_loc_0 = (r4 + r0);
    r0 = MemoryInline::FlatRead16(addr_lhax_806D28B0_loc_0);
    r0 = (r0 << 16);
...
// RECOMP_REGISTRATION base 0x806D2868 func_806D2868 preserves=true fpr_mask=0x00000000
