...
extern "C" void func_807E75DC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807E763C:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r27 = MemoryInline::FlatRead32((r3 + 2112));
}
...
loc_807E7670:
{
    ...
    r25 = r29;
    r26 = r30;
    r24_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r27), static_cast<uint32_t>(2));
    r24 = (r24_rot_0 & -4);
    r28 = (r27 + 1);
    r23 = 0;
    r27 = 0;
...
loc_807E76A0:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_255D = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_255D[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_255D[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    r0 = MemoryInline::FlatRead32((r29 + 5744));
    r24_addr_2 = (r24 + r0);
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r25 + 972), r23);
    r23 = (r23 + 1);
...
loc_807E76EC:
{
    r28 = 0x808B0000u;
    r0 = 7;
    f29.d = MemoryInline::FlatReadFloat64((r31 + 320));
    r28 = (r28 + -30048);
    f30.d = MemoryInline::FlatReadFloat32((r31 + 312));
    r29 = (r0 ^ -2147483648);
    f31.d = MemoryInline::FlatReadFloat32((r31 + 328));
    r23 = 0;
}
...
loc_807E770C:
{
    ...
    f4.d = MemoryInline::FlatReadFloat32((r31 + 316));
...
// RECOMP_REGISTRATION base 0x807E75DC func_807E75DC preserves=false fpr_mask=0xE0000000
