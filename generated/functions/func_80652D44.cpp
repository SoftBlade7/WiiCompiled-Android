...
extern "C" void func_80652D44(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r5 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r5 + -24616));
...
{
    r5 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r5 + -24604));
...
// RECOMP_REGISTRATION base 0x80652D44 func_80652D44 preserves=true fpr_mask=0x00000000
