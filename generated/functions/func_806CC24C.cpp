...
extern "C" void func_806CC24C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806CC298:
{
    ...
    f2.d = MemoryInline::FlatReadFloat32((r29 + -1504));
    ctx->lr = 0x806CC2B4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    f1.d = MemoryInline::FlatReadFloat32((r29 + -1504));
...
loc_806CC2F4:
{
    r28 = MemoryInline::FlatRead32((r31 + 216));
...
loc_806CC378:
{
    r3 = MemoryInline::FlatRead32((r3 + 8));
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r29 + -1560));
    r5 = 1;
    r3 = MemoryInline::FlatRead32((r3 + 40));
    f2.d = MemoryInline::FlatReadFloat32((r30 + -1504));
    ctx->lr = 0x806CC394u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    // end of inlined leaf 0x80557340
    r12 = MemoryInline::FlatRead32(r3);
    f1.d = MemoryInline::FlatReadFloat32((r30 + -1504));
    r12 = MemoryInline::FlatRead32((r12 + 28));
    ctr = r12;
    ctx->lr = 0x806CC3C0u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x806CC24C func_806CC24C preserves=true fpr_mask=0x00000000
