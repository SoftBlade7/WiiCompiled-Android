...
extern "C" void func_80680B04(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80680B04:
{
    ...
    r12 = MemoryInline::FlatRead32((r12 + 332));
    ctr = r12;
    ctx->gpr[12] = r12;
    ctx->ctr = ctr;
...
// RECOMP_REGISTRATION base 0x80680B04 func_80680B04 preserves=true fpr_mask=0x00000000
