...
extern "C" void func_8052A538(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8052A538:
{
    ...
    r30_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r28), static_cast<uint32_t>(2));
    r30 = (r30_rot_0 & 262140);
    r3 = r30;
    ctx->lr = 0x8052A5A4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8052A5DC:
{
    ...
    r5 = 128;
    r6_addr_2 = (r6 + r29);
    MemoryInline::FlatWrite32(r6_addr_2, r3);
...
// RECOMP_REGISTRATION base 0x8052A538 func_8052A538 preserves=true fpr_mask=0x00000000
