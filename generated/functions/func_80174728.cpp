...
extern "C" void func_80174728(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80174728:
{
    ...
    r11 = (r1 + 80);
    MemoryInline::FlatWriteRamFloat64((r1 + 88), f31.d);
...
loc_80174774:
{
    ...
    ctx->gpr[6] = r6;
    ctx->cr = cr;
    InvokeDirectCpu<0x8018CBDCu>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r5 = ctx->gpr[5];
    r6 = ctx->gpr[6];
...
loc_801747E4:
{
    r0 = MemoryInline::FlatRead16((r22 + 16));
...
loc_801748A8:
{
    f31.d = MemoryInline::FlatReadFloat64((r1 + 88));
    r3 = r30;
...
// RECOMP_REGISTRATION base 0x80174728 func_80174728 preserves=false fpr_mask=0xC0000000
