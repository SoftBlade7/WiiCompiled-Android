...
extern "C" void func_80214F14(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80214F14:
{
    ...
    r30 = r3;
    MemoryInline::FlatWrite32((r3 + 80), r3);
    ...
    r30 = ctx->gpr[30];
    r31 = ctx->gpr[31];
    MemoryInline::FlatWrite32((r30 + 156), r31);
...
// RECOMP_REGISTRATION base 0x80214F14 func_80214F14 preserves=true fpr_mask=0x00000000
