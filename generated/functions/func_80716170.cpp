...
extern "C" void func_80716170(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80716170:
{
    ...
    if (MkwStateFreeAbiEnabled(0x80632080u) && KnownTranslatedCpuCall<0x80632080u>::kAvailable && !KnownTranslatedCpuCall<0x80632080u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80632080u>()) {
        const auto state_free_result_80632080_B32 = func_80632080_statefree(r3, cr, xer);
        r3 = static_cast<uint32_t>(state_free_result_80632080_B32[0]);
        cr = static_cast<uint32_t>(state_free_result_80632080_B32[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_807161CC:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x808696F8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80716214:
{
    ...
    ctx->gpr[5] = r5;
    ctx->cr = cr;
    InvokeDirectCpu<0x80866388u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
...
loc_8071624C:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x808664C4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8071627C:
{
    ...
    ctx->gpr[5] = r5;
    ctx->cr = cr;
    InvokeDirectCpu<0x80866404u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
...
// RECOMP_REGISTRATION base 0x80716170 func_80716170 preserves=true fpr_mask=0x00000000
