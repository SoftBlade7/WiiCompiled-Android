...
extern "C" void func_807407E4(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r3 = 0x808A0000u;
    r3 = MemoryInline::FlatRead32((r3 + 10496));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x807407E4 func_807407E4 preserves=true fpr_mask=0x00000000
