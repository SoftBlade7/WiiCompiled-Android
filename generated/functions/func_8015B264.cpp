...
extern "C" void func_8015B264(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr1_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8015B264:
{
    ...
    r3 = MemoryInline::FlatRead8((r8 + 1));
...
// RECOMP_REGISTRATION base 0x8015B264 func_8015B264 preserves=true fpr_mask=0x00000000
