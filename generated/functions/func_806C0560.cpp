...
extern "C" void func_806C0560(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806C0560:
{
    ...
    MemoryInline::FlatWrite8((r3 + 177), static_cast<uint8_t>(r0));
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x806C0560 func_806C0560 preserves=true fpr_mask=0x00000000
