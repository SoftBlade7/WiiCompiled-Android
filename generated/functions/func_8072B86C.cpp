...
extern "C" void func_8072B86C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8072B86C:
{
    r3 = MemoryInline::FlatRead8((r3 + 436));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8072B86C func_8072B86C preserves=true fpr_mask=0x00000000
