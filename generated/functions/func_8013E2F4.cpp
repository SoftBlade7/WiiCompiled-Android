...
extern "C" void func_8013E2F4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8013E3AC:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80144A34u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8013E3C0:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801455BCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8013E42C:
{
    r3 = 0x80330000u;
    r3 = (r3 + 25208);
    r4 = MemoryInline::FlatRead16((r3 + 6404));
    MemoryInline::FlatWrite16((r31 + 32), static_cast<uint16_t>(r4));
    r5 = MemoryInline::FlatRead16((r3 + 1622));
    r3 = (r4 & r5);
    r0 = (r3 & 56);
}
...
loc_8013E47C:
{
    ...
    r4 = r29;
    r7 = MemoryInline::FlatRead16((r31 + 28));
    r10 = (r28 & 65535);
    r8 = MemoryInline::FlatRead16((r31 + 30));
    r9 = MemoryInline::FlatRead8((r31 + 34));
    ctx->lr = 0x8013E4A0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801454D4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite16((r31 + 32), static_cast<uint16_t>(r28));
    goto loc_8013E4B8;
}
...
loc_8013E4A8:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801449D4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8013E2F4 func_8013E2F4 preserves=true fpr_mask=0x00000000
