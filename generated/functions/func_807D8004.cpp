...
extern "C" void func_807D8004(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807D804C:
{
    r0 = (r1 + 144);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r1)) + static_cast<uint64_t>(static_cast<uint32_t>(144)) + (static_cast<uint64_t>(static_cast<uint32_t>(0)) & 1u);
...
loc_807D8084:
{
    ...
    r4 = (r29 + 964);
    f1.d = MemoryInline::FlatReadFloat32((r5 + 788));
    f0.d = MemoryInline::FlatReadFloat32((r5 + 988));
    f3.d = MemoryInline::FlatReadFloat32((r1 + 172));
    f1.d = static_cast<double>(PpcForceSingleValueInline(f1.d + f0.d));
    f0.d = MemoryInline::FlatReadFloat32((r28 + 352));
    ...
    f0.d = MemoryInline::FlatReadFloat32((r28 + 352));
    r4 = (r29 + 976);
    f2.d = MemoryInline::FlatReadFloat32((r5 + 784));
    f1.d = MemoryInline::FlatReadFloat32((r5 + 984));
    ...
    r3 = (r1 + 144);
    f0.d = MemoryInline::FlatReadFloat32((r28 + 356));
    f1.d = MemoryInline::FlatReadFloat32((r4 + 1208));
    f1.d = PpcFmulsInline(f0.d, f1.d);
    ctx->lr = 0x807D811Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r4_psq_tmp_7 = (r4 + 4);
    PpcSetPairedFprInline(f2, PPC_PsqLStackInline<0u, 0u>(ctx, r4_psq_tmp_7));
...
loc_807D81D8:
{
    ...
    r3 = (r1 + 68);
    r4 = (r1 + 20);
    MemoryInline::FlatWriteFloat32((r5 + 956), f0.d);
    ...
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r4_psq_tmp_8 = (r4 + 4);
    PpcSetPairedFprInline(f4, PPC_PsqLStackInline<0u, 0u>(ctx, r4_psq_tmp_8));
    r3 = (r1 + 144);
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r5_psq_tmp_1 = (r5 + 4);
    PpcSetPairedFprInline(f3, PPC_PsqLStackInline<0u, 0u>(ctx, r5_psq_tmp_1));
    // psq_load w=1 quant=0 (using PPC_PsqL)
    ...
    PpcSetPairedFprInline(f3, PPC_PsMaddInline(f0.d, f1.d, f4.d));
    ...
    MemoryInline::FlatWriteFloat32((r4 + 968), PPC_PsToScalarInline(f3.d));
    r4 = MemoryInline::FlatRead32((r29 + 16));
    f3.d = MemoryInline::FlatReadFloat32((r31 + 168));
    f4.d = MemoryInline::FlatReadFloat32((r4 + 968));
    f3.d = PpcFmulsInline(f4.d, f3.d);
    MemoryInline::FlatWriteFloat32((r4 + 968), f3.d);
    ...
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r3_psq_tmp_11 = (r3 + 32);
    PpcSetPairedFprInline(f4, PPC_PsqLStackInline<0u, 0u>(ctx, r3_psq_tmp_11));
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r4_psq_tmp_12 = (r4 + 32);
...
// RECOMP_REGISTRATION base 0x807D8004 func_807D8004 preserves=true fpr_mask=0x00000000
