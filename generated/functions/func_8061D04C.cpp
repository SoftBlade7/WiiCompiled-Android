...
extern "C" void func_8061D04C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8061D04C:
{
    ...
    r3 = 0x809C0000u;
    r5 = 0x80890000u;
    f1.d = MemoryInline::FlatReadFloat32((r5 + 31564));
    r4 = 5;
...
// RECOMP_REGISTRATION base 0x8061D04C func_8061D04C preserves=true fpr_mask=0x00000000
