...
extern "C" void func_80623DAC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80623DBC:
{
    ...
    ctx->gpr[3] = r3;
    ctx->cr = cr;
    InvokeDirectCpu<0x80627BD8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    cr = ctx->cr;
...
// RECOMP_REGISTRATION base 0x80623DAC func_80623DAC preserves=true fpr_mask=0x00000000
