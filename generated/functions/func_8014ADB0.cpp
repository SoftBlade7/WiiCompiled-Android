...
extern "C" void func_8014ADB0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8014ADB0:
{
    ...
    r7 = (r7 + -15212);
    r5 = MemoryInline::FlatRead16((r3 + 40));
    r3 = (r3 + 42);
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFFF07 gpr_write=0xFFFFFFFF gpr_return=0x00000018 fpr_read=0xFFFFFFFF fpr_write=0xFFFFFFFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x8014ADB0 func_8014ADB0 preserves=true fpr_mask=0x00000000
