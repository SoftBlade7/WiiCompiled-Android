...
extern "C" void func_806DBA98(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806DBB0C:
{
    ...
    ctx->fpr[3] = f3;
    ctx->cr = cr;
    InvokeDirectCpu<0x806DD128u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_806DBB18:
{
    r0 = MemoryInline::FlatRead8((r28 + 310));
...
loc_806DBB38:
{
    r27 = MemoryInline::FlatRead8((r29 + 108));
    goto loc_806DBB44;
}
...
loc_806DBB44:
{
    ...
    r10 = 0;
    r0 = 1;
    MemoryInline::FlatWrite8((r28 + 310), static_cast<uint8_t>(r0));
    r3 = (r28 + 48);
    r9 = MemoryInline::FlatRead8(r31);
    r4 = (r28 + 236);
    MemoryInline::FlatWriteFloat32((r28 + 300), f0.d);
    r5 = (r1 + 20);
    r8 = MemoryInline::FlatRead8((r7 + 1));
    MemoryInline::FlatWriteFloat32((r28 + 304), f0.d);
    r6 = MemoryInline::FlatRead8((r7 + 2));
    MemoryInline::FlatWrite16((r28 + 308), static_cast<uint16_t>(r10));
    r0 = MemoryInline::FlatRead8((r7 + 3));
    MemoryInline::FlatWrite32((r28 + 312), r10);
    ...
    // inline leaf 0x806B5A38 (1 guest instruction(s))
    // end of inlined leaf 0x806B5A38
...
loc_806DBBCC:
{
    r4 = 0x808C0000u;
    r3 = (r1 + 60);
    f1.d = MemoryInline::FlatReadFloat32((r4 + 23964));
    r4 = (r28 + 236);
...
loc_806DBC7C:
{
    ...
    MemoryInline::FlatWriteFloat32((r28 + 300), f0.d);
    MemoryInline::FlatWriteFloat32((r28 + 304), f0.d);
    MemoryInline::FlatWrite16((r28 + 308), static_cast<uint16_t>(r3));
    MemoryInline::FlatWrite8((r28 + 310), static_cast<uint8_t>(r0));
    MemoryInline::FlatWrite32((r28 + 312), r3);
    goto loc_806DC200;
}
...
loc_806DBD04:
{
    ...
    MemoryInline::FlatWriteRam8((r1 + 17), static_cast<uint8_t>(r8));
...
// RECOMP_REGISTRATION base 0x806DBA98 func_806DBA98 preserves=true fpr_mask=0x00000000
