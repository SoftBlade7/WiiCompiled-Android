...
extern "C" void func_805423BC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805423D8:
{
    ...
    r28 = (r26 + r3);
    r0 = (r0 * 28);
    r30 = MemoryInline::FlatRead32((r28 + 1456));
    r3 = (r26 + r0);
    r29 = (r3 + 8);
    r3 = r29;
    ctx->gpr[0] = r0;
...
loc_80542428:
{
    r0 = MemoryInline::FlatRead32((r28 + 1464));
}
...
loc_80542434:
{
    MemoryInline::FlatWrite32((r28 + 1456), r31);
    MemoryInline::FlatWrite32((r28 + 1460), r31);
    MemoryInline::FlatWrite32((r28 + 1464), r31);
}
...
loc_8054244C:
{
    r3 = MemoryInline::FlatRead32((r26 + 1552));
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWrite32((r26 + 1552), r0);
...
// RECOMP_REGISTRATION base 0x805423BC func_805423BC preserves=true fpr_mask=0x00000000
