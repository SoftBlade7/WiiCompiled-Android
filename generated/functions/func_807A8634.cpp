...
extern "C" void func_807A8634(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807A866C:
{
    r30 = MemoryInline::FlatRead32((r29 + 68));
...
// RECOMP_REGISTRATION base 0x807A8634 func_807A8634 preserves=true fpr_mask=0x00000000
