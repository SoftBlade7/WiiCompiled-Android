...
extern "C" void func_80092860(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80092860:
{
    ...
    r0 = ctx->lr;
    r5 = 0x80270000u;
    f1.d = MemoryInline::FlatReadFloat32((r2 + -28600));
    MemoryInline::WriteResolved32(guest_range_1, 52u, (r1 + 52), r0);
    r0 = 0;
    f3.d = MemoryInline::FlatReadFloat32((r2 + -28608));
    r5 = (r5 + 17208);
    MemoryInline::WriteResolved32(guest_range_1, 44u, (r1 + 44), r31);
    r31 = r3;
    f2.d = MemoryInline::FlatReadFloat32((r2 + -28604));
    r4 = (r1 + 8);
    f0.d = MemoryInline::FlatReadFloat32((r2 + -28596));
...
// RECOMP_REGISTRATION base 0x80092860 func_80092860 preserves=true fpr_mask=0x00000000
