...
extern "C" void func_80755FA0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80756084:
{
    ...
    cr = ctx->cr;
    r3 = 0x808D0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + -15164));
...
// RECOMP_REGISTRATION base 0x80755FA0 func_80755FA0 preserves=true fpr_mask=0x00000000
