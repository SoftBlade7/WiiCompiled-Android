...
extern "C" void func_806DEB40(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806DEB40:
{
    ...
    r3 = (r3 << 16);
    r3 = (static_cast<int32_t>(r3) >> 16);
    MemoryInline::FlatWrite8((r31 + 192), static_cast<uint8_t>(r3));
    r3 = (r3 & 255);
...
loc_806DECBC:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32(r27, r30);
}
...
// RECOMP_REGISTRATION base 0x806DEB40 func_806DEB40 preserves=true fpr_mask=0x00000000
