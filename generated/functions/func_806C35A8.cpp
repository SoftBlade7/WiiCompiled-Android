...
extern "C" void func_806C35A8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806C35A8:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r28 + 176), r3);
    r31 = (r31 + -2200);
    r3 = (r1 + 8);
    r4 = 1;
...
loc_806C3648:
{
    r7 = MemoryInline::FlatRead32((r28 + 176));
    r4 = (r1 + 16);
    r5 = (r1 + 8);
    r6 = 0;
    r7_addr_2 = (r7 + r30);
    MemoryInline::FlatWrite32(r7_addr_2, r3);
...
// RECOMP_REGISTRATION base 0x806C35A8 func_806C35A8 preserves=true fpr_mask=0x00000000
