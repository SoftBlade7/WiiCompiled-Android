...
extern "C" void func_805612EC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80561328:
{
    ...
    r5 = (r6 + 1);
    r0 = (r6 + 8);
    MemoryInline::FlatWrite32((r30 + 36), r5);
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x805603A8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x805612EC func_805612EC preserves=true fpr_mask=0x00000000
