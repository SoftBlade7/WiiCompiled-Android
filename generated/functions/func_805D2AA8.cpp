...
extern "C" void func_805D2AA8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_805D2AB8:
{
    MemoryInline::FlatWrite32((r16 + 464), r17);
    goto loc_805D2D1C;
}

loc_805D2AC0:
{
    r3 = MemoryInline::FlatRead16((r16 + 32));
    r0 = (r3 & 1);
}
...
loc_805D2AEC:
{
    r3 = MemoryInline::FlatRead32((r18 + 8464));
    r4 = r15;
    ctx->lr = 0x805D2AF8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_805D2B00:
{
    MemoryInline::FlatWrite32((r16 + 464), r19);
    goto loc_805D2D1C;
}

loc_805D2B08:
{
    r3 = MemoryInline::FlatRead32((r20 + 8408));
    ctx->lr = 0x805D2B10u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_805D2B18:
{
    MemoryInline::FlatWrite32((r16 + 464), r22);
    goto loc_805D2D1C;
}
...
loc_805D2D18:
{
    MemoryInline::FlatWrite32((r16 + 464), r30);
}
...
loc_805D2D1C:
{
    r15 = (r15 + 1);
    r31 = (r31 + 12);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r15), static_cast<int32_t>(30));
}
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFFFFF gpr_write=0xFFFFC03B gpr_return=0x00000018 fpr_read=0xFFFFFFFF fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0xFF cr_write=0x01 xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x805D2AA8 func_805D2AA8 preserves=true fpr_mask=0x00000000
