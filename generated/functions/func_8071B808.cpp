...
extern "C" void func_8071B808(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r4 = 0x809C0000u;
    MemoryInline::FlatWriteRam32((r4 + 10416), r3);
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x8071B808 func_8071B808 preserves=true fpr_mask=0x00000000
