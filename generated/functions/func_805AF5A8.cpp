...
extern "C" void func_805AF5A8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805AF684:
{
    MemoryInline::FlatWriteRam32((r3 + 32), r30);
    r4 = 1;
    MemoryInline::FlatWriteRam32((r3 + 48), r30);
    ctx->lr = 0x805AF694u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_805AF698:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x805AF774u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x805AF5A8 func_805AF5A8 preserves=true fpr_mask=0x00000000
