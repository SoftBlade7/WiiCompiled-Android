...
extern "C" void func_80668F4C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80668F4C:
{
    ...
    MemoryInline::FlatWrite32((r3 + 30072), r0);
...
// RECOMP_REGISTRATION base 0x80668F4C func_80668F4C preserves=true fpr_mask=0x00000000
