...
extern "C" void func_8076757C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807675B4:
{
    r4 = MemoryInline::FlatRead8((r31 + 108));
    goto loc_807675C0;
}
...
// RECOMP_REGISTRATION base 0x8076757C func_8076757C preserves=true fpr_mask=0x00000000
