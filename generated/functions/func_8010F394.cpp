...
extern "C" void func_8010F394(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8010F3F0:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead32((r30 + 1400));
    r0 = 0;
    r3 = 1;
    r4 = (r4 + r31);
    MemoryInline::FlatWrite32((r30 + 1400), r4);
    r4 = (r4 + r30);
...
// RECOMP_REGISTRATION base 0x8010F394 func_8010F394 preserves=true fpr_mask=0x00000000
