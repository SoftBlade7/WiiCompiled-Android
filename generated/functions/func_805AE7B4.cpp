...
extern "C" void func_805AE7B4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805AE7B4:
{
    ...
    MemoryInline::WriteResolvedFloat32(guest_range_0, 20u, (r30 + 20), f3.d);
    f3.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 8u, (r1 + 16));
    MemoryInline::WriteResolvedFloat32(guest_range_0, 36u, (r30 + 36), f3.d);
...
// RECOMP_REGISTRATION base 0x805AE7B4 func_805AE7B4 preserves=true fpr_mask=0x00000000
