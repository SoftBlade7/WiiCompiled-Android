...
extern "C" void func_80513D18(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80513D94:
{
    ...
    r27 = MemoryInline::FlatRead16((r29 + 4));
...
loc_80513DB4:
{
    MemoryInline::FlatWriteRam16((r3 + 4), static_cast<uint16_t>(r27));
    r3_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r27), static_cast<uint32_t>(2));
    r3 = (r3_rot_1 & 262140);
    ctx->lr = 0x80513DC0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80513DEC:
{
    ...
    r0 = (r26 + r0);
    MemoryInline::FlatWriteRam8((r3 + 20), static_cast<uint8_t>(r31));
...
// RECOMP_REGISTRATION base 0x80513D18 func_80513D18 preserves=true fpr_mask=0x00000000
