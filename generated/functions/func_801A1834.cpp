...
extern "C" void func_801A1834(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801A1834:
{
    ...
    r31 = r3;
    ctx->gpr[1] = r1;
    InvokeDirectCpu<0x801A1768u>(ctx);
    r3 = r31;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x801A1834 func_801A1834 preserves=true fpr_mask=0x00000000
