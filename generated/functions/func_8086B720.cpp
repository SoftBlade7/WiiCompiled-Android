...
extern "C" void func_8086B720(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8086B720:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r4 + 276));
    ...
    f2.d = MemoryInline::FlatReadFloat32((r6 + 8272));
    ...
    MemoryInline::WriteResolvedFloat32(guest_range_0, 16u, (r1 + 16), f4.d);
...
{
    r3 = 0x808B0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + 8272));
...
{
    r3 = 0x808B0000u;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 8272));
...
// RECOMP_REGISTRATION base 0x8086B720 func_8086B720 preserves=false fpr_mask=0xC0000000
