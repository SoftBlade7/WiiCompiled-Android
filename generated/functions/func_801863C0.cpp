...
extern "C" void func_801863C0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80186424:
{
    r0 = MemoryInline::FlatRead8((r28 + 207));
    r0 = (r0 & 1);
}
...
// RECOMP_REGISTRATION base 0x801863C0 func_801863C0 preserves=true fpr_mask=0x00000000
