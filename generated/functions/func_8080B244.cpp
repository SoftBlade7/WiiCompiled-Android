...
extern "C" void func_8080B244(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8080B284:
{
    ...
    MemoryInline::FlatWrite32((r4 + -8744), r3);
    f1.d = MemoryInline::FlatReadFloat32((r31 + 8));
    MemoryInline::FlatWrite32((r6 + -8748), r5);
    f4.d = MemoryInline::FlatReadFloat32((r3 + 56));
    f5.d = MemoryInline::FlatReadFloat32((r3 + 48));
    ...
    r0 = (r0_rot_1 & -4);
    r4 = (r4 + r0);
    MemoryInline::FlatWrite32((r4 + 180), r3);
...
// RECOMP_REGISTRATION base 0x8080B244 func_8080B244 preserves=true fpr_mask=0x00000000
