...
extern "C" void func_8051B0E0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8051B0E0:
{
    ...
    ctx->gpr[5] = r5;
    ctx->gpr[6] = r6;
    InvokeDirectCpu<0x8023B248u>(ctx);
    r3 = ctx->gpr[3];
    r5 = ctx->gpr[5];
    r6 = ctx->gpr[6];
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8051B0E0 func_8051B0E0 preserves=true fpr_mask=0x00000000
