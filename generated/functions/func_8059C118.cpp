...
extern "C" void func_8059C118(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8059C118:
{
    ...
    r29 = 0x80890000u;
    f1.d = MemoryInline::FlatReadFloat32((r29 + 8108));
    ctx->lr = 0x8059C1A0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    f0.d = MemoryInline::FlatReadFloat32((r29 + 8108));
    r3 = r31;
    ...
    ctx->fpr[0] = f0;
    ctx->fpr[1] = f1;
    InvokeDirectCpu<0x80591478u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r4 = 0x80890000u;
    f1.d = MemoryInline::FlatReadFloat32((r4 + 8104));
    r4 = 283;
    ...
    r3 = MemoryInline::FlatRead32((r3 + 20));
    r3 = (r3 + r0);
    // inline leaf 0x80798710 (6 guest instruction(s))
}
...
loc_inl6_cont_80798710:
{
    // end of inlined leaf 0x80798710
    f1.d = MemoryInline::FlatReadFloat32((r29 + 8108));
    r3 = r31;
    r4 = 40;
    r5 = 1;
    ...
    r30 = 0;
    MemoryInline::FlatWrite8((r3 + 369), static_cast<uint8_t>(r30));
    r3 = r31;
    // inline leaf 0x805903CC (5 guest instruction(s))
    r3 = MemoryInline::FlatRead32(r3);
    r3 = MemoryInline::FlatRead32((r3 + 8));
    ...
    r3 = MemoryInline::FlatRead32((r3 + 4));
    // end of inlined leaf 0x805903CC
    MemoryInline::FlatWrite8((r3 + 372), static_cast<uint8_t>(r30));
    r3 = r31;
    f31.d = MemoryInline::FlatReadFloat32((r29 + 8108));
    // inline leaf 0x8059077C (3 guest instruction(s))
    r3 = MemoryInline::FlatRead32(r3);
    r3 = MemoryInline::FlatRead32((r3 + 40));
    // end of inlined leaf 0x8059077C
    MemoryInline::FlatWriteFloat32((r3 + 384), f31.d);
    r3 = r31;
    // inline leaf 0x8059077C (3 guest instruction(s))
    r3 = MemoryInline::FlatRead32(r3);
    r3 = MemoryInline::FlatRead32((r3 + 40));
    // end of inlined leaf 0x8059077C
    MemoryInline::FlatWriteFloat32((r3 + 372), f31.d);
...
// RECOMP_REGISTRATION base 0x8059C118 func_8059C118 preserves=false fpr_mask=0x80000000
