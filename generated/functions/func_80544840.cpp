...
extern "C" void func_80544840(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80544840:
{
    ...
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x8054484Cu>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80544840 func_80544840 preserves=true fpr_mask=0x00000000
