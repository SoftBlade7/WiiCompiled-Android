...
extern "C" void func_801ED4EC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr1_0 = 0;
...
loc_801ED534:
{
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 100u, ((static_cast<uint64_t>(static_cast<uint32_t>(r12)) << 32) | static_cast<uint32_t>(r11)))) {
        MemoryInline::WriteResolved32(guest_range_1, 100u, (r1 + 108), r12);
        MemoryInline::WriteResolved32(guest_range_1, 104u, (r1 + 112), r11);
    }
...
// RECOMP_REGISTRATION base 0x801ED4EC func_801ED4EC preserves=true fpr_mask=0x00000000
