...
extern "C" void func_80781290(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80781304:
{
    ...
    MemoryInline::FlatWriteFloat32((r26 + 344), f0.d);
    goto loc_80781344;
}
...
loc_80781344:
{
    ...
    r7 = r27;
    r4 = MemoryInline::FlatRead32((r26 + 256));
    r6 = 0;
    r5 = MemoryInline::FlatRead32((r26 + 216));
    ctx->lr = 0x8078135Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r4 = MemoryInline::FlatRead32((r26 + 252));
    ctx->lr = 0x80781368u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80780AB8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r5 = (r1 + 8);
    r4 = 7;
    r3 = MemoryInline::FlatRead32((r26 + 260));
    r6 = 0;
...
// RECOMP_REGISTRATION base 0x80781290 func_80781290 preserves=true fpr_mask=0x00000000
