...
extern "C" void func_806E24FC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806E24FC:
{
    ...
    r4 = 0x808A0000u;
    r3 = r31;
    f1.d = MemoryInline::FlatReadFloat32((r4 + 1648));
...
// RECOMP_REGISTRATION base 0x806E24FC func_806E24FC preserves=true fpr_mask=0x00000000
