...
extern "C" void func_8011E038(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8011E0A8:
{
    MemoryInline::FlatWriteRam32((r3 + 2104), r29);
    r9 = 0x80120000u;
    r0 = 0;
    r4 = r22;
    MemoryInline::FlatWriteRam32((r3 + 2108), r30);
    r5 = r23;
    r6 = r24;
    r7 = r25;
    MemoryInline::FlatWriteRam32((r3 + 2092), r0);
    r8 = r28;
    r10 = r31;
    r9 = (r9 + -8956);
    r3 = (r3 + 76);
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8011EE1Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8011C834u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8011E038 func_8011E038 preserves=true fpr_mask=0x00000000
