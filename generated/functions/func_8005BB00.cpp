...
extern "C" void func_8005BB00(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8005BB4C:
{
    f1.d = MemoryInline::FlatReadFloat32((r2 + -29636));
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
...
// RECOMP_REGISTRATION base 0x8005BB00 func_8005BB00 preserves=true fpr_mask=0x00000000
