...
extern "C" void func_805EA7C4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805EA7C4:
{
    ...
    r3 = 0x809C0000u;
    r0 = (r7 + -29504);
    r8 = MemoryInline::FlatRead32((r3 + -10424));
    r0 = (r4 * r0);
...
// RECOMP_REGISTRATION base 0x805EA7C4 func_805EA7C4 preserves=true fpr_mask=0x00000000
