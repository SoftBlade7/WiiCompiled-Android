...
extern "C" void func_8008A050(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8008A0A4:
{
    MemoryInline::FlatWrite16((r4 + 150), static_cast<uint16_t>(r30));
...
// RECOMP_REGISTRATION base 0x8008A050 func_8008A050 preserves=true fpr_mask=0x00000000
