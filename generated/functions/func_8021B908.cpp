...
extern "C" void func_8021B908(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8021B908:
{
    ...
    MemoryInline::WriteResolved8(guest_range_0, 0u, (r28 + -32768), static_cast<uint8_t>(r19));
    MemoryInline::WriteResolved8(guest_range_0, 0u, (r28 + -32768), static_cast<uint8_t>(r24));
    MemoryInline::WriteResolved8(guest_range_0, 0u, (r28 + -32768), static_cast<uint8_t>(r19));
    MemoryInline::WriteResolved8(guest_range_0, 0u, (r28 + -32768), static_cast<uint8_t>(r25));
    MemoryInline::WriteResolved8(guest_range_0, 0u, (r28 + -32768), static_cast<uint8_t>(r19));
...
// RECOMP_REGISTRATION base 0x8021B908 func_8021B908 preserves=false fpr_mask=0xFE000000
