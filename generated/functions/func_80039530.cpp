...
extern "C" void func_80039530(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80039530:
{
    ...
    MemoryInline::WriteResolvedFloat64(guest_range_3, 192u, (r1 + 192), f15.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_16 = (r1 + 200);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_16, PPC_PsFromScalarInline(f15.d));
    MemoryInline::WriteResolvedFloat64(guest_range_3, 176u, (r1 + 176), f14.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_17 = (r1 + 184);
    ...
    f25.d = f2.d;
    f26.d = f3.d;
    MemoryInline::WriteResolved32(guest_range_3, 104u, (r1 + 104), r0);
    f27.d = f4.d;
    MemoryInline::WriteResolved32(guest_range_3, 112u, (r1 + 112), r0);
    f28.d = f5.d;
    guest_range_1 = MemoryInline::ResolveRangeHost((r2 + -30464), 0, 40u, true, false);
    f19.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 12u, (r2 + -30452));
    f29.d = f6.d;
    f20.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 8u, (r2 + -30456));
    f30.d = f7.d;
    f16.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 24u, (r2 + -30440));
    f31.d = f8.d;
    {
        const auto resolved_pair = MemoryInline::ReadResolvedPair32(guest_range_1, 0u);
        if (resolved_pair.valid) {
            f17.d = PpcBitCastToFloatInline(resolved_pair.first);
            f18.d = PpcBitCastToFloatInline(resolved_pair.second);
        } else {
            f17.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 0u, (r2 + -30464));
            f18.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 4u, (r2 + -30460));
        }
    }
    r20 = r3;
    f21.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 16u, (r2 + -30448));
    r21 = r4;
    f22.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 32u, (r2 + -30432));
    r22 = r5;
    f23.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 20u, (r2 + -30444));
    r23 = r6;
    r24 = r8;
    r25 = r9;
    r26 = r10;
...
loc_8003965C:
{
    ...
    f14.d = static_cast<double>(PpcForceSingleValueInline(f0.d / f18.d));
    f0.d = static_cast<double>(PpcForceSingleValueInline(f1.d - f16.d));
    f15.d = static_cast<double>(PpcForceSingleValueInline(f0.d / f17.d));
    if (((cr & 0x20000000u) != 0)) {
        goto loc_800396CC;
    }
}
...
loc_8003968C:
{
    f1.d = static_cast<double>(PpcForceSingleValueInline(f19.d - f15.d));
    f0.d = PpcFmulsInline(f14.d, f14.d);
    f0.d = PpcFmulsInline(f1.d, f0.d);
    f1.d = static_cast<double>(PpcForceSingleValueInline(f15.d + f0.d));
...
loc_800396B0:
{
    ...
    f2.d = static_cast<double>(PpcForceSingleValueInline(f19.d - f15.d));
    f0.d = PpcFmulsInline(f14.d, f14.d);
    f0.d = PpcFmulsInline(f2.d, f0.d);
    f0.d = static_cast<double>(PpcForceSingleValueInline(f15.d + f0.d));
...
loc_800396CC:
{
    f0.d = static_cast<double>(PpcForceSingleValueInline(f19.d - f15.d));
    f0.d = PpcFmulsInline(f14.d, f0.d);
    f15.d = static_cast<double>(PpcForceSingleValueInline(f15.d + f0.d));
}
...
loc_800396E0:
{
    ...
    f2.d = static_cast<double>(PpcForceSingleValueInline(f2.d - f16.d));
    f0.d = static_cast<double>(PpcForceSingleValueInline(f1.d - f0.d));
    f1.d = static_cast<double>(PpcForceSingleValueInline(f2.d / f17.d));
...
loc_80039734:
{
    ...
    f0.d = PpcFmulsInline(f2.d, f15.d);
    MemoryInline::FlatWriteRamFloat32((r1 + 64), f2.d);
    f1.d = (-(f1.d));
    MemoryInline::FlatWriteRamFloat32((r1 + 68), f20.d);
...
loc_80039760:
{
    ...
    f0.d = static_cast<double>(PpcForceSingleValueInline(f0.d / f17.d));
...
loc_8003979C:
{
    ...
    MemoryInline::FlatWriteRamFloat32((r1 + 56), f20.d);
...
loc_inl2_cont_80036F00:
{
    ...
    r6 = MemoryInline::FlatRead32((r1 + 88));
    r3 = (r1 + 40);
...
loc_inl3_cont_80036F00:
{
    ...
    f0.d = PpcFmulsInline(f0.d, f15.d);
    f1.d = static_cast<double>(PpcForceSingleValueInline(f19.d + f0.d));
    ctr = r12;
    ctx->lr = 0x800398D0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
{
    // psq_load w=0 quant=0 (using PPC_PsqL)
    guest_range_4 = MemoryInline::ResolveRangeHost((r1 + 176), 0, 296u, true, false);
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 272u, (r1 + 448));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f30.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 256u, (r1 + 432));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f29.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 240u, (r1 + 416));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f28.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 224u, (r1 + 400));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f27.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 208u, (r1 + 384));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f26.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 192u, (r1 + 368));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f25.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 176u, (r1 + 352));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f24.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 160u, (r1 + 336));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f23.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 144u, (r1 + 320));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f22.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 128u, (r1 + 304));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f21.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 112u, (r1 + 288));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f20.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 96u, (r1 + 272));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f19.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 80u, (r1 + 256));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f18.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 64u, (r1 + 240));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f17.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 48u, (r1 + 224));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f16.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 32u, (r1 + 208));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f15.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 16u, (r1 + 192));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r11 = (r1 + 176);
    f14.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 0u, (r1 + 176));
    ...
    r0 = MemoryInline::ReadResolved32(guest_range_4, 292u, (r1 + 468));
    ctx->lr = r0;
    r1 = (r1 + 464);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x80039530 func_80039530 preserves=false fpr_mask=0xFF00C000
