...
extern "C" void func_80638C64(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80638D8C:
{
    r31 = MemoryInline::FlatRead32((r28 + 564));
...
loc_80638DD4:
{
    ...
    r4 = r30;
    r5 = r29;
    r6 = MemoryInline::FlatRead32((r30 + 384));
...
// RECOMP_REGISTRATION base 0x80638C64 func_80638C64 preserves=true fpr_mask=0x00000000
