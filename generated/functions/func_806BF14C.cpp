...
extern "C" void func_806BF14C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r27 = (r28 + 1);
    r29_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r27), static_cast<uint32_t>(2));
    r29 = (r29_rot_0 & -4);
    goto loc_806BF244;
}
...
loc_806BF158:
{
    ...
    r30_addr_2 = (r30 + r5);
    r5 = MemoryInline::FlatRead32(r30_addr_2);
    r4 = (r4 + 48);
    r5 = (r5 + 48);
...
loc_806BF184:
{
    ...
    r5 = (r1 + 44);
    r30_addr_3 = (r30 + r0);
    r4 = MemoryInline::FlatRead32(r30_addr_3);
    r4 = (r4 + 48);
    // inline leaf 0x8051486C (13 guest instruction(s))
    f1.d = MemoryInline::FlatReadFloat32((r4 + 8));
    f0.d = MemoryInline::FlatReadFloat32((r5 + 8));
    ...
    r30_addr_4 = (r30 + r0);
    r3 = MemoryInline::FlatRead32(r30_addr_4);
...
loc_806BF280:
{
    ...
    r4_addr_5 = (r4 + r28);
    r5 = MemoryInline::FlatRead32(r4_addr_5);
    r4 = (r6 + 48);
    r5 = (r5 + 48);
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x806BF14C func_806BF14C preserves=false fpr_mask=0x80000000
