...
extern "C" void func_800EE22C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr6_0 = 0;
    uint32_t r0_ca_0 = 0;
    ...
    uint32_t r30_addr_14 = 0;
    uint32_t r30_addr_15 = 0;
...
loc_800EE22C:
{
    ...
    r22 = (r26 + 0);
    r23 = r4;
    r0 = MemoryInline::FlatRead32((r22 + 456));
    r27 = (r27 + -23576);
...
loc_800EE268:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r22 + 456));
    ctx->lr = 0x800EE280u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_800EE280:
{
    r28 = (r26 + 0);
    r5 = r21;
    MemoryInline::FlatWriteRam32((r28 + 456), r23);
    r4 = (r27 + 1312);
    r3 = 16777216;
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x800EE29Cu;
...
loc_800EE2CC:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r21), static_cast<int32_t>(14));
}
...
loc_800EE2D4:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x801D8DF0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800EE2EC:
{
    ...
    r3 = (r26 + 840);
    r0 = 1;
    MemoryInline::FlatWriteRam32(r26, r4);
...
loc_800EE318:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x801D93E4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(200));
}
...
loc_800EE32C:
{
    ...
    xer = ctx->xer;
    r0 = (-23000 - r21);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(-23000) >= static_cast<uint32_t>(r21) ? 1u : 0u) << 29);
    r3 = r23;
    MemoryInline::FlatWriteRam32(r26, r0);
    r4 = (r1 + 16);
    ctx->lr = 0x800EE354u;
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x801D937Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800EE3A8:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800134CCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800EE3FC:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x800CC974u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800EE470:
{
    ...
    xer = ctx->xer;
    r30_addr_3 = (r30 + r3);
    MemoryInline::FlatWrite8(r30_addr_3, static_cast<uint8_t>(r29));
    r21 = r3;
    r4 = r30;
    r3 = (r1 + 8);
    ctx->gpr[0] = r0;
...
loc_800EE4F8:
{
    ...
    xer = ctx->xer;
    r30_addr_4 = (r30 + r3);
    MemoryInline::FlatWrite8(r30_addr_4, static_cast<uint8_t>(r29));
    r21 = r3;
    r3 = r30;
    r4 = (r27 + 1508);
    r5 = (r1 + 44);
...
loc_800EE5B0:
{
    ...
    r4 = ctx->gpr[4];
    r4_subfc_sub_2 = r4;
    r4 = (r25 - r4_subfc_sub_2);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(r25) >= static_cast<uint32_t>(r4_subfc_sub_2) ? 1u : 0u) << 29);
    r5 = r21;
    r0_not_2 = ~(r3);
    r0_ca_2 = (xer >> 29) & 1u;
    r0 = (r0_not_2 + r22);
    r0 = (r0 + r0_ca_2);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r0_not_2)) + static_cast<uint64_t>(static_cast<uint32_t>(r22)) + (static_cast<uint64_t>(static_cast<uint32_t>(r0_ca_2)) & 1u);
        xer = (xer & 0xDFFFFFFFu) | (static_cast<uint32_t>((ppcCarryWide >> 32) & 1u) << 29);
    }
    MemoryInline::FlatWriteRam32((r28 + 452), r4);
    r4 = (r27 + 1564);
    r6 = (r1 + 64);
    MemoryInline::FlatWriteRam32((r28 + 448), r0);
    r3 = 16777216;
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x800EE5DCu;
    ctx->gpr[0] = r0;
...
loc_800EE600:
{
    ...
    xer = ctx->xer;
    r30_addr_5 = (r30 + r3);
    MemoryInline::FlatWrite8(r30_addr_5, static_cast<uint8_t>(r29));
    r22 = r3;
    r4 = r30;
    r3 = (r28 + 379);
    ctx->gpr[0] = r0;
...
loc_800EE684:
{
    ...
    xer = ctx->xer;
    r30_addr_6 = (r30 + r3);
    MemoryInline::FlatWrite8(r30_addr_6, static_cast<uint8_t>(r29));
    r22 = r3;
    r4 = r30;
    r3 = (r28 + 4);
    ctx->gpr[0] = r0;
...
loc_800EE708:
{
    ...
    xer = ctx->xer;
    r30_addr_7 = (r30 + r3);
    MemoryInline::FlatWrite8(r30_addr_7, static_cast<uint8_t>(r29));
    r22 = r3;
    r4 = r30;
    r3 = (r28 + 305);
    ctx->gpr[0] = r0;
...
loc_800EE78C:
{
    ...
    xer = ctx->xer;
    r30_addr_8 = (r30 + r3);
    MemoryInline::FlatWrite8(r30_addr_8, static_cast<uint8_t>(r29));
    r22 = r3;
    r3 = r30;
    r5 = (r28 + 432);
    r4 = (r13 + -31616);
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r7 = MemoryInline::FlatRead32((r28 + 432));
    r5 = r22;
    r8 = MemoryInline::FlatRead32((r28 + 436));
    r4 = (r27 + 1664);
    r3 = 16777216;
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x800EE7F8u;
...
loc_800EE81C:
{
    ...
    xer = ctx->xer;
    r30_addr_9 = (r30 + r3);
    MemoryInline::FlatWrite8(r30_addr_9, static_cast<uint8_t>(r29));
    r22 = r3;
    r4 = r30;
    r3 = (r31 + 4);
    ctx->gpr[0] = r0;
...
loc_800EE8A0:
{
    ...
    xer = ctx->xer;
    r30_addr_10 = (r30 + r3);
    MemoryInline::FlatWrite8(r30_addr_10, static_cast<uint8_t>(r29));
    r22 = r3;
    r4 = r30;
    r3 = (r31 + 69);
    ctx->gpr[0] = r0;
...
loc_800EE924:
{
    ...
    xer = ctx->xer;
    r30_addr_11 = (r30 + r3);
    MemoryInline::FlatWrite8(r30_addr_11, static_cast<uint8_t>(r29));
    r5 = r3;
    r6 = r30;
    r4 = (r27 + 1768);
    ...
    MemoryInline::FlatWriteRam32((r26 + 464), r0);
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x800EE98Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_800EE9B0:
{
    ...
    xer = ctx->xer;
    r30_addr_12 = (r30 + r3);
    MemoryInline::FlatWrite8(r30_addr_12, static_cast<uint8_t>(r29));
    r4 = r30;
    r3 = (r26 + 840);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_800EEA2C:
{
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80015350u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800EEA48:
{
    ...
    r0 = MemoryInline::FlatRead32((r4 + 23012));
...
loc_800EEAB4:
{
    SetCRResident(cr, xer, 6, static_cast<int32_t>(r3), static_cast<int32_t>(100));
}
...
loc_800EEAE8:
{
    ...
    xer = ctx->xer;
    r0 = (-20000 - r21);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(-20000) >= static_cast<uint32_t>(r21) ? 1u : 0u) << 29);
    MemoryInline::FlatWriteRam32(r26, r0);
    goto loc_800EEB54;
}
...
loc_800EEB08:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r21), static_cast<int32_t>(40));
}
...
// RECOMP_REGISTRATION base 0x800EE22C func_800EE22C preserves=true fpr_mask=0x00000000
