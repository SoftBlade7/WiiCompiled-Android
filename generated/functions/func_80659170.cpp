...
extern "C" void func_80659170(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806591F4:
{
    ...
    r3 = (r31 + 128);
    r4 = 126;
    r7 = MemoryInline::FlatRead32((r5 + 132));
    r5 = (r6 + 6);
    r6 = (r6 + 12);
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x80659220u;
...
loc_806592D0:
{
    r4 = (r3 + 65536);
    r3 = (r31 + 256);
    r29 = MemoryInline::FlatRead16((r4 + -28648));
    r4 = 0;
    r5 = 127;
    ctx->lr = 0x806592E8u;
    ctx->gpr[0] = r0;
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r28 = MemoryInline::FlatRead32((r31 + 384));
    r4 = r29;
    r5 = 0;
    r3 = (r28 + 10548);
    ctx->gpr[0] = r0;
    ...
    r0 = (r0_rot_0 & -4);
    r3 = (r28 + r0);
    r0 = MemoryInline::FlatRead16((r3 + 10550));
    r0 = (r29 - r0);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(1));
}
...
loc_80659318:
{
    r27 = MemoryInline::FlatRead32((r31 + 384));
    r4 = r29;
    r28 = (r0 & 65535);
    r5 = 0;
    r3 = (r27 + 10548);
    ...
    r0 = (r0_rot_1 & -4);
    r3 = (r27 + r0);
    r0 = MemoryInline::FlatRead16((r3 + 10548));
    r0 = (r29 + r0);
...
loc_806593B0:
{
    r4 = (r3 + 65536);
    r3 = (r31 + 256);
    r29 = MemoryInline::FlatRead16((r4 + -28640));
    r4 = 0;
    r5 = 127;
    ctx->lr = 0x806593C8u;
    ctx->gpr[0] = r0;
    ...
    r0 = (r0_rot_3 & -4);
    r3 = (r27 + r0);
    r0 = MemoryInline::FlatRead16((r3 + 10570));
    r0 = (r29 - r0);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(1));
}
...
loc_806593F8:
{
    ...
    r0 = (r0_rot_4 & -4);
    r3 = (r27 + r0);
    r0 = MemoryInline::FlatRead16((r3 + 10568));
    r0 = (r29 + r0);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r0), static_cast<uint32_t>(9999));
}
...
loc_806594CC:
{
    ...
    r3 = (r31 + 0);
    r10 = MemoryInline::FlatRead32((r30 + 10080));
    r5 = (r29 + 86);
    r6 = (r29 + 115);
    r7 = (r31 + 128);
    r8 = (r31 + 256);
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800D45F4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800D4258u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r11 = 0x80660000u;
    r5 = 0x80660000u;
    r3 = MemoryInline::FlatRead32((r30 + 10524));
    r11 = (r11 + -30872);
    r0 = (r1 + 24);
    r6 = r30;
    r7 = (r3 * 88);
    ...
    r8 = (r30 + r7);
    r10 = 0;
    r9 = MemoryInline::FlatRead8((r8 + 88));
    r7 = 0;
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800D1840u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80659170 func_80659170 preserves=true fpr_mask=0x00000000
