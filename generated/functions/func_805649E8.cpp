...
extern "C" void func_805649E8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805649F8:
{
    ...
    r3 = 2;
    MemoryInline::FlatWriteRam32((r4 + 19452), r0);
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->cr = cr;
...
// RECOMP_REGISTRATION base 0x805649E8 func_805649E8 preserves=true fpr_mask=0x00000000
