...
extern "C" void func_801ABD64(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801ABD64:
{
    ...
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    InvokeDirectCpu<0x801ABD70u>(ctx);
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
// RECOMP_REGISTRATION base 0x801ABD64 func_801ABD64 preserves=true fpr_mask=0x00000000
