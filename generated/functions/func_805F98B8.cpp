...
extern "C" void func_805F98B8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r5 = 0x80890000u;
    f0.d = MemoryInline::FlatReadFloat32((r5 + 25132));
...
{
    r5 = 0x80890000u;
    f0.d = MemoryInline::FlatReadFloat32((r5 + 25128));
...
// RECOMP_REGISTRATION base 0x805F98B8 func_805F98B8 preserves=true fpr_mask=0x00000000
