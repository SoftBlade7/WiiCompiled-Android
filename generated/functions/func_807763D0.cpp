...
extern "C" void func_807763D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_807763D0:
{
    ...
    r5 = 0x808A0000u;
    r4 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r5 + 16920));
    MemoryInline::FlatWriteRam32((r1 + 12), r31);
    r31 = r3;
    f0.d = MemoryInline::FlatReadFloat32((r4 + 16924));
...
// RECOMP_REGISTRATION base 0x807763D0 func_807763D0 preserves=false fpr_mask=0x80000000
