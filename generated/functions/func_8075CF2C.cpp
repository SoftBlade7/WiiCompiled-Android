...
extern "C" void func_8075CF2C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8075CF2C:
{
    ...
    r3 = r30;
    MemoryInline::FlatWrite32((r30 + 180), r31);
    r4 = 0;
    ...
    MemoryInline::FlatWrite8((r30 + 276), static_cast<uint8_t>(r31));
    MemoryInline::FlatWrite8((r30 + 277), static_cast<uint8_t>(r31));
    MemoryInline::FlatWrite8((r30 + 284), static_cast<uint8_t>(r31));
    ctx->lr = 0x8075CFC4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r3 = 0x809C0000u;
    r4 = 0;
    r0 = MemoryInline::FlatRead32((r3 + 11536));
    r3 = r30;
    MemoryInline::FlatWrite32((r30 + 272), r0);
    MemoryInline::FlatWrite32((r30 + 372), r31);
    MemoryInline::FlatWrite8((r30 + 376), static_cast<uint8_t>(r31));
    MemoryInline::FlatWrite8((r30 + 384), static_cast<uint8_t>(r31));
...
// RECOMP_REGISTRATION base 0x8075CF2C func_8075CF2C preserves=true fpr_mask=0x00000000
