...
extern "C" void func_8062B4F4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8062B4F4:
{
    ...
    MemoryInline::FlatWrite32((r19 + 600), r30);
    MemoryInline::FlatWriteFloat32((r19 + 604), f0.d);
    MemoryInline::FlatWrite32((r28 + 784), r30);
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_17B6 = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_17B6[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_17B6[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    r11 = MemoryInline::FlatRead32((r29 + 3124));
    ...
    r8 = MemoryInline::FlatRead32((r29 + 3136));
    ...
    r25 = 0x808C0000u;
    r30 = 0x808C0000u;
    guest_range_4 = MemoryInline::ResolveRangeHost((r29 + 3148), 0, 60u, true, false);
    r9 = MemoryInline::ReadResolved32(guest_range_4, 0u, (r29 + 3148));
    r4 = 0x80630000u;
    ...
    MemoryInline::WriteResolved32(guest_range_1, 16u, (r28 + 1636), r8);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r19 = MemoryInline::ReadResolved32(guest_range_4, 12u, (r29 + 3160));
        }
    }
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r22 = MemoryInline::ReadResolved32(guest_range_4, 24u, (r29 + 3172));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r25 = MemoryInline::ReadResolved32(guest_range_4, 36u, (r29 + 3184));
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 64u, ((static_cast<uint64_t>(static_cast<uint32_t>(r30)) << 32) | static_cast<uint32_t>(r28)))) {
        MemoryInline::WriteResolved32(guest_range_1, 64u, (r28 + 1684), r30);
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r12 = MemoryInline::ReadResolved32(guest_range_4, 48u, (r29 + 3196));
        }
    }
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 84u, ((static_cast<uint64_t>(static_cast<uint32_t>(r30)) << 32) | static_cast<uint32_t>(r28)))) {
        MemoryInline::WriteResolved32(guest_range_1, 84u, (r28 + 1704), r30);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 100u, ((static_cast<uint64_t>(static_cast<uint32_t>(r10)) << 32) | static_cast<uint32_t>(r31)))) {
...
// RECOMP_REGISTRATION base 0x8062B4F4 func_8062B4F4 preserves=true fpr_mask=0x00000000
