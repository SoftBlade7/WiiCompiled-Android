...
extern "C" void func_8076E210(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8076E240:
{
    ...
    r0 = MemoryInline::FlatRead32((r4 + 2944));
...
loc_8076E27C:
{
    ...
    MemoryInline::FlatWrite8((r31 + 188), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x8076E210 func_8076E210 preserves=true fpr_mask=0x00000000
