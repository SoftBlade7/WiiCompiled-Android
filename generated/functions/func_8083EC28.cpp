...
extern "C" void func_8083EC28(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8083EC28:
{
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 104u, ((static_cast<uint64_t>(static_cast<uint32_t>(r22)) << 32) | static_cast<uint32_t>(r23)))) {
        MemoryInline::WriteResolved32(guest_range_0, 104u, (r1 + 104), r22);
        MemoryInline::WriteResolved32(guest_range_0, 108u, (r1 + 108), r23);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 112u, ((static_cast<uint64_t>(static_cast<uint32_t>(r24)) << 32) | static_cast<uint32_t>(r25)))) {
...
loc_8083EC80:
{
    ...
    r25 = (r25 + 4);
    r22_addr_2 = (r22 + r4);
    r3 = MemoryInline::FlatRead32(r22_addr_2);
    r28 = (r28 + 1);
    r0 = (r3 + 1);
    r22_addr_3 = (r22 + r4);
    MemoryInline::FlatWrite32(r22_addr_3, r0);
}
...
loc_8083ED1C:
{
    r29_rot_3 = PpcRotl32Inline(static_cast<uint32_t>(r22), static_cast<uint32_t>(2));
    r29 = (r29_rot_3 & -4);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    cr = ctx->cr;
    r4 = (r3 & 255);
    r3 = (static_cast<int32_t>((static_cast<int64_t>(static_cast<int32_t>(r30)) * static_cast<int64_t>(static_cast<int32_t>(r4))) >> 32));
    ...
    r3 = (r3 + r22);
    r4 = (static_cast<int32_t>((static_cast<int64_t>(static_cast<int32_t>(r30)) * static_cast<int64_t>(static_cast<int32_t>(r3))) >> 32));
...
loc_8083ED64:
{
    ...
    r3 = MemoryInline::FlatRead32(r28);
    r4_rot_5 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(27));
    r4 = (r4_rot_5 & 134217727);
    r5 = 0;
    goto loc_8083ED94;
}
...
loc_8083EDB0:
{
    ...
    r27_addr_5 = (r27 + r29);
    MemoryInline::FlatWrite32(r27_addr_5, r0);
    r3 = (r5 + r4);
...
loc_8083EDFC:
{
    ...
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 104), 0, 48u, true, false);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r22 = MemoryInline::ReadResolved32(guest_range_1, 0u, (r1 + 104));
            r23 = MemoryInline::ReadResolved32(guest_range_1, 4u, (r1 + 108));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r24 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r1 + 112));
            r25 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r1 + 116));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r27 = MemoryInline::ReadResolved32(guest_range_1, 20u, (r1 + 124));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r28 = MemoryInline::ReadResolved32(guest_range_1, 24u, (r1 + 128));
            r29 = MemoryInline::ReadResolved32(guest_range_1, 28u, (r1 + 132));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r30 = MemoryInline::ReadResolved32(guest_range_1, 32u, (r1 + 136));
            r31 = MemoryInline::ReadResolved32(guest_range_1, 36u, (r1 + 140));
        }
    }
...
// RECOMP_REGISTRATION base 0x8083EC28 func_8083EC28 preserves=true fpr_mask=0x00000000
