...
extern "C" void func_80085B40_statefree(uint32_t, uint32_t, uint32_t, uint32_t);

extern "C" void func_80061FB0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80061FF0:
{
    ...
    r3 = r30;
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x80085B40u) && KnownTranslatedCpuCall<0x80085B40u>::kAvailable && !KnownTranslatedCpuCall<0x80085B40u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80085B40u>()) {
        func_80085B40_statefree(r2, r3, 0x80062000u, ctx->gqr[0]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
        ...
        ctx->fpr[2] = f2;
        ctx->cr = cr;
        InvokeDirectCpu<0x80085B40u>(ctx);
        r0 = ctx->gpr[0];
        r1 = ctx->gpr[1];
        r2 = ctx->gpr[2];
        r3 = ctx->gpr[3];
...
// RECOMP_GUEST_ABI gpr_read=0xFC00000E gpr_write=0xFC00080B gpr_return=0x00000008 fpr_read=0x00000000 fpr_write=0x00000007 fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80061FB0 func_80061FB0 preserves=true fpr_mask=0x00000000
