...
extern "C" void func_8009ACA0(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = (r13 + -27208);
    MemoryInline::FlatWrite32((r13 + -27152), r0);
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x8009ACA0 func_8009ACA0 preserves=true fpr_mask=0x00000000
