...
extern "C" void func_80771BF4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80771C64:
{
    r0 = MemoryInline::FlatRead8((r3 + 292));
...
loc_80771DAC:
{
    r0 = MemoryInline::FlatRead8((r30 + 292));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
// RECOMP_REGISTRATION base 0x80771BF4 func_80771BF4 preserves=true fpr_mask=0x00000000
