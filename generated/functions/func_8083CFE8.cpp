...
extern "C" void func_8083CFE8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r30 = 0x809C0000u;
    r28 = MemoryInline::FlatRead32((r5 + 576));
    r3 = MemoryInline::FlatRead32((r30 + 7736));
    r3 = MemoryInline::FlatRead32((r3 + 152));
    MemoryInline::FlatWrite32((r3 + 336), r28);
    r3 = MemoryInline::FlatRead32((r30 + 7736));
    ...
    if (MkwStateFreeAbiEnabled(0x80860484u) && KnownTranslatedCpuCall<0x80860484u>::kAvailable && !KnownTranslatedCpuCall<0x80860484u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x80860484u>()) {
        const auto state_free_result_80860484_8AC = func_80860484_statefree_v0(r3, xer);
        r0 = static_cast<uint32_t>(state_free_result_80860484_8AC[0]);
        r3 = static_cast<uint32_t>(state_free_result_80860484_8AC[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_8083D0D4:
{
    ...
    r5 = r27;
    r4 = 27;
    MemoryInline::FlatWrite32((r6 + 5976), r28);
    ctx->lr = 0x8083D0F0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x805E38FCu>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
...
{
    r0 = 1;
    MemoryInline::FlatWrite8((r31 + 6784), static_cast<uint8_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x8083CFE8 func_8083CFE8 preserves=true fpr_mask=0x00000000
