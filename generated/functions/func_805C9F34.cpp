...
extern "C" void func_805C9F34(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805C9F78:
{
    ...
    r3 = (r0 + r26);
    r28_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(27));
...
loc_805C9FC4:
{
    r3 = MemoryInline::FlatRead32((r30 + 476));
    r0 = (r3 + 1);
...
// RECOMP_REGISTRATION base 0x805C9F34 func_805C9F34 preserves=true fpr_mask=0x00000000
