...
extern "C" void func_807B62B8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807B62B8:
{
    ...
    r31 = 0x808A0000u;
    f0.d = MemoryInline::FlatReadFloat32((r31 + 24856));
...
loc_807B62EC:
{
    f31.d = MemoryInline::FlatReadFloat32((r3 + 424));
    r3 = (r3 + 420);
    r4 = r5;
    r5 = (r1 + 32);
    r6 = r3;
    ...
    f3 = ctx->fpr[3];
    f4 = ctx->fpr[4];
    r0 = MemoryInline::FlatRead8((r30 + 462));
...
loc_807B6310:
{
    ...
    r30_psq_tmp_4 = (r30 + 428);
    PPC_PsqStGqrInline<1u, 0u>(ctx, mkw_gqr0, r30_psq_tmp_4, f2.d);
    ctx->lr = 0x807B6344u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
{
    r3 = 0x808A0000u;
    f2.d = MemoryInline::FlatReadFloat32((r30 + 424));
...
loc_807B6364:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r3 + 24900));
...
loc_807B637C:
{
    ...
    r3 = (r30 + 420);
    r0 = MemoryInline::FlatRead32((r30 + 424));
    r4 = (r1 + 44);
    MemoryInline::FlatWriteRam32((r1 + 48), r0);
    MemoryInline::FlatWriteRam32((r1 + 44), r5);
    r0 = MemoryInline::FlatRead32((r30 + 428));
    ...
    f2.d = MemoryInline::FlatReadFloat32((r30 + 420));
    f1.d = MemoryInline::FlatReadFloat32((r30 + 424));
    f0.d = MemoryInline::FlatReadFloat32((r30 + 428));
    MemoryInline::FlatWriteFloat32((r30 + 432), f2.d);
    MemoryInline::FlatWriteFloat32((r30 + 436), f1.d);
    MemoryInline::FlatWriteFloat32((r30 + 440), f0.d);
    goto loc_807B64BC;
}
...
loc_807B6404:
{
    r5 = (r1 + 8);
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r30_psq_tmp_6 = (r30 + 420);
    PpcSetPairedFprInline(f0, PPC_PsqLGqrInline<0u, 0u>(ctx, mkw_gqr0, r30_psq_tmp_6));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    PpcSetPairedFprInline(f2, PPC_PsqLStackInline<0u, 0u>(ctx, r5));
    r3 = r30;
    f1.d = MemoryInline::FlatReadFloat32((r31 + 24856));
    ...
    PpcSetPairedFprInline(f2, PPC_PsSubInline(f0.d, f2.d));
    // psq_load w=1 quant=0 (using PPC_PsqL)
    r30_psq_tmp_7 = (r30 + 428);
    PpcSetPairedFprInline(f0, PPC_PsqLGqrInline<1u, 0u>(ctx, mkw_gqr0, r30_psq_tmp_7));
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r30_psq_tmp_8 = (r30 + 420);
    PPC_PsqStGqrInline<0u, 0u>(ctx, mkw_gqr0, r30_psq_tmp_8, f2.d);
    // psq_load w=1 quant=0 (using PPC_PsqL)
    r5_psq_tmp_4 = (r5 + 8);
    PpcSetPairedFprInline(f2, PPC_PsqLStackInline<1u, 0u>(ctx, r5_psq_tmp_4));
    PpcSetPairedFprInline(f2, PPC_PsSubInline(f0.d, f2.d));
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r30_psq_tmp_9 = (r30 + 428);
    PPC_PsqStGqrInline<1u, 0u>(ctx, mkw_gqr0, r30_psq_tmp_9, f2.d);
    ctx->lr = 0x807B6438u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_807B6470:
{
    ...
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r5_psq_tmp_6 = (r5 + 4);
    PPC_PsqStGqrInline<0u, 0u>(ctx, mkw_gqr0, r5_psq_tmp_6, f10.d);
    // end of inlined leaf 0x8019ACCC
    f2.d = MemoryInline::FlatReadFloat32((r30 + 420));
    f1.d = MemoryInline::FlatReadFloat32((r30 + 424));
    f0.d = MemoryInline::FlatReadFloat32((r30 + 428));
...
loc_807B64BC:
{
    ...
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r30_psq_tmp_12 = (r30 + 432);
    PpcSetPairedFprInline(f2, PPC_PsqLGqrInline<0u, 0u>(ctx, mkw_gqr0, r30_psq_tmp_12));
    PpcSetPairedFprInline(f1, PPC_PsMuls0Inline(f2.d, PPC_PsFromScalarInline(f0.d)));
    // psq_load w=1 quant=0 (using PPC_PsqL)
    r30_psq_tmp_13 = (r30 + 440);
    PpcSetPairedFprInline(f2, PPC_PsqLGqrInline<1u, 0u>(ctx, mkw_gqr0, r30_psq_tmp_13));
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r30_psq_tmp_14 = (r30 + 80);
    PPC_PsqStGqrInline<0u, 0u>(ctx, mkw_gqr0, r30_psq_tmp_14, f1.d);
    PpcSetPairedFprInline(f1, PPC_PsMuls0Inline(f2.d, PPC_PsFromScalarInline(f0.d)));
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r30_psq_tmp_15 = (r30 + 88);
    PPC_PsqStGqrInline<1u, 0u>(ctx, mkw_gqr0, r30_psq_tmp_15, f1.d);
    // psq_load w=0 quant=0 (using PPC_PsqL)
...
// RECOMP_REGISTRATION base 0x807B62B8 func_807B62B8 preserves=false fpr_mask=0x80000000
