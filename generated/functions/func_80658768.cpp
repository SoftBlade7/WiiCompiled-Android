...
extern "C" void func_80658768(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806587C0:
{
    ...
    r29 = (r29 + r29_ca_0);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r4)) + static_cast<uint64_t>(static_cast<uint32_t>(r3)) + (static_cast<uint64_t>(static_cast<uint32_t>(r29_ca_0)) & 1u);
...
// RECOMP_REGISTRATION base 0x80658768 func_80658768 preserves=true fpr_mask=0x00000000
