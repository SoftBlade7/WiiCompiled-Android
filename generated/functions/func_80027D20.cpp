...
extern "C" void func_80027D20(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80027D60:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80027EC0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80027D98:
{
    ...
    r0 = (r0_rot_2 & 262140);
    r30_addr_2 = (r30 + r0);
    r28 = MemoryInline::FlatRead32(r30_addr_2);
...
// RECOMP_REGISTRATION base 0x80027D20 func_80027D20 preserves=true fpr_mask=0x00000000
