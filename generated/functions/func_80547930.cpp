...
extern "C" void func_80547930(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_80547930:
{
    ...
    r3 = (r3 + r4);
    r3 = (r3 + r0);
    MemoryInline::FlatWrite16((r3 + 244), static_cast<uint16_t>(r5));
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->gpr[7] = r7;
...
// RECOMP_REGISTRATION base 0x80547930 func_80547930 preserves=true fpr_mask=0x00000000
