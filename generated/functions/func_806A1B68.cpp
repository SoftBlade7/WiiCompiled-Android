...
extern "C" void func_806A1B68(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806A1B68:
{
    ...
    r30 = (r7 * 12);
    r27 = r3;
    f1.d = MemoryInline::FlatReadFloat32((r3 + 2428));
    r31 = r4;
    r28 = r5;
    r4 = (r27 + r30);
    r29 = r6;
...
loc_806A1C68:
{
    r0 = MemoryInline::FlatRead8((r27 + 73));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
// RECOMP_REGISTRATION base 0x806A1B68 func_806A1B68 preserves=true fpr_mask=0x00000000
