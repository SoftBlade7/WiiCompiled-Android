...
extern "C" void func_8068B15C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8068B5E0:
{
    MemoryInline::FlatWriteFloat32((r22 + 72), f31.d);
    r0 = 1;
    goto loc_8068B5F0;
}
...
loc_8068B6A4:
{
    MemoryInline::FlatWriteFloat32((r22 + 76), f31.d);
    r0 = 1;
    goto loc_8068B6B4;
}
...
// RECOMP_REGISTRATION base 0x8068B15C func_8068B15C preserves=false fpr_mask=0xF8000000
