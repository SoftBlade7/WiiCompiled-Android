...
extern "C" void func_8072BD1C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8072BDB8:
{
    ...
    r3 = (static_cast<int32_t>(r3) >> 16);
    MemoryInline::FlatWrite32(r4, r3);
    r3 = MemoryInline::FlatRead16((r30 + 66));
    r3 = (r3 << 16);
    r3 = (static_cast<int32_t>(r3) >> 16);
    MemoryInline::FlatWrite32((r4 + 4), r3);
    MemoryInline::FlatWrite32((r4 + 8), r0);
...
loc_8072BDE8:
{
    ...
    r3 = (static_cast<int32_t>(r3) >> 16);
    MemoryInline::FlatWrite32((r4 + 4), r3);
    r3 = MemoryInline::FlatRead16((r30 + 82));
    r3 = (r3 << 16);
    r3 = (static_cast<int32_t>(r3) >> 16);
    MemoryInline::FlatWrite32((r4 + 8), r3);
    MemoryInline::FlatWrite32((r4 + 12), r0);
...
// RECOMP_REGISTRATION base 0x8072BD1C func_8072BD1C preserves=true fpr_mask=0x00000000
