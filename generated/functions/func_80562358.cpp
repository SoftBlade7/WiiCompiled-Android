...
extern "C" void func_80562358(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80562378:
{
    r4 = MemoryInline::FlatRead32((r24 + 16));
    ...
    xer = ctx->xer;
    r31 = 0x808B0000u;
    MemoryInline::FlatWrite32((r24 + 128), r3);
    r31 = (r31 + 19224);
    r27 = 0;
    r30 = 0;
    goto loc_80562424;
...
loc_805623B8:
{
    r4 = MemoryInline::FlatRead32((r24 + 128));
    r25 = 0;
    r4_addr_2 = (r4 + r30);
...
loc_805623CC:
{
    ...
    r29_rot_3 = PpcRotl32Inline(static_cast<uint32_t>(r25), static_cast<uint32_t>(2));
    r29 = (r29_rot_3 & 1020);
    r3 = r24;
    r4 = (r25 & 255);
...
loc_80562424:
{
    r0 = MemoryInline::FlatRead32((r24 + 84));
...
// RECOMP_REGISTRATION base 0x80562358 func_80562358 preserves=true fpr_mask=0x00000000
