...
extern "C" void func_80032490(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80032490:
{
    ...
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    InvokeDirectCpu<0x800334B0u>(ctx);
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
// RECOMP_REGISTRATION base 0x80032490 func_80032490 preserves=true fpr_mask=0x00000000
