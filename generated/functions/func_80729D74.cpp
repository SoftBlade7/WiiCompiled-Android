...
extern "C" void func_80729D74(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80729D74:
{
    ...
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x807B22F8u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80729D74 func_80729D74 preserves=true fpr_mask=0x00000000
