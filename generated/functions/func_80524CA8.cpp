...
extern "C" void func_80524CA8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80524CD0:
{
    r29 = MemoryInline::FlatRead32((r28 + 4));
...
{
    r0 = 2;
    MemoryInline::FlatWrite32((r26 + 20), r0);
...
// RECOMP_GUEST_ABI gpr_read=0xFC0000FA gpr_write=0xFC0000FB gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x80524CA8 func_80524CA8 preserves=true fpr_mask=0x00000000
