...
extern "C" void func_807312D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80731468:
{
    ...
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 92), 0, 76u, true, false);
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 52u, (r1 + 144));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f30.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 36u, (r1 + 128));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r11 = (r1 + 112);
    f29.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 20u, (r1 + 112));
    ...
    r0 = MemoryInline::ReadResolved32(guest_range_1, 72u, (r1 + 164));
    ctx->lr = r0;
    r1 = (r1 + 160);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_GUEST_ABI gpr_read=0xF800007E gpr_write=0xF800083B gpr_return=0x00000018 fpr_read=0xE0000003 fpr_write=0xE00000FF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x807312D0 func_807312D0 preserves=false fpr_mask=0xE0000000
