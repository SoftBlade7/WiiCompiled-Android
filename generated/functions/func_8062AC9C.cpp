...
extern "C" void func_8062AC9C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8062AC9C:
{
    ...
    MemoryInline::FlatWrite32((r20 + 600), r31);
    MemoryInline::FlatWriteFloat32((r20 + 604), f0.d);
    MemoryInline::FlatWrite32((r28 + 784), r31);
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_1758 = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_1758[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_1758[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    r7 = (r7 + -11484);
    r4 = 0x808E0000u;
    MemoryInline::WriteResolved8(guest_range_2, 988u, (r28 + 988), static_cast<uint8_t>(r30));
    r6 = (r29 + 2884);
    r5 = (r5 + -11496);
    r4 = (r4 + -26800);
    MemoryInline::WriteResolved8(guest_range_2, 989u, (r28 + 989), static_cast<uint8_t>(r31));
    r3 = (r28 + 1072);
    ...
    r11 = MemoryInline::FlatRead32((r29 + 2872));
    ...
    r8 = MemoryInline::FlatRead32((r29 + 2884));
    ...
    MemoryInline::WriteResolved32(guest_range_2, 1064u, (r28 + 1064), r31);
    MemoryInline::WriteResolved8(guest_range_2, 1068u, (r28 + 1068), static_cast<uint8_t>(r31));
    ...
    f0 = ctx->fpr[0];
    ctr = ctx->ctr;
    guest_range_1 = MemoryInline::ResolveRangeHost((r28 + 1620), 0, 132u, false, true);
    MemoryInline::WriteResolved32(guest_range_1, 0u, (r28 + 1620), r31);
    r3 = (r29 + 2896);
    r10 = 0x808C0000u;
    r8 = 0x808C0000u;
    guest_range_4 = MemoryInline::ResolveRangeHost((r29 + 2896), 0, 60u, true, false);
    r20 = MemoryInline::ReadResolved32(guest_range_4, 0u, (r29 + 2896));
    r4 = 0x808D0000u;
    r21 = MemoryInline::ReadResolved32(guest_range_4, 4u, (r3 + 4));
    r10 = (r10 + -12108);
    r22 = MemoryInline::ReadResolved32(guest_range_4, 8u, (r3 + 8));
    r9 = (r29 + 2908);
    MemoryInline::WriteResolved32(guest_range_1, 20u, (r28 + 1640), r22);
    r7 = (r29 + 2920);
    r6 = (r29 + 2932);
    r8 = (r8 + -12120);
    MemoryInline::WriteResolved32(guest_range_1, 4u, (r28 + 1624), r10);
    r5 = (r29 + 2944);
    r4 = (r4 + 13832);
    r3 = (r28 + 1756);
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 8u, ((static_cast<uint64_t>(static_cast<uint32_t>(r28)) << 32) | static_cast<uint32_t>(r20)))) {
        MemoryInline::WriteResolved32(guest_range_1, 8u, (r28 + 1628), r28);
        MemoryInline::WriteResolved32(guest_range_1, 12u, (r28 + 1632), r20);
    }
    MemoryInline::WriteResolved32(guest_range_1, 16u, (r28 + 1636), r21);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r23 = MemoryInline::ReadResolved32(guest_range_4, 12u, (r29 + 2908));
            r24 = MemoryInline::ReadResolved32(guest_range_4, 16u, (r9 + 4));
        }
    }
    r25 = MemoryInline::ReadResolved32(guest_range_4, 20u, (r9 + 8));
    MemoryInline::WriteResolved32(guest_range_1, 40u, (r28 + 1660), r25);
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r10)) << 32) | static_cast<uint32_t>(r28)))) {
        MemoryInline::WriteResolved32(guest_range_1, 24u, (r28 + 1644), r10);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 32u, ((static_cast<uint64_t>(static_cast<uint32_t>(r23)) << 32) | static_cast<uint32_t>(r24)))) {
        MemoryInline::WriteResolved32(guest_range_1, 32u, (r28 + 1652), r23);
        MemoryInline::WriteResolved32(guest_range_1, 36u, (r28 + 1656), r24);
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r26 = MemoryInline::ReadResolved32(guest_range_4, 24u, (r29 + 2920));
            r27 = MemoryInline::ReadResolved32(guest_range_4, 28u, (r7 + 4));
        }
    }
    r12 = MemoryInline::ReadResolved32(guest_range_4, 32u, (r7 + 8));
    MemoryInline::WriteResolved32(guest_range_1, 60u, (r28 + 1680), r12);
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 44u, ((static_cast<uint64_t>(static_cast<uint32_t>(r10)) << 32) | static_cast<uint32_t>(r28)))) {
        MemoryInline::WriteResolved32(guest_range_1, 44u, (r28 + 1664), r10);
        MemoryInline::WriteResolved32(guest_range_1, 48u, (r28 + 1668), r28);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 52u, ((static_cast<uint64_t>(static_cast<uint32_t>(r26)) << 32) | static_cast<uint32_t>(r27)))) {
        MemoryInline::WriteResolved32(guest_range_1, 52u, (r28 + 1672), r26);
        MemoryInline::WriteResolved32(guest_range_1, 56u, (r28 + 1676), r27);
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r11 = MemoryInline::ReadResolved32(guest_range_4, 36u, (r29 + 2932));
            r10 = MemoryInline::ReadResolved32(guest_range_4, 40u, (r6 + 4));
        }
    }
    r9 = MemoryInline::ReadResolved32(guest_range_4, 44u, (r6 + 8));
    MemoryInline::WriteResolved32(guest_range_1, 80u, (r28 + 1700), r9);
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 64u, ((static_cast<uint64_t>(static_cast<uint32_t>(r8)) << 32) | static_cast<uint32_t>(r28)))) {
        MemoryInline::WriteResolved32(guest_range_1, 64u, (r28 + 1684), r8);
        MemoryInline::WriteResolved32(guest_range_1, 68u, (r28 + 1688), r28);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 72u, ((static_cast<uint64_t>(static_cast<uint32_t>(r11)) << 32) | static_cast<uint32_t>(r10)))) {
        MemoryInline::WriteResolved32(guest_range_1, 72u, (r28 + 1692), r11);
        MemoryInline::WriteResolved32(guest_range_1, 76u, (r28 + 1696), r10);
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r7 = MemoryInline::ReadResolved32(guest_range_4, 48u, (r29 + 2944));
            r6 = MemoryInline::ReadResolved32(guest_range_4, 52u, (r5 + 4));
        }
    }
    r0 = MemoryInline::ReadResolved32(guest_range_4, 56u, (r5 + 8));
    guest_range_5 = MemoryInline::ResolveRangeHost((r1 + 32), 0, 60u, false, true);
    if (!MemoryInline::WriteResolvedPair32(guest_range_5, 48u, ((static_cast<uint64_t>(static_cast<uint32_t>(r20)) << 32) | static_cast<uint32_t>(r21)))) {
        MemoryInline::WriteResolved32(guest_range_5, 48u, (r1 + 80), r20);
        MemoryInline::WriteResolved32(guest_range_5, 52u, (r1 + 84), r21);
    }
    MemoryInline::WriteResolved32(guest_range_5, 56u, (r1 + 88), r22);
    if (!MemoryInline::WriteResolvedPair32(guest_range_5, 36u, ((static_cast<uint64_t>(static_cast<uint32_t>(r23)) << 32) | static_cast<uint32_t>(r24)))) {
        MemoryInline::WriteResolved32(guest_range_5, 36u, (r1 + 68), r23);
        MemoryInline::WriteResolved32(guest_range_5, 40u, (r1 + 72), r24);
    }
    MemoryInline::WriteResolved32(guest_range_5, 44u, (r1 + 76), r25);
    if (!MemoryInline::WriteResolvedPair32(guest_range_5, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r26)) << 32) | static_cast<uint32_t>(r27)))) {
        MemoryInline::WriteResolved32(guest_range_5, 24u, (r1 + 56), r26);
        MemoryInline::WriteResolved32(guest_range_5, 28u, (r1 + 60), r27);
    }
    MemoryInline::WriteResolved32(guest_range_5, 32u, (r1 + 64), r12);
    if (!MemoryInline::WriteResolvedPair32(guest_range_5, 12u, ((static_cast<uint64_t>(static_cast<uint32_t>(r11)) << 32) | static_cast<uint32_t>(r10)))) {
        MemoryInline::WriteResolved32(guest_range_5, 12u, (r1 + 44), r11);
        MemoryInline::WriteResolved32(guest_range_5, 16u, (r1 + 48), r10);
    }
    MemoryInline::WriteResolved32(guest_range_5, 20u, (r1 + 52), r9);
    if (!MemoryInline::WriteResolvedPair32(guest_range_5, 0u, ((static_cast<uint64_t>(static_cast<uint32_t>(r7)) << 32) | static_cast<uint32_t>(r6)))) {
        MemoryInline::WriteResolved32(guest_range_5, 0u, (r1 + 32), r7);
        MemoryInline::WriteResolved32(guest_range_5, 4u, (r1 + 36), r6);
    }
    MemoryInline::WriteResolved32(guest_range_5, 8u, (r1 + 40), r0);
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 84u, ((static_cast<uint64_t>(static_cast<uint32_t>(r8)) << 32) | static_cast<uint32_t>(r28)))) {
        MemoryInline::WriteResolved32(guest_range_1, 84u, (r28 + 1704), r8);
        MemoryInline::WriteResolved32(guest_range_1, 88u, (r28 + 1708), r28);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 92u, ((static_cast<uint64_t>(static_cast<uint32_t>(r7)) << 32) | static_cast<uint32_t>(r6)))) {
        MemoryInline::WriteResolved32(guest_range_1, 92u, (r28 + 1712), r7);
        MemoryInline::WriteResolved32(guest_range_1, 96u, (r28 + 1716), r6);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 100u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | static_cast<uint32_t>(r30)))) {
        MemoryInline::WriteResolved32(guest_range_1, 100u, (r28 + 1720), r0);
        MemoryInline::WriteResolved32(guest_range_1, 104u, (r28 + 1724), r30);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 108u, ((static_cast<uint64_t>(static_cast<uint32_t>(r30)) << 32) | static_cast<uint32_t>(r4)))) {
        MemoryInline::WriteResolved32(guest_range_1, 108u, (r28 + 1728), r30);
        MemoryInline::WriteResolved32(guest_range_1, 112u, (r28 + 1732), r4);
    }
    MemoryInline::WriteResolved8(guest_range_1, 124u, (r28 + 1744), static_cast<uint8_t>(r31));
    MemoryInline::WriteResolved32(guest_range_1, 128u, (r28 + 1748), r31);
    ctx->lr = 0x8062AEF8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r3 = (r28 + 2356);
    r4 = (r4 + 13712);
    MemoryInline::FlatWrite32((r28 + 1732), r4);
    r0 = (r4 + 24);
...
// RECOMP_REGISTRATION base 0x8062AC9C func_8062AC9C preserves=true fpr_mask=0x00000000
