...
extern "C" void func_80848AE8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80848B1C:
{
    ...
    MemoryInline::FlatWrite32((r31 + 860), r3);
    r3 = (r31 + 3496);
    r5 = (r31 + 788);
    r4 = 9501;
    ctx->lr = 0x80848B38u;
...
// RECOMP_REGISTRATION base 0x80848AE8 func_80848AE8 preserves=true fpr_mask=0x00000000
