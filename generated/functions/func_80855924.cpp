...
extern "C" void func_80855924(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_inl0_cont_805336A4:
{
    ...
    r0 = (r3 + 1);
    MemoryInline::FlatWrite8((r27 + 72), static_cast<uint8_t>(r0));
    r4 = (r0 & 255);
    r3 = r27;
    r4 = (r4 + 2);
    ctx->lr = 0x8085595Cu;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead8((r27 + 72));
...
loc_808559A8:
{
    r5 = MemoryInline::FlatRead32((r27 + 68));
...
loc_80855A18:
{
    r4 = MemoryInline::FlatRead8((r27 + 72));
    r0 = (r28 & 255);
...
loc_80855A28:
{
    ...
    r6 = ctx->gpr[6];
    r7 = ctx->gpr[7];
    r12 = MemoryInline::FlatRead32((r27 + 472));
    r31 = 0x808B0000u;
    r31 = (r31 + -5140);
    r3 = (r27 + 472);
...
// RECOMP_REGISTRATION base 0x80855924 func_80855924 preserves=true fpr_mask=0x00000000
