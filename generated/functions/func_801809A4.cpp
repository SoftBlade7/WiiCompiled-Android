...
extern "C" void func_801809A4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_stfsx_801809D8_loc_0 = 0;
    uint32_t cr0_0 = 0;
...
loc_801809C8:
{
    ...
    r5 = (r0 + r6);
    addr_stfsx_801809D8_loc_0 = (r6 + r0);
    MemoryInline::FlatWriteFloat32(addr_stfsx_801809D8_loc_0, f1.d);
...
// RECOMP_REGISTRATION base 0x801809A4 func_801809A4 preserves=true fpr_mask=0x00000000
