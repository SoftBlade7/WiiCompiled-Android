...
extern "C" void func_801EDF00(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801EDF40:
{
    ...
    xer = ctx->xer;
    r31 = r3;
    // inline leaf 0x801EC768 (3 guest instruction(s))
    r3 = 0x80350000u;
    r3 = (r3 + 29216);
    // end of inlined leaf 0x801EC768
...
// RECOMP_REGISTRATION base 0x801EDF00 func_801EDF00 preserves=true fpr_mask=0x00000000
