...
extern "C" void func_80547140(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80547160:
{
    ...
    r3 = (r8 + r10);
    r7 = (r3 + r9);
    r3 = MemoryInline::FlatRead8((r7 + 3600));
    r6 = (r7 + 3519);
    r3 = (r3 | 128);
    MemoryInline::FlatWrite8((r7 + 3600), static_cast<uint8_t>(r3));
    ctr = r0;
}
...
loc_805471B4:
{
    ...
    r0_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(25));
...
loc_805471DC:
{
    r3 = MemoryInline::ReadResolved8(guest_range_0, 2u, (r4 + 82));
}

loc_805471E0:
{
    r0 = MemoryInline::FlatRead32((r5 + 3596));
    r0_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(18));
...
loc_80547200:
{
    r3 = MemoryInline::ReadResolved16(guest_range_0, 4u, (r4 + 84));
}
...
loc_80547204:
{
    ...
    MemoryInline::FlatWrite8((r7 + 3600), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x80547140 func_80547140 preserves=true fpr_mask=0x00000000
