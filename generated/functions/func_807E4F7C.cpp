...
extern "C" void func_807E4F7C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807E4FE0:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    f30.d = MemoryInline::FlatReadFloat64((r29 + 392));
    r28 = (r24 + 396);
    f31.d = MemoryInline::FlatReadFloat32((r29 + 400));
    r27 = 0;
    r31 = 1127219200;
}
...
// RECOMP_REGISTRATION base 0x807E4F7C func_807E4F7C preserves=false fpr_mask=0xC0000000
