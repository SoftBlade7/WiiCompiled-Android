...
extern "C" void func_80079670(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80079720:
{
    r31 = MemoryInline::FlatRead32((r26 + 20));
    r30 = (r26 + 20);
    goto loc_80079750;
}
...
// RECOMP_REGISTRATION base 0x80079670 func_80079670 preserves=true fpr_mask=0x00000000
