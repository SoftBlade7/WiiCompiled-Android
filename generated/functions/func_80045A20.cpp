...
extern "C" void func_80045A20(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80045A20:
{
    ...
    r23 = r5;
    r4 = r29;
    MemoryInline::WriteResolved32(guest_range_2, 104u, (r1 + 104), r0);
...
loc_80045B44:
{
    f29.d = MemoryInline::FlatReadFloat32((r2 + -30020));
}
...
loc_80045B60:
{
    ...
    r5 = MemoryInline::FlatRead32((r29 + 60));
    goto loc_80045C48;
}

loc_80045C20:
{
    r3 = MemoryInline::FlatRead16((r29 + 66));
    r5_addr_2 = (r5 + r3);
...
loc_80045C5C:
{
    ...
    r22_psq_tmp_0 = (r22 + 164);
    PpcSetPairedFprInline(f0, PPC_PsqLGqrInline<0u, 0u>(ctx, mkw_gqr0, r22_psq_tmp_0));
    r4 = (r1 + 24);
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r5_psq_tmp_0 = (r5 + 172);
    ...
    // psq_load w=1 quant=0 (using PPC_PsqL)
    r22_psq_tmp_1 = (r22 + 172);
    PpcSetPairedFprInline(f0, PPC_PsqLGqrInline<1u, 0u>(ctx, mkw_gqr0, r22_psq_tmp_1));
    r6 = r23;
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    PPC_PsqStStackInline<0u, 0u>(ctx, r7, f2.d);
    r25 = (r25 + r24);
    ...
    // psq_load w=1 quant=0 (using PPC_PsqL)
    r4_psq_tmp_0 = (r4 + 8);
    PpcSetPairedFprInline(f3, PPC_PsqLStackInline<1u, 0u>(ctx, r4_psq_tmp_0));
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r7_psq_tmp_0 = (r7 + 8);
    PPC_PsqStStackInline<1u, 0u>(ctx, r7_psq_tmp_0, f2.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    ...
    xer = ctx->xer;
    mkw_gqr0 = ctx->gqr[0];
    f28.d = MemoryInline::FlatReadFloat64((r2 + -30016));
    r30 = r3;
...
loc_80045CDC:
{
    r0 = (r25 ^ -2147483648);
    MemoryInline::FlatWriteRam32((r1 + 116), r0);
    r18 = MemoryInline::FlatRead32((r1 + 64));
    f1.d = f31.d;
    f0.d = MemoryInline::FlatReadFloat64((r1 + 112));
    f2.d = f30.d;
    r19 = MemoryInline::FlatRead32((r1 + 68));
    r3 = r21;
    f0.d = static_cast<double>(PpcForceSingleValueInline(f0.d - f28.d));
    r20 = MemoryInline::FlatRead32((r1 + 72));
    r5 = r22;
    r27 = MemoryInline::FlatRead32((r1 + 76));
    r6 = r23;
    r12 = MemoryInline::FlatRead32((r1 + 80));
    r11 = MemoryInline::FlatRead32((r1 + 84));
    f3.d = PpcFmulsInline(f29.d, f0.d);
    r10 = MemoryInline::FlatRead32((r1 + 88));
    r7 = r30;
    r9 = MemoryInline::FlatRead32((r1 + 92));
    r8 = r28;
    r0 = MemoryInline::FlatRead32((r1 + 96));
    f0.d = MemoryInline::FlatReadFloat32((r1 + 100));
    r4 = (r1 + 64);
    MemoryInline::FlatWriteRam32((r1 + 24), r18);
    MemoryInline::FlatWriteRam32((r1 + 28), r19);
    MemoryInline::FlatWriteRam32((r1 + 32), r20);
...
// RECOMP_REGISTRATION base 0x80045A20 func_80045A20 preserves=false fpr_mask=0xF0000000
