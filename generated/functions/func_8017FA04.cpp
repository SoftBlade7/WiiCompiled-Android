...
extern "C" void func_8017FA04(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8017FADC:
{
    r0 = MemoryInline::FlatRead16((r31 + 14));
    r4 = 0;
    MemoryInline::FlatWrite16((r30 + 28), static_cast<uint16_t>(r0));
...
loc_8017FB0C:
{
    ...
    MemoryInline::FlatWrite8((r3 + 14), static_cast<uint8_t>(r4));
...
// RECOMP_REGISTRATION base 0x8017FA04 func_8017FA04 preserves=true fpr_mask=0x00000000
