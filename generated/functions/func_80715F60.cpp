...
extern "C" void func_80715F60(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80715F60:
{
    ...
    r0 = MemoryInline::FlatRead16((r3 + 38));
    r0 = (r0 << 16);
...
loc_80715FC4:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8070F648u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80715F60 func_80715F60 preserves=true fpr_mask=0x00000000
