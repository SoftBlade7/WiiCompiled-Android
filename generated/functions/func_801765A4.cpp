...
extern "C" void func_801765A4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_801765A4:
{
    ...
    r6 = MemoryInline::FlatRead32((r5 + 18736));
...
loc_801765E8:
{
    ...
    r6 = (r6 + r0);
    r4 = 4;
    MemoryInline::FlatWrite8((r6 + 92), static_cast<uint8_t>(r7));
    ctx->lr = 0x80176608u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x801765A4 func_801765A4 preserves=true fpr_mask=0x00000000
