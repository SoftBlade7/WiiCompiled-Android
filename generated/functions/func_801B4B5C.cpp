...
extern "C" void func_801B4B5C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_801B4BA0:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead32((r28 + 1592));
...
loc_801B4CB0:
{
    MemoryInline::FlatWrite16((r4 + 1708), static_cast<uint16_t>(r3));
    if ((static_cast<int32_t>(r0) != static_cast<int32_t>(0))) {
        goto loc_801B4D08;
    }
}
...
loc_801B4D20:
{
    ...
    r4 = MemoryInline::FlatRead32((r24 + 1592));
    r5 = 8192;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
// RECOMP_REGISTRATION base 0x801B4B5C func_801B4B5C preserves=true fpr_mask=0x00000000
