...
extern "C" void func_800A7A20(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800A7AA4:
{
    r0 = MemoryInline::FlatRead32((r30 + 260));
    r3 = r26;
    r6 = MemoryInline::FlatRead32((r30 + 268));
    r4 = r25;
    r0 = (r31 * r0);
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800AB040u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800A7AE8:
{
    ...
    r3 = ctx->gpr[3];
    r0 = 1;
    MemoryInline::FlatWrite8((r30 + 297), static_cast<uint8_t>(r0));
    r11 = (r1 + 48);
...
// RECOMP_REGISTRATION base 0x800A7A20 func_800A7A20 preserves=true fpr_mask=0x00000000
