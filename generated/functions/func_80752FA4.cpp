...
extern "C" void func_80752FA4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80752FE8:
{
    ...
    r0 = fctiwzword0;
    MemoryInline::FlatWrite8((r30 + 288), static_cast<uint8_t>(r0));
    r5 = (r0 & 255);
    ctx->lr = 0x80753028u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x80752FA4 func_80752FA4 preserves=true fpr_mask=0x00000000
