...
extern "C" void func_805C4430(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805C4468:
{
    ...
    r3 = 0x80890000u;
    f3.d = MemoryInline::FlatReadFloat64((r3 + 13416));
    r5 = 0x80890000u;
    ...
    f0.d = MemoryInline::FlatReadFloat32((r5 + 13408));
...
loc_805C44BC:
{
    r5 = 0x80890000u;
    r4 = 3;
    f1.d = MemoryInline::FlatReadFloat32((r5 + 13084));
    ctx->lr = 0x805C44CCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x805C4430 func_805C4430 preserves=true fpr_mask=0x00000000
