...
extern "C" void func_808885B0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_808885B0:
{
    ...
    r0 = 0;
    r7 = (r1 + 8);
    r8 = MemoryInline::FlatRead32((r4 + 9972));
    r4 = (r1 + 16);
...
// RECOMP_REGISTRATION base 0x808885B0 func_808885B0 preserves=true fpr_mask=0x00000000
