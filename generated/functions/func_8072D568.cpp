...
extern "C" void func_8072D568(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8072D568:
{
    r4 = 0x808A0000u;
    r0 = -1;
    f0.d = MemoryInline::FlatReadFloat32((r4 + 9560));
    r4 = 0;
    guest_range_0 = MemoryInline::ResolveRangeHost((r3 + 16), 0, 64u, false, true);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 16u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f0.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 20u, (r3 + 36), f0.d);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 16u, (r3 + 32), f0.d);
    }
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 24u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f0.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 24u, (r3 + 40), f0.d);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 28u, (r3 + 44), f0.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 32u, ((static_cast<uint64_t>(static_cast<uint32_t>(r4)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_0, 32u, (r3 + 48), r4);
        MemoryInline::WriteResolved32(guest_range_0, 36u, (r3 + 52), r0);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 40u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_0, 40u, (r3 + 56), r0);
        MemoryInline::WriteResolved32(guest_range_0, 44u, (r3 + 60), r0);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 48u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_0, 48u, (r3 + 64), r0);
        MemoryInline::WriteResolved32(guest_range_0, 52u, (r3 + 68), r0);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 56u, ((static_cast<uint64_t>(static_cast<uint32_t>(r4)) << 32) | static_cast<uint32_t>(r4)))) {
        MemoryInline::WriteResolved32(guest_range_0, 56u, (r3 + 72), r4);
        MemoryInline::WriteResolved32(guest_range_0, 60u, (r3 + 76), r4);
    }
    ctx->gpr[0] = r0;
    ctx->gpr[4] = r4;
    ctx->fpr[0] = f0;
...
// RECOMP_REGISTRATION base 0x8072D568 func_8072D568 preserves=true fpr_mask=0x00000000
