...
extern "C" void func_80153328(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80153394:
{
    ...
    r3 = 0;
    r0 = 5;
    MemoryInline::FlatWrite8((r30 + 105), static_cast<uint8_t>(r3));
...
loc_8015345C:
{
    ...
    r3 = r5;
    r4 = MemoryInline::FlatRead8((r30 + 13));
    r5 = MemoryInline::FlatRead16((r5 + 106));
    ctx->lr = 0x8015347Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80153328 func_80153328 preserves=true fpr_mask=0x00000000
