...
extern "C" void func_8079C554(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8079C554:
{
    ...
    r29 = r3;
    r8 = MemoryInline::FlatRead32((r31 + 13860));
    MemoryInline::FlatWrite16((r8 + 2), static_cast<uint16_t>(r5));
    r3 = MemoryInline::FlatRead32((r31 + 13860));
    MemoryInline::FlatWrite8((r3 + 4), static_cast<uint8_t>(r4));
    r3 = MemoryInline::FlatRead32((r31 + 13860));
    r0 = MemoryInline::FlatRead32((r7 + 14528));
    MemoryInline::FlatWrite16(r3, static_cast<uint16_t>(r0));
    r30 = MemoryInline::FlatRead32((r6 + 8016));
    r3 = r30;
...
// RECOMP_GUEST_ABI gpr_read=0xE000003B gpr_write=0xE00001FB gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x8079C554 func_8079C554 preserves=true fpr_mask=0x00000000
