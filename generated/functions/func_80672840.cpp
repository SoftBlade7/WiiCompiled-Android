...
extern "C" void func_80672840(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r4_rot_0 = 0;
    uint32_t r4_rot_1 = 0;
...
loc_806728C4:
{
    r3 = MemoryInline::FlatRead32((r31 + 16904));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
loc_80672918:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80672A00u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80672944:
{
    r4 = MemoryInline::FlatRead32((r31 + 16908));
    r3 = r31;
    r5 = 4;
    r6 = 1;
    ctx->lr = 0x80672958u;
    ...
    r8 = MemoryInline::FlatRead32((r31 + 16908));
    r9 = MemoryInline::FlatRead32((r31 + 16912));
    ctx->lr = 0x80672980u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80672840 func_80672840 preserves=true fpr_mask=0x00000000
