...
extern "C" void func_800AB210(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800AB210:
{
    ...
    f31.d = MemoryInline::FlatReadFloat32((r2 + -28024));
    r26 = r3;
    ...
    ctx->fpr[2] = f2;
    ctx->cr = cr;
    InvokeDirectCpu<0x80088A70u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    f0 = ctx->fpr[0];
    f1 = ctx->fpr[1];
...
loc_800AB268:
{
    ...
    r29 = (r26 + r30);
    f1.d = MemoryInline::FlatReadFloat32((r26 + 264));
    r27 = 0;
    f2.d = PpcFmulsInline(f31.d, f0.d);
    f0.d = MemoryInline::FlatReadFloat32((r26 + 260));
    f30.d = PpcFmulsInline(f2.d, f1.d);
...
loc_800AB298:
{
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8008B8C0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r30 = ctx->gpr[30];
...
// RECOMP_REGISTRATION base 0x800AB210 func_800AB210 preserves=false fpr_mask=0xE0000000
