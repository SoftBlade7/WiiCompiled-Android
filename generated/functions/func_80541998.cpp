...
extern "C" void func_80541998(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80541998:
{
    ...
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
    InvokeDirectCpu<0x80541B58u>(ctx);
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80541998 func_80541998 preserves=true fpr_mask=0x00000000
