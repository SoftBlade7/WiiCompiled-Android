...
extern "C" void func_805C8880(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805C8880:
{
    r3 = MemoryInline::FlatRead32((r3 + 6428));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x805C8880 func_805C8880 preserves=true fpr_mask=0x00000000
