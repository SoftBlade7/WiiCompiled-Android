...
extern "C" void func_80580F28(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80580F28:
{
    ...
    f1 = ctx->fpr[1];
    ctr = ctx->ctr;
    MemoryInline::FlatWrite16((r30 + 402), static_cast<uint16_t>(r31));
    r3 = MemoryInline::FlatRead32((r30 + 608));
    // inline leaf 0x8056B060 (13 guest instruction(s))
    r5 = 0x80890000u;
    r4 = 0x80890000u;
    ...
    // end of inlined leaf 0x8056B060
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFEFDE gpr_write=0xFFFFFFFF gpr_return=0x00000018 fpr_read=0xFFFFFFFD fpr_write=0xFFFFFFFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x80580F28 func_80580F28 preserves=true fpr_mask=0x00000000
