...
extern "C" void func_80765E30(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80765E30:
{
    ...
    r0 = MemoryInline::FlatRead8((r3 + 204));
...
loc_80766014:
{
    ...
    r30 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r30 + 15048));
    r4 = 0;
    r12 = MemoryInline::FlatRead32(r3);
    ...
    r4 = 0;
    f2.d = MemoryInline::FlatReadFloat32((r3 + 15072));
...
// RECOMP_REGISTRATION base 0x80765E30 func_80765E30 preserves=true fpr_mask=0x00000000
