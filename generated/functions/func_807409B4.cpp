...
extern "C" void func_807409B4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807409B4:
{
    ...
    r4 = 0x808D0000u;
    r26 = r3;
    r5 = MemoryInline::FlatRead16((r4 + -19836));
    r5 = (r5 << 16);
...
loc_80740A14:
{
    ...
    r4 = 0x808A0000u;
    r3 = 0x808A0000u;
    f29.d = MemoryInline::FlatReadFloat32((r5 + -19832));
    f30.d = MemoryInline::FlatReadFloat64((r4 + 10464));
    r27 = r26;
    f31.d = MemoryInline::FlatReadFloat32((r3 + 10448));
    r28 = 0;
    r30 = 0x809C0000u;
    r31 = 1127219200;
    goto loc_80740A74;
...
{
    f1.d = f29.d;
    r29 = MemoryInline::FlatRead32((r27 + 12));
...
loc_80740A80:
{
    ...
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 56u, (r1 + 80));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f30.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 40u, (r1 + 64));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    r11 = (r1 + 48);
    f29.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 24u, (r1 + 48));
...
// RECOMP_GUEST_ABI gpr_read=0xFC0000EB gpr_write=0xFC000FFB gpr_return=0x00000018 fpr_read=0xE000001F fpr_write=0xE000001F fpr_return=0x00000002 cr_read=0xC1 cr_write=0xC1 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x807409B4 func_807409B4 preserves=false fpr_mask=0xE0000000
