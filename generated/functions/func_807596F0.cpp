...
extern "C" void func_807596F0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807596F0:
{
    ...
    r24 = 0x808A0000u;
    r26 = r3;
    f29.d = MemoryInline::FlatReadFloat32((r24 + 13752));
    r31 = (r3 + 180);
    r29 = 0;
    r25 = 0x808D0000u;
}
...
loc_80759788:
{
    r23 = MemoryInline::FlatRead32((r26 + 176));
    goto loc_80759794;
}
...
loc_807597B0:
{
    r6 = MemoryInline::FlatRead32((r23 + 48));
    r3 = (r1 + 80);
    r0 = MemoryInline::FlatRead32((r23 + 52));
    r4 = (r1 + 104);
    ...
    f31 = ctx->fpr[31];
    cr = ctx->cr;
    f0.d = MemoryInline::FlatReadFloat32((r26 + 340));
    f31.d = f1.d;
...
loc_8075980C:
{
    MemoryInline::FlatWriteRamFloat32((r1 + 84), f29.d);
    r3 = (r1 + 80);
    ctx->lr = 0x80759818u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    f1.d = MemoryInline::FlatReadFloat32((r25 + -14088));
    r3 = (r1 + 68);
    r4 = (r1 + 56);
    // inline leaf 0x80514810 (10 guest instruction(s))
    f3.d = MemoryInline::FlatReadFloat32((r4 + 8));
    ...
    f1.d = MemoryInline::FlatReadFloat32((r24 + 13752));
    MemoryInline::FlatWrite16((r23 + 44), static_cast<uint16_t>(r0));
    MemoryInline::FlatWriteFloat32((r23 + 48), f3.d);
    MemoryInline::FlatWriteFloat32((r23 + 52), f2.d);
...
loc_8075998C:
{
    if ((static_cast<int32_t>(r27) < static_cast<int32_t>(11))) {
        goto loc_80759780;
    }
}
...
// RECOMP_REGISTRATION base 0x807596F0 func_807596F0 preserves=false fpr_mask=0xE0000000
