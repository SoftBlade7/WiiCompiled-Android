...
extern "C" void func_8086E824(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8086E844:
{
    guest_range_0 = MemoryInline::ResolveRangeHost((r27 + 472), 0, 4u, true, false);
    r6 = MemoryInline::ReadResolved32(guest_range_0, 0u, (r27 + 472));
    r4 = 0x808B0000u;
    r28 = 0x808B0000u;
    r5 = 0;
    ...
    r3 = MemoryInline::ReadResolved32(guest_range_0, 0u, (r27 + 472));
...
// RECOMP_REGISTRATION base 0x8086E824 func_8086E824 preserves=false fpr_mask=0xC0000000
