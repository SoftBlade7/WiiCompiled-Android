...
extern "C" void func_80601410(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80601410:
{
    ...
    r31 = 0x80890000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r31 + 26592));
    ctx->lr = 0x80601444u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80601410 func_80601410 preserves=true fpr_mask=0x00000000
