...
extern "C" void func_801BF694(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_801BF694:
{
    ...
    r3 = ctx->gpr[3];
    r31 = MemoryInline::FlatRead8((r31 + 2243));
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x801BF694 func_801BF694 preserves=true fpr_mask=0x00000000
