...
extern "C" void func_807071C4(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r3 = (r3 + -136);
    // inline leaf 0x8070539C (5 guest instruction(s))
    r0 = MemoryInline::FlatRead32((r3 + 96));
    r0 = (r0 & -16);
    r0 = (r0 | r4);
    MemoryInline::FlatWrite32((r3 + 96), r0);
    // end of inlined leaf 0x8070539C
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x807071C4 func_807071C4 preserves=true fpr_mask=0x00000000
