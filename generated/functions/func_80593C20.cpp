...
extern "C" void func_80593C20(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r3_rot_0 = 0;
...
loc_80593C20:
{
    ...
    r31 = ctx->gpr[31];
    r4 = 0x808B0000u;
    MemoryInline::FlatWrite8((r30 + 48), static_cast<uint8_t>(r31));
    r4 = (r4 + 25776);
...
// RECOMP_REGISTRATION base 0x80593C20 func_80593C20 preserves=true fpr_mask=0x00000000
