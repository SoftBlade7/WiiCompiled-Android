...
extern "C" void func_800C71E0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800C7234:
{
    ...
    xer = ctx->xer;
    r31 = 0;
    MemoryInline::FlatWrite16((r30 + 66), static_cast<uint16_t>(r31));
    r3 = r30;
    ctx->lr = 0x800C725Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x800C71E0 func_800C71E0 preserves=true fpr_mask=0x00000000
