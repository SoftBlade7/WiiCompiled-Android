...
extern "C" void func_80642BEC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80642BEC:
{
    ...
    r31 = 0x808A0000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r31 + -28168));
    ctx->lr = 0x80642C20u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80642BEC func_80642BEC preserves=true fpr_mask=0x00000000
