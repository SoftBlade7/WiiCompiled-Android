...
extern "C" void func_807D5B38(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807D5B38:
{
    ...
    f8.d = PpcFmulsInline(f6.d, f6.d);
    r31 = 0x808A0000u;
    r31 = (r31 + 29696);
    // psq_load w=0 quant=0 (using PPC_PsqL)
    PpcSetPairedFprInline(f9, PPC_PsqLGqrInline<0u, 0u>(ctx, mkw_gqr0, r6));
    f6.d = MemoryInline::FlatReadFloat32((r31 + 176));
    r10 = (r1 + 92);
    f30.d = PpcFmulsInline(f1.d, f8.d);
    f0.d = MemoryInline::FlatReadFloat32((r31 + 212));
    f1.d = PpcFmulsInline(f2.d, f8.d);
    // psq_load w=0 quant=0 (using PPC_PsqL)
    PpcSetPairedFprInline(f2, PPC_PsqLGqrInline<0u, 0u>(ctx, mkw_gqr0, r4));
    f4.d = static_cast<double>(PpcForceSingleValueInline(f6.d / f4.d));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    PpcSetPairedFprInline(f8, PPC_PsqLGqrInline<0u, 0u>(ctx, mkw_gqr0, r5));
    r30 = (r1 + 80);
    r23 = r3;
    r29 = (r1 + 68);
    r25 = r7;
    ...
    r27 = r9;
    r3 = r30;
    PpcSetPairedFprInline(f5, PPC_PsMuls0Inline(f8.d, PPC_PsFromScalarInline(f4.d)));
    // psq_load w=1 quant=0 (using PPC_PsqL)
    r5_psq_tmp_0 = (r5 + 8);
    PpcSetPairedFprInline(f8, PPC_PsqLGqrInline<1u, 0u>(ctx, mkw_gqr0, r5_psq_tmp_0));
    f1.d = static_cast<double>(PpcForceSingleValueInline(f1.d / f3.d));
    r5 = r25;
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    PPC_PsqStStackInline<0u, 0u>(ctx, r30, f5.d);
    f1.d = static_cast<double>(PpcForceSingleValueInline(f6.d + f1.d));
    PpcSetPairedFprInline(f11, f9.d);
    mkw_gqr0 = ctx->gqr[0];
    PpcSetPairedFprInline(f5, PPC_PsMuls0Inline(f8.d, PPC_PsFromScalarInline(f4.d)));
    f29.d = PpcFmulsInline(f0.d, f1.d);
    PpcSetPairedFprInline(f6, PPC_PsMuls0Inline(f11.d, PPC_PsFromScalarInline(f10.d)));
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r30_psq_tmp_0 = (r30 + 8);
    PPC_PsqStStackInline<1u, 0u>(ctx, r30_psq_tmp_0, f5.d);
    f31.d = f3.d;
    PpcSetPairedFprInline(f0, PPC_PsMuls0Inline(f9.d, PPC_PsFromScalarInline(f29.d)));
    // psq_load w=1 quant=0 (using PPC_PsqL)
    r6_psq_tmp_0 = (r6 + 8);
    PpcSetPairedFprInline(f9, PPC_PsqLGqrInline<1u, 0u>(ctx, mkw_gqr0, r6_psq_tmp_0));
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    PPC_PsqStStackInline<0u, 0u>(ctx, r29, f6.d);
    PpcSetPairedFprInline(f6, PPC_PsMuls0Inline(f9.d, PPC_PsFromScalarInline(f10.d)));
    r6 = (r1 + 56);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    PPC_PsqStStackInline<0u, 0u>(ctx, r10, f0.d);
    PpcSetPairedFprInline(f0, PPC_PsMuls0Inline(f9.d, PPC_PsFromScalarInline(f29.d)));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    PpcSetPairedFprInline(f1, PPC_PsqLStackInline<0u, 0u>(ctx, r10));
    f28.d = f7.d;
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r10_psq_tmp_0 = (r10 + 8);
    ...
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r29_psq_tmp_0 = (r29 + 8);
    PPC_PsqStStackInline<1u, 0u>(ctx, r29_psq_tmp_0, f6.d);
    r4 = r29;
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    ...
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r10_psq_tmp_1 = (r10 + 8);
    PPC_PsqStStackInline<1u, 0u>(ctx, r10_psq_tmp_1, f1.d);
    ctx->lr = 0x807D5C3Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    // psq_load w=1 quant=0 (using PPC_PsqL)
    r24_psq_tmp_0 = (r24 + 8);
    PpcSetPairedFprInline(f1, PPC_PsqLGqrInline<1u, 0u>(ctx, mkw_gqr0, r24_psq_tmp_0));
    r6 = (r1 + 44);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    PPC_PsqStStackInline<0u, 0u>(ctx, r28, f0.d);
    // psq_load w=1 quant=0 (using PPC_PsqL)
    r27_psq_tmp_0 = (r27 + 8);
    PpcSetPairedFprInline(f0, PPC_PsqLGqrInline<1u, 0u>(ctx, mkw_gqr0, r27_psq_tmp_0));
    PpcSetPairedFprInline(f0, PPC_PsSubInline(f0.d, f1.d));
    // psq_store w=1 quant=0 (using PPC_PsqSt)
    r28_psq_tmp_0 = (r28 + 8);
    PPC_PsqStStackInline<1u, 0u>(ctx, r28_psq_tmp_0, f0.d);
    ctx->lr = 0x807D5C74u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_807D5D6C:
{
    ...
    SetCRFloatResident(cr, 0, f29.d, f4.d);
}
...
loc_807D5D94:
{
    ...
    MemoryInline::FlatWriteFloat32(r27, f7.d);
    ...
    MemoryInline::FlatWriteFloat32((r27 + 4), f6.d);
    ...
    MemoryInline::FlatWriteFloat32((r27 + 8), f5.d);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_807D5E58;
    }
}
...
loc_807D5E28:
{
    f1.d = static_cast<double>(PpcForceSingleValueInline(f11.d - f0.d));
...
// RECOMP_REGISTRATION base 0x807D5B38 func_807D5B38 preserves=false fpr_mask=0xF0000000
