...
extern "C" void func_807E6C10(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807E6C10:
{
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 212u, ((static_cast<uint64_t>(static_cast<uint32_t>(r25)) << 32) | static_cast<uint32_t>(r26)))) {
        MemoryInline::WriteResolved32(guest_range_0, 212u, (r11 + -28), r25);
...
loc_807E6C44:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead32((r3 + 2112));
}
...
loc_807E6C68:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r30 + -30776));
    r4 = 0;
    ctx->lr = 0x807E6C80u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_22B2 = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_22B2[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_22B2[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    r0 = MemoryInline::FlatRead32((r25 + 3348));
    r26_addr_2 = (r26 + r0);
...
loc_807E6D0C:
{
    r3 = 0x808B0000u;
    r11 = (r1 + 240);
    f0.d = MemoryInline::FlatReadFloat32((r3 + -30772));
    MemoryInline::FlatWriteFloat32((r25 + 124), f0.d);
    ...
    r0 = MemoryInline::ReadResolved32(guest_range_1, 32u, (r1 + 244));
    ctx->lr = r0;
    r1 = (r1 + 240);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x807E6C10 func_807E6C10 preserves=true fpr_mask=0x00000000
