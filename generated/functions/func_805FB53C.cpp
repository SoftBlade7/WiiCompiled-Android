...
extern "C" void func_805FB53C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_805FB53C:
{
    ...
    r4 = (r4 + 25352);
    r4_addr_0 = (r4 + r0);
    r3 = MemoryInline::FlatRead16(r4_addr_0);
...
// RECOMP_REGISTRATION base 0x805FB53C func_805FB53C preserves=true fpr_mask=0x00000000
