...
extern "C" void func_8074BE40(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8074BE40:
{
    ...
    r3 = 0x808A0000u;
    f1.d = f30.d;
    f3.d = MemoryInline::FlatReadFloat32((r3 + 11480));
    f2.d = f31.d;
    r3 = (r1 + 16);
    ...
    MemoryInline::WriteResolvedFloat32(guest_range_0, 8u, r3, f1.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r3_psq_tmp_0 = (r3 + 4);
    ...
    MemoryInline::WriteResolvedFloat32(guest_range_0, 28u, (r3 + 20), f2.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r3_psq_tmp_2 = (r3 + 24);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 48u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f3.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f0.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 48u, (r3 + 40), f3.d);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 52u, (r3 + 44), f0.d);
    }
    // end of inlined leaf 0x8019A460
    f0.d = static_cast<double>(PpcForceSingleValueInline(f29.d - f31.d));
    r3 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + 11476));
    r4 = (r1 + 16);
    ...
    MemoryInline::WriteResolvedFloat32(guest_range_0, 20u, (r1 + 28), f28.d);
    MemoryInline::WriteResolvedFloat32(guest_range_0, 52u, (r1 + 60), f1.d);
...
// RECOMP_GUEST_ABI gpr_read=0xFF803FCE gpr_write=0xFF801FFB gpr_return=0x00000018 fpr_read=0xF000001E fpr_write=0xF00003FF fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x8074BE40 func_8074BE40 preserves=false fpr_mask=0xF0000000
