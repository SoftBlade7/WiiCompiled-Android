...
extern "C" void func_8071C978(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8071CA04:
{
    SetCRFloatResident(cr, 0, f31.d, f3.d);
}
...
{
    r3 = (r26 + 20);
    r5 = MemoryInline::FlatRead32((r26 + 20));
...
loc_8071CA54:
{
    f31.d = MemoryInline::FlatReadFloat32((r26 + 16));
    goto loc_8071CA60;
}
...
loc_8071CA7C:
{
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8071CBD8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8071CAE0:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r4 + -27596));
    f0.d = (-(f0.d));
    SetCRFloatResident(cr, 0, f1.d, f0.d);
}
...
loc_8071CB78:
{
    ...
    MemoryInline::FlatWrite8((r4 + 40), static_cast<uint8_t>(r3));
...
// RECOMP_GUEST_ABI gpr_read=0xFFC007FB gpr_write=0xFFC00FFB gpr_return=0x00000018 fpr_read=0xF8000007 fpr_write=0xF800000F fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x8071C978 func_8071C978 preserves=false fpr_mask=0x80000000
