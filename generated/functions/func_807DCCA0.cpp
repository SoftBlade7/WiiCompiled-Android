...
extern "C" void func_807DCCA0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807DCCA0:
{
    ...
    MemoryInline::FlatWriteFloat32(r3, f5.d);
    MemoryInline::FlatWriteFloat32((r3 + 4), f4.d);
...
// RECOMP_REGISTRATION base 0x807DCCA0 func_807DCCA0 preserves=true fpr_mask=0x00000000
