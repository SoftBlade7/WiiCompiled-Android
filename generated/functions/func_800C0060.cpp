...
extern "C" void func_800C0060(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800C00AC:
{
    if ((static_cast<int32_t>(r28) == static_cast<int32_t>(-6))) {
        goto loc_800C00BC;
    }
}
...
loc_800C00B4:
{
    if ((static_cast<int32_t>(r28) == static_cast<int32_t>(-11))) {
        goto loc_800C0104;
    }
}
...
// RECOMP_REGISTRATION base 0x800C0060 func_800C0060 preserves=true fpr_mask=0x00000000
