...
extern "C" void func_8064B640(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8064B640:
{
    ...
    r3 = (r31 + 12);
    r6 = 0x808C0000u;
    guest_range_3 = MemoryInline::ResolveRangeHost((r31 + 12), 0, 72u, true, false);
    r5 = MemoryInline::ReadResolved32(guest_range_3, 0u, (r31 + 12));
    r19 = (r19 + -76);
    ...
    MemoryInline::WriteResolved32(guest_range_1, 80u, (r29 + 80), r4);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r20 = MemoryInline::ReadResolved32(guest_range_3, 12u, (r31 + 24));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r23 = MemoryInline::ReadResolved32(guest_range_3, 24u, (r31 + 36));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r26 = MemoryInline::ReadResolved32(guest_range_3, 36u, (r31 + 48));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r12 = MemoryInline::ReadResolved32(guest_range_3, 48u, (r31 + 60));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r9 = MemoryInline::ReadResolved32(guest_range_3, 60u, (r31 + 72));
        }
    }
...
// RECOMP_REGISTRATION base 0x8064B640 func_8064B640 preserves=true fpr_mask=0x00000000
