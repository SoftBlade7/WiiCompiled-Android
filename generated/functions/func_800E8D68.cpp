...
extern "C" void func_800E8D68(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = 0;
    MemoryInline::FlatWrite32((r13 + -26856), r0);
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x800E8D68 func_800E8D68 preserves=true fpr_mask=0x00000000
