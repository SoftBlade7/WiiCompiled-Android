...
extern "C" void func_8077E444(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8077E444:
{
    ...
    ctx->fpr[1] = f1;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8076ED70u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8077E444 func_8077E444 preserves=true fpr_mask=0x00000000
