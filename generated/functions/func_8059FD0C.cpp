...
extern "C" void func_8059FD0C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8059FD0C:
{
    ...
    f10.d = MemoryInline::FlatReadFloat32((r3 + 112));
    ...
    f12.d = MemoryInline::FlatReadFloat32((r3 + 104));
    f5.d = PpcFmulsInline(f31.d, f0.d);
    f9.d = MemoryInline::FlatReadFloat32((r3 + 108));
...
// RECOMP_REGISTRATION base 0x8059FD0C func_8059FD0C preserves=true fpr_mask=0x00000000
