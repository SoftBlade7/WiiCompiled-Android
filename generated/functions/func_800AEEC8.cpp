...
extern "C" void func_800AEEC8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800AEEC8:
{
    r7 = MemoryInline::FlatRead16((r3 + 34));
    r0_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(12));
    r0 = (r0_rot_0 & 1044480);
    r9 = MemoryInline::FlatRead16((r3 + 36));
    r5 = 1;
    r6 = (static_cast<int32_t>(r7) >> 4);
    r4 = (r7 & 15);
...
// RECOMP_GUEST_ABI gpr_read=0x00000298 gpr_write=0x000003F9 gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x800AEEC8 func_800AEEC8 preserves=true fpr_mask=0x00000000
