...
extern "C" void func_8021AA88(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8021AAD0:
{
    ...
    r5_subfic_ra_0 = r5;
    r5 = (255 - r5_subfic_ra_0);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(255) >= static_cast<uint32_t>(r5_subfic_ra_0) ? 1u : 0u) << 29);
...
// RECOMP_GUEST_ABI gpr_read=0xF0003FFF gpr_write=0xF0001FFB gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x8021AA88 func_8021AA88 preserves=true fpr_mask=0x00000000
