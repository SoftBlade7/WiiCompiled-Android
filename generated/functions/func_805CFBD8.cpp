...
extern "C" void func_805CFBD8(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = 0;
    MemoryInline::FlatWrite8((r3 + 21036), static_cast<uint8_t>(r0));
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x805CFBD8 func_805CFBD8 preserves=true fpr_mask=0x00000000
