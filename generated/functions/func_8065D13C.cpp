...
extern "C" void func_8065D13C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8065D190:
{
    ...
    r0 = (r0_rot_2 & -8);
    r3 = (r28 + r0);
    r31 = MemoryInline::FlatRead8((r3 + 2));
    goto loc_8065D1DC;
}
...
// RECOMP_REGISTRATION base 0x8065D13C func_8065D13C preserves=true fpr_mask=0x00000000
