...
extern "C" void func_8001CA0C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8001CA20:
{
    // dcbst @ 0x8001CA20 (no-op)
    // dcbf @ 0x8001CA24 (no-op)
    // sync @ 0x8001CA28 (no-op)
    // icbi @ 0x8001CA2C (no-op)
    r5_addic_src_2 = r5;
    r5 = (r5_addic_src_2 + 8);
    r4_addic_src_2 = r4;
    r4 = (r4_addic_src_2 + -8);
...
// RECOMP_REGISTRATION base 0x8001CA0C func_8001CA0C preserves=true fpr_mask=0x00000000
