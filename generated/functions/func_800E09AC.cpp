...
extern "C" void func_800E09AC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800E09AC:
{
    ...
    r5 = MemoryInline::FlatRead32((r6 + 1820));
...
loc_800E0AA8:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r31 = MemoryInline::FlatRead32((r13 + -26868));
    r4 = MemoryInline::FlatRead32((r31 + 1920));
...
loc_800E0AD4:
{
    ...
    r3 = MemoryInline::FlatRead32((r31 + 1920));
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r12 = MemoryInline::FlatRead32((r31 + 2160));
    r7 = r3;
    r5 = r30;
    r6 = r29;
    r8 = MemoryInline::FlatRead32((r31 + 2164));
    r3 = 0;
    r4 = 1;
    ctr = r12;
    ctx->lr = 0x800E0B08u;
...
loc_800E0B18:
{
    ...
    r5 = 1;
    r0 = (0 - r3);
    MemoryInline::FlatWrite8((r4 + 1826), static_cast<uint8_t>(r5));
    r0 = (r0 | r3);
...
{
    r3 = MemoryInline::FlatRead32((r13 + -26868));
    r4 = MemoryInline::FlatRead32((r3 + 1592));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r4), static_cast<int32_t>(0));
}
...
loc_800E0B7C:
{
    r5 = MemoryInline::FlatRead32((r3 + 1596));
    r7 = 0;
    r6 = MemoryInline::FlatRead16((r3 + 1604));
    r3 = 5;
    r8 = 0;
    ctx->lr = 0x800E0B94u;
    ctx->gpr[0] = r0;
    ...
    xer = ctx->xer;
    r4 = MemoryInline::FlatRead32((r13 + -26868));
    MemoryInline::FlatWrite32((r4 + 1916), r30);
}
...
loc_800E0D70:
{
    ...
    r29 = 0;
    r0 = MemoryInline::FlatRead8((r6 + 24));
}
...
loc_800E0D8C:
{
    r0 = MemoryInline::FlatRead32((r6 + 1752));
}
...
loc_800E0D98:
{
    r3 = MemoryInline::FlatRead32((r6 + 1752));
    r0 = MemoryInline::FlatRead32((r6 + 1912));
...
loc_800E0DA8:
{
    r4 = MemoryInline::FlatRead32((r6 + 1752));
    r7 = (r1 + 8);
    r5 = MemoryInline::FlatRead32((r6 + 1596));
    r3 = 12;
    r6 = MemoryInline::FlatRead16((r6 + 1604));
    ...
    r29 = r3;
    r5 = 48;
    MemoryInline::FlatWrite8((r4 + 24), static_cast<uint8_t>(r30));
    r4 = 0;
    r3 = MemoryInline::FlatRead32((r13 + -26868));
    MemoryInline::FlatWrite32((r3 + 1752), r30);
    r3 = MemoryInline::FlatRead32((r13 + -26868));
    r3 = (r3 + 1592);
    ctx->lr = 0x800E0DECu;
    ctx->gpr[0] = r0;
...
{
    r3 = MemoryInline::FlatRead32((r13 + -26868));
    r3 = MemoryInline::FlatRead32((r3 + 1816));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(0));
}
...
loc_800E0F24:
{
    ...
    r0 = (r3 + -2);
    r0 = PPC_CntlzwInline(static_cast<uint32_t>(r0));
    r29_rot_5 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(27));
    r29 = (r29_rot_5 & 134217727);
}
...
loc_800E0F34:
{
    r0 = PPC_CntlzwInline(static_cast<uint32_t>(r4));
    r3 = MemoryInline::FlatRead32((r31 + 1920));
    r30_rot_3 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(27));
    r30 = (r30_rot_3 & 134217727);
    ctx->lr = 0x800E0F44u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x800E09AC func_800E09AC preserves=true fpr_mask=0x00000000
