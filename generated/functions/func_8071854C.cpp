...
extern "C" void func_8071854C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8071854C:
{
    ...
    r3 = r31;
    MemoryInline::FlatWrite8((r31 + 16), static_cast<uint8_t>(r4));
...
// RECOMP_REGISTRATION base 0x8071854C func_8071854C preserves=true fpr_mask=0x00000000
