...
extern "C" void func_807AF534(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807AF534:
{
    ...
    ctx->fpr[1] = f1;
    ctx->fpr[2] = f2;
    InvokeDirectCpu<0x8079FFDCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    r4 = 0;
    f2.d = MemoryInline::FlatReadFloat32((r5 + 24052));
    ctx->lr = 0x807AF58Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x807AF534 func_807AF534 preserves=true fpr_mask=0x00000000
