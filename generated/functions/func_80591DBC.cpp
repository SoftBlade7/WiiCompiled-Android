...
extern "C" void func_80591DBC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80591DBC:
{
    ...
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
    InvokeDirectCpu<0x805414A8u>(ctx);
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80591DBC func_80591DBC preserves=true fpr_mask=0x00000000
