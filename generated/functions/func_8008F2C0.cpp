...
extern "C" void func_8008F2C0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8008F304:
{
    r0 = MemoryInline::FlatRead8((r30 + 123));
...
loc_8008F3A8:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x800A3DE0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
...
loc_8008F3C0:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x800A3AB0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
...
loc_8008F3D4:
{
    ...
    ctx->gpr[30] = r30;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x80091E30u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8008F408:
{
    ...
    MemoryInline::FlatWrite8((r30 + 123), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x8008F2C0 func_8008F2C0 preserves=true fpr_mask=0x00000000
