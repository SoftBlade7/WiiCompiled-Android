...
extern "C" void func_807CE270(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_807CE270:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r31 + 2728));
...
// RECOMP_REGISTRATION base 0x807CE270 func_807CE270 preserves=false fpr_mask=0xF8000000
