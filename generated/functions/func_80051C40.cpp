...
extern "C" void func_80051C40(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
    uint32_t r0_rot_2 = 0;
...
loc_80051C50:
{
    ...
    r5 = (r5_rot_0 & -16);
    r6_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r9), static_cast<uint32_t>(7));
    r6 = (r6_rot_0 & -128);
    r3_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r8), static_cast<uint32_t>(1));
    r3 = (r3_rot_0 & -2);
    r0_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r7), static_cast<uint32_t>(2));
    r0 = (r0_rot_0 & -4);
    r8 = (r4 + 4160);
    r7_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r11), static_cast<uint32_t>(15));
    r7 = (r7_rot_0 & -32768);
    r0 = (r3 | r0);
    r5 = (r6 | r5);
    r4_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r10), static_cast<uint32_t>(12));
    r4 = (r4_rot_0 & -4096);
    r3 = r31;
    r6 = (r7 | r4);
    r0 = (r5 | r0);
...
// RECOMP_GUEST_ABI gpr_read=0xF0000F93 gpr_write=0xF00007FB gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x00 cr_write=0x00 xer_read=0 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80051C40 func_80051C40 preserves=true fpr_mask=0x00000000
