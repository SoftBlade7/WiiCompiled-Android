...
extern "C" void func_806E2624(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806E265C:
{
    r4 = 0x808C0000u;
    r3 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + 1648));
...
loc_806E2684:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r3 + 1888));
...
loc_806E26A4:
{
    r4 = 0x808A0000u;
    r3 = (r1 + 80);
    f0.d = MemoryInline::FlatReadFloat32((r4 + 1648));
    r4 = (r1 + 20);
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 80), 0, 48u, false, true);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 32u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f0.d))))) {
        ...
        MemoryInline::WriteResolvedFloat32(guest_range_1, 36u, (r1 + 116), f0.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 40u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f0.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 40u, (r1 + 120), f0.d);
        MemoryInline::WriteResolvedFloat32(guest_range_1, 44u, (r1 + 124), f0.d);
    }
...
// RECOMP_REGISTRATION base 0x806E2624 func_806E2624 preserves=true fpr_mask=0x00000000
