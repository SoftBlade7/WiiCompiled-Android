...
extern "C" void func_806AB468(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806AB468:
{
    ...
    r30 = r3;
    r31 = MemoryInline::FlatRead32((r3 + 660));
...
// RECOMP_REGISTRATION base 0x806AB468 func_806AB468 preserves=true fpr_mask=0x00000000
