...
extern "C" void func_8072B500(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8072B500:
{
    ...
    ctx->fpr[0] = f0;
    ctx->fpr[1] = f1;
    InvokeDirectCpu<0x8072C5E8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    f1.d = MemoryInline::FlatReadFloat32((r3 + 9560));
    r3 = 0x808A0000u;
    ...
    r0 = 0;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 9588));
    r3 = r31;
    ...
    ctx->fpr[0] = f0;
    ctx->fpr[1] = f1;
    InvokeDirectCpu<0x8072B680u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8072B500 func_8072B500 preserves=true fpr_mask=0x00000000
