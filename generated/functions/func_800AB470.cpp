...
extern "C" void func_800AB470(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800AB4D0:
{
    r23 = MemoryInline::FlatRead32((r29 + 12));
}
...
loc_800AB4E0:
{
    if ((static_cast<uint32_t>(r23) != static_cast<uint32_t>(r22))) {
        goto loc_800AB4FC;
    }
}
...
{
    r0 = 0;
    MemoryInline::FlatWrite8((r28 + 159), static_cast<uint8_t>(r0));
    MemoryInline::FlatWrite8((r28 + 157), static_cast<uint8_t>(r0));
    MemoryInline::FlatWrite32((r28 + 140), r0);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_800AB584;
    }
}
...
loc_800AB584:
{
    r12 = MemoryInline::FlatRead32((r28 + 148));
...
// RECOMP_REGISTRATION base 0x800AB470 func_800AB470 preserves=true fpr_mask=0x00000000
