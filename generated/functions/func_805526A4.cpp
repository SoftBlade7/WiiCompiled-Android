...
extern "C" void func_805526A4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805526A4:
{
    ...
    r30 = -1;
    r27 = (r27 + -3912);
    r25 = MemoryInline::FlatRead32((r29 + 184));
    r24 = MemoryInline::FlatRead32((r29 + 188));
}
...
loc_80552710:
{
    MemoryInline::FlatWriteRam32((r29 + 168), r30);
}
...
loc_8055272C:
{
    MemoryInline::FlatWrite32((r26 + 4), r31);
    r4 = r26;
    r3 = (r27 + 40);
    r5 = 1;
    ctx->lr = 0x80552740u;
...
loc_8055277C:
{
    r25 = MemoryInline::FlatRead32((r29 + 100));
    goto loc_8055278C;
}
...
// RECOMP_REGISTRATION base 0x805526A4 func_805526A4 preserves=true fpr_mask=0x00000000
