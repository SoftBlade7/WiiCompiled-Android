...
extern "C" void func_801326E0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80132760:
{
    ...
    r4 = 0;
    MemoryInline::FlatWriteRam8((r5 + 114), static_cast<uint8_t>(r0));
    ctr = r12;
    ctx->lr = 0x80132784u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x801326E0 func_801326E0 preserves=true fpr_mask=0x00000000
