...
extern "C" void func_80637AD0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80637AD0:
{
    ...
    MemoryInline::FlatWrite32((r31 + 380), r5);
...
// RECOMP_REGISTRATION base 0x80637AD0 func_80637AD0 preserves=true fpr_mask=0x00000000
