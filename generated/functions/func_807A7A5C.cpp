...
extern "C" void func_807A7A5C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807A7A98:
{
    r4 = 0x808A0000u;
    r3 = r31;
    f1.d = MemoryInline::FlatReadFloat32((r4 + 22208));
    r4 = 256;
    ctx->lr = 0x807A7AACu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x807A7A5C func_807A7A5C preserves=true fpr_mask=0x00000000
