...
extern "C" void func_801FBC3C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r0 = (r26 + -1);
    MemoryInline::FlatWrite32((r25 + 8), r30);
...
// RECOMP_REGISTRATION base 0x801FBC3C func_801FBC3C preserves=true fpr_mask=0x00000000
