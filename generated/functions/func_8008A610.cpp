...
extern "C" void func_8008A610(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8008A61C:
{
    ctx->gpr[3] = r3;
    ctx->cr = cr;
    InvokeDirectCpu<0x801252F8u>(ctx);
    r3 = ctx->gpr[3];
    cr = ctx->cr;
    ctx->gpr[3] = r3;
    ctx->cr = cr;
...
// RECOMP_REGISTRATION base 0x8008A610 func_8008A610 preserves=true fpr_mask=0x00000000
