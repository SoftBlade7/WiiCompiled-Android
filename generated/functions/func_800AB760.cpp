...
extern "C" void func_800AB760(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800AB760:
{
    guest_range_2 = MemoryInline::ResolveRangeHost((r1 + -432), 0, 440u, false, true);
    MemoryInline::WriteResolved32(guest_range_2, 0u, (r1 + -432), r1);
    r1 = (r1 + -432);
    r0 = ctx->lr;
    MemoryInline::WriteResolved32(guest_range_2, 436u, (r1 + 436), r0);
    MemoryInline::WriteResolvedFloat64(guest_range_2, 416u, (r1 + 416), f31.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_0 = (r1 + 424);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_0, PPC_PsFromScalarInline(f31.d));
    MemoryInline::WriteResolvedFloat64(guest_range_2, 400u, (r1 + 400), f30.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_1 = (r1 + 408);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_1, PPC_PsFromScalarInline(f30.d));
    MemoryInline::WriteResolvedFloat64(guest_range_2, 384u, (r1 + 384), f29.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_2 = (r1 + 392);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_2, PPC_PsFromScalarInline(f29.d));
    MemoryInline::WriteResolvedFloat64(guest_range_2, 368u, (r1 + 368), f28.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_3 = (r1 + 376);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_3, PPC_PsFromScalarInline(f28.d));
    MemoryInline::WriteResolvedFloat64(guest_range_2, 352u, (r1 + 352), f27.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_4 = (r1 + 360);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_4, PPC_PsFromScalarInline(f27.d));
    MemoryInline::WriteResolvedFloat64(guest_range_2, 336u, (r1 + 336), f26.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_5 = (r1 + 344);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_5, PPC_PsFromScalarInline(f26.d));
    MemoryInline::WriteResolvedFloat64(guest_range_2, 320u, (r1 + 320), f25.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_6 = (r1 + 328);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_6, PPC_PsFromScalarInline(f25.d));
    MemoryInline::WriteResolvedFloat64(guest_range_2, 304u, (r1 + 304), f24.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_7 = (r1 + 312);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_7, PPC_PsFromScalarInline(f24.d));
    MemoryInline::WriteResolvedFloat64(guest_range_2, 288u, (r1 + 288), f23.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_8 = (r1 + 296);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_8, PPC_PsFromScalarInline(f23.d));
    MemoryInline::WriteResolvedFloat64(guest_range_2, 272u, (r1 + 272), f22.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_9 = (r1 + 280);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_9, PPC_PsFromScalarInline(f22.d));
    MemoryInline::WriteResolvedFloat64(guest_range_2, 256u, (r1 + 256), f21.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_10 = (r1 + 264);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_10, PPC_PsFromScalarInline(f21.d));
    MemoryInline::WriteResolvedFloat64(guest_range_2, 240u, (r1 + 240), f20.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_11 = (r1 + 248);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_11, PPC_PsFromScalarInline(f20.d));
    MemoryInline::WriteResolvedFloat64(guest_range_2, 224u, (r1 + 224), f19.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_12 = (r1 + 232);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_12, PPC_PsFromScalarInline(f19.d));
    MemoryInline::WriteResolvedFloat64(guest_range_2, 208u, (r1 + 208), f18.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_13 = (r1 + 216);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_13, PPC_PsFromScalarInline(f18.d));
    MemoryInline::WriteResolvedFloat64(guest_range_2, 192u, (r1 + 192), f17.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_14 = (r1 + 200);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_14, PPC_PsFromScalarInline(f17.d));
    MemoryInline::WriteResolvedFloat64(guest_range_2, 176u, (r1 + 176), f16.d);
    // psq_store w=0 quant=0 (using PPC_PsqSt)
    r1_psq_tmp_15 = (r1 + 184);
    PPC_PsqStStackInline<0u, 0u>(ctx, r1_psq_tmp_15, PPC_PsFromScalarInline(f16.d));
    guest_range_0 = MemoryInline::ResolveRangeHost((r2 + -28024), 0, 44u, true, false);
    f2.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 4u, (r2 + -28020));
    MemoryInline::WriteResolved32(guest_range_2, 172u, (r1 + 172), r31);
    r31 = r7;
    f3.d = f2.d;
    MemoryInline::WriteResolved32(guest_range_2, 168u, (r1 + 168), r30);
    f4.d = f2.d;
    f0.d = f2.d;
    r30 = r6;
    MemoryInline::WriteResolved32(guest_range_2, 164u, (r1 + 164), r29);
    f5.d = f2.d;
    r29 = r5;
    MemoryInline::WriteResolved32(guest_range_2, 160u, (r1 + 160), r28);
    r28 = r3;
    guest_range_1 = MemoryInline::ResolveRangeHost((r3 + 140), 0, 136u, true, false);
    r10 = MemoryInline::ReadResolved32(guest_range_1, 40u, (r3 + 180));
    r0 = (r10 & 1);
}
...
{
    r0 = (r5 * 24);
    f1.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 52u, (r3 + 192));
    f4.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 0u, (r2 + -28024));
    f2.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 44u, (r3 + 184));
    r6 = (r3 + r0);
    f3.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 48u, (r3 + 188));
...
{
    {
        ...
        if (resolved_pair.valid) {
            ...
            f0.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 56u, (r3 + 196));
            f5.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 60u, (r3 + 200));
        }
    }
}
...
loc_800AB874:
{
    ...
    f30.d = PpcFmulsInline(f2.d, f4.d);
    r7 = r28;
    f29.d = PpcFmulsInline(f2.d, f0.d);
    r8 = (r1 + 144);
    f28.d = PpcFmulsInline(f2.d, f5.d);
    r9 = (r1 + 128);
    r11 = 0;
    ctr = r6;
    // nop
...
{
    f2.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 4u, (r2 + -28020));
    r0 = PPC_Slw(static_cast<uint32_t>(r6), static_cast<uint32_t>(r11));
    r0 = (r10 & r0);
    f1.d = f2.d;
    f3.d = f2.d;
    if ((static_cast<int32_t>(r0) == static_cast<int32_t>(0))) {
...
loc_800AB8B8:
{
    f2.d = MemoryInline::FlatReadFloat32((r7 + 204));
    f1.d = MemoryInline::FlatReadFloat32((r7 + 220));
    f3.d = MemoryInline::FlatReadFloat32((r7 + 236));
}
...
loc_800AB8F0:
{
    f2.d = MemoryInline::FlatReadFloat32((r7 + 208));
    f1.d = MemoryInline::FlatReadFloat32((r7 + 224));
    f3.d = MemoryInline::FlatReadFloat32((r7 + 240));
}
...
loc_800AB8FC:
{
    ...
    f0.d = PpcFmulsInline(f2.d, f3.d);
    r11 = (r11 + 1);
    MemoryInline::FlatWriteFloat32((r8 + 4), f1.d);
    r8 = (r8 + 8);
...
loc_800AB920:
{
    ...
    MemoryInline::FlatWriteRam8((r1 + 44), static_cast<uint8_t>(r7));
    MemoryInline::FlatWriteRam8((r1 + 45), static_cast<uint8_t>(r7));
    r0 = MemoryInline::ReadResolved32(guest_range_1, 132u, (r3 + 272));
}
...
loc_800AB9F0:
{
    r6 = MemoryInline::ReadResolved32(guest_range_1, 0u, (r3 + 140));
}
...
loc_800AB9FC:
{
    r0 = MemoryInline::ReadResolved32(guest_range_1, 128u, (r3 + 268));
}
...
loc_800ABA08:
{
    r0 = (r5 * 24);
    {
        ...
        if (resolved_pair.valid) {
            ...
            f3.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 28u, (r3 + 168));
            f2.d = MemoryInline::ReadResolvedFloat32(guest_range_1, 32u, (r3 + 172));
        }
    }
...
{
    f1.d = (-(f1.d));
    f27.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 4u, (r2 + -28020));
    r3 = (r1 + 40);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_800ABA8C:
{
    f16.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 4u, (r2 + -28020));
    if (((cr & 0x20000000u) == 0)) {
        goto loc_800ABAAC;
    }
}
...
loc_800ABA9C:
{
    f16.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 40u, (r2 + -27984));
}
...
loc_800ABAA8:
{
    f16.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 0u, (r2 + -28024));
}
...
loc_800ABCDC:
{
    guest_range_3 = MemoryInline::ResolveRangeHost((r1 + 128), 0, 32u, true, false);
    f1.d = MemoryInline::ReadResolvedFloat32(guest_range_3, 16u, (r1 + 144));
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_3, 0u, (r1 + 128));
    f8.d = PpcFmulsInline(f25.d, f1.d);
    f2.d = MemoryInline::ReadResolvedFloat32(guest_range_3, 20u, (r1 + 148));
    f7.d = PpcFmulsInline(f25.d, f0.d);
    f1.d = MemoryInline::ReadResolvedFloat32(guest_range_3, 4u, (r1 + 132));
    f6.d = PpcFmulsInline(f25.d, f2.d);
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_3, 24u, (r1 + 152));
    f5.d = PpcFmulsInline(f25.d, f1.d);
    f3.d = MemoryInline::ReadResolvedFloat32(guest_range_3, 8u, (r1 + 136));
    f4.d = PpcFmulsInline(f25.d, f0.d);
    f2.d = MemoryInline::ReadResolvedFloat32(guest_range_3, 28u, (r1 + 156));
    f1.d = MemoryInline::ReadResolvedFloat32(guest_range_3, 12u, (r1 + 140));
...
loc_800AC230:
{
    ...
    guest_range_4 = MemoryInline::ResolveRangeHost((r1 + 160), 0, 280u, true, false);
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 256u, (r1 + 416));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f30.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 240u, (r1 + 400));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f29.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 224u, (r1 + 384));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f28.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 208u, (r1 + 368));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f27.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 192u, (r1 + 352));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f26.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 176u, (r1 + 336));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f25.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 160u, (r1 + 320));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f24.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 144u, (r1 + 304));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f23.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 128u, (r1 + 288));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f22.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 112u, (r1 + 272));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f21.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 96u, (r1 + 256));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f20.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 80u, (r1 + 240));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f19.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 64u, (r1 + 224));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f18.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 48u, (r1 + 208));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f17.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 32u, (r1 + 192));
    // psq_load w=0 quant=0 (using PPC_PsqL)
    f16.d = MemoryInline::ReadResolvedFloat64(guest_range_4, 16u, (r1 + 176));
    {
        ...
        if (resolved_pair.valid) {
            ...
            r31 = MemoryInline::ReadResolved32(guest_range_4, 12u, (r1 + 172));
            r30 = MemoryInline::ReadResolved32(guest_range_4, 8u, (r1 + 168));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r29 = MemoryInline::ReadResolved32(guest_range_4, 4u, (r1 + 164));
            r28 = MemoryInline::ReadResolved32(guest_range_4, 0u, (r1 + 160));
        }
    }
    r0 = MemoryInline::ReadResolved32(guest_range_4, 276u, (r1 + 436));
    ctx->lr = r0;
    r1 = (r1 + 432);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x800AB760 func_800AB760 preserves=false fpr_mask=0xFFFF0000
