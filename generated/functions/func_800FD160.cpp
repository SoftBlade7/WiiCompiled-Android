...
extern "C" void func_800FD160(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800FD160:
{
    MemoryInline::FlatWriteRam32((r1 + -4528), r1);
    r1 = (r1 + -4528);
    r0 = ctx->lr;
    MemoryInline::FlatWriteRam32((r1 + 4532), r0);
    r11 = (r1 + 4528);
...
loc_800FD294:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r24), static_cast<int32_t>(101));
}
...
loc_800FD2A0:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r24), static_cast<int32_t>(100));
}
...
loc_800FD2AC:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r24), static_cast<int32_t>(103));
}
...
loc_800FD36C:
{
    ...
    r5 = r24;
    MemoryInline::FlatWriteRam32((r24 + 4), r31);
    r4 = (r1 + 104);
...
loc_800FD3B0:
{
    ...
    r0 = MemoryInline::FlatRead32((r28 + 460));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(0));
}
...
{
    r25 = 0;
    MemoryInline::FlatWriteRam8(r3, static_cast<uint8_t>(r25));
    r3 = (r3 + 8);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_800FD598:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r24 + 20), r25);
    r3 = (r27 + 8);
    ctx->lr = 0x800FD5ACu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    r3 = MemoryInline::FlatRead32((r24 + 24));
    r0 = (r3 + 1);
    MemoryInline::FlatWrite32((r24 + 24), r0);
    r3 = MemoryInline::FlatRead32((r28 + 432));
    r0 = MemoryInline::FlatRead32((r28 + 436));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(0));
}
...
loc_800FD648:
{
    r3 = MemoryInline::FlatRead32((r28 + 480));
...
loc_800FD7B0:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801065C8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800FD7D0:
{
    r4 = MemoryInline::FlatRead32((r28 + 1488));
    r3 = MemoryInline::FlatRead32((r25 + 8));
    r0 = (r4 + 1);
    MemoryInline::FlatWrite32(r3, r4);
    MemoryInline::FlatWrite32((r28 + 1488), r0);
}

loc_800FD7E4:
{
    r24 = MemoryInline::FlatRead32((r25 + 8));
    r3 = r27;
    r5 = (r1 + 392);
    r4 = (r13 + -31388);
    r6 = 4096;
...
loc_800FD870:
{
    ...
    r27 = 0;
    r3 = (r1 + 392);
    MemoryInline::FlatWrite32((r24 + 8), r27);
    r5 = (r1 + 136);
    r4 = (r13 + -31376);
    r6 = 256;
    ctx->lr = 0x800FD8A0u;
...
loc_800FD8A8:
{
    MemoryInline::FlatWriteRam8((r1 + 136), static_cast<uint8_t>(r27));
}
...
loc_800FD8D4:
{
    ...
    r27 = 0;
    r3 = (r1 + 392);
    MemoryInline::FlatWrite32((r24 + 12), r27);
    r5 = (r1 + 136);
    r4 = (r13 + -31368);
    r6 = 256;
    ctx->lr = 0x800FD8F8u;
...
loc_800FD910:
{
    MemoryInline::FlatWrite32((r24 + 12), r3);
    if (((cr & 0x20000000u) == 0)) {
        goto loc_800FD92C;
    }
}
...
loc_800FD954:
{
    ...
    MemoryInline::FlatWrite32((r24 + 16), r3);
}
...
loc_800FD98C:
{
    ...
    MemoryInline::FlatWrite16((r24 + 20), static_cast<uint16_t>(r3));
}
...
loc_800FD9C8:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r24 + 24), r3);
}

loc_800FD9D4:
{
    r3 = MemoryInline::FlatRead32((r28 + 440));
    r0 = MemoryInline::FlatRead32((r28 + 444));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(0));
}
...
loc_800FDA10:
{
    ...
    r4 = (r1 + 64);
    r9 = MemoryInline::FlatRead32(r24);
    r6 = 0;
    r0 = MemoryInline::FlatRead32((r1 + 44));
    r7 = 5;
    MemoryInline::FlatWriteRam32((r3 + 8), r9);
    MemoryInline::FlatWriteRam32((r3 + 4), r31);
    r3 = r26;
    MemoryInline::FlatWriteRam32((r1 + 64), r8);
...
{
    r0 = 0;
    MemoryInline::FlatWriteRam8((r1 + 136), static_cast<uint8_t>(r0));
}

loc_800FDB48:
{
    r3 = MemoryInline::FlatRead32((r28 + 464));
    r0 = MemoryInline::FlatRead32((r28 + 468));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(0));
}
...
loc_800FDC34:
{
    ...
    r0 = MemoryInline::FlatRead32((r1 + 4532));
    ctx->lr = r0;
    r1 = (r1 + 4528);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x800FD160 func_800FD160 preserves=true fpr_mask=0x00000000
