...
extern "C" void func_80090D40(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80090D40:
{
    ...
    r3 = ctx->gpr[3];
    r0 = MemoryInline::FlatRead8((r13 + -27192));
    r29 = r3;
...
loc_80090D7C:
{
    ...
    r5 = (r5 + 22680);
    MemoryInline::FlatWriteRam32((r6 + 22692), r0);
    ...
    r0 = 1;
    MemoryInline::FlatWrite8((r13 + -27192), static_cast<uint8_t>(r0));
}
...
loc_80090DBC:
{
    ...
    r3 = ctx->gpr[3];
    r29 = MemoryInline::FlatRead32((r21 + 4));
    r27 = (r21 + 4);
    r23 = 0;
    r24 = 0x80090000u;
    r25 = 0x802D0000u;
...
loc_80090E1C:
{
    MemoryInline::FlatWriteRam32((r21 + 4), r23);
    r6 = (r21 + 4);
    r3 = r21;
    r4 = (r24 + 3232);
    MemoryInline::FlatWriteRam32((r21 + 8), r23);
    r5 = (r25 + 22680);
    MemoryInline::FlatWriteRam32((r22 + 22692), r23);
    MemoryInline::FlatWriteRam32((r21 + 4), r6);
    MemoryInline::FlatWriteRam32((r21 + 8), r6);
    // inline leaf 0x80021338 (6 guest instruction(s))
    r0 = MemoryInline::FlatRead32((r13 + -27476));
    MemoryInline::FlatWriteRam32(r5, r0);
    MemoryInline::FlatWriteRam32((r5 + 4), r4);
    ...
    MemoryInline::FlatWrite32((r13 + -27476), r5);
    // end of inlined leaf 0x80021338
    MemoryInline::FlatWrite8((r13 + -27192), static_cast<uint8_t>(r26));
}
...
// RECOMP_REGISTRATION base 0x80090D40 func_80090D40 preserves=true fpr_mask=0x00000000
