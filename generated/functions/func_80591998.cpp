...
extern "C" void func_80591998(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80591998:
{
    ...
    ctx->gpr[7] = r7;
    ctx->gpr[8] = r8;
    InvokeDirectCpu<0x8056BD08u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80591998 func_80591998 preserves=true fpr_mask=0x00000000
