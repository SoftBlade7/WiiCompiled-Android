...
extern "C" void func_80215030(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r3 = (r3 + 60);
    // inline leaf 0x8015BD98 (2 guest instruction(s))
    r3 = 0;
    // end of inlined leaf 0x8015BD98
...
// RECOMP_REGISTRATION base 0x80215030 func_80215030 preserves=true fpr_mask=0x00000000
