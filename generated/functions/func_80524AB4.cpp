...
extern "C" void func_80524AB4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80524AB4:
{
    r3 = 0x809C0000u;
    r0 = -268435456;
    MemoryInline::FlatWriteRam32((r3 + -10488), r0);
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80524AB4 func_80524AB4 preserves=true fpr_mask=0x00000000
