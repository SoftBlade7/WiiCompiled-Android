...
extern "C" void func_800E0F90(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800E1064:
{
    ...
    r4 = MemoryInline::FlatRead32((r30 + 1920));
...
loc_800E1090:
{
    ...
    r3 = MemoryInline::FlatRead32((r30 + 1920));
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r12 = MemoryInline::FlatRead32((r30 + 2160));
    r7 = r3;
    r5 = r29;
    r6 = r28;
    r8 = MemoryInline::FlatRead32((r30 + 2164));
    r3 = 0;
    r4 = 1;
    ctr = r12;
    ctx->lr = 0x800E10C4u;
...
loc_800E10F4:
{
    ...
    r28_rot_5 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(27));
    r28 = (r28_rot_5 & 134217727);
    ctx->lr = 0x800E1108u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x800E0F90 func_800E0F90 preserves=true fpr_mask=0x00000000
