...
extern "C" void func_805C5918(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805C5918:
{
    ...
    r4 = MemoryInline::FlatRead16((r4 + 54));
    r4 = (r4 << 16);
    r4 = (static_cast<int32_t>(r4) >> 16);
    r4 = (r5 + r4);
    r4 = MemoryInline::FlatRead8((r4 + 1216));
    MemoryInline::FlatWrite8((r3 + 10356), static_cast<uint8_t>(r4));
    MemoryInline::FlatWrite32((r3 + 10364), r0);
...
// RECOMP_REGISTRATION base 0x805C5918 func_805C5918 preserves=true fpr_mask=0x00000000
