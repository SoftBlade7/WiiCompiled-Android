...
extern "C" void func_80795CA0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80795CA0:
{
    ...
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x807A92B0u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80795CA0 func_80795CA0 preserves=true fpr_mask=0x00000000
