...
extern "C" void func_80773970(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
{
    r3 = 0x809C0000u;
    r30_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r29), static_cast<uint32_t>(31));
    r30 = (r30_rot_1 & 32767);
    r27_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r28), static_cast<uint32_t>(31));
    r27 = (r27_rot_1 & 32767);
    ...
    r0_rot_6 = PpcRotl32Inline(static_cast<uint32_t>(r28), static_cast<uint32_t>(1));
    r0 = (r0_rot_6 & 131070);
    r26 = (r29 * r0);
...
loc_inl6_cont_8051BED0:
{
    ...
    r4 = 0x808A0000u;
    r3 = (r1 + 72);
    f1.d = MemoryInline::FlatReadFloat32((r4 + 16536));
    r4 = 1;
    r5 = 1;
    r6 = 0;
    f2.d = f1.d;
    ...
    r3 = 0x809C0000u;
    r29 = MemoryInline::FlatRead32((r3 + 17200));
...
loc_80773B24:
{
    MemoryInline::FlatWrite32((r29 + 92), r28);
}

loc_80773B28:
{
    r28 = MemoryInline::FlatRead32((r29 + 92));
    r4 = 100;
    r5 = 1;
    r6 = 1;
    r3 = r28;
    ...
    r3 = 0x808A0000u;
    r6 = 2;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 16540));
    r30 = (r1 + 72);
...
// RECOMP_REGISTRATION base 0x80773970 func_80773970 preserves=true fpr_mask=0x00000000
