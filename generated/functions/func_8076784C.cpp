...
extern "C" void func_8076784C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lhax_80767880_loc_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8076784C:
{
    ...
    addr_lhax_80767880_loc_0 = (r3 + r0);
    r0 = MemoryInline::FlatRead16(addr_lhax_80767880_loc_0);
    r0 = (r0 << 16);
...
// RECOMP_REGISTRATION base 0x8076784C func_8076784C preserves=true fpr_mask=0x00000000
