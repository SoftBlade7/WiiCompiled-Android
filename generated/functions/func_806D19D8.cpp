...
extern "C" void func_806D19D8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_806D19D8:
{
    ...
    r0 = (r0 | 1);
    f3.d = MemoryInline::FlatReadFloat32((r5 + 24));
...
loc_806D1B00:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    f3.d = MemoryInline::FlatReadFloat32((r30 + 200));
    r3 = r30;
    ...
    MemoryInline::FlatWriteFloat32((r30 + 192), f2.d);
...
// RECOMP_REGISTRATION base 0x806D19D8 func_806D19D8 preserves=true fpr_mask=0x00000000
