...
extern "C" void func_800E7AE0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r3_rot_0 = 0;
...
loc_800E7AE0:
{
    ...
    r3 = 2;
    r4 = MemoryInline::FlatRead32((r4 + 1820));
    r4 = (r4 + -8);
    r0 = (2 - r4);
...
// RECOMP_REGISTRATION base 0x800E7AE0 func_800E7AE0 preserves=true fpr_mask=0x00000000
