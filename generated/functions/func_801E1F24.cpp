...
extern "C" void func_801E1F24(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r5_rot_0 = 0;
    uint32_t r5_rot_1 = 0;
...
{
    r3 = 0;
    // inline leaf 0x801DD228 (2 guest instruction(s))
    MemoryInline::FlatWrite32((r13 + -24372), r3);
    // end of inlined leaf 0x801DD228
    r3 = r25;
    ctx->lr = 0x801E1F88u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801E2C24u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801E1F94:
{
    ...
    ctx->gpr[5] = r5;
    ctx->cr = cr;
    InvokeDirectCpu<0x801E2CF4u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
...
loc_801E1FA8:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801E2D94u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801E1FC0:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801DEE0Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801E1FEC:
{
    ...
    MemoryInline::FlatWrite32((r13 + -24352), r28);
    if (((cr & 0x20000000u) == 0)) {
        goto loc_801E20A0;
    }
}
...
loc_801E2000:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801E3220u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801E2024:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801E3308u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801E2048:
{
    r23 = MemoryInline::FlatRead32((r13 + -24384));
    r4 = (r13 + -28144);
    r3 = r23;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_801E20A0:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801E3688u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801E20C4:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801E3420u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801E20E8:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801E3520u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801E210C:
{
    r29 = MemoryInline::FlatRead32((r13 + -24384));
    ...
    r8 = MemoryInline::FlatRead32((r25 + 40));
    ...
    ctx->gpr[6] = r6;
    ctx->cr = cr;
    InvokeDirectCpu<0x801DA090u>(ctx);
    r0 = ctx->gpr[0];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
    r6 = ctx->gpr[6];
...
loc_801E2200:
{
    ...
    r3 = r29;
    r5 = MemoryInline::FlatRead32((r25 + 68));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
loc_801E22C8:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801E37C0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801E2300:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r5 = MemoryInline::FlatRead32((r25 + 24));
    r3 = r23;
    r4 = (r31 + 48);
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x801E2328u;
...
loc_801E2410:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r5 = MemoryInline::FlatRead32((r25 + 236));
    r3 = r23;
    r4 = (r31 + 88);
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x801E2438u;
...
loc_801E2484:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801E39DCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801E24A8:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801E38DCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801E267C:
{
    ...
    r3 = r24;
    r4 = (r31 + 184);
    r5_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r23), static_cast<uint32_t>(16));
    r5 = (r5_rot_1 & 65535);
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x801E26A4u;
    ctx->gpr[0] = r0;
...
loc_801E26F4:
{
    r4 = MemoryInline::FlatRead32((r25 + 212));
...
loc_801E2708:
{
    r3 = MemoryInline::FlatRead32((r25 + 208));
    r5 = MemoryInline::FlatRead32((r13 + -24352));
    ctx->lr = 0x801E2714u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
{
    r4 = MemoryInline::FlatRead32((r25 + 8));
    r0 = MemoryInline::FlatRead32((r25 + 212));
    r0 = (r4 + r0);
    MemoryInline::FlatWrite32((r25 + 8), r0);
}
...
loc_801E2748:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r5 = MemoryInline::FlatRead32((r25 + 40));
    r3 = (r28 + 28128);
    r6 = MemoryInline::FlatRead32(r25);
    r4 = (r31 + 208);
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x801E2774u;
    ctx->gpr[0] = r0;
...
loc_801E281C:
{
    ...
    r4 = 0;
    r5 = 1024;
    MemoryInline::FlatWrite32((r25 + 16), r0);
    r23 = MemoryInline::FlatRead32((r13 + -24384));
    r3 = r23;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_801E28A8:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801E3C4Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801E28E0:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801E3D80u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801E29BC:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801E3ADCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801E2A30:
{
    ...
    r3 = MemoryInline::FlatRead8((r25 + 201));
    r0 = (r3 + -1);
...
loc_801E2ADC:
{
    r0 = MemoryInline::FlatRead8((r25 + 201));
...
loc_801E2AFC:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801DF0D8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801DF4A8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801E2B88:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801DF2DCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801E2BC0:
{
    // inline leaf 0x801DD030 (5 guest instruction(s))
    r0 = MemoryInline::FlatRead32((r13 + -24376));
    r0 = (r0 | r3);
    r3 = 0;
    MemoryInline::FlatWrite32((r13 + -24376), r0);
    // end of inlined leaf 0x801DD030
}
...
loc_801E2BDC:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r27), static_cast<int32_t>(-38));
}
...
loc_801E2BE4:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r27), static_cast<int32_t>(-41));
}
...
loc_801E2BEC:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r27), static_cast<int32_t>(-43));
}
...
loc_801E2BF4:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r27), static_cast<int32_t>(-46));
}
...
// RECOMP_REGISTRATION base 0x801E1F24 func_801E1F24 preserves=true fpr_mask=0x00000000
