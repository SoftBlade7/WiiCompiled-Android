...
extern "C" void func_8019C30C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8019C330:
{
    ...
    r6 = MemoryInline::FlatRead32((r31 + 44));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
// RECOMP_REGISTRATION base 0x8019C30C func_8019C30C preserves=true fpr_mask=0x00000000
