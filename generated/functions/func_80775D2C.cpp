...
extern "C" void func_80775D2C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80775D50:
{
    r4 = 0x808A0000u;
    r5 = 5;
    f0.d = MemoryInline::FlatReadFloat32((r4 + 16916));
    r0 = 180;
...
loc_80775E14:
{
    ...
    xer = ctx->xer;
    r0 = (r3 & 65535);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r0), static_cast<uint32_t>(216));
}
...
// RECOMP_REGISTRATION base 0x80775D2C func_80775D2C preserves=true fpr_mask=0x00000000
