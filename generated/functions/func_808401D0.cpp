...
extern "C" void func_808401D0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_808401D0:
{
    ...
    r3 = 0x809C0000u;
    r4 = (r4 + 17720);
    MemoryInline::FlatWriteRam32((r3 + 17784), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x808401D0 func_808401D0 preserves=true fpr_mask=0x00000000
