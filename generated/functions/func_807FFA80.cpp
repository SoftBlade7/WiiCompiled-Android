...
extern "C" void func_807FFA80(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807FFA80:
{
    r3 = MemoryInline::FlatRead16((r3 + 176));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x807FFA80 func_807FFA80 preserves=true fpr_mask=0x00000000
