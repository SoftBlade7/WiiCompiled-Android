...
extern "C" void func_80754C44(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80754C44:
{
    ...
    ctx->lr = 0x80754C4Cu;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80756C10u>(ctx);
    r3 = ctx->gpr[3];
    r29 = ctx->gpr[29];
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80754C44 func_80754C44 preserves=true fpr_mask=0x00000000
