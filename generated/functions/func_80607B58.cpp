...
extern "C" void func_80607B58(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80607B58:
{
    ...
    r30 = r3;
    r4 = (r31 + 147);
    r5 = MemoryInline::FlatRead32((r3 + 424));
    ...
    r3 = r30;
    r6 = MemoryInline::FlatRead32((r30 + 428));
    r4 = (r31 + 153);
    r7 = 2;
    ctx->lr = 0x80607BA4u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x80607B58 func_80607B58 preserves=true fpr_mask=0x00000000
