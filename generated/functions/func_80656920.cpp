...
extern "C" void func_80656920(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r0 = 1;
    MemoryInline::FlatWrite8((r29 + 10071), static_cast<uint8_t>(r0));
    goto loc_80656990;
}
...
loc_80656978:
{
    MemoryInline::FlatWrite32((r29 + 48), r31);
    if (((cr & 0x40000000u) == 0)) {
        goto loc_80656988;
    }
}
...
// RECOMP_REGISTRATION base 0x80656920 func_80656920 preserves=true fpr_mask=0x00000000
