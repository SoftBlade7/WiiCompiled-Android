...
extern "C" void func_805F95C0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805F95C0:
{
    ...
    r31 = r3;
    MemoryInline::FlatWrite32((r3 + 416), r4);
    r4 = 0;
    ...
    r31 = ctx->gpr[31];
    r0 = -1;
    MemoryInline::FlatWrite32((r31 + 1540), r0);
...
// RECOMP_REGISTRATION base 0x805F95C0 func_805F95C0 preserves=true fpr_mask=0x00000000
