...
extern "C" void func_8077EBB8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8077EBD8:
{
    ...
    r3 = (r1 + 20);
    f1.d = MemoryInline::FlatReadFloat32((r4 + 17824));
    r4 = (r31 + 48);
    MemoryInline::FlatWriteRam32((r1 + 32), r5);
    r5 = (r1 + 8);
    f0.d = MemoryInline::FlatReadFloat32((r6 + 17836));
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_0, 96u, (r31 + 96));
    ...
    MemoryInline::FlatWriteRam32((r1 + 40), r6);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_0, 104u, (r31 + 104));
    ...
    MemoryInline::FlatWriteRam32((r1 + 48), r6);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_0, 112u, (r31 + 112));
    ...
    MemoryInline::FlatWriteRam32((r1 + 56), r6);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_0, 120u, (r31 + 120));
    ...
    MemoryInline::FlatWriteRam32((r1 + 64), r6);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r6 = MemoryInline::ReadResolved32(guest_range_0, 128u, (r31 + 128));
...
// RECOMP_REGISTRATION base 0x8077EBB8 func_8077EBB8 preserves=true fpr_mask=0x00000000
