...
extern "C" void func_80623288(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80623288:
{
    ...
    r0 = (r0_rot_1 & -4);
    r3 = (r31 + r0);
    MemoryInline::FlatWrite32((r3 + 852), r4);
...
// RECOMP_REGISTRATION base 0x80623288 func_80623288 preserves=true fpr_mask=0x00000000
