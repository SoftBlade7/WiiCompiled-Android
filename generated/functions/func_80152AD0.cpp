...
extern "C" void func_80152AD0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80152AD0:
{
    ...
    ctx->gpr[30] = r30;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x80152F40u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80152AD0 func_80152AD0 preserves=true fpr_mask=0x00000000
