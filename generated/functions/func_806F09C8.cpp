...
extern "C" void func_806F09C8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806F09C8:
{
    ...
    r0 = MemoryInline::FlatRead32((r3 + 8880));
...
{
    r4 = 0x809C0000u;
    MemoryInline::FlatWriteRam32((r4 + 8880), r3);
}
...
loc_inl0_cont_8051BED0:
{
    ...
    ctx->gpr[4] = r4;
    ctx->cr = cr;
    InvokeDirectCpu<0x806F0AD8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x806F09C8 func_806F09C8 preserves=true fpr_mask=0x00000000
