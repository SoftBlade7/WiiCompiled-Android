...
extern "C" void func_8010F4CC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8010F50C:
{
    MemoryInline::FlatWrite16((r29 + 2), static_cast<uint16_t>(r3));
    if (((cr & 0x20000000u) == 0)) {
        goto loc_8010F520;
    }
}
...
// RECOMP_REGISTRATION base 0x8010F4CC func_8010F4CC preserves=true fpr_mask=0x00000000
