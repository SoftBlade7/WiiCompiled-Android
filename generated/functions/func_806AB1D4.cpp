...
extern "C" void func_806AB1D4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806AB20C:
{
    r3 = MemoryInline::FlatRead32((r3 + 580));
...
// RECOMP_REGISTRATION base 0x806AB1D4 func_806AB1D4 preserves=true fpr_mask=0x00000000
