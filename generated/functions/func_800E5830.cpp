...
extern "C" void func_800E5830(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800E58A0:
{
    ...
    r4_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r6), static_cast<uint32_t>(8));
    r4 = (r4_rot_1 & -16777216);
    r3_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r8), static_cast<uint32_t>(24));
    ...
    r4_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r6), static_cast<uint32_t>(8));
    ...
    r5 = (r5_rot_3 & -1);
    r3_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r8), static_cast<uint32_t>(24));
    ...
    r4 = (static_cast<int32_t>(r7) >> 8);
    r0 = (r3 | r0);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r5), static_cast<uint32_t>(90));
}

loc_800E58F0:
{
    r4_rot_3 = PpcRotl32Inline(static_cast<uint32_t>(r7), static_cast<uint32_t>(8));
    r4_mrot_2 = (r4_rot_3 & 16776960);
    r4_mdest_2 = (r4 & -16776961);
    r4 = (r4_mdest_2 | r4_mrot_2);
    MemoryInline::FlatWriteRam32((r1 + 12), r5);
    r0_rot_3 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(16));
    r0 = (r0_rot_3 & -1);
    MemoryInline::FlatWriteRam16((r1 + 18), static_cast<uint16_t>(r4));
...
// RECOMP_REGISTRATION base 0x800E5830 func_800E5830 preserves=true fpr_mask=0x00000000
