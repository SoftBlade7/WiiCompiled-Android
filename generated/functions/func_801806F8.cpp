...
extern "C" void func_801806F8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801806F8:
{
    ...
    r3 = 0x80340000u;
    r4 = (r4 + 18856);
    MemoryInline::FlatWriteRam32((r3 + 18800), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x801806F8 func_801806F8 preserves=true fpr_mask=0x00000000
