...
extern "C" void func_800CC048(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
    uint32_t r3_rot_1 = 0;
...
loc_800CC048:
{
    ...
    r31 = PPC_Slw(static_cast<uint32_t>(r7), static_cast<uint32_t>(r4));
...
loc_800CC0F0:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800C7070u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800CC120:
{
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWriteRam16((r1 + 158), static_cast<uint16_t>(r0));
    r3 = (r1 + 84);
    r4 = 76;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    r7 = ctx->gpr[7];
    cr = ctx->cr;
    MemoryInline::FlatWriteRam16((r1 + 158), static_cast<uint16_t>(r3));
    r3 = (r1 + 84);
    ctx->lr = 0x800CC150u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x800CC048 func_800CC048 preserves=true fpr_mask=0x00000000
