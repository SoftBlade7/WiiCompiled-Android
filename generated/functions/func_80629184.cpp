...
extern "C" void func_80629184(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80629184:
{
    ...
    r3 = (r3 + 14156);
    r0 = 2001;
    MemoryInline::FlatWrite32(r19, r3);
    r3 = (r28 + 788);
    MemoryInline::FlatWrite32((r19 + 596), r0);
    MemoryInline::FlatWrite32((r19 + 600), r31);
    MemoryInline::FlatWriteFloat32((r19 + 604), f0.d);
    MemoryInline::FlatWrite32((r28 + 784), r31);
    ctx->gpr[1] = r1;
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_17C4 = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_17C4[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_17C4[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    MemoryInline::WriteResolved32(guest_range_2, 984u, (r28 + 984), r4);
    r8 = (r29 + 2272);
    r7 = 0x808C0000u;
    r5 = 0x808C0000u;
    ...
    r11 = MemoryInline::FlatRead32((r29 + 2272));
    ...
    r8 = MemoryInline::FlatRead32((r29 + 2284));
    ...
    r25 = 0x808C0000u;
    r31 = 0x808C0000u;
    guest_range_4 = MemoryInline::ResolveRangeHost((r29 + 2296), 0, 60u, true, false);
    r9 = MemoryInline::ReadResolved32(guest_range_4, 0u, (r29 + 2296));
    r4 = 0x80600000u;
    r8 = MemoryInline::ReadResolved32(guest_range_4, 4u, (r3 + 4));
    r5 = 0x80600000u;
    r0 = MemoryInline::ReadResolved32(guest_range_4, 8u, (r3 + 8));
    r25 = (r25 + -11988);
    MemoryInline::WriteResolved32(guest_range_1, 20u, (r28 + 1640), r0);
    r21 = (r29 + 2308);
    r12 = (r29 + 2320);
    r11 = (r29 + 2332);
    MemoryInline::WriteResolved32(guest_range_1, 4u, (r28 + 1624), r25);
    r31 = (r31 + -12000);
    r10 = (r29 + 2344);
    r3 = (r28 + 1732);
    ...
    r5 = (r5 + 22728);
    r6 = 664;
    MemoryInline::WriteResolved32(guest_range_1, 12u, (r28 + 1632), r9);
    r7 = 4;
    MemoryInline::WriteResolved32(guest_range_1, 16u, (r28 + 1636), r8);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r20 = MemoryInline::ReadResolved32(guest_range_4, 16u, (r21 + 4));
            r19 = MemoryInline::ReadResolved32(guest_range_4, 12u, (r29 + 2308));
        }
    }
    r21 = MemoryInline::ReadResolved32(guest_range_4, 20u, (r21 + 8));
    MemoryInline::WriteResolved32(guest_range_1, 40u, (r28 + 1660), r21);
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r25)) << 32) | static_cast<uint32_t>(r28)))) {
        MemoryInline::WriteResolved32(guest_range_1, 24u, (r28 + 1644), r25);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 32u, ((static_cast<uint64_t>(static_cast<uint32_t>(r19)) << 32) | static_cast<uint32_t>(r20)))) {
        MemoryInline::WriteResolved32(guest_range_1, 32u, (r28 + 1652), r19);
        MemoryInline::WriteResolved32(guest_range_1, 36u, (r28 + 1656), r20);
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r22 = MemoryInline::ReadResolved32(guest_range_4, 24u, (r29 + 2320));
            r23 = MemoryInline::ReadResolved32(guest_range_4, 28u, (r12 + 4));
        }
    }
    r24 = MemoryInline::ReadResolved32(guest_range_4, 32u, (r12 + 8));
    MemoryInline::WriteResolved32(guest_range_1, 60u, (r28 + 1680), r24);
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 44u, ((static_cast<uint64_t>(static_cast<uint32_t>(r25)) << 32) | static_cast<uint32_t>(r28)))) {
        MemoryInline::WriteResolved32(guest_range_1, 44u, (r28 + 1664), r25);
        MemoryInline::WriteResolved32(guest_range_1, 48u, (r28 + 1668), r28);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 52u, ((static_cast<uint64_t>(static_cast<uint32_t>(r22)) << 32) | static_cast<uint32_t>(r23)))) {
        MemoryInline::WriteResolved32(guest_range_1, 52u, (r28 + 1672), r22);
        MemoryInline::WriteResolved32(guest_range_1, 56u, (r28 + 1676), r23);
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r25 = MemoryInline::ReadResolved32(guest_range_4, 36u, (r29 + 2332));
            r26 = MemoryInline::ReadResolved32(guest_range_4, 40u, (r11 + 4));
        }
    }
    r27 = MemoryInline::ReadResolved32(guest_range_4, 44u, (r11 + 8));
    MemoryInline::WriteResolved32(guest_range_1, 80u, (r28 + 1700), r27);
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 64u, ((static_cast<uint64_t>(static_cast<uint32_t>(r31)) << 32) | static_cast<uint32_t>(r28)))) {
        MemoryInline::WriteResolved32(guest_range_1, 64u, (r28 + 1684), r31);
        MemoryInline::WriteResolved32(guest_range_1, 68u, (r28 + 1688), r28);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 72u, ((static_cast<uint64_t>(static_cast<uint32_t>(r25)) << 32) | static_cast<uint32_t>(r26)))) {
        MemoryInline::WriteResolved32(guest_range_1, 72u, (r28 + 1692), r25);
        MemoryInline::WriteResolved32(guest_range_1, 76u, (r28 + 1696), r26);
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r11 = MemoryInline::ReadResolved32(guest_range_4, 52u, (r10 + 4));
            r12 = MemoryInline::ReadResolved32(guest_range_4, 48u, (r29 + 2344));
        }
    }
    r10 = MemoryInline::ReadResolved32(guest_range_4, 56u, (r10 + 8));
    guest_range_5 = MemoryInline::ResolveRangeHost((r1 + 32), 0, 60u, false, true);
    if (!MemoryInline::WriteResolvedPair32(guest_range_5, 48u, ((static_cast<uint64_t>(static_cast<uint32_t>(r9)) << 32) | static_cast<uint32_t>(r8)))) {
        MemoryInline::WriteResolved32(guest_range_5, 48u, (r1 + 80), r9);
        MemoryInline::WriteResolved32(guest_range_5, 52u, (r1 + 84), r8);
    }
    MemoryInline::WriteResolved32(guest_range_5, 56u, (r1 + 88), r0);
    if (!MemoryInline::WriteResolvedPair32(guest_range_5, 36u, ((static_cast<uint64_t>(static_cast<uint32_t>(r19)) << 32) | static_cast<uint32_t>(r20)))) {
        MemoryInline::WriteResolved32(guest_range_5, 36u, (r1 + 68), r19);
        MemoryInline::WriteResolved32(guest_range_5, 40u, (r1 + 72), r20);
    }
    MemoryInline::WriteResolved32(guest_range_5, 44u, (r1 + 76), r21);
    if (!MemoryInline::WriteResolvedPair32(guest_range_5, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r22)) << 32) | static_cast<uint32_t>(r23)))) {
        MemoryInline::WriteResolved32(guest_range_5, 24u, (r1 + 56), r22);
        MemoryInline::WriteResolved32(guest_range_5, 28u, (r1 + 60), r23);
    }
    MemoryInline::WriteResolved32(guest_range_5, 32u, (r1 + 64), r24);
    if (!MemoryInline::WriteResolvedPair32(guest_range_5, 12u, ((static_cast<uint64_t>(static_cast<uint32_t>(r25)) << 32) | static_cast<uint32_t>(r26)))) {
        MemoryInline::WriteResolved32(guest_range_5, 12u, (r1 + 44), r25);
        MemoryInline::WriteResolved32(guest_range_5, 16u, (r1 + 48), r26);
    }
    MemoryInline::WriteResolved32(guest_range_5, 20u, (r1 + 52), r27);
    if (!MemoryInline::WriteResolvedPair32(guest_range_5, 0u, ((static_cast<uint64_t>(static_cast<uint32_t>(r12)) << 32) | static_cast<uint32_t>(r11)))) {
        MemoryInline::WriteResolved32(guest_range_5, 0u, (r1 + 32), r12);
        MemoryInline::WriteResolved32(guest_range_5, 4u, (r1 + 36), r11);
    }
    MemoryInline::WriteResolved32(guest_range_5, 8u, (r1 + 40), r10);
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 84u, ((static_cast<uint64_t>(static_cast<uint32_t>(r31)) << 32) | static_cast<uint32_t>(r28)))) {
        MemoryInline::WriteResolved32(guest_range_1, 84u, (r28 + 1704), r31);
        MemoryInline::WriteResolved32(guest_range_1, 88u, (r28 + 1708), r28);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 92u, ((static_cast<uint64_t>(static_cast<uint32_t>(r12)) << 32) | static_cast<uint32_t>(r11)))) {
        MemoryInline::WriteResolved32(guest_range_1, 92u, (r28 + 1712), r12);
        MemoryInline::WriteResolved32(guest_range_1, 96u, (r28 + 1716), r11);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 100u, ((static_cast<uint64_t>(static_cast<uint32_t>(r10)) << 32) | static_cast<uint32_t>(r30)))) {
        MemoryInline::WriteResolved32(guest_range_1, 100u, (r28 + 1720), r10);
...
// RECOMP_REGISTRATION base 0x80629184 func_80629184 preserves=true fpr_mask=0x00000000
