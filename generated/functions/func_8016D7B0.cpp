...
extern "C" void func_8016D7B0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8016D61C:
{
    ...
    ctx->gpr[6] = r6;
    ctx->cr = cr;
    InvokeDirectCpu<0x8016D61Cu>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r5 = ctx->gpr[5];
    r6 = ctx->gpr[6];
...
// RECOMP_REGISTRATION base 0x8016D7B0 func_8016D7B0 preserves=true fpr_mask=0x00000000
