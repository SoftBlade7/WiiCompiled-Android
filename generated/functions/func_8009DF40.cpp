...
extern "C" void func_8009DF40(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8009DF40:
{
    ...
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x8009E920u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8009DF40 func_8009DF40 preserves=true fpr_mask=0x00000000
