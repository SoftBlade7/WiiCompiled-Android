...
extern "C" void func_801A8BD4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_801A8BD4:
{
    ...
    r30 = 0x80340000u;
    r30 = (r30 + 29760);
    MemoryInline::FlatWriteRam32((r30 + 68), r0);
    r3 = r30;
    MemoryInline::FlatWriteRam32((r30 + 72), r0);
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
loc_801A8CEC:
{
    ...
    r0 = 64;
    r31 = (r31 + 29760);
    MemoryInline::FlatWriteRam32((r31 + 76), r3);
...
{
    r0 = 1;
    MemoryInline::FlatWriteRam32((r31 + 68), r3);
    r3 = (r31 + 20);
...
loc_801A8D2C:
{
    r30 = MemoryInline::FlatRead16((r3 + 40));
    r3 = 0;
    r4 = 20;
    ctx->lr = 0x801A8D3Cu;
    ctx->gpr[0] = r0;
...
loc_801A8D44:
{
    if ((static_cast<uint32_t>(r0) == static_cast<uint32_t>(20480))) {
        goto loc_801A8D54;
    }
}
...
loc_801A8DAC:
{
    MemoryInline::FlatWrite16((r5 + 40), static_cast<uint16_t>(r30));
    r3 = 1;
    r4 = 20;
    ctx->lr = 0x801A8DBCu;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x801A8BD4 func_801A8BD4 preserves=true fpr_mask=0x00000000
