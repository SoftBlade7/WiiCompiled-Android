...
extern "C" void func_8064ED34(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8064ED34:
{
    ...
    MemoryInline::FlatWrite32((r3 + 2224), r4);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r5), static_cast<int32_t>(0));
}

loc_8064ED5C:
{
    MemoryInline::FlatWrite8((r3 + 2228), static_cast<uint8_t>(r0));
    MemoryInline::FlatWrite8((r3 + 2229), static_cast<uint8_t>(r0));
    if (((cr & 0x20000000u) != 0)) {
        goto loc_8064ED74;
    }
}
...
// RECOMP_REGISTRATION base 0x8064ED34 func_8064ED34 preserves=true fpr_mask=0x00000000
