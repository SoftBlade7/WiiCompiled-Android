...
extern "C" void func_8064D0A0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8064D100:
{
    r3 = MemoryInline::FlatRead32((r31 + 7736));
    r3 = MemoryInline::FlatRead32(r3);
    r30 = MemoryInline::FlatRead32((r3 + 316));
...
// RECOMP_REGISTRATION base 0x8064D0A0 func_8064D0A0 preserves=true fpr_mask=0x00000000
