...
extern "C" void func_80171D60(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
{
    r9 = (r10 + r0);
    r11 = MemoryInline::FlatRead32((r9 + 384));
...
loc_80171D90:
{
    ...
    MemoryInline::FlatWrite32((r9 + 384), r11);
...
// RECOMP_REGISTRATION base 0x80171D60 func_80171D60 preserves=true fpr_mask=0x00000000
