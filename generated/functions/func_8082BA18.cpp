...
extern "C" void func_8082BA18(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8082BAAC:
{
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWriteRam32((r31 + 17616), r0);
}
...
// RECOMP_REGISTRATION base 0x8082BA18 func_8082BA18 preserves=true fpr_mask=0x00000000
