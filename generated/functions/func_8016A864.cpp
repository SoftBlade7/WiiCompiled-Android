...
extern "C" void func_8016A864(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8016A8D8:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r30 + 256), r28);
    r9 = 0x80170000u;
    r0 = 0;
    r5 = r30;
    MemoryInline::FlatWrite32((r30 + 260), r29);
    r10 = r30;
    r9 = (r9 + -25356);
    r4 = 7;
...
// RECOMP_REGISTRATION base 0x8016A864 func_8016A864 preserves=true fpr_mask=0x00000000
