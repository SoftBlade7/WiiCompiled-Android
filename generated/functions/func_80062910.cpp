...
extern "C" void func_80062910(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800629A8:
{
    ...
    ctx->gpr[10] = r10;
    ctx->cr = cr;
    InvokeDirectCpu<0x80050500u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
...
// RECOMP_REGISTRATION base 0x80062910 func_80062910 preserves=true fpr_mask=0x00000000
