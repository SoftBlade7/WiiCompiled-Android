...
extern "C" void func_800A4670(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
    uint32_t r3_rot_1 = 0;
...
{
    r31 = 1;
    MemoryInline::FlatWrite8((r3 + 916), static_cast<uint8_t>(r31));
    MemoryInline::FlatWrite32((r3 + 848), r5);
...
loc_800A46C0:
{
    ...
    MemoryInline::FlatWrite8((r13 + -27120), static_cast<uint8_t>(r31));
}
...
// RECOMP_REGISTRATION base 0x800A4670 func_800A4670 preserves=true fpr_mask=0x00000000
