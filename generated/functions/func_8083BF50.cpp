...
extern "C" void func_8083BF50(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8083BF84:
{
    ...
    r8 = ctx->gpr[8];
    r4 = 0x808B0000u;
    r7 = MemoryInline::FlatRead32((r30 + 1724));
    r4 = (r4 + -12732);
    r3 = r31;
    r5 = (r4 + 7);
    r8 = 0;
...
// RECOMP_REGISTRATION base 0x8083BF50 func_8083BF50 preserves=true fpr_mask=0x00000000
