...
extern "C" void func_806CA2F0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lfsx_80537B88_loc_0 = 0;
    uint32_t addr_stfsx_806CA414_loc_0 = 0;
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_806CA384:
{
    r4 = 0x808A0000u;
    r3 = (r1 + 20);
    f1.d = MemoryInline::FlatReadFloat32((r4 + -1360));
    r4 = (r1 + 80);
    r5 = (r1 + 92);
    ctx->lr = 0x806CA39Cu;
    ctx->gpr[0] = r0;
    ...
    ctx->fpr[3] = f3;
    ctx->fpr[4] = f4;
    InvokeDirectCpu<0x806CA55Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_806CA3B4:
{
    ...
    ctx->gpr[6] = r6;
    ctx->cr = cr;
    InvokeDirectCpu<0x806F481Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r5 = ctx->gpr[5];
...
loc_806CA3F4:
{
    ...
    r3 = MemoryInline::FlatRead32((r28 + 224));
    r27 = (r4 + -1);
    r31_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r29), static_cast<uint32_t>(2));
    r31 = (r31_rot_2 & 1020);
    r3_addr_2 = (r3 + r31);
    ...
    addr_stfsx_806CA414_loc_0 = (r30 + r0);
    MemoryInline::FlatWriteFloat32(addr_stfsx_806CA414_loc_0, f0.d);
    r5 = (r0 + r30);
...
// RECOMP_REGISTRATION base 0x806CA2F0 func_806CA2F0 preserves=true fpr_mask=0x00000000
