...
extern "C" void func_80756360(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80756360:
{
    ...
    f1.d = (-(f1.d));
    f0.d = (-(f0.d));
    MemoryInline::WriteResolvedFloat32(guest_range_0, 112u, (r3 + 8), f2.d);
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 104u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f1.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 104u, r3, f0.d);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 108u, (r3 + 4), f1.d);
    }
    // end of inlined leaf 0x805147D4
    f0.d = MemoryInline::FlatReadFloat32(r31);
    r3 = (r1 + 104);
    MemoryInline::WriteResolvedFloat32(guest_range_0, 108u, (r1 + 108), f0.d);
    ctx->lr = 0x8075639Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    f4.d = MemoryInline::FlatReadFloat32((r3 + -15196));
    ...
    r4 = 0x808D0000u;
    r3 = (r1 + 80);
    f1.d = MemoryInline::FlatReadFloat32((r4 + -15204));
    r4 = (r1 + 92);
    ...
    f4.d = MemoryInline::FlatReadFloat32((r30 + 208));
    f0.d = static_cast<double>(PpcForceSingleValueInline(f1.d + f0.d));
...
loc_80756520:
{
    ...
    ctx->fpr[2] = f2;
    ctx->xer = xer;
    InvokeDirectCpu<0x80756DCCu>(ctx);
    r0 = ctx->gpr[0];
    f0 = ctx->fpr[0];
    f1 = ctx->fpr[1];
    f2 = ctx->fpr[2];
...
// RECOMP_REGISTRATION base 0x80756360 func_80756360 preserves=true fpr_mask=0x00000000
