...
extern "C" void func_80572574(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80572574:
{
    r3 = MemoryInline::FlatRead16((r3 + 136));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80572574 func_80572574 preserves=true fpr_mask=0x00000000
