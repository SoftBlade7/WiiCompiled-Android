...
extern "C" void func_8071E9B4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8071E9B4:
{
    ...
    MemoryInline::FlatWrite32((r3 + 356), r30);
    r3 = 32;
    ctx->lr = 0x8071E9E4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8071E9F0:
{
    ...
    MemoryInline::FlatWriteRam8((r3 + 28), static_cast<uint8_t>(r30));
    r3 = 12;
    ctx->lr = 0x8071EA10u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8071EA5C:
{
    MemoryInline::FlatWrite32((r29 + 356), r31);
    r3 = r29;
...
// RECOMP_REGISTRATION base 0x8071E9B4 func_8071E9B4 preserves=true fpr_mask=0x00000000
