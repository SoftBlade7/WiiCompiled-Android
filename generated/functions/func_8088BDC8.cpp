...
extern "C" void func_8088BDC8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8088BDC8:
{
    r3 = 0x808B0000u;
    r4 = 0x808B0000u;
    f0.d = MemoryInline::FlatReadFloat32((r4 + 10576));
    r6 = 0x809C0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + 10280));
    r3 = (r6 + 19272);
    r4 = 0x80510000u;
    r5 = 0x809C0000u;
    MemoryInline::FlatWriteRamFloat32((r6 + 19272), f1.d);
    r4 = (r4 + 13824);
    r5 = (r5 + 19260);
...
// RECOMP_REGISTRATION base 0x8088BDC8 func_8088BDC8 preserves=true fpr_mask=0x00000000
