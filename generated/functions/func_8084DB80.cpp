...
extern "C" void func_8084DB80(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8084DB80:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r5 + -8756));
...
// RECOMP_REGISTRATION base 0x8084DB80 func_8084DB80 preserves=true fpr_mask=0x00000000
