...
extern "C" void func_8084B150(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8084B150:
{
    ...
    r29 = (r27 * 372);
    r0 = MemoryInline::FlatRead32((r26 + 1736));
    r28 = (r3 & 255);
    r3 = (r4 + 1);
    ...
    r6 = ctx->gpr[6];
    r7 = ctx->gpr[7];
    r3 = MemoryInline::FlatRead32((r26 + 1736));
}
...
// RECOMP_REGISTRATION base 0x8084B150 func_8084B150 preserves=true fpr_mask=0x00000000
