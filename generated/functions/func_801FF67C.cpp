...
extern "C" void func_801FF67C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801FF6C0:
{
    ...
    if (MkwStateFreeAbiEnabled(0x801F6390u) && KnownTranslatedCpuCall<0x801F6390u>::kAvailable && !KnownTranslatedCpuCall<0x801F6390u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x801F6390u>()) {
        const auto state_free_result_801F6390_826 = func_801F6390_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_801F6390_826);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801FEF94u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801FF718:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801FF22Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_801FF76C:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801FF400u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x801FF67C func_801FF67C preserves=true fpr_mask=0x00000000
