...
extern "C" void func_800493E0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_800493E0:
{
    ...
    r3 = r15;
    r4 = r21;
    // inline leaf 0x80048F90 (3 guest instruction(s))
    r0 = MemoryInline::FlatRead16(r4);
    r3 = (r0 & 2048);
    // end of inlined leaf 0x80048F90
    r12 = MemoryInline::FlatRead32(r15);
    r14 = r3;
    r3 = r15;
    ...
    xer = ctx->xer;
    mkw_gqr0 = ctx->gqr[0];
    r0 = MemoryInline::FlatRead8((r21 + 169));
    r26 = r3;
    f2.d = MemoryInline::FlatReadFloat64((r2 + -29936));
    r0 = (static_cast<int32_t>(static_cast<int8_t>(r0)));
    f0.d = MemoryInline::FlatReadFloat32((r2 + -29960));
    r0 = (r0 ^ -2147483648);
    ...
    ctx->gpr[5] = r5;
    ctx->cr = cr;
    InvokeDirectCpu<0x80049880u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
    ...
    r4 = (r16 + 164);
    r5 = (r5 + 172);
    // inline leaf 0x800498D0 (9 guest instruction(s))
    ...
    // end of inlined leaf 0x800498D0
    r3 = r15;
    r4 = r28;
    ...
    r3 = r15;
    r4 = r21;
    // inline leaf 0x80048FA0 (3 guest instruction(s))
    r0 = MemoryInline::FlatRead8((r4 + 178));
    r3 = (r0 & 192);
    // end of inlined leaf 0x80048FA0
}
...
loc_80049524:
{
    f30.d = MemoryInline::FlatReadFloat32((r2 + -29952));
    goto loc_80049548;
}
...
{
    r3 = (r1 + 104);
    // inline leaf 0x80048FB0 (1 guest instruction(s))
    // end of inlined leaf 0x80048FB0
    r3 = (r1 + 132);
    // inline leaf 0x80048FB0 (1 guest instruction(s))
    // end of inlined leaf 0x80048FB0
    r3 = (r1 + 160);
...
// RECOMP_REGISTRATION base 0x800493E0 func_800493E0 preserves=false fpr_mask=0xE0000000
