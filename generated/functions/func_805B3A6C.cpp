...
extern "C" void func_805B3A6C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805B3A6C:
{
    ...
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x805B8E70u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x805B3A6C func_805B3A6C preserves=true fpr_mask=0x00000000
