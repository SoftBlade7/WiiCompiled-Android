...
extern "C" void func_806B7944(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806B7944:
{
    ...
    xer = ctx->xer;
    r3 = 0x809C0000u;
    r0 = MemoryInline::FlatRead8((r3 + 8720));
...
loc_806B7A54:
{
    ...
    r3 = 0x808A0000u;
    r6 = 2;
    f0.d = MemoryInline::FlatReadFloat32((r3 + -3704));
    r7 = 0;
    MemoryInline::FlatWriteRamFloat32((r1 + 64), f0.d);
    r30 = 1;
    r8 = 0x809C0000u;
    r3 = MemoryInline::FlatRead32((r29 + 11760));
    MemoryInline::FlatWriteRam8((r1 + 68), static_cast<uint8_t>(r7));
    r8 = (r8 + 8728);
    ...
    xer = ctx->xer;
    r3 = 0x809C0000u;
    MemoryInline::FlatWriteRam8((r3 + 8720), static_cast<uint8_t>(r30));
}
...
// RECOMP_REGISTRATION base 0x806B7944 func_806B7944 preserves=true fpr_mask=0x00000000
