...
extern "C" void func_806E0D48(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_806E0D48:
{
    ...
    r31 = 0x808A0000u;
    f2.d = MemoryInline::FlatReadFloat32((r31 + 1824));
...
// RECOMP_REGISTRATION base 0x806E0D48 func_806E0D48 preserves=true fpr_mask=0x00000000
