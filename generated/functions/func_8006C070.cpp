...
extern "C" void func_8006C070(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8006C070:
{
    ...
    f1.d = (-(f0.d));
    f3.d = MemoryInline::FlatReadFloat32((r2 + -29332));
...
// RECOMP_REGISTRATION base 0x8006C070 func_8006C070 preserves=true fpr_mask=0x00000000
