...
extern "C" void func_80805AD8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80805B48:
{
    ...
    r4 = 0x808B0000u;
    r5 = 0x808D0000u;
    f2.d = MemoryInline::FlatReadFloat32((r4 + -20648));
    MemoryInline::FlatWriteRam32((r1 + 20), r3);
    r3 = (r1 + 20);
    f3.d = f2.d;
    f1.d = MemoryInline::FlatReadFloat32((r5 + 21192));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ...
    ctx->fpr[3] = f3;
    ctx->cr = cr;
    InvokeDirectCpu<0x80052E00u>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    cr = ctx->cr;
...
// RECOMP_REGISTRATION base 0x80805AD8 func_80805AD8 preserves=true fpr_mask=0x00000000
