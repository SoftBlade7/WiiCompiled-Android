...
extern "C" void func_805CBEA4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805CBEA4:
{
    ...
    guest_range_1 = MemoryInline::ResolveRangeHost((r3 + -68), 0, 72u, false, true);
    MemoryInline::WriteResolved32(guest_range_1, 68u, r3, r4);
    // end of inlined leaf 0x805C2C18
    r12 = (r31 + 592);
    r28 = MemoryInline::FlatRead32((r31 + 592));
    r27 = MemoryInline::FlatRead32((r12 + 4));
    r6 = r26;
    r11 = MemoryInline::FlatRead32((r12 + 8));
    r3 = (r1 + 120);
    r10 = MemoryInline::FlatRead32((r12 + 12));
    r4 = (r29 + 285);
    r9 = MemoryInline::FlatRead32((r12 + 16));
    r5 = (r29 + 292);
    r8 = MemoryInline::FlatRead32((r12 + 20));
    r7 = (r1 + 52);
    r0 = MemoryInline::FlatRead32((r12 + 24));
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 0u, ((static_cast<uint64_t>(static_cast<uint32_t>(r28)) << 32) | static_cast<uint32_t>(r27)))) {
        MemoryInline::WriteResolved32(guest_range_1, 0u, (r1 + 52), r28);
        MemoryInline::WriteResolved32(guest_range_1, 4u, (r1 + 56), r27);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 8u, ((static_cast<uint64_t>(static_cast<uint32_t>(r11)) << 32) | static_cast<uint32_t>(r10)))) {
        MemoryInline::WriteResolved32(guest_range_1, 8u, (r1 + 60), r11);
        MemoryInline::WriteResolved32(guest_range_1, 12u, (r1 + 64), r10);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 16u, ((static_cast<uint64_t>(static_cast<uint32_t>(r9)) << 32) | static_cast<uint32_t>(r8)))) {
        MemoryInline::WriteResolved32(guest_range_1, 16u, (r1 + 68), r9);
        MemoryInline::WriteResolved32(guest_range_1, 20u, (r1 + 72), r8);
    }
    MemoryInline::WriteResolved32(guest_range_1, 24u, (r1 + 76), r0);
    ctx->lr = 0x805CBF78u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_805CBF98:
{
    f1.d = MemoryInline::FlatReadFloat32((r31 + 620));
...
loc_805CBFB0:
{
    ...
    r26 = (r27 + 314);
    // inline leaf 0x805C2C18 (2 guest instruction(s))
    guest_range_2 = MemoryInline::ResolveRangeHost((r3 + -56), 0, 60u, false, true);
    MemoryInline::WriteResolved32(guest_range_2, 56u, r3, r4);
    // end of inlined leaf 0x805C2C18
    r12 = (r31 + 592);
    r28 = MemoryInline::FlatRead32((r31 + 592));
    r29 = MemoryInline::FlatRead32((r12 + 4));
    r6 = r26;
    r11 = MemoryInline::FlatRead32((r12 + 8));
    r3 = (r1 + 80);
    r10 = MemoryInline::FlatRead32((r12 + 12));
    ...
    r7 = (r1 + 24);
    r0 = MemoryInline::FlatRead32((r12 + 24));
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 0u, ((static_cast<uint64_t>(static_cast<uint32_t>(r28)) << 32) | static_cast<uint32_t>(r29)))) {
        MemoryInline::WriteResolved32(guest_range_2, 0u, (r1 + 24), r28);
        MemoryInline::WriteResolved32(guest_range_2, 4u, (r1 + 28), r29);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 8u, ((static_cast<uint64_t>(static_cast<uint32_t>(r11)) << 32) | static_cast<uint32_t>(r10)))) {
        MemoryInline::WriteResolved32(guest_range_2, 8u, (r1 + 32), r11);
        MemoryInline::WriteResolved32(guest_range_2, 12u, (r1 + 36), r10);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 16u, ((static_cast<uint64_t>(static_cast<uint32_t>(r9)) << 32) | static_cast<uint32_t>(r8)))) {
        MemoryInline::WriteResolved32(guest_range_2, 16u, (r1 + 40), r9);
        MemoryInline::WriteResolved32(guest_range_2, 20u, (r1 + 44), r8);
    }
    MemoryInline::WriteResolved32(guest_range_2, 24u, (r1 + 48), r0);
    ctx->lr = 0x805CC03Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x805CBEA4 func_805CBEA4 preserves=true fpr_mask=0x00000000
