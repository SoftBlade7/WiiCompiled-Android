...
extern "C" void func_807AEC64(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807AEC64:
{
    ...
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(900));
}
...
{
    r0 = 0;
    MemoryInline::FlatWrite32((r3 + 456), r0);
}

loc_807AECA8:
{
    r0 = MemoryInline::FlatRead32((r3 + 352));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(1500));
}
...
loc_807AECC4:
{
    r4 = 0x808A0000u;
    r3 = r31;
    f1.d = MemoryInline::FlatReadFloat32((r4 + 24000));
    ctx->lr = 0x807AECD4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r4 = 0x808A0000u;
    r3 = r31;
    f1.d = MemoryInline::FlatReadFloat32((r4 + 23808));
    r4 = 248;
    ctx->lr = 0x807AECF0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x807AEC64 func_807AEC64 preserves=true fpr_mask=0x00000000
