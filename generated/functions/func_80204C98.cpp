...
extern "C" void func_80204C98(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80204C98:
{
    ...
    r5 = MemoryInline::FlatRead8((r2 + -25992));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(0));
}

loc_80204CB4:
{
    r0 = MemoryInline::FlatRead8((r2 + -25991));
    r26 = r3;
...
loc_80204D78:
{
    r6 = (static_cast<int32_t>(static_cast<int16_t>(r29)));
...
loc_80204E18:
{
    MemoryInline::FlatWrite32(r27, r28);
    r30 = 1;
}
...
// RECOMP_REGISTRATION base 0x80204C98 func_80204C98 preserves=true fpr_mask=0x00000000
