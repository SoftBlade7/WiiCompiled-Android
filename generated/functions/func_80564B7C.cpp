...
extern "C" void func_80564B7C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80564B7C:
{
    ...
    MemoryInline::FlatWriteRam32((r4 + 19444), r3);
...
loc_80564BDC:
{
    ...
    r4 = 0;
    r31_addr_3 = (r31 + r29);
    MemoryInline::FlatWrite32(r31_addr_3, r4);
    r30 = (r0 + r3);
    goto loc_80564C0C;
}
...
{
    r31_addr_7 = (r31 + r29);
    r3 = MemoryInline::FlatRead32(r31_addr_7);
    r12 = MemoryInline::FlatRead32(r3);
...
{
    r31_addr_5 = (r31 + r29);
    r4 = MemoryInline::FlatRead32(r31_addr_5);
    r3 = r30;
...
{
    r31_addr_6 = (r31 + r29);
    MemoryInline::FlatWrite32(r31_addr_6, r3);
    if (((cr & 0x20000000u) == 0)) {
        goto loc_80564BF8;
    }
}
...
// RECOMP_REGISTRATION base 0x80564B7C func_80564B7C preserves=true fpr_mask=0x00000000
