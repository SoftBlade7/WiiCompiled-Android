...
extern "C" void func_80636C48(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80636C4C:
{
    MemoryInline::FlatWrite8((r3 + 572), static_cast<uint8_t>(r4));
    if (((cr & 0x20000000u) != 0)) {
        goto loc_80636C60;
    }
}
...
// RECOMP_REGISTRATION base 0x80636C48 func_80636C48 preserves=true fpr_mask=0x00000000
