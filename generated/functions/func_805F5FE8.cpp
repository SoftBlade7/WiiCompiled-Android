...
extern "C" void func_805F5FE8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805F5FE8:
{
    ...
    r3 = 0x809C0000u;
    r4 = (r4 + 7440);
    MemoryInline::FlatWriteRam32((r3 + 7336), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x805F5FE8 func_805F5FE8 preserves=true fpr_mask=0x00000000
