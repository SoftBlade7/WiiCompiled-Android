...
extern "C" void func_806A597C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806A597C:
{
    ...
    r31 = r3;
    r4 = MemoryInline::FlatRead32((r3 + 672));
    r3 = (r4 + 116);
...
loc_806A59D0:
{
    r3 = MemoryInline::FlatRead32((r31 + 672));
...
// RECOMP_REGISTRATION base 0x806A597C func_806A597C preserves=true fpr_mask=0x00000000
