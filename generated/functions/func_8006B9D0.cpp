...
extern "C" void func_8006B9D0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8006B9D0:
{
    ...
    f9.d = MemoryInline::FlatReadFloat32((r2 + -29348));
    f3.d = PpcFmulsInline(f5.d, f4.d);
    f1.d = PpcFmulsInline(f1.d, f4.d);
    f6.d = MemoryInline::FlatReadFloat32((r2 + -29344));
    ...
    f1.d = PpcFmulsInline(f6.d, f5.d);
    f11.d = MemoryInline::FlatReadFloat32((r30 + 8));
    ...
    f7.d = PpcFmulsInline(f9.d, f7.d);
    {
        ...
        if (resolved_pair.valid) {
            ...
            f13.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 0u, (r1 + 8));
        }
    }
    f0.d = static_cast<double>(PpcForceSingleValueInline(f7.d - f9.d));
    f3.d = (-(f2.d));
    f8.d = MemoryInline::FlatReadFloat32((r30 + 24));
    f12.d = PpcFmulsInline(f13.d, f4.d);
    f9.d = MemoryInline::FlatReadFloat32((r30 + 12));
    f6.d = PpcFmulsInline(f2.d, f10.d);
    f4.d = PpcFmulsInline(f3.d, f4.d);
    f3.d = PpcFmulsInline(f13.d, f10.d);
    f7.d = MemoryInline::FlatReadFloat32((r30 + 28));
    f6.d = static_cast<double>(PpcForceSingleValueInline(f12.d + f6.d));
    ...
    MemoryInline::FlatWriteFloat32((r30 + 20), f3.d);
    {
        const auto resolved_pair = MemoryInline::ReadResolvedPair32(guest_range_0, 0u);
        if (resolved_pair.valid) {
    ...
    f3.d = (-(f4.d));
    f6.d = PpcFmulsInline(f4.d, f7.d);
    f8.d = PpcFmulsInline(f10.d, f9.d);
    f4.d = PpcFmulsInline(f3.d, f9.d);
...
// RECOMP_REGISTRATION base 0x8006B9D0 func_8006B9D0 preserves=true fpr_mask=0x00000000
