...
extern "C" void func_80729A98(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80729A98:
{
    ...
    r0 = MemoryInline::FlatRead16((r4 + -25592));
    r0 = (r0 << 16);
...
// RECOMP_REGISTRATION base 0x80729A98 func_80729A98 preserves=true fpr_mask=0x00000000
