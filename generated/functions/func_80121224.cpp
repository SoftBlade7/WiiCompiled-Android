...
extern "C" void func_80121224(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r3_rot_0 = 0;
    uint32_t r3_rot_1 = 0;
...
loc_80121294:
{
    r0 = MemoryInline::FlatRead16((r24 + 1708));
    MemoryInline::FlatWriteRam16((r1 + 8), static_cast<uint16_t>(r0));
}

loc_8012129C:
{
    r29 = MemoryInline::FlatRead16((r1 + 8));
...
loc_80121370:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r12 = MemoryInline::FlatRead32((r24 + 1160));
    r3 = r24;
    r5 = MemoryInline::FlatRead32((r1 + 12));
    r4 = 0;
    r6 = MemoryInline::FlatRead32((r24 + 1172));
    ctr = r12;
    ctx->lr = 0x8012139Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x80121224 func_80121224 preserves=true fpr_mask=0x00000000
