...
extern "C" void func_801DA71C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr1_0 = 0;
...
loc_801DA750:
{
    ...
    ctx->gpr[12] = r12;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x801DA7A8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_GUEST_ABI gpr_read=0xFFFF07FA gpr_write=0xFFFF1FFB gpr_return=0x00000018 fpr_read=0x000001FE fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x03 cr_write=0x03 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x801DA71C func_801DA71C preserves=true fpr_mask=0x00000000
