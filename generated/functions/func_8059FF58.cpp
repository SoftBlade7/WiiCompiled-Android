...
extern "C" void func_8059FF58(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8059FF58:
{
    ...
    f10.d = MemoryInline::FlatReadFloat32((r4 + 12));
    ...
    f13.d = MemoryInline::FlatReadFloat32((r5 + 240));
    f11.d = MemoryInline::FlatReadFloat32((r5 + 244));
    ...
    f8.d = MemoryInline::FlatReadFloat32((r5 + 248));
...
// RECOMP_GUEST_ABI gpr_read=0x8000001A gpr_write=0x8000002B gpr_return=0x00000008 fpr_read=0x80000000 fpr_write=0x80003FFF fpr_return=0x00000002 cr_read=0x00 cr_write=0x00 xer_read=0 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8059FF58 func_8059FF58 preserves=true fpr_mask=0x00000000
