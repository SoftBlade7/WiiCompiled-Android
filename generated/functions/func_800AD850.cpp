...
extern "C" void func_800AD850(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = (r13 + -27208);
    MemoryInline::FlatWrite32((r13 + -27080), r0);
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x800AD850 func_800AD850 preserves=true fpr_mask=0x00000000
