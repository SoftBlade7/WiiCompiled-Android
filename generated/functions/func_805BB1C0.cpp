...
extern "C" void func_805BB1C0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805BB1C0:
{
    ...
    r31 = ctx->gpr[31];
    r0 = -1;
    MemoryInline::FlatWrite32((r31 + 836), r0);
...
// RECOMP_REGISTRATION base 0x805BB1C0 func_805BB1C0 preserves=true fpr_mask=0x00000000
