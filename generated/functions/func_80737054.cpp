...
extern "C" void func_80737054(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80737054:
{
    ...
    r29 = r3;
    r5 = MemoryInline::FlatRead32((r3 + 508));
    r5 = (r5 + 1);
    MemoryInline::FlatWrite32((r3 + 508), r5);
    r0 = MemoryInline::FlatRead16((r4 + -21800));
    r0 = (r0 << 16);
...
loc_807370B0:
{
    ...
    r4 = 0x808D0000u;
    f31.d = MemoryInline::FlatReadFloat32((r4 + -21804));
    r30 = MemoryInline::FlatRead32(r3);
    r31 = MemoryInline::FlatRead32((r29 + 504));
    r3 = r30;
...
// RECOMP_REGISTRATION base 0x80737054 func_80737054 preserves=false fpr_mask=0x80000000
