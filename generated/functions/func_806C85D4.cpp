...
extern "C" void func_806C85D4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r5_rot_0 = 0;
...
loc_806C8620:
{
    ...
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r0), static_cast<uint32_t>(19));
}
...
loc_806C8648:
{
    if ((static_cast<uint32_t>(r0) > static_cast<uint32_t>(149))) {
        goto loc_806C8650;
    }
}
...
// RECOMP_REGISTRATION base 0x806C85D4 func_806C85D4 preserves=true fpr_mask=0x00000000
