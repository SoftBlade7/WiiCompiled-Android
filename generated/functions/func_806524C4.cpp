...
extern "C" void func_806524C4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806524C4:
{
    ...
    r29 = r3;
    MemoryInline::FlatWrite32((r3 + 624), r4);
...
// RECOMP_REGISTRATION base 0x806524C4 func_806524C4 preserves=true fpr_mask=0x00000000
