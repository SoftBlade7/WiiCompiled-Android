...
extern "C" void func_807E9898(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807E98B8:
{
    r5 = 0x808B0000u;
    f2.d = std::fabs(f1.d);
    f0.d = MemoryInline::FlatReadFloat32((r5 + -28992));
...
// RECOMP_REGISTRATION base 0x807E9898 func_807E9898 preserves=true fpr_mask=0x00000000
