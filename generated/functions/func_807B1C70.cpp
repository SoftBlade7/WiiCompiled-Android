...
extern "C" void func_807B1C70(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807B1C70:
{
    ...
    r31 = 0x809C0000u;
    r3 = MemoryInline::FlatRead32((r31 + 13920));
    ctx->lr = 0x807B1C8Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    r31 = ctx->gpr[31];
    r0 = 0;
    MemoryInline::FlatWriteRam32((r31 + 13920), r0);
...
// RECOMP_REGISTRATION base 0x807B1C70 func_807B1C70 preserves=true fpr_mask=0x00000000
