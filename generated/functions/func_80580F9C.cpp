...
extern "C" void func_80580F9C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80580FC4:
{
    r4 = MemoryInline::FlatRead16((r3 + 402));
    r4 = (r4 << 16);
    r4 = (static_cast<int32_t>(r4) >> 16);
    r0 = (r4 + -1);
    MemoryInline::FlatWrite16((r3 + 402), static_cast<uint16_t>(r0));
...
// RECOMP_REGISTRATION base 0x80580F9C func_80580F9C preserves=true fpr_mask=0x00000000
