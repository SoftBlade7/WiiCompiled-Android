...
extern "C" void func_800A38D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800A38D0:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead8((r31 + 140));
...
loc_800A3944:
{
    ...
    r3 = (r0 + -240);
    {
        const uint64_t ppcCarryWide = static_cast<uint64_t>(static_cast<uint32_t>(r0)) + static_cast<uint64_t>(static_cast<uint32_t>(-240)) + (static_cast<uint64_t>(static_cast<uint32_t>(0)) & 1u);
...
loc_800A39F8:
{
    r5 = MemoryInline::FlatRead8((r3 + -100));
...
loc_800A3A1C:
{
    r5 = MemoryInline::FlatRead8((r31 + 140));
...
loc_800A3A54:
{
    ...
    r3 = r31;
    r4 = r30;
    // inline leaf 0x8008F450 (2 guest instruction(s))
    MemoryInline::FlatWrite32((r3 + 16), r4);
    // end of inlined leaf 0x8008F450
    ctx->lr = 0x800A3A84u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x800A38D0 func_800A38D0 preserves=true fpr_mask=0x00000000
