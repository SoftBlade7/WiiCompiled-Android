...
extern "C" void func_8019EC2C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr1_0 = 0;
...
loc_8019EC6C:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8019EBD8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8019ECA0:
{
    ...
    r3 = 0x80290000u;
    r5 = 0x801A0000u;
    MemoryInline::FlatWrite32((r13 + -25520), r30);
    r3 = (r3 + -5088);
    r4 = 3;
...
// RECOMP_REGISTRATION base 0x8019EC2C func_8019EC2C preserves=true fpr_mask=0x00000000
