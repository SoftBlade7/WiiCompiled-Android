...
extern "C" void func_8084FE40(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8084FE40:
{
    ...
    ctx->gpr[30] = r30;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x807E9DC0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8084FE40 func_8084FE40 preserves=true fpr_mask=0x00000000
