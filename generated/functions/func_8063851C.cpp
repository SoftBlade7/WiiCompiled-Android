...
extern "C" void func_8063851C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806385B0:
{
    r0 = MemoryInline::FlatRead32((r31 + 568));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_80638634:
{
    r0 = MemoryInline::FlatRead32((r31 + 572));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_80638640:
{
    ...
    cr = ctx->cr;
    ctr = ctx->ctr;
    r3 = MemoryInline::FlatRead32((r31 + 572));
    r12 = MemoryInline::FlatRead32(r3);
    r12 = MemoryInline::FlatRead32((r12 + 104));
    ctr = r12;
    ctx->lr = 0x80638660u;
...
// RECOMP_REGISTRATION base 0x8063851C func_8063851C preserves=true fpr_mask=0x00000000
