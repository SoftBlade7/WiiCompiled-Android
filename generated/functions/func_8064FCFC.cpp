...
extern "C" void func_8064FCFC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8064FCFC:
{
    ...
    r3 = MemoryInline::FlatRead32((r4 + 720));
    r0 = (r3 + 1);
    MemoryInline::FlatWrite32((r4 + 720), r0);
    r3 = MemoryInline::FlatRead32((r5 + 7736));
...
// RECOMP_REGISTRATION base 0x8064FCFC func_8064FCFC preserves=true fpr_mask=0x00000000
