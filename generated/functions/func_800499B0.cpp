...
extern "C" void func_800499B0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80049ADC:
{
    f28.d = MemoryInline::FlatReadFloat32((r2 + -29952));
}
...
// RECOMP_REGISTRATION base 0x800499B0 func_800499B0 preserves=false fpr_mask=0xF0000000
