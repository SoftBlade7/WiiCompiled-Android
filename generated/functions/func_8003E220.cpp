...
extern "C" void func_8003E220(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8003E220:
{
    ...
    r3 = (r8 + 48);
    guest_range_1 = MemoryInline::ResolveRangeHost(r8, 0, 52u, false, true);
    MemoryInline::WriteResolvedFloat32(guest_range_1, 0u, r8, f1.d);
    r7 = (r8 + 0);
    r6 = (r8 + 12);
    r5 = (r8 + 24);
    r4 = (r8 + 36);
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 4u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f0.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 4u, (r7 + 4), f0.d);
        MemoryInline::WriteResolvedFloat32(guest_range_1, 8u, (r7 + 8), f0.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 12u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f1.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 12u, (r8 + 12), f0.d);
        MemoryInline::WriteResolvedFloat32(guest_range_1, 16u, (r6 + 4), f1.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 20u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f0.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 20u, (r6 + 8), f0.d);
        MemoryInline::WriteResolvedFloat32(guest_range_1, 24u, (r8 + 24), f0.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 28u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f1.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 28u, (r5 + 4), f0.d);
        MemoryInline::WriteResolvedFloat32(guest_range_1, 32u, (r5 + 8), f1.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 36u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f0.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 36u, (r8 + 36), f0.d);
        MemoryInline::WriteResolvedFloat32(guest_range_1, 40u, (r4 + 4), f0.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 44u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f0.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f1.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_1, 44u, (r4 + 8), f0.d);
        MemoryInline::WriteResolvedFloat32(guest_range_1, 48u, (r8 + 48), f1.d);
    }
...
// RECOMP_GUEST_ABI gpr_read=0x00000004 gpr_write=0x000001F8 gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000003 fpr_return=0x00000002 cr_read=0x00 cr_write=0x00 xer_read=0 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8003E220 func_8003E220 preserves=true fpr_mask=0x00000000
