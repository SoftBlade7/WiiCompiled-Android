...
extern "C" void func_80526D94(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80526D94:
{
    ...
    r29 = r3;
    r23 = 0;
    r4 = MemoryInline::FlatRead32((r26 + -10432));
    r3 = MemoryInline::FlatRead32((r27 + -10440));
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r27 = MemoryInline::FlatRead32((r27 + -10440));
    // inline leaf 0x800BC6E0 (3 guest instruction(s))
    r3 = 0x80270000u;
    r3 = (r3 + 20344);
    // end of inlined leaf 0x800BC6E0
    r4 = MemoryInline::FlatRead32((r26 + -10432));
    r5 = r3;
    r3 = r27;
    r7 = (r29 + 28);
    r6 = MemoryInline::FlatRead32((r4 + 48));
    r4 = 0;
    r8 = 32;
    ctx->lr = 0x80526DF4u;
    ctx->gpr[0] = r0;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8054155Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80526E04:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x805411ECu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
{
    r3 = 1;
    // inline leaf 0x800BBB80 (7 guest instruction(s))
}
...
loc_inl1_cont_800BBB80:
{
    // end of inlined leaf 0x800BBB80
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x800BBF10u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
{
    r0 = 2;
    MemoryInline::FlatWrite32((r29 + 616), r0);
    goto loc_80527144;
}
...
{
    r3 = 100;
    // inline leaf 0x800C8850 (2 guest instruction(s))
    r3_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(6));
    r3 = (r3_rot_2 & 4194240);
    // end of inlined leaf 0x800C8850
    r12 = MemoryInline::FlatRead32(r30);
    r4 = r3;
    r3 = r30;
    r5 = 4;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r24 + 32), r3);
    r5 = r3;
    r3 = r25;
    r4 = 1;
    r6 = 100;
    ...
    r3 = r25;
    // inline leaf 0x800C97E0 (12 guest instruction(s))
}
...
loc_inl3_0x800C9800:
{
    ...
    r0_mrot_2 = (r0_rot_2 & -1073741824);
    r0_mdest_2 = (r0 & 1073741823);
...
loc_inl3_cont_800C97E0:
{
    // end of inlined leaf 0x800C97E0
    r3 = r25;
    ctx->lr = 0x80526EF4u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    cr = ctx->cr;
    r3 = r27;
    // inline leaf 0x800C9710 (2 guest instruction(s))
    r3 = MemoryInline::FlatRead16((r3 + 14));
    // end of inlined leaf 0x800C9710
    r4 = (r29 + r23);
    r23 = (r23 + 1);
...
loc_80526F0C:
{
    MemoryInline::FlatWrite8((r4 + 608), static_cast<uint8_t>(r3));
    r24 = (r24 + 4);
    r25 = (r25 + 24);
    r26 = (r26 + 4);
    r27 = (r27 + 24);
...
loc_80526F34:
{
    r3 = 100;
    // inline leaf 0x800C8850 (2 guest instruction(s))
    r3_rot_4 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(6));
    r3 = (r3_rot_4 & 4194240);
    // end of inlined leaf 0x800C8850
    r12 = MemoryInline::FlatRead32(r30);
    r4 = r3;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r24 + 40), r3);
    r5 = r3;
    r3 = r25;
    r4 = 3;
    r6 = 100;
    ...
    r4 = 2;
    r5 = 3;
    // inline leaf 0x800C97C0 (7 guest instruction(s))
}
...
loc_inl6_cont_800C97C0:
{
    // end of inlined leaf 0x800C97C0
    r23 = (r23 + 1);
    r25 = (r25 + 24);
...
loc_80526F98:
{
    r3 = 1;
    // inline leaf 0x800C8850 (2 guest instruction(s))
    r3_rot_5 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(6));
    r3 = (r3_rot_5 & 4194240);
    // end of inlined leaf 0x800C8850
    r12 = MemoryInline::FlatRead32(r30);
    r4 = r3;
...
loc_80526FE0:
{
    r3 = 2;
    // inline leaf 0x800C8850 (2 guest instruction(s))
    r3_rot_7 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(6));
    r3 = (r3_rot_7 & 4194240);
    // end of inlined leaf 0x800C8850
    r12 = MemoryInline::FlatRead32(r30);
    r4 = r3;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r24 + 56), r3);
    r5 = r3;
    r3 = r25;
    r4 = 5;
    r6 = 2;
...
loc_80527050:
{
    r3 = 100;
    // inline leaf 0x800C8850 (2 guest instruction(s))
    r3_rot_9 = PpcRotl32Inline(static_cast<uint32_t>(r3), static_cast<uint32_t>(6));
    r3 = (r3_rot_9 & 4194240);
    // end of inlined leaf 0x800C8850
    r12 = MemoryInline::FlatRead32(r30);
    r4 = r3;
    ...
    xer = ctx->xer;
    r4 = (r24 + r26);
    MemoryInline::FlatWrite32((r25 + 540), r3);
    r23 = (r4 + 8);
    r5 = r3;
    r3 = r23;
    r4 = 3;
...
loc_inl10_0x800C97C0:
{
    r0 = MemoryInline::FlatRead32(r3);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(3));
}

loc_inl10_0x800C97C8:
{
    if (((cr & 0x20000000u) == 0)) {
...
loc_inl10_0x800C97CC:
{
    MemoryInline::FlatWrite8((r3 + 16), static_cast<uint8_t>(r4));
    MemoryInline::FlatWrite8((r3 + 17), static_cast<uint8_t>(r5));
    MemoryInline::FlatWrite8((r3 + 18), static_cast<uint8_t>(r6));
    goto loc_inl10_cont_800C97C0;
}
...
loc_inl10_cont_800C97C0:
{
    ...
    cr = ctx->cr;
    r22 = (r22 + 1);
    MemoryInline::FlatWrite16((r25 + 568), static_cast<uint16_t>(r28));
...
{
    r28 = 1;
    MemoryInline::FlatWrite32((r29 + 620), r30);
    r3 = r29;
    MemoryInline::FlatWrite8((r29 + 611), static_cast<uint8_t>(r28));
    ctx->lr = 0x805270ECu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80527298u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead8((r29 + 611));
...
loc_80527120:
{
    MemoryInline::FlatWrite8((r29 + 612), static_cast<uint8_t>(r28));
}
...
// RECOMP_REGISTRATION base 0x80526D94 func_80526D94 preserves=true fpr_mask=0x00000000
