...
extern "C" void func_80589024(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r3 = 0x808B0000u;
    r3 = MemoryInline::FlatRead16((r3 + 23224));
    r3 = (r3 << 16);
...
// RECOMP_REGISTRATION base 0x80589024 func_80589024 preserves=true fpr_mask=0x00000000
