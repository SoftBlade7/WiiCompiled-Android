...
extern "C" void func_801D6430(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801D665C:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r6 = MemoryInline::FlatRead32((r31 + 804));
...
loc_801D6678:
{
    r4 = MemoryInline::FlatRead32((r30 + 2000));
    r3 = r27;
    r5 = r26;
    r7 = 0;
    ctx->lr = 0x801D668Cu;
...
// RECOMP_REGISTRATION base 0x801D6430 func_801D6430 preserves=true fpr_mask=0x00000000
