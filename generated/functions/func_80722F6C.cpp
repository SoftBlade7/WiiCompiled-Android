...
extern "C" void func_80722F6C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80722F6C:
{
    ...
    f30.d = MemoryInline::FlatReadFloat32((r4 + 28));
    ...
    f3.d = static_cast<double>(PpcForceSingleValueInline(f30.d - f31.d));
    f1.d = MemoryInline::FlatReadFloat32((r31 + 16));
    f0.d = MemoryInline::FlatReadFloat32((r3 + 8444));
...
loc_80722FFC:
{
    ...
    r30 = MemoryInline::FlatRead32((r28 + 40));
}
...
loc_80723090:
{
    ...
    MemoryInline::FlatWriteFloat32((r28 + 468), f0.d);
    MemoryInline::FlatWriteFloat32((r28 + 472), f31.d);
    MemoryInline::FlatWriteFloat32((r28 + 476), f1.d);
...
// RECOMP_GUEST_ABI gpr_read=0xFFFFEFFF gpr_write=0xFFFFFFFF gpr_return=0x00000018 fpr_read=0xFFFFFFF5 fpr_write=0xFFFFFFFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=1
// RECOMP_REGISTRATION base 0x80722F6C func_80722F6C preserves=false fpr_mask=0xC0000000
