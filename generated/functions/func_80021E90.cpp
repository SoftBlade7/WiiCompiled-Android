...
extern "C" void func_80021E90(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t cr1_0 = 0;
...
loc_80021EDC:
{
    ...
    r0 = MemoryInline::FlatRead32((r11 + 27768));
...
loc_80021F40:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80021F80u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80021E90 func_80021E90 preserves=true fpr_mask=0x00000000
