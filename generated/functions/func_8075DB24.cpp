...
extern "C" void func_8075DB24(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8075DB24:
{
    r3 = (r3 + -8);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x8075D58Cu>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8075DB24 func_8075DB24 preserves=true fpr_mask=0x00000000
