...
extern "C" void func_806BE9CC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_806BEA04:
{
    r4 = MemoryInline::FlatRead32((r30 + 340));
    r3 = (r1 + 8);
    r5 = (r30 + 328);
    r4 = (r4 + 24);
...
loc_806BEA34:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r3 + 10028));
...
// RECOMP_REGISTRATION base 0x806BE9CC func_806BE9CC preserves=false fpr_mask=0x80000000
