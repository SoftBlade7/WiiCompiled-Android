...
extern "C" void func_80070EC0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80070F88:
{
    ...
    r0 = (r28 + -9);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r0), static_cast<uint32_t>(332));
}
...
{
    r0 = MemoryInline::FlatRead32((r30 + 260));
    r27 = MemoryInline::FlatRead32((r30 + 236));
    r0 = (r0 & -2);
    MemoryInline::FlatWrite32((r30 + 260), r0);
}
...
loc_80070FE8:
{
    ...
    ctx->gpr[3] = r3;
    ctx->cr = cr;
    InvokeDirectCpu<0x8006E070u>(ctx);
    r3 = ctx->gpr[3];
    cr = ctx->cr;
    r12 = MemoryInline::FlatRead32(r30);
    r4 = 131072;
...
loc_80071044:
{
    r5 = MemoryInline::FlatRead32((r30 + 284));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r5), static_cast<int32_t>(0));
}
...
loc_80071050:
{
    r4 = MemoryInline::FlatRead16((r30 + 290));
    r3 = r27;
    ...
    r8 = MemoryInline::FlatRead32((r30 + 292));
    r0 = MemoryInline::FlatRead32((r30 + 232));
    MemoryInline::FlatWriteRam32((r1 + 20), r0);
    r4 = MemoryInline::FlatRead32((r30 + 240));
    r5 = MemoryInline::FlatRead32((r30 + 264));
    ctx->lr = 0x80071090u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x800679A0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800710CC:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80067F70u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800710EC:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800B1940u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80070EC0 func_80070EC0 preserves=true fpr_mask=0x00000000
