...
extern "C" void func_800943E0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800943E0:
{
    ...
    r0 = ctx->lr;
    r5 = 0x80270000u;
    f6.d = MemoryInline::FlatReadFloat32((r2 + -28464));
    MemoryInline::WriteResolved32(guest_range_1, 68u, (r1 + 68), r0);
    r6 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r2 + -28444));
    r5 = (r5 + 17408);
    MemoryInline::WriteResolved32(guest_range_1, 60u, (r1 + 60), r31);
    r0 = 5;
    f5.d = MemoryInline::FlatReadFloat32((r2 + -28460));
    r31 = r3;
    f4.d = MemoryInline::FlatReadFloat32((r2 + -28456));
    r4 = (r1 + 8);
    f3.d = MemoryInline::FlatReadFloat32((r2 + -28452));
    f2.d = MemoryInline::FlatReadFloat32((r2 + -28448));
    f0.d = MemoryInline::FlatReadFloat32((r2 + -28440));
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 28u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f6.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f5.d))))) {
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 36u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f4.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f3.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 36u, (r3 + 36), f4.d);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 52u, ((static_cast<uint64_t>(static_cast<uint32_t>(r0)) << 32) | PpcBitCastToU32Inline(static_cast<float>(f6.d))))) {
        MemoryInline::WriteResolved32(guest_range_0, 52u, (r3 + 52), r0);
        MemoryInline::WriteResolvedFloat32(guest_range_0, 56u, (r3 + 56), f6.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 60u, ((static_cast<uint64_t>(static_cast<uint32_t>(r6)) << 32) | PpcBitCastToU32Inline(static_cast<float>(f0.d))))) {
...
// RECOMP_REGISTRATION base 0x800943E0 func_800943E0 preserves=true fpr_mask=0x00000000
