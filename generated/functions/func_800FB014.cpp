...
extern "C" void func_800FB014(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800FB014:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800FAF38u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_800FB054:
{
    MemoryInline::FlatWrite8(r29, static_cast<uint8_t>(r31));
    r3 = 0;
    goto loc_800FB09C;
}
...
loc_800FB060:
{
    ...
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r30), static_cast<int32_t>(r5));
}
...
{
    r29_addr_1 = (r29 + r4);
    MemoryInline::FlatWrite8(r29_addr_1, static_cast<uint8_t>(r3));
    r3 = 1;
}
...
// RECOMP_REGISTRATION base 0x800FB014 func_800FB014 preserves=true fpr_mask=0x00000000
