...
extern "C" void func_80758BDC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80758C34:
{
    MemoryInline::FlatWrite32((r31 + 256), r26);
    r3 = 124;
    ctx->lr = 0x80758C40u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80758C6C:
{
    MemoryInline::FlatWrite32((r31 + 260), r26);
    r3 = 124;
    ctx->lr = 0x80758C78u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80758CA4:
{
    MemoryInline::FlatWrite32((r31 + 264), r26);
    r3 = 124;
    ctx->lr = 0x80758CB0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80758CDC:
{
    MemoryInline::FlatWrite32((r31 + 268), r26);
    r3 = 388;
    ctx->lr = 0x80758CE8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80758CF4:
{
    ...
    r3 = 124;
    r4 = (r4 + -13160);
    MemoryInline::FlatWriteRam32(r27, r4);
    MemoryInline::FlatWriteRam32((r27 + 176), r31);
    ctx->lr = 0x80758D20u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_80758D44:
{
    MemoryInline::FlatWriteRam32((r27 + 280), r28);
    r3 = 124;
    ctx->lr = 0x80758D50u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80758D7C:
{
    MemoryInline::FlatWriteRam32((r27 + 288), r26);
    r3 = 124;
    ctx->lr = 0x80758D88u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80758DB4:
{
    MemoryInline::FlatWriteRam32((r27 + 292), r26);
    r3 = 0x808D0000u;
    r3 = (r3 + -13468);
...
loc_80758DC4:
{
    MemoryInline::FlatWrite32((r31 + 176), r27);
    r3 = r27;
...
loc_80758E1C:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32(r25, r28);
    r3 = 124;
    MemoryInline::FlatWriteRam32((r25 + 176), r31);
    ctx->lr = 0x80758E38u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_80758E44:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    MemoryInline::FlatWriteRam32(r24, r29);
}

loc_80758E54:
{
    MemoryInline::FlatWriteRam32((r25 + 280), r24);
    r3 = 124;
    ctx->lr = 0x80758E60u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80758E7C:
{
    MemoryInline::FlatWriteRam32((r25 + 288), r24);
    r3 = 124;
    ctx->lr = 0x80758E88u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_80758EA4:
{
    MemoryInline::FlatWriteRam32((r25 + 292), r24);
    MemoryInline::FlatWriteRam32(r25, r30);
}

loc_80758EAC:
{
    MemoryInline::FlatWrite32((r26 + 180), r25);
    r3 = (r31 + r23);
    ...
    r22 = (r22 + 1);
    r23 = (r23 + 4);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r22), static_cast<int32_t>(10));
}
...
// RECOMP_REGISTRATION base 0x80758BDC func_80758BDC preserves=true fpr_mask=0x00000000
