...
extern "C" void func_807C6A44(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807C6A7C:
{
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r4), static_cast<uint32_t>(11));
}
...
// RECOMP_REGISTRATION base 0x807C6A44 func_807C6A44 preserves=true fpr_mask=0x00000000
