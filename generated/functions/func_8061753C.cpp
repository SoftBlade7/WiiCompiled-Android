...
extern "C" void func_8061753C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80617600:
{
    ...
    guest_range_3 = MemoryInline::ResolveRangeHost((r3 + -64), 0, 68u, false, true);
    MemoryInline::WriteResolved32(guest_range_3, 64u, r3, r4);
    // end of inlined leaf 0x805C2C18
    r16 = 0x80890000u;
    r5 = r17;
    r16 = (r16 + 30572);
    guest_range_1 = MemoryInline::ResolveRangeHost(r16, 0, 60u, true, false);
    r17 = MemoryInline::ReadResolved32(guest_range_1, 0u, r16);
    r25 = 0x80890000u;
    r25 = (r25 + 30688);
    MemoryInline::WriteResolved32(guest_range_3, 0u, (r1 + 8), r17);
    r18 = MemoryInline::ReadResolved32(guest_range_1, 4u, (r16 + 4));
    r3 = (r1 + 72);
    r19 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r16 + 8));
    r4 = (r25 + 251);
    r20 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r16 + 12));
    r6 = (r25 + 259);
    r21 = MemoryInline::ReadResolved32(guest_range_1, 16u, (r16 + 16));
    r7 = (r1 + 8);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r22 = MemoryInline::ReadResolved32(guest_range_1, 20u, (r16 + 20));
            r23 = MemoryInline::ReadResolved32(guest_range_1, 24u, (r16 + 24));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r24 = MemoryInline::ReadResolved32(guest_range_1, 28u, (r16 + 28));
            r26 = MemoryInline::ReadResolved32(guest_range_1, 32u, (r16 + 32));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r12 = MemoryInline::ReadResolved32(guest_range_1, 36u, (r16 + 36));
            r11 = MemoryInline::ReadResolved32(guest_range_1, 40u, (r16 + 40));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r10 = MemoryInline::ReadResolved32(guest_range_1, 44u, (r16 + 44));
            r9 = MemoryInline::ReadResolved32(guest_range_1, 48u, (r16 + 48));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r8 = MemoryInline::ReadResolved32(guest_range_1, 52u, (r16 + 52));
            r0 = MemoryInline::ReadResolved32(guest_range_1, 56u, (r16 + 56));
        }
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 4u, ((static_cast<uint64_t>(static_cast<uint32_t>(r18)) << 32) | static_cast<uint32_t>(r19)))) {
        MemoryInline::WriteResolved32(guest_range_3, 4u, (r1 + 12), r18);
        MemoryInline::WriteResolved32(guest_range_3, 8u, (r1 + 16), r19);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 12u, ((static_cast<uint64_t>(static_cast<uint32_t>(r20)) << 32) | static_cast<uint32_t>(r21)))) {
        MemoryInline::WriteResolved32(guest_range_3, 12u, (r1 + 20), r20);
        MemoryInline::WriteResolved32(guest_range_3, 16u, (r1 + 24), r21);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 20u, ((static_cast<uint64_t>(static_cast<uint32_t>(r22)) << 32) | static_cast<uint32_t>(r23)))) {
        MemoryInline::WriteResolved32(guest_range_3, 20u, (r1 + 28), r22);
        MemoryInline::WriteResolved32(guest_range_3, 24u, (r1 + 32), r23);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 28u, ((static_cast<uint64_t>(static_cast<uint32_t>(r24)) << 32) | static_cast<uint32_t>(r26)))) {
        MemoryInline::WriteResolved32(guest_range_3, 28u, (r1 + 36), r24);
        MemoryInline::WriteResolved32(guest_range_3, 32u, (r1 + 40), r26);
    }
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 52u, ((static_cast<uint64_t>(static_cast<uint32_t>(r8)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_3, 52u, (r1 + 60), r8);
        MemoryInline::WriteResolved32(guest_range_3, 56u, (r1 + 64), r0);
    }
    ctx->lr = 0x806176A8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x8061753C func_8061753C preserves=true fpr_mask=0x00000000
