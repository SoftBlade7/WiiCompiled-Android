...
extern "C" void func_80727B2C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r0 = 0;
    MemoryInline::FlatWrite32((r27 + 188), r0);
}
...
// RECOMP_REGISTRATION base 0x80727B2C func_80727B2C preserves=true fpr_mask=0x00000000
