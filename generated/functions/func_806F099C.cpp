...
extern "C" void func_806F099C(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r3 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + 2888));
    ctx->gpr[3] = r3;
    ctx->fpr[1] = f1;
    return;
}
...
// RECOMP_REGISTRATION base 0x806F099C func_806F099C preserves=true fpr_mask=0x00000000
