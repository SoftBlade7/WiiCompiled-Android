...
extern "C" void func_8063D9C0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8063D9C0:
{
    ...
    r3 = MemoryInline::FlatRead32((r3 + 1004));
    ctx->lr = 0x8063D9E8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[6] = r6;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x805E9F80u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r6 = ctx->gpr[6];
...
// RECOMP_REGISTRATION base 0x8063D9C0 func_8063D9C0 preserves=true fpr_mask=0x00000000
