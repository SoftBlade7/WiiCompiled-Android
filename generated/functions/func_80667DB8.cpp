...
extern "C" void func_80667DB8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80667DB8:
{
    ...
    r29 = r3;
    r5 = MemoryInline::FlatRead32((r3 + 10484));
    r3 = (r5 + 152);
...
loc_80667DF0:
{
    r3 = MemoryInline::FlatRead32((r29 + 10488));
    r4 = 0;
    r3 = (r3 + 152);
    // inline leaf 0x8063C830 (4 guest instruction(s))
    r0 = (r4 * 68);
...
loc_80667E0C:
{
    r31 = MemoryInline::FlatRead32((r29 + 10484));
    r4 = 0;
    r3 = (r31 + 152);
    ...
    r5 = 0x808A0000u;
    r4 = 5;
    f1.d = MemoryInline::FlatReadFloat32((r5 + -23608));
    ctx->lr = 0x80667E2Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_80667E34:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805BDBD4u) && KnownTranslatedCpuCall<0x805BDBD4u>::kAvailable && !KnownTranslatedCpuCall<0x805BDBD4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805BDBD4u>()) {
        const auto state_free_result_805BDBD4_CEA = func_805BDBD4_statefree(r3, r4);
        r3 = static_cast<uint32_t>(state_free_result_805BDBD4_CEA);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_80667E50:
{
    r3 = MemoryInline::FlatRead32((r29 + 10500));
    r0 = (r3 + -1);
    {
...
loc_80667E58:
{
    MemoryInline::FlatWrite32((r29 + 10500), r0);
    if (((cr & 0x80000000u) == 0)) {
        goto loc_80667E6C;
    }
}
...
loc_80667E60:
{
    r3 = MemoryInline::FlatRead32((r29 + 10496));
    r0 = (r3 + -1);
    MemoryInline::FlatWrite32((r29 + 10500), r0);
}
...
loc_80667E6C:
{
    ...
    r3 = r29;
    r0 = MemoryInline::FlatRead32((r29 + 10488));
    MemoryInline::FlatWrite32((r29 + 10484), r0);
    MemoryInline::FlatWrite32((r29 + 10488), r4);
    ctx->lr = 0x80667E84u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80667A50u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80667DB8 func_80667DB8 preserves=true fpr_mask=0x00000000
