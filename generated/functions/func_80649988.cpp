...
extern "C" void func_80649988(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80649988:
{
    ...
    MemoryInline::FlatWrite32((r31 + 1144), r4);
    MemoryInline::FlatWrite32((r31 + 1148), r31);
    MemoryInline::FlatWrite32((r31 + 1152), r6);
    MemoryInline::FlatWrite32((r31 + 1156), r5);
...
// RECOMP_REGISTRATION base 0x80649988 func_80649988 preserves=true fpr_mask=0x00000000
