...
extern "C" void func_80217A30(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80217A30:
{
    ...
    // inline leaf 0x801950EC (7 guest instruction(s))
    r0 = (r3 * 1336);
    r3 = 0x80340000u;
    r3 = (r3 + 22496);
    r3 = (r3 + r0);
    ...
    // end of inlined leaf 0x801950EC
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80217A30 func_80217A30 preserves=true fpr_mask=0x00000000
