...
extern "C" void func_8076E5D8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8076E604:
{
    ...
    xer = ctx->xer;
    r0 = 1;
    MemoryInline::FlatWrite8((r30 + 181), static_cast<uint8_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x8076E5D8 func_8076E5D8 preserves=true fpr_mask=0x00000000
