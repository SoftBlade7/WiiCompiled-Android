...
extern "C" void func_806810E8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806810E8:
{
    ...
    r12 = MemoryInline::FlatRead32((r12 + 328));
    ctr = r12;
    ctx->gpr[12] = r12;
    ctx->ctr = ctr;
...
// RECOMP_REGISTRATION base 0x806810E8 func_806810E8 preserves=true fpr_mask=0x00000000
