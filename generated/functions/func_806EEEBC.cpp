...
extern "C" void func_806EEEBC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806EEEBC:
{
    ...
    r0 = 0;
    f0.d = MemoryInline::FlatReadFloat32((r6 + 2836));
...
loc_806EEF28:
{
    r0 = MemoryInline::FlatRead8((r28 + 68));
...
loc_806EEF60:
{
    ...
    r6 = r29;
    r7 = r30;
    r5 = (static_cast<int32_t>(static_cast<int16_t>(r31)));
    ctx->lr = 0x806EEF80u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x806EEEBC func_806EEEBC preserves=true fpr_mask=0x00000000
