...
extern "C" void func_80707124(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80707124:
{
    r3 = (r3 + -140);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x807042C8u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80707124 func_80707124 preserves=true fpr_mask=0x00000000
