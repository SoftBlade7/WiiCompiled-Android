...
extern "C" void func_807FE03C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r3 = 0x809C0000u;
    r5 = MemoryInline::FlatRead16((r28 + 320));
    r5 = (r5 << 16);
...
// RECOMP_REGISTRATION base 0x807FE03C func_807FE03C preserves=false fpr_mask=0x80000000
