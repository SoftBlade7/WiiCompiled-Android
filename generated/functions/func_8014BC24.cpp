...
extern "C" void func_8014BC24(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8014BC24:
{
    ...
    r31 = 0x80280000u;
    r30 = MemoryInline::FlatRead32((r7 + 28));
    r25 = r3;
...
// RECOMP_REGISTRATION base 0x8014BC24 func_8014BC24 preserves=true fpr_mask=0x00000000
