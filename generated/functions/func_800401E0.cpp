...
extern "C" void func_800401E0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800401E0:
{
    ...
    // psq_load w=1 quant=0 (using PPC_PsqL)
    PpcSetPairedFprInline(f3, PPC_PsqLGqrInline<1u, 0u>(ctx, mkw_gqr0, r3));
    PpcSetPairedFprInline(f1, PPC_PsSubInline(f2.d, f1.d));
    ...
    PpcSetPairedFprInline(f2, PPC_PsMaddInline(f3.d, f3.d, f1.d));
...
// RECOMP_GUEST_ABI gpr_read=0xC000003E gpr_write=0xC0000003 gpr_return=0x00000000 fpr_read=0x0000001F fpr_write=0x0000001F fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x800401E0 func_800401E0 preserves=true fpr_mask=0x00000000
