...
extern "C" void func_80869FD0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8086A064:
{
    ...
    r0_rot_4 = PpcRotl32Inline(static_cast<uint32_t>(r25), static_cast<uint32_t>(2));
    r0 = (r0_rot_4 & 1020);
    MemoryInline::FlatWrite8((r28 + 9), static_cast<uint8_t>(r3));
    r3 = (r29 + r0);
    MemoryInline::FlatWrite8((r28 + 10), static_cast<uint8_t>(r30));
...
// RECOMP_REGISTRATION base 0x80869FD0 func_80869FD0 preserves=true fpr_mask=0x00000000
