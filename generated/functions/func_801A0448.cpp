...
extern "C" void func_801A0448(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801A0448:
{
    ...
    // mfspr 18 unsupported @ 0x801A0490
    r5 = PPC_ReadSpr(18);
    // mfspr 19 unsupported @ 0x801A0494
    r6 = PPC_ReadSpr(19);
...
// RECOMP_REGISTRATION base 0x801A0448 func_801A0448 preserves=true fpr_mask=0x00000000
