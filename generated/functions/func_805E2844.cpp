...
extern "C" void func_805E2844(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805E289C:
{
    ...
    r31 = 0x80890000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r31 + 20544));
    ctx->lr = 0x805E2918u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x805E2844 func_805E2844 preserves=true fpr_mask=0x00000000
