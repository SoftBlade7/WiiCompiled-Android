...
extern "C" void func_805EE658(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805EE658:
{
    r3 = MemoryInline::FlatRead32((r3 + 4872));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x805EE658 func_805EE658 preserves=true fpr_mask=0x00000000
