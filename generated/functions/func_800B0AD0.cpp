...
extern "C" void func_800B0AD0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800B0AD0:
{
    ...
    ctx->gpr[6] = r6;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x800B0C30u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r6 = ctx->gpr[6];
...
// RECOMP_REGISTRATION base 0x800B0AD0 func_800B0AD0 preserves=true fpr_mask=0x00000000
