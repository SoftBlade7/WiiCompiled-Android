...
extern "C" void func_80568064(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80568064:
{
    ...
    r0 = MemoryInline::FlatRead16((r3 + 338));
    r0 = (r0 << 16);
...
loc_805680A4:
{
    r0 = MemoryInline::FlatRead16((r28 + 204));
    r30 = 1;
    r3 = MemoryInline::FlatRead32(r28);
    r0 = (r0 | 2);
    MemoryInline::FlatWrite16((r28 + 204), static_cast<uint16_t>(r0));
...
// RECOMP_REGISTRATION base 0x80568064 func_80568064 preserves=true fpr_mask=0x00000000
