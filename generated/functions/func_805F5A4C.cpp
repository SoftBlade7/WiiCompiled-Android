...
extern "C" void func_805F5A4C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_805F5A60:
{
    ...
    // inline leaf 0x8059E5DC (5 guest instruction(s))
    ...
    r3 = (r3 + 8);
    // end of inlined leaf 0x8059E5DC
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->cr = cr;
    return;
...
// RECOMP_REGISTRATION base 0x805F5A4C func_805F5A4C preserves=true fpr_mask=0x00000000
