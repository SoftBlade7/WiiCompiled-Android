...
extern "C" void func_8076CB08(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8076CB7C:
{
    ...
    r30 = 1;
    r4_addr_1 = (r4 + r0);
    r29 = MemoryInline::FlatRead32(r4_addr_1);
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r3 + 15768));
    MemoryInline::FlatWrite32((r29 + 200), r30);
...
// RECOMP_REGISTRATION base 0x8076CB08 func_8076CB08 preserves=true fpr_mask=0x00000000
