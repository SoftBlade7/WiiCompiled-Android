...
extern "C" void func_80540E3C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80540E3C:
{
    ...
    r0 = (r4 * 28);
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 140u, ((static_cast<uint64_t>(static_cast<uint32_t>(r23)) << 32) | static_cast<uint32_t>(r24)))) {
...
loc_80540E90:
{
    if ((static_cast<int32_t>(r24) < static_cast<int32_t>(48))) {
        goto loc_80540E9C;
    }
}
...
{
    r4 = 0x80890000u;
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r23), static_cast<int32_t>(36));
}
...
loc_80540ECC:
{
    r0_rot_3 = PpcRotl32Inline(static_cast<uint32_t>(r23), static_cast<uint32_t>(2));
    r0 = (r0_rot_3 & -4);
    r6 = (r29 + 496);
    r6_addr_1 = (r6 + r0);
...
loc_80540ED8:
{
    r10_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r25), static_cast<uint32_t>(2));
    r10 = (r10_rot_0 & -4);
    r7 = (r29 + 640);
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r30 + 1244), r31);
    r3 = (r30 + 1256);
    r4 = (r1 + 8);
    r5 = 64;
    ctx->gpr[0] = r0;
    ...
    xer = ctx->xer;
    r4 = 0x80540000u;
    MemoryInline::FlatWrite32((r30 + 1320), r27);
    r3 = MemoryInline::FlatRead32((r30 + 1412));
    r4 = (r4 + 56);
    MemoryInline::FlatWrite32((r30 + 1324), r28);
    r5 = 5;
    r6 = 0;
    ctx->lr = 0x80540F2Cu;
    ctx->gpr[0] = r0;
...
loc_80540F44:
{
    ...
    r0_rot_7 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(26));
...
loc_80540F7C:
{
    guest_range_1 = MemoryInline::ResolveRangeHost((r1 + 140), 0, 44u, true, false);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r23 = MemoryInline::ReadResolved32(guest_range_1, 0u, (r1 + 140));
            r24 = MemoryInline::ReadResolved32(guest_range_1, 4u, (r1 + 144));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r25 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r1 + 148));
            r26 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r1 + 152));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r27 = MemoryInline::ReadResolved32(guest_range_1, 16u, (r1 + 156));
            r28 = MemoryInline::ReadResolved32(guest_range_1, 20u, (r1 + 160));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r29 = MemoryInline::ReadResolved32(guest_range_1, 24u, (r1 + 164));
            r30 = MemoryInline::ReadResolved32(guest_range_1, 28u, (r1 + 168));
        }
    }
    r31 = MemoryInline::ReadResolved32(guest_range_1, 32u, (r1 + 172));
    r0 = MemoryInline::ReadResolved32(guest_range_1, 40u, (r1 + 180));
    ctx->lr = r0;
    r1 = (r1 + 176);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x80540E3C func_80540E3C preserves=true fpr_mask=0x00000000
