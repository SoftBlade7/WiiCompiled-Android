...
extern "C" void func_800FF350(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800FF3D4:
{
    MemoryInline::FlatWrite32((r21 + 4), r29);
...
{
    r28_addr_2 = (r28 + r27);
    MemoryInline::FlatWrite8(r28_addr_2, static_cast<uint8_t>(r30));
    if (((cr & 0x80000000u) != 0)) {
        goto loc_800FF468;
    }
}
...
loc_800FF460:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r25), static_cast<int32_t>(r31));
}
...
loc_800FF468:
{
    MemoryInline::FlatWrite32(r21, r28);
    r3 = 0;
    MemoryInline::FlatWrite32((r21 + 8), r27);
    MemoryInline::FlatWrite32((r21 + 4), r26);
    MemoryInline::FlatWrite32(r22, r25);
    MemoryInline::FlatWrite32(r23, r24);
}
...
// RECOMP_REGISTRATION base 0x800FF350 func_800FF350 preserves=true fpr_mask=0x00000000
