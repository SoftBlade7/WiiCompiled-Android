...
extern "C" void func_8018D934(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8018D9AC:
{
    ...
    r3 = r30;
    // inline leaf 0x8018DEB8 (2 guest instruction(s))
    r3 = MemoryInline::FlatRead32((r3 + 84));
    // end of inlined leaf 0x8018DEB8
...
// RECOMP_REGISTRATION base 0x8018D934 func_8018D934 preserves=false fpr_mask=0xC0000000
