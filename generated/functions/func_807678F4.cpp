...
extern "C" void func_807678F4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807678F4:
{
    ...
    r5 = 0x808D0000u;
    r4 = 0;
    MemoryInline::FlatWrite32((r25 + 180), r4);
    r3 = (r3 + -7392);
    r5 = (r5 + -7156);
    ...
    MemoryInline::FlatWrite32((r25 + 184), r4);
...
loc_8076799C:
{
    MemoryInline::FlatWrite32((r25 + 192), r0);
    r3 = MemoryInline::FlatRead32((r25 + 160));
    r3 = MemoryInline::FlatRead32(r3);
...
loc_807679C0:
{
    ...
    MemoryInline::FlatWriteFloat32((r25 + 196), f1.d);
    r6 = MemoryInline::FlatRead32(r7);
    ...
    xer = ctx->xer;
    r31 = 0x808D0000u;
    f31.d = MemoryInline::FlatReadFloat64((r29 + 40));
    f27.d = MemoryInline::FlatReadFloat32(r29);
    r31 = (r31 + -7864);
    f28.d = MemoryInline::FlatReadFloat32((r29 + 28));
    r27 = 0;
    f29.d = MemoryInline::FlatReadFloat32((r29 + 32));
    r28 = 0;
    r30 = 0x808A0000u;
    goto loc_80767C30;
}
...
loc_80767AE4:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead32((r25 + 192));
    r3 = (r27 ^ -2147483648);
...
{
    r4 = MemoryInline::FlatRead32((r25 + 184));
    f0.d = PpcFmulsInline(f26.d, f30.d);
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r27), static_cast<int32_t>(0));
}
...
loc_80767BA8:
{
    ...
    r5 = MemoryInline::FlatRead32((r25 + 192));
    r0 = PPC_Divw(static_cast<int32_t>(r27), static_cast<int32_t>(r5));
    r4 = (r5 ^ -2147483648);
...
loc_80767C1C:
{
    ...
    r28 = (r28 + 4);
    MemoryInline::FlatWriteFloat32((r3 + 184), f26.d);
}
...
loc_80767C80:
{
    ...
    r5 = MemoryInline::FlatRead32((r25 + 204));
...
// RECOMP_REGISTRATION base 0x807678F4 func_807678F4 preserves=false fpr_mask=0xFC000000
