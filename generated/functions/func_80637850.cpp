...
extern "C" void func_80637850(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80637850:
{
    ...
    r31 = 0x809C0000u;
    MemoryInline::FlatWrite8((r3 + 456), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x80637850 func_80637850 preserves=true fpr_mask=0x00000000
