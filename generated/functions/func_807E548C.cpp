...
extern "C" void func_807E548C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r30 = 0x808B0000u;
    f29.d = MemoryInline::FlatReadFloat64((r29 + 392));
    f30.d = MemoryInline::FlatReadFloat32((r29 + 400));
    r30 = (r30 + -32224);
    f31.d = MemoryInline::FlatReadFloat32((r29 + 404));
    r31 = (r0 ^ -2147483648);
    r27 = 0;
}
...
loc_807E5550:
{
    ...
    f4.d = MemoryInline::FlatReadFloat32((r29 + 352));
...
// RECOMP_REGISTRATION base 0x807E548C func_807E548C preserves=false fpr_mask=0xE0000000
