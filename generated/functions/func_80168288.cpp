...
extern "C" void func_80168288(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8016832C:
{
    ...
    r0 = -855638016;
    r3 = (r0 + r3);
    MemoryInline::FlatWrite32((r3 + 26628), r4);
    MemoryInline::FlatWrite32((r3 + 26632), r28);
    r0_rot_3 = PpcRotl32Inline(static_cast<uint32_t>(r29), static_cast<uint32_t>(2));
    r0 = (r0_rot_3 & -4);
    r0 = (r0 | 3);
    MemoryInline::FlatWrite32((r3 + 26636), r0);
    r3 = r30;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x801A65D4u>(ctx);
...
// RECOMP_GUEST_ABI gpr_read=0xFE0000FB gpr_write=0xFE00081B gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80168288 func_80168288 preserves=true fpr_mask=0x00000000
