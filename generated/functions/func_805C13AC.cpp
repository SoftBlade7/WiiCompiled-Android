...
extern "C" void func_805C13AC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805C13AC:
{
    ...
    r3 = (r29 + 248);
    r4 = 0x808B0000u;
    guest_range_1 = MemoryInline::ResolveRangeHost((r29 + 248), 0, 36u, true, false);
    r30 = MemoryInline::ReadResolved32(guest_range_1, 0u, (r29 + 248));
    r7 = (r7 + 31412);
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r10 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r29 + 260));
    ...
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r7 = MemoryInline::ReadResolved32(guest_range_1, 24u, (r29 + 272));
...
// RECOMP_REGISTRATION base 0x805C13AC func_805C13AC preserves=true fpr_mask=0x00000000
