...
extern "C" void func_80662EBC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80662EE8:
{
    ...
    r0 = (r26 & 255);
    r27 = PPC_Slw(static_cast<uint32_t>(r31), static_cast<uint32_t>(r0));
...
loc_80662F18:
{
    r0_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r26), static_cast<uint32_t>(5));
    r0 = (r0_rot_2 & 8160);
    r3_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r26), static_cast<uint32_t>(2));
    r3 = (r3_rot_2 & 1020);
    r4 = (r5 + r0);
    r0 = MemoryInline::FlatRead32((r4 + 10160));
    r0 = (r0 * 48);
    r0 = (r5 + r0);
    r3 = (r3 + r0);
...
loc_80662F48:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r25 + 2532));
    r0 = (r3 & r27);
...
{
    r0 = (r3 | r27);
    MemoryInline::FlatWrite32((r25 + 2532), r0);
    r4 = r28;
    r3 = (r25 + 2504);
    r5 = (r26 & 65535);
    ctx->lr = 0x80662F78u;
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x800CC3F0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    r3 = MemoryInline::FlatRead32((r24 + -10480));
    r4 = (r25 + 2504);
    r5 = (r26 & 65535);
    ctx->lr = 0x80662F88u;
    ctx->gpr[0] = r0;
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x80529748u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80662EBC func_80662EBC preserves=true fpr_mask=0x00000000
