...
extern "C" void func_80776198(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80776298:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80776498u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8077630C:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x807768A0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80776340:
{
    MemoryInline::FlatWrite32((r30 + 220), r0);
    if (((cr & 0x20000000u) == 0)) {
        goto loc_8077635C;
    }
}
...
// RECOMP_REGISTRATION base 0x80776198 func_80776198 preserves=false fpr_mask=0x80000000
