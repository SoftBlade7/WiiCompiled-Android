...
extern "C" void func_807522B8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807522E0:
{
    ...
    r4 = 3;
    r5 = MemoryInline::FlatRead8((r31 + 264));
    ctx->lr = 0x807522F0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x807522B8 func_807522B8 preserves=true fpr_mask=0x00000000
