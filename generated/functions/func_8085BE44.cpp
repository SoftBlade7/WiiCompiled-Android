...
extern "C" void func_8085BE44(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8085BE44:
{
    ...
    MemoryInline::FlatWrite32((r31 + 72), r4);
    MemoryInline::FlatWrite32((r31 + 76), r31);
    MemoryInline::FlatWrite32((r31 + 80), r6);
    ...
    r3 = (r31 + 92);
    r6 = MemoryInline::FlatRead8((r6 + 38));
    r4 = 1;
    r0 = (r6 + -2);
    r5 = (r6 | ~r5);
...
// RECOMP_REGISTRATION base 0x8085BE44 func_8085BE44 preserves=true fpr_mask=0x00000000
