...
extern "C" void func_80560AA0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r3_rot_0 = 0;
...
loc_80560AA0:
{
    ...
    MemoryInline::FlatWrite8((r6 + 44), static_cast<uint8_t>(r0));
    r0 = MemoryInline::FlatRead8((r4 + 1));
    MemoryInline::FlatWrite8((r6 + 45), static_cast<uint8_t>(r0));
    r0 = MemoryInline::FlatRead8((r4 + 2));
    MemoryInline::FlatWrite8((r6 + 46), static_cast<uint8_t>(r0));
    r0 = MemoryInline::FlatRead8((r4 + 3));
    MemoryInline::FlatWrite8((r6 + 47), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x80560AA0 func_80560AA0 preserves=true fpr_mask=0x00000000
