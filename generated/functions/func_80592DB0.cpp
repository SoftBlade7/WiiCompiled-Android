...
extern "C" void func_80592DB0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lfsx_80592DD0_loc_0 = 0;
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_80592DBC:
{
    ...
    r4 = 0x809C0000u;
    r4 = MemoryInline::FlatRead32((r4 + 6488));
    r0_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(2));
    r0 = (r0_rot_0 & -4);
    r3 = MemoryInline::FlatRead32((r3 + 124));
    addr_lfsx_80592DD0_loc_0 = (r4 + r0);
    f0.d = MemoryInline::FlatReadFloat32(addr_lfsx_80592DD0_loc_0);
...
// RECOMP_REGISTRATION base 0x80592DB0 func_80592DB0 preserves=true fpr_mask=0x00000000
