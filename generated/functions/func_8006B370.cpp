...
extern "C" void func_8006B370(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8006B370:
{
    ...
    f2.d = MemoryInline::FlatReadFloat32((r2 + -29360));
    f1.d = (-(f0.d));
    f3.d = MemoryInline::FlatReadFloat32((r2 + -29356));
...
// RECOMP_REGISTRATION base 0x8006B370 func_8006B370 preserves=true fpr_mask=0x00000000
