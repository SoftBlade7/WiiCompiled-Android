...
extern "C" void func_80828F98(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_80828F98:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r5 + -14624));
    MemoryInline::FlatWriteRam32((r1 + 44), r31);
    r31 = r3;
    r3 = MemoryInline::FlatRead32((r3 + 32));
    r4 = MemoryInline::FlatRead16((r31 + 200));
    r4 = (r4 << 16);
    ...
    r0 = (r0_rot_0 & -16);
    r4 = (r4 + r0);
    r5 = MemoryInline::FlatRead16((r4 + 12));
...
loc_80828FEC:
{
    ...
    f1.d = MemoryInline::FlatReadFloat64((r4 + -14584));
...
// RECOMP_REGISTRATION base 0x80828F98 func_80828F98 preserves=true fpr_mask=0x00000000
