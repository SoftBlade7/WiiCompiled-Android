...
extern "C" void func_80526400(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80526430:
{
    ...
    r5 = MemoryInline::FlatRead8((r5 + 8));
    ctx->lr = 0x8052643Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80526400 func_80526400 preserves=true fpr_mask=0x00000000
