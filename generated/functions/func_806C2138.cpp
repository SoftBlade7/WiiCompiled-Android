...
extern "C" void func_806C2138(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806C2138:
{
    ...
    r0 = MemoryInline::FlatRead32((r4 + 12936));
...
loc_806C2168:
{
    ...
    r4 = 0x808A0000u;
    r3 = (r1 + 20);
    f1.d = MemoryInline::FlatReadFloat32((r4 + -2384));
    r4 = (r1 + 8);
    r5 = (r31 + 1340);
    ctx->lr = 0x806C2198u;
    ctx->gpr[0] = r0;
    ...
    ctx->fpr[1] = f1;
    ctx->fpr[2] = f2;
    InvokeDirectCpu<0x806C21C8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x806C2138 func_806C2138 preserves=true fpr_mask=0x00000000
