...
extern "C" void func_8011E480(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8011E480:
{
    r3 = (r3 + 76);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x8011EBF8u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8011E480 func_8011E480 preserves=true fpr_mask=0x00000000
