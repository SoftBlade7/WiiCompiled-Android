...
extern "C" void func_808095B8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80809748:
{
    ...
    MemoryInline::FlatWrite32((r28 + 356), r3);
    MemoryInline::FlatWrite32((r28 + 348), r0);
...
// RECOMP_REGISTRATION base 0x808095B8 func_808095B8 preserves=true fpr_mask=0x00000000
