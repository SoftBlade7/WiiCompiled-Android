...
extern "C" void func_80241CE0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80241CE0:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80241FCCu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80241D10:
{
    ...
    ctx->gpr[5] = r5;
    ctx->cr = cr;
    InvokeDirectCpu<0x80241F0Cu>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    r5 = ctx->gpr[5];
    cr = ctx->cr;
...
loc_80241D80:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r30), static_cast<int32_t>(35));
}
...
loc_80241D8C:
{
    ...
    ctx->gpr[4] = r4;
    ctx->cr = cr;
    InvokeDirectCpu<0x80241F9Cu>(ctx);
    r0 = ctx->gpr[0];
    r3 = ctx->gpr[3];
    cr = ctx->cr;
...
loc_80241E24:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r30), static_cast<int32_t>(13));
}
...
{
    r3_addr_3 = (r3 + r29);
    MemoryInline::FlatWrite8(r3_addr_3, static_cast<uint8_t>(r30));
    r29 = (r29 + 1);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_80241E90;
    }
...
// RECOMP_REGISTRATION base 0x80241CE0 func_80241CE0 preserves=true fpr_mask=0x00000000
