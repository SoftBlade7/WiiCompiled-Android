...
extern "C" void func_8080D12C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_inl5_cont_807BDA9C:
{
    ...
    r0_rot_5 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(5));
    r0 = (r0_rot_5 & 65504);
    r3 = (r3 + 14552);
    r4 = (r5 + -1);
    r4 = (r4 * 12);
...
loc_inl11_0x807BDAB4:
{
    if ((static_cast<int32_t>(r7) < static_cast<int32_t>(64))) {
        goto loc_inl11_0x807BDABC;
    }
}

loc_inl11_0x807BDAB8:
{
    r7 = 63;
}

loc_inl11_0x807BDABC:
{
    r0 = (r7 * 12);
    r3 = 0x809C0000u;
    r6 = 0x809C0000u;
...
// RECOMP_REGISTRATION base 0x8080D12C func_8080D12C preserves=false fpr_mask=0xFE000000
