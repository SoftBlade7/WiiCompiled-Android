...
extern "C" void func_805BDD98(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805BDE04:
{
    ...
    r5 = 0x80890000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r5 + 11816));
    ctx->lr = 0x805BDE20u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_805BDEB0:
{
    r0 = MemoryInline::FlatRead32((r31 + 588));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_805BDEBC:
{
    ...
    cr = ctx->cr;
    ctr = ctx->ctr;
    r3 = MemoryInline::FlatRead32((r31 + 588));
    r12 = MemoryInline::FlatRead32(r3);
    r12 = MemoryInline::FlatRead32((r12 + 104));
    ctr = r12;
    ctx->lr = 0x805BDEDCu;
...
// RECOMP_REGISTRATION base 0x805BDD98 func_805BDD98 preserves=true fpr_mask=0x00000000
