...
extern "C" void func_800B0AA0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800B0AA0:
{
    r4 = MemoryInline::FlatRead32((r4 + 328));
    r0 = 0;
    MemoryInline::FlatWrite8((r4 + 362), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x800B0AA0 func_800B0AA0 preserves=true fpr_mask=0x00000000
