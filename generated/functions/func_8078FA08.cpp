...
extern "C" void func_8078FA08(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8078FA98:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r9 + 144));
...
{
    r3 = 0x809C0000u;
    f1.d = MemoryInline::FlatReadFloat32((r9 + 136));
    ...
    ctx->fpr[2] = f2;
    ctx->cr = cr;
    InvokeDirectCpu<0x8081C0F8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8078FA08 func_8078FA08 preserves=true fpr_mask=0x00000000
