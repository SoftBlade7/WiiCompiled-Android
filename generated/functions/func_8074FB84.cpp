...
extern "C" void func_8074FB84(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8074FC00:
{
    ...
    r0 = MemoryInline::FlatRead32((r3 + 11440));
    r0 = (r4 + r0);
...
// RECOMP_REGISTRATION base 0x8074FB84 func_8074FB84 preserves=true fpr_mask=0x00000000
