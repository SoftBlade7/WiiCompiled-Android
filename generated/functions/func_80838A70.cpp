...
extern "C" void func_80838A70(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80838A70:
{
    r3 = MemoryInline::FlatRead32((r3 + 1000));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80838A70 func_80838A70 preserves=true fpr_mask=0x00000000
