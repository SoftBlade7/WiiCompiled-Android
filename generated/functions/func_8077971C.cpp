...
extern "C" void func_8077971C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8077978C:
{
    ...
    r0 = MemoryInline::FlatRead8((r28 + 208));
    r29 = (r3 & 255);
...
loc_80779808:
{
    ...
    r27 = 0x808A0000u;
    r26 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r27 + 17216));
    r3 = MemoryInline::FlatRead32((r3 + 40));
    r4 = 1;
    f2.d = MemoryInline::FlatReadFloat32((r26 + 17264));
    ctx->lr = 0x80779830u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
{
    r0 = 0;
    MemoryInline::FlatWrite32((r28 + 200), r29);
    MemoryInline::FlatWrite8((r28 + 208), static_cast<uint8_t>(r0));
    goto loc_80779A44;
}
...
{
    r26 = 1;
    MemoryInline::FlatWrite8((r3 + 180), static_cast<uint8_t>(r26));
    r3 = 0x808D0000u;
    r4 = 0x802A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + 1484));
    r3 = (r1 + 8);
    r4 = (r4 + 16688);
    ...
    MemoryInline::FlatWrite32((r28 + 212), r0);
    // inline leaf 0x80590A5C (4 guest instruction(s))
    r3 = MemoryInline::FlatRead32(r3);
    r3 = MemoryInline::FlatRead32(r3);
    r3 = MemoryInline::FlatRead8((r3 + 16));
...
loc_80779978:
{
    MemoryInline::FlatWrite32((r28 + 176), r26);
    r27 = 0x808A0000u;
    r3 = MemoryInline::FlatRead32((r28 + 8));
    r26 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r27 + 17216));
...
loc_807799C8:
{
    ...
    r26 = 0x808A0000u;
    r27 = 0x808A0000u;
    f1.d = MemoryInline::FlatReadFloat32((r26 + 17216));
    r3 = MemoryInline::FlatRead32((r3 + 40));
    r4 = 0;
    f2.d = MemoryInline::FlatReadFloat32((r27 + 17264));
    ctx->lr = 0x807799F0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
{
    r0 = 0;
    MemoryInline::FlatWrite32((r28 + 200), r31);
    MemoryInline::FlatWrite8((r28 + 208), static_cast<uint8_t>(r0));
}

loc_80779A24:
{
    r0 = MemoryInline::FlatRead8((r28 + 209));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r0), static_cast<int32_t>(0));
}
...
loc_80779A30:
{
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWrite8((r28 + 209), static_cast<uint8_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x8077971C func_8077971C preserves=false fpr_mask=0x80000000
