...
extern "C" void func_801D9610(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_801D96A8:
{
    r5 = MemoryInline::FlatRead16((r30 + 260));
    r3 = (r31 + 540);
    r4 = (r30 + 4);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_801D96C0;
...
loc_801D96C4:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x801D94A0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x801D9610 func_801D9610 preserves=true fpr_mask=0x00000000
