...
extern "C" void func_80112898(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80112948:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x801117F0u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8011297C:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80114398u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80112990:
{
    // inline leaf 0x80113AE4 (2 guest instruction(s))
    r3 = MemoryInline::FlatRead32((r3 + 24));
    // end of inlined leaf 0x80113AE4
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r3), static_cast<int32_t>(0));
}
...
loc_801129B8:
{
    r12 = MemoryInline::FlatRead32((r31 + 436));
...
// RECOMP_REGISTRATION base 0x80112898 func_80112898 preserves=true fpr_mask=0x00000000
