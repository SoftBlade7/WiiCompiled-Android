...
extern "C" void func_807DBE0C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_807DBE0C:
{
    ...
    r30 = r7;
    r31 = r9;
    r5 = MemoryInline::FlatRead32((r6 + 6484));
    r6 = 256;
    r8_addr_0 = (r8 + r0);
    r4 = MemoryInline::FlatRead32(r8_addr_0);
    ctx->lr = 0x807DBE54u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_807DBE7C:
{
    ...
    r3 = (r3 + r0);
    r0 = (r3 + 3116);
    MemoryInline::FlatWrite32((r26 + 76), r0);
}
...
// RECOMP_REGISTRATION base 0x807DBE0C func_807DBE0C preserves=true fpr_mask=0x00000000
