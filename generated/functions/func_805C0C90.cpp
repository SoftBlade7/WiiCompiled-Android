...
extern "C" void func_805C0C90(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805C0C90:
{
    ...
    r4 = 0x80890000u;
    f1.d = MemoryInline::FlatReadFloat32((r4 + 12276));
    r4 = 65;
...
// RECOMP_REGISTRATION base 0x805C0C90 func_805C0C90 preserves=true fpr_mask=0x00000000
