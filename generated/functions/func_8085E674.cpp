...
extern "C" void func_8085E674(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8085E6B8:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x807F651Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8085E728:
{
    MemoryInline::FlatWrite32((r28 + 6336), r31);
    r3 = r28;
    r4 = r30;
    r5 = r31;
    r6 = 0;
...
loc_8085E76C:
{
    ...
    r3 = 0x809C0000u;
    r0 = 0;
    MemoryInline::FlatWriteRam8((r4 + 18196), static_cast<uint8_t>(r0));
    MemoryInline::FlatWriteRam32((r3 + 18200), r0);
...
// RECOMP_REGISTRATION base 0x8085E674 func_8085E674 preserves=true fpr_mask=0x00000000
