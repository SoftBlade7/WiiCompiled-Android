...
extern "C" void func_80555628(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80555628:
{
    ...
    r5 = 0x80890000u;
    f2.d = MemoryInline::FlatReadFloat64((r5 + 4984));
    r5 = 0;
    r6 = (r10 * r8);
    r8 = (r11 * r8);
    r6 = (r7 + r6);
...
// RECOMP_GUEST_ABI gpr_read=0x0000000A gpr_write=0x00000FF3 gpr_return=0x00000010 fpr_read=0x00000000 fpr_write=0x00000007 fpr_return=0x00000002 cr_read=0x00 cr_write=0x00 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x80555628 func_80555628 preserves=true fpr_mask=0x00000000
