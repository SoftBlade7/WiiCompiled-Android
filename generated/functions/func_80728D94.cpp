...
extern "C" void func_80728D94(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80728E0C:
{
    r0 = MemoryInline::FlatRead32((r27 + 416));
...
// RECOMP_REGISTRATION base 0x80728D94 func_80728D94 preserves=true fpr_mask=0x00000000
