...
extern "C" void func_8072C5E8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8072C5E8:
{
    ...
    f31.d = PpcFmulsInline(f2.d, f2.d);
    MemoryInline::WriteResolved32(guest_range_2, 20u, (r1 + 20), r4);
    f30.d = PpcFmulsInline(f1.d, f1.d);
    f29.d = PpcFmulsInline(f0.d, f0.d);
    r31 = 0;
...
loc_8072C674:
{
    r25 = MemoryInline::FlatRead32((r28 + 12));
}
...
loc_8072C6C0:
{
    ...
    ctx->fpr[31] = f31;
    ctx->cr = cr;
    InvokeDirectCpu<0x8072C814u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_8072C6F0:
{
    MemoryInline::FlatWrite32((r28 + 36), r30);
    goto loc_8072C6FC;
}
...
// RECOMP_GUEST_ABI gpr_read=0xFF00003F gpr_write=0xFF00083B gpr_return=0x00000018 fpr_read=0xE000001F fpr_write=0xE00000FF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8072C5E8 func_8072C5E8 preserves=false fpr_mask=0xE0000000
