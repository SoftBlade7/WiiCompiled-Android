...
extern "C" void func_8078B540(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8078B540:
{
    ...
    r3 = (r29 + 16);
    f1.d = MemoryInline::FlatReadFloat32((r30 + 272));
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 12u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f2.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f1.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 12u, (r29 + 16), f2.d);
    ...
    r3 = (r29 + 40);
    MemoryInline::WriteResolvedFloat32(guest_range_0, 36u, (r29 + 40), f0.d);
    r4 = (r31 + 13824);
    r5 = (r29 + 28);
...
// RECOMP_REGISTRATION base 0x8078B540 func_8078B540 preserves=true fpr_mask=0x00000000
