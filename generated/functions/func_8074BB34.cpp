...
extern "C" void func_8074BB34(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8074BB34:
{
    ...
    r30 = 0x80380000u;
    MemoryInline::FlatWriteRam32((r30 + 16704), r31);
    r30 = (r30 + 16704);
    ...
    guest_range_0 = MemoryInline::ResolveRangeHost((r30 + 4), 0, 44u, false, true);
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 0u, ((static_cast<uint64_t>(static_cast<uint32_t>(r12)) << 32) | static_cast<uint32_t>(r11)))) {
        MemoryInline::WriteResolved32(guest_range_0, 0u, (r30 + 4), r12);
        MemoryInline::WriteResolved32(guest_range_0, 4u, (r30 + 8), r11);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 8u, ((static_cast<uint64_t>(static_cast<uint32_t>(r10)) << 32) | static_cast<uint32_t>(r9)))) {
        MemoryInline::WriteResolved32(guest_range_0, 8u, (r30 + 12), r10);
        MemoryInline::WriteResolved32(guest_range_0, 12u, (r30 + 16), r9);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 16u, ((static_cast<uint64_t>(static_cast<uint32_t>(r8)) << 32) | static_cast<uint32_t>(r7)))) {
        MemoryInline::WriteResolved32(guest_range_0, 16u, (r30 + 20), r8);
        MemoryInline::WriteResolved32(guest_range_0, 20u, (r30 + 24), r7);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r6)) << 32) | static_cast<uint32_t>(r5)))) {
        MemoryInline::WriteResolved32(guest_range_0, 24u, (r30 + 28), r6);
        MemoryInline::WriteResolved32(guest_range_0, 28u, (r30 + 32), r5);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 32u, ((static_cast<uint64_t>(static_cast<uint32_t>(r4)) << 32) | static_cast<uint32_t>(r3)))) {
        MemoryInline::WriteResolved32(guest_range_0, 32u, (r30 + 36), r4);
        MemoryInline::WriteResolved32(guest_range_0, 36u, (r30 + 40), r3);
    }
    MemoryInline::WriteResolved32(guest_range_0, 40u, (r30 + 44), r0);
...
// RECOMP_GUEST_ABI gpr_read=0xC0000006 gpr_write=0xC0001FFB gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000007 fpr_return=0x00000002 cr_read=0x00 cr_write=0x00 xer_read=0 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x8074BB34 func_8074BB34 preserves=true fpr_mask=0x00000000
