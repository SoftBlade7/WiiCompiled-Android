...
extern "C" void func_8020FCDC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8020FCDC:
{
    ...
    ctx->gpr[3] = r3;
    ctx->gpr[12] = r12;
    InvokeDirectCpu<0x802442E8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r12 = ctx->gpr[12];
...
// RECOMP_REGISTRATION base 0x8020FCDC func_8020FCDC preserves=true fpr_mask=0x00000000
