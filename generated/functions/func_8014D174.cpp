...
extern "C" void func_8014D174(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_8014D200:
{
    r31 = 0;
    r4 = r29;
    MemoryInline::FlatWrite16((r29 + 6), static_cast<uint16_t>(r31));
    r3 = (r3 + 68);
    ctx->lr = 0x8014D214u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x8014D174 func_8014D174 preserves=true fpr_mask=0x00000000
