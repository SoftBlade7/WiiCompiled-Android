...
extern "C" void func_8067E410(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8067E430:
{
    ...
    f2.d = MemoryInline::FlatReadFloat32((r4 + -11848));
    ctr = r12;
    ctx->lr = 0x8067E454u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x8067E410 func_8067E410 preserves=true fpr_mask=0x00000000
