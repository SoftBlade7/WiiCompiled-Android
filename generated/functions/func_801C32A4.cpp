...
extern "C" void func_801C32A4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r0_rot_0 = 0;
...
loc_801C32A4:
{
    ...
    r3 = ctx->gpr[3];
    r31 = MemoryInline::FlatRead32((r31 + 2104));
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x801C32A4 func_801C32A4 preserves=true fpr_mask=0x00000000
