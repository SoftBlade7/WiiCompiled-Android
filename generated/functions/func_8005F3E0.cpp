...
extern "C" void func_8005F3E0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8005F3E0:
{
    ...
    r3 = MemoryInline::FlatRead16((r3 + 60));
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8005F3E0 func_8005F3E0 preserves=true fpr_mask=0x00000000
