...
extern "C" void func_8059828C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8059828C:
{
    ...
    ctx->fpr[30] = f30;
    ctx->fpr[31] = f31;
    InvokeDirectCpu<0x80786050u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_GUEST_ABI gpr_read=0xF00007BA gpr_write=0xF00007FB gpr_return=0x00000018 fpr_read=0xC0000000 fpr_write=0xC0000007 fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x8059828C func_8059828C preserves=false fpr_mask=0xC0000000
