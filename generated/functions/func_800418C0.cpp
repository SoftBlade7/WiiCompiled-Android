...
extern "C" void func_800418C0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800418C0:
{
    ...
    r30 = r3;
    guest_range_0 = MemoryInline::ResolveRangeHost(r3, 0, 140u, true, false);
    {
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 40u, ((static_cast<uint64_t>(static_cast<uint32_t>(r5)) << 32) | static_cast<uint32_t>(r0)))) {
        ...
        MemoryInline::WriteResolved32(guest_range_1, 40u, (r4 + 40), r5);
    }
    f0.d = MemoryInline::ReadResolvedFloat32(guest_range_0, 136u, (r3 + 136));
...
// RECOMP_GUEST_ABI gpr_read=0xC000003F gpr_write=0xC000003B gpr_return=0x00000018 fpr_read=0x00001F7F fpr_write=0x00001F7F fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x800418C0 func_800418C0 preserves=true fpr_mask=0x00000000
