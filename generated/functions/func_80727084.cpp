...
extern "C" void func_80727084(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80727084:
{
    r4 = 0x808A0000u;
    r0 = 0;
    f0.d = MemoryInline::FlatReadFloat32((r4 + 9152));
...
// RECOMP_REGISTRATION base 0x80727084 func_80727084 preserves=true fpr_mask=0x00000000
