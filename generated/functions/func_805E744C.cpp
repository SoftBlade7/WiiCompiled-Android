...
extern "C" void func_805E744C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805E744C:
{
    ...
    r3 = 0x809C0000u;
    r4 = (r4 + 7440);
    MemoryInline::FlatWriteRam32((r3 + 7272), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x805E744C func_805E744C preserves=true fpr_mask=0x00000000
