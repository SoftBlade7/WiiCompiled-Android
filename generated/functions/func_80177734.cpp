...
extern "C" void func_80177734(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80177734:
{
    ...
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x8017F2D0u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80177734 func_80177734 preserves=true fpr_mask=0x00000000
