...
extern "C" void func_801441D4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_801441D4:
{
    ...
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    InvokeDirectCpu<0x80143FFCu>(ctx);
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
// RECOMP_REGISTRATION base 0x801441D4 func_801441D4 preserves=true fpr_mask=0x00000000
