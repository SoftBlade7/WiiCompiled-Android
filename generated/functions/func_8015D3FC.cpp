...
extern "C" void func_8015D3FC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t r3_rot_0 = 0;
...
{
    r3 = -872415232;
    r0 = MemoryInline::FlatRead16((r3 + 20480));
...
// RECOMP_REGISTRATION base 0x8015D3FC func_8015D3FC preserves=true fpr_mask=0x00000000
