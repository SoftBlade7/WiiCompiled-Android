...
extern "C" void func_8063BCF8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8063BCF8:
{
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWrite32((r29 + 456), r0);
    MemoryInline::FlatWrite8((r29 + 460), static_cast<uint8_t>(r0));
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
// RECOMP_REGISTRATION base 0x8063BCF8 func_8063BCF8 preserves=true fpr_mask=0x00000000
