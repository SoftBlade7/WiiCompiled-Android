...
extern "C" void func_8008F960(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = 0;
    MemoryInline::FlatWrite32((r13 + -27208), r0);
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x8008F960 func_8008F960 preserves=true fpr_mask=0x00000000
