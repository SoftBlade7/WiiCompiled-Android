...
extern "C" void func_805C208C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805C208C:
{
    ...
    r4 = MemoryInline::FlatRead32((r3 + 2636));
    r3 = (r3 + 2088);
...
loc_805C20D4:
{
    r3 = MemoryInline::FlatRead32((r29 + 2636));
...
// RECOMP_REGISTRATION base 0x805C208C func_805C208C preserves=true fpr_mask=0x00000000
