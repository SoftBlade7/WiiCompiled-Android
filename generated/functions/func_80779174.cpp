...
extern "C" void func_80779174(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80779174:
{
    ...
    r31 = r3;
    r3 = (r3 + 48);
    f1.d = MemoryInline::FlatReadFloat32((r4 + 1480));
    ctx->lr = 0x80779198u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
{
    r0 = 1;
    MemoryInline::FlatWrite8((r31 + 208), static_cast<uint8_t>(r0));
}
...
loc_807791B8:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r3 + 1488));
    r3 = (r1 + 8);
    r4 = (r31 + 48);
    r5 = (r31 + 184);
    ...
    ctx->fpr[4] = f4;
    ctx->cr = cr;
    InvokeDirectCpu<0x80779400u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80779174 func_80779174 preserves=true fpr_mask=0x00000000
