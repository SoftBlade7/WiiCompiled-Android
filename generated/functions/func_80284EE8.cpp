...
extern "C" void func_80284EE8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80284EE8:
{
    ...
    r0 = MemoryInline::ReadResolved32(guest_range_0, 120u, (r20 + 17724));
    r0 = MemoryInline::ReadResolved32(guest_range_0, 128u, (r20 + 17732));
    r0 = MemoryInline::ReadResolved32(guest_range_0, 168u, (r20 + 17772));
    r0 = MemoryInline::ReadResolved32(guest_range_0, 136u, (r20 + 17740));
    r0 = MemoryInline::ReadResolved32(guest_range_0, 136u, (r20 + 17740));
    r0 = MemoryInline::ReadResolved32(guest_range_0, 144u, (r20 + 17748));
    r0 = MemoryInline::ReadResolved32(guest_range_0, 152u, (r20 + 17756));
    r0 = MemoryInline::ReadResolved32(guest_range_0, 160u, (r20 + 17764));
...
// RECOMP_REGISTRATION base 0x80284EE8 func_80284EE8 preserves=true fpr_mask=0x00000000
