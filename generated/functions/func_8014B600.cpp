...
extern "C" void func_8014B600(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8014B600:
{
    ...
    r31 = 0x80280000u;
    r28 = MemoryInline::FlatRead32((r7 + 24));
    r30 = r5;
...
// RECOMP_REGISTRATION base 0x8014B600 func_8014B600 preserves=true fpr_mask=0x00000000
