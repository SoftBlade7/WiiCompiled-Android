...
extern "C" void func_807E666C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807E66C4:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r28 = MemoryInline::FlatRead32((r3 + 2112));
}
...
loc_807E66D0:
{
    ...
    r3 = 0x808B0000u;
    r25 = 0x808B0000u;
    f29.d = MemoryInline::FlatReadFloat64((r5 + -30984));
    r30 = r26;
    f30.d = MemoryInline::FlatReadFloat32((r4 + -30992));
    r29 = (r26 + 372);
    f31.d = MemoryInline::FlatReadFloat32((r3 + -30988));
    r25 = (r25 + -30768);
    r27 = 0;
    r31 = 1717960704;
}
...
loc_807E670C:
{
    ...
    r0 = MemoryInline::FlatRead32((r30 + 948));
    r3 = 122;
    MemoryInline::FlatWrite32((r26 + 5180), r0);
    ctx->lr = 0x807E6738u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r8 = MemoryInline::FlatRead32((r26 + 5180));
    r0 = (r31 + 26215);
    r3 = (r26 + 5208);
    r4 = (r25 + 236);
...
// RECOMP_REGISTRATION base 0x807E666C func_807E666C preserves=false fpr_mask=0xE0000000
