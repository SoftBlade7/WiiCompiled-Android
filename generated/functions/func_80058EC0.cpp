...
extern "C" void func_80058EC0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_80058F0C:
{
    f1.d = MemoryInline::FlatReadFloat32((r2 + -29684));
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    ctx->gpr[5] = r5;
...
// RECOMP_REGISTRATION base 0x80058EC0 func_80058EC0 preserves=true fpr_mask=0x00000000
