...
extern "C" void func_8072A0E8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8072A128:
{
    ...
    // inline leaf 0x8073177C (11 guest instruction(s))
    r6 = 0x808D0000u;
    r5 = 0x808A0000u;
    r6 = (r6 + -22924);
    ...
    // end of inlined leaf 0x8073177C
}
...
{
    r4 = MemoryInline::FlatRead32((r31 + 56));
    // inline leaf 0x80730B40 (8 guest instruction(s))
    r5 = 0x808A0000u;
    r6 = 0x808D0000u;
    f0.d = MemoryInline::FlatReadFloat32((r5 + 9864));
    r6 = (r6 + -22924);
    ...
    MemoryInline::FlatWriteRam32((r3 + 4), r4);
    MemoryInline::FlatWriteRamFloat32((r3 + 12), f0.d);
    // end of inlined leaf 0x80730B40
}
...
loc_8072A154:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r3 + 9544));
    r3 = 0x808A0000u;
    ...
    r0 = 0;
    f0.d = MemoryInline::FlatReadFloat32((r3 + 9548));
...
// RECOMP_REGISTRATION base 0x8072A0E8 func_8072A0E8 preserves=true fpr_mask=0x00000000
