...
extern "C" void func_80707104(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r3 = (r3 + -140);
    // inline leaf 0x807056FC (5 guest instruction(s))
    r0 = MemoryInline::FlatRead32((r3 + 96));
    r0 = (r0 & -16);
    r0 = (r0 | r4);
    MemoryInline::FlatWrite32((r3 + 96), r0);
    // end of inlined leaf 0x807056FC
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x80707104 func_80707104 preserves=true fpr_mask=0x00000000
