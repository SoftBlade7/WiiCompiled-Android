...
extern "C" void func_8017FF60(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8017FF60:
{
    ...
    r28_addr_0 = (r28 + r0);
    r3 = MemoryInline::FlatRead32(r28_addr_0);
    r27 = (r28 + r0);
    r25 = (r27 + 8);
...
loc_8017FFC4:
{
    ...
    r1_psq_tmp_2 = (r1 + 8);
    PPC_PsqStStackInline<1u, 5u>(ctx, r1_psq_tmp_2, PPC_PsFromScalarInline(f0.d));
    r6 = -1024;
...
loc_80180044:
{
    ...
    r20 = (r27 + r3);
    r27_addr_4 = (r27 + r3);
    r3 = MemoryInline::FlatRead8(r27_addr_4);
...
loc_80180060:
{
    ...
    r0_rot_9 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(9));
    r0 = (r0_rot_9 & 480);
    r3 = (r3 + r0);
    // end of inlined leaf 0x80184350
    r4 = (r20 * 20);
    r0_rot_10 = PpcRotl32Inline(static_cast<uint32_t>(r24), static_cast<uint32_t>(2));
    r0 = (r0_rot_10 & -4);
    r3 = (r3 + r4);
...
loc_801800C8:
{
    ...
    r20 = (r27 + r3);
    r27_addr_6 = (r27 + r3);
    r3 = MemoryInline::FlatRead8(r27_addr_6);
...
loc_801800F0:
{
    ...
    r24_addr_2 = (r24 + r0);
    r5 = MemoryInline::FlatRead32(r24_addr_2);
    r3 = r22;
    ctx->lr = 0x80180118u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8018013C:
{
    ...
    r24 = (r27 + r3);
    r27_addr_2 = (r27 + r3);
    r3 = MemoryInline::FlatRead8(r27_addr_2);
...
loc_80180158:
{
    ...
    r0_rot_3 = PpcRotl32Inline(static_cast<uint32_t>(r9), static_cast<uint32_t>(8));
    r0 = (r0_rot_3 & 15);
    r8_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r9), static_cast<uint32_t>(28));
    r8 = (r8_rot_2 & 4);
    r3 = (r0 * 20);
    r6_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r9), static_cast<uint32_t>(26));
    r6 = (r6_rot_2 & 4);
    r7_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r9), static_cast<uint32_t>(20));
    r7 = (r7_rot_2 & 4);
    r5_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r9), static_cast<uint32_t>(27));
    r5 = (r5_rot_2 & 4);
    r4_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r9), static_cast<uint32_t>(14));
    r4 = (r4_rot_2 & 60);
    r0_rot_4 = PpcRotl32Inline(static_cast<uint32_t>(r9), static_cast<uint32_t>(9));
    r0 = (r0_rot_4 & 480);
    r0 = (r4 + r0);
    r10_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r9), static_cast<uint32_t>(19));
    r10 = (r10_rot_2 & 28);
    ...
    r4 = (r24 * 20);
    r0_rot_5 = PpcRotl32Inline(static_cast<uint32_t>(r20), static_cast<uint32_t>(2));
    r0 = (r0_rot_5 & -4);
    r3 = (r3 + r4);
...
// RECOMP_REGISTRATION base 0x8017FF60 func_8017FF60 preserves=false fpr_mask=0xE0000000
