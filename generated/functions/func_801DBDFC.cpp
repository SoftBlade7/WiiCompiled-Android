...
extern "C" void func_801DBDFC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
{
    r22 = (2048 - r29);
    xer = (xer & 0xDFFFFFFFu) | ((static_cast<uint32_t>(2048) >= static_cast<uint32_t>(r29) ? 1u : 0u) << 29);
    SetCRResident(cr, xer, 0, static_cast<uint32_t>(r30), static_cast<uint32_t>(r22));
}
...
{
    r27 = (r27 + r22);
    if ((static_cast<uint32_t>(r29) < static_cast<uint32_t>(2048))) {
        goto loc_801DBF68;
    }
}
...
loc_801DBE84:
{
    r3 = MemoryInline::FlatRead32((r23 + 152));
    r4 = r28;
    r5 = 2048;
    ctx->lr = 0x801DBE94u;
    ctx->gpr[0] = r0;
...
loc_801DBF1C:
{
    r0 = MemoryInline::FlatRead32((r18 + 248));
    r0_rot_3 = PpcRotl32Inline(static_cast<uint32_t>(r0), static_cast<uint32_t>(30));
    r0 = (r0_rot_3 & 1073741823);
    r0 = (static_cast<uint32_t>((static_cast<uint64_t>(r31) * static_cast<uint64_t>(r0)) >> 32));
...
loc_801DBF44:
{
    if ((static_cast<uint32_t>(r24) < static_cast<uint32_t>(3))) {
        goto loc_801DBEFC;
    }
}
...
loc_801DBF58:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r26), static_cast<int32_t>(2048));
}
...
loc_801DBF70:
{
    MemoryInline::FlatWrite32((r23 + 8), r29);
    r3 = r25;
}
...
// RECOMP_REGISTRATION base 0x801DBDFC func_801DBDFC preserves=true fpr_mask=0x00000000
