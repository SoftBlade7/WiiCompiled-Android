...
extern "C" void func_807EE23C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_807EE23C:
{
    ...
    r3 = 0x809C0000u;
    r4 = (r4 + 7812);
    MemoryInline::FlatWriteRam32((r3 + 16496), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x807EE23C func_807EE23C preserves=true fpr_mask=0x00000000
