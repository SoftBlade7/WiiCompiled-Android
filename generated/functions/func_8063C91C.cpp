...
extern "C" void func_8063C91C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8063C950:
{
    ...
    r26_rot_1 = PpcRotl32Inline(static_cast<uint32_t>(r4), static_cast<uint32_t>(4));
    r26 = (r26_rot_1 & -16);
    r29 = (r3 + 24);
    r27 = 0x808C0000u;
    r28 = 0x808C0000u;
...
loc_8063C990:
{
    ...
    r5 = MemoryInline::FlatRead8((r31 + 52));
    ctr = r12;
    ctx->lr = 0x8063C9B8u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
loc_8063C9D4:
{
    ...
    r12 = MemoryInline::FlatRead32(r3);
    r26_addr_2 = (r26 + r0);
    r4 = MemoryInline::FlatRead32(r26_addr_2);
...
loc_8063CA04:
{
    ...
    r4_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r25), static_cast<uint32_t>(4));
    r4 = (r4_rot_0 & -16);
    r0 = 1;
    MemoryInline::FlatWrite32((r31 + 56), r25);
    r3 = (r5 + r4);
    MemoryInline::FlatWriteFloat32((r31 + 60), f31.d);
...
// RECOMP_REGISTRATION base 0x8063C91C func_8063C91C preserves=false fpr_mask=0x80000000
