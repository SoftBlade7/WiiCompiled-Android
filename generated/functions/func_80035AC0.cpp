...
extern "C" void func_80035AC0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80035AC0:
{
    ...
    r31 = 0;
    r28 = (r3 + r0);
    r29 = MemoryInline::FlatRead16((r28 + 4));
    r27 = (r28 + 8);
    goto loc_80035B54;
}
...
loc_80035AF0:
{
    ...
    r4 = r27;
    r27 = (r27 + r0);
    r6 = MemoryInline::FlatRead8((r27 + 2));
    r0 = MemoryInline::FlatRead8((r27 + 1));
    ...
    r0 = (r0_rot_2 & -65536);
    r6_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(24));
...
// RECOMP_REGISTRATION base 0x80035AC0 func_80035AC0 preserves=true fpr_mask=0x00000000
