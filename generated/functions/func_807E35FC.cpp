...
extern "C" void func_807E35FC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807E3608:
{
    ...
    r28 = r4;
    r30 = MemoryInline::FlatRead32((r4 + 576));
    if (((cr & 0x20000000u) == 0)) {
        goto loc_807E3634;
    }
}
...
// RECOMP_REGISTRATION base 0x807E35FC func_807E35FC preserves=true fpr_mask=0x00000000
