...
extern "C" void func_807EC20C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807EC244:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r3 + -27088));
...
loc_807EC25C:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r3 + -27084));
    r3 = (r1 + 20);
    r4 = (r31 + 376);
...
// RECOMP_REGISTRATION base 0x807EC20C func_807EC20C preserves=false fpr_mask=0x80000000
