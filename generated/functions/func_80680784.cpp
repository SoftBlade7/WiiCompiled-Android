...
extern "C" void func_80680784(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lhax_806807B8_loc_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_80680784:
{
    ...
    addr_lhax_806807B8_loc_0 = (r3 + r0);
    r0 = MemoryInline::FlatRead16(addr_lhax_806807B8_loc_0);
    r0 = (r0 << 16);
...
// RECOMP_REGISTRATION base 0x80680784 func_80680784 preserves=true fpr_mask=0x00000000
