...
extern "C" void func_806FF6B0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806FF6B0:
{
    r3 = (r3 + -4);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x806FF5C4u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x806FF6B0 func_806FF6B0 preserves=true fpr_mask=0x00000000
