...
extern "C" void func_8079FF5C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8079FF5C:
{
    ...
    ctx->gpr[9] = r9;
    ctx->gpr[10] = r10;
    InvokeDirectCpu<0x807A0040u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
...
// RECOMP_REGISTRATION base 0x8079FF5C func_8079FF5C preserves=true fpr_mask=0x00000000
