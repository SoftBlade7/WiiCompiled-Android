...
extern "C" void func_80591F4C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80591F4C:
{
    r4 = 0x809C0000u;
    r0 = (r3 * 396);
    r3 = MemoryInline::FlatRead32((r4 + 6424));
    r3 = (r3 + r0);
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
// RECOMP_REGISTRATION base 0x80591F4C func_80591F4C preserves=true fpr_mask=0x00000000
