...
extern "C" void func_8075DE40(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8075DE40:
{
    ...
    ctx->fpr[1] = f1;
    ctx->fpr[2] = f2;
    InvokeDirectCpu<0x8075E070u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8075DE40 func_8075DE40 preserves=true fpr_mask=0x00000000
