...
extern "C" void func_80651BEC(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80651BEC:
{
    ...
    r3 = 0x809C0000u;
    r4 = (r4 + 7440);
    MemoryInline::FlatWriteRam32((r3 + 7968), r4);
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x80651BEC func_80651BEC preserves=true fpr_mask=0x00000000
