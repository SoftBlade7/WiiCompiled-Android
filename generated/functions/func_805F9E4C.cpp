...
extern "C" void func_805F9E4C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805F9E4C:
{
    ...
    MemoryInline::FlatWriteRam32((r4 + 24), r3);
    ctx->gpr[0] = r0;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
    return;
...
// RECOMP_REGISTRATION base 0x805F9E4C func_805F9E4C preserves=true fpr_mask=0x00000000
