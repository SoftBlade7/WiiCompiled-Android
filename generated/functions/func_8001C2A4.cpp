...
extern "C" void func_8001C2A4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8001C2A4:
{
    ...
    ctx->gpr[3] = r3;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x8001DAD4u>(ctx);
    r3 = ctx->gpr[3];
    r30 = ctx->gpr[30];
    r31 = ctx->gpr[31];
    r31 = r3;
...
// RECOMP_REGISTRATION base 0x8001C2A4 func_8001C2A4 preserves=true fpr_mask=0x00000000
