...
extern "C" void func_808178A4(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r3 = 0x808B0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + -19352));
    ctx->gpr[3] = r3;
    ctx->fpr[1] = f1;
    return;
}
...
// RECOMP_REGISTRATION base 0x808178A4 func_808178A4 preserves=true fpr_mask=0x00000000
