...
extern "C" void func_80108EBC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r5_rot_0 = 0;
    uint32_t r5_rot_1 = 0;
...
loc_80108F1C:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32((r31 + 1464), r3);
}
...
// RECOMP_REGISTRATION base 0x80108EBC func_80108EBC preserves=true fpr_mask=0x00000000
