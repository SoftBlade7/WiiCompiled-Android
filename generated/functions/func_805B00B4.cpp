...
extern "C" void func_805B00B4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805B00B4:
{
    ...
    r6 = 0x809C0000u;
    r5 = 0x809C0000u;
    r26 = MemoryInline::FlatRead32((r6 + 6952));
    r5 = (r5 + 6960);
...
loc_805B0138:
{
    ...
    ctx->fpr[0] = f0;
    ctx->cr = cr;
    InvokeDirectCpu<0x805B0B28u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x805B00B4 func_805B00B4 preserves=true fpr_mask=0x00000000
