...
extern "C" void func_8011E15C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8011E1A4:
{
    r22 = 0;
    r24 = 0x80280000u;
    MemoryInline::FlatWrite32((r3 + 2088), r5);
    r25 = r6;
    r24 = (r24 + -11520);
    r21 = 0;
    MemoryInline::FlatWrite32((r3 + 64), r22);
    goto loc_8011E218;
}
...
loc_8011E1C4:
{
    ...
    r0 = (r0_rot_2 & -4);
    r24_addr_2 = (r24 + r0);
    r23 = MemoryInline::FlatRead32(r24_addr_2);
    r3 = r23;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
loc_8011E1E8:
{
    ...
    r22 = (r22 + r3);
    r3 = r26;
    // inline leaf 0x8011CFB4 (8 guest instruction(s))
}
...
loc_inl1_cont_8011CFB4:
{
    // end of inlined leaf 0x8011CFB4
    r21 = (r21 + 1);
    r25 = (r25 + 1);
}
...
loc_8011E218:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r21), static_cast<int32_t>(r28));
}
...
// RECOMP_REGISTRATION base 0x8011E15C func_8011E15C preserves=true fpr_mask=0x00000000
