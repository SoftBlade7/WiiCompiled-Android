...
extern "C" void func_806EBD58(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_stfsx_806EBDCC_loc_0 = 0;
    uint32_t addr_stfsx_806EBDE4_loc_0 = 0;
    uint32_t cr0_0 = 0;
...
loc_806EBD58:
{
    ...
    r3 = (r3_rot_0 & -4);
    f27.d = f2.d;
    addr_stfsx_806EBDE4_loc_0 = (r4 + r3);
    MemoryInline::FlatWriteFloat32(addr_stfsx_806EBDE4_loc_0, f2.d);
...
// RECOMP_REGISTRATION base 0x806EBD58 func_806EBD58 preserves=true fpr_mask=0x00000000
