...
extern "C" void func_80616054(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_80616054:
{
    ...
    r28 = r4;
    r4 = (r1 + 32);
    r30 = MemoryInline::FlatRead32((r3 + 7164));
...
loc_806160A8:
{
    ...
    r29 = MemoryInline::FlatRead32((r1 + 48));
...
loc_806160DC:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_1182 = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_1182[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_1182[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
    ...
    MemoryInline::FlatWriteRam32((r1 + 216), r29);
    r3 = r28;
    r5 = (r1 + 60);
    r4 = 6602;
    ctx->lr = 0x806160F8u;
...
// RECOMP_REGISTRATION base 0x80616054 func_80616054 preserves=true fpr_mask=0x00000000
