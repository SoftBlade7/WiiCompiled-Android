...
extern "C" void func_80757764(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
{
    r0 = (r0 * 48);
    r29 = MemoryInline::FlatRead32((r28 + 16));
...
// RECOMP_REGISTRATION base 0x80757764 func_80757764 preserves=true fpr_mask=0x00000000
