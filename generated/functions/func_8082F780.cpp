...
extern "C" void func_8082F780(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8082F810:
{
    ...
    r3 = 0x808B0000u;
    r5 = 0x808B0000u;
    f1.d = MemoryInline::FlatReadFloat32((r3 + -13960));
    r3 = MemoryInline::FlatRead32((r4 + 40));
    r4 = 0;
    f2.d = MemoryInline::FlatReadFloat32((r5 + -13956));
    ctx->lr = 0x8082F830u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8082F780 func_8082F780 preserves=true fpr_mask=0x00000000
