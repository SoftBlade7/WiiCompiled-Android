...
extern "C" void func_805D19A8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805D19A8:
{
    ...
    r31 = 0x80890000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r31 + 16800));
    ctx->lr = 0x805D19DCu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x805D19A8 func_805D19A8 preserves=true fpr_mask=0x00000000
