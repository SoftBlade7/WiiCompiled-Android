...
extern "C" void func_805D55A4(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805D55A4:
{
    ...
    r21 = 0x80890000u;
    r21 = (r21 + 17168);
    guest_range_1 = MemoryInline::ResolveRangeHost(r21, 0, 52u, true, false);
    r22 = MemoryInline::ReadResolved32(guest_range_1, 0u, r21);
    r7 = 0x80890000u;
    MemoryInline::WriteResolved32(guest_range_3, 8u, (r1 + 8), r22);
    r23 = MemoryInline::ReadResolved32(guest_range_1, 4u, (r21 + 4));
    r7 = (r7 + 17280);
    r24 = MemoryInline::ReadResolved32(guest_range_1, 8u, (r21 + 8));
    r31 = r3;
    r25 = MemoryInline::ReadResolved32(guest_range_1, 12u, (r21 + 12));
    r4 = (r1 + 8);
    r26 = MemoryInline::ReadResolved32(guest_range_1, 16u, (r21 + 16));
    r5 = (r7 + 508);
    r27 = MemoryInline::ReadResolved32(guest_range_1, 20u, (r21 + 20));
    r6 = (r7 + 515);
    r28 = MemoryInline::ReadResolved32(guest_range_1, 24u, (r21 + 24));
    r7 = (r7 + 529);
    r29 = MemoryInline::ReadResolved32(guest_range_1, 28u, (r21 + 28));
    r8 = 1;
    r30 = MemoryInline::ReadResolved32(guest_range_1, 32u, (r21 + 32));
    r9 = 0;
    {
        ...
        if (resolved_pair.valid) {
            ...
            r12 = MemoryInline::ReadResolved32(guest_range_1, 36u, (r21 + 36));
            r11 = MemoryInline::ReadResolved32(guest_range_1, 40u, (r21 + 40));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r10 = MemoryInline::ReadResolved32(guest_range_1, 44u, (r21 + 44));
            r0 = MemoryInline::ReadResolved32(guest_range_1, 48u, (r21 + 48));
        }
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 12u, ((static_cast<uint64_t>(static_cast<uint32_t>(r23)) << 32) | static_cast<uint32_t>(r24)))) {
        MemoryInline::WriteResolved32(guest_range_3, 12u, (r1 + 12), r23);
        MemoryInline::WriteResolved32(guest_range_3, 16u, (r1 + 16), r24);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 20u, ((static_cast<uint64_t>(static_cast<uint32_t>(r25)) << 32) | static_cast<uint32_t>(r26)))) {
        MemoryInline::WriteResolved32(guest_range_3, 20u, (r1 + 20), r25);
        MemoryInline::WriteResolved32(guest_range_3, 24u, (r1 + 24), r26);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 28u, ((static_cast<uint64_t>(static_cast<uint32_t>(r27)) << 32) | static_cast<uint32_t>(r28)))) {
        MemoryInline::WriteResolved32(guest_range_3, 28u, (r1 + 28), r27);
        MemoryInline::WriteResolved32(guest_range_3, 32u, (r1 + 32), r28);
    }
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 44u, ((static_cast<uint64_t>(static_cast<uint32_t>(r12)) << 32) | static_cast<uint32_t>(r11)))) {
        MemoryInline::WriteResolved32(guest_range_3, 44u, (r1 + 44), r12);
        MemoryInline::WriteResolved32(guest_range_3, 48u, (r1 + 48), r11);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_3, 52u, ((static_cast<uint64_t>(static_cast<uint32_t>(r10)) << 32) | static_cast<uint32_t>(r0)))) {
    ...
    r30 = 0x80890000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r30 + 17044));
    ctx->lr = 0x805D5668u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ...
    if (MkwStateFreeAbiEnabled(0x805BDBD4u) && KnownTranslatedCpuCall<0x805BDBD4u>::kAvailable && !KnownTranslatedCpuCall<0x805BDBD4u>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805BDBD4u>()) {
        const auto state_free_result_805BDBD4_2DFE = func_805BDBD4_statefree(r3, r4);
        r3 = static_cast<uint32_t>(state_free_result_805BDBD4_2DFE);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x805D55A4 func_805D55A4 preserves=true fpr_mask=0x00000000
