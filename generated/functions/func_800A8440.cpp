...
extern "C" void func_800A8440(CpuContext* MKW_RESTRICT ctx)
{
...
loc_800A8440:
{
    r3 = (r3 + -208);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x800A8400u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x800A8440 func_800A8440 preserves=true fpr_mask=0x00000000
