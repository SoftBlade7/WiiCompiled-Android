...
extern "C" void func_80055E70(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80055EC4:
{
    f31.d = MemoryInline::FlatReadFloat32((r2 + -29728));
...
loc_80055ED8:
{
    ...
    f2.d = MemoryInline::FlatReadFloat64((r2 + -29720));
...
loc_80055F1C:
{
    ...
    r30_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(2));
    r30 = (r30_rot_0 & 1);
    r29_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r5), static_cast<uint32_t>(1));
    r29 = (r29_rot_0 & 1);
...
// RECOMP_GUEST_ABI gpr_read=0xF00007FF gpr_write=0xF00007FB gpr_return=0x00000018 fpr_read=0xC0000FFF fpr_write=0xC0000FFF fpr_return=0x00000002 cr_read=0xFF cr_write=0xFF xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x80055E70 func_80055E70 preserves=false fpr_mask=0xC0000000
