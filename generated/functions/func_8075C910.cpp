...
extern "C" void func_8075C910(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8075C910:
{
    ...
    ctr = ctx->ctr;
    r0 = 1;
    MemoryInline::FlatWrite8((r31 + 285), static_cast<uint8_t>(r0));
...
// RECOMP_REGISTRATION base 0x8075C910 func_8075C910 preserves=true fpr_mask=0x00000000
