...
extern "C" void func_8084B388(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_8084B3B8:
{
    ...
    f0.d = MemoryInline::FlatReadFloat32((r3 + -9052));
...
loc_8084B468:
{
    ...
    r4 = (r0 + r28);
    r5 = MemoryInline::FlatRead32((r4 + 356));
    r4 = (2 - r5);
...
loc_8084B498:
{
    ...
    ctx->ctr = ctr;
    ctx->xer = xer;
    InvokeDirectCpu<0x8084B500u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x8084B388 func_8084B388 preserves=true fpr_mask=0x00000000
