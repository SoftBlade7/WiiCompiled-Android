...
extern "C" void func_80024870(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800248D8:
{
    ...
    r0 = MemoryInline::ReadResolved32(guest_range_0, 32u, (r1 + 164));
    ctx->lr = r0;
    r1 = (r1 + 160);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x80024870 func_80024870 preserves=true fpr_mask=0x00000000
