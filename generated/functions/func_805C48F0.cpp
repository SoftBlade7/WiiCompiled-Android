...
extern "C" void func_805C48F0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805C48F0:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8066BDB4u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_805C4A90:
{
    ...
    if (MkwStateFreeAbiEnabled(0x805CD94Cu) && KnownTranslatedCpuCall<0x805CD94Cu>::kAvailable && !KnownTranslatedCpuCall<0x805CD94Cu>::kMustRemainDynamicallyDispatchable && IsBaseTranslatedCpuTargetActive<0x805CD94Cu>()) {
        const auto state_free_result_805CD94C_2A8B = func_805CD94C_statefree(r3);
        r0 = static_cast<uint32_t>(state_free_result_805CD94C_2A8B[0]);
        r4 = static_cast<uint32_t>(state_free_result_805CD94C_2A8B[1]);
    } else {
        ctx->gpr[0] = r0;
        ctx->gpr[1] = r1;
        ctx->gpr[3] = r3;
...
loc_805C4B7C:
{
    ...
    xer = ctx->xer;
    r0 = (r31 + 88);
    MemoryInline::FlatWrite32((r29 + 2084), r0);
    r3 = r31;
    r4 = 82;
    r12 = MemoryInline::FlatRead32(r31);
    r5 = 0;
...
// RECOMP_REGISTRATION base 0x805C48F0 func_805C48F0 preserves=true fpr_mask=0x00000000
