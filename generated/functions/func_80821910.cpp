...
extern "C" void func_80821910(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80821910:
{
    ...
    r31 = r3;
    r6 = MemoryInline::FlatRead16((r3 + 44));
    r3 = r4;
...
// RECOMP_GUEST_ABI gpr_read=0xE000003E gpr_write=0xE000007B gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x000000FF fpr_return=0x00000002 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=0 fence=0
// RECOMP_REGISTRATION base 0x80821910 func_80821910 preserves=true fpr_mask=0x00000000
