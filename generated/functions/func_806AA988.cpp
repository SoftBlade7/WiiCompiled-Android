...
extern "C" void func_806AA988(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_806AA9D0:
{
    r31 = MemoryInline::FlatRead32((r3 + 572));
...
// RECOMP_REGISTRATION base 0x806AA988 func_806AA988 preserves=true fpr_mask=0x00000000
