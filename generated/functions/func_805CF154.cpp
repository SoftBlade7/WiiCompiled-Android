...
extern "C" void func_805CF154(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_805CF18C:
{
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r26), static_cast<int32_t>(r23));
}
...
{
    r22_addr_2 = (r22 + r31);
    r5 = MemoryInline::FlatRead16(r22_addr_2);
    r28 = (r22 + r31);
    r3 = r24;
    r4 = r30;
    ctx->lr = 0x805CF1A8u;
    ...
    r27 = (r27 + r0);
    MemoryInline::FlatWrite16((r29 + 60), static_cast<uint16_t>(r27));
    goto loc_805CF1BC;
}
...
loc_805CF1D4:
{
    ...
    MemoryInline::FlatWrite16((r21 + 8), static_cast<uint16_t>(r0));
    r0 = (r0 & 65535);
...
loc_805CF1E4:
{
    MemoryInline::FlatWrite16((r21 + 10), static_cast<uint16_t>(r25));
}
...
// RECOMP_GUEST_ABI gpr_read=0xFFE000FB gpr_write=0xFFE003FB gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000000 fpr_return=0x00000000 cr_read=0x01 cr_write=0x01 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x805CF154 func_805CF154 preserves=true fpr_mask=0x00000000
