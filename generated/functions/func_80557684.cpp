...
extern "C" void func_80557684(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80557684:
{
    ...
    r28_rot_0 = PpcRotl32Inline(static_cast<uint32_t>(r31), static_cast<uint32_t>(2));
    r28 = (r28_rot_0 & -4);
    r3_addr_0 = (r3 + r28);
...
loc_805576DC:
{
    ...
    r6 = ctx->gpr[6];
    cr = ctx->cr;
    r7 = MemoryInline::FlatRead32((r29 + 44));
    r5 = r3;
    ...
    r6 = ctx->gpr[6];
    cr = ctx->cr;
    r6 = MemoryInline::FlatRead32((r29 + 36));
    r4 = r30;
...
{
    r0 = 1;
    r3 = MemoryInline::FlatRead16((r29 + 56));
...
// RECOMP_REGISTRATION base 0x80557684 func_80557684 preserves=false fpr_mask=0xC0000000
