...
extern "C" void func_807138D0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80713938:
{
    ...
    r29 = MemoryInline::FlatRead32((r4 + 10264));
...
loc_80713954:
{
    ...
    r28 = MemoryInline::FlatRead32((r4 + 10264));
...
// RECOMP_REGISTRATION base 0x807138D0 func_807138D0 preserves=true fpr_mask=0x00000000
