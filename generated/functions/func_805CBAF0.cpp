...
extern "C" void func_805CBAF0(CpuContext* MKW_RESTRICT ctx)
{
...
{
    r0 = 1;
    MemoryInline::FlatWrite8((r3 + 2661), static_cast<uint8_t>(r0));
    ctx->gpr[0] = r0;
    return;
}
...
// RECOMP_REGISTRATION base 0x805CBAF0 func_805CBAF0 preserves=true fpr_mask=0x00000000
