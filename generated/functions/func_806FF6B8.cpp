...
extern "C" void func_806FF6B8(CpuContext* MKW_RESTRICT ctx)
{
...
loc_806FF6B8:
{
    r3 = (r3 + -4);
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x806FF578u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x806FF6B8 func_806FF6B8 preserves=true fpr_mask=0x00000000
