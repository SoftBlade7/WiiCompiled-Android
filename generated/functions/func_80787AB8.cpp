...
extern "C" void func_80787AB8(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80787AB8:
{
    ...
    f30.d = f2.d;
    MemoryInline::WriteResolvedFloat64(guest_range_0, 40u, (r1 + 40), f29.d);
    f29.d = f1.d;
...
loc_80787B10:
{
    ...
    ctx->fpr[3] = f3;
    ctx->cr = cr;
    InvokeDirectCpu<0x80787C24u>(ctx);
    r0 = ctx->gpr[0];
    f2 = ctx->fpr[2];
    cr = ctx->cr;
...
loc_80787B68:
{
    ...
    f31.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 44u, (r1 + 56));
    f30.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 36u, (r1 + 48));
    f29.d = MemoryInline::ReadResolvedFloat64(guest_range_1, 28u, (r1 + 40));
    {
...
// RECOMP_REGISTRATION base 0x80787AB8 func_80787AB8 preserves=false fpr_mask=0xE0000000
