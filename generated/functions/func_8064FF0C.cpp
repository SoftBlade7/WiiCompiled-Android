...
extern "C" void func_8064FF0C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8064FF0C:
{
    ...
    ctx->gpr[12] = r12;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x8064FF48u>(ctx);
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
    r12 = ctx->gpr[12];
...
// RECOMP_REGISTRATION base 0x8064FF0C func_8064FF0C preserves=true fpr_mask=0x00000000
