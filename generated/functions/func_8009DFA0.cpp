...
extern "C" void func_8009DFA0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8009DFA0:
{
    ...
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x8009EA50u>(ctx);
    r3 = ctx->gpr[3];
    ctx->gpr[3] = r3;
    return;
}
...
// RECOMP_REGISTRATION base 0x8009DFA0 func_8009DFA0 preserves=true fpr_mask=0x00000000
