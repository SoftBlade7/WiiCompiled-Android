...
extern "C" void func_80741898(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80741898:
{
    ...
    ctx->gpr[3] = r3;
    ctx->gpr[31] = r31;
    InvokeDirectCpu<0x8073F92Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r31 = ctx->gpr[31];
...
// RECOMP_REGISTRATION base 0x80741898 func_80741898 preserves=true fpr_mask=0x00000000
