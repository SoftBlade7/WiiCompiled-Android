...
extern "C" void func_80869118(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
...
loc_80869118:
{
    ...
    r30 = r3;
    r31 = (r5 + 16992);
    r29 = MemoryInline::FlatRead32((r5 + 16992));
    r4 = MemoryInline::FlatRead32((r5 + 16996));
    SetCRResident(cr, xer, 0, static_cast<int32_t>(r29), static_cast<int32_t>(-1));
}

loc_80869148:
{
    r0 = MemoryInline::FlatRead32((r5 + 17000));
    if (((cr & 0x20000000u) != 0)) {
        goto loc_808691B0;
    }
}
...
loc_80869178:
{
    ...
    ctx->gpr[6] = r6;
    ctx->cr = cr;
    InvokeDirectCpu<0x808675ECu>(ctx);
    r0 = ctx->gpr[0];
    r4 = ctx->gpr[4];
    r5 = ctx->gpr[5];
    r6 = ctx->gpr[6];
...
loc_808691B0:
{
    ...
    r3 = MemoryInline::FlatRead8((r3 + 33));
    r0 = (r3 + -3);
...
loc_808691DC:
{
    ...
    ctx->gpr[31] = r31;
    ctx->cr = cr;
    InvokeDirectCpu<0x808693B8u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_GUEST_ABI gpr_read=0xFE000FFB gpr_write=0xFE000FFB gpr_return=0x00000018 fpr_read=0x00000000 fpr_write=0x00000001 fpr_return=0x00000000 cr_read=0x03 cr_write=0x03 xer_read=1 xer_write=1 fence=0
// RECOMP_REGISTRATION base 0x80869118 func_80869118 preserves=true fpr_mask=0x00000000
