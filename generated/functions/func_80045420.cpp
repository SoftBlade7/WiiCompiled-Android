...
extern "C" void func_80045420(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_80045420:
{
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r0 = MemoryInline::FlatRead8((r31 + 325));
    r26 = r3;
    r3 = MemoryInline::FlatRead8((r31 + 326));
    ...
    f3.d = MemoryInline::FlatReadFloat64((r2 + -30016));
    r4 = (r4 ^ -2147483648);
...
loc_800454FC:
{
    ...
    f1.d = MemoryInline::FlatReadFloat32((r2 + -30024));
...
loc_80045520:
{
    ...
    f0.d = static_cast<double>(PpcForceSingleValueInline(f0.d - f3.d));
    PpcSetPairedFprInline(f28, PPC_Fres(PPC_PsFromScalarInline(f0.d)));
    PpcSetPairedFprInline(f2, PPC_PsAddInline(f28.d, f28.d));
    PpcSetPairedFprInline(f1, PPC_PsMulInline(f28.d, f28.d));
    PpcSetPairedFprInline(f28, PPC_PsNmsubInline(PPC_PsFromScalarInline(f0.d), f1.d, f2.d));
    f1.d = PPC_PsToScalarInline(f1.d);
    f2.d = PPC_PsToScalarInline(f2.d);
    f28.d = PPC_PsToScalarInline(f28.d);
    goto loc_8004554C;
}

loc_80045548:
{
    f28.d = MemoryInline::FlatReadFloat32((r2 + -30020));
}
...
loc_80045564:
{
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80044B40u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r2 = ctx->gpr[2];
    r3 = ctx->gpr[3];
...
loc_800455D8:
{
    r0 = (r25 ^ -2147483648);
    MemoryInline::FlatWriteRam32((r1 + 92), r0);
    r18 = MemoryInline::FlatRead32((r1 + 48));
    f1.d = f30.d;
    f0.d = MemoryInline::FlatReadFloat64((r1 + 88));
    f2.d = f29.d;
    r19 = MemoryInline::FlatRead32((r1 + 52));
    r3 = r21;
    f0.d = static_cast<double>(PpcForceSingleValueInline(f0.d - f31.d));
    r20 = MemoryInline::FlatRead32((r1 + 56));
    r5 = r22;
    ...
    f3.d = PpcFmulsInline(f28.d, f0.d);
    r10 = MemoryInline::FlatRead32((r1 + 72));
    r7 = r30;
    r9 = MemoryInline::FlatRead32((r1 + 76));
    r8 = r28;
    ...
    MemoryInline::FlatWriteRam32((r1 + 24), r12);
    MemoryInline::FlatWriteRam32((r1 + 28), r11);
    ...
    ctr = ctx->ctr;
    xer = ctx->xer;
    r7 = MemoryInline::FlatRead8((r31 + 332));
    r3 = r21;
    r8 = MemoryInline::FlatRead32((r22 + 212));
    r6 = r23;
    r4 = (r1 + 8);
    r5 = (r1 + 48);
    ctx->lr = 0x8004567Cu;
    ...
    ctx->cr = cr;
    ctx->ctr = ctr;
    InvokeDirectCpu<0x80045040u>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
// RECOMP_REGISTRATION base 0x80045420 func_80045420 preserves=false fpr_mask=0xF0000000
