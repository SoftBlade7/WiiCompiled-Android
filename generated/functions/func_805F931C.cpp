...
extern "C" void func_805F931C(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805F931C:
{
    ...
    MemoryInline::FlatWrite32((r30 + 396), r5);
    MemoryInline::FlatWrite32((r30 + 400), r30);
    MemoryInline::FlatWrite32((r30 + 404), r7);
...
// RECOMP_REGISTRATION base 0x805F931C func_805F931C preserves=true fpr_mask=0x00000000
