...
extern "C" void func_8006B3B0(CpuContext* MKW_RESTRICT ctx)
{
...
loc_8006B3B0:
{
    ...
    f11.d = PpcFmulsInline(f7.d, f1.d);
    f3.d = PpcFmulsInline(f7.d, f0.d);
    f6.d = MemoryInline::FlatReadFloat32((r2 + -29360));
    f9.d = PpcFmulsInline(f8.d, f1.d);
    f1.d = MemoryInline::FlatReadFloat32((r2 + -29348));
    f10.d = PpcFmulsInline(f8.d, f0.d);
    f2.d = static_cast<double>(PpcForceSingleValueInline(f3.d - f11.d));
    f3.d = (-(f3.d));
    f4.d = MemoryInline::FlatReadFloat32((r2 + -29344));
    f5.d = static_cast<double>(PpcForceSingleValueInline(f10.d + f9.d));
    ...
    MemoryInline::WriteResolvedFloat32(guest_range_0, 4u, (r30 + 4), f10.d);
    ...
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 12u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f2.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f3.d))))) {
        ...
        MemoryInline::WriteResolvedFloat32(guest_range_0, 16u, (r30 + 16), f3.d);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_0, 20u, ((static_cast<uint64_t>(PpcBitCastToU32Inline(static_cast<float>(f11.d))) << 32) | PpcBitCastToU32Inline(static_cast<float>(f6.d))))) {
        MemoryInline::WriteResolvedFloat32(guest_range_0, 20u, (r30 + 20), f11.d);
...
// RECOMP_REGISTRATION base 0x8006B3B0 func_8006B3B0 preserves=true fpr_mask=0x00000000
