...
extern "C" void func_8055F1E4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8055F1E4:
{
    ...
    r29 = MemoryInline::FlatRead32((r3 + 40));
    r27 = r3;
...
loc_8055F22C:
{
    r29 = MemoryInline::FlatRead16((r29 + 12));
    r28 = 0;
    r30 = 0x80890000u;
    r31 = 0x80890000u;
    goto loc_8055F258;
...
loc_8055F240:
{
    ...
    r4 = (r28 & 65535);
    f1.d = MemoryInline::FlatReadFloat32((r30 + 5048));
    f2.d = MemoryInline::FlatReadFloat32((r31 + 5052));
    ctx->lr = 0x8055F254u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x8055F1E4 func_8055F1E4 preserves=true fpr_mask=0x00000000
