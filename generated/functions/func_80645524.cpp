...
extern "C" void func_80645524(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80645524:
{
    ...
    r5 = 0x808A0000u;
    r4 = 0;
    f1.d = MemoryInline::FlatReadFloat32((r5 + -27884));
    ctx->lr = 0x8064554Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80645524 func_80645524 preserves=true fpr_mask=0x00000000
