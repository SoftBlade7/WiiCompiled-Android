...
extern "C" void func_8076F0AC(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_8076F190:
{
    r0 = MemoryInline::FlatRead8((r28 + 188));
...
loc_8076F19C:
{
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWrite8((r28 + 188), static_cast<uint8_t>(r0));
}
...
// RECOMP_REGISTRATION base 0x8076F0AC func_8076F0AC preserves=true fpr_mask=0x00000000
