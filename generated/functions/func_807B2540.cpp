...
extern "C" void func_807B2540(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807B25B8:
{
    if ((static_cast<int32_t>(r21) != static_cast<int32_t>(r22))) {
        goto loc_807B25CC;
    }
}
...
{
    r3 = r30;
    guest_range_2 = MemoryInline::ResolveRangeHost((r1 + 68), 0, 52u, true, false);
    {
        ...
        if (resolved_pair.valid) {
            ...
            r21 = MemoryInline::ReadResolved32(guest_range_2, 0u, (r1 + 68));
            r22 = MemoryInline::ReadResolved32(guest_range_2, 4u, (r1 + 72));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r23 = MemoryInline::ReadResolved32(guest_range_2, 8u, (r1 + 76));
            r24 = MemoryInline::ReadResolved32(guest_range_2, 12u, (r1 + 80));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r25 = MemoryInline::ReadResolved32(guest_range_2, 16u, (r1 + 84));
            r26 = MemoryInline::ReadResolved32(guest_range_2, 20u, (r1 + 88));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r27 = MemoryInline::ReadResolved32(guest_range_2, 24u, (r1 + 92));
            r28 = MemoryInline::ReadResolved32(guest_range_2, 28u, (r1 + 96));
        }
    }
    {
        ...
        if (resolved_pair.valid) {
            ...
            r29 = MemoryInline::ReadResolved32(guest_range_2, 32u, (r1 + 100));
            r30 = MemoryInline::ReadResolved32(guest_range_2, 36u, (r1 + 104));
        }
    }
    r31 = MemoryInline::ReadResolved32(guest_range_2, 40u, (r1 + 108));
    r0 = MemoryInline::ReadResolved32(guest_range_2, 48u, (r1 + 116));
    ctx->lr = r0;
    r1 = (r1 + 112);
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
...
// RECOMP_REGISTRATION base 0x807B2540 func_807B2540 preserves=true fpr_mask=0x00000000
