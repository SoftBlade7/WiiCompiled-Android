...
extern "C" void func_80766B58(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80766B58:
{
    ...
    r8 = 0;
    r7 = (r1 + 8);
    r0 = MemoryInline::FlatRead8((r4 + 15068));
    r4 = (r1 + 16);
...
// RECOMP_REGISTRATION base 0x80766B58 func_80766B58 preserves=true fpr_mask=0x00000000
