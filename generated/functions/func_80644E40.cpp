...
extern "C" void func_80644E40(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_inl0_cont_805E17CC:
{
    ...
    r28 = 7;
    r9 = (r10 * 240);
    r29 = MemoryInline::ReadResolved32(guest_range_0, 0u, (r3 + -10456));
    r8 = 10;
    r12 = 8;
    r11 = (r29 + r11);
    r10 = 9;
...
// RECOMP_REGISTRATION base 0x80644E40 func_80644E40 preserves=true fpr_mask=0x00000000
