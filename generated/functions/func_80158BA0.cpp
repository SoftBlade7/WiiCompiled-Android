...
extern "C" void func_80158BA0(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
    uint32_t r0_rot_0 = 0;
    uint32_t r0_rot_1 = 0;
...
loc_80158C54:
{
    r3 = MemoryInline::FlatRead32((r26 + 1040));
    r4 = (r26 + 2);
    ctx->lr = 0x80158C60u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    ctx->cr = cr;
    ctx->xer = xer;
    InvokeDirectCpu<0x80158D8Cu>(ctx);
    r0 = ctx->gpr[0];
    r1 = ctx->gpr[1];
    r3 = ctx->gpr[3];
    r4 = ctx->gpr[4];
...
loc_80158CA4:
{
    r29 = MemoryInline::FlatRead8(r30);
    r3 = (r30 + 1);
    r5 = (r1 + 8);
    r4 = r29;
    ctx->gpr[0] = r0;
    ...
    r8 = ctx->gpr[8];
    cr = ctx->cr;
    r0_rot_2 = PpcRotl32Inline(static_cast<uint32_t>(r29), static_cast<uint32_t>(29));
    r0 = (r0_rot_2 & 31);
}
...
// RECOMP_REGISTRATION base 0x80158BA0 func_80158BA0 preserves=true fpr_mask=0x00000000
