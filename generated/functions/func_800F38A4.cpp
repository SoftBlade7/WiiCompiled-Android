...
extern "C" void func_800F38A4(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_800F38A4:
{
    ...
    r31 = MemoryInline::FlatRead8((r29 + 64));
...
loc_800F3908:
{
    r30 = (r29 + 128);
    r0 = 2;
    MemoryInline::FlatWriteRam8((r30 + 5), static_cast<uint8_t>(r0));
    r3 = 27900;
...
loc_800F3920:
{
    MemoryInline::FlatWriteRam16((r30 + 6), static_cast<uint16_t>(r3));
    r3 = (r1 + 8);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_800F3930;
    }
...
loc_800F39A0:
{
    MemoryInline::FlatWriteRam32((r29 + 128), r3);
    if (((cr & 0x20000000u) != 0)) {
        goto loc_800F3A00;
    }
}
...
loc_800F39A8:
{
    ...
    MemoryInline::FlatWriteRam32((r30 + 76), r5);
    r4 = (r30 + 12);
    r7 = (r30 + 4);
    r6 = 0;
    r8 = 8;
    ...
    xer = ctx->xer;
    r0 = 0;
    MemoryInline::FlatWriteRam32((r30 + 80), r3);
...
// RECOMP_REGISTRATION base 0x800F38A4 func_800F38A4 preserves=true fpr_mask=0x00000000
