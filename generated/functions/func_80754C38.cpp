...
extern "C" void func_80754C38(CpuContext* MKW_RESTRICT ctx)
{
...
loc_80754C38:
{
    ...
    ctx->lr = 0x80754C40u;
    ctx->gpr[3] = r3;
    InvokeDirectCpu<0x80756A0Cu>(ctx);
    r3 = ctx->gpr[3];
    r29 = ctx->gpr[29];
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x80754C38 func_80754C38 preserves=true fpr_mask=0x00000000
