...
extern "C" void func_801B8120(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_801B8364_loc_0 = 0;
    uint32_t addr_801B8368_loc_0 = 0;
    uint32_t addr_801B836C_loc_0 = 0;
    uint32_t cr0_0 = 0;
...
{
    r31 = 0x802A0000u;
    r23 = MemoryInline::FlatRead32((r1 + 88));
    r15 = r3;
    r14 = MemoryInline::FlatRead8((r1 + 95));
    r16 = r4;
    r17 = r5;
    r18 = r6;
    r19 = r7;
...
loc_801B8348:
{
    MemoryInline::FlatWrite8(r29, static_cast<uint8_t>(r16));
    r6 = 0;
    r5 = 1;
    r0 = 2;
    MemoryInline::FlatWrite8(r28, static_cast<uint8_t>(r17));
    r3 = r29;
    r4 = 32;
    addr_801B8364_loc_0 = r26;
    PPC_StoreHalfwordByteReverse(addr_801B8364_loc_0, r18);
    addr_801B8368_loc_0 = r25;
    PPC_StoreHalfwordByteReverse(addr_801B8368_loc_0, r19);
    addr_801B836C_loc_0 = r24;
    PPC_StoreHalfwordByteReverse(addr_801B836C_loc_0, r20);
    MemoryInline::FlatWrite8(r27, static_cast<uint8_t>(r6));
    guest_range_1 = MemoryInline::ResolveRangeHost(r30, 0, 56u, false, true);
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 0u, ((static_cast<uint64_t>(static_cast<uint32_t>(r29)) << 32) | static_cast<uint32_t>(r5)))) {
        MemoryInline::WriteResolved32(guest_range_1, 0u, r30, r29);
        MemoryInline::WriteResolved32(guest_range_1, 4u, (r30 + 4), r5);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 8u, ((static_cast<uint64_t>(static_cast<uint32_t>(r28)) << 32) | static_cast<uint32_t>(r5)))) {
        MemoryInline::WriteResolved32(guest_range_1, 8u, (r30 + 8), r28);
        MemoryInline::WriteResolved32(guest_range_1, 12u, (r30 + 12), r5);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 16u, ((static_cast<uint64_t>(static_cast<uint32_t>(r26)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_1, 16u, (r30 + 16), r26);
        MemoryInline::WriteResolved32(guest_range_1, 20u, (r30 + 20), r0);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 24u, ((static_cast<uint64_t>(static_cast<uint32_t>(r25)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_1, 24u, (r30 + 24), r25);
        MemoryInline::WriteResolved32(guest_range_1, 28u, (r30 + 28), r0);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 32u, ((static_cast<uint64_t>(static_cast<uint32_t>(r24)) << 32) | static_cast<uint32_t>(r0)))) {
        MemoryInline::WriteResolved32(guest_range_1, 32u, (r30 + 32), r24);
        MemoryInline::WriteResolved32(guest_range_1, 36u, (r30 + 36), r0);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 40u, ((static_cast<uint64_t>(static_cast<uint32_t>(r27)) << 32) | static_cast<uint32_t>(r5)))) {
        MemoryInline::WriteResolved32(guest_range_1, 40u, (r30 + 40), r27);
        MemoryInline::WriteResolved32(guest_range_1, 44u, (r30 + 44), r5);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_1, 48u, ((static_cast<uint64_t>(static_cast<uint32_t>(r21)) << 32) | static_cast<uint32_t>(r20)))) {
        MemoryInline::WriteResolved32(guest_range_1, 48u, (r30 + 48), r21);
        MemoryInline::WriteResolved32(guest_range_1, 52u, (r30 + 52), r20);
    }
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
    ctx->gpr[4] = r4;
...
loc_801B8470:
{
    ...
    cr = ctx->cr;
    xer = ctx->xer;
    MemoryInline::FlatWrite32(r14, r22);
    r4 = r22;
    r5 = r23;
    r3 = (r31 + 932);
    MemoryInline::FlatWrite32((r14 + 8), r23);
    cr = PpcCrLogicalResident(cr, static_cast<uint32_t>(2), static_cast<uint32_t>(6), static_cast<uint32_t>(6), static_cast<uint32_t>(6));
    ctx->lr = 0x801B849Cu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    r0 = 7;
    r8 = 0x801B0000u;
    guest_range_2 = MemoryInline::ResolveRangeHost((r14 + 20), 0, 50u, false, true);
    MemoryInline::WriteResolved32(guest_range_2, 32u, (r14 + 52), r0);
    r3 = r15;
    r7 = r30;
    r9 = r14;
    MemoryInline::WriteResolved32(guest_range_2, 0u, (r14 + 20), r29);
    r8 = (r8 + 30840);
    r4 = 0;
    r5 = 6;
    MemoryInline::WriteResolved32(guest_range_2, 4u, (r14 + 24), r28);
    r6 = 1;
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 8u, ((static_cast<uint64_t>(static_cast<uint32_t>(r26)) << 32) | static_cast<uint32_t>(r25)))) {
        MemoryInline::WriteResolved32(guest_range_2, 8u, (r14 + 28), r26);
        MemoryInline::WriteResolved32(guest_range_2, 12u, (r14 + 32), r25);
    }
    if (!MemoryInline::WriteResolvedPair32(guest_range_2, 16u, ((static_cast<uint64_t>(static_cast<uint32_t>(r24)) << 32) | static_cast<uint32_t>(r27)))) {
        MemoryInline::WriteResolved32(guest_range_2, 16u, (r14 + 36), r24);
        MemoryInline::WriteResolved32(guest_range_2, 20u, (r14 + 40), r27);
    }
    MemoryInline::WriteResolved32(guest_range_2, 24u, (r14 + 44), r30);
    MemoryInline::WriteResolved32(guest_range_2, 44u, (r14 + 64), r21);
    MemoryInline::WriteResolved16(guest_range_2, 48u, (r14 + 68), static_cast<uint16_t>(r20));
    ctx->lr = 0x801B84ECu;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ctx->gpr[3] = r3;
...
// RECOMP_REGISTRATION base 0x801B8120 func_801B8120 preserves=true fpr_mask=0x00000000
