...
extern "C" void func_807B7B7C(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t cr0_0 = 0;
...
loc_807B7B7C:
{
    ...
    r30 = r3;
    r31 = MemoryInline::FlatRead8((r3 + 24));
    r3 = r31;
    ctx->lr = 0x807B7BA0u;
    ctx->gpr[0] = r0;
    ctx->gpr[1] = r1;
    ...
    r4 = 0x808A0000u;
    r3 = r30;
    f1.d = MemoryInline::FlatReadFloat32((r4 + 25200));
    r4 = 21;
    r5 = 1;
    ctx->lr = 0x807B7BB8u;
    ctx->gpr[0] = r0;
...
// RECOMP_REGISTRATION base 0x807B7B7C func_807B7B7C preserves=true fpr_mask=0x00000000
