...
extern "C" void func_806DAA44(CpuContext* MKW_RESTRICT ctx)
{
    uint32_t addr_lhax_806DAAA8_loc_0 = 0;
    uint32_t cr0_0 = 0;
    uint32_t r7_rot_0 = 0;
    uint32_t r7_rot_1 = 0;
    uint32_t r7_rot_2 = 0;
...
loc_806DAA64:
{
    ...
    addr_lhax_806DAAA8_loc_0 = (r8 + r7);
    r7 = MemoryInline::FlatRead16(addr_lhax_806DAAA8_loc_0);
    r7 = (r7 << 16);
    r7 = (static_cast<int32_t>(r7) >> 16);
    r9 = MemoryInline::FlatRead32((r9 + 8));
    r0 = (r7 * 116);
    f0.d = MemoryInline::FlatReadFloat32((r5 + 848));
    f3.d = MemoryInline::FlatReadFloat64((r6 + 840));
    r12 = MemoryInline::FlatRead32((r12 + 136));
    r5 = (r9 + r0);
    f2.d = MemoryInline::FlatReadFloat32((r4 + 832));
...
// RECOMP_REGISTRATION base 0x806DAA44 func_806DAA44 preserves=true fpr_mask=0x00000000
