...
extern "C" void func_805DAE30(CpuContext* MKW_RESTRICT ctx)
{
...
loc_805DAE30:
{
    ...
    MemoryInline::FlatWrite8((r3 + 11364), static_cast<uint8_t>(r0));
    ctx->gpr[0] = r0;
    ctx->gpr[4] = r4;
    return;
}
...
// RECOMP_REGISTRATION base 0x805DAE30 func_805DAE30 preserves=true fpr_mask=0x00000000
