...
bool initialize(AuroraBackend auroraBackend) {
  ...
  uint32_t maxTextureDimension2D = 0;
  {
    ...
    // single brace-init wrapped in parens no longer resolves to any constructor. The extra outer
    // brace invokes its Init&&-taking constructor with an aggregate-initialized Init argument,
    // matching Dawn's own generated-header convention for chained-struct types with this shape.
